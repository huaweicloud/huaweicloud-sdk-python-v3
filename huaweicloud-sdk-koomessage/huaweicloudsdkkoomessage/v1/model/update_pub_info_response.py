...
class UpdatePubInfoResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this UpdatePubInfoResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this UpdatePubInfoResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdatePubInfoResponse.to_dict() is deprecated and no longer maintained, "
