...
class PushPortalInfoResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this PushPortalInfoResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this PushPortalInfoResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("PushPortalInfoResponse.to_dict() is deprecated and no longer maintained, "
