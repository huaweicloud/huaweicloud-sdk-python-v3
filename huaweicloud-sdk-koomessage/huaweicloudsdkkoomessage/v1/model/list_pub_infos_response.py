...
class ListPubInfosResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this ListPubInfosResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this ListPubInfosResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListPubInfosResponse.to_dict() is deprecated and no longer maintained, "
