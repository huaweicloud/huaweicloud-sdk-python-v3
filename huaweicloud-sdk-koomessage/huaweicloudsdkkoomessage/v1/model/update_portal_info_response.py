...
class UpdatePortalInfoResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this UpdatePortalInfoResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this UpdatePortalInfoResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdatePortalInfoResponse.to_dict() is deprecated and no longer maintained, "
