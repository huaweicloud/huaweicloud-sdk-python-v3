...
class SendAimBatchDifferentMessagesRequest:
    ...
    openapi_types = {
        'body': 'SmsMultiTemplateTaskRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the SendAimBatchDifferentMessagesRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SendAimBatchDifferentMessagesRequest):
            return False
