...
class UnlockPortResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this UnlockPortResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this UnlockPortResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UnlockPortResponse.to_dict() is deprecated and no longer maintained, "
