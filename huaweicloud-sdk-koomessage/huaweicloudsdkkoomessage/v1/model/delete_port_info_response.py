...
class DeletePortInfoResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this DeletePortInfoResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this DeletePortInfoResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeletePortInfoResponse.to_dict() is deprecated and no longer maintained, "
