...
class SetPrimaryVideoThumbnailRequest:
    ...
    openapi_types = {
        'body': 'SetPrimaryVideoThumbnailRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the SetPrimaryVideoThumbnailRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SetPrimaryVideoThumbnailRequest):
            return False
