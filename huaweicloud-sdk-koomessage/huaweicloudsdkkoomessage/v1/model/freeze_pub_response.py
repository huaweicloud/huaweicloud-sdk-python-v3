...
class FreezePubResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this FreezePubResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this FreezePubResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("FreezePubResponse.to_dict() is deprecated and no longer maintained, "
