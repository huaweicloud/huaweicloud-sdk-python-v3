...
class DeleteTemplateMaterialResponse(SdkResponse):
    ...
    def data(self):
        ...
        :return: The data of this DeleteTemplateMaterialResponse.
        :rtype: object
        """
        return self._data
    ...
    def data(self, data):
        ...
        :param data: The data of this DeleteTemplateMaterialResponse.
        :type data: object
        """
        self._data = data
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteTemplateMaterialResponse.to_dict() is deprecated and no longer maintained, "
