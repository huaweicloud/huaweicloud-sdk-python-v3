...
class UpdatePortalFastappModel:
    ...
    @property
    def name(self):
        r"""Gets the name of this UpdatePortalFastappModel.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this UpdatePortalFastappModel.
    ...
    @property
    def logo_img(self):
        r"""Gets the logo_img of this UpdatePortalFastappModel.
    ...
    def logo_img(self, logo_img):
        r"""Sets the logo_img of this UpdatePortalFastappModel.
    ...
    def description(self):
        r"""Gets the description of this UpdatePortalFastappModel.
    ...
    def description(self, description):
        r"""Sets the description of this UpdatePortalFastappModel.
    ...
    @property
    def deeplink(self):
        r"""Gets the deeplink of this UpdatePortalFastappModel.
    ...
    def deeplink(self, deeplink):
        r"""Sets the deeplink of this UpdatePortalFastappModel.
    ...
    def depend_engine_version(self):
        r"""Gets the depend_engine_version of this UpdatePortalFastappModel.
    ...
    def depend_engine_version(self, depend_engine_version):
        r"""Sets the depend_engine_version of this UpdatePortalFastappModel.
