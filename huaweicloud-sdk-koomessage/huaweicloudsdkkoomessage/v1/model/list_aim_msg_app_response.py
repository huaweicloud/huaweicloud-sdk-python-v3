...
class ListAimMsgAppResponse(SdkResponse):
    ...
    def __init__(self, result=None, page_info=None):
        ...
        :param result: 查询结果。
        :type result: list[:class:`huaweicloudsdkkoomessage.v1.SmsApp`]
        :param page_info: 
    ...
    def result(self):
        ...
        :return: The result of this ListAimMsgAppResponse.
        :rtype: list[:class:`huaweicloudsdkkoomessage.v1.SmsApp`]
        """
        return self._result
    ...
    def result(self, result):
        ...
        :param result: The result of this ListAimMsgAppResponse.
        :type result: list[:class:`huaweicloudsdkkoomessage.v1.SmsApp`]
        """
        self._result = result
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAimMsgAppResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAimMsgAppResponse):
            return False
