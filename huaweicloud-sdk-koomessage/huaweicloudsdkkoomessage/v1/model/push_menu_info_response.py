...
class PushMenuInfoResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this PushMenuInfoResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this PushMenuInfoResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("PushMenuInfoResponse.to_dict() is deprecated and no longer maintained, "
