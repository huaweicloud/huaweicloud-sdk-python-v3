...
class RegisterPortResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this RegisterPortResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this RegisterPortResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("RegisterPortResponse.to_dict() is deprecated and no longer maintained, "
