...
class ListPortalInfosResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this ListPortalInfosResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this ListPortalInfosResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListPortalInfosResponse.to_dict() is deprecated and no longer maintained, "
