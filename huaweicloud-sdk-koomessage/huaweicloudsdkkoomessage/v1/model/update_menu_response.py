...
class UpdateMenuResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this UpdateMenuResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this UpdateMenuResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateMenuResponse.to_dict() is deprecated and no longer maintained, "
