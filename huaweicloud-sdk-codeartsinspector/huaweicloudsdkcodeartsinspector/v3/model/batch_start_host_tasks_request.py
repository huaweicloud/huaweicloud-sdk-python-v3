...
class BatchStartHostTasksRequest:
    ...
    openapi_types = {
        'body': 'BatchStartHostTasksRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchStartHostTasksRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchStartHostTasksRequest):
            return False
