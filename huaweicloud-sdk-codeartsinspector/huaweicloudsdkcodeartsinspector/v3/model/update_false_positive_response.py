...
class UpdateFalsePositiveResponse(SdkResponse):
    ...
    @property
    def info_code(self):
        r"""Gets the info_code of this UpdateFalsePositiveResponse.
    ...
    def info_code(self, info_code):
        r"""Sets the info_code of this UpdateFalsePositiveResponse.
    ...
    def info_description(self):
        r"""Gets the info_description of this UpdateFalsePositiveResponse.
    ...
    def info_description(self, info_description):
        r"""Sets the info_description of this UpdateFalsePositiveResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateFalsePositiveResponse.to_dict() is deprecated and no longer maintained, "
