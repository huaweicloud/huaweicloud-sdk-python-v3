...
class ListTaskHistoriesResponse(SdkResponse):
    ...
    openapi_types = {
        'total': 'int',
        'data': 'list[ShowTasksResponseBody]'
    }
    ...
    def __init__(self, total=None, data=None):
        ...
        :type data: list[:class:`huaweicloudsdkcodeartsinspector.v3.ShowTasksResponseBody`]
        """
    ...
    def data(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsinspector.v3.ShowTasksResponseBody`]
        """
        return self._data
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListTaskHistoriesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListTaskHistoriesResponse):
            return False
