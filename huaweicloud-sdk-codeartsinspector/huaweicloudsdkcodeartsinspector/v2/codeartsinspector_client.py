...
class CodeArtsInspectorClient(Client):
    ...
    def create_purchase_order_invoker(self, request):
        http_info = self._create_purchase_order_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_purchase_order_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def update_purchase_order_invoker(self, request):
        http_info = self._update_purchase_order_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_purchase_order_http_info(cls, request):
        http_info = {
            "method": "POST",
