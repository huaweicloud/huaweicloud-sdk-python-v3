...
class CodeArtsPipelineClient(Client):
    ...
    def show_pipeline_detail_invoker(self, request):
        http_info = self._show_pipeline_detail_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_pipeline_detail_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def update_pipeline_info_invoker(self, request):
        http_info = self._update_pipeline_info_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_pipeline_info_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v5/{project_id}/api/pipelines/{pipeline_id}",
            "request_type": request.__class__.__name__,
    ...
    def show_pipeline_artifacts_invoker(self, request):
        http_info = self._show_pipeline_artifacts_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_pipeline_artifacts_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_step_outputs_invoker(self, request):
        http_info = self._show_step_outputs_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_step_outputs_http_info(cls, request):
        http_info = {
            "method": "GET",
