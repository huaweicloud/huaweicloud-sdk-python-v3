...
class ListAvailablePublisherResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAvailablePublisherResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAvailablePublisherResponse):
            return False
