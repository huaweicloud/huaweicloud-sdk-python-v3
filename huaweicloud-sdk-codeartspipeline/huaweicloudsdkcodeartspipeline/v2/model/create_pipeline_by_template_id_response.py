...
class CreatePipelineByTemplateIdResponse(SdkResponse):
    ...
    def __init__(self, pipeline_id=None):
        r"""CreatePipelineByTemplateIdResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreatePipelineByTemplateIdResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreatePipelineByTemplateIdResponse):
            return False
