...
class ShowPluginMetricsResponse(SdkResponse):
    ...
    openapi_types = {
        'body': 'list[PluginPartQueryVOListAgentPluginOutputVO]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowPluginMetricsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowPluginMetricsResponse):
            return False
