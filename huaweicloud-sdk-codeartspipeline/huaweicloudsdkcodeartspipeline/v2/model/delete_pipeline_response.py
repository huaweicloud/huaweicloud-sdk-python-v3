...
class DeletePipelineResponse(SdkResponse):
    ...
    def pipeline_id(self):
        ...
        **参数解释**： 流水线ID，可以通过[查询流水线列表](ListPipelines.xml)接口，其中pipelines.pipelineId即为流水线ID。 **取值范围**： 32位字符，仅由数字和字母组成。 
        ...
        :return: The pipeline_id of this DeletePipelineResponse.
        :rtype: str
        """
    ...
    def pipeline_id(self, pipeline_id):
        ...
        **参数解释**： 流水线ID，可以通过[查询流水线列表](ListPipelines.xml)接口，其中pipelines.pipelineId即为流水线ID。 **取值范围**： 32位字符，仅由数字和字母组成。 
        ...
        :param pipeline_id: The pipeline_id of this DeletePipelineResponse.
        :type pipeline_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeletePipelineResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeletePipelineResponse):
            return False
