...
class ShowPluginInputsResponse(SdkResponse):
    ...
    openapi_types = {
        'body': 'list[PluginPartQueryVOListAgentPluginInputVO]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowPluginInputsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowPluginInputsResponse):
            return False
