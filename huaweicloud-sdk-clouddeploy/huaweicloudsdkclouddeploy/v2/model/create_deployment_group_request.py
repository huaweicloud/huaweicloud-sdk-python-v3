...
class CreateDeploymentGroupRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateDeploymentGroupRequest
        :type body: :class:`huaweicloudsdkclouddeploy.v2.DeploymentGroup`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkclouddeploy.v2.DeploymentGroup`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateDeploymentGroupRequest):
            return False
