...
class DrsClient(Client):
    ...
    def modify_group_and_stream(self, request):
        r"""更新LTS配置
        ...
        :param request: Request instance for ModifyGroupAndStream
        :type request: :class:`huaweicloudsdkdrs.v3.ModifyGroupAndStreamRequest`
        :rtype: :class:`huaweicloudsdkdrs.v3.ModifyGroupAndStreamResponse`
        """
        http_info = self._modify_group_and_stream_http_info(request)
        return self._call_api(**http_info)

    def modify_group_and_stream_invoker(self, request):
        http_info = self._modify_group_and_stream_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _modify_group_and_stream_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v3/{project_id}/jobs/{job_id}/lts-log-switch",
            "request_type": request.__class__.__name__,
            "response_type": "ModifyGroupAndStreamResponse"
            }
    ...
    def query_tuning_params(self, request):
        r"""查询高级设置参数
        ...
        :param request: Request instance for QueryTuningParams
        :type request: :class:`huaweicloudsdkdrs.v3.QueryTuningParamsRequest`
        :rtype: :class:`huaweicloudsdkdrs.v3.QueryTuningParamsResponse`
        """
        http_info = self._query_tuning_params_http_info(request)
        return self._call_api(**http_info)

    def query_tuning_params_invoker(self, request):
        http_info = self._query_tuning_params_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _query_tuning_params_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v3/{project_id}/job/{job_id}/tuning-params/query-params",
            "request_type": request.__class__.__name__,
            "response_type": "QueryTuningParamsResponse"
            }
    ...
    def select_group_and_stream(self, request):
        r"""查询LTS配置
        ...
        :param request: Request instance for SelectGroupAndStream
        :type request: :class:`huaweicloudsdkdrs.v3.SelectGroupAndStreamRequest`
        :rtype: :class:`huaweicloudsdkdrs.v3.SelectGroupAndStreamResponse`
        """
        http_info = self._select_group_and_stream_http_info(request)
        return self._call_api(**http_info)

    def select_group_and_stream_invoker(self, request):
        http_info = self._select_group_and_stream_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _select_group_and_stream_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v3/{project_id}/jobs/{job_id}/lts-log-switch",
            "request_type": request.__class__.__name__,
            "response_type": "SelectGroupAndStreamResponse"
            }
