...
class DrsAsyncClient(Client):
    ...
    def modify_group_and_stream_async(self, request):
        r"""更新LTS配置
    ...
    def modify_group_and_stream_async_invoker(self, request):
        http_info = self._modify_group_and_stream_http_info(request)
        return AsyncInvoker(self, http_info)

    def _modify_group_and_stream_http_info(self, request):
        http_info = {
            "method": "PUT",
    ...
    def query_tuning_params_async(self, request):
        r"""查询高级设置参数
    ...
    def query_tuning_params_async_invoker(self, request):
        http_info = self._query_tuning_params_http_info(request)
        return AsyncInvoker(self, http_info)

    def _query_tuning_params_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def select_group_and_stream_async(self, request):
        r"""查询LTS配置
    ...
    def select_group_and_stream_async_invoker(self, request):
        http_info = self._select_group_and_stream_http_info(request)
        return AsyncInvoker(self, http_info)

    def _select_group_and_stream_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v3/{project_id}/jobs/{job_id}/lts-log-switch",
            "request_type": request.__class__.__name__,
