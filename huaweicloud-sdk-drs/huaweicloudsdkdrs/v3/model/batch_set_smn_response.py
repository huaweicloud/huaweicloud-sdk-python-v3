...
class BatchSetSmnResponse(SdkResponse):
    ...
    @property
    def results(self):
        r"""Gets the results of this BatchSetSmnResponse.
    ...
    def results(self, results):
        r"""Sets the results of this BatchSetSmnResponse.
    ...
    @property
    def count(self):
        r"""Gets the count of this BatchSetSmnResponse.
    ...
    def count(self, count):
        r"""Sets the count of this BatchSetSmnResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchSetSmnResponse.to_dict() is deprecated and no longer maintained, "
