...
class BatchCheckJobsResponse(SdkResponse):
    ...
    @property
    def results(self):
        r"""Gets the results of this BatchCheckJobsResponse.
    ...
    def results(self, results):
        r"""Sets the results of this BatchCheckJobsResponse.
    ...
    @property
    def count(self):
        r"""Gets the count of this BatchCheckJobsResponse.
    ...
    def count(self, count):
        r"""Sets the count of this BatchCheckJobsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchCheckJobsResponse.to_dict() is deprecated and no longer maintained, "
