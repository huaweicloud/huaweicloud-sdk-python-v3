...
class BatchCheckResultsResponse(SdkResponse):
    ...
    @property
    def results(self):
        r"""Gets the results of this BatchCheckResultsResponse.
    ...
    def results(self, results):
        r"""Sets the results of this BatchCheckResultsResponse.
    ...
    @property
    def count(self):
        r"""Gets the count of this BatchCheckResultsResponse.
    ...
    def count(self, count):
        r"""Sets the count of this BatchCheckResultsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchCheckResultsResponse.to_dict() is deprecated and no longer maintained, "
