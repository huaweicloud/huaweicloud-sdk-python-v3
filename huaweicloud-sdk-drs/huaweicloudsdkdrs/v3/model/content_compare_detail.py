...
class ContentCompareDetail:
    ...
    def source_db_name(self):
        r"""Gets the source_db_name of this ContentCompareDetail.
    ...
    def source_db_name(self, source_db_name):
        r"""Sets the source_db_name of this ContentCompareDetail.
    ...
    def target_db_name(self):
        r"""Gets the target_db_name of this ContentCompareDetail.
    ...
    def target_db_name(self, target_db_name):
        r"""Sets the target_db_name of this ContentCompareDetail.
    ...
    def source_table_name(self):
        r"""Gets the source_table_name of this ContentCompareDetail.
    ...
    def source_table_name(self, source_table_name):
        r"""Sets the source_table_name of this ContentCompareDetail.
    ...
    def target_table_name(self):
        r"""Gets the target_table_name of this ContentCompareDetail.
    ...
    def target_table_name(self, target_table_name):
        r"""Sets the target_table_name of this ContentCompareDetail.
    ...
    def source_row_num(self):
        r"""Gets the source_row_num of this ContentCompareDetail.
    ...
    def source_row_num(self, source_row_num):
        r"""Sets the source_row_num of this ContentCompareDetail.
    ...
    def target_row_num(self):
        r"""Gets the target_row_num of this ContentCompareDetail.
    ...
    def target_row_num(self, target_row_num):
        r"""Sets the target_row_num of this ContentCompareDetail.
    ...
    def diff_row_num(self):
        r"""Gets the diff_row_num of this ContentCompareDetail.
    ...
    def diff_row_num(self, diff_row_num):
        r"""Sets the diff_row_num of this ContentCompareDetail.
    ...
    def line_compare_result(self):
        r"""Gets the line_compare_result of this ContentCompareDetail.
    ...
    def line_compare_result(self, line_compare_result):
        r"""Sets the line_compare_result of this ContentCompareDetail.
    ...
    def content_compare_result(self):
        r"""Gets the content_compare_result of this ContentCompareDetail.
    ...
    def content_compare_result(self, content_compare_result):
        r"""Sets the content_compare_result of this ContentCompareDetail.
    ...
    @property
    def message(self):
        r"""Gets the message of this ContentCompareDetail.
    ...
    def message(self, message):
        r"""Sets the message of this ContentCompareDetail.
