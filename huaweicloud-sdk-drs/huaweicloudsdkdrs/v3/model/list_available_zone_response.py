...
class ListAvailableZoneResponse(SdkResponse):
    ...
    @property
    def az_infos(self):
        r"""Gets the az_infos of this ListAvailableZoneResponse.
    ...
    def az_infos(self, az_infos):
        r"""Sets the az_infos of this ListAvailableZoneResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAvailableZoneResponse.to_dict() is deprecated and no longer maintained, "
