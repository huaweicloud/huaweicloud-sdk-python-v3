...
class BatchSetSpeedResponse(SdkResponse):
    ...
    def __init__(self, count=None, results=None):
        """BatchSetSpeedResponse - a model defined in huaweicloud sdk"""
    ...
    @property
    def count(self):
        """Gets the count of this BatchSetSpeedResponse.
    ...
    def count(self, count):
        """Sets the count of this BatchSetSpeedResponse.
    ...
    @property
    def results(self):
        """Gets the results of this BatchSetSpeedResponse.
    ...
    def results(self, results):
        """Sets the results of this BatchSetSpeedResponse.
