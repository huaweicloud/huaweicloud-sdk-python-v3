...
class BatchDeleteJobsResponse(SdkResponse):
    ...
    @property
    def results(self):
        r"""Gets the results of this BatchDeleteJobsResponse.
    ...
    def results(self, results):
        r"""Sets the results of this BatchDeleteJobsResponse.
    ...
    @property
    def count(self):
        r"""Gets the count of this BatchDeleteJobsResponse.
    ...
    def count(self, count):
        r"""Sets the count of this BatchDeleteJobsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchDeleteJobsResponse.to_dict() is deprecated and no longer maintained, "
