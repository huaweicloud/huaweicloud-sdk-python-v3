...
class BatchSetDefinerResponse(SdkResponse):
    ...
    def count(self):
        ...
        :return: The count of this BatchSetDefinerResponse.
        :rtype: int
        """
        return self._count
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchSetDefinerResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchSetDefinerResponse):
            return False
