...
class BatchSetPolicyResponse(SdkResponse):
    ...
    def count(self):
        ...
        :return: The count of this BatchSetPolicyResponse.
        :rtype: int
        """
        return self._count
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchSetPolicyResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchSetPolicyResponse):
            return False
