...
class BatchStopJobsResponse(SdkResponse):
    ...
    def count(self):
        ...
        :return: The count of this BatchStopJobsResponse.
        :rtype: int
        """
        return self._count
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchStopJobsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchStopJobsResponse):
            return False
