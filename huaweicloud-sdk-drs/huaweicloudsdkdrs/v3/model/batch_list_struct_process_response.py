...
class BatchListStructProcessResponse(SdkResponse):
    ...
    openapi_types = {
        'results': 'list[QueryStructProcessResp]',
        'count': 'int'
    }
    ...
    def count(self):
        ...
        :return: The count of this BatchListStructProcessResponse.
        :rtype: int
        """
        return self._count
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchListStructProcessResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchListStructProcessResponse):
            return False
