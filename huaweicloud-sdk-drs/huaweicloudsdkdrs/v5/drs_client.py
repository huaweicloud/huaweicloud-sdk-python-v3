...
class DrsClient(Client):
    ...
    def change_to_period(self, request):
        r"""按需转包周期
    ...
    def change_to_period_invoker(self, request):
        http_info = self._change_to_period_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _change_to_period_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def clean_alarms_invoker(self, request):
        http_info = self._clean_alarms_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _clean_alarms_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def count_instance_by_tags(self, request):
        r"""查询资源实例数量
    ...
    def count_instance_by_tags_invoker(self, request):
        http_info = self._count_instance_by_tags_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _count_instance_by_tags_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def create_replication_job_invoker(self, request):
        http_info = self._create_replication_job_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_replication_job_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def delete_column_infos(self, request):
        r"""删除对象的列信息（列映射、列过滤）
        ...
        :param request: Request instance for DeleteColumnInfos
        :type request: :class:`huaweicloudsdkdrs.v5.DeleteColumnInfosRequest`
        :rtype: :class:`huaweicloudsdkdrs.v5.DeleteColumnInfosResponse`
        """
        http_info = self._delete_column_infos_http_info(request)
        return self._call_api(**http_info)

    def delete_column_infos_invoker(self, request):
        http_info = self._delete_column_infos_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_column_infos_http_info(cls, request):
        http_info = {
            "method": "DELETE",
            "resource_path": "/v5/{project_id}/job/{job_id}/column-info",
            "request_type": request.__class__.__name__,
            "response_type": "DeleteColumnInfosResponse"
            }
    ...
    def delete_jdbc_driver(self, request):
        r"""删除驱动文件（不再推广）
    ...
    def delete_jdbc_driver_invoker(self, request):
        http_info = self._delete_jdbc_driver_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_jdbc_driver_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def delete_replication_job_invoker(self, request):
        http_info = self._delete_replication_job_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_replication_job_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def export_replay_report(self, request):
        r"""导出流量回放任务SQL报告文件
    ...
    def export_replay_report_invoker(self, request):
        http_info = self._export_replay_report_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _export_replay_report_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def list_extra_columns(self, request):
        r"""查询数据加工对象的附加列信息
    ...
    def list_extra_columns_invoker(self, request):
        http_info = self._list_extra_columns_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_extra_columns_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_instance_by_tags(self, request):
        r"""查询资源实例列表
    ...
    def list_instance_by_tags_invoker(self, request):
        http_info = self._list_instance_by_tags_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_instance_by_tags_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def list_jdbc_drivers(self, request):
        r"""查询驱动文件列表（不再推广）
    ...
    def list_jdbc_drivers_invoker(self, request):
        http_info = self._list_jdbc_drivers_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_jdbc_drivers_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v5/{project_id}/jdbc-drivers",
            "request_type": request.__class__.__name__,
    ...
    def list_job_ddls(self, request):
        r"""查询增量DDL列表
    ...
    def list_job_ddls_invoker(self, request):
        http_info = self._list_job_ddls_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_job_ddls_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_job_history_parameters(self, request):
        r"""查询任务的参数配置修改历史
    ...
    def list_job_history_parameters_invoker(self, request):
        http_info = self._list_job_history_parameters_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_job_history_parameters_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_job_parameters(self, request):
        r"""查询任务参数配置列表
    ...
    def list_job_parameters_invoker(self, request):
        http_info = self._list_job_parameters_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_job_parameters_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_replication_jobs(self, request):
        r"""查询备份迁移任务列表
    ...
    def list_replication_jobs_invoker(self, request):
        http_info = self._list_replication_jobs_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_replication_jobs_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v5/{project_id}/backup-migration-jobs",
            "request_type": request.__class__.__name__,
    ...
    def list_support_links(self, request):
        r"""查询可用链路信息
    ...
    def list_support_links_invoker(self, request):
        http_info = self._list_support_links_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_support_links_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def modify_column_infos(self, request):
        r"""修改对象的列信息（列映射、列过滤）
        ...
        :param request: Request instance for ModifyColumnInfos
        :type request: :class:`huaweicloudsdkdrs.v5.ModifyColumnInfosRequest`
        :rtype: :class:`huaweicloudsdkdrs.v5.ModifyColumnInfosResponse`
        """
        http_info = self._modify_column_infos_http_info(request)
        return self._call_api(**http_info)

    def modify_column_infos_invoker(self, request):
        http_info = self._modify_column_infos_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _modify_column_infos_http_info(cls, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v5/{project_id}/job/{job_id}/column-info-modification",
            "request_type": request.__class__.__name__,
            "response_type": "ModifyColumnInfosResponse"
            }
    ...
    def pause_compare_jobs(self, request):
        r"""暂停对比任务
    ...
    def pause_compare_jobs_invoker(self, request):
        http_info = self._pause_compare_jobs_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _pause_compare_jobs_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def restart_compare_jobs(self, request):
        r"""继续对比任务
    ...
    def restart_compare_jobs_invoker(self, request):
        http_info = self._restart_compare_jobs_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _restart_compare_jobs_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def show_child_num(self, request):
        r"""查询子任务数量
    ...
    def show_child_num_invoker(self, request):
        http_info = self._show_child_num_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_child_num_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_column_infos(self, request):
        r"""查询对象的列信息（列映射、列过滤）
        ...
        :param request: Request instance for ShowColumnInfos
        :type request: :class:`huaweicloudsdkdrs.v5.ShowColumnInfosRequest`
        :rtype: :class:`huaweicloudsdkdrs.v5.ShowColumnInfosResponse`
        """
        http_info = self._show_column_infos_http_info(request)
        return self._call_api(**http_info)

    def show_column_infos_invoker(self, request):
        http_info = self._show_column_infos_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_column_infos_http_info(cls, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v5/{project_id}/job/{job_id}/column-info",
            "request_type": request.__class__.__name__,
            "response_type": "ShowColumnInfosResponse"
            }
    ...
    def show_compare_users_detail(self, request):
        r"""查询用户对比详情
    ...
    def show_compare_users_detail_invoker(self, request):
        http_info = self._show_compare_users_detail_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_compare_users_detail_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def _show_dirty_data_http_info(cls, request):
        ...
        if 'limit' in local_var_params:
            query_params.append(('limit', local_var_params['limit']))
        if 'anonymize_mode' in local_var_params:
            query_params.append(('anonymize_mode', local_var_params['anonymize_mode']))
        if 'task_mode' in local_var_params:
            query_params.append(('task_mode', local_var_params['task_mode']))
    ...
    def show_health_compare_job_detail_invoker(self, request):
        http_info = self._show_health_compare_job_detail_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_health_compare_job_detail_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_health_object_compare_job_overview(self, request):
        r"""获取健康对比对象级对比概览
    ...
    def show_health_object_compare_job_overview_invoker(self, request):
        http_info = self._show_health_object_compare_job_overview_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_health_object_compare_job_overview_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_replay_progress(self, request):
        r"""查询录制回放任务进度
        ...
        :param request: Request instance for ShowReplayProgress
        :type request: :class:`huaweicloudsdkdrs.v5.ShowReplayProgressRequest`
        :rtype: :class:`huaweicloudsdkdrs.v5.ShowReplayProgressResponse`
        """
        http_info = self._show_replay_progress_http_info(request)
        return self._call_api(**http_info)

    def show_replay_progress_invoker(self, request):
        http_info = self._show_replay_progress_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_replay_progress_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v5/{project_id}/jobs/{job_id}/replay-progress",
            "request_type": request.__class__.__name__,
            "response_type": "ShowReplayProgressResponse"
            }
    ...
    def show_replay_report_export_status(self, request):
        r"""查询流量回放任务的报告文件导出状态
    ...
    def show_replay_report_export_status_invoker(self, request):
        http_info = self._show_replay_report_export_status_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_replay_report_export_status_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_replication_job(self, request):
        r"""查询备份迁移任务详细信息
    ...
    def show_replication_job_invoker(self, request):
        http_info = self._show_replication_job_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_replication_job_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v5/{project_id}/backup-migration-jobs/{job_id}",
            "request_type": request.__class__.__name__,
    ...
    def show_smn_topic_info(self, request):
        r"""SMN主题查询
    ...
    def show_smn_topic_info_invoker(self, request):
        http_info = self._show_smn_topic_info_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_smn_topic_info_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_subscription_detail(self, request):
        r"""查询订阅任务详情
    ...
    def show_subscription_detail_invoker(self, request):
        http_info = self._show_subscription_detail_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_subscription_detail_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v5/{project_id}/subscriptions/{job_id}",
            "request_type": request.__class__.__name__,
    ...
    def show_subscription_lists(self, request):
        r"""查询订阅任务列表
        ...
        :param request: Request instance for ShowSubscriptionLists
        :type request: :class:`huaweicloudsdkdrs.v5.ShowSubscriptionListsRequest`
        :rtype: :class:`huaweicloudsdkdrs.v5.ShowSubscriptionListsResponse`
        """
        http_info = self._show_subscription_lists_http_info(request)
        return self._call_api(**http_info)

    def show_subscription_lists_invoker(self, request):
        http_info = self._show_subscription_lists_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_subscription_lists_http_info(cls, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v5/{project_id}/subscriptions",
            "request_type": request.__class__.__name__,
            "response_type": "ShowSubscriptionListsResponse"
            }
    ...
    def show_timeline(self, request):
        r"""展示时间轴
    ...
    def show_timeline_invoker(self, request):
        http_info = self._show_timeline_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_timeline_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def sync_jdbc_driver(self, request):
        r"""同步驱动文件（不再推广）
    ...
    def sync_jdbc_driver_invoker(self, request):
        http_info = self._sync_jdbc_driver_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _sync_jdbc_driver_http_info(cls, request):
        http_info = {
            "method": "PUT",
    ...
    def update_compare_policy(self, request):
        r"""修改对比策略
    ...
    def update_compare_policy_invoker(self, request):
        http_info = self._update_compare_policy_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_compare_policy_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v5/{project_id}/jobs/{job_id}/compare-policy",
            "request_type": request.__class__.__name__,
    ...
    def update_job_configurations(self, request):
        r"""更新任务的参数信息
    ...
    def update_job_configurations_invoker(self, request):
        http_info = self._update_job_configurations_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_job_configurations_http_info(cls, request):
        http_info = {
            "method": "PUT",
    ...
    def update_replication_job(self, request):
        r"""修改备份迁移任务信息
    ...
    def update_replication_job_invoker(self, request):
        http_info = self._update_replication_job_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_replication_job_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v5/{project_id}/backup-migration-jobs/{job_id}",
            "request_type": request.__class__.__name__,
    ...
    def update_subscription_info(self, request):
        r"""修改订阅任务的信息
    ...
    def update_subscription_info_invoker(self, request):
        http_info = self._update_subscription_info_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_subscription_info_http_info(cls, request):
        http_info = {
            "method": "PUT",
    ...
    def upload_jdbc_driver(self, request):
        r"""上传驱动文件（不再推广）
    ...
    def upload_jdbc_driver_invoker(self, request):
        http_info = self._upload_jdbc_driver_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _upload_jdbc_driver_http_info(cls, request):
        http_info = {
            "method": "POST",
