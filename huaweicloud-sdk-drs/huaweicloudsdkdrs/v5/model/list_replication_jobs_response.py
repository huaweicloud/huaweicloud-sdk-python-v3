...
class ListReplicationJobsResponse(SdkResponse):
    ...
    @property
    def count(self):
        r"""Gets the count of this ListReplicationJobsResponse.
    ...
    def count(self, count):
        r"""Sets the count of this ListReplicationJobsResponse.
    ...
    @property
    def jobs(self):
        r"""Gets the jobs of this ListReplicationJobsResponse.
    ...
    @jobs.setter
    def jobs(self, jobs):
        r"""Sets the jobs of this ListReplicationJobsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListReplicationJobsResponse.to_dict() is deprecated and no longer maintained, "
