...
class UpdateDataProgressResponse(SdkResponse):
    ...
    def id(self):
        ...
        :return: The id of this UpdateDataProgressResponse.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this UpdateDataProgressResponse.
        :type id: str
        """
        self._id = id
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateDataProgressResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateDataProgressResponse):
            return False
