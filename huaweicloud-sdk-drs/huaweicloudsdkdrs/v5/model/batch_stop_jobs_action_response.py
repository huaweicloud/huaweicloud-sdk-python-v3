...
class BatchStopJobsActionResponse(SdkResponse):
    ...
    @property
    def jobs(self):
        r"""Gets the jobs of this BatchStopJobsActionResponse.
    ...
    @jobs.setter
    def jobs(self, jobs):
        r"""Sets the jobs of this BatchStopJobsActionResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchStopJobsActionResponse.to_dict() is deprecated and no longer maintained, "
