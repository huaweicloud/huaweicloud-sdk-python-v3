...
class CommitAsyncJobResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CommitAsyncJobResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CommitAsyncJobResponse):
            return False
