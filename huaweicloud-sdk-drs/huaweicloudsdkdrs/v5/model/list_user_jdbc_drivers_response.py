...
class ListUserJdbcDriversResponse(SdkResponse):
    ...
    @property
    def count(self):
        r"""Gets the count of this ListUserJdbcDriversResponse.
    ...
    def count(self, count):
        r"""Sets the count of this ListUserJdbcDriversResponse.
    ...
    @property
    def items(self):
        r"""Gets the items of this ListUserJdbcDriversResponse.
    ...
    def items(self, items):
        r"""Sets the items of this ListUserJdbcDriversResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListUserJdbcDriversResponse.to_dict() is deprecated and no longer maintained, "
