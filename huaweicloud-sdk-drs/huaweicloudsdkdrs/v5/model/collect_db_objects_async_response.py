...
class CollectDbObjectsAsyncResponse(SdkResponse):
    ...
    def id(self):
        ...
        :return: The id of this CollectDbObjectsAsyncResponse.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this CollectDbObjectsAsyncResponse.
        :type id: str
        """
        self._id = id
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CollectDbObjectsAsyncResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CollectDbObjectsAsyncResponse):
            return False
