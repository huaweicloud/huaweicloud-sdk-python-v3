...
class ShowHealthCompareJobListRequest:
    ...
    def __init__(self, x_language=None, job_id=None, status=None, offset=None, limit=None):
        ...
        :param job_id: 任务ID。
        :type job_id: str
        :param status: 状态，不传查询所有状态。 - WAITING_FOR_RUNNING：等待启动中 - RUNNING：运行中 - SUCCESSFUL：完成 - FAILED：失败 - CANCELLED：已取消 - TIMEOUT_INTERRUPT：超时中断 - FULL_DOING：全量校验中 - INCRE_DOING：增量校验中
        :type status: str
    ...
    def x_language(self):
        ...
        :return: The x_language of this ShowHealthCompareJobListRequest.
        :rtype: str
        """
    ...
    def x_language(self, x_language):
        ...
        :param x_language: The x_language of this ShowHealthCompareJobListRequest.
        :type x_language: str
        """
    ...
    def job_id(self):
        ...
        :return: The job_id of this ShowHealthCompareJobListRequest.
        :rtype: str
        """
        return self._job_id
    ...
    def job_id(self, job_id):
        ...
        :param job_id: The job_id of this ShowHealthCompareJobListRequest.
        :type job_id: str
        """
        self._job_id = job_id
    ...
    def status(self):
        ...
        :return: The status of this ShowHealthCompareJobListRequest.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this ShowHealthCompareJobListRequest.
        :type status: str
        """
        self._status = status
    ...
    def offset(self):
        ...
        :return: The offset of this ShowHealthCompareJobListRequest.
        :rtype: int
        """
        return self._offset
    ...
    def offset(self, offset):
        ...
        :param offset: The offset of this ShowHealthCompareJobListRequest.
        :type offset: int
        """
        self._offset = offset
    ...
    def limit(self):
        ...
        :return: The limit of this ShowHealthCompareJobListRequest.
        :rtype: int
        """
        return self._limit
    ...
    def limit(self, limit):
        ...
        :param limit: The limit of this ShowHealthCompareJobListRequest.
        :type limit: int
        """
        self._limit = limit
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowHealthCompareJobListRequest):
            return False
