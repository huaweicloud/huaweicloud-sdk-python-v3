...
class ShowDataProcessingRulesResultResponse(SdkResponse):
    ...
    def id(self):
        ...
        :return: The id of this ShowDataProcessingRulesResultResponse.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this ShowDataProcessingRulesResultResponse.
        :type id: str
        """
        self._id = id
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowDataProcessingRulesResultResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowDataProcessingRulesResultResponse):
            return False
