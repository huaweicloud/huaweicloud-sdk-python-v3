...
class UploadJdbcDriverRequestBody:
    ...
    @property
    def file(self):
        r"""Gets the file of this UploadJdbcDriverRequestBody.
    ...
    @file.setter
    def file(self, file):
        r"""Sets the file of this UploadJdbcDriverRequestBody.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadJdbcDriverRequestBody):
            return False
