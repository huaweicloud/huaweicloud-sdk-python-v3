...
class RegisterServerRequest:
    ...
    @property
    def body(self):
        r"""Gets the body of this RegisterServerRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this RegisterServerRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RegisterServerRequest):
            return False
