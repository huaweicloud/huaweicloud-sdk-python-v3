...
class CreateMigprojectRequest:
    ...
    def __init__(self, body=None):
        """CreateMigprojectRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateMigprojectRequest):
            return False
