...
class DeleteTemplatesRequest:
    ...
    @property
    def body(self):
        r"""Gets the body of this DeleteTemplatesRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this DeleteTemplatesRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteTemplatesRequest):
            return False
