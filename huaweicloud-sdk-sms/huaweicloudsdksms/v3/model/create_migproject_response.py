...
class CreateMigprojectResponse(SdkResponse):
    ...
    def id(self):
        ...
        :return: The id of this CreateMigprojectResponse.
        :rtype: str
        """
        return self._id
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateMigprojectResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateMigprojectResponse):
            return False
