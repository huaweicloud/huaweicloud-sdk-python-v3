...
class UpdateTaskStatusResponse(SdkResponse):
    ...
    def body(self):
        ...
        :return: The body of this UpdateTaskStatusResponse.
        :rtype: str
        """
        return self._body
    ...
    def body(self, body):
        ...
        :param body: The body of this UpdateTaskStatusResponse.
        :type body: str
        """
        self._body = body
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateTaskStatusResponse.to_dict() is deprecated and no longer maintained, "
