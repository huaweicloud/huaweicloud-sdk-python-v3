...
class UploadSpecialConfigurationSettingRequest:
    ...
    def __init__(self, task_id=None, body=None):
        ...
        :param task_id: 任务id
        :type task_id: str
        :param body: Body of the UploadSpecialConfigurationSettingRequest
    ...
    def task_id(self):
        ...
        :return: The task_id of this UploadSpecialConfigurationSettingRequest.
        :rtype: str
        """
    ...
    def task_id(self, task_id):
        ...
        :param task_id: The task_id of this UploadSpecialConfigurationSettingRequest.
        :type task_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadSpecialConfigurationSettingRequest):
            return False
