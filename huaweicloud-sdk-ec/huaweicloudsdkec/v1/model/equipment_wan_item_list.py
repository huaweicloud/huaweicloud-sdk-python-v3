...
class EquipmentWanItemList:
    ...
    def wan_interfaces(self):
        ...
        :return: The wan_interfaces of this EquipmentWanItemList.
    ...
    def wan_interfaces(self, wan_interfaces):
        ...
        :param wan_interfaces: The wan_interfaces of this EquipmentWanItemList.
        :type wan_interfaces: list[:class:`huaweicloudsdkec.v1.EquipmentWanItem`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EquipmentWanItemList):
            return False
