...
class ShowEquipmentDnsInfoResponse(SdkResponse):
    ...
    def master_dns(self):
        ...
        :return: The master_dns of this ShowEquipmentDnsInfoResponse.
        :rtype: str
        """
    ...
    def master_dns(self, master_dns):
        ...
        :param master_dns: The master_dns of this ShowEquipmentDnsInfoResponse.
        :type master_dns: str
        """
    ...
    def slave_dns(self):
        ...
        :return: The slave_dns of this ShowEquipmentDnsInfoResponse.
        :rtype: str
        """
    ...
    def slave_dns(self, slave_dns):
        ...
        :param slave_dns: The slave_dns of this ShowEquipmentDnsInfoResponse.
        :type slave_dns: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowEquipmentDnsInfoResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowEquipmentDnsInfoResponse):
            return False
