...
class AddEcnWithIegResponse(SdkResponse):
    ...
    @property
    def id(self):
        r"""Gets the id of this AddEcnWithIegResponse.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this AddEcnWithIegResponse.
    ...
    @property
    def ieg_id(self):
        r"""Gets the ieg_id of this AddEcnWithIegResponse.
    ...
    def ieg_id(self, ieg_id):
        r"""Sets the ieg_id of this AddEcnWithIegResponse.
    ...
    @property
    def region_id(self):
        r"""Gets the region_id of this AddEcnWithIegResponse.
    ...
    def region_id(self, region_id):
        r"""Sets the region_id of this AddEcnWithIegResponse.
    ...
    @property
    def status(self):
        r"""Gets the status of this AddEcnWithIegResponse.
    ...
    def status(self, status):
        r"""Sets the status of this AddEcnWithIegResponse.
    ...
    def health_status(self):
        r"""Gets the health_status of this AddEcnWithIegResponse.
    ...
    def health_status(self, health_status):
        r"""Sets the health_status of this AddEcnWithIegResponse.
    ...
    @property
    def created_at(self):
        r"""Gets the created_at of this AddEcnWithIegResponse.
    ...
    def created_at(self, created_at):
        r"""Sets the created_at of this AddEcnWithIegResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("AddEcnWithIegResponse.to_dict() is deprecated and no longer maintained, "
