...
class EcClient(Client):
    ...
    def show_equipment_wlan(self, request):
        """查询智能企业网关设备Wlan配置
    ...
    def show_equipment_wlan_invoker(self, request):
        http_info = self._show_equipment_wlan_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_equipment_wlan_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def update_equipment_wlan(self, request):
        """配置智能企业网关设备Wlan
    ...
    def update_equipment_wlan_invoker(self, request):
        http_info = self._update_equipment_wlan_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_equipment_wlan_http_info(cls, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v1/{domain_id}/enterprise-connect/intelligent-enterprise-gateway/{ieg_id}/equipment/{equipment_id}/wlan",
            "request_type": request.__class__.__name__,
    ...
    def add_ecn_with_vpc(self, request):
        """关联虚拟私有云到企业连接网络
    ...
    def add_ecn_with_vpc_invoker(self, request):
        http_info = self._add_ecn_with_vpc_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _add_ecn_with_vpc_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def delete_ecn_with_vpc(self, request):
        """解除虚拟私有云和企业连接网络的关联
    ...
    def delete_ecn_with_vpc_invoker(self, request):
        http_info = self._delete_ecn_with_vpc_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_ecn_with_vpc_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_ecn_with_vpc(self, request):
        """查询企业连接网络与虚拟私有云关联关系
    ...
    def list_ecn_with_vpc_invoker(self, request):
        http_info = self._list_ecn_with_vpc_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_ecn_with_vpc_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/{domain_id}/enterprise-connect/enterprise-connect-network/{ecn_id}/relationship/vpc",
            "request_type": request.__class__.__name__,
    ...
    def update_ecn_with_vpc(self, request):
        """更新虚拟私有云和企业连接网络的关联
    ...
    def update_ecn_with_vpc_invoker(self, request):
        http_info = self._update_ecn_with_vpc_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_ecn_with_vpc_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v1/{domain_id}/enterprise-connect/enterprise-connect-network/{ecn_id}/relationship/vpc/{relation_id}",
            "request_type": request.__class__.__name__,
