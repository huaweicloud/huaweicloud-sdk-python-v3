...
class AadClient(Client):
    ...
    def list_d_do_s_attack_event(self, request):
        r"""查询DDoS攻击事件列表
    ...
    def list_d_do_s_attack_event_invoker(self, request):
        http_info = self._list_d_do_s_attack_event_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_d_do_s_attack_event_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def list_d_do_s_connection_number(self, request):
        r"""查询新建连接数和并发连接数
    ...
    def list_d_do_s_connection_number_invoker(self, request):
        http_info = self._list_d_do_s_connection_number_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_d_do_s_connection_number_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_d_do_s_flow(self, request):
    ...
    def list_d_do_s_flow_invoker(self, request):
        http_info = self._list_d_do_s_flow_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_d_do_s_flow_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_frequency_control_rule(self, request):
        r"""查询频率控制规则列表
    ...
    def list_frequency_control_rule_invoker(self, request):
        http_info = self._list_frequency_control_rule_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_frequency_control_rule_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_instance_domains(self, request):
        r"""查询实例关联的域名信息
    ...
    def list_instance_domains_invoker(self, request):
        http_info = self._list_instance_domains_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_instance_domains_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_waf_attack_event(self, request):
        r"""查询攻击事件列表
    ...
    def list_waf_attack_event_invoker(self, request):
        http_info = self._list_waf_attack_event_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_waf_attack_event_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_waf_bandwidth(self, request):
        r"""带宽曲线
    ...
    def list_waf_bandwidth_invoker(self, request):
        http_info = self._list_waf_bandwidth_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_waf_bandwidth_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_waf_custom_rule(self, request):
        r"""查询精准防护规则
    ...
    def list_waf_custom_rule_invoker(self, request):
        http_info = self._list_waf_custom_rule_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_waf_custom_rule_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_waf_geo_ip_rule(self, request):
        r"""查询区域封禁规则
    ...
    def list_waf_geo_ip_rule_invoker(self, request):
        http_info = self._list_waf_geo_ip_rule_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_waf_geo_ip_rule_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_waf_qps_invoker(self, request):
        http_info = self._list_waf_qps_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_waf_qps_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_waf_white_ip_rule(self, request):
    ...
    def list_waf_white_ip_rule_invoker(self, request):
        http_info = self._list_waf_white_ip_rule_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_waf_white_ip_rule_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v2/aad/policies/waf/blackwhite-list",
            "request_type": request.__class__.__name__,
    ...
    def list_white_black_ip_rule(self, request):
        r"""查询DDoS攻击防护的黑白名单列表
    ...
    def list_white_black_ip_rule_invoker(self, request):
        http_info = self._list_white_black_ip_rule_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_white_black_ip_rule_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_domain_certificate(self, request):
        r"""查询域名关联的证书信息
    ...
    def show_domain_certificate_invoker(self, request):
        http_info = self._show_domain_certificate_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_domain_certificate_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_flow_block(self, request):
        r"""查询流量封禁信息
    ...
    def show_flow_block_invoker(self, request):
        http_info = self._show_flow_block_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_flow_block_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_waf_policy(self, request):
        r"""查询WEB防护策略配置
    ...
    def show_waf_policy_invoker(self, request):
        http_info = self._show_waf_policy_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_waf_policy_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_waf_qps_invoker(self, request):
        http_info = self._show_waf_qps_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_waf_qps_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def upgrade_instance_spec(self, request):
        r"""修改实例规格
    ...
    def upgrade_instance_spec_invoker(self, request):
        http_info = self._upgrade_instance_spec_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _upgrade_instance_spec_http_info(cls, request):
        http_info = {
            "method": "PUT",
