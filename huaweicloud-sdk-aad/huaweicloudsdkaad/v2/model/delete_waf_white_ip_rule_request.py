...
class DeleteWafWhiteIpRuleRequest:
    ...
    openapi_types = {
        'body': 'DeleteWafWhiteIpRuleV2RequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the DeleteWafWhiteIpRuleRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteWafWhiteIpRuleRequest):
            return False
