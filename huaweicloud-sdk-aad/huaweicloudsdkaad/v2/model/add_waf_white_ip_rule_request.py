...
class AddWafWhiteIpRuleRequest:
    ...
    openapi_types = {
        'body': 'AddWafWhiteIpRuleV2RequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the AddWafWhiteIpRuleRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddWafWhiteIpRuleRequest):
            return False
