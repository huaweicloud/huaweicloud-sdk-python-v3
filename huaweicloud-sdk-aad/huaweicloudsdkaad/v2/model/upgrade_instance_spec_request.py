...
class UpgradeInstanceSpecRequest:
    ...
    openapi_types = {
        'body': 'UpgradeInstanceSpecV2RequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the UpgradeInstanceSpecRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpgradeInstanceSpecRequest):
            return False
