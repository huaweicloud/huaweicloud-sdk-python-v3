...
class KvsAsyncClient(Client, KvsAsyncClientInterface):
    ...
    def new_builder(cls, clazz=None):
        if not clazz:
            ...
            if clazz.__name__ != "KvsAsyncClient":
                raise TypeError("client type error, support client type is KvsAsyncClient")
    ...
    def _describe_table_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def _list_store_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def _list_table_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def _batch_write_kv_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def _delete_kv_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def _get_kv_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def _put_kv_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def _scan_kv_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def _scan_skey_kv_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def _update_kv_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def _check_health_http_info(self, request):
        http_info = {
            "method": "POST",
