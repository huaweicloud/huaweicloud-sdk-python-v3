...
class ListPipelinesPagePipelines:
    ...
    def __init__(self, pipeline_id=None, name=None, project_id=None, component_id=None, is_publish=None, is_collect=None, manifest_version=None, create_time=None, latest_run=None):
        ...
        :param latest_run: 
        :type latest_run: :class:`huaweicloudsdkcloudpipeline.v2.ListPipelinesPageLatestRun`
        """
    ...
    def latest_run(self):
        ...
        :rtype: :class:`huaweicloudsdkcloudpipeline.v2.ListPipelinesPageLatestRun`
        """
