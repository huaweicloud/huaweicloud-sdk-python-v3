...
class RunPipelineDTO:
    ...
    def __init__(self, sources=None, description=None, variables=None, choose_jobs=None):
        """RunPipelineDTO

        The model defined in huaweicloud sdk

        :param sources: 使用的源
        :type sources: list[:class:`huaweicloudsdkcloudpipeline.v2.RunPipelineDTOSources`]
        :param description: 运行描述
        :type description: str
        :param variables: 使用的自定义参数
        :type variables: list[:class:`huaweicloudsdkcloudpipeline.v2.RunPipelineDTOVariables`]
    ...
    def sources(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcloudpipeline.v2.RunPipelineDTOSources`]
        """
    ...
    def variables(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcloudpipeline.v2.RunPipelineDTOVariables`]
        """
