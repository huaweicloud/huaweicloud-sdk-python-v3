...
class PipelineLatestRun:
    ...
    def __init__(self, pipeline_id=None, pipeline_run_id=None, executor_id=None, executor_name=None, stage_status_list=None, status=None, run_number=None, trigger_type=None, build_params=None, artifact_params=None, start_time=None, end_time=None):
        ...
        :type stage_status_list: list[:class:`huaweicloudsdkcloudpipeline.v2.PipelineLatestRunStageStatusList`]
        :param status: 流水线状态
        :type status: str
        ...
        :param build_params: 
        :type build_params: :class:`huaweicloudsdkcloudpipeline.v2.PipelineLatestRunBuildParams`
        :param artifact_params: 
        :type artifact_params: :class:`huaweicloudsdkcloudpipeline.v2.PipelineLatestRunArtifactParams`
    ...
    def stage_status_list(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcloudpipeline.v2.PipelineLatestRunStageStatusList`]
        """
    ...
    def build_params(self):
        ...
        :rtype: :class:`huaweicloudsdkcloudpipeline.v2.PipelineLatestRunBuildParams`
        """
    ...
    def artifact_params(self):
        ...
        :rtype: :class:`huaweicloudsdkcloudpipeline.v2.PipelineLatestRunArtifactParams`
        """
