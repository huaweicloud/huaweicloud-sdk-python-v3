...
class StageRun:
    ...
    def __init__(self, id=None, category=None, name=None, identifier=None, run_always=None, parallel=None, is_select=None, sequence=None, depends_on=None, condition=None, status=None, start_time=None, end_time=None, pre=None, post=None, jobs=None):
        ...
        :type end_time: int
        :param pre: 阶段准入
        :type pre: list[:class:`huaweicloudsdkcloudpipeline.v2.StepRun`]
        :param post: 阶段准出
        :type post: list[:class:`huaweicloudsdkcloudpipeline.v2.StepRun`]
        :param jobs: 任务
        :type jobs: list[:class:`huaweicloudsdkcloudpipeline.v2.JobRun`]
        """
    ...
    def jobs(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcloudpipeline.v2.JobRun`]
        """
        return self._jobs
