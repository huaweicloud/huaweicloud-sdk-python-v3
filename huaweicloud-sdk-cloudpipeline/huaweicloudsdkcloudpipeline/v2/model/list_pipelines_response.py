...
class ListPipelinesResponse(SdkResponse):
    ...
    def __init__(self, offset=None, limit=None, total=None, pipelines=None):
        ...
        :type total: int
        :param pipelines: 流水线
        :type pipelines: list[:class:`huaweicloudsdkcloudpipeline.v2.ListPipelinesPagePipelines`]
        """
    ...
    def pipelines(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcloudpipeline.v2.ListPipelinesPagePipelines`]
        """
