...
class ShowPipelineRunDetailResponse(SdkResponse):
    ...
    def __init__(self, id=None, pipeline_id=None, manifest_version=None, name=None, description=None, is_publish=None, executor_id=None, executor_name=None, status=None, trigger_type=None, run_number=None, start_time=None, end_time=None, stages=None, domain_id=None, project_id=None, region=None, component_id=None, language=None, sources=None, artifacts=None, subject_id=None):
        ...
        :type end_time: int
        :param stages: 阶段信息
        :type stages: list[:class:`huaweicloudsdkcloudpipeline.v2.StageRun`]
        ...
        :type language: str
        :param sources: 运行源信息
        :type sources: list[:class:`huaweicloudsdkcloudpipeline.v2.RunPipelineSource`]
        :param artifacts: 流水线运行产物
        :type artifacts: list[:class:`huaweicloudsdkcloudpipeline.v2.PackageInfo`]
    ...
    def stages(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcloudpipeline.v2.StageRun`]
        """
        return self._stages
    ...
    def sources(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcloudpipeline.v2.RunPipelineSource`]
        """
    ...
    def artifacts(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcloudpipeline.v2.PackageInfo`]
        """
