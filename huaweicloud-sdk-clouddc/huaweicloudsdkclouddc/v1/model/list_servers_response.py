...
class ListServersResponse(SdkResponse):
    ...
    def __init__(self, servers=None, page_info=None, count=None):
        r"""ListServersResponse

        The model defined in huaweicloud sdk

        :param servers: 物理服务器列表分页
        :type servers: list[:class:`huaweicloudsdkclouddc.v1.PhysicalServer`]
        :param page_info: 
    ...
    def servers(self):
        ...
        :rtype: list[:class:`huaweicloudsdkclouddc.v1.PhysicalServer`]
        """
