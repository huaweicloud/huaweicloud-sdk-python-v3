...
class UpdateRangeSwitchRequest:
    ...
    def __init__(self, enterprise_project_id=None, domain_id=None, body=None):
        ...
        :type domain_id: str
        :param body: Body of the UpdateRangeSwitchRequest
        :type body: :class:`huaweicloudsdkcdn.v1.RangeStatusRequest`
        """
    ...
    def enterprise_project_id(self):
        r"""Gets the enterprise_project_id of this UpdateRangeSwitchRequest.
    ...
    def enterprise_project_id(self, enterprise_project_id):
        r"""Sets the enterprise_project_id of this UpdateRangeSwitchRequest.
    ...
    @property
    def domain_id(self):
        r"""Gets the domain_id of this UpdateRangeSwitchRequest.
    ...
    def domain_id(self, domain_id):
        r"""Sets the domain_id of this UpdateRangeSwitchRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this UpdateRangeSwitchRequest.

        :return: The body of this UpdateRangeSwitchRequest.
        :rtype: :class:`huaweicloudsdkcdn.v1.RangeStatusRequest`
        """
        return self._body

    @body.setter
    def body(self, body):
        r"""Sets the body of this UpdateRangeSwitchRequest.
