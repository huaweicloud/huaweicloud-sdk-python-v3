...
class PreheatingTaskRequestPreheatingTask:
    ...
    def __init__(self, urls=None):
        """PreheatingTaskRequestPreheatingTask - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PreheatingTaskRequestPreheatingTask):
            return False
