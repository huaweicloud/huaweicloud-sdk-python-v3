...
class Rules:
    ...
    def __init__(self, rule_type=None, content=None, ttl=None, ttl_type=None, priority=None):
        ...
        :param rule_type: 0：全部类型，表示匹配所有文件，默认值。  1：文件类型，表示按文件后缀匹配。  2：文件夹类型，表示按目录匹配。  3：文件全路径类型，表示按文件全路径匹配。 5：缓存首页。
        :type rule_type: int
    ...
    @property
    def rule_type(self):
        r"""Gets the rule_type of this Rules.
    ...
    def rule_type(self, rule_type):
        r"""Sets the rule_type of this Rules.
    ...
    @property
    def content(self):
        r"""Gets the content of this Rules.
    ...
    def content(self, content):
        r"""Sets the content of this Rules.
    ...
    @property
    def ttl_type(self):
        r"""Gets the ttl_type of this Rules.
    ...
    def ttl_type(self, ttl_type):
        r"""Sets the ttl_type of this Rules.
    ...
    @property
    def priority(self):
        r"""Gets the priority of this Rules.
    ...
    def priority(self, priority):
        r"""Sets the priority of this Rules.
