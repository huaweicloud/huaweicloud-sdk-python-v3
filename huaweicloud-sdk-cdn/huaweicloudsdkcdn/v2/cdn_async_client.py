...
class CdnAsyncClient(Client):
    ...
    def batch_update_rule_status_async(self, request):
        r"""批量更新规则状态及优先级
    ...
    def batch_update_rule_status_async_invoker(self, request):
        http_info = self._batch_update_rule_status_http_info(request)
        return AsyncInvoker(self, http_info)

    def _batch_update_rule_status_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def create_rule_new_async(self, request):
        r"""创建规则引擎规则
    ...
    def create_rule_new_async_invoker(self, request):
        http_info = self._create_rule_new_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_rule_new_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def create_share_cache_groups_async(self, request):
        r"""创建共享缓存组
    ...
    def create_share_cache_groups_async_invoker(self, request):
        http_info = self._create_share_cache_groups_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_share_cache_groups_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def create_subscription_task_async(self, request):
        r"""创建运营报表订阅任务
    ...
    def create_subscription_task_async_invoker(self, request):
        http_info = self._create_subscription_task_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_subscription_task_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def delete_rule_new_async(self, request):
        r"""删除规则引擎规则
    ...
    def delete_rule_new_async_invoker(self, request):
        http_info = self._delete_rule_new_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_rule_new_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def delete_share_cache_groups_async(self, request):
        r"""删除共享缓存组
    ...
    def delete_share_cache_groups_async_invoker(self, request):
        http_info = self._delete_share_cache_groups_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_share_cache_groups_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def delete_subscription_task_async(self, request):
        r"""删除运营报表订阅任务
    ...
    def delete_subscription_task_async_invoker(self, request):
        http_info = self._delete_subscription_task_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_subscription_task_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_cdn_domain_top_ips_async_invoker(self, request):
        http_info = self._list_cdn_domain_top_ips_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_cdn_domain_top_ips_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_cdn_domain_top_origin_url_async(self, request):
        r"""查询域名top回源URL数据
    ...
    def list_cdn_domain_top_origin_url_async_invoker(self, request):
        http_info = self._list_cdn_domain_top_origin_url_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_cdn_domain_top_origin_url_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_cdn_domain_top_uas_async(self, request):
        r"""查询域名top ua统计分析数据
    ...
    def list_cdn_domain_top_uas_async_invoker(self, request):
        http_info = self._list_cdn_domain_top_uas_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_cdn_domain_top_uas_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_domain_client_stats_async(self, request):
    ...
    def list_domain_client_stats_async_invoker(self, request):
        http_info = self._list_domain_client_stats_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_domain_client_stats_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_rule_details_async(self, request):
        r"""查询规则引擎列表
    ...
    def list_rule_details_async_invoker(self, request):
        http_info = self._list_rule_details_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_rule_details_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1.0/cdn/configuration/domains/{domain_name}/rules",
            "request_type": request.__class__.__name__,
    ...
    def list_share_cache_groups_async(self, request):
        r"""查询共享缓存组列表
    ...
    def list_share_cache_groups_async_invoker(self, request):
        http_info = self._list_share_cache_groups_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_share_cache_groups_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1.0/cdn/configuration/share-cache-groups",
            "request_type": request.__class__.__name__,
    ...
    def list_subscription_tasks_async(self, request):
        r"""分页查询运营报表订阅任务
    ...
    def list_subscription_tasks_async_invoker(self, request):
        http_info = self._list_subscription_tasks_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_subscription_tasks_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/cdn/statistics/subscription-tasks",
            "request_type": request.__class__.__name__,
    ...
    def set_stats_config_async(self, request):
        r"""设置统计配置
    ...
    def set_stats_config_async_invoker(self, request):
        http_info = self._set_stats_config_http_info(request)
        return AsyncInvoker(self, http_info)

    def _set_stats_config_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def show_stats_configs_async_invoker(self, request):
        http_info = self._show_stats_configs_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_stats_configs_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/cdn/statistics/stats-configs",
            "request_type": request.__class__.__name__,
    ...
    def update_full_rule_async(self, request):
        r"""全量更新规则引擎规则
    ...
    def update_full_rule_async_invoker(self, request):
        http_info = self._update_full_rule_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_full_rule_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def update_rule_new_async(self, request):
        r"""更新规则引擎规则
    ...
    def update_rule_new_async_invoker(self, request):
        http_info = self._update_rule_new_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_rule_new_http_info(self, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v1.0/cdn/configuration/domains/{domain_name}/rules/{rule_id}",
            "request_type": request.__class__.__name__,
    ...
    def update_share_cache_groups_async(self, request):
        r"""更新共享缓存组
    ...
    def update_share_cache_groups_async_invoker(self, request):
        http_info = self._update_share_cache_groups_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_share_cache_groups_http_info(self, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v1.0/cdn/configuration/share-cache-groups/{id}",
            "request_type": request.__class__.__name__,
    ...
    def update_subscription_task_async(self, request):
        r"""修改运营报表订阅任务
    ...
    def update_subscription_task_async_invoker(self, request):
        http_info = self._update_subscription_task_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_subscription_task_http_info(self, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v1/cdn/statistics/subscription-tasks/{id}",
            "request_type": request.__class__.__name__,
