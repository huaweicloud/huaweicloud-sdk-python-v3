...
class ListCdnDomainTopUasRequest:
    ...
    def __init__(self, start_time=None, end_time=None, domain_name=None, group_by=None, stat_type=None, service_area=None, enterprise_project_id=None, include_ratio=None):
        r"""ListCdnDomainTopUasRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListCdnDomainTopUasRequest):
            return False
