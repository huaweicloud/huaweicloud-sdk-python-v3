...
class ShowHistoryTaskDetailsResponse(SdkResponse):
    ...
    def __init__(self, id=None, task_type=None, status=None, urls=None, create_time=None, processing=None, succeed=None, failed=None, total=None, file_type=None, x_request_id=None):
        ...
        :type urls: list[:class:`huaweicloudsdkcdn.v2.UrlObject`]
    ...
    def urls(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcdn.v2.UrlObject`]
        """
        return self._urls
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowHistoryTaskDetailsResponse.to_dict() is deprecated and no longer maintained, "
