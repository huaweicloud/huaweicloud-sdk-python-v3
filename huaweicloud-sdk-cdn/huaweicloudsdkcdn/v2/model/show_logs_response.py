...
class ShowLogsResponse(SdkResponse):
    ...
    def __init__(self, total=None, logs=None):
        ...
        :type total: int
        :param logs: 日志列表数据。
        :type logs: list[:class:`huaweicloudsdkcdn.v2.LogObject`]
        """
    ...
    def logs(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcdn.v2.LogObject`]
        """
        return self._logs
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowLogsResponse.to_dict() is deprecated and no longer maintained, "
