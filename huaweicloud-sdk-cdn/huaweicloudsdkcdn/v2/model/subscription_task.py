...
class SubscriptionTask:
    ...
    def __init__(self, id=None, create_time=None, update_time=None, name=None, period_type=None, emails=None, domain_name=None, report_type=None):
        r"""SubscriptionTask
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubscriptionTask):
            return False
