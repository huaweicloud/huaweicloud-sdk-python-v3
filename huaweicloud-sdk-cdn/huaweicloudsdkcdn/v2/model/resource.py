...
class Resource:
    ...
    @property
    def error_msg(self):
        r"""Gets the error_msg of this Resource.

        **参数解释：** 错误信息 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :return: The error_msg of this Resource.
        :rtype: str
        """
    ...
    def error_msg(self, error_msg):
        r"""Sets the error_msg of this Resource.

        **参数解释：** 错误信息 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :param error_msg: The error_msg of this Resource.
        :type error_msg: str
        """
