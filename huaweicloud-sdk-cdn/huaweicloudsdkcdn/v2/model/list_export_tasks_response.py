...
class ListExportTasksResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this ListExportTasksResponse.

        :return: The data of this ListExportTasksResponse.
        :rtype: list[:class:`huaweicloudsdkcdn.v2.ExportTask`]
        """
        return self._data

    @data.setter
    def data(self, data):
        r"""Sets the data of this ListExportTasksResponse.

        :param data: The data of this ListExportTasksResponse.
        :type data: list[:class:`huaweicloudsdkcdn.v2.ExportTask`]
        """
        self._data = data
