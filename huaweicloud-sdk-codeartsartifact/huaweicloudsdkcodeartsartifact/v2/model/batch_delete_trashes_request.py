...
class BatchDeleteTrashesRequest:
    ...
    openapi_types = {
        'body': 'list[TrashArtifactModelForDelete]'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchDeleteTrashesRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteTrashesRequest):
            return False
