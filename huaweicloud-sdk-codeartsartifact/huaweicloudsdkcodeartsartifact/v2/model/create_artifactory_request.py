...
class CreateArtifactoryRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateArtifactoryRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateArtifactoryRequest):
            return False
