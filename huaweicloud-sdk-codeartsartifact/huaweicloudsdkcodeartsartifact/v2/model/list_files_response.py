...
class ListFilesResponse(SdkResponse):
    ...
    def __init__(self, status=None, trace_id=None, result=None):
        ...
        :type trace_id: str
        :param result: 
        :type result: :class:`huaweicloudsdkcodeartsartifact.v2.RepoFileDOV5Page`
        """
    ...
    @property
    def trace_id(self):
        r"""Gets the trace_id of this ListFilesResponse.

        **参数解释**： 请求ID，当前请求唯一标识。 **取值范围**： 数字及中划线（-）组成的字符串。

        :return: The trace_id of this ListFilesResponse.
        :rtype: str
        """
    ...
    def trace_id(self, trace_id):
        r"""Sets the trace_id of this ListFilesResponse.

        **参数解释**： 请求ID，当前请求唯一标识。 **取值范围**： 数字及中划线（-）组成的字符串。

        :param trace_id: The trace_id of this ListFilesResponse.
        :type trace_id: str
        """
    ...
    def result(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsartifact.v2.RepoFileDOV5Page`
        """
        return self._result
