...
class ShowMavenInfoResponse(SdkResponse):
    ...
    def __init__(self, status=None, trace_id=None, result=None):
        ...
        :type trace_id: str
        :param result: **参数解释**： Maven仓库列表。 **取值范围**： 不涉及。 
        :type result: list[:class:`huaweicloudsdkcodeartsartifact.v2.RepositoryBuildVO`]
        """
    ...
    @property
    def status(self):
        r"""Gets the status of this ShowMavenInfoResponse.
    ...
    def status(self, status):
        r"""Sets the status of this ShowMavenInfoResponse.
    ...
    @property
    def trace_id(self):
        r"""Gets the trace_id of this ShowMavenInfoResponse.
    ...
    def trace_id(self, trace_id):
        r"""Sets the trace_id of this ShowMavenInfoResponse.
    ...
    @property
    def result(self):
        r"""Gets the result of this ShowMavenInfoResponse.

        **参数解释**： Maven仓库列表。 **取值范围**： 不涉及。 

        :return: The result of this ShowMavenInfoResponse.
        :rtype: list[:class:`huaweicloudsdkcodeartsartifact.v2.RepositoryBuildVO`]
        """
        return self._result

    @result.setter
    def result(self, result):
        r"""Sets the result of this ShowMavenInfoResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowMavenInfoResponse.to_dict() is deprecated and no longer maintained, "
