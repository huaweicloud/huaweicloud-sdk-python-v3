...
class BatchRestoreRepoRequest:
    ...
    openapi_types = {
        'body': 'list[IDETrashArtifactModel]'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchRestoreRepoRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchRestoreRepoRequest):
            return False
