...
class CreateArtifactoryResponse(SdkResponse):
    ...
    openapi_types = {
        'status': 'str',
        'trace_id': 'str',
        'result': 'CreateArtifactoryResult'
    }
    ...
    def __init__(self, status=None, trace_id=None, result=None):
        ...
        :type trace_id: str
        :param result: 
        :type result: :class:`huaweicloudsdkcodeartsartifact.v2.CreateArtifactoryResult`
        """
    ...
    def result(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsartifact.v2.CreateArtifactoryResult`
        """
        return self._result
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateArtifactoryResponse.to_dict() is deprecated and no longer maintained, "
