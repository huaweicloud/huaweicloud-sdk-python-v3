...
class CreateProjectRelatedRepositoryRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateProjectRelatedRepositoryRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateProjectRelatedRepositoryRequest):
            return False
