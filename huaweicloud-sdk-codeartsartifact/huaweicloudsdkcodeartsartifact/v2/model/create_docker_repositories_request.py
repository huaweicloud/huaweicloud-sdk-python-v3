...
class CreateDockerRepositoriesRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateDockerRepositoriesRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateDockerRepositoriesRequest):
            return False
