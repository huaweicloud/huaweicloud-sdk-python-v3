...
class CodeArtsArtifactClient(Client):
    ...
    def list_user_privileges(self, request):
        r"""查询用户权限
    ...
    def list_user_privileges_invoker(self, request):
        http_info = self._list_user_privileges_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_user_privileges_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_project_related_repository(self, request):
        r"""查询项目列表
    ...
    def show_project_related_repository_invoker(self, request):
        http_info = self._show_project_related_repository_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_project_related_repository_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_project_versions_count(self, request):
        r"""查询项目下的版本数量
    ...
    def show_project_versions_count_invoker(self, request):
        http_info = self._show_project_versions_count_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_project_versions_count_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_repository_roles_privilege(self, request):
        r"""查询仓库权限
    ...
    def show_repository_roles_privilege_invoker(self, request):
        http_info = self._show_repository_roles_privilege_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_repository_roles_privilege_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_version_list(self, request):
        r"""查询发布库版本列表
    ...
    def show_version_list_invoker(self, request):
        http_info = self._show_version_list_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_version_list_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def update_repo_roles_privilege(self, request):
        r"""更新角色权限
    ...
    def update_repo_roles_privilege_invoker(self, request):
        http_info = self._update_repo_roles_privilege_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_repo_roles_privilege_http_info(cls, request):
        http_info = {
            "method": "PUT",
