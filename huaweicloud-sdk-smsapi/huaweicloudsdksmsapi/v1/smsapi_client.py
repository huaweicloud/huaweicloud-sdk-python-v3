...
class SMSApiClient(Client):
    def __init__(self):
        super(SMSApiClient, self).__init__()
    ...
    def new_builder(cls, clazz=None):
        if not clazz:
            ...
            if clazz.__name__ != "SMSApiClient":
                raise TypeError("client type error, support client type is SMSApiClient")
    ...
    def batch_send_diff_sms_invoker(self, request):
        http_info = self._batch_send_diff_sms_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _batch_send_diff_sms_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def batch_send_sms_invoker(self, request):
        http_info = self._batch_send_sms_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _batch_send_sms_http_info(cls, request):
        http_info = {
            "method": "POST",
