...
class UploadSecretBlobRequestBody:
    ...
    def secret_blob(self):
        r"""Gets the secret_blob of this UploadSecretBlobRequestBody.

        将指定凭据对象进行备份后得到的凭据备份文件，备份文件包含有凭据当前所有的凭据版本信息，备份文件经过加密与编码，内容不可直接读。 

        :return: The secret_blob of this UploadSecretBlobRequestBody.
        :rtype: str
        """
    ...
    def secret_blob(self, secret_blob):
        r"""Sets the secret_blob of this UploadSecretBlobRequestBody.

        将指定凭据对象进行备份后得到的凭据备份文件，备份文件包含有凭据当前所有的凭据版本信息，备份文件经过加密与编码，内容不可直接读。 

        :param secret_blob: The secret_blob of this UploadSecretBlobRequestBody.
        :type secret_blob: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadSecretBlobRequestBody):
            return False
