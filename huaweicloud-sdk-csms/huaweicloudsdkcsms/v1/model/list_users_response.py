...
class ListUsersResponse(SdkResponse):
    ...
    def __init__(self, total=None, users=None):
        ...
        :type total: int
        :param users: 用户列表。
        :type users: list[:class:`huaweicloudsdkcsms.v1.UsersDetailsResult`]
        """
    ...
    @property
    def total(self):
        r"""Gets the total of this ListUsersResponse.

        用户总数。

        :return: The total of this ListUsersResponse.
        :rtype: int
        """
        return self._total
    ...
    def total(self, total):
        r"""Sets the total of this ListUsersResponse.

        用户总数。

        :param total: The total of this ListUsersResponse.
        :type total: int
        """
        self._total = total
    ...
    def users(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcsms.v1.UsersDetailsResult`]
        """
        return self._users
