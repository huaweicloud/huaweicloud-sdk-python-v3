...
class UploadSecretBlobResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UploadSecretBlobResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadSecretBlobResponse):
            return False
