...
class CreateSecretTagRequestBody:
    ...
    @property
    def tag(self):
        r"""Gets the tag of this CreateSecretTagRequestBody.
    ...
    @tag.setter
    def tag(self, tag):
        r"""Sets the tag of this CreateSecretTagRequestBody.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateSecretTagRequestBody):
            return False
