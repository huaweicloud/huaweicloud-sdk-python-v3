...
class UploadSecretBlobRequest:
    ...
    openapi_types = {
        'body': 'UploadSecretBlobRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the UploadSecretBlobRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadSecretBlobRequest):
            return False
