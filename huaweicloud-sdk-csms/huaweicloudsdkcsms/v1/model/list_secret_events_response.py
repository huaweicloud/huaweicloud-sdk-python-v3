...
class ListSecretEventsResponse(SdkResponse):
    ...
    def __init__(self, events=None, page_info=None):
        ...
        :param events: 事件详情列表。
        :type events: list[:class:`huaweicloudsdkcsms.v1.Event`]
        :param page_info: 
    ...
    def events(self):
        ...
        :return: The events of this ListSecretEventsResponse.
        :rtype: list[:class:`huaweicloudsdkcsms.v1.Event`]
        """
        return self._events
    ...
    def events(self, events):
        ...
        :param events: The events of this ListSecretEventsResponse.
        :type events: list[:class:`huaweicloudsdkcsms.v1.Event`]
        """
        self._events = events
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListSecretEventsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListSecretEventsResponse):
            return False
