...
class CreateSecretEventRequest:
    ...
    openapi_types = {
        'body': 'CreateSecretEventRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateSecretEventRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateSecretEventRequest):
            return False
