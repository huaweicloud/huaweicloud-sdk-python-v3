...
class CreateGrantsResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateGrantsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateGrantsResponse):
            return False
