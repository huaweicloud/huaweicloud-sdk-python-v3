...
class ShowSecretsConfigResponse(SdkResponse):
    ...
    def checking_secret_strength(self):
        r"""Gets the checking_secret_strength of this ShowSecretsConfigResponse.

        凭据强度检测配置是否打开。

        :return: The checking_secret_strength of this ShowSecretsConfigResponse.
        :rtype: bool
        """
    ...
    def checking_secret_strength(self, checking_secret_strength):
        r"""Sets the checking_secret_strength of this ShowSecretsConfigResponse.

        凭据强度检测配置是否打开。

        :param checking_secret_strength: The checking_secret_strength of this ShowSecretsConfigResponse.
        :type checking_secret_strength: bool
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowSecretsConfigResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowSecretsConfigResponse):
            return False
