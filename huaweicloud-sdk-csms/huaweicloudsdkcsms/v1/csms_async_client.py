...
class CsmsAsyncClient(Client):
    ...
    def batch_import_secrets_async(self, request):
        r"""批量导入凭据
    ...
    def batch_import_secrets_async_invoker(self, request):
        http_info = self._batch_import_secrets_http_info(request)
        return AsyncInvoker(self, http_info)

    def _batch_import_secrets_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def list_secret_task_async(self, request):
        r"""查询任务列表
    ...
    def list_secret_task_async_invoker(self, request):
        http_info = self._list_secret_task_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_secret_task_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_secret_function_templates_async(self, request):
        r"""获取凭据轮转函数模板
    ...
    def show_secret_function_templates_async_invoker(self, request):
        http_info = self._show_secret_function_templates_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_secret_function_templates_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def update_user_password_async(self, request):
        r"""修改用户密码
    ...
    def update_user_password_async_invoker(self, request):
        http_info = self._update_user_password_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_user_password_http_info(self, request):
        http_info = {
            "method": "POST",
