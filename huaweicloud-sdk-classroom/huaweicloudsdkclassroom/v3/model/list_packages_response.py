...
class ListPackagesResponse(SdkResponse):
    ...
    @property
    def total(self):
        r"""Gets the total of this ListPackagesResponse.
    ...
    def total(self, total):
        r"""Sets the total of this ListPackagesResponse.
    ...
    @property
    def data(self):
        r"""Gets the data of this ListPackagesResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this ListPackagesResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListPackagesResponse.to_dict() is deprecated and no longer maintained, "
