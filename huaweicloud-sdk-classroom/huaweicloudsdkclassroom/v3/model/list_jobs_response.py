...
class ListJobsResponse(SdkResponse):
    ...
    @property
    def total(self):
        r"""Gets the total of this ListJobsResponse.
    ...
    def total(self, total):
        r"""Sets the total of this ListJobsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListJobsResponse.to_dict() is deprecated and no longer maintained, "
