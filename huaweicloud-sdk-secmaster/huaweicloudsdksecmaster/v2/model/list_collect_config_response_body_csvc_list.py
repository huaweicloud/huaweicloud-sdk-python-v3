...
class ListCollectConfigResponseBodyCsvcList:
    ...
    def __init__(self, csvc=None, source_list=None):
        ...
        :type source_list: list[:class:`huaweicloudsdksecmaster.v2.ListCollectConfigResponseBodySourceList`]
        """
    ...
    def source_list(self):
        ...
        :rtype: list[:class:`huaweicloudsdksecmaster.v2.ListCollectConfigResponseBodySourceList`]
        """
