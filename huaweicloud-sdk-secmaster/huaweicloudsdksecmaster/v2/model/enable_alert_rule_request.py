...
class EnableAlertRuleRequest:
    ...
    @property
    def project_id(self):
        r"""Gets the project_id of this EnableAlertRuleRequest.
    ...
    def project_id(self, project_id):
        r"""Sets the project_id of this EnableAlertRuleRequest.
    ...
    def workspace_id(self):
        r"""Gets the workspace_id of this EnableAlertRuleRequest.
    ...
    def workspace_id(self, workspace_id):
        r"""Sets the workspace_id of this EnableAlertRuleRequest.
    ...
    def alert_rule_id(self):
        r"""Gets the alert_rule_id of this EnableAlertRuleRequest.

        告警规则 ID

        :return: The alert_rule_id of this EnableAlertRuleRequest.
        :rtype: str
        """
    ...
    def alert_rule_id(self, alert_rule_id):
        r"""Sets the alert_rule_id of this EnableAlertRuleRequest.

        告警规则 ID

        :param alert_rule_id: The alert_rule_id of this EnableAlertRuleRequest.
        :type alert_rule_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnableAlertRuleRequest):
            return False
