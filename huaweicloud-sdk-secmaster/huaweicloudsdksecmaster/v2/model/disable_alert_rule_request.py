...
class DisableAlertRuleRequest:
    ...
    def alert_rule_id(self):
        r"""Gets the alert_rule_id of this DisableAlertRuleRequest.

        告警规则 ID

        :return: The alert_rule_id of this DisableAlertRuleRequest.
        :rtype: str
        """
    ...
    def alert_rule_id(self, alert_rule_id):
        r"""Sets the alert_rule_id of this DisableAlertRuleRequest.

        告警规则 ID

        :param alert_rule_id: The alert_rule_id of this DisableAlertRuleRequest.
        :type alert_rule_id: str
        """
