...
class DeletePipeResponse(SdkResponse):
    ...
    def __init__(self, pipe_id=None, delete_time=None):
    ...
    def delete_time(self):
        r"""Gets the delete_time of this DeletePipeResponse.

        毫秒时间戳

        :return: The delete_time of this DeletePipeResponse.
        :rtype: int
        """
    ...
    def delete_time(self, delete_time):
        r"""Sets the delete_time of this DeletePipeResponse.

        毫秒时间戳

        :param delete_time: The delete_time of this DeletePipeResponse.
        :type delete_time: int
        """
