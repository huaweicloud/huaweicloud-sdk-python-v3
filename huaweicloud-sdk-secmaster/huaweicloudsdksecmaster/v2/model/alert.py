...
class Alert:
    ...
    @property
    def datasource(self):
        """Gets the datasource of this Alert.

        :return: The datasource of this Alert.
    ...
    def datasource(self, datasource):
        """Sets the datasource of this Alert.

        :param datasource: The datasource of this Alert.
        :type datasource: :class:`huaweicloudsdksecmaster.v2.ShowAlertRspDatasource`
        """
    ...
    @property
    def serverity(self):
        """Gets the serverity of this Alert.

        严重性等级

        :return: The serverity of this Alert.
        :rtype: str
        """
    ...
    def serverity(self, serverity):
        """Sets the serverity of this Alert.

        严重性等级

        :param serverity: The serverity of this Alert.
        :type serverity: str
        """
    ...
    @property
    def chop_phase(self):
        """Gets the chop_phase of this Alert.

        周期/处置阶段编号

        :return: The chop_phase of this Alert.
        :rtype: str
        """
    ...
    def chop_phase(self, chop_phase):
        """Sets the chop_phase of this Alert.

        周期/处置阶段编号

        :param chop_phase: The chop_phase of this Alert.
        :type chop_phase: str
        """
    ...
    @property
    def ppdr_phase(self):
        """Gets the ppdr_phase of this Alert.

        周期/处置阶段编号

        :return: The ppdr_phase of this Alert.
        :rtype: str
        """
    ...
    def ppdr_phase(self, ppdr_phase):
        """Sets the ppdr_phase of this Alert.

        周期/处置阶段编号

        :param ppdr_phase: The ppdr_phase of this Alert.
        :type ppdr_phase: str
        """
    ...
    @property
    def cteator(self):
        """Gets the cteator of this Alert.

        The name, display only

        :return: The cteator of this Alert.
        :rtype: str
        """
    ...
    def cteator(self, cteator):
        """Sets the cteator of this Alert.

        The name, display only

        :param cteator: The cteator of this Alert.
        :type cteator: str
        """
