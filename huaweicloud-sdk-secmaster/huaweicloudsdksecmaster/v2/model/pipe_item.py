...
class PipeItem:
    ...
    def __init__(self, project_id=None, workspace_id=None, pipe_id=None, pipe_name=None, pipe_alias=None, category=None, directory=None, description=None, process_status=None, process_error=None, owner_type=None, create_time=None, update_time=None, delete_time=None):
        r"""PipeItem
    ...
    @property
    def project_id(self):
        r"""Gets the project_id of this PipeItem.

        项目ID

        :return: The project_id of this PipeItem.
        :rtype: str
        """
    ...
    def project_id(self, project_id):
        r"""Sets the project_id of this PipeItem.

        项目ID

        :param project_id: The project_id of this PipeItem.
        :type project_id: str
        """
    ...
    def workspace_id(self):
        r"""Gets the workspace_id of this PipeItem.

        UUID

        :return: The workspace_id of this PipeItem.
        :rtype: str
        """
    ...
    def workspace_id(self, workspace_id):
        r"""Sets the workspace_id of this PipeItem.

        UUID

        :param workspace_id: The workspace_id of this PipeItem.
        :type workspace_id: str
        """
    ...
    @property
    def pipe_id(self):
        r"""Gets the pipe_id of this PipeItem.

        UUID

        :return: The pipe_id of this PipeItem.
        :rtype: str
        """
    ...
    def pipe_id(self, pipe_id):
        r"""Sets the pipe_id of this PipeItem.

        UUID

        :param pipe_id: The pipe_id of this PipeItem.
        :type pipe_id: str
        """
    ...
    @property
    def pipe_name(self):
        r"""Gets the pipe_name of this PipeItem.

        管道名称

        :return: The pipe_name of this PipeItem.
        :rtype: str
        """
    ...
    def pipe_name(self, pipe_name):
        r"""Sets the pipe_name of this PipeItem.

        管道名称

        :param pipe_name: The pipe_name of this PipeItem.
        :type pipe_name: str
        """
    ...
    @property
    def pipe_alias(self):
        r"""Gets the pipe_alias of this PipeItem.

        管道别名

        :return: The pipe_alias of this PipeItem.
        :rtype: str
        """
    ...
    def pipe_alias(self, pipe_alias):
        r"""Sets the pipe_alias of this PipeItem.

        管道别名

        :param pipe_alias: The pipe_alias of this PipeItem.
        :type pipe_alias: str
        """
    ...
    @property
    def directory(self):
        r"""Gets the directory of this PipeItem.

        directory 目录分组

        :return: The directory of this PipeItem.
        :rtype: str
        """
    ...
    def directory(self, directory):
        r"""Sets the directory of this PipeItem.

        directory 目录分组

        :param directory: The directory of this PipeItem.
        :type directory: str
        """
    ...
    def description(self):
        r"""Gets the description of this PipeItem.

        管道描述

        :return: The description of this PipeItem.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this PipeItem.

        管道描述

        :param description: The description of this PipeItem.
        :type description: str
        """
    ...
    def create_time(self):
        r"""Gets the create_time of this PipeItem.

        毫秒时间戳

        :return: The create_time of this PipeItem.
        :rtype: int
        """
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this PipeItem.

        毫秒时间戳

        :param create_time: The create_time of this PipeItem.
        :type create_time: int
        """
    ...
    def update_time(self):
        r"""Gets the update_time of this PipeItem.

        毫秒时间戳

        :return: The update_time of this PipeItem.
        :rtype: int
        """
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this PipeItem.

        毫秒时间戳

        :param update_time: The update_time of this PipeItem.
        :type update_time: int
        """
    ...
    def delete_time(self):
        r"""Gets the delete_time of this PipeItem.

        毫秒时间戳

        :return: The delete_time of this PipeItem.
        :rtype: int
        """
    ...
    def delete_time(self, delete_time):
        r"""Sets the delete_time of this PipeItem.

        毫秒时间戳

        :param delete_time: The delete_time of this PipeItem.
        :type delete_time: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PipeItem):
            return False
