...
class CreateCollectConfigV2RequestBody:
    ...
    def __init__(self, config=None, dataspace_id=None, dataspace_name=None, domain_id=None, lts_config=None, workspace_id=None):
        ...
        :param config: 数据集列表
        :type config: list[:class:`huaweicloudsdksecmaster.v2.ConfigInfo`]
        ...
        :type lts_config: list[:class:`huaweicloudsdksecmaster.v2.LtsRquestVo`]
    ...
    def config(self):
        ...
        :rtype: list[:class:`huaweicloudsdksecmaster.v2.ConfigInfo`]
        """
        return self._config
    ...
    def lts_config(self):
        ...
        :rtype: list[:class:`huaweicloudsdksecmaster.v2.LtsRquestVo`]
        """
