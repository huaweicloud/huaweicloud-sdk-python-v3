...
class ListPipesRequest:
    ...
    openapi_types = {
        ...
        'sort_key': 'str',
        'sort_dir': 'str',
        'pipe_name_in_query': 'str',
        'pipe_id_in_query': 'str'
    }
    ...
    attribute_map = {
        ...
        'sort_key': 'sort_key',
        'sort_dir': 'sort_dir',
        'pipe_name_in_query': 'pipe_name_in_query',
        'pipe_id_in_query': 'pipe_id_in_query'
    }

    def __init__(self, project_id=None, workspace_id=None, offset=None, limit=None, sort_key=None, sort_dir=None, pipe_name_in_query=None, pipe_id_in_query=None):
        r"""ListPipesRequest
        ...
        :type sort_dir: str
        :param pipe_name_in_query: 管道名称
        :type pipe_name_in_query: str
        :param pipe_id_in_query: 管道ID
        :type pipe_id_in_query: str
        """
        ...
        self._sort_key = None
        self._sort_dir = None
        self._pipe_name_in_query = None
        self._pipe_id_in_query = None
        ...
        if pipe_name_in_query is not None:
            self.pipe_name_in_query = pipe_name_in_query
        if pipe_id_in_query is not None:
            self.pipe_id_in_query = pipe_id_in_query
    ...
    @property
    def pipe_name_in_query(self):
        r"""Gets the pipe_name_in_query of this ListPipesRequest.

        管道名称

        :return: The pipe_name_in_query of this ListPipesRequest.
        :rtype: str
        """
        return self._pipe_name_in_query

    @pipe_name_in_query.setter
    def pipe_name_in_query(self, pipe_name_in_query):
        r"""Sets the pipe_name_in_query of this ListPipesRequest.

        管道名称

        :param pipe_name_in_query: The pipe_name_in_query of this ListPipesRequest.
        :type pipe_name_in_query: str
        """
        self._pipe_name_in_query = pipe_name_in_query

    @property
    def pipe_id_in_query(self):
        r"""Gets the pipe_id_in_query of this ListPipesRequest.

        管道ID

        :return: The pipe_id_in_query of this ListPipesRequest.
        :rtype: str
        """
        return self._pipe_id_in_query

    @pipe_id_in_query.setter
    def pipe_id_in_query(self, pipe_id_in_query):
        r"""Sets the pipe_id_in_query of this ListPipesRequest.

        管道ID

        :param pipe_id_in_query: The pipe_id_in_query of this ListPipesRequest.
        :type pipe_id_in_query: str
        """
        self._pipe_id_in_query = pipe_id_in_query
