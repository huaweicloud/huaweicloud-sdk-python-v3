...
class ShowAlertRuleResponse(SdkResponse):
    ...
    def alert_rule_id(self):
        r"""Gets the alert_rule_id of this ShowAlertRuleResponse.

        UUID

        :return: The alert_rule_id of this ShowAlertRuleResponse.
        :rtype: str
        """
    ...
    def alert_rule_id(self, alert_rule_id):
        r"""Sets the alert_rule_id of this ShowAlertRuleResponse.

        UUID

        :param alert_rule_id: The alert_rule_id of this ShowAlertRuleResponse.
        :type alert_rule_id: str
        """
    ...
    def alert_rule_name(self):
        r"""Gets the alert_rule_name of this ShowAlertRuleResponse.

        Alert rule name 告警规则名称

        :return: The alert_rule_name of this ShowAlertRuleResponse.
        :rtype: str
        """
    ...
    def alert_rule_name(self, alert_rule_name):
        r"""Sets the alert_rule_name of this ShowAlertRuleResponse.

        Alert rule name 告警规则名称

        :param alert_rule_name: The alert_rule_name of this ShowAlertRuleResponse.
        :type alert_rule_name: str
        """
    ...
    @property
    def script(self):
        r"""Gets the script of this ShowAlertRuleResponse.

        Job Script 作业脚本

        :return: The script of this ShowAlertRuleResponse.
        :rtype: str
        """
        return self._script
    ...
    def script(self, script):
        r"""Sets the script of this ShowAlertRuleResponse.

        Job Script 作业脚本

        :param script: The script of this ShowAlertRuleResponse.
        :type script: str
        """
        self._script = script
    ...
    @property
    def directory(self):
        r"""Gets the directory of this ShowAlertRuleResponse.

        directory 目录分组

        :return: The directory of this ShowAlertRuleResponse.
        :rtype: str
        """
    ...
    def directory(self, directory):
        r"""Sets the directory of this ShowAlertRuleResponse.

        directory 目录分组

        :param directory: The directory of this ShowAlertRuleResponse.
        :type directory: str
        """
    ...
    def description(self):
        r"""Gets the description of this ShowAlertRuleResponse.

        Alert rule description 告警规则描述

        :return: The description of this ShowAlertRuleResponse.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this ShowAlertRuleResponse.

        Alert rule description 告警规则描述

        :param description: The description of this ShowAlertRuleResponse.
        :type description: str
        """
    ...
    @property
    def job_mode(self):
        r"""Gets the job_mode of this ShowAlertRuleResponse.

        :return: The job_mode of this ShowAlertRuleResponse.
    ...
    def job_mode(self, job_mode):
        r"""Sets the job_mode of this ShowAlertRuleResponse.

        :param job_mode: The job_mode of this ShowAlertRuleResponse.
        :type job_mode: :class:`huaweicloudsdksecmaster.v2.IsapJobMode`
        """
    ...
    def job_mode_setting(self):
        r"""Gets the job_mode_setting of this ShowAlertRuleResponse.

        :return: The job_mode_setting of this ShowAlertRuleResponse.
    ...
    def job_mode_setting(self, job_mode_setting):
        r"""Sets the job_mode_setting of this ShowAlertRuleResponse.

        :param job_mode_setting: The job_mode_setting of this ShowAlertRuleResponse.
        :type job_mode_setting: :class:`huaweicloudsdksecmaster.v2.IsapJobModeSettingVo`
        """
    ...
    def job_output_setting(self):
        r"""Gets the job_output_setting of this ShowAlertRuleResponse.

        :return: The job_output_setting of this ShowAlertRuleResponse.
    ...
    def job_output_setting(self, job_output_setting):
        r"""Sets the job_output_setting of this ShowAlertRuleResponse.

        :param job_output_setting: The job_output_setting of this ShowAlertRuleResponse.
        :type job_output_setting: :class:`huaweicloudsdksecmaster.v2.AlertRuleJobSetting`
        """
    ...
    def process_status(self):
        r"""Gets the process_status of this ShowAlertRuleResponse.

        :return: The process_status of this ShowAlertRuleResponse.
    ...
    def process_status(self, process_status):
        r"""Sets the process_status of this ShowAlertRuleResponse.

        :param process_status: The process_status of this ShowAlertRuleResponse.
        :type process_status: :class:`huaweicloudsdksecmaster.v2.JobProcessStatus`
        """
    ...
    def process_error(self):
        r"""Gets the process_error of this ShowAlertRuleResponse.

        :return: The process_error of this ShowAlertRuleResponse.
    ...
    def process_error(self, process_error):
        r"""Sets the process_error of this ShowAlertRuleResponse.

        :param process_error: The process_error of this ShowAlertRuleResponse.
        :type process_error: :class:`huaweicloudsdksecmaster.v2.AlertRuleProcessError`
        """
    ...
    def environment(self):
        r"""Gets the environment of this ShowAlertRuleResponse.

        :return: The environment of this ShowAlertRuleResponse.
    ...
    def environment(self, environment):
        r"""Sets the environment of this ShowAlertRuleResponse.

        :param environment: The environment of this ShowAlertRuleResponse.
        :type environment: :class:`huaweicloudsdksecmaster.v2.JobEnvironment`
        """
    ...
    def output_table_id(self):
        r"""Gets the output_table_id of this ShowAlertRuleResponse.

        UUID

        :return: The output_table_id of this ShowAlertRuleResponse.
        :rtype: str
        """
    ...
    def output_table_id(self, output_table_id):
        r"""Sets the output_table_id of this ShowAlertRuleResponse.

        UUID

        :param output_table_id: The output_table_id of this ShowAlertRuleResponse.
        :type output_table_id: str
        """
    ...
    def output_table_name(self):
        r"""Gets the output_table_name of this ShowAlertRuleResponse.

        表名称

        :return: The output_table_name of this ShowAlertRuleResponse.
        :rtype: str
        """
    ...
    def output_table_name(self, output_table_name):
        r"""Sets the output_table_name of this ShowAlertRuleResponse.

        表名称

        :param output_table_name: The output_table_name of this ShowAlertRuleResponse.
        :type output_table_name: str
        """
    ...
    def output_table_ids(self):
        r"""Gets the output_table_ids of this ShowAlertRuleResponse.

        输出表ID列表

        :return: The output_table_ids of this ShowAlertRuleResponse.
        :rtype: list[str]
        """
    ...
    def output_table_ids(self, output_table_ids):
        r"""Sets the output_table_ids of this ShowAlertRuleResponse.

        输出表ID列表

        :param output_table_ids: The output_table_ids of this ShowAlertRuleResponse.
        :type output_table_ids: list[str]
        """
    ...
    def output_table_names(self):
        r"""Gets the output_table_names of this ShowAlertRuleResponse.

        输出表名称列表

        :return: The output_table_names of this ShowAlertRuleResponse.
        :rtype: list[str]
        """
    ...
    def output_table_names(self, output_table_names):
        r"""Sets the output_table_names of this ShowAlertRuleResponse.

        输出表名称列表

        :param output_table_names: The output_table_names of this ShowAlertRuleResponse.
        :type output_table_names: list[str]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowAlertRuleResponse.to_dict() is deprecated and no longer maintained, "
