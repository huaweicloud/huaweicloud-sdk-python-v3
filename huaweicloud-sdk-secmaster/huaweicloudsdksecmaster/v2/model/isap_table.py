...
class IsapTable:
    ...
    @property
    def project_id(self):
        r"""Gets the project_id of this IsapTable.

        项目ID

        :return: The project_id of this IsapTable.
        :rtype: str
        """
    ...
    def project_id(self, project_id):
        r"""Sets the project_id of this IsapTable.

        项目ID

        :param project_id: The project_id of this IsapTable.
        :type project_id: str
        """
    ...
    def workspace_id(self):
        r"""Gets the workspace_id of this IsapTable.

        工作空间ID

        :return: The workspace_id of this IsapTable.
        :rtype: str
        """
    ...
    def workspace_id(self, workspace_id):
        r"""Sets the workspace_id of this IsapTable.

        工作空间ID

        :param workspace_id: The workspace_id of this IsapTable.
        :type workspace_id: str
        """
    ...
    @property
    def table_id(self):
        r"""Gets the table_id of this IsapTable.

        UUID

        :return: The table_id of this IsapTable.
        :rtype: str
        """
    ...
    def table_id(self, table_id):
        r"""Sets the table_id of this IsapTable.

        UUID

        :param table_id: The table_id of this IsapTable.
        :type table_id: str
        """
    ...
    @property
    def pipe_id(self):
        r"""Gets the pipe_id of this IsapTable.

        UUID

        :return: The pipe_id of this IsapTable.
        :rtype: str
        """
    ...
    def pipe_id(self, pipe_id):
        r"""Sets the pipe_id of this IsapTable.

        UUID

        :param pipe_id: The pipe_id of this IsapTable.
        :type pipe_id: str
        """
    ...
    @property
    def table_name(self):
        r"""Gets the table_name of this IsapTable.

        表名称

        :return: The table_name of this IsapTable.
        :rtype: str
        """
    ...
    def table_name(self, table_name):
        r"""Sets the table_name of this IsapTable.

        表名称

        :param table_name: The table_name of this IsapTable.
        :type table_name: str
        """
    ...
    def table_alias(self):
        r"""Gets the table_alias of this IsapTable.

        表别名

        :return: The table_alias of this IsapTable.
        :rtype: str
        """
    ...
    def table_alias(self, table_alias):
        r"""Sets the table_alias of this IsapTable.

        表别名

        :param table_alias: The table_alias of this IsapTable.
        :type table_alias: str
        """
    ...
    def description(self):
        r"""Gets the description of this IsapTable.

        相关描述

        :return: The description of this IsapTable.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this IsapTable.

        相关描述

        :param description: The description of this IsapTable.
        :type description: str
        """
    ...
    @property
    def directory(self):
        r"""Gets the directory of this IsapTable.

        directory 目录分组

        :return: The directory of this IsapTable.
        :rtype: str
        """
    ...
    def directory(self, directory):
        r"""Sets the directory of this IsapTable.

        directory 目录分组

        :param directory: The directory of this IsapTable.
        :type directory: str
        """
    ...
    @property
    def category(self):
        r"""Gets the category of this IsapTable.
        ...
        **参数解释**: 目录类型 - STREAMING 实时流 - INDEX 索引 - APPLICATION 应用 - TENANT_BUCKET 租户桶 - LAKE 数据湖  **约束限制** 不涉及 **取值范围**: - STREAMING - INDEX - APPLICATION - TENANT_BUCKET - LAKE  **默认值** 不涉及     
        ...
        :return: The category of this IsapTable.
        :rtype: str
        """
    ...
    def category(self, category):
        r"""Sets the category of this IsapTable.

        **参数解释**: 目录类型 - STREAMING 实时流 - INDEX 索引 - APPLICATION 应用 - TENANT_BUCKET 租户桶 - LAKE 数据湖  **约束限制** 不涉及 **取值范围**: - STREAMING - INDEX - APPLICATION - TENANT_BUCKET - LAKE  **默认值** 不涉及     

        :param category: The category of this IsapTable.
        :type category: str
        """
    ...
    def lock_status(self):
        r"""Gets the lock_status of this IsapTable.

        **参数解释**: 表锁状态 - LOCKED 已锁 - UNLOCKED 未锁  **约束限制** 不涉及 **取值范围**: - LOCKED - UNLOCKED  **默认值** 不涉及      

        :return: The lock_status of this IsapTable.
        :rtype: str
        """
    ...
    def lock_status(self, lock_status):
        r"""Sets the lock_status of this IsapTable.

        **参数解释**: 表锁状态 - LOCKED 已锁 - UNLOCKED 未锁  **约束限制** 不涉及 **取值范围**: - LOCKED - UNLOCKED  **默认值** 不涉及      

        :param lock_status: The lock_status of this IsapTable.
        :type lock_status: str
        """
    ...
    def process_status(self):
        r"""Gets the process_status of this IsapTable.

        **参数解释**: 处理状态 - COMPLETED 已完成 - CREATING 创建中 - UPDATING 更新中 - DELETING 删除中 - TRUNCATING 清空中 - UPGRADING   升级中       - CREATE_FAILED 创建失败 - UPDATE_FAILED 更新失败 - DELETE_FAILED 删除失败 - TRUNCATE_FAILED 清空失败 - UPGRADE_FAILED 升级失败        **约束限制** 不涉及 **取值范围**: - COMPLETED - CREATING - UPDATING - DELETING - TRUNCATING - UPGRADING       - CREATE_FAILED - UPDATE_FAILED - DELETE_FAILED - TRUNCATE_FAILED - UPGRADE_FAILED  **默认值** 不涉及    

        :return: The process_status of this IsapTable.
        :rtype: str
        """
    ...
    def process_status(self, process_status):
        r"""Sets the process_status of this IsapTable.

        **参数解释**: 处理状态 - COMPLETED 已完成 - CREATING 创建中 - UPDATING 更新中 - DELETING 删除中 - TRUNCATING 清空中 - UPGRADING   升级中       - CREATE_FAILED 创建失败 - UPDATE_FAILED 更新失败 - DELETE_FAILED 删除失败 - TRUNCATE_FAILED 清空失败 - UPGRADE_FAILED 升级失败        **约束限制** 不涉及 **取值范围**: - COMPLETED - CREATING - UPDATING - DELETING - TRUNCATING - UPGRADING       - CREATE_FAILED - UPDATE_FAILED - DELETE_FAILED - TRUNCATE_FAILED - UPGRADE_FAILED  **默认值** 不涉及    

        :param process_status: The process_status of this IsapTable.
        :type process_status: str
        """
    ...
    def process_error(self):
        r"""Gets the process_error of this IsapTable.
        ...
        **参数解释**: 表处理错误 - NONE 无 - MISSING_ASSOCIATIONS 关联缺失 - FAILED_INIT_STORAGE_RESOURCES_WHEN_CREATING 创建时初始化存储资源失败 - FAILED_INIT_FLINK_RESOURCES_WHEN_CREATING 创建时初始化 Flink 资源失败 - FAILED_DELETE_FLINK_RESOURCES_WHEN_DELETING 删除时删除 Flink 资源失败 - FAILED_DELETE_STORAGE_RESOURCES_WHEN_DELETING 删除时删除存储资源失败 - FAILED_DELETE_ALL_RESOURCES_WHEN_DELETING 删除时删除所有资源失败 - FAILED_UPDATE_STORAGE_SETTING 更新存储配置失败 - FAILED_UPDATE_FLINK_SCHEMA 更新 Flink 模式失败 - FAILED_UPDATE_STORAGE_SCHEMA 更新存储模式失败 - FAILED_TO_APPLY_RESOURCE 应用资源失败 - FAILED_TO_UPGRADE_RESOURCE_MODEL 升级资源模型失败  **约束限制** 不涉及 **取值范围**: - NONE - MISSING_ASSOCIATIONS - FAILED_INIT_STORAGE_RESOURCES_WHEN_CREATING - FAILED_INIT_FLINK_RESOURCES_WHEN_CREATING - FAILED_DELETE_FLINK_RESOURCES_WHEN_DELETING - FAILED_DELETE_STORAGE_RESOURCES_WHEN_DELETING - FAILED_DELETE_ALL_RESOURCES_WHEN_DELETING - FAILED_UPDATE_STORAGE_SETTING - FAILED_UPDATE_FLINK_SCHEMA - FAILED_UPDATE_STORAGE_SCHEMA - FAILED_TO_APPLY_RESOURCE - FAILED_TO_UPGRADE_RESOURCE_MODEL  **默认值** 不涉及 
        ...
        :return: The process_error of this IsapTable.
        :rtype: str
        """
    ...
    def process_error(self, process_error):
        r"""Sets the process_error of this IsapTable.

        **参数解释**: 表处理错误 - NONE 无 - MISSING_ASSOCIATIONS 关联缺失 - FAILED_INIT_STORAGE_RESOURCES_WHEN_CREATING 创建时初始化存储资源失败 - FAILED_INIT_FLINK_RESOURCES_WHEN_CREATING 创建时初始化 Flink 资源失败 - FAILED_DELETE_FLINK_RESOURCES_WHEN_DELETING 删除时删除 Flink 资源失败 - FAILED_DELETE_STORAGE_RESOURCES_WHEN_DELETING 删除时删除存储资源失败 - FAILED_DELETE_ALL_RESOURCES_WHEN_DELETING 删除时删除所有资源失败 - FAILED_UPDATE_STORAGE_SETTING 更新存储配置失败 - FAILED_UPDATE_FLINK_SCHEMA 更新 Flink 模式失败 - FAILED_UPDATE_STORAGE_SCHEMA 更新存储模式失败 - FAILED_TO_APPLY_RESOURCE 应用资源失败 - FAILED_TO_UPGRADE_RESOURCE_MODEL 升级资源模型失败  **约束限制** 不涉及 **取值范围**: - NONE - MISSING_ASSOCIATIONS - FAILED_INIT_STORAGE_RESOURCES_WHEN_CREATING - FAILED_INIT_FLINK_RESOURCES_WHEN_CREATING - FAILED_DELETE_FLINK_RESOURCES_WHEN_DELETING - FAILED_DELETE_STORAGE_RESOURCES_WHEN_DELETING - FAILED_DELETE_ALL_RESOURCES_WHEN_DELETING - FAILED_UPDATE_STORAGE_SETTING - FAILED_UPDATE_FLINK_SCHEMA - FAILED_UPDATE_STORAGE_SCHEMA - FAILED_TO_APPLY_RESOURCE - FAILED_TO_UPGRADE_RESOURCE_MODEL  **默认值** 不涉及 

        :param process_error: The process_error of this IsapTable.
        :type process_error: str
        """
    ...
    @property
    def format(self):
        r"""Gets the format of this IsapTable.
        ...
        **参数解释**: 表格式 - JSON Json格式 - DEBEZIUM_JSON Debezium JSON 格式 - CSV CSV格式 - PARQUET PARQUET格式 - ORC ORC格式  **约束限制** 不涉及 **取值范围**: - JSON - DEBEZIUM_JSON - CSV - PARQUET - ORC  **默认值** 不涉及  
        ...
        :return: The format of this IsapTable.
        :rtype: str
        """
        return self._format
    ...
    def format(self, format):
        r"""Sets the format of this IsapTable.

        **参数解释**: 表格式 - JSON Json格式 - DEBEZIUM_JSON Debezium JSON 格式 - CSV CSV格式 - PARQUET PARQUET格式 - ORC ORC格式  **约束限制** 不涉及 **取值范围**: - JSON - DEBEZIUM_JSON - CSV - PARQUET - ORC  **默认值** 不涉及  

        :param format: The format of this IsapTable.
        :type format: str
        """
        self._format = format
    ...
    def rw_type(self, rw_type):
        r"""Sets the rw_type of this IsapTable.

        **参数解释**: 表读写类型 - READ_ONLY 只读 - READ_WRITE 读写 - WRITE_ONLY 只写  **约束限制** 不涉及 **取值范围**: - READ_ONLY - READ_WRITE - WRITE_ONLY  **默认值** 不涉及       

        :param rw_type: The rw_type of this IsapTable.
        :type rw_type: str
        """
    ...
    @property
    def owner_type(self):
        r"""Gets the owner_type of this IsapTable.
        ...
        **参数解释**: 拥有者类型 - SYSTEM 系统 - USER 用户 - SYSTEM_ALLOWED_DELETE 系统可删除 - USER_ALLOWED_DELETE 用户可删除  **约束限制** 不涉及 **取值范围**: - SYSTEM - USER - SYSTEM_ALLOWED_DELETE - USER_ALLOWED_DELETE  **默认值** 不涉及         
        ...
        :return: The owner_type of this IsapTable.
        :rtype: str
        """
    ...
    def owner_type(self, owner_type):
        r"""Sets the owner_type of this IsapTable.

        **参数解释**: 拥有者类型 - SYSTEM 系统 - USER 用户 - SYSTEM_ALLOWED_DELETE 系统可删除 - USER_ALLOWED_DELETE 用户可删除  **约束限制** 不涉及 **取值范围**: - SYSTEM - USER - SYSTEM_ALLOWED_DELETE - USER_ALLOWED_DELETE  **默认值** 不涉及         

        :param owner_type: The owner_type of this IsapTable.
        :type owner_type: str
        """
    ...
    def data_layering(self):
        r"""Gets the data_layering of this IsapTable.

        **参数解释**: 数据分层 - ODS 操作数据存储层 - DWS 数据汇总层 - ADS 应用数据服务层  **约束限制** 不涉及 **取值范围**: - ODS - DWS - ADS  **默认值** 不涉及     

        :return: The data_layering of this IsapTable.
        :rtype: str
        """
    ...
    def data_layering(self, data_layering):
        r"""Sets the data_layering of this IsapTable.

        **参数解释**: 数据分层 - ODS 操作数据存储层 - DWS 数据汇总层 - ADS 应用数据服务层  **约束限制** 不涉及 **取值范围**: - ODS - DWS - ADS  **默认值** 不涉及     

        :param data_layering: The data_layering of this IsapTable.
        :type data_layering: str
        """
    ...
    def data_classification(self, data_classification):
        r"""Sets the data_classification of this IsapTable.

        **参数解释**: 数据分类 - FACTUAL_DATA 事实数据 - DIMENSION_DATA 维度数据  **约束限制** 不涉及 **取值范围**: - FACTUAL_DATA - DIMENSION_DATA  **默认值** 不涉及      

        :param data_classification: The data_classification of this IsapTable.
        :type data_classification: str
        """
    ...
    @property
    def schema(self):
        r"""Gets the schema of this IsapTable.

        :return: The schema of this IsapTable.
    ...
    def schema(self, schema):
        r"""Sets the schema of this IsapTable.

        :param schema: The schema of this IsapTable.
        :type schema: :class:`huaweicloudsdksecmaster.v2.IsapTableSchema`
        """
        self._schema = schema
    ...
    def storage_setting(self):
        r"""Gets the storage_setting of this IsapTable.

        :return: The storage_setting of this IsapTable.
    ...
    def storage_setting(self, storage_setting):
        r"""Sets the storage_setting of this IsapTable.

        :param storage_setting: The storage_setting of this IsapTable.
        :type storage_setting: :class:`huaweicloudsdksecmaster.v2.TableStorageSetting`
        """
    ...
    def display_setting(self):
        r"""Gets the display_setting of this IsapTable.

        :return: The display_setting of this IsapTable.
    ...
    def display_setting(self, display_setting):
        r"""Sets the display_setting of this IsapTable.

        :param display_setting: The display_setting of this IsapTable.
        :type display_setting: :class:`huaweicloudsdksecmaster.v2.TableDisplaySetting`
        """
    ...
    def create_time(self):
        r"""Gets the create_time of this IsapTable.

        毫秒时间戳

        :return: The create_time of this IsapTable.
        :rtype: int
        """
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this IsapTable.

        毫秒时间戳

        :param create_time: The create_time of this IsapTable.
        :type create_time: int
        """
    ...
    def update_time(self):
        r"""Gets the update_time of this IsapTable.

        毫秒时间戳

        :return: The update_time of this IsapTable.
        :rtype: int
        """
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this IsapTable.

        毫秒时间戳

        :param update_time: The update_time of this IsapTable.
        :type update_time: int
        """
    ...
    def delete_time(self):
        r"""Gets the delete_time of this IsapTable.

        毫秒时间戳

        :return: The delete_time of this IsapTable.
        :rtype: int
        """
    ...
    def delete_time(self, delete_time):
        r"""Sets the delete_time of this IsapTable.

        毫秒时间戳

        :param delete_time: The delete_time of this IsapTable.
        :type delete_time: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IsapTable):
            return False
