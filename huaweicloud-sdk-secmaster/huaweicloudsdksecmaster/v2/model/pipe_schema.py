...
class PipeSchema:
    ...
    @property
    def columns(self):
        r"""Gets the columns of this PipeSchema.

        管道列

        :return: The columns of this PipeSchema.
    ...
    def columns(self, columns):
        r"""Sets the columns of this PipeSchema.

        管道列

        :param columns: The columns of this PipeSchema.
        :type columns: list[:class:`huaweicloudsdksecmaster.v2.TableColumnForIsapPipe`]
        """
    ...
    def watermark_column(self):
        r"""Gets the watermark_column of this PipeSchema.

        管道水线列

        :return: The watermark_column of this PipeSchema.
        :rtype: str
        """
    ...
    def watermark_column(self, watermark_column):
        r"""Sets the watermark_column of this PipeSchema.

        管道水线列

        :param watermark_column: The watermark_column of this PipeSchema.
        :type watermark_column: str
        """
    ...
    def watermark_interval(self):
        r"""Gets the watermark_interval of this PipeSchema.

        管道水线间隔时长

        :return: The watermark_interval of this PipeSchema.
        :rtype: float
        """
    ...
    def watermark_interval(self, watermark_interval):
        r"""Sets the watermark_interval of this PipeSchema.

        管道水线间隔时长

        :param watermark_interval: The watermark_interval of this PipeSchema.
        :type watermark_interval: float
        """
    ...
    def time_filter(self):
        r"""Gets the time_filter of this PipeSchema.

        管道过滤列

        :return: The time_filter of this PipeSchema.
        :rtype: str
        """
    ...
    def time_filter(self, time_filter):
        r"""Sets the time_filter of this PipeSchema.

        管道过滤列

        :param time_filter: The time_filter of this PipeSchema.
        :type time_filter: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PipeSchema):
            return False
