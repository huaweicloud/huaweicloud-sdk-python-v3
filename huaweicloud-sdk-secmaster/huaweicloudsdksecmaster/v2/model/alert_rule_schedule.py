...
class AlertRuleSchedule:
    ...
    def delay_interval(self):
        r"""Gets the delay_interval of this AlertRuleSchedule.

        整型时长

        :return: The delay_interval of this AlertRuleSchedule.
        :rtype: int
        """
    ...
    def delay_interval(self, delay_interval):
        r"""Sets the delay_interval of this AlertRuleSchedule.

        整型时长

        :param delay_interval: The delay_interval of this AlertRuleSchedule.
        :type delay_interval: int
        """
    ...
    def frequency_interval(self):
        r"""Gets the frequency_interval of this AlertRuleSchedule.

        整型时长

        :return: The frequency_interval of this AlertRuleSchedule.
        :rtype: int
        """
    ...
    def frequency_interval(self, frequency_interval):
        r"""Sets the frequency_interval of this AlertRuleSchedule.

        整型时长

        :param frequency_interval: The frequency_interval of this AlertRuleSchedule.
        :type frequency_interval: int
        """
    ...
    def overtime_interval(self):
        r"""Gets the overtime_interval of this AlertRuleSchedule.

        整型时长

        :return: The overtime_interval of this AlertRuleSchedule.
        :rtype: int
        """
    ...
    def overtime_interval(self, overtime_interval):
        r"""Sets the overtime_interval of this AlertRuleSchedule.

        整型时长

        :param overtime_interval: The overtime_interval of this AlertRuleSchedule.
        :type overtime_interval: int
        """
    ...
    def period_interval(self):
        r"""Gets the period_interval of this AlertRuleSchedule.

        整型时长

        :return: The period_interval of this AlertRuleSchedule.
        :rtype: int
        """
    ...
    def period_interval(self, period_interval):
        r"""Sets the period_interval of this AlertRuleSchedule.

        整型时长

        :param period_interval: The period_interval of this AlertRuleSchedule.
        :type period_interval: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AlertRuleSchedule):
            return False
