...
class IsapTableColumn:
    ...
    def __init__(self, column_name=None, column_type=None, column_type_setting=None, column_data_type=None, column_data_type_setting=None, nullable=None, array=None, depth=None, parent_name=None, own_name=None, column_display_setting=None, column_sequence_number=None):
        r"""IsapTableColumn
    ...
    def column_name(self):
        r"""Gets the column_name of this IsapTableColumn.

        表格列名称

        :return: The column_name of this IsapTableColumn.
        :rtype: str
        """
    ...
    def column_name(self, column_name):
        r"""Sets the column_name of this IsapTableColumn.

        表格列名称

        :param column_name: The column_name of this IsapTableColumn.
        :type column_name: str
        """
    ...
    def column_type(self):
        r"""Gets the column_type of this IsapTableColumn.
        ...
        **参数解释**: 列字段类型 - PHYSICAL 物理字段 - METADATA 元数据字段 - VIRTUAL_METADATA 虚拟元数据字段 - COMPUTED 计算字段  **约束限制** 不涉及  **取值范围**: - PHYSICAL - METADATA - VIRTUAL_METADATA - COMPUTED  **默认值** 不涉及
        ...
        :return: The column_type of this IsapTableColumn.
        :rtype: str
        """
    ...
    def column_type(self, column_type):
        r"""Sets the column_type of this IsapTableColumn.

        **参数解释**: 列字段类型 - PHYSICAL 物理字段 - METADATA 元数据字段 - VIRTUAL_METADATA 虚拟元数据字段 - COMPUTED 计算字段  **约束限制** 不涉及  **取值范围**: - PHYSICAL - METADATA - VIRTUAL_METADATA - COMPUTED  **默认值** 不涉及

        :param column_type: The column_type of this IsapTableColumn.
        :type column_type: str
        """
    ...
    def column_type_setting(self):
        r"""Gets the column_type_setting of this IsapTableColumn.

        表格列类型设置

        :return: The column_type_setting of this IsapTableColumn.
        :rtype: str
        """
    ...
    def column_type_setting(self, column_type_setting):
        r"""Sets the column_type_setting of this IsapTableColumn.

        表格列类型设置

        :param column_type_setting: The column_type_setting of this IsapTableColumn.
        :type column_type_setting: str
        """
    ...
    def column_data_type(self):
        r"""Gets the column_data_type of this IsapTableColumn.

        **参数解释**: 列字段数据类型 - ROW 行类型 - MAP_STRING 字符串映射类型 - MAP_DECIMAL 小数映射类型 - TINYINT 微整型 - SMALLINT 小整型 - INT 整型 - BIGINT 长整型 - DECIMAL 精确小数类型 - FLOAT 单精度浮点数 - DOUBLE 双精度浮点数 - CHAR 定长字符串 - VARCHAR 不定长字符串 - STRING 字符串类型 - KEYWORD 关键字类型 - BOOLEAN 布尔类型 - DATE 日期类型 - TIME 时间类型 - TIMESTAMP 时间戳类型 - TIMESTAMP_LTZ 本地时间戳类型  **约束限制** 不涉及  **取值范围**: - ROW - MAP_STRING - MAP_DECIMAL - TINYINT - SMALLINT - INT - BIGINT - DECIMAL - FLOAT - DOUBLE - CHAR - VARCHAR - STRING - KEYWORD - BOOLEAN - DATE - TIME - TIMESTAMP - TIMESTAMP_LTZ  **默认值** 不涉及    

        :return: The column_data_type of this IsapTableColumn.
        :rtype: str
        """
    ...
    def column_data_type(self, column_data_type):
        r"""Sets the column_data_type of this IsapTableColumn.

        **参数解释**: 列字段数据类型 - ROW 行类型 - MAP_STRING 字符串映射类型 - MAP_DECIMAL 小数映射类型 - TINYINT 微整型 - SMALLINT 小整型 - INT 整型 - BIGINT 长整型 - DECIMAL 精确小数类型 - FLOAT 单精度浮点数 - DOUBLE 双精度浮点数 - CHAR 定长字符串 - VARCHAR 不定长字符串 - STRING 字符串类型 - KEYWORD 关键字类型 - BOOLEAN 布尔类型 - DATE 日期类型 - TIME 时间类型 - TIMESTAMP 时间戳类型 - TIMESTAMP_LTZ 本地时间戳类型  **约束限制** 不涉及  **取值范围**: - ROW - MAP_STRING - MAP_DECIMAL - TINYINT - SMALLINT - INT - BIGINT - DECIMAL - FLOAT - DOUBLE - CHAR - VARCHAR - STRING - KEYWORD - BOOLEAN - DATE - TIME - TIMESTAMP - TIMESTAMP_LTZ  **默认值** 不涉及    

        :param column_data_type: The column_data_type of this IsapTableColumn.
        :type column_data_type: str
        """
    ...
    def column_data_type_setting(self):
        r"""Gets the column_data_type_setting of this IsapTableColumn.

        表格列数据类型设置

        :return: The column_data_type_setting of this IsapTableColumn.
        :rtype: str
        """
    ...
    def column_data_type_setting(self, column_data_type_setting):
        r"""Sets the column_data_type_setting of this IsapTableColumn.

        表格列数据类型设置

        :param column_data_type_setting: The column_data_type_setting of this IsapTableColumn.
        :type column_data_type_setting: str
        """
    ...
    @property
    def nullable(self):
        r"""Gets the nullable of this IsapTableColumn.

        是否为空

        :return: The nullable of this IsapTableColumn.
        :rtype: bool
        """
    ...
    def nullable(self, nullable):
        r"""Sets the nullable of this IsapTableColumn.

        是否为空

        :param nullable: The nullable of this IsapTableColumn.
        :type nullable: bool
        """
    ...
    @property
    def array(self):
        r"""Gets the array of this IsapTableColumn.

        是否为数组

        :return: The array of this IsapTableColumn.
        :rtype: bool
        """
        return self._array
    ...
    def array(self, array):
        r"""Sets the array of this IsapTableColumn.

        是否为数组

        :param array: The array of this IsapTableColumn.
        :type array: bool
        """
        self._array = array
    ...
    @property
    def depth(self):
        r"""Gets the depth of this IsapTableColumn.

        深度

        :return: The depth of this IsapTableColumn.
        :rtype: int
        """
        return self._depth
    ...
    def depth(self, depth):
        r"""Sets the depth of this IsapTableColumn.

        深度

        :param depth: The depth of this IsapTableColumn.
        :type depth: int
        """
        self._depth = depth
    ...
    def parent_name(self):
        r"""Gets the parent_name of this IsapTableColumn.

        父级名称

        :return: The parent_name of this IsapTableColumn.
        :rtype: str
        """
    ...
    def parent_name(self, parent_name):
        r"""Sets the parent_name of this IsapTableColumn.

        父级名称

        :param parent_name: The parent_name of this IsapTableColumn.
        :type parent_name: str
        """
    ...
    @property
    def own_name(self):
        r"""Gets the own_name of this IsapTableColumn.

        所属名称

        :return: The own_name of this IsapTableColumn.
        :rtype: str
        """
    ...
    def own_name(self, own_name):
        r"""Sets the own_name of this IsapTableColumn.

        所属名称

        :param own_name: The own_name of this IsapTableColumn.
        :type own_name: str
        """
    ...
    def column_display_setting(self):
        r"""Gets the column_display_setting of this IsapTableColumn.

        :return: The column_display_setting of this IsapTableColumn.
    ...
    def column_display_setting(self, column_display_setting):
        r"""Sets the column_display_setting of this IsapTableColumn.

        :param column_display_setting: The column_display_setting of this IsapTableColumn.
        :type column_display_setting: :class:`huaweicloudsdksecmaster.v2.ColumnDisplaySetting`
        """
    ...
    def column_sequence_number(self):
        r"""Gets the column_sequence_number of this IsapTableColumn.

        列序号

        :return: The column_sequence_number of this IsapTableColumn.
        :rtype: int
        """
    ...
    def column_sequence_number(self, column_sequence_number):
        r"""Sets the column_sequence_number of this IsapTableColumn.

        列序号

        :param column_sequence_number: The column_sequence_number of this IsapTableColumn.
        :type column_sequence_number: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IsapTableColumn):
            return False
