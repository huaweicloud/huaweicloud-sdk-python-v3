...
class ListCollectConfigResponseBodyDatasets:
    ...
    def __init__(self, account_all_num=None, account_successful_num=None, accounts=None, alert=None, all_accounts=None, allow_alert=None, dataspace_id=None, dataspace_name=None, enable=None, last_active_time=None, limit=None, new_account_auto_access=None, process_status=None, reference=None, region_id=None, sink_msg=None, source_id=None, source_name=None, target=None, type=None, workspace_id=None):
        ...
        :param accounts: 账号列表
        :type accounts: list[:class:`huaweicloudsdksecmaster.v2.ListCollectConfigResponseBodyAccounts`]
        :param alert: 自动转告警开关
        :type alert: bool
        ...
        :param reference: 
        :type reference: :class:`huaweicloudsdksecmaster.v2.ListCollectConfigResponseBodyReference`
        ...
        :param target: 
        :type target: :class:`huaweicloudsdksecmaster.v2.ListCollectConfigResponseBodyTarget`
        :param type: 类型
        :type type: str
    ...
    def accounts(self):
        ...
        :rtype: list[:class:`huaweicloudsdksecmaster.v2.ListCollectConfigResponseBodyAccounts`]
        """
    ...
    def reference(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v2.ListCollectConfigResponseBodyReference`
        """
    ...
    def target(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v2.ListCollectConfigResponseBodyTarget`
        """
        return self._target
