...
class ShowPlaybookMonitorsResponse(SdkResponse):
    ...
    def data(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v2.PlaybookInstanceMonitorDetail`
        """
        return self._data
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowPlaybookMonitorsResponse.to_dict() is deprecated and no longer maintained, "
