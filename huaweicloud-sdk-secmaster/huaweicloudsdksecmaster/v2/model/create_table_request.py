...
class CreateTableRequest:
    ...
    def __init__(self, project_id=None, workspace_id=None, body=None):
        ...
        :type body: :class:`huaweicloudsdksecmaster.v2.CreateTableRequestBody`
        """
    ...
    def project_id(self, project_id):
        r"""Sets the project_id of this CreateTableRequest.

        **参数解释：** 项目ID，用于明确项目归属，配置后可通过该ID查询项目下资产，可以通过调用API获取，也可以从控制台获取。[获取项目ID](secmaster_03_0014.xml) **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :param project_id: The project_id of this CreateTableRequest.
        :type project_id: str
        """
    ...
    def workspace_id(self):
        r"""Gets the workspace_id of this CreateTableRequest.

        工作空间ID

        :return: The workspace_id of this CreateTableRequest.
        :rtype: str
        """
    ...
    def workspace_id(self, workspace_id):
        r"""Sets the workspace_id of this CreateTableRequest.

        工作空间ID

        :param workspace_id: The workspace_id of this CreateTableRequest.
        :type workspace_id: str
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v2.CreateTableRequestBody`
        """
        return self._body
