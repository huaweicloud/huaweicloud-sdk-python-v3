...
class ListAlertRulesResponse(SdkResponse):
    ...
    def __init__(self, count=None, records=None):
        ...
        :type count: int
        :param records: 模型记录
        :type records: list[:class:`huaweicloudsdksecmaster.v2.AlertRuleItem`]
        """
    ...
    def records(self):
        ...
        :rtype: list[:class:`huaweicloudsdksecmaster.v2.AlertRuleItem`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAlertRulesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAlertRulesResponse):
            return False
