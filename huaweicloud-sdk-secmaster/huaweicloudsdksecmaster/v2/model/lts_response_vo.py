...
class LtsResponseVo:
    ...
    def __init__(self, config_id=None, config_name=None, enable=None, log_group_id=None, log_stream_id=None, log_type=None, log_types=None, lts_infos=None, pipe_alias=None, type_prefix=None):
        ...
        :type log_type: str
        :param log_types: 
        :type log_types: :class:`huaweicloudsdksecmaster.v2.LtsResponseVoLogTypes`
        :param lts_infos: lts日志信息map
        :type lts_infos: list[:class:`huaweicloudsdksecmaster.v2.LtsResponseVoLtsInfos`]
    ...
    def log_types(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v2.LtsResponseVoLogTypes`
        """
    ...
    def lts_infos(self):
        ...
        :rtype: list[:class:`huaweicloudsdksecmaster.v2.LtsResponseVoLtsInfos`]
        """
