...
class ListCollectConfigResponseBodyAllVendors:
    ...
    def __init__(self, cloud_vendor=None, csvc_list=None):
        ...
        :type csvc_list: list[:class:`huaweicloudsdksecmaster.v2.ListCollectConfigResponseBodyCsvcList`]
        """
    ...
    def csvc_list(self):
        ...
        :rtype: list[:class:`huaweicloudsdksecmaster.v2.ListCollectConfigResponseBodyCsvcList`]
        """
