...
class AlertRuleJobSetting:
    ...
    def alert_custom_properties(self):
        r"""Gets the alert_custom_properties of this AlertRuleJobSetting.

        映射表

        :return: The alert_custom_properties of this AlertRuleJobSetting.
        :rtype: dict(str, str)
        """
    ...
    def alert_custom_properties(self, alert_custom_properties):
        r"""Sets the alert_custom_properties of this AlertRuleJobSetting.

        映射表

        :param alert_custom_properties: The alert_custom_properties of this AlertRuleJobSetting.
        :type alert_custom_properties: dict(str, str)
        """
    ...
    def alert_description(self):
        r"""Gets the alert_description of this AlertRuleJobSetting.

        告警描述

        :return: The alert_description of this AlertRuleJobSetting.
        :rtype: str
        """
    ...
    def alert_description(self, alert_description):
        r"""Sets the alert_description of this AlertRuleJobSetting.

        告警描述

        :param alert_description: The alert_description of this AlertRuleJobSetting.
        :type alert_description: str
        """
    ...
    def alert_grouping(self):
        r"""Gets the alert_grouping of this AlertRuleJobSetting.

        分组标志

        :return: The alert_grouping of this AlertRuleJobSetting.
        :rtype: bool
        """
    ...
    def alert_grouping(self, alert_grouping):
        r"""Sets the alert_grouping of this AlertRuleJobSetting.

        分组标志

        :param alert_grouping: The alert_grouping of this AlertRuleJobSetting.
        :type alert_grouping: bool
        """
    ...
    def alert_mapping(self):
        r"""Gets the alert_mapping of this AlertRuleJobSetting.

        映射表

        :return: The alert_mapping of this AlertRuleJobSetting.
        :rtype: dict(str, str)
        """
    ...
    def alert_mapping(self, alert_mapping):
        r"""Sets the alert_mapping of this AlertRuleJobSetting.

        映射表

        :param alert_mapping: The alert_mapping of this AlertRuleJobSetting.
        :type alert_mapping: dict(str, str)
        """
    ...
    @property
    def alert_name(self):
        r"""Gets the alert_name of this AlertRuleJobSetting.

        告警报名称

        :return: The alert_name of this AlertRuleJobSetting.
        :rtype: str
        """
    ...
    def alert_name(self, alert_name):
        r"""Sets the alert_name of this AlertRuleJobSetting.

        告警报名称

        :param alert_name: The alert_name of this AlertRuleJobSetting.
        :type alert_name: str
        """
    ...
    def alert_remediation(self):
        r"""Gets the alert_remediation of this AlertRuleJobSetting.

        告警修复建议

        :return: The alert_remediation of this AlertRuleJobSetting.
        :rtype: str
        """
    ...
    def alert_remediation(self, alert_remediation):
        r"""Sets the alert_remediation of this AlertRuleJobSetting.

        告警修复建议

        :param alert_remediation: The alert_remediation of this AlertRuleJobSetting.
        :type alert_remediation: str
        """
    ...
    def alert_severity(self):
        r"""Gets the alert_severity of this AlertRuleJobSetting.

        **参数解释**: 告警等级 - TIPS 提示 - LOW 低危 - MEDIUM 中危 - HIGH 高危 - FATAL 致命  **约束限制** 不涉及 **取值范围**: - TIPS - LOW - MEDIUM - HIGH - FATAL  **默认值** 不涉及  

        :return: The alert_severity of this AlertRuleJobSetting.
        :rtype: str
        """
    ...
    def alert_severity(self, alert_severity):
        r"""Sets the alert_severity of this AlertRuleJobSetting.

        **参数解释**: 告警等级 - TIPS 提示 - LOW 低危 - MEDIUM 中危 - HIGH 高危 - FATAL 致命  **约束限制** 不涉及 **取值范围**: - TIPS - LOW - MEDIUM - HIGH - FATAL  **默认值** 不涉及  

        :param alert_severity: The alert_severity of this AlertRuleJobSetting.
        :type alert_severity: str
        """
    ...
    def alert_suppression(self):
        r"""Gets the alert_suppression of this AlertRuleJobSetting.

        抑制标志

        :return: The alert_suppression of this AlertRuleJobSetting.
        :rtype: bool
        """
    ...
    def alert_suppression(self, alert_suppression):
        r"""Sets the alert_suppression of this AlertRuleJobSetting.

        抑制标志

        :param alert_suppression: The alert_suppression of this AlertRuleJobSetting.
        :type alert_suppression: bool
        """
    ...
    @property
    def alert_type(self):
        r"""Gets the alert_type of this AlertRuleJobSetting.

        告警类型映射表

        :return: The alert_type of this AlertRuleJobSetting.
        :rtype: dict(str, str)
        """
    ...
    def alert_type(self, alert_type):
        r"""Sets the alert_type of this AlertRuleJobSetting.

        告警类型映射表

        :param alert_type: The alert_type of this AlertRuleJobSetting.
        :type alert_type: dict(str, str)
        """
    ...
    def entity_extraction(self):
        r"""Gets the entity_extraction of this AlertRuleJobSetting.

        提取的实体

        :return: The entity_extraction of this AlertRuleJobSetting.
        :rtype: dict(str, str)
        """
    ...
    def entity_extraction(self, entity_extraction):
        r"""Sets the entity_extraction of this AlertRuleJobSetting.

        提取的实体

        :param entity_extraction: The entity_extraction of this AlertRuleJobSetting.
        :type entity_extraction: dict(str, str)
        """
    ...
    def field_mapping(self):
        r"""Gets the field_mapping of this AlertRuleJobSetting.

        字段映射

        :return: The field_mapping of this AlertRuleJobSetting.
        :rtype: dict(str, str)
        """
    ...
    def field_mapping(self, field_mapping):
        r"""Sets the field_mapping of this AlertRuleJobSetting.

        字段映射

        :param field_mapping: The field_mapping of this AlertRuleJobSetting.
        :type field_mapping: dict(str, str)
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AlertRuleJobSetting):
            return False
