...
class ListIncidentsRequest:
    ...
    @property
    def project_id(self):
        r"""Gets the project_id of this ListIncidentsRequest.
    ...
    def project_id(self, project_id):
        r"""Sets the project_id of this ListIncidentsRequest.
    ...
    def workspace_id(self):
        r"""Gets the workspace_id of this ListIncidentsRequest.
    ...
    def workspace_id(self, workspace_id):
        r"""Sets the workspace_id of this ListIncidentsRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this ListIncidentsRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this ListIncidentsRequest.
