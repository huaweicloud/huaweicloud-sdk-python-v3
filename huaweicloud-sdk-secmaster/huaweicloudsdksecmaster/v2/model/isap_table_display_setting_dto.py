...
class IsapTableDisplaySettingDto:
    ...
    openapi_types = {
        'columns': 'list[IsapTableColumnDisplaySettingDto]',
        'format': 'str'
    }
    ...
    @property
    def columns(self):
        r"""Gets the columns of this IsapTableDisplaySettingDto.

        表格列展示列表

        :return: The columns of this IsapTableDisplaySettingDto.
    ...
    def columns(self, columns):
        r"""Sets the columns of this IsapTableDisplaySettingDto.

        表格列展示列表

        :param columns: The columns of this IsapTableDisplaySettingDto.
        :type columns: list[:class:`huaweicloudsdksecmaster.v2.IsapTableColumnDisplaySettingDto`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IsapTableDisplaySettingDto):
            return False
