...
class DisableAlertRuleResponse(SdkResponse):
    ...
    def __init__(self, fail_list=None, success_list=None, x_request_id=None):
        ...
        :param fail_list: 失败列表
        :type fail_list: list[:class:`huaweicloudsdksecmaster.v1.AlertRule`]
        :param success_list: 成功列表
        :type success_list: list[:class:`huaweicloudsdksecmaster.v1.AlertRule`]
        :param x_request_id: 
    ...
    def fail_list(self):
        ...
        :rtype: list[:class:`huaweicloudsdksecmaster.v1.AlertRule`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DisableAlertRuleResponse.to_dict() is deprecated and no longer maintained, "
