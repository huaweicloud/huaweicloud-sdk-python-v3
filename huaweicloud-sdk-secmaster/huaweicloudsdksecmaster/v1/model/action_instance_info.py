...
class ActionInstanceInfo:
    ...
    def __init__(self, action=None, instance_log=None):
        ...
        :param action: 
        :type action: :class:`huaweicloudsdksecmaster.v1.ActionInfo`
        :param instance_log: 
        :type instance_log: :class:`huaweicloudsdksecmaster.v1.AuditLogInfo`
        """
    ...
    def action(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.ActionInfo`
        """
        return self._action
