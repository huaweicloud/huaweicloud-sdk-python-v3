...
class ListReportsRequest:
    ...
    def __init__(self, project_id=None, workspace_id=None, report_period=None, status=None):
    ...
    def workspace_id(self):
        r"""Gets the workspace_id of this ListReportsRequest.

        **参数解释：** 工作空间id。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :return: The workspace_id of this ListReportsRequest.
        :rtype: str
        """
    ...
    def workspace_id(self, workspace_id):
        r"""Sets the workspace_id of this ListReportsRequest.

        **参数解释：** 工作空间id。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :param workspace_id: The workspace_id of this ListReportsRequest.
        :type workspace_id: str
        """
    ...
    def report_period(self):
        r"""Gets the report_period of this ListReportsRequest.

        报告周期

        :return: The report_period of this ListReportsRequest.
        :rtype: str
        """
    ...
    def report_period(self, report_period):
        r"""Sets the report_period of this ListReportsRequest.

        报告周期

        :param report_period: The report_period of this ListReportsRequest.
        :type report_period: str
        """
    ...
    @property
    def status(self):
        r"""Gets the status of this ListReportsRequest.

        状态

        :return: The status of this ListReportsRequest.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        r"""Sets the status of this ListReportsRequest.

        状态

        :param status: The status of this ListReportsRequest.
        :type status: str
        """
        self._status = status
