...
class CheckProductHealthyRequest:
    ...
    def __init__(self, x_language=None, project_id=None, body=None):
        ...
        :type project_id: str
        :param body: Body of the CheckProductHealthyRequest
        :type body: :class:`huaweicloudsdksecmaster.v1.ProductInfo`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.ProductInfo`
        """
        return self._body
