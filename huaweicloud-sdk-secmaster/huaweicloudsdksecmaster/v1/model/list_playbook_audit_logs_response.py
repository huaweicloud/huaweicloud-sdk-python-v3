...
class ListPlaybookAuditLogsResponse(SdkResponse):
    ...
    def __init__(self, count=None, audit_logs=None, x_request_id=None):
        ...
        :type audit_logs: list[:class:`huaweicloudsdksecmaster.v1.AuditLogInfo`]
        :param x_request_id: 
    ...
    def audit_logs(self):
        ...
        :rtype: list[:class:`huaweicloudsdksecmaster.v1.AuditLogInfo`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListPlaybookAuditLogsResponse.to_dict() is deprecated and no longer maintained, "
