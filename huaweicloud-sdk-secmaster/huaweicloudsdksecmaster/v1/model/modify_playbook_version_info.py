...
class ModifyPlaybookVersionInfo:
    ...
    def __init__(self, description=None, workspace_id=None, playbook_id=None, dataclass_id=None, rule_enable=None, enabled=None, status=None, rule_id=None, trigger_type=None, dataobject_create=None, dataobject_update=None, dataobject_delete=None, action_strategy=None, actions=None, rule=None):
        ...
        :param rule: 
        :type rule: :class:`huaweicloudsdksecmaster.v1.ModifyRuleInfo`
        """
    ...
    @property
    def actions(self):
        r"""Gets the actions of this ModifyPlaybookVersionInfo.

        关联流程列表

        :return: The actions of this ModifyPlaybookVersionInfo.
    ...
    def actions(self, actions):
        r"""Sets the actions of this ModifyPlaybookVersionInfo.

        关联流程列表

        :param actions: The actions of this ModifyPlaybookVersionInfo.
        :type actions: list[:class:`huaweicloudsdksecmaster.v1.CreateAction`]
        """
    ...
    @property
    def rule(self):
        r"""Gets the rule of this ModifyPlaybookVersionInfo.

        :return: The rule of this ModifyPlaybookVersionInfo.
        :rtype: :class:`huaweicloudsdksecmaster.v1.ModifyRuleInfo`
        """
        return self._rule

    @rule.setter
    def rule(self, rule):
        r"""Sets the rule of this ModifyPlaybookVersionInfo.

        :param rule: The rule of this ModifyPlaybookVersionInfo.
        :type rule: :class:`huaweicloudsdksecmaster.v1.ModifyRuleInfo`
        """
        self._rule = rule
