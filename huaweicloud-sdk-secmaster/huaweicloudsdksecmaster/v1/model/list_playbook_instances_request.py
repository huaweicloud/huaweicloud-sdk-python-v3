...
class ListPlaybookInstancesRequest:
    ...
    def __init__(self, project_id=None, workspace_id=None, status=None, name=None, playbook_name=None, dataclass_name=None, dataobject_name=None, trigger_type=None, from_date=None, to_date=None, date_type=None, limit=None, offset=None):
        ...
        :param from_date: 查询起始时间，时间格式 yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSS&#39;Z&#39;Z
        :type from_date: str
        :param to_date: 查询结束时间，时间格式 yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSS&#39;Z&#39;Z
        :type to_date: str
        :param date_type: 时间类型. START--按照开始时间检索, END--按照结束时间检索
        :type date_type: str
