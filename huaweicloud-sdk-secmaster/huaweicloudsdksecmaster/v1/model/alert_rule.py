...
class AlertRule:
    ...
    def __init__(self, create_by=None, create_time=None, custom_properties=None, delete_time=None, event_grouping=None, pipe_id=None, pipe_name=None, query=None, query_type=None, rule_id=None, rule_name=None, schedule=None, severity=None, status=None, triggers=None, update_by=None, update_time=None):
        r"""AlertRule
