...
class ListPlaybookApprovesResponse(SdkResponse):
    ...
    def __init__(self, code=None, message=None, data=None, x_request_id=None):
        ...
        :type message: str
        :param data: 剧本审核详情
        :type data: list[:class:`huaweicloudsdksecmaster.v1.ApproveOpinionDetail`]
        :param x_request_id: 
    ...
    def data(self):
        ...
        :rtype: list[:class:`huaweicloudsdksecmaster.v1.ApproveOpinionDetail`]
        """
        return self._data
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListPlaybookApprovesResponse.to_dict() is deprecated and no longer maintained, "
