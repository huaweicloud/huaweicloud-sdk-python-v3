...
class ListIncidentsResponse(SdkResponse):
    ...
    def __init__(self, code=None, message=None, total=None, size=None, page=None, success=None, data=None, x_request_id=None):
        ...
        :type success: bool
        :param data: 事件列表
        :type data: list[:class:`huaweicloudsdksecmaster.v1.IncidentDetail`]
        :param x_request_id: 
    ...
    @property
    def size(self):
        r"""Gets the size of this ListIncidentsResponse.

        分页大小

        :return: The size of this ListIncidentsResponse.
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        r"""Sets the size of this ListIncidentsResponse.

        分页大小

        :param size: The size of this ListIncidentsResponse.
        :type size: int
        """
        self._size = size
    ...
    @property
    def page(self):
        r"""Gets the page of this ListIncidentsResponse.

        分页的页码

        :return: The page of this ListIncidentsResponse.
        :rtype: int
        """
        return self._page
    ...
    @page.setter
    def page(self, page):
        r"""Sets the page of this ListIncidentsResponse.

        分页的页码

        :param page: The page of this ListIncidentsResponse.
        :type page: int
        """
        self._page = page
    ...
    def data(self):
        ...
        :rtype: list[:class:`huaweicloudsdksecmaster.v1.IncidentDetail`]
        """
        return self._data
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListIncidentsResponse.to_dict() is deprecated and no longer maintained, "
