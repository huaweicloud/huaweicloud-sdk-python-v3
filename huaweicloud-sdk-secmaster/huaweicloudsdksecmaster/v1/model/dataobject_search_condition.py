...
class DataobjectSearchCondition:
    ...
    def __init__(self, conditions=None, logics=None):
        ...
        :type conditions: list[:class:`huaweicloudsdksecmaster.v1.DataobjectSearchConditionConditions`]
    ...
    def conditions(self):
        ...
        :rtype: list[:class:`huaweicloudsdksecmaster.v1.DataobjectSearchConditionConditions`]
        """
