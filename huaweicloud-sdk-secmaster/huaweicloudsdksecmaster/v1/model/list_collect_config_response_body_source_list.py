...
class ListCollectConfigResponseBodySourceList:
    ...
    def csvc_display(self):
        r"""Gets the csvc_display of this ListCollectConfigResponseBodySourceList.

        云产品名称

        :return: The csvc_display of this ListCollectConfigResponseBodySourceList.
        :rtype: str
        """
    ...
    def csvc_display(self, csvc_display):
        r"""Sets the csvc_display of this ListCollectConfigResponseBodySourceList.

        云产品名称

        :param csvc_display: The csvc_display of this ListCollectConfigResponseBodySourceList.
        :type csvc_display: str
        """
    ...
    @property
    def link(self):
        r"""Gets the link of this ListCollectConfigResponseBodySourceList.

        链接

        :return: The link of this ListCollectConfigResponseBodySourceList.
        :rtype: str
        """
        return self._link
    ...
    @link.setter
    def link(self, link):
        r"""Sets the link of this ListCollectConfigResponseBodySourceList.

        链接

        :param link: The link of this ListCollectConfigResponseBodySourceList.
        :type link: str
        """
        self._link = link
    ...
    def source_display(self):
        r"""Gets the source_display of this ListCollectConfigResponseBodySourceList.

        日志名称

        :return: The source_display of this ListCollectConfigResponseBodySourceList.
        :rtype: str
        """
    ...
    def source_display(self, source_display):
        r"""Sets the source_display of this ListCollectConfigResponseBodySourceList.

        日志名称

        :param source_display: The source_display of this ListCollectConfigResponseBodySourceList.
        :type source_display: str
        """
    ...
    def source_help(self):
        r"""Gets the source_help of this ListCollectConfigResponseBodySourceList.

        日志描述

        :return: The source_help of this ListCollectConfigResponseBodySourceList.
        :rtype: str
        """
    ...
    def source_help(self, source_help):
        r"""Sets the source_help of this ListCollectConfigResponseBodySourceList.

        日志描述

        :param source_help: The source_help of this ListCollectConfigResponseBodySourceList.
        :type source_help: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListCollectConfigResponseBodySourceList):
            return False
