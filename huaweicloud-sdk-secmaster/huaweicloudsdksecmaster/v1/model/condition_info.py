...
class ConditionInfo:
    ...
    def __init__(self, expression_type=None, conditions=None, logics=None, cron=None, schedule_type=None, start_type=None, end_type=None, end_time=None, start_time=None, repeat_range=None, only_once=None, execution_type=None):
        r"""ConditionInfo

        The model defined in huaweicloud sdk

        :param expression_type: **参数解释：** 表达式类型 - common  通用表达式  **约束限制：** 事件触发剧本必填 **取值范围：** - common  **默认取值：** common
        :type expression_type: str
        :param conditions: 触发条件。事件触发剧本必填
        :type conditions: list[:class:`huaweicloudsdksecmaster.v1.ConditionItem`]
        :param logics: 条件逻辑组合。事件触发剧本必填
        :type logics: list[str]
        :param cron: Cron 表达式（定时任务）。定时触发剧本必填
        :type cron: str
        :param schedule_type: **参数解释：** 定时重复类型(second--秒, hour--小时,day--天，week-周)。 - second  秒 - hour 小时 - day 天 - week 周  **约束限制：** 定时触发剧本必填 **取值范围：** - second - hour - day - week  **默认取值：** 无
        :type schedule_type: str
        :param start_type: **参数解释：** 剧本开始执行类型 - IMMEDIATELY 创建完成立即执行 - CUSTOM 自定义执行时间  **约束限制：** 定时触发剧本必填 **取值范围：** - IMMEDIATELY - CUSTOM  **默认取值：** 无
        :type start_type: str
        :param end_type: **参数解释：** 剧本结束执行类型 - FOREVER 一直执行 - CUSTOM 自定义结束时间  **约束限制：** 定时触发剧本必填 **取值范围：** - FOREVER - CUSTOM  **默认取值：** 无
        :type end_type: str
        :param end_time: 定时结束时间。定时触发剧本必填
        :type end_time: str
        :param start_time: 定时开始时间。定时触发剧本必填
        :type start_time: str
        :param repeat_range: 执行时间段 2021-01-30T23:00:00Z+0800。定时触发剧本必填
        :type repeat_range: str
        :param only_once: 是否只执行一次。定时触发剧本必填
        :type only_once: bool
        :param execution_type: **参数解释：** 执行队列类型 - PARALLEL 新任务与之前任务并行 - SERIAL_WAIT 不发起新任务  **约束限制：** 定时触发剧本必填 **取值范围：** - PARALLEL - SERIAL_WAIT  **默认取值：** 无
    ...
    def conditions(self):
        ...
        :rtype: list[:class:`huaweicloudsdksecmaster.v1.ConditionItem`]
        """
    ...
    @property
    def start_time(self):
        r"""Gets the start_time of this ConditionInfo.

        定时开始时间。定时触发剧本必填

        :return: The start_time of this ConditionInfo.
        :rtype: str
        """
    ...
    def start_time(self, start_time):
        r"""Sets the start_time of this ConditionInfo.

        定时开始时间。定时触发剧本必填

        :param start_time: The start_time of this ConditionInfo.
        :type start_time: str
        """
