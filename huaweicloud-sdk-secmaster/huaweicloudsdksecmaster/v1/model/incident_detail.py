...
class IncidentDetail:
    ...
    def __init__(self, create_time=None, data_object=None, dataclass_ref=None, format_version=None, id=None, project_id=None, update_time=None, version=None, workspace_id=None, type=None):
        r"""IncidentDetail
        ...
        :param type: 数据类型（SIMULATION--告警, PLAYBOOK--剧本, MANUAL--手动触发,DATA_SOURCE--数据源）
        :type type: str
        """
