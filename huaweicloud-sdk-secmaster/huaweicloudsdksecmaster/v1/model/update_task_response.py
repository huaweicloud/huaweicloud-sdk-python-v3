...
class UpdateTaskResponse(SdkResponse):
    ...
    @property
    def success(self):
        r"""Gets the success of this UpdateTaskResponse.

        **参数解释**: 是否成功 **取值范围**: - true  成功 - false 失败

        :return: The success of this UpdateTaskResponse.
        :rtype: bool
        """
    ...
    def success(self, success):
        r"""Sets the success of this UpdateTaskResponse.

        **参数解释**: 是否成功 **取值范围**: - true  成功 - false 失败

        :param success: The success of this UpdateTaskResponse.
        :type success: bool
        """
    ...
    @property
    def data(self):
        r"""Gets the data of this UpdateTaskResponse.

        :return: The data of this UpdateTaskResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this UpdateTaskResponse.

        :param data: The data of this UpdateTaskResponse.
        :type data: :class:`huaweicloudsdksecmaster.v1.TaskInfo`
        """
        self._data = data
