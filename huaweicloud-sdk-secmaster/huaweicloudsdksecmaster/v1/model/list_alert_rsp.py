...
class ListAlertRsp:
    ...
    def __init__(self, version=None, id=None, domain_id=None, region_id=None, workspace_id=None, labels=None, environment=None, data_source=None, first_observed_time=None, last_observed_time=None, create_time=None, arrive_time=None, title=None, description=None, source_url=None, count=None, confidence=None, severity=None, criticality=None, alert_type=None, network_list=None, resource_list=None, remediation=None, verification_state=None, handle_status=None, sla=None, update_time=None, close_time=None, ipdrr_phase=None, simulation=None, actor=None, owner=None, creator=None, close_reason=None, close_comment=None, alert_list=None, incident_list=None, indicator_list=None, malware=None, system_info=None, process=None, user_info=None, file_info=None, origin_id=None, ttd=None, ttr=None, is_auto_closed=None, system_alert_table=None):
        ...
        :type severity: str
        :param criticality: 关键性，是指事件涉及的资产的重要性级别。 取值范围：0-100，0表示资产不关键，100表示最关键资产
        :type criticality: int
        :param alert_type: 
        :type alert_type: :class:`huaweicloudsdksecmaster.v1.AlertAlertType`
        ...
        :param malware: 
        :type malware: :class:`huaweicloudsdksecmaster.v1.AlertMalware`
        :param system_info: 系统信息
        :type system_info: object
        :param process: 进程信息
        :type process: list[:class:`huaweicloudsdksecmaster.v1.AlertProcess`]
        :param user_info: 用户信息
        :type user_info: list[:class:`huaweicloudsdksecmaster.v1.AlertUserInfo`]
        :param file_info: 文件信息
        :type file_info: list[:class:`huaweicloudsdksecmaster.v1.AlertFileInfo`]
    ...
    def data_source(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.AlertDataSource`
        """
    ...
    def alert_type(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.AlertAlertType`
        """
    ...
    def network_list(self):
        ...
        :rtype: list[:class:`huaweicloudsdksecmaster.v1.AlertNetworkList`]
        """
    ...
    def remediation(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.AlertRemediation`
        """
    ...
    def malware(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.AlertMalware`
        """
    ...
    def process(self):
        ...
        :rtype: list[:class:`huaweicloudsdksecmaster.v1.AlertProcess`]
        """
    ...
    def user_info(self):
        ...
        :rtype: list[:class:`huaweicloudsdksecmaster.v1.AlertUserInfo`]
        """
    ...
    def file_info(self):
        ...
        :rtype: list[:class:`huaweicloudsdksecmaster.v1.AlertFileInfo`]
        """
