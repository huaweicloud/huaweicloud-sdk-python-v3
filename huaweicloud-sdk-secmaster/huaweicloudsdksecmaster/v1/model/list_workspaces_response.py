...
class ListWorkspacesResponse(SdkResponse):
    ...
    def __init__(self, workspaces=None, count=None):
        ...
        :type workspaces: list[:class:`huaweicloudsdksecmaster.v1.CreateWorkspaceResponseBody`]
        :param count: 数据总量
        :type count: float
        """
    ...
    def workspaces(self):
        ...
        :rtype: list[:class:`huaweicloudsdksecmaster.v1.CreateWorkspaceResponseBody`]
        """
