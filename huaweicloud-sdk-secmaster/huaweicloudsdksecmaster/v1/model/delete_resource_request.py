...
class DeleteResourceRequest:
    ...
    openapi_types = {
        ...
        'workspace_id': 'str',
        'x_language': 'str',
        'body': 'DeleteResourceRequestBody'
    }
    ...
    def __init__(self, project_id=None, workspace_id=None, x_language=None, body=None):
        ...
        :type body: :class:`huaweicloudsdksecmaster.v1.DeleteResourceRequestBody`
        """
    ...
    def project_id(self, project_id):
        r"""Sets the project_id of this DeleteResourceRequest.

        **参数解释：** 项目ID，用于明确项目归属，配置后可通过该ID查询项目下资产，可以通过调用API获取，也可以从控制台获取。[获取项目ID](secmaster_03_0014.xml) **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :param project_id: The project_id of this DeleteResourceRequest.
        :type project_id: str
        """
    ...
    def workspace_id(self):
        r"""Gets the workspace_id of this DeleteResourceRequest.

        **参数解释：** 工作空间id。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :return: The workspace_id of this DeleteResourceRequest.
        :rtype: str
        """
    ...
    def workspace_id(self, workspace_id):
        r"""Sets the workspace_id of this DeleteResourceRequest.

        **参数解释：** 工作空间id。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :param workspace_id: The workspace_id of this DeleteResourceRequest.
        :type workspace_id: str
        """
    ...
    @property
    def x_language(self):
        r"""Gets the x_language of this DeleteResourceRequest.

        **参数解释：** 语言，参考值：zh-cn、en-us **约束限制：** 不涉及 **取值范围：** zh-cn：中文环境 en-us：英文环境 **默认取值：** 不涉及

        :return: The x_language of this DeleteResourceRequest.
        :rtype: str
        """
    ...
    def x_language(self, x_language):
        r"""Sets the x_language of this DeleteResourceRequest.

        **参数解释：** 语言，参考值：zh-cn、en-us **约束限制：** 不涉及 **取值范围：** zh-cn：中文环境 en-us：英文环境 **默认取值：** 不涉及

        :param x_language: The x_language of this DeleteResourceRequest.
        :type x_language: str
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.DeleteResourceRequestBody`
        """
        return self._body
