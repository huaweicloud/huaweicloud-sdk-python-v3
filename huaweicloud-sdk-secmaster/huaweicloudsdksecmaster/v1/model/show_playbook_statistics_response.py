...
class ShowPlaybookStatisticsResponse(SdkResponse):
    ...
    def __init__(self, code=None, message=None, data=None, x_request_id=None, x_api_deprecation_info=None, x_api_deprecation_date=None):
        r"""ShowPlaybookStatisticsResponse
        ...
        :type message: str
        :param data: 
        :type data: :class:`huaweicloudsdksecmaster.v1.PlaybookStatisticDetail`
        :param x_request_id: 
    ...
    @property
    def code(self):
        r"""Gets the code of this ShowPlaybookStatisticsResponse.
    ...
    @code.setter
    def code(self, code):
        r"""Sets the code of this ShowPlaybookStatisticsResponse.
    ...
    @property
    def message(self):
        r"""Gets the message of this ShowPlaybookStatisticsResponse.
    ...
    def message(self, message):
        r"""Sets the message of this ShowPlaybookStatisticsResponse.
    ...
    @property
    def data(self):
        r"""Gets the data of this ShowPlaybookStatisticsResponse.

        :return: The data of this ShowPlaybookStatisticsResponse.
        :rtype: :class:`huaweicloudsdksecmaster.v1.PlaybookStatisticDetail`
        """
        return self._data

    @data.setter
    def data(self, data):
        r"""Sets the data of this ShowPlaybookStatisticsResponse.
    ...
    def x_request_id(self):
        r"""Gets the x_request_id of this ShowPlaybookStatisticsResponse.
    ...
    def x_request_id(self, x_request_id):
        r"""Sets the x_request_id of this ShowPlaybookStatisticsResponse.
    ...
    def x_api_deprecation_info(self):
        r"""Gets the x_api_deprecation_info of this ShowPlaybookStatisticsResponse.

        :return: The x_api_deprecation_info of this ShowPlaybookStatisticsResponse.
        :rtype: str
        """
    ...
    def x_api_deprecation_info(self, x_api_deprecation_info):
        r"""Sets the x_api_deprecation_info of this ShowPlaybookStatisticsResponse.

        :param x_api_deprecation_info: The x_api_deprecation_info of this ShowPlaybookStatisticsResponse.
        :type x_api_deprecation_info: str
        """
    ...
    def x_api_deprecation_date(self):
        r"""Gets the x_api_deprecation_date of this ShowPlaybookStatisticsResponse.

        :return: The x_api_deprecation_date of this ShowPlaybookStatisticsResponse.
        :rtype: str
        """
    ...
    def x_api_deprecation_date(self, x_api_deprecation_date):
        r"""Sets the x_api_deprecation_date of this ShowPlaybookStatisticsResponse.

        :param x_api_deprecation_date: The x_api_deprecation_date of this ShowPlaybookStatisticsResponse.
        :type x_api_deprecation_date: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowPlaybookStatisticsResponse.to_dict() is deprecated and no longer maintained, "
