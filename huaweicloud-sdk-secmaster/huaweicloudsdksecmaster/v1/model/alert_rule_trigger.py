...
class AlertRuleTrigger:
    ...
    def __init__(self, accumulated_times=None, expression=None, mode=None, operator=None, severity=None):
        r"""AlertRuleTrigger
        ...
        :type expression: str
        :param mode: **参数解释**: 指标模式 - COUNT 数量  **约束限制** 不涉及 **取值范围**: - COUNT  **默认值** 不涉及
        :type mode: str
