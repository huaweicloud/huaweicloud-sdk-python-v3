...
class Department:
    ...
    def __init__(self, id=None, name=None):
        ...
        :param id: 资产所属部门名称id，若不填写为default
        :type id: str
        :param name: 资产所属部门名称
        :type name: str
        """
    ...
    @property
    def id(self):
        r"""Gets the id of this Department.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this Department.
    ...
    @property
    def name(self):
        r"""Gets the name of this Department.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this Department.
