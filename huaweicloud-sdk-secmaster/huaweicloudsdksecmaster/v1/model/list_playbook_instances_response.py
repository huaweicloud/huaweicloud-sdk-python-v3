...
class ListPlaybookInstancesResponse(SdkResponse):
    ...
    def __init__(self, count=None, instances=None, x_request_id=None):
        ...
        :type instances: list[:class:`huaweicloudsdksecmaster.v1.PlaybookInstanceInfo`]
        :param x_request_id: 
    ...
    def instances(self):
        ...
        :rtype: list[:class:`huaweicloudsdksecmaster.v1.PlaybookInstanceInfo`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListPlaybookInstancesResponse.to_dict() is deprecated and no longer maintained, "
