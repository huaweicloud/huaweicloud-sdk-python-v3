...
class ExportIndicatorsRequestBody:
    ...
    def data_object_filters_form(self):
        r"""Gets the data_object_filters_form of this ExportIndicatorsRequestBody.

        :return: The data_object_filters_form of this ExportIndicatorsRequestBody.
    ...
    def data_object_filters_form(self, data_object_filters_form):
        r"""Sets the data_object_filters_form of this ExportIndicatorsRequestBody.

        :param data_object_filters_form: The data_object_filters_form of this ExportIndicatorsRequestBody.
        :type data_object_filters_form: :class:`huaweicloudsdksecmaster.v1.DataobjectSearch`
        """
    ...
    @property
    def title(self):
        r"""Gets the title of this ExportIndicatorsRequestBody.

        导出字段列表

        :return: The title of this ExportIndicatorsRequestBody.
        :rtype: list[str]
        """
        return self._title
    ...
    def title(self, title):
        r"""Sets the title of this ExportIndicatorsRequestBody.

        导出字段列表

        :param title: The title of this ExportIndicatorsRequestBody.
        :type title: list[str]
        """
        self._title = title
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExportIndicatorsRequestBody):
            return False
