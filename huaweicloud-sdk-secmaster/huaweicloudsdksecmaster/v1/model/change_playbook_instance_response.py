...
class ChangePlaybookInstanceResponse(SdkResponse):
    ...
    def __init__(self, id=None, name=None, project_id=None, playbook=None, dataclass=None, dataobject=None, status=None, trigger_type=None, start_time=None, end_time=None, x_request_id=None):
        ...
        :type project_id: str
        :param playbook: 
        :type playbook: :class:`huaweicloudsdksecmaster.v1.PlaybookInfoRef`
        :param dataclass: 
        :type dataclass: :class:`huaweicloudsdksecmaster.v1.DataclassInfoRef`
        :param dataobject: 
        :type dataobject: :class:`huaweicloudsdksecmaster.v1.DataobjectRef`
    ...
    def playbook(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.PlaybookInfoRef`
        """
    ...
    def dataclass(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.DataclassInfoRef`
        """
    ...
    def dataobject(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.DataobjectRef`
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ChangePlaybookInstanceResponse.to_dict() is deprecated and no longer maintained, "
