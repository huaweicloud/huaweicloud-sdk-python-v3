...
class ExportIncidentsRequestBody:
    ...
    def data_object_filters_form(self):
        r"""Gets the data_object_filters_form of this ExportIncidentsRequestBody.

        :return: The data_object_filters_form of this ExportIncidentsRequestBody.
    ...
    def data_object_filters_form(self, data_object_filters_form):
        r"""Sets the data_object_filters_form of this ExportIncidentsRequestBody.

        :param data_object_filters_form: The data_object_filters_form of this ExportIncidentsRequestBody.
        :type data_object_filters_form: :class:`huaweicloudsdksecmaster.v1.DataobjectSearch`
        """
    ...
    @property
    def title(self):
        r"""Gets the title of this ExportIncidentsRequestBody.

        导出字段列表

        :return: The title of this ExportIncidentsRequestBody.
        :rtype: list[str]
        """
        return self._title
    ...
    def title(self, title):
        r"""Sets the title of this ExportIncidentsRequestBody.

        导出字段列表

        :param title: The title of this ExportIncidentsRequestBody.
        :type title: list[str]
        """
        self._title = title
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExportIncidentsRequestBody):
            return False
