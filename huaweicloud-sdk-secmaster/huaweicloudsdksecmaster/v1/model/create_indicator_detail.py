...
class CreateIndicatorDetail:
    ...
    def __init__(self, data_source=None, verdict=None, confidence=None, status=None, labels=None, value=None, granular_marking=None, environment=None, defanged=None, first_report_time=None, last_report_time=None, id=None, indicator_type=None, name=None, workspace_id=None, project_id=None, create_time=None, update_time=None):
        r"""CreateIndicatorDetail

        The model defined in huaweicloud sdk

        :param data_source: 
        :type data_source: :class:`huaweicloudsdksecmaster.v1.CreateIndicatorDetailDataSource`
        :param verdict: 威胁度
        :type verdict: str
        ...
        :param environment: 
        :type environment: :class:`huaweicloudsdksecmaster.v1.CreateIndicatorDetailEnvironment`
        :param defanged: 是否失效
        :type defanged: bool
        ...
        :type indicator_type: :class:`huaweicloudsdksecmaster.v1.CreateIndicatorDetailIndicatorType`
        :param name: 威胁情报名称
        :type name: str
    ...
    def data_source(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.CreateIndicatorDetailDataSource`
        """
    ...
    def environment(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.CreateIndicatorDetailEnvironment`
        """
    ...
    def indicator_type(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.CreateIndicatorDetailIndicatorType`
        """
