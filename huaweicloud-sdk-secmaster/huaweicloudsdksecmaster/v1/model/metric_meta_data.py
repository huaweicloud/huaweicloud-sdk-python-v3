...
class MetricMetaData:
    ...
    @property
    def name(self):
        r"""Gets the name of this MetricMetaData.

        指标名称

        :return: The name of this MetricMetaData.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this MetricMetaData.

        指标名称

        :param name: The name of this MetricMetaData.
        :type name: str
        """
        self._name = name
    ...
    @property
    def id(self):
        r"""Gets the id of this MetricMetaData.

        指标Id

        :return: The id of this MetricMetaData.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this MetricMetaData.

        指标Id

        :param id: The id of this MetricMetaData.
        :type id: str
        """
        self._id = id
    ...
    def metric_type(self):
        r"""Gets the metric_type of this MetricMetaData.

        指标类型， 当前仅支持创建日志类型指标

        :return: The metric_type of this MetricMetaData.
        :rtype: str
        """
    ...
    def metric_type(self, metric_type):
        r"""Sets the metric_type of this MetricMetaData.

        指标类型， 当前仅支持创建日志类型指标

        :param metric_type: The metric_type of this MetricMetaData.
        :type metric_type: str
        """
    ...
    @property
    def data_type(self):
        r"""Gets the data_type of this MetricMetaData.
    ...
    def data_type(self, data_type):
        r"""Sets the data_type of this MetricMetaData.
    ...
    def metric_dimension(self):
        r"""Gets the metric_dimension of this MetricMetaData.

        指标结果维度，0维：单个数字，2维：图表或表格，3+维：多标签图表, metric_type为DERIVED必填，其他类型选填（COMPOUND时必为0）

        :return: The metric_dimension of this MetricMetaData.
        :rtype: int
        """
    ...
    def metric_dimension(self, metric_dimension):
        r"""Sets the metric_dimension of this MetricMetaData.

        指标结果维度，0维：单个数字，2维：图表或表格，3+维：多标签图表, metric_type为DERIVED必填，其他类型选填（COMPOUND时必为0）

        :param metric_dimension: The metric_dimension of this MetricMetaData.
        :type metric_dimension: int
        """
    ...
    @property
    def cache_ttl(self):
        r"""Gets the cache_ttl of this MetricMetaData.

        缓存生命周期，单位s

        :return: The cache_ttl of this MetricMetaData.
        :rtype: int
        """
    ...
    def cache_ttl(self, cache_ttl):
        r"""Sets the cache_ttl of this MetricMetaData.

        缓存生命周期，单位s

        :param cache_ttl: The cache_ttl of this MetricMetaData.
        :type cache_ttl: int
        """
    ...
    def report_period(self):
        r"""Gets the report_period of this MetricMetaData.

        上报周期，埋点指标时必填，单位s

        :return: The report_period of this MetricMetaData.
        :rtype: int
        """
    ...
    def report_period(self, report_period):
        r"""Sets the report_period of this MetricMetaData.

        上报周期，埋点指标时必填，单位s

        :param report_period: The report_period of this MetricMetaData.
        :type report_period: int
        """
    ...
    def is_built_in(self):
        r"""Gets the is_built_in of this MetricMetaData.

        是否为系统指标

        :return: The is_built_in of this MetricMetaData.
        :rtype: bool
        """
    ...
    def is_built_in(self, is_built_in):
        r"""Sets the is_built_in of this MetricMetaData.

        是否为系统指标

        :param is_built_in: The is_built_in of this MetricMetaData.
        :type is_built_in: bool
        """
    ...
    def effective_column(self):
        r"""Gets the effective_column of this MetricMetaData.

        生效的列, 当有该参数时，使用指定列作为指标数据结果

        :return: The effective_column of this MetricMetaData.
        :rtype: str
        """
    ...
    def effective_column(self, effective_column):
        r"""Sets the effective_column of this MetricMetaData.

        生效的列, 当有该参数时，使用指定列作为指标数据结果

        :param effective_column: The effective_column of this MetricMetaData.
        :type effective_column: str
        """
    ...
    def max_query_range(self):
        r"""Gets the max_query_range of this MetricMetaData.

        指标支持的最大检索范围，单位：天；复合指标时，数值为derived_metrics列表元素中最小值

        :return: The max_query_range of this MetricMetaData.
        :rtype: int
        """
    ...
    def max_query_range(self, max_query_range):
        r"""Sets the max_query_range of this MetricMetaData.

        指标支持的最大检索范围，单位：天；复合指标时，数值为derived_metrics列表元素中最小值

        :param max_query_range: The max_query_range of this MetricMetaData.
        :type max_query_range: int
        """
    ...
    def derived_metrics(self):
        r"""Gets the derived_metrics of this MetricMetaData.

        衍生指标列表，非复合指标时只有一个元素，复合指标时，为各衍生指标的定义

        :return: The derived_metrics of this MetricMetaData.
    ...
    def derived_metrics(self, derived_metrics):
        r"""Sets the derived_metrics of this MetricMetaData.

        衍生指标列表，非复合指标时只有一个元素，复合指标时，为各衍生指标的定义

        :param derived_metrics: The derived_metrics of this MetricMetaData.
        :type derived_metrics: list[:class:`huaweicloudsdksecmaster.v1.MetricMetaDataDerivedMetrics`]
        """
    ...
    def compound_expression(self):
        r"""Gets the compound_expression of this MetricMetaData.

        metric_type为DERIVED时填写, 复合指标的表达式

        :return: The compound_expression of this MetricMetaData.
        :rtype: str
        """
    ...
    def compound_expression(self, compound_expression):
        r"""Sets the compound_expression of this MetricMetaData.

        metric_type为DERIVED时填写, 复合指标的表达式

        :param compound_expression: The compound_expression of this MetricMetaData.
        :type compound_expression: str
        """
    ...
    def metric_format(self):
        r"""Gets the metric_format of this MetricMetaData.

        指标格式

        :return: The metric_format of this MetricMetaData.
    ...
    def metric_format(self, metric_format):
        r"""Sets the metric_format of this MetricMetaData.

        指标格式

        :param metric_format: The metric_format of this MetricMetaData.
        :type metric_format: list[:class:`huaweicloudsdksecmaster.v1.LayoutMetricFormat`]
        """
    ...
    def metric_expand_dim(self):
        r"""Gets the metric_expand_dim of this MetricMetaData.

        :return: The metric_expand_dim of this MetricMetaData.
    ...
    def metric_expand_dim(self, metric_expand_dim):
        r"""Sets the metric_expand_dim of this MetricMetaData.

        :param metric_expand_dim: The metric_expand_dim of this MetricMetaData.
        :type metric_expand_dim: :class:`huaweicloudsdksecmaster.v1.MetricDimensionExpandParam`
        """
    ...
    @property
    def version(self):
        r"""Gets the version of this MetricMetaData.

        安全云脑版本

        :return: The version of this MetricMetaData.
        :rtype: str
        """
    ...
    def version(self, version):
        r"""Sets the version of this MetricMetaData.

        安全云脑版本

        :param version: The version of this MetricMetaData.
        :type version: str
        """
