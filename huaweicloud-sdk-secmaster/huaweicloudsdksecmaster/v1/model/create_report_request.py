...
class CreateReportRequest:
    ...
    def __init__(self, region=None, project_id=None, workspace_id=None, body=None):
        ...
        :type body: :class:`huaweicloudsdksecmaster.v1.CreateReportRequestBody`
        """
    ...
    @property
    def region(self):
        r"""Gets the region of this CreateReportRequest.

        区域ID

        :return: The region of this CreateReportRequest.
        :rtype: str
        """
        return self._region
    ...
    def region(self, region):
        r"""Sets the region of this CreateReportRequest.

        区域ID

        :param region: The region of this CreateReportRequest.
        :type region: str
        """
        self._region = region
    ...
    def workspace_id(self):
        r"""Gets the workspace_id of this CreateReportRequest.

        **参数解释：** 工作空间id。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :return: The workspace_id of this CreateReportRequest.
        :rtype: str
        """
    ...
    def workspace_id(self, workspace_id):
        r"""Sets the workspace_id of this CreateReportRequest.

        **参数解释：** 工作空间id。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :param workspace_id: The workspace_id of this CreateReportRequest.
        :type workspace_id: str
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.CreateReportRequestBody`
        """
        return self._body
