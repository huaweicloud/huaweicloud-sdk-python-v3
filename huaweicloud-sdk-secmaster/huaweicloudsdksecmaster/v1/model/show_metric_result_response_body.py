...
class ShowMetricResultResponseBody:
    ...
    def __init__(self, metric_id=None, result=None, metric_format=None, log_msg=None, status=None):
        ...
        :type metric_id: str
        :param result: 
        :type result: :class:`huaweicloudsdksecmaster.v1.ShowMetricResultResponseBodyResult`
        :param metric_format: 指标显示格式，根据不同指标固定返回。
        :type metric_format: list[:class:`huaweicloudsdksecmaster.v1.MetricFormat`]
    ...
    def result(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.ShowMetricResultResponseBodyResult`
        """
        return self._result
    ...
    def metric_format(self):
        ...
        :rtype: list[:class:`huaweicloudsdksecmaster.v1.MetricFormat`]
        """
