...
class ShowIndicatorDetailResponse(SdkResponse):
    ...
    def __init__(self, code=None, message=None, data=None, x_request_id=None):
        ...
        :type message: str
        :param data: 
        :type data: :class:`huaweicloudsdksecmaster.v1.IndicatorDetail`
        :param x_request_id: 
    ...
    def code(self):
        ...
        :return: The code of this ShowIndicatorDetailResponse.
        :rtype: str
        """
        return self._code
    ...
    def code(self, code):
        ...
        :param code: The code of this ShowIndicatorDetailResponse.
        :type code: str
        """
        self._code = code
    ...
    def message(self):
        ...
        :return: The message of this ShowIndicatorDetailResponse.
        :rtype: str
        """
    ...
    def message(self, message):
        ...
        :param message: The message of this ShowIndicatorDetailResponse.
        :type message: str
        """
    ...
    def data(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.IndicatorDetail`
        """
        return self._data
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowIndicatorDetailResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowIndicatorDetailResponse):
            return False
