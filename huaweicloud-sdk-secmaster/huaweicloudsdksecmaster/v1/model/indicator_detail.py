...
class IndicatorDetail:
    ...
    def __init__(self, id=None, name=None, data_object=None, workspace_id=None, project_id=None, dataclass_ref=None, create_time=None, update_time=None):
        ...
        :type name: str
        :param data_object: 
        :type data_object: :class:`huaweicloudsdksecmaster.v1.IndicatorDataObjectDetail`
        :param workspace_id: 工作空间ID
        :type workspace_id: str
        :param project_id: 项目ID
        :type project_id: str
        :param dataclass_ref: 
        :type dataclass_ref: :class:`huaweicloudsdksecmaster.v1.DataClassRefPojo`
    ...
    def data_object(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.IndicatorDataObjectDetail`
        """
    ...
    def dataclass_ref(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.DataClassRefPojo`
        """
