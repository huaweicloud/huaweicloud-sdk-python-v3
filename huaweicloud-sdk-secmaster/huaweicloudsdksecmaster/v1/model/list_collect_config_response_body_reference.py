...
class ListCollectConfigResponseBodyReference:
    ...
    @property
    def csvc_help(self):
        r"""Gets the csvc_help of this ListCollectConfigResponseBodyReference.

        云产品描述

        :return: The csvc_help of this ListCollectConfigResponseBodyReference.
        :rtype: str
        """
    ...
    def csvc_help(self, csvc_help):
        r"""Sets the csvc_help of this ListCollectConfigResponseBodyReference.

        云产品描述

        :param csvc_help: The csvc_help of this ListCollectConfigResponseBodyReference.
        :type csvc_help: str
        """
