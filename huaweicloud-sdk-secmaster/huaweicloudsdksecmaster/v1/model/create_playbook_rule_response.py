...
class CreatePlaybookRuleResponse(SdkResponse):
    ...
    @property
    def code(self):
        r"""Gets the code of this CreatePlaybookRuleResponse.
    ...
    @code.setter
    def code(self, code):
        r"""Sets the code of this CreatePlaybookRuleResponse.
    ...
    @property
    def message(self):
        r"""Gets the message of this CreatePlaybookRuleResponse.
    ...
    def message(self, message):
        r"""Sets the message of this CreatePlaybookRuleResponse.
    ...
    @property
    def data(self):
        r"""Gets the data of this CreatePlaybookRuleResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this CreatePlaybookRuleResponse.
    ...
    def x_request_id(self):
        r"""Gets the x_request_id of this CreatePlaybookRuleResponse.
    ...
    def x_request_id(self, x_request_id):
        r"""Sets the x_request_id of this CreatePlaybookRuleResponse.
    ...
    def x_api_deprecation_info(self):
        r"""Gets the x_api_deprecation_info of this CreatePlaybookRuleResponse.

        :return: The x_api_deprecation_info of this CreatePlaybookRuleResponse.
        :rtype: str
        """
    ...
    def x_api_deprecation_info(self, x_api_deprecation_info):
        r"""Sets the x_api_deprecation_info of this CreatePlaybookRuleResponse.

        :param x_api_deprecation_info: The x_api_deprecation_info of this CreatePlaybookRuleResponse.
        :type x_api_deprecation_info: str
        """
    ...
    def x_api_deprecation_date(self):
        r"""Gets the x_api_deprecation_date of this CreatePlaybookRuleResponse.

        :return: The x_api_deprecation_date of this CreatePlaybookRuleResponse.
        :rtype: str
        """
    ...
    def x_api_deprecation_date(self, x_api_deprecation_date):
        r"""Sets the x_api_deprecation_date of this CreatePlaybookRuleResponse.

        :param x_api_deprecation_date: The x_api_deprecation_date of this CreatePlaybookRuleResponse.
        :type x_api_deprecation_date: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreatePlaybookRuleResponse.to_dict() is deprecated and no longer maintained, "
