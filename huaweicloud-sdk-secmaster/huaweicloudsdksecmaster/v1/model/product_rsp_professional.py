...
class ProductRspProfessional:
    ...
    def resource_type(self):
        r"""Gets the resource_type of this ProductRspProfessional.

        资源类型编码

        :return: The resource_type of this ProductRspProfessional.
        :rtype: str
        """
    ...
    def resource_type(self, resource_type):
        r"""Sets the resource_type of this ProductRspProfessional.

        资源类型编码

        :param resource_type: The resource_type of this ProductRspProfessional.
        :type resource_type: str
        """
    ...
    def resource_spec_code(self):
        r"""Gets the resource_spec_code of this ProductRspProfessional.

        资源规格编码

        :return: The resource_spec_code of this ProductRspProfessional.
        :rtype: str
        """
    ...
    def resource_spec_code(self, resource_spec_code):
        r"""Sets the resource_spec_code of this ProductRspProfessional.

        资源规格编码

        :param resource_spec_code: The resource_spec_code of this ProductRspProfessional.
        :type resource_spec_code: str
        """
    ...
    def resource_size_measure_id(self):
        r"""Gets the resource_size_measure_id of this ProductRspProfessional.

        资源容量度量标识

        :return: The resource_size_measure_id of this ProductRspProfessional.
        :rtype: int
        """
    ...
    def resource_size_measure_id(self, resource_size_measure_id):
        r"""Sets the resource_size_measure_id of this ProductRspProfessional.

        资源容量度量标识

        :param resource_size_measure_id: The resource_size_measure_id of this ProductRspProfessional.
        :type resource_size_measure_id: int
        """
    ...
    def usage_factor(self):
        r"""Gets the usage_factor of this ProductRspProfessional.
        ...
        :return: The usage_factor of this ProductRspProfessional.
        :rtype: str
        """
    ...
    def usage_factor(self, usage_factor):
        r"""Sets the usage_factor of this ProductRspProfessional.

        使用量因子，按需计费必填，取值和话单中的使用量因子一致，云服务和使用量因子对应关系如下: 云脑目前支持有： duration： 时间，主要针对主版本(basic、standard、professional) count：次数，主要针对安全编排 flow：流量，主要针对日志分析和采集 retention：保留，主要针对日志保留

        :param usage_factor: The usage_factor of this ProductRspProfessional.
        :type usage_factor: str
        """
    ...
    def usage_measure_id(self):
        r"""Gets the usage_measure_id of this ProductRspProfessional.

        使用量单位标识，按需询价必填，例如按小时询价，使用量值为1，使用量单位为小时，枚举值如下： 4：小时 10：GB（带宽按流量询价使用） 11：MB（带宽按流量询价使用） 13：Byte（带宽按流量询价使用）

        :return: The usage_measure_id of this ProductRspProfessional.
        :rtype: int
        """
    ...
    def usage_measure_id(self, usage_measure_id):
        r"""Sets the usage_measure_id of this ProductRspProfessional.

        使用量单位标识，按需询价必填，例如按小时询价，使用量值为1，使用量单位为小时，枚举值如下： 4：小时 10：GB（带宽按流量询价使用） 11：MB（带宽按流量询价使用） 13：Byte（带宽按流量询价使用）

        :param usage_measure_id: The usage_measure_id of this ProductRspProfessional.
        :type usage_measure_id: int
        """
    ...
    @property
    def region_id(self):
        r"""Gets the region_id of this ProductRspProfessional.

        当前region编码，默认为null，即为当前region

        :return: The region_id of this ProductRspProfessional.
        :rtype: str
        """
    ...
    def region_id(self, region_id):
        r"""Sets the region_id of this ProductRspProfessional.

        当前region编码，默认为null，即为当前region

        :param region_id: The region_id of this ProductRspProfessional.
        :type region_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProductRspProfessional):
            return False
