...
class ListDataclassResponse(SdkResponse):
    ...
    def __init__(self, dataclass_details=None, total=None, x_request_id=None):
        ...
        :type dataclass_details: list[:class:`huaweicloudsdksecmaster.v1.DataClassResponseBody`]
        :param total: 数据总量
        :type total: float
        :param x_request_id: 
    ...
    def dataclass_details(self):
        ...
        :rtype: list[:class:`huaweicloudsdksecmaster.v1.DataClassResponseBody`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListDataclassResponse.to_dict() is deprecated and no longer maintained, "
