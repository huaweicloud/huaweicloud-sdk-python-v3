...
class ListDataobjectRelationsResponse(SdkResponse):
    ...
    @property
    def size(self):
        r"""Gets the size of this ListDataobjectRelationsResponse.

        分页大小

        :return: The size of this ListDataobjectRelationsResponse.
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        r"""Sets the size of this ListDataobjectRelationsResponse.

        分页大小

        :param size: The size of this ListDataobjectRelationsResponse.
        :type size: int
        """
        self._size = size
    ...
    @property
    def page(self):
        r"""Gets the page of this ListDataobjectRelationsResponse.

        分页的页码

        :return: The page of this ListDataobjectRelationsResponse.
        :rtype: int
        """
        return self._page
    ...
    @page.setter
    def page(self, page):
        r"""Sets the page of this ListDataobjectRelationsResponse.

        分页的页码

        :param page: The page of this ListDataobjectRelationsResponse.
        :type page: int
        """
        self._page = page
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListDataobjectRelationsResponse.to_dict() is deprecated and no longer maintained, "
