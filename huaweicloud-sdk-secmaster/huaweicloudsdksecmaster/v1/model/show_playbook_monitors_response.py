...
class ShowPlaybookMonitorsResponse(SdkResponse):
    ...
    def __init__(self, code=None, message=None, data=None, x_request_id=None, x_api_deprecation_info=None, x_api_deprecation_date=None):
        ...
        :type message: str
        :param data: 
        :type data: :class:`huaweicloudsdksecmaster.v1.PlaybookInstanceMonitorDetail`
        :param x_request_id: 
    ...
    def data(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.PlaybookInstanceMonitorDetail`
        """
        return self._data
    ...
    def x_api_deprecation_info(self):
        r"""Gets the x_api_deprecation_info of this ShowPlaybookMonitorsResponse.

        :return: The x_api_deprecation_info of this ShowPlaybookMonitorsResponse.
        :rtype: str
        """
    ...
    def x_api_deprecation_info(self, x_api_deprecation_info):
        r"""Sets the x_api_deprecation_info of this ShowPlaybookMonitorsResponse.

        :param x_api_deprecation_info: The x_api_deprecation_info of this ShowPlaybookMonitorsResponse.
        :type x_api_deprecation_info: str
        """
    ...
    def x_api_deprecation_date(self):
        r"""Gets the x_api_deprecation_date of this ShowPlaybookMonitorsResponse.

        :return: The x_api_deprecation_date of this ShowPlaybookMonitorsResponse.
        :rtype: str
        """
    ...
    def x_api_deprecation_date(self, x_api_deprecation_date):
        r"""Sets the x_api_deprecation_date of this ShowPlaybookMonitorsResponse.

        :param x_api_deprecation_date: The x_api_deprecation_date of this ShowPlaybookMonitorsResponse.
        :type x_api_deprecation_date: str
        """
