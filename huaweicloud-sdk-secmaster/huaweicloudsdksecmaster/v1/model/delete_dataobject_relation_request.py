...
class DeleteDataobjectRelationRequest:
    ...
    openapi_types = {
        ...
        'body': 'CreateDataobjectRelationRequestBody'
    }
    ...
    def __init__(self, project_id=None, workspace_id=None, dataclass_type=None, data_object_id=None, related_dataclass_type=None, body=None):
        ...
        :type body: :class:`huaweicloudsdksecmaster.v1.CreateDataobjectRelationRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.CreateDataobjectRelationRequestBody`
        """
        return self._body
