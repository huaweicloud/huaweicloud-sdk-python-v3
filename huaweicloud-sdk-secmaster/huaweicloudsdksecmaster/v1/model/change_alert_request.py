...
class ChangeAlertRequest:
    ...
    def __init__(self, project_id=None, workspace_id=None, alert_id=None, body=None):
        ...
        :param alert_id: **参数解释：** 告警id **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
        :type alert_id: str
        :param body: Body of the ChangeAlertRequest
        :type body: :class:`huaweicloudsdksecmaster.v1.ChangeAlertRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.ChangeAlertRequestBody`
        """
        return self._body
