...
class UpdateIndicatorRequest:
    ...
    openapi_types = {
        ...
        'workspace_id': 'str',
        'indicator_id': 'str',
        'body': 'UpdateIndicatorRequestBody'
    }
    ...
    def __init__(self, project_id=None, workspace_id=None, indicator_id=None, body=None):
        ...
        :type body: :class:`huaweicloudsdksecmaster.v1.UpdateIndicatorRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdksecmaster.v1.UpdateIndicatorRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateIndicatorRequest):
            return False
