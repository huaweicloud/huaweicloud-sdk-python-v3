...
class DownloadKieResponse(SdkResponse):
    ...
    @property
    def metadata(self):
        r"""Gets the metadata of this DownloadKieResponse.
    ...
    def metadata(self, metadata):
        r"""Sets the metadata of this DownloadKieResponse.
    ...
    @property
    def data(self):
        r"""Gets the data of this DownloadKieResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this DownloadKieResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DownloadKieResponse.to_dict() is deprecated and no longer maintained, "
