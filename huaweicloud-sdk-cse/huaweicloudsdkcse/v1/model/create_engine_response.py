...
class CreateEngineResponse(SdkResponse):
    ...
    @property
    def id(self):
        r"""Gets the id of this CreateEngineResponse.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this CreateEngineResponse.
    ...
    @property
    def name(self):
        r"""Gets the name of this CreateEngineResponse.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this CreateEngineResponse.
    ...
    @property
    def job_id(self):
        r"""Gets the job_id of this CreateEngineResponse.
    ...
    def job_id(self, job_id):
        r"""Sets the job_id of this CreateEngineResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateEngineResponse.to_dict() is deprecated and no longer maintained, "
