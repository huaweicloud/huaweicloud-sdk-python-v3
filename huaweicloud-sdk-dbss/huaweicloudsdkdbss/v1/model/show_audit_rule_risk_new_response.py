...
class ShowAuditRuleRiskNewResponse(SdkResponse):
    ...
    def __init__(self, rule_id=None, rule_name=None, status=None, action=None, schemas=None, rank=None, ignore_case=None, risk_level=None, db_ids=None, execution_symbol=None, execution_time=None, affect_symbol=None, affect_rows=None, client_ips=None):
        r"""ShowAuditRuleRiskNewResponse
    ...
    @property
    def rule_id(self):
        r"""Gets the rule_id of this ShowAuditRuleRiskNewResponse.

        风险规则ID

        :return: The rule_id of this ShowAuditRuleRiskNewResponse.
        :rtype: str
        """
    ...
    def rule_id(self, rule_id):
        r"""Sets the rule_id of this ShowAuditRuleRiskNewResponse.

        风险规则ID

        :param rule_id: The rule_id of this ShowAuditRuleRiskNewResponse.
        :type rule_id: str
        """
    ...
    @property
    def rule_name(self):
        r"""Gets the rule_name of this ShowAuditRuleRiskNewResponse.

        风险名称

        :return: The rule_name of this ShowAuditRuleRiskNewResponse.
        :rtype: str
        """
    ...
    def rule_name(self, rule_name):
        r"""Sets the rule_name of this ShowAuditRuleRiskNewResponse.

        风险名称

        :param rule_name: The rule_name of this ShowAuditRuleRiskNewResponse.
        :type rule_name: str
        """
    ...
    @property
    def action(self):
        r"""Gets the action of this ShowAuditRuleRiskNewResponse.
        ...
        :return: The action of this ShowAuditRuleRiskNewResponse.
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        r"""Sets the action of this ShowAuditRuleRiskNewResponse.

        操作集合, 中间逗号分隔。 LOGIN,CREATE_TABLE,CREATE_TABLESPACE,DROP_TABLE, DROP_TABLESPACE,DELETE,INSERT,INSERT_SELECT,SELECT,SELECT_FOR_UPDATE, UPDATE,CREATE_USER,DROP_USER,GRANT,OPERATE ALL

        :param action: The action of this ShowAuditRuleRiskNewResponse.
        :type action: str
        """
        self._action = action
    ...
    @property
    def schemas(self):
        r"""Gets the schemas of this ShowAuditRuleRiskNewResponse.

        Schema列表

        :return: The schemas of this ShowAuditRuleRiskNewResponse.
    ...
    def schemas(self, schemas):
        r"""Sets the schemas of this ShowAuditRuleRiskNewResponse.

        Schema列表

        :param schemas: The schemas of this ShowAuditRuleRiskNewResponse.
        :type schemas: list[:class:`huaweicloudsdkdbss.v1.RuleRiskInfoBeanSchemas`]
        """
    ...
    @property
    def rank(self):
        r"""Gets the rank of this ShowAuditRuleRiskNewResponse.

        风险规则优先级。数字越小优先级越高。

        :return: The rank of this ShowAuditRuleRiskNewResponse.
        :rtype: int
        """
        return self._rank
    ...
    @rank.setter
    def rank(self, rank):
        r"""Sets the rank of this ShowAuditRuleRiskNewResponse.

        风险规则优先级。数字越小优先级越高。

        :param rank: The rank of this ShowAuditRuleRiskNewResponse.
        :type rank: int
        """
        self._rank = rank
    ...
    def ignore_case(self):
        r"""Gets the ignore_case of this ShowAuditRuleRiskNewResponse.

        是否忽略大小写

        :return: The ignore_case of this ShowAuditRuleRiskNewResponse.
        :rtype: bool
        """
    ...
    def ignore_case(self, ignore_case):
        r"""Sets the ignore_case of this ShowAuditRuleRiskNewResponse.

        是否忽略大小写

        :param ignore_case: The ignore_case of this ShowAuditRuleRiskNewResponse.
        :type ignore_case: bool
        """
    ...
    @property
    def db_ids(self):
        r"""Gets the db_ids of this ShowAuditRuleRiskNewResponse.

        数据库id，中间逗号分隔（单个id 小于256位）

        :return: The db_ids of this ShowAuditRuleRiskNewResponse.
        :rtype: str
        """
        return self._db_ids
    ...
    def db_ids(self, db_ids):
        r"""Sets the db_ids of this ShowAuditRuleRiskNewResponse.

        数据库id，中间逗号分隔（单个id 小于256位）

        :param db_ids: The db_ids of this ShowAuditRuleRiskNewResponse.
        :type db_ids: str
        """
        self._db_ids = db_ids
    ...
    def execution_time(self):
        r"""Gets the execution_time of this ShowAuditRuleRiskNewResponse.

        设定的执行时长阈值

        :return: The execution_time of this ShowAuditRuleRiskNewResponse.
        :rtype: int
        """
    ...
    def execution_time(self, execution_time):
        r"""Sets the execution_time of this ShowAuditRuleRiskNewResponse.

        设定的执行时长阈值

        :param execution_time: The execution_time of this ShowAuditRuleRiskNewResponse.
        :type execution_time: int
        """
    ...
    def affect_rows(self):
        r"""Gets the affect_rows of this ShowAuditRuleRiskNewResponse.

        设定的影响行数阈值

        :return: The affect_rows of this ShowAuditRuleRiskNewResponse.
        :rtype: int
        """
    ...
    def affect_rows(self, affect_rows):
        r"""Sets the affect_rows of this ShowAuditRuleRiskNewResponse.

        设定的影响行数阈值

        :param affect_rows: The affect_rows of this ShowAuditRuleRiskNewResponse.
        :type affect_rows: int
        """
    ...
    @property
    def client_ips(self):
        r"""Gets the client_ips of this ShowAuditRuleRiskNewResponse.

        客户端IP段: IP-IP格式，或IP/XX 格式。 各个IP段使用逗号连接

        :return: The client_ips of this ShowAuditRuleRiskNewResponse.
        :rtype: str
        """
    ...
    def client_ips(self, client_ips):
        r"""Sets the client_ips of this ShowAuditRuleRiskNewResponse.

        客户端IP段: IP-IP格式，或IP/XX 格式。 各个IP段使用逗号连接

        :param client_ips: The client_ips of this ShowAuditRuleRiskNewResponse.
        :type client_ips: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowAuditRuleRiskNewResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowAuditRuleRiskNewResponse):
            return False
