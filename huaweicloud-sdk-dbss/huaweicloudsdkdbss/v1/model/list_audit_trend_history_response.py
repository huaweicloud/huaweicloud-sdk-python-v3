...
class ListAuditTrendHistoryResponse(SdkResponse):
    ...
    def __init__(self, body=None):
        r"""ListAuditTrendHistoryResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAuditTrendHistoryResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAuditTrendHistoryResponse):
            return False
