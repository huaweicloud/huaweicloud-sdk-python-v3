...
class UpdateAuditTaskStatusRequest:
    ...
    openapi_types = {
        'busi_type': 'str',
        'body': 'AuditSummaryStatusRequest'
    }
    ...
    def __init__(self, busi_type=None, body=None):
        r"""UpdateAuditTaskStatusRequest
    ...
    @property
    def body(self):
        r"""Gets the body of this UpdateAuditTaskStatusRequest.

        :return: The body of this UpdateAuditTaskStatusRequest.
        :rtype: :class:`huaweicloudsdkdbss.v1.AuditSummaryStatusRequest`
        """
        return self._body

    @body.setter
    def body(self, body):
        r"""Sets the body of this UpdateAuditTaskStatusRequest.

        :param body: The body of this UpdateAuditTaskStatusRequest.
        :type body: :class:`huaweicloudsdkdbss.v1.AuditSummaryStatusRequest`
        """
        self._body = body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateAuditTaskStatusRequest):
            return False
