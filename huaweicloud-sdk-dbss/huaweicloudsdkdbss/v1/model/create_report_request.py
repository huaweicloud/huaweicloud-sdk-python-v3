...
class CreateReportRequest:
    ...
    def __init__(self, instance_id=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkdbss.v1.CreateReportRequestBody`
        """
    ...
    def instance_id(self):
        r"""Gets the instance_id of this CreateReportRequest.

        **参数解释**： 实例ID。可通过查询实例列表接口ID字段获取 **约束限制**： 不涉及 **取值范围**： 以查询实例列表接口值为准，字符长度32-64。 **默认取值**： 不涉及 

        :return: The instance_id of this CreateReportRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this CreateReportRequest.

        **参数解释**： 实例ID。可通过查询实例列表接口ID字段获取 **约束限制**： 不涉及 **取值范围**： 以查询实例列表接口值为准，字符长度32-64。 **默认取值**： 不涉及 

        :param instance_id: The instance_id of this CreateReportRequest.
        :type instance_id: str
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkdbss.v1.CreateReportRequestBody`
        """
        return self._body
