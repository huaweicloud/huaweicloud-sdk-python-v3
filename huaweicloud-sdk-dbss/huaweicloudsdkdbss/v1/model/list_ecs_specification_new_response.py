...
class ListEcsSpecificationNewResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListEcsSpecificationNewResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListEcsSpecificationNewResponse):
            return False
