...
class UpdateDbOmInstanceNameResponse(SdkResponse):
    ...
    def __init__(self, result=None):
        r"""UpdateDbOmInstanceNameResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateDbOmInstanceNameResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateDbOmInstanceNameResponse):
            return False
