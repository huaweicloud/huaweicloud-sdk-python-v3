...
class SetAuditAlarmLogStatusResponse(SdkResponse):
    ...
    def __init__(self, result=None):
        r"""SetAuditAlarmLogStatusResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("SetAuditAlarmLogStatusResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SetAuditAlarmLogStatusResponse):
            return False
