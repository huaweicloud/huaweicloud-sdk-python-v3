...
class UpdateAuditWhitelistResponse(SdkResponse):
    ...
    def __init__(self, status=None):
        r"""UpdateAuditWhitelistResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateAuditWhitelistResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateAuditWhitelistResponse):
            return False
