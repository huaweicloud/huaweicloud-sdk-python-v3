...
class RiskBackupConfig:
    ...
    def backup_domain_id(self):
        r"""Gets the backup_domain_id of this RiskBackupConfig.

        账户ID

        :return: The backup_domain_id of this RiskBackupConfig.
        :rtype: str
        """
    ...
    def backup_domain_id(self, backup_domain_id):
        r"""Sets the backup_domain_id of this RiskBackupConfig.

        账户ID

        :param backup_domain_id: The backup_domain_id of this RiskBackupConfig.
        :type backup_domain_id: str
        """
    ...
    def bucket_name(self):
        r"""Gets the bucket_name of this RiskBackupConfig.

        OBS桶名称

        :return: The bucket_name of this RiskBackupConfig.
        :rtype: str
        """
    ...
    def bucket_name(self, bucket_name):
        r"""Sets the bucket_name of this RiskBackupConfig.

        OBS桶名称

        :param bucket_name: The bucket_name of this RiskBackupConfig.
        :type bucket_name: str
        """
    ...
    def bucket_root_path(self):
        r"""Gets the bucket_root_path of this RiskBackupConfig.

        OBS桶根路径

        :return: The bucket_root_path of this RiskBackupConfig.
        :rtype: str
        """
    ...
    def bucket_root_path(self, bucket_root_path):
        r"""Sets the bucket_root_path of this RiskBackupConfig.

        OBS桶根路径

        :param bucket_root_path: The bucket_root_path of this RiskBackupConfig.
        :type bucket_root_path: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RiskBackupConfig):
            return False
