...
class CountDbClientSessionResponse(SdkResponse):
    ...
    openapi_types = {
        'body': 'list[ReportClientSessionNew]'
    }
    ...
    def __init__(self, body=None):
        r"""CountDbClientSessionResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CountDbClientSessionResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CountDbClientSessionResponse):
            return False
