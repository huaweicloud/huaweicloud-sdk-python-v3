...
class GetDisPolicyRequest:
    ...
    @property
    def date(self):
        r"""Gets the date of this GetDisPolicyRequest.
        ...
        :return: The date of this GetDisPolicyRequest.
        :rtype: str
        """
        return self._date
    ...
    @date.setter
    def date(self, date):
        r"""Sets the date of this GetDisPolicyRequest.

        The date and time when the request is initiated, for example: Wed, 27 Jun 2018 13:39:15 +0000. Default value: None. Condition: If the x-obs-date header is included in the request, this field is optional; otherwise, it is required.

        :param date: The date of this GetDisPolicyRequest.
        :type date: str
        """
        self._date = date
    ...
    def bucket_name(self):
        r"""Gets the bucket_name of this GetDisPolicyRequest.

        The name of the requested bucket.

        :return: The bucket_name of this GetDisPolicyRequest.
        :rtype: str
        """
    ...
    def bucket_name(self, bucket_name):
        r"""Sets the bucket_name of this GetDisPolicyRequest.

        The name of the requested bucket.

        :param bucket_name: The bucket_name of this GetDisPolicyRequest.
        :type bucket_name: str
        """
    ...
    @property
    def dis_policy(self):
        r"""Gets the dis_policy of this GetDisPolicyRequest.

        disPolicy indicates a request to the DIS notification policy API.

        :return: The dis_policy of this GetDisPolicyRequest.
        :rtype: str
        """
    ...
    def dis_policy(self, dis_policy):
        r"""Sets the dis_policy of this GetDisPolicyRequest.

        disPolicy indicates a request to the DIS notification policy API.

        :param dis_policy: The dis_policy of this GetDisPolicyRequest.
        :type dis_policy: str
        """
    ...
    @property
    def host(self):
        r"""Gets the host of this GetDisPolicyRequest.
        ...
        :return: The host of this GetDisPolicyRequest.
        :rtype: str
        """
        return self._host
    ...
    @host.setter
    def host(self, host):
        r"""Sets the host of this GetDisPolicyRequest.

        Parameter description, The access domain name of the bucket, in the format BucketName.Endpoint, for example, examplebucketname.obs.cn-north-4.myhuaweicloud.com.

        :param host: The host of this GetDisPolicyRequest.
        :type host: str
        """
        self._host = host
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetDisPolicyRequest):
            return False
