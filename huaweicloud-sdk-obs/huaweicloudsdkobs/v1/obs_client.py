...
class ObsClient(Client):
    ...
    def delete_dis_policy(self, request):
    ...
    def delete_dis_policy_invoker(self, request):
        http_info = self._delete_dis_policy_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_dis_policy_http_info(cls, request):
        http_info = {
            "method": "DELETE",
            "resource_path": "/",
    ...
    def get_dis_policy(self, request):
    ...
    def get_dis_policy_invoker(self, request):
        http_info = self._get_dis_policy_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _get_dis_policy_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/",
            "request_type": request.__class__.__name__,
    ...
    def set_dis_policy(self, request):
    ...
    def set_dis_policy_invoker(self, request):
        http_info = self._set_dis_policy_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _set_dis_policy_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/",
            "request_type": request.__class__.__name__,
