...
class VehicleDTO:
    ...
    def vehicle_id(self):
        ...
        **参数说明**：车辆唯一标识符。  **取值范围**：长度不超过128，只允许字母、数字、以及_-等字符的组合。 
        ...
        :return: The vehicle_id of this VehicleDTO.
        :rtype: str
        """
    ...
    def vehicle_id(self, vehicle_id):
        ...
        **参数说明**：车辆唯一标识符。  **取值范围**：长度不超过128，只允许字母、数字、以及_-等字符的组合。 
        ...
        :param vehicle_id: The vehicle_id of this VehicleDTO.
        :type vehicle_id: str
        """
    ...
    def plate_no(self):
        ...
        **参数说明**：车牌号。  **取值范围**：长度最小1最大64，支持中文、字母、数字、下划线（_）、横杠（-）的组合。 
        ...
        :return: The plate_no of this VehicleDTO.
        :rtype: str
        """
    ...
    def plate_no(self, plate_no):
        ...
        **参数说明**：车牌号。  **取值范围**：长度最小1最大64，支持中文、字母、数字、下划线（_）、横杠（-）的组合。 
        ...
        :param plate_no: The plate_no of this VehicleDTO.
        :type plate_no: str
        """
    ...
    def vin(self):
        ...
        **参数说明**：VIN码，车辆的17位VIN码。  **取值范围**：长度不超过17，只允许字母、数字字符的组合。 
        ...
        :return: The vin of this VehicleDTO.
        :rtype: str
        """
        return self._vin
    ...
    def vin(self, vin):
        ...
        **参数说明**：VIN码，车辆的17位VIN码。  **取值范围**：长度不超过17，只允许字母、数字字符的组合。 
        ...
        :param vin: The vin of this VehicleDTO.
        :type vin: str
        """
        self._vin = vin
    ...
    def obu_id(self):
        ...
        :return: The obu_id of this VehicleDTO.
        :rtype: str
        """
        return self._obu_id
    ...
    def obu_id(self, obu_id):
        ...
        :param obu_id: The obu_id of this VehicleDTO.
        :type obu_id: str
        """
        self._obu_id = obu_id
    ...
    def imei(self):
        ...
        **参数说明**：IMEI，OBU上电子序列号。  **取值范围**：长度最小1最大255，支持纯数字的组合。 
        ...
        :return: The imei of this VehicleDTO.
        :rtype: str
        """
        return self._imei
    ...
    def imei(self, imei):
        ...
        **参数说明**：IMEI，OBU上电子序列号。  **取值范围**：长度最小1最大255，支持纯数字的组合。 
        ...
        :param imei: The imei of this VehicleDTO.
        :type imei: str
        """
        self._imei = imei
    ...
    def brand(self):
        ...
        **参数说明**：车俩品牌。  **取值范围**：长度最小1最大64，支持中文、字母、数字、下划线（_）、横杠（-）的组合。 
        ...
        :return: The brand of this VehicleDTO.
        :rtype: str
        """
        return self._brand
    ...
    def brand(self, brand):
        ...
        **参数说明**：车俩品牌。  **取值范围**：长度最小1最大64，支持中文、字母、数字、下划线（_）、横杠（-）的组合。 
        ...
        :param brand: The brand of this VehicleDTO.
        :type brand: str
        """
        self._brand = brand
    ...
    def model(self):
        ...
        **参数说明**：车牌型号。  **取值范围**：长度最小1最大64，支持字母、数字、下划线（_）、横杠（-）的组合。 
        ...
        :return: The model of this VehicleDTO.
        :rtype: str
        """
        return self._model
    ...
    def model(self, model):
        ...
        **参数说明**：车牌型号。  **取值范围**：长度最小1最大64，支持字母、数字、下划线（_）、横杠（-）的组合。 
        ...
        :param model: The model of this VehicleDTO.
        :type model: str
        """
        self._model = model
    ...
    def style(self):
        ...
        **参数说明**：车辆年款。  **取值范围**：长度最小1最大64，支持纯数字的组合。 
        ...
        :return: The style of this VehicleDTO.
        :rtype: str
        """
        return self._style
    ...
    def style(self, style):
        ...
        **参数说明**：车辆年款。  **取值范围**：长度最小1最大64，支持纯数字的组合。 
        ...
        :param style: The style of this VehicleDTO.
        :type style: str
        """
        self._style = style
    ...
    def fuel_type(self):
        ...
        **参数说明**：定义车辆的燃料动力类。  **取值范围**： - unknownFuel：未知 - gasoline：汽油 - ethanol：乙醇 - diesel：柴油 - electric：电动 - hybrid：混合燃料类型 - hydrogen：氢气 - natGasLiquid：液化天然气 - natGasComp：压缩天然气 - propane：丙烷\" 
        ...
        :return: The fuel_type of this VehicleDTO.
        :rtype: str
        """
    ...
    def fuel_type(self, fuel_type):
        ...
        **参数说明**：定义车辆的燃料动力类。  **取值范围**： - unknownFuel：未知 - gasoline：汽油 - ethanol：乙醇 - diesel：柴油 - electric：电动 - hybrid：混合燃料类型 - hydrogen：氢气 - natGasLiquid：液化天然气 - natGasComp：压缩天然气 - propane：丙烷\" 
        ...
        :param fuel_type: The fuel_type of this VehicleDTO.
        :type fuel_type: str
        """
    ...
    def color(self):
        ...
        **参数说明**：车辆颜色。  **取值范围**： - black：黑色 - white：白色 - gray：灰色 - red：红色 - blue：蓝色 - yellow：黄色 - orange：橙色 - brown：棕色 - green：绿色 - purple：紫色 - cyan：青色 - pink：粉红色 - transparent：透明色 - other：其他\" 
        ...
        :return: The color of this VehicleDTO.
        :rtype: str
        """
        return self._color
    ...
    def color(self, color):
        ...
        **参数说明**：车辆颜色。  **取值范围**： - black：黑色 - white：白色 - gray：灰色 - red：红色 - blue：蓝色 - yellow：黄色 - orange：橙色 - brown：棕色 - green：绿色 - purple：紫色 - cyan：青色 - pink：粉红色 - transparent：透明色 - other：其他\" 
        ...
        :param color: The color of this VehicleDTO.
        :type color: str
        """
        self._color = color
    ...
    def plate_color(self):
        ...
        **参数说明**：车辆颜色。  **取值范围**： - black：黑色 - white：白色 - blue：蓝色 - yellow：黄色 - green：绿色 
        ...
        :return: The plate_color of this VehicleDTO.
        :rtype: str
        """
    ...
    def plate_color(self, plate_color):
        ...
        **参数说明**：车辆颜色。  **取值范围**： - black：黑色 - white：白色 - blue：蓝色 - yellow：黄色 - green：绿色 
        ...
        :param plate_color: The plate_color of this VehicleDTO.
        :type plate_color: str
        """
    ...
    def access_type(self):
        ...
        **参数说明**：车辆接入网络的方式。  **取值范围**： - 5g - 4g  - 3g  - 2g - pc5Only  - pc5And5g  - pc5And4g  - pc5And3g  - pc5And2g 
        ...
        :return: The access_type of this VehicleDTO.
        :rtype: str
        """
    ...
    def access_type(self, access_type):
        ...
        **参数说明**：车辆接入网络的方式。  **取值范围**： - 5g - 4g  - 3g  - 2g - pc5Only  - pc5And5g  - pc5And4g  - pc5And3g  - pc5And2g 
        ...
        :param access_type: The access_type of this VehicleDTO.
        :type access_type: str
        """
    ...
    def description(self):
        ...
        **参数说明**：描述。  **取值范围**：长度不超过2048，只允许中文、字母、数字、以及_?'#().,&%@!-等字符的组合。 
        ...
        :return: The description of this VehicleDTO.
        :rtype: str
        """
    ...
    def description(self, description):
        ...
        **参数说明**：描述。  **取值范围**：长度不超过2048，只允许中文、字母、数字、以及_?'#().,&%@!-等字符的组合。 
        ...
        :param description: The description of this VehicleDTO.
        :type description: str
        """
    ...
    def last_modified_time(self):
        ...
        **参数说明**：最后修改的时间。格式：yyyy-MM-dd'T'HH:mm:ss'Z' 例如 2020-09-01T01:37:01Z
        ...
        :return: The last_modified_time of this VehicleDTO.
        :rtype: datetime
        """
    ...
    def last_modified_time(self, last_modified_time):
        ...
        **参数说明**：最后修改的时间。格式：yyyy-MM-dd'T'HH:mm:ss'Z' 例如 2020-09-01T01:37:01Z
        ...
        :param last_modified_time: The last_modified_time of this VehicleDTO.
        :type last_modified_time: datetime
        """
    ...
    def created_time(self):
        ...
        **参数说明**：创建的时间。格式：yyyy-MM-dd'T'HH:mm:ss'Z' 例如 2020-09-01T01:37:01Z
        ...
        :return: The created_time of this VehicleDTO.
        :rtype: datetime
        """
    ...
    def created_time(self, created_time):
        ...
        **参数说明**：创建的时间。格式：yyyy-MM-dd'T'HH:mm:ss'Z' 例如 2020-09-01T01:37:01Z
        ...
        :param created_time: The created_time of this VehicleDTO.
        :type created_time: datetime
        """
    ...
    def last_online_time(self):
        ...
        **参数说明**：最后的在线时间。格式：yyyy-MM-dd'T'HH:mm:ss'Z' 例如 2020-09-01T01:37:01Z
        ...
        :return: The last_online_time of this VehicleDTO.
        :rtype: datetime
        """
    ...
    def last_online_time(self, last_online_time):
        ...
        **参数说明**：最后的在线时间。格式：yyyy-MM-dd'T'HH:mm:ss'Z' 例如 2020-09-01T01:37:01Z
        ...
        :param last_online_time: The last_online_time of this VehicleDTO.
        :type last_online_time: datetime
        """
    ...
    def status(self):
        ...
        **参数说明**：设备状态。  **取值范围**： - ONLINE：在线 - OFFLINE：离线 - UNKNOWN：未知状态 
        ...
        :return: The status of this VehicleDTO.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        **参数说明**：设备状态。  **取值范围**： - ONLINE：在线 - OFFLINE：离线 - UNKNOWN：未知状态 
        ...
        :param status: The status of this VehicleDTO.
        :type status: str
        """
        self._status = status
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VehicleDTO):
            return False
