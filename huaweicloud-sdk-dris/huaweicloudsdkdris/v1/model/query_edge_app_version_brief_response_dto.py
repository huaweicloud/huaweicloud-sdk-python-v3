...
class QueryEdgeAppVersionBriefResponseDTO:
    ...
    def created_time(self):
        r"""Gets the created_time of this QueryEdgeAppVersionBriefResponseDTO.

        **参数说明**：创建时间。

        :return: The created_time of this QueryEdgeAppVersionBriefResponseDTO.
        :rtype: str
        """
    ...
    def created_time(self, created_time):
        r"""Sets the created_time of this QueryEdgeAppVersionBriefResponseDTO.

        **参数说明**：创建时间。

        :param created_time: The created_time of this QueryEdgeAppVersionBriefResponseDTO.
        :type created_time: str
        """
    ...
    def last_modified_time(self):
        r"""Gets the last_modified_time of this QueryEdgeAppVersionBriefResponseDTO.

        **参数说明**：最后一次修改时间。

        :return: The last_modified_time of this QueryEdgeAppVersionBriefResponseDTO.
        :rtype: str
        """
    ...
    def last_modified_time(self, last_modified_time):
        r"""Sets the last_modified_time of this QueryEdgeAppVersionBriefResponseDTO.

        **参数说明**：最后一次修改时间。

        :param last_modified_time: The last_modified_time of this QueryEdgeAppVersionBriefResponseDTO.
        :type last_modified_time: str
        """
