...
class CreateEdgeAppResponse(SdkResponse):
    ...
    def edge_app_id(self):
        ...
        **参数说明**：用户自定义应用唯一ID。  **取值范围**：只允许字母、数字、下划线（_）、连接符（-）、美元符号（$）的组合。
        ...
        :return: The edge_app_id of this CreateEdgeAppResponse.
        :rtype: str
        """
    ...
    def description(self):
        ...
        **参数说明**：应用描述。  **取值范围**：只允许中文、字母、数字、下划线（_）、中文分号（；）、中文冒号（：）、中文问号（？）、中文感叹号（！）中文逗号（，）、中文句号（。）、英文引号（;）、英文冒号（:）、英文逗号（,）、英文句号（.）、英文问号（?）、英文感叹号（!）、顿号（、）、连接符（-）的组合。
        ...
        :return: The description of this CreateEdgeAppResponse.
        :rtype: str
        """
    ...
    def created_time(self):
        ...
        **参数说明**：创建时间。
        ...
        :return: The created_time of this CreateEdgeAppResponse.
        :rtype: str
        """
    ...
    def created_time(self, created_time):
        ...
        **参数说明**：创建时间。
        ...
        :param created_time: The created_time of this CreateEdgeAppResponse.
        :type created_time: str
        """
    ...
    def last_modified_time(self):
        ...
        **参数说明**：更新时间。
        ...
        :return: The last_modified_time of this CreateEdgeAppResponse.
        :rtype: str
        """
    ...
    def last_modified_time(self, last_modified_time):
        ...
        **参数说明**：更新时间。
        ...
        :param last_modified_time: The last_modified_time of this CreateEdgeAppResponse.
        :type last_modified_time: str
        """
    ...
    def last_published_version(self):
        ...
        **参数说明**：最新发布版本。
        ...
        :return: The last_published_version of this CreateEdgeAppResponse.
        :rtype: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateEdgeAppResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateEdgeAppResponse):
            return False
