...
class BatchShowIpcsResponse(SdkResponse):
    ...
    @property
    def count(self):
        r"""Gets the count of this BatchShowIpcsResponse.
    ...
    def count(self, count):
        r"""Sets the count of this BatchShowIpcsResponse.
    ...
    @property
    def ipcs(self):
        r"""Gets the ipcs of this BatchShowIpcsResponse.
    ...
    @ipcs.setter
    def ipcs(self, ipcs):
        r"""Sets the ipcs of this BatchShowIpcsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchShowIpcsResponse.to_dict() is deprecated and no longer maintained, "
