...
class CreateEdgeApplicationVersionRequest:
    ...
    def __init__(self, instance_id=None, edge_app_id=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkdris.v1.CreateEdgeApplicationVersionDTO`
        """
    ...
    def instance_id(self):
        r"""Gets the instance_id of this CreateEdgeApplicationVersionRequest.
        ...
        **参数说明**：实例ID。dris物理实例的唯一标识。获取方法参见[获取Instance-Id](https://support.huaweicloud.com/api-v2x/v2x_04_0030.html)。  **取值范围**：仅支持数字，小写字母和连接符（-）的组合，长度36。
        ...
        :return: The instance_id of this CreateEdgeApplicationVersionRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this CreateEdgeApplicationVersionRequest.

        **参数说明**：实例ID。dris物理实例的唯一标识。获取方法参见[获取Instance-Id](https://support.huaweicloud.com/api-v2x/v2x_04_0030.html)。  **取值范围**：仅支持数字，小写字母和连接符（-）的组合，长度36。

        :param instance_id: The instance_id of this CreateEdgeApplicationVersionRequest.
        :type instance_id: str
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkdris.v1.CreateEdgeApplicationVersionDTO`
        """
        return self._body
