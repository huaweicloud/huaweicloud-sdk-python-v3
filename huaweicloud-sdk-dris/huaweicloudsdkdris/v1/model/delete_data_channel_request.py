...
class DeleteDataChannelRequest:
    ...
    def instance_id(self):
        ...
        **参数说明**：实例ID。dris物理实例的唯一标识。获取方法参见[获取Instance-Id](https://support.huaweicloud.com/api-v2x/v2x_04_0030.html)。  **取值范围**：仅支持数字，小写字母和横杠（-）的组合，长度36。
        ...
        :return: The instance_id of this DeleteDataChannelRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        ...
        **参数说明**：实例ID。dris物理实例的唯一标识。获取方法参见[获取Instance-Id](https://support.huaweicloud.com/api-v2x/v2x_04_0030.html)。  **取值范围**：仅支持数字，小写字母和横杠（-）的组合，长度36。
        ...
        :param instance_id: The instance_id of this DeleteDataChannelRequest.
        :type instance_id: str
        """
    ...
    def v2x_edge_id(self):
        ...
        **参数说明**：Edge ID，用于唯一标识一个Edge。
        ...
        :return: The v2x_edge_id of this DeleteDataChannelRequest.
        :rtype: str
        """
    ...
    def v2x_edge_id(self, v2x_edge_id):
        ...
        **参数说明**：Edge ID，用于唯一标识一个Edge。
        ...
        :param v2x_edge_id: The v2x_edge_id of this DeleteDataChannelRequest.
        :type v2x_edge_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteDataChannelRequest):
            return False
