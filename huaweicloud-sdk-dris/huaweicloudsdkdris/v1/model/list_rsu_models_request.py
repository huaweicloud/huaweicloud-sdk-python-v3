...
class ListRsuModelsRequest:
    ...
    def instance_id(self):
        ...
        :return: The instance_id of this ListRsuModelsRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        ...
        :param instance_id: The instance_id of this ListRsuModelsRequest.
        :type instance_id: str
        """
    ...
    def limit(self):
        ...
        **参数说明**：分页查询时每页显示的记录数。
        ...
        :return: The limit of this ListRsuModelsRequest.
        :rtype: int
        """
        return self._limit
    ...
    def limit(self, limit):
        ...
        **参数说明**：分页查询时每页显示的记录数。
        ...
        :param limit: The limit of this ListRsuModelsRequest.
        :type limit: int
        """
        self._limit = limit
    ...
    def manufacturer_name(self):
        ...
        **参数说明**: RSU的厂商名称。  **取值范围**：长度不低于1不超过32，只允许中文、字母、数字、下划线（_）、问号（?）、反引号（'）、井号（#）、左小括号（(）、右小括号（)）、点（.）、逗号（,）、与（&）、百分号（%）、At（@）、感叹号（!）、连接符（-）的组合。 
        ...
        :return: The manufacturer_name of this ListRsuModelsRequest.
        :rtype: str
        """
    ...
    def manufacturer_name(self, manufacturer_name):
        ...
        **参数说明**: RSU的厂商名称。  **取值范围**：长度不低于1不超过32，只允许中文、字母、数字、下划线（_）、问号（?）、反引号（'）、井号（#）、左小括号（(）、右小括号（)）、点（.）、逗号（,）、与（&）、百分号（%）、At（@）、感叹号（!）、连接符（-）的组合。 
        ...
        :param manufacturer_name: The manufacturer_name of this ListRsuModelsRequest.
        :type manufacturer_name: str
        """
    ...
    def offset(self):
        ...
        **参数说明**：分页查询时的页码。
        ...
        :return: The offset of this ListRsuModelsRequest.
        :rtype: int
        """
        return self._offset
    ...
    def offset(self, offset):
        ...
        **参数说明**：分页查询时的页码。
        ...
        :param offset: The offset of this ListRsuModelsRequest.
        :type offset: int
        """
        self._offset = offset
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRsuModelsRequest):
            return False
