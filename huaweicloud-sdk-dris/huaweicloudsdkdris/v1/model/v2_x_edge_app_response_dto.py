...
class V2XEdgeAppResponseDTO:
    ...
    def v2x_edge_id(self):
        ...
        **参数说明**：Edge ID，用于唯一标识一个Edge。
        ...
        :return: The v2x_edge_id of this V2XEdgeAppResponseDTO.
        :rtype: str
        """
    ...
    def v2x_edge_id(self, v2x_edge_id):
        ...
        **参数说明**：Edge ID，用于唯一标识一个Edge。
        ...
        :param v2x_edge_id: The v2x_edge_id of this V2XEdgeAppResponseDTO.
        :type v2x_edge_id: str
        """
    ...
    def edge_app_id(self):
        ...
        **参数说明**：用户自定义应用唯一ID。
        ...
        :return: The edge_app_id of this V2XEdgeAppResponseDTO.
        :rtype: str
        """
    ...
    def edge_app_id(self, edge_app_id):
        ...
        **参数说明**：用户自定义应用唯一ID。
        ...
        :param edge_app_id: The edge_app_id of this V2XEdgeAppResponseDTO.
        :type edge_app_id: str
        """
    ...
    def app_version(self):
        ...
        **参数说明**：应用版本，比如1.0.0。
        ...
        :return: The app_version of this V2XEdgeAppResponseDTO.
        :rtype: str
        """
    ...
    def app_version(self, app_version):
        ...
        **参数说明**：应用版本，比如1.0.0。
        ...
        :param app_version: The app_version of this V2XEdgeAppResponseDTO.
        :type app_version: str
        """
    ...
    def status(self):
        ...
        **参数说明**：应用部署状态。  **取值范围**：  - UNINSTALLED：待部署  - INSTALLED：部署中  - OFFLINE：离线  - ONLINE：在线  - UPGRADING：升级中  - DELETING：删除中  - RUNNING：运行中
        ...
        :return: The status of this V2XEdgeAppResponseDTO.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        **参数说明**：应用部署状态。  **取值范围**：  - UNINSTALLED：待部署  - INSTALLED：部署中  - OFFLINE：离线  - ONLINE：在线  - UPGRADING：升级中  - DELETING：删除中  - RUNNING：运行中
        ...
        :param status: The status of this V2XEdgeAppResponseDTO.
        :type status: str
        """
        self._status = status
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V2XEdgeAppResponseDTO):
            return False
