...
class TrafficControllerDTO:
    ...
    def traffic_controller_id(self):
        ...
        **参数说明**：信号机设备ID，全局唯一。
        ...
        :return: The traffic_controller_id of this TrafficControllerDTO.
        :rtype: str
        """
    ...
    def traffic_controller_id(self, traffic_controller_id):
        ...
        **参数说明**：信号机设备ID，全局唯一。
        ...
        :param traffic_controller_id: The traffic_controller_id of this TrafficControllerDTO.
        :type traffic_controller_id: str
        """
    ...
    def esn(self):
        ...
        :return: The esn of this TrafficControllerDTO.
        :rtype: str
        """
        return self._esn
    ...
    def esn(self, esn):
        ...
        :param esn: The esn of this TrafficControllerDTO.
        :type esn: str
        """
        self._esn = esn
    ...
    def name(self):
        ...
        **参数说明**：名称。
        ...
        :return: The name of this TrafficControllerDTO.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        **参数说明**：名称。
        ...
        :param name: The name of this TrafficControllerDTO.
        :type name: str
        """
        self._name = name
    ...
    def description(self):
        ...
        **参数说明**：描述。  **取值范围**：长度不超过2048，只允许中文、字母、数字、以及_?'#().,&%@!-等字符的组合。 
        ...
        :return: The description of this TrafficControllerDTO.
        :rtype: str
        """
    ...
    def description(self, description):
        ...
        **参数说明**：描述。  **取值范围**：长度不超过2048，只允许中文、字母、数字、以及_?'#().,&%@!-等字符的组合。 
        ...
        :param description: The description of this TrafficControllerDTO.
        :type description: str
        """
    ...
    def lat(self):
        ...
        **参数说明**：定义纬度数值，北纬为正，南纬为负，单位°，精度小数点后7位。
        ...
        :return: The lat of this TrafficControllerDTO.
        :rtype: float
        """
        return self._lat
    ...
    def lat(self, lat):
        ...
        **参数说明**：定义纬度数值，北纬为正，南纬为负，单位°，精度小数点后7位。
        ...
        :param lat: The lat of this TrafficControllerDTO.
        :type lat: float
        """
        self._lat = lat
    ...
    def lon(self):
        ...
        **参数说明**：定义经度数值。东经为正，西经为负，单位°，精度小数点后7位。
        ...
        :return: The lon of this TrafficControllerDTO.
        :rtype: float
        """
        return self._lon
    ...
    def lon(self, lon):
        ...
        **参数说明**：定义经度数值。东经为正，西经为负，单位°，精度小数点后7位。
        ...
        :param lon: The lon of this TrafficControllerDTO.
        :type lon: float
        """
        self._lon = lon
    ...
    def ele(self):
        ...
        **参数说明**：定义海拔高程，可选，单位为分米。
        ...
        :return: The ele of this TrafficControllerDTO.
        :rtype: float
        """
        return self._ele
    ...
    def ele(self, ele):
        ...
        **参数说明**：定义海拔高程，可选，单位为分米。
        ...
        :param ele: The ele of this TrafficControllerDTO.
        :type ele: float
        """
        self._ele = ele
    ...
    def pos_description(self):
        ...
        **参数说明**：位置说明。  **取值范围**：长度不超过128，只允许字母、数字、以及_等字符的组合。 
        ...
        :return: The pos_description of this TrafficControllerDTO.
        :rtype: str
        """
    ...
    def pos_description(self, pos_description):
        ...
        **参数说明**：位置说明。  **取值范围**：长度不超过128，只允许字母、数字、以及_等字符的组合。 
        ...
        :param pos_description: The pos_description of this TrafficControllerDTO.
        :type pos_description: str
        """
    ...
    def installation_mode(self):
        ...
        **参数说明**：架设方式。  **取值范围**： - columnar：柱式 - road-side-attach：路侧附着式 - cantilever：悬臂式 - gantry：门架式 - lane-above-attach：车行道上方附着式 
        ...
        :return: The installation_mode of this TrafficControllerDTO.
        :rtype: str
        """
    ...
    def installation_mode(self, installation_mode):
        ...
        **参数说明**：架设方式。  **取值范围**： - columnar：柱式 - road-side-attach：路侧附着式 - cantilever：悬臂式 - gantry：门架式 - lane-above-attach：车行道上方附着式 
        ...
        :param installation_mode: The installation_mode of this TrafficControllerDTO.
        :type installation_mode: str
        """
    ...
    def road_name(self):
        ...
        **参数说明**：所属道路名称，比如高速名称。  **取值范围**：长度不超过64，只允许汉字、字母、数字、以及_-等字符的组合。 
        ...
        :return: The road_name of this TrafficControllerDTO.
        :rtype: str
        """
    ...
    def road_name(self, road_name):
        ...
        **参数说明**：所属道路名称，比如高速名称。  **取值范围**：长度不超过64，只允许汉字、字母、数字、以及_-等字符的组合。 
        ...
        :param road_name: The road_name of this TrafficControllerDTO.
        :type road_name: str
        """
    ...
    def link_id(self):
        ...
        **参数说明**：信号机设备所属路段ID。  **取值范围**：长度等于30，只允许大写字母、数字。 
        ...
        :return: The link_id of this TrafficControllerDTO.
        :rtype: str
        """
    ...
    def link_id(self, link_id):
        ...
        **参数说明**：信号机设备所属路段ID。  **取值范围**：长度等于30，只允许大写字母、数字。 
        ...
        :param link_id: The link_id of this TrafficControllerDTO.
        :type link_id: str
        """
    ...
    def status(self):
        ...
        **参数说明**：设备状态。  **取值范围**： - ONLINE：在线 - OFFLINE：离线 - INITIAL：初始化 
        ...
        :return: The status of this TrafficControllerDTO.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        **参数说明**：设备状态。  **取值范围**： - ONLINE：在线 - OFFLINE：离线 - INITIAL：初始化 
        ...
        :param status: The status of this TrafficControllerDTO.
        :type status: str
        """
        self._status = status
    ...
    def last_modified_time(self):
        ...
        **参数说明**：最后修改的时间。格式：yyyy-MM-dd'T'HH:mm:ss'Z' 例如 2020-09-01T01:37:01Z
        ...
        :return: The last_modified_time of this TrafficControllerDTO.
        :rtype: datetime
        """
    ...
    def last_modified_time(self, last_modified_time):
        ...
        **参数说明**：最后修改的时间。格式：yyyy-MM-dd'T'HH:mm:ss'Z' 例如 2020-09-01T01:37:01Z
        ...
        :param last_modified_time: The last_modified_time of this TrafficControllerDTO.
        :type last_modified_time: datetime
        """
    ...
    def created_time(self):
        ...
        **参数说明**：创建的时间。格式：yyyy-MM-dd'T'HH:mm:ss'Z' 例如 2020-09-01T01:37:01Z
        ...
        :return: The created_time of this TrafficControllerDTO.
        :rtype: datetime
        """
    ...
    def created_time(self, created_time):
        ...
        **参数说明**：创建的时间。格式：yyyy-MM-dd'T'HH:mm:ss'Z' 例如 2020-09-01T01:37:01Z
        ...
        :param created_time: The created_time of this TrafficControllerDTO.
        :type created_time: datetime
        """
    ...
    def last_online_time(self):
        ...
        **参数说明**：最后的在线时间。格式：yyyy-MM-dd'T'HH:mm:ss'Z' 例如 2020-09-01T01:37:01Z
        ...
        :return: The last_online_time of this TrafficControllerDTO.
        :rtype: datetime
        """
    ...
    def last_online_time(self, last_online_time):
        ...
        **参数说明**：最后的在线时间。格式：yyyy-MM-dd'T'HH:mm:ss'Z' 例如 2020-09-01T01:37:01Z
        ...
        :param last_online_time: The last_online_time of this TrafficControllerDTO.
        :type last_online_time: datetime
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TrafficControllerDTO):
            return False
