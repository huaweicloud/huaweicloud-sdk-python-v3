...
class DeleteV2XEdgeAppByEdgeAppIdRequest:
    ...
    def __init__(self, edge_app_id=None, instance_id=None, v2x_edge_id=None):
        r"""DeleteV2XEdgeAppByEdgeAppIdRequest
    ...
    def edge_app_id(self):
        r"""Gets the edge_app_id of this DeleteV2XEdgeAppByEdgeAppIdRequest.

        **参数说明**：用户自定义应用唯一ID。  **取值范围**：只允许字母、数字、下划线（_）、连接符（-）、美元符号（$）的组合。

        :return: The edge_app_id of this DeleteV2XEdgeAppByEdgeAppIdRequest.
        :rtype: str
        """
    ...
    def edge_app_id(self, edge_app_id):
        r"""Sets the edge_app_id of this DeleteV2XEdgeAppByEdgeAppIdRequest.

        **参数说明**：用户自定义应用唯一ID。  **取值范围**：只允许字母、数字、下划线（_）、连接符（-）、美元符号（$）的组合。

        :param edge_app_id: The edge_app_id of this DeleteV2XEdgeAppByEdgeAppIdRequest.
        :type edge_app_id: str
        """
    ...
    def instance_id(self):
        r"""Gets the instance_id of this DeleteV2XEdgeAppByEdgeAppIdRequest.
        ...
        **参数说明**：实例ID。dris物理实例的唯一标识。获取方法参见[获取Instance-Id](https://support.huaweicloud.com/api-v2x/v2x_04_0030.html)。  **取值范围**：仅支持数字，小写字母和连接符（-）的组合，长度36。
        ...
        :return: The instance_id of this DeleteV2XEdgeAppByEdgeAppIdRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this DeleteV2XEdgeAppByEdgeAppIdRequest.

        **参数说明**：实例ID。dris物理实例的唯一标识。获取方法参见[获取Instance-Id](https://support.huaweicloud.com/api-v2x/v2x_04_0030.html)。  **取值范围**：仅支持数字，小写字母和连接符（-）的组合，长度36。

        :param instance_id: The instance_id of this DeleteV2XEdgeAppByEdgeAppIdRequest.
        :type instance_id: str
        """
    ...
    def v2x_edge_id(self):
        r"""Gets the v2x_edge_id of this DeleteV2XEdgeAppByEdgeAppIdRequest.

        **参数说明**：Edge ID，用于唯一标识一个Edge，创建Edge后获得。方法参见 [创建Edge](https://support.huaweicloud.com/api-v2x/v2x_04_0078.html)。

        :return: The v2x_edge_id of this DeleteV2XEdgeAppByEdgeAppIdRequest.
        :rtype: str
        """
    ...
    def v2x_edge_id(self, v2x_edge_id):
        r"""Sets the v2x_edge_id of this DeleteV2XEdgeAppByEdgeAppIdRequest.

        **参数说明**：Edge ID，用于唯一标识一个Edge，创建Edge后获得。方法参见 [创建Edge](https://support.huaweicloud.com/api-v2x/v2x_04_0078.html)。

        :param v2x_edge_id: The v2x_edge_id of this DeleteV2XEdgeAppByEdgeAppIdRequest.
        :type v2x_edge_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteV2XEdgeAppByEdgeAppIdRequest):
            return False
