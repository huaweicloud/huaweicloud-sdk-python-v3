...
class ImmediateEventDTO:
    ...
    def time_stamp(self):
        ...
        **参数说明**：事件发生时间，毫秒级。  格式：yyyy-MM-dd''T''HH:mm:ss.SSS''Z''  例如 2015-12-12T12:12:12.356Z。
        ...
        :return: The time_stamp of this ImmediateEventDTO.
        :rtype: datetime
        """
    ...
    def time_stamp(self, time_stamp):
        ...
        **参数说明**：事件发生时间，毫秒级。  格式：yyyy-MM-dd''T''HH:mm:ss.SSS''Z''  例如 2015-12-12T12:12:12.356Z。
        ...
        :param time_stamp: The time_stamp of this ImmediateEventDTO.
        :type time_stamp: datetime
        """
    ...
    def event_class(self):
        ...
        **参数说明**：事件类型，参照附录[《国标交通事件及标志列表》](https://support.huaweicloud.com/api-v2x/v2x_04_0101.html)文件。当填写event_type时，event_class为必选。
        ...
        :return: The event_class of this ImmediateEventDTO.
        :rtype: str
        """
    ...
    def event_class(self, event_class):
        ...
        **参数说明**：事件类型，参照附录[《国标交通事件及标志列表》](https://support.huaweicloud.com/api-v2x/v2x_04_0101.html)文件。当填写event_type时，event_class为必选。
        ...
        :param event_class: The event_class of this ImmediateEventDTO.
        :type event_class: str
        """
    ...
    def event_type(self):
        ...
        **参数说明**：事件类型，参照附录[《国标交通事件及标志列表》](https://support.huaweicloud.com/api-v2x/v2x_04_0101.html)文件。
        ...
        :return: The event_type of this ImmediateEventDTO.
        :rtype: int
        """
    ...
    def event_type(self, event_type):
        ...
        **参数说明**：事件类型，参照附录[《国标交通事件及标志列表》](https://support.huaweicloud.com/api-v2x/v2x_04_0101.html)文件。
        ...
        :param event_type: The event_type of this ImmediateEventDTO.
        :type event_type: int
        """
    ...
    def event_source(self):
        ...
        **参数说明**：事件来源类型列表,支持事件来源。  **取值范围**：  - unknown：未知数据  - police：警方数据  - government：政府数据  - meteorological：气象数据  - internet：互联网数据  - detection：检测器检测到的数据  - v2xServer：平台上报数据  - rsu：RSU上报数据  - obu：车载终端上报数据
        ...
        :return: The event_source of this ImmediateEventDTO.
        :rtype: str
        """
    ...
    def event_source(self, event_source):
        ...
        **参数说明**：事件来源类型列表,支持事件来源。  **取值范围**：  - unknown：未知数据  - police：警方数据  - government：政府数据  - meteorological：气象数据  - internet：互联网数据  - detection：检测器检测到的数据  - v2xServer：平台上报数据  - rsu：RSU上报数据  - obu：车载终端上报数据
        ...
        :param event_source: The event_source of this ImmediateEventDTO.
        :type event_source: str
        """
    ...
    def event_source_id(self):
        ...
        **参数说明**：事件来源的ID，由用户自定义。
        ...
        :return: The event_source_id of this ImmediateEventDTO.
        :rtype: str
        """
    ...
    def event_source_id(self, event_source_id):
        ...
        **参数说明**：事件来源的ID，由用户自定义。
        ...
        :param event_source_id: The event_source_id of this ImmediateEventDTO.
        :type event_source_id: str
        """
    ...
    def event_confidence(self):
        ...
        **参数说明**：道路交通事件的信息来源提供的事件置信度水平，帮助接收端判断是否相信该事件信息，可选。
        ...
        :return: The event_confidence of this ImmediateEventDTO.
        :rtype: int
        """
    ...
    def event_confidence(self, event_confidence):
        ...
        **参数说明**：道路交通事件的信息来源提供的事件置信度水平，帮助接收端判断是否相信该事件信息，可选。
        ...
        :param event_confidence: The event_confidence of this ImmediateEventDTO.
        :type event_confidence: int
        """
    ...
    def event_radius(self):
        ...
        **参数说明**：事件的发生区域半径，单位为分米。
        ...
        :return: The event_radius of this ImmediateEventDTO.
        :rtype: int
        """
    ...
    def event_radius(self, event_radius):
        ...
        **参数说明**：事件的发生区域半径，单位为分米。
        ...
        :param event_radius: The event_radius of this ImmediateEventDTO.
        :type event_radius: int
        """
    ...
    def event_priority(self):
        ...
        **参数说明**：事件优先级，0-7，数字越大，级别越高。
        ...
        :return: The event_priority of this ImmediateEventDTO.
        :rtype: int
        """
    ...
    def event_priority(self, event_priority):
        ...
        **参数说明**：事件优先级，0-7，数字越大，级别越高。
        ...
        :param event_priority: The event_priority of this ImmediateEventDTO.
        :type event_priority: int
        """
    ...
    def reference_paths(self):
        ...
        **参数说明**：事件生效的关联路径。
        ...
        :return: The reference_paths of this ImmediateEventDTO.
    ...
    def reference_paths(self, reference_paths):
        ...
        **参数说明**：事件生效的关联路径。
        ...
        :param reference_paths: The reference_paths of this ImmediateEventDTO.
        :type reference_paths: list[:class:`huaweicloudsdkdris.v1.ImmediateEventReferencePath`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ImmediateEventDTO):
            return False
