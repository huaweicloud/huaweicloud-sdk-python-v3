...
class AddForwardingConfigsRequest:
    ...
    openapi_types = {
        'instance_id': 'str',
        'body': 'AddForwardingConfigRequestDTO'
    }
    ...
    def __init__(self, instance_id=None, body=None):
        ...
        :param body: Body of the AddForwardingConfigsRequest
    ...
    def instance_id(self):
        ...
        **参数说明**：实例ID。dris物理实例的唯一标识。获取方法参见[获取Instance-Id](https://support.huaweicloud.com/api-v2x/v2x_04_0030.html)。  **取值范围**：仅支持数字，小写字母和连接符（-）的组合，长度36。
        ...
        :return: The instance_id of this AddForwardingConfigsRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        ...
        **参数说明**：实例ID。dris物理实例的唯一标识。获取方法参见[获取Instance-Id](https://support.huaweicloud.com/api-v2x/v2x_04_0030.html)。  **取值范围**：仅支持数字，小写字母和连接符（-）的组合，长度36。
        ...
        :param instance_id: The instance_id of this AddForwardingConfigsRequest.
        :type instance_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddForwardingConfigsRequest):
            return False
