...
class ImmediateEventPosition3D:
    ...
    @property
    def lat(self):
        r"""Gets the lat of this ImmediateEventPosition3D.
    ...
    @lat.setter
    def lat(self, lat):
        r"""Sets the lat of this ImmediateEventPosition3D.
    ...
    @property
    def lon(self):
        r"""Gets the lon of this ImmediateEventPosition3D.
    ...
    @lon.setter
    def lon(self, lon):
        r"""Sets the lon of this ImmediateEventPosition3D.
    ...
    @property
    def ele(self):
        r"""Gets the ele of this ImmediateEventPosition3D.
    ...
    @ele.setter
    def ele(self, ele):
        r"""Sets the ele of this ImmediateEventPosition3D.
