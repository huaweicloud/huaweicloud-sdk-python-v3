...
class AddV2XEdgeDTO:
    ...
    def __init__(self, name=None, description=None, esn=None, ip=None, port=None, hardware_type=None, position_description=None, location=None, camera_ids=None, radar_ids=None, local_rsus=None, edge_general_config=None, edge_advance_config=None):
        ...
        :param edge_advance_config: **参数说明**：Edge高级配置（请谨慎修改，错误配置将导致edge不可用），Json格式；如果想要删除整个edge_advance_config可以填写空Object（例如:{}）。如果想移除某个配置项，直接从配置数据中移除相应的属性即可
    ...
    def name(self):
        ...
        **参数说明**：名称。  **取值范围**：长度不超过128，只允许中文、字母、数字、以及_.-等字符的组合。
        ...
        :return: The name of this AddV2XEdgeDTO.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        **参数说明**：名称。  **取值范围**：长度不超过128，只允许中文、字母、数字、以及_.-等字符的组合。
        ...
        :param name: The name of this AddV2XEdgeDTO.
        :type name: str
        """
        self._name = name
    ...
    def description(self):
        ...
        **参数说明**：Edge描述。
        ...
        :return: The description of this AddV2XEdgeDTO.
        :rtype: str
        """
    ...
    def description(self, description):
        ...
        **参数说明**：Edge描述。
        ...
        :param description: The description of this AddV2XEdgeDTO.
        :type description: str
        """
    ...
    def esn(self):
        ...
        **参数说明**：设备编码。  **取值范围**：长度不超过64，只允许字母、数字、以及_等字符的组合。
        ...
        :return: The esn of this AddV2XEdgeDTO.
        :rtype: str
        """
        return self._esn
    ...
    def esn(self, esn):
        ...
        **参数说明**：设备编码。  **取值范围**：长度不超过64，只允许字母、数字、以及_等字符的组合。
        ...
        :param esn: The esn of this AddV2XEdgeDTO.
        :type esn: str
        """
        self._esn = esn
    ...
    def ip(self):
        ...
        **参数说明**：网络IP。例如127.0.0.1。
        ...
        :return: The ip of this AddV2XEdgeDTO.
        :rtype: str
        """
        return self._ip
    ...
    def ip(self, ip):
        ...
        **参数说明**：网络IP。例如127.0.0.1。
        ...
        :param ip: The ip of this AddV2XEdgeDTO.
        :type ip: str
        """
        self._ip = ip
    ...
    def port(self):
        ...
        **参数说明**：ITS800,ATLAS 端口号。
        ...
        :return: The port of this AddV2XEdgeDTO.
        :rtype: int
        """
        return self._port
    ...
    def port(self, port):
        ...
        **参数说明**：ITS800,ATLAS 端口号。
        ...
        :param port: The port of this AddV2XEdgeDTO.
        :type port: int
        """
        self._port = port
    ...
    def hardware_type(self):
        ...
        **参数说明**：硬件类型。  **取值范围**：ITS800 或者 ATLAS
        ...
        :return: The hardware_type of this AddV2XEdgeDTO.
        :rtype: str
        """
    ...
    def hardware_type(self, hardware_type):
        ...
        **参数说明**：硬件类型。  **取值范围**：ITS800 或者 ATLAS
        ...
        :param hardware_type: The hardware_type of this AddV2XEdgeDTO.
        :type hardware_type: str
        """
    ...
    def position_description(self):
        ...
        **参数说明**：安装位置编码，由用户自定义。  **取值范围**：长度不低于1不超过128，只允许字母、数字、下划线（_）的组合。
        ...
        :return: The position_description of this AddV2XEdgeDTO.
        :rtype: str
        """
    ...
    def position_description(self, position_description):
        ...
        **参数说明**：安装位置编码，由用户自定义。  **取值范围**：长度不低于1不超过128，只允许字母、数字、下划线（_）的组合。
        ...
        :param position_description: The position_description of this AddV2XEdgeDTO.
        :type position_description: str
        """
    ...
    def camera_ids(self):
        ...
        **参数说明**：摄像头ID列表。
        ...
        :return: The camera_ids of this AddV2XEdgeDTO.
        :rtype: list[str]
        """
    ...
    def camera_ids(self, camera_ids):
        ...
        **参数说明**：摄像头ID列表。
        ...
        :param camera_ids: The camera_ids of this AddV2XEdgeDTO.
        :type camera_ids: list[str]
        """
    ...
    def radar_ids(self):
        ...
        **参数说明**：雷达ID列表。
        ...
        :return: The radar_ids of this AddV2XEdgeDTO.
        :rtype: list[str]
        """
    ...
    def radar_ids(self, radar_ids):
        ...
        **参数说明**：雷达ID列表。
        ...
        :param radar_ids: The radar_ids of this AddV2XEdgeDTO.
        :type radar_ids: list[str]
        """
    ...
    def local_rsus(self):
        ...
        **参数说明**：Edge关联的本地RSU列表。
        ...
        :return: The local_rsus of this AddV2XEdgeDTO.
        :rtype: list[str]
        """
    ...
    def local_rsus(self, local_rsus):
        ...
        **参数说明**：Edge关联的本地RSU列表。
        ...
        :param local_rsus: The local_rsus of this AddV2XEdgeDTO.
        :type local_rsus: list[str]
        """
    ...
    def edge_advance_config(self):
        ...
        **参数说明**：Edge高级配置（请谨慎修改，错误配置将导致edge不可用），Json格式；如果想要删除整个edge_advance_config可以填写空Object（例如:{}）。如果想移除某个配置项，直接从配置数据中移除相应的属性即可
        ...
        :return: The edge_advance_config of this AddV2XEdgeDTO.
        :rtype: object
        """
    ...
    def edge_advance_config(self, edge_advance_config):
        ...
        **参数说明**：Edge高级配置（请谨慎修改，错误配置将导致edge不可用），Json格式；如果想要删除整个edge_advance_config可以填写空Object（例如:{}）。如果想移除某个配置项，直接从配置数据中移除相应的属性即可
        ...
        :param edge_advance_config: The edge_advance_config of this AddV2XEdgeDTO.
        :type edge_advance_config: object
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddV2XEdgeDTO):
            return False
