...
class AddTrafficEventDTO:
    ...
    def event_source_type(self):
        ...
        :return: The event_source_type of this AddTrafficEventDTO.
        :rtype: str
        """
    ...
    def event_source_type(self, event_source_type):
        ...
        :param event_source_type: The event_source_type of this AddTrafficEventDTO.
        :type event_source_type: str
        """
    ...
    def event_source_id(self):
        ...
        **参数说明**：事件来源的ID，由用户自定义。
        ...
        :return: The event_source_id of this AddTrafficEventDTO.
        :rtype: str
        """
    ...
    def event_source_id(self, event_source_id):
        ...
        **参数说明**：事件来源的ID，由用户自定义。
        ...
        :param event_source_id: The event_source_id of this AddTrafficEventDTO.
        :type event_source_id: str
        """
    ...
    def event_class(self):
        ...
        **参数说明**：事件类型，参照附录[《国标交通事件及标志列表》](https://support.huaweicloud.com/api-v2x/v2x_04_0101.html)文件。当填写event_type时，event_class为必选。
        ...
        :return: The event_class of this AddTrafficEventDTO.
        :rtype: str
        """
    ...
    def event_class(self, event_class):
        ...
        **参数说明**：事件类型，参照附录[《国标交通事件及标志列表》](https://support.huaweicloud.com/api-v2x/v2x_04_0101.html)文件。当填写event_type时，event_class为必选。
        ...
        :param event_class: The event_class of this AddTrafficEventDTO.
        :type event_class: str
        """
    ...
    def event_type(self):
        ...
        **参数说明**：事件类型，参照附录[《国标交通事件及标志列表》](https://support.huaweicloud.com/api-v2x/v2x_04_0101.html)文件。
        ...
        :return: The event_type of this AddTrafficEventDTO.
        :rtype: int
        """
    ...
    def event_type(self, event_type):
        ...
        **参数说明**：事件类型，参照附录[《国标交通事件及标志列表》](https://support.huaweicloud.com/api-v2x/v2x_04_0101.html)文件。
        ...
        :param event_type: The event_type of this AddTrafficEventDTO.
        :type event_type: int
        """
    ...
    def area_code(self):
        ...
        **参数说明**：区域码，参考[区域码查询](http://xzqh.mca.gov.cn/map)。
        ...
        :return: The area_code of this AddTrafficEventDTO.
        :rtype: int
        """
    ...
    def area_code(self, area_code):
        ...
        **参数说明**：区域码，参考[区域码查询](http://xzqh.mca.gov.cn/map)。
        ...
        :param area_code: The area_code of this AddTrafficEventDTO.
        :type area_code: int
        """
    ...
    def event_level(self):
        ...
        **参数说明**：事件优先级，0-7越大优先级越高。
        ...
        :return: The event_level of this AddTrafficEventDTO.
        :rtype: int
        """
    ...
    def event_level(self, event_level):
        ...
        **参数说明**：事件优先级，0-7越大优先级越高。
        ...
        :param event_level: The event_level of this AddTrafficEventDTO.
        :type event_level: int
        """
    ...
    def event_params(self):
        ...
        :return: The event_params of this AddTrafficEventDTO.
        :rtype: dict(str, str)
        """
    ...
    def event_params(self, event_params):
        ...
        :param event_params: The event_params of this AddTrafficEventDTO.
        :type event_params: dict(str, str)
        """
    ...
    def event_description(self):
        ...
        **参数说明**：事件描述。支持英文字母、数字、下划线、斜杠、中文及中文常用字符：。 ？ ！ ， 、 ； ： “ ”
        ...
        :return: The event_description of this AddTrafficEventDTO.
        :rtype: str
        """
    ...
    def event_description(self, event_description):
        ...
        **参数说明**：事件描述。支持英文字母、数字、下划线、斜杠、中文及中文常用字符：。 ？ ！ ， 、 ； ： “ ”
        ...
        :param event_description: The event_description of this AddTrafficEventDTO.
        :type event_description: str
        """
    ...
    def reference_paths(self):
        ...
        **参数说明**：事件生效的关联路径，至少需写入起始和终止位置的两个坐标点。
        ...
        :return: The reference_paths of this AddTrafficEventDTO.
    ...
    def reference_paths(self, reference_paths):
        ...
        **参数说明**：事件生效的关联路径，至少需写入起始和终止位置的两个坐标点。
        ...
        :param reference_paths: The reference_paths of this AddTrafficEventDTO.
        :type reference_paths: list[:class:`huaweicloudsdkdris.v1.EventReferencePath`]
        """
    ...
    def event_position_name(self):
        ...
        **参数说明**：事件所在位置。
        ...
        :return: The event_position_name of this AddTrafficEventDTO.
        :rtype: str
        """
    ...
    def event_position_name(self, event_position_name):
        ...
        **参数说明**：事件所在位置。
        ...
        :param event_position_name: The event_position_name of this AddTrafficEventDTO.
        :type event_position_name: str
        """
    ...
    def start_time(self):
        ...
        **参数说明**：开始时间。  格式：yyyy-MM-dd''T''HH:mm:ss''Z''。  例如 2020-09-01T01:37:01Z。 
        ...
        :return: The start_time of this AddTrafficEventDTO.
        :rtype: str
        """
    ...
    def start_time(self, start_time):
        ...
        **参数说明**：开始时间。  格式：yyyy-MM-dd''T''HH:mm:ss''Z''。  例如 2020-09-01T01:37:01Z。 
        ...
        :param start_time: The start_time of this AddTrafficEventDTO.
        :type start_time: str
        """
    ...
    def end_time(self):
        ...
        **参数说明**：结束时间。  格式：yyyy-MM-dd''T''HH:mm:ss''Z''。  例如 2020-09-01T01:37:01Z。 
        ...
        :return: The end_time of this AddTrafficEventDTO.
        :rtype: str
        """
    ...
    def end_time(self, end_time):
        ...
        **参数说明**：结束时间。  格式：yyyy-MM-dd''T''HH:mm:ss''Z''。  例如 2020-09-01T01:37:01Z。 
        ...
        :param end_time: The end_time of this AddTrafficEventDTO.
        :type end_time: str
        """
    ...
    def note(self):
        ...
        **参数说明**：备注。
        ...
        :return: The note of this AddTrafficEventDTO.
        :rtype: str
        """
        return self._note
    ...
    def note(self, note):
        ...
        **参数说明**：备注。
        ...
        :param note: The note of this AddTrafficEventDTO.
        :type note: str
        """
        self._note = note
    ...
    def event_confidence(self):
        ...
        **参数说明**：事件可信度。
        ...
        :return: The event_confidence of this AddTrafficEventDTO.
        :rtype: int
        """
    ...
    def event_confidence(self, event_confidence):
        ...
        **参数说明**：事件可信度。
        ...
        :param event_confidence: The event_confidence of this AddTrafficEventDTO.
        :type event_confidence: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddTrafficEventDTO):
            return False
