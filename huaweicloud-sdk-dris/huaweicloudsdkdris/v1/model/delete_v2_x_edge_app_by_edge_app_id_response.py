...
class DeleteV2XEdgeAppByEdgeAppIdResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteV2XEdgeAppByEdgeAppIdResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteV2XEdgeAppByEdgeAppIdResponse):
            return False
