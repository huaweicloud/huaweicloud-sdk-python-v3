...
class DeleteForwardingConfigRequest:
    ...
    def __init__(self, instance_id=None, forwarding_type=None, forwarding_config_id=None):
        r"""DeleteForwardingConfigRequest
    ...
    def instance_id(self):
        r"""Gets the instance_id of this DeleteForwardingConfigRequest.
        ...
        **参数说明**：实例ID。dris物理实例的唯一标识。获取方法参见[获取Instance-Id](https://support.huaweicloud.com/api-v2x/v2x_04_0030.html)。  **取值范围**：仅支持数字，小写字母和连接符（-）的组合，长度36。
        ...
        :return: The instance_id of this DeleteForwardingConfigRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this DeleteForwardingConfigRequest.

        **参数说明**：实例ID。dris物理实例的唯一标识。获取方法参见[获取Instance-Id](https://support.huaweicloud.com/api-v2x/v2x_04_0030.html)。  **取值范围**：仅支持数字，小写字母和连接符（-）的组合，长度36。

        :param instance_id: The instance_id of this DeleteForwardingConfigRequest.
        :type instance_id: str
        """
    ...
    def forwarding_type(self):
        r"""Gets the forwarding_type of this DeleteForwardingConfigRequest.

        **参数说明**：转发配置的类型。  **取值范围**：当前仅支持“kafka，mrskafka”。

        :return: The forwarding_type of this DeleteForwardingConfigRequest.
        :rtype: str
        """
    ...
    def forwarding_type(self, forwarding_type):
        r"""Sets the forwarding_type of this DeleteForwardingConfigRequest.

        **参数说明**：转发配置的类型。  **取值范围**：当前仅支持“kafka，mrskafka”。

        :param forwarding_type: The forwarding_type of this DeleteForwardingConfigRequest.
        :type forwarding_type: str
        """
    ...
    def forwarding_config_id(self):
        r"""Gets the forwarding_config_id of this DeleteForwardingConfigRequest.

        **参数说明**：转发配置的唯一ID。

        :return: The forwarding_config_id of this DeleteForwardingConfigRequest.
        :rtype: str
        """
    ...
    def forwarding_config_id(self, forwarding_config_id):
        r"""Sets the forwarding_config_id of this DeleteForwardingConfigRequest.

        **参数说明**：转发配置的唯一ID。

        :param forwarding_config_id: The forwarding_config_id of this DeleteForwardingConfigRequest.
        :type forwarding_config_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteForwardingConfigRequest):
            return False
