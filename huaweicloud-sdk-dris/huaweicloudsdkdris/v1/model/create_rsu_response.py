...
class CreateRsuResponse(SdkResponse):
    ...
    @property
    def rsu_id(self):
        r"""Gets the rsu_id of this CreateRsuResponse.

        **参数说明**：RSU的唯一标识符，在平台创建RSU时由平台生成。

        :return: The rsu_id of this CreateRsuResponse.
        :rtype: str
        """
        return self._rsu_id
    ...
    def rsu_id(self, rsu_id):
        r"""Sets the rsu_id of this CreateRsuResponse.

        **参数说明**：RSU的唯一标识符，在平台创建RSU时由平台生成。

        :param rsu_id: The rsu_id of this CreateRsuResponse.
        :type rsu_id: str
        """
        self._rsu_id = rsu_id
    ...
    @property
    def name(self):
        r"""Gets the name of this CreateRsuResponse.

        **参数说明**：RSU的名字。  **取值范围**：长度不低于1不超过128，只允许中文、字母、数字、下划线（_）、连接符（-）的组合。

        :return: The name of this CreateRsuResponse.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this CreateRsuResponse.

        **参数说明**：RSU的名字。  **取值范围**：长度不低于1不超过128，只允许中文、字母、数字、下划线（_）、连接符（-）的组合。

        :param name: The name of this CreateRsuResponse.
        :type name: str
        """
        self._name = name
    ...
    def description(self, description):
        r"""Sets the description of this CreateRsuResponse.

        **参数说明**：RSU的描述。  **取值范围**：只允许中文、字母、数字、下划线（_）、中文分号（；）、中文冒号（：）、中文问号（？）、中文感叹号（！）中文逗号（，）、中文句号（。）、英文分号（;）、英文冒号（:）、英文逗号（,）、英文句号（.）、英文问号（?）、英文感叹号（!）、顿号（、）、连接符（-）的组合。

        :param description: The description of this CreateRsuResponse.
        :type description: str
        """
    ...
    @property
    def esn(self):
        r"""Gets the esn of this CreateRsuResponse.

        **参数说明**：RSU的设备序列号。  **取值范围**：只允许字母、数字、下划线（_）的组合。

        :return: The esn of this CreateRsuResponse.
        :rtype: str
        """
        return self._esn
    ...
    @esn.setter
    def esn(self, esn):
        r"""Sets the esn of this CreateRsuResponse.

        **参数说明**：RSU的设备序列号。  **取值范围**：只允许字母、数字、下划线（_）的组合。

        :param esn: The esn of this CreateRsuResponse.
        :type esn: str
        """
        self._esn = esn
    ...
    def last_modified_time(self):
        r"""Gets the last_modified_time of this CreateRsuResponse.

        **参数说明**：最后修改的时间。  格式：yyyy-MM-dd'T'HH:mm:ss'Z'  例如 2020-09-01T01:37:01Z

        :return: The last_modified_time of this CreateRsuResponse.
        :rtype: datetime
        """
    ...
    def last_modified_time(self, last_modified_time):
        r"""Sets the last_modified_time of this CreateRsuResponse.

        **参数说明**：最后修改的时间。  格式：yyyy-MM-dd'T'HH:mm:ss'Z'  例如 2020-09-01T01:37:01Z

        :param last_modified_time: The last_modified_time of this CreateRsuResponse.
        :type last_modified_time: datetime
        """
    ...
    def created_time(self):
        r"""Gets the created_time of this CreateRsuResponse.

        **参数说明**：创建的时间。  格式：yyyy-MM-dd'T'HH:mm:ss'Z'  例如 2020-09-01T01:37:01Z

        :return: The created_time of this CreateRsuResponse.
        :rtype: datetime
        """
    ...
    def created_time(self, created_time):
        r"""Sets the created_time of this CreateRsuResponse.

        **参数说明**：创建的时间。  格式：yyyy-MM-dd'T'HH:mm:ss'Z'  例如 2020-09-01T01:37:01Z

        :param created_time: The created_time of this CreateRsuResponse.
        :type created_time: datetime
        """
    ...
    def last_online_time(self):
        r"""Gets the last_online_time of this CreateRsuResponse.

        **参数说明**：最后的在线时间。  格式：yyyy-MM-dd'T'HH:mm:ss'Z'  例如 2020-09-01T01:37:01Z

        :return: The last_online_time of this CreateRsuResponse.
        :rtype: datetime
        """
    ...
    def last_online_time(self, last_online_time):
        r"""Sets the last_online_time of this CreateRsuResponse.

        **参数说明**：最后的在线时间。  格式：yyyy-MM-dd'T'HH:mm:ss'Z'  例如 2020-09-01T01:37:01Z

        :param last_online_time: The last_online_time of this CreateRsuResponse.
        :type last_online_time: datetime
        """
    ...
    @property
    def ip(self):
        r"""Gets the ip of this CreateRsuResponse.

        **参数说明**：RSU的IP。满足IP的格式，例如127.0.0.1。

        :return: The ip of this CreateRsuResponse.
        :rtype: str
        """
        return self._ip
    ...
    @ip.setter
    def ip(self, ip):
        r"""Sets the ip of this CreateRsuResponse.

        **参数说明**：RSU的IP。满足IP的格式，例如127.0.0.1。

        :param ip: The ip of this CreateRsuResponse.
        :type ip: str
        """
        self._ip = ip
    ...
    def position_description(self):
        r"""Gets the position_description of this CreateRsuResponse.

        **参数说明**：安装位置编码，由用户自定义。  **取值范围**：长度不低于1不超过128，只允许字母、数字、下划线（_）的组合。

        :return: The position_description of this CreateRsuResponse.
        :rtype: str
        """
    ...
    def position_description(self, position_description):
        r"""Sets the position_description of this CreateRsuResponse.

        **参数说明**：安装位置编码，由用户自定义。  **取值范围**：长度不低于1不超过128，只允许字母、数字、下划线（_）的组合。

        :param position_description: The position_description of this CreateRsuResponse.
        :type position_description: str
        """
    ...
    @property
    def location(self):
        r"""Gets the location of this CreateRsuResponse.

        :return: The location of this CreateRsuResponse.
    ...
    def location(self, location):
        r"""Sets the location of this CreateRsuResponse.

        :param location: The location of this CreateRsuResponse.
        :type location: :class:`huaweicloudsdkdris.v1.RsuLocation`
        """
    ...
    @property
    def status(self):
        r"""Gets the status of this CreateRsuResponse.

        **参数说明**：RSU设备状态。  **取值范围**：  - ONLINE：在线  - OFFLINE：离线  - INITIAL：初始化  - UNKNOWN：未知

        :return: The status of this CreateRsuResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        r"""Sets the status of this CreateRsuResponse.

        **参数说明**：RSU设备状态。  **取值范围**：  - ONLINE：在线  - OFFLINE：离线  - INITIAL：初始化  - UNKNOWN：未知

        :param status: The status of this CreateRsuResponse.
        :type status: str
        """
        self._status = status
    ...
    def rsu_model_id(self):
        r"""Gets the rsu_model_id of this CreateRsuResponse.
        ...
        **参数说明**：RSU型号ID，用于唯一标识一个RSU型号，在平台创建RSU型号后由平台分配获得，获取方法可参见 [创建RSU型号](https://support.huaweicloud.com/api-v2x/v2x_04_0020.html)。  **取值范围**：长度不低于1不超过36，只允许字母、数字、连接符（-）的组合。  **该字段仅供使用MQTT协议RSU设备的用户输入。使用websocket协议RSU设备的用户需忽略此字段。**
        ...
        :return: The rsu_model_id of this CreateRsuResponse.
        :rtype: str
        """
    ...
    def rsu_model_id(self, rsu_model_id):
        r"""Sets the rsu_model_id of this CreateRsuResponse.

        **参数说明**：RSU型号ID，用于唯一标识一个RSU型号，在平台创建RSU型号后由平台分配获得，获取方法可参见 [创建RSU型号](https://support.huaweicloud.com/api-v2x/v2x_04_0020.html)。  **取值范围**：长度不低于1不超过36，只允许字母、数字、连接符（-）的组合。  **该字段仅供使用MQTT协议RSU设备的用户输入。使用websocket协议RSU设备的用户需忽略此字段。**

        :param rsu_model_id: The rsu_model_id of this CreateRsuResponse.
        :type rsu_model_id: str
        """
    ...
    def intersection_id(self, intersection_id):
        r"""Sets the intersection_id of this CreateRsuResponse.

        **参数说明**：在地图中，rsu所在区域对应的路口ID，也即区域ID拼接路口ID，格式为：region-node_id。其中路网最基本的构成即节点和节点之间连接的路段。节点可以是路口，也可以是一条 路的端点。一个节点的ID在同一个区域内是唯一的。

        :param intersection_id: The intersection_id of this CreateRsuResponse.
        :type intersection_id: str
        """
    ...
    def related_edge_num(self):
        r"""Gets the related_edge_num of this CreateRsuResponse.

        **参数说明**：RSU可关联的Edge的数量。

        :return: The related_edge_num of this CreateRsuResponse.
        :rtype: int
        """
    ...
    def related_edge_num(self, related_edge_num):
        r"""Sets the related_edge_num of this CreateRsuResponse.

        **参数说明**：RSU可关联的Edge的数量。

        :param related_edge_num: The related_edge_num of this CreateRsuResponse.
        :type related_edge_num: int
        """
    ...
    def software_version(self):
        r"""Gets the software_version of this CreateRsuResponse.

        **参数说明**：RSU的软件版本，由RSU上报其软件版本。

        :return: The software_version of this CreateRsuResponse.
        :rtype: str
        """
    ...
    def software_version(self, software_version):
        r"""Sets the software_version of this CreateRsuResponse.

        **参数说明**：RSU的软件版本，由RSU上报其软件版本。

        :param software_version: The software_version of this CreateRsuResponse.
        :type software_version: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateRsuResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateRsuResponse):
            return False
