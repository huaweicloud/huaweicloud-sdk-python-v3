...
class CreateRsuModelResponse(SdkResponse):
    ...
    def rsu_model_id(self):
        ...
        **参数说明**：RSU型号ID，用于唯一标识一个RSU型号，在平台创建RSU型号后由平台分配获得。  **取值范围**：长度不小于1不超过36，只允许字母、数字、连接符（-）的组合。
        ...
        :return: The rsu_model_id of this CreateRsuModelResponse.
        :rtype: str
        """
    ...
    def rsu_model_id(self, rsu_model_id):
        ...
        **参数说明**：RSU型号ID，用于唯一标识一个RSU型号，在平台创建RSU型号后由平台分配获得。  **取值范围**：长度不小于1不超过36，只允许字母、数字、连接符（-）的组合。
        ...
        :param rsu_model_id: The rsu_model_id of this CreateRsuModelResponse.
        :type rsu_model_id: str
        """
    ...
    def name(self):
        ...
        **参数说明**: RSU型号名称。  **取值范围**：长度不低于1不超过64，只允许中文、字母、数字、下划线（_）、问号（?）、反引号（'）、井号（#）、左小括号（(）、右小括号（)）、点（.）、逗号（,）、与（&）、百分号（%）、At（@）、感叹号（!）、连接符（-）的组合。
        ...
        :return: The name of this CreateRsuModelResponse.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        **参数说明**: RSU型号名称。  **取值范围**：长度不低于1不超过64，只允许中文、字母、数字、下划线（_）、问号（?）、反引号（'）、井号（#）、左小括号（(）、右小括号（)）、点（.）、逗号（,）、与（&）、百分号（%）、At（@）、感叹号（!）、连接符（-）的组合。
        ...
        :param name: The name of this CreateRsuModelResponse.
        :type name: str
        """
        self._name = name
    ...
    def manufacturer_name(self):
        ...
        **参数说明**: RSU的厂商名称。  **取值范围**：长度不低于1不超过32，只允许中文、字母、数字、下划线（_）、问号（?）、反引号（'）、井号（#）、左小括号（(）、右小括号（)）、点（.）、逗号（,）、与（&）、百分号（%）、At（@）、感叹号（!）、连接符（-）的组合。
        ...
        :return: The manufacturer_name of this CreateRsuModelResponse.
        :rtype: str
        """
    ...
    def manufacturer_name(self, manufacturer_name):
        ...
        **参数说明**: RSU的厂商名称。  **取值范围**：长度不低于1不超过32，只允许中文、字母、数字、下划线（_）、问号（?）、反引号（'）、井号（#）、左小括号（(）、右小括号（)）、点（.）、逗号（,）、与（&）、百分号（%）、At（@）、感叹号（!）、连接符（-）的组合。
        ...
        :param manufacturer_name: The manufacturer_name of this CreateRsuModelResponse.
        :type manufacturer_name: str
        """
    ...
    def description(self):
        ...
        **参数说明**: RSU型号的描述信息。  **取值范围**：长度不低于1不超过128，只允许中文、字母、数字、下划线（_）、问号（?）、反引号（'）、井号（#）、左小括号（(）、右小括号（)）、点（.）、逗号（,）、与（&）、百分号（%）、At（@）、感叹号（!）、连接符（-）的组合。
        ...
        :return: The description of this CreateRsuModelResponse.
        :rtype: str
        """
    ...
    def description(self, description):
        ...
        **参数说明**: RSU型号的描述信息。  **取值范围**：长度不低于1不超过128，只允许中文、字母、数字、下划线（_）、问号（?）、反引号（'）、井号（#）、左小括号（(）、右小括号（)）、点（.）、逗号（,）、与（&）、百分号（%）、At（@）、感叹号（!）、连接符（-）的组合。
        ...
        :param description: The description of this CreateRsuModelResponse.
        :type description: str
        """
    ...
    def last_modified_time(self):
        ...
        **参数说明**: RSU型号更新的时间。  格式：yyyy-MM-dd'T'HH:mm:ss'Z'  例如：2020-12-07T01:32:17Z
        ...
        :return: The last_modified_time of this CreateRsuModelResponse.
        :rtype: datetime
        """
    ...
    def last_modified_time(self, last_modified_time):
        ...
        **参数说明**: RSU型号更新的时间。  格式：yyyy-MM-dd'T'HH:mm:ss'Z'  例如：2020-12-07T01:32:17Z
        ...
        :param last_modified_time: The last_modified_time of this CreateRsuModelResponse.
        :type last_modified_time: datetime
        """
    ...
    def created_time(self):
        ...
        **参数说明**: 在平台创建RSU型号的时间。  格式：yyyy-MM-dd'T'HH:mm:ss'Z'  例如：2020-12-07T01:32:17Z
        ...
        :return: The created_time of this CreateRsuModelResponse.
        :rtype: datetime
        """
    ...
    def created_time(self, created_time):
        ...
        **参数说明**: 在平台创建RSU型号的时间。  格式：yyyy-MM-dd'T'HH:mm:ss'Z'  例如：2020-12-07T01:32:17Z
        ...
        :param created_time: The created_time of this CreateRsuModelResponse.
        :type created_time: datetime
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateRsuModelResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateRsuModelResponse):
            return False
