...
class ListIssuesV4Response(SdkResponse):
    ...
    @property
    def issues(self):
        r"""Gets the issues of this ListIssuesV4Response.
    ...
    def issues(self, issues):
        r"""Sets the issues of this ListIssuesV4Response.
    ...
    @property
    def total(self):
        r"""Gets the total of this ListIssuesV4Response.

        总数

        :return: The total of this ListIssuesV4Response.
        :rtype: int
        """
        return self._total
    ...
    def total(self, total):
        r"""Sets the total of this ListIssuesV4Response.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListIssuesV4Response):
            return False
