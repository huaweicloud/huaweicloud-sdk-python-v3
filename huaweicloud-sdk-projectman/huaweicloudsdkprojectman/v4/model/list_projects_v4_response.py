...
class ListProjectsV4Response(SdkResponse):
    ...
    def __init__(self, projects=None, total=None):
        ...
        :type projects: list[:class:`huaweicloudsdkprojectman.v4.ListProjectsV4ResponseBodyProjects`]
        :param total: 项目总数
        :type total: int
        """
    ...
    def projects(self):
        ...
        :rtype: list[:class:`huaweicloudsdkprojectman.v4.ListProjectsV4ResponseBodyProjects`]
        """
    ...
    @property
    def total(self):
        r"""Gets the total of this ListProjectsV4Response.
    ...
    def total(self, total):
        r"""Sets the total of this ListProjectsV4Response.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListProjectsV4Response.to_dict() is deprecated and no longer maintained, "
