...
class IssueItemSfV4Domain:
    ...
    @property
    def id(self):
        r"""Gets the id of this IssueItemSfV4Domain.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this IssueItemSfV4Domain.
    ...
    @property
    def name(self):
        r"""Gets the name of this IssueItemSfV4Domain.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this IssueItemSfV4Domain.
