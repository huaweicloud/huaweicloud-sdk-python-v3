...
class BatchUpdateChildNickNamesRequest:
    ...
    openapi_types = {
        'body': 'BatchUpdateChildUserNickNamesRequestBody'
    }
    ...
    def __init__(self, body=None):
        """BatchUpdateChildNickNamesRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: BatchUpdateChildUserNickNamesRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchUpdateChildNickNamesRequest):
            return False
