...
class ListProjectDemandStaticV4Response(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListProjectDemandStaticV4Response.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListProjectDemandStaticV4Response):
            return False
