...
class CreateIpdProjectIssueRequest:
    ...
    def __init__(self, project_id=None, body=None):
        r"""CreateIpdProjectIssueRequest
    ...
    @property
    def project_id(self):
        r"""Gets the project_id of this CreateIpdProjectIssueRequest.

        devcloud项目的32位id

        :return: The project_id of this CreateIpdProjectIssueRequest.
        :rtype: str
        """
    ...
    def project_id(self, project_id):
        r"""Sets the project_id of this CreateIpdProjectIssueRequest.

        devcloud项目的32位id

        :param project_id: The project_id of this CreateIpdProjectIssueRequest.
        :type project_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateIpdProjectIssueRequest):
            return False
