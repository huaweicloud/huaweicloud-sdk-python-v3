...
class CheckProjectNameV4Request:
    ...
    openapi_types = {
        'body': 'CheckProjectNameRequestV4'
    }
    ...
    def __init__(self, body=None):
        """CheckProjectNameV4Request - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: CheckProjectNameRequestV4
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CheckProjectNameV4Request):
            return False
