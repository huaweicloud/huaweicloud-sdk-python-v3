...
class ListSpecIssueStayTimesRequest:
    ...
    openapi_types = {
        'body': 'ListSpecIssueStayTimesRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ListSpecIssueStayTimesRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListSpecIssueStayTimesRequest):
            return False
