...
class RunImageTaggingRequest(object):
    ...
    @property
    def body(self):
        """Gets the body of this RunImageTaggingRequest.
    ...
    @body.setter
    def body(self, body):
        """Sets the body of this RunImageTaggingRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunImageTaggingRequest):
            return False
