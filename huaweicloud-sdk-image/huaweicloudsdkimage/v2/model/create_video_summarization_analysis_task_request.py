...
class CreateVideoSummarizationAnalysisTaskRequest:
    ...
    def __init__(self, body=None):
        """CreateVideoSummarizationAnalysisTaskRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateVideoSummarizationAnalysisTaskRequest):
            return False
