...
class ImageHighresolutionMattingRequestBody:
    ...
    @property
    def output(self):
        """Gets the output of this ImageHighresolutionMattingRequestBody.

        :return: The output of this ImageHighresolutionMattingRequestBody.
    ...
    def output(self, output):
        """Sets the output of this ImageHighresolutionMattingRequestBody.

        :param output: The output of this ImageHighresolutionMattingRequestBody.
        :type output: :class:`huaweicloudsdkimage.v2.TaskOutput`
        """
        self._output = output
    ...
    def param_callback(self):
        """Gets the param_callback of this ImageHighresolutionMattingRequestBody.

        :return: The param_callback of this ImageHighresolutionMattingRequestBody.
    ...
    def param_callback(self, param_callback):
        """Sets the param_callback of this ImageHighresolutionMattingRequestBody.

        :param param_callback: The param_callback of this ImageHighresolutionMattingRequestBody.
        :type param_callback: :class:`huaweicloudsdkimage.v2.TaskCallback`
        """
    ...
    @property
    def config(self):
        """Gets the config of this ImageHighresolutionMattingRequestBody.

        :return: The config of this ImageHighresolutionMattingRequestBody.
    ...
    def config(self, config):
        """Sets the config of this ImageHighresolutionMattingRequestBody.

        :param config: The config of this ImageHighresolutionMattingRequestBody.
        :type config: :class:`huaweicloudsdkimage.v2.ImageHighresolutionMattingConfig`
        """
        self._config = config
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ImageHighresolutionMattingRequestBody):
            return False
