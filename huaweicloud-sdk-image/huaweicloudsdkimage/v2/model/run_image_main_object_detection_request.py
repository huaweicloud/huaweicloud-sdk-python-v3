...
class RunImageMainObjectDetectionRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the RunImageMainObjectDetectionRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunImageMainObjectDetectionRequest):
            return False
