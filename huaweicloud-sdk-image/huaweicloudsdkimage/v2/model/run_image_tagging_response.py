...
class RunImageTaggingResponse(SdkResponse):
    ...
    openapi_types = {
        'result': 'ImageTaggingResponseResult'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("RunImageTaggingResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunImageTaggingResponse):
            return False
