...
class RunRecaptureDetectResponse(SdkResponse):
    ...
    openapi_types = {
        'result': 'RecaptureDetectResponseResult'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("RunRecaptureDetectResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunRecaptureDetectResponse):
            return False
