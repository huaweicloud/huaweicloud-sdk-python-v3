...
class RunImageMediaTaggingRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the RunImageMediaTaggingRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunImageMediaTaggingRequest):
            return False
