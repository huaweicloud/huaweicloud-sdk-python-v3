...
class CreateTimerRuleResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateTimerRuleResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateTimerRuleResponse):
            return False
