...
class ExecuteActionResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ExecuteActionResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExecuteActionResponse):
            return False
