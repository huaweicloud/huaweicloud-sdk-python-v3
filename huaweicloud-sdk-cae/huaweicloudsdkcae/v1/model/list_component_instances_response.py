...
class ListComponentInstancesResponse(SdkResponse):
    ...
    def __init__(self, api_version=None, kind=None, items=None):
        ...
        :param kind: API类型，固定值“ComponentInstance”，该值不可修改。
        :type kind: str
        :param items: 组件实例列表。
        :type items: list[:class:`huaweicloudsdkcae.v1.Instance`]
        """
        
        super(ListComponentInstancesResponse, self).__init__()
    ...
    def items(self):
        ...
        :return: The items of this ListComponentInstancesResponse.
    ...
    def items(self, items):
        ...
        :param items: The items of this ListComponentInstancesResponse.
        :type items: list[:class:`huaweicloudsdkcae.v1.Instance`]
        """
        self._items = items
