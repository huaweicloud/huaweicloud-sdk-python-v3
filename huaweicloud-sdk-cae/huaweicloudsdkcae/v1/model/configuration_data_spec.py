...
class ConfigurationDataSpec:
    ...
    def __init__(self, ip=None, rds_id=None, rds_db_name=None, rds_address=None, rds_username=None, rds_password=None, rds_port=None, config_center_addr=None, service_center_addr=None, cse_id=None, envs=None, items=None, max_replica_count=None, triggers=None, volumes=None, liveness_probe=None, startup_probe=None, readiness_probe=None, post_start=None, pre_stop=None, log_paths=None, access_key=None, access_value=None, business=None, image_pull_policy=None, version=None, path=None, port=None, metrics=None):
        ...
        :param log_paths: 自定义日志路径。
        :type log_paths: list[object]
        :param access_key: 性能管理配置访问密钥Key。
        :type access_key: str
        :param access_value: 性能管理配置访问密钥value。
        :type access_value: str
        :param business: 性能管理配置应用。
        :type business: str
        :param image_pull_policy: 性能管理配置升级策略。 - 重启自动升级：每次都尝试重新下载镜像。 - 手动升级: 如果本地有该镜像，则继续使用本地镜像，不下载镜像。
        :type image_pull_policy: str
        :param version: 性能管理配置探针版本。
        :type version: str
        :param path: 自定义监控指标配置采集路径。
        :type path: str
        :param port: 自定义监控指标配置采集端口。
        :type port: str
        :param metrics: 自定义监控指标配置指标名称。
