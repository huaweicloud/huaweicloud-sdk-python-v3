...
class BatchDeleteScheduleTaskReq:
    ...
    def items(self):
        ...
        :return: The items of this BatchDeleteScheduleTaskReq.
        :rtype: list[str]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :param items: The items of this BatchDeleteScheduleTaskReq.
        :type items: list[str]
        """
        self._items = items
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteScheduleTaskReq):
            return False
