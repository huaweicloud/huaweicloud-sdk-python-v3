...
class BatchDeleteServerGroupTagsRequest:
    ...
    openapi_types = {
        'body': 'BatchDeleteServerGroupTagsReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchDeleteServerGroupTagsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteServerGroupTagsRequest):
            return False
