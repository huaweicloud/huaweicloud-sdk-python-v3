...
class BatchMigrateHostsServerRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchMigrateHostsServerRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchMigrateHostsServerRequest):
            return False
