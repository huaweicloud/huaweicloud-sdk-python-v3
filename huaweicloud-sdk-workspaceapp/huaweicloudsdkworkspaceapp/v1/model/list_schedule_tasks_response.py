...
class ListScheduleTasksResponse(SdkResponse):
    ...
    def __init__(self, count=None, items=None):
        ...
        :param count: 总数。
        :type count: int
        :param items: 定时任务列表，返回列表条目数量上限为分页的最大上限值。
        :type items: list[:class:`huaweicloudsdkworkspaceapp.v1.ScheduleTask`]
        """
    ...
    def count(self):
        ...
        :return: The count of this ListScheduleTasksResponse.
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        ...
        :param count: The count of this ListScheduleTasksResponse.
        :type count: int
        """
        self._count = count
    ...
    def items(self):
        ...
        :return: The items of this ListScheduleTasksResponse.
        :rtype: list[:class:`huaweicloudsdkworkspaceapp.v1.ScheduleTask`]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :param items: The items of this ListScheduleTasksResponse.
        :type items: list[:class:`huaweicloudsdkworkspaceapp.v1.ScheduleTask`]
        """
        self._items = items
