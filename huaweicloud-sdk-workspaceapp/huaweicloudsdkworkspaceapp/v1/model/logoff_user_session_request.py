...
class LogoffUserSessionRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the LogoffUserSessionRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LogoffUserSessionRequest):
            return False
