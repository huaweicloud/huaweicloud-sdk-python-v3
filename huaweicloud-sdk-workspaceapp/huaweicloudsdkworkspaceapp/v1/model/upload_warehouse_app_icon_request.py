...
class UploadWarehouseAppIconRequest:
    ...
    openapi_types = {
        'body': 'UploadWarehouseAppIconRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the UploadWarehouseAppIconRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadWarehouseAppIconRequest):
            return False
