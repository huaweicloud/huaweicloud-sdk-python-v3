...
class CreateOrderRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateOrderRequest
        :type body: :class:`huaweicloudsdkworkspaceapp.v1.CreateOrderReq`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkworkspaceapp.v1.CreateOrderReq`
        """
        return self._body
