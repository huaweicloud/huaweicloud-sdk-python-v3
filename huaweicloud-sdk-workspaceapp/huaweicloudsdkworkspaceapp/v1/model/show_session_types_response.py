...
class ShowSessionTypesResponse(SdkResponse):
    ...
    def session_types(self):
        ...
        :return: The session_types of this ShowSessionTypesResponse.
    ...
    def session_types(self, session_types):
        ...
        :param session_types: The session_types of this ShowSessionTypesResponse.
        :type session_types: list[:class:`huaweicloudsdkworkspaceapp.v1.SessionTypeEntity`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowSessionTypesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowSessionTypesResponse):
            return False
