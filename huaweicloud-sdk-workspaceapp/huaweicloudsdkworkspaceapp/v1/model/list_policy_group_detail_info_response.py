...
class ListPolicyGroupDetailInfoResponse(SdkResponse):
    ...
    def count(self):
        ...
        :return: The count of this ListPolicyGroupDetailInfoResponse.
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        ...
        :param count: The count of this ListPolicyGroupDetailInfoResponse.
        :type count: int
        """
        self._count = count
    ...
    def items(self):
        ...
        :return: The items of this ListPolicyGroupDetailInfoResponse.
    ...
    def items(self, items):
        ...
        :param items: The items of this ListPolicyGroupDetailInfoResponse.
        :type items: list[:class:`huaweicloudsdkworkspaceapp.v1.PolicyGroup`]
        """
        self._items = items
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListPolicyGroupDetailInfoResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListPolicyGroupDetailInfoResponse):
            return False
