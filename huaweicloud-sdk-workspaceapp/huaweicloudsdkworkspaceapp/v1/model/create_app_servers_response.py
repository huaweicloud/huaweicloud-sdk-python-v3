...
class CreateAppServersResponse(SdkResponse):
    ...
    @property
    def order_id(self):
        r"""Gets the order_id of this CreateAppServersResponse.
    ...
    def order_id(self, order_id):
        r"""Sets the order_id of this CreateAppServersResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateAppServersResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateAppServersResponse):
            return False
