...
class BatchDeleteWarehouseAppRequest:
    ...
    openapi_types = {
        'body': 'BatchDeleteWarehouseAppReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchDeleteWarehouseAppRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteWarehouseAppRequest):
            return False
