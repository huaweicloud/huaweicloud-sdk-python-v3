...
class ListUserConnectionResponse(SdkResponse):
    ...
    @property
    def count(self):
        r"""Gets the count of this ListUserConnectionResponse.
    ...
    def count(self, count):
        r"""Sets the count of this ListUserConnectionResponse.
    ...
    @property
    def items(self):
        r"""Gets the items of this ListUserConnectionResponse.
    ...
    def items(self, items):
        r"""Sets the items of this ListUserConnectionResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListUserConnectionResponse.to_dict() is deprecated and no longer maintained, "
