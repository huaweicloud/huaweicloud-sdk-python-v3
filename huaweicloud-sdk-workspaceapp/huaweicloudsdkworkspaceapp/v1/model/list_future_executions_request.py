...
class ListFutureExecutionsRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ListFutureExecutionsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListFutureExecutionsRequest):
            return False
