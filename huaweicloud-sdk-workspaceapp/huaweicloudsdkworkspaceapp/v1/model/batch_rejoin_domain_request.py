...
class BatchRejoinDomainRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchRejoinDomainRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchRejoinDomainRequest):
            return False
