...
class CreateHotspotSessionConfigResponse(SdkResponse):
    ...
    def __init__(self, id=None, hotspot_session_migration_enable=None, hotspot_exit_session_num=None, non_migrate_users=None):
        r"""CreateHotspotSessionConfigResponse
    ...
    @property
    def id(self):
        r"""Gets the id of this CreateHotspotSessionConfigResponse.

        唯一标识。

        :return: The id of this CreateHotspotSessionConfigResponse.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this CreateHotspotSessionConfigResponse.

        唯一标识。

        :param id: The id of this CreateHotspotSessionConfigResponse.
        :type id: str
        """
        self._id = id
    ...
    def hotspot_session_migration_enable(self):
        r"""Gets the hotspot_session_migration_enable of this CreateHotspotSessionConfigResponse.

        是否开启热点会话迁移。取值为： false：表示关闭。 true：表示开启。

        :return: The hotspot_session_migration_enable of this CreateHotspotSessionConfigResponse.
        :rtype: bool
        """
    ...
    def hotspot_session_migration_enable(self, hotspot_session_migration_enable):
        r"""Sets the hotspot_session_migration_enable of this CreateHotspotSessionConfigResponse.

        是否开启热点会话迁移。取值为： false：表示关闭。 true：表示开启。

        :param hotspot_session_migration_enable: The hotspot_session_migration_enable of this CreateHotspotSessionConfigResponse.
        :type hotspot_session_migration_enable: bool
        """
    ...
    def hotspot_exit_session_num(self):
        r"""Gets the hotspot_exit_session_num of this CreateHotspotSessionConfigResponse.

        热点时退出会话个数。

        :return: The hotspot_exit_session_num of this CreateHotspotSessionConfigResponse.
        :rtype: int
        """
    ...
    def hotspot_exit_session_num(self, hotspot_exit_session_num):
        r"""Sets the hotspot_exit_session_num of this CreateHotspotSessionConfigResponse.

        热点时退出会话个数。

        :param hotspot_exit_session_num: The hotspot_exit_session_num of this CreateHotspotSessionConfigResponse.
        :type hotspot_exit_session_num: int
        """
    ...
    def non_migrate_users(self):
        r"""Gets the non_migrate_users of this CreateHotspotSessionConfigResponse.

        热点时不迁移用户id列表。

        :return: The non_migrate_users of this CreateHotspotSessionConfigResponse.
    ...
    def non_migrate_users(self, non_migrate_users):
        r"""Sets the non_migrate_users of this CreateHotspotSessionConfigResponse.

        热点时不迁移用户id列表。

        :param non_migrate_users: The non_migrate_users of this CreateHotspotSessionConfigResponse.
        :type non_migrate_users: list[:class:`huaweicloudsdkworkspaceapp.v1.UserInfo`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateHotspotSessionConfigResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateHotspotSessionConfigResponse):
            return False
