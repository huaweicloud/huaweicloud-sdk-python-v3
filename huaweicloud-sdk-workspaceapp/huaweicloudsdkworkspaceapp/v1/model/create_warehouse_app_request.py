...
class CreateWarehouseAppRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateWarehouseAppRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateWarehouseAppRequest):
            return False
