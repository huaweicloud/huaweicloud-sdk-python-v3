...
class BatchReinstallServerRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchReinstallServerRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchReinstallServerRequest):
            return False
