...
class BatchChangeServerImageRequest:
    ...
    openapi_types = {
        'body': 'BatchChangeServerImageReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchChangeServerImageRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchChangeServerImageRequest):
            return False
