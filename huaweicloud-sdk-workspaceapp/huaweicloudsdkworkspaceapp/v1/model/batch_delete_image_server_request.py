...
class BatchDeleteImageServerRequest:
    ...
    openapi_types = {
        'body': 'BatchDeleteImageServerReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchDeleteImageServerRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteImageServerRequest):
            return False
