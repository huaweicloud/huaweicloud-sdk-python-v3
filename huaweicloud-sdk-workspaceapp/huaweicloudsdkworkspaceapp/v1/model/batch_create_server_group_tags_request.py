...
class BatchCreateServerGroupTagsRequest:
    ...
    openapi_types = {
        'body': 'BatchCreateServerGroupTagsReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchCreateServerGroupTagsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchCreateServerGroupTagsRequest):
            return False
