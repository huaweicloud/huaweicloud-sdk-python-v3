...
class ExportSessionsReq:
    ...
    def __init__(self, user_name=None, query_begin_time=None, query_end_time=None, app_server_group_id=None, vm_ip=None, public_ip=None, machine_name=None, session_state=None, is_success=None):
        r"""ExportSessionsReq
    ...
    @property
    def user_name(self):
        r"""Gets the user_name of this ExportSessionsReq.

        用户名。

        :return: The user_name of this ExportSessionsReq.
        :rtype: str
        """
    ...
    def user_name(self, user_name):
        r"""Sets the user_name of this ExportSessionsReq.

        用户名。

        :param user_name: The user_name of this ExportSessionsReq.
        :type user_name: str
        """
    ...
    def app_server_group_id(self):
        r"""Gets the app_server_group_id of this ExportSessionsReq.

        AppServer组ID。

        :return: The app_server_group_id of this ExportSessionsReq.
        :rtype: str
        """
    ...
    def app_server_group_id(self, app_server_group_id):
        r"""Sets the app_server_group_id of this ExportSessionsReq.

        AppServer组ID。

        :param app_server_group_id: The app_server_group_id of this ExportSessionsReq.
        :type app_server_group_id: str
        """
    ...
    @property
    def vm_ip(self):
        r"""Gets the vm_ip of this ExportSessionsReq.

        服务器IP。

        :return: The vm_ip of this ExportSessionsReq.
        :rtype: str
        """
        return self._vm_ip
    ...
    def vm_ip(self, vm_ip):
        r"""Sets the vm_ip of this ExportSessionsReq.

        服务器IP。

        :param vm_ip: The vm_ip of this ExportSessionsReq.
        :type vm_ip: str
        """
        self._vm_ip = vm_ip
    ...
    @property
    def public_ip(self):
        r"""Gets the public_ip of this ExportSessionsReq.

        客户端出口IP。

        :return: The public_ip of this ExportSessionsReq.
        :rtype: str
        """
    ...
    def public_ip(self, public_ip):
        r"""Sets the public_ip of this ExportSessionsReq.

        客户端出口IP。

        :param public_ip: The public_ip of this ExportSessionsReq.
        :type public_ip: str
        """
    ...
    def machine_name(self):
        r"""Gets the machine_name of this ExportSessionsReq.

        应用服务器名称。

        :return: The machine_name of this ExportSessionsReq.
        :rtype: str
        """
    ...
    def machine_name(self, machine_name):
        r"""Sets the machine_name of this ExportSessionsReq.

        应用服务器名称。

        :param machine_name: The machine_name of this ExportSessionsReq.
        :type machine_name: str
        """
    ...
    def session_state(self):
        r"""Gets the session_state of this ExportSessionsReq.
        ...
        :return: The session_state of this ExportSessionsReq.
        :rtype: str
        """
    ...
    def session_state(self, session_state):
        r"""Sets the session_state of this ExportSessionsReq.

        应用状态，支持查询多个，中间用英文逗号分隔： * `Active` - 会话当前处于活动状态，有用户登录并且正在使用。 * `Disconnected` - 用户已经登录但会话处于断开连接状态。 * `AppcInit` - 会话正在初始化。 * `SignedOut` - 会话已注销。 * `InitFail` - 会话初始化失败。

        :param session_state: The session_state of this ExportSessionsReq.
        :type session_state: str
        """
    ...
    @property
    def is_success(self):
        r"""Gets the is_success of this ExportSessionsReq.

        会话是否创建成功,默认不填则查询全部 * 'true' - 会话创建成功 * 'false' - 会话创建失败

        :return: The is_success of this ExportSessionsReq.
        :rtype: str
        """
    ...
    def is_success(self, is_success):
        r"""Sets the is_success of this ExportSessionsReq.

        会话是否创建成功,默认不填则查询全部 * 'true' - 会话创建成功 * 'false' - 会话创建失败

        :param is_success: The is_success of this ExportSessionsReq.
        :type is_success: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExportSessionsReq):
            return False
