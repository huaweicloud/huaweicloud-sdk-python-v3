...
class ValidateServerGroupResponse(SdkResponse):
    ...
    @property
    def result(self):
        r"""Gets the result of this ValidateServerGroupResponse.

        校验结果。

        :return: The result of this ValidateServerGroupResponse.
        :rtype: bool
        """
        return self._result
    ...
    def result(self, result):
        r"""Sets the result of this ValidateServerGroupResponse.

        校验结果。

        :param result: The result of this ValidateServerGroupResponse.
        :type result: bool
        """
        self._result = result
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ValidateServerGroupResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ValidateServerGroupResponse):
            return False
