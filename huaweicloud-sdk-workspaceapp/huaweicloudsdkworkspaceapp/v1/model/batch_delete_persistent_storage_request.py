...
class BatchDeletePersistentStorageRequest:
    ...
    openapi_types = {
        'body': 'BatchDeletePersistentStorageReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchDeletePersistentStorageRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeletePersistentStorageRequest):
            return False
