...
class ListPolicyTemplateResponse(SdkResponse):
    ...
    @property
    def count(self):
        r"""Gets the count of this ListPolicyTemplateResponse.
    ...
    def count(self, count):
        r"""Sets the count of this ListPolicyTemplateResponse.
    ...
    @property
    def items(self):
        r"""Gets the items of this ListPolicyTemplateResponse.
    ...
    def items(self, items):
        r"""Sets the items of this ListPolicyTemplateResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListPolicyTemplateResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListPolicyTemplateResponse):
            return False
