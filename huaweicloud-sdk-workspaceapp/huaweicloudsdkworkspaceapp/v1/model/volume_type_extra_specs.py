...
class VolumeTypeExtraSpecs:
    ...
    openapi_types = {
        ...
        'sold_out_availability_zone': 'str'
    }

    attribute_map = {
        'availability_zone': 'availability_zone',
        'sold_out_availability_zone': 'sold_out_availability_zone'
    }
    ...
    def __init__(self, availability_zone=None, sold_out_availability_zone=None):
        ...
        self._sold_out_availability_zone = None
        self.discriminator = None

        if availability_zone is not None:
            self.availability_zone = availability_zone
        if sold_out_availability_zone is not None:
            self.sold_out_availability_zone = sold_out_availability_zone
    ...
    def sold_out_availability_zone(self):
        ...
        :rtype: str
        """
        return self._sold_out_availability_zone
    ...
    def sold_out_availability_zone(self, sold_out_availability_zone):
        ...
        :type sold_out_availability_zone: str
        """
        self._sold_out_availability_zone = sold_out_availability_zone
