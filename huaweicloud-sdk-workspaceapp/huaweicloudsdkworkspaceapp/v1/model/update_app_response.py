...
class UpdateAppResponse(SdkResponse):
    ...
    @property
    def name(self):
        r"""Gets the name of this UpdateAppResponse.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this UpdateAppResponse.
    ...
    @property
    def version(self):
        r"""Gets the version of this UpdateAppResponse.
    ...
    def version(self, version):
        r"""Sets the version of this UpdateAppResponse.
    ...
    def command_param(self):
        r"""Gets the command_param of this UpdateAppResponse.
    ...
    def command_param(self, command_param):
        r"""Sets the command_param of this UpdateAppResponse.
    ...
    def execute_path(self):
        r"""Gets the execute_path of this UpdateAppResponse.
    ...
    def execute_path(self, execute_path):
        r"""Sets the execute_path of this UpdateAppResponse.
    ...
    @property
    def work_path(self):
        r"""Gets the work_path of this UpdateAppResponse.
    ...
    def work_path(self, work_path):
        r"""Sets the work_path of this UpdateAppResponse.
    ...
    @property
    def icon_path(self):
        r"""Gets the icon_path of this UpdateAppResponse.
    ...
    def icon_path(self, icon_path):
        r"""Sets the icon_path of this UpdateAppResponse.
    ...
    @property
    def icon_index(self):
        r"""Gets the icon_index of this UpdateAppResponse.
    ...
    def icon_index(self, icon_index):
        r"""Sets the icon_index of this UpdateAppResponse.
    ...
    def description(self):
        r"""Gets the description of this UpdateAppResponse.
    ...
    def description(self, description):
        r"""Sets the description of this UpdateAppResponse.
    ...
    def app_group_id(self):
        r"""Gets the app_group_id of this UpdateAppResponse.
    ...
    def app_group_id(self, app_group_id):
        r"""Sets the app_group_id of this UpdateAppResponse.
    ...
    @property
    def state(self):
        r"""Gets the state of this UpdateAppResponse.

        应用状态： * `NORMAL` - 正常状态。 * `FORBIDDEN` - 禁用状态。

        :return: The state of this UpdateAppResponse.
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        r"""Sets the state of this UpdateAppResponse.

        应用状态： * `NORMAL` - 正常状态。 * `FORBIDDEN` - 禁用状态。

        :param state: The state of this UpdateAppResponse.
        :type state: str
        """
        self._state = state
    ...
    @property
    def tenant_id(self):
        r"""Gets the tenant_id of this UpdateAppResponse.
    ...
    def tenant_id(self, tenant_id):
        r"""Sets the tenant_id of this UpdateAppResponse.
    ...
    @property
    def publish_at(self):
        r"""Gets the publish_at of this UpdateAppResponse.
    ...
    def publish_at(self, publish_at):
        r"""Sets the publish_at of this UpdateAppResponse.
    ...
    def source_type(self):
        r"""Gets the source_type of this UpdateAppResponse.
    ...
    def source_type(self, source_type):
        r"""Sets the source_type of this UpdateAppResponse.
    ...
    @property
    def publisher(self):
        r"""Gets the publisher of this UpdateAppResponse.
    ...
    def publisher(self, publisher):
        r"""Sets the publisher of this UpdateAppResponse.
    ...
    @property
    def icon_url(self):
        r"""Gets the icon_url of this UpdateAppResponse.
    ...
    def icon_url(self, icon_url):
        r"""Sets the icon_url of this UpdateAppResponse.
    ...
    def publishable(self):
        r"""Gets the publishable of this UpdateAppResponse.
    ...
    def publishable(self, publishable):
        r"""Sets the publishable of this UpdateAppResponse.
    ...
    def sandbox_enable(self):
        r"""Gets the sandbox_enable of this UpdateAppResponse.
    ...
    def sandbox_enable(self, sandbox_enable):
        r"""Sets the sandbox_enable of this UpdateAppResponse.
    ...
    def is_pre_boot(self):
        r"""Gets the is_pre_boot of this UpdateAppResponse.

        是否开启应用预开，取值为： - false: 表示关闭应用预开。 - true: 表示开启应用预开。

        :return: The is_pre_boot of this UpdateAppResponse.
        :rtype: bool
        """
    ...
    def is_pre_boot(self, is_pre_boot):
        r"""Sets the is_pre_boot of this UpdateAppResponse.

        是否开启应用预开，取值为： - false: 表示关闭应用预开。 - true: 表示开启应用预开。

        :param is_pre_boot: The is_pre_boot of this UpdateAppResponse.
        :type is_pre_boot: bool
        """
    ...
    def app_extended_info(self):
        r"""Gets the app_extended_info of this UpdateAppResponse.

        :return: The app_extended_info of this UpdateAppResponse.
    ...
    def app_extended_info(self, app_extended_info):
        r"""Sets the app_extended_info of this UpdateAppResponse.

        :param app_extended_info: The app_extended_info of this UpdateAppResponse.
        :type app_extended_info: :class:`huaweicloudsdkworkspaceapp.v1.AppExtendedInfo`
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateAppResponse.to_dict() is deprecated and no longer maintained, "
