...
class CreatePersistentStorageRequest:
    ...
    openapi_types = {
        'body': 'CreatePersistentStorageReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreatePersistentStorageRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreatePersistentStorageRequest):
            return False
