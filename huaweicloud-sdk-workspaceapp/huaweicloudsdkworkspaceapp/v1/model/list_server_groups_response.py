...
class ListServerGroupsResponse(SdkResponse):
    ...
    @property
    def count(self):
        r"""Gets the count of this ListServerGroupsResponse.
    ...
    def count(self, count):
        r"""Sets the count of this ListServerGroupsResponse.
    ...
    @property
    def items(self):
        r"""Gets the items of this ListServerGroupsResponse.
    ...
    def items(self, items):
        r"""Sets the items of this ListServerGroupsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListServerGroupsResponse.to_dict() is deprecated and no longer maintained, "
