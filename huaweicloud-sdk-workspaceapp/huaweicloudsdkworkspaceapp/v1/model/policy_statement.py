...
class PolicyStatement:
    ...
    def __init__(self, policy_statement_id=None, actions=None):
        """PolicyStatement

        The model defined in huaweicloud sdk

        :param policy_statement_id: 支持的访问策略,内置如下三种策略 * &#x60;读写&#x60; - 上传、编辑、下载 policy_statement_id: DEFAULT_1 * &#x60;只读&#x60; - 下载 policy_statement_id: DEFAULT_2 * &#x60;只写&#x60; - 上传、编辑 policy_statement_id: DEFAULT_3
        :type policy_statement_id: str
        :param actions: 可以进行操作的权限合集 * &#x60;PutObject&#x60; -  上传、修改、重命名、移动 * &#x60;GetObject&#x60; - 下载 * &#x60;DeleteObject&#x60; - 删除
