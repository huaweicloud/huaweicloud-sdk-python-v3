...
class ProductDetailInfo:
    ...
    @property
    def flavor_id(self):
        r"""Gets the flavor_id of this ProductDetailInfo.
    ...
    def flavor_id(self, flavor_id):
        r"""Sets the flavor_id of this ProductDetailInfo.
    ...
    @property
    def type(self):
        r"""Gets the type of this ProductDetailInfo.
    ...
    @type.setter
    def type(self, type):
        r"""Sets the type of this ProductDetailInfo.
    ...
    def architecture(self):
        r"""Gets the architecture of this ProductDetailInfo.

        产品架构，当前仅支持x86。 - x86 - arm

        :return: The architecture of this ProductDetailInfo.
        :rtype: str
        """
    ...
    def architecture(self, architecture):
        r"""Sets the architecture of this ProductDetailInfo.

        产品架构，当前仅支持x86。 - x86 - arm

        :param architecture: The architecture of this ProductDetailInfo.
        :type architecture: str
        """
    ...
    @property
    def cpu(self):
        r"""Gets the cpu of this ProductDetailInfo.
    ...
    @cpu.setter
    def cpu(self, cpu):
        r"""Sets the cpu of this ProductDetailInfo.
    ...
    @property
    def cpu_desc(self):
        r"""Gets the cpu_desc of this ProductDetailInfo.

        CPU描述。

        :return: The cpu_desc of this ProductDetailInfo.
        :rtype: str
        """
    ...
    def cpu_desc(self, cpu_desc):
        r"""Sets the cpu_desc of this ProductDetailInfo.

        CPU描述。

        :param cpu_desc: The cpu_desc of this ProductDetailInfo.
        :type cpu_desc: str
        """
    ...
    @property
    def memory(self):
        r"""Gets the memory of this ProductDetailInfo.
    ...
    def memory(self, memory):
        r"""Sets the memory of this ProductDetailInfo.
    ...
    @property
    def is_gpu(self):
        r"""Gets the is_gpu of this ProductDetailInfo.

        是否是GPU类型的规格。

        :return: The is_gpu of this ProductDetailInfo.
        :rtype: bool
        """
        return self._is_gpu
    ...
    def is_gpu(self, is_gpu):
        r"""Sets the is_gpu of this ProductDetailInfo.

        是否是GPU类型的规格。

        :param is_gpu: The is_gpu of this ProductDetailInfo.
        :type is_gpu: bool
        """
        self._is_gpu = is_gpu
    ...
    def system_disk_type(self):
        r"""Gets the system_disk_type of this ProductDetailInfo.

        系统盘类型。

        :return: The system_disk_type of this ProductDetailInfo.
        :rtype: str
        """
    ...
    def system_disk_type(self, system_disk_type):
        r"""Sets the system_disk_type of this ProductDetailInfo.

        系统盘类型。

        :param system_disk_type: The system_disk_type of this ProductDetailInfo.
        :type system_disk_type: str
        """
    ...
    def system_disk_size(self):
        r"""Gets the system_disk_size of this ProductDetailInfo.

        系统盘大小。

        :return: The system_disk_size of this ProductDetailInfo.
        :rtype: str
        """
    ...
    def system_disk_size(self, system_disk_size):
        r"""Sets the system_disk_size of this ProductDetailInfo.

        系统盘大小。

        :param system_disk_size: The system_disk_size of this ProductDetailInfo.
        :type system_disk_size: str
        """
    ...
    @property
    def gpu_desc(self):
        r"""Gets the gpu_desc of this ProductDetailInfo.

        GPU描述。

        :return: The gpu_desc of this ProductDetailInfo.
        :rtype: str
        """
    ...
    def gpu_desc(self, gpu_desc):
        r"""Sets the gpu_desc of this ProductDetailInfo.

        GPU描述。

        :param gpu_desc: The gpu_desc of this ProductDetailInfo.
        :type gpu_desc: str
        """
    ...
    def descriptions(self):
        r"""Gets the descriptions of this ProductDetailInfo.
    ...
    def descriptions(self, descriptions):
        r"""Sets the descriptions of this ProductDetailInfo.
    ...
    def charge_mode(self):
        r"""Gets the charge_mode of this ProductDetailInfo.
    ...
    def charge_mode(self, charge_mode):
        r"""Sets the charge_mode of this ProductDetailInfo.
    ...
    def contain_data_disk(self):
        r"""Gets the contain_data_disk of this ProductDetailInfo.

        套餐计费是否包含了数据盘。

        :return: The contain_data_disk of this ProductDetailInfo.
        :rtype: bool
        """
    ...
    def contain_data_disk(self, contain_data_disk):
        r"""Sets the contain_data_disk of this ProductDetailInfo.

        套餐计费是否包含了数据盘。

        :param contain_data_disk: The contain_data_disk of this ProductDetailInfo.
        :type contain_data_disk: bool
        """
    ...
    def resource_type(self):
        r"""Gets the resource_type of this ProductDetailInfo.

        资源类型。

        :return: The resource_type of this ProductDetailInfo.
        :rtype: str
        """
    ...
    def resource_type(self, resource_type):
        r"""Sets the resource_type of this ProductDetailInfo.

        资源类型。

        :param resource_type: The resource_type of this ProductDetailInfo.
        :type resource_type: str
        """
    ...
    def cloud_service_type(self):
        r"""Gets the cloud_service_type of this ProductDetailInfo.

        云服务类型。

        :return: The cloud_service_type of this ProductDetailInfo.
        :rtype: str
        """
    ...
    def cloud_service_type(self, cloud_service_type):
        r"""Sets the cloud_service_type of this ProductDetailInfo.

        云服务类型。

        :param cloud_service_type: The cloud_service_type of this ProductDetailInfo.
        :type cloud_service_type: str
        """
    ...
    def volume_product_type(self):
        r"""Gets the volume_product_type of this ProductDetailInfo.

        磁盘产品类型： - workspace

        :return: The volume_product_type of this ProductDetailInfo.
        :rtype: str
        """
    ...
    def volume_product_type(self, volume_product_type):
        r"""Sets the volume_product_type of this ProductDetailInfo.

        磁盘产品类型： - workspace

        :param volume_product_type: The volume_product_type of this ProductDetailInfo.
        :type volume_product_type: str
        """
    ...
    @property
    def sessions(self):
        r"""Gets the sessions of this ProductDetailInfo.

        套餐默认支持的最大会话数。

        :return: The sessions of this ProductDetailInfo.
        :rtype: int
        """
    ...
    def sessions(self, sessions):
        r"""Sets the sessions of this ProductDetailInfo.

        套餐默认支持的最大会话数。

        :param sessions: The sessions of this ProductDetailInfo.
        :type sessions: int
        """
    ...
    @property
    def status(self):
        r"""Gets the status of this ProductDetailInfo.
        ...
        :return: The status of this ProductDetailInfo.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        r"""Sets the status of this ProductDetailInfo.

        产品套餐在销售模式下的状态，取值自ECS的cond:operation:status。 不配置时等同于normal在售状态。 * `normal` - 正常商用 * `abandon` - 下线（即不显示） * `sellout` - 售罄 * `obt` - 公测 * `obt_sellout` - 公测售罄 * `promotion` - 推荐(等同normal，也是商用)

        :param status: The status of this ProductDetailInfo.
        :type status: str
        """
        self._status = status
    ...
    def cond_operation_az(self):
        r"""Gets the cond_operation_az of this ProductDetailInfo.
        ...
        :return: The cond_operation_az of this ProductDetailInfo.
        :rtype: str
        """
    ...
    def cond_operation_az(self, cond_operation_az):
        r"""Sets the cond_operation_az of this ProductDetailInfo.

        产品套餐在可用区的状态，配套status使用。 > - 此参数是AZ级配置，优选取此参数的值，某个AZ没有在此参数中配置时默认使用status参数的取值。 > - 配置格式“az(xx)”。()内为某个AZ的flavor状态，()内必须要填有状态，不填为无效配置。 > - 例如：套餐在某个region的az0正常商用，az1售罄，az2公测，az3正常商用，其他az显示下线，可配置为： >   - “status”设置为：“abandon” 。 >   - “cond_operation_az”设置为：“az0(normal), az1(sellout), az2(obt), az3(normal)”。  > -  说明：如果flavor在某个AZ下的状态与status配置状态不同，必须配置该参数。

        :param cond_operation_az: The cond_operation_az of this ProductDetailInfo.
        :type cond_operation_az: str
        """
    ...
    def sub_product_list(self):
        r"""Gets the sub_product_list of this ProductDetailInfo.

        专属主机的子产品。

        :return: The sub_product_list of this ProductDetailInfo.
        :rtype: list[str]
        """
    ...
    def sub_product_list(self, sub_product_list):
        r"""Sets the sub_product_list of this ProductDetailInfo.

        专属主机的子产品。

        :param sub_product_list: The sub_product_list of this ProductDetailInfo.
        :type sub_product_list: list[str]
        """
    ...
    @property
    def domain_ids(self):
        r"""Gets the domain_ids of this ProductDetailInfo.

        产品属于专有的domainId。

        :return: The domain_ids of this ProductDetailInfo.
        :rtype: list[str]
        """
    ...
    def domain_ids(self, domain_ids):
        r"""Sets the domain_ids of this ProductDetailInfo.

        产品属于专有的domainId。

        :param domain_ids: The domain_ids of this ProductDetailInfo.
        :type domain_ids: list[str]
        """
    ...
    def package_type(self):
        r"""Gets the package_type of this ProductDetailInfo.

        套餐类型： - general：表示产品通用套餐。 - dedicated：表示产品专属主机套餐。

        :return: The package_type of this ProductDetailInfo.
        :rtype: str
        """
    ...
    def package_type(self, package_type):
        r"""Sets the package_type of this ProductDetailInfo.

        套餐类型： - general：表示产品通用套餐。 - dedicated：表示产品专属主机套餐。

        :param package_type: The package_type of this ProductDetailInfo.
        :type package_type: str
        """
    ...
    def series_type(self):
        r"""Gets the series_type of this ProductDetailInfo.

        系列类型： - d7 - c7

        :return: The series_type of this ProductDetailInfo.
        :rtype: str
        """
    ...
    def series_type(self, series_type):
        r"""Sets the series_type of this ProductDetailInfo.

        系列类型： - d7 - c7

        :param series_type: The series_type of this ProductDetailInfo.
        :type series_type: str
        """
    ...
    def expire_time(self):
        r"""Gets the expire_time of this ProductDetailInfo.

        产品套餐过期时间,产品将在该时间点后逐步下架。

        :return: The expire_time of this ProductDetailInfo.
        :rtype: datetime
        """
    ...
    def expire_time(self, expire_time):
        r"""Sets the expire_time of this ProductDetailInfo.

        产品套餐过期时间,产品将在该时间点后逐步下架。

        :param expire_time: The expire_time of this ProductDetailInfo.
        :type expire_time: datetime
        """
    ...
    def support_gpu_type(self):
        r"""Gets the support_gpu_type of this ProductDetailInfo.

        产品套餐支持的GPU类型。

        :return: The support_gpu_type of this ProductDetailInfo.
        :rtype: str
        """
    ...
    def support_gpu_type(self, support_gpu_type):
        r"""Sets the support_gpu_type of this ProductDetailInfo.

        产品套餐支持的GPU类型。

        :param support_gpu_type: The support_gpu_type of this ProductDetailInfo.
        :type support_gpu_type: str
        """
