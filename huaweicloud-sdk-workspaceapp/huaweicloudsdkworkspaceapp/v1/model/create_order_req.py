...
class CreateOrderReq:
    ...
    def __init__(self, resources=None, type=None):
        ...
        :param resources: 包周期资源对象。
        :type resources: list[:class:`huaweicloudsdkworkspaceapp.v1.Resource`]
        :param type: createApps【添加云应用】。
        :type type: str
        """
    ...
    def resources(self):
        ...
        :rtype: list[:class:`huaweicloudsdkworkspaceapp.v1.Resource`]
        """
