...
class Authorization:
    ...
    def __init__(self, account=None, app_id=None, app_name=None, app_group_id=None, app_group_name=None, authorization_type=None, account_type=None, domain=None, create_at=None):
        """Authorization
