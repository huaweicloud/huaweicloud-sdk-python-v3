...
class CreateHotspotSessionConfigReq:
    ...
    def __init__(self, hotspot_session_migration_enable=None, hotspot_exit_session_num=None, non_migrate_users=None):
        r"""CreateHotspotSessionConfigReq
    ...
    def hotspot_session_migration_enable(self):
        r"""Gets the hotspot_session_migration_enable of this CreateHotspotSessionConfigReq.

        是否开启热点会话迁移。取值为： false：表示关闭。 true：表示开启。

        :return: The hotspot_session_migration_enable of this CreateHotspotSessionConfigReq.
        :rtype: bool
        """
    ...
    def hotspot_session_migration_enable(self, hotspot_session_migration_enable):
        r"""Sets the hotspot_session_migration_enable of this CreateHotspotSessionConfigReq.

        是否开启热点会话迁移。取值为： false：表示关闭。 true：表示开启。

        :param hotspot_session_migration_enable: The hotspot_session_migration_enable of this CreateHotspotSessionConfigReq.
        :type hotspot_session_migration_enable: bool
        """
    ...
    def hotspot_exit_session_num(self):
        r"""Gets the hotspot_exit_session_num of this CreateHotspotSessionConfigReq.

        热点时退出会话个数。

        :return: The hotspot_exit_session_num of this CreateHotspotSessionConfigReq.
        :rtype: int
        """
    ...
    def hotspot_exit_session_num(self, hotspot_exit_session_num):
        r"""Sets the hotspot_exit_session_num of this CreateHotspotSessionConfigReq.

        热点时退出会话个数。

        :param hotspot_exit_session_num: The hotspot_exit_session_num of this CreateHotspotSessionConfigReq.
        :type hotspot_exit_session_num: int
        """
    ...
    def non_migrate_users(self):
        r"""Gets the non_migrate_users of this CreateHotspotSessionConfigReq.

        热点时不迁移用户id列表。

        :return: The non_migrate_users of this CreateHotspotSessionConfigReq.
    ...
    def non_migrate_users(self, non_migrate_users):
        r"""Sets the non_migrate_users of this CreateHotspotSessionConfigReq.

        热点时不迁移用户id列表。

        :param non_migrate_users: The non_migrate_users of this CreateHotspotSessionConfigReq.
        :type non_migrate_users: list[:class:`huaweicloudsdkworkspaceapp.v1.UserInfo`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateHotspotSessionConfigReq):
            return False
