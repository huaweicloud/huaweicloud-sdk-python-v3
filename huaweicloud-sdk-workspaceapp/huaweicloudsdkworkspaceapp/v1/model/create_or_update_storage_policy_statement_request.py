...
class CreateOrUpdateStoragePolicyStatementRequest:
    ...
    openapi_types = {
        'body': 'CreateOrUpdateStoragePolicyStatementReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateOrUpdateStoragePolicyStatementRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateOrUpdateStoragePolicyStatementRequest):
            return False
