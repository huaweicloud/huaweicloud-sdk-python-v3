...
class WorkspaceAppAsyncClient(Client):
    ...
    def check_publish_app_async(self, request):
        r"""校验应用
    ...
    def check_publish_app_async_invoker(self, request):
        http_info = self._check_publish_app_http_info(request)
        return AsyncInvoker(self, http_info)

    def _check_publish_app_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def upload_app_icon_raw_async(self, request):
        r"""修改自定义应用图标
    ...
    def upload_app_icon_raw_async_invoker(self, request):
        http_info = self._upload_app_icon_raw_http_info(request)
        return AsyncInvoker(self, http_info)

    def _upload_app_icon_raw_http_info(self, request):
        http_info = {
            "method": "PUT",
    ...
    def change_cluster_async(self, request):
        r"""切换文件夹归属集群
    ...
    def change_cluster_async_invoker(self, request):
        http_info = self._change_cluster_http_info(request)
        return AsyncInvoker(self, http_info)

    def _change_cluster_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def create_hotspot_session_config_async(self, request):
        r"""创建热点会话迁移配置
    ...
    def create_hotspot_session_config_async_invoker(self, request):
        http_info = self._create_hotspot_session_config_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_hotspot_session_config_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def list_hotspot_session_config_async(self, request):
        r"""查询热点会话迁移配置
    ...
    def list_hotspot_session_config_async_invoker(self, request):
        http_info = self._list_hotspot_session_config_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_hotspot_session_config_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/{project_id}/hotspot-session-config",
            "request_type": request.__class__.__name__,
    ...
    def list_non_migration_users_async(self, request):
        r"""查询热点会话不迁移用户
    ...
    def list_non_migration_users_async_invoker(self, request):
        http_info = self._list_non_migration_users_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_non_migration_users_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def update_hotspot_session_config_async(self, request):
        r"""修改热点会话迁移配置
    ...
    def update_hotspot_session_config_async_invoker(self, request):
        http_info = self._update_hotspot_session_config_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_hotspot_session_config_http_info(self, request):
        http_info = {
            "method": "PATCH",
    ...
    def update_non_migration_users_async(self, request):
        r"""修改热点会话不迁移用户
    ...
    def update_non_migration_users_async_invoker(self, request):
        http_info = self._update_non_migration_users_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_non_migration_users_http_info(self, request):
        http_info = {
            "method": "PATCH",
            "resource_path": "/v1/{project_id}/hotspot-session-config/{config_id}/non-migration-users",
            "request_type": request.__class__.__name__,
