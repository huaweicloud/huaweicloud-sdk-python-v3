...
class IvsStandardByVideoAndIdCardImageRequestBody:
    ...
    openapi_types = {
        'meta': 'Meta',
        'data': 'IvsStandardByVideoAndIdCardImageRequestBodyData'
    }
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IvsStandardByVideoAndIdCardImageRequestBody):
            return False
