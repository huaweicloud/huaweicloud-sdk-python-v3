...
class ListTablePrivilegesResponse(SdkResponse):
    ...
    openapi_types = {
        ...
        'message': 'str',
        'user_name': 'str',
        'privileges': 'list[TablePrivilege]'
    }
    ...
    def __init__(self, is_success=None, message=None, user_name=None, privileges=None):
        ...
        :type privileges: list[:class:`huaweicloudsdkdli.v1.TablePrivilege`]
        """
    ...
    def privileges(self):
        ...
        :rtype: list[:class:`huaweicloudsdkdli.v1.TablePrivilege`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListTablePrivilegesResponse.to_dict() is deprecated and no longer maintained, "
