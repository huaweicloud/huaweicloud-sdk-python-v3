...
class CreateAuthInfoRequest:
    ...
    @property
    def body(self):
        r"""Gets the body of this CreateAuthInfoRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this CreateAuthInfoRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateAuthInfoRequest):
            return False
