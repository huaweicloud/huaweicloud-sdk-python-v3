...
class CreateFlinkSqlJobTemplateRequest:
    ...
    def __init__(self, body=None):
        r"""CreateFlinkSqlJobTemplateRequest
    ...
    @property
    def body(self):
        r"""Gets the body of this CreateFlinkSqlJobTemplateRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this CreateFlinkSqlJobTemplateRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateFlinkSqlJobTemplateRequest):
            return False
