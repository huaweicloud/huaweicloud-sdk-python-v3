...
class CreateQueuePropertyRequestBodyProperties:
    ...
    def compute_engine_max_instance(self):
        """Gets the compute_engine_max_instance of this CreateQueuePropertyRequestBodyProperties.

        队列能启动的最大spark driver数量

        :return: The compute_engine_max_instance of this CreateQueuePropertyRequestBodyProperties.
        :rtype: int
        """
    ...
    def compute_engine_max_instance(self, compute_engine_max_instance):
        """Sets the compute_engine_max_instance of this CreateQueuePropertyRequestBodyProperties.

        队列能启动的最大spark driver数量

        :param compute_engine_max_instance: The compute_engine_max_instance of this CreateQueuePropertyRequestBodyProperties.
        :type compute_engine_max_instance: int
        """
    ...
    def job_max_concurrent(self):
        """Gets the job_max_concurrent of this CreateQueuePropertyRequestBodyProperties.

        单个spark driver能同时运行的最大任务数量

        :return: The job_max_concurrent of this CreateQueuePropertyRequestBodyProperties.
        :rtype: int
        """
    ...
    def job_max_concurrent(self, job_max_concurrent):
        """Sets the job_max_concurrent of this CreateQueuePropertyRequestBodyProperties.

        单个spark driver能同时运行的最大任务数量

        :param job_max_concurrent: The job_max_concurrent of this CreateQueuePropertyRequestBodyProperties.
        :type job_max_concurrent: int
        """
    ...
    def compute_engine_max_prefetch_instance(self):
        """Gets the compute_engine_max_prefetch_instance of this CreateQueuePropertyRequestBodyProperties.

        队列预先启动的最大spark driver数量

        :return: The compute_engine_max_prefetch_instance of this CreateQueuePropertyRequestBodyProperties.
        :rtype: int
        """
    ...
    def compute_engine_max_prefetch_instance(self, compute_engine_max_prefetch_instance):
        """Sets the compute_engine_max_prefetch_instance of this CreateQueuePropertyRequestBodyProperties.

        队列预先启动的最大spark driver数量

        :param compute_engine_max_prefetch_instance: The compute_engine_max_prefetch_instance of this CreateQueuePropertyRequestBodyProperties.
        :type compute_engine_max_prefetch_instance: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateQueuePropertyRequestBodyProperties):
            return False
