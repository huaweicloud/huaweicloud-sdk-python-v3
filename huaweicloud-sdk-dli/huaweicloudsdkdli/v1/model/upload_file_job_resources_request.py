...
class UploadFileJobResourcesRequest:
    ...
    openapi_types = {
        'user_id': 'str',
        'body': 'UploadResourcesRequestBody'
    }
    ...
    def __init__(self, user_id=None, body=None):
        ...
        :param user_id: 
        :type user_id: str
        :param body: Body of the UploadFileJobResourcesRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadFileJobResourcesRequest):
            return False
