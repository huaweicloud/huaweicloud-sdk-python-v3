...
class ExportFlinkJobsRequest:
    ...
    @property
    def body(self):
        r"""Gets the body of this ExportFlinkJobsRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this ExportFlinkJobsRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExportFlinkJobsRequest):
            return False
