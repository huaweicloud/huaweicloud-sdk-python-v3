...
class UpdateFlinkJobStatusReportRequest:
    ...
    openapi_types = {
        'body': 'ChangeFlinkJobStatusReportRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the UpdateFlinkJobStatusReportRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateFlinkJobStatusReportRequest):
            return False
