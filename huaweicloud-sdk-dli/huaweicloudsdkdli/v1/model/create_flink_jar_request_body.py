...
class CreateFlinkJarRequestBody:
    ...
    @property
    def name(self):
        """Gets the name of this CreateFlinkJarRequestBody.

        作业名称。长度限制：0-57个字符。

        :return: The name of this CreateFlinkJarRequestBody.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CreateFlinkJarRequestBody.

        作业名称。长度限制：0-57个字符。

        :param name: The name of this CreateFlinkJarRequestBody.
        :type name: str
        """
        self._name = name
    ...
    @property
    def desc(self):
        """Gets the desc of this CreateFlinkJarRequestBody.

        作业描述。长度限制：0-512个字符。

        :return: The desc of this CreateFlinkJarRequestBody.
        :rtype: str
        """
        return self._desc
    ...
    @desc.setter
    def desc(self, desc):
        """Sets the desc of this CreateFlinkJarRequestBody.

        作业描述。长度限制：0-512个字符。

        :param desc: The desc of this CreateFlinkJarRequestBody.
        :type desc: str
        """
        self._desc = desc
    ...
    @property
    def queue_name(self):
        """Gets the queue_name of this CreateFlinkJarRequestBody.

        队列名称。长度限制：1-128个字符。

        :return: The queue_name of this CreateFlinkJarRequestBody.
        :rtype: str
        """
    ...
    def queue_name(self, queue_name):
        """Sets the queue_name of this CreateFlinkJarRequestBody.

        队列名称。长度限制：1-128个字符。

        :param queue_name: The queue_name of this CreateFlinkJarRequestBody.
        :type queue_name: str
        """
    ...
    @property
    def cu_number(self):
        """Gets the cu_number of this CreateFlinkJarRequestBody.

        用户为作业选择的CU数量，默认值为2。

        :return: The cu_number of this CreateFlinkJarRequestBody.
        :rtype: int
        """
    ...
    def cu_number(self, cu_number):
        """Sets the cu_number of this CreateFlinkJarRequestBody.

        用户为作业选择的CU数量，默认值为2。

        :param cu_number: The cu_number of this CreateFlinkJarRequestBody.
        :type cu_number: int
        """
    ...
    def manager_cu_number(self):
        """Gets the manager_cu_number of this CreateFlinkJarRequestBody.

        用户为作业选择的管理节点CU数量，对应为flink jobmanager数量，默认值为1。

        :return: The manager_cu_number of this CreateFlinkJarRequestBody.
        :rtype: int
        """
    ...
    def manager_cu_number(self, manager_cu_number):
        """Sets the manager_cu_number of this CreateFlinkJarRequestBody.

        用户为作业选择的管理节点CU数量，对应为flink jobmanager数量，默认值为1。

        :param manager_cu_number: The manager_cu_number of this CreateFlinkJarRequestBody.
        :type manager_cu_number: int
        """
    ...
    def parallel_number(self):
        """Gets the parallel_number of this CreateFlinkJarRequestBody.

        用户为作业选择的并发量，默认值为1.

        :return: The parallel_number of this CreateFlinkJarRequestBody.
        :rtype: int
        """
    ...
    def parallel_number(self, parallel_number):
        """Sets the parallel_number of this CreateFlinkJarRequestBody.

        用户为作业选择的并发量，默认值为1.

        :param parallel_number: The parallel_number of this CreateFlinkJarRequestBody.
        :type parallel_number: int
        """
    ...
    def log_enabled(self):
        """Gets the log_enabled of this CreateFlinkJarRequestBody.

        是否开启作业日志。 开启：true 关闭：false 默认：false

        :return: The log_enabled of this CreateFlinkJarRequestBody.
        :rtype: bool
        """
    ...
    def log_enabled(self, log_enabled):
        """Sets the log_enabled of this CreateFlinkJarRequestBody.

        是否开启作业日志。 开启：true 关闭：false 默认：false

        :param log_enabled: The log_enabled of this CreateFlinkJarRequestBody.
        :type log_enabled: bool
        """
    ...
    @property
    def obs_bucket(self):
        """Gets the obs_bucket of this CreateFlinkJarRequestBody.

        当“log_enabled”为“true”时, 用户授权保存作业日志的OBS桶名。

        :return: The obs_bucket of this CreateFlinkJarRequestBody.
        :rtype: str
        """
    ...
    def obs_bucket(self, obs_bucket):
        """Sets the obs_bucket of this CreateFlinkJarRequestBody.

        当“log_enabled”为“true”时, 用户授权保存作业日志的OBS桶名。

        :param obs_bucket: The obs_bucket of this CreateFlinkJarRequestBody.
        :type obs_bucket: str
        """
    ...
    @property
    def smn_topic(self):
        """Gets the smn_topic of this CreateFlinkJarRequestBody.

        当作业异常时，向该SMN主题推送告警信息。

        :return: The smn_topic of this CreateFlinkJarRequestBody.
        :rtype: str
        """
    ...
    def smn_topic(self, smn_topic):
        """Sets the smn_topic of this CreateFlinkJarRequestBody.

        当作业异常时，向该SMN主题推送告警信息。

        :param smn_topic: The smn_topic of this CreateFlinkJarRequestBody.
        :type smn_topic: str
        """
    ...
    @property
    def main_class(self):
        """Gets the main_class of this CreateFlinkJarRequestBody.

        作业入口类。

        :return: The main_class of this CreateFlinkJarRequestBody.
        :rtype: str
        """
    ...
    def main_class(self, main_class):
        """Sets the main_class of this CreateFlinkJarRequestBody.

        作业入口类。

        :param main_class: The main_class of this CreateFlinkJarRequestBody.
        :type main_class: str
        """
    ...
    def entrypoint_args(self):
        """Gets the entrypoint_args of this CreateFlinkJarRequestBody.

        作业入口类参数，多个参数之间空格分隔。

        :return: The entrypoint_args of this CreateFlinkJarRequestBody.
        :rtype: str
        """
    ...
    def entrypoint_args(self, entrypoint_args):
        """Sets the entrypoint_args of this CreateFlinkJarRequestBody.

        作业入口类参数，多个参数之间空格分隔。

        :param entrypoint_args: The entrypoint_args of this CreateFlinkJarRequestBody.
        :type entrypoint_args: str
        """
    ...
    def restart_when_exception(self):
        """Gets the restart_when_exception of this CreateFlinkJarRequestBody.

        是否开启异常重启功能，默认值为“false”。

        :return: The restart_when_exception of this CreateFlinkJarRequestBody.
        :rtype: bool
        """
    ...
    def restart_when_exception(self, restart_when_exception):
        """Sets the restart_when_exception of this CreateFlinkJarRequestBody.

        是否开启异常重启功能，默认值为“false”。

        :param restart_when_exception: The restart_when_exception of this CreateFlinkJarRequestBody.
        :type restart_when_exception: bool
        """
    ...
    @property
    def entrypoint(self):
        """Gets the entrypoint of this CreateFlinkJarRequestBody.

        用户已上传到DLI资源管理系统的资源包名，用户自定义作业主类所在的jar包。

        :return: The entrypoint of this CreateFlinkJarRequestBody.
        :rtype: str
        """
    ...
    def entrypoint(self, entrypoint):
        """Sets the entrypoint of this CreateFlinkJarRequestBody.

        用户已上传到DLI资源管理系统的资源包名，用户自定义作业主类所在的jar包。

        :param entrypoint: The entrypoint of this CreateFlinkJarRequestBody.
        :type entrypoint: str
        """
    ...
    def dependency_jars(self):
        """Gets the dependency_jars of this CreateFlinkJarRequestBody.

        用户已上传到DLI资源管理系统的资源包名，用户自定义作业的其他依赖包。示例：[Group/test.jar,myGroup/test1.jar]

        :return: The dependency_jars of this CreateFlinkJarRequestBody.
        :rtype: list[str]
        """
    ...
    def dependency_jars(self, dependency_jars):
        """Sets the dependency_jars of this CreateFlinkJarRequestBody.

        用户已上传到DLI资源管理系统的资源包名，用户自定义作业的其他依赖包。示例：[Group/test.jar,myGroup/test1.jar]

        :param dependency_jars: The dependency_jars of this CreateFlinkJarRequestBody.
        :type dependency_jars: list[str]
        """
    ...
    def dependency_files(self):
        """Gets the dependency_files of this CreateFlinkJarRequestBody.

        用户已上传到DLI资源管理系统的资源包名，用户自定义作业的依赖文件，示例：[myGroup/test.cvs,myGroup/test1.csv] 

        :return: The dependency_files of this CreateFlinkJarRequestBody.
        :rtype: list[str]
        """
    ...
    def dependency_files(self, dependency_files):
        """Sets the dependency_files of this CreateFlinkJarRequestBody.

        用户已上传到DLI资源管理系统的资源包名，用户自定义作业的依赖文件，示例：[myGroup/test.cvs,myGroup/test1.csv] 

        :param dependency_files: The dependency_files of this CreateFlinkJarRequestBody.
        :type dependency_files: list[str]
        """
    ...
    def flink_version(self):
        """Gets the flink_version of this CreateFlinkJarRequestBody.

        Flink版本。当用户设置“feature”为“basic”时，该参数生效。用户可通过与“feature”参数配合使用，指定作业运行使用的DLI基础Flink镜像的版本。

        :return: The flink_version of this CreateFlinkJarRequestBody.
        :rtype: str
        """
    ...
    def flink_version(self, flink_version):
        """Sets the flink_version of this CreateFlinkJarRequestBody.

        Flink版本。当用户设置“feature”为“basic”时，该参数生效。用户可通过与“feature”参数配合使用，指定作业运行使用的DLI基础Flink镜像的版本。

        :param flink_version: The flink_version of this CreateFlinkJarRequestBody.
        :type flink_version: str
        """
    ...
    @property
    def image(self):
        """Gets the image of this CreateFlinkJarRequestBody.
        ...
        :return: The image of this CreateFlinkJarRequestBody.
        :rtype: str
        """
        return self._image
    ...
    def image(self, image):
        """Sets the image of this CreateFlinkJarRequestBody.

        自定义镜像。格式为：组织名/镜像名:镜像版本。当用户设置“feature”为“custom”时，该参数生效。用户可通过与“feature”参数配合使用，指定作业运行使用自定义的Flink镜像。关于如何使用自定义镜像，请参考《数据湖探索用户指南》

        :param image: The image of this CreateFlinkJarRequestBody.
        :type image: str
        """
        self._image = image
    ...
    def tm_slot_num(self):
        """Gets the tm_slot_num of this CreateFlinkJarRequestBody.

        每个taskmanager的slot数，默认值为“(parallel_number*tm_cus)/(cu_number-manager_cu_number)”。

        :return: The tm_slot_num of this CreateFlinkJarRequestBody.
        :rtype: int
        """
    ...
    def tm_slot_num(self, tm_slot_num):
        """Sets the tm_slot_num of this CreateFlinkJarRequestBody.

        每个taskmanager的slot数，默认值为“(parallel_number*tm_cus)/(cu_number-manager_cu_number)”。

        :param tm_slot_num: The tm_slot_num of this CreateFlinkJarRequestBody.
        :type tm_slot_num: int
        """
    ...
    @property
    def tm_cus(self):
        """Gets the tm_cus of this CreateFlinkJarRequestBody.

        每个taskmanager的CU数，默认值为“1”。

        :return: The tm_cus of this CreateFlinkJarRequestBody.
        :rtype: int
        """
        return self._tm_cus
    ...
    def tm_cus(self, tm_cus):
        """Sets the tm_cus of this CreateFlinkJarRequestBody.

        每个taskmanager的CU数，默认值为“1”。

        :param tm_cus: The tm_cus of this CreateFlinkJarRequestBody.
        :type tm_cus: int
        """
        self._tm_cus = tm_cus
    ...
    @property
    def feature(self):
        """Gets the feature of this CreateFlinkJarRequestBody.

        作业特性。表示用户作业使用的Flink镜像类型。basic：表示使用DLI提供的基础Flink镜像。custom：表示使用用户自定义的Flink镜像。

        :return: The feature of this CreateFlinkJarRequestBody.
        :rtype: str
        """
    ...
    def feature(self, feature):
        """Sets the feature of this CreateFlinkJarRequestBody.

        作业特性。表示用户作业使用的Flink镜像类型。basic：表示使用DLI提供的基础Flink镜像。custom：表示使用用户自定义的Flink镜像。

        :param feature: The feature of this CreateFlinkJarRequestBody.
        :type feature: str
        """
    ...
    def resume_checkpoint(self):
        """Gets the resume_checkpoint of this CreateFlinkJarRequestBody.

        异常重启是否从checkpoint恢复。

        :return: The resume_checkpoint of this CreateFlinkJarRequestBody.
        :rtype: bool
        """
    ...
    def resume_checkpoint(self, resume_checkpoint):
        """Sets the resume_checkpoint of this CreateFlinkJarRequestBody.

        异常重启是否从checkpoint恢复。

        :param resume_checkpoint: The resume_checkpoint of this CreateFlinkJarRequestBody.
        :type resume_checkpoint: bool
        """
    ...
    def resume_max_num(self):
        """Gets the resume_max_num of this CreateFlinkJarRequestBody.

        异常重试最大次数，单位：次/小时。取值范围：-1或大于0。默认值为“-1”，表示无限次数。

        :return: The resume_max_num of this CreateFlinkJarRequestBody.
        :rtype: int
        """
    ...
    def resume_max_num(self, resume_max_num):
        """Sets the resume_max_num of this CreateFlinkJarRequestBody.

        异常重试最大次数，单位：次/小时。取值范围：-1或大于0。默认值为“-1”，表示无限次数。

        :param resume_max_num: The resume_max_num of this CreateFlinkJarRequestBody.
        :type resume_max_num: int
        """
    ...
    def checkpoint_path(self):
        """Gets the checkpoint_path of this CreateFlinkJarRequestBody.

        用户Jar中checkpoint的储存地址，不同作业路径需要保持不同。

        :return: The checkpoint_path of this CreateFlinkJarRequestBody.
        :rtype: str
        """
    ...
    def checkpoint_path(self, checkpoint_path):
        """Sets the checkpoint_path of this CreateFlinkJarRequestBody.

        用户Jar中checkpoint的储存地址，不同作业路径需要保持不同。

        :param checkpoint_path: The checkpoint_path of this CreateFlinkJarRequestBody.
        :type checkpoint_path: str
        """
    ...
    def runtime_config(self):
        """Gets the runtime_config of this CreateFlinkJarRequestBody.

        Flink作业运行时自定义优化参数。

        :return: The runtime_config of this CreateFlinkJarRequestBody.
        :rtype: str
        """
    ...
    def runtime_config(self, runtime_config):
        """Sets the runtime_config of this CreateFlinkJarRequestBody.

        Flink作业运行时自定义优化参数。

        :param runtime_config: The runtime_config of this CreateFlinkJarRequestBody.
        :type runtime_config: str
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this CreateFlinkJarRequestBody.

        标签

        :return: The tags of this CreateFlinkJarRequestBody.
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this CreateFlinkJarRequestBody.

        标签

        :param tags: The tags of this CreateFlinkJarRequestBody.
        :type tags: list[:class:`huaweicloudsdkdli.v1.TmsTagEntity`]
        """
        self._tags = tags
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateFlinkJarRequestBody):
            return False
