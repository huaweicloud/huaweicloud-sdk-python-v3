...
class ListResourcesTagsRequest:
    ...
    def resource_type(self):
        r"""Gets the resource_type of this ListResourcesTagsRequest.

        资源类型

        :return: The resource_type of this ListResourcesTagsRequest.
        :rtype: str
        """
    ...
    def resource_type(self, resource_type):
        r"""Sets the resource_type of this ListResourcesTagsRequest.

        资源类型

        :param resource_type: The resource_type of this ListResourcesTagsRequest.
        :type resource_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListResourcesTagsRequest):
            return False
