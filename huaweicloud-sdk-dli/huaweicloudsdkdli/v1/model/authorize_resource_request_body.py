...
class AuthorizeResourceRequestBody:
    ...
    def grant_project_id(self):
        """Gets the grant_project_id of this AuthorizeResourceRequestBody.

        被赋权的项目ID，数据赋权给其他项目后，该项目的管理员将 有权访问指定的DLI资源权限，被收回或者更新访问权限。

        :return: The grant_project_id of this AuthorizeResourceRequestBody.
        :rtype: str
        """
    ...
    def grant_project_id(self, grant_project_id):
        """Sets the grant_project_id of this AuthorizeResourceRequestBody.

        被赋权的项目ID，数据赋权给其他项目后，该项目的管理员将 有权访问指定的DLI资源权限，被收回或者更新访问权限。

        :param grant_project_id: The grant_project_id of this AuthorizeResourceRequestBody.
        :type grant_project_id: str
        """
