...
class FlinkJob:
    ...
    def status_name(self):
        """Gets the status_name of this FlinkJob.

        作业状态名称。

        :return: The status_name of this FlinkJob.
        :rtype: str
        """
    ...
    def status_name(self, status_name):
        """Sets the status_name of this FlinkJob.

        作业状态名称。

        :param status_name: The status_name of this FlinkJob.
        :type status_name: str
        """
