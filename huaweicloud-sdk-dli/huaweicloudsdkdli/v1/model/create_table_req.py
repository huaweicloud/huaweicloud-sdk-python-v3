...
class CreateTableReq:
    ...
    @property
    def table_name(self):
        """Gets the table_name of this CreateTableReq.

        新增表名称。

        :return: The table_name of this CreateTableReq.
        :rtype: str
        """
    ...
    def table_name(self, table_name):
        """Sets the table_name of this CreateTableReq.

        新增表名称。

        :param table_name: The table_name of this CreateTableReq.
        :type table_name: str
        """
    ...
    def description(self):
        """Gets the description of this CreateTableReq.

        新增表的描述信息。

        :return: The description of this CreateTableReq.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this CreateTableReq.

        新增表的描述信息。

        :param description: The description of this CreateTableReq.
        :type description: str
        """
    ...
    @property
    def data_type(self):
        """Gets the data_type of this CreateTableReq.

        OBS表必选参数。新增OBS表数据的类型，目前支持：Parquet、ORC、CSV、JSON、Carbon和Avro格式。

        :return: The data_type of this CreateTableReq.
        :rtype: str
        """
    ...
    def data_type(self, data_type):
        """Sets the data_type of this CreateTableReq.

        OBS表必选参数。新增OBS表数据的类型，目前支持：Parquet、ORC、CSV、JSON、Carbon和Avro格式。

        :param data_type: The data_type of this CreateTableReq.
        :type data_type: str
        """
    ...
    @property
    def data_path(self):
        """Gets the data_path of this CreateTableReq.

        OBS表必选参数。新增OBS表数据的存储路径，必须是OBS上的路径，以s3a开头。

        :return: The data_path of this CreateTableReq.
        :rtype: str
        """
    ...
    def data_path(self, data_path):
        """Sets the data_path of this CreateTableReq.

        OBS表必选参数。新增OBS表数据的存储路径，必须是OBS上的路径，以s3a开头。

        :param data_path: The data_path of this CreateTableReq.
        :type data_path: str
        """
    ...
    def with_column_header(self):
        """Gets the with_column_header of this CreateTableReq.

        OBS表非必选参数。OBS表数据是否包含表头。只有CSV类型数据具有该属性。

        :return: The with_column_header of this CreateTableReq.
        :rtype: bool
        """
    ...
    def with_column_header(self, with_column_header):
        """Sets the with_column_header of this CreateTableReq.

        OBS表非必选参数。OBS表数据是否包含表头。只有CSV类型数据具有该属性。

        :param with_column_header: The with_column_header of this CreateTableReq.
        :type with_column_header: bool
        """
    ...
    @property
    def delimiter(self):
        """Gets the delimiter of this CreateTableReq.

        OBS表非必选参数。用户自定义数据分隔符。只有CSV类型数据具有该属性。

        :return: The delimiter of this CreateTableReq.
        :rtype: str
        """
    ...
    def delimiter(self, delimiter):
        """Sets the delimiter of this CreateTableReq.

        OBS表非必选参数。用户自定义数据分隔符。只有CSV类型数据具有该属性。

        :param delimiter: The delimiter of this CreateTableReq.
        :type delimiter: str
        """
    ...
    @property
    def quote_char(self):
        """Gets the quote_char of this CreateTableReq.

        OBS表非必选参数。用户自定义引用字符，默认为双引号（即“\\\"”）。只有CSV类型数据具有该属性。

        :return: The quote_char of this CreateTableReq.
        :rtype: str
        """
    ...
    def quote_char(self, quote_char):
        """Sets the quote_char of this CreateTableReq.

        OBS表非必选参数。用户自定义引用字符，默认为双引号（即“\\\"”）。只有CSV类型数据具有该属性。

        :param quote_char: The quote_char of this CreateTableReq.
        :type quote_char: str
        """
    ...
    def escape_char(self):
        """Gets the escape_char of this CreateTableReq.

        OBS表非必选参数。用户自定义转义字符，默认为反斜杠（即\"\\\\\"）。只有CSV类型数据具有该属性。

        :return: The escape_char of this CreateTableReq.
        :rtype: str
        """
    ...
    def escape_char(self, escape_char):
        """Sets the escape_char of this CreateTableReq.

        OBS表非必选参数。用户自定义转义字符，默认为反斜杠（即\"\\\\\"）。只有CSV类型数据具有该属性。

        :param escape_char: The escape_char of this CreateTableReq.
        :type escape_char: str
        """
    ...
    def date_format(self):
        """Gets the date_format of this CreateTableReq.

        OBS表非必选参数。用户自定义日期类型，默认格式为“yyyy-MM-dd”。只有CSV和JSON类型数据具有该属性。

        :return: The date_format of this CreateTableReq.
        :rtype: str
        """
    ...
    def date_format(self, date_format):
        """Sets the date_format of this CreateTableReq.

        OBS表非必选参数。用户自定义日期类型，默认格式为“yyyy-MM-dd”。只有CSV和JSON类型数据具有该属性。

        :param date_format: The date_format of this CreateTableReq.
        :type date_format: str
        """
    ...
    def timestamp_format(self):
        """Gets the timestamp_format of this CreateTableReq.

        OBS表非必选参数。用户自定义时间类型。默认格式为“yyyy-MM-dd HH:mm:ss”。只有CSV和JSON类型数据具有该属性。

        :return: The timestamp_format of this CreateTableReq.
        :rtype: str
        """
    ...
    def timestamp_format(self, timestamp_format):
        """Sets the timestamp_format of this CreateTableReq.

        OBS表非必选参数。用户自定义时间类型。默认格式为“yyyy-MM-dd HH:mm:ss”。只有CSV和JSON类型数据具有该属性。

        :param timestamp_format: The timestamp_format of this CreateTableReq.
        :type timestamp_format: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateTableReq):
            return False
