...
class RunAuthorizationActionRequestBody:
    ...
    def user_name(self):
        ...
        :return: The user_name of this RunAuthorizationActionRequestBody.
        :rtype: str
        """
    ...
    def user_name(self, user_name):
        ...
        :param user_name: The user_name of this RunAuthorizationActionRequestBody.
        :type user_name: str
        """
    ...
    @property
    def project_id(self):
        r"""Gets the project_id of this RunAuthorizationActionRequestBody.

        被赋权的项目ID，数据赋权给其他项目后，该项目的管理员将有权访问指定的数据库或数据表。

        :return: The project_id of this RunAuthorizationActionRequestBody.
        :rtype: str
        """
    ...
    def project_id(self, project_id):
        r"""Sets the project_id of this RunAuthorizationActionRequestBody.

        被赋权的项目ID，数据赋权给其他项目后，该项目的管理员将有权访问指定的数据库或数据表。

        :param project_id: The project_id of this RunAuthorizationActionRequestBody.
        :type project_id: str
        """
    ...
    def action(self):
        ...
        :return: The action of this RunAuthorizationActionRequestBody.
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        ...
        :param action: The action of this RunAuthorizationActionRequestBody.
        :type action: str
        """
        self._action = action
    ...
    def privileges(self):
        ...
        :return: The privileges of this RunAuthorizationActionRequestBody.
    ...
    def privileges(self, privileges):
        ...
        :param privileges: The privileges of this RunAuthorizationActionRequestBody.
        :type privileges: list[:class:`huaweicloudsdkdli.v1.Privilege`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunAuthorizationActionRequestBody):
            return False
