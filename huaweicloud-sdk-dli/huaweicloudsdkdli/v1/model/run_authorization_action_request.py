...
class RunAuthorizationActionRequest:
    ...
    def __init__(self, body=None):
        r"""RunAuthorizationActionRequest
    ...
    @property
    def body(self):
        r"""Gets the body of this RunAuthorizationActionRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this RunAuthorizationActionRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunAuthorizationActionRequest):
            return False
