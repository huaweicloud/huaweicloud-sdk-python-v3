...
class ListResourcesTagsResponse(SdkResponse):
    ...
    @property
    def tags(self):
        r"""Gets the tags of this ListResourcesTagsResponse.
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this ListResourcesTagsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListResourcesTagsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListResourcesTagsResponse):
            return False
