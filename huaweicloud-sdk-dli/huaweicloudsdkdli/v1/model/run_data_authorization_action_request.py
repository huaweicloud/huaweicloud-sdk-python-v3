...
class RunDataAuthorizationActionRequest:
    ...
    openapi_types = {
        'body': 'RunDataAuthorizationActionRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the RunDataAuthorizationActionRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunDataAuthorizationActionRequest):
            return False
