...
class RunCatalogActionRequest:
    ...
    openapi_types = {
        'body': 'RunCatalogActionRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the RunCatalogActionRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunCatalogActionRequest):
            return False
