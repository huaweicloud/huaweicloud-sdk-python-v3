...
class AuthInfos:
    ...
    def auth_info_name(self):
        """Gets the auth_info_name of this AuthInfos.

        用户安全集群的登录用户名

        :return: The auth_info_name of this AuthInfos.
        :rtype: str
        """
    ...
    def auth_info_name(self, auth_info_name):
        """Sets the auth_info_name of this AuthInfos.

        用户安全集群的登录用户名

        :param auth_info_name: The auth_info_name of this AuthInfos.
        :type auth_info_name: str
        """
    ...
    @property
    def user_name(self):
        """Gets the user_name of this AuthInfos.

        用户安全集群的登录密码

        :return: The user_name of this AuthInfos.
        :rtype: str
        """
    ...
    def user_name(self, user_name):
        """Sets the user_name of this AuthInfos.

        用户安全集群的登录密码

        :param user_name: The user_name of this AuthInfos.
        :type user_name: str
        """
    ...
    def certificate_location(self):
        """Gets the certificate_location of this AuthInfos.

        用户安全集群的证书路径，目前只支持OBS路径，cer类型文件

        :return: The certificate_location of this AuthInfos.
        :rtype: str
        """
    ...
    def certificate_location(self, certificate_location):
        """Sets the certificate_location of this AuthInfos.

        用户安全集群的证书路径，目前只支持OBS路径，cer类型文件

        :param certificate_location: The certificate_location of this AuthInfos.
        :type certificate_location: str
        """
    ...
    def datasource_type(self):
        """Gets the datasource_type of this AuthInfos.

        数据源类型，目前支持CSS,KRB,passwd,Kafka_SSL

        :return: The datasource_type of this AuthInfos.
        :rtype: str
        """
    ...
    def datasource_type(self, datasource_type):
        """Sets the datasource_type of this AuthInfos.

        数据源类型，目前支持CSS,KRB,passwd,Kafka_SSL

        :param datasource_type: The datasource_type of this AuthInfos.
        :type datasource_type: str
        """
    ...
    def create_time(self):
        """Gets the create_time of this AuthInfos.

        创建时间戳

        :return: The create_time of this AuthInfos.
        :rtype: int
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this AuthInfos.

        创建时间戳

        :param create_time: The create_time of this AuthInfos.
        :type create_time: int
        """
    ...
    def update_time(self):
        """Gets the update_time of this AuthInfos.

        更新时间戳

        :return: The update_time of this AuthInfos.
        :rtype: int
        """
    ...
    def update_time(self, update_time):
        """Sets the update_time of this AuthInfos.

        更新时间戳

        :param update_time: The update_time of this AuthInfos.
        :type update_time: int
        """
    ...
    @property
    def krb5_conf(self):
        """Gets the krb5_conf of this AuthInfos.

        krb5配置文件obs路径

        :return: The krb5_conf of this AuthInfos.
        :rtype: str
        """
    ...
    def krb5_conf(self, krb5_conf):
        """Sets the krb5_conf of this AuthInfos.

        krb5配置文件obs路径

        :param krb5_conf: The krb5_conf of this AuthInfos.
        :type krb5_conf: str
        """
    ...
    @property
    def keytab(self):
        """Gets the keytab of this AuthInfos.

        keytab配置文件obs路径

        :return: The keytab of this AuthInfos.
        :rtype: str
        """
        return self._keytab
    ...
    def keytab(self, keytab):
        """Sets the keytab of this AuthInfos.

        keytab配置文件obs路径

        :param keytab: The keytab of this AuthInfos.
        :type keytab: str
        """
        self._keytab = keytab
    ...
    def truststore_location(self):
        """Gets the truststore_location of this AuthInfos.

        truststore配置文件obs路径

        :return: The truststore_location of this AuthInfos.
        :rtype: str
        """
    ...
    def truststore_location(self, truststore_location):
        """Sets the truststore_location of this AuthInfos.

        truststore配置文件obs路径

        :param truststore_location: The truststore_location of this AuthInfos.
        :type truststore_location: str
        """
    ...
    def keystore_location(self):
        """Gets the keystore_location of this AuthInfos.

        keystore配置文件obs路径

        :return: The keystore_location of this AuthInfos.
        :rtype: str
        """
    ...
    def keystore_location(self, keystore_location):
        """Sets the keystore_location of this AuthInfos.

        keystore配置文件obs路径

        :param keystore_location: The keystore_location of this AuthInfos.
        :type keystore_location: str
        """
    ...
    @property
    def owner(self):
        """Gets the owner of this AuthInfos.

        所属用户名

        :return: The owner of this AuthInfos.
        :rtype: str
        """
        return self._owner
    ...
    def owner(self, owner):
        """Sets the owner of this AuthInfos.

        所属用户名

        :param owner: The owner of this AuthInfos.
        :type owner: str
        """
        self._owner = owner
