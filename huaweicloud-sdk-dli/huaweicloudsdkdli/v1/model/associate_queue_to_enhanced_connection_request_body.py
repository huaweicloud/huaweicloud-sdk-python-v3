...
class AssociateQueueToEnhancedConnectionRequestBody:
    ...
    def queues(self):
        ...
        :return: The queues of this AssociateQueueToEnhancedConnectionRequestBody.
        :rtype: list[str]
        """
        return self._queues
    ...
    def queues(self, queues):
        ...
        :param queues: The queues of this AssociateQueueToEnhancedConnectionRequestBody.
        :type queues: list[str]
        """
        self._queues = queues
    ...
    def elastic_resource_pools(self):
        ...
        :return: The elastic_resource_pools of this AssociateQueueToEnhancedConnectionRequestBody.
        :rtype: list[str]
        """
    ...
    def elastic_resource_pools(self, elastic_resource_pools):
        ...
        :param elastic_resource_pools: The elastic_resource_pools of this AssociateQueueToEnhancedConnectionRequestBody.
        :type elastic_resource_pools: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssociateQueueToEnhancedConnectionRequestBody):
            return False
