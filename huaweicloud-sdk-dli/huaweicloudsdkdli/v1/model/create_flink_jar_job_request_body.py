...
class CreateFlinkJarJobRequestBody:
    ...
    def __init__(self, name=None, desc=None, queue_name=None, cu_number=None, manager_cu_number=None, parallel_number=None, checkpoint_enabled=None, checkpoint_mode=None, checkpoint_interval=None, log_enabled=None, obs_bucket=None, smn_topic=None, main_class=None, entrypoint_args=None, restart_when_exception=None, entrypoint=None, dependency_jars=None, dependency_files=None, flink_version=None, image=None, tm_slot_num=None, tm_cus=None, feature=None, resume_checkpoint=None, resume_max_num=None, checkpoint_path=None, runtime_config=None, flink_log_config=None, execution_agency_urn=None, tags=None, resource_config=None, resource_config_version=None):
    ...
    def name(self):
        ...
        :return: The name of this CreateFlinkJarJobRequestBody.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this CreateFlinkJarJobRequestBody.
        :type name: str
        """
        self._name = name
    ...
    def desc(self):
        ...
        :return: The desc of this CreateFlinkJarJobRequestBody.
        :rtype: str
        """
        return self._desc
    ...
    def desc(self, desc):
        ...
        :param desc: The desc of this CreateFlinkJarJobRequestBody.
        :type desc: str
        """
        self._desc = desc
    ...
    def queue_name(self):
        ...
        :return: The queue_name of this CreateFlinkJarJobRequestBody.
        :rtype: str
        """
    ...
    def queue_name(self, queue_name):
        ...
        :param queue_name: The queue_name of this CreateFlinkJarJobRequestBody.
        :type queue_name: str
        """
    ...
    def cu_number(self):
        ...
        :return: The cu_number of this CreateFlinkJarJobRequestBody.
        :rtype: int
        """
    ...
    def cu_number(self, cu_number):
        ...
        :param cu_number: The cu_number of this CreateFlinkJarJobRequestBody.
        :type cu_number: int
        """
    ...
    def manager_cu_number(self):
        ...
        :return: The manager_cu_number of this CreateFlinkJarJobRequestBody.
        :rtype: int
        """
    ...
    def manager_cu_number(self, manager_cu_number):
        ...
        :param manager_cu_number: The manager_cu_number of this CreateFlinkJarJobRequestBody.
        :type manager_cu_number: int
        """
    ...
    def parallel_number(self):
        ...
        :return: The parallel_number of this CreateFlinkJarJobRequestBody.
        :rtype: int
        """
    ...
    def parallel_number(self, parallel_number):
        ...
        :param parallel_number: The parallel_number of this CreateFlinkJarJobRequestBody.
        :type parallel_number: int
        """
    ...
    def checkpoint_enabled(self):
        r"""Gets the checkpoint_enabled of this CreateFlinkJarJobRequestBody.

        是否开启作业自动快照功能。 开启：true； 关闭：false； 默认：false

        :return: The checkpoint_enabled of this CreateFlinkJarJobRequestBody.
        :rtype: bool
        """
    ...
    def checkpoint_enabled(self, checkpoint_enabled):
        r"""Sets the checkpoint_enabled of this CreateFlinkJarJobRequestBody.

        是否开启作业自动快照功能。 开启：true； 关闭：false； 默认：false

        :param checkpoint_enabled: The checkpoint_enabled of this CreateFlinkJarJobRequestBody.
        :type checkpoint_enabled: bool
        """
    ...
    def checkpoint_mode(self):
        r"""Gets the checkpoint_mode of this CreateFlinkJarJobRequestBody.

        快照模式。 1：exactly_once（精确一次） 2：at_least_once（至少一次） 默认：1

        :return: The checkpoint_mode of this CreateFlinkJarJobRequestBody.
        :rtype: int
        """
    ...
    def checkpoint_mode(self, checkpoint_mode):
        r"""Sets the checkpoint_mode of this CreateFlinkJarJobRequestBody.

        快照模式。 1：exactly_once（精确一次） 2：at_least_once（至少一次） 默认：1

        :param checkpoint_mode: The checkpoint_mode of this CreateFlinkJarJobRequestBody.
        :type checkpoint_mode: int
        """
    ...
    def checkpoint_interval(self):
        r"""Gets the checkpoint_interval of this CreateFlinkJarJobRequestBody.

        快照间隔，单位为秒。 默认：10 取值范围：1-3600

        :return: The checkpoint_interval of this CreateFlinkJarJobRequestBody.
        :rtype: int
        """
    ...
    def checkpoint_interval(self, checkpoint_interval):
        r"""Sets the checkpoint_interval of this CreateFlinkJarJobRequestBody.

        快照间隔，单位为秒。 默认：10 取值范围：1-3600

        :param checkpoint_interval: The checkpoint_interval of this CreateFlinkJarJobRequestBody.
        :type checkpoint_interval: int
        """
    ...
    def log_enabled(self):
        ...
        :return: The log_enabled of this CreateFlinkJarJobRequestBody.
        :rtype: bool
        """
    ...
    def log_enabled(self, log_enabled):
        ...
        :param log_enabled: The log_enabled of this CreateFlinkJarJobRequestBody.
        :type log_enabled: bool
        """
    ...
    def obs_bucket(self):
        ...
        :return: The obs_bucket of this CreateFlinkJarJobRequestBody.
        :rtype: str
        """
    ...
    def obs_bucket(self, obs_bucket):
        ...
        :param obs_bucket: The obs_bucket of this CreateFlinkJarJobRequestBody.
        :type obs_bucket: str
        """
    ...
    def smn_topic(self):
        ...
        :return: The smn_topic of this CreateFlinkJarJobRequestBody.
        :rtype: str
        """
    ...
    def smn_topic(self, smn_topic):
        ...
        :param smn_topic: The smn_topic of this CreateFlinkJarJobRequestBody.
        :type smn_topic: str
        """
    ...
    def main_class(self):
        ...
        :return: The main_class of this CreateFlinkJarJobRequestBody.
        :rtype: str
        """
    ...
    def main_class(self, main_class):
        ...
        :param main_class: The main_class of this CreateFlinkJarJobRequestBody.
        :type main_class: str
        """
    ...
    def entrypoint_args(self):
        ...
        :return: The entrypoint_args of this CreateFlinkJarJobRequestBody.
        :rtype: str
        """
    ...
    def entrypoint_args(self, entrypoint_args):
        ...
        :param entrypoint_args: The entrypoint_args of this CreateFlinkJarJobRequestBody.
        :type entrypoint_args: str
        """
    ...
    def restart_when_exception(self):
        ...
        :return: The restart_when_exception of this CreateFlinkJarJobRequestBody.
        :rtype: bool
        """
    ...
    def restart_when_exception(self, restart_when_exception):
        ...
        :param restart_when_exception: The restart_when_exception of this CreateFlinkJarJobRequestBody.
        :type restart_when_exception: bool
        """
    ...
    def flink_version(self):
        ...
        :return: The flink_version of this CreateFlinkJarJobRequestBody.
        :rtype: str
        """
    ...
    def flink_version(self, flink_version):
        ...
        :param flink_version: The flink_version of this CreateFlinkJarJobRequestBody.
        :type flink_version: str
        """
    ...
    def image(self):
        ...
        :return: The image of this CreateFlinkJarJobRequestBody.
        :rtype: str
        """
        return self._image
    ...
    def image(self, image):
        ...
        :param image: The image of this CreateFlinkJarJobRequestBody.
        :type image: str
        """
        self._image = image
    ...
    def tm_slot_num(self):
        ...
        :return: The tm_slot_num of this CreateFlinkJarJobRequestBody.
        :rtype: int
        """
    ...
    def tm_slot_num(self, tm_slot_num):
        ...
        :param tm_slot_num: The tm_slot_num of this CreateFlinkJarJobRequestBody.
        :type tm_slot_num: int
        """
    ...
    def tm_cus(self):
        ...
        :return: The tm_cus of this CreateFlinkJarJobRequestBody.
        :rtype: int
        """
        return self._tm_cus
    ...
    def tm_cus(self, tm_cus):
        ...
        :param tm_cus: The tm_cus of this CreateFlinkJarJobRequestBody.
        :type tm_cus: int
        """
        self._tm_cus = tm_cus
    ...
    def feature(self):
        ...
        :return: The feature of this CreateFlinkJarJobRequestBody.
        :rtype: str
        """
    ...
    def feature(self, feature):
        ...
        :param feature: The feature of this CreateFlinkJarJobRequestBody.
        :type feature: str
        """
    ...
    def resume_checkpoint(self):
        ...
        :return: The resume_checkpoint of this CreateFlinkJarJobRequestBody.
        :rtype: bool
        """
    ...
    def resume_checkpoint(self, resume_checkpoint):
        ...
        :param resume_checkpoint: The resume_checkpoint of this CreateFlinkJarJobRequestBody.
        :type resume_checkpoint: bool
        """
    ...
    def resume_max_num(self):
        ...
        :return: The resume_max_num of this CreateFlinkJarJobRequestBody.
        :rtype: int
        """
    ...
    def resume_max_num(self, resume_max_num):
        ...
        :param resume_max_num: The resume_max_num of this CreateFlinkJarJobRequestBody.
        :type resume_max_num: int
        """
    ...
    def checkpoint_path(self):
        ...
        :return: The checkpoint_path of this CreateFlinkJarJobRequestBody.
        :rtype: str
        """
    ...
    def checkpoint_path(self, checkpoint_path):
        ...
        :param checkpoint_path: The checkpoint_path of this CreateFlinkJarJobRequestBody.
        :type checkpoint_path: str
        """
    ...
    def runtime_config(self):
        ...
        :return: The runtime_config of this CreateFlinkJarJobRequestBody.
        :rtype: str
        """
    ...
    def runtime_config(self, runtime_config):
        ...
        :param runtime_config: The runtime_config of this CreateFlinkJarJobRequestBody.
        :type runtime_config: str
        """
    ...
    def flink_log_config(self):
        r"""Gets the flink_log_config of this CreateFlinkJarJobRequestBody.
        ...
        :return: The flink_log_config of this CreateFlinkJarJobRequestBody.
        :rtype: str
        """
    ...
    def flink_log_config(self, flink_log_config):
        r"""Sets the flink_log_config of this CreateFlinkJarJobRequestBody.

        Flink作业日志级别配置（JSON格式）。 支持全局root_logger_level及类/包级别loggers_level_of_class精细化控制，可选值为：TRACE，DEBUG，INFO，WARN，ERROR。 例如：{\\\"root_logger_level\\\":\\\"INFO\\\",\\\"loggers_level_of_class\\\":{\\\"org.apache.flink\\\":\\\"WARN\\\",\\\"org.apache.kafka.clients.consumer.KafkaConsumer\\\":\\\"DEBUG\\\",\\\"com.mycompany.job.MainFunction\\\":\\\"TRACE\\\"}}

        :param flink_log_config: The flink_log_config of this CreateFlinkJarJobRequestBody.
        :type flink_log_config: str
        """
    ...
    def tags(self):
        ...
        :return: The tags of this CreateFlinkJarJobRequestBody.
    ...
    def tags(self, tags):
        ...
        :param tags: The tags of this CreateFlinkJarJobRequestBody.
        :type tags: list[:class:`huaweicloudsdkdli.v1.Tag`]
        """
        self._tags = tags
    ...
    def resource_config(self):
        r"""Gets the resource_config of this CreateFlinkJarJobRequestBody.

        :return: The resource_config of this CreateFlinkJarJobRequestBody.
    ...
    def resource_config(self, resource_config):
        r"""Sets the resource_config of this CreateFlinkJarJobRequestBody.

        :param resource_config: The resource_config of this CreateFlinkJarJobRequestBody.
        :type resource_config: :class:`huaweicloudsdkdli.v1.ResourceConfig`
        """
    ...
    def resource_config_version(self):
        r"""Gets the resource_config_version of this CreateFlinkJarJobRequestBody.

        资源配置版本。可选值 \"v1\" ,\"v2\".默认为\"v1\"。

        :return: The resource_config_version of this CreateFlinkJarJobRequestBody.
        :rtype: str
        """
    ...
    def resource_config_version(self, resource_config_version):
        r"""Sets the resource_config_version of this CreateFlinkJarJobRequestBody.

        资源配置版本。可选值 \"v1\" ,\"v2\".默认为\"v1\"。

        :param resource_config_version: The resource_config_version of this CreateFlinkJarJobRequestBody.
        :type resource_config_version: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateFlinkJarJobRequestBody):
            return False
