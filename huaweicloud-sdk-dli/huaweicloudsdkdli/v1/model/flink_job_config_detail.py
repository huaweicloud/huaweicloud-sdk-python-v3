...
class FlinkJobConfigDetail:
    ...
    def checkpoint_enabled(self):
        """Gets the checkpoint_enabled of this FlinkJobConfigDetail.

        是否开启作业自动快照功能。 开启：true； 关闭：false； 默认：false。

        :return: The checkpoint_enabled of this FlinkJobConfigDetail.
        :rtype: bool
        """
    ...
    def checkpoint_enabled(self, checkpoint_enabled):
        """Sets the checkpoint_enabled of this FlinkJobConfigDetail.

        是否开启作业自动快照功能。 开启：true； 关闭：false； 默认：false。

        :param checkpoint_enabled: The checkpoint_enabled of this FlinkJobConfigDetail.
        :type checkpoint_enabled: bool
        """
    ...
    def checkpoint_mode(self):
        """Gets the checkpoint_mode of this FlinkJobConfigDetail.

        快照模式： exactly_once：数据只被消费一次。 at_least_once：数据至少被消费一次。 默认值为exactly_once。

        :return: The checkpoint_mode of this FlinkJobConfigDetail.
        :rtype: str
        """
    ...
    def checkpoint_mode(self, checkpoint_mode):
        """Sets the checkpoint_mode of this FlinkJobConfigDetail.

        快照模式： exactly_once：数据只被消费一次。 at_least_once：数据至少被消费一次。 默认值为exactly_once。

        :param checkpoint_mode: The checkpoint_mode of this FlinkJobConfigDetail.
        :type checkpoint_mode: str
        """
    ...
    def checkpoint_interval(self):
        """Gets the checkpoint_interval of this FlinkJobConfigDetail.

        快照时间间隔, 单位为秒，默认值为10。

        :return: The checkpoint_interval of this FlinkJobConfigDetail.
        :rtype: int
        """
    ...
    def checkpoint_interval(self, checkpoint_interval):
        """Sets the checkpoint_interval of this FlinkJobConfigDetail.

        快照时间间隔, 单位为秒，默认值为10。

        :param checkpoint_interval: The checkpoint_interval of this FlinkJobConfigDetail.
        :type checkpoint_interval: int
        """
    ...
    def log_enabled(self):
        """Gets the log_enabled of this FlinkJobConfigDetail.

        是否启用日志存储。默认为false。

        :return: The log_enabled of this FlinkJobConfigDetail.
        :rtype: bool
        """
    ...
    def log_enabled(self, log_enabled):
        """Sets the log_enabled of this FlinkJobConfigDetail.

        是否启用日志存储。默认为false。

        :param log_enabled: The log_enabled of this FlinkJobConfigDetail.
        :type log_enabled: bool
        """
    ...
    @property
    def obs_bucket(self):
        """Gets the obs_bucket of this FlinkJobConfigDetail.

        OBS桶名。

        :return: The obs_bucket of this FlinkJobConfigDetail.
        :rtype: str
        """
    ...
    def obs_bucket(self, obs_bucket):
        """Sets the obs_bucket of this FlinkJobConfigDetail.

        OBS桶名。

        :param obs_bucket: The obs_bucket of this FlinkJobConfigDetail.
        :type obs_bucket: str
        """
    ...
    @property
    def smn_topic(self):
        """Gets the smn_topic of this FlinkJobConfigDetail.

        当作业异常时，向该SMN主题推送告警信息。

        :return: The smn_topic of this FlinkJobConfigDetail.
        :rtype: str
        """
    ...
    def smn_topic(self, smn_topic):
        """Sets the smn_topic of this FlinkJobConfigDetail.

        当作业异常时，向该SMN主题推送告警信息。

        :param smn_topic: The smn_topic of this FlinkJobConfigDetail.
        :type smn_topic: str
        """
    ...
    def edge_group_ids(self):
        """Gets the edge_group_ids of this FlinkJobConfigDetail.

        边缘计算组ID列表。

        :return: The edge_group_ids of this FlinkJobConfigDetail.
        :rtype: list[str]
        """
    ...
    def edge_group_ids(self, edge_group_ids):
        """Sets the edge_group_ids of this FlinkJobConfigDetail.

        边缘计算组ID列表。

        :param edge_group_ids: The edge_group_ids of this FlinkJobConfigDetail.
        :type edge_group_ids: list[str]
        """
    ...
    @property
    def root_id(self):
        """Gets the root_id of this FlinkJobConfigDetail.

        父作业ID。

        :return: The root_id of this FlinkJobConfigDetail.
        :rtype: int
        """
    ...
    def root_id(self, root_id):
        """Sets the root_id of this FlinkJobConfigDetail.

        父作业ID。

        :param root_id: The root_id of this FlinkJobConfigDetail.
        :type root_id: int
        """
    ...
    def manager_cu_number(self):
        """Gets the manager_cu_number of this FlinkJobConfigDetail.

        管理单元CU数。默认为1。

        :return: The manager_cu_number of this FlinkJobConfigDetail.
        :rtype: int
        """
    ...
    def manager_cu_number(self, manager_cu_number):
        """Sets the manager_cu_number of this FlinkJobConfigDetail.

        管理单元CU数。默认为1。

        :param manager_cu_number: The manager_cu_number of this FlinkJobConfigDetail.
        :type manager_cu_number: int
        """
    ...
    @property
    def cu_number(self):
        """Gets the cu_number of this FlinkJobConfigDetail.

        用户为作业选择的CU数量, “show_detail”。默认为2。

        :return: The cu_number of this FlinkJobConfigDetail.
        :rtype: int
        """
    ...
    def cu_number(self, cu_number):
        """Sets the cu_number of this FlinkJobConfigDetail.

        用户为作业选择的CU数量, “show_detail”。默认为2。

        :param cu_number: The cu_number of this FlinkJobConfigDetail.
        :type cu_number: int
        """
    ...
    def parallel_number(self):
        """Gets the parallel_number of this FlinkJobConfigDetail.

        用户设置的作业并行数， “show_detail”为“true”时独有。默认值为1。 最小值：1，最大值：2000。

        :return: The parallel_number of this FlinkJobConfigDetail.
        :rtype: int
        """
    ...
    def parallel_number(self, parallel_number):
        """Sets the parallel_number of this FlinkJobConfigDetail.

        用户设置的作业并行数， “show_detail”为“true”时独有。默认值为1。 最小值：1，最大值：2000。

        :param parallel_number: The parallel_number of this FlinkJobConfigDetail.
        :type parallel_number: int
        """
    ...
    def restart_when_exception(self):
        """Gets the restart_when_exception of this FlinkJobConfigDetail.

        是否开启异常重启功能。

        :return: The restart_when_exception of this FlinkJobConfigDetail.
        :rtype: bool
        """
    ...
    def restart_when_exception(self, restart_when_exception):
        """Sets the restart_when_exception of this FlinkJobConfigDetail.

        是否开启异常重启功能。

        :param restart_when_exception: The restart_when_exception of this FlinkJobConfigDetail.
        :type restart_when_exception: bool
        """
    ...
    def idle_state_retention(self):
        """Gets the idle_state_retention of this FlinkJobConfigDetail.

        空闲状态过期周期。

        :return: The idle_state_retention of this FlinkJobConfigDetail.
        :rtype: int
        """
    ...
    def idle_state_retention(self, idle_state_retention):
        """Sets the idle_state_retention of this FlinkJobConfigDetail.

        空闲状态过期周期。

        :param idle_state_retention: The idle_state_retention of this FlinkJobConfigDetail.
        :type idle_state_retention: int
        """
    ...
    def udf_jar_url(self):
        """Gets the udf_jar_url of this FlinkJobConfigDetail.

        用户已上传到DLI资源管理系统的资源包名，用户sql作业的udf jar通过该参数传入。

        :return: The udf_jar_url of this FlinkJobConfigDetail.
        :rtype: str
        """
    ...
    def udf_jar_url(self, udf_jar_url):
        """Sets the udf_jar_url of this FlinkJobConfigDetail.

        用户已上传到DLI资源管理系统的资源包名，用户sql作业的udf jar通过该参数传入。

        :param udf_jar_url: The udf_jar_url of this FlinkJobConfigDetail.
        :type udf_jar_url: str
        """
    ...
    def dirty_data_strategy(self):
        """Gets the dirty_data_strategy of this FlinkJobConfigDetail.

        作业脏数据策略。 “2:obs-wan-wulan3/jobs”：保存 “1”：抛出异常 “0”：忽略

        :return: The dirty_data_strategy of this FlinkJobConfigDetail.
        :rtype: str
        """
    ...
    def dirty_data_strategy(self, dirty_data_strategy):
        """Sets the dirty_data_strategy of this FlinkJobConfigDetail.

        作业脏数据策略。 “2:obs-wan-wulan3/jobs”：保存 “1”：抛出异常 “0”：忽略

        :param dirty_data_strategy: The dirty_data_strategy of this FlinkJobConfigDetail.
        :type dirty_data_strategy: str
        """
    ...
    @property
    def entrypoint(self):
        """Gets the entrypoint of this FlinkJobConfigDetail.

        用户已上传到DLI资源管理系统的资源包名，用户自定义作业主类所在的jar包.

        :return: The entrypoint of this FlinkJobConfigDetail.
        :rtype: str
        """
    ...
    def entrypoint(self, entrypoint):
        """Sets the entrypoint of this FlinkJobConfigDetail.

        用户已上传到DLI资源管理系统的资源包名，用户自定义作业主类所在的jar包.

        :param entrypoint: The entrypoint of this FlinkJobConfigDetail.
        :type entrypoint: str
        """
    ...
    def dependency_jars(self):
        """Gets the dependency_jars of this FlinkJobConfigDetail.

        用户已上传到DLI资源管理系统的资源包名，用户自定义作业的其他依赖包

        :return: The dependency_jars of this FlinkJobConfigDetail.
        :rtype: list[str]
        """
    ...
    def dependency_jars(self, dependency_jars):
        """Sets the dependency_jars of this FlinkJobConfigDetail.

        用户已上传到DLI资源管理系统的资源包名，用户自定义作业的其他依赖包

        :param dependency_jars: The dependency_jars of this FlinkJobConfigDetail.
        :type dependency_jars: list[str]
        """
    ...
    def dependency_files(self):
        """Gets the dependency_files of this FlinkJobConfigDetail.

        用户已上传到DLI资源管理系统的资源包名，用户自定义作业的依赖文件.

        :return: The dependency_files of this FlinkJobConfigDetail.
        :rtype: list[str]
        """
    ...
    def dependency_files(self, dependency_files):
        """Sets the dependency_files of this FlinkJobConfigDetail.

        用户已上传到DLI资源管理系统的资源包名，用户自定义作业的依赖文件.

        :param dependency_files: The dependency_files of this FlinkJobConfigDetail.
        :type dependency_files: list[str]
        """
    ...
    def executor_number(self):
        """Gets the executor_number of this FlinkJobConfigDetail.

        作业使用计算节点个数

        :return: The executor_number of this FlinkJobConfigDetail.
        :rtype: int
        """
    ...
    def executor_number(self, executor_number):
        """Sets the executor_number of this FlinkJobConfigDetail.

        作业使用计算节点个数

        :param executor_number: The executor_number of this FlinkJobConfigDetail.
        :type executor_number: int
        """
    ...
    def executor_cu_number(self):
        """Gets the executor_cu_number of this FlinkJobConfigDetail.

        计算节点cu数

        :return: The executor_cu_number of this FlinkJobConfigDetail.
        :rtype: int
        """
    ...
    def executor_cu_number(self, executor_cu_number):
        """Sets the executor_cu_number of this FlinkJobConfigDetail.

        计算节点cu数

        :param executor_cu_number: The executor_cu_number of this FlinkJobConfigDetail.
        :type executor_cu_number: int
        """
    ...
    def resume_checkpoint(self):
        """Gets the resume_checkpoint of this FlinkJobConfigDetail.

        异常自动重启时，是否从最新checkpoint恢复，默认false

        :return: The resume_checkpoint of this FlinkJobConfigDetail.
        :rtype: bool
        """
    ...
    def resume_checkpoint(self, resume_checkpoint):
        """Sets the resume_checkpoint of this FlinkJobConfigDetail.

        异常自动重启时，是否从最新checkpoint恢复，默认false

        :param resume_checkpoint: The resume_checkpoint of this FlinkJobConfigDetail.
        :type resume_checkpoint: bool
        """
    ...
    def runtime_config(self):
        """Gets the runtime_config of this FlinkJobConfigDetail.

        Flink作业运行时自定义优化参数。

        :return: The runtime_config of this FlinkJobConfigDetail.
        :rtype: str
        """
    ...
    def runtime_config(self, runtime_config):
        """Sets the runtime_config of this FlinkJobConfigDetail.

        Flink作业运行时自定义优化参数。

        :param runtime_config: The runtime_config of this FlinkJobConfigDetail.
        :type runtime_config: str
        """
    ...
    def graph_editor_enabled(self):
        """Gets the graph_editor_enabled of this FlinkJobConfigDetail.

        流图编辑开关。默认为“false。

        :return: The graph_editor_enabled of this FlinkJobConfigDetail.
        :rtype: bool
        """
    ...
    def graph_editor_enabled(self, graph_editor_enabled):
        """Sets the graph_editor_enabled of this FlinkJobConfigDetail.

        流图编辑开关。默认为“false。

        :param graph_editor_enabled: The graph_editor_enabled of this FlinkJobConfigDetail.
        :type graph_editor_enabled: bool
        """
    ...
    def graph_editor_data(self):
        """Gets the graph_editor_data of this FlinkJobConfigDetail.

        流图编辑数据。默认为null。

        :return: The graph_editor_data of this FlinkJobConfigDetail.
        :rtype: str
        """
    ...
    def graph_editor_data(self, graph_editor_data):
        """Sets the graph_editor_data of this FlinkJobConfigDetail.

        流图编辑数据。默认为null。

        :param graph_editor_data: The graph_editor_data of this FlinkJobConfigDetail.
        :type graph_editor_data: str
        """
    ...
    def resume_max_num(self):
        """Gets the resume_max_num of this FlinkJobConfigDetail.

        异常重试最大次数。-1代表无限。

        :return: The resume_max_num of this FlinkJobConfigDetail.
        :rtype: int
        """
    ...
    def resume_max_num(self, resume_max_num):
        """Sets the resume_max_num of this FlinkJobConfigDetail.

        异常重试最大次数。-1代表无限。

        :param resume_max_num: The resume_max_num of this FlinkJobConfigDetail.
        :type resume_max_num: int
        """
    ...
    def checkpoint_path(self):
        """Gets the checkpoint_path of this FlinkJobConfigDetail.

        检查点保存路径。

        :return: The checkpoint_path of this FlinkJobConfigDetail.
        :rtype: str
        """
    ...
    def checkpoint_path(self, checkpoint_path):
        """Sets the checkpoint_path of this FlinkJobConfigDetail.

        检查点保存路径。

        :param checkpoint_path: The checkpoint_path of this FlinkJobConfigDetail.
        :type checkpoint_path: str
        """
    ...
    @property
    def config_url(self):
        """Gets the config_url of this FlinkJobConfigDetail.

        用户上传的config包OBS路径。

        :return: The config_url of this FlinkJobConfigDetail.
        :rtype: str
        """
    ...
    def config_url(self, config_url):
        """Sets the config_url of this FlinkJobConfigDetail.

        用户上传的config包OBS路径。

        :param config_url: The config_url of this FlinkJobConfigDetail.
        :type config_url: str
        """
    ...
    @property
    def tm_cus(self):
        """Gets the tm_cus of this FlinkJobConfigDetail.

        单TM所占CU数。

        :return: The tm_cus of this FlinkJobConfigDetail.
        :rtype: int
        """
        return self._tm_cus
    ...
    def tm_cus(self, tm_cus):
        """Sets the tm_cus of this FlinkJobConfigDetail.

        单TM所占CU数。

        :param tm_cus: The tm_cus of this FlinkJobConfigDetail.
        :type tm_cus: int
        """
        self._tm_cus = tm_cus
    ...
    def tm_slot_num(self):
        """Gets the tm_slot_num of this FlinkJobConfigDetail.

        单TM Slot数。

        :return: The tm_slot_num of this FlinkJobConfigDetail.
        :rtype: int
        """
    ...
    def tm_slot_num(self, tm_slot_num):
        """Sets the tm_slot_num of this FlinkJobConfigDetail.

        单TM Slot数。

        :param tm_slot_num: The tm_slot_num of this FlinkJobConfigDetail.
        :type tm_slot_num: int
        """
    ...
    def image(self, image):
        """Sets the image of this FlinkJobConfigDetail.

        自定义镜像。格式为：组织名/镜像名:镜像版本。当用户设置“feature”为“custom”时，该参数生效。用户可通过与“feature”参数配合使用，指定作业运行使用自定义的Flink镜像。

        :param image: The image of this FlinkJobConfigDetail.
        :type image: str
        """
        self._image = image
    ...
    @property
    def feature(self):
        """Gets the feature of this FlinkJobConfigDetail.

        自定义作业特性。表示用户作业使用的Flink镜像类型。basic：表示使用DLI提供的基础Flink镜像。custom：表示使用用户自定义的Flink镜像。

        :return: The feature of this FlinkJobConfigDetail.
        :rtype: str
        """
    ...
    def feature(self, feature):
        """Sets the feature of this FlinkJobConfigDetail.

        自定义作业特性。表示用户作业使用的Flink镜像类型。basic：表示使用DLI提供的基础Flink镜像。custom：表示使用用户自定义的Flink镜像。

        :param feature: The feature of this FlinkJobConfigDetail.
        :type feature: str
        """
    ...
    def flink_version(self):
        """Gets the flink_version of this FlinkJobConfigDetail.

        Flink版本。当用户设置“feature”为“basic”时，该参数生效。用户可通过与“feature”参数配合使用，指定作业运行使用的DLI基础Flink镜像的版本。

        :return: The flink_version of this FlinkJobConfigDetail.
        :rtype: str
        """
    ...
    def flink_version(self, flink_version):
        """Sets the flink_version of this FlinkJobConfigDetail.

        Flink版本。当用户设置“feature”为“basic”时，该参数生效。用户可通过与“feature”参数配合使用，指定作业运行使用的DLI基础Flink镜像的版本。

        :param flink_version: The flink_version of this FlinkJobConfigDetail.
        :type flink_version: str
        """
    ...
    def operator_config(self):
        """Gets the operator_config of this FlinkJobConfigDetail.

        各算子并行度参数，以json的形式展示各算子id和并行度。

        :return: The operator_config of this FlinkJobConfigDetail.
        :rtype: str
        """
    ...
    def operator_config(self, operator_config):
        """Sets the operator_config of this FlinkJobConfigDetail.

        各算子并行度参数，以json的形式展示各算子id和并行度。

        :param operator_config: The operator_config of this FlinkJobConfigDetail.
        :type operator_config: str
        """
    ...
    def static_estimator_config(self):
        """Gets the static_estimator_config of this FlinkJobConfigDetail.

        静态流图资源预估参数，以json的形式展示。

        :return: The static_estimator_config of this FlinkJobConfigDetail.
        :rtype: str
        """
    ...
    def static_estimator_config(self, static_estimator_config):
        """Sets the static_estimator_config of this FlinkJobConfigDetail.

        静态流图资源预估参数，以json的形式展示。

        :param static_estimator_config: The static_estimator_config of this FlinkJobConfigDetail.
        :type static_estimator_config: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FlinkJobConfigDetail):
            return False
