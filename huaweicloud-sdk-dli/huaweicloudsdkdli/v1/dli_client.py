...
class DliClient(Client):
    ...
    def create_stream_job(self, request):
        """提交流作业
        ...
        :param request: Request instance for CreateStreamJob
        :type request: :class:`huaweicloudsdkdli.v1.CreateStreamJobRequest`
        :rtype: :class:`huaweicloudsdkdli.v1.CreateStreamJobResponse`
        """
        http_info = self._create_stream_job_http_info(request)
        return self._call_api(**http_info)

    def create_stream_job_invoker(self, request):
        http_info = self._create_stream_job_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_stream_job_http_info(cls, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v2/{project_id}/streams",
            "request_type": request.__class__.__name__,
            "response_type": "CreateStreamJobResponse"
            }
