...
class ListDataobjectRelationResponse(SdkResponse):
    ...
    def __init__(self, code=None, message=None, total=None, limit=None, offset=None, data=None, x_request_id=None):
        ...
        :type data: list[:class:`huaweicloudsdksa.v2.DataobjectInfo`]
        :param x_request_id: 
    ...
    def data(self):
        ...
        :rtype: list[:class:`huaweicloudsdksa.v2.DataobjectInfo`]
        """
        return self._data
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListDataobjectRelationResponse.to_dict() is deprecated and no longer maintained, "
