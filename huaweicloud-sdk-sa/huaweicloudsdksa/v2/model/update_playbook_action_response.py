...
class UpdatePlaybookActionResponse(SdkResponse):
    ...
    def __init__(self, code=None, message=None, data=None, x_request_id=None):
        ...
        :type message: str
        :param data: 
        :type data: :class:`huaweicloudsdksa.v2.ActionInfo`
        :param x_request_id: 
        :type x_request_id: str
        """
        
        super(UpdatePlaybookActionResponse, self).__init__()
    ...
    def code(self):
        ...
        :return: The code of this UpdatePlaybookActionResponse.
        :rtype: str
        """
        return self._code
    ...
    def code(self, code):
        ...
        :param code: The code of this UpdatePlaybookActionResponse.
        :type code: str
        """
        self._code = code
    ...
    def message(self):
        ...
        :return: The message of this UpdatePlaybookActionResponse.
        :rtype: str
        """
    ...
    def message(self, message):
        ...
        :param message: The message of this UpdatePlaybookActionResponse.
        :type message: str
        """
    ...
    def data(self):
        ...
        :rtype: :class:`huaweicloudsdksa.v2.ActionInfo`
        """
        return self._data
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdatePlaybookActionResponse):
            return False
