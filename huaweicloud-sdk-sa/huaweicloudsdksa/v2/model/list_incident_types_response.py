...
class ListIncidentTypesResponse(SdkResponse):
    ...
    def __init__(self, code=None, message=None, data=None, total=None, size=None, page=None, x_request_id=None):
        ...
        :type data: list[:class:`huaweicloudsdksa.v2.DataClassTypeDetailInfo`]
    ...
    def data(self):
        ...
        :rtype: list[:class:`huaweicloudsdksa.v2.DataClassTypeDetailInfo`]
        """
        return self._data
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListIncidentTypesResponse.to_dict() is deprecated and no longer maintained, "
