...
class CreatePlaybookRuleRequest:
    ...
    def __init__(self, project_id=None, workspace_id=None, version_id=None, body=None):
        ...
        :type body: :class:`huaweicloudsdksa.v2.CreateRuleInfo`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdksa.v2.CreateRuleInfo`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreatePlaybookRuleRequest):
            return False
