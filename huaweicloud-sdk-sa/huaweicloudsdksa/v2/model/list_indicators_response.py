...
class ListIndicatorsResponse(SdkResponse):
    ...
    def __init__(self, code=None, message=None, total=None, data=None, x_request_id=None):
        ...
        :type data: list[:class:`huaweicloudsdksa.v2.IndicatorDetail`]
        :param x_request_id: 
    ...
    def data(self):
        ...
        :rtype: list[:class:`huaweicloudsdksa.v2.IndicatorDetail`]
        """
        return self._data
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListIndicatorsResponse.to_dict() is deprecated and no longer maintained, "
