...
class ShowPlaybookTopologyResponse(SdkResponse):
    ...
    def __init__(self, count=None, action_instances=None, x_request_id=None):
        ...
        :type action_instances: list[:class:`huaweicloudsdksa.v2.ActionInstanceInfo`]
        :param x_request_id: 
    ...
    def action_instances(self):
        ...
        :rtype: list[:class:`huaweicloudsdksa.v2.ActionInstanceInfo`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowPlaybookTopologyResponse.to_dict() is deprecated and no longer maintained, "
