...
class UpdateDefaultTopicRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the UpdateDefaultTopicRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateDefaultTopicRequest):
            return False
