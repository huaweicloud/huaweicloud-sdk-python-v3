...
class ShowDocWatermarkByAddressRequest:
    ...
    openapi_types = {
        'body': 'ShowDocWatermarkByAddressRequestBody'
    }
    ...
    def __init__(self, body=None):
        """ShowDocWatermarkByAddressRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: ShowDocWatermarkByAddressRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowDocWatermarkByAddressRequest):
            return False
