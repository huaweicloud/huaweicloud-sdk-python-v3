...
class ShowImageWatermarkWithImageRequest:
    ...
    openapi_types = {
        'body': 'ShowImageWatermarkWithImageRequestBody'
    }
    ...
    def __init__(self, body=None):
        """ShowImageWatermarkWithImageRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: ShowImageWatermarkWithImageRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowImageWatermarkWithImageRequest):
            return False
