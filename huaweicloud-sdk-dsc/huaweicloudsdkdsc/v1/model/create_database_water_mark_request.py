...
class CreateDatabaseWaterMarkRequest:
    ...
    openapi_types = {
        'body': 'EmbeddedDatabaseWatermark'
    }
    ...
    def __init__(self, body=None):
        """CreateDatabaseWaterMarkRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: EmbeddedDatabaseWatermark
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateDatabaseWaterMarkRequest):
            return False
