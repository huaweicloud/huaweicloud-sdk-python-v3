...
class ShowImageWatermarkByAddressResponse(SdkResponse):
    ...
    def __init__(self, watermark=None):
        """ShowImageWatermarkByAddressResponse - a model defined in huaweicloud sdk"""
        
        super(ShowImageWatermarkByAddressResponse, self).__init__()
    ...
    @property
    def watermark(self):
        """Gets the watermark of this ShowImageWatermarkByAddressResponse.
    ...
    def watermark(self, watermark):
        """Sets the watermark of this ShowImageWatermarkByAddressResponse.
