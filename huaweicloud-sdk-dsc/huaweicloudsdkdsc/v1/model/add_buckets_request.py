...
class AddBucketsRequest:
    ...
    def __init__(self, type=None, body=None):
        ...
        :param type: 资产类型
        :type type: str
        :param body: Body of the AddBucketsRequest
    ...
    def type(self):
        ...
        :return: The type of this AddBucketsRequest.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        ...
        :param type: The type of this AddBucketsRequest.
        :type type: str
        """
        self._type = type
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddBucketsRequest):
            return False
