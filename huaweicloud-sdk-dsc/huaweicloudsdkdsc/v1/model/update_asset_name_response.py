...
class UpdateAssetNameResponse(SdkResponse):
    ...
    @property
    def msg(self):
        r"""Gets the msg of this UpdateAssetNameResponse.
    ...
    @msg.setter
    def msg(self, msg):
        r"""Sets the msg of this UpdateAssetNameResponse.
    ...
    @property
    def status(self):
        r"""Gets the status of this UpdateAssetNameResponse.
    ...
    def status(self, status):
        r"""Sets the status of this UpdateAssetNameResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateAssetNameResponse.to_dict() is deprecated and no longer maintained, "
