...
class ShowWorkflowExecutionForPageRequest:
    ...
    def __init__(self, workflow_id=None, body=None):
        ...
        :param body: Body of the ShowWorkflowExecutionForPageRequest
        :type body: :class:`huaweicloudsdkfunctiongraph.v2.QueryRunListParam`
        """
    ...
    @property
    def body(self):
        """Gets the body of this ShowWorkflowExecutionForPageRequest.

        :return: The body of this ShowWorkflowExecutionForPageRequest.
        :rtype: :class:`huaweicloudsdkfunctiongraph.v2.QueryRunListParam`
        """
        return self._body

    @body.setter
    def body(self, body):
        """Sets the body of this ShowWorkflowExecutionForPageRequest.

        :param body: The body of this ShowWorkflowExecutionForPageRequest.
        :type body: :class:`huaweicloudsdkfunctiongraph.v2.QueryRunListParam`
        """
        self._body = body
