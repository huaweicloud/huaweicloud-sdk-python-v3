...
class ShowTracingResponse(SdkResponse):
    ...
    def tracing_ak(self):
        ...
        :return: The tracing_ak of this ShowTracingResponse.
        :rtype: str
        """
    ...
    def tracing_sk(self):
        ...
        :return: The tracing_sk of this ShowTracingResponse.
        :rtype: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowTracingResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowTracingResponse):
            return False
