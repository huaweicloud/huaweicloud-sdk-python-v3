...
class CreateFunctionTriggerResponse(SdkResponse):
    ...
    def __init__(self, trigger_id=None, trigger_type_code=None, trigger_status=None, event_data=None, last_updated_time=None, created_time=None):
        r"""CreateFunctionTriggerResponse
    ...
    @property
    def trigger_id(self):
        r"""Gets the trigger_id of this CreateFunctionTriggerResponse.

        触发器ID。

        :return: The trigger_id of this CreateFunctionTriggerResponse.
        :rtype: str
        """
    ...
    def trigger_id(self, trigger_id):
        r"""Sets the trigger_id of this CreateFunctionTriggerResponse.

        触发器ID。

        :param trigger_id: The trigger_id of this CreateFunctionTriggerResponse.
        :type trigger_id: str
        """
    ...
    def trigger_type_code(self):
        r"""Gets the trigger_type_code of this CreateFunctionTriggerResponse.
        ...
        :return: The trigger_type_code of this CreateFunctionTriggerResponse.
        :rtype: str
        """
    ...
    def trigger_type_code(self, trigger_type_code):
        r"""Sets the trigger_type_code of this CreateFunctionTriggerResponse.

        触发器类型。  - TIMER: \"定时触发器。\" - APIG: \"APIG触发器。\" - CTS: \"云审计服务触发器。\" - DDS: \"文档数据库服务触发器。\" - DMS: \"分布式服务触发器。\" - DIS: \"数据接入服务触发器。\" - LTS: \"云日志服务触发器。\" - OBS: \"对象存储触发器。\" - SMN: \"消息通知服务触发器。\" - KAFKA: \"专享版消息通知服务触发器。\"

        :param trigger_type_code: The trigger_type_code of this CreateFunctionTriggerResponse.
        :type trigger_type_code: str
        """
    ...
    def trigger_status(self):
        r"""Gets the trigger_status of this CreateFunctionTriggerResponse.
    ...
    def trigger_status(self, trigger_status):
        r"""Sets the trigger_status of this CreateFunctionTriggerResponse.
    ...
    @property
    def event_data(self):
        r"""Gets the event_data of this CreateFunctionTriggerResponse.
    ...
    def event_data(self, event_data):
        r"""Sets the event_data of this CreateFunctionTriggerResponse.
    ...
    def last_updated_time(self):
        r"""Gets the last_updated_time of this CreateFunctionTriggerResponse.

        最后更新时间。

        :return: The last_updated_time of this CreateFunctionTriggerResponse.
        :rtype: datetime
        """
    ...
    def last_updated_time(self, last_updated_time):
        r"""Sets the last_updated_time of this CreateFunctionTriggerResponse.

        最后更新时间。

        :param last_updated_time: The last_updated_time of this CreateFunctionTriggerResponse.
        :type last_updated_time: datetime
        """
    ...
    def created_time(self):
        r"""Gets the created_time of this CreateFunctionTriggerResponse.

        触发器创建时间。

        :return: The created_time of this CreateFunctionTriggerResponse.
        :rtype: datetime
        """
    ...
    def created_time(self, created_time):
        r"""Sets the created_time of this CreateFunctionTriggerResponse.

        触发器创建时间。

        :param created_time: The created_time of this CreateFunctionTriggerResponse.
        :type created_time: datetime
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateFunctionTriggerResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateFunctionTriggerResponse):
            return False
