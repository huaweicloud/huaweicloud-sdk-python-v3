...
class ListBridgeVersionsResponse(SdkResponse):
    ...
    openapi_types = {
        'body': 'list[ServiceBridgeVersion]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListBridgeVersionsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListBridgeVersionsResponse):
            return False
