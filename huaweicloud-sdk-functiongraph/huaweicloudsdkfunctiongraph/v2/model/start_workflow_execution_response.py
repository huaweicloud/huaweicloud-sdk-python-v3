...
class StartWorkflowExecutionResponse(SdkResponse):
    ...
    def execution_id(self):
        ...
        :return: The execution_id of this StartWorkflowExecutionResponse.
        :rtype: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("StartWorkflowExecutionResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StartWorkflowExecutionResponse):
            return False
