...
class UpdateFunctionReservedInstancesRequest:
    ...
    openapi_types = {
        'function_urn': 'str',
        'body': 'UpdateFunctionReservedInstancesRequestBody'
    }
    ...
    @property
    def body(self):
        """Gets the body of this UpdateFunctionReservedInstancesRequest.
    ...
    @body.setter
    def body(self, body):
        """Sets the body of this UpdateFunctionReservedInstancesRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateFunctionReservedInstancesRequest):
            return False
