...
class ImportFunctionRequest:
    ...
    openapi_types = {
        'body': 'ImportFunctionRequestBody'
    }
    ...
    @property
    def body(self):
        r"""Gets the body of this ImportFunctionRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this ImportFunctionRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ImportFunctionRequest):
            return False
