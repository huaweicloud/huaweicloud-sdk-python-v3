...
class ListFunctionAsyncInvocationsResponse(SdkResponse):
    ...
    def invocations(self):
        """Gets the invocations of this ListFunctionAsyncInvocationsResponse.
    ...
    def invocations(self, invocations):
        """Sets the invocations of this ListFunctionAsyncInvocationsResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListFunctionAsyncInvocationsResponse):
            return False
