...
class ShowFunctionAsyncInvokeConfigResponse(SdkResponse):
    ...
    def __init__(self, func_urn=None, max_async_event_age_in_seconds=None, max_async_retry_attempts=None, destination_config=None, created_time=None, last_modified=None, enable_async_status_log=None):
        r"""ShowFunctionAsyncInvokeConfigResponse
    ...
    @property
    def func_urn(self):
        r"""Gets the func_urn of this ShowFunctionAsyncInvokeConfigResponse.

        函数URN。

        :return: The func_urn of this ShowFunctionAsyncInvokeConfigResponse.
        :rtype: str
        """
    ...
    def func_urn(self, func_urn):
        r"""Sets the func_urn of this ShowFunctionAsyncInvokeConfigResponse.

        函数URN。

        :param func_urn: The func_urn of this ShowFunctionAsyncInvokeConfigResponse.
        :type func_urn: str
        """
    ...
    def max_async_event_age_in_seconds(self):
        r"""Gets the max_async_event_age_in_seconds of this ShowFunctionAsyncInvokeConfigResponse.

        消息最大存活时长，取值范围[60，86400]。单位：秒。

        :return: The max_async_event_age_in_seconds of this ShowFunctionAsyncInvokeConfigResponse.
        :rtype: int
        """
    ...
    def max_async_event_age_in_seconds(self, max_async_event_age_in_seconds):
        r"""Sets the max_async_event_age_in_seconds of this ShowFunctionAsyncInvokeConfigResponse.

        消息最大存活时长，取值范围[60，86400]。单位：秒。

        :param max_async_event_age_in_seconds: The max_async_event_age_in_seconds of this ShowFunctionAsyncInvokeConfigResponse.
        :type max_async_event_age_in_seconds: int
        """
    ...
    def max_async_retry_attempts(self):
        r"""Gets the max_async_retry_attempts of this ShowFunctionAsyncInvokeConfigResponse.

        异步调用失败后的最大重试次数，默认值为3。取值范围[0，8]。

        :return: The max_async_retry_attempts of this ShowFunctionAsyncInvokeConfigResponse.
        :rtype: int
        """
    ...
    def max_async_retry_attempts(self, max_async_retry_attempts):
        r"""Sets the max_async_retry_attempts of this ShowFunctionAsyncInvokeConfigResponse.

        异步调用失败后的最大重试次数，默认值为3。取值范围[0，8]。

        :param max_async_retry_attempts: The max_async_retry_attempts of this ShowFunctionAsyncInvokeConfigResponse.
        :type max_async_retry_attempts: int
        """
    ...
    def destination_config(self):
        r"""Gets the destination_config of this ShowFunctionAsyncInvokeConfigResponse.

        :return: The destination_config of this ShowFunctionAsyncInvokeConfigResponse.
    ...
    def destination_config(self, destination_config):
        r"""Sets the destination_config of this ShowFunctionAsyncInvokeConfigResponse.

        :param destination_config: The destination_config of this ShowFunctionAsyncInvokeConfigResponse.
        :type destination_config: :class:`huaweicloudsdkfunctiongraph.v2.FuncAsyncDestinationConfig`
        """
    ...
    def created_time(self):
        r"""Gets the created_time of this ShowFunctionAsyncInvokeConfigResponse.

        异步调用配置的创建时间。

        :return: The created_time of this ShowFunctionAsyncInvokeConfigResponse.
        :rtype: str
        """
    ...
    def created_time(self, created_time):
        r"""Sets the created_time of this ShowFunctionAsyncInvokeConfigResponse.

        异步调用配置的创建时间。

        :param created_time: The created_time of this ShowFunctionAsyncInvokeConfigResponse.
        :type created_time: str
        """
    ...
    def last_modified(self):
        r"""Gets the last_modified of this ShowFunctionAsyncInvokeConfigResponse.

        异步调用配置的最后更改时间。

        :return: The last_modified of this ShowFunctionAsyncInvokeConfigResponse.
        :rtype: str
        """
    ...
    def last_modified(self, last_modified):
        r"""Sets the last_modified of this ShowFunctionAsyncInvokeConfigResponse.

        异步调用配置的最后更改时间。

        :param last_modified: The last_modified of this ShowFunctionAsyncInvokeConfigResponse.
        :type last_modified: str
        """
    ...
    def enable_async_status_log(self):
        r"""Gets the enable_async_status_log of this ShowFunctionAsyncInvokeConfigResponse.
    ...
    def enable_async_status_log(self, enable_async_status_log):
        r"""Sets the enable_async_status_log of this ShowFunctionAsyncInvokeConfigResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowFunctionAsyncInvokeConfigResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowFunctionAsyncInvokeConfigResponse):
            return False
