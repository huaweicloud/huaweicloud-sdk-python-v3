...
class ObsModel:
    ...
    @property
    def obs_path(self):
        r"""Gets the obs_path of this ObsModel.

        **参数解释**：自定义训练作业产物保存的OBS地址，如：“obs://example/path”。 **取值范围**：不涉及。

        :return: The obs_path of this ObsModel.
        :rtype: str
        """
    ...
    def obs_path(self, obs_path):
        r"""Sets the obs_path of this ObsModel.

        **参数解释**：自定义训练作业产物保存的OBS地址，如：“obs://example/path”。 **取值范围**：不涉及。

        :param obs_path: The obs_path of this ObsModel.
        :type obs_path: str
        """
    ...
    @property
    def local_path(self):
        r"""Gets the local_path of this ObsModel.

        **参数解释**：自定义训练作业产物保存的宿主机的路径，如：“/example/path”。 **取值范围**：不涉及。

        :return: The local_path of this ObsModel.
        :rtype: str
        """
    ...
    def local_path(self, local_path):
        r"""Sets the local_path of this ObsModel.

        **参数解释**：自定义训练作业产物保存的宿主机的路径，如：“/example/path”。 **取值范围**：不涉及。

        :param local_path: The local_path of this ObsModel.
        :type local_path: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ObsModel):
            return False
