...
class Quota:
    ...
    def __init__(self, resources=None):
        ...
        :param resources: **参数解释**： 资源的配额信息。
        :type resources: list[:class:`huaweicloudsdkmodelarts.v1.ResourceQuota`]
        """
    ...
    def resources(self):
        ...
        **参数解释**： 资源的配额信息。
        ...
        :rtype: list[:class:`huaweicloudsdkmodelarts.v1.ResourceQuota`]
        """
