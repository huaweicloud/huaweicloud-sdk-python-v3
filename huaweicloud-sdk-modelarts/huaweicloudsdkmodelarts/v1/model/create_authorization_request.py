...
class CreateAuthorizationRequest:
    ...
    def __init__(self, body=None):
        ...
        :type body: :class:`huaweicloudsdkmodelarts.v1.AuthorizationRequest`
        """
    ...
    @property
    def body(self):
        r"""Gets the body of this CreateAuthorizationRequest.

        :return: The body of this CreateAuthorizationRequest.
        :rtype: :class:`huaweicloudsdkmodelarts.v1.AuthorizationRequest`
        """
        return self._body

    @body.setter
    def body(self, body):
        r"""Sets the body of this CreateAuthorizationRequest.
