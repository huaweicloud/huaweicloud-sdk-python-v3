...
class PatchNodePoolAnnotations:
    ...
    def __init__(self, os_modelarts_billing_mode=None, os_modelarts_period_num=None, os_modelarts_period_type=None, os_modelarts_auto_renew=None, os_modelarts_promotion_info=None, os_modelarts_service_console_url=None, os_modelarts_order_id=None):
        r"""PatchNodePoolAnnotations

        The model defined in huaweicloud sdk

        :param os_modelarts_billing_mode: **参数解释**：计费模式，不指定时新创节点沿用资源池计费模式。 **取值范围**：可选值如下： - 0：按需计费 - [1：包周期计费](tag:hc)
        :type os_modelarts_billing_mode: str
        :param os_modelarts_period_num: **参数解释**：包周期订购周期，比如2。当计费模式为包周期时该参数必传。 **取值范围**：不涉及。
        :type os_modelarts_period_num: str
        :param os_modelarts_period_type: **参数解释**：包周期订购类型。当计费模式为包周期时该参数必传。 **取值范围**：可选值如下： - 2：月 - 3：年
        :type os_modelarts_period_type: str
        :param os_modelarts_auto_renew: **参数解释**：是否自动续费，不指定时新创节点沿用资源池自动续费属性。 **取值范围**：可选值如下： - 0：不自动续费，默认值 - 1：自动续费
        :type os_modelarts_auto_renew: str
        :param os_modelarts_promotion_info: **参数解释**：用户在运营平台选择的折扣信息。 **取值范围**：不涉及。
        :type os_modelarts_promotion_info: str
        :param os_modelarts_service_console_url: **参数解释**：订购订单支付完成后跳转的url地址。 **取值范围**：不涉及。
        :type os_modelarts_service_console_url: str
        :param os_modelarts_order_id: **参数解释**：订单id，包周期资源创建或者计费模式变更的时候该参数必需。 **取值范围**：不涉及。
    ...
    def os_modelarts_billing_mode(self):
        r"""Gets the os_modelarts_billing_mode of this PatchNodePoolAnnotations.

        **参数解释**：计费模式，不指定时新创节点沿用资源池计费模式。 **取值范围**：可选值如下： - 0：按需计费 - [1：包周期计费](tag:hc)

        :return: The os_modelarts_billing_mode of this PatchNodePoolAnnotations.
        :rtype: str
        """
    ...
    def os_modelarts_billing_mode(self, os_modelarts_billing_mode):
        r"""Sets the os_modelarts_billing_mode of this PatchNodePoolAnnotations.

        **参数解释**：计费模式，不指定时新创节点沿用资源池计费模式。 **取值范围**：可选值如下： - 0：按需计费 - [1：包周期计费](tag:hc)

        :param os_modelarts_billing_mode: The os_modelarts_billing_mode of this PatchNodePoolAnnotations.
        :type os_modelarts_billing_mode: str
        """
    ...
    def os_modelarts_period_num(self):
        r"""Gets the os_modelarts_period_num of this PatchNodePoolAnnotations.

        **参数解释**：包周期订购周期，比如2。当计费模式为包周期时该参数必传。 **取值范围**：不涉及。

        :return: The os_modelarts_period_num of this PatchNodePoolAnnotations.
        :rtype: str
        """
    ...
    def os_modelarts_period_num(self, os_modelarts_period_num):
        r"""Sets the os_modelarts_period_num of this PatchNodePoolAnnotations.

        **参数解释**：包周期订购周期，比如2。当计费模式为包周期时该参数必传。 **取值范围**：不涉及。

        :param os_modelarts_period_num: The os_modelarts_period_num of this PatchNodePoolAnnotations.
        :type os_modelarts_period_num: str
        """
    ...
    def os_modelarts_period_type(self):
        r"""Gets the os_modelarts_period_type of this PatchNodePoolAnnotations.

        **参数解释**：包周期订购类型。当计费模式为包周期时该参数必传。 **取值范围**：可选值如下： - 2：月 - 3：年

        :return: The os_modelarts_period_type of this PatchNodePoolAnnotations.
        :rtype: str
        """
    ...
    def os_modelarts_period_type(self, os_modelarts_period_type):
        r"""Sets the os_modelarts_period_type of this PatchNodePoolAnnotations.

        **参数解释**：包周期订购类型。当计费模式为包周期时该参数必传。 **取值范围**：可选值如下： - 2：月 - 3：年

        :param os_modelarts_period_type: The os_modelarts_period_type of this PatchNodePoolAnnotations.
        :type os_modelarts_period_type: str
        """
    ...
    def os_modelarts_auto_renew(self):
        r"""Gets the os_modelarts_auto_renew of this PatchNodePoolAnnotations.

        **参数解释**：是否自动续费，不指定时新创节点沿用资源池自动续费属性。 **取值范围**：可选值如下： - 0：不自动续费，默认值 - 1：自动续费

        :return: The os_modelarts_auto_renew of this PatchNodePoolAnnotations.
        :rtype: str
        """
    ...
    def os_modelarts_auto_renew(self, os_modelarts_auto_renew):
        r"""Sets the os_modelarts_auto_renew of this PatchNodePoolAnnotations.

        **参数解释**：是否自动续费，不指定时新创节点沿用资源池自动续费属性。 **取值范围**：可选值如下： - 0：不自动续费，默认值 - 1：自动续费

        :param os_modelarts_auto_renew: The os_modelarts_auto_renew of this PatchNodePoolAnnotations.
        :type os_modelarts_auto_renew: str
        """
    ...
    def os_modelarts_promotion_info(self):
        r"""Gets the os_modelarts_promotion_info of this PatchNodePoolAnnotations.

        **参数解释**：用户在运营平台选择的折扣信息。 **取值范围**：不涉及。

        :return: The os_modelarts_promotion_info of this PatchNodePoolAnnotations.
        :rtype: str
        """
    ...
    def os_modelarts_promotion_info(self, os_modelarts_promotion_info):
        r"""Sets the os_modelarts_promotion_info of this PatchNodePoolAnnotations.

        **参数解释**：用户在运营平台选择的折扣信息。 **取值范围**：不涉及。

        :param os_modelarts_promotion_info: The os_modelarts_promotion_info of this PatchNodePoolAnnotations.
        :type os_modelarts_promotion_info: str
        """
    ...
    def os_modelarts_service_console_url(self):
        r"""Gets the os_modelarts_service_console_url of this PatchNodePoolAnnotations.

        **参数解释**：订购订单支付完成后跳转的url地址。 **取值范围**：不涉及。

        :return: The os_modelarts_service_console_url of this PatchNodePoolAnnotations.
        :rtype: str
        """
    ...
    def os_modelarts_service_console_url(self, os_modelarts_service_console_url):
        r"""Sets the os_modelarts_service_console_url of this PatchNodePoolAnnotations.

        **参数解释**：订购订单支付完成后跳转的url地址。 **取值范围**：不涉及。

        :param os_modelarts_service_console_url: The os_modelarts_service_console_url of this PatchNodePoolAnnotations.
        :type os_modelarts_service_console_url: str
        """
    ...
    def os_modelarts_order_id(self):
        r"""Gets the os_modelarts_order_id of this PatchNodePoolAnnotations.

        **参数解释**：订单id，包周期资源创建或者计费模式变更的时候该参数必需。 **取值范围**：不涉及。

        :return: The os_modelarts_order_id of this PatchNodePoolAnnotations.
        :rtype: str
        """
    ...
    def os_modelarts_order_id(self, os_modelarts_order_id):
        r"""Sets the os_modelarts_order_id of this PatchNodePoolAnnotations.

        **参数解释**：订单id，包周期资源创建或者计费模式变更的时候该参数必需。 **取值范围**：不涉及。

        :param os_modelarts_order_id: The os_modelarts_order_id of this PatchNodePoolAnnotations.
        :type os_modelarts_order_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchNodePoolAnnotations):
            return False
