...
class ShowWorkflowResponse(SdkResponse):
    ...
    def workflow_id(self):
        r"""Gets the workflow_id of this ShowWorkflowResponse.

        Workflow工作流ID。创建工作流时后台自动生成。

        :return: The workflow_id of this ShowWorkflowResponse.
        :rtype: str
        """
    ...
    def workflow_id(self, workflow_id):
        r"""Sets the workflow_id of this ShowWorkflowResponse.

        Workflow工作流ID。创建工作流时后台自动生成。

        :param workflow_id: The workflow_id of this ShowWorkflowResponse.
        :type workflow_id: str
        """
    ...
    @property
    def created_at(self):
        r"""Gets the created_at of this ShowWorkflowResponse.

        Workflow工作流的创建时间。

        :return: The created_at of this ShowWorkflowResponse.
        :rtype: str
        """
    ...
    def created_at(self, created_at):
        r"""Sets the created_at of this ShowWorkflowResponse.

        Workflow工作流的创建时间。

        :param created_at: The created_at of this ShowWorkflowResponse.
        :type created_at: str
        """
    ...
    @property
    def steps(self):
        r"""Gets the steps of this ShowWorkflowResponse.

        Workflow工作流包含的步骤定义。

        :return: The steps of this ShowWorkflowResponse.
    ...
    def steps(self, steps):
        r"""Sets the steps of this ShowWorkflowResponse.

        Workflow工作流包含的步骤定义。

        :param steps: The steps of this ShowWorkflowResponse.
        :type steps: list[:class:`huaweicloudsdkmodelarts.v1.WorkflowStep`]
        """
        self._steps = steps
    ...
    def workspace_id(self):
        r"""Gets the workspace_id of this ShowWorkflowResponse.

        工作空间ID。

        :return: The workspace_id of this ShowWorkflowResponse.
        :rtype: str
        """
    ...
    def workspace_id(self, workspace_id):
        r"""Sets the workspace_id of this ShowWorkflowResponse.

        工作空间ID。

        :param workspace_id: The workspace_id of this ShowWorkflowResponse.
        :type workspace_id: str
        """
    ...
    def data_requirements(self):
        r"""Gets the data_requirements of this ShowWorkflowResponse.

        Workflow需要的数据。

        :return: The data_requirements of this ShowWorkflowResponse.
    ...
    def data_requirements(self, data_requirements):
        r"""Sets the data_requirements of this ShowWorkflowResponse.

        Workflow需要的数据。

        :param data_requirements: The data_requirements of this ShowWorkflowResponse.
        :type data_requirements: list[:class:`huaweicloudsdkmodelarts.v1.DataRequirement`]
        """
    ...
    @property
    def data(self):
        r"""Gets the data of this ShowWorkflowResponse.

        Workflow包含的数据。

        :return: The data of this ShowWorkflowResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this ShowWorkflowResponse.

        Workflow包含的数据。

        :param data: The data of this ShowWorkflowResponse.
        :type data: list[:class:`huaweicloudsdkmodelarts.v1.Data`]
        """
        self._data = data
    ...
    @property
    def parameters(self):
        r"""Gets the parameters of this ShowWorkflowResponse.

        Workflow包含的参数。

        :return: The parameters of this ShowWorkflowResponse.
    ...
    def parameters(self, parameters):
        r"""Sets the parameters of this ShowWorkflowResponse.

        Workflow包含的参数。

        :param parameters: The parameters of this ShowWorkflowResponse.
        :type parameters: list[:class:`huaweicloudsdkmodelarts.v1.WorkflowParameter`]
        """
    ...
    def source_workflow_id(self):
        r"""Gets the source_workflow_id of this ShowWorkflowResponse.

        从指定Workflow工作流进行复制。通过复制来创建Workflow时必填。

        :return: The source_workflow_id of this ShowWorkflowResponse.
        :rtype: str
        """
    ...
    def source_workflow_id(self, source_workflow_id):
        r"""Sets the source_workflow_id of this ShowWorkflowResponse.

        从指定Workflow工作流进行复制。通过复制来创建Workflow时必填。

        :param source_workflow_id: The source_workflow_id of this ShowWorkflowResponse.
        :type source_workflow_id: str
        """
    ...
    def gallery_subscription(self):
        r"""Gets the gallery_subscription of this ShowWorkflowResponse.

        :return: The gallery_subscription of this ShowWorkflowResponse.
    ...
    def gallery_subscription(self, gallery_subscription):
        r"""Sets the gallery_subscription of this ShowWorkflowResponse.

        :param gallery_subscription: The gallery_subscription of this ShowWorkflowResponse.
        :type gallery_subscription: :class:`huaweicloudsdkmodelarts.v1.WorkflowGallerySubscription`
        """
    ...
    def latest_execution(self):
        r"""Gets the latest_execution of this ShowWorkflowResponse.

        :return: The latest_execution of this ShowWorkflowResponse.
    ...
    def latest_execution(self, latest_execution):
        r"""Sets the latest_execution of this ShowWorkflowResponse.

        :param latest_execution: The latest_execution of this ShowWorkflowResponse.
        :type latest_execution: :class:`huaweicloudsdkmodelarts.v1.ExecutionBrief`
        """
    ...
    @property
    def run_count(self):
        r"""Gets the run_count of this ShowWorkflowResponse.

        工作流的已运行次数。

        :return: The run_count of this ShowWorkflowResponse.
        :rtype: int
        """
    ...
    def run_count(self, run_count):
        r"""Sets the run_count of this ShowWorkflowResponse.

        工作流的已运行次数。

        :param run_count: The run_count of this ShowWorkflowResponse.
        :type run_count: int
        """
    ...
    def param_ready(self):
        r"""Gets the param_ready of this ShowWorkflowResponse.

        当前工作流的必选参数是否都已填完。

        :return: The param_ready of this ShowWorkflowResponse.
        :rtype: bool
        """
    ...
    def param_ready(self, param_ready):
        r"""Sets the param_ready of this ShowWorkflowResponse.

        当前工作流的必选参数是否都已填完。

        :param param_ready: The param_ready of this ShowWorkflowResponse.
        :type param_ready: bool
        """
    ...
    @property
    def source(self):
        r"""Gets the source of this ShowWorkflowResponse.

        工作流来源，可选值为ai_gallery，表示工作流是从AI Gallery导入的。

        :return: The source of this ShowWorkflowResponse.
        :rtype: str
        """
        return self._source
    ...
    def source(self, source):
        r"""Sets the source of this ShowWorkflowResponse.

        工作流来源，可选值为ai_gallery，表示工作流是从AI Gallery导入的。

        :param source: The source of this ShowWorkflowResponse.
        :type source: str
        """
        self._source = source
    ...
    @property
    def storages(self):
        r"""Gets the storages of this ShowWorkflowResponse.

        Workflow包含的统一存储定义。

        :return: The storages of this ShowWorkflowResponse.
    ...
    def storages(self, storages):
        r"""Sets the storages of this ShowWorkflowResponse.

        Workflow包含的统一存储定义。

        :param storages: The storages of this ShowWorkflowResponse.
        :type storages: list[:class:`huaweicloudsdkmodelarts.v1.WorkflowStorage`]
        """
    ...
    @property
    def assets(self):
        r"""Gets the assets of this ShowWorkflowResponse.

        工作流绑定的资产。

        :return: The assets of this ShowWorkflowResponse.
    ...
    def assets(self, assets):
        r"""Sets the assets of this ShowWorkflowResponse.

        工作流绑定的资产。

        :param assets: The assets of this ShowWorkflowResponse.
        :type assets: list[:class:`huaweicloudsdkmodelarts.v1.WorkflowAsset`]
        """
        self._assets = assets
    ...
    @property
    def sub_graphs(self):
        r"""Gets the sub_graphs of this ShowWorkflowResponse.

        工作流包含的子图。

        :return: The sub_graphs of this ShowWorkflowResponse.
    ...
    def sub_graphs(self, sub_graphs):
        r"""Sets the sub_graphs of this ShowWorkflowResponse.

        工作流包含的子图。

        :param sub_graphs: The sub_graphs of this ShowWorkflowResponse.
        :type sub_graphs: list[:class:`huaweicloudsdkmodelarts.v1.WorkflowSubgraph`]
        """
    ...
    @property
    def extend(self):
        r"""Gets the extend of this ShowWorkflowResponse.

        计费工作流使用的拓展字段。

        :return: The extend of this ShowWorkflowResponse.
    ...
    def extend(self, extend):
        r"""Sets the extend of this ShowWorkflowResponse.

        计费工作流使用的拓展字段。

        :param extend: The extend of this ShowWorkflowResponse.
        :type extend: dict(str, object)
        """
        self._extend = extend
    ...
    @property
    def policy(self):
        r"""Gets the policy of this ShowWorkflowResponse.

        :return: The policy of this ShowWorkflowResponse.
    ...
    def policy(self, policy):
        r"""Sets the policy of this ShowWorkflowResponse.

        :param policy: The policy of this ShowWorkflowResponse.
        :type policy: :class:`huaweicloudsdkmodelarts.v1.WorkflowPolicy`
        """
        self._policy = policy
    ...
    def with_subscription(self):
        r"""Gets the with_subscription of this ShowWorkflowResponse.

        工作流SMN消息订阅开关，默认为false，表示关闭消息订阅开关。

        :return: The with_subscription of this ShowWorkflowResponse.
        :rtype: bool
        """
    ...
    def with_subscription(self, with_subscription):
        r"""Sets the with_subscription of this ShowWorkflowResponse.

        工作流SMN消息订阅开关，默认为false，表示关闭消息订阅开关。

        :param with_subscription: The with_subscription of this ShowWorkflowResponse.
        :type with_subscription: bool
        """
    ...
    @property
    def smn_switch(self):
        r"""Gets the smn_switch of this ShowWorkflowResponse.

        SMN开关。

        :return: The smn_switch of this ShowWorkflowResponse.
        :rtype: bool
        """
    ...
    def smn_switch(self, smn_switch):
        r"""Sets the smn_switch of this ShowWorkflowResponse.

        SMN开关。

        :param smn_switch: The smn_switch of this ShowWorkflowResponse.
        :type smn_switch: bool
        """
    ...
    def subscription_id(self):
        r"""Gets the subscription_id of this ShowWorkflowResponse.

        SMN消息订阅ID。

        :return: The subscription_id of this ShowWorkflowResponse.
        :rtype: str
        """
    ...
    def subscription_id(self, subscription_id):
        r"""Sets the subscription_id of this ShowWorkflowResponse.

        SMN消息订阅ID。

        :param subscription_id: The subscription_id of this ShowWorkflowResponse.
        :type subscription_id: str
        """
    ...
    def exeml_template_id(self):
        r"""Gets the exeml_template_id of this ShowWorkflowResponse.

        自动学习模板ID。

        :return: The exeml_template_id of this ShowWorkflowResponse.
        :rtype: str
        """
    ...
    def exeml_template_id(self, exeml_template_id):
        r"""Sets the exeml_template_id of this ShowWorkflowResponse.

        自动学习模板ID。

        :param exeml_template_id: The exeml_template_id of this ShowWorkflowResponse.
        :type exeml_template_id: str
        """
    ...
    def last_modified_at(self):
        r"""Gets the last_modified_at of this ShowWorkflowResponse.

        最近一次修改的时间。

        :return: The last_modified_at of this ShowWorkflowResponse.
        :rtype: str
        """
    ...
    def last_modified_at(self, last_modified_at):
        r"""Sets the last_modified_at of this ShowWorkflowResponse.

        最近一次修改的时间。

        :param last_modified_at: The last_modified_at of this ShowWorkflowResponse.
        :type last_modified_at: str
        """
    ...
    @property
    def package(self):
        r"""Gets the package of this ShowWorkflowResponse.

        :return: The package of this ShowWorkflowResponse.
    ...
    def package(self, package):
        r"""Sets the package of this ShowWorkflowResponse.

        :param package: The package of this ShowWorkflowResponse.
        :type package: :class:`huaweicloudsdkmodelarts.v1.WorkflowServicePackege`
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowWorkflowResponse.to_dict() is deprecated and no longer maintained, "
