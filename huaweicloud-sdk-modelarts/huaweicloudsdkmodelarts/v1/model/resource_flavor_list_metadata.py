...
class ResourceFlavorListMetadata:
    ...
    @property
    def _continue(self):
        r"""Gets the _continue of this ResourceFlavorListMetadata.

        **参数解释**：分页查询的偏移标志。 **取值范围**：取值来自用户上一次分页查询响应结果中metadata.continue中的值，值为空默认无偏移。

        :return: The _continue of this ResourceFlavorListMetadata.
        :rtype: str
        """
    ...
    def _continue(self, _continue):
        r"""Sets the _continue of this ResourceFlavorListMetadata.

        **参数解释**：分页查询的偏移标志。 **取值范围**：取值来自用户上一次分页查询响应结果中metadata.continue中的值，值为空默认无偏移。

        :param _continue: The _continue of this ResourceFlavorListMetadata.
        :type _continue: str
        """
    ...
    def remaining_item_count(self):
        r"""Gets the remaining_item_count of this ResourceFlavorListMetadata.

        **参数解释**：分页查询中剩余资源的数量。 **默认取值**：不涉及。

        :return: The remaining_item_count of this ResourceFlavorListMetadata.
        :rtype: int
        """
    ...
    def remaining_item_count(self, remaining_item_count):
        r"""Sets the remaining_item_count of this ResourceFlavorListMetadata.

        **参数解释**：分页查询中剩余资源的数量。 **默认取值**：不涉及。

        :param remaining_item_count: The remaining_item_count of this ResourceFlavorListMetadata.
        :type remaining_item_count: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResourceFlavorListMetadata):
            return False
