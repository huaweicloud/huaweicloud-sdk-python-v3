...
class ListTrainingJobStagesRequest:
    ...
    def __init__(self, training_job_id=None):
        r"""ListTrainingJobStagesRequest
    ...
    def training_job_id(self):
        r"""Gets the training_job_id of this ListTrainingJobStagesRequest.

        **参数解释**：训练作业ID。获取方法请参见[查询训练作业列表](ListTrainingJobs.xml)。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :return: The training_job_id of this ListTrainingJobStagesRequest.
        :rtype: str
        """
    ...
    def training_job_id(self, training_job_id):
        r"""Sets the training_job_id of this ListTrainingJobStagesRequest.

        **参数解释**：训练作业ID。获取方法请参见[查询训练作业列表](ListTrainingJobs.xml)。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :param training_job_id: The training_job_id of this ListTrainingJobStagesRequest.
        :type training_job_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListTrainingJobStagesRequest):
            return False
