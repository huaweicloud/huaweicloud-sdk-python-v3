...
class Subscription:
    ...
    @property
    def created_at(self):
        r"""Gets the created_at of this Subscription.
    ...
    def created_at(self, created_at):
        r"""Sets the created_at of this Subscription.
    ...
    def subscription_id(self):
        r"""Gets the subscription_id of this Subscription.
    ...
    def subscription_id(self, subscription_id):
        r"""Sets the subscription_id of this Subscription.
    ...
    @property
    def topic_urns(self):
        r"""Gets the topic_urns of this Subscription.

        订阅的主题。

        :return: The topic_urns of this Subscription.
        :rtype: list[str]
        """
    ...
    def topic_urns(self, topic_urns):
        r"""Sets the topic_urns of this Subscription.

        订阅的主题。

        :param topic_urns: The topic_urns of this Subscription.
        :type topic_urns: list[str]
        """
    ...
    @property
    def entity(self):
        r"""Gets the entity of this Subscription.

        订阅的主体。

        :return: The entity of this Subscription.
        :rtype: str
        """
        return self._entity
    ...
    def entity(self, entity):
        r"""Sets the entity of this Subscription.

        订阅的主体。

        :param entity: The entity of this Subscription.
        :type entity: str
        """
        self._entity = entity
    ...
    @property
    def events(self):
        r"""Gets the events of this Subscription.
    ...
    def events(self, events):
        r"""Sets the events of this Subscription.
