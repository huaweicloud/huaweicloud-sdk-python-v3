...
class AlgorithmResponse:
    ...
    @property
    def metadata(self):
        r"""Gets the metadata of this AlgorithmResponse.

        :return: The metadata of this AlgorithmResponse.
    ...
    def metadata(self, metadata):
        r"""Sets the metadata of this AlgorithmResponse.

        :param metadata: The metadata of this AlgorithmResponse.
        :type metadata: :class:`huaweicloudsdkmodelarts.v1.AlgorithmResponseMetadata`
        """
    ...
    @property
    def job_config(self):
        r"""Gets the job_config of this AlgorithmResponse.

        :return: The job_config of this AlgorithmResponse.
    ...
    def job_config(self, job_config):
        r"""Sets the job_config of this AlgorithmResponse.

        :param job_config: The job_config of this AlgorithmResponse.
        :type job_config: :class:`huaweicloudsdkmodelarts.v1.AlgorithmResponseJobConfig`
        """
    ...
    def resource_requirements(self):
        r"""Gets the resource_requirements of this AlgorithmResponse.

        算法资源约束，可不设置。设置后，在算法使用于训练作业时，控制台会过滤可用的公共资源池。

        :return: The resource_requirements of this AlgorithmResponse.
    ...
    def resource_requirements(self, resource_requirements):
        r"""Sets the resource_requirements of this AlgorithmResponse.

        算法资源约束，可不设置。设置后，在算法使用于训练作业时，控制台会过滤可用的公共资源池。

        :param resource_requirements: The resource_requirements of this AlgorithmResponse.
        :type resource_requirements: list[:class:`huaweicloudsdkmodelarts.v1.AlgorithmResponseResourceRequirements`]
        """
    ...
    def advanced_config(self):
        r"""Gets the advanced_config of this AlgorithmResponse.

        :return: The advanced_config of this AlgorithmResponse.
    ...
    def advanced_config(self, advanced_config):
        r"""Sets the advanced_config of this AlgorithmResponse.

        :param advanced_config: The advanced_config of this AlgorithmResponse.
        :type advanced_config: :class:`huaweicloudsdkmodelarts.v1.AlgorithmResponseAdvancedConfig`
        """
