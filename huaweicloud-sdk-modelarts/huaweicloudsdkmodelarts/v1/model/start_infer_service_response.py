...
class StartInferServiceResponse(SdkResponse):
    ...
    @property
    def id(self):
        r"""Gets the id of this StartInferServiceResponse.
        ...
        **参数解释：** 服务ID，在[创建服务](CreateInferService.xml)时即可在返回体中获取，也可通过[查询服务列表](ListInferServices.xml)获取当前用户拥有的服务，其中service_id字段即为服务ID。 **取值范围：** 不涉及。
        ...
        :return: The id of this StartInferServiceResponse.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this StartInferServiceResponse.

        **参数解释：** 服务ID，在[创建服务](CreateInferService.xml)时即可在返回体中获取，也可通过[查询服务列表](ListInferServices.xml)获取当前用户拥有的服务，其中service_id字段即为服务ID。 **取值范围：** 不涉及。

        :param id: The id of this StartInferServiceResponse.
        :type id: str
        """
        self._id = id
    ...
    @property
    def name(self):
        r"""Gets the name of this StartInferServiceResponse.

        **参数解释：** 服务名，用户在[创建服务](CreateInferService.xml)时自定义的名称。 **取值范围：** 支持1-64位字符，可包含字母、中文、数字、中划线、下划线。

        :return: The name of this StartInferServiceResponse.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this StartInferServiceResponse.

        **参数解释：** 服务名，用户在[创建服务](CreateInferService.xml)时自定义的名称。 **取值范围：** 支持1-64位字符，可包含字母、中文、数字、中划线、下划线。

        :param name: The name of this StartInferServiceResponse.
        :type name: str
        """
        self._name = name
    ...
    def workspace_id(self):
        r"""Gets the workspace_id of this StartInferServiceResponse.

        **参数解释：** 工作空间ID。 **取值范围：** - 0：默认空间ID。 - 由数字和小写字母组成的32位字符：其他空间ID，可参考[工作空间创建](CreateWorkspace.xml)。

        :return: The workspace_id of this StartInferServiceResponse.
        :rtype: str
        """
    ...
    def workspace_id(self, workspace_id):
        r"""Sets the workspace_id of this StartInferServiceResponse.

        **参数解释：** 工作空间ID。 **取值范围：** - 0：默认空间ID。 - 由数字和小写字母组成的32位字符：其他空间ID，可参考[工作空间创建](CreateWorkspace.xml)。

        :param workspace_id: The workspace_id of this StartInferServiceResponse.
        :type workspace_id: str
        """
    ...
    @property
    def type(self):
        r"""Gets the type of this StartInferServiceResponse.

        **参数解释：** 推理服务类型。 **取值范围：** - REAL_TIME：在线服务。 - ASYNC_REAL_TIME：异步服务。

        :return: The type of this StartInferServiceResponse.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        r"""Sets the type of this StartInferServiceResponse.

        **参数解释：** 推理服务类型。 **取值范围：** - REAL_TIME：在线服务。 - ASYNC_REAL_TIME：异步服务。

        :param type: The type of this StartInferServiceResponse.
        :type type: str
        """
        self._type = type
    ...
    def deploy_type(self):
        r"""Gets the deploy_type of this StartInferServiceResponse.

        **参数解释：** 部署方式。 **取值范围：** - SINGLE：单机单卡。 - MULTI：多机多卡。

        :return: The deploy_type of this StartInferServiceResponse.
        :rtype: str
        """
    ...
    def deploy_type(self, deploy_type):
        r"""Sets the deploy_type of this StartInferServiceResponse.

        **参数解释：** 部署方式。 **取值范围：** - SINGLE：单机单卡。 - MULTI：多机多卡。

        :param deploy_type: The deploy_type of this StartInferServiceResponse.
        :type deploy_type: str
        """
    ...
    @property
    def status(self):
        r"""Gets the status of this StartInferServiceResponse.
        ...
        **参数解释：** 服务当前状态。 **取值范围：** - DEPLOYING：部署中 。 - FAILED：失败 。 - STOPPED：停止。 - RUNNING：运行中。 - DELETING：删除中 。 - STOPPING：停止中 。 - CONCERNING：告警 。 - UPGRADING：升级中 。 - ERROR：异常 。 - INIT：待部署。
        ...
        :return: The status of this StartInferServiceResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        r"""Sets the status of this StartInferServiceResponse.

        **参数解释：** 服务当前状态。 **取值范围：** - DEPLOYING：部署中 。 - FAILED：失败 。 - STOPPED：停止。 - RUNNING：运行中。 - DELETING：删除中 。 - STOPPING：停止中 。 - CONCERNING：告警 。 - UPGRADING：升级中 。 - ERROR：异常 。 - INIT：待部署。

        :param status: The status of this StartInferServiceResponse.
        :type status: str
        """
        self._status = status
    ...
    def failure_reason(self):
        r"""Gets the failure_reason of this StartInferServiceResponse.

        **参数解释：** 在线服务失败原因。 **取值范围：** 不涉及。

        :return: The failure_reason of this StartInferServiceResponse.
        :rtype: str
        """
    ...
    def failure_reason(self, failure_reason):
        r"""Sets the failure_reason of this StartInferServiceResponse.

        **参数解释：** 在线服务失败原因。 **取值范围：** 不涉及。

        :param failure_reason: The failure_reason of this StartInferServiceResponse.
        :type failure_reason: str
        """
    ...
    @property
    def version(self):
        r"""Gets the version of this StartInferServiceResponse.

        :return: The version of this StartInferServiceResponse.
    ...
    def version(self, version):
        r"""Sets the version of this StartInferServiceResponse.

        :param version: The version of this StartInferServiceResponse.
        :type version: :class:`huaweicloudsdkmodelarts.v1.ServiceVersionResponse`
        """
    ...
    def predict_url(self):
        r"""Gets the predict_url of this StartInferServiceResponse.

        **参数解释：** 在线服务访问地址，创建服务接口无返回，详情接口中返回。

        :return: The predict_url of this StartInferServiceResponse.
    ...
    def predict_url(self, predict_url):
        r"""Sets the predict_url of this StartInferServiceResponse.

        **参数解释：** 在线服务访问地址，创建服务接口无返回，详情接口中返回。

        :param predict_url: The predict_url of this StartInferServiceResponse.
        :type predict_url: list[:class:`huaweicloudsdkmodelarts.v1.PredictUrlResponse`]
        """
    ...
    def dispatcher_group_id(self):
        r"""Gets the dispatcher_group_id of this StartInferServiceResponse.

        **参数解释：** 服务绑定的dispatcher组ID，创建服务接口无返回，详情接口中返回。 **取值范围：** 不涉及。

        :return: The dispatcher_group_id of this StartInferServiceResponse.
        :rtype: str
        """
    ...
    def dispatcher_group_id(self, dispatcher_group_id):
        r"""Sets the dispatcher_group_id of this StartInferServiceResponse.

        **参数解释：** 服务绑定的dispatcher组ID，创建服务接口无返回，详情接口中返回。 **取值范围：** 不涉及。

        :param dispatcher_group_id: The dispatcher_group_id of this StartInferServiceResponse.
        :type dispatcher_group_id: str
        """
    ...
    @property
    def tags(self):
        r"""Gets the tags of this StartInferServiceResponse.

        **参数解释：** TMS对接标签类。

        :return: The tags of this StartInferServiceResponse.
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this StartInferServiceResponse.

        **参数解释：** TMS对接标签类。

        :param tags: The tags of this StartInferServiceResponse.
        :type tags: list[:class:`huaweicloudsdkmodelarts.v1.TagsResponse`]
        """
        self._tags = tags
    ...
    def deploy_timeout_minutes(self):
        r"""Gets the deploy_timeout_minutes of this StartInferServiceResponse.

        **参数解释：** 部署超时时间。

        :return: The deploy_timeout_minutes of this StartInferServiceResponse.
        :rtype: int
        """
    ...
    def deploy_timeout_minutes(self, deploy_timeout_minutes):
        r"""Sets the deploy_timeout_minutes of this StartInferServiceResponse.

        **参数解释：** 部署超时时间。

        :param deploy_timeout_minutes: The deploy_timeout_minutes of this StartInferServiceResponse.
        :type deploy_timeout_minutes: int
        """
    ...
    @property
    def schedule(self):
        r"""Gets the schedule of this StartInferServiceResponse.

        **参数解释：** 定时停止配置。

        :return: The schedule of this StartInferServiceResponse.
    ...
    def schedule(self, schedule):
        r"""Sets the schedule of this StartInferServiceResponse.

        **参数解释：** 定时停止配置。

        :param schedule: The schedule of this StartInferServiceResponse.
        :type schedule: list[:class:`huaweicloudsdkmodelarts.v1.ScheduleConfigResponse`]
        """
    ...
    @property
    def create_at(self):
        r"""Gets the create_at of this StartInferServiceResponse.

        **参数解释：** 创建时间，根据创建时的当前时间自动生成。 **取值范围：** 毫秒级时间戳，13位数字，如1609459200000。

        :return: The create_at of this StartInferServiceResponse.
        :rtype: str
        """
    ...
    def create_at(self, create_at):
        r"""Sets the create_at of this StartInferServiceResponse.

        **参数解释：** 创建时间，根据创建时的当前时间自动生成。 **取值范围：** 毫秒级时间戳，13位数字，如1609459200000。

        :param create_at: The create_at of this StartInferServiceResponse.
        :type create_at: str
        """
    ...
    @property
    def update_at(self):
        r"""Gets the update_at of this StartInferServiceResponse.

        **参数解释：** 更新时间，根据更新时的当前时间自动生成。 **取值范围：** 毫秒级时间戳，13位数字，如1609459200000。

        :return: The update_at of this StartInferServiceResponse.
        :rtype: str
        """
    ...
    def update_at(self, update_at):
        r"""Sets the update_at of this StartInferServiceResponse.

        **参数解释：** 更新时间，根据更新时的当前时间自动生成。 **取值范围：** 毫秒级时间戳，13位数字，如1609459200000。

        :param update_at: The update_at of this StartInferServiceResponse.
        :type update_at: str
        """
    ...
    @property
    def task_type(self):
        r"""Gets the task_type of this StartInferServiceResponse.
        ...
        **参数解释：** 模型类型。 **取值范围：** - TEXT_GENERATION：文本生成 - IMAGE_UNDERSTANDING：图像理解 - VIDEO_GENERATION：视频生成 - IMAGE_GENERATION：图像生成 - RERANK：重排序 - VECTOR_MODEL：向量模型 - EMBEDDING：Embedding嵌入
        ...
        :return: The task_type of this StartInferServiceResponse.
        :rtype: str
        """
    ...
    def task_type(self, task_type):
        r"""Sets the task_type of this StartInferServiceResponse.

        **参数解释：** 模型类型。 **取值范围：** - TEXT_GENERATION：文本生成 - IMAGE_UNDERSTANDING：图像理解 - VIDEO_GENERATION：视频生成 - IMAGE_GENERATION：图像生成 - RERANK：重排序 - VECTOR_MODEL：向量模型 - EMBEDDING：Embedding嵌入

        :param task_type: The task_type of this StartInferServiceResponse.
        :type task_type: str
        """
    ...
    @property
    def provider(self):
        r"""Gets the provider of this StartInferServiceResponse.
        ...
        **参数解释：** 服务提供者的账号id（创建服务时通过X-Auth-Token-Provider请求头解析iam token而来），该值不为空时，该服务的所有更新操作需要在请求头中添加X-Auth-Token-Provider，取值为该账号id的domain级或project级token。
        ...
        :return: The provider of this StartInferServiceResponse.
        :rtype: str
        """
    ...
    def provider(self, provider):
        r"""Sets the provider of this StartInferServiceResponse.

        **参数解释：** 服务提供者的账号id（创建服务时通过X-Auth-Token-Provider请求头解析iam token而来），该值不为空时，该服务的所有更新操作需要在请求头中添加X-Auth-Token-Provider，取值为该账号id的domain级或project级token。

        :param provider: The provider of this StartInferServiceResponse.
        :type provider: str
        """
    ...
    def frozen_infos(self):
        r"""Gets the frozen_infos of this StartInferServiceResponse.

        **参数解释：** 当服务或者部署被冻结时返回的冻结类型信息。

        :return: The frozen_infos of this StartInferServiceResponse.
    ...
    def frozen_infos(self, frozen_infos):
        r"""Sets the frozen_infos of this StartInferServiceResponse.

        **参数解释：** 当服务或者部署被冻结时返回的冻结类型信息。

        :param frozen_infos: The frozen_infos of this StartInferServiceResponse.
        :type frozen_infos: list[:class:`huaweicloudsdkmodelarts.v1.FrozenInfo`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("StartInferServiceResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StartInferServiceResponse):
            return False
