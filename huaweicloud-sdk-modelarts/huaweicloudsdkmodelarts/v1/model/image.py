...
class Image:
    ...
    @arch.setter
    def arch(self, arch):
        r"""Sets the arch of this Image.

        **参数解释**：该镜像所支持处理器架构类型。 **取值范围**：枚举类型，取值如下： - X86_64：x86处理器架构。 - AARCH64：ARM体系架构。

        :param arch: The arch of this Image.
        :type arch: str
        """
        self._arch = arch
    ...
    @property
    def create_at(self):
        r"""Gets the create_at of this Image.
    ...
    def create_at(self, create_at):
        r"""Sets the create_at of this Image.
    ...
    def description(self):
        r"""Gets the description of this Image.
    ...
    def description(self, description):
        r"""Sets the description of this Image.
    ...
    def dev_services(self, dev_services):
        r"""Sets the dev_services of this Image.

        **参数解释**：镜像支持的服务。 **取值范围**：枚举类型，取值如下： - NOTEBOOK：镜像支持通过https协议访问Notebook。 - SSH：镜像支持本地IDE通过SSH协议远程连接Notebook。

        :param dev_services: The dev_services of this Image.
        :type dev_services: list[str]
        """
    ...
    @property
    def namespace(self):
        r"""Gets the namespace of this Image.

        **参数解释**：镜像所属组织，可以在SWR控制台“组织管理”创建和查看。 **取值范围**：不涉及。

        :return: The namespace of this Image.
        :rtype: str
        """
    ...
    def namespace(self, namespace):
        r"""Sets the namespace of this Image.

        **参数解释**：镜像所属组织，可以在SWR控制台“组织管理”创建和查看。 **取值范围**：不涉及。

        :param namespace: The namespace of this Image.
        :type namespace: str
        """
    ...
    def origin(self, origin):
        r"""Sets the origin of this Image.

        **参数解释**：指定镜像来源。 **取值范围**：枚举类型，取值如下： - CUSTOMIZE：用户自定义构建镜像。 - IMAGE_SAVE：Notebook实例保存镜像。

        :param origin: The origin of this Image.
        :type origin: str
        """
        self._origin = origin
    ...
    def resource_categories(self):
        r"""Gets the resource_categories of this Image.

        **参数解释**：镜像支持的规格。枚举类型，取值如下： - CPU - GPU - [ASCEND](tag:hc,hk,fcs_super)

        :return: The resource_categories of this Image.
        :rtype: list[str]
        """
    ...
    def resource_categories(self, resource_categories):
        r"""Sets the resource_categories of this Image.

        **参数解释**：镜像支持的规格。枚举类型，取值如下： - CPU - GPU - [ASCEND](tag:hc,hk,fcs_super)

        :param resource_categories: The resource_categories of this Image.
        :type resource_categories: list[str]
        """
    ...
    def service_type(self):
        r"""Gets the service_type of this Image.
        ...
        **参数解释**：镜像支持服务类型。 **取值范围**：枚举类型，取值如下： - COMMON：通用镜像。 - INFERENCE：建议仅在推理部署场景使用。 - TRAIN：建议仅在训练任务场景使用。 - DEV：建议仅在开发调测场景使用。 - UNKNOWN：未明确设置的镜像支持的服务类型。
        ...
        :return: The service_type of this Image.
        :rtype: str
        """
    ...
    def service_type(self, service_type):
        r"""Sets the service_type of this Image.

        **参数解释**：镜像支持服务类型。 **取值范围**：枚举类型，取值如下： - COMMON：通用镜像。 - INFERENCE：建议仅在推理部署场景使用。 - TRAIN：建议仅在训练任务场景使用。 - DEV：建议仅在开发调测场景使用。 - UNKNOWN：未明确设置的镜像支持的服务类型。

        :param service_type: The service_type of this Image.
        :type service_type: str
        """
    ...
    def status_message(self):
        r"""Gets the status_message of this Image.

        **参数解释**：镜像保存操作过程中，构建信息展示。 **取值范围**：不涉及。

        :return: The status_message of this Image.
        :rtype: str
        """
    ...
    def status_message(self, status_message):
        r"""Sets the status_message of this Image.

        **参数解释**：镜像保存操作过程中，构建信息展示。 **取值范围**：不涉及。

        :param status_message: The status_message of this Image.
        :type status_message: str
        """
    ...
    def support_res_categories(self):
        r"""Gets the support_res_categories of this Image.

        **参数解释**：镜像支持的规格。 枚举类型，取值如下： - CPU - GPU - [ASCEND](tag:hc,hk,fcs_super)

        :return: The support_res_categories of this Image.
        :rtype: list[str]
        """
    ...
    def support_res_categories(self, support_res_categories):
        r"""Sets the support_res_categories of this Image.

        **参数解释**：镜像支持的规格。 枚举类型，取值如下： - CPU - GPU - [ASCEND](tag:hc,hk,fcs_super)

        :param support_res_categories: The support_res_categories of this Image.
        :type support_res_categories: list[str]
        """
    ...
    @property
    def swr_path(self):
        r"""Gets the swr_path of this Image.

        **参数解释**：SWR镜像地址。 **取值范围**：不涉及。

        :return: The swr_path of this Image.
        :rtype: str
        """
    ...
    def swr_path(self, swr_path):
        r"""Sets the swr_path of this Image.

        **参数解释**：SWR镜像地址。 **取值范围**：不涉及。

        :param swr_path: The swr_path of this Image.
        :type swr_path: str
        """
    ...
    @property
    def update_at(self):
        r"""Gets the update_at of this Image.

        **参数解释**：镜像最后更新的时间，UTC毫秒。 **取值范围**：不涉及。

        :return: The update_at of this Image.
        :rtype: int
        """
    ...
    def update_at(self, update_at):
        r"""Sets the update_at of this Image.

        **参数解释**：镜像最后更新的时间，UTC毫秒。 **取值范围**：不涉及。

        :param update_at: The update_at of this Image.
        :type update_at: int
        """
    ...
    @property
    def visibility(self):
        r"""Gets the visibility of this Image.
    ...
    def visibility(self, visibility):
        r"""Sets the visibility of this Image.
    ...
    def workspace_id(self):
        r"""Gets the workspace_id of this Image.

        **参数解释**：工作空间ID。未创建工作空间时默认值为“0”，存在创建并使用的工作空间，以实际取值为准。 **取值范围**：不涉及。

        :return: The workspace_id of this Image.
        :rtype: str
        """
    ...
    def workspace_id(self, workspace_id):
        r"""Sets the workspace_id of this Image.

        **参数解释**：工作空间ID。未创建工作空间时默认值为“0”，存在创建并使用的工作空间，以实际取值为准。 **取值范围**：不涉及。

        :param workspace_id: The workspace_id of this Image.
        :type workspace_id: str
        """
    ...
    def flavor_type(self, flavor_type):
        r"""Sets the flavor_type of this Image.

        **参数解释**：镜像的资源类型。 **取值范围**：枚举类型，取值如下： - ASCEND_SNT9：昇腾910芯片。 - ASCEND_SNT9B：昇腾910B芯片。 - ASCEND_SNT3：昇腾310芯片。

        :param flavor_type: The flavor_type of this Image.
        :type flavor_type: str
        """
    ...
    def swr_instance_id(self):
        r"""Gets the swr_instance_id of this Image.

        参数解释：SWR企业仓库ID。未使用SWR企业仓时该字段为null。 约束限制：不涉及。 取值范围：128位UUID。 默认取值：null。

        :return: The swr_instance_id of this Image.
        :rtype: str
        """
    ...
    def swr_instance_id(self, swr_instance_id):
        r"""Sets the swr_instance_id of this Image.

        参数解释：SWR企业仓库ID。未使用SWR企业仓时该字段为null。 约束限制：不涉及。 取值范围：128位UUID。 默认取值：null。

        :param swr_instance_id: The swr_instance_id of this Image.
        :type swr_instance_id: str
        """
    ...
    @property
    def show_name(self):
        r"""Gets the show_name of this Image.

        **参数解释**：镜像展示名称，仅预置镜像具备该字段。

        :return: The show_name of this Image.
        :rtype: str
        """
    ...
    def show_name(self, show_name):
        r"""Sets the show_name of this Image.

        **参数解释**：镜像展示名称，仅预置镜像具备该字段。

        :param show_name: The show_name of this Image.
        :type show_name: str
        """
    ...
    @property
    def show_tag(self):
        r"""Gets the show_tag of this Image.

        **参数解释**：镜像展示版本号，仅预置镜像具备该字段。

        :return: The show_tag of this Image.
        :rtype: str
        """
    ...
    def show_tag(self, show_tag):
        r"""Sets the show_tag of this Image.

        **参数解释**：镜像展示版本号，仅预置镜像具备该字段。

        :param show_tag: The show_tag of this Image.
        :type show_tag: str
        """
