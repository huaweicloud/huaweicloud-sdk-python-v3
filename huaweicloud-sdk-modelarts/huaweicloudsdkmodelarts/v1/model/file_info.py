...
class FileInfo:
    ...
    def source(self, source):
        r"""Sets the source of this FileInfo.

        **参数解释：** 代码来源类别。 **约束限制：** 不涉及。 **取值范围：** 如下参数不区分大小写 - OBS：对象存储服务。 - OBSFS：OBS的文件系统接口。 - EFS：弹性文件服务。 - LOCAL：挂载宿主机本地存储目录。 **默认取值：** 不涉及。

        :param source: The source of this FileInfo.
        :type source: str
        """
        self._source = source
    ...
    @property
    def address(self):
        r"""Gets the address of this FileInfo.

        **参数解释：** 代码来源地址，格式遵循不同存储系统。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The address of this FileInfo.
        :rtype: str
        """
    ...
    def address(self, address):
        r"""Sets the address of this FileInfo.

        **参数解释：** 代码来源地址，格式遵循不同存储系统。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param address: The address of this FileInfo.
        :type address: str
        """
    ...
    def mount_path(self, mount_path):
        r"""Sets the mount_path of this FileInfo.

        **参数解释：** 挂载到容器内的路径。 **约束限制：** 不涉及。 **取值范围：** 以(/)开头和结尾，可包含字母、数字、中划线、下划线，整个挂载路径长度不能超过255位。 **默认取值：** 不涉及。

        :param mount_path: The mount_path of this FileInfo.
        :type mount_path: str
        """
    ...
    @property
    def host_cache(self):
        r"""Gets the host_cache of this FileInfo.

        **参数解释：** 是否支持模型本地缓存，默认是不支持。 **约束限制：** 不涉及。 **取值范围：** - true：支持。 - false：不支持。 **默认取值：** false。

        :return: The host_cache of this FileInfo.
        :rtype: bool
        """
    ...
    def host_cache(self, host_cache):
        r"""Sets the host_cache of this FileInfo.

        **参数解释：** 是否支持模型本地缓存，默认是不支持。 **约束限制：** 不涉及。 **取值范围：** - true：支持。 - false：不支持。 **默认取值：** false。

        :param host_cache: The host_cache of this FileInfo.
        :type host_cache: bool
        """
    ...
    def efs_sub_path(self):
        r"""Gets the efs_sub_path of this FileInfo.

        **参数解释：** 当存储类别为EFS时，支持配置子目录。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The efs_sub_path of this FileInfo.
        :rtype: str
        """
    ...
    def efs_sub_path(self, efs_sub_path):
        r"""Sets the efs_sub_path of this FileInfo.

        **参数解释：** 当存储类别为EFS时，支持配置子目录。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param efs_sub_path: The efs_sub_path of this FileInfo.
        :type efs_sub_path: str
        """
    ...
    @property
    def read_only(self):
        r"""Gets the read_only of this FileInfo.

        **参数解释：** 挂载权限设置，是否只读。 **约束限制：** 不涉及。 **取值范围：** - true：只读。 - false：非只读。 **默认取值：** 不涉及。

        :return: The read_only of this FileInfo.
        :rtype: bool
        """
    ...
    def read_only(self, read_only):
        r"""Sets the read_only of this FileInfo.

        **参数解释：** 挂载权限设置，是否只读。 **约束限制：** 不涉及。 **取值范围：** - true：只读。 - false：非只读。 **默认取值：** 不涉及。

        :param read_only: The read_only of this FileInfo.
        :type read_only: bool
        """
    ...
    @property
    def os_warm_up(self):
        r"""Gets the os_warm_up of this FileInfo.

        **参数解释：** OS预热。 **约束限制：** 不涉及。 **取值范围：** - true：预热。 - false：不预热。 **默认取值：** 不涉及。

        :return: The os_warm_up of this FileInfo.
        :rtype: bool
        """
    ...
    def os_warm_up(self, os_warm_up):
        r"""Sets the os_warm_up of this FileInfo.

        **参数解释：** OS预热。 **约束限制：** 不涉及。 **取值范围：** - true：预热。 - false：不预热。 **默认取值：** 不涉及。

        :param os_warm_up: The os_warm_up of this FileInfo.
        :type os_warm_up: bool
        """
    ...
    def source_name(self):
        r"""Gets the source_name of this FileInfo.

        **参数解释：** 预热名称。 **约束限制：** os_warm_up为true时必填。 **取值范围：** 支持1-64位字符，可包含字母、中文、数字、中划线、下划线。 **默认取值：** 不涉及。

        :return: The source_name of this FileInfo.
        :rtype: str
        """
    ...
    def source_name(self, source_name):
        r"""Sets the source_name of this FileInfo.

        **参数解释：** 预热名称。 **约束限制：** os_warm_up为true时必填。 **取值范围：** 支持1-64位字符，可包含字母、中文、数字、中划线、下划线。 **默认取值：** 不涉及。

        :param source_name: The source_name of this FileInfo.
        :type source_name: str
        """
