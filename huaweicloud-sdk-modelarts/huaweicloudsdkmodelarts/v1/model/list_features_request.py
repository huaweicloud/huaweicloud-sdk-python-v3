...
class ListFeaturesRequest:
    ...
    @property
    def feature(self):
        r"""Gets the feature of this ListFeaturesRequest.

        **参数解释**：特性名称。 **约束限制**：不涉及。 **取值范围**：枚举类型，取值如下： - NOTEBOOK：用户显式创建的Notebook实例。  **默认取值**：NOTEBOOK。

        :return: The feature of this ListFeaturesRequest.
        :rtype: str
        """
    ...
    def feature(self, feature):
        r"""Sets the feature of this ListFeaturesRequest.

        **参数解释**：特性名称。 **约束限制**：不涉及。 **取值范围**：枚举类型，取值如下： - NOTEBOOK：用户显式创建的Notebook实例。  **默认取值**：NOTEBOOK。

        :param feature: The feature of this ListFeaturesRequest.
        :type feature: str
        """
