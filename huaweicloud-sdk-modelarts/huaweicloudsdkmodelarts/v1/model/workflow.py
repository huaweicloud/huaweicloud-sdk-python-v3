...
class Workflow:
    ...
    @property
    def created_at(self):
        r"""Gets the created_at of this Workflow.
    ...
    def created_at(self, created_at):
        r"""Sets the created_at of this Workflow.
    ...
    @property
    def user_name(self):
        r"""Gets the user_name of this Workflow.

        创建Workflow工作流的用户名。

        :return: The user_name of this Workflow.
        :rtype: str
        """
    ...
    def user_name(self, user_name):
        r"""Sets the user_name of this Workflow.

        创建Workflow工作流的用户名。

        :param user_name: The user_name of this Workflow.
        :type user_name: str
        """
    ...
    def workspace_id(self):
        r"""Gets the workspace_id of this Workflow.

        工作空间ID。

        :return: The workspace_id of this Workflow.
        :rtype: str
        """
    ...
    def workspace_id(self, workspace_id):
        r"""Sets the workspace_id of this Workflow.

        工作空间ID。

        :param workspace_id: The workspace_id of this Workflow.
        :type workspace_id: str
        """
    ...
    def data_requirements(self):
        r"""Gets the data_requirements of this Workflow.

        Workflow需要的数据。

        :return: The data_requirements of this Workflow.
    ...
    def data_requirements(self, data_requirements):
        r"""Sets the data_requirements of this Workflow.

        Workflow需要的数据。

        :param data_requirements: The data_requirements of this Workflow.
        :type data_requirements: list[:class:`huaweicloudsdkmodelarts.v1.DataRequirement`]
        """
    ...
    @property
    def data(self):
        r"""Gets the data of this Workflow.

        Workflow包含的数据。

        :return: The data of this Workflow.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this Workflow.

        Workflow包含的数据。

        :param data: The data of this Workflow.
        :type data: list[:class:`huaweicloudsdkmodelarts.v1.Data`]
        """
        self._data = data
    ...
    @property
    def parameters(self):
        r"""Gets the parameters of this Workflow.

        Workflow包含的参数。

        :return: The parameters of this Workflow.
    ...
    def parameters(self, parameters):
        r"""Sets the parameters of this Workflow.

        Workflow包含的参数。

        :param parameters: The parameters of this Workflow.
        :type parameters: list[:class:`huaweicloudsdkmodelarts.v1.WorkflowParameter`]
        """
    ...
    def source_workflow_id(self):
        r"""Gets the source_workflow_id of this Workflow.

        从指定Workflow工作流进行复制。通过复制来创建Workflow时必填。

        :return: The source_workflow_id of this Workflow.
        :rtype: str
        """
    ...
    def source_workflow_id(self, source_workflow_id):
        r"""Sets the source_workflow_id of this Workflow.

        从指定Workflow工作流进行复制。通过复制来创建Workflow时必填。

        :param source_workflow_id: The source_workflow_id of this Workflow.
        :type source_workflow_id: str
        """
    ...
    def gallery_subscription(self):
        r"""Gets the gallery_subscription of this Workflow.

        :return: The gallery_subscription of this Workflow.
    ...
    def gallery_subscription(self, gallery_subscription):
        r"""Sets the gallery_subscription of this Workflow.

        :param gallery_subscription: The gallery_subscription of this Workflow.
        :type gallery_subscription: :class:`huaweicloudsdkmodelarts.v1.WorkflowGallerySubscription`
        """
    ...
    def latest_execution(self):
        r"""Gets the latest_execution of this Workflow.

        :return: The latest_execution of this Workflow.
    ...
    def latest_execution(self, latest_execution):
        r"""Sets the latest_execution of this Workflow.

        :param latest_execution: The latest_execution of this Workflow.
        :type latest_execution: :class:`huaweicloudsdkmodelarts.v1.ExecutionBrief`
        """
    ...
    @property
    def run_count(self):
        r"""Gets the run_count of this Workflow.

        工作流的已运行次数。

        :return: The run_count of this Workflow.
        :rtype: int
        """
    ...
    def run_count(self, run_count):
        r"""Sets the run_count of this Workflow.

        工作流的已运行次数。

        :param run_count: The run_count of this Workflow.
        :type run_count: int
        """
    ...
    def param_ready(self):
        r"""Gets the param_ready of this Workflow.

        当前工作流的必选参数是否都已填完。

        :return: The param_ready of this Workflow.
        :rtype: bool
        """
    ...
    def param_ready(self, param_ready):
        r"""Sets the param_ready of this Workflow.

        当前工作流的必选参数是否都已填完。

        :param param_ready: The param_ready of this Workflow.
        :type param_ready: bool
        """
    ...
    @property
    def storages(self):
        r"""Gets the storages of this Workflow.

        Workflow包含的统一存储定义。

        :return: The storages of this Workflow.
    ...
    def storages(self, storages):
        r"""Sets the storages of this Workflow.

        Workflow包含的统一存储定义。

        :param storages: The storages of this Workflow.
        :type storages: list[:class:`huaweicloudsdkmodelarts.v1.WorkflowStorage`]
        """
    ...
    @property
    def labels(self):
        r"""Gets the labels of this Workflow.
    ...
    def labels(self, labels):
        r"""Sets the labels of this Workflow.
    ...
    @property
    def assets(self):
        r"""Gets the assets of this Workflow.

        工作流绑定的资产。

        :return: The assets of this Workflow.
    ...
    def assets(self, assets):
        r"""Sets the assets of this Workflow.

        工作流绑定的资产。

        :param assets: The assets of this Workflow.
        :type assets: list[:class:`huaweicloudsdkmodelarts.v1.WorkflowAsset`]
        """
        self._assets = assets
    ...
    @property
    def sub_graphs(self):
        r"""Gets the sub_graphs of this Workflow.

        工作流包含的子图。

        :return: The sub_graphs of this Workflow.
    ...
    def sub_graphs(self, sub_graphs):
        r"""Sets the sub_graphs of this Workflow.

        工作流包含的子图。

        :param sub_graphs: The sub_graphs of this Workflow.
        :type sub_graphs: list[:class:`huaweicloudsdkmodelarts.v1.WorkflowSubgraph`]
        """
    ...
    @property
    def extend(self):
        r"""Gets the extend of this Workflow.

        计费工作流使用的拓展字段。

        :return: The extend of this Workflow.
    ...
    def extend(self, extend):
        r"""Sets the extend of this Workflow.

        计费工作流使用的拓展字段。

        :param extend: The extend of this Workflow.
        :type extend: dict(str, object)
        """
        self._extend = extend
    ...
    @property
    def policy(self):
        r"""Gets the policy of this Workflow.

        :return: The policy of this Workflow.
    ...
    def policy(self, policy):
        r"""Sets the policy of this Workflow.

        :param policy: The policy of this Workflow.
        :type policy: :class:`huaweicloudsdkmodelarts.v1.WorkflowPolicy`
        """
        self._policy = policy
    ...
    def with_subscription(self):
        r"""Gets the with_subscription of this Workflow.

        工作流SMN消息订阅开关，默认为false，表示关闭消息订阅开关。

        :return: The with_subscription of this Workflow.
        :rtype: bool
        """
    ...
    def with_subscription(self, with_subscription):
        r"""Sets the with_subscription of this Workflow.

        工作流SMN消息订阅开关，默认为false，表示关闭消息订阅开关。

        :param with_subscription: The with_subscription of this Workflow.
        :type with_subscription: bool
        """
    ...
    @property
    def smn_switch(self):
        r"""Gets the smn_switch of this Workflow.

        SMN开关。

        :return: The smn_switch of this Workflow.
        :rtype: bool
        """
    ...
    def smn_switch(self, smn_switch):
        r"""Sets the smn_switch of this Workflow.

        SMN开关。

        :param smn_switch: The smn_switch of this Workflow.
        :type smn_switch: bool
        """
    ...
    def subscription_id(self):
        r"""Gets the subscription_id of this Workflow.

        SMN消息订阅ID。

        :return: The subscription_id of this Workflow.
        :rtype: str
        """
    ...
    def subscription_id(self, subscription_id):
        r"""Sets the subscription_id of this Workflow.

        SMN消息订阅ID。

        :param subscription_id: The subscription_id of this Workflow.
        :type subscription_id: str
        """
    ...
    def exeml_template_id(self):
        r"""Gets the exeml_template_id of this Workflow.

        自动学习模板ID。

        :return: The exeml_template_id of this Workflow.
        :rtype: str
        """
    ...
    def exeml_template_id(self, exeml_template_id):
        r"""Sets the exeml_template_id of this Workflow.

        自动学习模板ID。

        :param exeml_template_id: The exeml_template_id of this Workflow.
        :type exeml_template_id: str
        """
    ...
    def last_modified_at(self):
        r"""Gets the last_modified_at of this Workflow.

        最近一次修改的时间。

        :return: The last_modified_at of this Workflow.
        :rtype: str
        """
    ...
    def last_modified_at(self, last_modified_at):
        r"""Sets the last_modified_at of this Workflow.

        最近一次修改的时间。

        :param last_modified_at: The last_modified_at of this Workflow.
        :type last_modified_at: str
        """
    ...
    @property
    def package(self):
        r"""Gets the package of this Workflow.

        :return: The package of this Workflow.
    ...
    def package(self, package):
        r"""Sets the package of this Workflow.

        :param package: The package of this Workflow.
        :type package: :class:`huaweicloudsdkmodelarts.v1.WorkflowServicePackege`
        """
