...
class ListWorkflowsResponse(SdkResponse):
    ...
    def __init__(self, total=None, count=None, items=None):
        ...
        :param total: 查询到当前用户名下的所有Workflow总数。
        :type total: int
        :param count: 查询到当前用户名下的所有符合查询条件的Workflow总数。
        :type count: int
        :param items: 查询到当前用户名下的所有符合查询条件的Workflow详情。
        :type items: list[:class:`huaweicloudsdkmodelarts.v1.Workflow`]
        """
    ...
    @property
    def items(self):
        r"""Gets the items of this ListWorkflowsResponse.

        查询到当前用户名下的所有符合查询条件的Workflow详情。

        :return: The items of this ListWorkflowsResponse.
        :rtype: list[:class:`huaweicloudsdkmodelarts.v1.Workflow`]
        """
        return self._items

    @items.setter
    def items(self, items):
        r"""Sets the items of this ListWorkflowsResponse.
