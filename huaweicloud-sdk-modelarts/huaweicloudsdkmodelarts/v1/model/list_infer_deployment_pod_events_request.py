...
class ListInferDeploymentPodEventsRequest:
    ...
    def __init__(self, id=None, deployment_name=None, instance_name=None, name=None, start_time=None, end_time=None):
        ...
        :type name: str
        :param start_time: **参数解释：** 查询开始时间，Unix时间戳（毫秒）。 **约束限制：** 需要与end_time同时传入或同时为空。不能早于end_time。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
        :type start_time: str
        :param end_time: **参数解释：** 查询结束时间，Unix时间戳（毫秒）。 **约束限制：** 需要与start_time同时传入或同时为空。不能早于start_time。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
        :type end_time: str
        """
    ...
    @property
    def start_time(self):
        r"""Gets the start_time of this ListInferDeploymentPodEventsRequest.

        **参数解释：** 查询开始时间，Unix时间戳（毫秒）。 **约束限制：** 需要与end_time同时传入或同时为空。不能早于end_time。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The start_time of this ListInferDeploymentPodEventsRequest.
        :rtype: str
        """
    ...
    def start_time(self, start_time):
        r"""Sets the start_time of this ListInferDeploymentPodEventsRequest.

        **参数解释：** 查询开始时间，Unix时间戳（毫秒）。 **约束限制：** 需要与end_time同时传入或同时为空。不能早于end_time。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param start_time: The start_time of this ListInferDeploymentPodEventsRequest.
        :type start_time: str
        """
    ...
    @property
    def end_time(self):
        r"""Gets the end_time of this ListInferDeploymentPodEventsRequest.

        **参数解释：** 查询结束时间，Unix时间戳（毫秒）。 **约束限制：** 需要与start_time同时传入或同时为空。不能早于start_time。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The end_time of this ListInferDeploymentPodEventsRequest.
        :rtype: str
        """
    ...
    def end_time(self, end_time):
        r"""Sets the end_time of this ListInferDeploymentPodEventsRequest.

        **参数解释：** 查询结束时间，Unix时间戳（毫秒）。 **约束限制：** 需要与start_time同时传入或同时为空。不能早于start_time。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param end_time: The end_time of this ListInferDeploymentPodEventsRequest.
        :type end_time: str
        """
