...
class ListNodePoolsResponse(SdkResponse):
    ...
    def __init__(self, api_version=None, kind=None, items=None):
        ...
        :param kind: **参数解释**： 资源类型。 **取值范围**： 可选值如下： - NodePoolList：节点列表
        :type kind: str
        :param items: **参数解释**：节点池列表。
        :type items: list[:class:`huaweicloudsdkmodelarts.v1.NodePool`]
        """
    ...
    def items(self):
        ...
        **参数解释**：节点池列表。
        ...
        :rtype: list[:class:`huaweicloudsdkmodelarts.v1.NodePool`]
        """
        return self._items
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListNodePoolsResponse.to_dict() is deprecated and no longer maintained, "
