...
class FlavorInfo:
    ...
    def __init__(self, max_num=None, cpu=None, gpu=None, npu=None, memory=None, disk=None):
        ...
        :param disk: 
        :type disk: :class:`huaweicloudsdkmodelarts.v1.Disk`
        """
    ...
    @property
    def max_num(self):
        r"""Gets the max_num of this FlavorInfo.

        可以选择的最大节点数量（max_num，为1代表不支持分布式）。

        :return: The max_num of this FlavorInfo.
        :rtype: int
        """
    ...
    def max_num(self, max_num):
        r"""Sets the max_num of this FlavorInfo.

        可以选择的最大节点数量（max_num，为1代表不支持分布式）。

        :param max_num: The max_num of this FlavorInfo.
        :type max_num: int
        """
    ...
    @property
    def npu(self):
        r"""Gets the npu of this FlavorInfo.

        :return: The npu of this FlavorInfo.
    ...
    @npu.setter
    def npu(self, npu):
        r"""Sets the npu of this FlavorInfo.

        :param npu: The npu of this FlavorInfo.
        :type npu: :class:`huaweicloudsdkmodelarts.v1.Npu`
        """
        self._npu = npu
    ...
    @property
    def disk(self):
        r"""Gets the disk of this FlavorInfo.

        :return: The disk of this FlavorInfo.
        :rtype: :class:`huaweicloudsdkmodelarts.v1.Disk`
        """
        return self._disk

    @disk.setter
    def disk(self, disk):
        r"""Sets the disk of this FlavorInfo.

        :param disk: The disk of this FlavorInfo.
        :type disk: :class:`huaweicloudsdkmodelarts.v1.Disk`
        """
        self._disk = disk
