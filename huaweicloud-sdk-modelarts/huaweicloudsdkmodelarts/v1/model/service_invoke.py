...
class ServiceInvoke:
    ...
    def __init__(self, port=None, protocol=None, auth_type=None, internet_access_enable=None, intranet_approval_enable=None, dynamic_routing_enable=None, strategy=None, metric_api_scheme=None, metric_api_port=None, metric_api_path=None, ems_enable=None, request_retry_enable=None, request_retry_cnt_max=None, request_retry_interval_ms=None, fuse_configs=None):
        ...
        :param strategy: **参数解释：** 智能路由策略。 **约束限制：** 不涉及。 **取值范围：** - ROUND_ROBIN：轮询。 - ORIGIN_IP_HASH：源IP哈希。 - MIN_CONN：最小连接数。 - MIN_FIRST_TOKEN_TIME：最小首token时延。 - COMPOSITE： 综合负载。 - SLO_BASED：SLO优先级。 **默认取值：** 不涉及。
        :type strategy: str
    ...
    @property
    def port(self):
        r"""Gets the port of this ServiceInvoke.

        **参数解释：** 服务端口号。 **约束限制：**  不涉及。  **取值范围：** [1, 65535]。 **默认取值：**  不涉及。

        :return: The port of this ServiceInvoke.
        :rtype: int
        """
        return self._port
    ...
    @port.setter
    def port(self, port):
        r"""Sets the port of this ServiceInvoke.

        **参数解释：** 服务端口号。 **约束限制：**  不涉及。  **取值范围：** [1, 65535]。 **默认取值：**  不涉及。

        :param port: The port of this ServiceInvoke.
        :type port: int
        """
        self._port = port
    ...
    @property
    def protocol(self):
        r"""Gets the protocol of this ServiceInvoke.
        ...
        :return: The protocol of this ServiceInvoke.
        :rtype: str
        """
    ...
    def protocol(self, protocol):
        r"""Sets the protocol of this ServiceInvoke.

        参数解释： 服务请求协议。当选择WSS与WS时，服务接口会升级为WebSocket。开启WebSocket时，不支持同时设置“服务流量限制”。 约束限制： 异步服务仅支持HTTPS, HTTP。 取值范围： HTTP：HTTP协议。 HTTPS：HTTPS协议。 WSS：WebSocket Secure协议。 WS：WebSocket协议。 默认取值： 不涉及。

        :param protocol: The protocol of this ServiceInvoke.
        :type protocol: str
        """
    ...
    @property
    def auth_type(self):
        r"""Gets the auth_type of this ServiceInvoke.

        **参数解释：** 认证类型。 **约束限制：** 不涉及。 **取值范围：** - TOKEN：IAM Token认证。 - API_KEY：API Key认证。 - NONE：无认证。 **默认取值：** 不涉及。

        :return: The auth_type of this ServiceInvoke.
        :rtype: str
        """
    ...
    def auth_type(self, auth_type):
        r"""Sets the auth_type of this ServiceInvoke.

        **参数解释：** 认证类型。 **约束限制：** 不涉及。 **取值范围：** - TOKEN：IAM Token认证。 - API_KEY：API Key认证。 - NONE：无认证。 **默认取值：** 不涉及。

        :param auth_type: The auth_type of this ServiceInvoke.
        :type auth_type: str
        """
    ...
    def internet_access_enable(self):
        r"""Gets the internet_access_enable of this ServiceInvoke.

        **参数解释：** 外网访问。 不涉及。 **约束限制：** 不涉及。 **取值范围：** - TRUE：要外网访问。 - FALSE：无需内网审批。 **默认取值：** 不涉及。

        :return: The internet_access_enable of this ServiceInvoke.
        :rtype: bool
        """
    ...
    def internet_access_enable(self, internet_access_enable):
        r"""Sets the internet_access_enable of this ServiceInvoke.

        **参数解释：** 外网访问。 不涉及。 **约束限制：** 不涉及。 **取值范围：** - TRUE：要外网访问。 - FALSE：无需内网审批。 **默认取值：** 不涉及。

        :param internet_access_enable: The internet_access_enable of this ServiceInvoke.
        :type internet_access_enable: bool
        """
    ...
    def intranet_approval_enable(self):
        r"""Gets the intranet_approval_enable of this ServiceInvoke.

        **参数解释：** 内网审批。 **约束限制：** 不涉及。 **取值范围：** - TRUE：要内网审批。 - FALSE：无需内网审批。 **默认取值：** 不涉及。

        :return: The intranet_approval_enable of this ServiceInvoke.
        :rtype: bool
        """
    ...
    def intranet_approval_enable(self, intranet_approval_enable):
        r"""Sets the intranet_approval_enable of this ServiceInvoke.

        **参数解释：** 内网审批。 **约束限制：** 不涉及。 **取值范围：** - TRUE：要内网审批。 - FALSE：无需内网审批。 **默认取值：** 不涉及。

        :param intranet_approval_enable: The intranet_approval_enable of this ServiceInvoke.
        :type intranet_approval_enable: bool
        """
    ...
    def dynamic_routing_enable(self):
        r"""Gets the dynamic_routing_enable of this ServiceInvoke.

        **参数解释：** 动态路由开关。 **约束限制：** 不涉及。 **取值范围：** - TRUE：开启动态路由。 - FALSE：不开启动态路由。 **默认取值：** 不涉及。

        :return: The dynamic_routing_enable of this ServiceInvoke.
        :rtype: bool
        """
    ...
    def dynamic_routing_enable(self, dynamic_routing_enable):
        r"""Sets the dynamic_routing_enable of this ServiceInvoke.

        **参数解释：** 动态路由开关。 **约束限制：** 不涉及。 **取值范围：** - TRUE：开启动态路由。 - FALSE：不开启动态路由。 **默认取值：** 不涉及。

        :param dynamic_routing_enable: The dynamic_routing_enable of this ServiceInvoke.
        :type dynamic_routing_enable: bool
        """
    ...
    @property
    def strategy(self):
        r"""Gets the strategy of this ServiceInvoke.
        ...
        **参数解释：** 智能路由策略。 **约束限制：** 不涉及。 **取值范围：** - ROUND_ROBIN：轮询。 - ORIGIN_IP_HASH：源IP哈希。 - MIN_CONN：最小连接数。 - MIN_FIRST_TOKEN_TIME：最小首token时延。 - COMPOSITE： 综合负载。 - SLO_BASED：SLO优先级。 **默认取值：** 不涉及。
        ...
        :return: The strategy of this ServiceInvoke.
        :rtype: str
        """
    ...
    def strategy(self, strategy):
        r"""Sets the strategy of this ServiceInvoke.

        **参数解释：** 智能路由策略。 **约束限制：** 不涉及。 **取值范围：** - ROUND_ROBIN：轮询。 - ORIGIN_IP_HASH：源IP哈希。 - MIN_CONN：最小连接数。 - MIN_FIRST_TOKEN_TIME：最小首token时延。 - COMPOSITE： 综合负载。 - SLO_BASED：SLO优先级。 **默认取值：** 不涉及。

        :param strategy: The strategy of this ServiceInvoke.
        :type strategy: str
        """
    ...
    def metric_api_scheme(self):
        r"""Gets the metric_api_scheme of this ServiceInvoke.

        **参数解释：** 指标接口服务请求协议。 **约束限制：** 不涉及。 **取值范围：** - HTTP：HTTP协议。 - HTTPS：HTTPS协议。 **默认取值：** 不涉及。

        :return: The metric_api_scheme of this ServiceInvoke.
        :rtype: str
        """
    ...
    def metric_api_scheme(self, metric_api_scheme):
        r"""Sets the metric_api_scheme of this ServiceInvoke.

        **参数解释：** 指标接口服务请求协议。 **约束限制：** 不涉及。 **取值范围：** - HTTP：HTTP协议。 - HTTPS：HTTPS协议。 **默认取值：** 不涉及。

        :param metric_api_scheme: The metric_api_scheme of this ServiceInvoke.
        :type metric_api_scheme: str
        """
    ...
    def metric_api_port(self):
        r"""Gets the metric_api_port of this ServiceInvoke.

        **参数解释：** 指标接口端口号。 **约束限制：** 不涉及。 **取值范围：** [1, 65535]。 **默认取值：** 不涉及。

        :return: The metric_api_port of this ServiceInvoke.
        :rtype: str
        """
    ...
    def metric_api_port(self, metric_api_port):
        r"""Sets the metric_api_port of this ServiceInvoke.

        **参数解释：** 指标接口端口号。 **约束限制：** 不涉及。 **取值范围：** [1, 65535]。 **默认取值：** 不涉及。

        :param metric_api_port: The metric_api_port of this ServiceInvoke.
        :type metric_api_port: str
        """
    ...
    def metric_api_path(self):
        r"""Gets the metric_api_path of this ServiceInvoke.

        **参数解释：** 指标接口path。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The metric_api_path of this ServiceInvoke.
        :rtype: str
        """
    ...
    def metric_api_path(self, metric_api_path):
        r"""Sets the metric_api_path of this ServiceInvoke.

        **参数解释：** 指标接口path。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param metric_api_path: The metric_api_path of this ServiceInvoke.
        :type metric_api_path: str
        """
    ...
    @property
    def ems_enable(self):
        r"""Gets the ems_enable of this ServiceInvoke.

        **参数解释：** 是否开启EMS加速。 **约束限制：** 不涉及。 **取值范围：** - TRUE：开启EMS加速。 - FALSE：不开启EMS加速。 **默认取值：** 不涉及。

        :return: The ems_enable of this ServiceInvoke.
        :rtype: bool
        """
    ...
    def ems_enable(self, ems_enable):
        r"""Sets the ems_enable of this ServiceInvoke.

        **参数解释：** 是否开启EMS加速。 **约束限制：** 不涉及。 **取值范围：** - TRUE：开启EMS加速。 - FALSE：不开启EMS加速。 **默认取值：** 不涉及。

        :param ems_enable: The ems_enable of this ServiceInvoke.
        :type ems_enable: bool
        """
    ...
    def request_retry_enable(self):
        r"""Gets the request_retry_enable of this ServiceInvoke.

        **参数解释：** proxy支持请求重调度开关。 **约束限制：** 不涉及。 **取值范围：** - true：开启proxy支持请求重调度。 - false：不开启proxy支持请求重调度。 **默认取值：** false

        :return: The request_retry_enable of this ServiceInvoke.
        :rtype: bool
        """
    ...
    def request_retry_enable(self, request_retry_enable):
        r"""Sets the request_retry_enable of this ServiceInvoke.

        **参数解释：** proxy支持请求重调度开关。 **约束限制：** 不涉及。 **取值范围：** - true：开启proxy支持请求重调度。 - false：不开启proxy支持请求重调度。 **默认取值：** false

        :param request_retry_enable: The request_retry_enable of this ServiceInvoke.
        :type request_retry_enable: bool
        """
    ...
    def request_retry_cnt_max(self):
        r"""Gets the request_retry_cnt_max of this ServiceInvoke.

        **参数解释：** proxy支持请求重调度的重试次数 **约束限制：**  不涉及。  **取值范围：** [1, 10]。 **默认取值：**  不涉及。

        :return: The request_retry_cnt_max of this ServiceInvoke.
        :rtype: int
        """
    ...
    def request_retry_cnt_max(self, request_retry_cnt_max):
        r"""Sets the request_retry_cnt_max of this ServiceInvoke.

        **参数解释：** proxy支持请求重调度的重试次数 **约束限制：**  不涉及。  **取值范围：** [1, 10]。 **默认取值：**  不涉及。

        :param request_retry_cnt_max: The request_retry_cnt_max of this ServiceInvoke.
        :type request_retry_cnt_max: int
        """
    ...
    def request_retry_interval_ms(self):
        r"""Gets the request_retry_interval_ms of this ServiceInvoke.

        **参数解释：** proxy支持请求重调度的重试间隔，单位ms **约束限制：**  不涉及。  **取值范围：** [1, 10000]。 **默认取值：**  不涉及。

        :return: The request_retry_interval_ms of this ServiceInvoke.
        :rtype: int
        """
    ...
    def request_retry_interval_ms(self, request_retry_interval_ms):
        r"""Sets the request_retry_interval_ms of this ServiceInvoke.

        **参数解释：** proxy支持请求重调度的重试间隔，单位ms **约束限制：**  不涉及。  **取值范围：** [1, 10000]。 **默认取值：**  不涉及。

        :param request_retry_interval_ms: The request_retry_interval_ms of this ServiceInvoke.
        :type request_retry_interval_ms: int
        """
    ...
    def fuse_configs(self):
        r"""Gets the fuse_configs of this ServiceInvoke.

        :return: The fuse_configs of this ServiceInvoke.
    ...
    def fuse_configs(self, fuse_configs):
        r"""Sets the fuse_configs of this ServiceInvoke.

        :param fuse_configs: The fuse_configs of this ServiceInvoke.
        :type fuse_configs: :class:`huaweicloudsdkmodelarts.v1.FuseConfig`
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServiceInvoke):
            return False
