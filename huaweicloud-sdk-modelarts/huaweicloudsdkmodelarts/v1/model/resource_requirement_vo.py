...
class ResourceRequirementVO:
    ...
    @property
    def cpu(self):
        r"""Gets the cpu of this ResourceRequirementVO.

        **参数解释**：作业的运行使用的CPU资源量。 **取值范围**：不涉及。

        :return: The cpu of this ResourceRequirementVO.
        :rtype: str
        """
        return self._cpu
    ...
    @cpu.setter
    def cpu(self, cpu):
        r"""Sets the cpu of this ResourceRequirementVO.

        **参数解释**：作业的运行使用的CPU资源量。 **取值范围**：不涉及。

        :param cpu: The cpu of this ResourceRequirementVO.
        :type cpu: str
        """
        self._cpu = cpu
    ...
    @property
    def memory(self):
        r"""Gets the memory of this ResourceRequirementVO.

        **参数解释**：作业的运行使用的内存资源量。 **取值范围**：不涉及。

        :return: The memory of this ResourceRequirementVO.
        :rtype: str
        """
        return self._memory
    ...
    def memory(self, memory):
        r"""Sets the memory of this ResourceRequirementVO.

        **参数解释**：作业的运行使用的内存资源量。 **取值范围**：不涉及。

        :param memory: The memory of this ResourceRequirementVO.
        :type memory: str
        """
        self._memory = memory
    ...
    def nvidia_com_gpu(self):
        r"""Gets the nvidia_com_gpu of this ResourceRequirementVO.

        **参数解释**：作业的运行使用的GPU资源量。 **取值范围**：不涉及。

        :return: The nvidia_com_gpu of this ResourceRequirementVO.
        :rtype: str
        """
    ...
    def nvidia_com_gpu(self, nvidia_com_gpu):
        r"""Sets the nvidia_com_gpu of this ResourceRequirementVO.

        **参数解释**：作业的运行使用的GPU资源量。 **取值范围**：不涉及。

        :param nvidia_com_gpu: The nvidia_com_gpu of this ResourceRequirementVO.
        :type nvidia_com_gpu: str
        """
    ...
    def huawei_com_ascend_310(self):
        r"""Gets the huawei_com_ascend_310 of this ResourceRequirementVO.

        **参数解释**：作业的运行使用的snt3类型NPU资源量。 **取值范围**：不涉及。

        :return: The huawei_com_ascend_310 of this ResourceRequirementVO.
        :rtype: str
        """
    ...
    def huawei_com_ascend_310(self, huawei_com_ascend_310):
        r"""Sets the huawei_com_ascend_310 of this ResourceRequirementVO.

        **参数解释**：作业的运行使用的snt3类型NPU资源量。 **取值范围**：不涉及。

        :param huawei_com_ascend_310: The huawei_com_ascend_310 of this ResourceRequirementVO.
        :type huawei_com_ascend_310: str
        """
    ...
    def huawei_com_ascend_1980(self):
        r"""Gets the huawei_com_ascend_1980 of this ResourceRequirementVO.

        **参数解释**：作业的运行使用的snt9类型NPU资源量。 **取值范围**：不涉及。

        :return: The huawei_com_ascend_1980 of this ResourceRequirementVO.
        :rtype: str
        """
    ...
    def huawei_com_ascend_1980(self, huawei_com_ascend_1980):
        r"""Sets the huawei_com_ascend_1980 of this ResourceRequirementVO.

        **参数解释**：作业的运行使用的snt9类型NPU资源量。 **取值范围**：不涉及。

        :param huawei_com_ascend_1980: The huawei_com_ascend_1980 of this ResourceRequirementVO.
        :type huawei_com_ascend_1980: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResourceRequirementVO):
            return False
