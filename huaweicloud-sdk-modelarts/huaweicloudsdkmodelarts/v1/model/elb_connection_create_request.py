...
class ElbConnectionCreateRequest:
    ...
    def __init__(self, elb_id=None, m_tls=None, ca_cert_id=None, server_cert_id=None, sni_cert_ids=None):
        r"""ElbConnectionCreateRequest
    ...
    @property
    def elb_id(self):
        r"""Gets the elb_id of this ElbConnectionCreateRequest.

        **参数解释：** 负载均衡器ID。 **约束限制：**  不涉及。 **取值范围：** 不涉及。 **默认取值：**  不涉及。

        :return: The elb_id of this ElbConnectionCreateRequest.
        :rtype: str
        """
        return self._elb_id
    ...
    def elb_id(self, elb_id):
        r"""Sets the elb_id of this ElbConnectionCreateRequest.

        **参数解释：** 负载均衡器ID。 **约束限制：**  不涉及。 **取值范围：** 不涉及。 **默认取值：**  不涉及。

        :param elb_id: The elb_id of this ElbConnectionCreateRequest.
        :type elb_id: str
        """
        self._elb_id = elb_id
    ...
    @property
    def m_tls(self):
        r"""Gets the m_tls of this ElbConnectionCreateRequest.

        **参数解释：** 负载均衡器的HTTPS监听器是否开启双向认证。 **约束限制：** 仅推理服务协议为HTTPS或WSS时可配置为true，否则忽略该配置 **取值范围：** 不涉及。 **默认取值：** false

        :return: The m_tls of this ElbConnectionCreateRequest.
        :rtype: bool
        """
        return self._m_tls
    ...
    def m_tls(self, m_tls):
        r"""Sets the m_tls of this ElbConnectionCreateRequest.

        **参数解释：** 负载均衡器的HTTPS监听器是否开启双向认证。 **约束限制：** 仅推理服务协议为HTTPS或WSS时可配置为true，否则忽略该配置 **取值范围：** 不涉及。 **默认取值：** false

        :param m_tls: The m_tls of this ElbConnectionCreateRequest.
        :type m_tls: bool
        """
        self._m_tls = m_tls
    ...
    @property
    def ca_cert_id(self):
        r"""Gets the ca_cert_id of this ElbConnectionCreateRequest.

        **参数解释：** 负载均衡器的HTTPS监听器配置的客户端证书ID。 **约束限制：** 仅推理服务协议为HTTPS或WSS时可配置，否则忽略该配置 **取值范围：** 不涉及。 **默认取值：**  不涉及。

        :return: The ca_cert_id of this ElbConnectionCreateRequest.
        :rtype: str
        """
    ...
    def ca_cert_id(self, ca_cert_id):
        r"""Sets the ca_cert_id of this ElbConnectionCreateRequest.

        **参数解释：** 负载均衡器的HTTPS监听器配置的客户端证书ID。 **约束限制：** 仅推理服务协议为HTTPS或WSS时可配置，否则忽略该配置 **取值范围：** 不涉及。 **默认取值：**  不涉及。

        :param ca_cert_id: The ca_cert_id of this ElbConnectionCreateRequest.
        :type ca_cert_id: str
        """
    ...
    def server_cert_id(self):
        r"""Gets the server_cert_id of this ElbConnectionCreateRequest.

        **参数解释：** 负载均衡器的HTTPS监听器配置的服务端证书ID。 **约束限制：** 仅推理服务协议为HTTPS或WSS时可配置，否则忽略该配置。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The server_cert_id of this ElbConnectionCreateRequest.
        :rtype: str
        """
    ...
    def server_cert_id(self, server_cert_id):
        r"""Sets the server_cert_id of this ElbConnectionCreateRequest.

        **参数解释：** 负载均衡器的HTTPS监听器配置的服务端证书ID。 **约束限制：** 仅推理服务协议为HTTPS或WSS时可配置，否则忽略该配置。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param server_cert_id: The server_cert_id of this ElbConnectionCreateRequest.
        :type server_cert_id: str
        """
    ...
    def sni_cert_ids(self):
        r"""Gets the sni_cert_ids of this ElbConnectionCreateRequest.

        **参数解释：** 负载均衡器的HTTPS监听器配置的SNI（服务器名称指示）证书ID列表。 **约束限制：** 仅推理服务协议为HTTPS或WSS时可配置，否则忽略该配置。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The sni_cert_ids of this ElbConnectionCreateRequest.
        :rtype: list[str]
        """
    ...
    def sni_cert_ids(self, sni_cert_ids):
        r"""Sets the sni_cert_ids of this ElbConnectionCreateRequest.

        **参数解释：** 负载均衡器的HTTPS监听器配置的SNI（服务器名称指示）证书ID列表。 **约束限制：** 仅推理服务协议为HTTPS或WSS时可配置，否则忽略该配置。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param sni_cert_ids: The sni_cert_ids of this ElbConnectionCreateRequest.
        :type sni_cert_ids: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ElbConnectionCreateRequest):
            return False
