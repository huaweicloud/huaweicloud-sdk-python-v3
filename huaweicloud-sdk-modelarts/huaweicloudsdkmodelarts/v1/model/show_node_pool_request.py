...
class ShowNodePoolRequest:
    ...
    @property
    def pool_name(self):
        r"""Gets the pool_name of this ShowNodePoolRequest.

        **参数解释**：资源池名称。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :return: The pool_name of this ShowNodePoolRequest.
        :rtype: str
        """
    ...
    def pool_name(self, pool_name):
        r"""Sets the pool_name of this ShowNodePoolRequest.

        **参数解释**：资源池名称。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :param pool_name: The pool_name of this ShowNodePoolRequest.
        :type pool_name: str
        """
    ...
    def nodepool_name(self):
        r"""Gets the nodepool_name of this ShowNodePoolRequest.

        **参数解释**：节点池名称。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :return: The nodepool_name of this ShowNodePoolRequest.
        :rtype: str
        """
    ...
    def nodepool_name(self, nodepool_name):
        r"""Sets the nodepool_name of this ShowNodePoolRequest.

        **参数解释**：节点池名称。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :param nodepool_name: The nodepool_name of this ShowNodePoolRequest.
        :type nodepool_name: str
        """
    ...
    @property
    def _continue(self):
        r"""Gets the _continue of this ShowNodePoolRequest.

        **参数解释**：分页查询时上一页位置。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :return: The _continue of this ShowNodePoolRequest.
        :rtype: str
        """
    ...
    def _continue(self, _continue):
        r"""Sets the _continue of this ShowNodePoolRequest.

        **参数解释**：分页查询时上一页位置。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :param _continue: The _continue of this ShowNodePoolRequest.
        :type _continue: str
        """
    ...
    @property
    def limit(self):
        r"""Gets the limit of this ShowNodePoolRequest.

        **参数解释**：分页单次查询返回数。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :return: The limit of this ShowNodePoolRequest.
        :rtype: str
        """
        return self._limit
    ...
    def limit(self, limit):
        r"""Sets the limit of this ShowNodePoolRequest.

        **参数解释**：分页单次查询返回数。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :param limit: The limit of this ShowNodePoolRequest.
        :type limit: str
        """
        self._limit = limit
