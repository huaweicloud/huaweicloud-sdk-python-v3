...
class ShowNotebookResponse(SdkResponse):
    ...
    def action_progress(self):
        r"""Gets the action_progress of this ShowNotebookResponse.

        **参数解释**：实例初始化进度。

        :return: The action_progress of this ShowNotebookResponse.
    ...
    def action_progress(self, action_progress):
        r"""Sets the action_progress of this ShowNotebookResponse.

        **参数解释**：实例初始化进度。

        :param action_progress: The action_progress of this ShowNotebookResponse.
        :type action_progress: list[:class:`huaweicloudsdkmodelarts.v1.JobProgress`]
        """
    ...
    @property
    def endpoints(self):
        r"""Gets the endpoints of this ShowNotebookResponse.

        **参数解释**：本地IDE（如PyCharm、VS Code）或SSH客户端，通过SSH远程接入Notebook实例时需要的相关配置。

        :return: The endpoints of this ShowNotebookResponse.
    ...
    def endpoints(self, endpoints):
        r"""Sets the endpoints of this ShowNotebookResponse.

        **参数解释**：本地IDE（如PyCharm、VS Code）或SSH客户端，通过SSH远程接入Notebook实例时需要的相关配置。

        :param endpoints: The endpoints of this ShowNotebookResponse.
        :type endpoints: list[:class:`huaweicloudsdkmodelarts.v1.EndpointsRes`]
        """
    ...
    def fail_reason(self):
        r"""Gets the fail_reason of this ShowNotebookResponse.

        **参数解释**：实例失败原因。 **取值范围**：不涉及。

        :return: The fail_reason of this ShowNotebookResponse.
        :rtype: str
        """
    ...
    def fail_reason(self, fail_reason):
        r"""Sets the fail_reason of this ShowNotebookResponse.

        **参数解释**：实例失败原因。 **取值范围**：不涉及。

        :param fail_reason: The fail_reason of this ShowNotebookResponse.
        :type fail_reason: str
        """
    ...
    def custom_spec(self):
        r"""Gets the custom_spec of this ShowNotebookResponse.

        :return: The custom_spec of this ShowNotebookResponse.
    ...
    def custom_spec(self, custom_spec):
        r"""Sets the custom_spec of this ShowNotebookResponse.

        :param custom_spec: The custom_spec of this ShowNotebookResponse.
        :type custom_spec: :class:`huaweicloudsdkmodelarts.v1.NotebookCustomSpecRep`
        """
    ...
    @property
    def lease(self):
        r"""Gets the lease of this ShowNotebookResponse.

        :return: The lease of this ShowNotebookResponse.
    ...
    def lease(self, lease):
        r"""Sets the lease of this ShowNotebookResponse.

        :param lease: The lease of this ShowNotebookResponse.
        :type lease: :class:`huaweicloudsdkmodelarts.v1.Lease`
        """
        self._lease = lease
    ...
    @property
    def pool(self):
        r"""Gets the pool of this ShowNotebookResponse.

        :return: The pool of this ShowNotebookResponse.
    ...
    @pool.setter
    def pool(self, pool):
        r"""Sets the pool of this ShowNotebookResponse.

        :param pool: The pool of this ShowNotebookResponse.
        :type pool: :class:`huaweicloudsdkmodelarts.v1.Pool`
        """
        self._pool = pool
    ...
    @property
    def token(self):
        r"""Gets the token of this ShowNotebookResponse.

        **参数解释**：Notebook鉴权使用的token信息。 **取值范围**：不涉及。

        :return: The token of this ShowNotebookResponse.
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        r"""Sets the token of this ShowNotebookResponse.

        **参数解释**：Notebook鉴权使用的token信息。 **取值范围**：不涉及。

        :param token: The token of this ShowNotebookResponse.
        :type token: str
        """
        self._token = token
    ...
    @property
    def volume(self):
        r"""Gets the volume of this ShowNotebookResponse.

        :return: The volume of this ShowNotebookResponse.
    ...
    def volume(self, volume):
        r"""Sets the volume of this ShowNotebookResponse.

        :param volume: The volume of this ShowNotebookResponse.
        :type volume: :class:`huaweicloudsdkmodelarts.v1.VolumeRes`
        """
        self._volume = volume
    ...
    def workspace_id(self):
        r"""Gets the workspace_id of this ShowNotebookResponse.

        **参数解释**：工作空间ID。未创建工作空间时默认值为“0”，存在创建并使用的工作空间，以实际取值为准。 **取值范围**：不涉及。

        :return: The workspace_id of this ShowNotebookResponse.
        :rtype: str
        """
    ...
    def workspace_id(self, workspace_id):
        r"""Sets the workspace_id of this ShowNotebookResponse.

        **参数解释**：工作空间ID。未创建工作空间时默认值为“0”，存在创建并使用的工作空间，以实际取值为准。 **取值范围**：不涉及。

        :param workspace_id: The workspace_id of this ShowNotebookResponse.
        :type workspace_id: str
        """
    ...
    @property
    def feature(self):
        r"""Gets the feature of this ShowNotebookResponse.

        **参数解释**：实例类别。 **取值范围**：枚举类型，取值如下： - DEFAULT：CodeLab免费规格实例，每个用户最多只能创建一个。 - NOTEBOOK：计费规格实例。

        :return: The feature of this ShowNotebookResponse.
        :rtype: str
        """
    ...
    def feature(self, feature):
        r"""Sets the feature of this ShowNotebookResponse.

        **参数解释**：实例类别。 **取值范围**：枚举类型，取值如下： - DEFAULT：CodeLab免费规格实例，每个用户最多只能创建一个。 - NOTEBOOK：计费规格实例。

        :param feature: The feature of this ShowNotebookResponse.
        :type feature: str
        """
    ...
    def billing_items(self):
        r"""Gets the billing_items of this ShowNotebookResponse.

        **参数解释**：计费资源类型。枚举类型，取值如下： - STORAGE：存储资源计费。 - COMPUTE：计算资源计费。 - ALL：所有计费类型。

        :return: The billing_items of this ShowNotebookResponse.
        :rtype: list[str]
        """
    ...
    def billing_items(self, billing_items):
        r"""Sets the billing_items of this ShowNotebookResponse.

        **参数解释**：计费资源类型。枚举类型，取值如下： - STORAGE：存储资源计费。 - COMPUTE：计算资源计费。 - ALL：所有计费类型。

        :param billing_items: The billing_items of this ShowNotebookResponse.
        :type billing_items: list[str]
        """
    ...
    @property
    def user(self):
        r"""Gets the user of this ShowNotebookResponse.

        :return: The user of this ShowNotebookResponse.
    ...
    @user.setter
    def user(self, user):
        r"""Sets the user of this ShowNotebookResponse.

        :param user: The user of this ShowNotebookResponse.
        :type user: :class:`huaweicloudsdkmodelarts.v1.UserResponse`
        """
        self._user = user
    ...
    @property
    def affinity(self):
        r"""Gets the affinity of this ShowNotebookResponse.

        :return: The affinity of this ShowNotebookResponse.
    ...
    def affinity(self, affinity):
        r"""Sets the affinity of this ShowNotebookResponse.

        :param affinity: The affinity of this ShowNotebookResponse.
        :type affinity: :class:`huaweicloudsdkmodelarts.v1.AffinityType`
        """
    ...
    @property
    def run_user(self):
        r"""Gets the run_user of this ShowNotebookResponse.

        :return: The run_user of this ShowNotebookResponse.
    ...
    def run_user(self, run_user):
        r"""Sets the run_user of this ShowNotebookResponse.

        :param run_user: The run_user of this ShowNotebookResponse.
        :type run_user: :class:`huaweicloudsdkmodelarts.v1.RunUserInfo`
        """
    ...
    def data_volumes(self):
        r"""Gets the data_volumes of this ShowNotebookResponse.

        **参数解释**：扩展存储信息

        :return: The data_volumes of this ShowNotebookResponse.
    ...
    def data_volumes(self, data_volumes):
        r"""Sets the data_volumes of this ShowNotebookResponse.

        **参数解释**：扩展存储信息

        :param data_volumes: The data_volumes of this ShowNotebookResponse.
        :type data_volumes: list[:class:`huaweicloudsdkmodelarts.v1.VolumeResponse`]
        """
    ...
    @property
    def ip(self):
        r"""Gets the ip of this ShowNotebookResponse.

        **参数解释**：实例所在节点ip。 **取值范围**：不涉及。

        :return: The ip of this ShowNotebookResponse.
        :rtype: str
        """
        return self._ip
    ...
    @ip.setter
    def ip(self, ip):
        r"""Sets the ip of this ShowNotebookResponse.

        **参数解释**：实例所在节点ip。 **取值范围**：不涉及。

        :param ip: The ip of this ShowNotebookResponse.
        :type ip: str
        """
        self._ip = ip
    ...
    @property
    def user_vpc(self):
        r"""Gets the user_vpc of this ShowNotebookResponse.

        :return: The user_vpc of this ShowNotebookResponse.
    ...
    def user_vpc(self, user_vpc):
        r"""Sets the user_vpc of this ShowNotebookResponse.

        :param user_vpc: The user_vpc of this ShowNotebookResponse.
        :type user_vpc: :class:`huaweicloudsdkmodelarts.v1.UserVpcResponse`
        """
    ...
    @property
    def user_id(self):
        r"""Gets the user_id of this ShowNotebookResponse.

        **参数解释**：用户ID。 **取值范围**：不涉及。

        :return: The user_id of this ShowNotebookResponse.
        :rtype: str
        """
    ...
    def user_id(self, user_id):
        r"""Sets the user_id of this ShowNotebookResponse.

        **参数解释**：用户ID。 **取值范围**：不涉及。

        :param user_id: The user_id of this ShowNotebookResponse.
        :type user_id: str
        """
    ...
    def is_need_credentials(self):
        r"""Gets the is_need_credentials of this ShowNotebookResponse.

        **参数解释**：是否需要默认创建用户secret，默认为true。 **取值范围**：不涉及。

        :return: The is_need_credentials of this ShowNotebookResponse.
        :rtype: bool
        """
    ...
    def is_need_credentials(self, is_need_credentials):
        r"""Sets the is_need_credentials of this ShowNotebookResponse.

        **参数解释**：是否需要默认创建用户secret，默认为true。 **取值范围**：不涉及。

        :param is_need_credentials: The is_need_credentials of this ShowNotebookResponse.
        :type is_need_credentials: bool
        """
    ...
    def jupyter_version(self):
        r"""Gets the jupyter_version of this ShowNotebookResponse.

        **参数解释**：jupyter version版本号。 **取值范围**：不涉及。

        :return: The jupyter_version of this ShowNotebookResponse.
        :rtype: str
        """
    ...
    def jupyter_version(self, jupyter_version):
        r"""Sets the jupyter_version of this ShowNotebookResponse.

        **参数解释**：jupyter version版本号。 **取值范围**：不涉及。

        :param jupyter_version: The jupyter_version of this ShowNotebookResponse.
        :type jupyter_version: str
        """
    ...
    @property
    def tags(self):
        r"""Gets the tags of this ShowNotebookResponse.

        **参数解释**：实例标签。

        :return: The tags of this ShowNotebookResponse.
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this ShowNotebookResponse.

        **参数解释**：实例标签。

        :param tags: The tags of this ShowNotebookResponse.
        :type tags: list[:class:`huaweicloudsdkmodelarts.v1.TmsTagResponse`]
        """
        self._tags = tags
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowNotebookResponse.to_dict() is deprecated and no longer maintained, "
