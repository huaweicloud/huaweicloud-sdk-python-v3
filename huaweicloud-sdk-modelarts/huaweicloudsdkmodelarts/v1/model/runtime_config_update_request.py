...
class RuntimeConfigUpdateRequest:
    ...
    openapi_types = {
        'service_invoke': 'ServiceInvokeUpdateRequest',
    ...
    def __init__(self, service_invoke=None, service_limit=None, service_secret=None, server_task_limit=None):
        r"""RuntimeConfigUpdateRequest

        The model defined in huaweicloud sdk

        :param service_invoke: 
        :type service_invoke: :class:`huaweicloudsdkmodelarts.v1.ServiceInvokeUpdateRequest`
        :param service_limit: 
    ...
    def service_invoke(self):
        r"""Gets the service_invoke of this RuntimeConfigUpdateRequest.

        :return: The service_invoke of this RuntimeConfigUpdateRequest.
        :rtype: :class:`huaweicloudsdkmodelarts.v1.ServiceInvokeUpdateRequest`
        """
        return self._service_invoke

    @service_invoke.setter
    def service_invoke(self, service_invoke):
        r"""Sets the service_invoke of this RuntimeConfigUpdateRequest.

        :param service_invoke: The service_invoke of this RuntimeConfigUpdateRequest.
        :type service_invoke: :class:`huaweicloudsdkmodelarts.v1.ServiceInvokeUpdateRequest`
        """
    ...
    def service_limit(self):
        r"""Gets the service_limit of this RuntimeConfigUpdateRequest.

        :return: The service_limit of this RuntimeConfigUpdateRequest.
    ...
    def service_limit(self, service_limit):
        r"""Sets the service_limit of this RuntimeConfigUpdateRequest.

        :param service_limit: The service_limit of this RuntimeConfigUpdateRequest.
        :type service_limit: :class:`huaweicloudsdkmodelarts.v1.ServiceLimit`
        """
    ...
    def service_secret(self):
        r"""Gets the service_secret of this RuntimeConfigUpdateRequest.

        :return: The service_secret of this RuntimeConfigUpdateRequest.
    ...
    def service_secret(self, service_secret):
        r"""Sets the service_secret of this RuntimeConfigUpdateRequest.

        :param service_secret: The service_secret of this RuntimeConfigUpdateRequest.
        :type service_secret: :class:`huaweicloudsdkmodelarts.v1.ServiceSecret`
        """
    ...
    def server_task_limit(self):
        r"""Gets the server_task_limit of this RuntimeConfigUpdateRequest.

        :return: The server_task_limit of this RuntimeConfigUpdateRequest.
    ...
    def server_task_limit(self, server_task_limit):
        r"""Sets the server_task_limit of this RuntimeConfigUpdateRequest.

        :param server_task_limit: The server_task_limit of this RuntimeConfigUpdateRequest.
        :type server_task_limit: :class:`huaweicloudsdkmodelarts.v1.ServerTaskLimit`
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RuntimeConfigUpdateRequest):
            return False
