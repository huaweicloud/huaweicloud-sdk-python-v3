...
class Available:
    ...
    @property
    def value(self):
        r"""Gets the value of this Available.

        :return: The value of this Available.
    ...
    def value(self, value):
        r"""Sets the value of this Available.

        :param value: The value of this Available.
        :type value: :class:`huaweicloudsdkmodelarts.v1.Value`
        """
        self._value = value
    ...
    @property
    def timestamp(self):
        r"""Gets the timestamp of this Available.

        UTC时间，格式yyyy-MM-dd'T'HH:mm:ss'Z'。

        :return: The timestamp of this Available.
        :rtype: str
        """
    ...
    def timestamp(self, timestamp):
        r"""Sets the timestamp of this Available.

        UTC时间，格式yyyy-MM-dd'T'HH:mm:ss'Z'。

        :param timestamp: The timestamp of this Available.
        :type timestamp: str
        """
    ...
    @property
    def window(self):
        r"""Gets the window of this Available.

        统计间隔，1s表示1秒，1m表示1分钟，1h为1小时。

        :return: The window of this Available.
        :rtype: str
        """
        return self._window
    ...
    def window(self, window):
        r"""Sets the window of this Available.

        统计间隔，1s表示1秒，1m表示1分钟，1h为1小时。

        :param window: The window of this Available.
        :type window: str
        """
        self._window = window
