...
class ApiKeyResponseV2:
    ...
    @property
    def key_id(self):
        r"""Gets the key_id of this ApiKeyResponseV2.
        ...
        **参数解释：** api-key的ID，在[创建API_KEY](CreateInferApiKey.xml)时即可在返回体中获取，也可通过[查询api-keys列表](ListInferApiKeys.xml)获取当前用户拥有的api-key，其中id字段即为api-key的ID。 **取值范围：** UUID格式。
        ...
        :return: The key_id of this ApiKeyResponseV2.
        :rtype: str
        """
        return self._key_id
    ...
    def key_id(self, key_id):
        r"""Sets the key_id of this ApiKeyResponseV2.

        **参数解释：** api-key的ID，在[创建API_KEY](CreateInferApiKey.xml)时即可在返回体中获取，也可通过[查询api-keys列表](ListInferApiKeys.xml)获取当前用户拥有的api-key，其中id字段即为api-key的ID。 **取值范围：** UUID格式。

        :param key_id: The key_id of this ApiKeyResponseV2.
        :type key_id: str
        """
        self._key_id = key_id
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this ApiKeyResponseV2.

        **参数解释：** api-key的名称，在[创建API_KEY](CreateInferApiKey.xml)时自定义。 **取值范围：** 支持1-64个字符，可以包含字母、汉字、数字、连字符和下划线。

        :param name: The name of this ApiKeyResponseV2.
        :type name: str
        """
        self._name = name
    ...
    def description(self):
        r"""Gets the description of this ApiKeyResponseV2.

        **参数解释：** api-key的描述，在[创建API_KEY](CreateInferApiKey.xml)时自定义。 **取值范围：** 支持1-256个字符，可以包含字母、汉字、数字、连字符和下划线。

        :return: The description of this ApiKeyResponseV2.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this ApiKeyResponseV2.

        **参数解释：** api-key的描述，在[创建API_KEY](CreateInferApiKey.xml)时自定义。 **取值范围：** 支持1-256个字符，可以包含字母、汉字、数字、连字符和下划线。

        :param description: The description of this ApiKeyResponseV2.
        :type description: str
        """
    ...
    def create_time(self):
        r"""Gets the create_time of this ApiKeyResponseV2.

        **参数解释：** api-key的创建时间，根据创建时的当前时间自动生成。 **取值范围：** 毫秒级时间戳，13位数字，如1609459200000。

        :return: The create_time of this ApiKeyResponseV2.
        :rtype: str
        """
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this ApiKeyResponseV2.

        **参数解释：** api-key的创建时间，根据创建时的当前时间自动生成。 **取值范围：** 毫秒级时间戳，13位数字，如1609459200000。

        :param create_time: The create_time of this ApiKeyResponseV2.
        :type create_time: str
        """
    ...
    def scope(self, scope):
        r"""Sets the scope of this ApiKeyResponseV2.

        **参数解释：** api-key生效范围。 **取值范围：** - USER：表示生效范围为用户级别，可以访问该用户创建的所有在线服务。 - SERVICE：表示生效范围为单个服务，可以访问绑定该api-key的在线服务。

        :param scope: The scope of this ApiKeyResponseV2.
        :type scope: str
        """
        self._scope = scope
    ...
    @property
    def domain_id(self):
        r"""Gets the domain_id of this ApiKeyResponseV2.

        **参数解释：** 用户domain ID。获取方法请参见[获取账号名和账号ID](modelarts_03_0148.xml)。 **取值范围：** 账号ID。

        :return: The domain_id of this ApiKeyResponseV2.
        :rtype: str
        """
    ...
    def domain_id(self, domain_id):
        r"""Sets the domain_id of this ApiKeyResponseV2.

        **参数解释：** 用户domain ID。获取方法请参见[获取账号名和账号ID](modelarts_03_0148.xml)。 **取值范围：** 账号ID。

        :param domain_id: The domain_id of this ApiKeyResponseV2.
        :type domain_id: str
        """
    ...
    @property
    def project_id(self):
        r"""Gets the project_id of this ApiKeyResponseV2.
        ...
        **参数解释：** [用户项目ID](tag:hws,hws_hk,fcs,fcs_super)[资源空间ID](tag:hcs,hcs_sm)。获取方法请参见[[获取项目ID和名称](tag:hws,hws_hk,fcs,fcs_super)[获取资源空间ID和名称](tag:hcs,hcs_sm)](modelarts_03_0147.xml)。 **取值范围：** 账号的项目ID。
        ...
        :return: The project_id of this ApiKeyResponseV2.
        :rtype: str
        """
    ...
    def project_id(self, project_id):
        r"""Sets the project_id of this ApiKeyResponseV2.

        **参数解释：** [用户项目ID](tag:hws,hws_hk,fcs,fcs_super)[资源空间ID](tag:hcs,hcs_sm)。获取方法请参见[[获取项目ID和名称](tag:hws,hws_hk,fcs,fcs_super)[获取资源空间ID和名称](tag:hcs,hcs_sm)](modelarts_03_0147.xml)。 **取值范围：** 账号的项目ID。

        :param project_id: The project_id of this ApiKeyResponseV2.
        :type project_id: str
        """
    ...
    @property
    def services(self):
        r"""Gets the services of this ApiKeyResponseV2.

        **参数解释：** 绑定此api-key的在线服务列表。

        :return: The services of this ApiKeyResponseV2.
    ...
    def services(self, services):
        r"""Sets the services of this ApiKeyResponseV2.

        **参数解释：** 绑定此api-key的在线服务列表。

        :param services: The services of this ApiKeyResponseV2.
        :type services: list[:class:`huaweicloudsdkmodelarts.v1.ServiceIdName`]
        """
    ...
    def workspace_id(self):
        r"""Gets the workspace_id of this ApiKeyResponseV2.

        **参数解释：** 工作空间ID。 **取值范围：** 工作空间ID。

        :return: The workspace_id of this ApiKeyResponseV2.
        :rtype: str
        """
    ...
    def workspace_id(self, workspace_id):
        r"""Sets the workspace_id of this ApiKeyResponseV2.

        **参数解释：** 工作空间ID。 **取值范围：** 工作空间ID。

        :param workspace_id: The workspace_id of this ApiKeyResponseV2.
        :type workspace_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApiKeyResponseV2):
            return False
