...
class PoolAnnotationsCreation:
    ...
    attribute_map = {
        ...
        'os_modelarts_auto_pay': 'os.modelarts/auto.pay',
    ...
    def __init__(self, os_modelarts_description=None, os_modelarts_billing_mode=None, os_modelarts_period_num=None, os_modelarts_period_type=None, os_modelarts_auto_renew=None, os_modelarts_auto_pay=None, os_modelarts_promotion_info=None, os_modelarts_service_console_url=None, os_modelarts_order_id=None):
        r"""PoolAnnotationsCreation
        ...
        :param os_modelarts_period_type: **参数解释**：包周期订购类型。当计费模式为包周期时该参数必传。 **约束限制**：不涉及。 **取值范围**：可选值如下： - 2：月 - 3：年 **默认取值**：不涉及。
        ...
        :param os_modelarts_auto_pay: **参数解释**：是否自动付费，仅在用户购买包周期资源时生效。 **约束限制**：不涉及。 **取值范围**：可选值如下： - true：自动付费 - false：手动付费，默认值 **默认取值**：不涉及。
        :type os_modelarts_auto_pay: str
        :param os_modelarts_promotion_info: **参数解释**：用户在cbc选择的折扣信息。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
        ...
        :param os_modelarts_order_id: **参数解释**：订单id，包周期资源池创建或者计费模式变更的时候该参数必需。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。
        ...
        self._os_modelarts_auto_pay = None
        ...
        if os_modelarts_auto_pay is not None:
            self.os_modelarts_auto_pay = os_modelarts_auto_pay
    ...
    def os_modelarts_description(self):
        r"""Gets the os_modelarts_description of this PoolAnnotationsCreation.

        **参数解释**：资源池的描述信息。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :return: The os_modelarts_description of this PoolAnnotationsCreation.
        :rtype: str
        """
    ...
    def os_modelarts_description(self, os_modelarts_description):
        r"""Sets the os_modelarts_description of this PoolAnnotationsCreation.

        **参数解释**：资源池的描述信息。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :param os_modelarts_description: The os_modelarts_description of this PoolAnnotationsCreation.
        :type os_modelarts_description: str
        """
    ...
    def os_modelarts_billing_mode(self):
        r"""Gets the os_modelarts_billing_mode of this PoolAnnotationsCreation.

        **参数解释**：计费模式。 **约束限制**：不涉及。 **取值范围**：可选值如下： - 0：按需计费 - 1：包周期计费 **默认取值**：不涉及。

        :return: The os_modelarts_billing_mode of this PoolAnnotationsCreation.
        :rtype: str
        """
    ...
    def os_modelarts_billing_mode(self, os_modelarts_billing_mode):
        r"""Sets the os_modelarts_billing_mode of this PoolAnnotationsCreation.

        **参数解释**：计费模式。 **约束限制**：不涉及。 **取值范围**：可选值如下： - 0：按需计费 - 1：包周期计费 **默认取值**：不涉及。

        :param os_modelarts_billing_mode: The os_modelarts_billing_mode of this PoolAnnotationsCreation.
        :type os_modelarts_billing_mode: str
        """
    ...
    def os_modelarts_period_num(self):
        r"""Gets the os_modelarts_period_num of this PoolAnnotationsCreation.

        **参数解释**：包周期订购周期，比如2。当计费模式为包周期时该参数必传。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :return: The os_modelarts_period_num of this PoolAnnotationsCreation.
        :rtype: str
        """
    ...
    def os_modelarts_period_num(self, os_modelarts_period_num):
        r"""Sets the os_modelarts_period_num of this PoolAnnotationsCreation.

        **参数解释**：包周期订购周期，比如2。当计费模式为包周期时该参数必传。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :param os_modelarts_period_num: The os_modelarts_period_num of this PoolAnnotationsCreation.
        :type os_modelarts_period_num: str
        """
    ...
    def os_modelarts_period_type(self):
        r"""Gets the os_modelarts_period_type of this PoolAnnotationsCreation.

        **参数解释**：包周期订购类型。当计费模式为包周期时该参数必传。 **约束限制**：不涉及。 **取值范围**：可选值如下： - 2：月 - 3：年 **默认取值**：不涉及。

        :return: The os_modelarts_period_type of this PoolAnnotationsCreation.
        :rtype: str
        """
    ...
    def os_modelarts_period_type(self, os_modelarts_period_type):
        r"""Sets the os_modelarts_period_type of this PoolAnnotationsCreation.

        **参数解释**：包周期订购类型。当计费模式为包周期时该参数必传。 **约束限制**：不涉及。 **取值范围**：可选值如下： - 2：月 - 3：年 **默认取值**：不涉及。

        :param os_modelarts_period_type: The os_modelarts_period_type of this PoolAnnotationsCreation.
        :type os_modelarts_period_type: str
        """
    ...
    def os_modelarts_auto_renew(self):
        r"""Gets the os_modelarts_auto_renew of this PoolAnnotationsCreation.

        **参数解释**：是否自动续费。 **约束限制**：不涉及。 **取值范围**：可选值如下： - 0：不自动续费  - 1：自动续费 **默认取值**：0。

        :return: The os_modelarts_auto_renew of this PoolAnnotationsCreation.
        :rtype: str
        """
    ...
    def os_modelarts_auto_renew(self, os_modelarts_auto_renew):
        r"""Sets the os_modelarts_auto_renew of this PoolAnnotationsCreation.

        **参数解释**：是否自动续费。 **约束限制**：不涉及。 **取值范围**：可选值如下： - 0：不自动续费  - 1：自动续费 **默认取值**：0。

        :param os_modelarts_auto_renew: The os_modelarts_auto_renew of this PoolAnnotationsCreation.
        :type os_modelarts_auto_renew: str
        """
        self._os_modelarts_auto_renew = os_modelarts_auto_renew

    @property
    def os_modelarts_auto_pay(self):
        r"""Gets the os_modelarts_auto_pay of this PoolAnnotationsCreation.

        **参数解释**：是否自动付费，仅在用户购买包周期资源时生效。 **约束限制**：不涉及。 **取值范围**：可选值如下： - true：自动付费 - false：手动付费，默认值 **默认取值**：不涉及。

        :return: The os_modelarts_auto_pay of this PoolAnnotationsCreation.
        :rtype: str
        """
        return self._os_modelarts_auto_pay

    @os_modelarts_auto_pay.setter
    def os_modelarts_auto_pay(self, os_modelarts_auto_pay):
        r"""Sets the os_modelarts_auto_pay of this PoolAnnotationsCreation.

        **参数解释**：是否自动付费，仅在用户购买包周期资源时生效。 **约束限制**：不涉及。 **取值范围**：可选值如下： - true：自动付费 - false：手动付费，默认值 **默认取值**：不涉及。

        :param os_modelarts_auto_pay: The os_modelarts_auto_pay of this PoolAnnotationsCreation.
        :type os_modelarts_auto_pay: str
        """
        self._os_modelarts_auto_pay = os_modelarts_auto_pay

    @property
    def os_modelarts_promotion_info(self):
        r"""Gets the os_modelarts_promotion_info of this PoolAnnotationsCreation.

        **参数解释**：用户在cbc选择的折扣信息。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :return: The os_modelarts_promotion_info of this PoolAnnotationsCreation.
        :rtype: str
        """
    ...
    def os_modelarts_promotion_info(self, os_modelarts_promotion_info):
        r"""Sets the os_modelarts_promotion_info of this PoolAnnotationsCreation.

        **参数解释**：用户在cbc选择的折扣信息。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :param os_modelarts_promotion_info: The os_modelarts_promotion_info of this PoolAnnotationsCreation.
        :type os_modelarts_promotion_info: str
        """
    ...
    def os_modelarts_service_console_url(self):
        r"""Gets the os_modelarts_service_console_url of this PoolAnnotationsCreation.

        **参数解释**：订购订单支付完成后跳转的url地址。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :return: The os_modelarts_service_console_url of this PoolAnnotationsCreation.
        :rtype: str
        """
    ...
    def os_modelarts_service_console_url(self, os_modelarts_service_console_url):
        r"""Sets the os_modelarts_service_console_url of this PoolAnnotationsCreation.

        **参数解释**：订购订单支付完成后跳转的url地址。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :param os_modelarts_service_console_url: The os_modelarts_service_console_url of this PoolAnnotationsCreation.
        :type os_modelarts_service_console_url: str
        """
    ...
    def os_modelarts_order_id(self):
        r"""Gets the os_modelarts_order_id of this PoolAnnotationsCreation.

        **参数解释**：订单id，包周期资源池创建或者计费模式变更的时候该参数必需。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :return: The os_modelarts_order_id of this PoolAnnotationsCreation.
        :rtype: str
        """
    ...
    def os_modelarts_order_id(self, os_modelarts_order_id):
        r"""Sets the os_modelarts_order_id of this PoolAnnotationsCreation.

        **参数解释**：订单id，包周期资源池创建或者计费模式变更的时候该参数必需。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :param os_modelarts_order_id: The os_modelarts_order_id of this PoolAnnotationsCreation.
        :type os_modelarts_order_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PoolAnnotationsCreation):
            return False
