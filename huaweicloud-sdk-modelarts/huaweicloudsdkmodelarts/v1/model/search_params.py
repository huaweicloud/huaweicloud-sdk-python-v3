...
class SearchParams:
    ...
    @property
    def name(self):
        r"""Gets the name of this SearchParams.

        超参名称。

        :return: The name of this SearchParams.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this SearchParams.

        超参名称。

        :param name: The name of this SearchParams.
        :type name: str
        """
        self._name = name
    ...
    def param_type(self, param_type):
        r"""Sets the param_type of this SearchParams.

        参数类型。 - continuous：指定时表示这个超参是连续类型的。连续类型的超参在算法使用于训练作业时，控制台显示为输入框。 - discrete：指定时表示这个超参是离散类型的。离散类型的超参在算法使用于训练作业时，控制台显示为下拉选择框架。

        :param param_type: The param_type of this SearchParams.
        :type param_type: str
        """
    ...
    def lower_bound(self):
        r"""Gets the lower_bound of this SearchParams.

        超参下界。

        :return: The lower_bound of this SearchParams.
        :rtype: str
        """
    ...
    def lower_bound(self, lower_bound):
        r"""Sets the lower_bound of this SearchParams.

        超参下界。

        :param lower_bound: The lower_bound of this SearchParams.
        :type lower_bound: str
        """
    ...
    def upper_bound(self):
        r"""Gets the upper_bound of this SearchParams.

        超参上界。

        :return: The upper_bound of this SearchParams.
        :rtype: str
        """
    ...
    def upper_bound(self, upper_bound):
        r"""Sets the upper_bound of this SearchParams.

        超参上界。

        :param upper_bound: The upper_bound of this SearchParams.
        :type upper_bound: str
        """
    ...
    def discrete_points_num(self):
        r"""Gets the discrete_points_num of this SearchParams.

        连续型超参离散化取值个数。

        :return: The discrete_points_num of this SearchParams.
        :rtype: str
        """
    ...
    def discrete_points_num(self, discrete_points_num):
        r"""Sets the discrete_points_num of this SearchParams.

        连续型超参离散化取值个数。

        :param discrete_points_num: The discrete_points_num of this SearchParams.
        :type discrete_points_num: str
        """
    ...
    def discrete_values(self):
        r"""Gets the discrete_values of this SearchParams.

        离散型超参的取值列表。

        :return: The discrete_values of this SearchParams.
        :rtype: list[str]
        """
    ...
    def discrete_values(self, discrete_values):
        r"""Sets the discrete_values of this SearchParams.

        离散型超参的取值列表。

        :param discrete_values: The discrete_values of this SearchParams.
        :type discrete_values: list[str]
        """
