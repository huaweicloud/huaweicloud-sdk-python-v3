...
class ImageResponse:
    ...
    def __init__(self, arch=None, create_at=None, description=None, dev_services=None, id=None, name=None, namespace=None, origin=None, resource_categories=None, service_type=None, size=None, status=None, status_message=None, swr_path=None, tag=None, type=None, update_at=None, visibility=None, workspace_id=None, flavor_type=None, swr_instance_id=None, show_name=None, show_tag=None, tags=None):
        ...
        :type create_at: int
        :param description: **参数解释**：该镜像所对应的描述信息，长度限制512个字符。 **取值范围**：不涉及。
        :type description: str
        :param dev_services: **参数解释**：镜像支持的服务。元素为枚举类型，取值如下： - NOTEBOOK：镜像支持通过https协议访问Notebook。 - SSH：镜像支持本地IDE通过SSH协议远程连接Notebook。
        ...
        :type origin: str
        :param resource_categories: **参数解释**：镜像支持的规格。元素为枚举类型，取值如下： - CPU - GPU - [ASCEND](tag:hc,hk,fcs_super)
    ...
    @property
    def arch(self):
        r"""Gets the arch of this ImageResponse.

        **参数解释**：该镜像所支持处理器架构类型。 **取值范围**：枚举类型，取值如下： - X86_64：x86处理器架构。 - AARCH64：ARM体系架构。

        :return: The arch of this ImageResponse.
        :rtype: str
        """
        return self._arch
    ...
    @arch.setter
    def arch(self, arch):
        r"""Sets the arch of this ImageResponse.

        **参数解释**：该镜像所支持处理器架构类型。 **取值范围**：枚举类型，取值如下： - X86_64：x86处理器架构。 - AARCH64：ARM体系架构。

        :param arch: The arch of this ImageResponse.
        :type arch: str
        """
        self._arch = arch
    ...
    @property
    def create_at(self):
        r"""Gets the create_at of this ImageResponse.

        **参数解释**：镜像创建的时间，UTC毫秒。 **取值范围**：不涉及。

        :return: The create_at of this ImageResponse.
        :rtype: int
        """
    ...
    def create_at(self, create_at):
        r"""Sets the create_at of this ImageResponse.

        **参数解释**：镜像创建的时间，UTC毫秒。 **取值范围**：不涉及。

        :param create_at: The create_at of this ImageResponse.
        :type create_at: int
        """
    ...
    def description(self):
        r"""Gets the description of this ImageResponse.
    ...
    def description(self, description):
        r"""Sets the description of this ImageResponse.
    ...
    def dev_services(self, dev_services):
        r"""Sets the dev_services of this ImageResponse.

        **参数解释**：镜像支持的服务。元素为枚举类型，取值如下： - NOTEBOOK：镜像支持通过https协议访问Notebook。 - SSH：镜像支持本地IDE通过SSH协议远程连接Notebook。

        :param dev_services: The dev_services of this ImageResponse.
        :type dev_services: list[str]
        """
    ...
    @property
    def id(self):
        r"""Gets the id of this ImageResponse.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this ImageResponse.
    ...
    @property
    def name(self):
        r"""Gets the name of this ImageResponse.

        **参数解释**：镜像名称。 **取值范围**：长度限制512个字符，支持小写字母、数字、中划线、下划线和点。

        :return: The name of this ImageResponse.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this ImageResponse.

        **参数解释**：镜像名称。 **取值范围**：长度限制512个字符，支持小写字母、数字、中划线、下划线和点。

        :param name: The name of this ImageResponse.
        :type name: str
        """
        self._name = name
    ...
    @property
    def namespace(self):
        r"""Gets the namespace of this ImageResponse.

        **参数解释**：镜像所属组织，可以在SWR控制台“组织管理”创建和查看。 **取值范围**：不涉及。

        :return: The namespace of this ImageResponse.
        :rtype: str
        """
    ...
    def namespace(self, namespace):
        r"""Sets the namespace of this ImageResponse.

        **参数解释**：镜像所属组织，可以在SWR控制台“组织管理”创建和查看。 **取值范围**：不涉及。

        :param namespace: The namespace of this ImageResponse.
        :type namespace: str
        """
    ...
    @property
    def origin(self):
        r"""Gets the origin of this ImageResponse.

        **参数解释**：指定镜像来源。 **取值范围**：枚举类型，取值如下： - CUSTOMIZE: 用户自定义构建镜像。 - IMAGE_SAVE：Notebook实例保存镜像。

        :return: The origin of this ImageResponse.
        :rtype: str
        """
        return self._origin
    ...
    def origin(self, origin):
        r"""Sets the origin of this ImageResponse.

        **参数解释**：指定镜像来源。 **取值范围**：枚举类型，取值如下： - CUSTOMIZE: 用户自定义构建镜像。 - IMAGE_SAVE：Notebook实例保存镜像。

        :param origin: The origin of this ImageResponse.
        :type origin: str
        """
        self._origin = origin
    ...
    def resource_categories(self):
        r"""Gets the resource_categories of this ImageResponse.

        **参数解释**：镜像支持的规格。元素为枚举类型，取值如下： - CPU - GPU - [ASCEND](tag:hc,hk,fcs_super)

        :return: The resource_categories of this ImageResponse.
        :rtype: list[str]
        """
    ...
    def resource_categories(self, resource_categories):
        r"""Sets the resource_categories of this ImageResponse.

        **参数解释**：镜像支持的规格。元素为枚举类型，取值如下： - CPU - GPU - [ASCEND](tag:hc,hk,fcs_super)

        :param resource_categories: The resource_categories of this ImageResponse.
        :type resource_categories: list[str]
        """
    ...
    def service_type(self):
        r"""Gets the service_type of this ImageResponse.
        ...
        **参数解释**：镜像支持服务类型。 **取值范围**：枚举类型，取值如下： - COMMON：通用镜像。 - INFERENCE: 建议仅在推理部署场景使用。 - TRAIN: 建议仅在训练任务场景使用。 - DEV: 建议仅在开发调测场景使用。 - UNKNOWN: 未明确设置的镜像支持的服务类型。
        ...
        :return: The service_type of this ImageResponse.
        :rtype: str
        """
    ...
    def service_type(self, service_type):
        r"""Sets the service_type of this ImageResponse.

        **参数解释**：镜像支持服务类型。 **取值范围**：枚举类型，取值如下： - COMMON：通用镜像。 - INFERENCE: 建议仅在推理部署场景使用。 - TRAIN: 建议仅在训练任务场景使用。 - DEV: 建议仅在开发调测场景使用。 - UNKNOWN: 未明确设置的镜像支持的服务类型。

        :param service_type: The service_type of this ImageResponse.
        :type service_type: str
        """
    ...
    @property
    def size(self):
        r"""Gets the size of this ImageResponse.

        **参数解释**：镜像大小（单位KB）。 **取值范围**：不涉及。

        :return: The size of this ImageResponse.
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        r"""Sets the size of this ImageResponse.

        **参数解释**：镜像大小（单位KB）。 **取值范围**：不涉及。

        :param size: The size of this ImageResponse.
        :type size: int
        """
        self._size = size
    ...
    @property
    def status(self):
        r"""Gets the status of this ImageResponse.
    ...
    def status(self, status):
        r"""Sets the status of this ImageResponse.
    ...
    def status_message(self):
        r"""Gets the status_message of this ImageResponse.

        **参数解释**：镜像保存操作过程中，构建信息展示。 **取值范围**：不涉及。

        :return: The status_message of this ImageResponse.
        :rtype: str
        """
    ...
    def status_message(self, status_message):
        r"""Sets the status_message of this ImageResponse.

        **参数解释**：镜像保存操作过程中，构建信息展示。 **取值范围**：不涉及。

        :param status_message: The status_message of this ImageResponse.
        :type status_message: str
        """
    ...
    @property
    def swr_path(self):
        r"""Gets the swr_path of this ImageResponse.

        **参数解释**：SWR镜像地址。 **取值范围**：不涉及。

        :return: The swr_path of this ImageResponse.
        :rtype: str
        """
    ...
    def swr_path(self, swr_path):
        r"""Sets the swr_path of this ImageResponse.

        **参数解释**：SWR镜像地址。 **取值范围**：不涉及。

        :param swr_path: The swr_path of this ImageResponse.
        :type swr_path: str
        """
    ...
    @property
    def tag(self):
        r"""Gets the tag of this ImageResponse.

        **参数解释**：镜像Tag。 **取值范围**：不涉及。

        :return: The tag of this ImageResponse.
        :rtype: str
        """
        return self._tag
    ...
    @tag.setter
    def tag(self, tag):
        r"""Sets the tag of this ImageResponse.

        **参数解释**：镜像Tag。 **取值范围**：不涉及。

        :param tag: The tag of this ImageResponse.
        :type tag: str
        """
        self._tag = tag
    ...
    @property
    def type(self):
        r"""Gets the type of this ImageResponse.
    ...
    @type.setter
    def type(self, type):
        r"""Sets the type of this ImageResponse.
    ...
    @property
    def update_at(self):
        r"""Gets the update_at of this ImageResponse.

        **参数解释**：镜像最后更新的时间，UTC毫秒。 **取值范围**：不涉及。

        :return: The update_at of this ImageResponse.
        :rtype: int
        """
    ...
    def update_at(self, update_at):
        r"""Sets the update_at of this ImageResponse.

        **参数解释**：镜像最后更新的时间，UTC毫秒。 **取值范围**：不涉及。

        :param update_at: The update_at of this ImageResponse.
        :type update_at: int
        """
    ...
    @property
    def visibility(self):
        r"""Gets the visibility of this ImageResponse.

        **参数解释**：镜像可见度。 **取值范围**：枚举类型，取值如下： - PRIVATE：私有镜像。 - PUBLIC: 所有用户可以根据image_id来进行只读使用。

        :return: The visibility of this ImageResponse.
        :rtype: str
        """
    ...
    def visibility(self, visibility):
        r"""Sets the visibility of this ImageResponse.

        **参数解释**：镜像可见度。 **取值范围**：枚举类型，取值如下： - PRIVATE：私有镜像。 - PUBLIC: 所有用户可以根据image_id来进行只读使用。

        :param visibility: The visibility of this ImageResponse.
        :type visibility: str
        """
    ...
    def workspace_id(self):
        r"""Gets the workspace_id of this ImageResponse.

        **参数解释**：工作空间ID。未创建工作空间时默认值为“0”，存在创建并使用的工作空间，以实际取值为准。 **取值范围**：不涉及。

        :return: The workspace_id of this ImageResponse.
        :rtype: str
        """
    ...
    def workspace_id(self, workspace_id):
        r"""Sets the workspace_id of this ImageResponse.

        **参数解释**：工作空间ID。未创建工作空间时默认值为“0”，存在创建并使用的工作空间，以实际取值为准。 **取值范围**：不涉及。

        :param workspace_id: The workspace_id of this ImageResponse.
        :type workspace_id: str
        """
    ...
    def flavor_type(self, flavor_type):
        r"""Sets the flavor_type of this ImageResponse.

        **参数解释**：镜像的资源类型。 **取值范围**：枚举类型，取值如下： -ASCEND_SNT9：昇腾910芯片。 -ASCEND_SNT9B：昇腾910B芯片。 -ASCEND_SNT3：昇腾310芯片。

        :param flavor_type: The flavor_type of this ImageResponse.
        :type flavor_type: str
        """
    ...
    def swr_instance_id(self):
        r"""Gets the swr_instance_id of this ImageResponse.

        **参数解释**：SWR企业仓库ID。未使用SWR企业仓时该字段为null。 **约束限制**：不涉及。 **取值范围**：128位UUID。 **默认取值**：null。

        :return: The swr_instance_id of this ImageResponse.
        :rtype: str
        """
    ...
    def swr_instance_id(self, swr_instance_id):
        r"""Sets the swr_instance_id of this ImageResponse.

        **参数解释**：SWR企业仓库ID。未使用SWR企业仓时该字段为null。 **约束限制**：不涉及。 **取值范围**：128位UUID。 **默认取值**：null。

        :param swr_instance_id: The swr_instance_id of this ImageResponse.
        :type swr_instance_id: str
        """
    ...
    @property
    def show_name(self):
        r"""Gets the show_name of this ImageResponse.

        **参数解释**：镜像展示名称，仅预置镜像具备该字段。

        :return: The show_name of this ImageResponse.
        :rtype: str
        """
    ...
    def show_name(self, show_name):
        r"""Sets the show_name of this ImageResponse.

        **参数解释**：镜像展示名称，仅预置镜像具备该字段。

        :param show_name: The show_name of this ImageResponse.
        :type show_name: str
        """
    ...
    @property
    def show_tag(self):
        r"""Gets the show_tag of this ImageResponse.

        **参数解释**：镜像展示版本号，仅预置镜像具备该字段。

        :return: The show_tag of this ImageResponse.
        :rtype: str
        """
    ...
    def show_tag(self, show_tag):
        r"""Sets the show_tag of this ImageResponse.

        **参数解释**：镜像展示版本号，仅预置镜像具备该字段。

        :param show_tag: The show_tag of this ImageResponse.
        :type show_tag: str
        """
    ...
    @property
    def tags(self):
        r"""Gets the tags of this ImageResponse.

        **参数解释**：镜像标签。

        :return: The tags of this ImageResponse.
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this ImageResponse.

        **参数解释**：镜像标签。

        :param tags: The tags of this ImageResponse.
        :type tags: list[:class:`huaweicloudsdkmodelarts.v1.TmsTagResponse`]
        """
        self._tags = tags
