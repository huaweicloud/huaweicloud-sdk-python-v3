...
class ClusterResponse:
    ...
    def logic_cluster_id(self):
        r"""Gets the logic_cluster_id of this ClusterResponse.

        **参数解释**： 逻辑资源池ID。 **取值范围**： 不涉及。

        :return: The logic_cluster_id of this ClusterResponse.
        :rtype: str
        """
    ...
    def logic_cluster_id(self, logic_cluster_id):
        r"""Sets the logic_cluster_id of this ClusterResponse.

        **参数解释**： 逻辑资源池ID。 **取值范围**： 不涉及。

        :param logic_cluster_id: The logic_cluster_id of this ClusterResponse.
        :type logic_cluster_id: str
        """
    ...
    @property
    def status(self):
        r"""Gets the status of this ClusterResponse.
    ...
    def status(self, status):
        r"""Sets the status of this ClusterResponse.
    ...
    @property
    def pool_id(self):
        r"""Gets the pool_id of this ClusterResponse.

        **参数解释**：资源池ID。 **取值范围**：不涉及。

        :return: The pool_id of this ClusterResponse.
        :rtype: str
        """
    ...
    def pool_id(self, pool_id):
        r"""Sets the pool_id of this ClusterResponse.

        **参数解释**：资源池ID。 **取值范围**：不涉及。

        :param pool_id: The pool_id of this ClusterResponse.
        :type pool_id: str
        """
    ...
    @property
    def type(self):
        r"""Gets the type of this ClusterResponse.

        **参数解释**：资源池类型。  **取值范围**：枚举类型，取值如下： - MANAGED：公共池。 - DEDICATED：专属池。

        :return: The type of this ClusterResponse.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        r"""Sets the type of this ClusterResponse.

        **参数解释**：资源池类型。  **取值范围**：枚举类型，取值如下： - MANAGED：公共池。 - DEDICATED：专属池。

        :param type: The type of this ClusterResponse.
        :type type: str
        """
        self._type = type
    ...
    def resource_categories(self):
        r"""Gets the resource_categories of this ClusterResponse.

        **参数解释**：资源类别。 **取值范围**：枚举类型，取值如下： - GPU - CPU - ASCEND

        :return: The resource_categories of this ClusterResponse.
        :rtype: str
        """
    ...
    def resource_categories(self, resource_categories):
        r"""Sets the resource_categories of this ClusterResponse.

        **参数解释**：资源类别。 **取值范围**：枚举类型，取值如下： - GPU - CPU - ASCEND

        :param resource_categories: The resource_categories of this ClusterResponse.
        :type resource_categories: str
        """
    ...
    def workspace_id(self, workspace_id):
        r"""Sets the workspace_id of this ClusterResponse.

        **参数解释**：工作空间ID。获取方法请参见[[查询工作空间列表](ListWorkspace.xml)](tag:hc,hk)。未创建工作空间时默认值为“0”，存在创建并使用的工作空间，以实际取值为准。 **取值范围**：不涉及。

        :param workspace_id: The workspace_id of this ClusterResponse.
        :type workspace_id: str
        """
    ...
    @property
    def create_at(self):
        r"""Gets the create_at of this ClusterResponse.

        **参数解释**：实例创建的时间，UTC毫秒。 **取值范围**：不涉及。

        :return: The create_at of this ClusterResponse.
        :rtype: str
        """
    ...
    def create_at(self, create_at):
        r"""Sets the create_at of this ClusterResponse.

        **参数解释**：实例创建的时间，UTC毫秒。 **取值范围**：不涉及。

        :param create_at: The create_at of this ClusterResponse.
        :type create_at: str
        """
    ...
    @property
    def update_at(self):
        r"""Gets the update_at of this ClusterResponse.

        **参数解释**：实例最后更新的时间，UTC毫秒。 **取值范围**：不涉及。

        :return: The update_at of this ClusterResponse.
        :rtype: str
        """
    ...
    def update_at(self, update_at):
        r"""Sets the update_at of this ClusterResponse.

        **参数解释**：实例最后更新的时间，UTC毫秒。 **取值范围**：不涉及。

        :param update_at: The update_at of this ClusterResponse.
        :type update_at: str
        """
    ...
    @property
    def project_id(self):
        r"""Gets the project_id of this ClusterResponse.

        **参数解释**：用户项目ID，获取方法请参见[获取项目ID和名称](modelarts_03_0147.xml)。 **取值范围**：不涉及。

        :return: The project_id of this ClusterResponse.
        :rtype: str
        """
    ...
    def project_id(self, project_id):
        r"""Sets the project_id of this ClusterResponse.

        **参数解释**：用户项目ID，获取方法请参见[获取项目ID和名称](modelarts_03_0147.xml)。 **取值范围**：不涉及。

        :param project_id: The project_id of this ClusterResponse.
        :type project_id: str
        """
    ...
    @property
    def domain_id(self):
        r"""Gets the domain_id of this ClusterResponse.

        **参数解释**：账号ID。 **取值范围**：不涉及。

        :return: The domain_id of this ClusterResponse.
        :rtype: str
        """
    ...
    def domain_id(self, domain_id):
        r"""Sets the domain_id of this ClusterResponse.

        **参数解释**：账号ID。 **取值范围**：不涉及。

        :param domain_id: The domain_id of this ClusterResponse.
        :type domain_id: str
        """
    ...
    @property
    def flavors(self):
        r"""Gets the flavors of this ClusterResponse.

        **参数解释**：资源池规格。

        :return: The flavors of this ClusterResponse.
    ...
    def flavors(self, flavors):
        r"""Sets the flavors of this ClusterResponse.

        **参数解释**：资源池规格。

        :param flavors: The flavors of this ClusterResponse.
        :type flavors: list[:class:`huaweicloudsdkmodelarts.v1.Flavor`]
        """
    ...
    def is_allow_root(self):
        r"""Gets the is_allow_root of this ClusterResponse.

        **参数解释**：资源池是否允许实例以root启动。

        :return: The is_allow_root of this ClusterResponse.
        :rtype: bool
        """
    ...
    def is_allow_root(self, is_allow_root):
        r"""Sets the is_allow_root of this ClusterResponse.

        **参数解释**：资源池是否允许实例以root启动。

        :param is_allow_root: The is_allow_root of this ClusterResponse.
        :type is_allow_root: bool
        """
