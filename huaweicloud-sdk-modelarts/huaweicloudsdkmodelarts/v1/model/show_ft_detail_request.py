...
class ShowFtDetailRequest:
    ...
    def training_job_id(self):
        r"""Gets the training_job_id of this ShowFtDetailRequest.

        训练作业ID。获取方法请参见[查询训练作业列表](ListTrainingJobs.xml)。

        :return: The training_job_id of this ShowFtDetailRequest.
        :rtype: str
        """
    ...
    def training_job_id(self, training_job_id):
        r"""Sets the training_job_id of this ShowFtDetailRequest.

        训练作业ID。获取方法请参见[查询训练作业列表](ListTrainingJobs.xml)。

        :param training_job_id: The training_job_id of this ShowFtDetailRequest.
        :type training_job_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowFtDetailRequest):
            return False
