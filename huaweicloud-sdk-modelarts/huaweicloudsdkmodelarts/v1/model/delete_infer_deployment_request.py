...
class DeleteInferDeploymentRequest:
    ...
    def __init__(self, service_id=None, deployment_id=None):
        r"""DeleteInferDeploymentRequest
    ...
    @property
    def service_id(self):
        r"""Gets the service_id of this DeleteInferDeploymentRequest.
        ...
        **参数解释：** 服务ID，在[创建服务](CreateInferService.xml)时即可在返回体中获取，也可通过[查询服务列表](ListInferServices.xml)获取当前用户拥有的服务，其中service_id字段即为服务ID。 **约束限制：** 不涉及。 **取值范围：** 服务ID。 **默认取值：** 不涉及。
        ...
        :return: The service_id of this DeleteInferDeploymentRequest.
        :rtype: str
        """
    ...
    def service_id(self, service_id):
        r"""Sets the service_id of this DeleteInferDeploymentRequest.

        **参数解释：** 服务ID，在[创建服务](CreateInferService.xml)时即可在返回体中获取，也可通过[查询服务列表](ListInferServices.xml)获取当前用户拥有的服务，其中service_id字段即为服务ID。 **约束限制：** 不涉及。 **取值范围：** 服务ID。 **默认取值：** 不涉及。

        :param service_id: The service_id of this DeleteInferDeploymentRequest.
        :type service_id: str
        """
    ...
    def deployment_id(self):
        r"""Gets the deployment_id of this DeleteInferDeploymentRequest.
        ...
        **参数解释：** 部署ID，在[添加部署](CreateInferDeployment.xml)时即可在返回体中获取，也可通过[查询服务部署列表](ListInferDeployments.xml)获取当前用户拥有的部署，其中deployment_id字段即为部署ID。 **约束限制：** 不涉及。 **取值范围：** 部署ID。 **默认取值：** 不涉及。
        ...
        :return: The deployment_id of this DeleteInferDeploymentRequest.
        :rtype: str
        """
    ...
    def deployment_id(self, deployment_id):
        r"""Sets the deployment_id of this DeleteInferDeploymentRequest.

        **参数解释：** 部署ID，在[添加部署](CreateInferDeployment.xml)时即可在返回体中获取，也可通过[查询服务部署列表](ListInferDeployments.xml)获取当前用户拥有的部署，其中deployment_id字段即为部署ID。 **约束限制：** 不涉及。 **取值范围：** 部署ID。 **默认取值：** 不涉及。

        :param deployment_id: The deployment_id of this DeleteInferDeploymentRequest.
        :type deployment_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteInferDeploymentRequest):
            return False
