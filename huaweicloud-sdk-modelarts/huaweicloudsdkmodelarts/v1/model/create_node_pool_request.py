...
class CreateNodePoolRequest:
    ...
    def __init__(self, pool_name=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkmodelarts.v1.CreateNodePoolRequestBody`
        """
    ...
    @property
    def pool_name(self):
        r"""Gets the pool_name of this CreateNodePoolRequest.

        **参数解释**：资源池名称。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :return: The pool_name of this CreateNodePoolRequest.
        :rtype: str
        """
    ...
    def pool_name(self, pool_name):
        r"""Sets the pool_name of this CreateNodePoolRequest.

        **参数解释**：资源池名称。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :param pool_name: The pool_name of this CreateNodePoolRequest.
        :type pool_name: str
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkmodelarts.v1.CreateNodePoolRequestBody`
        """
        return self._body
