...
class RequiredAffinityResp:
    ...
    def __init__(self, affinity_type=None, job_level=None, affinity_group_size=None, affinity_group_level=None):
        r"""RequiredAffinityResp

        The model defined in huaweicloud sdk

        :param affinity_type: **参数解释**：亲和调度策略。 **取值范围**： - cabinet：强整柜调度 - hyperinstance：超节点亲和调度
        ...
        :type job_level: str
        :param affinity_group_size: **参数解释**：亲和组大小。 **取值范围**：不涉及。
    ...
    def affinity_type(self):
        r"""Gets the affinity_type of this RequiredAffinityResp.

        **参数解释**：亲和调度策略。 **取值范围**： - cabinet：强整柜调度 - hyperinstance：超节点亲和调度

        :return: The affinity_type of this RequiredAffinityResp.
        :rtype: str
        """
    ...
    def affinity_type(self, affinity_type):
        r"""Sets the affinity_type of this RequiredAffinityResp.

        **参数解释**：亲和调度策略。 **取值范围**： - cabinet：强整柜调度 - hyperinstance：超节点亲和调度

        :param affinity_type: The affinity_type of this RequiredAffinityResp.
        :type affinity_type: str
        """
    ...
    @property
    def job_level(self):
        r"""Gets the job_level of this RequiredAffinityResp.
        ...
        **参数解释**：作业整体的网络拓扑约束。 **约束限制**：affinity_type为networkTopology时有效，系统会将作业的所有task调度至不高于job_level层的节点组中。 用户向超节点资源池投递训练作业，如果未设置作业整体的网络拓扑约束，系统会默认赋值为cluster。 **取值范围**： - cluster：资源池级 - hyperinstanceGroup: 超节点级  **默认取值**：默认值cluster。
        ...
        :return: The job_level of this RequiredAffinityResp.
        :rtype: str
        """
    ...
    def job_level(self, job_level):
        r"""Sets the job_level of this RequiredAffinityResp.

        **参数解释**：作业整体的网络拓扑约束。 **约束限制**：affinity_type为networkTopology时有效，系统会将作业的所有task调度至不高于job_level层的节点组中。 用户向超节点资源池投递训练作业，如果未设置作业整体的网络拓扑约束，系统会默认赋值为cluster。 **取值范围**： - cluster：资源池级 - hyperinstanceGroup: 超节点级  **默认取值**：默认值cluster。

        :param job_level: The job_level of this RequiredAffinityResp.
        :type job_level: str
        """
    ...
    def affinity_group_size(self):
        r"""Gets the affinity_group_size of this RequiredAffinityResp.

        **参数解释**：亲和组大小。 **取值范围**：不涉及。

        :return: The affinity_group_size of this RequiredAffinityResp.
        :rtype: int
        """
    ...
    def affinity_group_size(self, affinity_group_size):
        r"""Sets the affinity_group_size of this RequiredAffinityResp.

        **参数解释**：亲和组大小。 **取值范围**：不涉及。

        :param affinity_group_size: The affinity_group_size of this RequiredAffinityResp.
        :type affinity_group_size: int
        """
    ...
    def affinity_group_level(self):
        r"""Gets the affinity_group_level of this RequiredAffinityResp.
        ...
        **参数解释**：亲和组的网络拓扑约束。 **约束限制**：affinity_type为networkTopology时有效，系统会将affinity_group_size个task组成的亲和组调度至不高于affinity_group_level层的节点组中。 用户向超节点资源池投递训练作业，如果未设置亲和组的网络拓扑约束，系统会默认赋值为hyperinstanceGroup。 **取值范围**： - hyperinstance：超节点级 - slice: 柜级  **默认取值**：默认值hyperinstanceGroup。
        ...
        :return: The affinity_group_level of this RequiredAffinityResp.
        :rtype: str
        """
    ...
    def affinity_group_level(self, affinity_group_level):
        r"""Sets the affinity_group_level of this RequiredAffinityResp.

        **参数解释**：亲和组的网络拓扑约束。 **约束限制**：affinity_type为networkTopology时有效，系统会将affinity_group_size个task组成的亲和组调度至不高于affinity_group_level层的节点组中。 用户向超节点资源池投递训练作业，如果未设置亲和组的网络拓扑约束，系统会默认赋值为hyperinstanceGroup。 **取值范围**： - hyperinstance：超节点级 - slice: 柜级  **默认取值**：默认值hyperinstanceGroup。

        :param affinity_group_level: The affinity_group_level of this RequiredAffinityResp.
        :type affinity_group_level: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RequiredAffinityResp):
            return False
