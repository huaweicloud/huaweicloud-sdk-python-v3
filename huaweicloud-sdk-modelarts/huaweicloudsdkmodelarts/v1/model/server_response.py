...
class ServerResponse:
    ...
    @property
    def create_at(self):
        r"""Gets the create_at of this ServerResponse.

        **参数解释**：创建时间。 **取值范围**：不涉及。

        :return: The create_at of this ServerResponse.
        :rtype: int
        """
    ...
    def create_at(self, create_at):
        r"""Sets the create_at of this ServerResponse.

        **参数解释**：创建时间。 **取值范围**：不涉及。

        :param create_at: The create_at of this ServerResponse.
        :type create_at: int
        """
    ...
    @property
    def update_at(self):
        r"""Gets the update_at of this ServerResponse.

        **参数解释**：更新时间。 **取值范围**：不涉及。

        :return: The update_at of this ServerResponse.
        :rtype: int
        """
    ...
    def update_at(self, update_at):
        r"""Sets the update_at of this ServerResponse.

        **参数解释**：更新时间。 **取值范围**：不涉及。

        :param update_at: The update_at of this ServerResponse.
        :type update_at: int
        """
    ...
    def charging_mode(self):
        r"""Gets the charging_mode of this ServerResponse.

        **参数解释**：计费模式。 **取值范围**： - [COMMON：同时支持包周期和按需](tag:hws,hws_hk) - POST_PAID：按需模式 - [PRE_PAID：包周期](tag:hws,hws_hk)

        :return: The charging_mode of this ServerResponse.
        :rtype: str
        """
    ...
    def charging_mode(self, charging_mode):
        r"""Sets the charging_mode of this ServerResponse.

        **参数解释**：计费模式。 **取值范围**： - [COMMON：同时支持包周期和按需](tag:hws,hws_hk) - POST_PAID：按需模式 - [PRE_PAID：包周期](tag:hws,hws_hk)

        :param charging_mode: The charging_mode of this ServerResponse.
        :type charging_mode: str
        """
    ...
    def cloud_server(self):
        r"""Gets the cloud_server of this ServerResponse.

        :return: The cloud_server of this ServerResponse.
    ...
    def cloud_server(self, cloud_server):
        r"""Sets the cloud_server of this ServerResponse.

        :param cloud_server: The cloud_server of this ServerResponse.
        :type cloud_server: :class:`huaweicloudsdkmodelarts.v1.CloudServer`
        """
    ...
    def endpoints_response(self):
        r"""Gets the endpoints_response of this ServerResponse.

        **参数解释**：实例私有IP信息。

        :return: The endpoints_response of this ServerResponse.
    ...
    def endpoints_response(self, endpoints_response):
        r"""Sets the endpoints_response of this ServerResponse.

        **参数解释**：实例私有IP信息。

        :param endpoints_response: The endpoints_response of this ServerResponse.
        :type endpoints_response: list[:class:`huaweicloudsdkmodelarts.v1.Endpoints`]
        """
    ...
    @property
    def flavor(self):
        r"""Gets the flavor of this ServerResponse.

        **参数解释**：实例规格名称。 **取值范围**：^.{1,128}$。

        :return: The flavor of this ServerResponse.
        :rtype: str
        """
        return self._flavor
    ...
    def flavor(self, flavor):
        r"""Sets the flavor of this ServerResponse.

        **参数解释**：实例规格名称。 **取值范围**：^.{1,128}$。

        :param flavor: The flavor of this ServerResponse.
        :type flavor: str
        """
        self._flavor = flavor
    ...
    @property
    def id(self):
        r"""Gets the id of this ServerResponse.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this ServerResponse.
    ...
    def key_pair_name(self):
        r"""Gets the key_pair_name of this ServerResponse.

        **参数解释**：密钥对名称。 **取值范围**：^[-_.a-zA-Z0-9]{1,64}$。

        :return: The key_pair_name of this ServerResponse.
        :rtype: str
        """
    ...
    def key_pair_name(self, key_pair_name):
        r"""Sets the key_pair_name of this ServerResponse.

        **参数解释**：密钥对名称。 **取值范围**：^[-_.a-zA-Z0-9]{1,64}$。

        :param key_pair_name: The key_pair_name of this ServerResponse.
        :type key_pair_name: str
        """
    ...
    @property
    def name(self):
        r"""Gets the name of this ServerResponse.

        **参数解释**：实例名称。 **取值范围**：^[-_.a-zA-Z0-9]{1,64}$。

        :return: The name of this ServerResponse.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this ServerResponse.

        **参数解释**：实例名称。 **取值范围**：^[-_.a-zA-Z0-9]{1,64}$。

        :param name: The name of this ServerResponse.
        :type name: str
        """
        self._name = name
    ...
    @property
    def order_id(self):
        r"""Gets the order_id of this ServerResponse.

        **参数解释**：订单ID。 **取值范围**：^[a-zA-Z0-9]{1,64}$。

        :return: The order_id of this ServerResponse.
        :rtype: str
        """
    ...
    def order_id(self, order_id):
        r"""Sets the order_id of this ServerResponse.

        **参数解释**：订单ID。 **取值范围**：^[a-zA-Z0-9]{1,64}$。

        :param order_id: The order_id of this ServerResponse.
        :type order_id: str
        """
    ...
    @property
    def status(self):
        r"""Gets the status of this ServerResponse.
        ...
        **参数解释**：实例状态。表示实例的当前运行状态，用于监控实例的生命周期和健康状况。 **取值范围**： - CREATE_FAILED: 创建失败 - CREATING: 创建中 - DELETED: 已删除 - DELETE_FAILED: 删除失败 - DELETING: 删除中 - ERROR: 错误 - RUNNING: 运行中 - STARTING: 启动中 - START_FAILED: 启动失败 - STOPPED: 已停止 - STOPPING: 停止中 - STOP_FAILED: 停止失败 - REBOOTING: 重启中 - REBOOT_FAILED: 重启失败 - CHANGINGOS: 切换操作系统中 - CHANGINGOS_FAILED: 切换操作系统失败 - REINSTALLINGOS: 重装操作系统中 - REINSTALLINGOS_FAILED: 重装操作系统失败
        ...
        :return: The status of this ServerResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        r"""Sets the status of this ServerResponse.

        **参数解释**：实例状态。表示实例的当前运行状态，用于监控实例的生命周期和健康状况。 **取值范围**： - CREATE_FAILED: 创建失败 - CREATING: 创建中 - DELETED: 已删除 - DELETE_FAILED: 删除失败 - DELETING: 删除中 - ERROR: 错误 - RUNNING: 运行中 - STARTING: 启动中 - START_FAILED: 启动失败 - STOPPED: 已停止 - STOPPING: 停止中 - STOP_FAILED: 停止失败 - REBOOTING: 重启中 - REBOOT_FAILED: 重启失败 - CHANGINGOS: 切换操作系统中 - CHANGINGOS_FAILED: 切换操作系统失败 - REINSTALLINGOS: 重装操作系统中 - REINSTALLINGOS_FAILED: 重装操作系统失败

        :param status: The status of this ServerResponse.
        :type status: str
        """
        self._status = status
    ...
    @property
    def vpc_id(self):
        r"""Gets the vpc_id of this ServerResponse.

        **参数解释**：实例所在虚拟私有云ID。 **取值范围**：^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$。

        :return: The vpc_id of this ServerResponse.
        :rtype: str
        """
        return self._vpc_id
    ...
    def vpc_id(self, vpc_id):
        r"""Sets the vpc_id of this ServerResponse.

        **参数解释**：实例所在虚拟私有云ID。 **取值范围**：^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$。

        :param vpc_id: The vpc_id of this ServerResponse.
        :type vpc_id: str
        """
        self._vpc_id = vpc_id
    ...
    @property
    def endpoints(self):
        r"""Gets the endpoints of this ServerResponse.

        **参数解释**：服务器私有IP信息。

        :return: The endpoints of this ServerResponse.
    ...
    def endpoints(self, endpoints):
        r"""Sets the endpoints of this ServerResponse.

        **参数解释**：服务器私有IP信息。

        :param endpoints: The endpoints of this ServerResponse.
        :type endpoints: list[:class:`huaweicloudsdkmodelarts.v1.EndpointsRes`]
        """
    ...
    @property
    def volumes(self):
        r"""Gets the volumes of this ServerResponse.

        **参数解释**：挂载硬盘信息。

        :return: The volumes of this ServerResponse.
    ...
    def volumes(self, volumes):
        r"""Sets the volumes of this ServerResponse.

        **参数解释**：挂载硬盘信息。

        :param volumes: The volumes of this ServerResponse.
        :type volumes: list[:class:`huaweicloudsdkmodelarts.v1.ServerVolume`]
        """
    ...
    @property
    def image(self):
        r"""Gets the image of this ServerResponse.

        :return: The image of this ServerResponse.
    ...
    def image(self, image):
        r"""Sets the image of this ServerResponse.

        :param image: The image of this ServerResponse.
        :type image: :class:`huaweicloudsdkmodelarts.v1.ServerImageResponse`
        """
        self._image = image
    ...
    def category(self, category):
        r"""Sets the category of this ServerResponse.

        **参数解释**：服务器归属类型。 **取值范围**： - [HPS：超节点服务器](tag:hws,hws_hk) - [SPOD：整柜服务器](tag:hws,hws_hk) - [SERVER：单台服务器](tag:hws,hws_hk)

        :param category: The category of this ServerResponse.
        :type category: str
        """
    ...
    @property
    def server_hps(self):
        r"""Gets the server_hps of this ServerResponse.

        :return: The server_hps of this ServerResponse.
    ...
    def server_hps(self, server_hps):
        r"""Sets the server_hps of this ServerResponse.

        :param server_hps: The server_hps of this ServerResponse.
        :type server_hps: :class:`huaweicloudsdkmodelarts.v1.ServerHpsInfo`
        """
    ...
    @property
    def subnet_id(self):
        r"""Gets the subnet_id of this ServerResponse.

        **参数解释**：实例所在子网的ID。 **取值范围**：^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$。

        :return: The subnet_id of this ServerResponse.
        :rtype: str
        """
    ...
    def subnet_id(self, subnet_id):
        r"""Sets the subnet_id of this ServerResponse.

        **参数解释**：实例所在子网的ID。 **取值范围**：^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$。

        :param subnet_id: The subnet_id of this ServerResponse.
        :type subnet_id: str
        """
