...
class CreateImageResponse(SdkResponse):
    ...
    @property
    def arch(self):
        r"""Gets the arch of this CreateImageResponse.

        **参数解释**：该镜像所支持处理器架构类型。 **取值范围**：枚举类型，取值如下： - X86_64：x86处理器架构。 - AARCH64：ARM体系架构。

        :return: The arch of this CreateImageResponse.
        :rtype: str
        """
        return self._arch
    ...
    @arch.setter
    def arch(self, arch):
        r"""Sets the arch of this CreateImageResponse.

        **参数解释**：该镜像所支持处理器架构类型。 **取值范围**：枚举类型，取值如下： - X86_64：x86处理器架构。 - AARCH64：ARM体系架构。

        :param arch: The arch of this CreateImageResponse.
        :type arch: str
        """
        self._arch = arch
    ...
    @property
    def create_at(self):
        r"""Gets the create_at of this CreateImageResponse.

        **参数解释**：镜像创建的时间，UTC毫秒。 **取值范围**：不涉及。

        :return: The create_at of this CreateImageResponse.
        :rtype: int
        """
    ...
    def create_at(self, create_at):
        r"""Sets the create_at of this CreateImageResponse.

        **参数解释**：镜像创建的时间，UTC毫秒。 **取值范围**：不涉及。

        :param create_at: The create_at of this CreateImageResponse.
        :type create_at: int
        """
    ...
    def description(self):
        r"""Gets the description of this CreateImageResponse.

        **参数解释**：该镜像所对应的描述信息。 **取值范围**：长度限制512个字符。

        :return: The description of this CreateImageResponse.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this CreateImageResponse.

        **参数解释**：该镜像所对应的描述信息。 **取值范围**：长度限制512个字符。

        :param description: The description of this CreateImageResponse.
        :type description: str
        """
    ...
    def dev_services(self):
        r"""Gets the dev_services of this CreateImageResponse.

        **参数解释**：镜像支持的服务。 **取值范围**：枚举类型，取值如下： - NOTEBOOK：镜像支持通过https协议访问Notebook。 - SSH：镜像支持本地IDE通过SSH协议远程连接Notebook。

        :return: The dev_services of this CreateImageResponse.
        :rtype: list[str]
        """
    ...
    def dev_services(self, dev_services):
        r"""Sets the dev_services of this CreateImageResponse.

        **参数解释**：镜像支持的服务。 **取值范围**：枚举类型，取值如下： - NOTEBOOK：镜像支持通过https协议访问Notebook。 - SSH：镜像支持本地IDE通过SSH协议远程连接Notebook。

        :param dev_services: The dev_services of this CreateImageResponse.
        :type dev_services: list[str]
        """
    ...
    @property
    def name(self):
        r"""Gets the name of this CreateImageResponse.

        **参数解释**：镜像名称。 **取值范围**：长度限制512个字符，支持小写字母、数字、中划线、下划线和点。

        :return: The name of this CreateImageResponse.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this CreateImageResponse.

        **参数解释**：镜像名称。 **取值范围**：长度限制512个字符，支持小写字母、数字、中划线、下划线和点。

        :param name: The name of this CreateImageResponse.
        :type name: str
        """
        self._name = name
    ...
    @property
    def namespace(self):
        r"""Gets the namespace of this CreateImageResponse.

        **参数解释**：镜像所属组织，可以在SWR控制台“组织管理”创建和查看。 **取值范围**：不涉及。

        :return: The namespace of this CreateImageResponse.
        :rtype: str
        """
    ...
    def namespace(self, namespace):
        r"""Sets the namespace of this CreateImageResponse.

        **参数解释**：镜像所属组织，可以在SWR控制台“组织管理”创建和查看。 **取值范围**：不涉及。

        :param namespace: The namespace of this CreateImageResponse.
        :type namespace: str
        """
    ...
    @property
    def origin(self):
        r"""Gets the origin of this CreateImageResponse.

        **参数解释**：指定镜像来源。 **取值范围**：枚举类型，取值如下： - CUSTOMIZE：用户自定义构建镜像。 - IMAGE_SAVE：Notebook实例保存镜像。

        :return: The origin of this CreateImageResponse.
        :rtype: str
        """
        return self._origin
    ...
    def origin(self, origin):
        r"""Sets the origin of this CreateImageResponse.

        **参数解释**：指定镜像来源。 **取值范围**：枚举类型，取值如下： - CUSTOMIZE：用户自定义构建镜像。 - IMAGE_SAVE：Notebook实例保存镜像。

        :param origin: The origin of this CreateImageResponse.
        :type origin: str
        """
        self._origin = origin
    ...
    def resource_categories(self):
        r"""Gets the resource_categories of this CreateImageResponse.

        **参数解释**：镜像支持的规格。枚举类型，取值如下： - CPU - GPU - [ASCEND](tag:hc,hk,fcs_super)

        :return: The resource_categories of this CreateImageResponse.
        :rtype: list[str]
        """
    ...
    def resource_categories(self, resource_categories):
        r"""Sets the resource_categories of this CreateImageResponse.

        **参数解释**：镜像支持的规格。枚举类型，取值如下： - CPU - GPU - [ASCEND](tag:hc,hk,fcs_super)

        :param resource_categories: The resource_categories of this CreateImageResponse.
        :type resource_categories: list[str]
        """
    ...
    def service_type(self):
        r"""Gets the service_type of this CreateImageResponse.
        ...
        **参数解释**：镜像支持服务类型。 **取值范围**：枚举类型，取值如下： - COMMON：通用镜像。 - INFERENCE：建议仅在推理部署场景使用。 - TRAIN：建议仅在训练任务场景使用。 - DEV：建议仅在开发调测场景使用。 - UNKNOWN：未明确设置的镜像支持的服务类型。
        ...
        :return: The service_type of this CreateImageResponse.
        :rtype: str
        """
    ...
    def service_type(self, service_type):
        r"""Sets the service_type of this CreateImageResponse.

        **参数解释**：镜像支持服务类型。 **取值范围**：枚举类型，取值如下： - COMMON：通用镜像。 - INFERENCE：建议仅在推理部署场景使用。 - TRAIN：建议仅在训练任务场景使用。 - DEV：建议仅在开发调测场景使用。 - UNKNOWN：未明确设置的镜像支持的服务类型。

        :param service_type: The service_type of this CreateImageResponse.
        :type service_type: str
        """
    ...
    @property
    def size(self):
        r"""Gets the size of this CreateImageResponse.

        **参数解释**：镜像大小（单位KB）。 **取值范围**：不涉及。

        :return: The size of this CreateImageResponse.
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        r"""Sets the size of this CreateImageResponse.

        **参数解释**：镜像大小（单位KB）。 **取值范围**：不涉及。

        :param size: The size of this CreateImageResponse.
        :type size: int
        """
        self._size = size
    ...
    @property
    def status(self):
        r"""Gets the status of this CreateImageResponse.
        ...
        **参数解释**：镜像状态。 **取值范围**：枚举类型，取值如下： - INIT：初始化。 - CREATING：镜像保存中，此时Notebook不可用。 - CREATE_FAILED：镜像保存失败。 - ERROR：错误。 - DELETED：已删除。 - ACTIVE：镜像保存成功，保存的镜像可以在SWR控制台查看，同时可以基于保存的镜像创建Notebook实例。
        ...
        :return: The status of this CreateImageResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        r"""Sets the status of this CreateImageResponse.

        **参数解释**：镜像状态。 **取值范围**：枚举类型，取值如下： - INIT：初始化。 - CREATING：镜像保存中，此时Notebook不可用。 - CREATE_FAILED：镜像保存失败。 - ERROR：错误。 - DELETED：已删除。 - ACTIVE：镜像保存成功，保存的镜像可以在SWR控制台查看，同时可以基于保存的镜像创建Notebook实例。

        :param status: The status of this CreateImageResponse.
        :type status: str
        """
        self._status = status
    ...
    def status_message(self):
        r"""Gets the status_message of this CreateImageResponse.

        **参数解释**：镜像保存操作过程中，构建信息展示。 **取值范围**：不涉及。

        :return: The status_message of this CreateImageResponse.
        :rtype: str
        """
    ...
    def status_message(self, status_message):
        r"""Sets the status_message of this CreateImageResponse.

        **参数解释**：镜像保存操作过程中，构建信息展示。 **取值范围**：不涉及。

        :param status_message: The status_message of this CreateImageResponse.
        :type status_message: str
        """
    ...
    def support_res_categories(self):
        r"""Gets the support_res_categories of this CreateImageResponse.

        **参数解释**：镜像支持的规格。 枚举类型，取值如下： - CPU - GPU - [ASCEND](tag:hc,hk,fcs_super)

        :return: The support_res_categories of this CreateImageResponse.
        :rtype: list[str]
        """
    ...
    def support_res_categories(self, support_res_categories):
        r"""Sets the support_res_categories of this CreateImageResponse.

        **参数解释**：镜像支持的规格。 枚举类型，取值如下： - CPU - GPU - [ASCEND](tag:hc,hk,fcs_super)

        :param support_res_categories: The support_res_categories of this CreateImageResponse.
        :type support_res_categories: list[str]
        """
    ...
    @property
    def swr_path(self):
        r"""Gets the swr_path of this CreateImageResponse.

        **参数解释**：SWR镜像地址。 **取值范围**：不涉及。

        :return: The swr_path of this CreateImageResponse.
        :rtype: str
        """
    ...
    def swr_path(self, swr_path):
        r"""Sets the swr_path of this CreateImageResponse.

        **参数解释**：SWR镜像地址。 **取值范围**：不涉及。

        :param swr_path: The swr_path of this CreateImageResponse.
        :type swr_path: str
        """
    ...
    @property
    def tag(self):
        r"""Gets the tag of this CreateImageResponse.

        **参数解释**：镜像Tag。 **取值范围**：不涉及。

        :return: The tag of this CreateImageResponse.
        :rtype: str
        """
        return self._tag
    ...
    @tag.setter
    def tag(self, tag):
        r"""Sets the tag of this CreateImageResponse.

        **参数解释**：镜像Tag。 **取值范围**：不涉及。

        :param tag: The tag of this CreateImageResponse.
        :type tag: str
        """
        self._tag = tag
    ...
    @property
    def type(self):
        r"""Gets the type of this CreateImageResponse.

        **参数解释**：镜像类型。 **取值范围**：枚举类型，取值如下： - BUILD_IN：系统内置镜像。 - DEDICATED：用户保存的镜像。

        :return: The type of this CreateImageResponse.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        r"""Sets the type of this CreateImageResponse.

        **参数解释**：镜像类型。 **取值范围**：枚举类型，取值如下： - BUILD_IN：系统内置镜像。 - DEDICATED：用户保存的镜像。

        :param type: The type of this CreateImageResponse.
        :type type: str
        """
        self._type = type
    ...
    @property
    def update_at(self):
        r"""Gets the update_at of this CreateImageResponse.

        **参数解释**：镜像最后更新的时间，UTC毫秒。 **取值范围**：不涉及。

        :return: The update_at of this CreateImageResponse.
        :rtype: int
        """
    ...
    def update_at(self, update_at):
        r"""Sets the update_at of this CreateImageResponse.

        **参数解释**：镜像最后更新的时间，UTC毫秒。 **取值范围**：不涉及。

        :param update_at: The update_at of this CreateImageResponse.
        :type update_at: int
        """
    ...
    @property
    def visibility(self):
        r"""Gets the visibility of this CreateImageResponse.

        **参数解释**：镜像可见度。 **取值范围**：枚举类型，取值如下： - PRIVATE：私有镜像。 - PUBLIC：所有用户可以根据image_id来进行只读使用。

        :return: The visibility of this CreateImageResponse.
        :rtype: str
        """
    ...
    def visibility(self, visibility):
        r"""Sets the visibility of this CreateImageResponse.

        **参数解释**：镜像可见度。 **取值范围**：枚举类型，取值如下： - PRIVATE：私有镜像。 - PUBLIC：所有用户可以根据image_id来进行只读使用。

        :param visibility: The visibility of this CreateImageResponse.
        :type visibility: str
        """
    ...
    def workspace_id(self):
        r"""Gets the workspace_id of this CreateImageResponse.

        **参数解释**：工作空间ID。未创建工作空间时默认值为“0”，存在创建并使用的工作空间，以实际取值为准。 **取值范围**：不涉及。

        :return: The workspace_id of this CreateImageResponse.
        :rtype: str
        """
    ...
    def workspace_id(self, workspace_id):
        r"""Sets the workspace_id of this CreateImageResponse.

        **参数解释**：工作空间ID。未创建工作空间时默认值为“0”，存在创建并使用的工作空间，以实际取值为准。 **取值范围**：不涉及。

        :param workspace_id: The workspace_id of this CreateImageResponse.
        :type workspace_id: str
        """
    ...
    def flavor_type(self):
        r"""Gets the flavor_type of this CreateImageResponse.

        **参数解释**：镜像的资源类型。 **取值范围**：枚举类型，取值如下： - ASCEND_SNT9：昇腾910芯片。 - ASCEND_SNT9B：昇腾910B芯片。 - ASCEND_SNT3：昇腾310芯片。

        :return: The flavor_type of this CreateImageResponse.
        :rtype: str
        """
    ...
    def flavor_type(self, flavor_type):
        r"""Sets the flavor_type of this CreateImageResponse.

        **参数解释**：镜像的资源类型。 **取值范围**：枚举类型，取值如下： - ASCEND_SNT9：昇腾910芯片。 - ASCEND_SNT9B：昇腾910B芯片。 - ASCEND_SNT3：昇腾310芯片。

        :param flavor_type: The flavor_type of this CreateImageResponse.
        :type flavor_type: str
        """
    ...
    def swr_instance_id(self):
        r"""Gets the swr_instance_id of this CreateImageResponse.

        参数解释：SWR企业仓库ID。未使用SWR企业仓时该字段为null。 约束限制：不涉及。 取值范围：128位UUID。 默认取值：null。

        :return: The swr_instance_id of this CreateImageResponse.
        :rtype: str
        """
    ...
    def swr_instance_id(self, swr_instance_id):
        r"""Sets the swr_instance_id of this CreateImageResponse.

        参数解释：SWR企业仓库ID。未使用SWR企业仓时该字段为null。 约束限制：不涉及。 取值范围：128位UUID。 默认取值：null。

        :param swr_instance_id: The swr_instance_id of this CreateImageResponse.
        :type swr_instance_id: str
        """
    ...
    @property
    def show_name(self):
        r"""Gets the show_name of this CreateImageResponse.

        **参数解释**：镜像展示名称，仅预置镜像具备该字段。

        :return: The show_name of this CreateImageResponse.
        :rtype: str
        """
    ...
    def show_name(self, show_name):
        r"""Sets the show_name of this CreateImageResponse.

        **参数解释**：镜像展示名称，仅预置镜像具备该字段。

        :param show_name: The show_name of this CreateImageResponse.
        :type show_name: str
        """
    ...
    @property
    def show_tag(self):
        r"""Gets the show_tag of this CreateImageResponse.

        **参数解释**：镜像展示版本号，仅预置镜像具备该字段。

        :return: The show_tag of this CreateImageResponse.
        :rtype: str
        """
    ...
    def show_tag(self, show_tag):
        r"""Sets the show_tag of this CreateImageResponse.

        **参数解释**：镜像展示版本号，仅预置镜像具备该字段。

        :param show_tag: The show_tag of this CreateImageResponse.
        :type show_tag: str
        """
    ...
    @property
    def tags(self):
        r"""Gets the tags of this CreateImageResponse.

        **参数解释**：镜像标签。

        :return: The tags of this CreateImageResponse.
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this CreateImageResponse.

        **参数解释**：镜像标签。

        :param tags: The tags of this CreateImageResponse.
        :type tags: list[:class:`huaweicloudsdkmodelarts.v1.TmsTagResponse`]
        """
        self._tags = tags
