...
class TmsTag:
    ...
    def __init__(self, key=None, value=None):
        ...
        :param key: **参数解释**：TMS标签的key。 **约束限制**：长度限制为128个字符，支持任意语种字母、数字、空格，以及_ . : &#x3D; + - @特殊字符，但首尾不能含有空格，不能以_sys_开头。 **取值范围**：不涉及。 **默认取值**：不涉及。
        :type key: str
        :param value: **参数解释**：TMS标签的value。 **约束限制**：长度限制为255个字符，支持任意语种字母、数字、空格，以及_ . : / &#x3D; + - @特殊字符。 **取值范围**：不涉及。 **默认取值**：不涉及。
        :type value: str
        """
