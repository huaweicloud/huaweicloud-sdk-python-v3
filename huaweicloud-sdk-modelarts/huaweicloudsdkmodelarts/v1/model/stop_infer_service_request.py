...
class StopInferServiceRequest:
    ...
    @property
    def service_id(self):
        r"""Gets the service_id of this StopInferServiceRequest.
        ...
        **参数解释：** 服务ID，在[创建服务](CreateInferService.xml)时即可在返回体中获取，也可通过[查询服务列表](ListInferServices.xml)获取当前用户拥有的服务，其中service_id字段即为服务ID。 **约束限制：** 不涉及。 **取值范围：** 服务ID。 **默认取值：** 不涉及。
        ...
        :return: The service_id of this StopInferServiceRequest.
        :rtype: str
        """
    ...
    def service_id(self, service_id):
        r"""Sets the service_id of this StopInferServiceRequest.

        **参数解释：** 服务ID，在[创建服务](CreateInferService.xml)时即可在返回体中获取，也可通过[查询服务列表](ListInferServices.xml)获取当前用户拥有的服务，其中service_id字段即为服务ID。 **约束限制：** 不涉及。 **取值范围：** 服务ID。 **默认取值：** 不涉及。

        :param service_id: The service_id of this StopInferServiceRequest.
        :type service_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StopInferServiceRequest):
            return False
