...
class RuntimeConfigCreateRequest:
    ...
    openapi_types = {
        'service_invoke': 'ServiceInvokeCreateRequest',
    ...
    def __init__(self, service_invoke=None, service_limit=None, service_secret=None, server_task_limit=None):
        r"""RuntimeConfigCreateRequest

        The model defined in huaweicloud sdk

        :param service_invoke: 
        :type service_invoke: :class:`huaweicloudsdkmodelarts.v1.ServiceInvokeCreateRequest`
        :param service_limit: 
    ...
    def service_invoke(self):
        r"""Gets the service_invoke of this RuntimeConfigCreateRequest.

        :return: The service_invoke of this RuntimeConfigCreateRequest.
        :rtype: :class:`huaweicloudsdkmodelarts.v1.ServiceInvokeCreateRequest`
        """
        return self._service_invoke

    @service_invoke.setter
    def service_invoke(self, service_invoke):
        r"""Sets the service_invoke of this RuntimeConfigCreateRequest.

        :param service_invoke: The service_invoke of this RuntimeConfigCreateRequest.
        :type service_invoke: :class:`huaweicloudsdkmodelarts.v1.ServiceInvokeCreateRequest`
        """
    ...
    def service_limit(self):
        r"""Gets the service_limit of this RuntimeConfigCreateRequest.

        :return: The service_limit of this RuntimeConfigCreateRequest.
    ...
    def service_limit(self, service_limit):
        r"""Sets the service_limit of this RuntimeConfigCreateRequest.

        :param service_limit: The service_limit of this RuntimeConfigCreateRequest.
        :type service_limit: :class:`huaweicloudsdkmodelarts.v1.ServiceLimit`
        """
    ...
    def service_secret(self):
        r"""Gets the service_secret of this RuntimeConfigCreateRequest.

        :return: The service_secret of this RuntimeConfigCreateRequest.
    ...
    def service_secret(self, service_secret):
        r"""Sets the service_secret of this RuntimeConfigCreateRequest.

        :param service_secret: The service_secret of this RuntimeConfigCreateRequest.
        :type service_secret: :class:`huaweicloudsdkmodelarts.v1.ServiceSecret`
        """
    ...
    def server_task_limit(self):
        r"""Gets the server_task_limit of this RuntimeConfigCreateRequest.

        :return: The server_task_limit of this RuntimeConfigCreateRequest.
    ...
    def server_task_limit(self, server_task_limit):
        r"""Sets the server_task_limit of this RuntimeConfigCreateRequest.

        :param server_task_limit: The server_task_limit of this RuntimeConfigCreateRequest.
        :type server_task_limit: :class:`huaweicloudsdkmodelarts.v1.ServerTaskLimit`
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RuntimeConfigCreateRequest):
            return False
