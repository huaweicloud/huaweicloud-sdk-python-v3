...
class GaussDBClient(Client):
    ...
    def batch_update_backup_policy(self, request):
        r"""批量设置同区域备份策略
    ...
    def batch_update_backup_policy_invoker(self, request):
        http_info = self._batch_update_backup_policy_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _batch_update_backup_policy_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def check_kernel_upgrade(self, request):
        r"""实例升级预检查
    ...
    def check_kernel_upgrade_invoker(self, request):
        http_info = self._check_kernel_upgrade_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _check_kernel_upgrade_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def clear_online_ddl_task_temp_table(self, request):
        r"""清理实例无锁变更任务临时表
    ...
    def clear_online_ddl_task_temp_table_invoker(self, request):
        http_info = self._clear_online_ddl_task_temp_table_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _clear_online_ddl_task_temp_table_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def delete_online_ddl_task_record(self, request):
        r"""删除实例无锁变更任务记录
    ...
    def delete_online_ddl_task_record_invoker(self, request):
        http_info = self._delete_online_ddl_task_record_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_online_ddl_task_record_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def download_online_ddl_task_log(self, request):
    ...
    def download_online_ddl_task_log_invoker(self, request):
        http_info = self._download_online_ddl_task_log_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _download_online_ddl_task_log_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def list_cold_table_metas(self, request):
        r"""查询冷表元信息
    ...
    def list_cold_table_metas_invoker(self, request):
        http_info = self._list_cold_table_metas_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_cold_table_metas_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_gauss_my_sql_instance_detail_info(self, request):
        ...
        """
        warnings.warn("Method 'list_gauss_my_sql_instance_detail_info' of GaussDBClient is deprecated and will be removed in the future versions", DeprecationWarning)
    ...
    def list_gauss_my_sql_instance_detail_info_invoker(self, request):
        warnings.warn("Method 'list_gauss_my_sql_instance_detail_info_invoker' of GaussDBClient is deprecated and will be removed in the future versions", DeprecationWarning)
        http_info = self._list_gauss_my_sql_instance_detail_info_http_info(request)
        return SyncInvoker(self, http_info)
    ...
    def list_gauss_my_sql_instances(self, request):
        ...
        """
        warnings.warn("Method 'list_gauss_my_sql_instances' of GaussDBClient is deprecated and will be removed in the future versions", DeprecationWarning)
        http_info = self._list_gauss_my_sql_instances_http_info(request)
        return self._call_api(**http_info)

    def list_gauss_my_sql_instances_invoker(self, request):
        warnings.warn("Method 'list_gauss_my_sql_instances_invoker' of GaussDBClient is deprecated and will be removed in the future versions", DeprecationWarning)
        http_info = self._list_gauss_my_sql_instances_http_info(request)
        return SyncInvoker(self, http_info)
    ...
    def list_online_ddl_task_records(self, request):
        r"""查询无锁变更任务记录列表
    ...
    def list_online_ddl_task_records_invoker(self, request):
        http_info = self._list_online_ddl_task_records_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_online_ddl_task_records_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def set_instance_readonly_status(self, request):
        r"""设置/解除实例只读
    ...
    def set_instance_readonly_status_invoker(self, request):
        http_info = self._set_instance_readonly_status_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _set_instance_readonly_status_http_info(cls, request):
        http_info = {
            "method": "PUT",
    ...
    def set_instance_schedule_events(self, request):
        r"""操作事件
    ...
    def set_instance_schedule_events_invoker(self, request):
        http_info = self._set_instance_schedule_events_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _set_instance_schedule_events_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def show_gauss_my_sql_instance_info(self, request):
        ...
        """
        warnings.warn("Method 'show_gauss_my_sql_instance_info' of GaussDBClient is deprecated and will be removed in the future versions", DeprecationWarning)
    ...
    def show_gauss_my_sql_instance_info_invoker(self, request):
        warnings.warn("Method 'show_gauss_my_sql_instance_info_invoker' of GaussDBClient is deprecated and will be removed in the future versions", DeprecationWarning)
        http_info = self._show_gauss_my_sql_instance_info_http_info(request)
        return SyncInvoker(self, http_info)
    ...
    def show_instance_schedule_events(self, request):
        r"""获取事件列表
    ...
    def show_instance_schedule_events_invoker(self, request):
        http_info = self._show_instance_schedule_events_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_instance_schedule_events_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v3/{project_id}/schedule-events",
            "request_type": request.__class__.__name__,
    ...
    def show_kernel_upgrade_check_result(self, request):
        r"""查询实例升级预检查结果
    ...
    def show_kernel_upgrade_check_result_invoker(self, request):
        http_info = self._show_kernel_upgrade_check_result_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_kernel_upgrade_check_result_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def show_restore_tables(self, request):
        ...
        """
        warnings.warn("Method 'show_restore_tables' of GaussDBClient is deprecated and will be removed in the future versions", DeprecationWarning)
        http_info = self._show_restore_tables_http_info(request)
        return self._call_api(**http_info)

    def show_restore_tables_invoker(self, request):
        warnings.warn("Method 'show_restore_tables_invoker' of GaussDBClient is deprecated and will be removed in the future versions", DeprecationWarning)
        http_info = self._show_restore_tables_http_info(request)
        return SyncInvoker(self, http_info)
    ...
    def show_serverless_compute_ability_policy(self, request):
        r"""查询Serverless算力策略
    ...
    def show_serverless_compute_ability_policy_invoker(self, request):
        http_info = self._show_serverless_compute_ability_policy_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_serverless_compute_ability_policy_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_serverless_scaling_policy(self, request):
    ...
    def show_serverless_scaling_policy_invoker(self, request):
        http_info = self._show_serverless_scaling_policy_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_serverless_scaling_policy_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_slow_log_detail(self, request):
    ...
    def show_slow_log_detail_invoker(self, request):
        http_info = self._show_slow_log_detail_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_slow_log_detail_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def show_star_rocks_slowlog_sensitive_status(self, request):
    ...
    def show_star_rocks_slowlog_sensitive_status_invoker(self, request):
        http_info = self._show_star_rocks_slowlog_sensitive_status_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_star_rocks_slowlog_sensitive_status_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_taurus_db_advanced_backup_policy(self, request):
        r"""查询自动备份策略
    ...
    def show_taurus_db_advanced_backup_policy_invoker(self, request):
        http_info = self._show_taurus_db_advanced_backup_policy_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_taurus_db_advanced_backup_policy_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_taurus_db_txn_progress(self, request):
        r"""查询大事务执行进度
    ...
    def show_taurus_db_txn_progress_invoker(self, request):
        http_info = self._show_taurus_db_txn_progress_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_taurus_db_txn_progress_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def start_online_ddl_task(self, request):
        r"""开启实例无锁变更任务
    ...
    def start_online_ddl_task_invoker(self, request):
        http_info = self._start_online_ddl_task_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _start_online_ddl_task_http_info(cls, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v3/{project_id}/instances/{instance_id}/online-ddl-task",
            "request_type": request.__class__.__name__,
    ...
    def stop_online_ddl_task(self, request):
        r"""停止实例无锁变更任务
    ...
    def stop_online_ddl_task_invoker(self, request):
        http_info = self._stop_online_ddl_task_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _stop_online_ddl_task_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def update_serverless_compute_ability_policy(self, request):
        r"""设置Serverless算力策略
    ...
    def update_serverless_compute_ability_policy_invoker(self, request):
        http_info = self._update_serverless_compute_ability_policy_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_serverless_compute_ability_policy_http_info(cls, request):
        http_info = {
            "method": "PUT",
    ...
    def update_serverless_scaling_policy(self, request):
    ...
    def update_serverless_scaling_policy_invoker(self, request):
        http_info = self._update_serverless_scaling_policy_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_serverless_scaling_policy_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v3/{project_id}/instances/{instance_id}/serverless/scaling-policy",
            "request_type": request.__class__.__name__,
    ...
    def update_slowlog_sensitive_status(self, request):
    ...
    def update_slowlog_sensitive_status_invoker(self, request):
        http_info = self._update_slowlog_sensitive_status_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_slowlog_sensitive_status_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v3/{project_id}/instances/{instance_id}/starrocks/slowlog-sensitive",
            "request_type": request.__class__.__name__,
    ...
    def update_taurus_db_advanced_backup_policy(self, request):
        r"""设置同区域备份策略
    ...
    def update_taurus_db_advanced_backup_policy_invoker(self, request):
        http_info = self._update_taurus_db_advanced_backup_policy_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_taurus_db_advanced_backup_policy_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v3/{project_id}/instances/{instance_id}/backups/advanced-policy",
            "request_type": request.__class__.__name__,
    ...
    def upgrade_configuration(self, request):
        r"""更新自定义参数模板
    ...
    def upgrade_configuration_invoker(self, request):
        http_info = self._upgrade_configuration_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _upgrade_configuration_http_info(cls, request):
        http_info = {
            "method": "PUT",
    ...
    def set_htap_query_queues_rule(self, request):
        r"""设置当前查询队列阈值
    ...
    def set_htap_query_queues_rule_invoker(self, request):
        http_info = self._set_htap_query_queues_rule_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _set_htap_query_queues_rule_http_info(cls, request):
        http_info = {
            "method": "PUT",
    ...
    def show_htap_query_queues_rule_invoker(self, request):
        http_info = self._show_htap_query_queues_rule_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_htap_query_queues_rule_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v3/{project_id}/instances/{instance_id}/query-queue/rules",
            "request_type": request.__class__.__name__,
    ...
    def update_htap_query_queues_control(self, request):
        r"""开启或者关闭查询队列功能
    ...
    def update_htap_query_queues_control_invoker(self, request):
        http_info = self._update_htap_query_queues_control_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_htap_query_queues_control_http_info(cls, request):
        http_info = {
            "method": "POST",
