...
class SwitchAccessControlRequestBody:
    ...
    def __init__(self, open_access_control=None):
        ...
        :param open_access_control: 是否开启访问控制。 取值： - true：开启。 - false：关闭。
    ...
    def open_access_control(self):
        ...
        :return: The open_access_control of this SwitchAccessControlRequestBody.
        :rtype: bool
        """
    ...
    def open_access_control(self, open_access_control):
        ...
        :param open_access_control: The open_access_control of this SwitchAccessControlRequestBody.
        :type open_access_control: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SwitchAccessControlRequestBody):
            return False
