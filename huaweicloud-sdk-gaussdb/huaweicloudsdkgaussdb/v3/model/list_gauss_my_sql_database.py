...
class ListGaussMySqlDatabase:
    ...
    def name(self):
        ...
        :return: The name of this ListGaussMySqlDatabase.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this ListGaussMySqlDatabase.
        :type name: str
        """
        self._name = name
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListGaussMySqlDatabase):
            return False
