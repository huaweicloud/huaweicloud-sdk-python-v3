...
class SetGaussMySqlQuotasResponse(SdkResponse):
    ...
    @property
    def quota_list(self):
        r"""Gets the quota_list of this SetGaussMySqlQuotasResponse.
    ...
    def quota_list(self, quota_list):
        r"""Sets the quota_list of this SetGaussMySqlQuotasResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("SetGaussMySqlQuotasResponse.to_dict() is deprecated and no longer maintained, "
