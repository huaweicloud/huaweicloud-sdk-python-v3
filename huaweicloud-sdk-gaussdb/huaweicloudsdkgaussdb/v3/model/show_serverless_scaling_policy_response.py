...
class ShowServerlessScalingPolicyResponse(SdkResponse):
    ...
    def __init__(self, enlarge_step_size=None, custom_scaling_config=None):
        r"""ShowServerlessScalingPolicyResponse
    ...
    def enlarge_step_size(self):
        r"""Gets the enlarge_step_size of this ShowServerlessScalingPolicyResponse.

        **参数描述**：  自定义扩容步长。  **约束限制**：  不涉及。  **取值范围**：  2-算力上限的一半。  **默认取值**：  不涉及。

        :return: The enlarge_step_size of this ShowServerlessScalingPolicyResponse.
        :rtype: str
        """
    ...
    def enlarge_step_size(self, enlarge_step_size):
        r"""Sets the enlarge_step_size of this ShowServerlessScalingPolicyResponse.

        **参数描述**：  自定义扩容步长。  **约束限制**：  不涉及。  **取值范围**：  2-算力上限的一半。  **默认取值**：  不涉及。

        :param enlarge_step_size: The enlarge_step_size of this ShowServerlessScalingPolicyResponse.
        :type enlarge_step_size: str
        """
    ...
    def custom_scaling_config(self):
        r"""Gets the custom_scaling_config of this ShowServerlessScalingPolicyResponse.

        :return: The custom_scaling_config of this ShowServerlessScalingPolicyResponse.
    ...
    def custom_scaling_config(self, custom_scaling_config):
        r"""Sets the custom_scaling_config of this ShowServerlessScalingPolicyResponse.

        :param custom_scaling_config: The custom_scaling_config of this ShowServerlessScalingPolicyResponse.
        :type custom_scaling_config: :class:`huaweicloudsdkgaussdb.v3.CustomScalingConfig`
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowServerlessScalingPolicyResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowServerlessScalingPolicyResponse):
            return False
