...
class DeleteAutoSqlLimitingRequest:
    ...
    def __init__(self, x_language=None, instance_id=None, node_id=None):
        r"""DeleteAutoSqlLimitingRequest
    ...
    @property
    def x_language(self):
        r"""Gets the x_language of this DeleteAutoSqlLimitingRequest.

        **参数解释**：  请求语言类型。  **约束限制**：  不涉及。  **取值范围**：  - en-us - zh-cn  **默认取值**：  en-us。

        :return: The x_language of this DeleteAutoSqlLimitingRequest.
        :rtype: str
        """
    ...
    def x_language(self, x_language):
        r"""Sets the x_language of this DeleteAutoSqlLimitingRequest.

        **参数解释**：  请求语言类型。  **约束限制**：  不涉及。  **取值范围**：  - en-us - zh-cn  **默认取值**：  en-us。

        :param x_language: The x_language of this DeleteAutoSqlLimitingRequest.
        :type x_language: str
        """
    ...
    def instance_id(self):
        r"""Gets the instance_id of this DeleteAutoSqlLimitingRequest.
        ...
        **参数解释**：  实例ID，此参数是实例的唯一标识。  获取方法请参见[查询实例列表](https://support.huaweicloud.com/api-taurusdb/ListGaussMySqlInstancesUnifyStatus.html)。  **约束限制**：  不涉及。  **取值范围**：  只能由英文字母、数字组成，后缀为in07，长度为36个字符。  **默认取值**：  不涉及。
        ...
        :return: The instance_id of this DeleteAutoSqlLimitingRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this DeleteAutoSqlLimitingRequest.

        **参数解释**：  实例ID，此参数是实例的唯一标识。  获取方法请参见[查询实例列表](https://support.huaweicloud.com/api-taurusdb/ListGaussMySqlInstancesUnifyStatus.html)。  **约束限制**：  不涉及。  **取值范围**：  只能由英文字母、数字组成，后缀为in07，长度为36个字符。  **默认取值**：  不涉及。

        :param instance_id: The instance_id of this DeleteAutoSqlLimitingRequest.
        :type instance_id: str
        """
    ...
    @property
    def node_id(self):
        r"""Gets the node_id of this DeleteAutoSqlLimitingRequest.
        ...
        **参数解释**：  节点ID。  获取方法请参见[查询实例详情](https://support.huaweicloud.com/api-taurusdb/ShowGaussMySqlInstanceInfoUnifyStatus.html)。  **约束限制**：  节点角色必须为主节点。  **取值范围**：  只能由英文字母、数字组成，前面为UUID，后缀为no07，长度为36个字符。  **默认取值**：  不涉及。
        ...
        :return: The node_id of this DeleteAutoSqlLimitingRequest.
        :rtype: str
        """
    ...
    def node_id(self, node_id):
        r"""Sets the node_id of this DeleteAutoSqlLimitingRequest.

        **参数解释**：  节点ID。  获取方法请参见[查询实例详情](https://support.huaweicloud.com/api-taurusdb/ShowGaussMySqlInstanceInfoUnifyStatus.html)。  **约束限制**：  节点角色必须为主节点。  **取值范围**：  只能由英文字母、数字组成，前面为UUID，后缀为no07，长度为36个字符。  **默认取值**：  不涉及。

        :param node_id: The node_id of this DeleteAutoSqlLimitingRequest.
        :type node_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteAutoSqlLimitingRequest):
            return False
