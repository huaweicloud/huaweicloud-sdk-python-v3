...
class TaskDetailInfo:
    ...
    def show_detail(self, show_detail):
        r"""Sets the show_detail of this TaskDetailInfo.

        **参数解释**：  是否支持通过[获取异步任务详情](https://support.huaweicloud.com/api-taurusdb/ShowTaskDetails.html)接口获取任务详情。  **取值范围**：  - true：是。 - false：否。

        :param show_detail: The show_detail of this TaskDetailInfo.
        :type show_detail: bool
        """
