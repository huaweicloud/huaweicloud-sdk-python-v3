...
class ShowAuditLogResponse(SdkResponse):
    ...
    def switch_status(self):
        ...
        :return: The switch_status of this ShowAuditLogResponse.
        :rtype: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowAuditLogResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowAuditLogResponse):
            return False
