...
class ListHtapDataStoreResponse(SdkResponse):
    ...
    @property
    def datastores(self):
        r"""Gets the datastores of this ListHtapDataStoreResponse.
    ...
    def datastores(self, datastores):
        r"""Sets the datastores of this ListHtapDataStoreResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListHtapDataStoreResponse.to_dict() is deprecated and no longer maintained, "
