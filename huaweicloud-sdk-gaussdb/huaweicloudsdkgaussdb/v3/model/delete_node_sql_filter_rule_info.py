...
class DeleteNodeSqlFilterRuleInfo:
    ...
    openapi_types = {
        'node_id': 'str',
        'rules': 'list[DeleteNodeSqlFilterRule]'
    }
    ...
    def rules(self):
        ...
        :return: The rules of this DeleteNodeSqlFilterRuleInfo.
        :rtype: list[:class:`huaweicloudsdkgaussdb.v3.DeleteNodeSqlFilterRule`]
        """
        return self._rules
    ...
    def rules(self, rules):
        ...
        :param rules: The rules of this DeleteNodeSqlFilterRuleInfo.
        :type rules: list[:class:`huaweicloudsdkgaussdb.v3.DeleteNodeSqlFilterRule`]
        """
        self._rules = rules
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteNodeSqlFilterRuleInfo):
            return False
