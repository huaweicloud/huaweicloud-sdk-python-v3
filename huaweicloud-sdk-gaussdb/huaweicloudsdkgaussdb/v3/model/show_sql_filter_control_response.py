...
class ShowSqlFilterControlResponse(SdkResponse):
    ...
    def __init__(self, switch_status=None):
        ...
        :param switch_status: sql限流开关状态。  取值：  - ON：已开启 - OFF：已关闭
    ...
    def switch_status(self):
        ...
        :return: The switch_status of this ShowSqlFilterControlResponse.
        :rtype: str
        """
    ...
    def switch_status(self, switch_status):
        ...
        :param switch_status: The switch_status of this ShowSqlFilterControlResponse.
        :type switch_status: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowSqlFilterControlResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowSqlFilterControlResponse):
            return False
