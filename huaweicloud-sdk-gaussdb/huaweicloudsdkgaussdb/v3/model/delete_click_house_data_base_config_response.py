...
class DeleteClickHouseDataBaseConfigResponse(SdkResponse):
    ...
    def __init__(self, job_id=None):
        r"""DeleteClickHouseDataBaseConfigResponse
    ...
    @property
    def job_id(self):
        r"""Gets the job_id of this DeleteClickHouseDataBaseConfigResponse.
    ...
    def job_id(self, job_id):
        r"""Sets the job_id of this DeleteClickHouseDataBaseConfigResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteClickHouseDataBaseConfigResponse.to_dict() is deprecated and no longer maintained, "
