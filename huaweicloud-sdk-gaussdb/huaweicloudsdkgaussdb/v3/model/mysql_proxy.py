...
class MysqlProxy:
    ...
    def transaction_split(self):
        """Gets the transaction_split of this MysqlProxy.

        Proxy事务拆分开关状态【ON/OFF】。

        :return: The transaction_split of this MysqlProxy.
        :rtype: str
        """
    ...
    def transaction_split(self, transaction_split):
        """Sets the transaction_split of this MysqlProxy.

        Proxy事务拆分开关状态【ON/OFF】。

        :param transaction_split: The transaction_split of this MysqlProxy.
        :type transaction_split: str
        """
