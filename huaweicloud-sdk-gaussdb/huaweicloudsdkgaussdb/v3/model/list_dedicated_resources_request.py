...
class ListDedicatedResourcesRequest:
    ...
    @property
    def x_language(self):
        """Gets the x_language of this ListDedicatedResourcesRequest.

        语言

        :return: The x_language of this ListDedicatedResourcesRequest.
        :rtype: str
        """
    ...
    def x_language(self, x_language):
        """Sets the x_language of this ListDedicatedResourcesRequest.

        语言

        :param x_language: The x_language of this ListDedicatedResourcesRequest.
        :type: str
        """
