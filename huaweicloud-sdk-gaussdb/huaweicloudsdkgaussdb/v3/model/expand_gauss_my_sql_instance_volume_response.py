...
class ExpandGaussMySqlInstanceVolumeResponse(SdkResponse):
    ...
    def size(self):
        ...
        :return: The size of this ExpandGaussMySqlInstanceVolumeResponse.
        :rtype: int
        """
        return self._size
    ...
    def order_id(self):
        ...
        :return: The order_id of this ExpandGaussMySqlInstanceVolumeResponse.
        :rtype: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ExpandGaussMySqlInstanceVolumeResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExpandGaussMySqlInstanceVolumeResponse):
            return False
