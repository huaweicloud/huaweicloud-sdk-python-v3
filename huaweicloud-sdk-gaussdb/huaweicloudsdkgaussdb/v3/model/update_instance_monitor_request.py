...
class UpdateInstanceMonitorRequest:
    ...
    openapi_types = {
        'x_language': 'str',
        'instance_id': 'str',
        'body': 'TaurusModifyInstanceMonitorRequestBody'
    }
    ...
    def __init__(self, x_language=None, instance_id=None, body=None):
        """UpdateInstanceMonitorRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: TaurusModifyInstanceMonitorRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateInstanceMonitorRequest):
            return False
