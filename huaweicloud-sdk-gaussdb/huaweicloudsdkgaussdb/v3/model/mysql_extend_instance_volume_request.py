...
class MysqlExtendInstanceVolumeRequest:
    ...
    def __init__(self, size=None, is_auto_pay=None):
        r"""MysqlExtendInstanceVolumeRequest

        The model defined in huaweicloud sdk

        :param size: 扩容后的容量。包周期实例初始最小磁盘规格为10G，实例所选容量大小必须为10的整数倍，且大于实际使用容量，最大为128000GB.  取值范围： 扩容时必须大于等于20G； 缩容时必须大于等于10G。
        :type size: int
    ...
    @property
    def size(self):
        r"""Gets the size of this MysqlExtendInstanceVolumeRequest.
    ...
    @size.setter
    def size(self, size):
        r"""Sets the size of this MysqlExtendInstanceVolumeRequest.
    ...
    def is_auto_pay(self):
        r"""Gets the is_auto_pay of this MysqlExtendInstanceVolumeRequest.
    ...
    def is_auto_pay(self, is_auto_pay):
        r"""Sets the is_auto_pay of this MysqlExtendInstanceVolumeRequest.
