...
class ShowGaussMySqlInstanceInfoUnifyStatusResponse(SdkResponse):
    ...
    openapi_types = {
        'instance': 'MysqlInstanceInfoDetailUnifyStatus'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowGaussMySqlInstanceInfoUnifyStatusResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowGaussMySqlInstanceInfoUnifyStatusResponse):
            return False
