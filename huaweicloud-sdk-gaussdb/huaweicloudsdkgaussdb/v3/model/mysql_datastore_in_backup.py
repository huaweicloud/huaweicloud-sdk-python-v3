...
class MysqlDatastoreInBackup:
    ...
    def __init__(self, type=None, version=None):
        ...
        :type type: str
        :param version: 数据库版本。  数据库支持的版本信息，获取方法请参见[查询数据库引擎的版本](https://support.huaweicloud.com/api-gaussdb/ShowGaussMySqlEngineVersion.html)返回的name字段。
        :type version: str
        """
    ...
    def type(self):
        ...
        :return: The type of this MysqlDatastoreInBackup.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        ...
        :param type: The type of this MysqlDatastoreInBackup.
        :type type: str
        """
        self._type = type
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MysqlDatastoreInBackup):
            return False
