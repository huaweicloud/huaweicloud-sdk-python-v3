...
class SetQuotasRequestBody:
    ...
    def __init__(self, quota_list=None):
        """SetQuotasRequestBody - a model defined in huaweicloud sdk"""
    ...
    def quota_list(self):
        ...
        :return: The quota_list of this SetQuotasRequestBody.
        :rtype: list[SetQuota]
        """
    ...
    def quota_list(self, quota_list):
        ...
        :param quota_list: The quota_list of this SetQuotasRequestBody.
        :type: list[SetQuota]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SetQuotasRequestBody):
            return False
