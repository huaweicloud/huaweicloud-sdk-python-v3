...
class RestartStarrocksInstanceResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("RestartStarrocksInstanceResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RestartStarrocksInstanceResponse):
            return False
