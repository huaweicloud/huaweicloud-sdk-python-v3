...
class MysqlDatastoreInRes:
    ...
    def __init__(self, type=None, version=None, kernel_version=None):
        ...
        :type version: str
        :param kernel_version: 内核数据库版本。  完整的四位内核数据库版本号，获取方法请参见[查询数据库引擎的版本](https://support.huaweicloud.com/api-gaussdb/ShowGaussMySqlEngineVersion.html)返回的kernel_version字段。
    ...
    def type(self):
        ...
        :return: The type of this MysqlDatastoreInRes.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        ...
        :param type: The type of this MysqlDatastoreInRes.
        :type type: str
        """
        self._type = type
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MysqlDatastoreInRes):
            return False
