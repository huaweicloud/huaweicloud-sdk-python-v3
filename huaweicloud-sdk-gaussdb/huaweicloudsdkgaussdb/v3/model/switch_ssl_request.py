...
class SwitchSSLRequest:
    ...
    def __init__(self, ssl_option=None):
        ...
        :param ssl_option: SSL数据加密开关设置。  - true: 开启SSL数据加密。 - false: 关闭SSL数据加密。
    ...
    @property
    def ssl_option(self):
        r"""Gets the ssl_option of this SwitchSSLRequest.

        SSL数据加密开关设置。  - true: 开启SSL数据加密。 - false: 关闭SSL数据加密。

        :return: The ssl_option of this SwitchSSLRequest.
        :rtype: bool
        """
    ...
    def ssl_option(self, ssl_option):
        r"""Sets the ssl_option of this SwitchSSLRequest.

        SSL数据加密开关设置。  - true: 开启SSL数据加密。 - false: 关闭SSL数据加密。

        :param ssl_option: The ssl_option of this SwitchSSLRequest.
        :type ssl_option: bool
        """
