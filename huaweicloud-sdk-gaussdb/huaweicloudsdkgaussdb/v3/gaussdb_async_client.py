...
class GaussDBAsyncClient(Client):
    ...
    def change_mysql_instance_specification_async(self, request):
        """变更实例规格
    ...
    def create_mysql_backup_async(self, request):
        """创建手动备份
    ...
    def create_mysql_instance_async(self, request):
        """创建数据库实例
    ...
    def create_mysql_proxy_async(self, request):
        """开启数据库代理
    ...
    def create_mysql_readonly_node_async(self, request):
        """创建只读节点
    ...
    def delete_mysql_instance_async(self, request):
        """删除实例
    ...
    def delete_mysql_proxy_async(self, request):
        """关闭数据库代理
    ...
    def delete_mysql_readonly_node_async(self, request):
        """删除只读节点
    ...
    def expand_mysql_instance_volume_async(self, request):
        """包周期存储扩容
    ...
    def expand_mysql_proxy_async(self, request):
        """扩容数据库代理节点的数量
    ...
    def list_mysql_configurations_async(self, request):
        """查询参数模板
    ...
    def list_mysql_error_log_async(self, request):
        """查询数据库错误日志
    ...
    def list_mysql_slow_log_async(self, request):
        """查询数据库慢日志
    ...
    def reset_mysql_password_async(self, request):
        """重置数据库密码
    ...
    def set_mysql_quotas_async(self, request):
        """设置租户基于企业项目的资源配额
    ...
    def show_mysql_backup_list_async(self, request):
        """查询备份列表
    ...
    def show_mysql_backup_policy_async(self, request):
        """查询自动备份策略
    ...
    def show_mysql_engine_version_async(self, request):
        """查询数据库引擎的版本
    ...
    def show_mysql_flavors_async(self, request):
        """查询数据库规格
    ...
    def show_mysql_instance_info_async(self, request):
        """查询实例详情信息
    ...
    def show_mysql_instance_list_async(self, request):
        """查询实例列表
    ...
    def show_mysql_job_info_async(self, request):
        """获取指定ID的任务信息
    ...
    def show_mysql_project_quotas_async(self, request):
        """查询租户的实例配额
    ...
    def show_mysql_proxy_async(self, request):
        """查询数据库代理信息
    ...
    def show_mysql_proxy_flavors_async(self, request):
        """查询数据库代理规格信息
    ...
    def show_mysql_quotas_async(self, request):
        """查询租户基于企业项目的资源配额
    ...
    def update_mysql_backup_policy_async(self, request):
        """修改备份策略
    ...
    def update_mysql_instance_name_async(self, request):
        """修改实例名称
    ...
    def update_mysql_quotas_async(self, request):
        """修改租户基于企业项目的资源配额
