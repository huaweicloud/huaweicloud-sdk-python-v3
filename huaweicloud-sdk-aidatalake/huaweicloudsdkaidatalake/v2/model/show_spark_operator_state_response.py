...
class ShowSparkOperatorStateResponse(SdkResponse):
    ...
    def __init__(self, status=None, operator_info=None, message=None, create_time=None, end_time=None):
        ...
        :type status: str
        :param operator_info: 
        :type operator_info: :class:`huaweicloudsdkaidatalake.v2.ShowSparkOperatorStateOperationInfo`
    ...
    def operator_info(self):
        ...
        :rtype: :class:`huaweicloudsdkaidatalake.v2.ShowSparkOperatorStateOperationInfo`
        """
