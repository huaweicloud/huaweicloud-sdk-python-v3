...
class ShowSparkJobResponse(SdkResponse):
    ...
    def __init__(self, job_id=None, client_token=None, name=None, endpoint_name=None, catalog_name=None, job_agency=None, state=None, state_message=None, job_config=None, resource_config=None, restore_strategy=None, spark_config=None, logging_config=None, image=None, retry_times=None, labels=None, create_time=None, start_time=None, end_time=None, create_user=None, log_url=None, description=None):
        ...
        :param job_config: 
        :type job_config: :class:`huaweicloudsdkaidatalake.v2.ShowSparkJobArtifactResponse`
        :param resource_config: 
        :type resource_config: :class:`huaweicloudsdkaidatalake.v2.ShowSparkResourceConfigResponse`
        :param restore_strategy: 
        :type restore_strategy: :class:`huaweicloudsdkaidatalake.v2.ShowSparkRestoreStrategyResponse`
        :param spark_config: **参数解释**：用户自定义Spark参数配置。 **取值范围**：长度为0~1024个字符。
        :type spark_config: dict(str, str)
        :param logging_config: 
        :type logging_config: :class:`huaweicloudsdkaidatalake.v2.ShowSparkLoggingConfigResponse`
        :param image: 
        :type image: :class:`huaweicloudsdkaidatalake.v2.ShowSparkJobImageConfigResponse`
        :param retry_times: **参数解释**：作业重试次数，用于记录作业失败后的重试次数。 **取值范围**：最小值为0。
        :type retry_times: int
        :param labels: **参数解释**：作业标签列表，用于标识和分类作业。
        :type labels: list[:class:`huaweicloudsdkaidatalake.v2.ShowSparkJobLabelResponse`]
    ...
    def job_config(self):
        ...
        :rtype: :class:`huaweicloudsdkaidatalake.v2.ShowSparkJobArtifactResponse`
        """
    ...
    def resource_config(self):
        ...
        :rtype: :class:`huaweicloudsdkaidatalake.v2.ShowSparkResourceConfigResponse`
        """
    ...
    def restore_strategy(self):
        ...
        :rtype: :class:`huaweicloudsdkaidatalake.v2.ShowSparkRestoreStrategyResponse`
        """
    ...
    def logging_config(self):
        ...
        :rtype: :class:`huaweicloudsdkaidatalake.v2.ShowSparkLoggingConfigResponse`
        """
    ...
    def image(self):
        ...
        :rtype: :class:`huaweicloudsdkaidatalake.v2.ShowSparkJobImageConfigResponse`
        """
        return self._image
    ...
    def labels(self):
        ...
        **参数解释**：作业标签列表，用于标识和分类作业。
        ...
        :rtype: list[:class:`huaweicloudsdkaidatalake.v2.ShowSparkJobLabelResponse`]
        """
        return self._labels
