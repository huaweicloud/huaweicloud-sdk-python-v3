...
class ShowSparkSqlResponse(SdkResponse):
    ...
    def __init__(self, endpoint_name=None, client_token=None, catalog_context=None, statement=None, parameters=None, statement_type=None, statement_id=None, state=None, error=None, spark_config=None, image=None, result=None, metric_statistics=None, timeout=None, log_url=None, create_time=None, start_time=None, end_time=None, create_user=None, labels=None):
        ...
        :type catalog_context: :class:`huaweicloudsdkaidatalake.v2.SparkSqlCatalogContextResponse`
        ...
        :type state: str
        :param error: 
        :type error: :class:`huaweicloudsdkaidatalake.v2.SparkSqlErrorDto`
        :param spark_config: **参数解释**：用户自定义Spark参数配置，用于配置作业执行时的Spark参数。
        :type spark_config: dict(str, str)
        :param image: 
        :type image: :class:`huaweicloudsdkaidatalake.v2.ShowSparkSqlImageConfigResponse`
        :param result: 
        :type result: :class:`huaweicloudsdkaidatalake.v2.SparkSqlResultResponse`
        :param metric_statistics: 
        :type metric_statistics: :class:`huaweicloudsdkaidatalake.v2.SparkSqlMetricStatisticsResponse`
        :param timeout: 
        ...
        :type end_time: int
        :param create_user: 
        :type create_user: :class:`huaweicloudsdkaidatalake.v2.SparkCreateUser`
        :param labels: **参数解释**：作业标签列表，用于标识和分类作业。数组中的每个元素为SparkSqlLabelRes对象，包含标签的键和值。
        :type labels: list[:class:`huaweicloudsdkaidatalake.v2.SparkSqlLabelRes`]
        """
    ...
    def catalog_context(self):
        ...
        :rtype: :class:`huaweicloudsdkaidatalake.v2.SparkSqlCatalogContextResponse`
        """
    ...
    def error(self):
        ...
        :rtype: :class:`huaweicloudsdkaidatalake.v2.SparkSqlErrorDto`
        """
        return self._error
    ...
    def image(self):
        ...
        :rtype: :class:`huaweicloudsdkaidatalake.v2.ShowSparkSqlImageConfigResponse`
        """
        return self._image
    ...
    def result(self):
        ...
        :rtype: :class:`huaweicloudsdkaidatalake.v2.SparkSqlResultResponse`
        """
        return self._result
    ...
    def metric_statistics(self):
        ...
        :rtype: :class:`huaweicloudsdkaidatalake.v2.SparkSqlMetricStatisticsResponse`
        """
    ...
    def create_user(self):
        ...
        :rtype: :class:`huaweicloudsdkaidatalake.v2.SparkCreateUser`
        """
    ...
    def labels(self):
        ...
        **参数解释**：作业标签列表，用于标识和分类作业。数组中的每个元素为SparkSqlLabelRes对象，包含标签的键和值。
        ...
        :rtype: list[:class:`huaweicloudsdkaidatalake.v2.SparkSqlLabelRes`]
        """
        return self._labels
