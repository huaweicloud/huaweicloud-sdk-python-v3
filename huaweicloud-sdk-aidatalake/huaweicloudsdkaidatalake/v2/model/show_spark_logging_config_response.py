...
class ShowSparkLoggingConfigResponse:
    ...
    def __init__(self, driver_root_logger_level=None, driver_loggers_level_of_class=None, executor_root_logger_level=None, executor_loggers_level_of_class=None):
        ...
        :type driver_loggers_level_of_class: list[:class:`huaweicloudsdkaidatalake.v2.ShowSparkClassLoggerLevelResponse`]
        ...
        :type executor_loggers_level_of_class: list[:class:`huaweicloudsdkaidatalake.v2.ShowSparkClassLoggerLevelResponse`]
        """
    ...
    def driver_loggers_level_of_class(self):
        ...
        **参数解释**：Driver类日志级别配置列表，用于为指定类设置特定的日志级别。 
        ...
        :rtype: list[:class:`huaweicloudsdkaidatalake.v2.ShowSparkClassLoggerLevelResponse`]
        """
