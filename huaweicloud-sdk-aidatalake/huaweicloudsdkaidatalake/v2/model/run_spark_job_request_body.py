...
class RunSparkJobRequestBody:
    ...
    def __init__(self, name=None, endpoint_name=None, job_config=None, catalog_name=None, job_agency=None, resource_config=None, spark_config=None, image=None, logging_config=None, restore_strategy=None, labels=None, description=None):
        ...
        :param job_config: 
        :type job_config: :class:`huaweicloudsdkaidatalake.v2.SparkJobArtifact`
        ...
        :type resource_config: :class:`huaweicloudsdkaidatalake.v2.SparkResourceConfig`
        :param spark_config: **参数解释**：用户自定义Spark参数配置，用于优化Spark作业性能。 **约束限制**：最多支持100个参数。
        :type spark_config: dict(str, str)
        :param image: 
        :type image: :class:`huaweicloudsdkaidatalake.v2.SparkJobImageConfig`
        :param logging_config: 
        :type logging_config: :class:`huaweicloudsdkaidatalake.v2.SparkLoggingConfig`
        :param restore_strategy: 
        :type restore_strategy: :class:`huaweicloudsdkaidatalake.v2.SparkRestoreStrategy`
        :param labels: **参数解释**：作业标签列表，用于标识和分类作业。 **约束限制**：标签数量不能超过16条。
        :type labels: list[:class:`huaweicloudsdkaidatalake.v2.SparkJobLabel`]
    ...
    def job_config(self):
        ...
        :rtype: :class:`huaweicloudsdkaidatalake.v2.SparkJobArtifact`
        """
    ...
    def resource_config(self):
        ...
        :rtype: :class:`huaweicloudsdkaidatalake.v2.SparkResourceConfig`
        """
    ...
    def image(self):
        ...
        :rtype: :class:`huaweicloudsdkaidatalake.v2.SparkJobImageConfig`
        """
        return self._image
    ...
    def logging_config(self):
        ...
        :rtype: :class:`huaweicloudsdkaidatalake.v2.SparkLoggingConfig`
        """
    ...
    def restore_strategy(self):
        ...
        :rtype: :class:`huaweicloudsdkaidatalake.v2.SparkRestoreStrategy`
        """
    ...
    def labels(self):
        ...
        **参数解释**：作业标签列表，用于标识和分类作业。 **约束限制**：标签数量不能超过16条。
        ...
        :rtype: list[:class:`huaweicloudsdkaidatalake.v2.SparkJobLabel`]
        """
        return self._labels
