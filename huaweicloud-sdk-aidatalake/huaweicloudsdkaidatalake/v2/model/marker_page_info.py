...
class MarkerPageInfo:
    ...
    def next_marker(self):
        r"""Gets the next_marker of this MarkerPageInfo.

        **参数解释**：下一页查询marker值，若为空表示当前已是最后一页。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。 

        :return: The next_marker of this MarkerPageInfo.
        :rtype: str
        """
    ...
    def next_marker(self, next_marker):
        r"""Sets the next_marker of this MarkerPageInfo.

        **参数解释**：下一页查询marker值，若为空表示当前已是最后一页。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。 

        :param next_marker: The next_marker of this MarkerPageInfo.
        :type next_marker: str
        """
    ...
    def previous_marker(self):
        r"""Gets the previous_marker of this MarkerPageInfo.

        **参数解释**：返回前一页查询地址，为空则表示是第一页。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。 

        :return: The previous_marker of this MarkerPageInfo.
        :rtype: str
        """
    ...
    def previous_marker(self, previous_marker):
        r"""Sets the previous_marker of this MarkerPageInfo.

        **参数解释**：返回前一页查询地址，为空则表示是第一页。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。 

        :param previous_marker: The previous_marker of this MarkerPageInfo.
        :type previous_marker: str
        """
    ...
    def current_count(self):
        r"""Gets the current_count of this MarkerPageInfo.

        **参数解释**：本次查询记录总数。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :return: The current_count of this MarkerPageInfo.
        :rtype: int
        """
    ...
    def current_count(self, current_count):
        r"""Sets the current_count of this MarkerPageInfo.

        **参数解释**：本次查询记录总数。 **约束限制**：不涉及。 **取值范围**：不涉及。 **默认取值**：不涉及。

        :param current_count: The current_count of this MarkerPageInfo.
        :type current_count: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MarkerPageInfo):
            return False
