...
class RestartSparkSqlClusterRequest:
    ...
    def __init__(self, workspace_id=None, endpoint_name=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkaidatalake.v2.RestartSparkSqlClusterRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkaidatalake.v2.RestartSparkSqlClusterRequestBody`
        """
        return self._body
