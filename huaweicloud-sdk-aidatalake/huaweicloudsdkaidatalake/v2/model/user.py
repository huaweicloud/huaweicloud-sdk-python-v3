...
class User:
    ...
    def __init__(self, domain_name=None, domain_id=None, user_name=None, user_id=None):
        ...
        :param domain_name: **参数解释**：账户名称。 **约束限制**：不涉及。 **取值范围**：长度为[0,64]个字符。 **默认取值**：不涉及。 
        :type domain_name: str
        :param domain_id: **参数解释**：账号ID。 **约束限制**：不涉及。 **取值范围**：长度为[1,36]的数字、英文字符和中划线(-)的组合。 **默认取值**：不涉及。 
        :type domain_id: str
        :param user_name: **参数解释**：用户名称。 **约束限制**：不涉及。 **取值范围**：长度为[0,64]个字符。 **默认取值**：不涉及。 
        :type user_name: str
        :param user_id: **参数解释**：用户ID。 **约束限制**：不涉及。 **取值范围**：长度为[1,36]的数字、英文字符和中划线(-)的组合。 **默认取值**：不涉及。 
        :type user_id: str
        """
