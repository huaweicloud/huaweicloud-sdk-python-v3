...
class AIDataLakeClient(Client):
    ...
    def new_builder(cls, clazz=None):
        if not clazz:
            ...
            if clazz.__name__ != "AIDataLakeClient":
                raise TypeError("client type error, support client type is AIDataLakeClient")
    ...
    def cancel_ray_job(self, request):
        r"""取消作业运行
    ...
    def cancel_ray_job_invoker(self, request):
        http_info = self._cancel_ray_job_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _cancel_ray_job_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def list_ray_jobs(self, request):
        r"""查询Ray作业列表
    ...
    def list_ray_jobs_invoker(self, request):
        http_info = self._list_ray_jobs_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_ray_jobs_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def run_ray_job_invoker(self, request):
        http_info = self._run_ray_job_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _run_ray_job_http_info(cls, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v2/workspaces/{workspace_id}/ray-jobs",
            "request_type": request.__class__.__name__,
    ...
    def show_ray_job_invoker(self, request):
        http_info = self._show_ray_job_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_ray_job_http_info(cls, request):
        http_info = {
            "method": "GET",
