...
class CheckObsBucketsRequest:
    ...
    openapi_types = {
        'domain_id': 'str',
        'body': 'CheckObsBucketsRequestBody'
    }
    ...
    def __init__(self, domain_id=None, body=None):
        ...
        :param domain_id: 账户id，参见《云审计服务API参考》“获取账号ID和项目ID”章节。
        :type domain_id: str
        :param body: Body of the CheckObsBucketsRequest
    ...
    def domain_id(self):
        ...
        :return: The domain_id of this CheckObsBucketsRequest.
        :rtype: str
        """
    ...
    def domain_id(self, domain_id):
        ...
        :param domain_id: The domain_id of this CheckObsBucketsRequest.
        :type domain_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CheckObsBucketsRequest):
            return False
