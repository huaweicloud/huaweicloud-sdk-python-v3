...
class CreateCertificateRequest:
    ...
    def __init__(self, project_id=None, enterprise_project_id=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkedgesec.v1.CreateCertificateRequestBody`
        """
    ...
    @property
    def project_id(self):
        """Gets the project_id of this CreateCertificateRequest.

        项目ID，对应华为云控制台用户名->我的凭证->项目列表->项目ID

        :return: The project_id of this CreateCertificateRequest.
        :rtype: str
        """
    ...
    def project_id(self, project_id):
        """Sets the project_id of this CreateCertificateRequest.

        项目ID，对应华为云控制台用户名->我的凭证->项目列表->项目ID

        :param project_id: The project_id of this CreateCertificateRequest.
        :type project_id: str
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkedgesec.v1.CreateCertificateRequestBody`
        """
        return self._body
