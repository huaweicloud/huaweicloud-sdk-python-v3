...
class WafPolicyAction:
    ...
    @property
    def category(self):
        """Gets the category of this WafPolicyAction.

        web基础防护动作（log为仅记录、block为拦截）

        :return: The category of this WafPolicyAction.
        :rtype: str
        """
    ...
    def category(self, category):
        """Sets the category of this WafPolicyAction.

        web基础防护动作（log为仅记录、block为拦截）

        :param category: The category of this WafPolicyAction.
        :type category: str
        """
    ...
    def followed_action_id(self):
        """Gets the followed_action_id of this WafPolicyAction.

        攻击惩罚规则ID

        :return: The followed_action_id of this WafPolicyAction.
        :rtype: str
        """
    ...
    def followed_action_id(self, followed_action_id):
        """Sets the followed_action_id of this WafPolicyAction.

        攻击惩罚规则ID

        :param followed_action_id: The followed_action_id of this WafPolicyAction.
        :type followed_action_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WafPolicyAction):
            return False
