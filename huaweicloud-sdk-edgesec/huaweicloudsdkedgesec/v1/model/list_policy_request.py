...
class ListPolicyRequest:
    ...
    def __init__(self, project_id=None, enterprise_project_id=None, page=None, pagesize=None, name=None):
        """ListPolicyRequest
    ...
    @property
    def project_id(self):
        """Gets the project_id of this ListPolicyRequest.

        项目ID，对应华为云控制台用户名->我的凭证->项目列表->项目ID

        :return: The project_id of this ListPolicyRequest.
        :rtype: str
        """
    ...
    def project_id(self, project_id):
        """Sets the project_id of this ListPolicyRequest.

        项目ID，对应华为云控制台用户名->我的凭证->项目列表->项目ID

        :param project_id: The project_id of this ListPolicyRequest.
        :type project_id: str
        """
