...
class CreatePolicyResponse(SdkResponse):
    ...
    def __init__(self, id=None, name=None, level=None, full_detection=None, robot_action=None, action=None, options=None, modulex_options=None, hosts=None, bind_host=None, extend=None, timestamp=None):
        ...
        :param robot_action: 
        :type robot_action: :class:`huaweicloudsdkedgesec.v1.Action`
        :param action: 
        :type action: :class:`huaweicloudsdkedgesec.v1.PolicyAction`
        :param options: 
        :type options: :class:`huaweicloudsdkedgesec.v1.PolicyOption`
    ...
    def full_detection(self, full_detection):
        """Sets the full_detection of this CreatePolicyResponse.
    ...
    def robot_action(self):
        """Gets the robot_action of this CreatePolicyResponse.

        :return: The robot_action of this CreatePolicyResponse.
        :rtype: :class:`huaweicloudsdkedgesec.v1.Action`
        """
        return self._robot_action

    @robot_action.setter
    def robot_action(self, robot_action):
        """Sets the robot_action of this CreatePolicyResponse.
    ...
    def action(self):
        ...
        :rtype: :class:`huaweicloudsdkedgesec.v1.PolicyAction`
        """
        return self._action

    @action.setter
    def action(self, action):
        """Sets the action of this CreatePolicyResponse.
    ...
    @property
    def options(self):
        """Gets the options of this CreatePolicyResponse.

        :return: The options of this CreatePolicyResponse.
        :rtype: :class:`huaweicloudsdkedgesec.v1.PolicyOption`
        """
        return self._options

    @options.setter
    def options(self, options):
        """Sets the options of this CreatePolicyResponse.
    ...
    def modulex_options(self):
        """Gets the modulex_options of this CreatePolicyResponse.
    ...
    def modulex_options(self, modulex_options):
        """Sets the modulex_options of this CreatePolicyResponse.
    ...
    @property
    def extend(self):
        """Gets the extend of this CreatePolicyResponse.
    ...
    def extend(self, extend):
        """Sets the extend of this CreatePolicyResponse.
    ...
    @property
    def timestamp(self):
        """Gets the timestamp of this CreatePolicyResponse.
    ...
    def timestamp(self, timestamp):
        """Sets the timestamp of this CreatePolicyResponse.
