...
class ShowCertificateRequest:
    ...
    @property
    def project_id(self):
        """Gets the project_id of this ShowCertificateRequest.

        项目ID，对应华为云控制台用户名->我的凭证->项目列表->项目ID

        :return: The project_id of this ShowCertificateRequest.
        :rtype: str
        """
    ...
    def project_id(self, project_id):
        """Sets the project_id of this ShowCertificateRequest.

        项目ID，对应华为云控制台用户名->我的凭证->项目列表->项目ID

        :param project_id: The project_id of this ShowCertificateRequest.
        :type project_id: str
        """
