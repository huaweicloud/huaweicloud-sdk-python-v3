...
class CreateHttpPolicyRequest:
    ...
    openapi_types = {
        'body': 'CreateHttpPolicyRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateHttpPolicyRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateHttpPolicyRequest):
            return False
