...
class UpdateHttpGeoIpRuleRequestBody:
    ...
    @property
    def name(self):
        """Gets the name of this UpdateHttpGeoIpRuleRequestBody.
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this UpdateHttpGeoIpRuleRequestBody.
    ...
    def description(self):
        """Gets the description of this UpdateHttpGeoIpRuleRequestBody.
    ...
    def description(self, description):
        """Sets the description of this UpdateHttpGeoIpRuleRequestBody.
    ...
    @property
    def status(self):
        """Gets the status of this UpdateHttpGeoIpRuleRequestBody.
    ...
    def status(self, status):
        """Sets the status of this UpdateHttpGeoIpRuleRequestBody.
    ...
    @property
    def geo_ip(self):
        """Gets the geo_ip of this UpdateHttpGeoIpRuleRequestBody.
    ...
    def geo_ip(self, geo_ip):
        """Sets the geo_ip of this UpdateHttpGeoIpRuleRequestBody.
    ...
    @property
    def white(self):
        """Gets the white of this UpdateHttpGeoIpRuleRequestBody.
    ...
    def white(self, white):
        """Sets the white of this UpdateHttpGeoIpRuleRequestBody.
