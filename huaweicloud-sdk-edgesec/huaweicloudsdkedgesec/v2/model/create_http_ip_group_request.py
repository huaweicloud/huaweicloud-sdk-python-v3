...
class CreateHttpIpGroupRequest:
    ...
    openapi_types = {
        'body': 'CreateHttpIpGroupRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateHttpIpGroupRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateHttpIpGroupRequest):
            return False
