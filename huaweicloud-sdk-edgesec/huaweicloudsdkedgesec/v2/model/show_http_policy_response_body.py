...
class ShowHttpPolicyResponseBody:
    ...
    def id(self):
        ...
        :return: The id of this ShowHttpPolicyResponseBody.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this ShowHttpPolicyResponseBody.
        :type id: str
        """
        self._id = id
    ...
    def name(self):
        ...
        :return: The name of this ShowHttpPolicyResponseBody.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this ShowHttpPolicyResponseBody.
        :type name: str
        """
        self._name = name
    ...
    def level(self):
        ...
        :return: The level of this ShowHttpPolicyResponseBody.
        :rtype: int
        """
        return self._level
    ...
    def level(self, level):
        ...
        :param level: The level of this ShowHttpPolicyResponseBody.
        :type level: int
        """
        self._level = level
    ...
    def full_detection(self):
        ...
        :return: The full_detection of this ShowHttpPolicyResponseBody.
        :rtype: bool
        """
    ...
    def full_detection(self, full_detection):
        ...
        :param full_detection: The full_detection of this ShowHttpPolicyResponseBody.
        :type full_detection: bool
        """
    ...
    def bind_host(self):
        ...
        :return: The bind_host of this ShowHttpPolicyResponseBody.
    ...
    def bind_host(self, bind_host):
        ...
        :param bind_host: The bind_host of this ShowHttpPolicyResponseBody.
        :type bind_host: list[:class:`huaweicloudsdkedgesec.v2.HttpPolicyBindHost`]
        """
    ...
    def extend(self):
        ...
        :return: The extend of this ShowHttpPolicyResponseBody.
        :rtype: dict(str, str)
        """
        return self._extend
    ...
    def extend(self, extend):
        ...
        :param extend: The extend of this ShowHttpPolicyResponseBody.
        :type extend: dict(str, str)
        """
        self._extend = extend
    ...
    def third_bot_options(self):
        ...
        :return: The third_bot_options of this ShowHttpPolicyResponseBody.
    ...
    def third_bot_options(self, third_bot_options):
        ...
        :param third_bot_options: The third_bot_options of this ShowHttpPolicyResponseBody.
        :type third_bot_options: dict(str, object)
        """
    ...
    def wap_managed_ruleset_id(self):
        ...
        :return: The wap_managed_ruleset_id of this ShowHttpPolicyResponseBody.
        :rtype: str
        """
    ...
    def wap_managed_ruleset_id(self, wap_managed_ruleset_id):
        ...
        :param wap_managed_ruleset_id: The wap_managed_ruleset_id of this ShowHttpPolicyResponseBody.
        :type wap_managed_ruleset_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowHttpPolicyResponseBody):
            return False
