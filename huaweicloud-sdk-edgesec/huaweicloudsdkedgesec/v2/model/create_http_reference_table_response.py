...
class CreateHttpReferenceTableResponse(SdkResponse):
    ...
    def __init__(self, id=None, name=None, type=None, description=None, timestamp=None, values=None, producer=None):
        """CreateHttpReferenceTableResponse
    ...
    @property
    def id(self):
        """Gets the id of this CreateHttpReferenceTableResponse.
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CreateHttpReferenceTableResponse.
    ...
    @property
    def name(self):
        """Gets the name of this CreateHttpReferenceTableResponse.
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CreateHttpReferenceTableResponse.
    ...
    @property
    def type(self):
        """Gets the type of this CreateHttpReferenceTableResponse.
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this CreateHttpReferenceTableResponse.
    ...
    def description(self):
        """Gets the description of this CreateHttpReferenceTableResponse.
    ...
    def description(self, description):
        """Sets the description of this CreateHttpReferenceTableResponse.
    ...
    @property
    def timestamp(self):
        """Gets the timestamp of this CreateHttpReferenceTableResponse.
    ...
    def timestamp(self, timestamp):
        """Sets the timestamp of this CreateHttpReferenceTableResponse.
    ...
    @property
    def values(self):
        """Gets the values of this CreateHttpReferenceTableResponse.
    ...
    def values(self, values):
        """Sets the values of this CreateHttpReferenceTableResponse.
    ...
    @property
    def producer(self):
        """Gets the producer of this CreateHttpReferenceTableResponse.
    ...
    def producer(self, producer):
        """Sets the producer of this CreateHttpReferenceTableResponse.
