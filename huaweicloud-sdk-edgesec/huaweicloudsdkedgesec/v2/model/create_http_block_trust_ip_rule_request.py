...
class CreateHttpBlockTrustIpRuleRequest:
    ...
    openapi_types = {
        'policy_id': 'str',
        'body': 'CreateHttpBlockTrustIpRuleRequestBody'
    }
    ...
    def __init__(self, policy_id=None, body=None):
        ...
        :type policy_id: str
        :param body: Body of the CreateHttpBlockTrustIpRuleRequest
    ...
    def policy_id(self):
        ...
        :return: The policy_id of this CreateHttpBlockTrustIpRuleRequest.
        :rtype: str
        """
    ...
    def policy_id(self, policy_id):
        ...
        :param policy_id: The policy_id of this CreateHttpBlockTrustIpRuleRequest.
        :type policy_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateHttpBlockTrustIpRuleRequest):
            return False
