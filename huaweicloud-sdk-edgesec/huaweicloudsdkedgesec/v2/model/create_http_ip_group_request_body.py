...
class CreateHttpIpGroupRequestBody:
    ...
    @property
    def name(self):
        """Gets the name of this CreateHttpIpGroupRequestBody.
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CreateHttpIpGroupRequestBody.
    ...
    @property
    def ips(self):
        """Gets the ips of this CreateHttpIpGroupRequestBody.
    ...
    @ips.setter
    def ips(self, ips):
        """Sets the ips of this CreateHttpIpGroupRequestBody.
    ...
    def description(self):
        """Gets the description of this CreateHttpIpGroupRequestBody.
    ...
    def description(self, description):
        """Sets the description of this CreateHttpIpGroupRequestBody.
