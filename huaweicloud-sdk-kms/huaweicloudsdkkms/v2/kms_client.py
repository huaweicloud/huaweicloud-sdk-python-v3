...
class KmsClient(Client):
    ...
    def associate_alias_invoker(self, request):
        http_info = self._associate_alias_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _associate_alias_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def create_ec_datakey_pair_invoker(self, request):
        http_info = self._create_ec_datakey_pair_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_ec_datakey_pair_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def create_pin_invoker(self, request):
        http_info = self._create_pin_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_pin_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def create_rsa_datakey_pair_invoker(self, request):
        http_info = self._create_rsa_datakey_pair_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_rsa_datakey_pair_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def delete_alias_invoker(self, request):
        http_info = self._delete_alias_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_alias_http_info(cls, request):
        http_info = {
            "method": "DELETE",
            "resource_path": "/v1.0/{project_id}/kms/aliases",
            "request_type": request.__class__.__name__,
    ...
    def derive_shared_secret(self, request):
        r"""派生共享密钥
    ...
    def derive_shared_secret_invoker(self, request):
        http_info = self._derive_shared_secret_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _derive_shared_secret_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def generate_mac_invoker(self, request):
        http_info = self._generate_mac_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _generate_mac_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def list_aliases_invoker(self, request):
        http_info = self._list_aliases_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_aliases_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1.0/{project_id}/kms/aliases",
            "request_type": request.__class__.__name__,
    ...
    def re_encrypt_invoker(self, request):
        http_info = self._re_encrypt_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _re_encrypt_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def verify_mac_invoker(self, request):
        http_info = self._verify_mac_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _verify_mac_http_info(cls, request):
        http_info = {
            "method": "POST",
