...
class KmsAsyncClient(Client):
    ...
    def create_access_point_async(self, request):
        r"""创建接入点
    ...
    def create_access_point_async_invoker(self, request):
        http_info = self._create_access_point_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_access_point_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def create_datakey_capsule_async(self, request):
        r"""创建密钥胶囊
    ...
    def create_datakey_capsule_async_invoker(self, request):
        http_info = self._create_datakey_capsule_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_datakey_capsule_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def create_key_policy_async(self, request):
        r"""创建密钥策略
    ...
    def create_key_policy_async_invoker(self, request):
        http_info = self._create_key_policy_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_key_policy_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def decrypt_datakey_capsule_async(self, request):
        r"""解密密钥胶囊
    ...
    def decrypt_datakey_capsule_async_invoker(self, request):
        http_info = self._decrypt_datakey_capsule_http_info(request)
        return AsyncInvoker(self, http_info)

    def _decrypt_datakey_capsule_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def delete_access_point_async(self, request):
        r"""删除接入点
    ...
    def delete_access_point_async_invoker(self, request):
        http_info = self._delete_access_point_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_access_point_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def delete_key_policy_async(self, request):
        r"""删除密钥策略
    ...
    def delete_key_policy_async_invoker(self, request):
        http_info = self._delete_key_policy_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_key_policy_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def disable_access_point_async(self, request):
        r"""禁用接入点
    ...
    def disable_access_point_async_invoker(self, request):
        http_info = self._disable_access_point_http_info(request)
        return AsyncInvoker(self, http_info)

    def _disable_access_point_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def download_access_point_private_key_async(self, request):
        r"""下载通用接入点私钥
    ...
    def download_access_point_private_key_async_invoker(self, request):
        http_info = self._download_access_point_private_key_http_info(request)
        return AsyncInvoker(self, http_info)

    def _download_access_point_private_key_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def enable_access_point_async(self, request):
        r"""启用接入点
    ...
    def enable_access_point_async_invoker(self, request):
        http_info = self._enable_access_point_http_info(request)
        return AsyncInvoker(self, http_info)

    def _enable_access_point_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def list_access_point_async(self, request):
        r"""查询接入点列表
    ...
    def list_access_point_async_invoker(self, request):
        http_info = self._list_access_point_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_access_point_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1.0/{project_id}/kms/access-points",
            "request_type": request.__class__.__name__,
    ...
    def list_key_policy_async(self, request):
        r"""查询密钥策略列表
    ...
    def list_key_policy_async_invoker(self, request):
        http_info = self._list_key_policy_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_key_policy_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1.0/{project_id}/kms/key-policies",
            "request_type": request.__class__.__name__,
    ...
    def rotate_on_demand_async(self, request):
        r"""按需轮转密钥
    ...
    def rotate_on_demand_async_invoker(self, request):
        http_info = self._rotate_on_demand_http_info(request)
        return AsyncInvoker(self, http_info)

    def _rotate_on_demand_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def show_key_policy_async(self, request):
        r"""查询密钥策略
    ...
    def show_key_policy_async_invoker(self, request):
        http_info = self._show_key_policy_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_key_policy_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1.0/{project_id}/kms/key-policies/{policy_id}",
            "request_type": request.__class__.__name__,
    ...
    def update_key_policy_async(self, request):
        r"""更新密钥策略
    ...
    def update_key_policy_async_invoker(self, request):
        http_info = self._update_key_policy_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_key_policy_http_info(self, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v1.0/{project_id}/kms/key-policies/{policy_id}",
            "request_type": request.__class__.__name__,
