...
class DeleteAccessPointRequest:
    ...
    def access_point_id(self):
        r"""Gets the access_point_id of this DeleteAccessPointRequest.

        **参数解释：** 接入点ID。 **约束限制：** 不涉及 **取值范围：** UUID格式，字符长度36-36。 **默认取值：** 不涉及

        :return: The access_point_id of this DeleteAccessPointRequest.
        :rtype: str
        """
    ...
    def access_point_id(self, access_point_id):
        r"""Sets the access_point_id of this DeleteAccessPointRequest.

        **参数解释：** 接入点ID。 **约束限制：** 不涉及 **取值范围：** UUID格式，字符长度36-36。 **默认取值：** 不涉及

        :param access_point_id: The access_point_id of this DeleteAccessPointRequest.
        :type access_point_id: str
        """
