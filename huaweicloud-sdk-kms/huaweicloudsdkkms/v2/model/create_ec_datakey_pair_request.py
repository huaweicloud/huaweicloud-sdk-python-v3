...
class CreateEcDatakeyPairRequest:
    ...
    openapi_types = {
        'body': 'CreateEcDatakeyPairRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateEcDatakeyPairRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateEcDatakeyPairRequest):
            return False
