...
class DisableKeyResponse(SdkResponse):
    ...
    @property
    def key_info(self):
        r"""Gets the key_info of this DisableKeyResponse.
    ...
    def key_info(self, key_info):
        r"""Sets the key_info of this DisableKeyResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DisableKeyResponse.to_dict() is deprecated and no longer maintained, "
