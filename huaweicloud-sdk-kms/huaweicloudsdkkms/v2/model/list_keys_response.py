...
class ListKeysResponse(SdkResponse):
    ...
    def __init__(self, keys=None, key_details=None, next_marker=None, truncated=None, total=None):
        ...
        :type key_details: list[:class:`huaweicloudsdkkms.v2.KeyDetails`]
    ...
    def key_details(self):
        ...
        :rtype: list[:class:`huaweicloudsdkkms.v2.KeyDetails`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListKeysResponse.to_dict() is deprecated and no longer maintained, "
