...
class CreateRsaDatakeyPairResponse(SdkResponse):
    ...
    def key_id(self):
        ...
        :return: The key_id of this CreateRsaDatakeyPairResponse.
        :rtype: str
        """
        return self._key_id
    ...
    def key_id(self, key_id):
        ...
        :param key_id: The key_id of this CreateRsaDatakeyPairResponse.
        :type key_id: str
        """
        self._key_id = key_id
    ...
    def key_spec(self):
        ...
        :return: The key_spec of this CreateRsaDatakeyPairResponse.
        :rtype: str
        """
    ...
    def key_spec(self, key_spec):
        ...
        :param key_spec: The key_spec of this CreateRsaDatakeyPairResponse.
        :type key_spec: str
        """
    ...
    def public_key(self):
        ...
        :return: The public_key of this CreateRsaDatakeyPairResponse.
        :rtype: str
        """
    ...
    def public_key(self, public_key):
        ...
        :param public_key: The public_key of this CreateRsaDatakeyPairResponse.
        :type public_key: str
        """
    ...
    def private_key_cipher_text(self):
        ...
        :return: The private_key_cipher_text of this CreateRsaDatakeyPairResponse.
        :rtype: str
        """
    ...
    def private_key_cipher_text(self, private_key_cipher_text):
        ...
        :param private_key_cipher_text: The private_key_cipher_text of this CreateRsaDatakeyPairResponse.
        :type private_key_cipher_text: str
        """
    ...
    def private_key_plain_text(self):
        ...
        :return: The private_key_plain_text of this CreateRsaDatakeyPairResponse.
        :rtype: str
        """
    ...
    def private_key_plain_text(self, private_key_plain_text):
        ...
        :param private_key_plain_text: The private_key_plain_text of this CreateRsaDatakeyPairResponse.
        :type private_key_plain_text: str
        """
    ...
    def wrapped_private_key(self):
        ...
        :return: The wrapped_private_key of this CreateRsaDatakeyPairResponse.
        :rtype: str
        """
    ...
    def wrapped_private_key(self, wrapped_private_key):
        ...
        :param wrapped_private_key: The wrapped_private_key of this CreateRsaDatakeyPairResponse.
        :type wrapped_private_key: str
        """
    ...
    def ciphertext_recipient(self):
        ...
        :return: The ciphertext_recipient of this CreateRsaDatakeyPairResponse.
        :rtype: str
        """
    ...
    def ciphertext_recipient(self, ciphertext_recipient):
        ...
        :param ciphertext_recipient: The ciphertext_recipient of this CreateRsaDatakeyPairResponse.
        :type ciphertext_recipient: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateRsaDatakeyPairResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateRsaDatakeyPairResponse):
            return False
