...
class IdentityCenterOIDCAsyncClient(Client):
    def __init__(self):
        super(IdentityCenterOIDCAsyncClient, self).__init__()
    ...
    def new_builder(cls, clazz=None):
        if not clazz:
            ...
            if clazz.__name__ != "IdentityCenterOIDCAsyncClient":
                raise TypeError("client type error, support client type is IdentityCenterOIDCAsyncClient")
    ...
    def register_client_async_invoker(self, request):
        http_info = self._register_client_http_info(request)
        return AsyncInvoker(self, http_info)

    def _register_client_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def start_device_authorization_async_invoker(self, request):
        http_info = self._start_device_authorization_http_info(request)
        return AsyncInvoker(self, http_info)

    def _start_device_authorization_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def create_token_async_invoker(self, request):
        http_info = self._create_token_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_token_http_info(self, request):
        http_info = {
            "method": "POST",
