...
class CreateCollectionBody:
    ...
    def __init__(self, store_name=None, collection_name=None, primary_field=None, fields=None, description=None, index_params=None, params=None):
        ...
        :param primary_field: 
        :type primary_field: :class:`huaweicloudsdklms.v1.PrimaryField`
        :param fields: 集合中通用字段，创建列的schema
        :type fields: list[:class:`huaweicloudsdklms.v1.Field`]
        :param description: 指定 Collection 的描述信息
        :type description: str
        :param index_params: 索引的配置信息
        :type index_params: list[:class:`huaweicloudsdklms.v1.IndexParams`]
    ...
    def primary_field(self):
        ...
        :rtype: :class:`huaweicloudsdklms.v1.PrimaryField`
        """
    ...
    def fields(self):
        ...
        :rtype: list[:class:`huaweicloudsdklms.v1.Field`]
        """
        return self._fields
