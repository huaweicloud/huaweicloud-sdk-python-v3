...
class GetProgressResponse(SdkResponse):
    ...
    def __init__(self, code=None, message=None, data=None):
        ...
        :type message: str
        :param data: 
        :type data: :class:`huaweicloudsdklms.v1.GetIndexProgressResponseData`
        """
    ...
    def data(self):
        ...
        :rtype: :class:`huaweicloudsdklms.v1.GetIndexProgressResponseData`
        """
        return self._data
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetProgressResponse):
            return False
