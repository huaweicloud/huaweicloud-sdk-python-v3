...
class DescribeCollectionResponse(SdkResponse):
    ...
    def __init__(self, code=None, message=None, data=None):
        ...
        :type message: str
        :param data: 
        :type data: :class:`huaweicloudsdklms.v1.DecribeCollectionData`
        """
        
        super(DescribeCollectionResponse, self).__init__()
    ...
    def data(self):
        ...
        :rtype: :class:`huaweicloudsdklms.v1.DecribeCollectionData`
        """
        return self._data
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DescribeCollectionResponse):
            return False
