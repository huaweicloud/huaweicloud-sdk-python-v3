...
class DecribeCollectionData:
    ...
    def __init__(self, store_name=None, collection_name=None, fields=None, load_status=None, description=None, params=None, indexes=None, entity_num=None):
        ...
        :type fields: list[:class:`huaweicloudsdklms.v1.FieldData`]
        ...
        :type indexes: list[:class:`huaweicloudsdklms.v1.IndexParams`]
    ...
    def fields(self):
        ...
        :rtype: list[:class:`huaweicloudsdklms.v1.FieldData`]
        """
        return self._fields
    ...
    def indexes(self):
        ...
        :rtype: list[:class:`huaweicloudsdklms.v1.IndexParams`]
        """
