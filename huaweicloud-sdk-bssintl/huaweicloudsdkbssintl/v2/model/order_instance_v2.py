...
class OrderInstanceV2:
    ...
    def __init__(self, effective_time=None, expire_policy=None, expire_time=None, id=None, is_main_resource=None, parent_resource_id=None, product_id=None, project_id=None, region_code=None, resource_id=None, resource_name=None, resource_spec_code=None, resource_type_code=None, service_type_code=None, status=None):
