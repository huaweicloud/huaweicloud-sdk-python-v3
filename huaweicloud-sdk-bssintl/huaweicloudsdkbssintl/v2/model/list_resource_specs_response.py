...
class ListResourceSpecsResponse(SdkResponse):
    ...
    def __init__(self, page_info=None, cloud_service_basics=None):
        ...
        :param page_info: 
        :type page_info: :class:`huaweicloudsdkbssintl.v2.PageInfo`
        :param cloud_service_basics: |参数名称：资源规格信息列表| |参数的约束及描述：资源规格信息列表|
        :type cloud_service_basics: list[:class:`huaweicloudsdkbssintl.v2.CloudServiceBasic`]
        """
    ...
    def page_info(self):
        ...
        :rtype: :class:`huaweicloudsdkbssintl.v2.PageInfo`
        """
    ...
    def cloud_service_basics(self):
        ...
        :rtype: list[:class:`huaweicloudsdkbssintl.v2.CloudServiceBasic`]
        """
