...
class ListFreeResourceUsagesResponse(SdkResponse):
    ...
    def __init__(self, free_resources=None):
        ...
        :type free_resources: list[:class:`huaweicloudsdkbssintl.v2.FreeResourceDetail`]
        """
    ...
    def free_resources(self):
        ...
        :rtype: list[:class:`huaweicloudsdkbssintl.v2.FreeResourceDetail`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListFreeResourceUsagesResponse.to_dict() is deprecated and no longer maintained, "
