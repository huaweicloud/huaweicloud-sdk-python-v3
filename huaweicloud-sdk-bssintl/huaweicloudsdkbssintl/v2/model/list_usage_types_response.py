...
class ListUsageTypesResponse(SdkResponse):
    ...
    def __init__(self, total_count=None, usage_types=None):
        ...
        :type usage_types: list[:class:`huaweicloudsdkbssintl.v2.UsageType`]
        """
    ...
    def total_count(self):
        r"""Gets the total_count of this ListUsageTypesResponse.
    ...
    def total_count(self, total_count):
        r"""Sets the total_count of this ListUsageTypesResponse.
    ...
    def usage_types(self):
        r"""Gets the usage_types of this ListUsageTypesResponse.

        使用量类型列表，具体请参见表3。

        :return: The usage_types of this ListUsageTypesResponse.
        :rtype: list[:class:`huaweicloudsdkbssintl.v2.UsageType`]
        """
        return self._usage_types

    @usage_types.setter
    def usage_types(self, usage_types):
        r"""Sets the usage_types of this ListUsageTypesResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListUsageTypesResponse.to_dict() is deprecated and no longer maintained, "
