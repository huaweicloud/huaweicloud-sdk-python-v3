...
class ListIndirectPartnersRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ListIndirectPartnersRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListIndirectPartnersRequest):
            return False
