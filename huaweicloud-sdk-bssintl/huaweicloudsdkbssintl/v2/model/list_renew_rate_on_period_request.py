...
class ListRenewRateOnPeriodRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ListRenewRateOnPeriodRequest
        :type body: :class:`huaweicloudsdkbssintl.v2.ListRenewRateOnPeriodReq`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkbssintl.v2.ListRenewRateOnPeriodReq`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRenewRateOnPeriodRequest):
            return False
