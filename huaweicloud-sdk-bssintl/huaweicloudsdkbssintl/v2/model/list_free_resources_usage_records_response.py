...
class ListFreeResourcesUsageRecordsResponse(SdkResponse):
    ...
    def __init__(self, free_resource_records=None, total_count=None):
        ...
        :type free_resource_records: list[:class:`huaweicloudsdkbssintl.v2.FreeResourceRecord`]
    ...
    def free_resource_records(self):
        ...
        :rtype: list[:class:`huaweicloudsdkbssintl.v2.FreeResourceRecord`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListFreeResourcesUsageRecordsResponse.to_dict() is deprecated and no longer maintained, "
