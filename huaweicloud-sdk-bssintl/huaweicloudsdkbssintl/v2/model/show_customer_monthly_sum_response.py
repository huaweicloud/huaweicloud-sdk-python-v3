...
class ShowCustomerMonthlySumResponse(SdkResponse):
    ...
    def __init__(self, total_count=None, bill_sums=None, consume_amount=None, debt_amount=None, coupon_amount=None, flexipurchase_coupon_amount=None, stored_value_card_amount=None, cash_amount=None, credit_amount=None, writeoff_amount=None, measure_id=None, currency=None):
        ...
        :param bill_sums: 账单记录，具体参考BillSumRecordInfoV2。
        :type bill_sums: list[:class:`huaweicloudsdkbssintl.v2.BillSumRecordInfoV2`]
        ...
        :type stored_value_card_amount: :class:`huaweicloudsdkbssintl.v2.decimal.Decimal`
        ...
        :type writeoff_amount: :class:`huaweicloudsdkbssintl.v2.decimal.Decimal`
    ...
    def bill_sums(self):
        ...
        :rtype: list[:class:`huaweicloudsdkbssintl.v2.BillSumRecordInfoV2`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowCustomerMonthlySumResponse.to_dict() is deprecated and no longer maintained, "
