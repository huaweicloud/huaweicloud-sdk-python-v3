...
class ListPayPerUseCustomerResourcesResponse(SdkResponse):
    ...
    def __init__(self, data=None, total_count=None):
        ...
        :type data: list[:class:`huaweicloudsdkbssintl.v2.OrderInstanceV2`]
    ...
    def data(self):
        ...
        :rtype: list[:class:`huaweicloudsdkbssintl.v2.OrderInstanceV2`]
        """
        return self._data
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListPayPerUseCustomerResourcesResponse.to_dict() is deprecated and no longer maintained, "
