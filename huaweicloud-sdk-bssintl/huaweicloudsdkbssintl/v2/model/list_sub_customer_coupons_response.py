...
class ListSubCustomerCouponsResponse(SdkResponse):
    ...
    def __init__(self, count=None, user_coupons=None):
        r"""ListSubCustomerCouponsResponse
        ...
        :type user_coupons: list[:class:`huaweicloudsdkbssintl.v2.IQueryUserCouponsResultV2`]
        """
    ...
    @property
    def count(self):
        r"""Gets the count of this ListSubCustomerCouponsResponse.
    ...
    def count(self, count):
        r"""Sets the count of this ListSubCustomerCouponsResponse.
    ...
    def user_coupons(self):
        r"""Gets the user_coupons of this ListSubCustomerCouponsResponse.

        优惠券记录。 具体请参见表2。

        :return: The user_coupons of this ListSubCustomerCouponsResponse.
        :rtype: list[:class:`huaweicloudsdkbssintl.v2.IQueryUserCouponsResultV2`]
        """
        return self._user_coupons

    @user_coupons.setter
    def user_coupons(self, user_coupons):
        r"""Sets the user_coupons of this ListSubCustomerCouponsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListSubCustomerCouponsResponse.to_dict() is deprecated and no longer maintained, "
