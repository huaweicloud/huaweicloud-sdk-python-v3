...
class ListEnterpriseSubCustomersResponse(SdkResponse):
    ...
    def __init__(self, total_count=None, sub_customer_infos=None):
        ...
        :type sub_customer_infos: list[:class:`huaweicloudsdkbssintl.v2.SubCustomerInfoV2`]
        """
    ...
    def sub_customer_infos(self):
        ...
        :rtype: list[:class:`huaweicloudsdkbssintl.v2.SubCustomerInfoV2`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListEnterpriseSubCustomersResponse.to_dict() is deprecated and no longer maintained, "
