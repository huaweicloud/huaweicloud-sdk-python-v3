...
class ListSubCustomerBudgetRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ListSubCustomerBudgetRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListSubCustomerBudgetRequest):
            return False
