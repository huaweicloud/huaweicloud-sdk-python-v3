...
class ListInvoicesResponse(SdkResponse):
    ...
    @property
    def count(self):
        r"""Gets the count of this ListInvoicesResponse.
    ...
    def count(self, count):
        r"""Sets the count of this ListInvoicesResponse.
    ...
    @property
    def invoices(self):
        r"""Gets the invoices of this ListInvoicesResponse.
    ...
    def invoices(self, invoices):
        r"""Sets the invoices of this ListInvoicesResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListInvoicesResponse.to_dict() is deprecated and no longer maintained, "
