...
class AutoRenewalResourcesRequest:
    ...
    def __init__(self, resource_id=None, body=None):
        ...
        :param resource_id: 资源实例ID。您可以调用“查询客户包年包月资源列表”接口获取资源ID。在设置弹性云服务器自动续费时，能够自动将其挂载的硬盘一并设置为自动续费。
        :type resource_id: str
        :param body: Body of the AutoRenewalResourcesRequest
        :type body: :class:`huaweicloudsdkbssintl.v2.AutoRenewalResourcesReq`
        """
    ...
    def resource_id(self):
        r"""Gets the resource_id of this AutoRenewalResourcesRequest.
    ...
    def resource_id(self, resource_id):
        r"""Sets the resource_id of this AutoRenewalResourcesRequest.
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkbssintl.v2.AutoRenewalResourcesReq`
        """
        return self._body
