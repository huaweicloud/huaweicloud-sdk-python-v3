...
class CustomerOrderV2:
    ...
    def __init__(self, order_id=None, customer_id=None, service_type_code=None, service_type_name=None, source_type=None, status=None, order_type=None, amount_after_discount=None, official_amount=None, measure_id=None, create_time=None, payment_time=None, currency=None, contract_id=None, amount_info=None, enterprise_projects=None, sub_order_infos=None, agent_pay_info=None):
        ...
        :type sub_order_infos: list[:class:`huaweicloudsdkbssintl.v2.SubCustomerOrderV2`]
        :param agent_pay_info: 
        :type agent_pay_info: :class:`huaweicloudsdkbssintl.v2.AgentPayInfoV2`
        """
    ...
    @property
    def order_id(self):
        r"""Gets the order_id of this CustomerOrderV2.
    ...
    def order_id(self, order_id):
        r"""Sets the order_id of this CustomerOrderV2.
    ...
    def customer_id(self):
        r"""Gets the customer_id of this CustomerOrderV2.
    ...
    def customer_id(self, customer_id):
        r"""Sets the customer_id of this CustomerOrderV2.
    ...
    def service_type_code(self):
        r"""Gets the service_type_code of this CustomerOrderV2.
    ...
    def service_type_code(self, service_type_code):
        r"""Sets the service_type_code of this CustomerOrderV2.
    ...
    def service_type_name(self):
        r"""Gets the service_type_name of this CustomerOrderV2.
    ...
    def service_type_name(self, service_type_name):
        r"""Sets the service_type_name of this CustomerOrderV2.
    ...
    def source_type(self):
        r"""Gets the source_type of this CustomerOrderV2.
    ...
    def source_type(self, source_type):
        r"""Sets the source_type of this CustomerOrderV2.
    ...
    @property
    def status(self):
        r"""Gets the status of this CustomerOrderV2.
    ...
    def status(self, status):
        r"""Sets the status of this CustomerOrderV2.
    ...
    @property
    def order_type(self):
        r"""Gets the order_type of this CustomerOrderV2.
    ...
    def order_type(self, order_type):
        r"""Sets the order_type of this CustomerOrderV2.
    ...
    def amount_after_discount(self):
        r"""Gets the amount_after_discount of this CustomerOrderV2.
    ...
    def amount_after_discount(self, amount_after_discount):
        r"""Sets the amount_after_discount of this CustomerOrderV2.
    ...
    def official_amount(self):
        r"""Gets the official_amount of this CustomerOrderV2.
    ...
    def official_amount(self, official_amount):
        r"""Sets the official_amount of this CustomerOrderV2.
    ...
    @property
    def measure_id(self):
        r"""Gets the measure_id of this CustomerOrderV2.
    ...
    def measure_id(self, measure_id):
        r"""Sets the measure_id of this CustomerOrderV2.
    ...
    def create_time(self):
        r"""Gets the create_time of this CustomerOrderV2.
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this CustomerOrderV2.
    ...
    def payment_time(self):
        r"""Gets the payment_time of this CustomerOrderV2.
    ...
    def payment_time(self, payment_time):
        r"""Sets the payment_time of this CustomerOrderV2.
    ...
    @property
    def currency(self):
        r"""Gets the currency of this CustomerOrderV2.
    ...
    def currency(self, currency):
        r"""Sets the currency of this CustomerOrderV2.
    ...
    def contract_id(self):
        r"""Gets the contract_id of this CustomerOrderV2.
    ...
    def contract_id(self, contract_id):
        r"""Sets the contract_id of this CustomerOrderV2.
    ...
    def amount_info(self):
        r"""Gets the amount_info of this CustomerOrderV2.
    ...
    def amount_info(self, amount_info):
        r"""Sets the amount_info of this CustomerOrderV2.
    ...
    def enterprise_projects(self):
        r"""Gets the enterprise_projects of this CustomerOrderV2.
    ...
    def enterprise_projects(self, enterprise_projects):
        r"""Sets the enterprise_projects of this CustomerOrderV2.
    ...
    def sub_order_infos(self):
        r"""Gets the sub_order_infos of this CustomerOrderV2.
        ...
        :rtype: list[:class:`huaweicloudsdkbssintl.v2.SubCustomerOrderV2`]
        """
        return self._sub_order_infos

    @sub_order_infos.setter
    def sub_order_infos(self, sub_order_infos):
        r"""Sets the sub_order_infos of this CustomerOrderV2.
    ...
    def agent_pay_info(self):
        ...
        :rtype: :class:`huaweicloudsdkbssintl.v2.AgentPayInfoV2`
        """
