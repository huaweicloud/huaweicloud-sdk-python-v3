...
class ListCostsReq:
    ...
    def __init__(self, time_condition=None, groupby=None, cost_type=None, amount_type=None, offset=None, limit=None):
        """ListCostsReq - a model defined in huaweicloud sdk"""
