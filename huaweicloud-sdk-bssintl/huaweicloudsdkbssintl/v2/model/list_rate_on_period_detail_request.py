...
class ListRateOnPeriodDetailRequest:
    ...
    def __init__(self, body=None):
        r"""ListRateOnPeriodDetailRequest
    ...
    @property
    def body(self):
        r"""Gets the body of this ListRateOnPeriodDetailRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this ListRateOnPeriodDetailRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRateOnPeriodDetailRequest):
            return False
