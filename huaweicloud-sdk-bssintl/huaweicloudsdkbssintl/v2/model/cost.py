...
class Cost:
    ...
    def __init__(self, time_dimension_value=None, time_measure_id=None, amount=None, official_amount=None):
        """Cost - a model defined in huaweicloud sdk"""
    ...
    def time_dimension_value(self):
        ...
        |参数名称：时间维度值如按天维度，该值为yyyy-mm-dd如按月维度，该值为yyyy-mm| |参数约束及描述：时间维度值如按天维度，该值为yyyy-mm-dd如按月维度，该值为yyyy-mm|
    ...
    def amount(self):
        ...
        |参数名称：应付或者实付的成本金额或者均摊金额，具体看页面选择| |参数约束及描述：应付或者实付的成本金额或者均摊金额，具体看页面选择|
