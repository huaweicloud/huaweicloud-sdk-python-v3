...
class ListOrderDiscountsResponse(SdkResponse):
    ...
    def __init__(self, discounts=None):
        ...
        :type discounts: list[:class:`huaweicloudsdkbssintl.v2.DiscountInfoV3`]
        """
    ...
    def discounts(self):
        ...
        :rtype: list[:class:`huaweicloudsdkbssintl.v2.DiscountInfoV3`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListOrderDiscountsResponse.to_dict() is deprecated and no longer maintained, "
