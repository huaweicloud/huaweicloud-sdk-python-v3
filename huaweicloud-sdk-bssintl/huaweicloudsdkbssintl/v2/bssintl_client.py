...
class BssintlClient(Client):
    ...
    def list_resource_specs_price(self, request):
        r"""查询云服务类型资源规格定价
    ...
    def list_resource_specs_price_invoker(self, request):
        http_info = self._list_resource_specs_price_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_resource_specs_price_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def list_sub_customer_budget_records(self, request):
        r"""查询客户预算调整记录
    ...
    def list_sub_customer_budget_records_invoker(self, request):
        http_info = self._list_sub_customer_budget_records_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_sub_customer_budget_records_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_customer_expenditure_quota(self, request):
        r"""查询消费配额
    ...
    def show_customer_expenditure_quota_invoker(self, request):
        http_info = self._show_customer_expenditure_quota_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_customer_expenditure_quota_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_partner_consumption_quota_invoker(self, request):
        http_info = self._show_partner_consumption_quota_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_partner_consumption_quota_http_info(cls, request):
        http_info = {
            "method": "GET",
