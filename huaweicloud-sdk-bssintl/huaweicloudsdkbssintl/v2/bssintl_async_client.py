...
class BssintlAsyncClient(Client):
    ...
    def list_monthly_expenditures_async(self, request):
        ...
        """
        warnings.warn("Method 'list_monthly_expenditures_async' of BssintlAsyncClient is deprecated and will be removed in the future versions", DeprecationWarning)
        http_info = self._list_monthly_expenditures_http_info(request)
        return self._call_api(**http_info)

    def list_monthly_expenditures_async_invoker(self, request):
        warnings.warn("Method 'list_monthly_expenditures_async_invoker' of BssintlAsyncClient is deprecated and will be removed in the future versions", DeprecationWarning)
        http_info = self._list_monthly_expenditures_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_monthly_expenditures_http_info(self, request):
        http_info = {
            "method": "GET",
