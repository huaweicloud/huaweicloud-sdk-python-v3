...
class BssintlAsyncClient(Client):
    ...
    def new_builder(cls, clazz=None):
        if not clazz:
            ...
            if clazz.__name__ != "BssintlAsyncClient":
                raise TypeError("client type error, support client type is BssintlAsyncClient")
    ...
    def freeze_sub_customers_async_invoker(self, request):
        http_info = self._freeze_sub_customers_http_info(request)
        return AsyncInvoker(self, http_info)

    def _freeze_sub_customers_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def list_invoices_async_invoker(self, request):
        http_info = self._list_invoices_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_invoices_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_postpaid_bill_sum_async_invoker(self, request):
        http_info = self._list_postpaid_bill_sum_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_postpaid_bill_sum_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_resource_specs_async(self, request):
        r"""查询云服务类型资源规格
        ...
        :type request: :class:`huaweicloudsdkbssintl.v2.ListResourceSpecsRequest`
        :rtype: :class:`huaweicloudsdkbssintl.v2.ListResourceSpecsResponse`
        """
        http_info = self._list_resource_specs_http_info(request)
        return self._call_api(**http_info)

    def list_resource_specs_async_invoker(self, request):
        http_info = self._list_resource_specs_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_resource_specs_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def list_resource_specs_price_async(self, request):
        r"""查询云服务类型资源规格定价
        ...
        :param request: Request instance for ListResourceSpecsPrice
        :type request: :class:`huaweicloudsdkbssintl.v2.ListResourceSpecsPriceRequest`
        :rtype: :class:`huaweicloudsdkbssintl.v2.ListResourceSpecsPriceResponse`
        """
        http_info = self._list_resource_specs_price_http_info(request)
        return self._call_api(**http_info)

    def list_resource_specs_price_async_invoker(self, request):
        http_info = self._list_resource_specs_price_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_resource_specs_price_http_info(self, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v2/products/resource-specs-price/query",
            "request_type": request.__class__.__name__,
            "response_type": "ListResourceSpecsPriceResponse"
            }
    ...
    def list_sub_customer_budget_async(self, request):
        r"""批量查询客户预算
    ...
    def list_sub_customer_budget_async_invoker(self, request):
        http_info = self._list_sub_customer_budget_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_sub_customer_budget_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def show_customer_expenditure_quota_async(self, request):
        r"""查询消费配额
        ...
        :param request: Request instance for ShowCustomerExpenditureQuota
        :type request: :class:`huaweicloudsdkbssintl.v2.ShowCustomerExpenditureQuotaRequest`
        :rtype: :class:`huaweicloudsdkbssintl.v2.ShowCustomerExpenditureQuotaResponse`
        """
        http_info = self._show_customer_expenditure_quota_http_info(request)
        return self._call_api(**http_info)

    def show_customer_expenditure_quota_async_invoker(self, request):
        http_info = self._show_customer_expenditure_quota_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_customer_expenditure_quota_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v2/accounts/customer-accounts/expenditure-quota",
            "request_type": request.__class__.__name__,
            "response_type": "ShowCustomerExpenditureQuotaResponse"
            }
    ...
    def show_sub_customer_budget_async_invoker(self, request):
        http_info = self._show_sub_customer_budget_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_sub_customer_budget_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def unfreeze_sub_customers_async_invoker(self, request):
        http_info = self._unfreeze_sub_customers_http_info(request)
        return AsyncInvoker(self, http_info)

    def _unfreeze_sub_customers_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def update_sub_customer_budget_async_invoker(self, request):
        http_info = self._update_sub_customer_budget_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_sub_customer_budget_http_info(self, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v2/partners/sub-customers/budget",
            "request_type": request.__class__.__name__,
    ...
    def set_resources_renew_config_async(self, request):
    ...
    def set_resources_renew_config_async_invoker(self, request):
        http_info = self._set_resources_renew_config_http_info(request)
        return AsyncInvoker(self, http_info)

    def _set_resources_renew_config_http_info(self, request):
        http_info = {
            "method": "POST",
