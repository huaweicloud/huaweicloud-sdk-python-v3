...
class ListAreaDetailResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAreaDetailResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAreaDetailResponse):
            return False
