...
class ListSingleStreamFramerateRequest:
    ...
    def __init__(self, domain=None, app=None, stream=None, start_time=None, end_time=None):
        """ListSingleStreamFramerateRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListSingleStreamFramerateRequest):
            return False
