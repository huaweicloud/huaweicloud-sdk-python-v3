...
class ListSingleStreamBitrateRequest:
    ...
    def __init__(self, domain=None, app=None, stream=None, type=None, start_time=None, end_time=None):
        r"""ListSingleStreamBitrateRequest
        ...
        :param stream: 流名。 
        :type stream: str
        :param type: 数据类型，取值如下：  - VIDEO ：视频码率  - AUDIO ：音频码率   不填写默认查询视频码率的数据。 
        :type type: str
    ...
    @property
    def domain(self):
        r"""Gets the domain of this ListSingleStreamBitrateRequest.
    ...
    def domain(self, domain):
        r"""Sets the domain of this ListSingleStreamBitrateRequest.
    ...
    @property
    def app(self):
        r"""Gets the app of this ListSingleStreamBitrateRequest.
    ...
    @app.setter
    def app(self, app):
        r"""Sets the app of this ListSingleStreamBitrateRequest.
    ...
    @property
    def stream(self):
        r"""Gets the stream of this ListSingleStreamBitrateRequest.
    ...
    def stream(self, stream):
        r"""Sets the stream of this ListSingleStreamBitrateRequest.
    ...
    @property
    def type(self):
        r"""Gets the type of this ListSingleStreamBitrateRequest.

        数据类型，取值如下：  - VIDEO ：视频码率  - AUDIO ：音频码率   不填写默认查询视频码率的数据。 

        :return: The type of this ListSingleStreamBitrateRequest.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        r"""Sets the type of this ListSingleStreamBitrateRequest.

        数据类型，取值如下：  - VIDEO ：视频码率  - AUDIO ：音频码率   不填写默认查询视频码率的数据。 

        :param type: The type of this ListSingleStreamBitrateRequest.
        :type type: str
        """
        self._type = type
    ...
    @property
    def start_time(self):
        r"""Gets the start_time of this ListSingleStreamBitrateRequest.
    ...
    def start_time(self, start_time):
        r"""Sets the start_time of this ListSingleStreamBitrateRequest.
    ...
    @property
    def end_time(self):
        r"""Gets the end_time of this ListSingleStreamBitrateRequest.
    ...
    def end_time(self, end_time):
        r"""Sets the end_time of this ListSingleStreamBitrateRequest.
