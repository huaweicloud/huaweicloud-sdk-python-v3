...
class LiveAPIClient(Client):
    ...
    def __init__(self):
        super(LiveAPIClient, self).__init__()
    ...
    def list_bandwidth_detail_v2(self, request):
        """查询播放带宽趋势接口
    ...
    def list_domain_bandwidth_summary_v2(self, request):
        """查询播放带宽峰值接口
    ...
    def list_domain_traffic_detail_v2(self, request):
        """查询播放流量趋势接口
    ...
    def list_domain_traffic_summary_v2(self, request):
        """查询播放流量汇总接口
    ...
    def list_history_streams_v2(self, request):
        """查询历史推流列表接口
    ...
    def list_record_data_v2(self, request):
        """查询录制用量接口
    ...
    def list_single_stream_bitrate_v2(self, request):
        """查询推流码率数据接口
    ...
    def list_single_stream_framerate_v2(self, request):
        """查询推流帧率数据接口
    ...
    def list_snapshot_data_v2(self, request):
        """查询截图用量接口
    ...
    def list_transcode_data_v2(self, request):
        """查询转码用量接口
    ...
    def list_users_of_stream_v2(self, request):
        """查询观众趋势接口
    ...
    def show_stream_count_v2(self, request):
        """查询域名维度推流路数接口
    ...
    def show_up_bandwidth_v2(self, request):
        """查询上行带宽数据接口
