...
class LiveClient(Client):
    ...
    def list_play_domain_stream_info(self, request):
        r"""查询播放域名下的流数据
    ...
    def list_play_domain_stream_info_invoker(self, request):
        http_info = self._list_play_domain_stream_info_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_play_domain_stream_info_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_transcode_concurrency_num(self, request):
        r"""查询推流域名转码路数
    ...
    def list_transcode_concurrency_num_invoker(self, request):
        http_info = self._list_transcode_concurrency_num_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_transcode_concurrency_num_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_transcode_task_detail(self, request):
        r"""查询转码明细
    ...
    def list_transcode_task_detail_invoker(self, request):
        http_info = self._list_transcode_task_detail_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_transcode_task_detail_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_carousel_task_detail(self, request):
        r"""查询轮播任务监控数据接口
    ...
    def list_carousel_task_detail_invoker(self, request):
        http_info = self._list_carousel_task_detail_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_carousel_task_detail_http_info(cls, request):
        http_info = {
            "method": "GET",
