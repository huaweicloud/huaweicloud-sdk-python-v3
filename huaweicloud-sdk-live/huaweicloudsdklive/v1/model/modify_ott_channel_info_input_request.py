...
class ModifyOttChannelInfoInputRequest:
    ...
    def __init__(self, access_control_allow_internal=None, access_control_allow_external=None, body=None):
        r"""ModifyOttChannelInfoInputRequest
        ...
        :param body: Body of the ModifyOttChannelInfoInputRequest
        :type body: :class:`huaweicloudsdklive.v1.ModifyOttChannelInputReq`
        """
    ...
    def access_control_allow_internal(self):
        r"""Gets the access_control_allow_internal of this ModifyOttChannelInfoInputRequest.

        服务鉴权Token，服务开启鉴权，必须携带Access-Control-Allow-Internal访问服务。

        :return: The access_control_allow_internal of this ModifyOttChannelInfoInputRequest.
        :rtype: str
        """
    ...
    def access_control_allow_internal(self, access_control_allow_internal):
        r"""Sets the access_control_allow_internal of this ModifyOttChannelInfoInputRequest.

        服务鉴权Token，服务开启鉴权，必须携带Access-Control-Allow-Internal访问服务。

        :param access_control_allow_internal: The access_control_allow_internal of this ModifyOttChannelInfoInputRequest.
        :type access_control_allow_internal: str
        """
    ...
    def access_control_allow_external(self):
        r"""Gets the access_control_allow_external of this ModifyOttChannelInfoInputRequest.

        服务鉴权Token，服务开启鉴权，必须携带Access-Control-Allow-External访问服务。

        :return: The access_control_allow_external of this ModifyOttChannelInfoInputRequest.
        :rtype: str
        """
    ...
    def access_control_allow_external(self, access_control_allow_external):
        r"""Sets the access_control_allow_external of this ModifyOttChannelInfoInputRequest.

        服务鉴权Token，服务开启鉴权，必须携带Access-Control-Allow-External访问服务。

        :param access_control_allow_external: The access_control_allow_external of this ModifyOttChannelInfoInputRequest.
        :type access_control_allow_external: str
        """
    ...
    @property
    def body(self):
        r"""Gets the body of this ModifyOttChannelInfoInputRequest.

        :return: The body of this ModifyOttChannelInfoInputRequest.
        :rtype: :class:`huaweicloudsdklive.v1.ModifyOttChannelInputReq`
        """
        return self._body

    @body.setter
    def body(self, body):
        r"""Sets the body of this ModifyOttChannelInfoInputRequest.

        :param body: The body of this ModifyOttChannelInfoInputRequest.
        :type body: :class:`huaweicloudsdklive.v1.ModifyOttChannelInputReq`
        """
        self._body = body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModifyOttChannelInfoInputRequest):
            return False
