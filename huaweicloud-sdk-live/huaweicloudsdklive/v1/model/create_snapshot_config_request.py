...
class CreateSnapshotConfigRequest:
    ...
    def __init__(self, access_control_allow_internal=None, access_control_allow_external=None, body=None):
        ...
        :param body: Body of the CreateSnapshotConfigRequest
        :type body: :class:`huaweicloudsdklive.v1.LiveSnapshotConfig`
        """
    ...
    def access_control_allow_internal(self):
        """Gets the access_control_allow_internal of this CreateSnapshotConfigRequest.

        服务鉴权Token，服务开启鉴权，必须携带Access-Control-Allow-Internal访问服务。

        :return: The access_control_allow_internal of this CreateSnapshotConfigRequest.
        :rtype: str
        """
    ...
    def access_control_allow_internal(self, access_control_allow_internal):
        """Sets the access_control_allow_internal of this CreateSnapshotConfigRequest.

        服务鉴权Token，服务开启鉴权，必须携带Access-Control-Allow-Internal访问服务。

        :param access_control_allow_internal: The access_control_allow_internal of this CreateSnapshotConfigRequest.
        :type access_control_allow_internal: str
        """
    ...
    def access_control_allow_external(self):
        """Gets the access_control_allow_external of this CreateSnapshotConfigRequest.

        服务鉴权Token，服务开启鉴权，必须携带Access-Control-Allow-External访问服务。

        :return: The access_control_allow_external of this CreateSnapshotConfigRequest.
        :rtype: str
        """
    ...
    def access_control_allow_external(self, access_control_allow_external):
        """Sets the access_control_allow_external of this CreateSnapshotConfigRequest.

        服务鉴权Token，服务开启鉴权，必须携带Access-Control-Allow-External访问服务。

        :param access_control_allow_external: The access_control_allow_external of this CreateSnapshotConfigRequest.
        :type access_control_allow_external: str
        """
    ...
    @property
    def body(self):
        """Gets the body of this CreateSnapshotConfigRequest.

        :return: The body of this CreateSnapshotConfigRequest.
    ...
    @body.setter
    def body(self, body):
        """Sets the body of this CreateSnapshotConfigRequest.

        :param body: The body of this CreateSnapshotConfigRequest.
        :type body: :class:`huaweicloudsdklive.v1.LiveSnapshotConfig`
        """
        self._body = body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateSnapshotConfigRequest):
            return False
