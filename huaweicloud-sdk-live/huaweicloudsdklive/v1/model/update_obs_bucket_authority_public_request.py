...
class UpdateObsBucketAuthorityPublicRequest:
    ...
    def __init__(self, access_control_allow_internal=None, access_control_allow_external=None, body=None):
        ...
        :param body: Body of the UpdateObsBucketAuthorityPublicRequest
        :type body: :class:`huaweicloudsdklive.v1.ObsAuthorityConfigV2`
        """
    ...
    def access_control_allow_internal(self):
        """Gets the access_control_allow_internal of this UpdateObsBucketAuthorityPublicRequest.

        服务鉴权Token，服务开启鉴权，必须携带Access-Control-Allow-Internal访问服务。

        :return: The access_control_allow_internal of this UpdateObsBucketAuthorityPublicRequest.
        :rtype: str
        """
    ...
    def access_control_allow_internal(self, access_control_allow_internal):
        """Sets the access_control_allow_internal of this UpdateObsBucketAuthorityPublicRequest.

        服务鉴权Token，服务开启鉴权，必须携带Access-Control-Allow-Internal访问服务。

        :param access_control_allow_internal: The access_control_allow_internal of this UpdateObsBucketAuthorityPublicRequest.
        :type access_control_allow_internal: str
        """
    ...
    def access_control_allow_external(self):
        """Gets the access_control_allow_external of this UpdateObsBucketAuthorityPublicRequest.

        服务鉴权Token，服务开启鉴权，必须携带Access-Control-Allow-External访问服务。

        :return: The access_control_allow_external of this UpdateObsBucketAuthorityPublicRequest.
        :rtype: str
        """
    ...
    def access_control_allow_external(self, access_control_allow_external):
        """Sets the access_control_allow_external of this UpdateObsBucketAuthorityPublicRequest.

        服务鉴权Token，服务开启鉴权，必须携带Access-Control-Allow-External访问服务。

        :param access_control_allow_external: The access_control_allow_external of this UpdateObsBucketAuthorityPublicRequest.
        :type access_control_allow_external: str
        """
    ...
    @property
    def body(self):
        """Gets the body of this UpdateObsBucketAuthorityPublicRequest.

        :return: The body of this UpdateObsBucketAuthorityPublicRequest.
        :rtype: :class:`huaweicloudsdklive.v1.ObsAuthorityConfigV2`
        """
        return self._body

    @body.setter
    def body(self, body):
        """Sets the body of this UpdateObsBucketAuthorityPublicRequest.

        :param body: The body of this UpdateObsBucketAuthorityPublicRequest.
        :type body: :class:`huaweicloudsdklive.v1.ObsAuthorityConfigV2`
        """
        self._body = body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateObsBucketAuthorityPublicRequest):
            return False
