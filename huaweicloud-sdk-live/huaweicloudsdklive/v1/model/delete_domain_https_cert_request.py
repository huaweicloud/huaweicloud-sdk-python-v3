...
class DeleteDomainHttpsCertRequest:
    ...
    def access_control_allow_internal(self):
        """Gets the access_control_allow_internal of this DeleteDomainHttpsCertRequest.

        服务鉴权Token，服务开启鉴权，必须携带Access-Control-Allow-Internal访问服务。

        :return: The access_control_allow_internal of this DeleteDomainHttpsCertRequest.
        :rtype: str
        """
    ...
    def access_control_allow_internal(self, access_control_allow_internal):
        """Sets the access_control_allow_internal of this DeleteDomainHttpsCertRequest.

        服务鉴权Token，服务开启鉴权，必须携带Access-Control-Allow-Internal访问服务。

        :param access_control_allow_internal: The access_control_allow_internal of this DeleteDomainHttpsCertRequest.
        :type access_control_allow_internal: str
        """
    ...
    def access_control_allow_external(self):
        """Gets the access_control_allow_external of this DeleteDomainHttpsCertRequest.

        服务鉴权Token，服务开启鉴权，必须携带Access-Control-Allow-External访问服务。

        :return: The access_control_allow_external of this DeleteDomainHttpsCertRequest.
        :rtype: str
        """
    ...
    def access_control_allow_external(self, access_control_allow_external):
        """Sets the access_control_allow_external of this DeleteDomainHttpsCertRequest.

        服务鉴权Token，服务开启鉴权，必须携带Access-Control-Allow-External访问服务。

        :param access_control_allow_external: The access_control_allow_external of this DeleteDomainHttpsCertRequest.
        :type access_control_allow_external: str
        """
    ...
    def domain(self):
        ...
        :return: The domain of this DeleteDomainHttpsCertRequest.
        :rtype: str
        """
        return self._domain
    ...
    def domain(self, domain):
        ...
        :param domain: The domain of this DeleteDomainHttpsCertRequest.
        :type domain: str
        """
        self._domain = domain
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteDomainHttpsCertRequest):
            return False
