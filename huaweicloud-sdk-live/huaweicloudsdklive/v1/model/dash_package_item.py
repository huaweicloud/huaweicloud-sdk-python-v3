...
class DashPackageItem:
    ...
    @property
    def id(self):
        r"""Gets the id of this DashPackageItem.

        package唯一标识id，由服务创建并在查询时返回，修改endpoints时需要携带。

        :return: The id of this DashPackageItem.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this DashPackageItem.

        package唯一标识id，由服务创建并在查询时返回，修改endpoints时需要携带。

        :param id: The id of this DashPackageItem.
        :type id: str
        """
        self._id = id
    ...
    def enable_access(self):
        r"""Gets the enable_access of this DashPackageItem.

        当频道mode是ONLY_OS类型时，允许本输出可以直接从源站拉流，默认：false true：允许output访问 false：禁止output访问

        :return: The enable_access of this DashPackageItem.
        :rtype: bool
        """
    ...
    def enable_access(self, enable_access):
        r"""Sets the enable_access of this DashPackageItem.

        当频道mode是ONLY_OS类型时，允许本输出可以直接从源站拉流，默认：false true：允许output访问 false：禁止output访问

        :param enable_access: The enable_access of this DashPackageItem.
        :type enable_access: bool
        """
    ...
    def allow_all_ip_access(self, allow_all_ip_access):
        r"""Sets the allow_all_ip_access of this DashPackageItem.

        是否放通所有的IP访问，默认：false true：允许所有的IP地址访问，ip_whitelist配置不生效 false：不允许所有的IP地址访问，ip_whitelist生效，仅在ip_whitelist配置的ip地址才能访问

        :param allow_all_ip_access: The allow_all_ip_access of this DashPackageItem.
        :type allow_all_ip_access: bool
        """
    ...
    def ip_whitelist(self):
        r"""Gets the ip_whitelist of this DashPackageItem.

        当频道类型mode是ONLY_OS类型时，允许直接从源站拉流的IP白名单

        :return: The ip_whitelist of this DashPackageItem.
        :rtype: str
        """
    ...
    def ip_whitelist(self, ip_whitelist):
        r"""Sets the ip_whitelist of this DashPackageItem.

        当频道类型mode是ONLY_OS类型时，允许直接从源站拉流的IP白名单

        :param ip_whitelist: The ip_whitelist of this DashPackageItem.
        :type ip_whitelist: str
        """
    ...
    def cdn_identifier_header(self):
        r"""Gets the cdn_identifier_header of this DashPackageItem.

        :return: The cdn_identifier_header of this DashPackageItem.
    ...
    def cdn_identifier_header(self, cdn_identifier_header):
        r"""Sets the cdn_identifier_header of this DashPackageItem.

        :param cdn_identifier_header: The cdn_identifier_header of this DashPackageItem.
        :type cdn_identifier_header: :class:`huaweicloudsdklive.v1.HttpHeader`
        """
    ...
    def origin_domain_master(self):
        r"""Gets the origin_domain_master of this DashPackageItem.

        源站分发域名-主region 跟CreateOttChannelInfoReq.region一致 满足正则：^(\\[a-zA-Z0-9]([a-zA-Z0-9\\-]{0,61}[a-zA-Z0-9])?\\.){2,}[a-zA-Z]{2,16}$ 最大长度255

        :return: The origin_domain_master of this DashPackageItem.
        :rtype: str
        """
    ...
    def origin_domain_master(self, origin_domain_master):
        r"""Sets the origin_domain_master of this DashPackageItem.

        源站分发域名-主region 跟CreateOttChannelInfoReq.region一致 满足正则：^(\\[a-zA-Z0-9]([a-zA-Z0-9\\-]{0,61}[a-zA-Z0-9])?\\.){2,}[a-zA-Z]{2,16}$ 最大长度255

        :param origin_domain_master: The origin_domain_master of this DashPackageItem.
        :type origin_domain_master: str
        """
    ...
    def origin_domain_slave(self):
        r"""Gets the origin_domain_slave of this DashPackageItem.

        源站分发域名-备region 满足正则：^(\\[a-zA-Z0-9]([a-zA-Z0-9\\-]{0,61}[a-zA-Z0-9])?\\.){2,}[a-zA-Z]{2,16}$ 最大长度255

        :return: The origin_domain_slave of this DashPackageItem.
        :rtype: str
        """
    ...
    def origin_domain_slave(self, origin_domain_slave):
        r"""Sets the origin_domain_slave of this DashPackageItem.

        源站分发域名-备region 满足正则：^(\\[a-zA-Z0-9]([a-zA-Z0-9\\-]{0,61}[a-zA-Z0-9])?\\.){2,}[a-zA-Z]{2,16}$ 最大长度255

        :param origin_domain_slave: The origin_domain_slave of this DashPackageItem.
        :type origin_domain_slave: str
        """
    ...
    def manifest_name(self):
        r"""Gets the manifest_name of this DashPackageItem.

        output的索引文件名字 默认：index 长度：0-128 字符集：大小写字母、数字、\"-\"、\".\"、\"_\"，不能有/路径

        :return: The manifest_name of this DashPackageItem.
        :rtype: str
        """
    ...
    def manifest_name(self, manifest_name):
        r"""Sets the manifest_name of this DashPackageItem.

        output的索引文件名字 默认：index 长度：0-128 字符集：大小写字母、数字、\"-\"、\".\"、\"_\"，不能有/路径

        :param manifest_name: The manifest_name of this DashPackageItem.
        :type manifest_name: str
        """
    ...
    @property
    def slave_url(self):
        r"""Gets the slave_url of this DashPackageItem.

        客户自定义的拉流地址，包括方法、域名、路径

        :return: The slave_url of this DashPackageItem.
        :rtype: str
        """
    ...
    def slave_url(self, slave_url):
        r"""Sets the slave_url of this DashPackageItem.

        客户自定义的拉流地址，包括方法、域名、路径

        :param slave_url: The slave_url of this DashPackageItem.
        :type slave_url: str
        """
    ...
    def manifest_selection(self):
        r"""Gets the manifest_selection of this DashPackageItem.

        :return: The manifest_selection of this DashPackageItem.
    ...
    def manifest_selection(self, manifest_selection):
        r"""Sets the manifest_selection of this DashPackageItem.

        :param manifest_selection: The manifest_selection of this DashPackageItem.
        :type manifest_selection: :class:`huaweicloudsdklive.v1.ManifestSelection`
        """
