...
class ShowRefererChainResponse(SdkResponse):
    ...
    def domain(self):
        ...
        :return: The domain of this ShowRefererChainResponse.
        :rtype: str
        """
        return self._domain
    ...
    def domain(self, domain):
        ...
        :param domain: The domain of this ShowRefererChainResponse.
        :type domain: str
        """
        self._domain = domain
    ...
    def guard_switch(self):
        ...
        :return: The guard_switch of this ShowRefererChainResponse.
        :rtype: str
        """
    ...
    def guard_switch(self, guard_switch):
        ...
        :param guard_switch: The guard_switch of this ShowRefererChainResponse.
        :type guard_switch: str
        """
    ...
    def referer_config_empty(self):
        ...
        :return: The referer_config_empty of this ShowRefererChainResponse.
        :rtype: str
        """
    ...
    def referer_config_empty(self, referer_config_empty):
        ...
        :param referer_config_empty: The referer_config_empty of this ShowRefererChainResponse.
        :type referer_config_empty: str
        """
    ...
    def referer_white_list(self):
        ...
        :return: The referer_white_list of this ShowRefererChainResponse.
        :rtype: str
        """
    ...
    def referer_white_list(self, referer_white_list):
        ...
        :param referer_white_list: The referer_white_list of this ShowRefererChainResponse.
        :type referer_white_list: str
        """
    ...
    def referer_auth_list(self):
        ...
        :return: The referer_auth_list of this ShowRefererChainResponse.
        :rtype: list[str]
        """
    ...
    def referer_auth_list(self, referer_auth_list):
        ...
        :param referer_auth_list: The referer_auth_list of this ShowRefererChainResponse.
        :type referer_auth_list: list[str]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowRefererChainResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowRefererChainResponse):
            return False
