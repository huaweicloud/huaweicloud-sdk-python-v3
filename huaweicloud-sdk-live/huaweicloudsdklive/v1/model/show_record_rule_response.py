...
class ShowRecordRuleResponse(SdkResponse):
    ...
    def __init__(self, id=None, publish_domain=None, app=None, stream=None, record_type=None, plan_record_time=None, default_record_config=None, create_time=None, update_time=None):
        """ShowRecordRuleResponse - a model defined in huaweicloud sdk"""
        
        super(ShowRecordRuleResponse, self).__init__()
    ...
    @property
    def id(self):
        """Gets the id of this ShowRecordRuleResponse.

        规则id，由服务端返回。创建或修改的时候不携带

        :return: The id of this ShowRecordRuleResponse.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ShowRecordRuleResponse.

        规则id，由服务端返回。创建或修改的时候不携带

        :param id: The id of this ShowRecordRuleResponse.
        :type: str
        """
        self._id = id
    ...
    def publish_domain(self):
        """Gets the publish_domain of this ShowRecordRuleResponse.

        直播推流域名

        :return: The publish_domain of this ShowRecordRuleResponse.
        :rtype: str
        """
    ...
    def publish_domain(self, publish_domain):
        """Sets the publish_domain of this ShowRecordRuleResponse.

        直播推流域名

        :param publish_domain: The publish_domain of this ShowRecordRuleResponse.
        :type: str
        """
    ...
    @property
    def app(self):
        """Gets the app of this ShowRecordRuleResponse.

        应用名，如果任意应用填写*。录制规则匹配的时候，优先精确app匹配，如果匹配不到，则匹配*

        :return: The app of this ShowRecordRuleResponse.
        :rtype: str
        """
        return self._app
    ...
    @app.setter
    def app(self, app):
        """Sets the app of this ShowRecordRuleResponse.

        应用名，如果任意应用填写*。录制规则匹配的时候，优先精确app匹配，如果匹配不到，则匹配*

        :param app: The app of this ShowRecordRuleResponse.
        :type: str
        """
        self._app = app
    ...
    @property
    def stream(self):
        """Gets the stream of this ShowRecordRuleResponse.

        录制的流名，如果任意流名则填写*。录制规则匹配的时候，优先精确stream匹配，如果匹配不到，则匹配*

        :return: The stream of this ShowRecordRuleResponse.
        :rtype: str
        """
        return self._stream
    ...
    def stream(self, stream):
        """Sets the stream of this ShowRecordRuleResponse.

        录制的流名，如果任意流名则填写*。录制规则匹配的时候，优先精确stream匹配，如果匹配不到，则匹配*

        :param stream: The stream of this ShowRecordRuleResponse.
        :type: str
        """
        self._stream = stream
    ...
    def record_type(self):
        """Gets the record_type of this ShowRecordRuleResponse.
        ...
        :return: The record_type of this ShowRecordRuleResponse.
        :rtype: str
        """
    ...
    def record_type(self, record_type):
        """Sets the record_type of this ShowRecordRuleResponse.

        录制类型，包括：CONTINUOUS_RECORD，COMMAND_RECORD，PLAN_RECORD, ON_DEMAND_RECORD。默认CONTINUOUS_RECORD。 - CONTINUOUS_RECORD: 持续录制，在该规则类型配置后，只要有流到推送到录制系统，就触发录制。 - COMMAND_RECORD: 命令录制，在该规则类型配置后，在流推送到录制系统后，租户需要通过命令控制该流的录制开始和结束。命令控制的接口参考/v1/{project_id}/record/control - PLAN_RECORD: 计划录制，在该规则类型配置后，推的流如果在计划录制的时间区间则触发录制。 - ON_DEMAND_RECORD: 按需录制，在该规则类型配置后，录制系统收到推流后，需要调用租户提供的接口查询录制规则，并根据规则录制。租户提供的接口定义参考：/customer-record-ondemand-url 

        :param record_type: The record_type of this ShowRecordRuleResponse.
        :type: str
        """
    ...
    def plan_record_time(self):
        """Gets the plan_record_time of this ShowRecordRuleResponse.


        :return: The plan_record_time of this ShowRecordRuleResponse.
    ...
    def plan_record_time(self, plan_record_time):
        """Sets the plan_record_time of this ShowRecordRuleResponse.


        :param plan_record_time: The plan_record_time of this ShowRecordRuleResponse.
        :type: PlanRecordTime
        """
    ...
    def create_time(self):
        ...
        :return: The create_time of this ShowRecordRuleResponse.
        :rtype: date
        """
    ...
    def create_time(self, create_time):
        ...
        :param create_time: The create_time of this ShowRecordRuleResponse.
        :type: date
        """
    ...
    def update_time(self):
        ...
        :return: The update_time of this ShowRecordRuleResponse.
        :rtype: date
        """
    ...
    def update_time(self, update_time):
        ...
        :param update_time: The update_time of this ShowRecordRuleResponse.
        :type: date
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowRecordRuleResponse):
            return False
