...
class UpdateRecordRuleRequest:
    ...
    def __init__(self, id=None, body=None):
        ...
        :param id: 规则ID，在创建成功规则后返回
        :type id: str
        :param body: Body of the UpdateRecordRuleRequest
    ...
    def id(self):
        ...
        :return: The id of this UpdateRecordRuleRequest.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this UpdateRecordRuleRequest.
        :type id: str
        """
        self._id = id
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateRecordRuleRequest):
            return False
