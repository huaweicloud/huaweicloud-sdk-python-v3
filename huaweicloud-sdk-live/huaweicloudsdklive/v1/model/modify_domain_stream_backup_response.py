...
class ModifyDomainStreamBackupResponse(SdkResponse):
    ...
    def __init__(self, publish_domain=None, stream_backup_enable=None):
        r"""ModifyDomainStreamBackupResponse
        ...
        if stream_backup_enable is not None:
            self.stream_backup_enable = stream_backup_enable

    @property
    def publish_domain(self):
        r"""Gets the publish_domain of this ModifyDomainStreamBackupResponse.

        **参数解释**： 直播推流域名 **约束限制**： 不涉及 **取值范围**： 字符长度为[1-255]位 **默认取值**： 不涉及 

        :return: The publish_domain of this ModifyDomainStreamBackupResponse.
        :rtype: str
        """
    ...
    def publish_domain(self, publish_domain):
        r"""Sets the publish_domain of this ModifyDomainStreamBackupResponse.

        **参数解释**： 直播推流域名 **约束限制**： 不涉及 **取值范围**： 字符长度为[1-255]位 **默认取值**： 不涉及 

        :param publish_domain: The publish_domain of this ModifyDomainStreamBackupResponse.
        :type publish_domain: str
        """
    ...
    def stream_backup_enable(self):
        r"""Gets the stream_backup_enable of this ModifyDomainStreamBackupResponse.

        **参数解释**： 主备流开关 **约束限制**： 不涉及 **取值范围**： - true： 开启主备流功能 - false：关闭主备流功能 **默认取值**： false 

        :return: The stream_backup_enable of this ModifyDomainStreamBackupResponse.
        :rtype: bool
        """
    ...
    def stream_backup_enable(self, stream_backup_enable):
        r"""Sets the stream_backup_enable of this ModifyDomainStreamBackupResponse.

        **参数解释**： 主备流开关 **约束限制**： 不涉及 **取值范围**： - true： 开启主备流功能 - false：关闭主备流功能 **默认取值**： false 

        :param stream_backup_enable: The stream_backup_enable of this ModifyDomainStreamBackupResponse.
        :type stream_backup_enable: bool
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ModifyDomainStreamBackupResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModifyDomainStreamBackupResponse):
            return False
