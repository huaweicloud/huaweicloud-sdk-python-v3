...
class CreateScheduleRecordTasksRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateScheduleRecordTasksRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateScheduleRecordTasksRequest):
            return False
