...
class UpdateRecordCallbackConfigRequest:
    ...
    openapi_types = {
        'id': 'str',
        'body': 'RecordCallbackConfigRequest'
    }
    ...
    def __init__(self, id=None, body=None):
        ...
        :param id: 配置ID，在创建配置成功后返回
        :type id: str
        :param body: Body of the UpdateRecordCallbackConfigRequest
    ...
    def id(self):
        ...
        :return: The id of this UpdateRecordCallbackConfigRequest.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this UpdateRecordCallbackConfigRequest.
        :type id: str
        """
        self._id = id
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateRecordCallbackConfigRequest):
            return False
