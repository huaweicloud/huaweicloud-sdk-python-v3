...
class UpdateDomainIp6SwitchRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the UpdateDomainIp6SwitchRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateDomainIp6SwitchRequest):
            return False
