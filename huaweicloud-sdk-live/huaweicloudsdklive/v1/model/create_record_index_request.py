...
class CreateRecordIndexRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateRecordIndexRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateRecordIndexRequest):
            return False
