...
class CreateUrlAuthchainRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateUrlAuthchainRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateUrlAuthchainRequest):
            return False
