...
class HlsPackageItem:
    ...
    def enable_access(self):
        r"""Gets the enable_access of this HlsPackageItem.

        当频道mode是ONLY_OS类型时，允许本输出可以直接从源站拉流，默认：false true：允许output访问 false：禁止output访问

        :return: The enable_access of this HlsPackageItem.
        :rtype: bool
        """
    ...
    def enable_access(self, enable_access):
        r"""Sets the enable_access of this HlsPackageItem.

        当频道mode是ONLY_OS类型时，允许本输出可以直接从源站拉流，默认：false true：允许output访问 false：禁止output访问

        :param enable_access: The enable_access of this HlsPackageItem.
        :type enable_access: bool
        """
    ...
    def allow_all_ip_access(self, allow_all_ip_access):
        r"""Sets the allow_all_ip_access of this HlsPackageItem.

        是否放通所有的IP访问，默认：false true：允许所有的IP地址访问，ip_whitelist配置不生效 false：不允许所有的IP地址访问，ip_whitelist生效，仅在ip_whitelist配置的ip地址才能访问

        :param allow_all_ip_access: The allow_all_ip_access of this HlsPackageItem.
        :type allow_all_ip_access: bool
        """
    ...
    def ip_whitelist(self):
        r"""Gets the ip_whitelist of this HlsPackageItem.

        当频道类型mode是ONLY_OS类型时，允许直接从源站拉流的IP白名单

        :return: The ip_whitelist of this HlsPackageItem.
        :rtype: str
        """
    ...
    def ip_whitelist(self, ip_whitelist):
        r"""Sets the ip_whitelist of this HlsPackageItem.

        当频道类型mode是ONLY_OS类型时，允许直接从源站拉流的IP白名单

        :param ip_whitelist: The ip_whitelist of this HlsPackageItem.
        :type ip_whitelist: str
        """
    ...
    def cdn_identifier_header(self):
        r"""Gets the cdn_identifier_header of this HlsPackageItem.

        :return: The cdn_identifier_header of this HlsPackageItem.
    ...
    def cdn_identifier_header(self, cdn_identifier_header):
        r"""Sets the cdn_identifier_header of this HlsPackageItem.

        :param cdn_identifier_header: The cdn_identifier_header of this HlsPackageItem.
        :type cdn_identifier_header: :class:`huaweicloudsdklive.v1.HttpHeader`
        """
    ...
    def origin_domain_master(self, origin_domain_master):
        r"""Sets the origin_domain_master of this HlsPackageItem.

        源站分发域名-主region 跟CreateOttChannelInfoReq.region一致 满足正则：^(\\[a-zA-Z0-9]([a-zA-Z0-9\\-]{0,61}[a-zA-Z0-9])?\\.){2,}[a-zA-Z]{2,16}$ 最大长度255

        :param origin_domain_master: The origin_domain_master of this HlsPackageItem.
        :type origin_domain_master: str
        """
    ...
    def origin_domain_slave(self):
        r"""Gets the origin_domain_slave of this HlsPackageItem.

        源站分发域名-备region 满足正则：^(\\[a-zA-Z0-9]([a-zA-Z0-9\\-]{0,61}[a-zA-Z0-9])?\\.){2,}[a-zA-Z]{2,16}$ 最大长度255

        :return: The origin_domain_slave of this HlsPackageItem.
        :rtype: str
        """
    ...
    def origin_domain_slave(self, origin_domain_slave):
        r"""Sets the origin_domain_slave of this HlsPackageItem.

        源站分发域名-备region 满足正则：^(\\[a-zA-Z0-9]([a-zA-Z0-9\\-]{0,61}[a-zA-Z0-9])?\\.){2,}[a-zA-Z]{2,16}$ 最大长度255

        :param origin_domain_slave: The origin_domain_slave of this HlsPackageItem.
        :type origin_domain_slave: str
        """
    ...
    def manifest_name(self):
        r"""Gets the manifest_name of this HlsPackageItem.

        output的索引文件名字 默认：index 长度：0-128 字符集：大小写字母、数字、\"-\"、\".\"、\"_\"，不能有/路径

        :return: The manifest_name of this HlsPackageItem.
        :rtype: str
        """
    ...
    def manifest_name(self, manifest_name):
        r"""Sets the manifest_name of this HlsPackageItem.

        output的索引文件名字 默认：index 长度：0-128 字符集：大小写字母、数字、\"-\"、\".\"、\"_\"，不能有/路径

        :param manifest_name: The manifest_name of this HlsPackageItem.
        :type manifest_name: str
        """
    ...
    @property
    def slave_url(self):
        r"""Gets the slave_url of this HlsPackageItem.

        客户自定义的拉流地址，包括方法、域名、路径

        :return: The slave_url of this HlsPackageItem.
        :rtype: str
        """
    ...
    def slave_url(self, slave_url):
        r"""Sets the slave_url of this HlsPackageItem.

        客户自定义的拉流地址，包括方法、域名、路径

        :param slave_url: The slave_url of this HlsPackageItem.
        :type slave_url: str
        """
