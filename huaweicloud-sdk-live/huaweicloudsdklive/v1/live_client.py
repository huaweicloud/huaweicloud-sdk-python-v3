...
class LiveClient(Client):
    ...
    def modify_domain_stream_backup(self, request):
        r"""设置域名主备流功能开关
    ...
    def modify_domain_stream_backup_invoker(self, request):
        http_info = self._modify_domain_stream_backup_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _modify_domain_stream_backup_http_info(cls, request):
        http_info = {
            "method": "PUT",
    ...
    def show_domain_stream_backup(self, request):
        r"""查询域名主备流功能开关
    ...
    def show_domain_stream_backup_invoker(self, request):
        http_info = self._show_domain_stream_backup_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_domain_stream_backup_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/{project_id}/domain/stream-backup",
            "request_type": request.__class__.__name__,
