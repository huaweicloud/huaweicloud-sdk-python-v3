...
class ChatCompletionReq:
    ...
    def __init__(self, messages=None, user=None, stream=None, temperature=None, top_p=None, max_tokens=None, n=None, presence_penalty=None, frequency_penalty=None):
        r"""ChatCompletionReq

        The model defined in huaweicloud sdk

        :param messages: 多轮对话问答对
        :type messages: list[:class:`huaweicloudsdkmastudio.v1.Message`]
        ...
        :param top_p: 一种替代温度采样的方法，称为nucleus sampling，取值范围：(0, 1]，其中模型考虑具有top_p 概率质量的标记的结果。因此 0.1 意味着只考虑构成前 10% 概率质量的标记。我们通常建议更改此值或温度，但不要同时更改两者。通常建议更改top_p或temperature来调整生成文本的倾向性，但不要同时更改这两个参数。
        :type top_p: float
    ...
    @property
    def messages(self):
        r"""Gets the messages of this ChatCompletionReq.

        多轮对话问答对

        :return: The messages of this ChatCompletionReq.
        :rtype: list[:class:`huaweicloudsdkmastudio.v1.Message`]
        """
        return self._messages

    @messages.setter
    def messages(self, messages):
        r"""Sets the messages of this ChatCompletionReq.
    ...
    @property
    def user(self):
        r"""Gets the user of this ChatCompletionReq.
    ...
    @user.setter
    def user(self, user):
        r"""Sets the user of this ChatCompletionReq.
    ...
    @property
    def stream(self):
        r"""Gets the stream of this ChatCompletionReq.
    ...
    def stream(self, stream):
        r"""Sets the stream of this ChatCompletionReq.
    ...
    def temperature(self):
        r"""Gets the temperature of this ChatCompletionReq.
    ...
    def temperature(self, temperature):
        r"""Sets the temperature of this ChatCompletionReq.
    ...
    @property
    def top_p(self):
        r"""Gets the top_p of this ChatCompletionReq.
    ...
    def top_p(self, top_p):
        r"""Sets the top_p of this ChatCompletionReq.
    ...
    @property
    def max_tokens(self):
        r"""Gets the max_tokens of this ChatCompletionReq.
    ...
    def max_tokens(self, max_tokens):
        r"""Sets the max_tokens of this ChatCompletionReq.
    ...
    @property
    def n(self):
        r"""Gets the n of this ChatCompletionReq.
    ...
    @n.setter
    def n(self, n):
        r"""Sets the n of this ChatCompletionReq.
    ...
    def presence_penalty(self):
        r"""Gets the presence_penalty of this ChatCompletionReq.
    ...
    def presence_penalty(self, presence_penalty):
        r"""Sets the presence_penalty of this ChatCompletionReq.
    ...
    def frequency_penalty(self):
        r"""Gets the frequency_penalty of this ChatCompletionReq.
        ...
        :return: The frequency_penalty of this ChatCompletionReq.
        :rtype: float
        """
    ...
    def frequency_penalty(self, frequency_penalty):
        r"""Sets the frequency_penalty of this ChatCompletionReq.

        用于调整模型对频繁出现的Token的处理方式。即如果一个Token在训练集中出现的频率较高，那么模型在生成这个Token时会受到一定的惩罚。当frequency_penalty的值为正数时，模型会更倾向于生成出现频率较低的Token，即模型会更倾向于使用不常见的词汇。最小值：-2，最大值：2

        :param frequency_penalty: The frequency_penalty of this ChatCompletionReq.
        :type frequency_penalty: float
        """
