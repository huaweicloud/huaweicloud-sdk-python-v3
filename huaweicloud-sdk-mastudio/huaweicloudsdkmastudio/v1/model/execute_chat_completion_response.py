...
class ExecuteChatCompletionResponse(SdkResponse):
    ...
    def __init__(self, id=None, created=None, choices=None, usage=None):
        ...
        :type created: int
        :param choices: 模型回复
        :type choices: list[:class:`huaweicloudsdkmastudio.v1.ChatChoice`]
        :param usage: 
        :type usage: :class:`huaweicloudsdkmastudio.v1.CompletionUsage`
        """
    ...
    def choices(self):
        ...
        :rtype: list[:class:`huaweicloudsdkmastudio.v1.ChatChoice`]
        """
    ...
    def usage(self):
        ...
        :rtype: :class:`huaweicloudsdkmastudio.v1.CompletionUsage`
        """
        return self._usage
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ExecuteChatCompletionResponse.to_dict() is deprecated and no longer maintained, "
