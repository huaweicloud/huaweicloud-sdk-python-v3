...
class MaStudioClient(Client):
    def __init__(self):
        super(MaStudioClient, self).__init__()
    ...
    def new_builder(cls, clazz=None):
        if not clazz:
            ...
            if clazz.__name__ != "MaStudioClient":
                raise TypeError("client type error, support client type is MaStudioClient")
