...
class ListSignatureKeysV2Response(SdkResponse):
    ...
    def __init__(self, size=None, total=None, signs=None):
        ...
        :type signs: list[:class:`huaweicloudsdkroma.v2.SignatureWithBindNum`]
        """
    ...
    @property
    def size(self):
        r"""Gets the size of this ListSignatureKeysV2Response.
    ...
    @size.setter
    def size(self, size):
        r"""Sets the size of this ListSignatureKeysV2Response.
    ...
    @property
    def total(self):
        r"""Gets the total of this ListSignatureKeysV2Response.
    ...
    def total(self, total):
        r"""Sets the total of this ListSignatureKeysV2Response.
    ...
    @property
    def signs(self):
        r"""Gets the signs of this ListSignatureKeysV2Response.

        本次查询到的签名密钥列表

        :return: The signs of this ListSignatureKeysV2Response.
        :rtype: list[:class:`huaweicloudsdkroma.v2.SignatureWithBindNum`]
        """
        return self._signs

    @signs.setter
    def signs(self, signs):
        r"""Sets the signs of this ListSignatureKeysV2Response.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListSignatureKeysV2Response.to_dict() is deprecated and no longer maintained, "
