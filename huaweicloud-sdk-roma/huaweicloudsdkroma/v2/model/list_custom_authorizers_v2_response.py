...
class ListCustomAuthorizersV2Response(SdkResponse):
    ...
    def __init__(self, size=None, total=None, authorizer_list=None):
        ...
        :type authorizer_list: list[:class:`huaweicloudsdkroma.v2.AuthorizerResp`]
        """
    ...
    def authorizer_list(self):
        ...
        :rtype: list[:class:`huaweicloudsdkroma.v2.AuthorizerResp`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListCustomAuthorizersV2Response.to_dict() is deprecated and no longer maintained, "
