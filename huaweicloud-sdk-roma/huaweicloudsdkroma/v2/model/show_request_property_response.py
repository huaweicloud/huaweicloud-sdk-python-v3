...
class ShowRequestPropertyResponse(SdkResponse):
    ...
    def property_id(self):
        r"""Gets the property_id of this ShowRequestPropertyResponse.
    ...
    def property_id(self, property_id):
        r"""Sets the property_id of this ShowRequestPropertyResponse.
    ...
    def property_name(self):
        r"""Gets the property_name of this ShowRequestPropertyResponse.
    ...
    def property_name(self, property_name):
        r"""Sets the property_name of this ShowRequestPropertyResponse.
    ...
    def description(self):
        r"""Gets the description of this ShowRequestPropertyResponse.
    ...
    def description(self, description):
        r"""Sets the description of this ShowRequestPropertyResponse.
    ...
    @property
    def data_type(self):
        r"""Gets the data_type of this ShowRequestPropertyResponse.
    ...
    def data_type(self, data_type):
        r"""Sets the data_type of this ShowRequestPropertyResponse.
    ...
    @property
    def required(self):
        r"""Gets the required of this ShowRequestPropertyResponse.
    ...
    def required(self, required):
        r"""Sets the required of this ShowRequestPropertyResponse.
    ...
    @property
    def min(self):
        r"""Gets the min of this ShowRequestPropertyResponse.
    ...
    @min.setter
    def min(self, min):
        r"""Sets the min of this ShowRequestPropertyResponse.
    ...
    @property
    def max(self):
        r"""Gets the max of this ShowRequestPropertyResponse.
    ...
    @max.setter
    def max(self, max):
        r"""Sets the max of this ShowRequestPropertyResponse.
    ...
    @property
    def step(self):
        r"""Gets the step of this ShowRequestPropertyResponse.
    ...
    @step.setter
    def step(self, step):
        r"""Sets the step of this ShowRequestPropertyResponse.
    ...
    @property
    def max_length(self):
        r"""Gets the max_length of this ShowRequestPropertyResponse.
    ...
    def max_length(self, max_length):
        r"""Sets the max_length of this ShowRequestPropertyResponse.
    ...
    @property
    def unit(self):
        r"""Gets the unit of this ShowRequestPropertyResponse.
    ...
    @unit.setter
    def unit(self, unit):
        r"""Sets the unit of this ShowRequestPropertyResponse.
    ...
    @property
    def enum_list(self):
        r"""Gets the enum_list of this ShowRequestPropertyResponse.
    ...
    def enum_list(self, enum_list):
        r"""Sets the enum_list of this ShowRequestPropertyResponse.
    ...
    @property
    def enum_dict(self):
        r"""Gets the enum_dict of this ShowRequestPropertyResponse.

        当数据类型为boolean枚举值时填写json格式数据，形如\"enum_dict\":{\"0\":\"xxx\",\"1\":\"xxx\"}

        :return: The enum_dict of this ShowRequestPropertyResponse.
        :rtype: object
        """
    ...
    def enum_dict(self, enum_dict):
        r"""Sets the enum_dict of this ShowRequestPropertyResponse.

        当数据类型为boolean枚举值时填写json格式数据，形如\"enum_dict\":{\"0\":\"xxx\",\"1\":\"xxx\"}

        :param enum_dict: The enum_dict of this ShowRequestPropertyResponse.
        :type enum_dict: object
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowRequestPropertyResponse.to_dict() is deprecated and no longer maintained, "
