...
class ListVpcChannelsV2Response(SdkResponse):
    ...
    def __init__(self, size=None, total=None, vpc_channels=None):
        ...
        :type vpc_channels: list[:class:`huaweicloudsdkroma.v2.VpcChannelInfo`]
        """
    ...
    def vpc_channels(self):
        ...
        :rtype: list[:class:`huaweicloudsdkroma.v2.VpcChannelInfo`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListVpcChannelsV2Response.to_dict() is deprecated and no longer maintained, "
