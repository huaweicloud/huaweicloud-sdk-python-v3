...
class BackendParam:
    ...
    def __init__(self, name=None, location=None, origin=None, value=None, remark=None, id=None, req_param_id=None):
        r"""BackendParam
    ...
    @property
    def name(self):
        r"""Gets the name of this BackendParam.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this BackendParam.
    ...
    @property
    def location(self):
        r"""Gets the location of this BackendParam.
    ...
    def location(self, location):
        r"""Sets the location of this BackendParam.
    ...
    @property
    def origin(self):
        r"""Gets the origin of this BackendParam.
    ...
    def origin(self, origin):
        r"""Sets the origin of this BackendParam.
    ...
    @property
    def value(self):
        r"""Gets the value of this BackendParam.
    ...
    def value(self, value):
        r"""Sets the value of this BackendParam.
    ...
    @property
    def remark(self):
        r"""Gets the remark of this BackendParam.
    ...
    def remark(self, remark):
        r"""Sets the remark of this BackendParam.
    ...
    @property
    def id(self):
        r"""Gets the id of this BackendParam.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this BackendParam.
    ...
    def req_param_id(self):
        r"""Gets the req_param_id of this BackendParam.
    ...
    def req_param_id(self, req_param_id):
        r"""Sets the req_param_id of this BackendParam.
