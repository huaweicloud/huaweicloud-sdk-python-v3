...
class UpdatePluginResponse(SdkResponse):
    ...
    @property
    def plugin_id(self):
        r"""Gets the plugin_id of this UpdatePluginResponse.

        插件编码。

        :return: The plugin_id of this UpdatePluginResponse.
        :rtype: str
        """
    ...
    def plugin_id(self, plugin_id):
        r"""Sets the plugin_id of this UpdatePluginResponse.

        插件编码。

        :param plugin_id: The plugin_id of this UpdatePluginResponse.
        :type plugin_id: str
        """
    ...
    def plugin_name(self):
        r"""Gets the plugin_name of this UpdatePluginResponse.

        插件名称。支持汉字，英文，数字，下划线，且只能以英文和汉字开头，3-255字符。 > 中文字符必须为UTF-8或者unicode编码。

        :return: The plugin_name of this UpdatePluginResponse.
        :rtype: str
        """
    ...
    def plugin_name(self, plugin_name):
        r"""Sets the plugin_name of this UpdatePluginResponse.

        插件名称。支持汉字，英文，数字，下划线，且只能以英文和汉字开头，3-255字符。 > 中文字符必须为UTF-8或者unicode编码。

        :param plugin_name: The plugin_name of this UpdatePluginResponse.
        :type plugin_name: str
        """
    ...
    def plugin_type(self):
        r"""Gets the plugin_type of this UpdatePluginResponse.
    ...
    def plugin_type(self, plugin_type):
        r"""Sets the plugin_type of this UpdatePluginResponse.
    ...
    def plugin_scope(self):
        r"""Gets the plugin_scope of this UpdatePluginResponse.

        插件可见范围 - global：全局可见 - app：集成应用可见

        :return: The plugin_scope of this UpdatePluginResponse.
        :rtype: str
        """
    ...
    def plugin_scope(self, plugin_scope):
        r"""Sets the plugin_scope of this UpdatePluginResponse.

        插件可见范围 - global：全局可见 - app：集成应用可见

        :param plugin_scope: The plugin_scope of this UpdatePluginResponse.
        :type plugin_scope: str
        """
    ...
    def plugin_content(self):
        r"""Gets the plugin_content of this UpdatePluginResponse.
    ...
    def plugin_content(self, plugin_content):
        r"""Sets the plugin_content of this UpdatePluginResponse.
    ...
    @property
    def remark(self):
        r"""Gets the remark of this UpdatePluginResponse.

        插件描述，255字符。 > 中文字符必须为UTF-8或者unicode编码。

        :return: The remark of this UpdatePluginResponse.
        :rtype: str
        """
        return self._remark
    ...
    def remark(self, remark):
        r"""Sets the remark of this UpdatePluginResponse.

        插件描述，255字符。 > 中文字符必须为UTF-8或者unicode编码。

        :param remark: The remark of this UpdatePluginResponse.
        :type remark: str
        """
        self._remark = remark
    ...
    def create_time(self):
        r"""Gets the create_time of this UpdatePluginResponse.

        创建时间。

        :return: The create_time of this UpdatePluginResponse.
        :rtype: datetime
        """
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this UpdatePluginResponse.

        创建时间。

        :param create_time: The create_time of this UpdatePluginResponse.
        :type create_time: datetime
        """
    ...
    def update_time(self):
        r"""Gets the update_time of this UpdatePluginResponse.

        更新时间。

        :return: The update_time of this UpdatePluginResponse.
        :rtype: datetime
        """
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this UpdatePluginResponse.

        更新时间。

        :param update_time: The update_time of this UpdatePluginResponse.
        :type update_time: datetime
        """
    ...
    def roma_app_id(self):
        r"""Gets the roma_app_id of this UpdatePluginResponse.

        归属集成应用编码，plugin_scope为app时生效

        :return: The roma_app_id of this UpdatePluginResponse.
        :rtype: str
        """
    ...
    def roma_app_id(self, roma_app_id):
        r"""Sets the roma_app_id of this UpdatePluginResponse.

        归属集成应用编码，plugin_scope为app时生效

        :param roma_app_id: The roma_app_id of this UpdatePluginResponse.
        :type roma_app_id: str
        """
    ...
    def roma_app_name(self):
        r"""Gets the roma_app_name of this UpdatePluginResponse.

        API归属的集成应用名称

        :return: The roma_app_name of this UpdatePluginResponse.
        :rtype: str
        """
    ...
    def roma_app_name(self, roma_app_name):
        r"""Sets the roma_app_name of this UpdatePluginResponse.

        API归属的集成应用名称

        :param roma_app_name: The roma_app_name of this UpdatePluginResponse.
        :type roma_app_name: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdatePluginResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdatePluginResponse):
            return False
