...
class CreateAppQuotaRequest:
    ...
    def instance_id(self):
        r"""Gets the instance_id of this CreateAppQuotaRequest.

        实例ID

        :return: The instance_id of this CreateAppQuotaRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this CreateAppQuotaRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this CreateAppQuotaRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this CreateAppQuotaRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateAppQuotaRequest):
            return False
