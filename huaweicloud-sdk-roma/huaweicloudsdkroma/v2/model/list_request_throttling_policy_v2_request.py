...
class ListRequestThrottlingPolicyV2Request:
    ...
    def __init__(self, instance_id=None, offset=None, limit=None, id=None, name=None, precise_search=None):
        r"""ListRequestThrottlingPolicyV2Request
    ...
    def instance_id(self):
        r"""Gets the instance_id of this ListRequestThrottlingPolicyV2Request.
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this ListRequestThrottlingPolicyV2Request.
    ...
    @property
    def offset(self):
        r"""Gets the offset of this ListRequestThrottlingPolicyV2Request.
    ...
    def offset(self, offset):
        r"""Sets the offset of this ListRequestThrottlingPolicyV2Request.
    ...
    @property
    def limit(self):
        r"""Gets the limit of this ListRequestThrottlingPolicyV2Request.
    ...
    def limit(self, limit):
        r"""Sets the limit of this ListRequestThrottlingPolicyV2Request.
    ...
    @property
    def id(self):
        r"""Gets the id of this ListRequestThrottlingPolicyV2Request.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this ListRequestThrottlingPolicyV2Request.
    ...
    @property
    def name(self):
        r"""Gets the name of this ListRequestThrottlingPolicyV2Request.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this ListRequestThrottlingPolicyV2Request.
    ...
    def precise_search(self):
        r"""Gets the precise_search of this ListRequestThrottlingPolicyV2Request.
    ...
    def precise_search(self, precise_search):
        r"""Sets the precise_search of this ListRequestThrottlingPolicyV2Request.
