...
class ResetMultiTaskOffsetResponse(SdkResponse):
    ...
    def message(self):
        ...
        :return: The message of this ResetMultiTaskOffsetResponse.
        :rtype: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ResetMultiTaskOffsetResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResetMultiTaskOffsetResponse):
            return False
