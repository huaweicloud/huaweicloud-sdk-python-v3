...
class AddUserToAppResponse(SdkResponse):
    ...
    @property
    def total(self):
        """Gets the total of this AddUserToAppResponse.
    ...
    def total(self, total):
        """Sets the total of this AddUserToAppResponse.
    ...
    @property
    def id(self):
        """Gets the id of this AddUserToAppResponse.
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this AddUserToAppResponse.
    ...
    @property
    def users(self):
        """Gets the users of this AddUserToAppResponse.
    ...
    def users(self, users):
        """Sets the users of this AddUserToAppResponse.
