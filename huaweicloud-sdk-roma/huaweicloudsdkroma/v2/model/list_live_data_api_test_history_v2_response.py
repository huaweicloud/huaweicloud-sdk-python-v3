...
class ListLiveDataApiTestHistoryV2Response(SdkResponse):
    ...
    def __init__(self, size=None, total=None, histories=None):
        r"""ListLiveDataApiTestHistoryV2Response
    ...
    @property
    def size(self):
        r"""Gets the size of this ListLiveDataApiTestHistoryV2Response.
    ...
    @size.setter
    def size(self, size):
        r"""Sets the size of this ListLiveDataApiTestHistoryV2Response.
    ...
    @property
    def total(self):
        r"""Gets the total of this ListLiveDataApiTestHistoryV2Response.
    ...
    def total(self, total):
        r"""Sets the total of this ListLiveDataApiTestHistoryV2Response.
    ...
    @property
    def histories(self):
        r"""Gets the histories of this ListLiveDataApiTestHistoryV2Response.
    ...
    def histories(self, histories):
        r"""Sets the histories of this ListLiveDataApiTestHistoryV2Response.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListLiveDataApiTestHistoryV2Response.to_dict() is deprecated and no longer maintained, "
