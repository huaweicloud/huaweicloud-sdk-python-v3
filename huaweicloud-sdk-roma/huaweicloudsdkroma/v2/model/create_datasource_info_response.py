...
class CreateDatasourceInfoResponse(SdkResponse):
    ...
    def __init__(self, datasource_id=None, datasource_name=None, datasource_type=None, vpc_id=None, app_id=None, app_name=None, instance_id=None, create_time=None, update_time=None, custom_plugin_id=None, content=None, description=None, app_permission=None):
        r"""CreateDatasourceInfoResponse
    ...
    def datasource_id(self):
        r"""Gets the datasource_id of this CreateDatasourceInfoResponse.

        数据源ID

        :return: The datasource_id of this CreateDatasourceInfoResponse.
        :rtype: str
        """
    ...
    def datasource_id(self, datasource_id):
        r"""Sets the datasource_id of this CreateDatasourceInfoResponse.
    ...
    def datasource_name(self):
        r"""Gets the datasource_name of this CreateDatasourceInfoResponse.

        数据源名称

        :return: The datasource_name of this CreateDatasourceInfoResponse.
        :rtype: str
        """
    ...
    def datasource_name(self, datasource_name):
        r"""Sets the datasource_name of this CreateDatasourceInfoResponse.
    ...
    def datasource_type(self):
        r"""Gets the datasource_type of this CreateDatasourceInfoResponse.
        ...
        :return: The datasource_type of this CreateDatasourceInfoResponse.
        :rtype: str
        """
    ...
    def datasource_type(self, datasource_type):
        r"""Sets the datasource_type of this CreateDatasourceInfoResponse.
    ...
    @property
    def vpc_id(self):
        r"""Gets the vpc_id of this CreateDatasourceInfoResponse.

        数据源所属虚拟私有云VpcId

        :return: The vpc_id of this CreateDatasourceInfoResponse.
        :rtype: str
        """
        return self._vpc_id
    ...
    def vpc_id(self, vpc_id):
        r"""Sets the vpc_id of this CreateDatasourceInfoResponse.
    ...
    @property
    def app_id(self):
        r"""Gets the app_id of this CreateDatasourceInfoResponse.

        数据源所属应用ID

        :return: The app_id of this CreateDatasourceInfoResponse.
        :rtype: str
        """
        return self._app_id
    ...
    def app_id(self, app_id):
        r"""Sets the app_id of this CreateDatasourceInfoResponse.
    ...
    @property
    def app_name(self):
        r"""Gets the app_name of this CreateDatasourceInfoResponse.

        数据源所属应用名称

        :return: The app_name of this CreateDatasourceInfoResponse.
        :rtype: str
        """
    ...
    def app_name(self, app_name):
        r"""Sets the app_name of this CreateDatasourceInfoResponse.
    ...
    def instance_id(self):
        r"""Gets the instance_id of this CreateDatasourceInfoResponse.

        数据源所属实例Id

        :return: The instance_id of this CreateDatasourceInfoResponse.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this CreateDatasourceInfoResponse.
    ...
    def create_time(self):
        r"""Gets the create_time of this CreateDatasourceInfoResponse.

        数据源创建时间

        :return: The create_time of this CreateDatasourceInfoResponse.
        :rtype: int
        """
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this CreateDatasourceInfoResponse.
    ...
    def update_time(self):
        r"""Gets the update_time of this CreateDatasourceInfoResponse.

        数据源修改时间

        :return: The update_time of this CreateDatasourceInfoResponse.
        :rtype: int
        """
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this CreateDatasourceInfoResponse.
    ...
    def custom_plugin_id(self):
        r"""Gets the custom_plugin_id of this CreateDatasourceInfoResponse.

        数据源所属连接器Id

        :return: The custom_plugin_id of this CreateDatasourceInfoResponse.
        :rtype: str
        """
    ...
    def custom_plugin_id(self, custom_plugin_id):
        r"""Sets the custom_plugin_id of this CreateDatasourceInfoResponse.
    ...
    @property
    def content(self):
        r"""Gets the content of this CreateDatasourceInfoResponse.
    ...
    def content(self, content):
        r"""Sets the content of this CreateDatasourceInfoResponse.
    ...
    def description(self):
        r"""Gets the description of this CreateDatasourceInfoResponse.

        数据源描述

        :return: The description of this CreateDatasourceInfoResponse.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this CreateDatasourceInfoResponse.
    ...
    def app_permission(self):
        r"""Gets the app_permission of this CreateDatasourceInfoResponse.

        集成应用权限信息 - read (读权限) - access (调用权限) - delete (删除权限) - modify (修改权限)

        :return: The app_permission of this CreateDatasourceInfoResponse.
        :rtype: list[str]
        """
    ...
    def app_permission(self, app_permission):
        r"""Sets the app_permission of this CreateDatasourceInfoResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateDatasourceInfoResponse):
            return False
