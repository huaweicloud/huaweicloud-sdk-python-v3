...
class UpdateDeviceGroupResponse(SdkResponse):
    ...
    @property
    def app_name(self):
        """Gets the app_name of this UpdateDeviceGroupResponse.

        应用名称

        :return: The app_name of this UpdateDeviceGroupResponse.
        :rtype: str
        """
    ...
    def app_name(self, app_name):
        """Sets the app_name of this UpdateDeviceGroupResponse.

        应用名称

        :param app_name: The app_name of this UpdateDeviceGroupResponse.
        :type app_name: str
        """
