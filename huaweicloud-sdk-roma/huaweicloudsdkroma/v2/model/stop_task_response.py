...
class StopTaskResponse(SdkResponse):
    ...
    @property
    def message(self):
        r"""Gets the message of this StopTaskResponse.
    ...
    def message(self, message):
        r"""Sets the message of this StopTaskResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("StopTaskResponse.to_dict() is deprecated and no longer maintained, "
