...
class ListAppsV2Response(SdkResponse):
    ...
    def __init__(self, size=None, total=None, apps=None):
        ...
        :type total: int
        :param apps: APP列表
        :type apps: list[:class:`huaweicloudsdkroma.v2.AppInfoWithBindNum`]
        """
    ...
    def apps(self):
        ...
        :rtype: list[:class:`huaweicloudsdkroma.v2.AppInfoWithBindNum`]
        """
        return self._apps
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAppsV2Response.to_dict() is deprecated and no longer maintained, "
