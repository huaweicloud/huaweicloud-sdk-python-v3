...
class ShowDetailsOfDomainNameCertificateV2Response(SdkResponse):
    ...
    def algorithm_type(self):
        r"""Gets the algorithm_type of this ShowDetailsOfDomainNameCertificateV2Response.

        证书算法类型： - RSA - ECC - SM2  [暂不支持](tag:hws;hws_hk;g42;Site)

        :return: The algorithm_type of this ShowDetailsOfDomainNameCertificateV2Response.
        :rtype: str
        """
    ...
    def algorithm_type(self, algorithm_type):
        r"""Sets the algorithm_type of this ShowDetailsOfDomainNameCertificateV2Response.

        证书算法类型： - RSA - ECC - SM2  [暂不支持](tag:hws;hws_hk;g42;Site)

        :param algorithm_type: The algorithm_type of this ShowDetailsOfDomainNameCertificateV2Response.
        :type algorithm_type: str
        """
    ...
    def is_has_trusted_root_ca(self):
        r"""Gets the is_has_trusted_root_ca of this ShowDetailsOfDomainNameCertificateV2Response.

        是否存在信任的根证书CA。当绑定证书存在trusted_root_ca时为true。  [暂不支持](tag:fcs;hcs;g42;Site)

        :return: The is_has_trusted_root_ca of this ShowDetailsOfDomainNameCertificateV2Response.
        :rtype: bool
        """
    ...
    def is_has_trusted_root_ca(self, is_has_trusted_root_ca):
        r"""Sets the is_has_trusted_root_ca of this ShowDetailsOfDomainNameCertificateV2Response.

        是否存在信任的根证书CA。当绑定证书存在trusted_root_ca时为true。  [暂不支持](tag:fcs;hcs;g42;Site)

        :param is_has_trusted_root_ca: The is_has_trusted_root_ca of this ShowDetailsOfDomainNameCertificateV2Response.
        :type is_has_trusted_root_ca: bool
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowDetailsOfDomainNameCertificateV2Response.to_dict() is deprecated and no longer maintained, "
