...
class CreateApiGroupV2Response(SdkResponse):
    ...
    @property
    def id(self):
        r"""Gets the id of this CreateApiGroupV2Response.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this CreateApiGroupV2Response.
    ...
    @property
    def name(self):
        r"""Gets the name of this CreateApiGroupV2Response.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this CreateApiGroupV2Response.
    ...
    @property
    def status(self):
        r"""Gets the status of this CreateApiGroupV2Response.
    ...
    def status(self, status):
        r"""Sets the status of this CreateApiGroupV2Response.
    ...
    @property
    def sl_domain(self):
        r"""Gets the sl_domain of this CreateApiGroupV2Response.
    ...
    def sl_domain(self, sl_domain):
        r"""Sets the sl_domain of this CreateApiGroupV2Response.
    ...
    def register_time(self):
        r"""Gets the register_time of this CreateApiGroupV2Response.
    ...
    def register_time(self, register_time):
        r"""Sets the register_time of this CreateApiGroupV2Response.
    ...
    def update_time(self):
        r"""Gets the update_time of this CreateApiGroupV2Response.
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this CreateApiGroupV2Response.
    ...
    def on_sell_status(self):
        r"""Gets the on_sell_status of this CreateApiGroupV2Response.
    ...
    def on_sell_status(self, on_sell_status):
        r"""Sets the on_sell_status of this CreateApiGroupV2Response.
    ...
    def url_domains(self):
        r"""Gets the url_domains of this CreateApiGroupV2Response.
    ...
    def url_domains(self, url_domains):
        r"""Sets the url_domains of this CreateApiGroupV2Response.
    ...
    @property
    def sl_domains(self):
        r"""Gets the sl_domains of this CreateApiGroupV2Response.

        系统默认分配的子域名列表

        :return: The sl_domains of this CreateApiGroupV2Response.
        :rtype: list[str]
        """
    ...
    def sl_domains(self, sl_domains):
        r"""Sets the sl_domains of this CreateApiGroupV2Response.

        系统默认分配的子域名列表

        :param sl_domains: The sl_domains of this CreateApiGroupV2Response.
        :type sl_domains: list[str]
        """
    ...
    @property
    def remark(self):
        r"""Gets the remark of this CreateApiGroupV2Response.

        描述

        :return: The remark of this CreateApiGroupV2Response.
        :rtype: str
        """
        return self._remark
    ...
    def remark(self, remark):
        r"""Sets the remark of this CreateApiGroupV2Response.

        描述

        :param remark: The remark of this CreateApiGroupV2Response.
        :type remark: str
        """
        self._remark = remark
    ...
    def call_limits(self):
        r"""Gets the call_limits of this CreateApiGroupV2Response.

        流控时长内分组下的API的总访问次数限制，默认不限，请根据服务的负载能力自行设置  暂不支持

        :return: The call_limits of this CreateApiGroupV2Response.
        :rtype: int
        """
    ...
    def call_limits(self, call_limits):
        r"""Sets the call_limits of this CreateApiGroupV2Response.

        流控时长内分组下的API的总访问次数限制，默认不限，请根据服务的负载能力自行设置  暂不支持

        :param call_limits: The call_limits of this CreateApiGroupV2Response.
        :type call_limits: int
        """
    ...
    def time_interval(self):
        r"""Gets the time_interval of this CreateApiGroupV2Response.

        流控时长  暂不支持

        :return: The time_interval of this CreateApiGroupV2Response.
        :rtype: int
        """
    ...
    def time_interval(self, time_interval):
        r"""Sets the time_interval of this CreateApiGroupV2Response.

        流控时长  暂不支持

        :param time_interval: The time_interval of this CreateApiGroupV2Response.
        :type time_interval: int
        """
    ...
    @property
    def time_unit(self):
        r"""Gets the time_unit of this CreateApiGroupV2Response.

        流控的时间单位  暂不支持

        :return: The time_unit of this CreateApiGroupV2Response.
        :rtype: str
        """
    ...
    def time_unit(self, time_unit):
        r"""Sets the time_unit of this CreateApiGroupV2Response.

        流控的时间单位  暂不支持

        :param time_unit: The time_unit of this CreateApiGroupV2Response.
        :type time_unit: str
        """
    ...
    @property
    def is_default(self):
        r"""Gets the is_default of this CreateApiGroupV2Response.

        是否为默认分组

        :return: The is_default of this CreateApiGroupV2Response.
        :rtype: int
        """
    ...
    def is_default(self, is_default):
        r"""Sets the is_default of this CreateApiGroupV2Response.

        是否为默认分组

        :param is_default: The is_default of this CreateApiGroupV2Response.
        :type is_default: int
        """
    ...
    @property
    def version(self):
        r"""Gets the version of this CreateApiGroupV2Response.
    ...
    def version(self, version):
        r"""Sets the version of this CreateApiGroupV2Response.
    ...
    def roma_app_id(self):
        r"""Gets the roma_app_id of this CreateApiGroupV2Response.
    ...
    def roma_app_id(self, roma_app_id):
        r"""Sets the roma_app_id of this CreateApiGroupV2Response.
    ...
    def roma_app_name(self):
        r"""Gets the roma_app_name of this CreateApiGroupV2Response.
    ...
    def roma_app_name(self, roma_app_name):
        r"""Sets the roma_app_name of this CreateApiGroupV2Response.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateApiGroupV2Response.to_dict() is deprecated and no longer maintained, "
