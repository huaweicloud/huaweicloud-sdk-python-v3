...
class ShowTaskRequest:
    ...
    def instance_id(self):
        r"""Gets the instance_id of this ShowTaskRequest.

        实例ID

        :return: The instance_id of this ShowTaskRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this ShowTaskRequest.

        实例ID

        :param instance_id: The instance_id of this ShowTaskRequest.
        :type instance_id: str
        """
