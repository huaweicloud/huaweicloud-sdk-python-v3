...
class CertificateForm:
    ...
    def __init__(self, name=None, cert_content=None, private_key=None, type=None, instance_id=None, trusted_root_ca=None, algorithm_type=None, cert_content_sign=None, private_key_sign=None):
        ...
        :param type: 证书可见范围： - instance - global  编辑证书时不支持修改为其他可见范围
        :type type: str
        ...
        :param cert_content_sign: 签名类型证书内容，仅algorithm_type&#x3D;SM2时必填  [暂不支持](tag:hws;hws_hk;g42;Site)
        :type cert_content_sign: str
        :param private_key_sign: 签名类型私钥内容，仅algorithm_type&#x3D;SM2时必填  [暂不支持](tag:hws;hws_hk;g42;Site)
