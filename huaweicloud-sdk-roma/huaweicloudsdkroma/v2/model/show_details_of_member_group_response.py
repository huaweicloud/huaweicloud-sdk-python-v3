...
class ShowDetailsOfMemberGroupResponse(SdkResponse):
    ...
    def __init__(self, member_group_name=None, member_group_remark=None, member_group_weight=None, dict_code=None, microservice_version=None, microservice_port=None, microservice_labels=None, member_group_id=None, create_time=None, update_time=None):
        r"""ShowDetailsOfMemberGroupResponse
    ...
    def member_group_name(self):
        r"""Gets the member_group_name of this ShowDetailsOfMemberGroupResponse.

        VPC通道后端服务器组名称

        :return: The member_group_name of this ShowDetailsOfMemberGroupResponse.
        :rtype: str
        """
    ...
    def member_group_name(self, member_group_name):
        r"""Sets the member_group_name of this ShowDetailsOfMemberGroupResponse.

        VPC通道后端服务器组名称

        :param member_group_name: The member_group_name of this ShowDetailsOfMemberGroupResponse.
        :type member_group_name: str
        """
    ...
    def member_group_remark(self):
        r"""Gets the member_group_remark of this ShowDetailsOfMemberGroupResponse.

        VPC通道后端服务器组描述

        :return: The member_group_remark of this ShowDetailsOfMemberGroupResponse.
        :rtype: str
        """
    ...
    def member_group_remark(self, member_group_remark):
        r"""Sets the member_group_remark of this ShowDetailsOfMemberGroupResponse.

        VPC通道后端服务器组描述

        :param member_group_remark: The member_group_remark of this ShowDetailsOfMemberGroupResponse.
        :type member_group_remark: str
        """
    ...
    def member_group_weight(self):
        r"""Gets the member_group_weight of this ShowDetailsOfMemberGroupResponse.

        VPC通道后端服务器组权重值。  当前服务器组存在服务器且此权重值存在时，自动使用此权重值分配权重。

        :return: The member_group_weight of this ShowDetailsOfMemberGroupResponse.
        :rtype: int
        """
    ...
    def member_group_weight(self, member_group_weight):
        r"""Sets the member_group_weight of this ShowDetailsOfMemberGroupResponse.

        VPC通道后端服务器组权重值。  当前服务器组存在服务器且此权重值存在时，自动使用此权重值分配权重。

        :param member_group_weight: The member_group_weight of this ShowDetailsOfMemberGroupResponse.
        :type member_group_weight: int
        """
    ...
    @property
    def dict_code(self):
        r"""Gets the dict_code of this ShowDetailsOfMemberGroupResponse.

        VPC通道后端服务器组的字典编码  支持英文，数字，特殊字符（-_.）  暂不支持

        :return: The dict_code of this ShowDetailsOfMemberGroupResponse.
        :rtype: str
        """
    ...
    def dict_code(self, dict_code):
        r"""Sets the dict_code of this ShowDetailsOfMemberGroupResponse.

        VPC通道后端服务器组的字典编码  支持英文，数字，特殊字符（-_.）  暂不支持

        :param dict_code: The dict_code of this ShowDetailsOfMemberGroupResponse.
        :type dict_code: str
        """
    ...
    def microservice_version(self):
        r"""Gets the microservice_version of this ShowDetailsOfMemberGroupResponse.

        VPC通道后端服务器组的版本，仅VPC通道类型为微服务时支持。

        :return: The microservice_version of this ShowDetailsOfMemberGroupResponse.
        :rtype: str
        """
    ...
    def microservice_version(self, microservice_version):
        r"""Sets the microservice_version of this ShowDetailsOfMemberGroupResponse.

        VPC通道后端服务器组的版本，仅VPC通道类型为微服务时支持。

        :param microservice_version: The microservice_version of this ShowDetailsOfMemberGroupResponse.
        :type microservice_version: str
        """
    ...
    def microservice_port(self):
        r"""Gets the microservice_port of this ShowDetailsOfMemberGroupResponse.

        VPC通道后端服务器组的端口号，仅VPC通道类型为微服务时支持。端口号为0时后端服务器组下的所有地址沿用原来负载端口继承逻辑。

        :return: The microservice_port of this ShowDetailsOfMemberGroupResponse.
        :rtype: int
        """
    ...
    def microservice_port(self, microservice_port):
        r"""Sets the microservice_port of this ShowDetailsOfMemberGroupResponse.

        VPC通道后端服务器组的端口号，仅VPC通道类型为微服务时支持。端口号为0时后端服务器组下的所有地址沿用原来负载端口继承逻辑。

        :param microservice_port: The microservice_port of this ShowDetailsOfMemberGroupResponse.
        :type microservice_port: int
        """
    ...
    def microservice_labels(self):
        r"""Gets the microservice_labels of this ShowDetailsOfMemberGroupResponse.

        VPC通道后端服务器组的标签，仅VPC通道类型为微服务时支持。

        :return: The microservice_labels of this ShowDetailsOfMemberGroupResponse.
    ...
    def microservice_labels(self, microservice_labels):
        r"""Sets the microservice_labels of this ShowDetailsOfMemberGroupResponse.

        VPC通道后端服务器组的标签，仅VPC通道类型为微服务时支持。

        :param microservice_labels: The microservice_labels of this ShowDetailsOfMemberGroupResponse.
        :type microservice_labels: list[:class:`huaweicloudsdkroma.v2.MicroserviceLabel`]
        """
    ...
    def member_group_id(self):
        r"""Gets the member_group_id of this ShowDetailsOfMemberGroupResponse.

        VPC通道后端服务器组编号

        :return: The member_group_id of this ShowDetailsOfMemberGroupResponse.
        :rtype: str
        """
    ...
    def member_group_id(self, member_group_id):
        r"""Sets the member_group_id of this ShowDetailsOfMemberGroupResponse.

        VPC通道后端服务器组编号

        :param member_group_id: The member_group_id of this ShowDetailsOfMemberGroupResponse.
        :type member_group_id: str
        """
    ...
    def create_time(self):
        r"""Gets the create_time of this ShowDetailsOfMemberGroupResponse.

        VPC通道后端服务器组创建时间

        :return: The create_time of this ShowDetailsOfMemberGroupResponse.
        :rtype: datetime
        """
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this ShowDetailsOfMemberGroupResponse.

        VPC通道后端服务器组创建时间

        :param create_time: The create_time of this ShowDetailsOfMemberGroupResponse.
        :type create_time: datetime
        """
    ...
    def update_time(self):
        r"""Gets the update_time of this ShowDetailsOfMemberGroupResponse.

        VPC通道后端服务器组更新时间

        :return: The update_time of this ShowDetailsOfMemberGroupResponse.
        :rtype: datetime
        """
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this ShowDetailsOfMemberGroupResponse.

        VPC通道后端服务器组更新时间

        :param update_time: The update_time of this ShowDetailsOfMemberGroupResponse.
        :type update_time: datetime
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowDetailsOfMemberGroupResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowDetailsOfMemberGroupResponse):
            return False
