...
class CreateProductResponse(SdkResponse):
    ...
    def permissions(self):
        r"""Gets the permissions of this CreateProductResponse.

        权限

        :return: The permissions of this CreateProductResponse.
        :rtype: list[str]
        """
    ...
    def permissions(self, permissions):
        r"""Sets the permissions of this CreateProductResponse.
    ...
    @property
    def id(self):
        r"""Gets the id of this CreateProductResponse.

        产品ID

        :return: The id of this CreateProductResponse.
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this CreateProductResponse.
    ...
    def product_serial(self):
        r"""Gets the product_serial of this CreateProductResponse.

        产品唯一序列（系统唯一值，用于MQS的TOPIC中标记产品）

        :return: The product_serial of this CreateProductResponse.
        :rtype: str
        """
    ...
    def product_serial(self, product_serial):
        r"""Sets the product_serial of this CreateProductResponse.
    ...
    @property
    def app_id(self):
        r"""Gets the app_id of this CreateProductResponse.

        应用ID

        :return: The app_id of this CreateProductResponse.
        :rtype: str
        """
        return self._app_id
    ...
    def app_id(self, app_id):
        r"""Sets the app_id of this CreateProductResponse.
    ...
    @property
    def name(self):
        r"""Gets the name of this CreateProductResponse.

        产品名称，创建产品时租户内唯一，长度最大64，仅支持中文，英文字母，数字，下划线和中划线

        :return: The name of this CreateProductResponse.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this CreateProductResponse.
    ...
    def manufacturer_id(self):
        r"""Gets the manufacturer_id of this CreateProductResponse.

        产品供应商ID

        :return: The manufacturer_id of this CreateProductResponse.
        :rtype: str
        """
    ...
    def manufacturer_id(self, manufacturer_id):
        r"""Sets the manufacturer_id of this CreateProductResponse.
    ...
    def manufacturer_name(self):
        r"""Gets the manufacturer_name of this CreateProductResponse.

        厂商名称

        :return: The manufacturer_name of this CreateProductResponse.
        :rtype: str
        """
    ...
    def manufacturer_name(self, manufacturer_name):
        r"""Sets the manufacturer_name of this CreateProductResponse.
    ...
    @property
    def model(self):
        r"""Gets the model of this CreateProductResponse.

        产品型号

        :return: The model of this CreateProductResponse.
        :rtype: str
        """
        return self._model
    ...
    def model(self, model):
        r"""Sets the model of this CreateProductResponse.
    ...
    def product_type(self):
        r"""Gets the product_type of this CreateProductResponse.

        产品类型，0-普通产品(不支持子设备) 1-网关产品

        :return: The product_type of this CreateProductResponse.
        :rtype: int
        """
    ...
    def product_type(self, product_type):
        r"""Sets the product_type of this CreateProductResponse.
    ...
    def description(self):
        r"""Gets the description of this CreateProductResponse.

        产品描述，长度0-200

        :return: The description of this CreateProductResponse.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this CreateProductResponse.
    ...
    def protocol_type(self):
        r"""Gets the protocol_type of this CreateProductResponse.

        产品的协议类型 0-mqtt 2-modbus 4-opcua

        :return: The protocol_type of this CreateProductResponse.
        :rtype: int
        """
    ...
    def protocol_type(self, protocol_type):
        r"""Sets the protocol_type of this CreateProductResponse.
    ...
    def device_type(self):
        r"""Gets the device_type of this CreateProductResponse.

        产品的设备类型（默认Default）

        :return: The device_type of this CreateProductResponse.
        :rtype: str
        """
    ...
    def device_type(self, device_type):
        r"""Sets the device_type of this CreateProductResponse.
    ...
    @property
    def version(self):
        r"""Gets the version of this CreateProductResponse.

        产品版本

        :return: The version of this CreateProductResponse.
        :rtype: str
        """
    ...
    def version(self, version):
        r"""Sets the version of this CreateProductResponse.
    ...
    def created_user(self):
        r"""Gets the created_user of this CreateProductResponse.
    ...
    def created_user(self, created_user):
        r"""Sets the created_user of this CreateProductResponse.
    ...
    def last_updated_user(self):
        r"""Gets the last_updated_user of this CreateProductResponse.
    ...
    def last_updated_user(self, last_updated_user):
        r"""Sets the last_updated_user of this CreateProductResponse.
    ...
    def authentication(self):
        r"""Gets the authentication of this CreateProductResponse.
    ...
    def authentication(self, authentication):
        r"""Sets the authentication of this CreateProductResponse.
    ...
    def created_datetime(self):
        r"""Gets the created_datetime of this CreateProductResponse.

        创建时间，timestamp(ms)，使用UTC时区

        :return: The created_datetime of this CreateProductResponse.
        :rtype: int
        """
    ...
    def created_datetime(self, created_datetime):
        r"""Sets the created_datetime of this CreateProductResponse.
    ...
    @property
    def app_name(self):
        r"""Gets the app_name of this CreateProductResponse.

        应用名称

        :return: The app_name of this CreateProductResponse.
        :rtype: str
        """
    ...
    def app_name(self, app_name):
        r"""Sets the app_name of this CreateProductResponse.
    ...
    def data_format(self):
        r"""Gets the data_format of this CreateProductResponse.

        data_format 0-JSON 1-USER_DEFINED

        :return: The data_format of this CreateProductResponse.
        :rtype: int
        """
    ...
    def data_format(self, data_format):
        r"""Sets the data_format of this CreateProductResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateProductResponse.to_dict() is deprecated and no longer maintained, "
