...
class ListApiAttachedPluginsResponse(SdkResponse):
    ...
    def __init__(self, size=None, total=None, plugins=None):
        ...
        :type plugins: list[:class:`huaweicloudsdkroma.v2.AttachedPluginInfo`]
        """
    ...
    def plugins(self):
        ...
        :rtype: list[:class:`huaweicloudsdkroma.v2.AttachedPluginInfo`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListApiAttachedPluginsResponse.to_dict() is deprecated and no longer maintained, "
