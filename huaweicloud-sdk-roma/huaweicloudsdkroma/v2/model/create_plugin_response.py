...
class CreatePluginResponse(SdkResponse):
    ...
    def roma_app_id(self):
        r"""Gets the roma_app_id of this CreatePluginResponse.

        归属集成应用编码，plugin_scope为app时生效

        :return: The roma_app_id of this CreatePluginResponse.
        :rtype: str
        """
    ...
    def roma_app_id(self, roma_app_id):
        r"""Sets the roma_app_id of this CreatePluginResponse.

        归属集成应用编码，plugin_scope为app时生效

        :param roma_app_id: The roma_app_id of this CreatePluginResponse.
        :type roma_app_id: str
        """
    ...
    def roma_app_name(self):
        r"""Gets the roma_app_name of this CreatePluginResponse.

        API归属的集成应用名称

        :return: The roma_app_name of this CreatePluginResponse.
        :rtype: str
        """
    ...
    def roma_app_name(self, roma_app_name):
        r"""Sets the roma_app_name of this CreatePluginResponse.

        API归属的集成应用名称

        :param roma_app_name: The roma_app_name of this CreatePluginResponse.
        :type roma_app_name: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreatePluginResponse.to_dict() is deprecated and no longer maintained, "
