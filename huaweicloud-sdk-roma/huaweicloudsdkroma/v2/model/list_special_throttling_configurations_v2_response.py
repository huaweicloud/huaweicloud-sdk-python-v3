...
class ListSpecialThrottlingConfigurationsV2Response(SdkResponse):
    ...
    def __init__(self, size=None, total=None, throttle_specials=None):
        ...
        :type throttle_specials: list[:class:`huaweicloudsdkroma.v2.ThrottleSpecialInfo`]
        """
    ...
    def throttle_specials(self):
        ...
        :rtype: list[:class:`huaweicloudsdkroma.v2.ThrottleSpecialInfo`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListSpecialThrottlingConfigurationsV2Response.to_dict() is deprecated and no longer maintained, "
