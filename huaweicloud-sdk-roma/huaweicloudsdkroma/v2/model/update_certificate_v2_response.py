...
class UpdateCertificateV2Response(SdkResponse):
    ...
    @property
    def id(self):
        r"""Gets the id of this UpdateCertificateV2Response.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this UpdateCertificateV2Response.
    ...
    @property
    def name(self):
        r"""Gets the name of this UpdateCertificateV2Response.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this UpdateCertificateV2Response.
    ...
    @property
    def type(self):
        r"""Gets the type of this UpdateCertificateV2Response.
    ...
    @type.setter
    def type(self, type):
        r"""Sets the type of this UpdateCertificateV2Response.
    ...
    def instance_id(self):
        r"""Gets the instance_id of this UpdateCertificateV2Response.
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this UpdateCertificateV2Response.
    ...
    @property
    def project_id(self):
        r"""Gets the project_id of this UpdateCertificateV2Response.
    ...
    def project_id(self, project_id):
        r"""Sets the project_id of this UpdateCertificateV2Response.
    ...
    def common_name(self):
        r"""Gets the common_name of this UpdateCertificateV2Response.
    ...
    def common_name(self, common_name):
        r"""Sets the common_name of this UpdateCertificateV2Response.
    ...
    @property
    def san(self):
        r"""Gets the san of this UpdateCertificateV2Response.
    ...
    @san.setter
    def san(self, san):
        r"""Sets the san of this UpdateCertificateV2Response.
    ...
    @property
    def not_after(self):
        r"""Gets the not_after of this UpdateCertificateV2Response.
    ...
    def not_after(self, not_after):
        r"""Sets the not_after of this UpdateCertificateV2Response.
    ...
    def signature_algorithm(self):
        r"""Gets the signature_algorithm of this UpdateCertificateV2Response.
    ...
    def signature_algorithm(self, signature_algorithm):
        r"""Sets the signature_algorithm of this UpdateCertificateV2Response.
    ...
    def create_time(self):
        r"""Gets the create_time of this UpdateCertificateV2Response.
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this UpdateCertificateV2Response.
    ...
    def update_time(self):
        r"""Gets the update_time of this UpdateCertificateV2Response.
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this UpdateCertificateV2Response.
    ...
    def algorithm_type(self):
        r"""Gets the algorithm_type of this UpdateCertificateV2Response.

        证书算法类型： - RSA - ECC - SM2  [暂不支持](tag:hws;hws_hk;g42;Site)

        :return: The algorithm_type of this UpdateCertificateV2Response.
        :rtype: str
        """
    ...
    def algorithm_type(self, algorithm_type):
        r"""Sets the algorithm_type of this UpdateCertificateV2Response.

        证书算法类型： - RSA - ECC - SM2  [暂不支持](tag:hws;hws_hk;g42;Site)

        :param algorithm_type: The algorithm_type of this UpdateCertificateV2Response.
        :type algorithm_type: str
        """
    ...
    def is_has_trusted_root_ca(self):
        r"""Gets the is_has_trusted_root_ca of this UpdateCertificateV2Response.

        是否存在信任的根证书CA。当绑定证书存在trusted_root_ca时为true。  [暂不支持](tag:fcs;hcs;g42;Site)

        :return: The is_has_trusted_root_ca of this UpdateCertificateV2Response.
        :rtype: bool
        """
    ...
    def is_has_trusted_root_ca(self, is_has_trusted_root_ca):
        r"""Sets the is_has_trusted_root_ca of this UpdateCertificateV2Response.

        是否存在信任的根证书CA。当绑定证书存在trusted_root_ca时为true。  [暂不支持](tag:fcs;hcs;g42;Site)

        :param is_has_trusted_root_ca: The is_has_trusted_root_ca of this UpdateCertificateV2Response.
        :type is_has_trusted_root_ca: bool
        """
    ...
    @property
    def version(self):
        r"""Gets the version of this UpdateCertificateV2Response.
    ...
    def version(self, version):
        r"""Sets the version of this UpdateCertificateV2Response.
    ...
    def organization(self):
        r"""Gets the organization of this UpdateCertificateV2Response.
    ...
    def organization(self, organization):
        r"""Sets the organization of this UpdateCertificateV2Response.
    ...
    def organizational_unit(self):
        r"""Gets the organizational_unit of this UpdateCertificateV2Response.
    ...
    def organizational_unit(self, organizational_unit):
        r"""Sets the organizational_unit of this UpdateCertificateV2Response.
    ...
    @property
    def locality(self):
        r"""Gets the locality of this UpdateCertificateV2Response.
    ...
    def locality(self, locality):
        r"""Sets the locality of this UpdateCertificateV2Response.
    ...
    @property
    def state(self):
        r"""Gets the state of this UpdateCertificateV2Response.
    ...
    def state(self, state):
        r"""Sets the state of this UpdateCertificateV2Response.
    ...
    @property
    def country(self):
        r"""Gets the country of this UpdateCertificateV2Response.
    ...
    def country(self, country):
        r"""Sets the country of this UpdateCertificateV2Response.
    ...
    @property
    def not_before(self):
        r"""Gets the not_before of this UpdateCertificateV2Response.
    ...
    def not_before(self, not_before):
        r"""Sets the not_before of this UpdateCertificateV2Response.
    ...
    def serial_number(self):
        r"""Gets the serial_number of this UpdateCertificateV2Response.
    ...
    def serial_number(self, serial_number):
        r"""Sets the serial_number of this UpdateCertificateV2Response.
    ...
    @property
    def issuer(self):
        r"""Gets the issuer of this UpdateCertificateV2Response.
    ...
    def issuer(self, issuer):
        r"""Sets the issuer of this UpdateCertificateV2Response.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateCertificateV2Response.to_dict() is deprecated and no longer maintained, "
