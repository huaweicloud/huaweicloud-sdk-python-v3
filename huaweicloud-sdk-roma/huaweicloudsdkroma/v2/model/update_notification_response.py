...
class UpdateNotificationResponse(SdkResponse):
    ...
    @property
    def type(self):
        r"""Gets the type of this UpdateNotificationResponse.

        订阅类型, 0:设备上线通知类型, 1:设备下线通知类型, 2:设备添加通知类型, 3:设备删除通知类型, 4:设备变更通知类型

        :return: The type of this UpdateNotificationResponse.
        :rtype: int
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        r"""Sets the type of this UpdateNotificationResponse.
    ...
    @property
    def topic(self):
        r"""Gets the topic of this UpdateNotificationResponse.

        订阅的topic名称

        :return: The topic of this UpdateNotificationResponse.
        :rtype: str
        """
        return self._topic
    ...
    def topic(self, topic):
        r"""Sets the topic of this UpdateNotificationResponse.
    ...
    def instance_id(self):
        r"""Gets the instance_id of this UpdateNotificationResponse.

        实例ID

        :return: The instance_id of this UpdateNotificationResponse.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this UpdateNotificationResponse.
    ...
    @property
    def app_id(self):
        r"""Gets the app_id of this UpdateNotificationResponse.

        应用ID

        :return: The app_id of this UpdateNotificationResponse.
        :rtype: str
        """
        return self._app_id
    ...
    def app_id(self, app_id):
        r"""Sets the app_id of this UpdateNotificationResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateNotificationResponse.to_dict() is deprecated and no longer maintained, "
