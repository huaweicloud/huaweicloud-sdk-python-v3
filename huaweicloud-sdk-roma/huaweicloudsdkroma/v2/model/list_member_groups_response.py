...
class ListMemberGroupsResponse(SdkResponse):
    ...
    @property
    def size(self):
        r"""Gets the size of this ListMemberGroupsResponse.

        本次返回的列表长度

        :return: The size of this ListMemberGroupsResponse.
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        r"""Sets the size of this ListMemberGroupsResponse.
    ...
    @property
    def total(self):
        r"""Gets the total of this ListMemberGroupsResponse.

        满足条件的记录数

        :return: The total of this ListMemberGroupsResponse.
        :rtype: int
        """
        return self._total
    ...
    def total(self, total):
        r"""Sets the total of this ListMemberGroupsResponse.
    ...
    def member_groups(self):
        r"""Gets the member_groups of this ListMemberGroupsResponse.
    ...
    def member_groups(self, member_groups):
        r"""Sets the member_groups of this ListMemberGroupsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListMemberGroupsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListMemberGroupsResponse):
            return False
