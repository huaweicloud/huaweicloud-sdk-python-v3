...
class ListApisUnbindedToAppV2Response(SdkResponse):
    ...
    def __init__(self, size=None, total=None, apis=None):
        ...
        :type total: int
        :param apis: 本次返回的API列表
        :type apis: list[:class:`huaweicloudsdkroma.v2.ApiOutline`]
        """
    ...
    def apis(self):
        ...
        :rtype: list[:class:`huaweicloudsdkroma.v2.ApiOutline`]
        """
        return self._apis
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListApisUnbindedToAppV2Response.to_dict() is deprecated and no longer maintained, "
