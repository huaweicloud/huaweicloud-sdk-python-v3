...
class CreateServiceResponse(SdkResponse):
    ...
    def product_template_id(self):
        r"""Gets the product_template_id of this CreateServiceResponse.

        服务归属的产品模板ID

        :return: The product_template_id of this CreateServiceResponse.
        :rtype: int
        """
    ...
    def product_template_id(self, product_template_id):
        r"""Sets the product_template_id of this CreateServiceResponse.

        服务归属的产品模板ID

        :param product_template_id: The product_template_id of this CreateServiceResponse.
        :type product_template_id: int
        """
    ...
    @property
    def product_id(self):
        r"""Gets the product_id of this CreateServiceResponse.

        服务归属的产品ID

        :return: The product_id of this CreateServiceResponse.
        :rtype: int
        """
    ...
    def product_id(self, product_id):
        r"""Sets the product_id of this CreateServiceResponse.

        服务归属的产品ID

        :param product_id: The product_id of this CreateServiceResponse.
        :type product_id: int
        """
    ...
    def description(self):
        r"""Gets the description of this CreateServiceResponse.
    ...
    def description(self, description):
        r"""Sets the description of this CreateServiceResponse.
    ...
    @property
    def status(self):
        r"""Gets the status of this CreateServiceResponse.
    ...
    def status(self, status):
        r"""Sets the status of this CreateServiceResponse.
    ...
    def created_user(self):
        r"""Gets the created_user of this CreateServiceResponse.

        :return: The created_user of this CreateServiceResponse.
    ...
    def created_user(self, created_user):
        r"""Sets the created_user of this CreateServiceResponse.

        :param created_user: The created_user of this CreateServiceResponse.
        :type created_user: :class:`huaweicloudsdkroma.v2.CreatedUser`
        """
    ...
    def last_updated_user(self):
        r"""Gets the last_updated_user of this CreateServiceResponse.

        :return: The last_updated_user of this CreateServiceResponse.
    ...
    def last_updated_user(self, last_updated_user):
        r"""Sets the last_updated_user of this CreateServiceResponse.

        :param last_updated_user: The last_updated_user of this CreateServiceResponse.
        :type last_updated_user: :class:`huaweicloudsdkroma.v2.LastUpdatedUser`
        """
    ...
    def created_datetime(self):
        r"""Gets the created_datetime of this CreateServiceResponse.

        创建时间止，格式timestamp(ms)，使用UTC时区

        :return: The created_datetime of this CreateServiceResponse.
        :rtype: int
        """
    ...
    def created_datetime(self, created_datetime):
        r"""Sets the created_datetime of this CreateServiceResponse.

        创建时间止，格式timestamp(ms)，使用UTC时区

        :param created_datetime: The created_datetime of this CreateServiceResponse.
        :type created_datetime: int
        """
    ...
    def last_updated_datetime(self):
        r"""Gets the last_updated_datetime of this CreateServiceResponse.

        最后修改时间止，格式timestamp(ms)，使用UTC时区

        :return: The last_updated_datetime of this CreateServiceResponse.
        :rtype: int
        """
    ...
    def last_updated_datetime(self, last_updated_datetime):
        r"""Sets the last_updated_datetime of this CreateServiceResponse.

        最后修改时间止，格式timestamp(ms)，使用UTC时区

        :param last_updated_datetime: The last_updated_datetime of this CreateServiceResponse.
        :type last_updated_datetime: int
        """
