...
class CreateLiveDataApiScriptV2Request:
    ...
    def __init__(self, instance_id=None, ld_api_id=None, body=None):
        r"""CreateLiveDataApiScriptV2Request
    ...
    def instance_id(self):
        r"""Gets the instance_id of this CreateLiveDataApiScriptV2Request.
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this CreateLiveDataApiScriptV2Request.
    ...
    @property
    def ld_api_id(self):
        r"""Gets the ld_api_id of this CreateLiveDataApiScriptV2Request.
    ...
    def ld_api_id(self, ld_api_id):
        r"""Sets the ld_api_id of this CreateLiveDataApiScriptV2Request.
    ...
    @property
    def body(self):
        r"""Gets the body of this CreateLiveDataApiScriptV2Request.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this CreateLiveDataApiScriptV2Request.
