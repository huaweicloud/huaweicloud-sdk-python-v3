...
class ListRequestThrottlingPoliciesBindedToApiV2Response(SdkResponse):
    ...
    def __init__(self, size=None, total=None, throttles=None):
        ...
        :type throttles: list[:class:`huaweicloudsdkroma.v2.ThrottleForApi`]
        """
    ...
    def throttles(self):
        ...
        :rtype: list[:class:`huaweicloudsdkroma.v2.ThrottleForApi`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListRequestThrottlingPoliciesBindedToApiV2Response.to_dict() is deprecated and no longer maintained, "
