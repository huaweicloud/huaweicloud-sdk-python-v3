...
class ListApisBindedToAclPolicyV2Response(SdkResponse):
    ...
    def __init__(self, size=None, total=None, apis=None):
        r"""ListApisBindedToAclPolicyV2Response
    ...
    @property
    def size(self):
        r"""Gets the size of this ListApisBindedToAclPolicyV2Response.
    ...
    @size.setter
    def size(self, size):
        r"""Sets the size of this ListApisBindedToAclPolicyV2Response.
    ...
    @property
    def total(self):
        r"""Gets the total of this ListApisBindedToAclPolicyV2Response.
    ...
    def total(self, total):
        r"""Sets the total of this ListApisBindedToAclPolicyV2Response.
    ...
    @property
    def apis(self):
        r"""Gets the apis of this ListApisBindedToAclPolicyV2Response.
    ...
    @apis.setter
    def apis(self, apis):
        r"""Sets the apis of this ListApisBindedToAclPolicyV2Response.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListApisBindedToAclPolicyV2Response.to_dict() is deprecated and no longer maintained, "
