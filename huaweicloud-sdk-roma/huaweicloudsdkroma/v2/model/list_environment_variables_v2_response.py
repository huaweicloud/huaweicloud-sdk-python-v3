...
class ListEnvironmentVariablesV2Response(SdkResponse):
    ...
    def __init__(self, size=None, total=None, variables=None):
        r"""ListEnvironmentVariablesV2Response
        ...
        :type variables: list[:class:`huaweicloudsdkroma.v2.EnvVariableInfo`]
        """
    ...
    @property
    def size(self):
        r"""Gets the size of this ListEnvironmentVariablesV2Response.
    ...
    @size.setter
    def size(self, size):
        r"""Sets the size of this ListEnvironmentVariablesV2Response.
    ...
    @property
    def total(self):
        r"""Gets the total of this ListEnvironmentVariablesV2Response.
    ...
    def total(self, total):
        r"""Sets the total of this ListEnvironmentVariablesV2Response.
    ...
    @property
    def variables(self):
        r"""Gets the variables of this ListEnvironmentVariablesV2Response.

        本次返回的环境变量列表

        :return: The variables of this ListEnvironmentVariablesV2Response.
        :rtype: list[:class:`huaweicloudsdkroma.v2.EnvVariableInfo`]
        """
        return self._variables

    @variables.setter
    def variables(self, variables):
        r"""Sets the variables of this ListEnvironmentVariablesV2Response.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListEnvironmentVariablesV2Response.to_dict() is deprecated and no longer maintained, "
