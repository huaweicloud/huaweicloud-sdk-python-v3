...
class ListDuplicateApisForAppV2Response(SdkResponse):
    ...
    @property
    def size(self):
        """Gets the size of this ListDuplicateApisForAppV2Response.
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this ListDuplicateApisForAppV2Response.
    ...
    @property
    def total(self):
        """Gets the total of this ListDuplicateApisForAppV2Response.
    ...
    def total(self, total):
        """Sets the total of this ListDuplicateApisForAppV2Response.
    ...
    @property
    def apis(self):
        """Gets the apis of this ListDuplicateApisForAppV2Response.
    ...
    @apis.setter
    def apis(self, apis):
        """Sets the apis of this ListDuplicateApisForAppV2Response.
