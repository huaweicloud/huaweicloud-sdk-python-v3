...
class BatchFreezeDevicesRequest:
    ...
    openapi_types = {
        'instance_id': 'str',
        'body': 'BatchFreezeDevicesRequestBody'
    }
    ...
    def instance_id(self):
        r"""Gets the instance_id of this BatchFreezeDevicesRequest.

        实例ID

        :return: The instance_id of this BatchFreezeDevicesRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this BatchFreezeDevicesRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this BatchFreezeDevicesRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this BatchFreezeDevicesRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchFreezeDevicesRequest):
            return False
