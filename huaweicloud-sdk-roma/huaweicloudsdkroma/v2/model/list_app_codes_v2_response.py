...
class ListAppCodesV2Response(SdkResponse):
    ...
    def __init__(self, size=None, total=None, app_codes=None):
        """ListAppCodesV2Response - a model defined in huaweicloud sdk"""
    ...
    @property
    def size(self):
        """Gets the size of this ListAppCodesV2Response.
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this ListAppCodesV2Response.
    ...
    @property
    def total(self):
        """Gets the total of this ListAppCodesV2Response.
    ...
    def total(self, total):
        """Sets the total of this ListAppCodesV2Response.
