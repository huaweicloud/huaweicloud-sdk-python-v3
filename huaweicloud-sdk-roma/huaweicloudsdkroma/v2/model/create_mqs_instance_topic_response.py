...
class CreateMqsInstanceTopicResponse(SdkResponse):
    ...
    def name(self):
        ...
        :return: The name of this CreateMqsInstanceTopicResponse.
        :rtype: str
        """
        return self._name
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateMqsInstanceTopicResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateMqsInstanceTopicResponse):
            return False
