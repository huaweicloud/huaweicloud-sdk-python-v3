...
class ResetRomaAppSecretResponse(SdkResponse):
    ...
    @property
    def id(self):
        r"""Gets the id of this ResetRomaAppSecretResponse.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this ResetRomaAppSecretResponse.
    ...
    @property
    def secret(self):
        r"""Gets the secret of this ResetRomaAppSecretResponse.
    ...
    def secret(self, secret):
        r"""Sets the secret of this ResetRomaAppSecretResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ResetRomaAppSecretResponse.to_dict() is deprecated and no longer maintained, "
