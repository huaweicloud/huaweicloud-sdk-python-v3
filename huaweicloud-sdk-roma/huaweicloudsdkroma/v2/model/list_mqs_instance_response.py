...
class ListMqsInstanceResponse(SdkResponse):
    ...
    def instance_num(self):
        ...
        :return: The instance_num of this ListMqsInstanceResponse.
        :rtype: int
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListMqsInstanceResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListMqsInstanceResponse):
            return False
