...
class ListApisBindedToSignatureKeyV2Response(SdkResponse):
    ...
    def __init__(self, size=None, total=None, bindings=None):
        r"""ListApisBindedToSignatureKeyV2Response
        ...
        :type bindings: list[:class:`huaweicloudsdkroma.v2.SignApiBindingBase`]
        """
    ...
    @property
    def size(self):
        r"""Gets the size of this ListApisBindedToSignatureKeyV2Response.
    ...
    @size.setter
    def size(self, size):
        r"""Sets the size of this ListApisBindedToSignatureKeyV2Response.
    ...
    @property
    def total(self):
        r"""Gets the total of this ListApisBindedToSignatureKeyV2Response.
    ...
    def total(self, total):
        r"""Sets the total of this ListApisBindedToSignatureKeyV2Response.
    ...
    @property
    def bindings(self):
        r"""Gets the bindings of this ListApisBindedToSignatureKeyV2Response.

        本次查询到的签名密钥和API绑定关系列表

        :return: The bindings of this ListApisBindedToSignatureKeyV2Response.
        :rtype: list[:class:`huaweicloudsdkroma.v2.SignApiBindingBase`]
        """
        return self._bindings

    @bindings.setter
    def bindings(self, bindings):
        r"""Sets the bindings of this ListApisBindedToSignatureKeyV2Response.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListApisBindedToSignatureKeyV2Response.to_dict() is deprecated and no longer maintained, "
