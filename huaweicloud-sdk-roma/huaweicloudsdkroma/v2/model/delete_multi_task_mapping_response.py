...
class DeleteMultiTaskMappingResponse(SdkResponse):
    ...
    def __init__(self, mapping_id=None):
        r"""DeleteMultiTaskMappingResponse
    ...
    @property
    def mapping_id(self):
        r"""Gets the mapping_id of this DeleteMultiTaskMappingResponse.

        映射唯一ID

        :return: The mapping_id of this DeleteMultiTaskMappingResponse.
        :rtype: str
        """
    ...
    def mapping_id(self, mapping_id):
        r"""Sets the mapping_id of this DeleteMultiTaskMappingResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteMultiTaskMappingResponse):
            return False
