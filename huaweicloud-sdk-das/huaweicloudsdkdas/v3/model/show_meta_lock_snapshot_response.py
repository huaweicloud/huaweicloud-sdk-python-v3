...
class ShowMetaLockSnapshotResponse(SdkResponse):
    ...
    def __init__(self, infos=None, count=None, wait_lock_count=None, hold_lock_count=None, time_greater_than_count=None, lock_wait_threshold_second=None):
        r"""ShowMetaLockSnapshotResponse
    ...
    @property
    def infos(self):
        r"""Gets the infos of this ShowMetaLockSnapshotResponse.

        MDL锁等待信息

        :return: The infos of this ShowMetaLockSnapshotResponse.
    ...
    def infos(self, infos):
        r"""Sets the infos of this ShowMetaLockSnapshotResponse.

        MDL锁等待信息

        :param infos: The infos of this ShowMetaLockSnapshotResponse.
        :type infos: list[:class:`huaweicloudsdkdas.v3.MetaLockInfo`]
        """
        self._infos = infos
    ...
    @property
    def count(self):
        r"""Gets the count of this ShowMetaLockSnapshotResponse.

        MDL锁总数量

        :return: The count of this ShowMetaLockSnapshotResponse.
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        r"""Sets the count of this ShowMetaLockSnapshotResponse.

        MDL锁总数量

        :param count: The count of this ShowMetaLockSnapshotResponse.
        :type count: int
        """
        self._count = count
    ...
    def wait_lock_count(self):
        r"""Gets the wait_lock_count of this ShowMetaLockSnapshotResponse.

        等待锁的会话的数量

        :return: The wait_lock_count of this ShowMetaLockSnapshotResponse.
        :rtype: int
        """
    ...
    def wait_lock_count(self, wait_lock_count):
        r"""Sets the wait_lock_count of this ShowMetaLockSnapshotResponse.

        等待锁的会话的数量

        :param wait_lock_count: The wait_lock_count of this ShowMetaLockSnapshotResponse.
        :type wait_lock_count: int
        """
    ...
    def hold_lock_count(self):
        r"""Gets the hold_lock_count of this ShowMetaLockSnapshotResponse.

        持有锁的会话的数量

        :return: The hold_lock_count of this ShowMetaLockSnapshotResponse.
        :rtype: int
        """
    ...
    def hold_lock_count(self, hold_lock_count):
        r"""Sets the hold_lock_count of this ShowMetaLockSnapshotResponse.

        持有锁的会话的数量

        :param hold_lock_count: The hold_lock_count of this ShowMetaLockSnapshotResponse.
        :type hold_lock_count: int
        """
    ...
    def time_greater_than_count(self):
        r"""Gets the time_greater_than_count of this ShowMetaLockSnapshotResponse.

        等锁时间大于阈值的会话的数量

        :return: The time_greater_than_count of this ShowMetaLockSnapshotResponse.
        :rtype: int
        """
    ...
    def time_greater_than_count(self, time_greater_than_count):
        r"""Sets the time_greater_than_count of this ShowMetaLockSnapshotResponse.

        等锁时间大于阈值的会话的数量

        :param time_greater_than_count: The time_greater_than_count of this ShowMetaLockSnapshotResponse.
        :type time_greater_than_count: int
        """
    ...
    def lock_wait_threshold_second(self):
        r"""Gets the lock_wait_threshold_second of this ShowMetaLockSnapshotResponse.

        MDL锁等待时间阈值

        :return: The lock_wait_threshold_second of this ShowMetaLockSnapshotResponse.
        :rtype: int
        """
    ...
    def lock_wait_threshold_second(self, lock_wait_threshold_second):
        r"""Sets the lock_wait_threshold_second of this ShowMetaLockSnapshotResponse.

        MDL锁等待时间阈值

        :param lock_wait_threshold_second: The lock_wait_threshold_second of this ShowMetaLockSnapshotResponse.
        :type lock_wait_threshold_second: int
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowMetaLockSnapshotResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowMetaLockSnapshotResponse):
            return False
