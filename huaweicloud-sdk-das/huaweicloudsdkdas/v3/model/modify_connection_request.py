...
class ModifyConnectionRequest:
    ...
    openapi_types = {
        'connection_id': 'str',
        'body': 'ModifyConnectionRequestBody'
    }
    ...
    def __init__(self, connection_id=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkdas.v3.ModifyConnectionRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkdas.v3.ModifyConnectionRequestBody`
        """
        return self._body
