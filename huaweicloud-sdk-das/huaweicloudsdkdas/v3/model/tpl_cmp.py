...
class TplCmp:
    ...
    def __init__(self, template_id=None, sql_template=None, sql_sample_string=None, db_names=None, db_name=None, sql_type=None, execute_num=None, total_cost=None, avg_cost=None, max_cost=None, avg_rows_sent=None, max_rows_sent=None, avg_rows_affected=None, max_rows_affected=None, avg_lock_time=None, max_lock_time=None, total_rows_examined=None, avg_rows_examined=None, max_rows_examined=None, total_cost_ratio=None, total_examined_ratio=None, execute_num_ratio=None):
        r"""TplCmp
    ...
    def template_id(self):
        r"""Gets the template_id of this TplCmp.

        SQL模板ID

        :return: The template_id of this TplCmp.
        :rtype: str
        """
    ...
    def template_id(self, template_id):
        r"""Sets the template_id of this TplCmp.

        SQL模板ID

        :param template_id: The template_id of this TplCmp.
        :type template_id: str
        """
    ...
    def sql_template(self):
        r"""Gets the sql_template of this TplCmp.

        SQL模板

        :return: The sql_template of this TplCmp.
        :rtype: str
        """
    ...
    def sql_template(self, sql_template):
        r"""Sets the sql_template of this TplCmp.

        SQL模板

        :param sql_template: The sql_template of this TplCmp.
        :type sql_template: str
        """
    ...
    def sql_sample_string(self):
        r"""Gets the sql_sample_string of this TplCmp.

        SQL样例

        :return: The sql_sample_string of this TplCmp.
        :rtype: str
        """
    ...
    def sql_sample_string(self, sql_sample_string):
        r"""Sets the sql_sample_string of this TplCmp.

        SQL样例

        :param sql_sample_string: The sql_sample_string of this TplCmp.
        :type sql_sample_string: str
        """
    ...
    @property
    def db_names(self):
        r"""Gets the db_names of this TplCmp.

        数据库列表

        :return: The db_names of this TplCmp.
        :rtype: list[str]
        """
    ...
    def db_names(self, db_names):
        r"""Sets the db_names of this TplCmp.

        数据库列表

        :param db_names: The db_names of this TplCmp.
        :type db_names: list[str]
        """
    ...
    @property
    def db_name(self):
        r"""Gets the db_name of this TplCmp.

        数据库名称

        :return: The db_name of this TplCmp.
        :rtype: str
        """
    ...
    def db_name(self, db_name):
        r"""Sets the db_name of this TplCmp.

        数据库名称

        :param db_name: The db_name of this TplCmp.
        :type db_name: str
        """
    ...
    @property
    def sql_type(self):
        r"""Gets the sql_type of this TplCmp.

        SQL类型

        :return: The sql_type of this TplCmp.
        :rtype: str
        """
    ...
    def sql_type(self, sql_type):
        r"""Sets the sql_type of this TplCmp.

        SQL类型

        :param sql_type: The sql_type of this TplCmp.
        :type sql_type: str
        """
    ...
    def execute_num(self):
        r"""Gets the execute_num of this TplCmp.

        执行次数

        :return: The execute_num of this TplCmp.
        :rtype: int
        """
    ...
    def execute_num(self, execute_num):
        r"""Sets the execute_num of this TplCmp.

        执行次数

        :param execute_num: The execute_num of this TplCmp.
        :type execute_num: int
        """
    ...
    @property
    def total_cost(self):
        r"""Gets the total_cost of this TplCmp.

        总执行耗时 ms

        :return: The total_cost of this TplCmp.
        :rtype: float
        """
    ...
    def total_cost(self, total_cost):
        r"""Sets the total_cost of this TplCmp.

        总执行耗时 ms

        :param total_cost: The total_cost of this TplCmp.
        :type total_cost: float
        """
    ...
    @property
    def avg_cost(self):
        r"""Gets the avg_cost of this TplCmp.

        平均执行耗时 ms

        :return: The avg_cost of this TplCmp.
        :rtype: float
        """
    ...
    def avg_cost(self, avg_cost):
        r"""Sets the avg_cost of this TplCmp.

        平均执行耗时 ms

        :param avg_cost: The avg_cost of this TplCmp.
        :type avg_cost: float
        """
    ...
    @property
    def max_cost(self):
        r"""Gets the max_cost of this TplCmp.

        最大执行耗时 ms

        :return: The max_cost of this TplCmp.
        :rtype: float
        """
    ...
    def max_cost(self, max_cost):
        r"""Sets the max_cost of this TplCmp.

        最大执行耗时 ms

        :param max_cost: The max_cost of this TplCmp.
        :type max_cost: float
        """
    ...
    def avg_rows_sent(self):
        r"""Gets the avg_rows_sent of this TplCmp.

        平均返回行数

        :return: The avg_rows_sent of this TplCmp.
        :rtype: float
        """
    ...
    def avg_rows_sent(self, avg_rows_sent):
        r"""Sets the avg_rows_sent of this TplCmp.

        平均返回行数

        :param avg_rows_sent: The avg_rows_sent of this TplCmp.
        :type avg_rows_sent: float
        """
    ...
    def max_rows_sent(self):
        r"""Gets the max_rows_sent of this TplCmp.

        最大返回行数

        :return: The max_rows_sent of this TplCmp.
        :rtype: float
        """
    ...
    def max_rows_sent(self, max_rows_sent):
        r"""Sets the max_rows_sent of this TplCmp.

        最大返回行数

        :param max_rows_sent: The max_rows_sent of this TplCmp.
        :type max_rows_sent: float
        """
    ...
    def avg_rows_affected(self):
        r"""Gets the avg_rows_affected of this TplCmp.

        平均影响行数

        :return: The avg_rows_affected of this TplCmp.
        :rtype: float
        """
    ...
    def avg_rows_affected(self, avg_rows_affected):
        r"""Sets the avg_rows_affected of this TplCmp.

        平均影响行数

        :param avg_rows_affected: The avg_rows_affected of this TplCmp.
        :type avg_rows_affected: float
        """
    ...
    def max_rows_affected(self):
        r"""Gets the max_rows_affected of this TplCmp.

        最大影响行数

        :return: The max_rows_affected of this TplCmp.
        :rtype: float
        """
    ...
    def max_rows_affected(self, max_rows_affected):
        r"""Sets the max_rows_affected of this TplCmp.

        最大影响行数

        :param max_rows_affected: The max_rows_affected of this TplCmp.
        :type max_rows_affected: float
        """
    ...
    def avg_lock_time(self):
        r"""Gets the avg_lock_time of this TplCmp.

        平均锁等待时间

        :return: The avg_lock_time of this TplCmp.
        :rtype: float
        """
    ...
    def avg_lock_time(self, avg_lock_time):
        r"""Sets the avg_lock_time of this TplCmp.

        平均锁等待时间

        :param avg_lock_time: The avg_lock_time of this TplCmp.
        :type avg_lock_time: float
        """
    ...
    def max_lock_time(self):
        r"""Gets the max_lock_time of this TplCmp.

        最大锁等待时间

        :return: The max_lock_time of this TplCmp.
        :rtype: float
        """
    ...
    def max_lock_time(self, max_lock_time):
        r"""Sets the max_lock_time of this TplCmp.

        最大锁等待时间

        :param max_lock_time: The max_lock_time of this TplCmp.
        :type max_lock_time: float
        """
    ...
    def total_rows_examined(self):
        r"""Gets the total_rows_examined of this TplCmp.

        总扫描行数

        :return: The total_rows_examined of this TplCmp.
        :rtype: float
        """
    ...
    def total_rows_examined(self, total_rows_examined):
        r"""Sets the total_rows_examined of this TplCmp.

        总扫描行数

        :param total_rows_examined: The total_rows_examined of this TplCmp.
        :type total_rows_examined: float
        """
    ...
    def avg_rows_examined(self):
        r"""Gets the avg_rows_examined of this TplCmp.

        平均扫描行数

        :return: The avg_rows_examined of this TplCmp.
        :rtype: float
        """
    ...
    def avg_rows_examined(self, avg_rows_examined):
        r"""Sets the avg_rows_examined of this TplCmp.

        平均扫描行数

        :param avg_rows_examined: The avg_rows_examined of this TplCmp.
        :type avg_rows_examined: float
        """
    ...
    def max_rows_examined(self):
        r"""Gets the max_rows_examined of this TplCmp.

        最大扫描行数

        :return: The max_rows_examined of this TplCmp.
        :rtype: float
        """
    ...
    def max_rows_examined(self, max_rows_examined):
        r"""Sets the max_rows_examined of this TplCmp.

        最大扫描行数

        :param max_rows_examined: The max_rows_examined of this TplCmp.
        :type max_rows_examined: float
        """
    ...
    def total_cost_ratio(self):
        r"""Gets the total_cost_ratio of this TplCmp.

        执行耗时占比

        :return: The total_cost_ratio of this TplCmp.
        :rtype: str
        """
    ...
    def total_cost_ratio(self, total_cost_ratio):
        r"""Sets the total_cost_ratio of this TplCmp.

        执行耗时占比

        :param total_cost_ratio: The total_cost_ratio of this TplCmp.
        :type total_cost_ratio: str
        """
    ...
    def total_examined_ratio(self):
        r"""Gets the total_examined_ratio of this TplCmp.

        扫描行数占比

        :return: The total_examined_ratio of this TplCmp.
        :rtype: str
        """
    ...
    def total_examined_ratio(self, total_examined_ratio):
        r"""Sets the total_examined_ratio of this TplCmp.

        扫描行数占比

        :param total_examined_ratio: The total_examined_ratio of this TplCmp.
        :type total_examined_ratio: str
        """
    ...
    def execute_num_ratio(self):
        r"""Gets the execute_num_ratio of this TplCmp.

        执行次数占比

        :return: The execute_num_ratio of this TplCmp.
        :rtype: str
        """
    ...
    def execute_num_ratio(self, execute_num_ratio):
        r"""Sets the execute_num_ratio of this TplCmp.

        执行次数占比

        :param execute_num_ratio: The execute_num_ratio of this TplCmp.
        :type execute_num_ratio: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TplCmp):
            return False
