...
class ShowSqlExplainResponse(SdkResponse):
    ...
    def execution_plans(self):
        r"""Gets the execution_plans of this ShowSqlExplainResponse.
    ...
    def execution_plans(self, execution_plans):
        r"""Sets the execution_plans of this ShowSqlExplainResponse.
    ...
    def error_message(self):
        r"""Gets the error_message of this ShowSqlExplainResponse.

        SQL执行失败时，显示执行错误信息

        :return: The error_message of this ShowSqlExplainResponse.
        :rtype: str
        """
    ...
    def error_message(self, error_message):
        r"""Sets the error_message of this ShowSqlExplainResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowSqlExplainResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowSqlExplainResponse):
            return False
