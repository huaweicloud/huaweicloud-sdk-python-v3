...
class IndexUsagePercent:
    ...
    def percent_le10_count(self):
        r"""Gets the percent_le10_count of this IndexUsagePercent.

        百分比小于等于10%的数量

        :return: The percent_le10_count of this IndexUsagePercent.
        :rtype: int
        """
    ...
    def percent_le10_count(self, percent_le10_count):
        r"""Sets the percent_le10_count of this IndexUsagePercent.

        百分比小于等于10%的数量

        :param percent_le10_count: The percent_le10_count of this IndexUsagePercent.
        :type percent_le10_count: int
        """
    ...
    def percent10_to50_count(self):
        r"""Gets the percent10_to50_count of this IndexUsagePercent.

        百分比大于10%小于等于50%的数量

        :return: The percent10_to50_count of this IndexUsagePercent.
        :rtype: int
        """
    ...
    def percent10_to50_count(self, percent10_to50_count):
        r"""Sets the percent10_to50_count of this IndexUsagePercent.

        百分比大于10%小于等于50%的数量

        :param percent10_to50_count: The percent10_to50_count of this IndexUsagePercent.
        :type percent10_to50_count: int
        """
    ...
    def percent50_to80_count(self):
        r"""Gets the percent50_to80_count of this IndexUsagePercent.

        百分比大于50%小于等于80%的数量

        :return: The percent50_to80_count of this IndexUsagePercent.
        :rtype: int
        """
    ...
    def percent50_to80_count(self, percent50_to80_count):
        r"""Sets the percent50_to80_count of this IndexUsagePercent.

        百分比大于50%小于等于80%的数量

        :param percent50_to80_count: The percent50_to80_count of this IndexUsagePercent.
        :type percent50_to80_count: int
        """
    ...
    def percent_gl80_count(self):
        r"""Gets the percent_gl80_count of this IndexUsagePercent.

        百分比大于80%的数量

        :return: The percent_gl80_count of this IndexUsagePercent.
        :rtype: int
        """
    ...
    def percent_gl80_count(self, percent_gl80_count):
        r"""Sets the percent_gl80_count of this IndexUsagePercent.

        百分比大于80%的数量

        :param percent_gl80_count: The percent_gl80_count of this IndexUsagePercent.
        :type percent_gl80_count: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IndexUsagePercent):
            return False
