...
class CreateHealthReportTaskResponse(SdkResponse):
    ...
    def __init__(self, create_success=None):
        ...
        :param create_success: 诊断任务创建是否成功
    ...
    def create_success(self):
        ...
        :return: The create_success of this CreateHealthReportTaskResponse.
        :rtype: bool
        """
    ...
    def create_success(self, create_success):
        ...
        :param create_success: The create_success of this CreateHealthReportTaskResponse.
        :type create_success: bool
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateHealthReportTaskResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateHealthReportTaskResponse):
            return False
