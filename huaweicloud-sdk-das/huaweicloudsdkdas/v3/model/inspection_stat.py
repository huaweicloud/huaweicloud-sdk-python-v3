...
class InspectionStat:
    ...
    def inspection_score(self):
        r"""Gets the inspection_score of this InspectionStat.

        巡检评分

        :return: The inspection_score of this InspectionStat.
    ...
    def inspection_score(self, inspection_score):
        r"""Sets the inspection_score of this InspectionStat.

        巡检评分

        :param inspection_score: The inspection_score of this InspectionStat.
        :type inspection_score: list[:class:`huaweicloudsdkdas.v3.HealthReportInspectionScore`]
        """
    ...
    def analyze_success(self):
        r"""Gets the analyze_success of this InspectionStat.

        统计分析是否成功

        :return: The analyze_success of this InspectionStat.
        :rtype: bool
        """
    ...
    def analyze_success(self, analyze_success):
        r"""Sets the analyze_success of this InspectionStat.

        统计分析是否成功

        :param analyze_success: The analyze_success of this InspectionStat.
        :type analyze_success: bool
        """
    ...
    def error_message(self):
        r"""Gets the error_message of this InspectionStat.

        错误信息

        :return: The error_message of this InspectionStat.
        :rtype: str
        """
    ...
    def error_message(self, error_message):
        r"""Sets the error_message of this InspectionStat.

        错误信息

        :param error_message: The error_message of this InspectionStat.
        :type error_message: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InspectionStat):
            return False
