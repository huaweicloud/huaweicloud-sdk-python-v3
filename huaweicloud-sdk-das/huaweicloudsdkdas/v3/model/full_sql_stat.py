...
class FullSqlStat:
    ...
    def collect_full_sql(self):
        r"""Gets the collect_full_sql of this FullSqlStat.

        是否收集全量SQL

        :return: The collect_full_sql of this FullSqlStat.
        :rtype: bool
        """
    ...
    def collect_full_sql(self, collect_full_sql):
        r"""Sets the collect_full_sql of this FullSqlStat.

        是否收集全量SQL

        :param collect_full_sql: The collect_full_sql of this FullSqlStat.
        :type collect_full_sql: bool
        """
    ...
    def execute_top_templates(self):
        r"""Gets the execute_top_templates of this FullSqlStat.

        全量SQL Top总执行次数列表

        :return: The execute_top_templates of this FullSqlStat.
    ...
    def execute_top_templates(self, execute_top_templates):
        r"""Sets the execute_top_templates of this FullSqlStat.

        全量SQL Top总执行次数列表

        :param execute_top_templates: The execute_top_templates of this FullSqlStat.
        :type execute_top_templates: list[:class:`huaweicloudsdkdas.v3.HealthReportSqlTemplate`]
        """
    ...
    def sum_rows_examined_top_templates(self):
        r"""Gets the sum_rows_examined_top_templates of this FullSqlStat.

        全量SQL Top总扫描行数列表

        :return: The sum_rows_examined_top_templates of this FullSqlStat.
        :rtype: list[:class:`huaweicloudsdkdas.v3.HealthReportSqlTemplate`]
        """
    ...
    def sum_rows_examined_top_templates(self, sum_rows_examined_top_templates):
        r"""Sets the sum_rows_examined_top_templates of this FullSqlStat.

        全量SQL Top总扫描行数列表

        :param sum_rows_examined_top_templates: The sum_rows_examined_top_templates of this FullSqlStat.
        :type sum_rows_examined_top_templates: list[:class:`huaweicloudsdkdas.v3.HealthReportSqlTemplate`]
        """
    ...
    def avg_cost_top_templates(self):
        r"""Gets the avg_cost_top_templates of this FullSqlStat.

        全量SQL Top平均执行耗时列表

        :return: The avg_cost_top_templates of this FullSqlStat.
        :rtype: list[:class:`huaweicloudsdkdas.v3.HealthReportSqlTemplate`]
        """
    ...
    def avg_cost_top_templates(self, avg_cost_top_templates):
        r"""Sets the avg_cost_top_templates of this FullSqlStat.

        全量SQL Top平均执行耗时列表

        :param avg_cost_top_templates: The avg_cost_top_templates of this FullSqlStat.
        :type avg_cost_top_templates: list[:class:`huaweicloudsdkdas.v3.HealthReportSqlTemplate`]
        """
    ...
    def analyze_success(self):
        r"""Gets the analyze_success of this FullSqlStat.

        统计分析是否成功

        :return: The analyze_success of this FullSqlStat.
        :rtype: bool
        """
    ...
    def analyze_success(self, analyze_success):
        r"""Sets the analyze_success of this FullSqlStat.

        统计分析是否成功

        :param analyze_success: The analyze_success of this FullSqlStat.
        :type analyze_success: bool
        """
    ...
    def error_message(self):
        r"""Gets the error_message of this FullSqlStat.

        错误信息

        :return: The error_message of this FullSqlStat.
        :rtype: str
        """
    ...
    def error_message(self, error_message):
        r"""Sets the error_message of this FullSqlStat.

        错误信息

        :param error_message: The error_message of this FullSqlStat.
        :type error_message: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FullSqlStat):
            return False
