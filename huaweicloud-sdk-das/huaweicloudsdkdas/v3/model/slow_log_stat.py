...
class SlowLogStat:
    ...
    def collect_slow_log(self):
        r"""Gets the collect_slow_log of this SlowLogStat.

        是否收集慢SQL

        :return: The collect_slow_log of this SlowLogStat.
        :rtype: bool
        """
    ...
    def collect_slow_log(self, collect_slow_log):
        r"""Sets the collect_slow_log of this SlowLogStat.

        是否收集慢SQL

        :param collect_slow_log: The collect_slow_log of this SlowLogStat.
        :type collect_slow_log: bool
        """
    ...
    def top_execute_slow_logs(self):
        r"""Gets the top_execute_slow_logs of this SlowLogStat.

        慢SQL Top执行次数列表

        :return: The top_execute_slow_logs of this SlowLogStat.
    ...
    def top_execute_slow_logs(self, top_execute_slow_logs):
        r"""Sets the top_execute_slow_logs of this SlowLogStat.

        慢SQL Top执行次数列表

        :param top_execute_slow_logs: The top_execute_slow_logs of this SlowLogStat.
        :type top_execute_slow_logs: list[:class:`huaweicloudsdkdas.v3.HealthReportSqlTemplate`]
        """
    ...
    def top_avg_query_time_slow_logs(self):
        r"""Gets the top_avg_query_time_slow_logs of this SlowLogStat.

        慢SQL Top平均执行时间列表

        :return: The top_avg_query_time_slow_logs of this SlowLogStat.
        :rtype: list[:class:`huaweicloudsdkdas.v3.HealthReportSqlTemplate`]
        """
    ...
    def top_avg_query_time_slow_logs(self, top_avg_query_time_slow_logs):
        r"""Sets the top_avg_query_time_slow_logs of this SlowLogStat.

        慢SQL Top平均执行时间列表

        :param top_avg_query_time_slow_logs: The top_avg_query_time_slow_logs of this SlowLogStat.
        :type top_avg_query_time_slow_logs: list[:class:`huaweicloudsdkdas.v3.HealthReportSqlTemplate`]
        """
    ...
    def top_max_query_time_slow_logs(self):
        r"""Gets the top_max_query_time_slow_logs of this SlowLogStat.

        慢SQL Top最大执行时间列表

        :return: The top_max_query_time_slow_logs of this SlowLogStat.
        :rtype: list[:class:`huaweicloudsdkdas.v3.HealthReportSqlTemplate`]
        """
    ...
    def top_max_query_time_slow_logs(self, top_max_query_time_slow_logs):
        r"""Sets the top_max_query_time_slow_logs of this SlowLogStat.

        慢SQL Top最大执行时间列表

        :param top_max_query_time_slow_logs: The top_max_query_time_slow_logs of this SlowLogStat.
        :type top_max_query_time_slow_logs: list[:class:`huaweicloudsdkdas.v3.HealthReportSqlTemplate`]
        """
    ...
    def rows_examined_exceeding(self):
        r"""Gets the rows_examined_exceeding of this SlowLogStat.

        慢SQL Top扫描返回比列表

        :return: The rows_examined_exceeding of this SlowLogStat.
        :rtype: list[:class:`huaweicloudsdkdas.v3.HealthReportSqlTemplate`]
        """
    ...
    def rows_examined_exceeding(self, rows_examined_exceeding):
        r"""Sets the rows_examined_exceeding of this SlowLogStat.

        慢SQL Top扫描返回比列表

        :param rows_examined_exceeding: The rows_examined_exceeding of this SlowLogStat.
        :type rows_examined_exceeding: list[:class:`huaweicloudsdkdas.v3.HealthReportSqlTemplate`]
        """
    ...
    def analyze_success(self):
        r"""Gets the analyze_success of this SlowLogStat.

        统计分析是否成功

        :return: The analyze_success of this SlowLogStat.
        :rtype: bool
        """
    ...
    def analyze_success(self, analyze_success):
        r"""Sets the analyze_success of this SlowLogStat.

        统计分析是否成功

        :param analyze_success: The analyze_success of this SlowLogStat.
        :type analyze_success: bool
        """
    ...
    def error_message(self):
        r"""Gets the error_message of this SlowLogStat.

        错误信息

        :return: The error_message of this SlowLogStat.
        :rtype: str
        """
    ...
    def error_message(self, error_message):
        r"""Sets the error_message of this SlowLogStat.

        错误信息

        :param error_message: The error_message of this SlowLogStat.
        :type error_message: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SlowLogStat):
            return False
