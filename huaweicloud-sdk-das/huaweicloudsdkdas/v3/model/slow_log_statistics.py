...
class SlowLogStatistics:
    ...
    def __init__(self, execute_count=None, avg_execute_time=None, max_execute_time=None, avg_lock_wait_time=None, max_lock_wait_time=None, avg_rows_examined=None, max_rows_examined=None, avg_rows_sent=None, max_rows_sent=None, avg_key_examined=None, max_key_examined=None, node_id=None, node_name=None, sql_type=None, db_name=None, collection=None, user=None, client=None):
        ...
        :param node_id: 节点ID，按nodeId统计时赋值
        :type node_id: str
        :param node_name: 节点名称，按nodeId统计时赋值
        :type node_name: str
        :param sql_type: 语句类型，按sqlType统计时赋值
        :type sql_type: str
        :param db_name: 库名，按dbName、collection统计时赋值
        :type db_name: str
        ...
        if avg_execute_time is not None:
            self.avg_execute_time = avg_execute_time
        if max_execute_time is not None:
            self.max_execute_time = max_execute_time
        if avg_lock_wait_time is not None:
            self.avg_lock_wait_time = avg_lock_wait_time
        if max_lock_wait_time is not None:
        ...
        if avg_key_examined is not None:
            self.avg_key_examined = avg_key_examined
        if max_key_examined is not None:
    ...
    def execute_count(self):
        r"""Gets the execute_count of this SlowLogStatistics.

        执行次数

        :return: The execute_count of this SlowLogStatistics.
        :rtype: int
        """
    ...
    def execute_count(self, execute_count):
        r"""Sets the execute_count of this SlowLogStatistics.

        执行次数

        :param execute_count: The execute_count of this SlowLogStatistics.
        :type execute_count: int
        """
    ...
    def avg_execute_time(self):
        r"""Gets the avg_execute_time of this SlowLogStatistics.

        平均执行耗时(s)

        :return: The avg_execute_time of this SlowLogStatistics.
        :rtype: float
        """
    ...
    def avg_execute_time(self, avg_execute_time):
        r"""Sets the avg_execute_time of this SlowLogStatistics.

        平均执行耗时(s)

        :param avg_execute_time: The avg_execute_time of this SlowLogStatistics.
        :type avg_execute_time: float
        """
    ...
    def max_execute_time(self):
        r"""Gets the max_execute_time of this SlowLogStatistics.

        最大执行耗时(s)

        :return: The max_execute_time of this SlowLogStatistics.
        :rtype: float
        """
    ...
    def max_execute_time(self, max_execute_time):
        r"""Sets the max_execute_time of this SlowLogStatistics.

        最大执行耗时(s)

        :param max_execute_time: The max_execute_time of this SlowLogStatistics.
        :type max_execute_time: float
        """
    ...
    def avg_lock_wait_time(self):
        r"""Gets the avg_lock_wait_time of this SlowLogStatistics.

        平均锁等待时间(s)

        :return: The avg_lock_wait_time of this SlowLogStatistics.
        :rtype: float
        """
    ...
    def avg_lock_wait_time(self, avg_lock_wait_time):
        r"""Sets the avg_lock_wait_time of this SlowLogStatistics.

        平均锁等待时间(s)

        :param avg_lock_wait_time: The avg_lock_wait_time of this SlowLogStatistics.
        :type avg_lock_wait_time: float
        """
    ...
    def max_lock_wait_time(self):
        r"""Gets the max_lock_wait_time of this SlowLogStatistics.

        最大锁等待时间(s)

        :return: The max_lock_wait_time of this SlowLogStatistics.
        :rtype: float
        """
    ...
    def max_lock_wait_time(self, max_lock_wait_time):
        r"""Sets the max_lock_wait_time of this SlowLogStatistics.

        最大锁等待时间(s)

        :param max_lock_wait_time: The max_lock_wait_time of this SlowLogStatistics.
        :type max_lock_wait_time: float
        """
    ...
    def avg_rows_examined(self):
        r"""Gets the avg_rows_examined of this SlowLogStatistics.

        平均扫描行数

        :return: The avg_rows_examined of this SlowLogStatistics.
        :rtype: float
        """
    ...
    def avg_rows_examined(self, avg_rows_examined):
        r"""Sets the avg_rows_examined of this SlowLogStatistics.

        平均扫描行数

        :param avg_rows_examined: The avg_rows_examined of this SlowLogStatistics.
        :type avg_rows_examined: float
        """
    ...
    def max_rows_examined(self):
        r"""Gets the max_rows_examined of this SlowLogStatistics.

        最大扫描行数

        :return: The max_rows_examined of this SlowLogStatistics.
        :rtype: float
        """
    ...
    def max_rows_examined(self, max_rows_examined):
        r"""Sets the max_rows_examined of this SlowLogStatistics.

        最大扫描行数

        :param max_rows_examined: The max_rows_examined of this SlowLogStatistics.
        :type max_rows_examined: float
        """
    ...
    def avg_rows_sent(self):
        r"""Gets the avg_rows_sent of this SlowLogStatistics.

        平均返回行数

        :return: The avg_rows_sent of this SlowLogStatistics.
        :rtype: float
        """
    ...
    def avg_rows_sent(self, avg_rows_sent):
        r"""Sets the avg_rows_sent of this SlowLogStatistics.

        平均返回行数

        :param avg_rows_sent: The avg_rows_sent of this SlowLogStatistics.
        :type avg_rows_sent: float
        """
    ...
    def max_rows_sent(self):
        r"""Gets the max_rows_sent of this SlowLogStatistics.

        最大返回行数

        :return: The max_rows_sent of this SlowLogStatistics.
        :rtype: float
        """
    ...
    def max_rows_sent(self, max_rows_sent):
        r"""Sets the max_rows_sent of this SlowLogStatistics.

        最大返回行数

        :param max_rows_sent: The max_rows_sent of this SlowLogStatistics.
        :type max_rows_sent: float
        """
    ...
    def avg_key_examined(self):
        r"""Gets the avg_key_examined of this SlowLogStatistics.

        平均扫描索引数

        :return: The avg_key_examined of this SlowLogStatistics.
        :rtype: float
        """
    ...
    def avg_key_examined(self, avg_key_examined):
        r"""Sets the avg_key_examined of this SlowLogStatistics.

        平均扫描索引数

        :param avg_key_examined: The avg_key_examined of this SlowLogStatistics.
        :type avg_key_examined: float
        """
    ...
    def max_key_examined(self):
        r"""Gets the max_key_examined of this SlowLogStatistics.

        最大扫描索引数

        :return: The max_key_examined of this SlowLogStatistics.
        :rtype: float
        """
    ...
    def max_key_examined(self, max_key_examined):
        r"""Sets the max_key_examined of this SlowLogStatistics.

        最大扫描索引数

        :param max_key_examined: The max_key_examined of this SlowLogStatistics.
        :type max_key_examined: float
        """
    ...
    @property
    def node_id(self):
        r"""Gets the node_id of this SlowLogStatistics.

        节点ID，按nodeId统计时赋值

        :return: The node_id of this SlowLogStatistics.
        :rtype: str
        """
    ...
    def node_id(self, node_id):
        r"""Sets the node_id of this SlowLogStatistics.

        节点ID，按nodeId统计时赋值

        :param node_id: The node_id of this SlowLogStatistics.
        :type node_id: str
        """
    ...
    @property
    def node_name(self):
        r"""Gets the node_name of this SlowLogStatistics.

        节点名称，按nodeId统计时赋值

        :return: The node_name of this SlowLogStatistics.
        :rtype: str
        """
    ...
    def node_name(self, node_name):
        r"""Sets the node_name of this SlowLogStatistics.

        节点名称，按nodeId统计时赋值

        :param node_name: The node_name of this SlowLogStatistics.
        :type node_name: str
        """
    ...
    @property
    def sql_type(self):
        r"""Gets the sql_type of this SlowLogStatistics.

        语句类型，按sqlType统计时赋值

        :return: The sql_type of this SlowLogStatistics.
        :rtype: str
        """
    ...
    def sql_type(self, sql_type):
        r"""Sets the sql_type of this SlowLogStatistics.

        语句类型，按sqlType统计时赋值

        :param sql_type: The sql_type of this SlowLogStatistics.
        :type sql_type: str
        """
    ...
    @property
    def db_name(self):
        r"""Gets the db_name of this SlowLogStatistics.

        库名，按dbName、collection统计时赋值

        :return: The db_name of this SlowLogStatistics.
        :rtype: str
        """
    ...
    def db_name(self, db_name):
        r"""Sets the db_name of this SlowLogStatistics.

        库名，按dbName、collection统计时赋值

        :param db_name: The db_name of this SlowLogStatistics.
        :type db_name: str
        """
    ...
    @property
    def collection(self):
        r"""Gets the collection of this SlowLogStatistics.

        数据库表，按collection统计时赋值

        :return: The collection of this SlowLogStatistics.
        :rtype: str
        """
    ...
    def collection(self, collection):
        r"""Sets the collection of this SlowLogStatistics.

        数据库表，按collection统计时赋值

        :param collection: The collection of this SlowLogStatistics.
        :type collection: str
        """
    ...
    @property
    def user(self):
        r"""Gets the user of this SlowLogStatistics.

        用户名，按user统计时赋值

        :return: The user of this SlowLogStatistics.
        :rtype: str
        """
        return self._user
    ...
    @user.setter
    def user(self, user):
        r"""Sets the user of this SlowLogStatistics.

        用户名，按user统计时赋值

        :param user: The user of this SlowLogStatistics.
        :type user: str
        """
        self._user = user
    ...
    @property
    def client(self):
        r"""Gets the client of this SlowLogStatistics.

        客户端，按client统计时赋值

        :return: The client of this SlowLogStatistics.
        :rtype: str
        """
        return self._client
    ...
    def client(self, client):
        r"""Sets the client of this SlowLogStatistics.

        客户端，按client统计时赋值

        :param client: The client of this SlowLogStatistics.
        :type client: str
        """
        self._client = client
