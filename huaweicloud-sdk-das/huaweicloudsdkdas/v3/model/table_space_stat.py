...
class TableSpaceStat:
    ...
    def __init__(self, size_top=None, rows_top=None, size_incr_top=None, rows_incr_top=None, analyze_success=None, error_message=None):
        ...
        if rows_top is not None:
            self.rows_top = rows_top
        if size_incr_top is not None:
            self.size_incr_top = size_incr_top
        if rows_incr_top is not None:
    ...
    @property
    def size_top(self):
        r"""Gets the size_top of this TableSpaceStat.

        表大小Top列表

        :return: The size_top of this TableSpaceStat.
    ...
    def size_top(self, size_top):
        r"""Sets the size_top of this TableSpaceStat.

        表大小Top列表

        :param size_top: The size_top of this TableSpaceStat.
        :type size_top: list[:class:`huaweicloudsdkdas.v3.HealthReportTableSpaceInfo`]
        """
    ...
    @property
    def rows_top(self):
        r"""Gets the rows_top of this TableSpaceStat.

        表行数量Top列表

        :return: The rows_top of this TableSpaceStat.
        :rtype: list[:class:`huaweicloudsdkdas.v3.HealthReportTableSpaceInfo`]
        """
    ...
    def rows_top(self, rows_top):
        r"""Sets the rows_top of this TableSpaceStat.

        表行数量Top列表

        :param rows_top: The rows_top of this TableSpaceStat.
        :type rows_top: list[:class:`huaweicloudsdkdas.v3.HealthReportTableSpaceInfo`]
        """
    ...
    def size_incr_top(self):
        r"""Gets the size_incr_top of this TableSpaceStat.

        表大小增长Top列表

        :return: The size_incr_top of this TableSpaceStat.
    ...
    def size_incr_top(self, size_incr_top):
        r"""Sets the size_incr_top of this TableSpaceStat.

        表大小增长Top列表

        :param size_incr_top: The size_incr_top of this TableSpaceStat.
        :type size_incr_top: list[:class:`huaweicloudsdkdas.v3.HealthReportTableSpaceIncrInfo`]
        """
    ...
    def rows_incr_top(self):
        r"""Gets the rows_incr_top of this TableSpaceStat.

        表行数量增长Top列表

        :return: The rows_incr_top of this TableSpaceStat.
        :rtype: list[:class:`huaweicloudsdkdas.v3.HealthReportTableSpaceIncrInfo`]
        """
    ...
    def rows_incr_top(self, rows_incr_top):
        r"""Sets the rows_incr_top of this TableSpaceStat.

        表行数量增长Top列表

        :param rows_incr_top: The rows_incr_top of this TableSpaceStat.
        :type rows_incr_top: list[:class:`huaweicloudsdkdas.v3.HealthReportTableSpaceIncrInfo`]
        """
    ...
    def analyze_success(self):
        r"""Gets the analyze_success of this TableSpaceStat.

        统计分析是否成功

        :return: The analyze_success of this TableSpaceStat.
        :rtype: bool
        """
    ...
    def analyze_success(self, analyze_success):
        r"""Sets the analyze_success of this TableSpaceStat.

        统计分析是否成功

        :param analyze_success: The analyze_success of this TableSpaceStat.
        :type analyze_success: bool
        """
    ...
    def error_message(self):
        r"""Gets the error_message of this TableSpaceStat.

        错误信息

        :return: The error_message of this TableSpaceStat.
        :rtype: str
        """
    ...
    def error_message(self, error_message):
        r"""Sets the error_message of this TableSpaceStat.

        错误信息

        :param error_message: The error_message of this TableSpaceStat.
        :type error_message: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TableSpaceStat):
            return False
