...
class RelatedInstance:
    ...
    @property
    def name(self):
        r"""Gets the name of this RelatedInstance.

        实例名称

        :return: The name of this RelatedInstance.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this RelatedInstance.

        实例名称

        :param name: The name of this RelatedInstance.
        :type name: str
        """
        self._name = name
