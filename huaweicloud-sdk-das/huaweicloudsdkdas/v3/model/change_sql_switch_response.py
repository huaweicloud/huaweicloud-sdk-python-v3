...
class ChangeSqlSwitchResponse(SdkResponse):
    ...
    def status(self):
        ...
        :return: The status of this ChangeSqlSwitchResponse.
        :rtype: str
        """
        return self._status
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ChangeSqlSwitchResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChangeSqlSwitchResponse):
            return False
