...
class NodeInfo:
    ...
    @property
    def role(self):
        r"""Gets the role of this NodeInfo.

        节点角色

        :return: The role of this NodeInfo.
        :rtype: str
        """
        return self._role
    ...
    @role.setter
    def role(self, role):
        r"""Sets the role of this NodeInfo.

        节点角色

        :param role: The role of this NodeInfo.
        :type role: str
        """
        self._role = role
    ...
    @property
    def type(self):
        r"""Gets the type of this NodeInfo.
    ...
    @type.setter
    def type(self, type):
        r"""Sets the type of this NodeInfo.
