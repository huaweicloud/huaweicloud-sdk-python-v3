...
class ShowEPResponse(SdkResponse):
    ...
    def __init__(self, enterprise_project=None):
        """ShowEPResponse - a model defined in huaweicloud sdk"""
    ...
    def enterprise_project(self):
        """Gets the enterprise_project of this ShowEPResponse.


        :return: The enterprise_project of this ShowEPResponse.
        :rtype: EpDetail
        """
    ...
    def enterprise_project(self, enterprise_project):
        """Sets the enterprise_project of this ShowEPResponse.


        :param enterprise_project: The enterprise_project of this ShowEPResponse.
        :type: EpDetail
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowEPResponse):
            return False
