...
class ModifyEPResponse(SdkResponse):
    ...
    def __init__(self, enterprise_project=None):
        """ModifyEPResponse - a model defined in huaweicloud sdk"""
    ...
    def enterprise_project(self):
        """Gets the enterprise_project of this ModifyEPResponse.


        :return: The enterprise_project of this ModifyEPResponse.
        :rtype: EpDetail
        """
    ...
    def enterprise_project(self, enterprise_project):
        """Sets the enterprise_project of this ModifyEPResponse.


        :param enterprise_project: The enterprise_project of this ModifyEPResponse.
        :type: EpDetail
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModifyEPResponse):
            return False
