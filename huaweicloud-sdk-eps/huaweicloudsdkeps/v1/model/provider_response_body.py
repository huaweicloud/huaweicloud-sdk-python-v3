...
class ProviderResponseBody:
    ...
    def __init__(self, provider=None, provider_i18n_display_name=None, resource_types=None):
        ...
        :type provider: str
        :param provider_i18n_display_name: 云服务显示名称，可以通过参数中的&#39;locale&#39;设置语言
        :type provider_i18n_display_name: str
        :param resource_types: 资源类型列表
        :type resource_types: list[:class:`huaweicloudsdkeps.v1.ResourceTypeBody`]
        """
    ...
    def resource_types(self):
        ...
        :rtype: list[:class:`huaweicloudsdkeps.v1.ResourceTypeBody`]
        """
