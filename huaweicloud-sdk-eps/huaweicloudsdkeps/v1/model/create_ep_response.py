...
class CreateEPResponse(SdkResponse):
    ...
    def __init__(self, enterprise_project=None):
        """CreateEPResponse - a model defined in huaweicloud sdk"""
    ...
    def enterprise_project(self):
        """Gets the enterprise_project of this CreateEPResponse.


        :return: The enterprise_project of this CreateEPResponse.
        :rtype: EpDetail
        """
    ...
    def enterprise_project(self, enterprise_project):
        """Sets the enterprise_project of this CreateEPResponse.


        :param enterprise_project: The enterprise_project of this CreateEPResponse.
        :type: EpDetail
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateEPResponse):
            return False
