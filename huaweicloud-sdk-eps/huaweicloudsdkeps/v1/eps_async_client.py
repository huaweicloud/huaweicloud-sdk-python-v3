...
class EpsAsyncClient(Client):
    ...
    def delete_enterprise_project_async(self, request):
        r"""删除企业项目
    ...
    def delete_enterprise_project_async_invoker(self, request):
        http_info = self._delete_enterprise_project_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_enterprise_project_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_migration_record_async(self, request):
        r"""查询资源迁移记录
    ...
    def list_migration_record_async_invoker(self, request):
        http_info = self._list_migration_record_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_migration_record_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_resource_mapping_async(self, request):
        r"""查询资源类型映射
    ...
    def list_resource_mapping_async_invoker(self, request):
        http_info = self._list_resource_mapping_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_resource_mapping_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_associated_resources_async(self, request):
        r"""查询关联资源
    ...
    def show_associated_resources_async_invoker(self, request):
        http_info = self._show_associated_resources_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_associated_resources_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_ep_configs_async(self, request):
        r"""查询服务配置
    ...
    def show_ep_configs_async_invoker(self, request):
        http_info = self._show_ep_configs_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_ep_configs_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_resource_bind_enterprise_project_async(self, request):
        ...
        """
        warnings.warn("Method 'show_resource_bind_enterprise_project_async' of EpsAsyncClient is deprecated and will be removed in the future versions", DeprecationWarning)
    ...
    def show_resource_bind_enterprise_project_async_invoker(self, request):
        warnings.warn("Method 'show_resource_bind_enterprise_project_async_invoker' of EpsAsyncClient is deprecated and will be removed in the future versions", DeprecationWarning)
        http_info = self._show_resource_bind_enterprise_project_http_info(request)
        return AsyncInvoker(self, http_info)
