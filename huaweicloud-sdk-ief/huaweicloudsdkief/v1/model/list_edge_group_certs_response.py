...
class ListEdgeGroupCertsResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListEdgeGroupCertsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListEdgeGroupCertsResponse):
            return False
