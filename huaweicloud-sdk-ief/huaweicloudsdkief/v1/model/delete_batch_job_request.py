...
class DeleteBatchJobRequest:
    ...
    @property
    def job_id(self):
        """Gets the job_id of this DeleteBatchJobRequest.
    ...
    def job_id(self, job_id):
        """Sets the job_id of this DeleteBatchJobRequest.
    ...
    def ief_instance_id(self):
        """Gets the ief_instance_id of this DeleteBatchJobRequest.

        铂金版实例ID，专业版实例为空值

        :return: The ief_instance_id of this DeleteBatchJobRequest.
        :rtype: str
        """
    ...
    def ief_instance_id(self, ief_instance_id):
        """Sets the ief_instance_id of this DeleteBatchJobRequest.

        铂金版实例ID，专业版实例为空值

        :param ief_instance_id: The ief_instance_id of this DeleteBatchJobRequest.
        :type ief_instance_id: str
        """
