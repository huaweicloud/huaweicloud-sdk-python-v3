...
class EdgeNodeUpdateByDevice:
    ...
    def __init__(self, nodes=None):
        """EdgeNodeUpdateByDevice - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EdgeNodeUpdateByDevice):
            return False
