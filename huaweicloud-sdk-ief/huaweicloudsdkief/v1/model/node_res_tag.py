...
class NodeResTag:
    ...
    @property
    def key(self):
        r"""Gets the key of this NodeResTag.

        键。最大长度36个unicode字符。 不能为空，只能包含大小写字母，数字，中划线“-”，下划线“_”。

        :return: The key of this NodeResTag.
        :rtype: str
        """
        return self._key
    ...
    @key.setter
    def key(self, key):
        r"""Sets the key of this NodeResTag.
    ...
    def value(self, value):
        r"""Sets the value of this NodeResTag.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NodeResTag):
            return False
