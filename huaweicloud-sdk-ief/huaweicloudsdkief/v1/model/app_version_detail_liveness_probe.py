...
class AppVersionDetailLivenessProbe:
    ...
    def exec_command(self):
        """Gets the exec_command of this AppVersionDetailLivenessProbe.

        执行探测的命令行命令，长度1-10240内的字符串

        :return: The exec_command of this AppVersionDetailLivenessProbe.
        :rtype: str
        """
    ...
    def exec_command(self, exec_command):
        """Sets the exec_command of this AppVersionDetailLivenessProbe.
    ...
    @property
    def http_get(self):
        """Gets the http_get of this AppVersionDetailLivenessProbe.
    ...
    def http_get(self, http_get):
        """Sets the http_get of this AppVersionDetailLivenessProbe.
    ...
    def initial_delay_seconds(self):
        """Gets the initial_delay_seconds of this AppVersionDetailLivenessProbe.

        表示从工作负载启动后从多久开始探测，大于0且不大于3600的整数，默认为10

        :return: The initial_delay_seconds of this AppVersionDetailLivenessProbe.
        :rtype: int
        """
    ...
    def initial_delay_seconds(self, initial_delay_seconds):
        """Sets the initial_delay_seconds of this AppVersionDetailLivenessProbe.
    ...
    def timeout_seconds(self):
        """Gets the timeout_seconds of this AppVersionDetailLivenessProbe.

        表示探测超时时间，大于0且不大于3600的整数，默认为1

        :return: The timeout_seconds of this AppVersionDetailLivenessProbe.
        :rtype: int
        """
    ...
    def timeout_seconds(self, timeout_seconds):
        """Sets the timeout_seconds of this AppVersionDetailLivenessProbe.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AppVersionDetailLivenessProbe):
            return False
