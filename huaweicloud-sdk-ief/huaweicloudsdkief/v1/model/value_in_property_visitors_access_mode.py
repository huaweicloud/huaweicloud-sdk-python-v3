...
class ValueInPropertyVisitorsAccessMode:
    ...
    @property
    def value(self):
        """Gets the value of this ValueInPropertyVisitorsAccessMode.

        value 最大长度512， value允许英文字母、数字、下划线、中划线、点、逗号、@、#、+、\\、/、？、^、=、%、&、:、~

        :return: The value of this ValueInPropertyVisitorsAccessMode.
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this ValueInPropertyVisitorsAccessMode.
    ...
    @property
    def optional(self):
        """Gets the optional of this ValueInPropertyVisitorsAccessMode.

        标识属性是否可选，默认为true

        :return: The optional of this ValueInPropertyVisitorsAccessMode.
        :rtype: bool
        """
    ...
    def optional(self, optional):
        """Sets the optional of this ValueInPropertyVisitorsAccessMode.
    ...
    @property
    def metadata(self):
        """Gets the metadata of this ValueInPropertyVisitorsAccessMode.
    ...
    def metadata(self, metadata):
        """Sets the metadata of this ValueInPropertyVisitorsAccessMode.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ValueInPropertyVisitorsAccessMode):
            return False
