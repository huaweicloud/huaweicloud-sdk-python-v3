...
class DeleteDeviceRequest:
    ...
    def __init__(self, ief_instance_id=None, device_id=None):
        """DeleteDeviceRequest - a model defined in huaweicloud sdk"""
    ...
    def ief_instance_id(self):
        """Gets the ief_instance_id of this DeleteDeviceRequest.

        铂金版实例ID，专业版实例为空值

        :return: The ief_instance_id of this DeleteDeviceRequest.
        :rtype: str
        """
    ...
    def ief_instance_id(self, ief_instance_id):
        """Sets the ief_instance_id of this DeleteDeviceRequest.

        铂金版实例ID，专业版实例为空值

        :param ief_instance_id: The ief_instance_id of this DeleteDeviceRequest.
        :type: str
        """
