...
class EdgemgrDevices:
    ...
    def __init__(self, device=None):
        """EdgemgrDevices - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EdgemgrDevices):
            return False
