...
class ListDeploymentsRequest:
    ...
    def ief_instance_id(self):
        r"""Gets the ief_instance_id of this ListDeploymentsRequest.
    ...
    def ief_instance_id(self, ief_instance_id):
        r"""Sets the ief_instance_id of this ListDeploymentsRequest.
    ...
    @property
    def sort(self):
        r"""Gets the sort of this ListDeploymentsRequest.
    ...
    @sort.setter
    def sort(self, sort):
        r"""Sets the sort of this ListDeploymentsRequest.
    ...
    @property
    def name(self):
        r"""Gets the name of this ListDeploymentsRequest.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this ListDeploymentsRequest.
    ...
    @property
    def node_id(self):
        r"""Gets the node_id of this ListDeploymentsRequest.
    ...
    def node_id(self, node_id):
        r"""Sets the node_id of this ListDeploymentsRequest.
    ...
    @property
    def group_id(self):
        r"""Gets the group_id of this ListDeploymentsRequest.
    ...
    def group_id(self, group_id):
        r"""Sets the group_id of this ListDeploymentsRequest.
