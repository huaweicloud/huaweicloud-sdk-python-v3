...
class EdgeNodeMqttConfig:
    ...
    def enable_mqtt(self):
        """Gets the enable_mqtt of this EdgeNodeMqttConfig.

        是否启用MQTT

        :return: The enable_mqtt of this EdgeNodeMqttConfig.
        :rtype: bool
        """
    ...
    def enable_mqtt(self, enable_mqtt):
        """Sets the enable_mqtt of this EdgeNodeMqttConfig.
    ...
    @property
    def mqtts(self):
        """Gets the mqtts of this EdgeNodeMqttConfig.
    ...
    def mqtts(self, mqtts):
        """Sets the mqtts of this EdgeNodeMqttConfig.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EdgeNodeMqttConfig):
            return False
