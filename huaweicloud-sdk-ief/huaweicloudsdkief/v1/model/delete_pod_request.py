...
class DeletePodRequest:
    ...
    @property
    def pod_name(self):
        r"""Gets the pod_name of this DeletePodRequest.

        应用实例名称

        :return: The pod_name of this DeletePodRequest.
        :rtype: str
        """
    ...
    def pod_name(self, pod_name):
        r"""Sets the pod_name of this DeletePodRequest.

        应用实例名称

        :param pod_name: The pod_name of this DeletePodRequest.
        :type pod_name: str
        """
    ...
    def ief_instance_id(self):
        r"""Gets the ief_instance_id of this DeletePodRequest.

        铂金版实例ID，专业版实例为空值

        :return: The ief_instance_id of this DeletePodRequest.
        :rtype: str
        """
    ...
    def ief_instance_id(self, ief_instance_id):
        r"""Sets the ief_instance_id of this DeletePodRequest.

        铂金版实例ID，专业版实例为空值

        :param ief_instance_id: The ief_instance_id of this DeletePodRequest.
        :type ief_instance_id: str
        """
