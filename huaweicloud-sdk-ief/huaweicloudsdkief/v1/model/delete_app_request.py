...
class DeleteAppRequest:
    ...
    def ief_instance_id(self):
        r"""Gets the ief_instance_id of this DeleteAppRequest.

        铂金版实例ID，专业版实例为空值

        :return: The ief_instance_id of this DeleteAppRequest.
        :rtype: str
        """
    ...
    def ief_instance_id(self, ief_instance_id):
        r"""Sets the ief_instance_id of this DeleteAppRequest.

        铂金版实例ID，专业版实例为空值

        :param ief_instance_id: The ief_instance_id of this DeleteAppRequest.
        :type ief_instance_id: str
        """
