...
class DeletePtrRecordReq:
    ...
    def __init__(self, floatingip_ids=None):
        ...
        :param floatingip_ids: 待删除PTR ID。
    ...
    def floatingip_ids(self):
        """Gets the floatingip_ids of this DeletePtrRecordReq.

        待删除PTR ID。

        :return: The floatingip_ids of this DeletePtrRecordReq.
        :rtype: list[str]
        """
    ...
    def floatingip_ids(self, floatingip_ids):
        """Sets the floatingip_ids of this DeletePtrRecordReq.

        待删除PTR ID。

        :param floatingip_ids: The floatingip_ids of this DeletePtrRecordReq.
        :type floatingip_ids: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeletePtrRecordReq):
            return False
