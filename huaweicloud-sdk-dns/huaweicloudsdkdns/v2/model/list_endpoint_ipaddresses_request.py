...
class ListEndpointIpaddressesRequest:
    ...
    def __init__(self, endpoint_id=None):
        ...
        :param endpoint_id: 待查询的ip地址列表所在的endpoint的ID。
    ...
    def endpoint_id(self):
        """Gets the endpoint_id of this ListEndpointIpaddressesRequest.
    ...
    def endpoint_id(self, endpoint_id):
        """Sets the endpoint_id of this ListEndpointIpaddressesRequest.
