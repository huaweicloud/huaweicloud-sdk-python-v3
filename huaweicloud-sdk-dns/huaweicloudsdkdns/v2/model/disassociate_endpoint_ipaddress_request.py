...
class DisassociateEndpointIpaddressRequest:
    ...
    def __init__(self, endpoint_id=None, ipaddress_id=None):
        r"""DisassociateEndpointIpaddressRequest

        The model defined in huaweicloud sdk

        :param endpoint_id: 终端节点ID。
        :type endpoint_id: str
        :param ipaddress_id: IP地址ID。
    ...
    def endpoint_id(self):
        r"""Gets the endpoint_id of this DisassociateEndpointIpaddressRequest.
    ...
    def endpoint_id(self, endpoint_id):
        r"""Sets the endpoint_id of this DisassociateEndpointIpaddressRequest.
    ...
    def ipaddress_id(self):
        r"""Gets the ipaddress_id of this DisassociateEndpointIpaddressRequest.
    ...
    def ipaddress_id(self, ipaddress_id):
        r"""Sets the ipaddress_id of this DisassociateEndpointIpaddressRequest.
