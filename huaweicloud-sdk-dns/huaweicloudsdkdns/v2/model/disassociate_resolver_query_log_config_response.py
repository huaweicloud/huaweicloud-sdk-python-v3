...
class DisassociateResolverQueryLogConfigResponse(SdkResponse):
    ...
    def __init__(self, resolver_query_log_config=None):
        r"""DisassociateResolverQueryLogConfigResponse
    ...
    def resolver_query_log_config(self):
        r"""Gets the resolver_query_log_config of this DisassociateResolverQueryLogConfigResponse.

        :return: The resolver_query_log_config of this DisassociateResolverQueryLogConfigResponse.
    ...
    def resolver_query_log_config(self, resolver_query_log_config):
        r"""Sets the resolver_query_log_config of this DisassociateResolverQueryLogConfigResponse.

        :param resolver_query_log_config: The resolver_query_log_config of this DisassociateResolverQueryLogConfigResponse.
        :type resolver_query_log_config: :class:`huaweicloudsdkdns.v2.ResolverQueryLogConfig`
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DisassociateResolverQueryLogConfigResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DisassociateResolverQueryLogConfigResponse):
            return False
