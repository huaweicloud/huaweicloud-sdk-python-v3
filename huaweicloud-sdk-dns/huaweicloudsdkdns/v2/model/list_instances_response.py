...
class ListInstancesResponse(SdkResponse):
    ...
    openapi_types = {
        'instances': 'list[ResolutionInstances]'
    }
    ...
    def __init__(self, instances=None):
        ...
        :param instances: 返回查询到的解析量资源实例。
        :type instances: list[:class:`huaweicloudsdkdns.v2.ResolutionInstances`]
        """
    ...
    def instances(self):
        ...
        :rtype: list[:class:`huaweicloudsdkdns.v2.ResolutionInstances`]
        """
