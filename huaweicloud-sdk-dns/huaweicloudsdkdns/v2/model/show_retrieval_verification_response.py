...
class ShowRetrievalVerificationResponse(SdkResponse):
    ...
    def __init__(self, id=None, status=None, updated_at=None):
        """ShowRetrievalVerificationResponse
        ...
        super(ShowRetrievalVerificationResponse, self).__init__()
    ...
    @property
    def id(self):
        """Gets the id of this ShowRetrievalVerificationResponse.
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ShowRetrievalVerificationResponse.
    ...
    @property
    def status(self):
        """Gets the status of this ShowRetrievalVerificationResponse.
    ...
    def status(self, status):
        """Sets the status of this ShowRetrievalVerificationResponse.
    ...
    @property
    def updated_at(self):
        """Gets the updated_at of this ShowRetrievalVerificationResponse.
    ...
    def updated_at(self, updated_at):
        """Sets the updated_at of this ShowRetrievalVerificationResponse.
