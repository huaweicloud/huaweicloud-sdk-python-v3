...
class ZoneData:
    ...
    def __init__(self, id=None, name=None, description=None, email=None, zone_type=None, ttl=None, serial=None, status=None, record_num=None, pool_id=None, project_id=None, created_at=None, updated_at=None, region=None, links=None, masters=None):
        """ZoneData
        ...
        :type email: str
        :param zone_type: zone类型，取值system。
        :type zone_type: str
    ...
    @property
    def region(self):
        """Gets the region of this ZoneData.

        域名所属的区域。

        :return: The region of this ZoneData.
        :rtype: str
        """
        return self._region
    ...
    def region(self, region):
        """Sets the region of this ZoneData.

        域名所属的区域。

        :param region: The region of this ZoneData.
        :type region: str
        """
        self._region = region
