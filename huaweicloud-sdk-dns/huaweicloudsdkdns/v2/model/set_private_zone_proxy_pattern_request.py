...
class SetPrivateZoneProxyPatternRequest:
    ...
    def __init__(self, zone_id=None, body=None):
        """SetPrivateZoneProxyPatternRequest

        The model defined in huaweicloud sdk

        :param zone_id: 待设置内网Zone的ID。
        :type zone_id: str
    ...
    @property
    def zone_id(self):
        """Gets the zone_id of this SetPrivateZoneProxyPatternRequest.
    ...
    def zone_id(self, zone_id):
        """Sets the zone_id of this SetPrivateZoneProxyPatternRequest.
    ...
    @property
    def body(self):
        """Gets the body of this SetPrivateZoneProxyPatternRequest.
    ...
    @body.setter
    def body(self, body):
        """Sets the body of this SetPrivateZoneProxyPatternRequest.
