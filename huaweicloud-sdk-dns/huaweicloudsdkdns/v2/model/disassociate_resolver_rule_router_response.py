...
class DisassociateResolverRuleRouterResponse(SdkResponse):
    ...
    def __init__(self, router_id=None, router_region=None, status=None):
        r"""DisassociateResolverRuleRouterResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DisassociateResolverRuleRouterResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DisassociateResolverRuleRouterResponse):
            return False
