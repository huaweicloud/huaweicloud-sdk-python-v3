...
class DeleteResolveRuleResponse(SdkResponse):
    ...
    def resolver_rule(self):
        """Gets the resolver_rule of this DeleteResolveRuleResponse.

        :return: The resolver_rule of this DeleteResolveRuleResponse.
    ...
    def resolver_rule(self, resolver_rule):
        """Sets the resolver_rule of this DeleteResolveRuleResponse.

        :param resolver_rule: The resolver_rule of this DeleteResolveRuleResponse.
        :type resolver_rule: :class:`huaweicloudsdkdns.v2.ResolveRuleParam`
        """
