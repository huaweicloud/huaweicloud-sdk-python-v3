...
class UpdateResolveRuleResponse(SdkResponse):
    ...
    def __init__(self, resolver_rules=None):
        ...
        super(UpdateResolveRuleResponse, self).__init__()
    ...
    def resolver_rules(self):
        """Gets the resolver_rules of this UpdateResolveRuleResponse.

        查询resolver_rule的列表响应。

        :return: The resolver_rules of this UpdateResolveRuleResponse.
    ...
    def resolver_rules(self, resolver_rules):
        """Sets the resolver_rules of this UpdateResolveRuleResponse.

        查询resolver_rule的列表响应。

        :param resolver_rules: The resolver_rules of this UpdateResolveRuleResponse.
        :type resolver_rules: list[:class:`huaweicloudsdkdns.v2.ResolveRuleParam`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateResolveRuleResponse):
            return False
