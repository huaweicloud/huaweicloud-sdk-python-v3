...
class CreateResolverQueryLogConfigResponse(SdkResponse):
    ...
    def __init__(self, resolver_query_log_config=None):
        r"""CreateResolverQueryLogConfigResponse
    ...
    def resolver_query_log_config(self):
        r"""Gets the resolver_query_log_config of this CreateResolverQueryLogConfigResponse.
    ...
    def resolver_query_log_config(self, resolver_query_log_config):
        r"""Sets the resolver_query_log_config of this CreateResolverQueryLogConfigResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateResolverQueryLogConfigResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateResolverQueryLogConfigResponse):
            return False
