...
class DisassociateRouterResponse(SdkResponse):
    ...
    def status(self):
        ...
        :return: The status of this DisassociateRouterResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this DisassociateRouterResponse.
        :type status: str
        """
        self._status = status
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DisassociateRouterResponse):
            return False
