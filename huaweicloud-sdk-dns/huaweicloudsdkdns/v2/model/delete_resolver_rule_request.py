...
class DeleteResolverRuleRequest:
    ...
    def resolverrule_id(self):
        r"""Gets the resolverrule_id of this DeleteResolverRuleRequest.

        转发规则ID。

        :return: The resolverrule_id of this DeleteResolverRuleRequest.
        :rtype: str
        """
    ...
    def resolverrule_id(self, resolverrule_id):
        r"""Sets the resolverrule_id of this DeleteResolverRuleRequest.

        转发规则ID。

        :param resolverrule_id: The resolverrule_id of this DeleteResolverRuleRequest.
        :type resolverrule_id: str
        """
