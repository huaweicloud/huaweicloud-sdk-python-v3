...
class UpdateEndpointRequest:
    ...
    def __init__(self, endpoint_id=None, body=None):
        ...
        :param endpoint_id: 待修改endpoint的ID。。
        :type endpoint_id: str
        :param body: Body of the UpdateEndpointRequest
        :type body: :class:`huaweicloudsdkdns.v2.UpdateEndpointInfo`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkdns.v2.UpdateEndpointInfo`
        """
        return self._body
