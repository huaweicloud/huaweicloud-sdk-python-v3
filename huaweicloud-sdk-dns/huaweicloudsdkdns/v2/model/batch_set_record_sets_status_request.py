...
class BatchSetRecordSetsStatusRequest:
    ...
    openapi_types = {
        'body': 'BatchSetRecordSetsStatusReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :type body: :class:`huaweicloudsdkdns.v2.BatchSetRecordSetsStatusReq`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkdns.v2.BatchSetRecordSetsStatusReq`
        """
        return self._body
