...
class NonRequiredGcbSize:
    ...
    def size(self):
        ...
        :return: The size of this NonRequiredGcbSize.
        :rtype: int
        """
        return self._size
    ...
    def size(self, size):
        ...
        :param size: The size of this NonRequiredGcbSize.
        :type size: int
        """
        self._size = size
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NonRequiredGcbSize):
            return False
