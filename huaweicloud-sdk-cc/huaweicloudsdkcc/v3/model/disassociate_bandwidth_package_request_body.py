...
class DisassociateBandwidthPackageRequestBody:
    ...
    openapi_types = {
        'bandwidth_package': 'DisassociateBandwidthPackage'
    }
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DisassociateBandwidthPackageRequestBody):
            return False
