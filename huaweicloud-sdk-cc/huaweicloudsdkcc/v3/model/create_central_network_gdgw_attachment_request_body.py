...
class CreateCentralNetworkGdgwAttachmentRequestBody:
    ...
    openapi_types = {
        'central_network_gdgw_attachment': 'CreateCentralNetworkGdgwAttachment'
    }
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateCentralNetworkGdgwAttachmentRequestBody):
            return False
