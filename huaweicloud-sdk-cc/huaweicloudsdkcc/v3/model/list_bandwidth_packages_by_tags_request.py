...
class ListBandwidthPackagesByTagsRequest:
    ...
    openapi_types = {
        'body': 'ListBandwidthPackagesByTagsRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ListBandwidthPackagesByTagsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListBandwidthPackagesByTagsRequest):
            return False
