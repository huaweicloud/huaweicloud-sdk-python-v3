...
class AssociateSiteConnectionBandwidthRequestBody:
    ...
    openapi_types = {
        'site_connection': 'AssociateSiteConnectionBandwidth'
    }
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssociateSiteConnectionBandwidthRequestBody):
            return False
