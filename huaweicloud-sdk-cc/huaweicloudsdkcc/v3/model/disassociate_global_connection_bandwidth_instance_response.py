...
class DisassociateGlobalConnectionBandwidthInstanceResponse(SdkResponse):
    ...
    openapi_types = {
        'request_id': 'str',
        'gcbandwidths': 'list[DisassociateGlobalConnectionBandwidthInstanceResponseInfo]'
    }
    ...
    def gcbandwidths(self, gcbandwidths):
        ...
        :param gcbandwidths: The gcbandwidths of this DisassociateGlobalConnectionBandwidthInstanceResponse.
        :type gcbandwidths: list[:class:`huaweicloudsdkcc.v3.DisassociateGlobalConnectionBandwidthInstanceResponseInfo`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DisassociateGlobalConnectionBandwidthInstanceResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DisassociateGlobalConnectionBandwidthInstanceResponse):
            return False
