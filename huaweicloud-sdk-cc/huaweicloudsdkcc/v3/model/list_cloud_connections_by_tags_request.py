...
class ListCloudConnectionsByTagsRequest:
    ...
    openapi_types = {
        'body': 'ListCloudConnectionsByTagsRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ListCloudConnectionsByTagsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListCloudConnectionsByTagsRequest):
            return False
