...
class DeleteCentralNetworkRequest:
    ...
    def central_network_id(self):
        r"""Gets the central_network_id of this DeleteCentralNetworkRequest.

        中心网络的ID。

        :return: The central_network_id of this DeleteCentralNetworkRequest.
        :rtype: str
        """
    ...
    def central_network_id(self, central_network_id):
        r"""Sets the central_network_id of this DeleteCentralNetworkRequest.

        中心网络的ID。

        :param central_network_id: The central_network_id of this DeleteCentralNetworkRequest.
        :type central_network_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteCentralNetworkRequest):
            return False
