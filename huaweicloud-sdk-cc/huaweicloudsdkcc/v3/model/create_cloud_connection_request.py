...
class CreateCloudConnectionRequest:
    ...
    openapi_types = {
        'body': 'CreateCloudConnectionRequestBody'
    }
    ...
    def __init__(self, body=None):
        """CreateCloudConnectionRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: CreateCloudConnectionRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateCloudConnectionRequest):
            return False
