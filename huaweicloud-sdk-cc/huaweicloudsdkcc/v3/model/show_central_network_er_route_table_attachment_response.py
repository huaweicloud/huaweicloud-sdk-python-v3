...
class ShowCentralNetworkErRouteTableAttachmentResponse(SdkResponse):
    ...
    def request_id(self):
        ...
        :return: The request_id of this ShowCentralNetworkErRouteTableAttachmentResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        ...
        :param request_id: The request_id of this ShowCentralNetworkErRouteTableAttachmentResponse.
        :type request_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowCentralNetworkErRouteTableAttachmentResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowCentralNetworkErRouteTableAttachmentResponse):
            return False
