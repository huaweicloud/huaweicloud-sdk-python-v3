...
class ListCentralNetworkCapabilitiesResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, page_info=None, capabilities=None):
        r"""ListCentralNetworkCapabilitiesResponse
    ...
    @property
    def request_id(self):
        r"""Gets the request_id of this ListCentralNetworkCapabilitiesResponse.
    ...
    def request_id(self, request_id):
        r"""Sets the request_id of this ListCentralNetworkCapabilitiesResponse.
    ...
    @property
    def page_info(self):
        r"""Gets the page_info of this ListCentralNetworkCapabilitiesResponse.

        :return: The page_info of this ListCentralNetworkCapabilitiesResponse.
    ...
    def page_info(self, page_info):
        r"""Sets the page_info of this ListCentralNetworkCapabilitiesResponse.

        :param page_info: The page_info of this ListCentralNetworkCapabilitiesResponse.
        :type page_info: :class:`huaweicloudsdkcc.v3.PageInfo`
        """
    ...
    def capabilities(self):
        r"""Gets the capabilities of this ListCentralNetworkCapabilitiesResponse.
    ...
    def capabilities(self, capabilities):
        r"""Sets the capabilities of this ListCentralNetworkCapabilitiesResponse.
