...
class UpdateCentralNetworkConnectionResponse(SdkResponse):
    ...
    openapi_types = {
        'request_id': 'str',
        'central_network_connection': 'CentralNetworkConnection'
    }
    ...
    def __init__(self, request_id=None, central_network_connection=None):
        ...
        super(UpdateCentralNetworkConnectionResponse, self).__init__()
    ...
    def request_id(self):
        ...
        :return: The request_id of this UpdateCentralNetworkConnectionResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        ...
        :param request_id: The request_id of this UpdateCentralNetworkConnectionResponse.
        :type request_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateCentralNetworkConnectionResponse):
            return False
