...
class UpdateCentralNetworkErRouteTableAttachmentResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, central_network_er_route_table_attachment=None):
        r"""UpdateCentralNetworkErRouteTableAttachmentResponse
    ...
    @property
    def request_id(self):
        r"""Gets the request_id of this UpdateCentralNetworkErRouteTableAttachmentResponse.
    ...
    def request_id(self, request_id):
        r"""Sets the request_id of this UpdateCentralNetworkErRouteTableAttachmentResponse.
    ...
    def central_network_er_route_table_attachment(self):
        r"""Gets the central_network_er_route_table_attachment of this UpdateCentralNetworkErRouteTableAttachmentResponse.
    ...
    def central_network_er_route_table_attachment(self, central_network_er_route_table_attachment):
        r"""Sets the central_network_er_route_table_attachment of this UpdateCentralNetworkErRouteTableAttachmentResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateCentralNetworkErRouteTableAttachmentResponse.to_dict() is deprecated and no longer maintained, "
