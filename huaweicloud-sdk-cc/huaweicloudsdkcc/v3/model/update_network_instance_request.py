...
class UpdateNetworkInstanceRequest:
    ...
    openapi_types = {
        'id': 'str',
        'body': 'UpdateNetworkInstanceRequestBody'
    }
    ...
    def __init__(self, id=None, body=None):
        """UpdateNetworkInstanceRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: UpdateNetworkInstanceRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateNetworkInstanceRequest):
            return False
