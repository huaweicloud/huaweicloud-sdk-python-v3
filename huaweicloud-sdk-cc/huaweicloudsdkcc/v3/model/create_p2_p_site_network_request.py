...
class CreateP2PSiteNetworkRequest:
    ...
    openapi_types = {
        'body': 'CreateP2PSiteNetworkRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateP2PSiteNetworkRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateP2PSiteNetworkRequest):
            return False
