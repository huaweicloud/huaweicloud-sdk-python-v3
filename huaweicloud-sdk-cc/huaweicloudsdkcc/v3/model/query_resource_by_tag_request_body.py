...
class QueryResourceByTagRequestBody:
    ...
    def __init__(self, request_id=None, without_any_tag=None, tags=None, tags_any=None, not_tags=None, not_tags_any=None, matches=None):
        ...
        :type tags: list[:class:`huaweicloudsdkcc.v3.QueryTag`]
        ...
        :type tags_any: list[:class:`huaweicloudsdkcc.v3.QueryTag`]
        ...
        :type not_tags: list[:class:`huaweicloudsdkcc.v3.QueryTag`]
        ...
        :type not_tags_any: list[:class:`huaweicloudsdkcc.v3.QueryTag`]
        :param matches: 是否匹配以下tag，key必须为\&quot;resource_name\&quot;，value如果有值则模糊匹配，如果为空字符串则精确匹配。
        :type matches: list[:class:`huaweicloudsdkcc.v3.TmsMatch`]
        """
    ...
    def tags(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcc.v3.QueryTag`]
        """
        return self._tags
    ...
    def matches(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcc.v3.TmsMatch`]
        """
