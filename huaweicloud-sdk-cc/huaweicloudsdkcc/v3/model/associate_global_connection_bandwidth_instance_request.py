...
class AssociateGlobalConnectionBandwidthInstanceRequest:
    ...
    openapi_types = {
        'id': 'str',
        'body': 'AssociateGlobalConnectionBandwidthInstanceRequestBody'
    }
    ...
    def __init__(self, id=None, body=None):
        ...
        :param id: 实例ID。
        :type id: str
        :param body: Body of the AssociateGlobalConnectionBandwidthInstanceRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssociateGlobalConnectionBandwidthInstanceRequest):
            return False
