...
class GlobalDcGatewayProjectId:
    ...
    def __init__(self, global_dc_gateway_project_id=None):
        r"""GlobalDcGatewayProjectId
    ...
    def global_dc_gateway_project_id(self):
        r"""Gets the global_dc_gateway_project_id of this GlobalDcGatewayProjectId.

        Gdgw的项目ID。

        :return: The global_dc_gateway_project_id of this GlobalDcGatewayProjectId.
        :rtype: str
        """
    ...
    def global_dc_gateway_project_id(self, global_dc_gateway_project_id):
        r"""Sets the global_dc_gateway_project_id of this GlobalDcGatewayProjectId.

        Gdgw的项目ID。

        :param global_dc_gateway_project_id: The global_dc_gateway_project_id of this GlobalDcGatewayProjectId.
        :type global_dc_gateway_project_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GlobalDcGatewayProjectId):
            return False
