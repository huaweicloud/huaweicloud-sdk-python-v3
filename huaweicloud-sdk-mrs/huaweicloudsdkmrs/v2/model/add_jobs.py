...
class AddJobs:
    ...
    def job_type(self, job_type):
        """Sets the job_type of this AddJobs.
    ...
    @property
    def job_name(self):
        """Gets the job_name of this AddJobs.

        作业名称。 只能由字母、数字、中划线和下划线组成，并且长度为1～64个字符。  说明： 不同作业的名称允许相同，但不建议设置相同。

        :return: The job_name of this AddJobs.
        :rtype: str
        """
    ...
    def job_name(self, job_name):
        """Sets the job_name of this AddJobs.
    ...
    @property
    def jar_path(self):
        """Gets the jar_path of this AddJobs.
        ...
        :return: The jar_path of this AddJobs.
        :rtype: str
        """
    ...
    def jar_path(self, jar_path):
        """Sets the jar_path of this AddJobs.
    ...
    def input(self, input):
        """Sets the input of this AddJobs.
    ...
    def output(self, output):
        """Sets the output of this AddJobs.
    ...
    def job_log(self, job_log):
        """Sets the job_log of this AddJobs.
    ...
    def hive_script_path(self):
        """Gets the hive_script_path of this AddJobs.
        ...
        :return: The hive_script_path of this AddJobs.
        :rtype: str
        """
    ...
    def hive_script_path(self, hive_script_path):
        """Sets the hive_script_path of this AddJobs.
    ...
    @property
    def hql(self):
        """Gets the hql of this AddJobs.

        HQL脚本语句。

        :return: The hql of this AddJobs.
        :rtype: str
        """
        return self._hql
    ...
    def shutdown_cluster(self):
        """Gets the shutdown_cluster of this AddJobs.

        作业执行完成后，是否删除集群。  - true：是  - false：否

        :return: The shutdown_cluster of this AddJobs.
        :rtype: bool
        """
    ...
    def shutdown_cluster(self, shutdown_cluster):
        """Sets the shutdown_cluster of this AddJobs.
    ...
    def submit_job_once_cluster_run(self):
        """Gets the submit_job_once_cluster_run of this AddJobs.

        - true：创建集群同时提交作业  - false：单独提交作业  此处应设置为true。

        :return: The submit_job_once_cluster_run of this AddJobs.
        :rtype: bool
        """
    ...
    def submit_job_once_cluster_run(self, submit_job_once_cluster_run):
        """Sets the submit_job_once_cluster_run of this AddJobs.
    ...
    def file_action(self):
        """Gets the file_action of this AddJobs.

        数据导入导出。 - import - export

        :return: The file_action of this AddJobs.
        :rtype: str
        """
    ...
    def file_action(self, file_action):
        """Sets the file_action of this AddJobs.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddJobs):
            return False
