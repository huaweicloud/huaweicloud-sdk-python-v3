...
class UpdateAgencyMappingResponse(SdkResponse):
    ...
    def result(self):
        ...
        :return: The result of this UpdateAgencyMappingResponse.
        :rtype: str
        """
        return self._result
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateAgencyMappingResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateAgencyMappingResponse):
            return False
