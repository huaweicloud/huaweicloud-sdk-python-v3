...
class MrsAsyncClient(Client):
    ...
    def list_cluster_manager_auth_state_async(self, request):
        r"""查询集群界面授权状态
        ...
        :param request: Request instance for ListClusterManagerAuthState
        :type request: :class:`huaweicloudsdkmrs.v2.ListClusterManagerAuthStateRequest`
        :rtype: :class:`huaweicloudsdkmrs.v2.ListClusterManagerAuthStateResponse`
        """
        http_info = self._list_cluster_manager_auth_state_http_info(request)
        return self._call_api(**http_info)

    def list_cluster_manager_auth_state_async_invoker(self, request):
        http_info = self._list_cluster_manager_auth_state_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_cluster_manager_auth_state_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v2/{project_id}/clusters/{cluster_id}/manager-auth",
            "request_type": request.__class__.__name__,
            "response_type": "ListClusterManagerAuthStateResponse"
            }
    ...
    def update_cluster_auth_tros_async(self, request):
        r"""开启/关闭集群界面授权
        ...
        :param request: Request instance for UpdateClusterAuthTros
        :type request: :class:`huaweicloudsdkmrs.v2.UpdateClusterAuthTrosRequest`
        :rtype: :class:`huaweicloudsdkmrs.v2.UpdateClusterAuthTrosResponse`
        """
        http_info = self._update_cluster_auth_tros_http_info(request)
        return self._call_api(**http_info)

    def update_cluster_auth_tros_async_invoker(self, request):
        http_info = self._update_cluster_auth_tros_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_cluster_auth_tros_http_info(self, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v2/{project_id}/clusters/{cluster_id}/manager-auth",
            "request_type": request.__class__.__name__,
            "response_type": "UpdateClusterAuthTrosResponse"
            }
