...
class MrsClient(Client):
    ...
    def list_cluster_manager_auth_state(self, request):
        r"""查询集群界面授权状态
    ...
    def list_cluster_manager_auth_state_invoker(self, request):
        http_info = self._list_cluster_manager_auth_state_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_cluster_manager_auth_state_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_security_rule_status(self, request):
        r"""获取当前集群通信安全授权状态
    ...
    def list_security_rule_status_invoker(self, request):
        http_info = self._list_security_rule_status_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_security_rule_status_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def update_cluster_auth_tros(self, request):
        r"""开启/关闭集群界面授权
    ...
    def update_cluster_auth_tros_invoker(self, request):
        http_info = self._update_cluster_auth_tros_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_cluster_auth_tros_http_info(cls, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v2/{project_id}/clusters/{cluster_id}/manager-auth",
            "request_type": request.__class__.__name__,
    ...
    def cancel_sync_iam_user(self, request):
        r"""指定用户、用户组取消同步
    ...
    def cancel_sync_iam_user_invoker(self, request):
        http_info = self._cancel_sync_iam_user_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _cancel_sync_iam_user_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_sync_requirements(self, request):
        r"""查询指定集群的IAM同步情况
    ...
    def list_sync_requirements_invoker(self, request):
        http_info = self._list_sync_requirements_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_sync_requirements_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_sync_status(self, request):
        r"""查询当前集群是否在IAM同步进行中
    ...
    def list_sync_status_invoker(self, request):
        http_info = self._list_sync_status_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_sync_status_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_sync_iam_user(self, request):
        r"""获取已经同步的IAM用户和用户组
    ...
    def show_sync_iam_user_invoker(self, request):
        http_info = self._show_sync_iam_user_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_sync_iam_user_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v2/{project_id}/clusters/{cluster_id}/iam-sync-user",
            "request_type": request.__class__.__name__,
    ...
    def update_sync_iam_user(self, request):
        r"""IAM同步
    ...
    def update_sync_iam_user_invoker(self, request):
        http_info = self._update_sync_iam_user_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_sync_iam_user_http_info(cls, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v2/{project_id}/clusters/{cluster_id}/iam-sync-user",
            "request_type": request.__class__.__name__,
    ...
    def show_mrs_flavors(self, request):
        r"""查询MRS集群版本可用的规格
    ...
    def show_mrs_flavors_invoker(self, request):
        http_info = self._show_mrs_flavors_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_mrs_flavors_http_info(cls, request):
        http_info = {
            "method": "GET",
