...
class MrsAsyncClient(Client):
    ...
    def _create_and_execute_job_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def create_cluster_tag_async_invoker(self, request):
        http_info = self._create_cluster_tag_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_cluster_tag_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def delete_cluster_tag_async_invoker(self, request):
        http_info = self._delete_cluster_tag_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_cluster_tag_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def _delete_job_execution_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_async_task_status_async(self, request):
        r"""查询指定集群切换委托任务状态
        ...
        :param request: Request instance for ListAsyncTaskStatus
        :type request: :class:`huaweicloudsdkmrs.v1.ListAsyncTaskStatusRequest`
        :rtype: :class:`huaweicloudsdkmrs.v1.ListAsyncTaskStatusResponse`
        """
        http_info = self._list_async_task_status_http_info(request)
        return self._call_api(**http_info)

    def list_async_task_status_async_invoker(self, request):
        http_info = self._list_async_task_status_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_async_task_status_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/{project_id}/clusters/{cluster_id}/async_task_status/update_ecs_agency",
            "request_type": request.__class__.__name__,
            "response_type": "ListAsyncTaskStatusResponse"
            }
    ...
    def list_cluster_ssh_state_async(self, request):
        r"""查询集群节点授权状态
    ...
    def list_cluster_ssh_state_async_invoker(self, request):
        http_info = self._list_cluster_ssh_state_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_cluster_ssh_state_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_clusters_by_tags_async_invoker(self, request):
        http_info = self._list_clusters_by_tags_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_clusters_by_tags_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def _list_execute_job_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_cluster_details_async_invoker(self, request):
        http_info = self._show_cluster_details_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_cluster_details_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def _show_job_exes_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def update_cluster_scaling_async_invoker(self, request):
        http_info = self._update_cluster_scaling_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_cluster_scaling_http_info(self, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v1.1/{project_id}/cluster_infos/{cluster_id}",
            "request_type": request.__class__.__name__,
    ...
    def update_cluster_ssh_async(self, request):
        r"""开启/关闭集群节点授权
    ...
    def update_cluster_ssh_async_invoker(self, request):
        http_info = self._update_cluster_ssh_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_cluster_ssh_http_info(self, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v1/cluster/{cluster_id}/ssh",
            "request_type": request.__class__.__name__,
