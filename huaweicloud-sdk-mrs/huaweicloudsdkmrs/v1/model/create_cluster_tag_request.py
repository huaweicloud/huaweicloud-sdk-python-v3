...
class CreateClusterTagRequest:
    ...
    @property
    def cluster_id(self):
        r"""Gets the cluster_id of this CreateClusterTagRequest.

        集群ID。

        :return: The cluster_id of this CreateClusterTagRequest.
        :rtype: str
        """
    ...
    def cluster_id(self, cluster_id):
        r"""Sets the cluster_id of this CreateClusterTagRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this CreateClusterTagRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this CreateClusterTagRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateClusterTagRequest):
            return False
