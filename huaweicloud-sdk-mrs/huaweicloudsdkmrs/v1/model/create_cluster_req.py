...
class CreateClusterReq:
    ...
    openapi_types = {
        ...
        'core_node_size': 'str',
        'component_list': 'list[ComponentList]',
        ...
        'task_node_groups': 'list[TaskNodeGroups]',
    ...
    def cluster_version(self):
        """Gets the cluster_version of this CreateClusterReq.

        集群版本。 MRS目前支持MRS 1.8.10、MRS 1.9.2、MRS 2.1.0、MRS 3.0.2版本。

        :return: The cluster_version of this CreateClusterReq.
        :rtype: str
        """
    ...
    def cluster_version(self, cluster_version):
        """Sets the cluster_version of this CreateClusterReq.
    ...
    def cluster_name(self):
        """Gets the cluster_name of this CreateClusterReq.
    ...
    def cluster_name(self, cluster_name):
        """Sets the cluster_name of this CreateClusterReq.
    ...
    def master_node_num(self):
        """Gets the master_node_num of this CreateClusterReq.

        Master节点数量。启用集群高可用功能时配置为2，不启用集群高可用功能时配置为1。

        :return: The master_node_num of this CreateClusterReq.
        :rtype: int
        """
    ...
    def master_node_num(self, master_node_num):
        """Sets the master_node_num of this CreateClusterReq.
    ...
    def billing_type(self):
        """Gets the billing_type of this CreateClusterReq.

        集群的计费模式。   12表示按需计费。接口调用仅支持创建按需计费集群。

        :return: The billing_type of this CreateClusterReq.
        :rtype: int
        """
    ...
    def billing_type(self, billing_type):
        """Sets the billing_type of this CreateClusterReq.
    ...
    def data_center(self):
        """Gets the data_center of this CreateClusterReq.

        集群区域信息，请参见[终端节点及区域](mrs_02_0003.xml)。

        :return: The data_center of this CreateClusterReq.
        :rtype: str
        """
    ...
    def data_center(self, data_center):
        """Sets the data_center of this CreateClusterReq.
    ...
    @vpc.setter
    def vpc(self, vpc):
        """Sets the vpc of this CreateClusterReq.
    ...
    def master_node_size(self):
        """Gets the master_node_size of this CreateClusterReq.
        ...
        :return: The master_node_size of this CreateClusterReq.
        :rtype: str
        """
    ...
    def master_node_size(self, master_node_size):
        """Sets the master_node_size of this CreateClusterReq.
    ...
    def core_node_size(self, core_node_size):
        """Sets the core_node_size of this CreateClusterReq.
    ...
    def component_list(self):
        """Gets the component_list of this CreateClusterReq.
    ...
    def component_list(self, component_list):
        """Sets the component_list of this CreateClusterReq.
    ...
    def available_zone_id(self):
        """Gets the available_zone_id of this CreateClusterReq.
        ...
        :return: The available_zone_id of this CreateClusterReq.
        :rtype: str
        """
    ...
    def available_zone_id(self, available_zone_id):
        """Sets the available_zone_id of this CreateClusterReq.
    ...
    def vpc_id(self, vpc_id):
        """Sets the vpc_id of this CreateClusterReq.
    ...
    @property
    def subnet_id(self):
        """Gets the subnet_id of this CreateClusterReq.
        ...
        :return: The subnet_id of this CreateClusterReq.
        :rtype: str
        """
    ...
    def subnet_id(self, subnet_id):
        """Sets the subnet_id of this CreateClusterReq.
    ...
    def subnet_name(self):
        """Gets the subnet_name of this CreateClusterReq.
        ...
        :return: The subnet_name of this CreateClusterReq.
        :rtype: str
        """
    ...
    def subnet_name(self, subnet_name):
        """Sets the subnet_name of this CreateClusterReq.
    ...
    def security_groups_id(self):
        """Gets the security_groups_id of this CreateClusterReq.
        ...
        :return: The security_groups_id of this CreateClusterReq.
        :rtype: str
        """
    ...
    def security_groups_id(self, security_groups_id):
        """Sets the security_groups_id of this CreateClusterReq.
    ...
    @property
    def add_jobs(self):
        """Gets the add_jobs of this CreateClusterReq.
    ...
    def add_jobs(self, add_jobs):
        """Sets the add_jobs of this CreateClusterReq.
    ...
    def volume_size(self):
        """Gets the volume_size of this CreateClusterReq.
        ...
        :return: The volume_size of this CreateClusterReq.
        :rtype: int
        """
    ...
    def volume_size(self, volume_size):
        """Sets the volume_size of this CreateClusterReq.
    ...
    def volume_type(self):
        """Gets the volume_type of this CreateClusterReq.
        ...
        :return: The volume_type of this CreateClusterReq.
        :rtype: str
        """
    ...
    def volume_type(self, volume_type):
        """Sets the volume_type of this CreateClusterReq.
    ...
    def master_data_volume_type(self):
        """Gets the master_data_volume_type of this CreateClusterReq.

        该参数为多磁盘参数，表示Master节点数据磁盘存储类别，目前支持SATA、SAS、SSD和GPSSD。

        :return: The master_data_volume_type of this CreateClusterReq.
        :rtype: str
        """
    ...
    def master_data_volume_type(self, master_data_volume_type):
        """Sets the master_data_volume_type of this CreateClusterReq.
    ...
    def master_data_volume_size(self):
        """Gets the master_data_volume_size of this CreateClusterReq.

        该参数为多磁盘参数，表示Master节点数据磁盘存储空间。为增大数据存储容量，创建集群时可同时添加磁盘。  取值范围：100GB～32000GB，传值只需填数字，不需要带单位GB。

        :return: The master_data_volume_size of this CreateClusterReq.
        :rtype: int
        """
    ...
    def master_data_volume_size(self, master_data_volume_size):
        """Sets the master_data_volume_size of this CreateClusterReq.
    ...
    def master_data_volume_count(self):
        """Gets the master_data_volume_count of this CreateClusterReq.

        该参数为多磁盘参数，表示Master节点数据磁盘个数。取值只能是1。

        :return: The master_data_volume_count of this CreateClusterReq.
        :rtype: int
        """
    ...
    def master_data_volume_count(self, master_data_volume_count):
        """Sets the master_data_volume_count of this CreateClusterReq.
    ...
    def core_data_volume_type(self):
        """Gets the core_data_volume_type of this CreateClusterReq.

        该参数为多磁盘参数，表示Core节点数据磁盘存储类别，目前支持SATA、SAS、SSD和GPSSD。

        :return: The core_data_volume_type of this CreateClusterReq.
        :rtype: str
        """
    ...
    def core_data_volume_type(self, core_data_volume_type):
        """Sets the core_data_volume_type of this CreateClusterReq.
    ...
    def core_data_volume_size(self):
        """Gets the core_data_volume_size of this CreateClusterReq.

        该参数为多磁盘参数，表示Core节点数据磁盘存储空间。为增大数据存储容量，创建集群时可同时添加磁盘。  取值范围：100GB～32000GB，传值只需填数字，不需要带单位GB。

        :return: The core_data_volume_size of this CreateClusterReq.
        :rtype: int
        """
    ...
    def core_data_volume_size(self, core_data_volume_size):
        """Sets the core_data_volume_size of this CreateClusterReq.
    ...
    def core_data_volume_count(self):
        """Gets the core_data_volume_count of this CreateClusterReq.

        该参数为多磁盘参数，表示Core节点数据磁盘个数。 取值范围：1～10

        :return: The core_data_volume_count of this CreateClusterReq.
        :rtype: int
        """
    ...
    def core_data_volume_count(self, core_data_volume_count):
        """Sets the core_data_volume_count of this CreateClusterReq.
    ...
    def task_node_groups(self):
        """Gets the task_node_groups of this CreateClusterReq.
    ...
    def task_node_groups(self, task_node_groups):
        """Sets the task_node_groups of this CreateClusterReq.
    ...
    def bootstrap_scripts(self):
        """Gets the bootstrap_scripts of this CreateClusterReq.
    ...
    def bootstrap_scripts(self, bootstrap_scripts):
        """Sets the bootstrap_scripts of this CreateClusterReq.
    ...
    def node_public_cert_name(self):
        """Gets the node_public_cert_name of this CreateClusterReq.

        密钥对名称。用户可以使用密钥对方式登录集群节点。当“login_mode”配置为“1”时，请求消息体中包含node_public_cert_name字段。

        :return: The node_public_cert_name of this CreateClusterReq.
        :rtype: str
        """
    ...
    def node_public_cert_name(self, node_public_cert_name):
        """Sets the node_public_cert_name of this CreateClusterReq.
    ...
    @property
    def safe_mode(self):
        """Gets the safe_mode of this CreateClusterReq.
        ...
        :return: The safe_mode of this CreateClusterReq.
        :rtype: int
        """
    ...
    def safe_mode(self, safe_mode):
        """Sets the safe_mode of this CreateClusterReq.
    ...
    def cluster_type(self):
        """Gets the cluster_type of this CreateClusterReq.

        集群类型。  默认值为0：分析集群。  说明：暂不支持通过接口方式创建混合集群。  枚举值： - 0：分析集群 - 1：流式集群

        :return: The cluster_type of this CreateClusterReq.
        :rtype: int
        """
    ...
    def cluster_type(self, cluster_type):
        """Sets the cluster_type of this CreateClusterReq.
    ...
    def log_collection(self):
        """Gets the log_collection of this CreateClusterReq.

        集群创建失败时，是否收集失败日志。  默认设置为1，将创建OBS桶仅用于MRS集群创建失败时的日志收集。  枚举值： - 0：不收集 - 1：收集

        :return: The log_collection of this CreateClusterReq.
        :rtype: int
        """
    ...
    def log_collection(self, log_collection):
        """Sets the log_collection of this CreateClusterReq.
    ...
    def enterprise_project_id(self, enterprise_project_id):
        """Sets the enterprise_project_id of this CreateClusterReq.
    ...
    @property
    def tags(self):
        """Gets the tags of this CreateClusterReq.
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this CreateClusterReq.
    ...
    @property
    def login_mode(self):
        """Gets the login_mode of this CreateClusterReq.
        ...
        :return: The login_mode of this CreateClusterReq.
        :rtype: int
        """
    ...
    def login_mode(self, login_mode):
        """Sets the login_mode of this CreateClusterReq.
