...
class ListClustersByTagsRequest:
    ...
    def __init__(self, body=None):
        """ListClustersByTagsRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListClustersByTagsRequest):
            return False
