...
class CreateAndExecuteJobRequest:
    ...
    def __init__(self, body=None):
        """CreateAndExecuteJobRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateAndExecuteJobRequest):
            return False
