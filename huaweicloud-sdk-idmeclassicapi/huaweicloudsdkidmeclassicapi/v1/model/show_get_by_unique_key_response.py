...
class ShowGetByUniqueKeyResponse(SdkResponse):
    ...
    def __init__(self, result=None, data=None, errors=None):
        ...
        super(ShowGetByUniqueKeyResponse, self).__init__()
    ...
    @property
    def result(self):
        """Gets the result of this ShowGetByUniqueKeyResponse.
    ...
    def result(self, result):
        """Sets the result of this ShowGetByUniqueKeyResponse.
    ...
    @property
    def data(self):
        """Gets the data of this ShowGetByUniqueKeyResponse.
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this ShowGetByUniqueKeyResponse.
    ...
    @property
    def errors(self):
        """Gets the errors of this ShowGetByUniqueKeyResponse.
    ...
    def errors(self, errors):
        """Sets the errors of this ShowGetByUniqueKeyResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowGetByUniqueKeyResponse):
            return False
