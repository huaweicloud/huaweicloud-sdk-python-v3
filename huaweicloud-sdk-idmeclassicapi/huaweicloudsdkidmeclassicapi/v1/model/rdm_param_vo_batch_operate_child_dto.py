...
class RDMParamVOBatchOperateChildDTO:
    ...
    def application_id(self):
        ...
        **参数解释**：  应用ID。  **约束限制**：  不涉及。  **取值范围**：  由英文字母和数字组成，且长度为32个字符。  **默认取值**：  不涉及。
        ...
        :return: The application_id of this RDMParamVOBatchOperateChildDTO.
        :rtype: str
        """
    ...
    def application_id(self, application_id):
        ...
        **参数解释**：  应用ID。  **约束限制**：  不涉及。  **取值范围**：  由英文字母和数字组成，且长度为32个字符。  **默认取值**：  不涉及。
        ...
        :param application_id: The application_id of this RDMParamVOBatchOperateChildDTO.
        :type application_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RDMParamVOBatchOperateChildDTO):
            return False
