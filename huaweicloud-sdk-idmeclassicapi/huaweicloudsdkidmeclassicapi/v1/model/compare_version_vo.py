...
class CompareVersionVO:
    ...
    def __init__(self, id=None, basic_version=None, correlation_version=None):
        r"""CompareVersionVO

        The model defined in huaweicloud sdk

        :param id: **参数解释：**  数据实例ID，用于指定待对比版本的数据实例。 获取方法请参见[分页查询实例 - ShowFindUsingPost](https://support.huaweicloud.com/api-idme/ShowFindUsingPost.html)。  **约束限制：**  不涉及。  **取值范围：**  -9223372036854775808到9223372036854775807的整数。  **默认取值：**  不涉及。
        :type id: str
        :param basic_version: **参数解释：**  基础版本号，作为对比的基准版本。对应系统版本号（rdmVersion）。  **约束限制：**  不涉及。  **取值范围：**  不涉及。  **默认取值：**  不涉及。
        :type basic_version: str
        :param correlation_version: **参数解释：**  对比版本号，与基础版本进行对比的目标版本。对应系统版本号（rdmVersion）。  **约束限制：**  不涉及。  **取值范围：**  不涉及。  **默认取值：**  不涉及。
    ...
    def id(self):
        ...
        **参数解释：**  数据实例ID，用于指定待对比版本的数据实例。 获取方法请参见[分页查询实例 - ShowFindUsingPost](https://support.huaweicloud.com/api-idme/ShowFindUsingPost.html)。  **约束限制：**  不涉及。  **取值范围：**  -9223372036854775808到9223372036854775807的整数。  **默认取值：**  不涉及。
        ...
        :return: The id of this CompareVersionVO.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        **参数解释：**  数据实例ID，用于指定待对比版本的数据实例。 获取方法请参见[分页查询实例 - ShowFindUsingPost](https://support.huaweicloud.com/api-idme/ShowFindUsingPost.html)。  **约束限制：**  不涉及。  **取值范围：**  -9223372036854775808到9223372036854775807的整数。  **默认取值：**  不涉及。
        ...
        :param id: The id of this CompareVersionVO.
        :type id: str
        """
        self._id = id
    ...
    def basic_version(self):
        ...
        **参数解释：**  基础版本号，作为对比的基准版本。对应系统版本号（rdmVersion）。  **约束限制：**  不涉及。  **取值范围：**  不涉及。  **默认取值：**  不涉及。
        ...
        :return: The basic_version of this CompareVersionVO.
        :rtype: str
        """
    ...
    def basic_version(self, basic_version):
        ...
        **参数解释：**  基础版本号，作为对比的基准版本。对应系统版本号（rdmVersion）。  **约束限制：**  不涉及。  **取值范围：**  不涉及。  **默认取值：**  不涉及。
        ...
        :param basic_version: The basic_version of this CompareVersionVO.
        :type basic_version: str
        """
    ...
    def correlation_version(self):
        ...
        **参数解释：**  对比版本号，与基础版本进行对比的目标版本。对应系统版本号（rdmVersion）。  **约束限制：**  不涉及。  **取值范围：**  不涉及。  **默认取值：**  不涉及。
        ...
        :return: The correlation_version of this CompareVersionVO.
        :rtype: str
        """
    ...
    def correlation_version(self, correlation_version):
        ...
        **参数解释：**  对比版本号，与基础版本进行对比的目标版本。对应系统版本号（rdmVersion）。  **约束限制：**  不涉及。  **取值范围：**  不涉及。  **默认取值：**  不涉及。
        ...
        :param correlation_version: The correlation_version of this CompareVersionVO.
        :type correlation_version: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CompareVersionVO):
            return False
