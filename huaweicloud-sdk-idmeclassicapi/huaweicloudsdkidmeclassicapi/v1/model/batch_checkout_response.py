...
class BatchCheckoutResponse(SdkResponse):
    ...
    @property
    def result(self):
        r"""Gets the result of this BatchCheckoutResponse.
    ...
    def result(self, result):
        r"""Sets the result of this BatchCheckoutResponse.
    ...
    @property
    def data(self):
        r"""Gets the data of this BatchCheckoutResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this BatchCheckoutResponse.
    ...
    @property
    def errors(self):
        r"""Gets the errors of this BatchCheckoutResponse.
    ...
    def errors(self, errors):
        r"""Sets the errors of this BatchCheckoutResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchCheckoutResponse.to_dict() is deprecated and no longer maintained, "
