...
class RDMParamVOListBatchUpdateStructuredDocDto:
    ...
    openapi_types = {
        'application_id': 'str',
        'params': 'list[BatchUpdateStructuredDocDto]'
    }
    ...
    def __init__(self, application_id=None, params=None):
        r"""RDMParamVOListBatchUpdateStructuredDocDto
        ...
        :param params: **参数解释：**  批量更新参数数组，每个元素包含一个待更新文档的标识信息和更新内容。  **约束限制：**  不涉及。  **取值范围：**  不涉及。  **默认取值：**  不涉及。
    ...
    def application_id(self):
        r"""Gets the application_id of this RDMParamVOListBatchUpdateStructuredDocDto.
        ...
        **参数解释：**  应用ID，用于指定实例所属的应用。 当URL路径中已能明确应用上下文时，此参数可不传。 获取方法请参见[获取租户下的应用清单 - ListApps](https://support.huaweicloud.com/api-idme/ListApps.html)。  **约束限制：**  不涉及。  **取值范围：**  - 于2023年06月01日之前创建的应用：由英文字母和数字组成，长度为1-36个字符。 - 于2023年06月01日之后创建的应用：由英文字母和数字组成，且长度为32个字符。  **默认取值：**  不涉及。
        ...
        :return: The application_id of this RDMParamVOListBatchUpdateStructuredDocDto.
        :rtype: str
        """
    ...
    def application_id(self, application_id):
        r"""Sets the application_id of this RDMParamVOListBatchUpdateStructuredDocDto.

        **参数解释：**  应用ID，用于指定实例所属的应用。 当URL路径中已能明确应用上下文时，此参数可不传。 获取方法请参见[获取租户下的应用清单 - ListApps](https://support.huaweicloud.com/api-idme/ListApps.html)。  **约束限制：**  不涉及。  **取值范围：**  - 于2023年06月01日之前创建的应用：由英文字母和数字组成，长度为1-36个字符。 - 于2023年06月01日之后创建的应用：由英文字母和数字组成，且长度为32个字符。  **默认取值：**  不涉及。

        :param application_id: The application_id of this RDMParamVOListBatchUpdateStructuredDocDto.
        :type application_id: str
        """
    ...
    @property
    def params(self):
        r"""Gets the params of this RDMParamVOListBatchUpdateStructuredDocDto.
    ...
    def params(self, params):
        r"""Sets the params of this RDMParamVOListBatchUpdateStructuredDocDto.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RDMParamVOListBatchUpdateStructuredDocDto):
            return False
