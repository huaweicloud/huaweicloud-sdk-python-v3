...
class PersistableModelQueryViewDTO:
    ...
    def __init__(self, class_name=None, create_time=None, creator=None, disable_flag=None, ext_attr_map=None, ext_attrs=None, folder=None, id=None, last_update_time=None, modifier=None, rdm_extension_type=None, tenant=None):
        ...
        :param class_name: **参数解释：**  类名，表示数据实例的具体类类型。  **取值范围：**  不涉及。 
        :type class_name: str
        :param create_time: **参数解释：**  创建时间。使用UTC+0时间格式，格式为yyyy-MM-ddTHH:mm:ss.SSSZ。  **取值范围：**  不涉及。 
        :type create_time: str
        :param creator: **参数解释：**  创建者账号。  **取值范围：**  不涉及。 
        :type creator: str
        :param disable_flag: **参数解释：**  失效标识，用于标识实例是否已失效。   **取值范围：**  - true：失效。  - false：未失效。 
        :type disable_flag: bool
        :param ext_attr_map: **参数解释：**  扩展属性映射集，以键值对形式存储扩展属性。   **取值范围：**  不涉及。 
        :type ext_attr_map: object
        :param ext_attrs: **参数解释：**  扩展属性列表，包含实例的所有扩展属性详情。  **取值范围：**  不涉及。 
        ...
        :param id: **参数解释：**  数据实例的唯一标识。  **取值范围：**  -9223372036854775808到9223372036854775807的整数。 
        :type id: str
        ...
        :type modifier: str
        :param rdm_extension_type: **参数解释：**  扩展类型，表示数据模型的具体扩展类型。  **取值范围：**  不涉及。 
