...
class BatchAddChildNodeResponse(SdkResponse):
    ...
    openapi_types = {
        'result': 'str',
        'data': 'list[TreeableModelViewDTO]',
        'errors': 'list[str]'
    }
    ...
    def __init__(self, result=None, data=None, errors=None):
        ...
        super(BatchAddChildNodeResponse, self).__init__()
    ...
    @property
    def result(self):
        """Gets the result of this BatchAddChildNodeResponse.
    ...
    def result(self, result):
        """Sets the result of this BatchAddChildNodeResponse.
    ...
    @property
    def data(self):
        """Gets the data of this BatchAddChildNodeResponse.
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this BatchAddChildNodeResponse.
    ...
    @property
    def errors(self):
        """Gets the errors of this BatchAddChildNodeResponse.
    ...
    def errors(self, errors):
        """Sets the errors of this BatchAddChildNodeResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchAddChildNodeResponse):
            return False
