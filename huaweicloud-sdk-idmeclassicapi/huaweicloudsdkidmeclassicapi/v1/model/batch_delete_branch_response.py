...
class BatchDeleteBranchResponse(SdkResponse):
    ...
    @property
    def result(self):
        """Gets the result of this BatchDeleteBranchResponse.
    ...
    def result(self, result):
        """Sets the result of this BatchDeleteBranchResponse.
    ...
    @property
    def data(self):
        """Gets the data of this BatchDeleteBranchResponse.
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this BatchDeleteBranchResponse.
    ...
    @property
    def errors(self):
        """Gets the errors of this BatchDeleteBranchResponse.
    ...
    def errors(self, errors):
        """Sets the errors of this BatchDeleteBranchResponse.
