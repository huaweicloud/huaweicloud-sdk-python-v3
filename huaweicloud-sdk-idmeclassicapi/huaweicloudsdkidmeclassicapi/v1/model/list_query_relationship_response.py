...
class ListQueryRelationshipResponse(SdkResponse):
    ...
    openapi_types = {
        'result': 'str',
        'data': 'list[RelationModelViewDTO]',
        'errors': 'list[str]',
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListQueryRelationshipResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListQueryRelationshipResponse):
            return False
