...
class BatchCheckoutRequest:
    ...
    def __init__(self, identifier=None, model_name=None, body=None):
        ...
        :type model_name: str
        :param body: Body of the BatchCheckoutRequest
    ...
    def identifier(self):
        ...
        **参数解释：**  应用唯一标识。  **约束限制：**  不涉及。  **取值范围：**  由英文字母和数字组成，且长度为32个字符。  **默认取值：**  不涉及。 
        ...
        :return: The identifier of this BatchCheckoutRequest.
        :rtype: str
        """
    ...
    def identifier(self, identifier):
        ...
        **参数解释：**  应用唯一标识。  **约束限制：**  不涉及。  **取值范围：**  由英文字母和数字组成，且长度为32个字符。  **默认取值：**  不涉及。 
        ...
        :param identifier: The identifier of this BatchCheckoutRequest.
        :type identifier: str
        """
    ...
    def model_name(self):
        ...
        **参数解释：**  数据模型的英文名称。  **约束限制：**  不涉及。  **取值范围：**  大写字母开头，只能包含字母、数字、“_”，且长度为[1-60]个字符。  **默认取值：**  不涉及。
        ...
        :return: The model_name of this BatchCheckoutRequest.
        :rtype: str
        """
    ...
    def model_name(self, model_name):
        ...
        **参数解释：**  数据模型的英文名称。  **约束限制：**  不涉及。  **取值范围：**  大写字母开头，只能包含字母、数字、“_”，且长度为[1-60]个字符。  **默认取值：**  不涉及。
        ...
        :param model_name: The model_name of this BatchCheckoutRequest.
        :type model_name: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchCheckoutRequest):
            return False
