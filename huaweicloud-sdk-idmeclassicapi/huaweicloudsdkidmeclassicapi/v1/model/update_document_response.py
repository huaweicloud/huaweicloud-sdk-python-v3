...
class UpdateDocumentResponse(SdkResponse):
    ...
    @property
    def result(self):
        r"""Gets the result of this UpdateDocumentResponse.

        **参数解释：**  请求结果。  **取值范围：**  - SUCCESS：请求成功。 - FAIL：请求失败。 

        :return: The result of this UpdateDocumentResponse.
        :rtype: str
        """
        return self._result
    ...
    def result(self, result):
        r"""Sets the result of this UpdateDocumentResponse.

        **参数解释：**  请求结果。  **取值范围：**  - SUCCESS：请求成功。 - FAIL：请求失败。 

        :param result: The result of this UpdateDocumentResponse.
        :type result: str
        """
        self._result = result
    ...
    @property
    def errors(self):
        r"""Gets the errors of this UpdateDocumentResponse.

        **参数解释：**  异常信息，当请求失败时返回具体的错误描述。  **取值范围：**  不涉及。 

        :return: The errors of this UpdateDocumentResponse.
        :rtype: list[str]
        """
        return self._errors
    ...
    def errors(self, errors):
        r"""Sets the errors of this UpdateDocumentResponse.

        **参数解释：**  异常信息，当请求失败时返回具体的错误描述。  **取值范围：**  不涉及。 

        :param errors: The errors of this UpdateDocumentResponse.
        :type errors: list[str]
        """
        self._errors = errors
