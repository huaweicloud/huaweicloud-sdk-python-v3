...
class MultiViewModelBranchViewDTO:
    ...
    def __init__(self, id=None, class_name=None, create_time=None, creator=None, last_update_time=None, modifier=None, rdm_delete_flag=None, rdm_extension_type=None, rdm_version=None, tenant=None, version=None):
