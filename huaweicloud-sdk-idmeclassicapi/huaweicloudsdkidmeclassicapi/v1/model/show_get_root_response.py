...
class ShowGetRootResponse(SdkResponse):
    ...
    def result(self):
        ...
        **参数解释：**  请求结果。  **取值范围：**  - SUCCESS：请求成功。 - FAIL：请求失败。 
        ...
        :return: The result of this ShowGetRootResponse.
        :rtype: str
        """
        return self._result
    ...
    def result(self, result):
        ...
        **参数解释：**  请求结果。  **取值范围：**  - SUCCESS：请求成功。 - FAIL：请求失败。 
        ...
        :param result: The result of this ShowGetRootResponse.
        :type result: str
        """
        self._result = result
    ...
    def data(self):
        ...
        **参数解释：**  请求数据，返回目标数据实例所在树形结构的根节点信息列表。 数组按从直接父节点到根节点的顺序排列，包含各父节点的完整列表属性。  **取值范围：**  不涉及。
        ...
        :return: The data of this ShowGetRootResponse.
    ...
    def data(self, data):
        ...
        **参数解释：**  请求数据，返回目标数据实例所在树形结构的根节点信息列表。 数组按从直接父节点到根节点的顺序排列，包含各父节点的完整列表属性。  **取值范围：**  不涉及。
        ...
        :param data: The data of this ShowGetRootResponse.
        :type data: list[:class:`huaweicloudsdkidmeclassicapi.v1.BasicObjectQueryViewDTO`]
        """
        self._data = data
    ...
    def errors(self):
        ...
        **参数解释：**  异常信息，当请求失败时返回具体的错误描述。  **取值范围：**  不涉及。 
        ...
        :return: The errors of this ShowGetRootResponse.
        :rtype: list[str]
        """
        return self._errors
    ...
    def errors(self, errors):
        ...
        **参数解释：**  异常信息，当请求失败时返回具体的错误描述。  **取值范围：**  不涉及。 
        ...
        :param errors: The errors of this ShowGetRootResponse.
        :type errors: list[str]
        """
        self._errors = errors
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowGetRootResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowGetRootResponse):
            return False
