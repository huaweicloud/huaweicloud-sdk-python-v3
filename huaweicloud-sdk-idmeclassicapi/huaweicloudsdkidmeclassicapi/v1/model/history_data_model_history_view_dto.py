...
class HistoryDataModelHistoryViewDTO:
    ...
    def last_update_time(self):
        ...
        **参数解释：**  修改时间。使用UTC+0时间格式，格式为yyyy-MM-ddTHH:mm:ss.SSSZ。  **取值范围：**  不涉及。 
