...
class PersistableModelCreateDTO:
    ...
    @property
    def acl_entry(self):
        """Gets the acl_entry of this PersistableModelCreateDTO.

        访问控制列表。

        :return: The acl_entry of this PersistableModelCreateDTO.
        :rtype: str
        """
    ...
    def acl_entry(self, acl_entry):
        """Sets the acl_entry of this PersistableModelCreateDTO.

        访问控制列表。

        :param acl_entry: The acl_entry of this PersistableModelCreateDTO.
        :type acl_entry: str
        """
    ...
    @property
    def cls_attrs(self):
        """Gets the cls_attrs of this PersistableModelCreateDTO.

        分类属性。

        :return: The cls_attrs of this PersistableModelCreateDTO.
        :rtype: list[object]
        """
    ...
    def cls_attrs(self, cls_attrs):
        """Sets the cls_attrs of this PersistableModelCreateDTO.

        分类属性。

        :param cls_attrs: The cls_attrs of this PersistableModelCreateDTO.
        :type cls_attrs: list[object]
        """
    ...
    def disable_flag(self):
        """Gets the disable_flag of this PersistableModelCreateDTO.

        失效标识。  - true：失效。  - false：未失效。

        :return: The disable_flag of this PersistableModelCreateDTO.
        :rtype: bool
        """
    ...
    def disable_flag(self, disable_flag):
        """Sets the disable_flag of this PersistableModelCreateDTO.

        失效标识。  - true：失效。  - false：未失效。

        :param disable_flag: The disable_flag of this PersistableModelCreateDTO.
        :type disable_flag: bool
        """
    ...
    def ext_attr_map(self):
        """Gets the ext_attr_map of this PersistableModelCreateDTO.

        扩展属性映射集。

        :return: The ext_attr_map of this PersistableModelCreateDTO.
        :rtype: object
        """
    ...
    def ext_attr_map(self, ext_attr_map):
        """Sets the ext_attr_map of this PersistableModelCreateDTO.

        扩展属性映射集。

        :param ext_attr_map: The ext_attr_map of this PersistableModelCreateDTO.
        :type ext_attr_map: object
        """
    ...
    @property
    def ext_attrs(self):
        """Gets the ext_attrs of this PersistableModelCreateDTO.

        扩展属性列表。

        :return: The ext_attrs of this PersistableModelCreateDTO.
    ...
    def ext_attrs(self, ext_attrs):
        """Sets the ext_attrs of this PersistableModelCreateDTO.

        扩展属性列表。

        :param ext_attrs: The ext_attrs of this PersistableModelCreateDTO.
        :type ext_attrs: list[:class:`huaweicloudsdkidmeclassicapi.v1.EXAValueParamDTO`]
        """
    ...
    @property
    def folder(self):
        """Gets the folder of this PersistableModelCreateDTO.

        :return: The folder of this PersistableModelCreateDTO.
    ...
    def folder(self, folder):
        """Sets the folder of this PersistableModelCreateDTO.

        :param folder: The folder of this PersistableModelCreateDTO.
        :type folder: :class:`huaweicloudsdkidmeclassicapi.v1.ObjectReferenceParamDTO`
        """
        self._folder = folder
    ...
    def lifecycle_state(self):
        """Gets the lifecycle_state of this PersistableModelCreateDTO.

        :return: The lifecycle_state of this PersistableModelCreateDTO.
        :rtype: :class:`huaweicloudsdkidmeclassicapi.v1.ObjectReferenceParamDTO`
        """
    ...
    def lifecycle_state(self, lifecycle_state):
        """Sets the lifecycle_state of this PersistableModelCreateDTO.

        :param lifecycle_state: The lifecycle_state of this PersistableModelCreateDTO.
        :type lifecycle_state: :class:`huaweicloudsdkidmeclassicapi.v1.ObjectReferenceParamDTO`
        """
    ...
    def lifecycle_template(self):
        """Gets the lifecycle_template of this PersistableModelCreateDTO.

        :return: The lifecycle_template of this PersistableModelCreateDTO.
        :rtype: :class:`huaweicloudsdkidmeclassicapi.v1.ObjectReferenceParamDTO`
        """
    ...
    def lifecycle_template(self, lifecycle_template):
        """Sets the lifecycle_template of this PersistableModelCreateDTO.

        :param lifecycle_template: The lifecycle_template of this PersistableModelCreateDTO.
        :type lifecycle_template: :class:`huaweicloudsdkidmeclassicapi.v1.ObjectReferenceParamDTO`
        """
    ...
    @property
    def owner(self):
        """Gets the owner of this PersistableModelCreateDTO.

        拥有者。

        :return: The owner of this PersistableModelCreateDTO.
        :rtype: str
        """
        return self._owner
    ...
    def owner(self, owner):
        """Sets the owner of this PersistableModelCreateDTO.

        拥有者。

        :param owner: The owner of this PersistableModelCreateDTO.
        :type owner: str
        """
        self._owner = owner
    ...
    def parent_node(self):
        """Gets the parent_node of this PersistableModelCreateDTO.

        :return: The parent_node of this PersistableModelCreateDTO.
        :rtype: :class:`huaweicloudsdkidmeclassicapi.v1.ObjectReferenceParamDTO`
        """
    ...
    def parent_node(self, parent_node):
        """Sets the parent_node of this PersistableModelCreateDTO.

        :param parent_node: The parent_node of this PersistableModelCreateDTO.
        :type parent_node: :class:`huaweicloudsdkidmeclassicapi.v1.ObjectReferenceParamDTO`
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PersistableModelCreateDTO):
            return False
