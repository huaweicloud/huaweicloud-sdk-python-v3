...
class GeneralPolicyBodyDto:
    ...
    def disable_fork(self):
        r"""Gets the disable_fork of this GeneralPolicyBodyDto.

        **参数解释：** 是否禁止fork该仓库。 **约束限制：** 不涉及。 **取值范围：** - true，禁止fork。 - false，允许fork。 **默认取值：** 不涉及。

        :return: The disable_fork of this GeneralPolicyBodyDto.
        :rtype: bool
        """
    ...
    def disable_fork(self, disable_fork):
        r"""Sets the disable_fork of this GeneralPolicyBodyDto.

        **参数解释：** 是否禁止fork该仓库。 **约束限制：** 不涉及。 **取值范围：** - true，禁止fork。 - false，允许fork。 **默认取值：** 不涉及。

        :param disable_fork: The disable_fork of this GeneralPolicyBodyDto.
        :type disable_fork: bool
        """
    ...
    def generate_pre_merge_ref(self):
        r"""Gets the generate_pre_merge_ref of this GeneralPolicyBodyDto.

        **参数解释：** 是否预合并MR。 **约束限制：** 不涉及。 **取值范围：** - true，禁止预合并MR。 - false，允许预合并MR。 **默认取值：** 不涉及。

        :return: The generate_pre_merge_ref of this GeneralPolicyBodyDto.
        :rtype: bool
        """
    ...
    def generate_pre_merge_ref(self, generate_pre_merge_ref):
        r"""Sets the generate_pre_merge_ref of this GeneralPolicyBodyDto.

        **参数解释：** 是否预合并MR。 **约束限制：** 不涉及。 **取值范围：** - true，禁止预合并MR。 - false，允许预合并MR。 **默认取值：** 不涉及。

        :param generate_pre_merge_ref: The generate_pre_merge_ref of this GeneralPolicyBodyDto.
        :type generate_pre_merge_ref: bool
        """
    ...
    def branch_name_regex(self):
        r"""Gets the branch_name_regex of this GeneralPolicyBodyDto.

        **参数解释：** 分支名规则。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The branch_name_regex of this GeneralPolicyBodyDto.
        :rtype: str
        """
    ...
    def branch_name_regex(self, branch_name_regex):
        r"""Sets the branch_name_regex of this GeneralPolicyBodyDto.

        **参数解释：** 分支名规则。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param branch_name_regex: The branch_name_regex of this GeneralPolicyBodyDto.
        :type branch_name_regex: str
        """
    ...
    def tag_name_regex(self):
        r"""Gets the tag_name_regex of this GeneralPolicyBodyDto.

        **参数解释：** Tag名规则。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The tag_name_regex of this GeneralPolicyBodyDto.
        :rtype: str
        """
    ...
    def tag_name_regex(self, tag_name_regex):
        r"""Sets the tag_name_regex of this GeneralPolicyBodyDto.

        **参数解释：** Tag名规则。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param tag_name_regex: The tag_name_regex of this GeneralPolicyBodyDto.
        :type tag_name_regex: str
        """
    ...
    def forbidden_developer_create_branch(self):
        r"""Gets the forbidden_developer_create_branch of this GeneralPolicyBodyDto.

        **参数解释：** 是否禁止开发者创建分支。 **约束限制：** 不涉及。 **取值范围：** - true，禁止开发者创建分支。 - false，允许开发者创建分支。

        :return: The forbidden_developer_create_branch of this GeneralPolicyBodyDto.
        :rtype: bool
        """
    ...
    def forbidden_developer_create_branch(self, forbidden_developer_create_branch):
        r"""Sets the forbidden_developer_create_branch of this GeneralPolicyBodyDto.

        **参数解释：** 是否禁止开发者创建分支。 **约束限制：** 不涉及。 **取值范围：** - true，禁止开发者创建分支。 - false，允许开发者创建分支。

        :param forbidden_developer_create_branch: The forbidden_developer_create_branch of this GeneralPolicyBodyDto.
        :type forbidden_developer_create_branch: bool
        """
        self._forbidden_developer_create_branch = forbidden_developer_create_branch

    @property
    def create_branch_whitelist_user_ids(self):
        r"""Gets the create_branch_whitelist_user_ids of this GeneralPolicyBodyDto.

        **参数解释：** 开发人员创建分支权限例外白名单。多个用户ID使用逗号分隔。

        :return: The create_branch_whitelist_user_ids of this GeneralPolicyBodyDto.
        :rtype: str
        """
        return self._create_branch_whitelist_user_ids

    @create_branch_whitelist_user_ids.setter
    def create_branch_whitelist_user_ids(self, create_branch_whitelist_user_ids):
        r"""Sets the create_branch_whitelist_user_ids of this GeneralPolicyBodyDto.

        **参数解释：** 开发人员创建分支权限例外白名单。多个用户ID使用逗号分隔。

        :param create_branch_whitelist_user_ids: The create_branch_whitelist_user_ids of this GeneralPolicyBodyDto.
        :type create_branch_whitelist_user_ids: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GeneralPolicyBodyDto):
            return False
