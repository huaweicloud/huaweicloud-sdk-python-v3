...
class UserBasicDto:
    ...
    def __init__(self, id=None, name=None, username=None, state=None, service_license_status=None, avatar_url=None, avatar_path=None, email=None, name_cn=None, web_url=None, nick_name=None, tenant_name=None, error_message=None):
        r"""UserBasicDto
    ...
    def service_license_status(self):
        r"""Gets the service_license_status of this UserBasicDto.

        服务级权限状态 0：停用 1：启用

        :return: The service_license_status of this UserBasicDto.
        :rtype: int
        """
    ...
    def service_license_status(self, service_license_status):
        r"""Sets the service_license_status of this UserBasicDto.

        服务级权限状态 0：停用 1：启用

        :param service_license_status: The service_license_status of this UserBasicDto.
        :type service_license_status: int
        """
    ...
    def error_message(self):
        r"""Gets the error_message of this UserBasicDto.

        **参数解释：** 部分查询接口校验到传参里的用户权限不足或不存在时，返回该用户但该字段不为空用于提示。

        :return: The error_message of this UserBasicDto.
        :rtype: str
        """
    ...
    def error_message(self, error_message):
        r"""Sets the error_message of this UserBasicDto.

        **参数解释：** 部分查询接口校验到传参里的用户权限不足或不存在时，返回该用户但该字段不为空用于提示。

        :param error_message: The error_message of this UserBasicDto.
        :type error_message: str
        """
