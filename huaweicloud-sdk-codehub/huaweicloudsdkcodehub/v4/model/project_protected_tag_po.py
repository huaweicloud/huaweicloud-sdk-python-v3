...
class ProjectProtectedTagPo:
    ...
    def __init__(self, id=None, source=None, project_id=None, updated_at=None, name=None, actions=None):
        ...
        :type actions: list[:class:`huaweicloudsdkcodehub.v4.ProjectProtectedActionResultDto`]
        """
    ...
    def actions(self):
        ...
        **参数解释：** 事件列表。
        ...
        :rtype: list[:class:`huaweicloudsdkcodehub.v4.ProjectProtectedActionResultDto`]
        """
