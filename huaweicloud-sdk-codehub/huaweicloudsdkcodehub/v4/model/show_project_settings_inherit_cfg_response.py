...
class ShowProjectSettingsInheritCfgResponse(SdkResponse):
    ...
    def __init__(self, body=None):
        r"""ShowProjectSettingsInheritCfgResponse
        ...
        super(ShowProjectSettingsInheritCfgResponse, self).__init__()
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowProjectSettingsInheritCfgResponse):
            return False
