...
class ListProjectMergeRequestCanBeAssignedUsersResponse(SdkResponse):
    ...
    def __init__(self, body=None):
        ...
        super(ListProjectMergeRequestCanBeAssignedUsersResponse, self).__init__()
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListProjectMergeRequestCanBeAssignedUsersResponse):
            return False
