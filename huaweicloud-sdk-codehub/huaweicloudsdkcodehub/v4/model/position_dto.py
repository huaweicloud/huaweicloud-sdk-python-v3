...
class PositionDto:
    ...
    def __init__(self, base_sha=None, start_sha=None, head_sha=None, old_path=None, new_path=None, position_type=None, old_line=None, new_line=None):
        ...
        :param base_sha: **参数解释：** 基础sha值。
        :type base_sha: str
        :param start_sha: **参数解释：** 起始sha值。
        :type start_sha: str
        :param head_sha: **参数解释：** 最新sha值。
        :type head_sha: str
        :param old_path: **参数解释：** 文件旧路径。
        :type old_path: str
        :param new_path: **参数解释：** 文件新路径。
        :type new_path: str
        :param position_type: **参数解释：** 文件类型。
        :type position_type: str
        :param old_line: **参数解释：** 旧文件行号。
        :type old_line: int
        :param new_line: **参数解释：** 新文件行号。
        :type new_line: int
        """
