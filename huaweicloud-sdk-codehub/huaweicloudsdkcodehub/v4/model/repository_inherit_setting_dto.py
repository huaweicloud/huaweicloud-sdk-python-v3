...
class RepositoryInheritSettingDto:
    ...
    def inherit_mod(self):
        r"""Gets the inherit_mod of this RepositoryInheritSettingDto.

        **参数解释：** 继承设置。 **取值范围：** - inherit，继承上级配置。 - custom，使用当前仓库配置。 - force_inherit，强制继承上级配置。

        :return: The inherit_mod of this RepositoryInheritSettingDto.
        :rtype: str
        """
    ...
    def inherit_mod(self, inherit_mod):
        r"""Sets the inherit_mod of this RepositoryInheritSettingDto.

        **参数解释：** 继承设置。 **取值范围：** - inherit，继承上级配置。 - custom，使用当前仓库配置。 - force_inherit，强制继承上级配置。

        :param inherit_mod: The inherit_mod of this RepositoryInheritSettingDto.
        :type inherit_mod: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RepositoryInheritSettingDto):
            return False
