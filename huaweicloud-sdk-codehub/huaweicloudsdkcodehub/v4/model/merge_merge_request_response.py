...
class MergeMergeRequestResponse(SdkResponse):
    ...
    def __init__(self, id=None, iid=None, repository_id=None, title=None, description=None, state=None, created_at=None, updated_at=None, source_branch=None, target_branch=None, is_source_branch_protected=None, devcloud_source_branch=None, author=None, source_repository_id=None, target_repository_id=None, source_project_id=None, target_project_id=None, labels=None, work_in_progress=None, milestone=None, merge_when_build_succeeds=None, merge_status=None, sha=None, merge_commit_sha=None, subscribed=None, merged_by=None, merged_at=None, closed_by=None, closed_at=None, user_notes_count=None, force_remove_source_branch=None, web_url=None, merge_request_diff=None, merge_request_reviewers_count=None, merge_request_review_count=None, merge_request_reviewer_list=None, merge_request_assignee_list=None, notes=None, codecheck_state=None, codecheck_defect_count=None, merge_request_related_work_items=None, diverged_commits_count=None, moderation_result=None, moderation_time=None, moderation_status=None, is_use_temp_branch=None, approval_merge_request_approvers=None, review_mode=None, squash=None, squash_commit_message=None, rebase_in_progress=None, source_repository=None, target_repository=None, is_source_branch_exist=None, merge_request_type=None):
        ...
        super(MergeMergeRequestResponse, self).__init__()
    ...
    @property
    def id(self):
        r"""Gets the id of this MergeMergeRequestResponse.

        合并请求id

        :return: The id of this MergeMergeRequestResponse.
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this MergeMergeRequestResponse.

        合并请求id

        :param id: The id of this MergeMergeRequestResponse.
        :type id: int
        """
        self._id = id
    ...
    @property
    def iid(self):
        r"""Gets the iid of this MergeMergeRequestResponse.

        合并请求iid

        :return: The iid of this MergeMergeRequestResponse.
        :rtype: int
        """
        return self._iid
    ...
    @iid.setter
    def iid(self, iid):
        r"""Sets the iid of this MergeMergeRequestResponse.

        合并请求iid

        :param iid: The iid of this MergeMergeRequestResponse.
        :type iid: int
        """
        self._iid = iid
    ...
    def repository_id(self):
        r"""Gets the repository_id of this MergeMergeRequestResponse.

        目标仓库id

        :return: The repository_id of this MergeMergeRequestResponse.
        :rtype: int
        """
    ...
    def repository_id(self, repository_id):
        r"""Sets the repository_id of this MergeMergeRequestResponse.

        目标仓库id

        :param repository_id: The repository_id of this MergeMergeRequestResponse.
        :type repository_id: int
        """
    ...
    @property
    def title(self):
        r"""Gets the title of this MergeMergeRequestResponse.

        合并请求标题

        :return: The title of this MergeMergeRequestResponse.
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        r"""Sets the title of this MergeMergeRequestResponse.

        合并请求标题

        :param title: The title of this MergeMergeRequestResponse.
        :type title: str
        """
        self._title = title
    ...
    def description(self):
        r"""Gets the description of this MergeMergeRequestResponse.

        合并请求描述

        :return: The description of this MergeMergeRequestResponse.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this MergeMergeRequestResponse.

        合并请求描述

        :param description: The description of this MergeMergeRequestResponse.
        :type description: str
        """
    ...
    @property
    def state(self):
        r"""Gets the state of this MergeMergeRequestResponse.

        合并请求状态

        :return: The state of this MergeMergeRequestResponse.
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        r"""Sets the state of this MergeMergeRequestResponse.

        合并请求状态

        :param state: The state of this MergeMergeRequestResponse.
        :type state: str
        """
        self._state = state
    ...
    @property
    def created_at(self):
        r"""Gets the created_at of this MergeMergeRequestResponse.

        创建时间

        :return: The created_at of this MergeMergeRequestResponse.
        :rtype: str
        """
    ...
    def created_at(self, created_at):
        r"""Sets the created_at of this MergeMergeRequestResponse.

        创建时间

        :param created_at: The created_at of this MergeMergeRequestResponse.
        :type created_at: str
        """
    ...
    @property
    def updated_at(self):
        r"""Gets the updated_at of this MergeMergeRequestResponse.

        更新时间

        :return: The updated_at of this MergeMergeRequestResponse.
        :rtype: str
        """
    ...
    def updated_at(self, updated_at):
        r"""Sets the updated_at of this MergeMergeRequestResponse.

        更新时间

        :param updated_at: The updated_at of this MergeMergeRequestResponse.
        :type updated_at: str
        """
    ...
    def source_branch(self):
        r"""Gets the source_branch of this MergeMergeRequestResponse.

        源分支

        :return: The source_branch of this MergeMergeRequestResponse.
        :rtype: str
        """
    ...
    def source_branch(self, source_branch):
        r"""Sets the source_branch of this MergeMergeRequestResponse.

        源分支

        :param source_branch: The source_branch of this MergeMergeRequestResponse.
        :type source_branch: str
        """
    ...
    def target_branch(self):
        r"""Gets the target_branch of this MergeMergeRequestResponse.

        目标分支

        :return: The target_branch of this MergeMergeRequestResponse.
        :rtype: str
        """
    ...
    def target_branch(self, target_branch):
        r"""Sets the target_branch of this MergeMergeRequestResponse.

        目标分支

        :param target_branch: The target_branch of this MergeMergeRequestResponse.
        :type target_branch: str
        """
    ...
    def is_source_branch_protected(self):
        r"""Gets the is_source_branch_protected of this MergeMergeRequestResponse.

        源分支是否为保护分支

        :return: The is_source_branch_protected of this MergeMergeRequestResponse.
        :rtype: bool
        """
    ...
    def is_source_branch_protected(self, is_source_branch_protected):
        r"""Sets the is_source_branch_protected of this MergeMergeRequestResponse.

        源分支是否为保护分支

        :param is_source_branch_protected: The is_source_branch_protected of this MergeMergeRequestResponse.
        :type is_source_branch_protected: bool
        """
    ...
    def devcloud_source_branch(self):
        r"""Gets the devcloud_source_branch of this MergeMergeRequestResponse.

        源分支

        :return: The devcloud_source_branch of this MergeMergeRequestResponse.
        :rtype: str
        """
    ...
    def devcloud_source_branch(self, devcloud_source_branch):
        r"""Sets the devcloud_source_branch of this MergeMergeRequestResponse.

        源分支

        :param devcloud_source_branch: The devcloud_source_branch of this MergeMergeRequestResponse.
        :type devcloud_source_branch: str
        """
    ...
    @property
    def author(self):
        r"""Gets the author of this MergeMergeRequestResponse.

        :return: The author of this MergeMergeRequestResponse.
    ...
    def author(self, author):
        r"""Sets the author of this MergeMergeRequestResponse.

        :param author: The author of this MergeMergeRequestResponse.
        :type author: :class:`huaweicloudsdkcodehub.v4.UserBasicExternalDto`
        """
        self._author = author
    ...
    def source_repository_id(self):
        r"""Gets the source_repository_id of this MergeMergeRequestResponse.

        源仓库id

        :return: The source_repository_id of this MergeMergeRequestResponse.
        :rtype: int
        """
    ...
    def source_repository_id(self, source_repository_id):
        r"""Sets the source_repository_id of this MergeMergeRequestResponse.

        源仓库id

        :param source_repository_id: The source_repository_id of this MergeMergeRequestResponse.
        :type source_repository_id: int
        """
    ...
    def target_repository_id(self):
        r"""Gets the target_repository_id of this MergeMergeRequestResponse.

        目标仓库id

        :return: The target_repository_id of this MergeMergeRequestResponse.
        :rtype: int
        """
    ...
    def target_repository_id(self, target_repository_id):
        r"""Sets the target_repository_id of this MergeMergeRequestResponse.

        目标仓库id

        :param target_repository_id: The target_repository_id of this MergeMergeRequestResponse.
        :type target_repository_id: int
        """
    ...
    def source_project_id(self):
        r"""Gets the source_project_id of this MergeMergeRequestResponse.

        源项目id

        :return: The source_project_id of this MergeMergeRequestResponse.
        :rtype: str
        """
    ...
    def source_project_id(self, source_project_id):
        r"""Sets the source_project_id of this MergeMergeRequestResponse.

        源项目id

        :param source_project_id: The source_project_id of this MergeMergeRequestResponse.
        :type source_project_id: str
        """
    ...
    def target_project_id(self):
        r"""Gets the target_project_id of this MergeMergeRequestResponse.

        目标项目id

        :return: The target_project_id of this MergeMergeRequestResponse.
        :rtype: str
        """
    ...
    def target_project_id(self, target_project_id):
        r"""Sets the target_project_id of this MergeMergeRequestResponse.

        目标项目id

        :param target_project_id: The target_project_id of this MergeMergeRequestResponse.
        :type target_project_id: str
        """
    ...
    @property
    def labels(self):
        r"""Gets the labels of this MergeMergeRequestResponse.

        标签

        :return: The labels of this MergeMergeRequestResponse.
        :rtype: list[object]
        """
        return self._labels
    ...
    def labels(self, labels):
        r"""Sets the labels of this MergeMergeRequestResponse.

        标签

        :param labels: The labels of this MergeMergeRequestResponse.
        :type labels: list[object]
        """
        self._labels = labels
    ...
    def work_in_progress(self):
        r"""Gets the work_in_progress of this MergeMergeRequestResponse.

        WIP状态

        :return: The work_in_progress of this MergeMergeRequestResponse.
        :rtype: bool
        """
    ...
    def work_in_progress(self, work_in_progress):
        r"""Sets the work_in_progress of this MergeMergeRequestResponse.

        WIP状态

        :param work_in_progress: The work_in_progress of this MergeMergeRequestResponse.
        :type work_in_progress: bool
        """
    ...
    @property
    def milestone(self):
        r"""Gets the milestone of this MergeMergeRequestResponse.

        :return: The milestone of this MergeMergeRequestResponse.
    ...
    def milestone(self, milestone):
        r"""Sets the milestone of this MergeMergeRequestResponse.

        :param milestone: The milestone of this MergeMergeRequestResponse.
        :type milestone: :class:`huaweicloudsdkcodehub.v4.MilestoneBasicDto`
        """
    ...
    def merge_when_build_succeeds(self):
        r"""Gets the merge_when_build_succeeds of this MergeMergeRequestResponse.

        流水线成功后自动合入

        :return: The merge_when_build_succeeds of this MergeMergeRequestResponse.
        :rtype: bool
        """
    ...
    def merge_when_build_succeeds(self, merge_when_build_succeeds):
        r"""Sets the merge_when_build_succeeds of this MergeMergeRequestResponse.

        流水线成功后自动合入

        :param merge_when_build_succeeds: The merge_when_build_succeeds of this MergeMergeRequestResponse.
        :type merge_when_build_succeeds: bool
        """
    ...
    def merge_status(self):
        r"""Gets the merge_status of this MergeMergeRequestResponse.

        可合并状态

        :return: The merge_status of this MergeMergeRequestResponse.
        :rtype: str
        """
    ...
    def merge_status(self, merge_status):
        r"""Sets the merge_status of this MergeMergeRequestResponse.

        可合并状态

        :param merge_status: The merge_status of this MergeMergeRequestResponse.
        :type merge_status: str
        """
    ...
    @property
    def sha(self):
        r"""Gets the sha of this MergeMergeRequestResponse.

        当前合并请求最新commit

        :return: The sha of this MergeMergeRequestResponse.
        :rtype: str
        """
        return self._sha
    ...
    @sha.setter
    def sha(self, sha):
        r"""Sets the sha of this MergeMergeRequestResponse.

        当前合并请求最新commit

        :param sha: The sha of this MergeMergeRequestResponse.
        :type sha: str
        """
        self._sha = sha
    ...
    def merge_commit_sha(self):
        r"""Gets the merge_commit_sha of this MergeMergeRequestResponse.

        合入commit节点

        :return: The merge_commit_sha of this MergeMergeRequestResponse.
        :rtype: str
        """
    ...
    def merge_commit_sha(self, merge_commit_sha):
        r"""Sets the merge_commit_sha of this MergeMergeRequestResponse.

        合入commit节点

        :param merge_commit_sha: The merge_commit_sha of this MergeMergeRequestResponse.
        :type merge_commit_sha: str
        """
    ...
    @property
    def subscribed(self):
        r"""Gets the subscribed of this MergeMergeRequestResponse.

        订阅

        :return: The subscribed of this MergeMergeRequestResponse.
        :rtype: bool
        """
    ...
    def subscribed(self, subscribed):
        r"""Sets the subscribed of this MergeMergeRequestResponse.

        订阅

        :param subscribed: The subscribed of this MergeMergeRequestResponse.
        :type subscribed: bool
        """
    ...
    @property
    def merged_by(self):
        r"""Gets the merged_by of this MergeMergeRequestResponse.

        :return: The merged_by of this MergeMergeRequestResponse.
        :rtype: :class:`huaweicloudsdkcodehub.v4.UserBasicExternalDto`
        """
    ...
    def merged_by(self, merged_by):
        r"""Sets the merged_by of this MergeMergeRequestResponse.

        :param merged_by: The merged_by of this MergeMergeRequestResponse.
        :type merged_by: :class:`huaweicloudsdkcodehub.v4.UserBasicExternalDto`
        """
    ...
    @property
    def merged_at(self):
        r"""Gets the merged_at of this MergeMergeRequestResponse.

        合并时间

        :return: The merged_at of this MergeMergeRequestResponse.
        :rtype: str
        """
    ...
    def merged_at(self, merged_at):
        r"""Sets the merged_at of this MergeMergeRequestResponse.

        合并时间

        :param merged_at: The merged_at of this MergeMergeRequestResponse.
        :type merged_at: str
        """
    ...
    @property
    def closed_by(self):
        r"""Gets the closed_by of this MergeMergeRequestResponse.

        :return: The closed_by of this MergeMergeRequestResponse.
        :rtype: :class:`huaweicloudsdkcodehub.v4.UserBasicExternalDto`
        """
    ...
    def closed_by(self, closed_by):
        r"""Sets the closed_by of this MergeMergeRequestResponse.

        :param closed_by: The closed_by of this MergeMergeRequestResponse.
        :type closed_by: :class:`huaweicloudsdkcodehub.v4.UserBasicExternalDto`
        """
    ...
    @property
    def closed_at(self):
        r"""Gets the closed_at of this MergeMergeRequestResponse.

        关闭时间

        :return: The closed_at of this MergeMergeRequestResponse.
        :rtype: str
        """
    ...
    def closed_at(self, closed_at):
        r"""Sets the closed_at of this MergeMergeRequestResponse.

        关闭时间

        :param closed_at: The closed_at of this MergeMergeRequestResponse.
        :type closed_at: str
        """
    ...
    def user_notes_count(self):
        r"""Gets the user_notes_count of this MergeMergeRequestResponse.

        检视意见数量

        :return: The user_notes_count of this MergeMergeRequestResponse.
        :rtype: int
        """
    ...
    def user_notes_count(self, user_notes_count):
        r"""Sets the user_notes_count of this MergeMergeRequestResponse.

        检视意见数量

        :param user_notes_count: The user_notes_count of this MergeMergeRequestResponse.
        :type user_notes_count: int
        """
    ...
    def force_remove_source_branch(self):
        r"""Gets the force_remove_source_branch of this MergeMergeRequestResponse.

        合入后删除源分支

        :return: The force_remove_source_branch of this MergeMergeRequestResponse.
        :rtype: bool
        """
    ...
    def force_remove_source_branch(self, force_remove_source_branch):
        r"""Sets the force_remove_source_branch of this MergeMergeRequestResponse.

        合入后删除源分支

        :param force_remove_source_branch: The force_remove_source_branch of this MergeMergeRequestResponse.
        :type force_remove_source_branch: bool
        """
    ...
    @property
    def web_url(self):
        r"""Gets the web_url of this MergeMergeRequestResponse.

        主页url

        :return: The web_url of this MergeMergeRequestResponse.
        :rtype: str
        """
    ...
    def web_url(self, web_url):
        r"""Sets the web_url of this MergeMergeRequestResponse.

        主页url

        :param web_url: The web_url of this MergeMergeRequestResponse.
        :type web_url: str
        """
    ...
    def merge_request_diff(self):
        r"""Gets the merge_request_diff of this MergeMergeRequestResponse.

        :return: The merge_request_diff of this MergeMergeRequestResponse.
    ...
    def merge_request_diff(self, merge_request_diff):
        r"""Sets the merge_request_diff of this MergeMergeRequestResponse.

        :param merge_request_diff: The merge_request_diff of this MergeMergeRequestResponse.
        :type merge_request_diff: :class:`huaweicloudsdkcodehub.v4.MergeRequestDiffExternalDto`
        """
    ...
    def merge_request_reviewers_count(self):
        r"""Gets the merge_request_reviewers_count of this MergeMergeRequestResponse.

        评审人数量

        :return: The merge_request_reviewers_count of this MergeMergeRequestResponse.
        :rtype: int
        """
    ...
    def merge_request_reviewers_count(self, merge_request_reviewers_count):
        r"""Sets the merge_request_reviewers_count of this MergeMergeRequestResponse.

        评审人数量

        :param merge_request_reviewers_count: The merge_request_reviewers_count of this MergeMergeRequestResponse.
        :type merge_request_reviewers_count: int
        """
    ...
    def merge_request_review_count(self):
        r"""Gets the merge_request_review_count of this MergeMergeRequestResponse.

        打分

        :return: The merge_request_review_count of this MergeMergeRequestResponse.
        :rtype: int
        """
    ...
    def merge_request_review_count(self, merge_request_review_count):
        r"""Sets the merge_request_review_count of this MergeMergeRequestResponse.

        打分

        :param merge_request_review_count: The merge_request_review_count of this MergeMergeRequestResponse.
        :type merge_request_review_count: int
        """
    ...
    def merge_request_reviewer_list(self):
        r"""Gets the merge_request_reviewer_list of this MergeMergeRequestResponse.

        评审人列表

        :return: The merge_request_reviewer_list of this MergeMergeRequestResponse.
    ...
    def merge_request_reviewer_list(self, merge_request_reviewer_list):
        r"""Sets the merge_request_reviewer_list of this MergeMergeRequestResponse.

        评审人列表

        :param merge_request_reviewer_list: The merge_request_reviewer_list of this MergeMergeRequestResponse.
        :type merge_request_reviewer_list: list[:class:`huaweicloudsdkcodehub.v4.MergeRequestReviewerExternalDto`]
        """
    ...
    def merge_request_assignee_list(self):
        r"""Gets the merge_request_assignee_list of this MergeMergeRequestResponse.

        合并人列表

        :return: The merge_request_assignee_list of this MergeMergeRequestResponse.
    ...
    def merge_request_assignee_list(self, merge_request_assignee_list):
        r"""Sets the merge_request_assignee_list of this MergeMergeRequestResponse.

        合并人列表

        :param merge_request_assignee_list: The merge_request_assignee_list of this MergeMergeRequestResponse.
        :type merge_request_assignee_list: list[:class:`huaweicloudsdkcodehub.v4.UserBasicExternalDto`]
        """
    ...
    @property
    def notes(self):
        r"""Gets the notes of this MergeMergeRequestResponse.

        检视意见

        :return: The notes of this MergeMergeRequestResponse.
        :rtype: int
        """
        return self._notes
    ...
    def notes(self, notes):
        r"""Sets the notes of this MergeMergeRequestResponse.

        检视意见

        :param notes: The notes of this MergeMergeRequestResponse.
        :type notes: int
        """
        self._notes = notes
    ...
    def codecheck_state(self):
        r"""Gets the codecheck_state of this MergeMergeRequestResponse.

        代码检查状态

        :return: The codecheck_state of this MergeMergeRequestResponse.
        :rtype: int
        """
    ...
    def codecheck_state(self, codecheck_state):
        r"""Sets the codecheck_state of this MergeMergeRequestResponse.

        代码检查状态

        :param codecheck_state: The codecheck_state of this MergeMergeRequestResponse.
        :type codecheck_state: int
        """
    ...
    def codecheck_defect_count(self):
        r"""Gets the codecheck_defect_count of this MergeMergeRequestResponse.

        代码检查问题数

        :return: The codecheck_defect_count of this MergeMergeRequestResponse.
        :rtype: int
        """
    ...
    def codecheck_defect_count(self, codecheck_defect_count):
        r"""Sets the codecheck_defect_count of this MergeMergeRequestResponse.

        代码检查问题数

        :param codecheck_defect_count: The codecheck_defect_count of this MergeMergeRequestResponse.
        :type codecheck_defect_count: int
        """
    ...
    def merge_request_related_work_items(self):
        r"""Gets the merge_request_related_work_items of this MergeMergeRequestResponse.

        合并请求关联单数量

        :return: The merge_request_related_work_items of this MergeMergeRequestResponse.
    ...
    def merge_request_related_work_items(self, merge_request_related_work_items):
        r"""Sets the merge_request_related_work_items of this MergeMergeRequestResponse.

        合并请求关联单数量

        :param merge_request_related_work_items: The merge_request_related_work_items of this MergeMergeRequestResponse.
        :type merge_request_related_work_items: list[:class:`huaweicloudsdkcodehub.v4.MergeRequestRelatedWorkItemDto`]
        """
    ...
    def diverged_commits_count(self):
        r"""Gets the diverged_commits_count of this MergeMergeRequestResponse.

        源分支落后commit数

        :return: The diverged_commits_count of this MergeMergeRequestResponse.
        :rtype: int
        """
    ...
    def diverged_commits_count(self, diverged_commits_count):
        r"""Sets the diverged_commits_count of this MergeMergeRequestResponse.

        源分支落后commit数

        :param diverged_commits_count: The diverged_commits_count of this MergeMergeRequestResponse.
        :type diverged_commits_count: int
        """
    ...
    def moderation_result(self):
        r"""Gets the moderation_result of this MergeMergeRequestResponse.

        送审结果

        :return: The moderation_result of this MergeMergeRequestResponse.
        :rtype: bool
        """
    ...
    def moderation_result(self, moderation_result):
        r"""Sets the moderation_result of this MergeMergeRequestResponse.

        送审结果

        :param moderation_result: The moderation_result of this MergeMergeRequestResponse.
        :type moderation_result: bool
        """
    ...
    def moderation_time(self):
        r"""Gets the moderation_time of this MergeMergeRequestResponse.

        送审时间时间戳

        :return: The moderation_time of this MergeMergeRequestResponse.
        :rtype: int
        """
    ...
    def moderation_time(self, moderation_time):
        r"""Sets the moderation_time of this MergeMergeRequestResponse.

        送审时间时间戳

        :param moderation_time: The moderation_time of this MergeMergeRequestResponse.
        :type moderation_time: int
        """
    ...
    def moderation_status(self):
        r"""Gets the moderation_status of this MergeMergeRequestResponse.

        送审状态码

        :return: The moderation_status of this MergeMergeRequestResponse.
        :rtype: int
        """
    ...
    def moderation_status(self, moderation_status):
        r"""Sets the moderation_status of this MergeMergeRequestResponse.

        送审状态码

        :param moderation_status: The moderation_status of this MergeMergeRequestResponse.
        :type moderation_status: int
        """
    ...
    def is_use_temp_branch(self):
        r"""Gets the is_use_temp_branch of this MergeMergeRequestResponse.

        是否使用临时分支

        :return: The is_use_temp_branch of this MergeMergeRequestResponse.
        :rtype: bool
        """
    ...
    def is_use_temp_branch(self, is_use_temp_branch):
        r"""Sets the is_use_temp_branch of this MergeMergeRequestResponse.

        是否使用临时分支

        :param is_use_temp_branch: The is_use_temp_branch of this MergeMergeRequestResponse.
        :type is_use_temp_branch: bool
        """
    ...
    def approval_merge_request_approvers(self):
        r"""Gets the approval_merge_request_approvers of this MergeMergeRequestResponse.

        审核人

        :return: The approval_merge_request_approvers of this MergeMergeRequestResponse.
    ...
    def approval_merge_request_approvers(self, approval_merge_request_approvers):
        r"""Sets the approval_merge_request_approvers of this MergeMergeRequestResponse.

        审核人

        :param approval_merge_request_approvers: The approval_merge_request_approvers of this MergeMergeRequestResponse.
        :type approval_merge_request_approvers: list[:class:`huaweicloudsdkcodehub.v4.ApprovalUserDto`]
        """
    ...
    def review_mode(self):
        r"""Gets the review_mode of this MergeMergeRequestResponse.

        合并请求模式

        :return: The review_mode of this MergeMergeRequestResponse.
        :rtype: str
        """
    ...
    def review_mode(self, review_mode):
        r"""Sets the review_mode of this MergeMergeRequestResponse.

        合并请求模式

        :param review_mode: The review_mode of this MergeMergeRequestResponse.
        :type review_mode: str
        """
    ...
    @property
    def squash(self):
        r"""Gets the squash of this MergeMergeRequestResponse.

        squash合入

        :return: The squash of this MergeMergeRequestResponse.
        :rtype: bool
        """
        return self._squash
    ...
    def squash(self, squash):
        r"""Sets the squash of this MergeMergeRequestResponse.

        squash合入

        :param squash: The squash of this MergeMergeRequestResponse.
        :type squash: bool
        """
        self._squash = squash
    ...
    def squash_commit_message(self):
        r"""Gets the squash_commit_message of this MergeMergeRequestResponse.

        squash提交信息

        :return: The squash_commit_message of this MergeMergeRequestResponse.
        :rtype: str
        """
    ...
    def squash_commit_message(self, squash_commit_message):
        r"""Sets the squash_commit_message of this MergeMergeRequestResponse.

        squash提交信息

        :param squash_commit_message: The squash_commit_message of this MergeMergeRequestResponse.
        :type squash_commit_message: str
        """
    ...
    def rebase_in_progress(self):
        r"""Gets the rebase_in_progress of this MergeMergeRequestResponse.

        是否正在rebase

        :return: The rebase_in_progress of this MergeMergeRequestResponse.
        :rtype: bool
        """
    ...
    def rebase_in_progress(self, rebase_in_progress):
        r"""Sets the rebase_in_progress of this MergeMergeRequestResponse.

        是否正在rebase

        :param rebase_in_progress: The rebase_in_progress of this MergeMergeRequestResponse.
        :type rebase_in_progress: bool
        """
    ...
    def source_repository(self):
        r"""Gets the source_repository of this MergeMergeRequestResponse.

        :return: The source_repository of this MergeMergeRequestResponse.
    ...
    def source_repository(self, source_repository):
        r"""Sets the source_repository of this MergeMergeRequestResponse.

        :param source_repository: The source_repository of this MergeMergeRequestResponse.
        :type source_repository: :class:`huaweicloudsdkcodehub.v4.ProjectSimpleDto`
        """
    ...
    def target_repository(self):
        r"""Gets the target_repository of this MergeMergeRequestResponse.

        :return: The target_repository of this MergeMergeRequestResponse.
        :rtype: :class:`huaweicloudsdkcodehub.v4.ProjectSimpleDto`
        """
    ...
    def target_repository(self, target_repository):
        r"""Sets the target_repository of this MergeMergeRequestResponse.

        :param target_repository: The target_repository of this MergeMergeRequestResponse.
        :type target_repository: :class:`huaweicloudsdkcodehub.v4.ProjectSimpleDto`
        """
    ...
    def is_source_branch_exist(self):
        r"""Gets the is_source_branch_exist of this MergeMergeRequestResponse.

        源分支是否存在

        :return: The is_source_branch_exist of this MergeMergeRequestResponse.
        :rtype: bool
        """
    ...
    def is_source_branch_exist(self, is_source_branch_exist):
        r"""Sets the is_source_branch_exist of this MergeMergeRequestResponse.

        源分支是否存在

        :param is_source_branch_exist: The is_source_branch_exist of this MergeMergeRequestResponse.
        :type is_source_branch_exist: bool
        """
    ...
    def merge_request_type(self):
        r"""Gets the merge_request_type of this MergeMergeRequestResponse.

        合并请求类型

        :return: The merge_request_type of this MergeMergeRequestResponse.
        :rtype: str
        """
    ...
    def merge_request_type(self, merge_request_type):
        r"""Sets the merge_request_type of this MergeMergeRequestResponse.

        合并请求类型

        :param merge_request_type: The merge_request_type of this MergeMergeRequestResponse.
        :type merge_request_type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MergeMergeRequestResponse):
            return False
