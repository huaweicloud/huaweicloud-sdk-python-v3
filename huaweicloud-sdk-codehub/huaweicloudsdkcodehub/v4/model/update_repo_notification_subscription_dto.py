...
class UpdateRepoNotificationSubscriptionDto:
    ...
    openapi_types = {
        'enabled': 'bool',
        'config_source': 'str',
        'webhook_config': 'UpdateRepoWebHookSubscriptionDto',
    ...
    def __init__(self, enabled=None, config_source=None, webhook_config=None, waring_repo_usage_rate=None, subscript_events=None):
        r"""UpdateRepoNotificationSubscriptionDto
        ...
        :type webhook_config: :class:`huaweicloudsdkcodehub.v4.UpdateRepoWebHookSubscriptionDto`
    ...
    @property
    def enabled(self):
        r"""Gets the enabled of this UpdateRepoNotificationSubscriptionDto.

        **参数解释：** 开启通知。

        :return: The enabled of this UpdateRepoNotificationSubscriptionDto.
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        r"""Sets the enabled of this UpdateRepoNotificationSubscriptionDto.

        **参数解释：** 开启通知。

        :param enabled: The enabled of this UpdateRepoNotificationSubscriptionDto.
        :type enabled: bool
        """
    ...
    def webhook_config(self):
        r"""Gets the webhook_config of this UpdateRepoNotificationSubscriptionDto.

        :return: The webhook_config of this UpdateRepoNotificationSubscriptionDto.
        :rtype: :class:`huaweicloudsdkcodehub.v4.UpdateRepoWebHookSubscriptionDto`
        """
        return self._webhook_config

    @webhook_config.setter
    def webhook_config(self, webhook_config):
        r"""Sets the webhook_config of this UpdateRepoNotificationSubscriptionDto.

        :param webhook_config: The webhook_config of this UpdateRepoNotificationSubscriptionDto.
        :type webhook_config: :class:`huaweicloudsdkcodehub.v4.UpdateRepoWebHookSubscriptionDto`
        """
    ...
    def subscript_events(self):
        r"""Gets the subscript_events of this UpdateRepoNotificationSubscriptionDto.

        **参数解释：** 通知事件。

        :return: The subscript_events of this UpdateRepoNotificationSubscriptionDto.
    ...
    def subscript_events(self, subscript_events):
        r"""Sets the subscript_events of this UpdateRepoNotificationSubscriptionDto.

        **参数解释：** 通知事件。

        :param subscript_events: The subscript_events of this UpdateRepoNotificationSubscriptionDto.
        :type subscript_events: list[:class:`huaweicloudsdkcodehub.v4.RepoSubscriptionEventDto`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateRepoNotificationSubscriptionDto):
            return False
