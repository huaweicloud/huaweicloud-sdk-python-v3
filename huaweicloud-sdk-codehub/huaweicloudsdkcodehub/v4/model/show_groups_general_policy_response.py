...
class ShowGroupsGeneralPolicyResponse(SdkResponse):
    ...
    def __init__(self, disable_fork=None, forbidden_developer_create_branch=None, forbidden_developer_create_tag=None, forbidden_committer_create_branch=None, branch_name_regex=None, tag_name_regex=None, generate_pre_merge_ref=None, forbidden_gitlab_access=None, rebase_disable_trigger_webhook=None, open_gpg_verified=None):
        r"""ShowGroupsGeneralPolicyResponse
        ...
        super(ShowGroupsGeneralPolicyResponse, self).__init__()
    ...
    def disable_fork(self):
        r"""Gets the disable_fork of this ShowGroupsGeneralPolicyResponse.

        **参数解释：** 是否禁用fork。

        :return: The disable_fork of this ShowGroupsGeneralPolicyResponse.
        :rtype: bool
        """
    ...
    def disable_fork(self, disable_fork):
        r"""Sets the disable_fork of this ShowGroupsGeneralPolicyResponse.

        **参数解释：** 是否禁用fork。

        :param disable_fork: The disable_fork of this ShowGroupsGeneralPolicyResponse.
        :type disable_fork: bool
        """
    ...
    def forbidden_developer_create_branch(self):
        r"""Gets the forbidden_developer_create_branch of this ShowGroupsGeneralPolicyResponse.

        **参数解释：** 是否禁止开发者创建分支。

        :return: The forbidden_developer_create_branch of this ShowGroupsGeneralPolicyResponse.
        :rtype: bool
        """
    ...
    def forbidden_developer_create_branch(self, forbidden_developer_create_branch):
        r"""Sets the forbidden_developer_create_branch of this ShowGroupsGeneralPolicyResponse.

        **参数解释：** 是否禁止开发者创建分支。

        :param forbidden_developer_create_branch: The forbidden_developer_create_branch of this ShowGroupsGeneralPolicyResponse.
        :type forbidden_developer_create_branch: bool
        """
    ...
    def forbidden_developer_create_tag(self):
        r"""Gets the forbidden_developer_create_tag of this ShowGroupsGeneralPolicyResponse.

        **参数解释：** 是否禁用开发者创建tag。

        :return: The forbidden_developer_create_tag of this ShowGroupsGeneralPolicyResponse.
        :rtype: bool
        """
    ...
    def forbidden_developer_create_tag(self, forbidden_developer_create_tag):
        r"""Sets the forbidden_developer_create_tag of this ShowGroupsGeneralPolicyResponse.

        **参数解释：** 是否禁用开发者创建tag。

        :param forbidden_developer_create_tag: The forbidden_developer_create_tag of this ShowGroupsGeneralPolicyResponse.
        :type forbidden_developer_create_tag: bool
        """
    ...
    def forbidden_committer_create_branch(self):
        r"""Gets the forbidden_committer_create_branch of this ShowGroupsGeneralPolicyResponse.

        **参数解释：** 禁止开发者创建标签。

        :return: The forbidden_committer_create_branch of this ShowGroupsGeneralPolicyResponse.
        :rtype: bool
        """
    ...
    def forbidden_committer_create_branch(self, forbidden_committer_create_branch):
        r"""Sets the forbidden_committer_create_branch of this ShowGroupsGeneralPolicyResponse.

        **参数解释：** 禁止开发者创建标签。

        :param forbidden_committer_create_branch: The forbidden_committer_create_branch of this ShowGroupsGeneralPolicyResponse.
        :type forbidden_committer_create_branch: bool
        """
    ...
    def branch_name_regex(self):
        r"""Gets the branch_name_regex of this ShowGroupsGeneralPolicyResponse.

        **参数解释：** 分支名称正则表达式。 **取值范围：** 字符串长度不少于1，不超过1000。

        :return: The branch_name_regex of this ShowGroupsGeneralPolicyResponse.
        :rtype: str
        """
    ...
    def branch_name_regex(self, branch_name_regex):
        r"""Sets the branch_name_regex of this ShowGroupsGeneralPolicyResponse.

        **参数解释：** 分支名称正则表达式。 **取值范围：** 字符串长度不少于1，不超过1000。

        :param branch_name_regex: The branch_name_regex of this ShowGroupsGeneralPolicyResponse.
        :type branch_name_regex: str
        """
    ...
    def tag_name_regex(self):
        r"""Gets the tag_name_regex of this ShowGroupsGeneralPolicyResponse.

        **参数解释：** 标签名正则表达式。 **取值范围：** 字符串长度不少于1，不超过1000。

        :return: The tag_name_regex of this ShowGroupsGeneralPolicyResponse.
        :rtype: str
        """
    ...
    def tag_name_regex(self, tag_name_regex):
        r"""Sets the tag_name_regex of this ShowGroupsGeneralPolicyResponse.

        **参数解释：** 标签名正则表达式。 **取值范围：** 字符串长度不少于1，不超过1000。

        :param tag_name_regex: The tag_name_regex of this ShowGroupsGeneralPolicyResponse.
        :type tag_name_regex: str
        """
    ...
    def generate_pre_merge_ref(self):
        r"""Gets the generate_pre_merge_ref of this ShowGroupsGeneralPolicyResponse.

        **参数解释：** 生成合并请求预合并。

        :return: The generate_pre_merge_ref of this ShowGroupsGeneralPolicyResponse.
        :rtype: bool
        """
    ...
    def generate_pre_merge_ref(self, generate_pre_merge_ref):
        r"""Sets the generate_pre_merge_ref of this ShowGroupsGeneralPolicyResponse.

        **参数解释：** 生成合并请求预合并。

        :param generate_pre_merge_ref: The generate_pre_merge_ref of this ShowGroupsGeneralPolicyResponse.
        :type generate_pre_merge_ref: bool
        """
    ...
    def forbidden_gitlab_access(self):
        r"""Gets the forbidden_gitlab_access of this ShowGroupsGeneralPolicyResponse.

        **参数解释：** 是否禁止repo访问。

        :return: The forbidden_gitlab_access of this ShowGroupsGeneralPolicyResponse.
        :rtype: bool
        """
    ...
    def forbidden_gitlab_access(self, forbidden_gitlab_access):
        r"""Sets the forbidden_gitlab_access of this ShowGroupsGeneralPolicyResponse.

        **参数解释：** 是否禁止repo访问。

        :param forbidden_gitlab_access: The forbidden_gitlab_access of this ShowGroupsGeneralPolicyResponse.
        :type forbidden_gitlab_access: bool
        """
    ...
    def rebase_disable_trigger_webhook(self):
        r"""Gets the rebase_disable_trigger_webhook of this ShowGroupsGeneralPolicyResponse.

        **参数解释：** MR rebase是否禁止触发webhook事件。

        :return: The rebase_disable_trigger_webhook of this ShowGroupsGeneralPolicyResponse.
        :rtype: bool
        """
    ...
    def rebase_disable_trigger_webhook(self, rebase_disable_trigger_webhook):
        r"""Sets the rebase_disable_trigger_webhook of this ShowGroupsGeneralPolicyResponse.

        **参数解释：** MR rebase是否禁止触发webhook事件。

        :param rebase_disable_trigger_webhook: The rebase_disable_trigger_webhook of this ShowGroupsGeneralPolicyResponse.
        :type rebase_disable_trigger_webhook: bool
        """
    ...
    def open_gpg_verified(self):
        r"""Gets the open_gpg_verified of this ShowGroupsGeneralPolicyResponse.

        **参数解释：** 是否开启gpg公钥验证。

        :return: The open_gpg_verified of this ShowGroupsGeneralPolicyResponse.
        :rtype: bool
        """
    ...
    def open_gpg_verified(self, open_gpg_verified):
        r"""Sets the open_gpg_verified of this ShowGroupsGeneralPolicyResponse.

        **参数解释：** 是否开启gpg公钥验证。

        :param open_gpg_verified: The open_gpg_verified of this ShowGroupsGeneralPolicyResponse.
        :type open_gpg_verified: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowGroupsGeneralPolicyResponse):
            return False
