...
class CreateProjectProtectedBranchesResponse(SdkResponse):
    ...
    def __init__(self, id=None, name=None, actions=None):
        r"""CreateProjectProtectedBranchesResponse
        ...
        super(CreateProjectProtectedBranchesResponse, self).__init__()
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateProjectProtectedBranchesResponse):
            return False
