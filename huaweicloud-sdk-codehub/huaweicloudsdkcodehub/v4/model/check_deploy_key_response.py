...
class CheckDeployKeyResponse(SdkResponse):
    ...
    def __init__(self, exists=None):
        ...
        super(CheckDeployKeyResponse, self).__init__()
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CheckDeployKeyResponse):
            return False
