...
class UpdateProjectNoteRequiredAttributesResponse(SdkResponse):
    ...
    def __init__(self, note_required_attributes=None):
        r"""UpdateProjectNoteRequiredAttributesResponse
        ...
        super(UpdateProjectNoteRequiredAttributesResponse, self).__init__()
    ...
    def note_required_attributes(self):
        r"""Gets the note_required_attributes of this UpdateProjectNoteRequiredAttributesResponse.

        **参数解释：** 检视意见必填项。

        :return: The note_required_attributes of this UpdateProjectNoteRequiredAttributesResponse.
    ...
    def note_required_attributes(self, note_required_attributes):
        r"""Sets the note_required_attributes of this UpdateProjectNoteRequiredAttributesResponse.

        **参数解释：** 检视意见必填项。

        :param note_required_attributes: The note_required_attributes of this UpdateProjectNoteRequiredAttributesResponse.
        :type note_required_attributes: list[:class:`huaweicloudsdkcodehub.v4.RequiredAttributeDto`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateProjectNoteRequiredAttributesResponse):
            return False
