...
class SSHKeyDto:
    ...
    @property
    def key(self):
        r"""Gets the key of this SSHKeyDto.

        **参数解释：** 公钥。 **取值范围：** 字符串长度不少于1，不超过1000。

        :return: The key of this SSHKeyDto.
        :rtype: str
        """
        return self._key
    ...
    @key.setter
    def key(self, key):
        r"""Sets the key of this SSHKeyDto.

        **参数解释：** 公钥。 **取值范围：** 字符串长度不少于1，不超过1000。

        :param key: The key of this SSHKeyDto.
        :type key: str
        """
        self._key = key
    ...
    @property
    def created_at(self):
        r"""Gets the created_at of this SSHKeyDto.

        **参数解释：** 创建时间。 **取值范围：** 字符串长度不少于1，不超过1000。

        :return: The created_at of this SSHKeyDto.
        :rtype: str
        """
    ...
    def created_at(self, created_at):
        r"""Sets the created_at of this SSHKeyDto.

        **参数解释：** 创建时间。 **取值范围：** 字符串长度不少于1，不超过1000。

        :param created_at: The created_at of this SSHKeyDto.
        :type created_at: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SSHKeyDto):
            return False
