...
class ProjectSimpleDto:
    ...
    def __init__(self, id=None, description=None, name=None, name_with_namespace=None, path=None, path_with_namespace=None, created_at=None, updated_at=None, archived=None, is_kia=None, ssh_url_to_repo=None, http_url_to_repo=None, web_url=None, readme_url=None, project_id=None, project_name=None, develop_mode=None, moderation_result=None):
        r"""ProjectSimpleDto
        ...
        :param name: 仓库名称
        :type name: str
        :param name_with_namespace: 组织名/组织名.../仓库名
        :type name_with_namespace: str
        :param path: 仓库路径
        :type path: str
        :param path_with_namespace: 仓库完整路径
        ...
        :param is_kia: 是否机密
        :type is_kia: bool
        :param ssh_url_to_repo: 仓库ssh地址
        :type ssh_url_to_repo: str
        :param http_url_to_repo: 仓库http地址
        :type http_url_to_repo: str
        :param web_url: 仓库页面链接
        :type web_url: str
        :param readme_url: 仓库readme文件链接
        :type readme_url: str
        :param project_id: 项目id
        :type project_id: str
        :param project_name: 项目名称
        :type project_name: str
        :param develop_mode: 仓库开发模式：normal、CR
        :type develop_mode: str
        :param moderation_result: 审核状态
    ...
    @property
    def project_id(self):
        r"""Gets the project_id of this ProjectSimpleDto.

        项目id

        :return: The project_id of this ProjectSimpleDto.
        :rtype: str
        """
    ...
    def project_id(self, project_id):
        r"""Sets the project_id of this ProjectSimpleDto.

        项目id

        :param project_id: The project_id of this ProjectSimpleDto.
        :type project_id: str
        """
    ...
    def project_name(self):
        r"""Gets the project_name of this ProjectSimpleDto.

        项目名称

        :return: The project_name of this ProjectSimpleDto.
        :rtype: str
        """
    ...
    def project_name(self, project_name):
        r"""Sets the project_name of this ProjectSimpleDto.

        项目名称

        :param project_name: The project_name of this ProjectSimpleDto.
        :type project_name: str
        """
    ...
    def moderation_result(self):
        r"""Gets the moderation_result of this ProjectSimpleDto.

        审核状态

        :return: The moderation_result of this ProjectSimpleDto.
        :rtype: bool
        """
    ...
    def moderation_result(self, moderation_result):
        r"""Sets the moderation_result of this ProjectSimpleDto.

        审核状态

        :param moderation_result: The moderation_result of this ProjectSimpleDto.
        :type moderation_result: bool
        """
