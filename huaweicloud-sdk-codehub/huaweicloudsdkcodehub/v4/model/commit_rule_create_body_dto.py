...
class CommitRuleCreateBodyDto:
    ...
    @property
    def name(self):
        r"""Gets the name of this CommitRuleCreateBodyDto.

        **参数解释：** 规则名称。 **约束限制：** 必填。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The name of this CommitRuleCreateBodyDto.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this CommitRuleCreateBodyDto.

        **参数解释：** 规则名称。 **约束限制：** 必填。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param name: The name of this CommitRuleCreateBodyDto.
        :type name: str
        """
        self._name = name
    ...
    def branch_name(self):
        r"""Gets the branch_name of this CommitRuleCreateBodyDto.

        **参数解释：** 分支规则。 **约束限制：** 必填。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The branch_name of this CommitRuleCreateBodyDto.
        :rtype: str
        """
    ...
    def branch_name(self, branch_name):
        r"""Sets the branch_name of this CommitRuleCreateBodyDto.

        **参数解释：** 分支规则。 **约束限制：** 必填。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param branch_name: The branch_name of this CommitRuleCreateBodyDto.
        :type branch_name: str
        """
    ...
    def commit_message_regex(self):
        r"""Gets the commit_message_regex of this CommitRuleCreateBodyDto.
        ...
        **参数解释：** 提交信息匹配规则。 所有提交消息都必须进行正则表达式匹配， 例如: \\d+\\..*。 若符合正则匹配，则允许提交。若此字段为空，则允许任何提交消息。 您也可以设置在提交信息中必须包含工作项单号，实现代码的E2E追溯。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
        ...
        :return: The commit_message_regex of this CommitRuleCreateBodyDto.
        :rtype: str
        """
    ...
    def commit_message_regex(self, commit_message_regex):
        r"""Sets the commit_message_regex of this CommitRuleCreateBodyDto.

        **参数解释：** 提交信息匹配规则。 所有提交消息都必须进行正则表达式匹配， 例如: \\d+\\..*。 若符合正则匹配，则允许提交。若此字段为空，则允许任何提交消息。 您也可以设置在提交信息中必须包含工作项单号，实现代码的E2E追溯。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param commit_message_regex: The commit_message_regex of this CommitRuleCreateBodyDto.
        :type commit_message_regex: str
        """
    ...
    def commit_message_negative_regex(self):
        r"""Gets the commit_message_negative_regex of this CommitRuleCreateBodyDto.

        **参数解释：** 提交信息负面匹配规则。 所有提交消息都必须进行正则表达式匹配，例如: \\d+\\..*。 符合正则匹配，则不允许提交。若此字段为空，则允许任何提交消息。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The commit_message_negative_regex of this CommitRuleCreateBodyDto.
        :rtype: str
        """
    ...
    def commit_message_negative_regex(self, commit_message_negative_regex):
        r"""Sets the commit_message_negative_regex of this CommitRuleCreateBodyDto.

        **参数解释：** 提交信息负面匹配规则。 所有提交消息都必须进行正则表达式匹配，例如: \\d+\\..*。 符合正则匹配，则不允许提交。若此字段为空，则允许任何提交消息。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param commit_message_negative_regex: The commit_message_negative_regex of this CommitRuleCreateBodyDto.
        :type commit_message_negative_regex: str
        """
    ...
    def author_regex(self):
        r"""Gets the author_regex of this CommitRuleCreateBodyDto.

        **参数解释：** 提交人的正则表达式。 提交人必须进行正则表达式匹配， 例如: /([a-zA-Z]\\d){7}/。如果此字段为空，则允许任何提交人。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The author_regex of this CommitRuleCreateBodyDto.
        :rtype: str
        """
    ...
    def author_regex(self, author_regex):
        r"""Sets the author_regex of this CommitRuleCreateBodyDto.

        **参数解释：** 提交人的正则表达式。 提交人必须进行正则表达式匹配， 例如: /([a-zA-Z]\\d){7}/。如果此字段为空，则允许任何提交人。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param author_regex: The author_regex of this CommitRuleCreateBodyDto.
        :type author_regex: str
        """
    ...
    def author_email_regex(self):
        r"""Gets the author_email_regex of this CommitRuleCreateBodyDto.

        **参数解释：** 提交人邮箱地址的正则表达式。 所有提交者邮箱地址都必须进行正则表达式匹配， 例如: @my-company.com$。如果此字段为空，则允许任何提交邮箱地址。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The author_email_regex of this CommitRuleCreateBodyDto.
        :rtype: str
        """
    ...
    def author_email_regex(self, author_email_regex):
        r"""Sets the author_email_regex of this CommitRuleCreateBodyDto.

        **参数解释：** 提交人邮箱地址的正则表达式。 所有提交者邮箱地址都必须进行正则表达式匹配， 例如: @my-company.com$。如果此字段为空，则允许任何提交邮箱地址。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param author_email_regex: The author_email_regex of this CommitRuleCreateBodyDto.
        :type author_email_regex: str
        """
    ...
    def prohibited_file_name_regex(self):
        r"""Gets the prohibited_file_name_regex of this CommitRuleCreateBodyDto.

        **参数解释：** 禁止提交的文件名称的正则表达式。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The prohibited_file_name_regex of this CommitRuleCreateBodyDto.
        :rtype: str
        """
    ...
    def prohibited_file_name_regex(self, prohibited_file_name_regex):
        r"""Sets the prohibited_file_name_regex of this CommitRuleCreateBodyDto.

        **参数解释：** 禁止提交的文件名称的正则表达式。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param prohibited_file_name_regex: The prohibited_file_name_regex of this CommitRuleCreateBodyDto.
        :type prohibited_file_name_regex: str
        """
    ...
    def max_file_size(self):
        r"""Gets the max_file_size of this CommitRuleCreateBodyDto.

        **参数解释：** 单文件大小限制（MB）。 单文件大小超过上述规格的添加或更新推送将被拒绝，Repo建议的最佳上限值为50MB。 系统支持单文件提交的最大值为300MB。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 50

        :return: The max_file_size of this CommitRuleCreateBodyDto.
        :rtype: int
        """
    ...
    def max_file_size(self, max_file_size):
        r"""Sets the max_file_size of this CommitRuleCreateBodyDto.

        **参数解释：** 单文件大小限制（MB）。 单文件大小超过上述规格的添加或更新推送将被拒绝，Repo建议的最佳上限值为50MB。 系统支持单文件提交的最大值为300MB。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 50

        :param max_file_size: The max_file_size of this CommitRuleCreateBodyDto.
        :type max_file_size: int
        """
    ...
    def binary_gate_enabled(self):
        r"""Gets the binary_gate_enabled of this CommitRuleCreateBodyDto.

        **参数解释：** 禁止新增二进制文件（对特权用户无效）。 **约束限制：** 不涉及。 **取值范围：** - true，禁止新增二进制文件。 - false，允许新增二进制文件。 **默认取值：** 不涉及。

        :return: The binary_gate_enabled of this CommitRuleCreateBodyDto.
        :rtype: bool
        """
    ...
    def binary_gate_enabled(self, binary_gate_enabled):
        r"""Sets the binary_gate_enabled of this CommitRuleCreateBodyDto.

        **参数解释：** 禁止新增二进制文件（对特权用户无效）。 **约束限制：** 不涉及。 **取值范围：** - true，禁止新增二进制文件。 - false，允许新增二进制文件。 **默认取值：** 不涉及。

        :param binary_gate_enabled: The binary_gate_enabled of this CommitRuleCreateBodyDto.
        :type binary_gate_enabled: bool
        """
    ...
    def allowed_modify_binary(self):
        r"""Gets the allowed_modify_binary of this CommitRuleCreateBodyDto.

        **参数解释：** 允许修改二进制文件（对特权用户无效）。 **约束限制：** 不涉及。 **取值范围：** - true，允许修改二进制文件。 - false，禁止修改二进制文件。 **默认取值：** 不涉及。

        :return: The allowed_modify_binary of this CommitRuleCreateBodyDto.
        :rtype: bool
        """
    ...
    def allowed_modify_binary(self, allowed_modify_binary):
        r"""Sets the allowed_modify_binary of this CommitRuleCreateBodyDto.

        **参数解释：** 允许修改二进制文件（对特权用户无效）。 **约束限制：** 不涉及。 **取值范围：** - true，允许修改二进制文件。 - false，禁止修改二进制文件。 **默认取值：** 不涉及。

        :param allowed_modify_binary: The allowed_modify_binary of this CommitRuleCreateBodyDto.
        :type allowed_modify_binary: bool
        """
    ...
    def allowed_binary_file_name_regex(self):
        r"""Gets the allowed_binary_file_name_regex of this CommitRuleCreateBodyDto.

        **参数解释：** 二进制文件白名单（可直接入库的文件）。 所有被推送的二进制文件名必须进行正则表达式匹配， 例如: (\\.png|\\.xls|\\.xlsx|\\.docx|\\.doc)$ 。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The allowed_binary_file_name_regex of this CommitRuleCreateBodyDto.
        :rtype: str
        """
    ...
    def allowed_binary_file_name_regex(self, allowed_binary_file_name_regex):
        r"""Sets the allowed_binary_file_name_regex of this CommitRuleCreateBodyDto.

        **参数解释：** 二进制文件白名单（可直接入库的文件）。 所有被推送的二进制文件名必须进行正则表达式匹配， 例如: (\\.png|\\.xls|\\.xlsx|\\.docx|\\.doc)$ 。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param allowed_binary_file_name_regex: The allowed_binary_file_name_regex of this CommitRuleCreateBodyDto.
        :type allowed_binary_file_name_regex: str
        """
    ...
    def privileged_user_ids(self):
        r"""Gets the privileged_user_ids of this CommitRuleCreateBodyDto.

        **参数解释：** 特权用户ID列表（特权用户可直接推送所有二进制文件入库。 只有特权用户能推送二进制文件。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The privileged_user_ids of this CommitRuleCreateBodyDto.
        :rtype: list[int]
        """
    ...
    def privileged_user_ids(self, privileged_user_ids):
        r"""Sets the privileged_user_ids of this CommitRuleCreateBodyDto.

        **参数解释：** 特权用户ID列表（特权用户可直接推送所有二进制文件入库。 只有特权用户能推送二进制文件。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param privileged_user_ids: The privileged_user_ids of this CommitRuleCreateBodyDto.
        :type privileged_user_ids: list[int]
        """
    ...
    def effective_date(self):
        r"""Gets the effective_date of this CommitRuleCreateBodyDto.

        **参数解释：** 规则生效时间， 例如: 2025-8-19。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The effective_date of this CommitRuleCreateBodyDto.
        :rtype: str
        """
    ...
    def effective_date(self, effective_date):
        r"""Sets the effective_date of this CommitRuleCreateBodyDto.

        **参数解释：** 规则生效时间， 例如: 2025-8-19。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param effective_date: The effective_date of this CommitRuleCreateBodyDto.
        :type effective_date: str
        """
    ...
    def skip_rule_check(self):
        r"""Gets the skip_rule_check of this CommitRuleCreateBodyDto.

        **参数解释：** 跳过规则检测。 **约束限制：** 仅CR仓库支持此参数。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The skip_rule_check of this CommitRuleCreateBodyDto.
        :rtype: bool
        """
    ...
    def skip_rule_check(self, skip_rule_check):
        r"""Sets the skip_rule_check of this CommitRuleCreateBodyDto.

        **参数解释：** 跳过规则检测。 **约束限制：** 仅CR仓库支持此参数。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param skip_rule_check: The skip_rule_check of this CommitRuleCreateBodyDto.
        :type skip_rule_check: bool
        """
    ...
    def skip_rule_end_date(self):
        r"""Gets the skip_rule_end_date of this CommitRuleCreateBodyDto.

        **参数解释：** 跳过规则检测失效时间， 例如: 2025-8-19 10:00:00。 **约束限制：** 仅CR仓库支持此参数。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The skip_rule_end_date of this CommitRuleCreateBodyDto.
        :rtype: str
        """
    ...
    def skip_rule_end_date(self, skip_rule_end_date):
        r"""Sets the skip_rule_end_date of this CommitRuleCreateBodyDto.

        **参数解释：** 跳过规则检测失效时间， 例如: 2025-8-19 10:00:00。 **约束限制：** 仅CR仓库支持此参数。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param skip_rule_end_date: The skip_rule_end_date of this CommitRuleCreateBodyDto.
        :type skip_rule_end_date: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CommitRuleCreateBodyDto):
            return False
