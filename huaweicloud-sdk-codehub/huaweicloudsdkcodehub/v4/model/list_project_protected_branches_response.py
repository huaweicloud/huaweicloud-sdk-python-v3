...
class ListProjectProtectedBranchesResponse(SdkResponse):
    ...
    @property
    def body(self):
        r"""Gets the body of this ListProjectProtectedBranchesResponse.

        项目下保护分支列表

        :return: The body of this ListProjectProtectedBranchesResponse.
        :rtype: list[:class:`huaweicloudsdkcodehub.v4.ProjectProtectedBranchApiDto`]
        """
        return self._body

    @body.setter
    def body(self, body):
        r"""Sets the body of this ListProjectProtectedBranchesResponse.

        项目下保护分支列表

        :param body: The body of this ListProjectProtectedBranchesResponse.
        :type body: list[:class:`huaweicloudsdkcodehub.v4.ProjectProtectedBranchApiDto`]
        """
        self._body = body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListProjectProtectedBranchesResponse):
            return False
