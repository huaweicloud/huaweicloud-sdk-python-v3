...
class ListImpersonationTokensRequest:
    ...
    @property
    def search(self):
        r"""Gets the search of this ListImpersonationTokensRequest.

        **参数解释：** 检索内容

        :return: The search of this ListImpersonationTokensRequest.
        :rtype: str
        """
        return self._search
    ...
    def search(self, search):
        r"""Sets the search of this ListImpersonationTokensRequest.

        **参数解释：** 检索内容

        :param search: The search of this ListImpersonationTokensRequest.
        :type search: str
        """
        self._search = search
    ...
    @property
    def offset(self):
        r"""Gets the offset of this ListImpersonationTokensRequest.

        **参数解释：** 偏移量，从0开始。

        :return: The offset of this ListImpersonationTokensRequest.
        :rtype: int
        """
        return self._offset
    ...
    def offset(self, offset):
        r"""Sets the offset of this ListImpersonationTokensRequest.

        **参数解释：** 偏移量，从0开始。

        :param offset: The offset of this ListImpersonationTokensRequest.
        :type offset: int
        """
        self._offset = offset
    ...
    @property
    def limit(self):
        r"""Gets the limit of this ListImpersonationTokensRequest.

        **参数解释：** 返回数量。

        :return: The limit of this ListImpersonationTokensRequest.
        :rtype: int
        """
        return self._limit
    ...
    def limit(self, limit):
        r"""Sets the limit of this ListImpersonationTokensRequest.

        **参数解释：** 返回数量。

        :param limit: The limit of this ListImpersonationTokensRequest.
        :type limit: int
        """
        self._limit = limit
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListImpersonationTokensRequest):
            return False
