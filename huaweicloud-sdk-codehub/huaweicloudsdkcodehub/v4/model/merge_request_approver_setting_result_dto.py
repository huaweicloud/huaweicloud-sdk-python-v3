...
class MergeRequestApproverSettingResultDto:
    ...
    def __init__(self, id=None, target=None, target_type=None, is_use_approval=None, approval_required_reviewers=None, approval_required_approvers=None, reset_approvals_on_push=None, reset_reviewers_on_push=None, approvers_from_project=None, append_reviewer_ids=None, append_reviewers=None, append_approver_ids=None, append_approvers=None, only_merge_when_pipeline_pass=None, assignee_ids=None, assignees=None, approver_ids=None, approvers=None, reviewer_ids=None, reviewers=None):
        r"""MergeRequestApproverSettingResultDto
    ...
    @property
    def id(self):
        r"""Gets the id of this MergeRequestApproverSettingResultDto.

        **参数解释：**  设置主键id。

        :return: The id of this MergeRequestApproverSettingResultDto.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this MergeRequestApproverSettingResultDto.

        **参数解释：**  设置主键id。

        :param id: The id of this MergeRequestApproverSettingResultDto.
        :type id: str
        """
        self._id = id
    ...
    @property
    def target(self):
        r"""Gets the target of this MergeRequestApproverSettingResultDto.

        **参数解释：**  分支，可使用*作为通配符使用，如：dev* 指以dev开头的所有分支

        :return: The target of this MergeRequestApproverSettingResultDto.
        :rtype: str
        """
        return self._target
    ...
    def target(self, target):
        r"""Sets the target of this MergeRequestApproverSettingResultDto.

        **参数解释：**  分支，可使用*作为通配符使用，如：dev* 指以dev开头的所有分支

        :param target: The target of this MergeRequestApproverSettingResultDto.
        :type target: str
        """
        self._target = target
    ...
    def target_type(self):
        r"""Gets the target_type of this MergeRequestApproverSettingResultDto.

        设置类型，当前仅开放branch类型

        :return: The target_type of this MergeRequestApproverSettingResultDto.
        :rtype: str
        """
    ...
    def target_type(self, target_type):
        r"""Sets the target_type of this MergeRequestApproverSettingResultDto.

        设置类型，当前仅开放branch类型

        :param target_type: The target_type of this MergeRequestApproverSettingResultDto.
        :type target_type: str
        """
    ...
    def is_use_approval(self):
        r"""Gets the is_use_approval of this MergeRequestApproverSettingResultDto.

        是否为审核模式，审核模式：true 评分模式：false

        :return: The is_use_approval of this MergeRequestApproverSettingResultDto.
        :rtype: bool
        """
    ...
    def is_use_approval(self, is_use_approval):
        r"""Sets the is_use_approval of this MergeRequestApproverSettingResultDto.

        是否为审核模式，审核模式：true 评分模式：false

        :param is_use_approval: The is_use_approval of this MergeRequestApproverSettingResultDto.
        :type is_use_approval: bool
        """
    ...
    def approval_required_reviewers(self):
        r"""Gets the approval_required_reviewers of this MergeRequestApproverSettingResultDto.

        最小检视人数

        :return: The approval_required_reviewers of this MergeRequestApproverSettingResultDto.
        :rtype: int
        """
    ...
    def approval_required_reviewers(self, approval_required_reviewers):
        r"""Sets the approval_required_reviewers of this MergeRequestApproverSettingResultDto.

        最小检视人数

        :param approval_required_reviewers: The approval_required_reviewers of this MergeRequestApproverSettingResultDto.
        :type approval_required_reviewers: int
        """
    ...
    def approval_required_approvers(self):
        r"""Gets the approval_required_approvers of this MergeRequestApproverSettingResultDto.

        最小审核人数

        :return: The approval_required_approvers of this MergeRequestApproverSettingResultDto.
        :rtype: int
        """
    ...
    def approval_required_approvers(self, approval_required_approvers):
        r"""Sets the approval_required_approvers of this MergeRequestApproverSettingResultDto.

        最小审核人数

        :param approval_required_approvers: The approval_required_approvers of this MergeRequestApproverSettingResultDto.
        :type approval_required_approvers: int
        """
    ...
    def reset_approvals_on_push(self):
        r"""Gets the reset_approvals_on_push of this MergeRequestApproverSettingResultDto.

        推送时是否重置审核门禁状态

        :return: The reset_approvals_on_push of this MergeRequestApproverSettingResultDto.
        :rtype: bool
        """
    ...
    def reset_approvals_on_push(self, reset_approvals_on_push):
        r"""Sets the reset_approvals_on_push of this MergeRequestApproverSettingResultDto.

        推送时是否重置审核门禁状态

        :param reset_approvals_on_push: The reset_approvals_on_push of this MergeRequestApproverSettingResultDto.
        :type reset_approvals_on_push: bool
        """
    ...
    def reset_reviewers_on_push(self):
        r"""Gets the reset_reviewers_on_push of this MergeRequestApproverSettingResultDto.

        推送时是否重置检视门禁状态

        :return: The reset_reviewers_on_push of this MergeRequestApproverSettingResultDto.
        :rtype: bool
        """
    ...
    def reset_reviewers_on_push(self, reset_reviewers_on_push):
        r"""Sets the reset_reviewers_on_push of this MergeRequestApproverSettingResultDto.

        推送时是否重置检视门禁状态

        :param reset_reviewers_on_push: The reset_reviewers_on_push of this MergeRequestApproverSettingResultDto.
        :type reset_reviewers_on_push: bool
        """
    ...
    def approvers_from_project(self):
        r"""Gets the approvers_from_project of this MergeRequestApproverSettingResultDto.

        是否开启仅能从以下审核/检视人中追加审核人/检视人

        :return: The approvers_from_project of this MergeRequestApproverSettingResultDto.
        :rtype: bool
        """
    ...
    def approvers_from_project(self, approvers_from_project):
        r"""Sets the approvers_from_project of this MergeRequestApproverSettingResultDto.

        是否开启仅能从以下审核/检视人中追加审核人/检视人

        :param approvers_from_project: The approvers_from_project of this MergeRequestApproverSettingResultDto.
        :type approvers_from_project: bool
        """
    ...
    def append_reviewer_ids(self):
        r"""Gets the append_reviewer_ids of this MergeRequestApproverSettingResultDto.

        追加检视人id列表

        :return: The append_reviewer_ids of this MergeRequestApproverSettingResultDto.
        :rtype: list[int]
        """
    ...
    def append_reviewer_ids(self, append_reviewer_ids):
        r"""Sets the append_reviewer_ids of this MergeRequestApproverSettingResultDto.

        追加检视人id列表

        :param append_reviewer_ids: The append_reviewer_ids of this MergeRequestApproverSettingResultDto.
        :type append_reviewer_ids: list[int]
        """
    ...
    def append_reviewers(self):
        r"""Gets the append_reviewers of this MergeRequestApproverSettingResultDto.

        追加检视人实体列表

        :return: The append_reviewers of this MergeRequestApproverSettingResultDto.
    ...
    def append_reviewers(self, append_reviewers):
        r"""Sets the append_reviewers of this MergeRequestApproverSettingResultDto.

        追加检视人实体列表

        :param append_reviewers: The append_reviewers of this MergeRequestApproverSettingResultDto.
        :type append_reviewers: list[:class:`huaweicloudsdkcodehub.v4.UserBasicDto`]
        """
    ...
    def append_approver_ids(self):
        r"""Gets the append_approver_ids of this MergeRequestApproverSettingResultDto.

        追加审核人id列表

        :return: The append_approver_ids of this MergeRequestApproverSettingResultDto.
        :rtype: list[int]
        """
    ...
    def append_approver_ids(self, append_approver_ids):
        r"""Sets the append_approver_ids of this MergeRequestApproverSettingResultDto.

        追加审核人id列表

        :param append_approver_ids: The append_approver_ids of this MergeRequestApproverSettingResultDto.
        :type append_approver_ids: list[int]
        """
    ...
    def append_approvers(self):
        r"""Gets the append_approvers of this MergeRequestApproverSettingResultDto.

        追加审核人实体列表

        :return: The append_approvers of this MergeRequestApproverSettingResultDto.
        :rtype: list[:class:`huaweicloudsdkcodehub.v4.UserBasicDto`]
        """
    ...
    def append_approvers(self, append_approvers):
        r"""Sets the append_approvers of this MergeRequestApproverSettingResultDto.

        追加审核人实体列表

        :param append_approvers: The append_approvers of this MergeRequestApproverSettingResultDto.
        :type append_approvers: list[:class:`huaweicloudsdkcodehub.v4.UserBasicDto`]
        """
    ...
    def only_merge_when_pipeline_pass(self):
        r"""Gets the only_merge_when_pipeline_pass of this MergeRequestApproverSettingResultDto.

        是否开启流水线门禁

        :return: The only_merge_when_pipeline_pass of this MergeRequestApproverSettingResultDto.
        :rtype: bool
        """
    ...
    def only_merge_when_pipeline_pass(self, only_merge_when_pipeline_pass):
        r"""Sets the only_merge_when_pipeline_pass of this MergeRequestApproverSettingResultDto.

        是否开启流水线门禁

        :param only_merge_when_pipeline_pass: The only_merge_when_pipeline_pass of this MergeRequestApproverSettingResultDto.
        :type only_merge_when_pipeline_pass: bool
        """
    ...
    def assignee_ids(self):
        r"""Gets the assignee_ids of this MergeRequestApproverSettingResultDto.

        合并人id列表

        :return: The assignee_ids of this MergeRequestApproverSettingResultDto.
        :rtype: list[int]
        """
    ...
    def assignee_ids(self, assignee_ids):
        r"""Sets the assignee_ids of this MergeRequestApproverSettingResultDto.

        合并人id列表

        :param assignee_ids: The assignee_ids of this MergeRequestApproverSettingResultDto.
        :type assignee_ids: list[int]
        """
    ...
    @property
    def assignees(self):
        r"""Gets the assignees of this MergeRequestApproverSettingResultDto.

        合并人实体列表

        :return: The assignees of this MergeRequestApproverSettingResultDto.
        :rtype: list[:class:`huaweicloudsdkcodehub.v4.UserBasicDto`]
        """
    ...
    def assignees(self, assignees):
        r"""Sets the assignees of this MergeRequestApproverSettingResultDto.

        合并人实体列表

        :param assignees: The assignees of this MergeRequestApproverSettingResultDto.
        :type assignees: list[:class:`huaweicloudsdkcodehub.v4.UserBasicDto`]
        """
    ...
    def approver_ids(self):
        r"""Gets the approver_ids of this MergeRequestApproverSettingResultDto.

        审核人id列表

        :return: The approver_ids of this MergeRequestApproverSettingResultDto.
        :rtype: list[int]
        """
    ...
    def approver_ids(self, approver_ids):
        r"""Sets the approver_ids of this MergeRequestApproverSettingResultDto.

        审核人id列表

        :param approver_ids: The approver_ids of this MergeRequestApproverSettingResultDto.
        :type approver_ids: list[int]
        """
    ...
    @property
    def approvers(self):
        r"""Gets the approvers of this MergeRequestApproverSettingResultDto.

        审核人实体列表

        :return: The approvers of this MergeRequestApproverSettingResultDto.
        :rtype: list[:class:`huaweicloudsdkcodehub.v4.UserBasicDto`]
        """
    ...
    def approvers(self, approvers):
        r"""Sets the approvers of this MergeRequestApproverSettingResultDto.

        审核人实体列表

        :param approvers: The approvers of this MergeRequestApproverSettingResultDto.
        :type approvers: list[:class:`huaweicloudsdkcodehub.v4.UserBasicDto`]
        """
    ...
    def reviewer_ids(self):
        r"""Gets the reviewer_ids of this MergeRequestApproverSettingResultDto.

        检视人id列表

        :return: The reviewer_ids of this MergeRequestApproverSettingResultDto.
        :rtype: list[int]
        """
    ...
    def reviewer_ids(self, reviewer_ids):
        r"""Sets the reviewer_ids of this MergeRequestApproverSettingResultDto.

        检视人id列表

        :param reviewer_ids: The reviewer_ids of this MergeRequestApproverSettingResultDto.
        :type reviewer_ids: list[int]
        """
    ...
    @property
    def reviewers(self):
        r"""Gets the reviewers of this MergeRequestApproverSettingResultDto.

        检视人实体列表

        :return: The reviewers of this MergeRequestApproverSettingResultDto.
        :rtype: list[:class:`huaweicloudsdkcodehub.v4.UserBasicDto`]
        """
    ...
    def reviewers(self, reviewers):
        r"""Sets the reviewers of this MergeRequestApproverSettingResultDto.

        检视人实体列表

        :param reviewers: The reviewers of this MergeRequestApproverSettingResultDto.
        :type reviewers: list[:class:`huaweicloudsdkcodehub.v4.UserBasicDto`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MergeRequestApproverSettingResultDto):
            return False
