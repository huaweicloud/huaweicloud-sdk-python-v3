...
class ListRepositoryWebhooksRequest:
    ...
    @property
    def offset(self):
        r"""Gets the offset of this ListRepositoryWebhooksRequest.

        **参数解释：** 偏移量，从0开始。

        :return: The offset of this ListRepositoryWebhooksRequest.
        :rtype: int
        """
        return self._offset
    ...
    def offset(self, offset):
        r"""Sets the offset of this ListRepositoryWebhooksRequest.

        **参数解释：** 偏移量，从0开始。

        :param offset: The offset of this ListRepositoryWebhooksRequest.
        :type offset: int
        """
        self._offset = offset
    ...
    @property
    def limit(self):
        r"""Gets the limit of this ListRepositoryWebhooksRequest.

        **参数解释：** 返回数量。

        :return: The limit of this ListRepositoryWebhooksRequest.
        :rtype: int
        """
        return self._limit
    ...
    def limit(self, limit):
        r"""Sets the limit of this ListRepositoryWebhooksRequest.

        **参数解释：** 返回数量。

        :param limit: The limit of this ListRepositoryWebhooksRequest.
        :type limit: int
        """
        self._limit = limit
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRepositoryWebhooksRequest):
            return False
