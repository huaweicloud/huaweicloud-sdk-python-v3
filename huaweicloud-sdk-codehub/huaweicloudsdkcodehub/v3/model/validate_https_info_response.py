...
class ValidateHttpsInfoResponse(SdkResponse):
    ...
    def __init__(self, error=None, result=None, status=None):
        """ValidateHttpsInfoResponse - a model defined in huaweicloud sdk"""
        
        super(ValidateHttpsInfoResponse, self).__init__()
    ...
    def result(self):
        ...
        :return: The result of this ValidateHttpsInfoResponse.
        :rtype: str
        """
        return self._result
    ...
    def result(self, result):
        ...
        :param result: The result of this ValidateHttpsInfoResponse.
        :type: str
        """
        self._result = result
    ...
    def status(self):
        ...
        :return: The status of this ValidateHttpsInfoResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this ValidateHttpsInfoResponse.
        :type: str
        """
        self._status = status
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ValidateHttpsInfoResponse):
            return False
