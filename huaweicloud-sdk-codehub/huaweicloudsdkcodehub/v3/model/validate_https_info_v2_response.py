...
class ValidateHttpsInfoV2Response(SdkResponse):
    ...
    def __init__(self, error=None, result=None, status=None):
        """ValidateHttpsInfoV2Response - a model defined in huaweicloud sdk"""
        
        super(ValidateHttpsInfoV2Response, self).__init__()
    ...
    def result(self):
        ...
        :return: The result of this ValidateHttpsInfoV2Response.
        :rtype: str
        """
        return self._result
    ...
    def result(self, result):
        ...
        :param result: The result of this ValidateHttpsInfoV2Response.
        :type: str
        """
        self._result = result
    ...
    def status(self):
        ...
        :return: The status of this ValidateHttpsInfoV2Response.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this ValidateHttpsInfoV2Response.
        :type: str
        """
        self._status = status
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ValidateHttpsInfoV2Response):
            return False
