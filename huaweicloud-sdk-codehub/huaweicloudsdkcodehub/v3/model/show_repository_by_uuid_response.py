...
class ShowRepositoryByUuidResponse(SdkResponse):
    ...
    def __init__(self, error=None, result=None, status=None):
        """ShowRepositoryByUuidResponse - a model defined in huaweicloud sdk"""
    ...
    @property
    def status(self):
        """Gets the status of this ShowRepositoryByUuidResponse.
    ...
    def status(self, status):
        """Sets the status of this ShowRepositoryByUuidResponse.
