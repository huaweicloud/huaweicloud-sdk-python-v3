...
class ListRepositoryStatusRequest:
    ...
    def repository_uuid(self):
        r"""Gets the repository_uuid of this ListRepositoryStatusRequest.

        仓库的uuid,用来指定需要查看的仓库

        :return: The repository_uuid of this ListRepositoryStatusRequest.
        :rtype: str
        """
    ...
    def repository_uuid(self, repository_uuid):
        r"""Sets the repository_uuid of this ListRepositoryStatusRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRepositoryStatusRequest):
            return False
