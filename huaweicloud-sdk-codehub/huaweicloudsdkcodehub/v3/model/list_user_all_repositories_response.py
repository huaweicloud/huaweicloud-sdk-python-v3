...
class ListUserAllRepositoriesResponse(SdkResponse):
    ...
    def __init__(self, error=None, result=None, status=None):
        """ListUserAllRepositoriesResponse - a model defined in huaweicloud sdk"""
        
        super(ListUserAllRepositoriesResponse, self).__init__()
    ...
    def status(self):
        ...
        :return: The status of this ListUserAllRepositoriesResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this ListUserAllRepositoriesResponse.
        :type: str
        """
        self._status = status
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListUserAllRepositoriesResponse):
            return False
