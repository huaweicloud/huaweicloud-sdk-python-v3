...
class ShowPrivateKeyVerifyResponse(SdkResponse):
    ...
    def __init__(self, error=None, result=None, status=None):
        """ShowPrivateKeyVerifyResponse - a model defined in huaweicloud sdk"""
    ...
    @property
    def error(self):
        """Gets the error of this ShowPrivateKeyVerifyResponse.
    ...
    def error(self, error):
        """Sets the error of this ShowPrivateKeyVerifyResponse.
    ...
    @property
    def result(self):
        """Gets the result of this ShowPrivateKeyVerifyResponse.
    ...
    def result(self, result):
        """Sets the result of this ShowPrivateKeyVerifyResponse.
    ...
    @property
    def status(self):
        """Gets the status of this ShowPrivateKeyVerifyResponse.
    ...
    def status(self, status):
        """Sets the status of this ShowPrivateKeyVerifyResponse.
