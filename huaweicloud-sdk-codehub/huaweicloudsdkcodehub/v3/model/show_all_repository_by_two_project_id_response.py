...
class ShowAllRepositoryByTwoProjectIdResponse(SdkResponse):
    ...
    def __init__(self, error=None, result=None, status=None):
        """ShowAllRepositoryByTwoProjectIdResponse - a model defined in huaweicloud sdk"""
        
        super(ShowAllRepositoryByTwoProjectIdResponse, self).__init__()
