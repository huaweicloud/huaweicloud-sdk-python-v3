...
class BatchCreateProtectedInstancesRequest:
    ...
    openapi_types = {
        'body': 'BatchCreateProtectedInstancesRequestBody'
    }
    ...
    def __init__(self, body=None):
        """BatchCreateProtectedInstancesRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: BatchCreateProtectedInstancesRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchCreateProtectedInstancesRequest):
            return False
