...
class UpdateProtectedInstanceNameResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateProtectedInstanceNameResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateProtectedInstanceNameResponse):
            return False
