...
class CreateProtectedInstanceRequest:
    ...
    openapi_types = {
        'body': 'CreateProtectedInstanceRequestBody'
    }
    ...
    def __init__(self, body=None):
        """CreateProtectedInstanceRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: CreateProtectedInstanceRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateProtectedInstanceRequest):
            return False
