...
class ListProtectedInstancesByTagsRequest:
    ...
    openapi_types = {
        'body': 'ListProtectedInstancesByTagsRequestBody'
    }
    ...
    def __init__(self, body=None):
        """ListProtectedInstancesByTagsRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: ListProtectedInstancesByTagsRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListProtectedInstancesByTagsRequest):
            return False
