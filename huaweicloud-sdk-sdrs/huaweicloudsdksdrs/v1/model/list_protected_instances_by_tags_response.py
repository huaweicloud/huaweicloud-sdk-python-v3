...
class ListProtectedInstancesByTagsResponse(SdkResponse):
    ...
    def total_count(self):
        ...
        :return: The total_count of this ListProtectedInstancesByTagsResponse.
        :rtype: int
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListProtectedInstancesByTagsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListProtectedInstancesByTagsResponse):
            return False
