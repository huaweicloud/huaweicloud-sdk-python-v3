...
class CreateDisasterRecoveryDrillRequest:
    ...
    openapi_types = {
        'body': 'CreateDisasterRecoveryDrillRequestBody'
    }
    ...
    def __init__(self, body=None):
        r"""CreateDisasterRecoveryDrillRequest
    ...
    @property
    def body(self):
        r"""Gets the body of this CreateDisasterRecoveryDrillRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this CreateDisasterRecoveryDrillRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateDisasterRecoveryDrillRequest):
            return False
