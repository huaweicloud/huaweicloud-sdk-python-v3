...
class UpdateProtectionGroupNameResponse(SdkResponse):
    ...
    def __init__(self, server_group=None):
        r"""UpdateProtectionGroupNameResponse
    ...
    def server_group(self):
        r"""Gets the server_group of this UpdateProtectionGroupNameResponse.
    ...
    def server_group(self, server_group):
        r"""Sets the server_group of this UpdateProtectionGroupNameResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateProtectionGroupNameResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateProtectionGroupNameResponse):
            return False
