...
class ConfigurationPrimitiveTypeHolder:
    ...
    def __init__(self, configuration=None):
        ...
        :param configuration: 
        :type configuration: :class:`huaweicloudsdkrfs.v1.ConfigurationPrimitiveTypeHolderConfiguration`
        """
    ...
    def configuration(self):
        ...
        :rtype: :class:`huaweicloudsdkrfs.v1.ConfigurationPrimitiveTypeHolderConfiguration`
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfigurationPrimitiveTypeHolder):
            return False
