...
class ParseTemplateVariablesRequest:
    ...
    openapi_types = {
        ...
        'body': 'ParseTemplateVariablesRequestBody'
    }
    ...
    def __init__(self, client_request_id=None, body=None):
        ...
        :param body: Body of the ParseTemplateVariablesRequest
        :type body: :class:`huaweicloudsdkrfs.v1.ParseTemplateVariablesRequestBody`
        """
    ...
    def client_request_id(self):
        ...
        :return: The client_request_id of this ParseTemplateVariablesRequest.
        :rtype: str
        """
    ...
    def client_request_id(self, client_request_id):
        ...
        :param client_request_id: The client_request_id of this ParseTemplateVariablesRequest.
        :type client_request_id: str
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkrfs.v1.ParseTemplateVariablesRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ParseTemplateVariablesRequest):
            return False
