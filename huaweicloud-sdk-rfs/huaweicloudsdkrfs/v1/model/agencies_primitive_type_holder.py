...
class AgenciesPrimitiveTypeHolder:
    ...
    @property
    def agencies(self):
        r"""Gets the agencies of this AgenciesPrimitiveTypeHolder.
    ...
    def agencies(self, agencies):
        r"""Sets the agencies of this AgenciesPrimitiveTypeHolder.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AgenciesPrimitiveTypeHolder):
            return False
