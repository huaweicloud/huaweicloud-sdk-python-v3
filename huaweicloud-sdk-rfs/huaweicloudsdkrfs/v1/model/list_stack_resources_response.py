...
class ListStackResourcesResponse(SdkResponse):
    ...
    def __init__(self, stack_resources=None, page_info=None):
        ...
        :type stack_resources: list[:class:`huaweicloudsdkrfs.v1.StackResource`]
        :param page_info: 
    ...
    def stack_resources(self):
        ...
        :rtype: list[:class:`huaweicloudsdkrfs.v1.StackResource`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListStackResourcesResponse.to_dict() is deprecated and no longer maintained, "
