...
class UpdatePrivateProviderMetadataRequest:
    ...
    def __init__(self, client_request_id=None, provider_name=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkrfs.v1.UpdatePrivateProviderMetadataRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkrfs.v1.UpdatePrivateProviderMetadataRequestBody`
        """
        return self._body
