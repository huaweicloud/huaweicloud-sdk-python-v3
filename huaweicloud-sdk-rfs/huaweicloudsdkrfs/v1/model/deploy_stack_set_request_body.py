...
class DeployStackSetRequestBody:
    ...
    def __init__(self, stack_set_id=None, deployment_targets=None, template_body=None, template_uri=None, vars_uri=None, vars_body=None, operation_preferences=None, call_identity=None):
        ...
        :type deployment_targets: :class:`huaweicloudsdkrfs.v1.DeploymentTargets`
        ...
        :type operation_preferences: :class:`huaweicloudsdkrfs.v1.OperationPreferences`
    ...
    def stack_set_id(self):
        r"""Gets the stack_set_id of this DeployStackSetRequestBody.
    ...
    def stack_set_id(self, stack_set_id):
        r"""Sets the stack_set_id of this DeployStackSetRequestBody.
    ...
    def deployment_targets(self):
        r"""Gets the deployment_targets of this DeployStackSetRequestBody.

        :return: The deployment_targets of this DeployStackSetRequestBody.
        :rtype: :class:`huaweicloudsdkrfs.v1.DeploymentTargets`
        """
        return self._deployment_targets

    @deployment_targets.setter
    def deployment_targets(self, deployment_targets):
        r"""Sets the deployment_targets of this DeployStackSetRequestBody.
    ...
    def template_body(self):
        r"""Gets the template_body of this DeployStackSetRequestBody.
    ...
    def template_body(self, template_body):
        r"""Sets the template_body of this DeployStackSetRequestBody.
    ...
    def template_uri(self):
        r"""Gets the template_uri of this DeployStackSetRequestBody.
    ...
    def template_uri(self, template_uri):
        r"""Sets the template_uri of this DeployStackSetRequestBody.
    ...
    @property
    def vars_uri(self):
        r"""Gets the vars_uri of this DeployStackSetRequestBody.
    ...
    def vars_uri(self, vars_uri):
        r"""Sets the vars_uri of this DeployStackSetRequestBody.
    ...
    @property
    def vars_body(self):
        r"""Gets the vars_body of this DeployStackSetRequestBody.
    ...
    def vars_body(self, vars_body):
        r"""Sets the vars_body of this DeployStackSetRequestBody.
    ...
    def operation_preferences(self):
        r"""Gets the operation_preferences of this DeployStackSetRequestBody.

        :return: The operation_preferences of this DeployStackSetRequestBody.
        :rtype: :class:`huaweicloudsdkrfs.v1.OperationPreferences`
        """
        return self._operation_preferences

    @operation_preferences.setter
    def operation_preferences(self, operation_preferences):
        r"""Sets the operation_preferences of this DeployStackSetRequestBody.
    ...
    def call_identity(self):
        r"""Gets the call_identity of this DeployStackSetRequestBody.
    ...
    def call_identity(self, call_identity):
        r"""Sets the call_identity of this DeployStackSetRequestBody.
