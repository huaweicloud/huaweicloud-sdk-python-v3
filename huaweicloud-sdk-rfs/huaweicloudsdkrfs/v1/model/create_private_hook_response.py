...
class CreatePrivateHookResponse(SdkResponse):
    ...
    @property
    def hook_id(self):
        r"""Gets the hook_id of this CreatePrivateHookResponse.
    ...
    def hook_id(self, hook_id):
        r"""Sets the hook_id of this CreatePrivateHookResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreatePrivateHookResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreatePrivateHookResponse):
            return False
