...
class ListStacksResponse(SdkResponse):
    ...
    def __init__(self, stacks=None, page_info=None):
        ...
        :type stacks: list[:class:`huaweicloudsdkrfs.v1.Stack`]
        :param page_info: 
    ...
    def stacks(self):
        ...
        :rtype: list[:class:`huaweicloudsdkrfs.v1.Stack`]
        """
        return self._stacks
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListStacksResponse.to_dict() is deprecated and no longer maintained, "
