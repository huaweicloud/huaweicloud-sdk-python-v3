...
class ListPrivateProvidersResponse(SdkResponse):
    ...
    def __init__(self, providers=None, page_info=None):
        ...
        :type providers: list[:class:`huaweicloudsdkrfs.v1.PrivateProviderSummary`]
        :param page_info: 
    ...
    def providers(self):
        ...
        :rtype: list[:class:`huaweicloudsdkrfs.v1.PrivateProviderSummary`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListPrivateProvidersResponse.to_dict() is deprecated and no longer maintained, "
