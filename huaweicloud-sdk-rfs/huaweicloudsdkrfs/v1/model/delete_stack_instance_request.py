...
class DeleteStackInstanceRequest:
    ...
    def __init__(self, client_request_id=None, stack_set_name=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkrfs.v1.DeleteStackInstanceRequestBody`
        """
    ...
    def client_request_id(self):
        r"""Gets the client_request_id of this DeleteStackInstanceRequest.
    ...
    def client_request_id(self, client_request_id):
        r"""Sets the client_request_id of this DeleteStackInstanceRequest.
    ...
    def stack_set_name(self):
        r"""Gets the stack_set_name of this DeleteStackInstanceRequest.
    ...
    def stack_set_name(self, stack_set_name):
        r"""Sets the stack_set_name of this DeleteStackInstanceRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this DeleteStackInstanceRequest.

        :return: The body of this DeleteStackInstanceRequest.
        :rtype: :class:`huaweicloudsdkrfs.v1.DeleteStackInstanceRequestBody`
        """
        return self._body

    @body.setter
    def body(self, body):
        r"""Sets the body of this DeleteStackInstanceRequest.
