...
class ListStackEventsResponse(SdkResponse):
    ...
    def __init__(self, stack_events=None, page_info=None):
        ...
        :type stack_events: list[:class:`huaweicloudsdkrfs.v1.StackEvent`]
        :param page_info: 
    ...
    def stack_events(self):
        ...
        :rtype: list[:class:`huaweicloudsdkrfs.v1.StackEvent`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListStackEventsResponse.to_dict() is deprecated and no longer maintained, "
