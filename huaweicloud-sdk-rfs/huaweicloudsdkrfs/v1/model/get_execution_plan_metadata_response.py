...
class GetExecutionPlanMetadataResponse(SdkResponse):
    ...
    def __init__(self, stack_id=None, stack_name=None, execution_plan_id=None, execution_plan_name=None, description=None, vars_structure=None, vars_uri_content=None, vars_body=None, status=None, status_message=None, create_time=None, apply_time=None, summary=None):
        ...
        :type vars_structure: list[:class:`huaweicloudsdkrfs.v1.VarsStructure`]
        ...
        :type apply_time: str
        :param summary: 
        :type summary: :class:`huaweicloudsdkrfs.v1.ExecutionPlanSummary`
        """
    ...
    def vars_structure(self):
        ...
        :rtype: list[:class:`huaweicloudsdkrfs.v1.VarsStructure`]
        """
    ...
    def summary(self):
        ...
        :rtype: :class:`huaweicloudsdkrfs.v1.ExecutionPlanSummary`
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("GetExecutionPlanMetadataResponse.to_dict() is deprecated and no longer maintained, "
