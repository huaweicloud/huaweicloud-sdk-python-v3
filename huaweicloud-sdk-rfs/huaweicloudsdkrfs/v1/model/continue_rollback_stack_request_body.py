...
class ContinueRollbackStackRequestBody:
    ...
    def __init__(self, stack_id=None):
        r"""ContinueRollbackStackRequestBody
    ...
    @property
    def stack_id(self):
        r"""Gets the stack_id of this ContinueRollbackStackRequestBody.
    ...
    def stack_id(self, stack_id):
        r"""Sets the stack_id of this ContinueRollbackStackRequestBody.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ContinueRollbackStackRequestBody):
            return False
