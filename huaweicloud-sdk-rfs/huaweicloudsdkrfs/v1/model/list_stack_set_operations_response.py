...
class ListStackSetOperationsResponse(SdkResponse):
    ...
    def __init__(self, stack_set_operations=None, page_info=None):
        ...
        :type stack_set_operations: list[:class:`huaweicloudsdkrfs.v1.StackSetOperation`]
        :param page_info: 
    ...
    def stack_set_operations(self):
        ...
        :rtype: list[:class:`huaweicloudsdkrfs.v1.StackSetOperation`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListStackSetOperationsResponse.to_dict() is deprecated and no longer maintained, "
