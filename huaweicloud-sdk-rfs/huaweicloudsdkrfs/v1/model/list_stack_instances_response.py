...
class ListStackInstancesResponse(SdkResponse):
    ...
    def __init__(self, stack_instances=None, page_info=None):
        ...
        :type stack_instances: list[:class:`huaweicloudsdkrfs.v1.StackInstance`]
        :param page_info: 
    ...
    def stack_instances(self):
        ...
        :rtype: list[:class:`huaweicloudsdkrfs.v1.StackInstance`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListStackInstancesResponse.to_dict() is deprecated and no longer maintained, "
