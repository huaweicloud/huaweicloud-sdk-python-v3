...
class DeleteStackRequest:
    ...
    def client_request_id(self):
        r"""Gets the client_request_id of this DeleteStackRequest.

        用户指定的，对于此请求的唯一ID，用于定位某个请求，推荐使用UUID

        :return: The client_request_id of this DeleteStackRequest.
        :rtype: str
        """
    ...
    def client_request_id(self, client_request_id):
        r"""Sets the client_request_id of this DeleteStackRequest.

        用户指定的，对于此请求的唯一ID，用于定位某个请求，推荐使用UUID

        :param client_request_id: The client_request_id of this DeleteStackRequest.
        :type client_request_id: str
        """
    ...
    @property
    def stack_name(self):
        r"""Gets the stack_name of this DeleteStackRequest.

        资源栈的名称。此名字在domain_id+区域+project_id下应唯一，可以使用中文、大小写英文、数字、下划线、中划线。首字符需为中文或者英文，区分大小写。

        :return: The stack_name of this DeleteStackRequest.
        :rtype: str
        """
    ...
    def stack_name(self, stack_name):
        r"""Sets the stack_name of this DeleteStackRequest.

        资源栈的名称。此名字在domain_id+区域+project_id下应唯一，可以使用中文、大小写英文、数字、下划线、中划线。首字符需为中文或者英文，区分大小写。

        :param stack_name: The stack_name of this DeleteStackRequest.
        :type stack_name: str
        """
    ...
    @property
    def stack_id(self):
        r"""Gets the stack_id of this DeleteStackRequest.
    ...
    def stack_id(self, stack_id):
        r"""Sets the stack_id of this DeleteStackRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteStackRequest):
            return False
