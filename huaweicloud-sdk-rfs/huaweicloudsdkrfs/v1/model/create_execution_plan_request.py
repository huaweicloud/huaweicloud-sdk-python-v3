...
class CreateExecutionPlanRequest:
    ...
    def __init__(self, client_request_id=None, stack_name=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkrfs.v1.CreateExecutionPlanRequestBody`
        """
    ...
    def client_request_id(self):
        r"""Gets the client_request_id of this CreateExecutionPlanRequest.
    ...
    def client_request_id(self, client_request_id):
        r"""Sets the client_request_id of this CreateExecutionPlanRequest.
    ...
    @property
    def stack_name(self):
        r"""Gets the stack_name of this CreateExecutionPlanRequest.
    ...
    def stack_name(self, stack_name):
        r"""Sets the stack_name of this CreateExecutionPlanRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this CreateExecutionPlanRequest.

        :return: The body of this CreateExecutionPlanRequest.
        :rtype: :class:`huaweicloudsdkrfs.v1.CreateExecutionPlanRequestBody`
        """
        return self._body

    @body.setter
    def body(self, body):
        r"""Sets the body of this CreateExecutionPlanRequest.
