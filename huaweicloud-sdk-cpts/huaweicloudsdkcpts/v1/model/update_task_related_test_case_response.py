...
class UpdateTaskRelatedTestCaseResponse(SdkResponse):
    ...
    def __init__(self, code=None, message=None, task_info=None):
        r"""UpdateTaskRelatedTestCaseResponse
    ...
    @property
    def code(self):
        r"""Gets the code of this UpdateTaskRelatedTestCaseResponse.
    ...
    @code.setter
    def code(self, code):
        r"""Sets the code of this UpdateTaskRelatedTestCaseResponse.
    ...
    @property
    def message(self):
        r"""Gets the message of this UpdateTaskRelatedTestCaseResponse.
    ...
    def message(self, message):
        r"""Sets the message of this UpdateTaskRelatedTestCaseResponse.
    ...
    @property
    def task_info(self):
        r"""Gets the task_info of this UpdateTaskRelatedTestCaseResponse.
    ...
    def task_info(self, task_info):
        r"""Sets the task_info of this UpdateTaskRelatedTestCaseResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateTaskRelatedTestCaseResponse.to_dict() is deprecated and no longer maintained, "
