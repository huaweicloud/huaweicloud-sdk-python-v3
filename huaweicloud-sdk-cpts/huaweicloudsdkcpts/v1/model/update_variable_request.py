...
class UpdateVariableRequest:
    ...
    openapi_types = {
        'test_suite_id': 'int',
        'body': 'list[UpdateVariableRequestBody]'
    }
    ...
    def __init__(self, test_suite_id=None, body=None):
        """UpdateVariableRequest - a model defined in huaweicloud sdk"""
    ...
    def test_suite_id(self):
        ...
        :return: The test_suite_id of this UpdateVariableRequest.
        :rtype: int
        """
    ...
    def test_suite_id(self, test_suite_id):
        ...
        :param test_suite_id: The test_suite_id of this UpdateVariableRequest.
        :type: int
        """
    ...
    def body(self):
        ...
        :rtype: list[UpdateVariableRequestBody]
        """
        return self._body
    ...
    def body(self, body):
        ...
        :type: list[UpdateVariableRequestBody]
        """
        self._body = body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateVariableRequest):
            return False
