...
class CloudPondAsyncClient(Client):
    ...
    def list_network_devices_async(self, request):
        r"""查询网络设备列表
    ...
    def list_network_devices_async_invoker(self, request):
        http_info = self._list_network_devices_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_network_devices_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_network_device_async(self, request):
        r"""查询网络设备详情
    ...
    def show_network_device_async_invoker(self, request):
        http_info = self._show_network_device_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_network_device_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_network_device_offerings_async(self, request):
        r"""查询网络设备商品列表
    ...
    def list_network_device_offerings_async_invoker(self, request):
        http_info = self._list_network_device_offerings_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_network_device_offerings_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_server_offerings_async(self, request):
        r"""查询服务器商品列表
    ...
    def list_server_offerings_async_invoker(self, request):
        http_info = self._list_server_offerings_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_server_offerings_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_sale_cycles_async(self, request):
        r"""查询可购买的销售周期
    ...
    def list_sale_cycles_async_invoker(self, request):
        http_info = self._list_sale_cycles_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_sale_cycles_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_storage_gears_async(self, request):
        r"""查询存储计费档位
    ...
    def list_storage_gears_async_invoker(self, request):
        http_info = self._list_storage_gears_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_storage_gears_http_info(self, request):
        http_info = {
            "method": "GET",
