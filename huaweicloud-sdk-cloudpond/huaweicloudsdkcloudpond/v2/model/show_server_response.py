...
class ShowServerResponse(SdkResponse):
    ...
    def __init__(self, server=None):
        ...
        :param server: 
        :type server: :class:`huaweicloudsdkcloudpond.v2.Server`
        """
    ...
    @property
    def server(self):
        r"""Gets the server of this ShowServerResponse.

        :return: The server of this ShowServerResponse.
        :rtype: :class:`huaweicloudsdkcloudpond.v2.Server`
        """
        return self._server

    @server.setter
    def server(self, server):
        r"""Sets the server of this ShowServerResponse.
