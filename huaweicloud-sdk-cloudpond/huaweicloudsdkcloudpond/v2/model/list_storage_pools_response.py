...
class ListStoragePoolsResponse(SdkResponse):
    ...
    openapi_types = {
        'storage_pools': 'list[StoragePoolV2]',
        'page_info': 'PageInfo'
    }
    ...
    def __init__(self, storage_pools=None, page_info=None):
        ...
        :type storage_pools: list[:class:`huaweicloudsdkcloudpond.v2.StoragePoolV2`]
        :param page_info: 
    ...
    def storage_pools(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcloudpond.v2.StoragePoolV2`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListStoragePoolsResponse.to_dict() is deprecated and no longer maintained, "
