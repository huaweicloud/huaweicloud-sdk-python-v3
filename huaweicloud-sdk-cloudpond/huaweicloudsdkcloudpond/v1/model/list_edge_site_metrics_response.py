...
class ListEdgeSiteMetricsResponse(SdkResponse):
    ...
    def __init__(self, metric_data=None):
        ...
        :type metric_data: list[:class:`huaweicloudsdkcloudpond.v1.MetricDataDetail`]
        """
    ...
    def metric_data(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcloudpond.v1.MetricDataDetail`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListEdgeSiteMetricsResponse.to_dict() is deprecated and no longer maintained, "
