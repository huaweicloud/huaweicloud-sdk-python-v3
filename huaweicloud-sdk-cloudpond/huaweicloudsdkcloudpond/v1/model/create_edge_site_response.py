...
class CreateEdgeSiteResponse(SdkResponse):
    ...
    @property
    def edge_site(self):
        r"""Gets the edge_site of this CreateEdgeSiteResponse.
    ...
    def edge_site(self, edge_site):
        r"""Sets the edge_site of this CreateEdgeSiteResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateEdgeSiteResponse.to_dict() is deprecated and no longer maintained, "
