...
class NatAsyncClient(Client):
    ...
    def update_nat_gateway_to_period_async(self, request):
        r"""公网NAT网关按需转包
    ...
    def update_nat_gateway_to_period_async_invoker(self, request):
        http_info = self._update_nat_gateway_to_period_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_nat_gateway_to_period_http_info(self, request):
        http_info = {
            "method": "POST",
