...
class CreateNatGatewayDnatRuleResponse(SdkResponse):
    ...
    def __init__(self, dnat_rule=None):
        r"""CreateNatGatewayDnatRuleResponse
    ...
    @property
    def dnat_rule(self):
        r"""Gets the dnat_rule of this CreateNatGatewayDnatRuleResponse.
    ...
    def dnat_rule(self, dnat_rule):
        r"""Sets the dnat_rule of this CreateNatGatewayDnatRuleResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateNatGatewayDnatRuleResponse.to_dict() is deprecated and no longer maintained, "
