...
class UpdateNatGatewayResponse(SdkResponse):
    ...
    def __init__(self, nat_gateway=None, order_id=None):
        r"""UpdateNatGatewayResponse
    ...
    def nat_gateway(self):
        r"""Gets the nat_gateway of this UpdateNatGatewayResponse.
    ...
    def nat_gateway(self, nat_gateway):
        r"""Sets the nat_gateway of this UpdateNatGatewayResponse.
    ...
    @property
    def order_id(self):
        r"""Gets the order_id of this UpdateNatGatewayResponse.

        订单ID。

        :return: The order_id of this UpdateNatGatewayResponse.
        :rtype: str
        """
    ...
    def order_id(self, order_id):
        r"""Sets the order_id of this UpdateNatGatewayResponse.

        订单ID。

        :param order_id: The order_id of this UpdateNatGatewayResponse.
        :type order_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateNatGatewayResponse.to_dict() is deprecated and no longer maintained, "
