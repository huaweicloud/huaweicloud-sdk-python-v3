...
class CreateNatGatewaySnatRuleRequest:
    ...
    openapi_types = {
        'body': 'CreateNatGatewaySnatRuleRequestOption'
    }
    ...
    def __init__(self, body=None):
        """CreateNatGatewaySnatRuleRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: CreateNatGatewaySnatRuleRequestOption
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateNatGatewaySnatRuleRequest):
            return False
