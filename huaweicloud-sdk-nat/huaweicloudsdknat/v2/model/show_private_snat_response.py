...
class ShowPrivateSnatResponse(SdkResponse):
    ...
    def __init__(self, snat_rule=None, request_id=None):
        ...
        super(ShowPrivateSnatResponse, self).__init__()
    ...
    def request_id(self):
        ...
        :return: The request_id of this ShowPrivateSnatResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        ...
        :param request_id: The request_id of this ShowPrivateSnatResponse.
        :type request_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowPrivateSnatResponse):
            return False
