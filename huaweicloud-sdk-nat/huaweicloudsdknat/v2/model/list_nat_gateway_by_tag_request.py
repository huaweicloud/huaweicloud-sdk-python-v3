...
class ListNatGatewayByTagRequest:
    ...
    openapi_types = {
        'body': 'ListNatsByTagsRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ListNatGatewayByTagRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListNatGatewayByTagRequest):
            return False
