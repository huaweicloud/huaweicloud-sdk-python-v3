...
class DownlinkVpc:
    ...
    def __init__(self, vpc_id=None, virsubnet_id=None, ngport_ip_address=None):
        r"""DownlinkVpc
    ...
    def ngport_ip_address(self):
        r"""Gets the ngport_ip_address of this DownlinkVpc.

        私网NAT网关的ngport_ip_addrss。

        :return: The ngport_ip_address of this DownlinkVpc.
        :rtype: str
        """
    ...
    def ngport_ip_address(self, ngport_ip_address):
        r"""Sets the ngport_ip_address of this DownlinkVpc.

        私网NAT网关的ngport_ip_addrss。

        :param ngport_ip_address: The ngport_ip_address of this DownlinkVpc.
        :type ngport_ip_address: str
        """
