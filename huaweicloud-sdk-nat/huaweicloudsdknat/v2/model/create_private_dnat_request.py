...
class CreatePrivateDnatRequest:
    ...
    openapi_types = {
        'body': 'CreatePrivateDnatOptionBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreatePrivateDnatRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreatePrivateDnatRequest):
            return False
