...
class NatGatewaySnatRuleResponseBody:
    ...
    def __init__(self, id=None, tenant_id=None, nat_gateway_id=None, cidr=None, source_type=None, floating_ip_id=None, description=None, status=None, created_at=None, network_id=None, admin_state_up=None, floating_ip_address=None, freezed_ip_address=None, global_eip_id=None, global_eip_address=None):
        r"""NatGatewaySnatRuleResponseBody
        ...
        :param freezed_ip_address: 功能说明：冻结的弹性公网IP，多个冻结的弹性公网IP使用逗号分隔。
    ...
    @property
    def id(self):
        r"""Gets the id of this NatGatewaySnatRuleResponseBody.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this NatGatewaySnatRuleResponseBody.
    ...
    @property
    def tenant_id(self):
        r"""Gets the tenant_id of this NatGatewaySnatRuleResponseBody.
    ...
    def tenant_id(self, tenant_id):
        r"""Sets the tenant_id of this NatGatewaySnatRuleResponseBody.
    ...
    def nat_gateway_id(self):
        r"""Gets the nat_gateway_id of this NatGatewaySnatRuleResponseBody.
    ...
    def nat_gateway_id(self, nat_gateway_id):
        r"""Sets the nat_gateway_id of this NatGatewaySnatRuleResponseBody.
    ...
    @property
    def cidr(self):
        r"""Gets the cidr of this NatGatewaySnatRuleResponseBody.
    ...
    @cidr.setter
    def cidr(self, cidr):
        r"""Sets the cidr of this NatGatewaySnatRuleResponseBody.
    ...
    def floating_ip_id(self):
        r"""Gets the floating_ip_id of this NatGatewaySnatRuleResponseBody.
    ...
    def floating_ip_id(self, floating_ip_id):
        r"""Sets the floating_ip_id of this NatGatewaySnatRuleResponseBody.
    ...
    def description(self):
        r"""Gets the description of this NatGatewaySnatRuleResponseBody.
    ...
    def description(self, description):
        r"""Sets the description of this NatGatewaySnatRuleResponseBody.
    ...
    @property
    def created_at(self):
        r"""Gets the created_at of this NatGatewaySnatRuleResponseBody.
    ...
    def created_at(self, created_at):
        r"""Sets the created_at of this NatGatewaySnatRuleResponseBody.
    ...
    @property
    def network_id(self):
        r"""Gets the network_id of this NatGatewaySnatRuleResponseBody.
    ...
    def network_id(self, network_id):
        r"""Sets the network_id of this NatGatewaySnatRuleResponseBody.
    ...
    def floating_ip_address(self):
        r"""Gets the floating_ip_address of this NatGatewaySnatRuleResponseBody.
    ...
    def floating_ip_address(self, floating_ip_address):
        r"""Sets the floating_ip_address of this NatGatewaySnatRuleResponseBody.
    ...
    def freezed_ip_address(self):
        r"""Gets the freezed_ip_address of this NatGatewaySnatRuleResponseBody.
    ...
    def freezed_ip_address(self, freezed_ip_address):
        r"""Sets the freezed_ip_address of this NatGatewaySnatRuleResponseBody.
    ...
    def global_eip_id(self):
        r"""Gets the global_eip_id of this NatGatewaySnatRuleResponseBody.

        全域弹性公网IP的id。

        :return: The global_eip_id of this NatGatewaySnatRuleResponseBody.
        :rtype: str
        """
    ...
    def global_eip_id(self, global_eip_id):
        r"""Sets the global_eip_id of this NatGatewaySnatRuleResponseBody.

        全域弹性公网IP的id。

        :param global_eip_id: The global_eip_id of this NatGatewaySnatRuleResponseBody.
        :type global_eip_id: str
        """
    ...
    def global_eip_address(self):
        r"""Gets the global_eip_address of this NatGatewaySnatRuleResponseBody.

        全域弹性公网IP的地址。

        :return: The global_eip_address of this NatGatewaySnatRuleResponseBody.
        :rtype: str
        """
    ...
    def global_eip_address(self, global_eip_address):
        r"""Sets the global_eip_address of this NatGatewaySnatRuleResponseBody.

        全域弹性公网IP的地址。

        :param global_eip_address: The global_eip_address of this NatGatewaySnatRuleResponseBody.
        :type global_eip_address: str
        """
