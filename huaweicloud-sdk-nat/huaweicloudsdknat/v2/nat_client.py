...
class NatClient(Client):
    ...
    def batch_create_delete_transit_subnet_tags(self, request):
        r"""批量添加删除中转子网标签
    ...
    def batch_create_delete_transit_subnet_tags_invoker(self, request):
        http_info = self._batch_create_delete_transit_subnet_tags_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _batch_create_delete_transit_subnet_tags_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def create_transit_subnet(self, request):
        r"""创建中转子网
    ...
    def create_transit_subnet_invoker(self, request):
        http_info = self._create_transit_subnet_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_transit_subnet_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def create_transit_subnet_tag(self, request):
        r"""添加中转子网标签
    ...
    def create_transit_subnet_tag_invoker(self, request):
        http_info = self._create_transit_subnet_tag_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_transit_subnet_tag_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def delete_transit_subnet(self, request):
        r"""删除中转子网
    ...
    def delete_transit_subnet_invoker(self, request):
        http_info = self._delete_transit_subnet_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_transit_subnet_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def delete_transit_subnet_tag(self, request):
        r"""删除中转子网标签
    ...
    def delete_transit_subnet_tag_invoker(self, request):
        http_info = self._delete_transit_subnet_tag_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_transit_subnet_tag_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_transit_subnet(self, request):
        r"""查询中转子网列表
    ...
    def list_transit_subnet_invoker(self, request):
        http_info = self._list_transit_subnet_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_transit_subnet_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v3/{project_id}/private-nat/transit-subnets",
            "request_type": request.__class__.__name__,
    ...
    def list_transit_subnet_tags(self, request):
        r"""查询中转子网项目标签
    ...
    def list_transit_subnet_tags_invoker(self, request):
        http_info = self._list_transit_subnet_tags_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_transit_subnet_tags_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_transit_subnets_by_tags(self, request):
        r"""查询中转子网实例
    ...
    def list_transit_subnets_by_tags_invoker(self, request):
        http_info = self._list_transit_subnets_by_tags_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_transit_subnets_by_tags_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def show_transit_subnet(self, request):
        r"""查询指定的中转子网详情
    ...
    def show_transit_subnet_invoker(self, request):
        http_info = self._show_transit_subnet_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_transit_subnet_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v3/{project_id}/private-nat/transit-subnets/{transit_subnet_id}",
            "request_type": request.__class__.__name__,
    ...
    def show_transit_subnet_tags(self, request):
        r"""查询中转子网标签
    ...
    def show_transit_subnet_tags_invoker(self, request):
        http_info = self._show_transit_subnet_tags_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_transit_subnet_tags_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v3/{project_id}/transit-subnets/{resource_id}/tags",
            "request_type": request.__class__.__name__,
    ...
    def update_transit_subnet(self, request):
        r"""更新中转子网
    ...
    def update_transit_subnet_invoker(self, request):
        http_info = self._update_transit_subnet_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_transit_subnet_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v3/{project_id}/private-nat/transit-subnets/{transit_subnet_id}",
            "request_type": request.__class__.__name__,
    ...
    def list_nat_gateway_specs(self, request):
        r"""支持创建的NAT网关规格列表
    ...
    def list_nat_gateway_specs_invoker(self, request):
        http_info = self._list_nat_gateway_specs_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_nat_gateway_specs_http_info(cls, request):
        http_info = {
            "method": "GET",
