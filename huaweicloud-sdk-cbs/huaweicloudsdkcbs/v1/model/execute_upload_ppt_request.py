...
class ExecuteUploadPptRequest:
    ...
    openapi_types = {
        'video_id': 'str',
        'body': 'ExecuteUploadPptRequestBody'
    }
    ...
    def __init__(self, video_id=None, body=None):
        ...
        :param video_id: 视频id
        :type video_id: str
        :param body: Body of the ExecuteUploadPptRequest
    ...
    def video_id(self):
        ...
        :return: The video_id of this ExecuteUploadPptRequest.
        :rtype: str
        """
    ...
    def video_id(self, video_id):
        ...
        :param video_id: The video_id of this ExecuteUploadPptRequest.
        :type video_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExecuteUploadPptRequest):
            return False
