...
class UpdateImageNameReq:
    ...
    def name(self):
        ...
        :return: The name of this UpdateImageNameReq.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this UpdateImageNameReq.
        :type name: str
        """
        self._name = name
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateImageNameReq):
            return False
