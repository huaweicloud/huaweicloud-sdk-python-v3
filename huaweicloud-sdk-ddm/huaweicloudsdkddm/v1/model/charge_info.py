...
class ChargeInfo:
    ...
    def __init__(self, charge_mode=None, period_num=None, period_type=None, is_auto_pay=None, is_auto_renew=None):
        r"""ChargeInfo

        The model defined in huaweicloud sdk

        :param charge_mode: 付费模式。
        :type charge_mode: str
        :param period_num: 使用周期。
        :type period_num: int
        :param period_type: 周期模式。
