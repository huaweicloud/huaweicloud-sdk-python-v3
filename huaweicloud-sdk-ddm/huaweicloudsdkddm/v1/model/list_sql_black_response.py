...
class ListSqlBlackResponse(SdkResponse):
    ...
    def sql_black_list_full_check(self):
        r"""Gets the sql_black_list_full_check of this ListSqlBlackResponse.

        **参数解释**：  全量匹配sql黑名单。  **参数范围**：  不涉及。

        :return: The sql_black_list_full_check of this ListSqlBlackResponse.
        :rtype: str
        """
    ...
    def sql_black_list_full_check(self, sql_black_list_full_check):
        r"""Sets the sql_black_list_full_check of this ListSqlBlackResponse.

        **参数解释**：  全量匹配sql黑名单。  **参数范围**：  不涉及。

        :param sql_black_list_full_check: The sql_black_list_full_check of this ListSqlBlackResponse.
        :type sql_black_list_full_check: str
        """
    ...
    def sql_black_list_prefix_check(self):
        r"""Gets the sql_black_list_prefix_check of this ListSqlBlackResponse.

        **参数解释**：  前缀匹配sql黑名单。  **参数范围**：  不涉及。

        :return: The sql_black_list_prefix_check of this ListSqlBlackResponse.
        :rtype: str
        """
    ...
    def sql_black_list_prefix_check(self, sql_black_list_prefix_check):
        r"""Sets the sql_black_list_prefix_check of this ListSqlBlackResponse.

        **参数解释**：  前缀匹配sql黑名单。  **参数范围**：  不涉及。

        :param sql_black_list_prefix_check: The sql_black_list_prefix_check of this ListSqlBlackResponse.
        :type sql_black_list_prefix_check: str
        """
    ...
    def sql_black_list_regex_check(self):
        r"""Gets the sql_black_list_regex_check of this ListSqlBlackResponse.

        **参数解释**：  正则匹配sql黑名单。  **参数范围**：  不涉及。

        :return: The sql_black_list_regex_check of this ListSqlBlackResponse.
        :rtype: str
        """
    ...
    def sql_black_list_regex_check(self, sql_black_list_regex_check):
        r"""Sets the sql_black_list_regex_check of this ListSqlBlackResponse.

        **参数解释**：  正则匹配sql黑名单。  **参数范围**：  不涉及。

        :param sql_black_list_regex_check: The sql_black_list_regex_check of this ListSqlBlackResponse.
        :type sql_black_list_regex_check: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListSqlBlackResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListSqlBlackResponse):
            return False
