...
class CheckDataNodeConnectionResponse(SdkResponse):
    ...
    def __init__(self, rds_check_infos=None):
        r"""CheckDataNodeConnectionResponse
    ...
    def rds_check_infos(self):
        r"""Gets the rds_check_infos of this CheckDataNodeConnectionResponse.

        **参数解释**：  rds测试连通性相关信息的集合。  **参数范围**：  不涉及。

        :return: The rds_check_infos of this CheckDataNodeConnectionResponse.
    ...
    def rds_check_infos(self, rds_check_infos):
        r"""Sets the rds_check_infos of this CheckDataNodeConnectionResponse.

        **参数解释**：  rds测试连通性相关信息的集合。  **参数范围**：  不涉及。

        :param rds_check_infos: The rds_check_infos of this CheckDataNodeConnectionResponse.
        :type rds_check_infos: list[:class:`huaweicloudsdkddm.v1.CheckRdsConnectionResqVO`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CheckDataNodeConnectionResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CheckDataNodeConnectionResponse):
            return False
