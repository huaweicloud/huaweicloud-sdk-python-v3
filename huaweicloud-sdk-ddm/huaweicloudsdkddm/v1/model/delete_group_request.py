...
class DeleteGroupRequest:
    ...
    def instance_id(self):
        r"""Gets the instance_id of this DeleteGroupRequest.

        实例 ID。

        :return: The instance_id of this DeleteGroupRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this DeleteGroupRequest.

        实例 ID。

        :param instance_id: The instance_id of this DeleteGroupRequest.
        :type instance_id: str
        """
