...
class ShowRiskInfoResponse(SdkResponse):
    ...
    def __init__(self, risks=None):
        ...
        :param risks: 内核风险提醒信息。
        :type risks: list[:class:`huaweicloudsdkddm.v1.Risks`]
        """
        
        super(ShowRiskInfoResponse, self).__init__()
    ...
    def risks(self):
        ...
        :rtype: list[:class:`huaweicloudsdkddm.v1.Risks`]
        """
        return self._risks
