...
class UpdateInstanceNameResponse(SdkResponse):
    ...
    @property
    def name(self):
        r"""Gets the name of this UpdateInstanceNameResponse.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this UpdateInstanceNameResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateInstanceNameResponse.to_dict() is deprecated and no longer maintained, "
