...
class DdmAsyncClient(Client):
    ...
    def create_ddm_configurations_async(self, request):
        r"""创建参数组
    ...
    def create_ddm_configurations_async_invoker(self, request):
        http_info = self._create_ddm_configurations_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_ddm_configurations_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def modify_configuration_async_invoker(self, request):
        http_info = self._modify_configuration_http_info(request)
        return AsyncInvoker(self, http_info)

    def _modify_configuration_http_info(self, request):
        http_info = {
            "method": "PUT",
    ...
    def cancel_migration_async_invoker(self, request):
        http_info = self._cancel_migration_http_info(request)
        return AsyncInvoker(self, http_info)

    def _cancel_migration_http_info(self, request):
        http_info = {
            "method": "PUT",
    ...
    def change_strategy_async(self, request):
        r"""修改切换路由策略
    ...
    def change_strategy_async_invoker(self, request):
        http_info = self._change_strategy_http_info(request)
        return AsyncInvoker(self, http_info)

    def _change_strategy_http_info(self, request):
        http_info = {
            "method": "PUT",
    ...
    def check_migrate_logic_db_async(self, request):
        r"""分片变更预校验
    ...
    def check_migrate_logic_db_async_invoker(self, request):
        http_info = self._check_migrate_logic_db_http_info(request)
        return AsyncInvoker(self, http_info)

    def _check_migrate_logic_db_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def check_preliminary_results_async(self, request):
        r"""查询分片变更预校验异步结果
    ...
    def check_preliminary_results_async_invoker(self, request):
        http_info = self._check_preliminary_results_http_info(request)
        return AsyncInvoker(self, http_info)

    def _check_preliminary_results_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def clean_migration_async(self, request):
        r"""清理分片变更
    ...
    def clean_migration_async_invoker(self, request):
        http_info = self._clean_migration_http_info(request)
        return AsyncInvoker(self, http_info)

    def _clean_migration_http_info(self, request):
        http_info = {
            "method": "PUT",
    ...
    def create_ddm_user_async(self, request):
        r"""创建账号
    ...
    def create_ddm_user_async_invoker(self, request):
        http_info = self._create_ddm_user_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_ddm_user_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def delete_ddm_user_async(self, request):
        r"""删除账号
    ...
    def delete_ddm_user_async_invoker(self, request):
        http_info = self._delete_ddm_user_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_ddm_user_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def download_schema_metadata_async(self, request):
        r"""导出逻辑库元数据
    ...
    def download_schema_metadata_async_invoker(self, request):
        http_info = self._download_schema_metadata_http_info(request)
        return AsyncInvoker(self, http_info)

    def _download_schema_metadata_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_available_rds_async(self, request):
    ...
    def list_available_rds_async_invoker(self, request):
        http_info = self._list_available_rds_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_available_rds_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_available_rds_for_migrate_async(self, request):
    ...
    def list_available_rds_for_migrate_async_invoker(self, request):
        http_info = self._list_available_rds_for_migrate_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_available_rds_for_migrate_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_ddm_users_async(self, request):
        r"""查询账号列表
    ...
    def list_ddm_users_async_invoker(self, request):
        http_info = self._list_ddm_users_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_ddm_users_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v3/{project_id}/instances/{instance_id}/users",
            "request_type": request.__class__.__name__,
    ...
    def list_ddms_async(self, request):
        r"""查询实例列表
    ...
    def list_ddms_async_invoker(self, request):
        http_info = self._list_ddms_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_ddms_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v3/{project_id}/instances",
            "request_type": request.__class__.__name__,
    ...
    def list_slow_log_analysis_async(self, request):
        r"""查询慢日志
    ...
    def list_slow_log_analysis_async_invoker(self, request):
        http_info = self._list_slow_log_analysis_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_slow_log_analysis_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def migrate_logic_db_async(self, request):
        r"""分片变更
    ...
    def migrate_logic_db_async_invoker(self, request):
        http_info = self._migrate_logic_db_http_info(request)
        return AsyncInvoker(self, http_info)

    def _migrate_logic_db_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def migrate_results_async(self, request):
        r"""查询分片变更任务详情
    ...
    def migrate_results_async_invoker(self, request):
        http_info = self._migrate_results_http_info(request)
        return AsyncInvoker(self, http_info)

    def _migrate_results_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def reset_ddm_user_password_async(self, request):
        r"""重置账号密码
    ...
    def reset_ddm_user_password_async_invoker(self, request):
        http_info = self._reset_ddm_user_password_http_info(request)
        return AsyncInvoker(self, http_info)

    def _reset_ddm_user_password_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def restore2_exist_async(self, request):
        r"""恢复到新实例
    ...
    def restore2_exist_async_invoker(self, request):
        http_info = self._restore2_exist_http_info(request)
        return AsyncInvoker(self, http_info)

    def _restore2_exist_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def restore_metadata_async(self, request):
        r"""元数据恢复
    ...
    def restore_metadata_async_invoker(self, request):
        http_info = self._restore_metadata_http_info(request)
        return AsyncInvoker(self, http_info)

    def _restore_metadata_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def retry_migration_async(self, request):
        r"""重试分片变更
    ...
    def retry_migration_async_invoker(self, request):
        http_info = self._retry_migration_http_info(request)
        return AsyncInvoker(self, http_info)

    def _retry_migration_http_info(self, request):
        http_info = {
            "method": "PUT",
    ...
    def rollback_migration_async(self, request):
        r"""回滚分片变更
    ...
    def rollback_migration_async_invoker(self, request):
        http_info = self._rollback_migration_http_info(request)
        return AsyncInvoker(self, http_info)

    def _rollback_migration_http_info(self, request):
        http_info = {
            "method": "PUT",
    ...
    def show_avalible_ddms_async(self, request):
        r"""查询可用于恢复的实例列表
    ...
    def show_avalible_ddms_async_invoker(self, request):
        http_info = self._show_avalible_ddms_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_avalible_ddms_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_avalible_rds_async(self, request):
        r"""查询可用于时间点恢复的数据节点列表
    ...
    def show_avalible_rds_async_invoker(self, request):
        http_info = self._show_avalible_rds_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_avalible_rds_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_avalible_time_async(self, request):
        r"""查询可恢复时间段
    ...
    def show_avalible_time_async_invoker(self, request):
        http_info = self._show_avalible_time_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_avalible_time_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_instance_database_async(self, request):
        r"""查询逻辑库详情
    ...
    def show_instance_database_async_invoker(self, request):
        http_info = self._show_instance_database_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_instance_database_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v3/{project_id}/instances/{instance_id}/databases/{database_name}",
            "request_type": request.__class__.__name__,
    ...
    def show_migration_log_async(self, request):
        r"""查询分片变更的日志
    ...
    def show_migration_log_async_invoker(self, request):
        http_info = self._show_migration_log_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_migration_log_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_related_dns_async_invoker(self, request):
        http_info = self._show_related_dns_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_related_dns_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def switch_route_async(self, request):
        r"""切换路由
    ...
    def switch_route_async_invoker(self, request):
        http_info = self._switch_route_http_info(request)
        return AsyncInvoker(self, http_info)

    def _switch_route_http_info(self, request):
        http_info = {
            "method": "PUT",
    ...
    def update_ddm_user_async(self, request):
        r"""修改账号
    ...
    def update_ddm_user_async_invoker(self, request):
        http_info = self._update_ddm_user_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_ddm_user_http_info(self, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v3/{project_id}/instances/{instance_id}/users/{username}",
            "request_type": request.__class__.__name__,
    ...
    def upload_schema_metadata_async(self, request):
        r"""导入逻辑库元数据
    ...
    def upload_schema_metadata_async_invoker(self, request):
        http_info = self._upload_schema_metadata_http_info(request)
        return AsyncInvoker(self, http_info)

    def _upload_schema_metadata_http_info(self, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v3/{project_id}/instances/{instance_id}/schema-metadata",
            "request_type": request.__class__.__name__,
    ...
    def check_data_node_connection_async(self, request):
        r"""rds连通性检查V3
    ...
    def check_data_node_connection_async_invoker(self, request):
        http_info = self._check_data_node_connection_http_info(request)
        return AsyncInvoker(self, http_info)
    ...
    def compare_parameter_groups_async(self, request):
        r"""比较参数组V3
    ...
    def compare_parameter_groups_async_invoker(self, request):
        http_info = self._compare_parameter_groups_http_info(request)
        return AsyncInvoker(self, http_info)

    def _compare_parameter_groups_http_info(self, request):
        http_info = {
            "method": "PUT",
    ...
    def move_tmlog_files_async(self, request):
        r"""移动TMLOG文件
    ...
    def move_tmlog_files_async_invoker(self, request):
        http_info = self._move_tmlog_files_http_info(request)
        return AsyncInvoker(self, http_info)

    def _move_tmlog_files_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def reset_parameter_group_async(self, request):
        r"""更新参数组V3
    ...
    def reset_parameter_group_async_invoker(self, request):
        http_info = self._reset_parameter_group_http_info(request)
        return AsyncInvoker(self, http_info)

    def _reset_parameter_group_http_info(self, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v3/{project_id}/configurations/{config_id}",
            "request_type": request.__class__.__name__,
    ...
    def set_read_only_status_async(self, request):
        r"""设置实例只读状态V3
    ...
    def set_read_only_status_async_invoker(self, request):
        http_info = self._set_read_only_status_http_info(request)
        return AsyncInvoker(self, http_info)

    def _set_read_only_status_http_info(self, request):
        http_info = {
            "method": "PUT",
    ...
    def show_ddm_detail_async(self, request):
        r"""查询实例详情V3
    ...
    def show_ddm_detail_async_invoker(self, request):
        http_info = self._show_ddm_detail_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_ddm_detail_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v3/{project_id}/instances/{instance_id}",
            "request_type": request.__class__.__name__,
    ...
    def show_tmlog_infos_async(self, request):
        r"""查询TMLOG信息
    ...
    def show_tmlog_infos_async_invoker(self, request):
        http_info = self._show_tmlog_infos_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_tmlog_infos_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v3/{project_id}/instances/{instance_id}/tmlogs",
            "request_type": request.__class__.__name__,
    ...
    def batch_modify_read_write_strategy_async(self, request):
        r"""批量设置读策略V3
    ...
    def batch_modify_read_write_strategy_async_invoker(self, request):
        http_info = self._batch_modify_read_write_strategy_http_info(request)
        return AsyncInvoker(self, http_info)

    def _batch_modify_read_write_strategy_http_info(self, request):
        http_info = {
            "method": "PUT",
    ...
    def modify_sql_black_list_async(self, request):
        r"""修改sql黑名单
    ...
    def modify_sql_black_list_async_invoker(self, request):
        http_info = self._modify_sql_black_list_http_info(request)
        return AsyncInvoker(self, http_info)

    def _modify_sql_black_list_http_info(self, request):
        http_info = {
            "method": "PUT",
    ...
    def list_sql_black_async(self, request):
        r"""查询sql黑名单V3
    ...
    def list_sql_black_async_invoker(self, request):
        http_info = self._list_sql_black_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_sql_black_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v3/{project_id}/instances/{instance_id}/databases/{logic_db_name}/sql-black-list",
            "request_type": request.__class__.__name__,
