...
class DdmAsyncClient(Client):
    ...
    def check_data_node_connection_v0_v3_async(self, request):
        r"""rds连通性检查V3
    ...
    def check_data_node_connection_v0_v3_async_invoker(self, request):
        http_info = self._check_data_node_connection_v0_v3_http_info(request)
        return AsyncInvoker(self, http_info)

    def _check_data_node_connection_v0_v3_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def copy_parameter_group_async(self, request):
        r"""复制参数组V3
    ...
    def copy_parameter_group_async_invoker(self, request):
        http_info = self._copy_parameter_group_http_info(request)
        return AsyncInvoker(self, http_info)

    def _copy_parameter_group_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def list_instances_applied_parameter_group_v0_v3_async(self, request):
        r"""查询可应用的实例列表V3
    ...
    def list_instances_applied_parameter_group_v0_v3_async_invoker(self, request):
        http_info = self._list_instances_applied_parameter_group_v0_v3_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_instances_applied_parameter_group_v0_v3_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_parameter_group_apply_history_v0_v3_async(self, request):
        r"""参数组应用记录V3
    ...
    def list_parameter_group_apply_history_v0_v3_async_invoker(self, request):
        http_info = self._list_parameter_group_apply_history_v0_v3_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_parameter_group_apply_history_v0_v3_http_info(self, request):
        http_info = {
            "method": "GET",
