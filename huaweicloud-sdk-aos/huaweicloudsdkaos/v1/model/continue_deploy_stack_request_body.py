...
class ContinueDeployStackRequestBody:
    ...
    def __init__(self, stack_id=None):
        r"""ContinueDeployStackRequestBody
    ...
    @property
    def stack_id(self):
        r"""Gets the stack_id of this ContinueDeployStackRequestBody.
    ...
    def stack_id(self, stack_id):
        r"""Sets the stack_id of this ContinueDeployStackRequestBody.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ContinueDeployStackRequestBody):
            return False
