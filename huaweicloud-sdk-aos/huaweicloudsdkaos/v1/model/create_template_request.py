...
class CreateTemplateRequest:
    ...
    def __init__(self, client_request_id=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkaos.v1.CreateTemplateRequestBody`
        """
    ...
    def client_request_id(self):
        r"""Gets the client_request_id of this CreateTemplateRequest.

        用户指定的，对于此请求的唯一ID，用于定位某个请求，推荐使用UUID

        :return: The client_request_id of this CreateTemplateRequest.
        :rtype: str
        """
    ...
    def client_request_id(self, client_request_id):
        r"""Sets the client_request_id of this CreateTemplateRequest.

        用户指定的，对于此请求的唯一ID，用于定位某个请求，推荐使用UUID

        :param client_request_id: The client_request_id of this CreateTemplateRequest.
        :type client_request_id: str
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkaos.v1.CreateTemplateRequestBody`
        """
        return self._body
