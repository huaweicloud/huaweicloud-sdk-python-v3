...
class BaseTemplateBody:
    ...
    def version_description(self):
        r"""Gets the version_description of this BaseTemplateBody.

        模板版本的描述。可用于客户识别自己的模板版本

        :return: The version_description of this BaseTemplateBody.
        :rtype: str
        """
    ...
    def version_description(self, version_description):
        r"""Sets the version_description of this BaseTemplateBody.

        模板版本的描述。可用于客户识别自己的模板版本

        :param version_description: The version_description of this BaseTemplateBody.
        :type version_description: str
        """
    ...
    def template_body(self):
        r"""Gets the template_body of this BaseTemplateBody.

        HCL模板，描述了模板中使用的资源 template_body 和 template_uri 有且仅有一个存在

        :return: The template_body of this BaseTemplateBody.
        :rtype: str
        """
    ...
    def template_body(self, template_body):
        r"""Sets the template_body of this BaseTemplateBody.

        HCL模板，描述了模板中使用的资源 template_body 和 template_uri 有且仅有一个存在

        :param template_body: The template_body of this BaseTemplateBody.
        :type template_body: str
        """
    ...
    def template_uri(self):
        r"""Gets the template_uri of this BaseTemplateBody.
        ...
        :return: The template_uri of this BaseTemplateBody.
        :rtype: str
        """
    ...
    def template_uri(self, template_uri):
        r"""Sets the template_uri of this BaseTemplateBody.

        HCL模板的obs链接，该模板描述了资源的目标状态  对应的文件应该是纯tf文件或zip压缩包  纯tf文件需要以`.tf`或者`.tf.json`结尾，并遵守hcl语法  压缩包目前只支持zip格式，文件需要以\".zip\"结尾。解压后的文件不得包含\".tfvars\"文件  template_body 和 template_uri 有且仅有一个存在

        :param template_uri: The template_uri of this BaseTemplateBody.
        :type template_uri: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BaseTemplateBody):
            return False
