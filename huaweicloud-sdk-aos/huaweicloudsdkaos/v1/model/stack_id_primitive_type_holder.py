...
class StackIdPrimitiveTypeHolder:
    ...
    @property
    def stack_id(self):
        r"""Gets the stack_id of this StackIdPrimitiveTypeHolder.
    ...
    def stack_id(self, stack_id):
        r"""Sets the stack_id of this StackIdPrimitiveTypeHolder.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StackIdPrimitiveTypeHolder):
            return False
