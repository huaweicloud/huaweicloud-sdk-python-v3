...
class DeleteExecutionPlanRequest:
    ...
    def client_request_id(self):
        r"""Gets the client_request_id of this DeleteExecutionPlanRequest.

        用户指定的，对于此请求的唯一ID，用于定位某个请求，推荐使用UUID

        :return: The client_request_id of this DeleteExecutionPlanRequest.
        :rtype: str
        """
    ...
    def client_request_id(self, client_request_id):
        r"""Sets the client_request_id of this DeleteExecutionPlanRequest.

        用户指定的，对于此请求的唯一ID，用于定位某个请求，推荐使用UUID

        :param client_request_id: The client_request_id of this DeleteExecutionPlanRequest.
        :type client_request_id: str
        """
    ...
    @property
    def stack_name(self):
        r"""Gets the stack_name of this DeleteExecutionPlanRequest.

        资源栈的名称。此名字在domain_id+区域+project_id下应唯一，可以使用中文、大小写英文、数字、下划线、中划线。首字符需为中文或者英文，区分大小写。

        :return: The stack_name of this DeleteExecutionPlanRequest.
        :rtype: str
        """
    ...
    def stack_name(self, stack_name):
        r"""Sets the stack_name of this DeleteExecutionPlanRequest.

        资源栈的名称。此名字在domain_id+区域+project_id下应唯一，可以使用中文、大小写英文、数字、下划线、中划线。首字符需为中文或者英文，区分大小写。

        :param stack_name: The stack_name of this DeleteExecutionPlanRequest.
        :type stack_name: str
        """
    ...
    def execution_plan_name(self):
        r"""Gets the execution_plan_name of this DeleteExecutionPlanRequest.

        执行计划的名称。此名字在domain_id+区域+project_id+stack_id下应唯一，可以使用中文、大小写英文、数字、下划线、中划线。首字符需为中文或者英文，区分大小写。

        :return: The execution_plan_name of this DeleteExecutionPlanRequest.
        :rtype: str
        """
    ...
    def execution_plan_name(self, execution_plan_name):
        r"""Sets the execution_plan_name of this DeleteExecutionPlanRequest.

        执行计划的名称。此名字在domain_id+区域+project_id+stack_id下应唯一，可以使用中文、大小写英文、数字、下划线、中划线。首字符需为中文或者英文，区分大小写。

        :param execution_plan_name: The execution_plan_name of this DeleteExecutionPlanRequest.
        :type execution_plan_name: str
        """
    ...
    @property
    def stack_id(self):
        r"""Gets the stack_id of this DeleteExecutionPlanRequest.
    ...
    def stack_id(self, stack_id):
        r"""Sets the stack_id of this DeleteExecutionPlanRequest.
    ...
    def execution_plan_id(self):
        r"""Gets the execution_plan_id of this DeleteExecutionPlanRequest.
    ...
    def execution_plan_id(self, execution_plan_id):
        r"""Sets the execution_plan_id of this DeleteExecutionPlanRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteExecutionPlanRequest):
            return False
