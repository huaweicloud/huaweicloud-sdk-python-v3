...
class GetExecutionPlanMetadataRequest:
    ...
    def __init__(self, client_request_id=None, stack_name=None, execution_plan_name=None, stack_id=None, execution_plan_id=None):
        r"""GetExecutionPlanMetadataRequest
        ...
        :type stack_id: str
        :param execution_plan_id: 执行计划（execution_plan）的唯一ID。  此ID由资源编排服务在生成执行计划的时候生成，为UUID。  由于执行计划名仅仅在同一时间下唯一，即用户允许先生成一个叫HelloWorld的执行计划，删除，再重新创建一个同名执行计划。  对于团队并行开发，用户可能希望确保，当前我操作的执行计划就是我认为的那个，而不是其他队友删除后创建的同名执行计划。因此，使用ID就可以做到强匹配。  资源编排服务保证每次创建的执行计划所对应的ID都不相同，更新不会影响ID。如果给予的execution_plan_id和当前执行计划的ID不一致，则返回400
    ...
    def client_request_id(self):
        r"""Gets the client_request_id of this GetExecutionPlanMetadataRequest.

        用户指定的，对于此请求的唯一ID，用于定位某个请求，推荐使用UUID

        :return: The client_request_id of this GetExecutionPlanMetadataRequest.
        :rtype: str
        """
    ...
    def client_request_id(self, client_request_id):
        r"""Sets the client_request_id of this GetExecutionPlanMetadataRequest.

        用户指定的，对于此请求的唯一ID，用于定位某个请求，推荐使用UUID

        :param client_request_id: The client_request_id of this GetExecutionPlanMetadataRequest.
        :type client_request_id: str
        """
    ...
    @property
    def stack_name(self):
        r"""Gets the stack_name of this GetExecutionPlanMetadataRequest.

        资源栈的名称。此名字在domain_id+区域+project_id下应唯一，可以使用中文、大小写英文、数字、下划线、中划线。首字符需为中文或者英文，区分大小写。

        :return: The stack_name of this GetExecutionPlanMetadataRequest.
        :rtype: str
        """
    ...
    def stack_name(self, stack_name):
        r"""Sets the stack_name of this GetExecutionPlanMetadataRequest.

        资源栈的名称。此名字在domain_id+区域+project_id下应唯一，可以使用中文、大小写英文、数字、下划线、中划线。首字符需为中文或者英文，区分大小写。

        :param stack_name: The stack_name of this GetExecutionPlanMetadataRequest.
        :type stack_name: str
        """
    ...
    def execution_plan_name(self):
        r"""Gets the execution_plan_name of this GetExecutionPlanMetadataRequest.

        执行计划的名称。此名字在domain_id+区域+project_id+stack_id下应唯一，可以使用中文、大小写英文、数字、下划线、中划线。首字符需为中文或者英文，区分大小写。

        :return: The execution_plan_name of this GetExecutionPlanMetadataRequest.
        :rtype: str
        """
    ...
    def execution_plan_name(self, execution_plan_name):
        r"""Sets the execution_plan_name of this GetExecutionPlanMetadataRequest.

        执行计划的名称。此名字在domain_id+区域+project_id+stack_id下应唯一，可以使用中文、大小写英文、数字、下划线、中划线。首字符需为中文或者英文，区分大小写。

        :param execution_plan_name: The execution_plan_name of this GetExecutionPlanMetadataRequest.
        :type execution_plan_name: str
        """
    ...
    @property
    def stack_id(self):
        r"""Gets the stack_id of this GetExecutionPlanMetadataRequest.
    ...
    def stack_id(self, stack_id):
        r"""Sets the stack_id of this GetExecutionPlanMetadataRequest.
    ...
    def execution_plan_id(self):
        r"""Gets the execution_plan_id of this GetExecutionPlanMetadataRequest.
    ...
    def execution_plan_id(self, execution_plan_id):
        r"""Sets the execution_plan_id of this GetExecutionPlanMetadataRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetExecutionPlanMetadataRequest):
            return False
