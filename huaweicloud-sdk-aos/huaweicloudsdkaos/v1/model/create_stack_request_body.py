...
class CreateStackRequestBody:
    ...
    def __init__(self, stack_name=None, executor=None, agencies=None, description=None, enable_deletion_protection=None, enable_auto_rollback=None, template_body=None, template_uri=None, vars_body=None, vars_structure=None, vars_uri=None):
    ...
    @property
    def executor(self):
        """Gets the executor of this CreateStackRequestBody.

        执行操作者的名字，将用做未来的审计工作

        :return: The executor of this CreateStackRequestBody.
        :rtype: str
        """
    ...
    def executor(self, executor):
        """Sets the executor of this CreateStackRequestBody.

        执行操作者的名字，将用做未来的审计工作

        :param executor: The executor of this CreateStackRequestBody.
        :type executor: str
        """
