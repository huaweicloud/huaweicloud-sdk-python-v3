...
class DeployStackSetResponse(SdkResponse):
    ...
    def stack_set_operation_id(self):
        r"""Gets the stack_set_operation_id of this DeployStackSetResponse.

        资源栈集操作（stack_set_operation）的唯一Id。  此ID由资源编排服务在生成资源栈集操作的时候生成，为UUID。

        :return: The stack_set_operation_id of this DeployStackSetResponse.
        :rtype: str
        """
    ...
    def stack_set_operation_id(self, stack_set_operation_id):
        r"""Sets the stack_set_operation_id of this DeployStackSetResponse.

        资源栈集操作（stack_set_operation）的唯一Id。  此ID由资源编排服务在生成资源栈集操作的时候生成，为UUID。

        :param stack_set_operation_id: The stack_set_operation_id of this DeployStackSetResponse.
        :type stack_set_operation_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeployStackSetResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeployStackSetResponse):
            return False
