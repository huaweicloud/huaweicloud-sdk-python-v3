...
class ShowPrivateHookVersionMetadataResponse(SdkResponse):
    ...
    def __init__(self, hook_name=None, hook_id=None, hook_version=None, hook_version_description=None, create_time=None):
        r"""ShowPrivateHookVersionMetadataResponse
    ...
    @property
    def hook_name(self):
        r"""Gets the hook_name of this ShowPrivateHookVersionMetadataResponse.

        私有hook的名字。此名字在domain_id+region下应唯一，可以使用中文、大小写英文、数字、下划线、中划线。首字符需为中文或者英文，区分大小写。

        :return: The hook_name of this ShowPrivateHookVersionMetadataResponse.
        :rtype: str
        """
    ...
    def hook_name(self, hook_name):
        r"""Sets the hook_name of this ShowPrivateHookVersionMetadataResponse.

        私有hook的名字。此名字在domain_id+region下应唯一，可以使用中文、大小写英文、数字、下划线、中划线。首字符需为中文或者英文，区分大小写。

        :param hook_name: The hook_name of this ShowPrivateHookVersionMetadataResponse.
        :type hook_name: str
        """
    ...
    @property
    def hook_id(self):
        r"""Gets the hook_id of this ShowPrivateHookVersionMetadataResponse.
    ...
    def hook_id(self, hook_id):
        r"""Sets the hook_id of this ShowPrivateHookVersionMetadataResponse.
    ...
    def hook_version(self):
        r"""Gets the hook_version of this ShowPrivateHookVersionMetadataResponse.

        私有hook的版本号。版本号必须遵循语义化版本号（Semantic Version），为用户自定义。

        :return: The hook_version of this ShowPrivateHookVersionMetadataResponse.
        :rtype: str
        """
    ...
    def hook_version(self, hook_version):
        r"""Sets the hook_version of this ShowPrivateHookVersionMetadataResponse.

        私有hook的版本号。版本号必须遵循语义化版本号（Semantic Version），为用户自定义。

        :param hook_version: The hook_version of this ShowPrivateHookVersionMetadataResponse.
        :type hook_version: str
        """
    ...
    def hook_version_description(self):
        r"""Gets the hook_version_description of this ShowPrivateHookVersionMetadataResponse.

        私有hook版本的描述。可用于客户识别创建私有hook的版本。注意：hook版本为不可更新（immutable），所以该字段不可更新，如果需要更新，请删除后重建。

        :return: The hook_version_description of this ShowPrivateHookVersionMetadataResponse.
        :rtype: str
        """
    ...
    def hook_version_description(self, hook_version_description):
        r"""Sets the hook_version_description of this ShowPrivateHookVersionMetadataResponse.

        私有hook版本的描述。可用于客户识别创建私有hook的版本。注意：hook版本为不可更新（immutable），所以该字段不可更新，如果需要更新，请删除后重建。

        :param hook_version_description: The hook_version_description of this ShowPrivateHookVersionMetadataResponse.
        :type hook_version_description: str
        """
    ...
    def create_time(self):
        r"""Gets the create_time of this ShowPrivateHookVersionMetadataResponse.

        私有Hook Version（private-hook-version）的生成时间，格式为YYYY-MM-DDTHH:mm:ss.SSSZ，精确到毫秒，UTC时区，即，如1970-01-01T00:00:00.000Z。

        :return: The create_time of this ShowPrivateHookVersionMetadataResponse.
        :rtype: str
        """
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this ShowPrivateHookVersionMetadataResponse.

        私有Hook Version（private-hook-version）的生成时间，格式为YYYY-MM-DDTHH:mm:ss.SSSZ，精确到毫秒，UTC时区，即，如1970-01-01T00:00:00.000Z。

        :param create_time: The create_time of this ShowPrivateHookVersionMetadataResponse.
        :type create_time: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowPrivateHookVersionMetadataResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowPrivateHookVersionMetadataResponse):
            return False
