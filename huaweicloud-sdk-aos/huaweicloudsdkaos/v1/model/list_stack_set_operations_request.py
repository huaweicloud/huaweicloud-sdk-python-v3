...
class ListStackSetOperationsRequest:
    ...
    def __init__(self, client_request_id=None, stack_set_name=None, stack_set_id=None, filter=None, sort_key=None, sort_dir=None):
        ...
        :param stack_set_id: 资源栈集（stack_set）的唯一ID。  此ID由资源编排服务在生成资源栈集的时候生成，为UUID。  由于资源栈集名称仅仅在同一时间下唯一，即用户允许先生成一个叫HelloWorld的资源栈集，删除，再重新创建一个同名资源栈集。  对于团队并行开发，用户可能希望确保，当前我操作的资源栈集就是我认为的那个，而不是其他队友删除后创建的同名资源栈集。因此，使用ID就可以做到强匹配。  资源编排服务保证每次创建的资源栈集所对应的ID都不相同，更新不会影响ID。如果给与的stack_set_id和当前资源栈集的ID不一致，则返回400
        :type stack_set_id: str
        :param filter: 过滤条件  * 与（AND）运算符使用逗号（，）定义 * 或（OR）运算符使用竖线（|）定义，OR运算符优先级高于AND运算符 * 不支持括号 * 过滤运算符仅支持双等号（&#x3D;&#x3D;） * 过滤参数名及其值仅支持包含大小写英文、数字和下划线 * 过滤条件中禁止使用分号，若有分号，则此条过滤会被忽略 * 一个过滤参数仅能与一个与条件相关，一个与条件中的多个或条件仅能与一个过滤参数相关
        :type filter: str
    ...
    def client_request_id(self):
        """Gets the client_request_id of this ListStackSetOperationsRequest.
    ...
    def client_request_id(self, client_request_id):
        """Sets the client_request_id of this ListStackSetOperationsRequest.
    ...
    def stack_set_name(self):
        """Gets the stack_set_name of this ListStackSetOperationsRequest.
    ...
    def stack_set_name(self, stack_set_name):
        """Sets the stack_set_name of this ListStackSetOperationsRequest.
    ...
    def stack_set_id(self):
        """Gets the stack_set_id of this ListStackSetOperationsRequest.
    ...
    def stack_set_id(self, stack_set_id):
        """Sets the stack_set_id of this ListStackSetOperationsRequest.
    ...
    @property
    def filter(self):
        """Gets the filter of this ListStackSetOperationsRequest.
    ...
    def filter(self, filter):
        """Sets the filter of this ListStackSetOperationsRequest.
    ...
    @property
    def sort_key(self):
        """Gets the sort_key of this ListStackSetOperationsRequest.
    ...
    def sort_key(self, sort_key):
        """Sets the sort_key of this ListStackSetOperationsRequest.
    ...
    @property
    def sort_dir(self):
        """Gets the sort_dir of this ListStackSetOperationsRequest.
    ...
    def sort_dir(self, sort_dir):
        """Sets the sort_dir of this ListStackSetOperationsRequest.
