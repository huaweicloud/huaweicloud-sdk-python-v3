...
class UpdateStackSetRequest:
    ...
    def client_request_id(self):
        r"""Gets the client_request_id of this UpdateStackSetRequest.
    ...
    def client_request_id(self, client_request_id):
        r"""Sets the client_request_id of this UpdateStackSetRequest.
    ...
    def stack_set_name(self):
        r"""Gets the stack_set_name of this UpdateStackSetRequest.
    ...
    def stack_set_name(self, stack_set_name):
        r"""Sets the stack_set_name of this UpdateStackSetRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this UpdateStackSetRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this UpdateStackSetRequest.
