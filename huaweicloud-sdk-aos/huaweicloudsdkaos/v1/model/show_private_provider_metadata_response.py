...
class ShowPrivateProviderMetadataResponse(SdkResponse):
    ...
    def __init__(self, provider_id=None, provider_name=None, provider_description=None, provider_source=None, provider_agency_urn=None, provider_agency_name=None, create_time=None, update_time=None):
        r"""ShowPrivateProviderMetadataResponse
    ...
    def provider_id(self):
        r"""Gets the provider_id of this ShowPrivateProviderMetadataResponse.
        ...
        :return: The provider_id of this ShowPrivateProviderMetadataResponse.
        :rtype: str
        """
    ...
    def provider_id(self, provider_id):
        r"""Sets the provider_id of this ShowPrivateProviderMetadataResponse.

        私有provider（private-provider）的唯一Id。  此Id由资源编排服务在生成provider的时候生成，为UUID。  由于私有provider名仅仅在同一时间下唯一，即用户允许先生成一个叫HelloWorld的私有provider，删除，再重新创建一个同名私有provider。  对于团队并行开发，用户可能希望确保，当前我操作的私有provider就是我以为的那个，而不是其他队友删除后创建的同名私有provider。因此，使用Id就可以做到强匹配。  资源编排服务保证每次创建的私有provider所对应的Id都不相同，更新不会影响Id。如果给予的provider_id和当前provider的Id不一致，则返回400

        :param provider_id: The provider_id of this ShowPrivateProviderMetadataResponse.
        :type provider_id: str
        """
    ...
    def provider_name(self):
        r"""Gets the provider_name of this ShowPrivateProviderMetadataResponse.
        ...
        :return: The provider_name of this ShowPrivateProviderMetadataResponse.
        :rtype: str
        """
    ...
    def provider_name(self, provider_name):
        r"""Sets the provider_name of this ShowPrivateProviderMetadataResponse.

        私有provider（private-provider）的名称。此名字在domain_id+region下应唯一，可以使用小写英文、数字、中划线。仅支持以小写英文、数字开头结尾。  按照HCL最佳实践，该名称推荐为在模板中定义的provider的本地名称（local_name）。  创建私有Provider（CreatePrivateProvider）API 还会以 “huawei.com/private-provider”为固定前缀，并以“huawei.com/private-provider/{provider_name}”的形式返回provider_source字段。关于provider_name和provider_source字段在模板中的使用细节，详见创建私有Provider的API描述。

        :param provider_name: The provider_name of this ShowPrivateProviderMetadataResponse.
        :type provider_name: str
        """
    ...
    def provider_description(self):
        r"""Gets the provider_description of this ShowPrivateProviderMetadataResponse.

        私有provider（private-provider）的描述。可用于客户识别被管理的私有provider。

        :return: The provider_description of this ShowPrivateProviderMetadataResponse.
        :rtype: str
        """
    ...
    def provider_description(self, provider_description):
        r"""Sets the provider_description of this ShowPrivateProviderMetadataResponse.

        私有provider（private-provider）的描述。可用于客户识别被管理的私有provider。

        :param provider_description: The provider_description of this ShowPrivateProviderMetadataResponse.
        :type provider_description: str
        """
    ...
    def provider_source(self):
        r"""Gets the provider_source of this ShowPrivateProviderMetadataResponse.
        ...
        :return: The provider_source of this ShowPrivateProviderMetadataResponse.
        :rtype: str
        """
    ...
    def provider_source(self, provider_source):
        r"""Sets the provider_source of this ShowPrivateProviderMetadataResponse.

        用户使用私有provider，在Terraform模板中定义required_providers信息时，需要指明的source参数。  该参数按照“huawei.com/private-provider/{provider_name}”的形式拼接。关于provider_name和provider_source字段在模板中的使用细节，详见创建私有Provider的API描述。

        :param provider_source: The provider_source of this ShowPrivateProviderMetadataResponse.
        :type provider_source: str
        """
    ...
    def provider_agency_urn(self):
        r"""Gets the provider_agency_urn of this ShowPrivateProviderMetadataResponse.

        自定义provider所绑定的IAM委托URN，provider_agency_name和provider_agency_urn最多只能提供一个。

        :return: The provider_agency_urn of this ShowPrivateProviderMetadataResponse.
        :rtype: str
        """
    ...
    def provider_agency_urn(self, provider_agency_urn):
        r"""Sets the provider_agency_urn of this ShowPrivateProviderMetadataResponse.

        自定义provider所绑定的IAM委托URN，provider_agency_name和provider_agency_urn最多只能提供一个。

        :param provider_agency_urn: The provider_agency_urn of this ShowPrivateProviderMetadataResponse.
        :type provider_agency_urn: str
        """
    ...
    def provider_agency_name(self):
        r"""Gets the provider_agency_name of this ShowPrivateProviderMetadataResponse.

        自定义provider所绑定的IAM委托名称，provider_agency_name和provider_agency_urn最多只能提供一个。

        :return: The provider_agency_name of this ShowPrivateProviderMetadataResponse.
        :rtype: str
        """
    ...
    def provider_agency_name(self, provider_agency_name):
        r"""Sets the provider_agency_name of this ShowPrivateProviderMetadataResponse.

        自定义provider所绑定的IAM委托名称，provider_agency_name和provider_agency_urn最多只能提供一个。

        :param provider_agency_name: The provider_agency_name of this ShowPrivateProviderMetadataResponse.
        :type provider_agency_name: str
        """
    ...
    def create_time(self):
        r"""Gets the create_time of this ShowPrivateProviderMetadataResponse.

        私有provider（private-provider）的生成时间，格式为YYYY-MM-DDTHH:mm:ss.SSSZ，精确到毫秒，UTC时区，即，如1970-01-01T00:00:00.000Z。

        :return: The create_time of this ShowPrivateProviderMetadataResponse.
        :rtype: str
        """
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this ShowPrivateProviderMetadataResponse.

        私有provider（private-provider）的生成时间，格式为YYYY-MM-DDTHH:mm:ss.SSSZ，精确到毫秒，UTC时区，即，如1970-01-01T00:00:00.000Z。

        :param create_time: The create_time of this ShowPrivateProviderMetadataResponse.
        :type create_time: str
        """
    ...
    def update_time(self):
        r"""Gets the update_time of this ShowPrivateProviderMetadataResponse.

        私有provider（private-provider）的更新时间，格式为YYYY-MM-DDTHH:mm:ss.SSSZ，精确到毫秒，UTC时区，即，如1970-01-01T00:00:00.000Z。

        :return: The update_time of this ShowPrivateProviderMetadataResponse.
        :rtype: str
        """
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this ShowPrivateProviderMetadataResponse.

        私有provider（private-provider）的更新时间，格式为YYYY-MM-DDTHH:mm:ss.SSSZ，精确到毫秒，UTC时区，即，如1970-01-01T00:00:00.000Z。

        :param update_time: The update_time of this ShowPrivateProviderMetadataResponse.
        :type update_time: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowPrivateProviderMetadataResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowPrivateProviderMetadataResponse):
            return False
