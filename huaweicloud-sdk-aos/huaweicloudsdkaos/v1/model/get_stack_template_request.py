...
class GetStackTemplateRequest:
    ...
    @property
    def executor(self):
        """Gets the executor of this GetStackTemplateRequest.

        执行操作者的名字，将用做未来的审计工作。

        :return: The executor of this GetStackTemplateRequest.
        :rtype: str
        """
    ...
    def executor(self, executor):
        """Sets the executor of this GetStackTemplateRequest.

        执行操作者的名字，将用做未来的审计工作。

        :param executor: The executor of this GetStackTemplateRequest.
        :type executor: str
        """
