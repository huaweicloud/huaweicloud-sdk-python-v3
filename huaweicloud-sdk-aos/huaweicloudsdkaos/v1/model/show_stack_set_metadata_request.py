...
class ShowStackSetMetadataRequest:
    ...
    def client_request_id(self):
        r"""Gets the client_request_id of this ShowStackSetMetadataRequest.
    ...
    def client_request_id(self, client_request_id):
        r"""Sets the client_request_id of this ShowStackSetMetadataRequest.
    ...
    def stack_set_name(self):
        r"""Gets the stack_set_name of this ShowStackSetMetadataRequest.
    ...
    def stack_set_name(self, stack_set_name):
        r"""Sets the stack_set_name of this ShowStackSetMetadataRequest.
    ...
    def stack_set_id(self):
        r"""Gets the stack_set_id of this ShowStackSetMetadataRequest.
    ...
    def stack_set_id(self, stack_set_id):
        r"""Sets the stack_set_id of this ShowStackSetMetadataRequest.
    ...
    def call_identity(self):
        r"""Gets the call_identity of this ShowStackSetMetadataRequest.
        ...
        :return: The call_identity of this ShowStackSetMetadataRequest.
        :rtype: str
        """
    ...
    def call_identity(self, call_identity):
        r"""Sets the call_identity of this ShowStackSetMetadataRequest.

        仅支持资源栈集权限模式为SERVICE_MANAGED时指定该参数。用于指定用户是以组织管理账号还是成员账号中的服务委托管理员身份调用资源栈集。默认为SELF。 * 无论指定何种用户身份，创建或部署的资源栈集始终在组织管理账号名下。*   * `SELF` - 以组织管理账号身份调用。   * `DELEGATED_ADMIN` - 以服务委托管理员身份调用。用户的华为云账号必须在组织中已经被注册为”资源编排资源栈集服务“的委托管理员。

        :param call_identity: The call_identity of this ShowStackSetMetadataRequest.
        :type call_identity: str
        """
