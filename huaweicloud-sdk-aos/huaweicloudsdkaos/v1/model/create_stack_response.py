...
class CreateStackResponse(SdkResponse):
    ...
    @property
    def stack_id(self):
        r"""Gets the stack_id of this CreateStackResponse.
    ...
    def stack_id(self, stack_id):
        r"""Sets the stack_id of this CreateStackResponse.
    ...
    def deployment_id(self):
        r"""Gets the deployment_id of this CreateStackResponse.
        ...
        :return: The deployment_id of this CreateStackResponse.
        :rtype: str
        """
    ...
    def deployment_id(self, deployment_id):
        r"""Sets the deployment_id of this CreateStackResponse.

        部署ID 接受请求，进行异步处理。可以调用GetStackMetadata来获取异步请求的部署状态  **注意：** * 部署资源栈后，资源编排服务持久化请求并立即返回，客户端不等待请求最终处理完成，用户无法实时感知请求处理结果 * 资源编排服务最终会将异步部署请求排队，在服务端空闲的情况下逐个处理。用户最大等待时长为6小时

        :param deployment_id: The deployment_id of this CreateStackResponse.
        :type deployment_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateStackResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateStackResponse):
            return False
