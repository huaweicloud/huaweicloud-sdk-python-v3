...
from huaweicloudsdkaos.v1.model.deployment_targets_primitive_type_holder_deployment_targets import DeploymentTargetsPrimitiveTypeHolderDeploymentTargets
