...
class UpdatePredefineTagsRequest:
    ...
    @property
    def body(self):
        r"""Gets the body of this UpdatePredefineTagsRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this UpdatePredefineTagsRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdatePredefineTagsRequest):
            return False
