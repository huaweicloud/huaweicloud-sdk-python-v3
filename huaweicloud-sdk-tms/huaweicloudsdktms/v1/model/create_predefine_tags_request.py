...
class CreatePredefineTagsRequest:
    ...
    def __init__(self, body=None):
        """CreatePredefineTagsRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreatePredefineTagsRequest):
            return False
