...
class DeletePredefineTagsRequest:
    ...
    def __init__(self, body=None):
        """DeletePredefineTagsRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeletePredefineTagsRequest):
            return False
