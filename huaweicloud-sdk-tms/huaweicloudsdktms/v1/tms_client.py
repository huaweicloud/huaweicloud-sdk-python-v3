...
class TmsClient(Client):
    ...
    def change_associated_resource_open_status(self, request):
        r"""开通或关闭关联资源标签继承能力
    ...
    def change_associated_resource_open_status_invoker(self, request):
        http_info = self._change_associated_resource_open_status_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _change_associated_resource_open_status_http_info(cls, request):
        http_info = {
            "method": "PUT",
    ...
    def create_associated_resource_rules(self, request):
        r"""批量启用规则
    ...
    def create_associated_resource_rules_invoker(self, request):
        http_info = self._create_associated_resource_rules_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_associated_resource_rules_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def delete_associated_resource_rule(self, request):
        r"""关闭规则
    ...
    def delete_associated_resource_rule_invoker(self, request):
        http_info = self._delete_associated_resource_rule_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_associated_resource_rule_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_associated_resource_rules(self, request):
        r"""查询当前规则列表
    ...
    def list_associated_resource_rules_invoker(self, request):
        http_info = self._list_associated_resource_rules_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_associated_resource_rules_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_associated_resource_settings(self, request):
        r"""查询当前规则的配置列表
    ...
    def list_associated_resource_settings_invoker(self, request):
        http_info = self._list_associated_resource_settings_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_associated_resource_settings_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_tags(self, request):
        ...
        :type request: :class:`huaweicloudsdktms.v1.ListTagsRequest`
        :rtype: :class:`huaweicloudsdktms.v1.ListTagsResponse`
        """
    ...
    def _list_tags_http_info(cls, request):
        ...
        query_params = []
        if 'resource_types' in local_var_params:
            query_params.append(('resource_types', local_var_params['resource_types']))
        if 'project_id' in local_var_params:
            query_params.append(('project_id', local_var_params['project_id']))
        if 'tag_types' in local_var_params:
            query_params.append(('tag_types', local_var_params['tag_types']))
    ...
    def show_associated_resource_open_status(self, request):
    ...
    def show_associated_resource_open_status_invoker(self, request):
        http_info = self._show_associated_resource_open_status_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_associated_resource_open_status_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v2/tms/associated-resources/status",
            "request_type": request.__class__.__name__,
    ...
    def update_associated_resource_rules(self, request):
        r"""更新规则
    ...
    def update_associated_resource_rules_invoker(self, request):
        http_info = self._update_associated_resource_rules_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_associated_resource_rules_http_info(cls, request):
        http_info = {
            "method": "PUT",
