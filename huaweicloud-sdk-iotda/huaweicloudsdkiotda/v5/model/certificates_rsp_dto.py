...
class CertificatesRspDTO:
    ...
    def ocsp_enable(self, ocsp_enable):
        r"""Sets the ocsp_enable of this CertificatesRspDTO.

        是否开启该CA证书下的设备证书OCSP校验，当为true且设备证书信息中包含OCSP url时则平台会校验证书的状态，当证书状态为revoked时平台会拒绝设备连接，true：开启，false：关闭。

        :param ocsp_enable: The ocsp_enable of this CertificatesRspDTO.
        :type ocsp_enable: bool
        """
    ...
    def ocsp_server_ca_id(self):
        r"""Gets the ocsp_server_ca_id of this CertificatesRspDTO.

        ocsp服务器端CA证书id，仅当ocsp服务器开启SSL时配置，平台使用该CA证书认证ocsp服务器。

        :return: The ocsp_server_ca_id of this CertificatesRspDTO.
        :rtype: str
        """
    ...
    def ocsp_server_ca_id(self, ocsp_server_ca_id):
        r"""Sets the ocsp_server_ca_id of this CertificatesRspDTO.

        ocsp服务器端CA证书id，仅当ocsp服务器开启SSL时配置，平台使用该CA证书认证ocsp服务器。

        :param ocsp_server_ca_id: The ocsp_server_ca_id of this CertificatesRspDTO.
        :type ocsp_server_ca_id: str
        """
    ...
    def ocsp_ssl_enable(self):
        r"""Gets the ocsp_ssl_enable of this CertificatesRspDTO.

        ocsp服务器是否开启SSL加密，开启后必须配置OCSP服务器CA证书。

        :return: The ocsp_ssl_enable of this CertificatesRspDTO.
        :rtype: bool
        """
    ...
    def ocsp_ssl_enable(self, ocsp_ssl_enable):
        r"""Sets the ocsp_ssl_enable of this CertificatesRspDTO.

        ocsp服务器是否开启SSL加密，开启后必须配置OCSP服务器CA证书。

        :param ocsp_ssl_enable: The ocsp_ssl_enable of this CertificatesRspDTO.
        :type ocsp_ssl_enable: bool
        """
