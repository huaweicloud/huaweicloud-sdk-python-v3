...
class ShowCertificateRequest:
    ...
    def sp_auth_token(self):
        r"""Gets the sp_auth_token of this ShowCertificateRequest.

        Sp用户Token。通过调用IoBPS服务获取SP用户Token

        :return: The sp_auth_token of this ShowCertificateRequest.
        :rtype: str
        """
    ...
    def sp_auth_token(self, sp_auth_token):
        r"""Sets the sp_auth_token of this ShowCertificateRequest.

        Sp用户Token。通过调用IoBPS服务获取SP用户Token

        :param sp_auth_token: The sp_auth_token of this ShowCertificateRequest.
        :type sp_auth_token: str
        """
    ...
    def stage_auth_token(self):
        r"""Gets the stage_auth_token of this ShowCertificateRequest.

        Stage用户的Token, 仅提供给IoStage服务使用

        :return: The stage_auth_token of this ShowCertificateRequest.
        :rtype: str
        """
    ...
    def stage_auth_token(self, stage_auth_token):
        r"""Sets the stage_auth_token of this ShowCertificateRequest.

        Stage用户的Token, 仅提供给IoStage服务使用

        :param stage_auth_token: The stage_auth_token of this ShowCertificateRequest.
        :type stage_auth_token: str
        """
    ...
    def instance_id(self):
        r"""Gets the instance_id of this ShowCertificateRequest.

        实例ID。物理多租下各实例的唯一标识，一般华为云租户无需携带该参数，仅在物理多租场景下从管理面访问API时需要携带该参数。

        :return: The instance_id of this ShowCertificateRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this ShowCertificateRequest.

        实例ID。物理多租下各实例的唯一标识，一般华为云租户无需携带该参数，仅在物理多租场景下从管理面访问API时需要携带该参数。

        :param instance_id: The instance_id of this ShowCertificateRequest.
        :type instance_id: str
        """
