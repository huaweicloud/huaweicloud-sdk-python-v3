...
class ShowDeviceProxyResponse(SdkResponse):
    ...
    def proxy_id(self):
        ...
        **参数说明**：代理ID。用来唯一标识一个代理规则
        ...
        :return: The proxy_id of this ShowDeviceProxyResponse.
        :rtype: str
        """
    ...
    def proxy_id(self, proxy_id):
        ...
        **参数说明**：代理ID。用来唯一标识一个代理规则
        ...
        :param proxy_id: The proxy_id of this ShowDeviceProxyResponse.
        :type proxy_id: str
        """
    ...
    def proxy_name(self):
        ...
        **参数说明**：设备代理名称
        ...
        :return: The proxy_name of this ShowDeviceProxyResponse.
        :rtype: str
        """
    ...
    def proxy_name(self, proxy_name):
        ...
        **参数说明**：设备代理名称
        ...
        :param proxy_name: The proxy_name of this ShowDeviceProxyResponse.
        :type proxy_name: str
        """
    ...
    def proxy_devices(self):
        ...
        **参数说明**：代理设备组，组内所有设备共享网关权限，即组内任意一个网关下的子设备可以通过组里任意一个网关上线然后进行数据上报。
        ...
        :return: The proxy_devices of this ShowDeviceProxyResponse.
        :rtype: list[str]
        """
    ...
    def proxy_devices(self, proxy_devices):
        ...
        **参数说明**：代理设备组，组内所有设备共享网关权限，即组内任意一个网关下的子设备可以通过组里任意一个网关上线然后进行数据上报。
        ...
        :param proxy_devices: The proxy_devices of this ShowDeviceProxyResponse.
        :type proxy_devices: list[str]
        """
    ...
    def app_id(self):
        ...
        **参数说明**：资源空间ID。
        ...
        :return: The app_id of this ShowDeviceProxyResponse.
        :rtype: str
        """
        return self._app_id
    ...
    def app_id(self, app_id):
        ...
        **参数说明**：资源空间ID。
        ...
        :param app_id: The app_id of this ShowDeviceProxyResponse.
        :type app_id: str
        """
        self._app_id = app_id
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowDeviceProxyResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowDeviceProxyResponse):
            return False
