...
class CreateRoutingFlowControlPolicyRequest:
    ...
    def __init__(self, instance_id=None, body=None):
        ...
        :param body: Body of the CreateRoutingFlowControlPolicyRequest
    ...
    def instance_id(self):
        ...
        **参数说明**：实例ID。物理多租下各实例的唯一标识，一般华为云租户无需携带该参数，仅在物理多租场景下从管理面访问API时需要携带该参数。您可以在IoTDA管理控制台界面，选择左侧导航栏“总览”页签查看当前实例的ID。
        ...
        :return: The instance_id of this CreateRoutingFlowControlPolicyRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        ...
        **参数说明**：实例ID。物理多租下各实例的唯一标识，一般华为云租户无需携带该参数，仅在物理多租场景下从管理面访问API时需要携带该参数。您可以在IoTDA管理控制台界面，选择左侧导航栏“总览”页签查看当前实例的ID。
        ...
        :param instance_id: The instance_id of this CreateRoutingFlowControlPolicyRequest.
        :type instance_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateRoutingFlowControlPolicyRequest):
            return False
