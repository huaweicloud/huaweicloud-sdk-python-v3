...
class UpdateBacklogPolicy:
    ...
    def policy_name(self):
        ...
        **参数说明**：数据流转积压策略名称。 **取值范围**：长度不超过256，只允许中文、字母、数字、以及_?'#().,&%@!-等字符的组合。
        ...
        :return: The policy_name of this UpdateBacklogPolicy.
        :rtype: str
        """
    ...
    def policy_name(self, policy_name):
        ...
        **参数说明**：数据流转积压策略名称。 **取值范围**：长度不超过256，只允许中文、字母、数字、以及_?'#().,&%@!-等字符的组合。
        ...
        :param policy_name: The policy_name of this UpdateBacklogPolicy.
        :type policy_name: str
        """
    ...
    def description(self):
        ...
        **参数说明**：用户自定义的数据流转积压策略描述。 **取值范围**：长度不超过256，只允许中文、字母、数字、以及_?'#().,&%@!-等字符的组合。
        ...
        :return: The description of this UpdateBacklogPolicy.
        :rtype: str
        """
    ...
    def description(self, description):
        ...
        **参数说明**：用户自定义的数据流转积压策略描述。 **取值范围**：长度不超过256，只允许中文、字母、数字、以及_?'#().,&%@!-等字符的组合。
        ...
        :param description: The description of this UpdateBacklogPolicy.
        :type description: str
        """
    ...
    def backlog_size(self):
        ...
        **参数说明**：数据积压大小。单位为B（字节），取值范围为0~1073741823的整数，默认为1073741823（即1GB）。当backlog_size为0时，表示不积压。若同时配置了backlog_size和backlog_time两个维度，则以最先达到阈值的维度为准。
        ...
        :return: The backlog_size of this UpdateBacklogPolicy.
        :rtype: int
        """
    ...
    def backlog_size(self, backlog_size):
        ...
        **参数说明**：数据积压大小。单位为B（字节），取值范围为0~1073741823的整数，默认为1073741823（即1GB）。当backlog_size为0时，表示不积压。若同时配置了backlog_size和backlog_time两个维度，则以最先达到阈值的维度为准。
        ...
        :param backlog_size: The backlog_size of this UpdateBacklogPolicy.
        :type backlog_size: int
        """
    ...
    def backlog_time(self):
        ...
        **参数说明**：数据积压时间。单位为s（秒），取值范围为0~86399的整数，默认为86399（即1天）。当backlog_time为0时，表示不积压。若同时配置了backlog_size和backlog_time两个维度，则以最先达到阈值的维度为准。
        ...
        :return: The backlog_time of this UpdateBacklogPolicy.
        :rtype: int
        """
    ...
    def backlog_time(self, backlog_time):
        ...
        **参数说明**：数据积压时间。单位为s（秒），取值范围为0~86399的整数，默认为86399（即1天）。当backlog_time为0时，表示不积压。若同时配置了backlog_size和backlog_time两个维度，则以最先达到阈值的维度为准。
        ...
        :param backlog_time: The backlog_time of this UpdateBacklogPolicy.
        :type backlog_time: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateBacklogPolicy):
            return False
