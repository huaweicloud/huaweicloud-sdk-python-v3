...
class UpdateDeviceShadowDesiredDataRequest:
    ...
    def __init__(self, instance_id=None, device_id=None, body=None):
        r"""UpdateDeviceShadowDesiredDataRequest
        ...
        :type device_id: str
        :param body: Body of the UpdateDeviceShadowDesiredDataRequest
        :type body: :class:`huaweicloudsdkiotda.v5.UpdateDesireds`
        """
    ...
    def instance_id(self):
        r"""Gets the instance_id of this UpdateDeviceShadowDesiredDataRequest.
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this UpdateDeviceShadowDesiredDataRequest.
    ...
    @property
    def device_id(self):
        r"""Gets the device_id of this UpdateDeviceShadowDesiredDataRequest.
    ...
    def device_id(self, device_id):
        r"""Sets the device_id of this UpdateDeviceShadowDesiredDataRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this UpdateDeviceShadowDesiredDataRequest.

        :return: The body of this UpdateDeviceShadowDesiredDataRequest.
        :rtype: :class:`huaweicloudsdkiotda.v5.UpdateDesireds`
        """
        return self._body

    @body.setter
    def body(self, body):
        r"""Sets the body of this UpdateDeviceShadowDesiredDataRequest.
