...
class AddDeviceResponse(SdkResponse):
    ...
    @property
    def app_id(self):
        r"""Gets the app_id of this AddDeviceResponse.
    ...
    def app_id(self, app_id):
        r"""Sets the app_id of this AddDeviceResponse.
    ...
    @property
    def app_name(self):
        r"""Gets the app_name of this AddDeviceResponse.
    ...
    def app_name(self, app_name):
        r"""Sets the app_name of this AddDeviceResponse.
    ...
    @property
    def node_id(self):
        r"""Gets the node_id of this AddDeviceResponse.
    ...
    def node_id(self, node_id):
        r"""Sets the node_id of this AddDeviceResponse.
    ...
    @property
    def gateway_id(self):
        r"""Gets the gateway_id of this AddDeviceResponse.
    ...
    def gateway_id(self, gateway_id):
        r"""Sets the gateway_id of this AddDeviceResponse.
    ...
    def device_name(self):
        r"""Gets the device_name of this AddDeviceResponse.
    ...
    def device_name(self, device_name):
        r"""Sets the device_name of this AddDeviceResponse.
    ...
    @property
    def node_type(self):
        r"""Gets the node_type of this AddDeviceResponse.
    ...
    def node_type(self, node_type):
        r"""Sets the node_type of this AddDeviceResponse.
    ...
    def description(self):
        r"""Gets the description of this AddDeviceResponse.
    ...
    def description(self, description):
        r"""Sets the description of this AddDeviceResponse.
    ...
    @property
    def fw_version(self):
        r"""Gets the fw_version of this AddDeviceResponse.
    ...
    def fw_version(self, fw_version):
        r"""Sets the fw_version of this AddDeviceResponse.
    ...
    @property
    def sw_version(self):
        r"""Gets the sw_version of this AddDeviceResponse.
    ...
    def sw_version(self, sw_version):
        r"""Sets the sw_version of this AddDeviceResponse.
    ...
    def device_sdk_version(self):
        r"""Gets the device_sdk_version of this AddDeviceResponse.
    ...
    def device_sdk_version(self, device_sdk_version):
        r"""Sets the device_sdk_version of this AddDeviceResponse.
    ...
    @property
    def auth_info(self):
        r"""Gets the auth_info of this AddDeviceResponse.
    ...
    def auth_info(self, auth_info):
        r"""Sets the auth_info of this AddDeviceResponse.
    ...
    @property
    def product_id(self):
        r"""Gets the product_id of this AddDeviceResponse.
    ...
    def product_id(self, product_id):
        r"""Sets the product_id of this AddDeviceResponse.
    ...
    def product_name(self):
        r"""Gets the product_name of this AddDeviceResponse.
    ...
    def product_name(self, product_name):
        r"""Sets the product_name of this AddDeviceResponse.
    ...
    @property
    def status(self):
        r"""Gets the status of this AddDeviceResponse.
    ...
    def status(self, status):
        r"""Sets the status of this AddDeviceResponse.
    ...
    def create_time(self):
        r"""Gets the create_time of this AddDeviceResponse.
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this AddDeviceResponse.
    ...
    def connection_status_update_time(self):
        r"""Gets the connection_status_update_time of this AddDeviceResponse.

        设备最近一次连接状态(ONLINE:在线，OFFLINE：离线，ABNORMAL：异常)变化时间。格式：yyyy-MM-dd'T'HH:mm:ss.SSS'Z' ，如2015-12-12T12:12:122Z。

        :return: The connection_status_update_time of this AddDeviceResponse.
        :rtype: str
        """
    ...
    def connection_status_update_time(self, connection_status_update_time):
        r"""Sets the connection_status_update_time of this AddDeviceResponse.

        设备最近一次连接状态(ONLINE:在线，OFFLINE：离线，ABNORMAL：异常)变化时间。格式：yyyy-MM-dd'T'HH:mm:ss.SSS'Z' ，如2015-12-12T12:12:122Z。

        :param connection_status_update_time: The connection_status_update_time of this AddDeviceResponse.
        :type connection_status_update_time: str
        """
    ...
    def active_time(self):
        r"""Gets the active_time of this AddDeviceResponse.

        设备激活时间。格式：yyyy-MM-dd'T'HH:mm:ss.SSS'Z' ，如2015-12-12T12:12:122Z。

        :return: The active_time of this AddDeviceResponse.
        :rtype: str
        """
    ...
    def active_time(self, active_time):
        r"""Sets the active_time of this AddDeviceResponse.

        设备激活时间。格式：yyyy-MM-dd'T'HH:mm:ss.SSS'Z' ，如2015-12-12T12:12:122Z。

        :param active_time: The active_time of this AddDeviceResponse.
        :type active_time: str
        """
    ...
    @property
    def tags(self):
        r"""Gets the tags of this AddDeviceResponse.
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this AddDeviceResponse.
    ...
    def extension_info(self):
        r"""Gets the extension_info of this AddDeviceResponse.
    ...
    def extension_info(self, extension_info):
        r"""Sets the extension_info of this AddDeviceResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("AddDeviceResponse.to_dict() is deprecated and no longer maintained, "
