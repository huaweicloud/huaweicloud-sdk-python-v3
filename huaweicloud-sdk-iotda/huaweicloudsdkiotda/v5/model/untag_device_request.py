...
class UntagDeviceRequest:
    ...
    def instance_id(self):
        r"""Gets the instance_id of this UntagDeviceRequest.
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this UntagDeviceRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this UntagDeviceRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this UntagDeviceRequest.
