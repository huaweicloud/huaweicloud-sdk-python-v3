...
class TagDeviceRequest:
    ...
    def __init__(self, instance_id=None, body=None):
        ...
        :param body: Body of the TagDeviceRequest
    ...
    def instance_id(self):
        r"""Gets the instance_id of this TagDeviceRequest.
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this TagDeviceRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this TagDeviceRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this TagDeviceRequest.
