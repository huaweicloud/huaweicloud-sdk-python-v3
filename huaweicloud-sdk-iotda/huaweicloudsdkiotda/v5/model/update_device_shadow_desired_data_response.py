...
class UpdateDeviceShadowDesiredDataResponse(SdkResponse):
    ...
    def __init__(self, device_id=None, shadow=None):
        r"""UpdateDeviceShadowDesiredDataResponse
    ...
    @property
    def device_id(self):
        r"""Gets the device_id of this UpdateDeviceShadowDesiredDataResponse.

        设备ID，用于唯一标识一个设备。在注册设备时直接指定，或者由物联网平台分配获得。由物联网平台分配时，生成规则为\"product_id\" + \"_\" + \"node_id\"拼接而成。

        :return: The device_id of this UpdateDeviceShadowDesiredDataResponse.
        :rtype: str
        """
    ...
    def device_id(self, device_id):
        r"""Sets the device_id of this UpdateDeviceShadowDesiredDataResponse.
    ...
    @property
    def shadow(self):
        r"""Gets the shadow of this UpdateDeviceShadowDesiredDataResponse.
    ...
    def shadow(self, shadow):
        r"""Sets the shadow of this UpdateDeviceShadowDesiredDataResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateDeviceShadowDesiredDataResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateDeviceShadowDesiredDataResponse):
            return False
