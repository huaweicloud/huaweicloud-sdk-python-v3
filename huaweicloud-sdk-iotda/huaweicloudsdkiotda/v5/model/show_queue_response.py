...
class ShowQueueResponse(SdkResponse):
    ...
    def last_modify_time(self):
        r"""Gets the last_modify_time of this ShowQueueResponse.

        在物联网平台最后修改队列的时间。格式：yyyyMMdd'T'HHmmss'Z'，如20151212T121212Z。

        :return: The last_modify_time of this ShowQueueResponse.
        :rtype: str
        """
    ...
    def last_modify_time(self, last_modify_time):
        r"""Sets the last_modify_time of this ShowQueueResponse.
