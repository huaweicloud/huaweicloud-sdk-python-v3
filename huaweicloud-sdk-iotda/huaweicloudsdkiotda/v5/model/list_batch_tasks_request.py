...
class ListBatchTasksRequest:
    ...
    def __init__(self, instance_id=None, app_id=None, task_type=None, status=None, limit=None, marker=None, offset=None):
        ...
        :type app_id: str
        :param task_type: **参数说明**：批量任务类型。 **取值范围**： - softwareUpgrade: 软件升级任务 - firmwareUpgrade: 固件升级任务 - moduleUpgrade: 模块升级任务 - createDevices: 批量创建设备任务 - deleteDevices: 批量删除设备任务 - freezeDevices: 批量冻结设备任务 - unfreezeDevices: 批量解冻设备任务 - createCommands: 批量创建同步命令任务 - createAsyncCommands: 批量创建异步命令任务 - createMessages: 批量创建消息任务 - updateDeviceShadows：批量配置设备影子任务 - updateDevices：批量更新设备任务
        :type task_type: str
        :param status: **参数说明**：批量任务的状态，可选参数。 **取值范围**： - Initializing: 初始化中。 - Waitting: 等待中。 - Processing: 执行中。 - Success: 成功。 - Fail: 失败。 - PartialSuccess: 部分成功。 - Stopped: 停止。 - Stopping: 停止中。
        :type status: str
    ...
    def instance_id(self):
        r"""Gets the instance_id of this ListBatchTasksRequest.
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this ListBatchTasksRequest.
    ...
    @property
    def app_id(self):
        r"""Gets the app_id of this ListBatchTasksRequest.
    ...
    def app_id(self, app_id):
        r"""Sets the app_id of this ListBatchTasksRequest.
    ...
    @property
    def task_type(self):
        r"""Gets the task_type of this ListBatchTasksRequest.
    ...
    def task_type(self, task_type):
        r"""Sets the task_type of this ListBatchTasksRequest.
    ...
    @property
    def status(self):
        r"""Gets the status of this ListBatchTasksRequest.
    ...
    def status(self, status):
        r"""Sets the status of this ListBatchTasksRequest.
    ...
    @property
    def limit(self):
        r"""Gets the limit of this ListBatchTasksRequest.
    ...
    def limit(self, limit):
        r"""Sets the limit of this ListBatchTasksRequest.
    ...
    @property
    def marker(self):
        r"""Gets the marker of this ListBatchTasksRequest.
    ...
    def marker(self, marker):
        r"""Sets the marker of this ListBatchTasksRequest.
    ...
    @property
    def offset(self):
        r"""Gets the offset of this ListBatchTasksRequest.
    ...
    def offset(self, offset):
        r"""Sets the offset of this ListBatchTasksRequest.
