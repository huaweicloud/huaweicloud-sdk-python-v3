...
class ShowOtaPackageResponse(SdkResponse):
    ...
    @property
    def package_id(self):
        r"""Gets the package_id of this ShowOtaPackageResponse.
    ...
    def package_id(self, package_id):
        r"""Sets the package_id of this ShowOtaPackageResponse.
    ...
    @property
    def app_id(self):
        r"""Gets the app_id of this ShowOtaPackageResponse.
    ...
    def app_id(self, app_id):
        r"""Sets the app_id of this ShowOtaPackageResponse.
    ...
    def package_type(self):
        r"""Gets the package_type of this ShowOtaPackageResponse.
    ...
    def package_type(self, package_type):
        r"""Sets the package_type of this ShowOtaPackageResponse.
    ...
    @property
    def product_id(self):
        r"""Gets the product_id of this ShowOtaPackageResponse.
    ...
    def product_id(self, product_id):
        r"""Sets the product_id of this ShowOtaPackageResponse.
    ...
    def product_name(self):
        r"""Gets the product_name of this ShowOtaPackageResponse.

        设备关联的产品名称

        :return: The product_name of this ShowOtaPackageResponse.
        :rtype: str
        """
    ...
    def product_name(self, product_name):
        r"""Sets the product_name of this ShowOtaPackageResponse.

        设备关联的产品名称

        :param product_name: The product_name of this ShowOtaPackageResponse.
        :type product_name: str
        """
    ...
    def module_name(self):
        r"""Gets the module_name of this ShowOtaPackageResponse.

        **参数说明**：OTA模块名称，产品下唯一且不可修改。 **取值范围**：长度不超过64，号只允许字母、数字、下划线（_）、连接符（-）、英文点（.）的组合。

        :return: The module_name of this ShowOtaPackageResponse.
        :rtype: str
        """
    ...
    def module_name(self, module_name):
        r"""Sets the module_name of this ShowOtaPackageResponse.

        **参数说明**：OTA模块名称，产品下唯一且不可修改。 **取值范围**：长度不超过64，号只允许字母、数字、下划线（_）、连接符（-）、英文点（.）的组合。

        :param module_name: The module_name of this ShowOtaPackageResponse.
        :type module_name: str
        """
    ...
    @property
    def version(self):
        r"""Gets the version of this ShowOtaPackageResponse.
    ...
    def version(self, version):
        r"""Sets the version of this ShowOtaPackageResponse.
    ...
    def support_source_versions(self):
        r"""Gets the support_source_versions of this ShowOtaPackageResponse.
    ...
    def support_source_versions(self, support_source_versions):
        r"""Sets the support_source_versions of this ShowOtaPackageResponse.
    ...
    def description(self):
        r"""Gets the description of this ShowOtaPackageResponse.
    ...
    def description(self, description):
        r"""Sets the description of this ShowOtaPackageResponse.
    ...
    def custom_info(self):
        r"""Gets the custom_info of this ShowOtaPackageResponse.
    ...
    def custom_info(self, custom_info):
        r"""Sets the custom_info of this ShowOtaPackageResponse.
    ...
    def create_time(self):
        r"""Gets the create_time of this ShowOtaPackageResponse.
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this ShowOtaPackageResponse.
    ...
    def file_location(self):
        r"""Gets the file_location of this ShowOtaPackageResponse.
    ...
    def file_location(self, file_location):
        r"""Sets the file_location of this ShowOtaPackageResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowOtaPackageResponse.to_dict() is deprecated and no longer maintained, "
