...
class CreateProvisioningTemplateRequest:
    ...
    def instance_id(self, instance_id):
        """Sets the instance_id of this CreateProvisioningTemplateRequest.
    ...
    @property
    def body(self):
        """Gets the body of this CreateProvisioningTemplateRequest.
    ...
    @body.setter
    def body(self, body):
        """Sets the body of this CreateProvisioningTemplateRequest.
