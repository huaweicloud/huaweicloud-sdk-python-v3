...
class CreateRuleResponse(SdkResponse):
    ...
    @property
    def name(self):
        r"""Gets the name of this CreateRuleResponse.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this CreateRuleResponse.
    ...
    def description(self):
        r"""Gets the description of this CreateRuleResponse.
    ...
    def description(self, description):
        r"""Sets the description of this CreateRuleResponse.
    ...
    def condition_group(self):
        r"""Gets the condition_group of this CreateRuleResponse.

        :return: The condition_group of this CreateRuleResponse.
    ...
    def condition_group(self, condition_group):
        r"""Sets the condition_group of this CreateRuleResponse.

        :param condition_group: The condition_group of this CreateRuleResponse.
        :type condition_group: :class:`huaweicloudsdkiotda.v5.ConditionGroup`
        """
    ...
    @property
    def actions(self):
        r"""Gets the actions of this CreateRuleResponse.

        规则的动作列表，单个规则最多支持设置10个动作。

        :return: The actions of this CreateRuleResponse.
    ...
    def actions(self, actions):
        r"""Sets the actions of this CreateRuleResponse.

        规则的动作列表，单个规则最多支持设置10个动作。

        :param actions: The actions of this CreateRuleResponse.
        :type actions: list[:class:`huaweicloudsdkiotda.v5.RuleAction`]
        """
    ...
    @property
    def rule_type(self):
        r"""Gets the rule_type of this CreateRuleResponse.

        规则的类型 - DEVICE_LINKAGE：云端联动规则。 - DEVICE_SIDE：端侧规则。

        :return: The rule_type of this CreateRuleResponse.
        :rtype: str
        """
    ...
    def rule_type(self, rule_type):
        r"""Sets the rule_type of this CreateRuleResponse.

        规则的类型 - DEVICE_LINKAGE：云端联动规则。 - DEVICE_SIDE：端侧规则。

        :param rule_type: The rule_type of this CreateRuleResponse.
        :type rule_type: str
        """
    ...
    @property
    def app_id(self):
        r"""Gets the app_id of this CreateRuleResponse.
    ...
    def app_id(self, app_id):
        r"""Sets the app_id of this CreateRuleResponse.
    ...
    def edge_node_ids(self):
        r"""Gets the edge_node_ids of this CreateRuleResponse.

        归属边缘侧节点设备ID列表。

        :return: The edge_node_ids of this CreateRuleResponse.
        :rtype: list[str]
        """
    ...
    def edge_node_ids(self, edge_node_ids):
        r"""Sets the edge_node_ids of this CreateRuleResponse.

        归属边缘侧节点设备ID列表。

        :param edge_node_ids: The edge_node_ids of this CreateRuleResponse.
        :type edge_node_ids: list[str]
        """
    ...
    def last_update_time(self):
        r"""Gets the last_update_time of this CreateRuleResponse.

        规则最后更新时间，使用UTC时区，格式：yyyyMMdd'T'HHmmss'Z'。

        :return: The last_update_time of this CreateRuleResponse.
        :rtype: str
        """
    ...
    def last_update_time(self, last_update_time):
        r"""Sets the last_update_time of this CreateRuleResponse.

        规则最后更新时间，使用UTC时区，格式：yyyyMMdd'T'HHmmss'Z'。

        :param last_update_time: The last_update_time of this CreateRuleResponse.
        :type last_update_time: str
        """
    ...
    def device_side(self):
        r"""Gets the device_side of this CreateRuleResponse.

        :return: The device_side of this CreateRuleResponse.
    ...
    def device_side(self, device_side):
        r"""Sets the device_side of this CreateRuleResponse.

        :param device_side: The device_side of this CreateRuleResponse.
        :type device_side: :class:`huaweicloudsdkiotda.v5.DeviceSide`
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateRuleResponse.to_dict() is deprecated and no longer maintained, "
