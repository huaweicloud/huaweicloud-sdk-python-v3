...
class CreateRoutingFlowControlPolicyResponse(SdkResponse):
    ...
    def policy_id(self):
        ...
        **参数说明**：数据流转流控策略id，用于唯一标识一个数据流转流控策略，在创建数据流转流控策略时由物联网平台分配获得。
        ...
        :return: The policy_id of this CreateRoutingFlowControlPolicyResponse.
        :rtype: str
        """
    ...
    def policy_id(self, policy_id):
        ...
        **参数说明**：数据流转流控策略id，用于唯一标识一个数据流转流控策略，在创建数据流转流控策略时由物联网平台分配获得。
        ...
        :param policy_id: The policy_id of this CreateRoutingFlowControlPolicyResponse.
        :type policy_id: str
        """
    ...
    def policy_name(self):
        ...
        **参数说明**：数据流转流控策略名称。 **取值范围**：长度不超过256，只允许中文、字母、数字、以及_?'#().,&%@!-等字符的组合。
        ...
        :return: The policy_name of this CreateRoutingFlowControlPolicyResponse.
        :rtype: str
        """
    ...
    def policy_name(self, policy_name):
        ...
        **参数说明**：数据流转流控策略名称。 **取值范围**：长度不超过256，只允许中文、字母、数字、以及_?'#().,&%@!-等字符的组合。
        ...
        :param policy_name: The policy_name of this CreateRoutingFlowControlPolicyResponse.
        :type policy_name: str
        """
    ...
    def description(self):
        ...
        **参数说明**：用户自定义的数据流转流控策略描述。 **取值范围**：长度不超过256，只允许中文、字母、数字、以及_?'#().,&%@!-等字符的组合。
        ...
        :return: The description of this CreateRoutingFlowControlPolicyResponse.
        :rtype: str
        """
    ...
    def description(self, description):
        ...
        **参数说明**：用户自定义的数据流转流控策略描述。 **取值范围**：长度不超过256，只允许中文、字母、数字、以及_?'#().,&%@!-等字符的组合。
        ...
        :param description: The description of this CreateRoutingFlowControlPolicyResponse.
        :type description: str
        """
    ...
    def scope(self):
        ...
        **参数说明**：流控策略作用域. **取值范围**： - USER：租户级流控策略。 - CHANNEL：转发通道级流控策略。 - RULE：转发规则级流控策略。 - ACTION：转发动作级流控策略。
        ...
        :return: The scope of this CreateRoutingFlowControlPolicyResponse.
        :rtype: str
        """
        return self._scope
    ...
    def scope(self, scope):
        ...
        **参数说明**：流控策略作用域. **取值范围**： - USER：租户级流控策略。 - CHANNEL：转发通道级流控策略。 - RULE：转发规则级流控策略。 - ACTION：转发动作级流控策略。
        ...
        :param scope: The scope of this CreateRoutingFlowControlPolicyResponse.
        :type scope: str
        """
        self._scope = scope
    ...
    def scope_value(self):
        ...
        **参数说明**：流控策略作用域附加值。 scope取值为USER时，可不携带该字段，表示租户级流控。 scope取值为CHANNEL时，**取值范围**：HTTP_FORWARDING、DIS_FORWARDING、OBS_FORWARDING、AMQP_FORWARDING、DMS_KAFKA_FORWARDING。 scope取值为RULE时，该字段为对应的ruleId。 scope取值为ACTION时，该字段为对应的actionId。
        ...
        :return: The scope_value of this CreateRoutingFlowControlPolicyResponse.
        :rtype: str
        """
    ...
    def scope_value(self, scope_value):
        ...
        **参数说明**：流控策略作用域附加值。 scope取值为USER时，可不携带该字段，表示租户级流控。 scope取值为CHANNEL时，**取值范围**：HTTP_FORWARDING、DIS_FORWARDING、OBS_FORWARDING、AMQP_FORWARDING、DMS_KAFKA_FORWARDING。 scope取值为RULE时，该字段为对应的ruleId。 scope取值为ACTION时，该字段为对应的actionId。
        ...
        :param scope_value: The scope_value of this CreateRoutingFlowControlPolicyResponse.
        :type scope_value: str
        """
    ...
    def limit(self):
        ...
        **参数说明**：数据转发流控大小。单位为tps，取值范围为1~1000的整数，默认为1000.
        ...
        :return: The limit of this CreateRoutingFlowControlPolicyResponse.
        :rtype: int
        """
        return self._limit
    ...
    def limit(self, limit):
        ...
        **参数说明**：数据转发流控大小。单位为tps，取值范围为1~1000的整数，默认为1000.
        ...
        :param limit: The limit of this CreateRoutingFlowControlPolicyResponse.
        :type limit: int
        """
        self._limit = limit
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateRoutingFlowControlPolicyResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateRoutingFlowControlPolicyResponse):
            return False
