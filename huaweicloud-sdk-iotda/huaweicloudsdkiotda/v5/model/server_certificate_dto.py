...
class ServerCertificateDTO:
    ...
    def server_certificate_id(self):
        r"""Gets the server_certificate_id of this ServerCertificateDTO.

        唯一标识ID

        :return: The server_certificate_id of this ServerCertificateDTO.
        :rtype: str
        """
    ...
    def server_certificate_id(self, server_certificate_id):
        r"""Sets the server_certificate_id of this ServerCertificateDTO.

        唯一标识ID

        :param server_certificate_id: The server_certificate_id of this ServerCertificateDTO.
        :type server_certificate_id: str
        """
    ...
    def common_name(self):
        r"""Gets the common_name of this ServerCertificateDTO.

        **参数说明**：证书通用名

        :return: The common_name of this ServerCertificateDTO.
        :rtype: str
        """
    ...
    def common_name(self, common_name):
        r"""Sets the common_name of this ServerCertificateDTO.

        **参数说明**：证书通用名

        :param common_name: The common_name of this ServerCertificateDTO.
        :type common_name: str
        """
    ...
    def effective_date(self):
        r"""Gets the effective_date of this ServerCertificateDTO.

        证书生效日期。格式：yyyyMMdd'T'HHmmss'Z'，如20151212T121212Z。

        :return: The effective_date of this ServerCertificateDTO.
        :rtype: str
        """
    ...
    def effective_date(self, effective_date):
        r"""Sets the effective_date of this ServerCertificateDTO.

        证书生效日期。格式：yyyyMMdd'T'HHmmss'Z'，如20151212T121212Z。

        :param effective_date: The effective_date of this ServerCertificateDTO.
        :type effective_date: str
        """
    ...
    def expiry_date(self):
        r"""Gets the expiry_date of this ServerCertificateDTO.

        证书失效日期。格式：yyyyMMdd'T'HHmmss'Z'，如20151212T121212Z。

        :return: The expiry_date of this ServerCertificateDTO.
        :rtype: str
        """
    ...
    def expiry_date(self, expiry_date):
        r"""Sets the expiry_date of this ServerCertificateDTO.

        证书失效日期。格式：yyyyMMdd'T'HHmmss'Z'，如20151212T121212Z。

        :param expiry_date: The expiry_date of this ServerCertificateDTO.
        :type expiry_date: str
        """
    ...
    def certificate_owner(self):
        r"""Gets the certificate_owner of this ServerCertificateDTO.

        证书所有者。

        :return: The certificate_owner of this ServerCertificateDTO.
        :rtype: str
        """
    ...
    def certificate_owner(self, certificate_owner):
        r"""Sets the certificate_owner of this ServerCertificateDTO.

        证书所有者。

        :param certificate_owner: The certificate_owner of this ServerCertificateDTO.
        :type certificate_owner: str
        """
    ...
    def certificate_issuer(self):
        r"""Gets the certificate_issuer of this ServerCertificateDTO.

        证书颁发者。

        :return: The certificate_issuer of this ServerCertificateDTO.
        :rtype: str
        """
    ...
    def certificate_issuer(self, certificate_issuer):
        r"""Sets the certificate_issuer of this ServerCertificateDTO.

        证书颁发者。

        :param certificate_issuer: The certificate_issuer of this ServerCertificateDTO.
        :type certificate_issuer: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServerCertificateDTO):
            return False
