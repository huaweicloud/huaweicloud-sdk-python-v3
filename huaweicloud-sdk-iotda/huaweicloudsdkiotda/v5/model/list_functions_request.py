...
class ListFunctionsRequest:
    ...
    def __init__(self, instance_id=None, app_id=None, product_id=None):
    ...
    @property
    def app_id(self):
        r"""Gets the app_id of this ListFunctionsRequest.
    ...
    def app_id(self, app_id):
        r"""Sets the app_id of this ListFunctionsRequest.
    ...
    @property
    def product_id(self):
        r"""Gets the product_id of this ListFunctionsRequest.
    ...
    def product_id(self, product_id):
        r"""Sets the product_id of this ListFunctionsRequest.
