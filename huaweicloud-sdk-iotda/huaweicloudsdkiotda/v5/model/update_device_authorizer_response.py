...
class UpdateDeviceAuthorizerResponse(SdkResponse):
    ...
    def authorizer_id(self):
        ...
        **参数说明**：自定义鉴权ID。
        ...
        :return: The authorizer_id of this UpdateDeviceAuthorizerResponse.
        :rtype: str
        """
    ...
    def authorizer_id(self, authorizer_id):
        ...
        **参数说明**：自定义鉴权ID。
        ...
        :param authorizer_id: The authorizer_id of this UpdateDeviceAuthorizerResponse.
        :type authorizer_id: str
        """
    ...
    def authorizer_name(self):
        ...
        **参数说明**：自定义鉴权器名称，同一租户下的自定义鉴权器名称不能重复。 **取值范围**：长度不超过128，只允许字母、数字、下划线（_）、连接符（-）的组合。
        ...
        :return: The authorizer_name of this UpdateDeviceAuthorizerResponse.
        :rtype: str
        """
    ...
    def authorizer_name(self, authorizer_name):
        ...
        **参数说明**：自定义鉴权器名称，同一租户下的自定义鉴权器名称不能重复。 **取值范围**：长度不超过128，只允许字母、数字、下划线（_）、连接符（-）的组合。
        ...
        :param authorizer_name: The authorizer_name of this UpdateDeviceAuthorizerResponse.
        :type authorizer_name: str
        """
    ...
    def func_name(self):
        ...
        **参数说明**：函数名称。
        ...
        :return: The func_name of this UpdateDeviceAuthorizerResponse.
        :rtype: str
        """
    ...
    def func_name(self, func_name):
        ...
        **参数说明**：函数名称。
        ...
        :param func_name: The func_name of this UpdateDeviceAuthorizerResponse.
        :type func_name: str
        """
    ...
    def func_urn(self):
        ...
        **参数说明**：函数的URN（Uniform Resource Name），唯一标识函数，即自定义鉴权器对应的处理函数地址。
        ...
        :return: The func_urn of this UpdateDeviceAuthorizerResponse.
        :rtype: str
        """
    ...
    def func_urn(self, func_urn):
        ...
        **参数说明**：函数的URN（Uniform Resource Name），唯一标识函数，即自定义鉴权器对应的处理函数地址。
        ...
        :param func_urn: The func_urn of this UpdateDeviceAuthorizerResponse.
        :type func_urn: str
        """
    ...
    def signing_enable(self):
        ...
        **参数说明**：是否启动签名校验，启动签名校验后不满足签名要求的鉴权信息将被拒绝，以减少无效的函数调用。推荐用户进行安全的签名校验，默认开启。
        ...
        :return: The signing_enable of this UpdateDeviceAuthorizerResponse.
        :rtype: bool
        """
    ...
    def signing_enable(self, signing_enable):
        ...
        **参数说明**：是否启动签名校验，启动签名校验后不满足签名要求的鉴权信息将被拒绝，以减少无效的函数调用。推荐用户进行安全的签名校验，默认开启。
        ...
        :param signing_enable: The signing_enable of this UpdateDeviceAuthorizerResponse.
        :type signing_enable: bool
        """
    ...
    def signing_token(self):
        ...
        **参数说明**：签名校验的Key值，开启签名校验时使用。 **取值范围**：长度不超过128，只允许字母、数字、下划线（_）、连接符（-）的组合。
        ...
        :return: The signing_token of this UpdateDeviceAuthorizerResponse.
        :rtype: str
        """
    ...
    def signing_token(self, signing_token):
        ...
        **参数说明**：签名校验的Key值，开启签名校验时使用。 **取值范围**：长度不超过128，只允许字母、数字、下划线（_）、连接符（-）的组合。
        ...
        :param signing_token: The signing_token of this UpdateDeviceAuthorizerResponse.
        :type signing_token: str
        """
    ...
    def signing_public_key(self):
        ...
        **参数说明**：签名校验的公钥，开启签名校验时使用。用于认证设备携带的签名信息是否正确。
        ...
        :return: The signing_public_key of this UpdateDeviceAuthorizerResponse.
        :rtype: str
        """
    ...
    def signing_public_key(self, signing_public_key):
        ...
        **参数说明**：签名校验的公钥，开启签名校验时使用。用于认证设备携带的签名信息是否正确。
        ...
        :param signing_public_key: The signing_public_key of this UpdateDeviceAuthorizerResponse.
        :type signing_public_key: str
        """
    ...
    def default_authorizer(self):
        ...
        **参数说明**：是否为默认的鉴权方式，默认为false。
        ...
        :return: The default_authorizer of this UpdateDeviceAuthorizerResponse.
        :rtype: bool
        """
    ...
    def default_authorizer(self, default_authorizer):
        ...
        **参数说明**：是否为默认的鉴权方式，默认为false。
        ...
        :param default_authorizer: The default_authorizer of this UpdateDeviceAuthorizerResponse.
        :type default_authorizer: bool
        """
    ...
    def status(self):
        ...
        **参数说明**：是否激活该鉴权方式 - ACTIVE：该鉴权为激活状态。 - INACTIVE：该鉴权为停用状态。
        ...
        :return: The status of this UpdateDeviceAuthorizerResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        **参数说明**：是否激活该鉴权方式 - ACTIVE：该鉴权为激活状态。 - INACTIVE：该鉴权为停用状态。
        ...
        :param status: The status of this UpdateDeviceAuthorizerResponse.
        :type status: str
        """
        self._status = status
    ...
    def cache_enable(self):
        ...
        **参数说明**：是否开启缓存，默认为false，设备为true时，当设备入参（username，clientId，password，以及证书信息，函数urn）不变时，当缓存结果存在时，将直接使用缓存结果，建议在调试时设置为false，生产时设置为true，避免频繁调用函数。
        ...
        :return: The cache_enable of this UpdateDeviceAuthorizerResponse.
        :rtype: bool
        """
    ...
    def cache_enable(self, cache_enable):
        ...
        **参数说明**：是否开启缓存，默认为false，设备为true时，当设备入参（username，clientId，password，以及证书信息，函数urn）不变时，当缓存结果存在时，将直接使用缓存结果，建议在调试时设置为false，生产时设置为true，避免频繁调用函数。
        ...
        :param cache_enable: The cache_enable of this UpdateDeviceAuthorizerResponse.
        :type cache_enable: bool
        """
    ...
    def create_time(self):
        ...
        :return: The create_time of this UpdateDeviceAuthorizerResponse.
        :rtype: str
        """
    ...
    def create_time(self, create_time):
        ...
        :param create_time: The create_time of this UpdateDeviceAuthorizerResponse.
        :type create_time: str
        """
    ...
    def update_time(self):
        ...
        :return: The update_time of this UpdateDeviceAuthorizerResponse.
        :rtype: str
        """
    ...
    def update_time(self, update_time):
        ...
        :param update_time: The update_time of this UpdateDeviceAuthorizerResponse.
        :type update_time: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateDeviceAuthorizerResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateDeviceAuthorizerResponse):
            return False
