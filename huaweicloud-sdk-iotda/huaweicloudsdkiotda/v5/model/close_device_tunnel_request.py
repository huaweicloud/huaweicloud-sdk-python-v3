...
class CloseDeviceTunnelRequest:
    ...
    def instance_id(self):
        r"""Gets the instance_id of this CloseDeviceTunnelRequest.
        ...
        **参数说明**：实例ID。物理多租下各实例的唯一标识，建议携带该参数，在使用专业版时必须携带该参数。您可以在IoTDA管理控制台界面，选择左侧导航栏“总览”页签查看当前实例的ID，具体获取方式请参考[[查看实例详情](https://support.huaweicloud.com/usermanual-iothub/iot_01_0121.html)](tag:hws) [[查看实例详情](https://support.huaweicloud.com/intl/zh-cn/usermanual-iothub/iot_01_0121.html)](tag:hws_hk)。
        ...
        :return: The instance_id of this CloseDeviceTunnelRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this CloseDeviceTunnelRequest.

        **参数说明**：实例ID。物理多租下各实例的唯一标识，建议携带该参数，在使用专业版时必须携带该参数。您可以在IoTDA管理控制台界面，选择左侧导航栏“总览”页签查看当前实例的ID，具体获取方式请参考[[查看实例详情](https://support.huaweicloud.com/usermanual-iothub/iot_01_0121.html)](tag:hws) [[查看实例详情](https://support.huaweicloud.com/intl/zh-cn/usermanual-iothub/iot_01_0121.html)](tag:hws_hk)。

        :param instance_id: The instance_id of this CloseDeviceTunnelRequest.
        :type instance_id: str
        """
    ...
    @property
    def tunnel_id(self):
        r"""Gets the tunnel_id of this CloseDeviceTunnelRequest.

        隧道ID

        :return: The tunnel_id of this CloseDeviceTunnelRequest.
        :rtype: str
        """
    ...
    def tunnel_id(self, tunnel_id):
        r"""Sets the tunnel_id of this CloseDeviceTunnelRequest.

        隧道ID

        :param tunnel_id: The tunnel_id of this CloseDeviceTunnelRequest.
        :type tunnel_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CloseDeviceTunnelRequest):
            return False
