...
class ListDevicePoliciesResponse(SdkResponse):
    ...
    @property
    def policies(self):
        r"""Gets the policies of this ListDevicePoliciesResponse.
    ...
    def policies(self, policies):
        r"""Sets the policies of this ListDevicePoliciesResponse.
    ...
    @property
    def page(self):
        r"""Gets the page of this ListDevicePoliciesResponse.
    ...
    @page.setter
    def page(self, page):
        r"""Sets the page of this ListDevicePoliciesResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListDevicePoliciesResponse.to_dict() is deprecated and no longer maintained, "
