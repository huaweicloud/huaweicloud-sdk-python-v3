...
class CheckCertificateResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CheckCertificateResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CheckCertificateResponse):
            return False
