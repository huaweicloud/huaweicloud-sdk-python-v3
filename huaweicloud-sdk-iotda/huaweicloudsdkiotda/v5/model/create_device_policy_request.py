...
class CreateDevicePolicyRequest:
    ...
    def __init__(self, instance_id=None, body=None):
        ...
        :param body: Body of the CreateDevicePolicyRequest
    ...
    def instance_id(self):
        ...
        **参数说明**：实例ID。物理多租下各实例的唯一标识，建议携带该参数，在使用专业版时必须携带该参数。您可以在IoTDA管理控制台界面，选择左侧导航栏“总览”页签查看当前实例的ID，具体获取方式请参考[[查看实例详情](https://support.huaweicloud.com/usermanual-iothub/iot_01_0079.html#section1)](tag:hws) [[查看实例详情](https://support.huaweicloud.com/intl/zh-cn/usermanual-iothub/iot_01_0079.html#section1)](tag:hws_hk)。
        ...
        :return: The instance_id of this CreateDevicePolicyRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        ...
        **参数说明**：实例ID。物理多租下各实例的唯一标识，建议携带该参数，在使用专业版时必须携带该参数。您可以在IoTDA管理控制台界面，选择左侧导航栏“总览”页签查看当前实例的ID，具体获取方式请参考[[查看实例详情](https://support.huaweicloud.com/usermanual-iothub/iot_01_0079.html#section1)](tag:hws) [[查看实例详情](https://support.huaweicloud.com/intl/zh-cn/usermanual-iothub/iot_01_0079.html#section1)](tag:hws_hk)。
        ...
        :param instance_id: The instance_id of this CreateDevicePolicyRequest.
        :type instance_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateDevicePolicyRequest):
            return False
