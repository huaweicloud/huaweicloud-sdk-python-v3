...
class DeleteServerCertificateRequest:
    ...
    def instance_id(self):
        r"""Gets the instance_id of this DeleteServerCertificateRequest.

        **参数说明**：实例ID。物理多租下各实例的唯一标识，建议携带该参数，在使用专业版时必须携带该参数。您可以在IoTDA管理控制台界面，选择左侧导航栏“总览”页签查看当前实例的ID，具体获取方式请参考[[查看实例详情](https://support.huaweicloud.com/usermanual-iothub/iot_01_0079.html#section1)](tag:hws) [[查看实例详情](https://support.huaweicloud.com/intl/zh-cn/usermanual-iothub/iot_01_0079.html#section1)](tag:hws_hk)。

        :return: The instance_id of this DeleteServerCertificateRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this DeleteServerCertificateRequest.

        **参数说明**：实例ID。物理多租下各实例的唯一标识，建议携带该参数，在使用专业版时必须携带该参数。您可以在IoTDA管理控制台界面，选择左侧导航栏“总览”页签查看当前实例的ID，具体获取方式请参考[[查看实例详情](https://support.huaweicloud.com/usermanual-iothub/iot_01_0079.html#section1)](tag:hws) [[查看实例详情](https://support.huaweicloud.com/intl/zh-cn/usermanual-iothub/iot_01_0079.html#section1)](tag:hws_hk)。

        :param instance_id: The instance_id of this DeleteServerCertificateRequest.
        :type instance_id: str
        """
    ...
    def server_certificate_id(self):
        r"""Gets the server_certificate_id of this DeleteServerCertificateRequest.

        服务器证书ID，由平台分配的唯一标识。

        :return: The server_certificate_id of this DeleteServerCertificateRequest.
        :rtype: str
        """
    ...
    def server_certificate_id(self, server_certificate_id):
        r"""Sets the server_certificate_id of this DeleteServerCertificateRequest.

        服务器证书ID，由平台分配的唯一标识。

        :param server_certificate_id: The server_certificate_id of this DeleteServerCertificateRequest.
        :type server_certificate_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteServerCertificateRequest):
            return False
