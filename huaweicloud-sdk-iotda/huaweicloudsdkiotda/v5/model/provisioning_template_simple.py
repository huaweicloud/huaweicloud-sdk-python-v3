...
class ProvisioningTemplateSimple:
    ...
    def template_id(self):
        ...
        **参数说明**：预调配模板ID。
        ...
        :return: The template_id of this ProvisioningTemplateSimple.
        :rtype: str
        """
    ...
    def template_id(self, template_id):
        ...
        **参数说明**：预调配模板ID。
        ...
        :param template_id: The template_id of this ProvisioningTemplateSimple.
        :type template_id: str
        """
    ...
    def template_name(self):
        ...
        **参数说明**：预调配模板名称。 **取值范围**：长度不超过128，只允许中文、字母、数字、下划线（_）、连接符（-）的组合。
        ...
        :return: The template_name of this ProvisioningTemplateSimple.
        :rtype: str
        """
    ...
    def template_name(self, template_name):
        ...
        **参数说明**：预调配模板名称。 **取值范围**：长度不超过128，只允许中文、字母、数字、下划线（_）、连接符（-）的组合。
        ...
        :param template_name: The template_name of this ProvisioningTemplateSimple.
        :type template_name: str
        """
    ...
    def description(self):
        ...
        **参数说明**：预调配模板的描述信息。 **取值范围**：长度不超过2048，只允许中文、字母、数字、以及_?'#().,&%@!-等字符的组合
        ...
        :return: The description of this ProvisioningTemplateSimple.
        :rtype: str
        """
    ...
    def description(self, description):
        ...
        **参数说明**：预调配模板的描述信息。 **取值范围**：长度不超过2048，只允许中文、字母、数字、以及_?'#().,&%@!-等字符的组合
        ...
        :param description: The description of this ProvisioningTemplateSimple.
        :type description: str
        """
    ...
    def create_time(self):
        ...
        :return: The create_time of this ProvisioningTemplateSimple.
        :rtype: str
        """
    ...
    def create_time(self, create_time):
        ...
        :param create_time: The create_time of this ProvisioningTemplateSimple.
        :type create_time: str
        """
    ...
    def update_time(self):
        ...
        :return: The update_time of this ProvisioningTemplateSimple.
        :rtype: str
        """
    ...
    def update_time(self, update_time):
        ...
        :param update_time: The update_time of this ProvisioningTemplateSimple.
        :type update_time: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProvisioningTemplateSimple):
            return False
