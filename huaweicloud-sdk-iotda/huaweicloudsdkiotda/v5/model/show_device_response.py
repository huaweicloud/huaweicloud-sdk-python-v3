...
class ShowDeviceResponse(SdkResponse):
    ...
    @property
    def modules(self):
        r"""Gets the modules of this ShowDeviceResponse.

        设备的OTA模块列表。

        :return: The modules of this ShowDeviceResponse.
    ...
    def modules(self, modules):
        r"""Sets the modules of this ShowDeviceResponse.

        设备的OTA模块列表。

        :param modules: The modules of this ShowDeviceResponse.
        :type modules: list[:class:`huaweicloudsdkiotda.v5.ModuleDTO`]
        """
