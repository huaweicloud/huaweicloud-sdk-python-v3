...
class CreateOtaPackage:
    ...
    def app_id(self):
        ...
        **参数说明**：资源空间ID。存在多资源空间的用户需要使用该接口时，建议携带该参数指定创建的升级包归属到哪个资源空间下。 **取值范围**：长度不超过36，只允许字母、数字、下划线（_）、连接符（-）的组合。
        ...
        :return: The app_id of this CreateOtaPackage.
        :rtype: str
        """
        return self._app_id
    ...
    def app_id(self, app_id):
        ...
        **参数说明**：资源空间ID。存在多资源空间的用户需要使用该接口时，建议携带该参数指定创建的升级包归属到哪个资源空间下。 **取值范围**：长度不超过36，只允许字母、数字、下划线（_）、连接符（-）的组合。
        ...
        :param app_id: The app_id of this CreateOtaPackage.
        :type app_id: str
        """
        self._app_id = app_id
    ...
    def product_id(self):
        ...
        **参数说明**：设备关联的产品ID，用于唯一标识一个产品模型，创建产品后获得。方法请参见 [[创建产品](https://support.huaweicloud.com/api-iothub/iot_06_v5_0050.html)](tag:hws)[[创建产品](https://support.huaweicloud.com/intl/zh-cn/api-iothub/iot_06_v5_0050.html)](tag:hws_hk)。 **取值范围**：长度不超过36，只允许字母、数字、下划线（_）、连接符（-）的组合。
        ...
        :return: The product_id of this CreateOtaPackage.
        :rtype: str
        """
    ...
    def product_id(self, product_id):
        ...
        **参数说明**：设备关联的产品ID，用于唯一标识一个产品模型，创建产品后获得。方法请参见 [[创建产品](https://support.huaweicloud.com/api-iothub/iot_06_v5_0050.html)](tag:hws)[[创建产品](https://support.huaweicloud.com/intl/zh-cn/api-iothub/iot_06_v5_0050.html)](tag:hws_hk)。 **取值范围**：长度不超过36，只允许字母、数字、下划线（_）、连接符（-）的组合。
        ...
        :param product_id: The product_id of this CreateOtaPackage.
        :type product_id: str
        """
    ...
    def version(self):
        ...
        **参数说明**：升级包版本号。 **取值范围**：长度不超过256，只允许字母、数字、下划线（_）、连接符（-）、英文点（.）的组合。
        ...
        :return: The version of this CreateOtaPackage.
        :rtype: str
        """
    ...
    def version(self, version):
        ...
        **参数说明**：升级包版本号。 **取值范围**：长度不超过256，只允许字母、数字、下划线（_）、连接符（-）、英文点（.）的组合。
        ...
        :param version: The version of this CreateOtaPackage.
        :type version: str
        """
    ...
    def support_source_versions(self):
        ...
        **参数说明**：支持用于升级此版本包的设备源版本号列表。最多支持20个源版本号。 **取值范围**：源版本号列表，源版本号只允许字母、数字、下划线（_）、连接符（-）、英文点（.）的组合。
        ...
        :return: The support_source_versions of this CreateOtaPackage.
        :rtype: list[str]
        """
    ...
    def support_source_versions(self, support_source_versions):
        ...
        **参数说明**：支持用于升级此版本包的设备源版本号列表。最多支持20个源版本号。 **取值范围**：源版本号列表，源版本号只允许字母、数字、下划线（_）、连接符（-）、英文点（.）的组合。
        ...
        :param support_source_versions: The support_source_versions of this CreateOtaPackage.
        :type support_source_versions: list[str]
        """
    ...
    def description(self):
        ...
        **参数说明**：用于描述升级包的功能等信息。 **取值范围**：长度不超过1024。
        ...
        :return: The description of this CreateOtaPackage.
        :rtype: str
        """
    ...
    def description(self, description):
        ...
        **参数说明**：用于描述升级包的功能等信息。 **取值范围**：长度不超过1024。
        ...
        :param description: The description of this CreateOtaPackage.
        :type description: str
        """
    ...
    def custom_info(self):
        ...
        **参数说明**：推送给设备的自定义信息。添加该升级包完成，并创建升级任务后，物联网平台向设备下发升级通知时，会下发该自定义信息给设备。 **取值范围**：长度不超过4096。
        ...
        :return: The custom_info of this CreateOtaPackage.
        :rtype: str
        """
    ...
    def custom_info(self, custom_info):
        ...
        **参数说明**：推送给设备的自定义信息。添加该升级包完成，并创建升级任务后，物联网平台向设备下发升级通知时，会下发该自定义信息给设备。 **取值范围**：长度不超过4096。
        ...
        :param custom_info: The custom_info of this CreateOtaPackage.
        :type custom_info: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateOtaPackage):
            return False
