...
class UpdateDeviceResponse(SdkResponse):
    ...
    def __init__(self, app_id=None, app_name=None, device_id=None, node_id=None, gateway_id=None, device_name=None, node_type=None, description=None, fw_version=None, sw_version=None, device_sdk_version=None, auth_info=None, product_id=None, product_name=None, status=None, create_time=None, connection_status_update_time=None, active_time=None, tags=None, modules=None, extension_info=None):
        ...
        if connection_status_update_time is not None:
            self.connection_status_update_time = connection_status_update_time
    ...
    def gateway_id(self, gateway_id):
        r"""Sets the gateway_id of this UpdateDeviceResponse.
    ...
    @property
    def fw_version(self):
        r"""Gets the fw_version of this UpdateDeviceResponse.

        设备的固件版本。

        :return: The fw_version of this UpdateDeviceResponse.
        :rtype: str
        """
    ...
    def fw_version(self, fw_version):
        r"""Sets the fw_version of this UpdateDeviceResponse.
    ...
    @property
    def sw_version(self):
        r"""Gets the sw_version of this UpdateDeviceResponse.

        设备的软件版本。

        :return: The sw_version of this UpdateDeviceResponse.
        :rtype: str
        """
    ...
    def sw_version(self, sw_version):
        r"""Sets the sw_version of this UpdateDeviceResponse.
    ...
    def device_sdk_version(self):
        r"""Gets the device_sdk_version of this UpdateDeviceResponse.

        设备的sdk信息。

        :return: The device_sdk_version of this UpdateDeviceResponse.
        :rtype: str
        """
    ...
    def device_sdk_version(self, device_sdk_version):
        r"""Sets the device_sdk_version of this UpdateDeviceResponse.
    ...
    @property
    def auth_info(self):
        r"""Gets the auth_info of this UpdateDeviceResponse.
    ...
    def auth_info(self, auth_info):
        r"""Sets the auth_info of this UpdateDeviceResponse.
    ...
    @property
    def product_id(self):
        r"""Gets the product_id of this UpdateDeviceResponse.

        设备关联的产品ID，用于唯一标识一个产品模型。

        :return: The product_id of this UpdateDeviceResponse.
        :rtype: str
        """
    ...
    def product_id(self, product_id):
        r"""Sets the product_id of this UpdateDeviceResponse.
    ...
    def product_name(self):
        r"""Gets the product_name of this UpdateDeviceResponse.

        设备关联的产品名称。

        :return: The product_name of this UpdateDeviceResponse.
        :rtype: str
        """
    ...
    def product_name(self, product_name):
        r"""Sets the product_name of this UpdateDeviceResponse.
    ...
    def create_time(self):
        r"""Gets the create_time of this UpdateDeviceResponse.

        在物联网平台注册设备的时间。格式：yyyyMMdd'T'HHmmss'Z'，如20151212T121212Z。

        :return: The create_time of this UpdateDeviceResponse.
        :rtype: str
        """
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this UpdateDeviceResponse.
    ...
    def connection_status_update_time(self):
        r"""Gets the connection_status_update_time of this UpdateDeviceResponse.

        设备最近一次连接状态(ONLINE:在线，OFFLINE：离线，ABNORMAL：异常)变化时间。格式：yyyy-MM-dd'T'HH:mm:ss.SSS'Z' ，如2015-12-12T12:12:122Z。

        :return: The connection_status_update_time of this UpdateDeviceResponse.
        :rtype: str
        """
        return self._connection_status_update_time

    @connection_status_update_time.setter
    def connection_status_update_time(self, connection_status_update_time):
        r"""Sets the connection_status_update_time of this UpdateDeviceResponse.

        设备最近一次连接状态(ONLINE:在线，OFFLINE：离线，ABNORMAL：异常)变化时间。格式：yyyy-MM-dd'T'HH:mm:ss.SSS'Z' ，如2015-12-12T12:12:122Z。

        :param connection_status_update_time: The connection_status_update_time of this UpdateDeviceResponse.
        :type connection_status_update_time: str
        """
        self._connection_status_update_time = connection_status_update_time

    @property
    def active_time(self):
        r"""Gets the active_time of this UpdateDeviceResponse.

        设备激活时间。格式：yyyy-MM-dd'T'HH:mm:ss.SSS'Z' ，如2015-12-12T12:12:122Z。

        :return: The active_time of this UpdateDeviceResponse.
        :rtype: str
        """
    ...
    def active_time(self, active_time):
        r"""Sets the active_time of this UpdateDeviceResponse.

        设备激活时间。格式：yyyy-MM-dd'T'HH:mm:ss.SSS'Z' ，如2015-12-12T12:12:122Z。

        :param active_time: The active_time of this UpdateDeviceResponse.
        :type active_time: str
        """
    ...
    @property
    def modules(self):
        r"""Gets the modules of this UpdateDeviceResponse.

        设备的OTA模块列表。

        :return: The modules of this UpdateDeviceResponse.
    ...
    def modules(self, modules):
        r"""Sets the modules of this UpdateDeviceResponse.

        设备的OTA模块列表。

        :param modules: The modules of this UpdateDeviceResponse.
        :type modules: list[:class:`huaweicloudsdkiotda.v5.ModuleDTO`]
        """
    ...
    def extension_info(self):
        r"""Gets the extension_info of this UpdateDeviceResponse.

        设备扩展信息。用户可以自定义任何想要的扩展信息，如果在创建设备时为子设备指定该字段，将会通过MQTT接口“平台通知网关子设备新增“将该信息通知给网关。

        :return: The extension_info of this UpdateDeviceResponse.
        :rtype: object
        """
    ...
    def extension_info(self, extension_info):
        r"""Sets the extension_info of this UpdateDeviceResponse.
