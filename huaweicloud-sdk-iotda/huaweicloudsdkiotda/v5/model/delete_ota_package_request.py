...
class DeleteOtaPackageRequest:
    ...
    def sp_auth_token(self):
        """Gets the sp_auth_token of this DeleteOtaPackageRequest.

        Sp用户Token。通过调用IoBPS服务获取SP用户Token

        :return: The sp_auth_token of this DeleteOtaPackageRequest.
        :rtype: str
        """
    ...
    def sp_auth_token(self, sp_auth_token):
        """Sets the sp_auth_token of this DeleteOtaPackageRequest.

        Sp用户Token。通过调用IoBPS服务获取SP用户Token

        :param sp_auth_token: The sp_auth_token of this DeleteOtaPackageRequest.
        :type sp_auth_token: str
        """
    ...
    def instance_id(self):
        ...
        :return: The instance_id of this DeleteOtaPackageRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        ...
        :param instance_id: The instance_id of this DeleteOtaPackageRequest.
        :type instance_id: str
        """
    ...
    def package_id(self):
        ...
        **参数说明**：升级包ID，用于唯一标识一个升级包。由物联网平台分配获得。 **取值范围**：长度不超过36，只允许字母、数字、连接符（-）的组合。
        ...
        :return: The package_id of this DeleteOtaPackageRequest.
        :rtype: str
        """
    ...
    def package_id(self, package_id):
        ...
        **参数说明**：升级包ID，用于唯一标识一个升级包。由物联网平台分配获得。 **取值范围**：长度不超过36，只允许字母、数字、连接符（-）的组合。
        ...
        :param package_id: The package_id of this DeleteOtaPackageRequest.
        :type package_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteOtaPackageRequest):
            return False
