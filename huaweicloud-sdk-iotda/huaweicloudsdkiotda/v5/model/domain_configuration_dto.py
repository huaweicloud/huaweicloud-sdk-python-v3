...
class DomainConfigurationDTO:
    ...
    def configuration_id(self):
        r"""Gets the configuration_id of this DomainConfigurationDTO.

        域配置唯一标识ID

        :return: The configuration_id of this DomainConfigurationDTO.
        :rtype: str
        """
    ...
    def configuration_id(self, configuration_id):
        r"""Sets the configuration_id of this DomainConfigurationDTO.

        域配置唯一标识ID

        :param configuration_id: The configuration_id of this DomainConfigurationDTO.
        :type configuration_id: str
        """
    ...
    def domain_name(self):
        r"""Gets the domain_name of this DomainConfigurationDTO.

        **参数说明**：自定义域名

        :return: The domain_name of this DomainConfigurationDTO.
        :rtype: str
        """
    ...
    def domain_name(self, domain_name):
        r"""Sets the domain_name of this DomainConfigurationDTO.

        **参数说明**：自定义域名

        :param domain_name: The domain_name of this DomainConfigurationDTO.
        :type domain_name: str
        """
    ...
    def access_protocol(self):
        r"""Gets the access_protocol of this DomainConfigurationDTO.

        **参数说明**：应用协议场景，当前仅支持Device-MQTTS：设备接入MQTTS场景

        :return: The access_protocol of this DomainConfigurationDTO.
        :rtype: str
        """
    ...
    def access_protocol(self, access_protocol):
        r"""Sets the access_protocol of this DomainConfigurationDTO.

        **参数说明**：应用协议场景，当前仅支持Device-MQTTS：设备接入MQTTS场景

        :param access_protocol: The access_protocol of this DomainConfigurationDTO.
        :type access_protocol: str
        """
    ...
    def server_certificate_id(self):
        r"""Gets the server_certificate_id of this DomainConfigurationDTO.

        **参数说明**：自定义服务端证书ID

        :return: The server_certificate_id of this DomainConfigurationDTO.
        :rtype: str
        """
    ...
    def server_certificate_id(self, server_certificate_id):
        r"""Sets the server_certificate_id of this DomainConfigurationDTO.

        **参数说明**：自定义服务端证书ID

        :param server_certificate_id: The server_certificate_id of this DomainConfigurationDTO.
        :type server_certificate_id: str
        """
    ...
    def server_certificate_config(self):
        r"""Gets the server_certificate_config of this DomainConfigurationDTO.

        :return: The server_certificate_config of this DomainConfigurationDTO.
    ...
    def server_certificate_config(self, server_certificate_config):
        r"""Sets the server_certificate_config of this DomainConfigurationDTO.

        :param server_certificate_config: The server_certificate_config of this DomainConfigurationDTO.
        :type server_certificate_config: :class:`huaweicloudsdkiotda.v5.ServerCertificateConfig`
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DomainConfigurationDTO):
            return False
