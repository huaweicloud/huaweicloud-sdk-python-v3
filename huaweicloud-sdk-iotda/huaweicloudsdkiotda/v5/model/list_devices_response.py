...
class ListDevicesResponse(SdkResponse):
    ...
    def __init__(self, devices=None, page=None):
        ...
        :type devices: list[:class:`huaweicloudsdkiotda.v5.QueryDeviceSimplify`]
        :param page: 
    ...
    def devices(self):
        ...
        :rtype: list[:class:`huaweicloudsdkiotda.v5.QueryDeviceSimplify`]
        """
    ...
    @property
    def page(self):
        r"""Gets the page of this ListDevicesResponse.
    ...
    @page.setter
    def page(self, page):
        r"""Sets the page of this ListDevicesResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListDevicesResponse.to_dict() is deprecated and no longer maintained, "
