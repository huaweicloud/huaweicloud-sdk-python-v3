...
class DeleteDeviceCertificateRequest:
    ...
    def __init__(self, instance_id=None, certificate_id=None):
        r"""DeleteDeviceCertificateRequest
    ...
    def instance_id(self):
        r"""Gets the instance_id of this DeleteDeviceCertificateRequest.
        ...
        **参数说明**：实例ID。物理多租下各实例的唯一标识，建议携带该参数，在使用专业版时必须携带该参数。您可以在IoTDA管理控制台界面，选择左侧导航栏“总览”页签查看当前实例的ID，具体获取方式请参考[[查看实例详情](https://support.huaweicloud.com/usermanual-iothub/iot_01_0121.html)](tag:hws) [[查看实例详情](https://support.huaweicloud.com/intl/zh-cn/usermanual-iothub/iot_01_0121.html)](tag:hws_hk)。
        ...
        :return: The instance_id of this DeleteDeviceCertificateRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this DeleteDeviceCertificateRequest.

        **参数说明**：实例ID。物理多租下各实例的唯一标识，建议携带该参数，在使用专业版时必须携带该参数。您可以在IoTDA管理控制台界面，选择左侧导航栏“总览”页签查看当前实例的ID，具体获取方式请参考[[查看实例详情](https://support.huaweicloud.com/usermanual-iothub/iot_01_0121.html)](tag:hws) [[查看实例详情](https://support.huaweicloud.com/intl/zh-cn/usermanual-iothub/iot_01_0121.html)](tag:hws_hk)。

        :param instance_id: The instance_id of this DeleteDeviceCertificateRequest.
        :type instance_id: str
        """
    ...
    def certificate_id(self):
        r"""Gets the certificate_id of this DeleteDeviceCertificateRequest.

        **参数说明**：设备证书ID，用于唯一标识一个设备证书。在注册设备证书时由物联网平台分配获得。

        :return: The certificate_id of this DeleteDeviceCertificateRequest.
        :rtype: str
        """
    ...
    def certificate_id(self, certificate_id):
        r"""Sets the certificate_id of this DeleteDeviceCertificateRequest.

        **参数说明**：设备证书ID，用于唯一标识一个设备证书。在注册设备证书时由物联网平台分配获得。

        :param certificate_id: The certificate_id of this DeleteDeviceCertificateRequest.
        :type certificate_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteDeviceCertificateRequest):
            return False
