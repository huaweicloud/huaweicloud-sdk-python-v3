...
class CreateDeviceAuthorizerResponse(SdkResponse):
    ...
    def __init__(self, authorizer_id=None, authorizer_name=None, func_name=None, func_urn=None, signing_enable=None, signing_token=None, signing_public_key=None, default_authorizer=None, status=None, cache_enable=None, create_time=None, update_time=None):
        r"""CreateDeviceAuthorizerResponse
    ...
    def authorizer_id(self):
        r"""Gets the authorizer_id of this CreateDeviceAuthorizerResponse.

        **参数说明**：自定义鉴权ID。

        :return: The authorizer_id of this CreateDeviceAuthorizerResponse.
        :rtype: str
        """
    ...
    def authorizer_id(self, authorizer_id):
        r"""Sets the authorizer_id of this CreateDeviceAuthorizerResponse.

        **参数说明**：自定义鉴权ID。

        :param authorizer_id: The authorizer_id of this CreateDeviceAuthorizerResponse.
        :type authorizer_id: str
        """
    ...
    def authorizer_name(self):
        r"""Gets the authorizer_name of this CreateDeviceAuthorizerResponse.

        **参数说明**：自定义鉴权器名称，同一租户下的自定义鉴权器名称不能重复。 **取值范围**：长度不超过128，只允许字母、数字、下划线（_）、连接符（-）的组合。

        :return: The authorizer_name of this CreateDeviceAuthorizerResponse.
        :rtype: str
        """
    ...
    def authorizer_name(self, authorizer_name):
        r"""Sets the authorizer_name of this CreateDeviceAuthorizerResponse.

        **参数说明**：自定义鉴权器名称，同一租户下的自定义鉴权器名称不能重复。 **取值范围**：长度不超过128，只允许字母、数字、下划线（_）、连接符（-）的组合。

        :param authorizer_name: The authorizer_name of this CreateDeviceAuthorizerResponse.
        :type authorizer_name: str
        """
    ...
    @property
    def func_name(self):
        r"""Gets the func_name of this CreateDeviceAuthorizerResponse.

        **参数说明**：函数名称。

        :return: The func_name of this CreateDeviceAuthorizerResponse.
        :rtype: str
        """
    ...
    def func_name(self, func_name):
        r"""Sets the func_name of this CreateDeviceAuthorizerResponse.

        **参数说明**：函数名称。

        :param func_name: The func_name of this CreateDeviceAuthorizerResponse.
        :type func_name: str
        """
    ...
    @property
    def func_urn(self):
        r"""Gets the func_urn of this CreateDeviceAuthorizerResponse.

        **参数说明**：函数的URN（Uniform Resource Name），唯一标识函数，即自定义鉴权器对应的处理函数地址。

        :return: The func_urn of this CreateDeviceAuthorizerResponse.
        :rtype: str
        """
    ...
    def func_urn(self, func_urn):
        r"""Sets the func_urn of this CreateDeviceAuthorizerResponse.

        **参数说明**：函数的URN（Uniform Resource Name），唯一标识函数，即自定义鉴权器对应的处理函数地址。

        :param func_urn: The func_urn of this CreateDeviceAuthorizerResponse.
        :type func_urn: str
        """
    ...
    def signing_enable(self):
        r"""Gets the signing_enable of this CreateDeviceAuthorizerResponse.

        **参数说明**：是否启动签名校验，启动签名校验后不满足签名要求的鉴权信息将被拒绝，以减少无效的函数调用。推荐用户进行安全的签名校验，默认开启。

        :return: The signing_enable of this CreateDeviceAuthorizerResponse.
        :rtype: bool
        """
    ...
    def signing_enable(self, signing_enable):
        r"""Sets the signing_enable of this CreateDeviceAuthorizerResponse.

        **参数说明**：是否启动签名校验，启动签名校验后不满足签名要求的鉴权信息将被拒绝，以减少无效的函数调用。推荐用户进行安全的签名校验，默认开启。

        :param signing_enable: The signing_enable of this CreateDeviceAuthorizerResponse.
        :type signing_enable: bool
        """
    ...
    def signing_token(self):
        r"""Gets the signing_token of this CreateDeviceAuthorizerResponse.

        **参数说明**：签名校验的Key值，开启签名校验时使用。 **取值范围**：长度不超过128，只允许字母、数字、下划线（_）、连接符（-）的组合。

        :return: The signing_token of this CreateDeviceAuthorizerResponse.
        :rtype: str
        """
    ...
    def signing_token(self, signing_token):
        r"""Sets the signing_token of this CreateDeviceAuthorizerResponse.

        **参数说明**：签名校验的Key值，开启签名校验时使用。 **取值范围**：长度不超过128，只允许字母、数字、下划线（_）、连接符（-）的组合。

        :param signing_token: The signing_token of this CreateDeviceAuthorizerResponse.
        :type signing_token: str
        """
    ...
    def signing_public_key(self):
        r"""Gets the signing_public_key of this CreateDeviceAuthorizerResponse.

        **参数说明**：签名校验的公钥，开启签名校验时使用。用于认证设备携带的签名信息是否正确。

        :return: The signing_public_key of this CreateDeviceAuthorizerResponse.
        :rtype: str
        """
    ...
    def signing_public_key(self, signing_public_key):
        r"""Sets the signing_public_key of this CreateDeviceAuthorizerResponse.

        **参数说明**：签名校验的公钥，开启签名校验时使用。用于认证设备携带的签名信息是否正确。

        :param signing_public_key: The signing_public_key of this CreateDeviceAuthorizerResponse.
        :type signing_public_key: str
        """
    ...
    def default_authorizer(self):
        r"""Gets the default_authorizer of this CreateDeviceAuthorizerResponse.

        **参数说明**：是否为默认的鉴权方式，默认为false。

        :return: The default_authorizer of this CreateDeviceAuthorizerResponse.
        :rtype: bool
        """
    ...
    def default_authorizer(self, default_authorizer):
        r"""Sets the default_authorizer of this CreateDeviceAuthorizerResponse.

        **参数说明**：是否为默认的鉴权方式，默认为false。

        :param default_authorizer: The default_authorizer of this CreateDeviceAuthorizerResponse.
        :type default_authorizer: bool
        """
    ...
    @property
    def status(self):
        r"""Gets the status of this CreateDeviceAuthorizerResponse.

        **参数说明**：是否激活该鉴权方式 - ACTIVE：该鉴权为激活状态。 - INACTIVE：该鉴权为停用状态。

        :return: The status of this CreateDeviceAuthorizerResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        r"""Sets the status of this CreateDeviceAuthorizerResponse.

        **参数说明**：是否激活该鉴权方式 - ACTIVE：该鉴权为激活状态。 - INACTIVE：该鉴权为停用状态。

        :param status: The status of this CreateDeviceAuthorizerResponse.
        :type status: str
        """
        self._status = status
    ...
    def cache_enable(self):
        r"""Gets the cache_enable of this CreateDeviceAuthorizerResponse.
        ...
        **参数说明**：是否开启缓存，默认为false，设备为true时，当设备入参（username，clientId，password，以及证书信息，函数urn）不变时，当缓存结果存在时，将直接使用缓存结果，建议在调试时设置为false，生产时设置为true，避免频繁调用函数。
        ...
        :return: The cache_enable of this CreateDeviceAuthorizerResponse.
        :rtype: bool
        """
    ...
    def cache_enable(self, cache_enable):
        r"""Sets the cache_enable of this CreateDeviceAuthorizerResponse.

        **参数说明**：是否开启缓存，默认为false，设备为true时，当设备入参（username，clientId，password，以及证书信息，函数urn）不变时，当缓存结果存在时，将直接使用缓存结果，建议在调试时设置为false，生产时设置为true，避免频繁调用函数。

        :param cache_enable: The cache_enable of this CreateDeviceAuthorizerResponse.
        :type cache_enable: bool
        """
    ...
    def create_time(self):
        r"""Gets the create_time of this CreateDeviceAuthorizerResponse.

        在物联网平台进行自定义鉴权相关操作的时间。格式：yyyyMMdd'T'HHmmss'Z'，如：20151212T121212Z。

        :return: The create_time of this CreateDeviceAuthorizerResponse.
        :rtype: str
        """
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this CreateDeviceAuthorizerResponse.

        在物联网平台进行自定义鉴权相关操作的时间。格式：yyyyMMdd'T'HHmmss'Z'，如：20151212T121212Z。

        :param create_time: The create_time of this CreateDeviceAuthorizerResponse.
        :type create_time: str
        """
    ...
    def update_time(self):
        r"""Gets the update_time of this CreateDeviceAuthorizerResponse.

        在物联网平台更新自定义鉴权相关操作的时间。格式：yyyyMMdd'T'HHmmss'Z'，如：20151212T121212Z。

        :return: The update_time of this CreateDeviceAuthorizerResponse.
        :rtype: str
        """
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this CreateDeviceAuthorizerResponse.

        在物联网平台更新自定义鉴权相关操作的时间。格式：yyyyMMdd'T'HHmmss'Z'，如：20151212T121212Z。

        :param update_time: The update_time of this CreateDeviceAuthorizerResponse.
        :type update_time: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateDeviceAuthorizerResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateDeviceAuthorizerResponse):
            return False
