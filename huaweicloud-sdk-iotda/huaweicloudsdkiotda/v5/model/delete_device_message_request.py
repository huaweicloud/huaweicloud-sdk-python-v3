...
class DeleteDeviceMessageRequest:
    ...
    @property
    def device_id(self):
        r"""Gets the device_id of this DeleteDeviceMessageRequest.

        **参数说明**：下发消息的设备ID，用于唯一标识一个设备，在注册设备时由物联网平台分配获得。 **取值范围**：长度不超过128，只允许字母、数字、下划线（_）、连接符（-）的组合。

        :return: The device_id of this DeleteDeviceMessageRequest.
        :rtype: str
        """
    ...
    def device_id(self, device_id):
        r"""Sets the device_id of this DeleteDeviceMessageRequest.

        **参数说明**：下发消息的设备ID，用于唯一标识一个设备，在注册设备时由物联网平台分配获得。 **取值范围**：长度不超过128，只允许字母、数字、下划线（_）、连接符（-）的组合。

        :param device_id: The device_id of this DeleteDeviceMessageRequest.
        :type device_id: str
        """
    ...
    def instance_id(self):
        r"""Gets the instance_id of this DeleteDeviceMessageRequest.
        ...
        **参数说明**：实例ID。物理多租下各实例的唯一标识，建议携带该参数，在使用专业版时必须携带该参数。您可以在IoTDA管理控制台界面，选择左侧导航栏“总览”页签查看当前实例的ID，具体获取方式请参考[[查看实例详情](https://support.huaweicloud.com/usermanual-iothub/iot_01_0121.html)](tag:hws) [[查看实例详情](https://support.huaweicloud.com/intl/zh-cn/usermanual-iothub/iot_01_0121.html)](tag:hws_hk)。
        ...
        :return: The instance_id of this DeleteDeviceMessageRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this DeleteDeviceMessageRequest.

        **参数说明**：实例ID。物理多租下各实例的唯一标识，建议携带该参数，在使用专业版时必须携带该参数。您可以在IoTDA管理控制台界面，选择左侧导航栏“总览”页签查看当前实例的ID，具体获取方式请参考[[查看实例详情](https://support.huaweicloud.com/usermanual-iothub/iot_01_0121.html)](tag:hws) [[查看实例详情](https://support.huaweicloud.com/intl/zh-cn/usermanual-iothub/iot_01_0121.html)](tag:hws_hk)。

        :param instance_id: The instance_id of this DeleteDeviceMessageRequest.
        :type instance_id: str
        """
    ...
    @property
    def message_id(self):
        r"""Gets the message_id of this DeleteDeviceMessageRequest.

        **参数说明**：下发消息的消息ID，用于唯一标识一个消息，在消息下发时由物联网平台分配获得。 **取值范围**：长度不超过100，只允许字母、数字、下划线（_）、连接符（-）的组合。

        :return: The message_id of this DeleteDeviceMessageRequest.
        :rtype: str
        """
    ...
    def message_id(self, message_id):
        r"""Sets the message_id of this DeleteDeviceMessageRequest.

        **参数说明**：下发消息的消息ID，用于唯一标识一个消息，在消息下发时由物联网平台分配获得。 **取值范围**：长度不超过100，只允许字母、数字、下划线（_）、连接符（-）的组合。

        :param message_id: The message_id of this DeleteDeviceMessageRequest.
        :type message_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteDeviceMessageRequest):
            return False
