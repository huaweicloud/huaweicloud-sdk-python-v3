...
class UpdateRoutingRuleRequest:
    ...
    def __init__(self, stage_auth_token=None, instance_id=None, rule_id=None, body=None):
    ...
    def stage_auth_token(self):
        """Gets the stage_auth_token of this UpdateRoutingRuleRequest.


        :return: The stage_auth_token of this UpdateRoutingRuleRequest.
        :rtype: str
        """
    ...
    def stage_auth_token(self, stage_auth_token):
        """Sets the stage_auth_token of this UpdateRoutingRuleRequest.


        :param stage_auth_token: The stage_auth_token of this UpdateRoutingRuleRequest.
        :type: str
        """
