...
class FunctionDTO:
    ...
    def app_id(self):
        ...
        **参数说明**：资源空间ID。此参数为非必选参数，存在多资源空间的用户需要使用该接口时，可以携带该参数查询指定资源空间下的产品列表，不携带该参数则会查询该用户下所有产品列表。 **取值范围**：长度不超过36，只允许字母、数字、下划线（_）、连接符（-）的组合。
        ...
        :return: The app_id of this FunctionDTO.
        :rtype: str
        """
        return self._app_id
    ...
    def app_id(self, app_id):
        ...
        **参数说明**：资源空间ID。此参数为非必选参数，存在多资源空间的用户需要使用该接口时，可以携带该参数查询指定资源空间下的产品列表，不携带该参数则会查询该用户下所有产品列表。 **取值范围**：长度不超过36，只允许字母、数字、下划线（_）、连接符（-）的组合。
        ...
        :param app_id: The app_id of this FunctionDTO.
        :type app_id: str
        """
        self._app_id = app_id
    ...
    def product_id(self):
        ...
        **参数说明**：设备关联的产品ID，用于唯一标识一个产品模型，创建产品后获得。方法请参见 [[创建产品](https://support.huaweicloud.com/api-iothub/iot_06_v5_0050.html)](tag:hws)[[创建产品](https://support.huaweicloud.com/intl/zh-cn/api-iothub/iot_06_v5_0050.html)](tag:hws_hk)。 **取值范围**：长度不超过36，只允许字母、数字、下划线（_）、连接符（-）的组合。
        ...
        :return: The product_id of this FunctionDTO.
        :rtype: str
        """
    ...
    def product_id(self, product_id):
        ...
        **参数说明**：设备关联的产品ID，用于唯一标识一个产品模型，创建产品后获得。方法请参见 [[创建产品](https://support.huaweicloud.com/api-iothub/iot_06_v5_0050.html)](tag:hws)[[创建产品](https://support.huaweicloud.com/intl/zh-cn/api-iothub/iot_06_v5_0050.html)](tag:hws_hk)。 **取值范围**：长度不超过36，只允许字母、数字、下划线（_）、连接符（-）的组合。
        ...
        :param product_id: The product_id of this FunctionDTO.
        :type product_id: str
        """
    ...
    def function_id(self):
        ...
        **参数说明**：函数ID，产品配置函数后生成的唯一标识。 **取值范围**：长度不超过36，只允许字母、数字、下划线（_）、连接符（-）的组合。
        ...
        :return: The function_id of this FunctionDTO.
        :rtype: str
        """
    ...
    def function_id(self, function_id):
        ...
        **参数说明**：函数ID，产品配置函数后生成的唯一标识。 **取值范围**：长度不超过36，只允许字母、数字、下划线（_）、连接符（-）的组合。
        ...
        :param function_id: The function_id of this FunctionDTO.
        :type function_id: str
        """
    ...
    def urn(self):
        ...
        **参数说明**：产品关联函数的URN（Uniform Resource Name）。 **取值范围**：长度不超过128，只允许字母、数字、下划线（_）、连接符（-）、分隔符（:）的组合。
        ...
        :return: The urn of this FunctionDTO.
        :rtype: str
        """
        return self._urn
    ...
    def urn(self, urn):
        ...
        **参数说明**：产品关联函数的URN（Uniform Resource Name）。 **取值范围**：长度不超过128，只允许字母、数字、下划线（_）、连接符（-）、分隔符（:）的组合。
        ...
        :param urn: The urn of this FunctionDTO.
        :type urn: str
        """
        self._urn = urn
    ...
    def description(self):
        ...
        **参数说明**：编解码函数描述信息。 **取值范围**：128，只允许中文、字母、数字、以及_? '#().,&%@!-等字符的组合。
        ...
        :return: The description of this FunctionDTO.
        :rtype: str
        """
    ...
    def description(self, description):
        ...
        **参数说明**：编解码函数描述信息。 **取值范围**：128，只允许中文、字母、数字、以及_? '#().,&%@!-等字符的组合。
        ...
        :param description: The description of this FunctionDTO.
        :type description: str
        """
    ...
    def create_time(self):
        ...
        **参数说明**：产品函数创建时间。**格式**：yyyyMMdd'T'HHmmss'Z'，如20151212T121212Z。
        ...
        :return: The create_time of this FunctionDTO.
        :rtype: str
        """
    ...
    def create_time(self, create_time):
        ...
        **参数说明**：产品函数创建时间。**格式**：yyyyMMdd'T'HHmmss'Z'，如20151212T121212Z。
        ...
        :param create_time: The create_time of this FunctionDTO.
        :type create_time: str
        """
