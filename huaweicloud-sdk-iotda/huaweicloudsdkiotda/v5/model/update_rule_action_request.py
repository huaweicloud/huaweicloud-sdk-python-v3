...
class UpdateRuleActionRequest:
    ...
    def instance_id(self):
        r"""Gets the instance_id of this UpdateRuleActionRequest.
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this UpdateRuleActionRequest.
    ...
    @property
    def action_id(self):
        r"""Gets the action_id of this UpdateRuleActionRequest.
    ...
    def action_id(self, action_id):
        r"""Sets the action_id of this UpdateRuleActionRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this UpdateRuleActionRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this UpdateRuleActionRequest.
