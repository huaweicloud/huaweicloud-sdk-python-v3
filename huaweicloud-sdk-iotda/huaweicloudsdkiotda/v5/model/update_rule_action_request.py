...
class UpdateRuleActionRequest:
    ...
    def __init__(self, stage_auth_token=None, instance_id=None, action_id=None, body=None):
    ...
    def stage_auth_token(self):
        """Gets the stage_auth_token of this UpdateRuleActionRequest.


        :return: The stage_auth_token of this UpdateRuleActionRequest.
        :rtype: str
        """
    ...
    def stage_auth_token(self, stage_auth_token):
        """Sets the stage_auth_token of this UpdateRuleActionRequest.


        :param stage_auth_token: The stage_auth_token of this UpdateRuleActionRequest.
        :type: str
        """
