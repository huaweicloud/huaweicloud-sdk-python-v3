...
class CreateOtaPackageResponse(SdkResponse):
    ...
    def __init__(self, package_id=None, app_id=None, package_type=None, product_id=None, product_name=None, module_name=None, version=None, support_source_versions=None, description=None, custom_info=None, create_time=None, file_location=None):
    ...
    def package_id(self):
        ...
        **参数说明**：升级包ID，用于唯一标识一个升级包。由物联网平台分配获得。 **取值范围**：长度不超过36，只允许字母、数字、连接符（-）的组合。
        ...
        :return: The package_id of this CreateOtaPackageResponse.
        :rtype: str
        """
    ...
    def package_id(self, package_id):
        ...
        **参数说明**：升级包ID，用于唯一标识一个升级包。由物联网平台分配获得。 **取值范围**：长度不超过36，只允许字母、数字、连接符（-）的组合。
        ...
        :param package_id: The package_id of this CreateOtaPackageResponse.
        :type package_id: str
        """
    ...
    def app_id(self):
        ...
        **参数说明**：资源空间ID。 **取值范围**：长度不超过36，只允许字母、数字、下划线（_）、连接符（-）的组合。
        ...
        :return: The app_id of this CreateOtaPackageResponse.
        :rtype: str
        """
        return self._app_id
    ...
    def app_id(self, app_id):
        ...
        **参数说明**：资源空间ID。 **取值范围**：长度不超过36，只允许字母、数字、下划线（_）、连接符（-）的组合。
        ...
        :param app_id: The app_id of this CreateOtaPackageResponse.
        :type app_id: str
        """
        self._app_id = app_id
    ...
    def package_type(self):
        ...
        **参数说明**：升级包类型。 **取值范围**：软件包必须设置为：softwarePackage，固件包必须设置为：firmwarePackage。
        ...
        :return: The package_type of this CreateOtaPackageResponse.
        :rtype: str
        """
    ...
    def package_type(self, package_type):
        ...
        **参数说明**：升级包类型。 **取值范围**：软件包必须设置为：softwarePackage，固件包必须设置为：firmwarePackage。
        ...
        :param package_type: The package_type of this CreateOtaPackageResponse.
        :type package_type: str
        """
    ...
    def product_id(self):
        ...
        **参数说明**：设备关联的产品ID，用于唯一标识一个产品模型，创建产品后获得。方法请参见 [[创建产品](https://support.huaweicloud.com/api-iothub/iot_06_v5_0050.html)](tag:hws)[[创建产品](https://support.huaweicloud.com/intl/zh-cn/api-iothub/iot_06_v5_0050.html)](tag:hws_hk)。 **取值范围**：长度不超过36，只允许字母、数字、下划线（_）、连接符（-）的组合。
        ...
        :return: The product_id of this CreateOtaPackageResponse.
        :rtype: str
        """
    ...
    def product_id(self, product_id):
        ...
        **参数说明**：设备关联的产品ID，用于唯一标识一个产品模型，创建产品后获得。方法请参见 [[创建产品](https://support.huaweicloud.com/api-iothub/iot_06_v5_0050.html)](tag:hws)[[创建产品](https://support.huaweicloud.com/intl/zh-cn/api-iothub/iot_06_v5_0050.html)](tag:hws_hk)。 **取值范围**：长度不超过36，只允许字母、数字、下划线（_）、连接符（-）的组合。
        ...
        :param product_id: The product_id of this CreateOtaPackageResponse.
        :type product_id: str
        """
    ...
    def product_name(self):
        r"""Gets the product_name of this CreateOtaPackageResponse.

        设备关联的产品名称

        :return: The product_name of this CreateOtaPackageResponse.
        :rtype: str
        """
    ...
    def product_name(self, product_name):
        r"""Sets the product_name of this CreateOtaPackageResponse.

        设备关联的产品名称

        :param product_name: The product_name of this CreateOtaPackageResponse.
        :type product_name: str
        """
    ...
    def module_name(self):
        r"""Gets the module_name of this CreateOtaPackageResponse.

        **参数说明**：OTA模块名称，产品下唯一且不可修改。 **取值范围**：长度不超过64，号只允许字母、数字、下划线（_）、连接符（-）、英文点（.）的组合。

        :return: The module_name of this CreateOtaPackageResponse.
        :rtype: str
        """
    ...
    def module_name(self, module_name):
        r"""Sets the module_name of this CreateOtaPackageResponse.

        **参数说明**：OTA模块名称，产品下唯一且不可修改。 **取值范围**：长度不超过64，号只允许字母、数字、下划线（_）、连接符（-）、英文点（.）的组合。

        :param module_name: The module_name of this CreateOtaPackageResponse.
        :type module_name: str
        """
    ...
    def version(self):
        ...
        **参数说明**：升级包版本号。 **取值范围**：长度不超过256，只允许字母、数字、下划线（_）、连接符（-）、英文点（.）的组合。
        ...
        :return: The version of this CreateOtaPackageResponse.
        :rtype: str
        """
    ...
    def version(self, version):
        ...
        **参数说明**：升级包版本号。 **取值范围**：长度不超过256，只允许字母、数字、下划线（_）、连接符（-）、英文点（.）的组合。
        ...
        :param version: The version of this CreateOtaPackageResponse.
        :type version: str
        """
    ...
    def support_source_versions(self):
        ...
        **参数说明**：支持用于升级此版本包的设备源版本号列表。最多支持20个源版本号。 **取值范围**：源版本号列表，源版本号只允许字母、数字、下划线（_）、连接符（-）、英文点（.）的组合。
        ...
        :return: The support_source_versions of this CreateOtaPackageResponse.
        :rtype: list[str]
        """
    ...
    def support_source_versions(self, support_source_versions):
        ...
        **参数说明**：支持用于升级此版本包的设备源版本号列表。最多支持20个源版本号。 **取值范围**：源版本号列表，源版本号只允许字母、数字、下划线（_）、连接符（-）、英文点（.）的组合。
        ...
        :param support_source_versions: The support_source_versions of this CreateOtaPackageResponse.
        :type support_source_versions: list[str]
        """
    ...
    def description(self):
        ...
        **参数说明**：用于描述升级包的功能等信息。 **取值范围**：长度不超过1024。
        ...
        :return: The description of this CreateOtaPackageResponse.
        :rtype: str
        """
    ...
    def description(self, description):
        ...
        **参数说明**：用于描述升级包的功能等信息。 **取值范围**：长度不超过1024。
        ...
        :param description: The description of this CreateOtaPackageResponse.
        :type description: str
        """
    ...
    def custom_info(self):
        ...
        **参数说明**：推送给设备的自定义信息。添加该升级包完成，并创建升级任务后，物联网平台向设备下发升级通知时，会下发该自定义信息给设备。 **取值范围**：长度不超过4096。
        ...
        :return: The custom_info of this CreateOtaPackageResponse.
        :rtype: str
        """
    ...
    def custom_info(self, custom_info):
        ...
        **参数说明**：推送给设备的自定义信息。添加该升级包完成，并创建升级任务后，物联网平台向设备下发升级通知时，会下发该自定义信息给设备。 **取值范围**：长度不超过4096。
        ...
        :param custom_info: The custom_info of this CreateOtaPackageResponse.
        :type custom_info: str
        """
    ...
    def create_time(self):
        ...
        :return: The create_time of this CreateOtaPackageResponse.
        :rtype: str
        """
    ...
    def create_time(self, create_time):
        ...
        :param create_time: The create_time of this CreateOtaPackageResponse.
        :type create_time: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateOtaPackageResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateOtaPackageResponse):
            return False
