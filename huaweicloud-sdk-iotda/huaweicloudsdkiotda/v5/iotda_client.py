...
class IoTDAClient(Client):
    ...
    def create_app_certificate(self, request):
        """上传应用侧CA证书
    ...
    def delete_app_certificate(self, request):
        """删除应用侧CA证书
    ...
    def list_app_certificates(self, request):
        """查询应用侧CA证书列表
    ...
    def show_app_certificate(self, request):
        """查询应用侧CA证书
    ...
    def update_app_certificate(self, request):
        """更新应用侧CA证书
