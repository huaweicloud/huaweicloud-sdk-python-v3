...
class CbrAsyncClient(Client):
    ...
    def add_agent_path_async(self, request):
        r"""新增备份路径
    ...
    def show_feature_async(self, request):
        r"""查询指定特性
    ...
    def show_feature_async_invoker(self, request):
        http_info = self._show_feature_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_feature_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def update_expiration_time_async(self, request):
        r"""变更指定存储库备份过期时间
    ...
    def update_expiration_time_async_invoker(self, request):
        http_info = self._update_expiration_time_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_expiration_time_http_info(self, request):
        http_info = {
            "method": "PUT",
