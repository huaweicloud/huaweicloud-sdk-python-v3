...
class CreateVaultResponse(SdkResponse):
    ...
    @property
    def vault(self):
        r"""Gets the vault of this CreateVaultResponse.
    ...
    def vault(self, vault):
        r"""Sets the vault of this CreateVaultResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateVaultResponse.to_dict() is deprecated and no longer maintained, "
