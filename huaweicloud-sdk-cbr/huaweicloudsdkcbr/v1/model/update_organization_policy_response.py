...
class UpdateOrganizationPolicyResponse(SdkResponse):
    ...
    def __init__(self, policy=None):
        r"""UpdateOrganizationPolicyResponse
    ...
    @property
    def policy(self):
        r"""Gets the policy of this UpdateOrganizationPolicyResponse.
    ...
    def policy(self, policy):
        r"""Sets the policy of this UpdateOrganizationPolicyResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateOrganizationPolicyResponse.to_dict() is deprecated and no longer maintained, "
