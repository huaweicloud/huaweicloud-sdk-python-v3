...
class CbcProductInfoUpdate:
    ...
    @property
    def product_id(self):
        r"""Gets the product_id of this CbcProductInfoUpdate.

        产品标识，通过订购询价接口获得，长度限制：1-64，只能由字母、数字、“_”、“-”组成。。

        :return: The product_id of this CbcProductInfoUpdate.
        :rtype: str
        """
    ...
    def product_id(self, product_id):
        r"""Sets the product_id of this CbcProductInfoUpdate.

        产品标识，通过订购询价接口获得，长度限制：1-64，只能由字母、数字、“_”、“-”组成。。

        :param product_id: The product_id of this CbcProductInfoUpdate.
        :type product_id: str
        """
    ...
    def resource_size(self):
        r"""Gets the resource_size of this CbcProductInfoUpdate.

        资源容量大小，取值范围：10-10485760

        :return: The resource_size of this CbcProductInfoUpdate.
        :rtype: int
        """
    ...
    def resource_size(self, resource_size):
        r"""Sets the resource_size of this CbcProductInfoUpdate.

        资源容量大小，取值范围：10-10485760

        :param resource_size: The resource_size of this CbcProductInfoUpdate.
        :type resource_size: int
        """
    ...
    def resource_size_measure_id(self):
        r"""Gets the resource_size_measure_id of this CbcProductInfoUpdate.

        资源容量度量标识，枚举值17：GB

        :return: The resource_size_measure_id of this CbcProductInfoUpdate.
        :rtype: int
        """
    ...
    def resource_size_measure_id(self, resource_size_measure_id):
        r"""Sets the resource_size_measure_id of this CbcProductInfoUpdate.

        资源容量度量标识，枚举值17：GB

        :param resource_size_measure_id: The resource_size_measure_id of this CbcProductInfoUpdate.
        :type resource_size_measure_id: int
        """
    ...
    def resource_spec_code(self):
        r"""Gets the resource_spec_code of this CbcProductInfoUpdate.
    ...
    def resource_spec_code(self, resource_spec_code):
        r"""Sets the resource_spec_code of this CbcProductInfoUpdate.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CbcProductInfoUpdate):
            return False
