...
class CopyCheckpointRequest:
    ...
    def __init__(self, body=None):
        """CopyCheckpointRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CopyCheckpointRequest):
            return False
