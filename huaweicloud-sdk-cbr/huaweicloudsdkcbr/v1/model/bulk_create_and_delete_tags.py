...
class BulkCreateAndDeleteTags:
    ...
    @property
    def key(self):
        r"""Gets the key of this BulkCreateAndDeleteTags.
        ...
        :return: The key of this BulkCreateAndDeleteTags.
        :rtype: str
        """
        return self._key
    ...
    @key.setter
    def key(self, key):
        r"""Sets the key of this BulkCreateAndDeleteTags.

        键。 key最大长度为36个字符。 key不能为空字符串。 key前后空格会被丢弃。 key不能包含非打印字符ASCII(0-31)，“=”,“*”,“<”,“>”,“\\”,“,”,“|”,“/”。 [key只能由中文，字母，数字，“-”，“_”组成。](tag:hws,hws_hk,fcs_vm,ctc)   [key只能由字母，数字，“_”，“-”组成。](tag:dt,ocb,tlf,sbc,g42,hcso_dt,tm) 创建时如果请求体中存在重复key则报错。 创建时，不允许重复key，如果数据库存在就覆盖。 删除时，允许重复key。 删除时，如果删除的标签不存在，默认处理成功,删除时不对标签字符集范围做校验。 删除时tags结构体不能缺失，key不能为空，或者空字符串。

        :param key: The key of this BulkCreateAndDeleteTags.
        :type key: str
        """
        self._key = key
    ...
    @property
    def value(self):
        r"""Gets the value of this BulkCreateAndDeleteTags.
        ...
        :return: The value of this BulkCreateAndDeleteTags.
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        r"""Sets the value of this BulkCreateAndDeleteTags.

        值。 添加标签时value值必选，删除标签时value值可选。 value最大长度为43个字符。 value可以为空字符串。 value前后的空格会被丢弃。 value不能包含非打印字符ASCII(0-31)，“=”,“*”,“<”,“>”,“\\”,“,”,“|”,“/”。 [value只能由中文，字母，数字，“-”，“_”，“.”组成。](tag:hws,hws_hk,fcs_vm,ctc) [value只能由字母，数字，“_”，“-”组成。](tag:dt,ocb,tlf,sbc,g42,hcso_dt,tm)

        :param value: The value of this BulkCreateAndDeleteTags.
        :type value: str
        """
        self._value = value
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkCreateAndDeleteTags):
            return False
