...
class VaultCreateParameters:
    ...
    def combined_order(self, combined_order):
        ...
        :type combined_order: :class:`huaweicloudsdkcbr.v1.CombinedOrder`
        """
        self._combined_order = combined_order
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VaultCreateParameters):
            return False
