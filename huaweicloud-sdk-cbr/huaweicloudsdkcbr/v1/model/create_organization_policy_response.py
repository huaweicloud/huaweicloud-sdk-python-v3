...
class CreateOrganizationPolicyResponse(SdkResponse):
    ...
    def __init__(self, policy=None):
        r"""CreateOrganizationPolicyResponse
    ...
    @property
    def policy(self):
        r"""Gets the policy of this CreateOrganizationPolicyResponse.
    ...
    def policy(self, policy):
        r"""Sets the policy of this CreateOrganizationPolicyResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateOrganizationPolicyResponse.to_dict() is deprecated and no longer maintained, "
