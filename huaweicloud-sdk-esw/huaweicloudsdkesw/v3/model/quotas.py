...
class Quotas:
    ...
    def __init__(self, resources=None):
        ...
        :param resources: - 参数解释：配额信息列表。 - 约束限制：不涉及。 - 取值范围：instance。 - 默认取值：不涉及。
        :type resources: list[:class:`huaweicloudsdkesw.v3.QuotaObject`]
        """
    ...
    def resources(self):
        ...
        :rtype: list[:class:`huaweicloudsdkesw.v3.QuotaObject`]
        """
