...
class ListQuotasResponse(SdkResponse):
    ...
    def __init__(self, quotas=None, request_id=None):
        ...
        :param quotas: 
        :type quotas: :class:`huaweicloudsdkesw.v3.Quotas`
    ...
    def quotas(self):
        ...
        :rtype: :class:`huaweicloudsdkesw.v3.Quotas`
        """
        return self._quotas
    ...
    @property
    def request_id(self):
        r"""Gets the request_id of this ListQuotasResponse.
    ...
    def request_id(self, request_id):
        r"""Sets the request_id of this ListQuotasResponse.
