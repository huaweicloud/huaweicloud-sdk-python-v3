...
class DeleteConnectionRequest:
    ...
    def instance_id(self):
        r"""Gets the instance_id of this DeleteConnectionRequest.

        - 参数解释：ESW实例的唯一标识。 - 约束限制：带“-”的UUID格式。 - 取值范围：不涉及。 - 默认取值：不涉及。

        :return: The instance_id of this DeleteConnectionRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this DeleteConnectionRequest.

        - 参数解释：ESW实例的唯一标识。 - 约束限制：带“-”的UUID格式。 - 取值范围：不涉及。 - 默认取值：不涉及。

        :param instance_id: The instance_id of this DeleteConnectionRequest.
        :type instance_id: str
        """
