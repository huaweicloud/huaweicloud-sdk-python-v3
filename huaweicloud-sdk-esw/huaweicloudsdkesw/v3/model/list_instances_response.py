...
class ListInstancesResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, page_info=None, instances=None):
        ...
        :param instances: - 参数解释：查询实例列表响应体。 - 约束限制：不涉及。 - 取值范围：不涉及。 - 默认取值：不涉及。
        :type instances: list[:class:`huaweicloudsdkesw.v3.Instance`]
        """
    ...
    @property
    def request_id(self):
        r"""Gets the request_id of this ListInstancesResponse.

        - 参数解释：请求的唯一标识。 - 约束限制：UUID格式。 - 取值范围：不涉及。 - 默认取值：不涉及。

        :return: The request_id of this ListInstancesResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        r"""Sets the request_id of this ListInstancesResponse.

        - 参数解释：请求的唯一标识。 - 约束限制：UUID格式。 - 取值范围：不涉及。 - 默认取值：不涉及。

        :param request_id: The request_id of this ListInstancesResponse.
        :type request_id: str
        """
    ...
    def instances(self):
        ...
        :rtype: list[:class:`huaweicloudsdkesw.v3.Instance`]
        """
