...
class ListFlavorsResponse(SdkResponse):
    ...
    def __init__(self, flavors=None, request_id=None):
        r"""ListFlavorsResponse

        The model defined in huaweicloud sdk

        :param flavors: - 参数解释：查询实例规格列表的响应体。 - 约束限制：不涉及。 - 取值范围：不涉及。 - 默认取值：不涉及。
        :type flavors: list[:class:`huaweicloudsdkesw.v3.Flavor`]
    ...
    def flavors(self):
        ...
        :rtype: list[:class:`huaweicloudsdkesw.v3.Flavor`]
        """
