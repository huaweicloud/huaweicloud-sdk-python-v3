...
class EswRegion:
    _PROVIDER = RegionProviderChain.get_default_region_provider_chain("ESW")
    ...
    def value_of(cls, region_id, static_fields=None):
        ...
        raise KeyError("region_id '%s' is not in the following supported regions of service 'Esw': [%s]" % (
