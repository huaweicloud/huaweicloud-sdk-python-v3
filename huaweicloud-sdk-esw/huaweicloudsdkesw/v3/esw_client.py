...
class EswClient(Client):
    ...
    def new_builder(cls, clazz=None):
        if not clazz:
            ...
            if clazz.__name__ != "EswClient":
                raise TypeError("client type error, support client type is EswClient")
    ...
    def bind_vport_invoker(self, request):
        http_info = self._bind_vport_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _bind_vport_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def list_connections_all_instances(self, request):
        r"""查询二层连接列表
    ...
    def list_connections_all_instances_invoker(self, request):
        http_info = self._list_connections_all_instances_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_connections_all_instances_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_resource_jobs(self, request):
        r"""查询任务的执行状态
    ...
    def list_resource_jobs_invoker(self, request):
        http_info = self._list_resource_jobs_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_resource_jobs_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def unbind_vport_invoker(self, request):
        http_info = self._unbind_vport_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _unbind_vport_http_info(cls, request):
        http_info = {
            "method": "POST",
