...
class ExecuteGenerateReportRequest:
    ...
    openapi_types = {
        'body': 'ExecuteGenerateReportRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ExecuteGenerateReportRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExecuteGenerateReportRequest):
            return False
