...
class OcrClient(Client):
    ...
    def recognize_auto_id_doc_classification(self, request):
        r"""智能证件分类
    ...
    def recognize_auto_id_doc_classification_invoker(self, request):
        http_info = self._recognize_auto_id_doc_classification_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _recognize_auto_id_doc_classification_http_info(cls, request):
        http_info = {
            "method": "POST",
