...
class WaybillElectronicRequestBody:
    ...
    def __init__(self, image=None, url=None):
        r"""WaybillElectronicRequestBody
    ...
    @property
    def image(self):
        r"""Gets the image of this WaybillElectronicRequestBody.
    ...
    def image(self, image):
        r"""Sets the image of this WaybillElectronicRequestBody.
    ...
    @property
    def url(self):
        r"""Gets the url of this WaybillElectronicRequestBody.
    ...
    @url.setter
    def url(self, url):
        r"""Sets the url of this WaybillElectronicRequestBody.
