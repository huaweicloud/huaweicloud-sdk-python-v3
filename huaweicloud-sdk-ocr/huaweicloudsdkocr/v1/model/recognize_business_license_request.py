...
class RecognizeBusinessLicenseRequest:
    ...
    def __init__(self, enterprise_project_id=None, body=None):
        r"""RecognizeBusinessLicenseRequest
    ...
    def enterprise_project_id(self):
        r"""Gets the enterprise_project_id of this RecognizeBusinessLicenseRequest.
    ...
    def enterprise_project_id(self, enterprise_project_id):
        r"""Sets the enterprise_project_id of this RecognizeBusinessLicenseRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this RecognizeBusinessLicenseRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this RecognizeBusinessLicenseRequest.
