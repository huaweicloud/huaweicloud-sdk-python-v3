...
class VietnamIdCardRequestBody:
    ...
    def __init__(self, image=None, url=None, side=None, return_portrait_image=None, return_portrait_location=None, return_idcard_type=None, return_text_location=None):
        ...
        :type url: str
        :param side: 证件图片正反面信息。可选值包括： - front：越南身份证正面 - back：越南身份证背面  如果参数值为空或无该参数，系统自动识别，建议填写，准确率更高。 
        :type side: str
        :param return_portrait_image: 是否返回头像内容开关，可选值如下所示： - true：返回身份证头像照片的 base64编码 - false：：不返回身份证头像照片的 base64编码  未传入该参数时默认为“false”，即不返回身份证头像照片的 base64 编码。 
        ...
        :param return_idcard_type: 是否返回身份证拍摄类型的开关，可选值如下所示： - true：返回身份证的类型，类型包括身份证原件以及身份证复印件。 - false：不返回身份证的类型。 
    ...
    @property
    def image(self):
        r"""Gets the image of this VietnamIdCardRequestBody.
        ...
        :return: The image of this VietnamIdCardRequestBody.
        :rtype: str
        """
        return self._image
    ...
    def image(self, image):
        r"""Sets the image of this VietnamIdCardRequestBody.

        与url二选一。 图片的Base64编码，要求单个图片其对应的Base64编码不超过10MB。文件在Base64编码后会大于文件原本大小，请注意做好边界判断，建议文件大小不超过7MB。 图片最小边不小于15像素，最长边不超过8192像素。支持JPG/PNG/BMP/TIFF格式。 

        :param image: The image of this VietnamIdCardRequestBody.
        :type image: str
        """
        self._image = image
    ...
    @property
    def url(self):
        r"""Gets the url of this VietnamIdCardRequestBody.
        ...
        :return: The url of this VietnamIdCardRequestBody.
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        r"""Sets the url of this VietnamIdCardRequestBody.

        与image二选一。  单个图片其对应的Base64编码不超过10MB。文件在Base64编码后会大于文件原本大小，请注意做好边界判断，建议文件大小不超过7MB。 图片最小边不小于15像素，最长边不超过8192像素。支持JPG/PNG/BMP/TIFF格式。 图片的url路径，目前支持： - 公网http/https url - OBS提供的url，使用OBS数据需要进行授权。包括对服务授权、临时授权、匿名公开授权，详情参见[配置OBS访问权限](https://support.huaweicloud.com/intl/zh-cn/api-ocr/ocr_03_0132.html)>。 > 说明： - 接口响应时间依赖于图片的下载时间，如果图片下载时间过长，会返回接口调用失败。 - 请保证被检测图片所在的存储服务稳定可靠，推荐使用OBS服务存储图片数据。 - url中不能存在中文字符，若存在，中文需要进行utf8编码。 

        :param url: The url of this VietnamIdCardRequestBody.
        :type url: str
        """
        self._url = url
    ...
    @property
    def side(self):
        r"""Gets the side of this VietnamIdCardRequestBody.

        证件图片正反面信息。可选值包括： - front：越南身份证正面 - back：越南身份证背面  如果参数值为空或无该参数，系统自动识别，建议填写，准确率更高。 

        :return: The side of this VietnamIdCardRequestBody.
        :rtype: str
        """
        return self._side
    ...
    @side.setter
    def side(self, side):
        r"""Sets the side of this VietnamIdCardRequestBody.

        证件图片正反面信息。可选值包括： - front：越南身份证正面 - back：越南身份证背面  如果参数值为空或无该参数，系统自动识别，建议填写，准确率更高。 

        :param side: The side of this VietnamIdCardRequestBody.
        :type side: str
        """
        self._side = side
    ...
    def return_portrait_image(self):
        r"""Gets the return_portrait_image of this VietnamIdCardRequestBody.

        是否返回头像内容开关，可选值如下所示： - true：返回身份证头像照片的 base64编码 - false：：不返回身份证头像照片的 base64编码  未传入该参数时默认为“false”，即不返回身份证头像照片的 base64 编码。 

        :return: The return_portrait_image of this VietnamIdCardRequestBody.
        :rtype: bool
        """
    ...
    def return_portrait_image(self, return_portrait_image):
        r"""Sets the return_portrait_image of this VietnamIdCardRequestBody.

        是否返回头像内容开关，可选值如下所示： - true：返回身份证头像照片的 base64编码 - false：：不返回身份证头像照片的 base64编码  未传入该参数时默认为“false”，即不返回身份证头像照片的 base64 编码。 

        :param return_portrait_image: The return_portrait_image of this VietnamIdCardRequestBody.
        :type return_portrait_image: bool
        """
    ...
    def return_portrait_location(self):
        r"""Gets the return_portrait_location of this VietnamIdCardRequestBody.

        是否返回头像坐标的开关，可选值如下所示： - true：返回身份证头像的位置 - false：不返回身份证头像的位置 

        :return: The return_portrait_location of this VietnamIdCardRequestBody.
        :rtype: bool
        """
    ...
    def return_portrait_location(self, return_portrait_location):
        r"""Sets the return_portrait_location of this VietnamIdCardRequestBody.

        是否返回头像坐标的开关，可选值如下所示： - true：返回身份证头像的位置 - false：不返回身份证头像的位置 

        :param return_portrait_location: The return_portrait_location of this VietnamIdCardRequestBody.
        :type return_portrait_location: bool
        """
    ...
    def return_idcard_type(self):
        r"""Gets the return_idcard_type of this VietnamIdCardRequestBody.

        是否返回身份证拍摄类型的开关，可选值如下所示： - true：返回身份证的类型，类型包括身份证原件以及身份证复印件。 - false：不返回身份证的类型。 

        :return: The return_idcard_type of this VietnamIdCardRequestBody.
        :rtype: bool
        """
    ...
    def return_idcard_type(self, return_idcard_type):
        r"""Sets the return_idcard_type of this VietnamIdCardRequestBody.

        是否返回身份证拍摄类型的开关，可选值如下所示： - true：返回身份证的类型，类型包括身份证原件以及身份证复印件。 - false：不返回身份证的类型。 

        :param return_idcard_type: The return_idcard_type of this VietnamIdCardRequestBody.
        :type return_idcard_type: bool
        """
    ...
    def return_text_location(self):
        r"""Gets the return_text_location of this VietnamIdCardRequestBody.

        识别到的文字块的区域位置信息。可选值包括： - true：返回各个文字块区域 - false：不返回各个文字块区域  如果无该参数，系统默认不返回文字块区域。如果输入参数不是Boolean类型，则会报非法参数错误。 

        :return: The return_text_location of this VietnamIdCardRequestBody.
        :rtype: bool
        """
    ...
    def return_text_location(self, return_text_location):
        r"""Sets the return_text_location of this VietnamIdCardRequestBody.

        识别到的文字块的区域位置信息。可选值包括： - true：返回各个文字块区域 - false：不返回各个文字块区域  如果无该参数，系统默认不返回文字块区域。如果输入参数不是Boolean类型，则会报非法参数错误。 

        :param return_text_location: The return_text_location of this VietnamIdCardRequestBody.
        :type return_text_location: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VietnamIdCardRequestBody):
            return False
