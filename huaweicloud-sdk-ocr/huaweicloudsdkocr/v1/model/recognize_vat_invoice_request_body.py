...
class RecognizeVatInvoiceRequestBody:
    ...
    @property
    def url(self):
        """Gets the url of this RecognizeVatInvoiceRequestBody.
        ...
        :return: The url of this RecognizeVatInvoiceRequestBody.
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this RecognizeVatInvoiceRequestBody.

        图片的URL路径，目前支持：  - 公网HTTP/HTTPS URL  - 华为云OBS提供的URL，使用OBS数据需要进行授权。包括对服务授权、临时授权、匿名公开授权。详请参见配置OBS访问权限。  > 说明：  - 接口响应时间依赖图片的下载时间，如果图片下载时间过长，会返回接口调用失败。请保证被检测图片所在的存储服务稳定可靠，建议您使用华为云OBS存储。 

        :param url: The url of this RecognizeVatInvoiceRequestBody.
        :type: str
        """
        self._url = url
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecognizeVatInvoiceRequestBody):
            return False
