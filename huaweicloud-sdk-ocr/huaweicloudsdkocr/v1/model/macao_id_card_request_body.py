...
class MacaoIdCardRequestBody:
    ...
    def __init__(self, image=None, url=None, side=None, return_portrait_image=None):
        r"""MacaoIdCardRequestBody

        The model defined in huaweicloud sdk

        :param image: 与url二选一。 图片的Base64编码，要求单个图片其对应的Base64编码不超过10MB。文件在Base64编码后会大于文件原本大小，请注意做好边界判断，建议文件大小不超过7MB。 图片最小边不小于15像素，最长边不超过8192像素。支持JPG/PNG/BMP/TIFF格式。 图片Base64编码示例 如/9j/4AAQSkZJRgABAg...，带有多余前缀会产生The image format is not supported报错。 
        :type image: str
    ...
    @property
    def image(self):
        r"""Gets the image of this MacaoIdCardRequestBody.

        与url二选一。 图片的Base64编码，要求单个图片其对应的Base64编码不超过10MB。文件在Base64编码后会大于文件原本大小，请注意做好边界判断，建议文件大小不超过7MB。 图片最小边不小于15像素，最长边不超过8192像素。支持JPG/PNG/BMP/TIFF格式。 图片Base64编码示例 如/9j/4AAQSkZJRgABAg...，带有多余前缀会产生The image format is not supported报错。 
    ...
    def image(self, image):
        r"""Sets the image of this MacaoIdCardRequestBody.
    ...
    @property
    def url(self):
        r"""Gets the url of this MacaoIdCardRequestBody.
    ...
    @url.setter
    def url(self, url):
        r"""Sets the url of this MacaoIdCardRequestBody.
    ...
    @property
    def side(self):
        r"""Gets the side of this MacaoIdCardRequestBody.
    ...
    @side.setter
    def side(self, side):
        r"""Sets the side of this MacaoIdCardRequestBody.
    ...
    def return_portrait_image(self):
        r"""Gets the return_portrait_image of this MacaoIdCardRequestBody.
    ...
    def return_portrait_image(self, return_portrait_image):
        r"""Sets the return_portrait_image of this MacaoIdCardRequestBody.
