...
class PassportRequestBody:
    ...
    def __init__(self, image=None, url=None, country_code=None):
        ...
        :param image: 与url二选一  图像数据，base64编码，要求base64编码后大小不超过10MB。图片最小边不小于15px，最长边不超过8192px，支持JPEG、JPG、PNG、BMP、TIFF格式。  图片文件Base64编码字符串，[点击[这里](https://support.huaweicloud.com/ocr_faq/ocr_01_0032.html)](tag:hc)[点击[这里](https://support.huaweicloud.com/intl/zh-cn/ocr_faq/ocr_01_0032.html)](tag:hk)查看详细获取方式。     
        :type image: str
        ...
        :type url: str
        :param country_code: 输入值为护照颁发国的国家码，根据国家码选择对应的护照识别服务。  - 若输入中未选此字段，服务会根据自己识别判断的护照类型匹配相应的护照识别服务。  - 若选择值为GENERAL，则选择护照机器码识别。  - 若选择值为CHN，则选择中国护照全字段识别。 
    ...
    def image(self):
        ...
        :return: The image of this PassportRequestBody.
        :rtype: str
        """
        return self._image
    ...
    def image(self, image):
        ...
        :param image: The image of this PassportRequestBody.
        :type image: str
        """
        self._image = image
    ...
    def url(self):
        ...
        :return: The url of this PassportRequestBody.
        :rtype: str
        """
        return self._url
    ...
    def url(self, url):
        ...
        :param url: The url of this PassportRequestBody.
        :type url: str
        """
        self._url = url
    ...
    def country_code(self):
        ...
        :return: The country_code of this PassportRequestBody.
        :rtype: str
        """
    ...
    def country_code(self, country_code):
        ...
        :param country_code: The country_code of this PassportRequestBody.
        :type country_code: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PassportRequestBody):
            return False
