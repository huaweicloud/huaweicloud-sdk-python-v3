...
class SmartDocumentRecognizerCharList:
    ...
    def __init__(self, char=None, char_confidence=None, char_location=None):
        r"""SmartDocumentRecognizerCharList
    ...
    @property
    def char(self):
        r"""Gets the char of this SmartDocumentRecognizerCharList.

        单字符识别结果。 

        :return: The char of this SmartDocumentRecognizerCharList.
        :rtype: str
        """
        return self._char
    ...
    @char.setter
    def char(self, char):
        r"""Sets the char of this SmartDocumentRecognizerCharList.

        单字符识别结果。 

        :param char: The char of this SmartDocumentRecognizerCharList.
        :type char: str
        """
        self._char = char
    ...
    def char_confidence(self):
        r"""Gets the char_confidence of this SmartDocumentRecognizerCharList.

        单字符的置信度，置信度越大，表示本次识别的文字的可靠性越高，在统计意义上，置信度越大，准确率越高。置信度由算法给出，不直接等价于对应字段的准确率。 

        :return: The char_confidence of this SmartDocumentRecognizerCharList.
        :rtype: float
        """
    ...
    def char_confidence(self, char_confidence):
        r"""Sets the char_confidence of this SmartDocumentRecognizerCharList.

        单字符的置信度，置信度越大，表示本次识别的文字的可靠性越高，在统计意义上，置信度越大，准确率越高。置信度由算法给出，不直接等价于对应字段的准确率。 

        :param char_confidence: The char_confidence of this SmartDocumentRecognizerCharList.
        :type char_confidence: float
        """
    ...
    def char_location(self):
        r"""Gets the char_location of this SmartDocumentRecognizerCharList.

        单字符的位置信息，列表形式，分别表示文字块4个顶点的x, y坐标;坐标原点为图片左上角，x轴沿水平方向，y轴沿竖直方向。 

        :return: The char_location of this SmartDocumentRecognizerCharList.
        :rtype: list[list[int]]
        """
    ...
    def char_location(self, char_location):
        r"""Sets the char_location of this SmartDocumentRecognizerCharList.

        单字符的位置信息，列表形式，分别表示文字块4个顶点的x, y坐标;坐标原点为图片左上角，x轴沿水平方向，y轴沿竖直方向。 

        :param char_location: The char_location of this SmartDocumentRecognizerCharList.
        :type char_location: list[list[int]]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SmartDocumentRecognizerCharList):
            return False
