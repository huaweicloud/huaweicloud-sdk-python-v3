...
class IdDocumentRequestBody:
    ...
    def __init__(self, image=None, url=None, country_region=None, id_type=None, return_portrait_image=None):
        r"""IdDocumentRequestBody

        The model defined in huaweicloud sdk

        :param image: 该参数与url二选一。  图片的Base64编码，要求单个图片其对应的Base64编码不超过10MB。文件在Base64编码后会大于文件原本大小，请注意做好边界判断，建议文件大小不超过7MB。 图片最小边不小于100px，最长边不超过8192px，支持JPEG、JPG、PNG、BMP、TIFF。 
        :type image: str
        :param url: 该参数与image二选一。  单个图片其对应的Base64编码不超过10MB。文件在Base64编码后会大于文件原本大小，请注意做好边界判断，建议文件大小不超过7MB。 图片最小边不小于100px，最长边不超过8192px，支持JPEG、JPG、PNG、BMP、TIFF。 图片的url路径，目前支持： Image URL. Currently, the following URLs are supported: - 公网http/https url - OBS提供的url，使用OBS数据需要进行授权。包括对服务授权、临时授权、匿名公开授权。 &gt; 说明: - 接口响应时间依赖于图片的下载时间，如果图片下载时间过长，会返回接口调用失败。 - 请保证被检测图片所在的存储服务稳定可靠，推荐使用OBS服务存储图片数据。 - url中不能存在中文字符，若存在，中文需要进行utf8编码。 
        :type url: str
    ...
    @property
    def image(self):
        r"""Gets the image of this IdDocumentRequestBody.
    ...
    def image(self, image):
        r"""Sets the image of this IdDocumentRequestBody.
    ...
    @property
    def url(self):
        r"""Gets the url of this IdDocumentRequestBody.
    ...
    @url.setter
    def url(self, url):
        r"""Sets the url of this IdDocumentRequestBody.
    ...
    def country_region(self):
        r"""Gets the country_region of this IdDocumentRequestBody.
    ...
    def country_region(self, country_region):
        r"""Sets the country_region of this IdDocumentRequestBody.
    ...
    @property
    def id_type(self):
        r"""Gets the id_type of this IdDocumentRequestBody.
    ...
    def id_type(self, id_type):
        r"""Sets the id_type of this IdDocumentRequestBody.
    ...
    def return_portrait_image(self):
        r"""Gets the return_portrait_image of this IdDocumentRequestBody.
    ...
    def return_portrait_image(self, return_portrait_image):
        r"""Sets the return_portrait_image of this IdDocumentRequestBody.
