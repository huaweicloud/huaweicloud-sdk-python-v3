...
class MainlandTravelPermitRequestBody:
    ...
    def __init__(self, image=None, url=None, return_portrait_image=None, return_portrait_location=None):
        r"""MainlandTravelPermitRequestBody

        The model defined in huaweicloud sdk

        :param image: 与url二选一。  图片的Base64编码，要求单个图片其对应的Base64编码不超过10MB。文件在Base64编码后会大于文件原本大小，请注意做好边界判断，建议文件大小不超过7MB。 图片尺寸不小于15×15像素，最长边不超过8192像素，支持JPG/PNG/BMP/TIFF格式。 
        :type image: str
    ...
    @property
    def image(self):
        r"""Gets the image of this MainlandTravelPermitRequestBody.
    ...
    def image(self, image):
        r"""Sets the image of this MainlandTravelPermitRequestBody.
    ...
    @property
    def url(self):
        r"""Gets the url of this MainlandTravelPermitRequestBody.
    ...
    @url.setter
    def url(self, url):
        r"""Sets the url of this MainlandTravelPermitRequestBody.
    ...
    def return_portrait_image(self):
        r"""Gets the return_portrait_image of this MainlandTravelPermitRequestBody.
    ...
    def return_portrait_image(self, return_portrait_image):
        r"""Sets the return_portrait_image of this MainlandTravelPermitRequestBody.
    ...
    def return_portrait_location(self):
        r"""Gets the return_portrait_location of this MainlandTravelPermitRequestBody.
    ...
    def return_portrait_location(self, return_portrait_location):
        r"""Sets the return_portrait_location of this MainlandTravelPermitRequestBody.
