...
class ValidateRocketMqConsumedMessageResponse(SdkResponse):
    ...
    def __init__(self, resend_results=None):
        """ValidateRocketMqConsumedMessageResponse
        ...
        super(ValidateRocketMqConsumedMessageResponse, self).__init__()
    ...
    def resend_results(self):
        """Gets the resend_results of this ValidateRocketMqConsumedMessageResponse.

        消费验证结果。

        :return: The resend_results of this ValidateRocketMqConsumedMessageResponse.
    ...
    def resend_results(self, resend_results):
        """Sets the resend_results of this ValidateRocketMqConsumedMessageResponse.

        消费验证结果。

        :param resend_results: The resend_results of this ValidateRocketMqConsumedMessageResponse.
        :type resend_results: list[:class:`huaweicloudsdkrocketmq.v2.DeadletterResendRespResendResults`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ValidateRocketMqConsumedMessageResponse):
            return False
