...
class ListScheduledTasksResponse(SdkResponse):
    ...
    def __init__(self, job_count=None, jobs=None):
        ...
        :param job_count: **参数解释**： 任务总数。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        :type job_count: str
        :param jobs: **参数解释**： 任务列表。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        :type jobs: list[:class:`huaweicloudsdkrocketmq.v2.ScheduledTaskEntity`]
        """
    ...
    def jobs(self):
        ...
        **参数解释**： 任务列表。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        ...
        :rtype: list[:class:`huaweicloudsdkrocketmq.v2.ScheduledTaskEntity`]
        """
        return self._jobs
