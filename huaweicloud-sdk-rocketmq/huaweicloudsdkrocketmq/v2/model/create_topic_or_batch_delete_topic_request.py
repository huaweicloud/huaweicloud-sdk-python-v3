...
class CreateTopicOrBatchDeleteTopicRequest:
    ...
    openapi_types = {
        'instance_id': 'str',
        'action': 'str',
        'body': 'CreateTopicOrBatchDeleteTopicReq'
    }
    ...
    def __init__(self, instance_id=None, action=None, body=None):
        ...
        :param action: **参数解释**： 批量删除Topic时使用，不配置则为创建接口。 **约束限制**： 不涉及。 **取值范围**： - delete：批量删除Topic。 - 不填：创建Topic。 **默认取值**： 不涉及。
        :type action: str
    ...
    def instance_id(self):
        ...
        **参数解释**： 实例ID。获取方法如下：调用“查询所有实例列表”接口，从响应体中获取实例ID。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        ...
        :return: The instance_id of this CreateTopicOrBatchDeleteTopicRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        ...
        **参数解释**： 实例ID。获取方法如下：调用“查询所有实例列表”接口，从响应体中获取实例ID。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        ...
        :param instance_id: The instance_id of this CreateTopicOrBatchDeleteTopicRequest.
        :type instance_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateTopicOrBatchDeleteTopicRequest):
            return False
