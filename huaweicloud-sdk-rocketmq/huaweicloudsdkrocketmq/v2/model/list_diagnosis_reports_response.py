...
class ListDiagnosisReportsResponse(SdkResponse):
    ...
    @property
    def total_num(self):
        r"""Gets the total_num of this ListDiagnosisReportsResponse.
    ...
    def total_num(self, total_num):
        r"""Sets the total_num of this ListDiagnosisReportsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListDiagnosisReportsResponse.to_dict() is deprecated and no longer maintained, "
