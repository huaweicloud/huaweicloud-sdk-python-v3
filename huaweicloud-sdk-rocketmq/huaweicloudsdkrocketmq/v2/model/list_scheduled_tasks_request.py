...
class ListScheduledTasksRequest:
    ...
    def __init__(self, instance_id=None, start=None, limit=None, begin_time=None, end_time=None):
        ...
        :param start: **参数解释**： 开启查询的定时任务编号。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        :type start: str
        :param limit: **参数解释**： 查询的定时任务个数。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        :type limit: int
        :param begin_time: **参数解释**： 查询定时任务的最小时间，格式为YYYYMMDDHHmmss。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        :type begin_time: str
        :param end_time: **参数解释**： 查询定时任务的最大时间，格式为YYYYMMDDHHmmss。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        :type end_time: str
        """
    ...
    @property
    def start(self):
        r"""Gets the start of this ListScheduledTasksRequest.

        **参数解释**： 开启查询的定时任务编号。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :return: The start of this ListScheduledTasksRequest.
        :rtype: str
        """
        return self._start
    ...
    def start(self, start):
        r"""Sets the start of this ListScheduledTasksRequest.

        **参数解释**： 开启查询的定时任务编号。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :param start: The start of this ListScheduledTasksRequest.
        :type start: str
        """
        self._start = start
    ...
    @property
    def begin_time(self):
        r"""Gets the begin_time of this ListScheduledTasksRequest.

        **参数解释**： 查询定时任务的最小时间，格式为YYYYMMDDHHmmss。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :return: The begin_time of this ListScheduledTasksRequest.
        :rtype: str
        """
    ...
    def begin_time(self, begin_time):
        r"""Sets the begin_time of this ListScheduledTasksRequest.

        **参数解释**： 查询定时任务的最小时间，格式为YYYYMMDDHHmmss。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :param begin_time: The begin_time of this ListScheduledTasksRequest.
        :type begin_time: str
        """
