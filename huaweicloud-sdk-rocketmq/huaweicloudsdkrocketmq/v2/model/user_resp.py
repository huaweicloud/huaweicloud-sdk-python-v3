...
class UserResp:
    ...
    @property
    def access_key(self):
        r"""Gets the access_key of this UserResp.

        **参数解释**： 用户名。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :return: The access_key of this UserResp.
        :rtype: str
        """
    ...
    def access_key(self, access_key):
        r"""Sets the access_key of this UserResp.

        **参数解释**： 用户名。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :param access_key: The access_key of this UserResp.
        :type access_key: str
        """
    ...
    @property
    def secret_key(self):
        r"""Gets the secret_key of this UserResp.

        **参数解释**： 密钥。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :return: The secret_key of this UserResp.
        :rtype: str
        """
    ...
    def secret_key(self, secret_key):
        r"""Sets the secret_key of this UserResp.

        **参数解释**： 密钥。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :param secret_key: The secret_key of this UserResp.
        :type secret_key: str
        """
    ...
    def white_remote_address(self):
        r"""Gets the white_remote_address of this UserResp.

        **参数解释**： IP白名单。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :return: The white_remote_address of this UserResp.
        :rtype: str
        """
    ...
    def white_remote_address(self, white_remote_address):
        r"""Sets the white_remote_address of this UserResp.

        **参数解释**： IP白名单。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :param white_remote_address: The white_remote_address of this UserResp.
        :type white_remote_address: str
        """
    ...
    @property
    def admin(self):
        r"""Gets the admin of this UserResp.

        **参数解释**： 是否为管理员。 **约束限制**： 不涉及。 **取值范围**： - true：是管理员。 - false：不是管理员。 **默认取值**： 不涉及。

        :return: The admin of this UserResp.
        :rtype: bool
        """
        return self._admin
    ...
    def admin(self, admin):
        r"""Sets the admin of this UserResp.

        **参数解释**： 是否为管理员。 **约束限制**： 不涉及。 **取值范围**： - true：是管理员。 - false：不是管理员。 **默认取值**： 不涉及。

        :param admin: The admin of this UserResp.
        :type admin: bool
        """
        self._admin = admin
    ...
    def default_topic_perm(self):
        r"""Gets the default_topic_perm of this UserResp.

        **参数解释**： 默认的主题权限。 **约束限制**： 不涉及。 **取值范围**： - PUB：拥有发布权限。 - SUB：拥有订阅权限。 - PUB|SUB：拥有发布订阅权限。 - DENY：无权限。 **默认取值**： 不涉及。

        :return: The default_topic_perm of this UserResp.
        :rtype: str
        """
    ...
    def default_topic_perm(self, default_topic_perm):
        r"""Sets the default_topic_perm of this UserResp.

        **参数解释**： 默认的主题权限。 **约束限制**： 不涉及。 **取值范围**： - PUB：拥有发布权限。 - SUB：拥有订阅权限。 - PUB|SUB：拥有发布订阅权限。 - DENY：无权限。 **默认取值**： 不涉及。

        :param default_topic_perm: The default_topic_perm of this UserResp.
        :type default_topic_perm: str
        """
    ...
    def default_group_perm(self):
        r"""Gets the default_group_perm of this UserResp.

        **参数解释**： 默认的消费组权限。 **约束限制**： 不涉及。 **取值范围**： - SUB：拥有订阅权限。 - DENY：无权限。 **默认取值**： 不涉及。

        :return: The default_group_perm of this UserResp.
        :rtype: str
        """
    ...
    def default_group_perm(self, default_group_perm):
        r"""Sets the default_group_perm of this UserResp.

        **参数解释**： 默认的消费组权限。 **约束限制**： 不涉及。 **取值范围**： - SUB：拥有订阅权限。 - DENY：无权限。 **默认取值**： 不涉及。

        :param default_group_perm: The default_group_perm of this UserResp.
        :type default_group_perm: str
        """
    ...
    def topic_perms(self):
        r"""Gets the topic_perms of this UserResp.

        **参数解释**： 特殊的主题权限。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :return: The topic_perms of this UserResp.
    ...
    def topic_perms(self, topic_perms):
        r"""Sets the topic_perms of this UserResp.

        **参数解释**： 特殊的主题权限。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :param topic_perms: The topic_perms of this UserResp.
        :type topic_perms: list[:class:`huaweicloudsdkrocketmq.v2.UserTopicPerms`]
        """
    ...
    def group_perms(self):
        r"""Gets the group_perms of this UserResp.

        **参数解释**： 特殊的消费组权限。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :return: The group_perms of this UserResp.
    ...
    def group_perms(self, group_perms):
        r"""Sets the group_perms of this UserResp.

        **参数解释**： 特殊的消费组权限。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :param group_perms: The group_perms of this UserResp.
        :type group_perms: list[:class:`huaweicloudsdkrocketmq.v2.UserRespGroupPerms`]
        """
