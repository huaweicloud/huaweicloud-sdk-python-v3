...
class ListRocketInstanceTopicsResponse(SdkResponse):
    ...
    def __init__(self, total=None, max=None, remaining=None, next_offset=None, previous_offset=None, topics=None):
        ...
        :type total: int
        :param max: **参数解释**： 最大可创建Topic数量。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        :type max: int
        :param remaining: **参数解释**： 剩余可创建Topic数量。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        :type remaining: int
        ...
        :param topics: **参数解释**： 剩余可创建Topic数量。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    ...
    def max(self):
        ...
        **参数解释**： 最大可创建Topic数量。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    ...
    def remaining(self):
        ...
        **参数解释**： 剩余可创建Topic数量。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListRocketInstanceTopicsResponse.to_dict() is deprecated and no longer maintained, "
