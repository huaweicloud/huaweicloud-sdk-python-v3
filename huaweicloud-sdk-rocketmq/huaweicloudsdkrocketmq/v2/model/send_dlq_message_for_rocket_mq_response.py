...
class SendDlqMessageForRocketMqResponse(SdkResponse):
    ...
    def __init__(self, resend_results=None):
        r"""SendDlqMessageForRocketMqResponse
    ...
    def resend_results(self):
        r"""Gets the resend_results of this SendDlqMessageForRocketMqResponse.

        **参数解释**： 重发死信消息结果。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值** 不涉及。

        :return: The resend_results of this SendDlqMessageForRocketMqResponse.
    ...
    def resend_results(self, resend_results):
        r"""Sets the resend_results of this SendDlqMessageForRocketMqResponse.

        **参数解释**： 重发死信消息结果。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值** 不涉及。

        :param resend_results: The resend_results of this SendDlqMessageForRocketMqResponse.
        :type resend_results: list[:class:`huaweicloudsdkrocketmq.v2.DeadletterResendRespResendResults`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("SendDlqMessageForRocketMqResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SendDlqMessageForRocketMqResponse):
            return False
