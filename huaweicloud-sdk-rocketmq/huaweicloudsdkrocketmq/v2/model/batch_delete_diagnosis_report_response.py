...
class BatchDeleteDiagnosisReportResponse(SdkResponse):
    ...
    def __init__(self, report_id_list=None):
        r"""BatchDeleteDiagnosisReportResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchDeleteDiagnosisReportResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteDiagnosisReportResponse):
            return False
