...
class DiagnosisReq:
    ...
    @property
    def group_name(self):
        r"""Gets the group_name of this DiagnosisReq.

        **参数解释**： 消费组名称。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :return: The group_name of this DiagnosisReq.
        :rtype: str
        """
    ...
    def group_name(self, group_name):
        r"""Sets the group_name of this DiagnosisReq.

        **参数解释**： 消费组名称。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :param group_name: The group_name of this DiagnosisReq.
        :type group_name: str
        """
    ...
    def node_id_list(self):
        r"""Gets the node_id_list of this DiagnosisReq.

        **参数解释**： 节点ID列表。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :return: The node_id_list of this DiagnosisReq.
        :rtype: list[str]
        """
    ...
    def node_id_list(self, node_id_list):
        r"""Sets the node_id_list of this DiagnosisReq.

        **参数解释**： 节点ID列表。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :param node_id_list: The node_id_list of this DiagnosisReq.
        :type node_id_list: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DiagnosisReq):
            return False
