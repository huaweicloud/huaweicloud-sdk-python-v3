...
class ShowCeshierarchyRespDimensions:
    ...
    def __init__(self, name=None, metrics=None, key_name=None, dim_router=None, children=None):
        ...
        :param name: **参数解释**： 监控维度名称。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        :type name: str
        :param metrics: **参数解释**： 监控指标名称。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        :type metrics: list[str]
        :param key_name: **参数解释**： 监控查询使用的key。   **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        :type key_name: list[str]
        :param dim_router: **参数解释**： 监控维度路由。     **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        :type dim_router: list[str]
        :param children: **参数解释**： 子维度列表。     **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        :type children: list[:class:`huaweicloudsdkrocketmq.v2.ShowCeshierarchyRespChildren`]
        """
    ...
    def children(self):
        ...
        **参数解释**： 子维度列表。     **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        ...
        :rtype: list[:class:`huaweicloudsdkrocketmq.v2.ShowCeshierarchyRespChildren`]
        """
