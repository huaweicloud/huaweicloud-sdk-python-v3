...
class DeleteRocketMqMigrationTaskResponse(SdkResponse):
    ...
    def success_task_list(self):
        r"""Gets the success_task_list of this DeleteRocketMqMigrationTaskResponse.

        **参数解释**： 删除成功的任务列表。 **约束限制**： 不涉及。 **取值范围**： 不涉及 **默认取值**： 不涉及。

        :return: The success_task_list of this DeleteRocketMqMigrationTaskResponse.
        :rtype: list[str]
        """
    ...
    def success_task_list(self, success_task_list):
        r"""Sets the success_task_list of this DeleteRocketMqMigrationTaskResponse.

        **参数解释**： 删除成功的任务列表。 **约束限制**： 不涉及。 **取值范围**： 不涉及 **默认取值**： 不涉及。

        :param success_task_list: The success_task_list of this DeleteRocketMqMigrationTaskResponse.
        :type success_task_list: list[str]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteRocketMqMigrationTaskResponse.to_dict() is deprecated and no longer maintained, "
