...
class InstanceDetail:
    ...
    def __init__(self, name=None, engine=None, status=None, description=None, type=None, specification=None, engine_version=None, instance_id=None, arch_type=None, charging_mode=None, vpc_id=None, vpc_name=None, created_at=None, product_id=None, security_group_id=None, security_group_name=None, subnet_id=None, subnet_cidr=None, available_zones=None, available_zone_names=None, user_id=None, user_name=None, maintain_begin=None, maintain_end=None, enable_log_collection=None, storage_space=None, used_storage_space=None, enable_publicip=None, publicip_id=None, publicip_address=None, ssl_enable=None, cross_vpc_info=None, storage_resource_id=None, storage_spec_code=None, service_type=None, storage_type=None, extend_times=None, ipv6_enable=None, support_features=None, disk_encrypted=None, ces_version=None, node_num=None, new_spec_billing_enable=None, enable_acl=None, broker_num=None, dns_enable=None, namesrv_address=None, namesrv_domain_name=None, broker_address=None, public_namesrv_address=None, public_namesrv_domain_name=None, public_broker_address=None, grpc_address=None, grpc_domain_name=None, public_grpc_address=None, public_grpc_domain_name=None, enterprise_project_id=None, tags=None, total_storage_space=None, resource_spec_code=None, produce_portion=None, consume_portion=None, dr_enable=None, quota_address=None, max_msg_process_tps=None, config_ssl_need_restart_process=None, tls_mode=None, enable_elastic_tps=None):
        ...
        :type engine: str
        :param status: **参数解释**： 状态。 **约束限制**： 不涉及。 **取值范围**： [详细状态说明请参考[实例状态说明](hrm-api-0010.xml)。](tag:hws,hws_hk,ctc,hws_eu,ocb,g42,hk_g42,tm,sbc,hk_sbc,cmcc,hk_tm,dt,ax,srg)[详细状态说明请参考[实例状态说明](kafka-api-180514012.xml)。](tag:hcs,fcs,hcs_oemout) **默认取值**： 不涉及。
        :type status: str
        :param description: **参数解释**： 消息描述。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        :type description: str
        :param type: **参数解释**： 实例类型。 **约束限制**： 不涉及。 **取值范围**： [- single：4.8.0单机。](tag:hws,hws_eu,hws_hk,ocb,hws_ocb,ctc,g42,hk_g42,tm,sbc,hk_sbc,hk_tm,cmcc,ax,srg) [- cluster：4.8.0集群。](tag:hws,hws_eu,hws_hk,ocb,hws_ocb,ctc,g42,hk_g42,tm,sbc,hk_sbc,hk_tm,cmcc,ax,srg) [- single.basic：5.x单机基础版。](tag:hws,hws_hk,ctc,hws_eu,ocb,g42,hk_g42,tm,sbc,hk_sbc,hk_tm,dt,hcs,fcs,hcs_oemout,srg) [- cluster.basic：5.x集群基础版。](tag:hws,hws_hk,ctc,hws_eu,ocb,g42,hk_g42,tm,sbc,hk_sbc,hk_tm,dt,hcs,fcs,hcs_oemout,srg) [- cluster.professional：5.x集群专业版。](tag:hws,hws_eu,hws_hk,ctc,srg) **默认取值**： 不涉及。
        :type type: str
        :param specification: **参数解释**： 实例规格。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        :type specification: str
        :param engine_version: **参数解释**： 实例版本。 **约束限制**： 不涉及。 **取值范围**： [- 4.8.0](tag:hws,hws_eu,hws_hk,ocb,hws_ocb,ctc,g42,hk_g42,tm,sbc,hk_sbc,hk_tm,cmcc,ax,srg) [- 5.x](tag:hws,hws_hk,ctc,hws_eu,ocb,tm,sbc,hk_sbc,hk_tm,dt,hcs,fcs,srg,hcs_oemout) **默认取值**： 不涉及。
        :type engine_version: str
        :param instance_id: **参数解释**： 实例ID。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        :type instance_id: str
        :param arch_type: **参数解释**： 架构类型。 **取值范围**： - X86。 - ARM。
        :type arch_type: str
        :param charging_mode: **参数解释**： 付费模式。 **约束限制**： 不涉及。 **取值范围**： [1表示按需计费。](tag:hws_eu,g42,hk_g42,tm,sbc,hk_sbc,hk_tm,dt)[1表示按需计费，0表示包年/包月计费。](tag:hws,hws_eu,hws_hk,ctc,cmcc,ax) [计费模式，参数暂未使用。](tag:ocb,hws_ocb,hcs,fcs,hcs_oemout,srg) **默认取值**： 不涉及。
        ...
        :param used_storage_space: **参数解释**： 已用消息存储空间，单位：GB。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        ...
        :param cross_vpc_info: **参数解释**： 跨VPC访问信息。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        ...
        :param service_type: **参数解释**： 服务类型。 **约束限制**： 不涉及。 **取值范围**： - advanced：[华为云服务类型。](tag:hws,hws_hk)[服务类型。](tag:ctc,hws_eu,ocb,g42,hk_g42,tm,sbc,hk_sbc,cmcc,hk_tm,hcs,fcs,dt,hcs_oemout,ax,srg) [- dec：专属云服务类型。](tag:hws,hws_hk) **默认取值**： 不涉及。
        :type service_type: str
        :param storage_type: **参数解释**： 存储类型。 **约束限制**： 不涉及。 **取值范围**： - hec：[华为云存储类型。](tag:hws,hws_hk)[存储类型。](tag:ctc,hws_eu,ocb,g42,hk_g42,tm,sbc,hk_sbc,cmcc,hk_tm,hcs,fcs,dt,hcs_oemout,ax,srg) [- dss：专属云存储类型。](tag:hws,hws_hk) **默认取值**： 不涉及。
        :type storage_type: str
        :param extend_times: **参数解释**： 扩展时间。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        :type extend_times: int
        :param ipv6_enable: **参数解释**： 是否开启IPv6。[华为云Stack不支持此参数。](tag:hcs,hcs_oemout) **约束限制**： 不涉及。 **取值范围**： - true：开启。 - false：未开启。 **默认取值**： 不涉及。
        :type ipv6_enable: bool
        :param support_features: **参数解释**： 实例支持的特性功能。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        ...
        :type node_num: int
        :param new_spec_billing_enable: **参数解释**： 是否启用新规格计费。 **约束限制**： 不涉及。 **取值范围**： - true：开启。 - false：未开启。 **默认取值**： 不涉及。
        :type new_spec_billing_enable: bool
        :param enable_acl: **参数解释**： 是否开启访问控制列表。 **约束限制**： 不涉及。 **取值范围**： - true：开启。 - false：未开启。 **默认取值**： 不涉及。
        :type enable_acl: bool
        :param broker_num: **参数解释**： Broker节点数。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        :type broker_num: int
        :param dns_enable: **参数解释**： 实例是否开启域名访问功能。 **约束限制**： 不涉及。 **取值范围**： - true：开启。 - false：未开启。 **默认取值**： 不涉及。
    ...
    @property
    def arch_type(self):
        r"""Gets the arch_type of this InstanceDetail.

        **参数解释**： 架构类型。 **取值范围**： - X86。 - ARM。

        :return: The arch_type of this InstanceDetail.
        :rtype: str
        """
    ...
    def arch_type(self, arch_type):
        r"""Sets the arch_type of this InstanceDetail.

        **参数解释**： 架构类型。 **取值范围**： - X86。 - ARM。

        :param arch_type: The arch_type of this InstanceDetail.
        :type arch_type: str
        """
    ...
    def quota_address(self):
        r"""Gets the quota_address of this InstanceDetail.

        **参数解释**： 流控地址。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :return: The quota_address of this InstanceDetail.
        :rtype: str
        """
    ...
    def quota_address(self, quota_address):
        r"""Sets the quota_address of this InstanceDetail.

        **参数解释**： 流控地址。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :param quota_address: The quota_address of this InstanceDetail.
        :type quota_address: str
        """
    ...
    def max_msg_process_tps(self):
        r"""Gets the max_msg_process_tps of this InstanceDetail.

        **参数解释**： 最大消息TPS。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :return: The max_msg_process_tps of this InstanceDetail.
        :rtype: int
        """
    ...
    def max_msg_process_tps(self, max_msg_process_tps):
        r"""Sets the max_msg_process_tps of this InstanceDetail.

        **参数解释**： 最大消息TPS。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :param max_msg_process_tps: The max_msg_process_tps of this InstanceDetail.
        :type max_msg_process_tps: int
        """
    ...
    def enable_elastic_tps(self):
        r"""Gets the enable_elastic_tps of this InstanceDetail.

        **参数解释**： 弹性TPS开关状态。 **约束限制**： 不涉及。 **取值范围**： - true：开启弹性TPS。 - false：不开启弹性TPS。 **默认取值**： 不涉及。

        :return: The enable_elastic_tps of this InstanceDetail.
        :rtype: bool
        """
    ...
    def enable_elastic_tps(self, enable_elastic_tps):
        r"""Sets the enable_elastic_tps of this InstanceDetail.

        **参数解释**： 弹性TPS开关状态。 **约束限制**： 不涉及。 **取值范围**： - true：开启弹性TPS。 - false：不开启弹性TPS。 **默认取值**： 不涉及。

        :param enable_elastic_tps: The enable_elastic_tps of this InstanceDetail.
        :type enable_elastic_tps: bool
        """
