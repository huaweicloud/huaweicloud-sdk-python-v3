...
class CodeArtsDeployClient(Client):
    ...
    def check_deploy_status(self, request):
        r"""获取部署任务状态
    ...
    def check_deploy_status_invoker(self, request):
        http_info = self._check_deploy_status_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _check_deploy_status_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def stop_deploy_task(self, request):
        r"""停止部署任务
    ...
    def stop_deploy_task_invoker(self, request):
        http_info = self._stop_deploy_task_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _stop_deploy_task_http_info(cls, request):
        http_info = {
            "method": "PUT",
