...
class CodeArtsDeployAsyncClient(Client):
    ...
    def check_deploy_status_async(self, request):
        r"""获取部署任务状态
        ...
        :param request: Request instance for CheckDeployStatus
        :type request: :class:`huaweicloudsdkcodeartsdeploy.v2.CheckDeployStatusRequest`
        :rtype: :class:`huaweicloudsdkcodeartsdeploy.v2.CheckDeployStatusResponse`
        """
        http_info = self._check_deploy_status_http_info(request)
        return self._call_api(**http_info)

    def check_deploy_status_async_invoker(self, request):
        http_info = self._check_deploy_status_http_info(request)
        return AsyncInvoker(self, http_info)

    def _check_deploy_status_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v2/tasks/{task_id}/state",
            "request_type": request.__class__.__name__,
            "response_type": "CheckDeployStatusResponse"
            }
        ...
        if 'step_state' in local_var_params:
            query_params.append(('step_state', local_var_params['step_state']))
    ...
    def stop_deploy_task_async(self, request):
        r"""停止部署任务
        ...
        :param request: Request instance for StopDeployTask
        :type request: :class:`huaweicloudsdkcodeartsdeploy.v2.StopDeployTaskRequest`
        :rtype: :class:`huaweicloudsdkcodeartsdeploy.v2.StopDeployTaskResponse`
        """
        http_info = self._stop_deploy_task_http_info(request)
        return self._call_api(**http_info)

    def stop_deploy_task_async_invoker(self, request):
        http_info = self._stop_deploy_task_http_info(request)
        return AsyncInvoker(self, http_info)

    def _stop_deploy_task_http_info(self, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v2/tasks/{task_id}/records/{record_id}/stop",
            "request_type": request.__class__.__name__,
            "response_type": "StopDeployTaskResponse"
            }
