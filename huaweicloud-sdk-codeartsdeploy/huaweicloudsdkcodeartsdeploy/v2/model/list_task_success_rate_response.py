...
class ListTaskSuccessRateResponse(SdkResponse):
    ...
    def __init__(self, project_id=None, project_name=None, start_date=None, end_date=None, tasks_success_rate=None):
        ...
        :type tasks_success_rate: list[:class:`huaweicloudsdkcodeartsdeploy.v2.TaskSuccessRate`]
        """
    ...
    def tasks_success_rate(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsdeploy.v2.TaskSuccessRate`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListTaskSuccessRateResponse.to_dict() is deprecated and no longer maintained, "
