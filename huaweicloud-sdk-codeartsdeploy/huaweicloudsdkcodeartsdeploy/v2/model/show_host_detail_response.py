...
class ShowHostDetailResponse(SdkResponse):
    ...
    @property
    def status(self):
        r"""Gets the status of this ShowHostDetailResponse.
    ...
    def status(self, status):
        r"""Sets the status of this ShowHostDetailResponse.
    ...
    @property
    def result(self):
        r"""Gets the result of this ShowHostDetailResponse.
    ...
    def result(self, result):
        r"""Sets the result of this ShowHostDetailResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowHostDetailResponse.to_dict() is deprecated and no longer maintained, "
