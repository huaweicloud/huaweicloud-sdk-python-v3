...
class CreateHostClusterRequest:
    ...
    openapi_types = {
        'body': 'CreateHostClusterRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateHostClusterRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateHostClusterRequest):
            return False
