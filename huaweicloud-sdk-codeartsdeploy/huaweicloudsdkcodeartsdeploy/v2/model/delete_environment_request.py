...
class DeleteEnvironmentRequest:
    ...
    def application_id(self):
        r"""Gets the application_id of this DeleteEnvironmentRequest.

        应用id

        :return: The application_id of this DeleteEnvironmentRequest.
        :rtype: str
        """
    ...
    def application_id(self, application_id):
        r"""Sets the application_id of this DeleteEnvironmentRequest.

        应用id

        :param application_id: The application_id of this DeleteEnvironmentRequest.
        :type application_id: str
        """
