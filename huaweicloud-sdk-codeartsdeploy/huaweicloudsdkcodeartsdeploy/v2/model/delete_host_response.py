...
class DeleteHostResponse(SdkResponse):
    ...
    @property
    def status(self):
        r"""Gets the status of this DeleteHostResponse.

        请求成功失败状态

        :return: The status of this DeleteHostResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        r"""Sets the status of this DeleteHostResponse.

        请求成功失败状态

        :param status: The status of this DeleteHostResponse.
        :type status: str
        """
        self._status = status
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteHostResponse.to_dict() is deprecated and no longer maintained, "
