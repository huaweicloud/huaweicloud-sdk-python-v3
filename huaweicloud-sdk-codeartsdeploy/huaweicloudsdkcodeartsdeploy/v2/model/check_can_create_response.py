...
class CheckCanCreateResponse(SdkResponse):
    ...
    openapi_types = {
        'result': 'CheckCanCreateResponseBodyResult',
        'status': 'str'
    }
    ...
    def status(self):
        ...
        :return: The status of this CheckCanCreateResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this CheckCanCreateResponse.
        :type status: str
        """
        self._status = status
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CheckCanCreateResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CheckCanCreateResponse):
            return False
