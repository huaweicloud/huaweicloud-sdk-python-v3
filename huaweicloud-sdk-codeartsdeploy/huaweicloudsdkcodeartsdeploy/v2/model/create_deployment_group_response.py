...
class CreateDeploymentGroupResponse(SdkResponse):
    ...
    def __init__(self, group_id=None):
        r"""CreateDeploymentGroupResponse
    ...
    @property
    def group_id(self):
        r"""Gets the group_id of this CreateDeploymentGroupResponse.
    ...
    def group_id(self, group_id):
        r"""Sets the group_id of this CreateDeploymentGroupResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateDeploymentGroupResponse.to_dict() is deprecated and no longer maintained, "
