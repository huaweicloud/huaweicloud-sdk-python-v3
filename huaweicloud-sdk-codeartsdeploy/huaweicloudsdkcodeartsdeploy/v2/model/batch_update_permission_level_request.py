...
class BatchUpdatePermissionLevelRequest:
    ...
    openapi_types = {
        'body': 'BatchUpdatePermissionLevelRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchUpdatePermissionLevelRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchUpdatePermissionLevelRequest):
            return False
