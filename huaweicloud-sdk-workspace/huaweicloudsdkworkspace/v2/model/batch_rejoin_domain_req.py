...
class BatchRejoinDomainReq:
    ...
    def desktop_ids(self):
        r"""Gets the desktop_ids of this BatchRejoinDomainReq.

        桌面ID列表。

        :return: The desktop_ids of this BatchRejoinDomainReq.
        :rtype: list[str]
        """
    ...
    def desktop_ids(self, desktop_ids):
        r"""Sets the desktop_ids of this BatchRejoinDomainReq.

        桌面ID列表。

        :param desktop_ids: The desktop_ids of this BatchRejoinDomainReq.
        :type desktop_ids: list[str]
        """
