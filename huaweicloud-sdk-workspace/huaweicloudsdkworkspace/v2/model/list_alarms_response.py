...
class ListAlarmsResponse(SdkResponse):
    ...
    openapi_types = {
        'alarm_histories': 'list[AlarmHistoryItem]',
        'count': 'int'
    }
    ...
    def alarm_histories(self):
        """Gets the alarm_histories of this ListAlarmsResponse.
    ...
    def alarm_histories(self, alarm_histories):
        """Sets the alarm_histories of this ListAlarmsResponse.
    ...
    @property
    def count(self):
        """Gets the count of this ListAlarmsResponse.
    ...
    def count(self, count):
        """Sets the count of this ListAlarmsResponse.
