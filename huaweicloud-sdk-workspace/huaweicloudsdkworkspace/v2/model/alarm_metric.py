...
class AlarmMetric:
    ...
    openapi_types = {
        'namespace': 'str',
        'metric_name': 'str',
        'dimensions': 'list[AlarmMetricDimension]'
    }
    ...
    def dimensions(self):
        ...
        :return: The dimensions of this AlarmMetric.
        :rtype: list[:class:`huaweicloudsdkworkspace.v2.AlarmMetricDimension`]
        """
    ...
    def dimensions(self, dimensions):
        ...
        :param dimensions: The dimensions of this AlarmMetric.
        :type dimensions: list[:class:`huaweicloudsdkworkspace.v2.AlarmMetricDimension`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AlarmMetric):
            return False
