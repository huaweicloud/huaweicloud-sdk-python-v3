...
class AttachInstancesDesktopInfo:
    ...
    def __init__(self, desktop_id=None, user_name=None, user_id=None, user_email=None, user_group=None, computer_name=None, is_clear_data=None, attach_user_infos=None):
    ...
    @property
    def user_id(self):
        r"""Gets the user_id of this AttachInstancesDesktopInfo.

        用户id。

        :return: The user_id of this AttachInstancesDesktopInfo.
        :rtype: str
        """
    ...
    def user_id(self, user_id):
        r"""Sets the user_id of this AttachInstancesDesktopInfo.

        用户id。

        :param user_id: The user_id of this AttachInstancesDesktopInfo.
        :type user_id: str
        """
