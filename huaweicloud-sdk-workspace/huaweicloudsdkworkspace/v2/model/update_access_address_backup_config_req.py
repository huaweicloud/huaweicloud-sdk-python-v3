...
class UpdateAccessAddressBackupConfigReq:
    ...
    def access_config(self):
        ...
        :return: The access_config of this UpdateAccessAddressBackupConfigReq.
    ...
    def access_config(self, access_config):
        ...
        :param access_config: The access_config of this UpdateAccessAddressBackupConfigReq.
        :type access_config: list[:class:`huaweicloudsdkworkspace.v2.AccessConfigInfo`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateAccessAddressBackupConfigReq):
            return False
