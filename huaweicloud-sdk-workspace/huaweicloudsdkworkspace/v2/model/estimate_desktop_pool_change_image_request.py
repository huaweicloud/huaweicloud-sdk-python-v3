...
class EstimateDesktopPoolChangeImageRequest:
    ...
    openapi_types = {
        'body': 'EstimateChangeImageRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the EstimateDesktopPoolChangeImageRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EstimateDesktopPoolChangeImageRequest):
            return False
