...
class PoliciesCloudStorage:
    ...
    openapi_types = {
        ...
        'options': 'PoliciesCloudStorageOptions'
    }
    ...
    def __init__(self, cloud_storage_enable=None, options=None):
        ...
        :param cloud_storage_enable: 是否开启云存储。取值为： false：表示关闭。 true：表示开启。
        :type cloud_storage_enable: bool
        :param options: 
        :type options: :class:`huaweicloudsdkworkspace.v2.PoliciesCloudStorageOptions`
        """
    ...
    def options(self):
        ...
        :rtype: :class:`huaweicloudsdkworkspace.v2.PoliciesCloudStorageOptions`
        """
