...
class BatchDeleteOtpDevicesRequest:
    ...
    def __init__(self, user_id=None, body=None):
        ...
        :param user_id: 用户ID。
        :type user_id: str
        :param body: Body of the BatchDeleteOtpDevicesRequest
    ...
    def user_id(self):
        ...
        :return: The user_id of this BatchDeleteOtpDevicesRequest.
        :rtype: str
        """
    ...
    def user_id(self, user_id):
        ...
        :param user_id: The user_id of this BatchDeleteOtpDevicesRequest.
        :type user_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteOtpDevicesRequest):
            return False
