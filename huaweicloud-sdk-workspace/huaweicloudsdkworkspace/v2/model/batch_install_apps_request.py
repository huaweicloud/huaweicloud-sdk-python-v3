...
class BatchInstallAppsRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchInstallAppsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchInstallAppsRequest):
            return False
