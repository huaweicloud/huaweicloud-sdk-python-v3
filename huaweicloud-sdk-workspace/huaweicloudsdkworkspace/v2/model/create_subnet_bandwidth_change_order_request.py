...
class CreateSubnetBandwidthChangeOrderRequest:
    ...
    openapi_types = {
        'bandwidth_id': 'str',
        'body': 'CreateSubnetBandwidthChangeOrderRequestBody'
    }
    ...
    def __init__(self, bandwidth_id=None, body=None):
        ...
        :param body: Body of the CreateSubnetBandwidthChangeOrderRequest
    ...
    def bandwidth_id(self):
        ...
        :return: The bandwidth_id of this CreateSubnetBandwidthChangeOrderRequest.
        :rtype: str
        """
    ...
    def bandwidth_id(self, bandwidth_id):
        ...
        :param bandwidth_id: The bandwidth_id of this CreateSubnetBandwidthChangeOrderRequest.
        :type bandwidth_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateSubnetBandwidthChangeOrderRequest):
            return False
