...
class ShowRuleRestrictionResponse(SdkResponse):
    ...
    def app_restrict_rule_switch(self):
        r"""Gets the app_restrict_rule_switch of this ShowRuleRestrictionResponse.

        应用管控开关，false：关闭，true：打开

        :return: The app_restrict_rule_switch of this ShowRuleRestrictionResponse.
        :rtype: bool
        """
    ...
    def app_restrict_rule_switch(self, app_restrict_rule_switch):
        r"""Sets the app_restrict_rule_switch of this ShowRuleRestrictionResponse.

        应用管控开关，false：关闭，true：打开

        :param app_restrict_rule_switch: The app_restrict_rule_switch of this ShowRuleRestrictionResponse.
        :type app_restrict_rule_switch: bool
        """
    ...
    def app_control_mode(self):
        r"""Gets the app_control_mode of this ShowRuleRestrictionResponse.

        应用管控方式，0：禁止列表应用程序运行

        :return: The app_control_mode of this ShowRuleRestrictionResponse.
        :rtype: int
        """
    ...
    def app_control_mode(self, app_control_mode):
        r"""Sets the app_control_mode of this ShowRuleRestrictionResponse.

        应用管控方式，0：禁止列表应用程序运行

        :param app_control_mode: The app_control_mode of this ShowRuleRestrictionResponse.
        :type app_control_mode: int
        """
    ...
    def app_periodic_switch(self):
        r"""Gets the app_periodic_switch of this ShowRuleRestrictionResponse.

        周期性监控开关，false：关闭，true：打开

        :return: The app_periodic_switch of this ShowRuleRestrictionResponse.
        :rtype: bool
        """
    ...
    def app_periodic_switch(self, app_periodic_switch):
        r"""Sets the app_periodic_switch of this ShowRuleRestrictionResponse.

        周期性监控开关，false：关闭，true：打开

        :param app_periodic_switch: The app_periodic_switch of this ShowRuleRestrictionResponse.
        :type app_periodic_switch: bool
        """
    ...
    def app_periodic_interval(self):
        r"""Gets the app_periodic_interval of this ShowRuleRestrictionResponse.

        周期性监控间隔时间，单位分钟

        :return: The app_periodic_interval of this ShowRuleRestrictionResponse.
        :rtype: int
        """
    ...
    def app_periodic_interval(self, app_periodic_interval):
        r"""Sets the app_periodic_interval of this ShowRuleRestrictionResponse.

        周期性监控间隔时间，单位分钟

        :param app_periodic_interval: The app_periodic_interval of this ShowRuleRestrictionResponse.
        :type app_periodic_interval: int
        """
    ...
    def app_force_kill_proc_switch(self):
        r"""Gets the app_force_kill_proc_switch of this ShowRuleRestrictionResponse.

        强制kill应用开关，false：关闭，true：打开

        :return: The app_force_kill_proc_switch of this ShowRuleRestrictionResponse.
        :rtype: bool
        """
    ...
    def app_force_kill_proc_switch(self, app_force_kill_proc_switch):
        r"""Sets the app_force_kill_proc_switch of this ShowRuleRestrictionResponse.

        强制kill应用开关，false：关闭，true：打开

        :param app_force_kill_proc_switch: The app_force_kill_proc_switch of this ShowRuleRestrictionResponse.
        :type app_force_kill_proc_switch: bool
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowRuleRestrictionResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowRuleRestrictionResponse):
            return False
