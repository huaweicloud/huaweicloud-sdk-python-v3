...
class CreateDesktopOrderRequest:
    ...
    openapi_types = {
        'body': 'CreateDesktopOrderRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateDesktopOrderRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateDesktopOrderRequest):
            return False
