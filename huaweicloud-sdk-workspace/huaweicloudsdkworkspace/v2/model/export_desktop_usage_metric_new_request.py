...
class ExportDesktopUsageMetricNewRequest:
    ...
    def __init__(self, start_time=None, end_time=None, resource_name=None, resource_id=None, min_idle_days=None, max_idle_days=None, usage_min_hours=None, usage_max_hours=None, enterprise_project_id=None, sort_field=None, sort_type=None):
    ...
    def resource_id(self):
        r"""Gets the resource_id of this ExportDesktopUsageMetricNewRequest.

        资源ID(精确匹配)。

        :return: The resource_id of this ExportDesktopUsageMetricNewRequest.
        :rtype: str
        """
    ...
    def resource_id(self, resource_id):
        r"""Sets the resource_id of this ExportDesktopUsageMetricNewRequest.

        资源ID(精确匹配)。

        :param resource_id: The resource_id of this ExportDesktopUsageMetricNewRequest.
        :type resource_id: str
        """
