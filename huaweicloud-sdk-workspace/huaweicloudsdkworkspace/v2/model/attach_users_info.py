...
class AttachUsersInfo:
    ...
    @property
    def id(self):
        r"""Gets the id of this AttachUsersInfo.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this AttachUsersInfo.
    ...
    @property
    def name(self):
        r"""Gets the name of this AttachUsersInfo.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this AttachUsersInfo.
    ...
    @property
    def user_group(self):
        r"""Gets the user_group of this AttachUsersInfo.
    ...
    def user_group(self, user_group):
        r"""Sets the user_group of this AttachUsersInfo.
    ...
    @property
    def type(self):
        r"""Gets the type of this AttachUsersInfo.
    ...
    @type.setter
    def type(self, type):
        r"""Sets the type of this AttachUsersInfo.
