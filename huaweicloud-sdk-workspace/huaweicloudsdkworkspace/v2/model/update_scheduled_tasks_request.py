...
class UpdateScheduledTasksRequest:
    ...
    def __init__(self, task_id=None, body=None):
        ...
        :param task_id: 任务ID。
        :type task_id: str
        :param body: Body of the UpdateScheduledTasksRequest
    ...
    def task_id(self):
        ...
        :return: The task_id of this UpdateScheduledTasksRequest.
        :rtype: str
        """
    ...
    def task_id(self, task_id):
        ...
        :param task_id: The task_id of this UpdateScheduledTasksRequest.
        :type task_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateScheduledTasksRequest):
            return False
