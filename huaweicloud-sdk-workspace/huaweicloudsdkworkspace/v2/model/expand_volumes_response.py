...
class ExpandVolumesResponse(SdkResponse):
    ...
    def __init__(self, job_id=None, get_job_endpoint=None, max_provision_time=None, min_provision_time=None, periodic_query_time=None):
        ...
        super(ExpandVolumesResponse, self).__init__()
    ...
    @property
    def job_id(self):
        r"""Gets the job_id of this ExpandVolumesResponse.

        扩容磁盘任务ID。

        :return: The job_id of this ExpandVolumesResponse.
        :rtype: str
        """
        return self._job_id
    ...
    def job_id(self, job_id):
        r"""Sets the job_id of this ExpandVolumesResponse.

        扩容磁盘任务ID。

        :param job_id: The job_id of this ExpandVolumesResponse.
        :type job_id: str
        """
        self._job_id = job_id
    ...
    def get_job_endpoint(self):
        r"""Gets the get_job_endpoint of this ExpandVolumesResponse.

        云运营平台CBC获取到JobId后，会使用getJobEndpoint当做URL，调用云服务，查询获取Job结果

        :return: The get_job_endpoint of this ExpandVolumesResponse.
        :rtype: str
        """
    ...
    def get_job_endpoint(self, get_job_endpoint):
        r"""Sets the get_job_endpoint of this ExpandVolumesResponse.

        云运营平台CBC获取到JobId后，会使用getJobEndpoint当做URL，调用云服务，查询获取Job结果

        :param get_job_endpoint: The get_job_endpoint of this ExpandVolumesResponse.
        :type get_job_endpoint: str
        """
    ...
    def max_provision_time(self):
        r"""Gets the max_provision_time of this ExpandVolumesResponse.

        在线开通最大时间

        :return: The max_provision_time of this ExpandVolumesResponse.
        :rtype: int
        """
    ...
    def max_provision_time(self, max_provision_time):
        r"""Sets the max_provision_time of this ExpandVolumesResponse.

        在线开通最大时间

        :param max_provision_time: The max_provision_time of this ExpandVolumesResponse.
        :type max_provision_time: int
        """
    ...
    def min_provision_time(self):
        r"""Gets the min_provision_time of this ExpandVolumesResponse.

        开通最小时间（云服务最快开通时长，或一般开通时长）

        :return: The min_provision_time of this ExpandVolumesResponse.
        :rtype: int
        """
    ...
    def min_provision_time(self, min_provision_time):
        r"""Sets the min_provision_time of this ExpandVolumesResponse.

        开通最小时间（云服务最快开通时长，或一般开通时长）

        :param min_provision_time: The min_provision_time of this ExpandVolumesResponse.
        :type min_provision_time: int
        """
    ...
    def periodic_query_time(self):
        r"""Gets the periodic_query_time of this ExpandVolumesResponse.

        Job周期性查询时间，默认1分钟查询一次

        :return: The periodic_query_time of this ExpandVolumesResponse.
        :rtype: int
        """
    ...
    def periodic_query_time(self, periodic_query_time):
        r"""Sets the periodic_query_time of this ExpandVolumesResponse.

        Job周期性查询时间，默认1分钟查询一次

        :param periodic_query_time: The periodic_query_time of this ExpandVolumesResponse.
        :type periodic_query_time: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExpandVolumesResponse):
            return False
