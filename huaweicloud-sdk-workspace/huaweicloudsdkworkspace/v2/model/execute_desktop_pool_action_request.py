...
class ExecuteDesktopPoolActionRequest:
    ...
    def __init__(self, pool_id=None, body=None):
        ...
        :param pool_id: 桌面池ID。
        :type pool_id: str
        :param body: Body of the ExecuteDesktopPoolActionRequest
    ...
    def pool_id(self):
        ...
        :return: The pool_id of this ExecuteDesktopPoolActionRequest.
        :rtype: str
        """
    ...
    def pool_id(self, pool_id):
        ...
        :param pool_id: The pool_id of this ExecuteDesktopPoolActionRequest.
        :type pool_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExecuteDesktopPoolActionRequest):
            return False
