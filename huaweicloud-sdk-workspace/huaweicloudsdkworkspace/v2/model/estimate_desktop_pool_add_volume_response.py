...
class EstimateDesktopPoolAddVolumeResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("EstimateDesktopPoolAddVolumeResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EstimateDesktopPoolAddVolumeResponse):
            return False
