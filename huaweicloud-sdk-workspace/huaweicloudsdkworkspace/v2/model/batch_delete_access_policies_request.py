...
class BatchDeleteAccessPoliciesRequest:
    ...
    openapi_types = {
        'body': 'BatchDeleteAccessPoliciesReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchDeleteAccessPoliciesRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteAccessPoliciesRequest):
            return False
