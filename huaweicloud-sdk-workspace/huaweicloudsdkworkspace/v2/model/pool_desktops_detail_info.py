...
class PoolDesktopsDetailInfo:
    ...
    @property
    def isolated(self):
        r"""Gets the isolated of this PoolDesktopsDetailInfo.

        动态池桌面隔离状态，false表示未隔离，true表示已隔离。

        :return: The isolated of this PoolDesktopsDetailInfo.
        :rtype: bool
        """
    ...
    def isolated(self, isolated):
        r"""Sets the isolated of this PoolDesktopsDetailInfo.

        动态池桌面隔离状态，false表示未隔离，true表示已隔离。

        :param isolated: The isolated of this PoolDesktopsDetailInfo.
        :type isolated: bool
        """
    ...
    @property
    def domain(self):
        r"""Gets the domain of this PoolDesktopsDetailInfo.

        桌面分配的域。

        :return: The domain of this PoolDesktopsDetailInfo.
        :rtype: str
        """
        return self._domain
    ...
    def domain(self, domain):
        r"""Sets the domain of this PoolDesktopsDetailInfo.

        桌面分配的域。

        :param domain: The domain of this PoolDesktopsDetailInfo.
        :type domain: str
        """
        self._domain = domain
