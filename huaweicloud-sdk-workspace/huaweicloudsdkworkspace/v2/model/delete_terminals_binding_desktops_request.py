...
class DeleteTerminalsBindingDesktopsRequest:
    ...
    openapi_types = {
        'body': 'DeleteTerminalsBindingDesktopsRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the DeleteTerminalsBindingDesktopsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteTerminalsBindingDesktopsRequest):
            return False
