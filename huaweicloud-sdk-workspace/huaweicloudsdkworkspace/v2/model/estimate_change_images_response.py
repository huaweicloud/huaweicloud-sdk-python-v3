...
class EstimateChangeImagesResponse(SdkResponse):
    ...
    def __init__(self, currency=None, cloud_service_rating_results=None):
        r"""EstimateChangeImagesResponse
    ...
    @property
    def currency(self):
        r"""Gets the currency of this EstimateChangeImagesResponse.

        币种，比如CNY。

        :return: The currency of this EstimateChangeImagesResponse.
        :rtype: str
        """
    ...
    def currency(self, currency):
        r"""Sets the currency of this EstimateChangeImagesResponse.

        币种，比如CNY。

        :param currency: The currency of this EstimateChangeImagesResponse.
        :type currency: str
        """
    ...
    def cloud_service_rating_results(self):
        r"""Gets the cloud_service_rating_results of this EstimateChangeImagesResponse.

        询价结果。

        :return: The cloud_service_rating_results of this EstimateChangeImagesResponse.
    ...
    def cloud_service_rating_results(self, cloud_service_rating_results):
        r"""Sets the cloud_service_rating_results of this EstimateChangeImagesResponse.

        询价结果。

        :param cloud_service_rating_results: The cloud_service_rating_results of this EstimateChangeImagesResponse.
        :type cloud_service_rating_results: list[:class:`huaweicloudsdkworkspace.v2.CloudServiceRatingResult`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("EstimateChangeImagesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EstimateChangeImagesResponse):
            return False
