...
class BatchAttachInstancesRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchAttachInstancesRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchAttachInstancesRequest):
            return False
