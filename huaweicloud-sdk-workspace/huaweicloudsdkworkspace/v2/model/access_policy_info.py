...
class AccessPolicyInfo:
    ...
    def __init__(self, policy_name=None, blacklist_type=None, access_control_type=None, ip_list=None, is_enable=None, is_block_all=None, ip_total_count=None):
        r"""AccessPolicyInfo
    ...
    @property
    def is_enable(self):
        r"""Gets the is_enable of this AccessPolicyInfo.

        IP白名单是否生效。只能单独更新，此值的优先级最高，传此值只修改该策略是否生效。

        :return: The is_enable of this AccessPolicyInfo.
        :rtype: bool
        """
    ...
    def is_enable(self, is_enable):
        r"""Sets the is_enable of this AccessPolicyInfo.

        IP白名单是否生效。只能单独更新，此值的优先级最高，传此值只修改该策略是否生效。

        :param is_enable: The is_enable of this AccessPolicyInfo.
        :type is_enable: bool
        """
    ...
    def is_block_all(self):
        r"""Gets the is_block_all of this AccessPolicyInfo.

        IP白名单是否禁止所有Ip接入。is_enable为false时，无法修改此值。此值也只能单独更新。

        :return: The is_block_all of this AccessPolicyInfo.
        :rtype: bool
        """
    ...
    def is_block_all(self, is_block_all):
        r"""Sets the is_block_all of this AccessPolicyInfo.

        IP白名单是否禁止所有Ip接入。is_enable为false时，无法修改此值。此值也只能单独更新。

        :param is_block_all: The is_block_all of this AccessPolicyInfo.
        :type is_block_all: bool
        """
