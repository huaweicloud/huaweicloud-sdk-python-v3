...
class EstimateDesktopPoolResizeRequest:
    ...
    openapi_types = {
        'body': 'EstimateResizeRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the EstimateDesktopPoolResizeRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EstimateDesktopPoolResizeRequest):
            return False
