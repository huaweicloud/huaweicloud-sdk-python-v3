...
class SendDesktopPoolNotificationsRequest:
    ...
    openapi_types = {
        'pool_id': 'str',
        'body': 'SendDesktopPoolNotificationsReq'
    }
    ...
    def __init__(self, pool_id=None, body=None):
        ...
        :param pool_id: 桌面池ID。
        :type pool_id: str
        :param body: Body of the SendDesktopPoolNotificationsRequest
    ...
    def pool_id(self):
        ...
        :return: The pool_id of this SendDesktopPoolNotificationsRequest.
        :rtype: str
        """
    ...
    def pool_id(self, pool_id):
        ...
        :param pool_id: The pool_id of this SendDesktopPoolNotificationsRequest.
        :type pool_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SendDesktopPoolNotificationsRequest):
            return False
