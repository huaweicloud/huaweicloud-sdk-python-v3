...
class BatchUpdateAppAuthorizationsRequest:
    ...
    openapi_types = {
        'body': 'BatchAssignAppAuthorizationsReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchUpdateAppAuthorizationsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchUpdateAppAuthorizationsRequest):
            return False
