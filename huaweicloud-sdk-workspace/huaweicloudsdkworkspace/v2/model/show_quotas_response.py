...
class ShowQuotasResponse(SdkResponse):
    ...
    openapi_types = {
        'quotas': 'QuotaNoLimit',
        'site_quotas': 'list[SiteQuotaNoLimit]'
    }
    ...
    def __init__(self, quotas=None, site_quotas=None):
        ...
        self._quotas = None
        self._site_quotas = None
        self.discriminator = None

        if quotas is not None:
            self.quotas = quotas
        if site_quotas is not None:
            self.site_quotas = site_quotas
