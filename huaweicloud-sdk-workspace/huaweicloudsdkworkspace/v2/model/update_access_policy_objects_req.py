...
class UpdateAccessPolicyObjectsReq:
    ...
    def __init__(self, policy_objects_list=None):
        ...
        :param policy_objects_list: 更新策略应用对象列表请求。
    ...
    def policy_objects_list(self):
        ...
        :return: The policy_objects_list of this UpdateAccessPolicyObjectsReq.
    ...
    def policy_objects_list(self, policy_objects_list):
        ...
        :param policy_objects_list: The policy_objects_list of this UpdateAccessPolicyObjectsReq.
        :type policy_objects_list: list[:class:`huaweicloudsdkworkspace.v2.AccessPolicyObjectInfo`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateAccessPolicyObjectsReq):
            return False
