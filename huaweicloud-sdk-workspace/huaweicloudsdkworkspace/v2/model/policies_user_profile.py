...
class PoliciesUserProfile:
    ...
    openapi_types = {
        ...
        'options': 'PoliciesUserProfileOptions'
    }
    ...
    def __init__(self, user_profile_enable=None, options=None):
        ...
        :param user_profile_enable: 是否开启UPM配置。取值为： false：表示关闭。 true：表示开启。
        :type user_profile_enable: bool
        :param options: 
        :type options: :class:`huaweicloudsdkworkspace.v2.PoliciesUserProfileOptions`
        """
    ...
    def options(self):
        ...
        :rtype: :class:`huaweicloudsdkworkspace.v2.PoliciesUserProfileOptions`
        """
