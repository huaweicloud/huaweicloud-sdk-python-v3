...
class CreateDesktopPoolChangeOrderRequest:
    ...
    openapi_types = {
        'body': 'CreateBatchChangeOrderRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateDesktopPoolChangeOrderRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateDesktopPoolChangeOrderRequest):
            return False
