...
class AssociateDesktopsEipRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the AssociateDesktopsEipRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssociateDesktopsEipRequest):
            return False
