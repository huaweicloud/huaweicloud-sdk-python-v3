...
class UpdateAccessAddressBackupConfigRequest:
    ...
    openapi_types = {
        'body': 'UpdateAccessAddressBackupConfigReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the UpdateAccessAddressBackupConfigRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateAccessAddressBackupConfigRequest):
            return False
