...
class ListNatGatewaysResponse(SdkResponse):
    ...
    def __init__(self, nat_gateways=None):
        ...
        :param nat_gateways: 网关实例信息列表。
        :type nat_gateways: list[:class:`huaweicloudsdkworkspace.v2.NatGateway`]
        """
    ...
    def nat_gateways(self):
        ...
        :rtype: list[:class:`huaweicloudsdkworkspace.v2.NatGateway`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListNatGatewaysResponse.to_dict() is deprecated and no longer maintained, "
