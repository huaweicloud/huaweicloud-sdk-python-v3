...
class ApplyWorkspaceAdDomain:
    ...
    def domain_type(self):
        r"""Gets the domain_type of this ApplyWorkspaceAdDomain.

        域类型。 - LITE_AS：本地认证。 - LOCAL_AD：本地AD。 说明：域类型为“LOCAL_AD”时，请确保所选VPC网络与AD所属网络可连通。

        :return: The domain_type of this ApplyWorkspaceAdDomain.
        :rtype: str
        """
    ...
    def domain_type(self, domain_type):
        r"""Sets the domain_type of this ApplyWorkspaceAdDomain.

        域类型。 - LITE_AS：本地认证。 - LOCAL_AD：本地AD。 说明：域类型为“LOCAL_AD”时，请确保所选VPC网络与AD所属网络可连通。

        :param domain_type: The domain_type of this ApplyWorkspaceAdDomain.
        :type domain_type: str
        """
    ...
    def domain_name(self):
        r"""Gets the domain_name of this ApplyWorkspaceAdDomain.

        域名称。域类型为LOCAL_AD时需要配置。 域名必须为AD服务器上已经存在的域名，且长度不超过55。

        :return: The domain_name of this ApplyWorkspaceAdDomain.
        :rtype: str
        """
    ...
    def domain_name(self, domain_name):
        r"""Sets the domain_name of this ApplyWorkspaceAdDomain.

        域名称。域类型为LOCAL_AD时需要配置。 域名必须为AD服务器上已经存在的域名，且长度不超过55。

        :param domain_name: The domain_name of this ApplyWorkspaceAdDomain.
        :type domain_name: str
        """
    ...
    def domain_admin_account(self):
        r"""Gets the domain_admin_account of this ApplyWorkspaceAdDomain.

        域管理员账号。域类型为LOCAL_AD时需要配置。 必须为AD服务器上已经存在的域管理员账号。

        :return: The domain_admin_account of this ApplyWorkspaceAdDomain.
        :rtype: str
        """
    ...
    def domain_admin_account(self, domain_admin_account):
        r"""Sets the domain_admin_account of this ApplyWorkspaceAdDomain.

        域管理员账号。域类型为LOCAL_AD时需要配置。 必须为AD服务器上已经存在的域管理员账号。

        :param domain_admin_account: The domain_admin_account of this ApplyWorkspaceAdDomain.
        :type domain_admin_account: str
        """
    ...
    def domain_password(self):
        r"""Gets the domain_password of this ApplyWorkspaceAdDomain.

        域管理员账号密码。域类型为LOCAL_AD时需要配置。

        :return: The domain_password of this ApplyWorkspaceAdDomain.
        :rtype: str
        """
    ...
    def domain_password(self, domain_password):
        r"""Sets the domain_password of this ApplyWorkspaceAdDomain.

        域管理员账号密码。域类型为LOCAL_AD时需要配置。

        :param domain_password: The domain_password of this ApplyWorkspaceAdDomain.
        :type domain_password: str
        """
    ...
    def active_domain_ip(self):
        r"""Gets the active_domain_ip of this ApplyWorkspaceAdDomain.

        主域控制器IP地址。域类型为LOCAL_AD时需要配置。

        :return: The active_domain_ip of this ApplyWorkspaceAdDomain.
        :rtype: str
        """
    ...
    def active_domain_ip(self, active_domain_ip):
        r"""Sets the active_domain_ip of this ApplyWorkspaceAdDomain.

        主域控制器IP地址。域类型为LOCAL_AD时需要配置。

        :param active_domain_ip: The active_domain_ip of this ApplyWorkspaceAdDomain.
        :type active_domain_ip: str
        """
    ...
    def active_domain_name(self):
        r"""Gets the active_domain_name of this ApplyWorkspaceAdDomain.

        主域控制器名称。域类型为LOCAL_AD时需要配置。

        :return: The active_domain_name of this ApplyWorkspaceAdDomain.
        :rtype: str
        """
    ...
    def active_domain_name(self, active_domain_name):
        r"""Sets the active_domain_name of this ApplyWorkspaceAdDomain.

        主域控制器名称。域类型为LOCAL_AD时需要配置。

        :param active_domain_name: The active_domain_name of this ApplyWorkspaceAdDomain.
        :type active_domain_name: str
        """
    ...
    def standby_domain_ip(self):
        r"""Gets the standby_domain_ip of this ApplyWorkspaceAdDomain.

        备域控制器IP地址。域类型为LOCAL_AD时且配置备节点时需要配置。

        :return: The standby_domain_ip of this ApplyWorkspaceAdDomain.
        :rtype: str
        """
    ...
    def standby_domain_ip(self, standby_domain_ip):
        r"""Sets the standby_domain_ip of this ApplyWorkspaceAdDomain.

        备域控制器IP地址。域类型为LOCAL_AD时且配置备节点时需要配置。

        :param standby_domain_ip: The standby_domain_ip of this ApplyWorkspaceAdDomain.
        :type standby_domain_ip: str
        """
    ...
    def standby_domain_name(self):
        r"""Gets the standby_domain_name of this ApplyWorkspaceAdDomain.

        备域控制器名称。域类型为LOCAL_AD时且配置备节点时需要配置。

        :return: The standby_domain_name of this ApplyWorkspaceAdDomain.
        :rtype: str
        """
    ...
    def standby_domain_name(self, standby_domain_name):
        r"""Sets the standby_domain_name of this ApplyWorkspaceAdDomain.

        备域控制器名称。域类型为LOCAL_AD时且配置备节点时需要配置。

        :param standby_domain_name: The standby_domain_name of this ApplyWorkspaceAdDomain.
        :type standby_domain_name: str
        """
    ...
    def active_dns_ip(self):
        r"""Gets the active_dns_ip of this ApplyWorkspaceAdDomain.

        主DNS IP地址。域类型为LOCAL_AD时需要配置。

        :return: The active_dns_ip of this ApplyWorkspaceAdDomain.
        :rtype: str
        """
    ...
    def active_dns_ip(self, active_dns_ip):
        r"""Sets the active_dns_ip of this ApplyWorkspaceAdDomain.

        主DNS IP地址。域类型为LOCAL_AD时需要配置。

        :param active_dns_ip: The active_dns_ip of this ApplyWorkspaceAdDomain.
        :type active_dns_ip: str
        """
    ...
    def standby_dns_ip(self):
        r"""Gets the standby_dns_ip of this ApplyWorkspaceAdDomain.

        备DNS IP地址。域类型为LOCAL_AD时且配置备节点时需要配置。

        :return: The standby_dns_ip of this ApplyWorkspaceAdDomain.
        :rtype: str
        """
    ...
    def standby_dns_ip(self, standby_dns_ip):
        r"""Sets the standby_dns_ip of this ApplyWorkspaceAdDomain.

        备DNS IP地址。域类型为LOCAL_AD时且配置备节点时需要配置。

        :param standby_dns_ip: The standby_dns_ip of this ApplyWorkspaceAdDomain.
        :type standby_dns_ip: str
        """
    ...
    def delete_computer_object(self):
        r"""Gets the delete_computer_object of this ApplyWorkspaceAdDomain.

        是否在删除桌面的同时删除AD上对应的计算机对象，0代表不删除，1代表删除。

        :return: The delete_computer_object of this ApplyWorkspaceAdDomain.
        :rtype: int
        """
    ...
    def delete_computer_object(self, delete_computer_object):
        r"""Sets the delete_computer_object of this ApplyWorkspaceAdDomain.

        是否在删除桌面的同时删除AD上对应的计算机对象，0代表不删除，1代表删除。

        :param delete_computer_object: The delete_computer_object of this ApplyWorkspaceAdDomain.
        :type delete_computer_object: int
        """
    ...
    @property
    def use_ldaps(self):
        r"""Gets the use_ldaps of this ApplyWorkspaceAdDomain.

        是否开启LDAPS。

        :return: The use_ldaps of this ApplyWorkspaceAdDomain.
        :rtype: bool
        """
    ...
    def use_ldaps(self, use_ldaps):
        r"""Sets the use_ldaps of this ApplyWorkspaceAdDomain.

        是否开启LDAPS。

        :param use_ldaps: The use_ldaps of this ApplyWorkspaceAdDomain.
        :type use_ldaps: bool
        """
    ...
    @property
    def tls_config(self):
        r"""Gets the tls_config of this ApplyWorkspaceAdDomain.

        :return: The tls_config of this ApplyWorkspaceAdDomain.
    ...
    def tls_config(self, tls_config):
        r"""Sets the tls_config of this ApplyWorkspaceAdDomain.

        :param tls_config: The tls_config of this ApplyWorkspaceAdDomain.
        :type tls_config: :class:`huaweicloudsdkworkspace.v2.TlsConfig`
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApplyWorkspaceAdDomain):
            return False
