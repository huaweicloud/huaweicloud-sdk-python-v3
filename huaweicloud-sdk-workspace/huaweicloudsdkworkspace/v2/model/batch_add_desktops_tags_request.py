...
class BatchAddDesktopsTagsRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchAddDesktopsTagsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchAddDesktopsTagsRequest):
            return False
