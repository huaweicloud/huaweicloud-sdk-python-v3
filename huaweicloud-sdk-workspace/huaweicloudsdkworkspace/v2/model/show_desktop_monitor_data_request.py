...
class ShowDesktopMonitorDataRequest:
    ...
    def __init__(self, desktop_id=None, start_time=None, end_time=None, metric_name=None):
        ...
        :type end_time: str
        :param metric_name: 监控查询指标：例如 \&quot;cpu_util\&quot;，详情见下表；当metric_name为空时，为批量查询| 指标                                  | 指标名称          | 测量对象     | 监控周期 || ------------------------------------- | ----------------- | ------------ | -------- || cpu_util                              | CPU使用率         | 弹性云服务器 | 5分钟    || mem_util                              | 内存使用率        | 弹性云服务器 | 5分钟    || disk_util_inband                      | 磁盘使用率        | 弹性云服务器 | 5分钟    || disk_read_bytes_rate                  | 磁盘读带宽        | 弹性云服务器 | 5分钟    || disk_write_bytes_rate                 | 磁盘写带宽        | 弹性云服务器 | 5分钟    || disk_read_requests_rate               | 磁盘读IOPS        | 弹性云服务器 | 5分钟    || disk_write_requests_rate              | 磁盘写IOPS        | 弹性云服务器 | 5分钟    || network_incoming_bytes_rate_inband    | 带内网络流入速率  | 弹性云服务器 | 5分钟    || network_outgoing_bytes_rate_inband    | 带内网络流出速率  | 弹性云服务器 | 5分钟    || network_incoming_bytes_aggregate_rate | 带外网络流入速率  | 弹性云服务器 | 5分钟    || network_outgoing_bytes_aggregate_rate | 带外网络流出速率  | 弹性云服务器 | 5分钟    || network_vm_connections                | 网络连接数        | 弹性云服务器 | 5分钟    || cpu_credit_usage                      | CPU积分使用量     | 弹性云服务器 | 5分钟    || cpu_credit_balance                    | CPU积分累积量     | 弹性云服务器 | 5分钟    || cpu_surplus_credit_balance            | CPU超额积分累积量 | 弹性云服务器 | 5分钟    || cpu_surplus_credit_charged            | CPU超额积分收费量 | 弹性云服务器 | 5分钟    || user_online_info                      | 用户在线信息      | 弹性云服务器 | -        |
    ...
    @property
    def desktop_id(self):
        """Gets the desktop_id of this ShowDesktopMonitorDataRequest.
    ...
    def desktop_id(self, desktop_id):
        """Sets the desktop_id of this ShowDesktopMonitorDataRequest.
    ...
    @property
    def start_time(self):
        """Gets the start_time of this ShowDesktopMonitorDataRequest.
    ...
    def start_time(self, start_time):
        """Sets the start_time of this ShowDesktopMonitorDataRequest.
    ...
    @property
    def end_time(self):
        """Gets the end_time of this ShowDesktopMonitorDataRequest.
    ...
    def end_time(self, end_time):
        """Sets the end_time of this ShowDesktopMonitorDataRequest.
    ...
    def metric_name(self):
        """Gets the metric_name of this ShowDesktopMonitorDataRequest.
    ...
    def metric_name(self, metric_name):
        """Sets the metric_name of this ShowDesktopMonitorDataRequest.
