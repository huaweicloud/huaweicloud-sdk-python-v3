...
class CreateDesktopRequest:
    ...
    def __init__(self, service_transaction_id=None, body=None):
        ...
        :param body: Body of the CreateDesktopRequest
    ...
    def service_transaction_id(self):
        ...
        :return: The service_transaction_id of this CreateDesktopRequest.
        :rtype: str
        """
    ...
    def service_transaction_id(self, service_transaction_id):
        ...
        :param service_transaction_id: The service_transaction_id of this CreateDesktopRequest.
        :type service_transaction_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateDesktopRequest):
            return False
