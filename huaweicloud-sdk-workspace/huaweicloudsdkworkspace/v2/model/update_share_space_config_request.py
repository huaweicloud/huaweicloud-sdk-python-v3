...
class UpdateShareSpaceConfigRequest:
    ...
    openapi_types = {
        'body': 'UpdateShareSpaceConfigReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the UpdateShareSpaceConfigRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateShareSpaceConfigRequest):
            return False
