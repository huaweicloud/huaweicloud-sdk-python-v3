...
class AddMetricNotifyRuleRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the AddMetricNotifyRuleRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddMetricNotifyRuleRequest):
            return False
