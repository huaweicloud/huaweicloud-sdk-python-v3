...
class UpdateNatMappingConfigsRequest:
    ...
    openapi_types = {
        'body': 'UpdateNatMappingConfigsReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the UpdateNatMappingConfigsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateNatMappingConfigsRequest):
            return False
