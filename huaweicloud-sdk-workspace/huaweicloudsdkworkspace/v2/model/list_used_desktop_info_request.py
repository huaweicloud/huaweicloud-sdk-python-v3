...
class ListUsedDesktopInfoRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ListUsedDesktopInfoRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListUsedDesktopInfoRequest):
            return False
