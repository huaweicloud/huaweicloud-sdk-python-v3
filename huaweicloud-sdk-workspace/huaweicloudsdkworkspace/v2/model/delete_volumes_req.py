...
class DeleteVolumesReq:
    ...
    def __init__(self, volume_ids=None):
        ...
        :param volume_ids: 待删除的桌面数据盘ID列表。
    ...
    def volume_ids(self):
        ...
        :return: The volume_ids of this DeleteVolumesReq.
        :rtype: list[str]
        """
    ...
    def volume_ids(self, volume_ids):
        ...
        :param volume_ids: The volume_ids of this DeleteVolumesReq.
        :type volume_ids: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteVolumesReq):
            return False
