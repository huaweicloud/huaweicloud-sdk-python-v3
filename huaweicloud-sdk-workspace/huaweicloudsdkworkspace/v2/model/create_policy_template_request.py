...
class CreatePolicyTemplateRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreatePolicyTemplateRequest
        :type body: :class:`huaweicloudsdkworkspace.v2.CreatePolicyTemplateReq`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkworkspace.v2.CreatePolicyTemplateReq`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreatePolicyTemplateRequest):
            return False
