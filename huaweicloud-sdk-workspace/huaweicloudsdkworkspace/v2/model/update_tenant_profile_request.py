...
class UpdateTenantProfileRequest:
    ...
    def body(self):
        ...
        :return: The body of this UpdateTenantProfileRequest.
        :rtype: dict(str, bool)
        """
        return self._body
    ...
    def body(self, body):
        ...
        :param body: The body of this UpdateTenantProfileRequest.
        :type body: dict(str, bool)
        """
        self._body = body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateTenantProfileRequest):
            return False
