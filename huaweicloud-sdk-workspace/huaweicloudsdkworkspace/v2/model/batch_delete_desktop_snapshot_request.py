...
class BatchDeleteDesktopSnapshotRequest:
    ...
    openapi_types = {
        'body': 'BatchDeleteDesktopSnapshotReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchDeleteDesktopSnapshotRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteDesktopSnapshotRequest):
            return False
