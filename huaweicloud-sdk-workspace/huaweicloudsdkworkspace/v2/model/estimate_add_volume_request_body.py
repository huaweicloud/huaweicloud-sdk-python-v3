...
class EstimateAddVolumeRequestBody:
    ...
    def handle_type(self):
        r"""Gets the handle_type of this EstimateAddVolumeRequestBody.

        处理类型 - ONLY_FOR_EXPAND：仅对新扩容桌面生效 - FOR_EXPAND_AND_IDLE：对新扩容桌面与空闲桌面生效 - FOR_EXPAND_AND_ALL：对新扩容桌面与已有全部桌面生效

        :return: The handle_type of this EstimateAddVolumeRequestBody.
        :rtype: str
        """
    ...
    def handle_type(self, handle_type):
        r"""Sets the handle_type of this EstimateAddVolumeRequestBody.

        处理类型 - ONLY_FOR_EXPAND：仅对新扩容桌面生效 - FOR_EXPAND_AND_IDLE：对新扩容桌面与空闲桌面生效 - FOR_EXPAND_AND_ALL：对新扩容桌面与已有全部桌面生效

        :param handle_type: The handle_type of this EstimateAddVolumeRequestBody.
        :type handle_type: str
        """
