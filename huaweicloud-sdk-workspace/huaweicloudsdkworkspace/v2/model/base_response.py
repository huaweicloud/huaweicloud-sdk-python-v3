...
class BaseResponse:
    ...
    def error_detail(self):
        r"""Gets the error_detail of this BaseResponse.

        错误详情。

        :return: The error_detail of this BaseResponse.
        :rtype: str
        """
    ...
    def error_detail(self, error_detail):
        r"""Sets the error_detail of this BaseResponse.

        错误详情。

        :param error_detail: The error_detail of this BaseResponse.
        :type error_detail: str
        """
