...
class UpdateScreenRecordsTrafficLimitConfigRequest:
    ...
    def __init__(self, body=None):
        r"""UpdateScreenRecordsTrafficLimitConfigRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateScreenRecordsTrafficLimitConfigRequest):
            return False
