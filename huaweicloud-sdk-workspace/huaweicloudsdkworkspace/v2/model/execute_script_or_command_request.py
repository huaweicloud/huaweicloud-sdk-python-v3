...
class ExecuteScriptOrCommandRequest:
    ...
    openapi_types = {
        'body': 'ExecuteScriptOrCommandReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ExecuteScriptOrCommandRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExecuteScriptOrCommandRequest):
            return False
