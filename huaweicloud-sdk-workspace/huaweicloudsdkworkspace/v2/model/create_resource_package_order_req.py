...
class CreateResourcePackageOrderReq:
    ...
    openapi_types = {
        ...
        'resource_packages': 'list[DesktopResourceItem]',
        'resource_size': 'int',
    ...
    def __init__(self, enterprise_project_id=None, resource_packages=None, resource_size=None, extend_param=None):
        ...
        :type resource_packages: list[:class:`huaweicloudsdkworkspace.v2.DesktopResourceItem`]
    ...
    def resource_packages(self):
        ...
        :rtype: list[:class:`huaweicloudsdkworkspace.v2.DesktopResourceItem`]
        """
