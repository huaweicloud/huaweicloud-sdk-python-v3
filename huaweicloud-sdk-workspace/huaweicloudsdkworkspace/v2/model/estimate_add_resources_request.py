...
class EstimateAddResourcesRequest:
    ...
    openapi_types = {
        'body': 'EstimateAddSubResourcesRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the EstimateAddResourcesRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EstimateAddResourcesRequest):
            return False
