...
class ShowQuotaDetailsResponse(SdkResponse):
    ...
    openapi_types = {
        'resources': 'list[ResourceNoLimit]',
        'site_id': 'str'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowQuotaDetailsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowQuotaDetailsResponse):
            return False
