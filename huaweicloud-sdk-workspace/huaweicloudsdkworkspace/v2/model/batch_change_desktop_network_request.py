...
class BatchChangeDesktopNetworkRequest:
    ...
    openapi_types = {
        'body': 'BatchChangeDesktopNetworkReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchChangeDesktopNetworkRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchChangeDesktopNetworkRequest):
            return False
