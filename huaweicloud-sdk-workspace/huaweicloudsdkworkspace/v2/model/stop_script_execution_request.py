...
class StopScriptExecutionRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the StopScriptExecutionRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StopScriptExecutionRequest):
            return False
