...
class CreateScheduledTasksReq:
    ...
    def __init__(self, scheduled_type=None, day_interval=None, week_list=None, month_list=None, date_list=None, scheduled_date=None, scheduled_time=None, expire_time=None, gray_count=None, gray_desktop_ids=None, gray_fail_threshold=None, life_cycle_type=None, time_zone=None, task_type=None, task_name=None, force_execute=None, description=None, extra_params=None, apply_objects=None):
        ...
        :param time_zone: 时区。
        :type time_zone: str
        :param task_type: 任务类型，可选值为： - START：开机。 - STOP：关机。 - REBOOT：重启。 - HIBERNATE：休眠。 - REBUILD：重建系统盘。 - EXECUTE_SCRIPT：执行脚本。
        :type task_type: str
    ...
    def scheduled_type(self):
        """Gets the scheduled_type of this CreateScheduledTasksReq.

        执行周期类型，可选值为： - FIXED_TIME：指定时间。 - DAY：按天。 - WEEK：按周。 - MONTH：按月。 - LIFE_CYCLE：指定场景下触发。

        :return: The scheduled_type of this CreateScheduledTasksReq.
        :rtype: str
        """
    ...
    def scheduled_type(self, scheduled_type):
        """Sets the scheduled_type of this CreateScheduledTasksReq.

        执行周期类型，可选值为： - FIXED_TIME：指定时间。 - DAY：按天。 - WEEK：按周。 - MONTH：按月。 - LIFE_CYCLE：指定场景下触发。

        :param scheduled_type: The scheduled_type of this CreateScheduledTasksReq.
        :type scheduled_type: str
        """
    ...
    def day_interval(self):
        """Gets the day_interval of this CreateScheduledTasksReq.

        周期按天时：按x天间隔执行。

        :return: The day_interval of this CreateScheduledTasksReq.
        :rtype: int
        """
    ...
    def day_interval(self, day_interval):
        """Sets the day_interval of this CreateScheduledTasksReq.

        周期按天时：按x天间隔执行。

        :param day_interval: The day_interval of this CreateScheduledTasksReq.
        :type day_interval: int
        """
    ...
    @property
    def week_list(self):
        """Gets the week_list of this CreateScheduledTasksReq.

        周期按周时：取值1~7，分别对应周日~周六，英文逗号分隔，如1,2,7。

        :return: The week_list of this CreateScheduledTasksReq.
        :rtype: str
        """
    ...
    def week_list(self, week_list):
        """Sets the week_list of this CreateScheduledTasksReq.

        周期按周时：取值1~7，分别对应周日~周六，英文逗号分隔，如1,2,7。

        :param week_list: The week_list of this CreateScheduledTasksReq.
        :type week_list: str
        """
    ...
    @property
    def month_list(self):
        """Gets the month_list of this CreateScheduledTasksReq.

        周期按月时：取值1~12，英文逗号分隔，如1,3,12。

        :return: The month_list of this CreateScheduledTasksReq.
        :rtype: str
        """
    ...
    def month_list(self, month_list):
        """Sets the month_list of this CreateScheduledTasksReq.

        周期按月时：取值1~12，英文逗号分隔，如1,3,12。

        :param month_list: The month_list of this CreateScheduledTasksReq.
        :type month_list: str
        """
    ...
    @property
    def date_list(self):
        """Gets the date_list of this CreateScheduledTasksReq.

        周期按月时：取值1~31及L(代表当月最后一天)，英文逗号分隔，如1,2,28,L。

        :return: The date_list of this CreateScheduledTasksReq.
        :rtype: str
        """
    ...
    def date_list(self, date_list):
        """Sets the date_list of this CreateScheduledTasksReq.

        周期按月时：取值1~31及L(代表当月最后一天)，英文逗号分隔，如1,2,28,L。

        :param date_list: The date_list of this CreateScheduledTasksReq.
        :type date_list: str
        """
    ...
    def scheduled_date(self):
        """Gets the scheduled_date of this CreateScheduledTasksReq.

        周期指定时间时：表示指定的日期，格式为yyyy-MM-dd。

        :return: The scheduled_date of this CreateScheduledTasksReq.
        :rtype: str
        """
    ...
    def scheduled_date(self, scheduled_date):
        """Sets the scheduled_date of this CreateScheduledTasksReq.

        周期指定时间时：表示指定的日期，格式为yyyy-MM-dd。

        :param scheduled_date: The scheduled_date of this CreateScheduledTasksReq.
        :type scheduled_date: str
        """
    ...
    def scheduled_time(self):
        """Gets the scheduled_time of this CreateScheduledTasksReq.

        指定的执行时间点，格式为HH:mm:ss。

        :return: The scheduled_time of this CreateScheduledTasksReq.
        :rtype: str
        """
    ...
    def scheduled_time(self, scheduled_time):
        """Sets the scheduled_time of this CreateScheduledTasksReq.

        指定的执行时间点，格式为HH:mm:ss。

        :param scheduled_time: The scheduled_time of this CreateScheduledTasksReq.
        :type scheduled_time: str
        """
    ...
    def expire_time(self):
        """Gets the expire_time of this CreateScheduledTasksReq.

        到期时间，格式为yyyy-MM-dd HH:mm:ss。

        :return: The expire_time of this CreateScheduledTasksReq.
        :rtype: str
        """
    ...
    def expire_time(self, expire_time):
        """Sets the expire_time of this CreateScheduledTasksReq.

        到期时间，格式为yyyy-MM-dd HH:mm:ss。

        :param expire_time: The expire_time of this CreateScheduledTasksReq.
        :type expire_time: str
        """
    ...
    @property
    def gray_count(self):
        """Gets the gray_count of this CreateScheduledTasksReq.

        灰度对象数量，优先级高于gray_desktop_ids。只支持脚本执行。

        :return: The gray_count of this CreateScheduledTasksReq.
        :rtype: int
        """
    ...
    def gray_count(self, gray_count):
        """Sets the gray_count of this CreateScheduledTasksReq.

        灰度对象数量，优先级高于gray_desktop_ids。只支持脚本执行。

        :param gray_count: The gray_count of this CreateScheduledTasksReq.
        :type gray_count: int
        """
    ...
    def gray_desktop_ids(self):
        """Gets the gray_desktop_ids of this CreateScheduledTasksReq.

        灰度执行的桌面id列表，优先级低于gray_count。只支持脚本执行。

        :return: The gray_desktop_ids of this CreateScheduledTasksReq.
        :rtype: list[str]
        """
    ...
    def gray_desktop_ids(self, gray_desktop_ids):
        """Sets the gray_desktop_ids of this CreateScheduledTasksReq.

        灰度执行的桌面id列表，优先级低于gray_count。只支持脚本执行。

        :param gray_desktop_ids: The gray_desktop_ids of this CreateScheduledTasksReq.
        :type gray_desktop_ids: list[str]
        """
    ...
    def gray_fail_threshold(self):
        """Gets the gray_fail_threshold of this CreateScheduledTasksReq.

        灰度失败阈值，灰度执行失败次数达到该值时，不执行下一批任务。只支持脚本执行。

        :return: The gray_fail_threshold of this CreateScheduledTasksReq.
        :rtype: int
        """
    ...
    def gray_fail_threshold(self, gray_fail_threshold):
        """Sets the gray_fail_threshold of this CreateScheduledTasksReq.

        灰度失败阈值，灰度执行失败次数达到该值时，不执行下一批任务。只支持脚本执行。

        :param gray_fail_threshold: The gray_fail_threshold of this CreateScheduledTasksReq.
        :type gray_fail_threshold: int
        """
    ...
    def life_cycle_type(self):
        """Gets the life_cycle_type of this CreateScheduledTasksReq.
        ...
        :return: The life_cycle_type of this CreateScheduledTasksReq.
        :rtype: str
        """
    ...
    def life_cycle_type(self, life_cycle_type):
        """Sets the life_cycle_type of this CreateScheduledTasksReq.

        触发场景。POST_CREATE_DESKTOP_SUCCESS：创建桌面成功后，POST_REBUILD_DESKTOP_SUCCESS：重建桌面成功后，POST_REATTACH_DESKTOP_SUCCESS：触发重建的分配用户任务成功后。

        :param life_cycle_type: The life_cycle_type of this CreateScheduledTasksReq.
        :type life_cycle_type: str
        """
    ...
    @property
    def time_zone(self):
        """Gets the time_zone of this CreateScheduledTasksReq.

        时区。

        :return: The time_zone of this CreateScheduledTasksReq.
        :rtype: str
        """
    ...
    def time_zone(self, time_zone):
        """Sets the time_zone of this CreateScheduledTasksReq.

        时区。

        :param time_zone: The time_zone of this CreateScheduledTasksReq.
        :type time_zone: str
        """
    ...
    @property
    def task_type(self):
        """Gets the task_type of this CreateScheduledTasksReq.
    ...
    def task_type(self, task_type):
        """Sets the task_type of this CreateScheduledTasksReq.
    ...
    @property
    def task_name(self):
        """Gets the task_name of this CreateScheduledTasksReq.
    ...
    def task_name(self, task_name):
        """Sets the task_name of this CreateScheduledTasksReq.
    ...
    def force_execute(self):
        """Gets the force_execute of this CreateScheduledTasksReq.
    ...
    def force_execute(self, force_execute):
        """Sets the force_execute of this CreateScheduledTasksReq.
    ...
    def description(self):
        """Gets the description of this CreateScheduledTasksReq.
    ...
    def description(self, description):
        """Sets the description of this CreateScheduledTasksReq.
    ...
    def extra_params(self):
        """Gets the extra_params of this CreateScheduledTasksReq.
    ...
    def extra_params(self, extra_params):
        """Sets the extra_params of this CreateScheduledTasksReq.
    ...
    def apply_objects(self):
        """Gets the apply_objects of this CreateScheduledTasksReq.
    ...
    def apply_objects(self, apply_objects):
        """Sets the apply_objects of this CreateScheduledTasksReq.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateScheduledTasksReq):
            return False
