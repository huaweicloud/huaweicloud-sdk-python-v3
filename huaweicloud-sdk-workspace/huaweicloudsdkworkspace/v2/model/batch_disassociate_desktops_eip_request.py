...
class BatchDisassociateDesktopsEipRequest:
    ...
    openapi_types = {
        'body': 'BatchDisassociateDesktopsEipReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchDisassociateDesktopsEipRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDisassociateDesktopsEipRequest):
            return False
