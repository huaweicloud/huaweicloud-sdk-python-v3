...
class UpdateDesktopRequest:
    ...
    openapi_types = {
        'desktop_id': 'str',
        'body': 'ModifyDesktopAttributesReq'
    }
    ...
    def __init__(self, desktop_id=None, body=None):
        ...
        :type desktop_id: str
        :param body: Body of the UpdateDesktopRequest
    ...
    def desktop_id(self):
        ...
        :return: The desktop_id of this UpdateDesktopRequest.
        :rtype: str
        """
    ...
    def desktop_id(self, desktop_id):
        ...
        :param desktop_id: The desktop_id of this UpdateDesktopRequest.
        :type desktop_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateDesktopRequest):
            return False
