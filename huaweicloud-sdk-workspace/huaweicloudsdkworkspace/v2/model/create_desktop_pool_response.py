...
class CreateDesktopPoolResponse(SdkResponse):
    ...
    @property
    def job_id(self):
        r"""Gets the job_id of this CreateDesktopPoolResponse.
    ...
    def job_id(self, job_id):
        r"""Sets the job_id of this CreateDesktopPoolResponse.
    ...
    @property
    def cbc_job_id(self):
        r"""Gets the cbc_job_id of this CreateDesktopPoolResponse.

        【CBC回调】包周期创建桌面的任务ID

        :return: The cbc_job_id of this CreateDesktopPoolResponse.
        :rtype: str
        """
    ...
    def cbc_job_id(self, cbc_job_id):
        r"""Sets the cbc_job_id of this CreateDesktopPoolResponse.

        【CBC回调】包周期创建桌面的任务ID

        :param cbc_job_id: The cbc_job_id of this CreateDesktopPoolResponse.
        :type cbc_job_id: str
        """
    ...
    def get_job_endpoint(self):
        r"""Gets the get_job_endpoint of this CreateDesktopPoolResponse.

        【CBC回调】云运营平台CBC获取到JobId后，会使用getJobEndpoint当做URL，调用云服务，查询获取Job结果。

        :return: The get_job_endpoint of this CreateDesktopPoolResponse.
        :rtype: str
        """
    ...
    def get_job_endpoint(self, get_job_endpoint):
        r"""Sets the get_job_endpoint of this CreateDesktopPoolResponse.

        【CBC回调】云运营平台CBC获取到JobId后，会使用getJobEndpoint当做URL，调用云服务，查询获取Job结果。

        :param get_job_endpoint: The get_job_endpoint of this CreateDesktopPoolResponse.
        :type get_job_endpoint: str
        """
    ...
    def max_provision_time(self):
        r"""Gets the max_provision_time of this CreateDesktopPoolResponse.

        【CBC回调】在线开通最大时间，在maxProvisionTime时间范围内，CBC会周期性的查询云服务开通结果；超过maxProvisionTime还没有开通成功，CBC会发失败工单，人工去分析处理。

        :return: The max_provision_time of this CreateDesktopPoolResponse.
        :rtype: int
        """
    ...
    def max_provision_time(self, max_provision_time):
        r"""Sets the max_provision_time of this CreateDesktopPoolResponse.

        【CBC回调】在线开通最大时间，在maxProvisionTime时间范围内，CBC会周期性的查询云服务开通结果；超过maxProvisionTime还没有开通成功，CBC会发失败工单，人工去分析处理。

        :param max_provision_time: The max_provision_time of this CreateDesktopPoolResponse.
        :type max_provision_time: int
        """
    ...
    def min_provision_time(self):
        r"""Gets the min_provision_time of this CreateDesktopPoolResponse.

        【CBC回调】开通最小时间（云服务最快开通时长，或一般开通时长）。获取到JobId后，经过minProvisionTime时间后，才来查询获取云服务开通结果。如果为空，云运营平台获取到JobId后，就去查询云服务开通结果。

        :return: The min_provision_time of this CreateDesktopPoolResponse.
        :rtype: int
        """
    ...
    def min_provision_time(self, min_provision_time):
        r"""Sets the min_provision_time of this CreateDesktopPoolResponse.

        【CBC回调】开通最小时间（云服务最快开通时长，或一般开通时长）。获取到JobId后，经过minProvisionTime时间后，才来查询获取云服务开通结果。如果为空，云运营平台获取到JobId后，就去查询云服务开通结果。

        :param min_provision_time: The min_provision_time of this CreateDesktopPoolResponse.
        :type min_provision_time: int
        """
    ...
    def periodic_query_time(self):
        r"""Gets the periodic_query_time of this CreateDesktopPoolResponse.

        【CBC回调】云运营平台会使用getJobEndpoint(Job查询接口)、每隔periodicQueryTime时间去查询云服务开通结果。

        :return: The periodic_query_time of this CreateDesktopPoolResponse.
        :rtype: int
        """
    ...
    def periodic_query_time(self, periodic_query_time):
        r"""Sets the periodic_query_time of this CreateDesktopPoolResponse.

        【CBC回调】云运营平台会使用getJobEndpoint(Job查询接口)、每隔periodicQueryTime时间去查询云服务开通结果。

        :param periodic_query_time: The periodic_query_time of this CreateDesktopPoolResponse.
        :type periodic_query_time: int
        """
