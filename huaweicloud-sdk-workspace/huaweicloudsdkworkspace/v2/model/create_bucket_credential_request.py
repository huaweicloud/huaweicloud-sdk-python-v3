...
class CreateBucketCredentialRequest:
    ...
    openapi_types = {
        'body': 'CreateBucketCredentialReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateBucketCredentialRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateBucketCredentialRequest):
            return False
