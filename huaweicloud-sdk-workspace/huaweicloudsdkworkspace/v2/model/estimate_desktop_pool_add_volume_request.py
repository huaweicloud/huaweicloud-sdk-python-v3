...
class EstimateDesktopPoolAddVolumeRequest:
    ...
    openapi_types = {
        'body': 'EstimateAddVolumeRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the EstimateDesktopPoolAddVolumeRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EstimateDesktopPoolAddVolumeRequest):
            return False
