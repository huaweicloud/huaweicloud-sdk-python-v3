...
class BatchDeleteScheduledTasksRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchDeleteScheduledTasksRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteScheduledTasksRequest):
            return False
