...
class BatchDeleteDesktopSnapshotReq:
    ...
    def __init__(self, snapshot_ids=None):
        ...
        :param snapshot_ids: 快照id数组，最多支持100。
    ...
    def snapshot_ids(self):
        ...
        :return: The snapshot_ids of this BatchDeleteDesktopSnapshotReq.
        :rtype: list[str]
        """
    ...
    def snapshot_ids(self, snapshot_ids):
        ...
        :param snapshot_ids: The snapshot_ids of this BatchDeleteDesktopSnapshotReq.
        :type snapshot_ids: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteDesktopSnapshotReq):
            return False
