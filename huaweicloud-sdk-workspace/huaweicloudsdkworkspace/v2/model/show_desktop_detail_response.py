...
class ShowDesktopDetailResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowDesktopDetailResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowDesktopDetailResponse):
            return False
