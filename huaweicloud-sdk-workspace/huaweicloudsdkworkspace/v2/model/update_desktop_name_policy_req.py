...
class UpdateDesktopNamePolicyReq:
    ...
    def prefix_truncation_enabled(self):
        r"""Gets the prefix_truncation_enabled of this UpdateDesktopNamePolicyReq.

        当名称前缀加数字长度生成的桌面名称长度超15位时，是否截断名称前缀部分。

        :return: The prefix_truncation_enabled of this UpdateDesktopNamePolicyReq.
        :rtype: bool
        """
    ...
    def prefix_truncation_enabled(self, prefix_truncation_enabled):
        r"""Sets the prefix_truncation_enabled of this UpdateDesktopNamePolicyReq.

        当名称前缀加数字长度生成的桌面名称长度超15位时，是否截断名称前缀部分。

        :param prefix_truncation_enabled: The prefix_truncation_enabled of this UpdateDesktopNamePolicyReq.
        :type prefix_truncation_enabled: bool
        """
