...
class PoliciesPeripheralsDeviceRedirectionPrinterRedirectionOptions:
    ...
    def __init__(self, mobile_printer_enable=None, print_data_compression_mode=None, sync_client_default_printer_enable=None, universal_printer_driver=None):
        ...
        :param mobile_printer_enable: 移动客户端打印机重定向。取值为： false：表示关闭。 true：表示开启。
        :type mobile_printer_enable: bool
        :param print_data_compression_mode: 是否开启打印数据压缩模式。取值为： false：表示关闭。 true：表示开启。
        :type print_data_compression_mode: bool
        ...
        self._mobile_printer_enable = None
        ...
        if mobile_printer_enable is not None:
            self.mobile_printer_enable = mobile_printer_enable
        if print_data_compression_mode is not None:
            self.print_data_compression_mode = print_data_compression_mode
    ...
    def mobile_printer_enable(self):
        ...
        :return: The mobile_printer_enable of this PoliciesPeripheralsDeviceRedirectionPrinterRedirectionOptions.
        :rtype: bool
        """
        return self._mobile_printer_enable
    ...
    def mobile_printer_enable(self, mobile_printer_enable):
        ...
        :param mobile_printer_enable: The mobile_printer_enable of this PoliciesPeripheralsDeviceRedirectionPrinterRedirectionOptions.
        :type mobile_printer_enable: bool
        """
        self._mobile_printer_enable = mobile_printer_enable
    ...
    def print_data_compression_mode(self):
        ...
        :return: The print_data_compression_mode of this PoliciesPeripheralsDeviceRedirectionPrinterRedirectionOptions.
        :rtype: bool
        """
        return self._print_data_compression_mode
    ...
    def print_data_compression_mode(self, print_data_compression_mode):
        ...
        :param print_data_compression_mode: The print_data_compression_mode of this PoliciesPeripheralsDeviceRedirectionPrinterRedirectionOptions.
        :type print_data_compression_mode: bool
        """
        self._print_data_compression_mode = print_data_compression_mode
    ...
    def sync_client_default_printer_enable(self):
        ...
        :return: The sync_client_default_printer_enable of this PoliciesPeripheralsDeviceRedirectionPrinterRedirectionOptions.
        :rtype: bool
        """
    ...
    def sync_client_default_printer_enable(self, sync_client_default_printer_enable):
        ...
        :param sync_client_default_printer_enable: The sync_client_default_printer_enable of this PoliciesPeripheralsDeviceRedirectionPrinterRedirectionOptions.
        :type sync_client_default_printer_enable: bool
        """
    ...
    def universal_printer_driver(self):
        ...
        :return: The universal_printer_driver of this PoliciesPeripheralsDeviceRedirectionPrinterRedirectionOptions.
        :rtype: str
        """
    ...
    def universal_printer_driver(self, universal_printer_driver):
        ...
        :param universal_printer_driver: The universal_printer_driver of this PoliciesPeripheralsDeviceRedirectionPrinterRedirectionOptions.
        :type universal_printer_driver: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PoliciesPeripheralsDeviceRedirectionPrinterRedirectionOptions):
            return False
