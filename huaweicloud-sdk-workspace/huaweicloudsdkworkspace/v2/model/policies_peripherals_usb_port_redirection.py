...
class PoliciesPeripheralsUsbPortRedirection:
    ...
    def __init__(self, usb_enable=None, options=None):
        ...
        :param options: 
        :type options: :class:`huaweicloudsdkworkspace.v2.PoliciesPeripheralsUsbPortRedirectionOptions`
        """
    ...
    def options(self):
        ...
        :rtype: :class:`huaweicloudsdkworkspace.v2.PoliciesPeripheralsUsbPortRedirectionOptions`
        """
