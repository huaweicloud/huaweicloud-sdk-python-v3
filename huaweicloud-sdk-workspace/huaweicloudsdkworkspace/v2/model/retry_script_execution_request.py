...
class RetryScriptExecutionRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the RetryScriptExecutionRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RetryScriptExecutionRequest):
            return False
