...
class UpdateSubnetIdsRequest:
    ...
    openapi_types = {
        'site_id': 'str',
        'body': 'UpdateSubnetIdsRequestBody'
    }
    ...
    def __init__(self, site_id=None, body=None):
        ...
        :param site_id: 站点ID。
        :type site_id: str
        :param body: Body of the UpdateSubnetIdsRequest
    ...
    def site_id(self):
        ...
        :return: The site_id of this UpdateSubnetIdsRequest.
        :rtype: str
        """
    ...
    def site_id(self, site_id):
        ...
        :param site_id: The site_id of this UpdateSubnetIdsRequest.
        :type site_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateSubnetIdsRequest):
            return False
