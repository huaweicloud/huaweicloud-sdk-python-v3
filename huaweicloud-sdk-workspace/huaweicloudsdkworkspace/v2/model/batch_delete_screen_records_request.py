...
class BatchDeleteScreenRecordsRequest:
    ...
    openapi_types = {
        'body': 'BatchDeleteScreenRecordsRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchDeleteScreenRecordsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteScreenRecordsRequest):
            return False
