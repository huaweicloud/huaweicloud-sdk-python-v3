...
class BatchAssociateInstancesRequest:
    ...
    openapi_types = {
        'body': 'PreBatchAttachInstancesReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchAssociateInstancesRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchAssociateInstancesRequest):
            return False
