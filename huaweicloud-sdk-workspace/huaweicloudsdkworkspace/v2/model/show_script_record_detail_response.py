...
class ShowScriptRecordDetailResponse(SdkResponse):
    ...
    def __init__(self, id=None, script_id=None, script_name=None, script_task_id=None, resource_id=None, resource_name=None, resource_type=None, start_time=None, end_time=None, status=None, execute_order=None, result_code=None, reason=None, output=None):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowScriptRecordDetailResponse.to_dict() is deprecated and no longer maintained, "
