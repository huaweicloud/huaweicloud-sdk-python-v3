...
class PoliciesUserProfileOptions:
    ...
    def __init__(self, user_profile_rule=None, redir_exclude_common_folders=None, redir_exclude_copy0s=None, redir_exclude_copy1s=None, redir_exclude_copy2s=None, redir_exclude_copy3s=None, redir_exclude_includes=None):
        r"""PoliciesUserProfileOptions

        The model defined in huaweicloud sdk

        :param user_profile_rule: 配置项内容。json格式
        :type user_profile_rule: str
        :param redir_exclude_common_folders: 排除常用文件夹。json格式
        :type redir_exclude_common_folders: str
        :param redir_exclude_copy0s: 禁止自定义文件夹/copy base &#x3D; 0,copy back &#x3D; 0。json格式
        :type redir_exclude_copy0s: str
        :param redir_exclude_copy1s: 禁止自定义文件夹/copy base &#x3D; 0,copy back &#x3D; 1。json格式
        :type redir_exclude_copy1s: str
        :param redir_exclude_copy2s: 禁止自定义文件夹/copy base &#x3D; 1,copy back &#x3D; 0。json格式
        :type redir_exclude_copy2s: str
        :param redir_exclude_copy3s: 禁止自定义文件夹/copy base &#x3D; 1,copy back &#x3D; 1。json格式
        :type redir_exclude_copy3s: str
        :param redir_exclude_includes: 允许自定义文件夹 json格式
    ...
    def user_profile_rule(self):
        r"""Gets the user_profile_rule of this PoliciesUserProfileOptions.

        配置项内容。json格式

        :return: The user_profile_rule of this PoliciesUserProfileOptions.
        :rtype: str
        """
    ...
    def user_profile_rule(self, user_profile_rule):
        r"""Sets the user_profile_rule of this PoliciesUserProfileOptions.

        配置项内容。json格式

        :param user_profile_rule: The user_profile_rule of this PoliciesUserProfileOptions.
        :type user_profile_rule: str
        """
    ...
    def redir_exclude_common_folders(self):
        r"""Gets the redir_exclude_common_folders of this PoliciesUserProfileOptions.

        排除常用文件夹。json格式

        :return: The redir_exclude_common_folders of this PoliciesUserProfileOptions.
        :rtype: str
        """
    ...
    def redir_exclude_common_folders(self, redir_exclude_common_folders):
        r"""Sets the redir_exclude_common_folders of this PoliciesUserProfileOptions.

        排除常用文件夹。json格式

        :param redir_exclude_common_folders: The redir_exclude_common_folders of this PoliciesUserProfileOptions.
        :type redir_exclude_common_folders: str
        """
    ...
    def redir_exclude_copy0s(self):
        r"""Gets the redir_exclude_copy0s of this PoliciesUserProfileOptions.

        禁止自定义文件夹/copy base = 0,copy back = 0。json格式

        :return: The redir_exclude_copy0s of this PoliciesUserProfileOptions.
        :rtype: str
        """
    ...
    def redir_exclude_copy0s(self, redir_exclude_copy0s):
        r"""Sets the redir_exclude_copy0s of this PoliciesUserProfileOptions.

        禁止自定义文件夹/copy base = 0,copy back = 0。json格式

        :param redir_exclude_copy0s: The redir_exclude_copy0s of this PoliciesUserProfileOptions.
        :type redir_exclude_copy0s: str
        """
    ...
    def redir_exclude_copy1s(self):
        r"""Gets the redir_exclude_copy1s of this PoliciesUserProfileOptions.

        禁止自定义文件夹/copy base = 0,copy back = 1。json格式

        :return: The redir_exclude_copy1s of this PoliciesUserProfileOptions.
        :rtype: str
        """
    ...
    def redir_exclude_copy1s(self, redir_exclude_copy1s):
        r"""Sets the redir_exclude_copy1s of this PoliciesUserProfileOptions.

        禁止自定义文件夹/copy base = 0,copy back = 1。json格式

        :param redir_exclude_copy1s: The redir_exclude_copy1s of this PoliciesUserProfileOptions.
        :type redir_exclude_copy1s: str
        """
    ...
    def redir_exclude_copy2s(self):
        r"""Gets the redir_exclude_copy2s of this PoliciesUserProfileOptions.

        禁止自定义文件夹/copy base = 1,copy back = 0。json格式

        :return: The redir_exclude_copy2s of this PoliciesUserProfileOptions.
        :rtype: str
        """
    ...
    def redir_exclude_copy2s(self, redir_exclude_copy2s):
        r"""Sets the redir_exclude_copy2s of this PoliciesUserProfileOptions.

        禁止自定义文件夹/copy base = 1,copy back = 0。json格式

        :param redir_exclude_copy2s: The redir_exclude_copy2s of this PoliciesUserProfileOptions.
        :type redir_exclude_copy2s: str
        """
    ...
    def redir_exclude_copy3s(self):
        r"""Gets the redir_exclude_copy3s of this PoliciesUserProfileOptions.

        禁止自定义文件夹/copy base = 1,copy back = 1。json格式

        :return: The redir_exclude_copy3s of this PoliciesUserProfileOptions.
        :rtype: str
        """
    ...
    def redir_exclude_copy3s(self, redir_exclude_copy3s):
        r"""Sets the redir_exclude_copy3s of this PoliciesUserProfileOptions.

        禁止自定义文件夹/copy base = 1,copy back = 1。json格式

        :param redir_exclude_copy3s: The redir_exclude_copy3s of this PoliciesUserProfileOptions.
        :type redir_exclude_copy3s: str
        """
    ...
    def redir_exclude_includes(self):
        r"""Gets the redir_exclude_includes of this PoliciesUserProfileOptions.

        允许自定义文件夹 json格式

        :return: The redir_exclude_includes of this PoliciesUserProfileOptions.
        :rtype: str
        """
    ...
    def redir_exclude_includes(self, redir_exclude_includes):
        r"""Sets the redir_exclude_includes of this PoliciesUserProfileOptions.

        允许自定义文件夹 json格式

        :param redir_exclude_includes: The redir_exclude_includes of this PoliciesUserProfileOptions.
        :type redir_exclude_includes: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PoliciesUserProfileOptions):
            return False
