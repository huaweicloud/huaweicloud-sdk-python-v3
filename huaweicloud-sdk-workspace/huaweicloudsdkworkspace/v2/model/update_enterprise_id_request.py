...
class UpdateEnterpriseIdRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the UpdateEnterpriseIdRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateEnterpriseIdRequest):
            return False
