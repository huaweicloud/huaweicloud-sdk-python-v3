...
class ListUsersResponse(SdkResponse):
    ...
    def __init__(self, total_count=None, users=None):
        r"""ListUsersResponse

        The model defined in huaweicloud sdk

        :param total_count: 用户总数。
    ...
    def total_count(self):
        r"""Gets the total_count of this ListUsersResponse.

        用户总数。

        :return: The total_count of this ListUsersResponse.
        :rtype: int
        """
    ...
    def total_count(self, total_count):
        r"""Sets the total_count of this ListUsersResponse.

        用户总数。

        :param total_count: The total_count of this ListUsersResponse.
        :type total_count: int
        """
