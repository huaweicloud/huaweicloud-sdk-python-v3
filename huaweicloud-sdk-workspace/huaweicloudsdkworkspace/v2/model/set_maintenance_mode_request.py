...
class SetMaintenanceModeRequest:
    ...
    openapi_types = {
        'body': 'BatchSetMaintenanceModeReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the SetMaintenanceModeRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SetMaintenanceModeRequest):
            return False
