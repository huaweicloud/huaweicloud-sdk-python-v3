...
class ListTenantProfilesResponse(SdkResponse):
    ...
    @property
    def body(self):
        r"""Gets the body of this ListTenantProfilesResponse.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this ListTenantProfilesResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListTenantProfilesResponse.to_dict() is deprecated and no longer maintained, "
