...
class BatchOperateAppRulesReq:
    ...
    def items(self):
        ...
        :return: The items of this BatchOperateAppRulesReq.
        :rtype: list[str]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :param items: The items of this BatchOperateAppRulesReq.
        :type items: list[str]
        """
        self._items = items
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchOperateAppRulesReq):
            return False
