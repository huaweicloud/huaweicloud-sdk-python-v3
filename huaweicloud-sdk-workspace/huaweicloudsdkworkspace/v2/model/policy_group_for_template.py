...
class PolicyGroupForTemplate:
    ...
    def __init__(self, policy_group_name=None, description=None, policies=None, policy_group_type=None):
        ...
        :param policies: 策略。
        :type policies: str
        :param policy_group_type: 策略组类型。
        :type policy_group_type: str
        """
    ...
    def policy_group_name(self):
        r"""Gets the policy_group_name of this PolicyGroupForTemplate.

        策略组名称。

        :return: The policy_group_name of this PolicyGroupForTemplate.
        :rtype: str
        """
    ...
    def policy_group_name(self, policy_group_name):
        r"""Sets the policy_group_name of this PolicyGroupForTemplate.

        策略组名称。

        :param policy_group_name: The policy_group_name of this PolicyGroupForTemplate.
        :type policy_group_name: str
        """
    ...
    @property
    def policies(self):
        r"""Gets the policies of this PolicyGroupForTemplate.

        策略。

        :return: The policies of this PolicyGroupForTemplate.
        :rtype: str
        """
    ...
    def policies(self, policies):
        r"""Sets the policies of this PolicyGroupForTemplate.

        策略。

        :param policies: The policies of this PolicyGroupForTemplate.
        :type policies: str
        """
    ...
    def policy_group_type(self):
        r"""Gets the policy_group_type of this PolicyGroupForTemplate.

        策略组类型。

        :return: The policy_group_type of this PolicyGroupForTemplate.
        :rtype: str
        """
    ...
    def policy_group_type(self, policy_group_type):
        r"""Sets the policy_group_type of this PolicyGroupForTemplate.

        策略组类型。

        :param policy_group_type: The policy_group_type of this PolicyGroupForTemplate.
        :type policy_group_type: str
        """
