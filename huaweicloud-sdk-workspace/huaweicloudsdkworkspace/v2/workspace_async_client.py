...
class WorkspaceAsyncClient(Client):
    ...
    def update_full_speed_record_config_async(self, request):
        r"""更新录屏全速上传详情
    ...
    def update_full_speed_record_config_async_invoker(self, request):
        http_info = self._update_full_speed_record_config_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_full_speed_record_config_http_info(self, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v2/{project_id}/screen-records/{record_id}",
            "request_type": request.__class__.__name__,
