...
class WorkspaceClient(Client):
    ...
    def list_desktops_status(self, request):
        ...
        """
        warnings.warn("Method 'list_desktops_status' of WorkspaceClient is deprecated and will be removed in the future versions", DeprecationWarning)
        http_info = self._list_desktops_status_http_info(request)
        return self._call_api(**http_info)

    def list_desktops_status_invoker(self, request):
        warnings.warn("Method 'list_desktops_status_invoker' of WorkspaceClient is deprecated and will be removed in the future versions", DeprecationWarning)
        http_info = self._list_desktops_status_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_desktops_status_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_history_online_info_invoker(self, request):
        http_info = self._list_history_online_info_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_history_online_info_http_info(cls, request):
        http_info = {
            "method": "GET",
