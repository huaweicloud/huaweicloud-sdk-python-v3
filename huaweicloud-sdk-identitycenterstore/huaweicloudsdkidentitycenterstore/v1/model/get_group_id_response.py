...
class GetGroupIdResponse(SdkResponse):
    ...
    def __init__(self, group_id=None, identity_store_id=None):
        ...
        super(GetGroupIdResponse, self).__init__()
    ...
    @property
    def group_id(self):
        """Gets the group_id of this GetGroupIdResponse.
    ...
    def group_id(self, group_id):
        """Sets the group_id of this GetGroupIdResponse.
    ...
    def identity_store_id(self):
        """Gets the identity_store_id of this GetGroupIdResponse.

        身份源的全局唯一标识符（ID）

        :return: The identity_store_id of this GetGroupIdResponse.
        :rtype: str
        """
    ...
    def identity_store_id(self, identity_store_id):
        """Sets the identity_store_id of this GetGroupIdResponse.

        身份源的全局唯一标识符（ID）

        :param identity_store_id: The identity_store_id of this GetGroupIdResponse.
        :type identity_store_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetGroupIdResponse):
            return False
