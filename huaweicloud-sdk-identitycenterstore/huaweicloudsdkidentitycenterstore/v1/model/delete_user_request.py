...
class DeleteUserRequest:
    ...
    def x_security_token(self):
        r"""Gets the x_security_token of this DeleteUserRequest.

        如果正在使用临时安全凭据，则此header是必需的，该值是临时安全凭据的安全令牌（会话令牌）。

        :return: The x_security_token of this DeleteUserRequest.
        :rtype: str
        """
    ...
    def x_security_token(self, x_security_token):
        r"""Sets the x_security_token of this DeleteUserRequest.

        如果正在使用临时安全凭据，则此header是必需的，该值是临时安全凭据的安全令牌（会话令牌）。

        :param x_security_token: The x_security_token of this DeleteUserRequest.
        :type x_security_token: str
        """
    ...
    def identity_store_id(self):
        r"""Gets the identity_store_id of this DeleteUserRequest.

        身份源的全局唯一标识符（ID）

        :return: The identity_store_id of this DeleteUserRequest.
        :rtype: str
        """
    ...
    def identity_store_id(self, identity_store_id):
        r"""Sets the identity_store_id of this DeleteUserRequest.

        身份源的全局唯一标识符（ID）

        :param identity_store_id: The identity_store_id of this DeleteUserRequest.
        :type identity_store_id: str
        """
