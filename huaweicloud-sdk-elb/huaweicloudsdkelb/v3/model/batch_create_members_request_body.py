...
class BatchCreateMembersRequestBody:
    ...
    openapi_types = {
        'members': 'list[BatchCreateMembersOption]'
    }
    ...
    @property
    def members(self):
        """Gets the members of this BatchCreateMembersRequestBody.
    ...
    def members(self, members):
        """Sets the members of this BatchCreateMembersRequestBody.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchCreateMembersRequestBody):
            return False
