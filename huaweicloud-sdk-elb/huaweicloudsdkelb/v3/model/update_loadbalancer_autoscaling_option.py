...
class UpdateLoadbalancerAutoscalingOption:
    ...
    def __init__(self, enable=None, min_l4_flavor_id=None, min_l7_flavor_id=None):
        """UpdateLoadbalancerAutoscalingOption - a model defined in huaweicloud sdk"""
    ...
    def min_l4_flavor_id(self):
        """Gets the min_l4_flavor_id of this UpdateLoadbalancerAutoscalingOption.

        弹性扩缩容的最小四层规格ID，有四层监听器时，该字段不能为空。

        :return: The min_l4_flavor_id of this UpdateLoadbalancerAutoscalingOption.
        :rtype: str
        """
    ...
    def min_l4_flavor_id(self, min_l4_flavor_id):
        """Sets the min_l4_flavor_id of this UpdateLoadbalancerAutoscalingOption.

        弹性扩缩容的最小四层规格ID，有四层监听器时，该字段不能为空。

        :param min_l4_flavor_id: The min_l4_flavor_id of this UpdateLoadbalancerAutoscalingOption.
        :type: str
        """
