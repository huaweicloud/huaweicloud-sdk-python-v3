...
class SystemDefaultDnsConfigRequestBody:
    ...
    def __init__(self, private_domain_name_enable=None, private_dns_record_set_ttl=None, public_domain_name_enable=None, public_dns_record_set_ttl=None):
        r"""SystemDefaultDnsConfigRequestBody

        The model defined in huaweicloud sdk

        :param private_domain_name_enable: **参数解释**：是否启用私网域名解析。  **约束限制**：不涉及  **取值范围**： - true：开启私网域名解析。 - false：关闭私网域名解析。  **默认取值**：false
