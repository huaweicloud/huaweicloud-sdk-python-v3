...
class UpdateSystemDefaultDomainConfigRequest:
    ...
    openapi_types = {
        'loadbalancer_id': 'str',
        'body': 'UpdateSystemDefaultDomainConfigRequestBody'
    }
    ...
    def __init__(self, loadbalancer_id=None, body=None):
        r"""UpdateSystemDefaultDomainConfigRequest
    ...
    @property
    def body(self):
        r"""Gets the body of this UpdateSystemDefaultDomainConfigRequest.

        :return: The body of this UpdateSystemDefaultDomainConfigRequest.
        :rtype: :class:`huaweicloudsdkelb.v3.UpdateSystemDefaultDomainConfigRequestBody`
        """
        return self._body

    @body.setter
    def body(self, body):
        r"""Sets the body of this UpdateSystemDefaultDomainConfigRequest.

        :param body: The body of this UpdateSystemDefaultDomainConfigRequest.
        :type body: :class:`huaweicloudsdkelb.v3.UpdateSystemDefaultDomainConfigRequestBody`
        """
        self._body = body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateSystemDefaultDomainConfigRequest):
            return False
