...
class BatchDisableDomainIPsResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchDisableDomainIPsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDisableDomainIPsResponse):
            return False
