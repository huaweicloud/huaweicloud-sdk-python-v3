...
class UpdateIpGroupIpListOption:
    ...
    @property
    def name(self):
        """Gets the name of this UpdateIpGroupIpListOption.

        IP地址组的名称

        :return: The name of this UpdateIpGroupIpListOption.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this UpdateIpGroupIpListOption.
    ...
    @property
    def ip_list(self):
        """Gets the ip_list of this UpdateIpGroupIpListOption.
    ...
    def ip_list(self, ip_list):
        """Sets the ip_list of this UpdateIpGroupIpListOption.
    ...
    def description(self):
        """Gets the description of this UpdateIpGroupIpListOption.

        IP地址组的描述信息

        :return: The description of this UpdateIpGroupIpListOption.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this UpdateIpGroupIpListOption.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateIpGroupIpListOption):
            return False
