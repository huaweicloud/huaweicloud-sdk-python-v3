...
class CreateLoadBalancerBandwidthOption:
    ...
    def __init__(self, name=None, size=None, charge_mode=None, share_type=None, billing_info=None, id=None):
        ...
        :type size: int
        :param charge_mode: 计费模式。   [取值范围：bandwidth 表示按带宽计费，traffic表示按流量计费。](tag:hws,hws_hk,ocb,tlf,ctc,hcs,sbc,g42,tm,cmcc,hk_g42,mix,hk_sbc,hws_ocb,fcs)   [当前仅支持traffic按流量计费](tag:dt,dt_test,hcso_dt)   使用说明：当id字段为null时，charge_mode是必须的。
