...
class ShowMemberResponse(SdkResponse):
    ...
    @property
    def request_id(self):
        r"""Gets the request_id of this ShowMemberResponse.
    ...
    def request_id(self, request_id):
        r"""Sets the request_id of this ShowMemberResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowMemberResponse.to_dict() is deprecated and no longer maintained, "
