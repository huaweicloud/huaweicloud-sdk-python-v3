...
class UpdateLoadBalancerResponse(SdkResponse):
    ...
    def __init__(self, loadbalancer=None, loadbalancer_id=None, order_id=None, request_id=None):
        ...
        :param loadbalancer_id: 负载均衡器的id[（包周期场景返回该字段）  不支持该字段，请勿使用](tag:hws_eu,g42,hk_g42,dt,dt_test,hcso_dt,hk_vdf,fcs,ctc,cmcc)
        :type loadbalancer_id: str
        :param order_id: 订单号[（包周期规格变更场景返回该字段）  不支持该字段，请勿使用](tag:hws_eu,g42,hk_g42,dt,dt_test,hcso_dt,hk_vdf,fcs,ctc,cmcc)
        :type order_id: str
