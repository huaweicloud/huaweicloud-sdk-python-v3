...
class CreateTrafficLimitConfig:
    ...
    @property
    def qps(self):
        r"""Gets the qps of this CreateTrafficLimitConfig.
    ...
    @qps.setter
    def qps(self, qps):
        r"""Sets the qps of this CreateTrafficLimitConfig.
    ...
    def per_source_ip_qps(self):
        r"""Gets the per_source_ip_qps of this CreateTrafficLimitConfig.
    ...
    def per_source_ip_qps(self, per_source_ip_qps):
        r"""Sets the per_source_ip_qps of this CreateTrafficLimitConfig.
    ...
    @property
    def burst(self):
        r"""Gets the burst of this CreateTrafficLimitConfig.
    ...
    def burst(self, burst):
        r"""Sets the burst of this CreateTrafficLimitConfig.
