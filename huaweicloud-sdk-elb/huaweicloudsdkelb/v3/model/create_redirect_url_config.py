...
class CreateRedirectUrlConfig:
    ...
    def __init__(self, protocol=None, host=None, port=None, path=None, query=None, status_code=None, insert_headers_config=None, remove_headers_config=None):
        r"""CreateRedirectUrlConfig

        The model defined in huaweicloud sdk

        :param protocol: **参数解释**：重定向的协议。  **约束限制**：不涉及  **取值范围**： - HTTP - HTTPS - ${protocol}，表示继承原值（即与被转发请求保持一致）。  **默认取值**：${protocol}
        :type protocol: str
        :param host: **参数解释**：重定向的主机名。  **约束限制**：不涉及  **取值范围**：字符串只能包含英文字母、数字、“-”、“.”，必须以字母、数字开头。  **默认取值**：${host}，表示继承原值（即与被转发请求保持一致）。
        :type host: str
        :param port: **参数解释**：重定向到的端口。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：${port}，表示继承原值（即与被转发请求保持一致）。
        :type port: str
        :param path: **参数解释**：重定向的路径。  **约束限制**：不涉及  **取值范围**：只能包含英文字母、数字、_~&#39;;@^-%#&amp;$.\\*+?,&#x3D;!:|\\/()\\[\\]{}，且必须以\&quot;/\&quot;开头。其中$1，$2会匹配请求url通配符星号（\\*）  **默认取值**：${path}，表示继承原值（即与被转发请求保持一致）。
        :type path: str
        :param query: **参数解释**：重定向的查询字符串。举例如下： 将query设置为：${query}&amp;name&#x3D;my_name，则在转发符合条件的URL（如https://www.example.com:8080/elb?type&#x3D;loadbalancer）时，将会重定向到https://www.example.com:8080/elb?type&#x3D;loadbalancer&amp;name&#x3D;my_name。在例子中${query}表示type&#x3D;loadbalancer。  **约束限制**：不涉及  **取值范围**：只能包含英文字母、数字和特殊字符：!$&amp;&#39;()\\*+,-./:;&#x3D;?@^_&#x60;。字母区分大小写。其中$1，$2会匹配请求url通配符星号（\\*）  **默认取值**：${query}表示继承原值（即与被转发请求保持一致）
        :type query: str
        :param status_code: **参数解释**：重定向后的返回码。  **约束限制**：不涉及  **取值范围**： - 301 - 302 - 303 - 307 - 308  **默认取值**：不涉及
    ...
    @property
    def protocol(self):
        r"""Gets the protocol of this CreateRedirectUrlConfig.

        **参数解释**：重定向的协议。  **约束限制**：不涉及  **取值范围**： - HTTP - HTTPS - ${protocol}，表示继承原值（即与被转发请求保持一致）。  **默认取值**：${protocol}
    ...
    def protocol(self, protocol):
        r"""Sets the protocol of this CreateRedirectUrlConfig.
    ...
    @property
    def host(self):
        r"""Gets the host of this CreateRedirectUrlConfig.
    ...
    @host.setter
    def host(self, host):
        r"""Sets the host of this CreateRedirectUrlConfig.
    ...
    @property
    def port(self):
        r"""Gets the port of this CreateRedirectUrlConfig.
    ...
    @port.setter
    def port(self, port):
        r"""Sets the port of this CreateRedirectUrlConfig.
    ...
    @property
    def path(self):
        r"""Gets the path of this CreateRedirectUrlConfig.

        **参数解释**：重定向的路径。  **约束限制**：不涉及  **取值范围**：只能包含英文字母、数字、_~';@^-%#&$.\\*+?,=!:|\\/()\\[\\]{}，且必须以\"/\"开头。其中$1，$2会匹配请求url通配符星号（\\*）  **默认取值**：${path}，表示继承原值（即与被转发请求保持一致）。
    ...
    @path.setter
    def path(self, path):
        r"""Sets the path of this CreateRedirectUrlConfig.
    ...
    @property
    def query(self):
        r"""Gets the query of this CreateRedirectUrlConfig.
    ...
    def query(self, query):
        r"""Sets the query of this CreateRedirectUrlConfig.
    ...
    def status_code(self):
        r"""Gets the status_code of this CreateRedirectUrlConfig.
    ...
    def status_code(self, status_code):
        r"""Sets the status_code of this CreateRedirectUrlConfig.
    ...
    def insert_headers_config(self):
        r"""Gets the insert_headers_config of this CreateRedirectUrlConfig.
    ...
    def insert_headers_config(self, insert_headers_config):
        r"""Sets the insert_headers_config of this CreateRedirectUrlConfig.
    ...
    def remove_headers_config(self):
        r"""Gets the remove_headers_config of this CreateRedirectUrlConfig.
    ...
    def remove_headers_config(self, remove_headers_config):
        r"""Sets the remove_headers_config of this CreateRedirectUrlConfig.
