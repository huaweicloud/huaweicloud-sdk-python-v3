...
class BatchMember:
    ...
    def __init__(self, id=None, name=None, project_id=None, admin_state_up=None, subnet_cidr_id=None, protocol_port=None, weight=None, address=None, operating_status=None, status=None, member_type=None, instance_id=None, port_id=None, ret_status=None):
        ...
        :type address: str
        :param operating_status: 后端云服务器的健康状态。当响应参数的status字段非空时，以status字段中监听器粒度的健康检查状态优先。  取值： - ONLINE：后端云服务器正常。 - NO_MONITOR：后端云服务器所在的服务器组没有健康检查器。 - OFFLINE：后端云服务器关联的ECS服务器不存在或已关机。
    ...
    @property
    def id(self):
        """Gets the id of this BatchMember.
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this BatchMember.
    ...
    @property
    def name(self):
        """Gets the name of this BatchMember.
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this BatchMember.
    ...
    @property
    def project_id(self):
        """Gets the project_id of this BatchMember.
    ...
    def project_id(self, project_id):
        """Sets the project_id of this BatchMember.
    ...
    def instance_id(self):
        """Gets the instance_id of this BatchMember.
    ...
    def instance_id(self, instance_id):
        """Sets the instance_id of this BatchMember.
    ...
    @property
    def port_id(self):
        """Gets the port_id of this BatchMember.
    ...
    def port_id(self, port_id):
        """Sets the port_id of this BatchMember.
    ...
    @property
    def ret_status(self):
        """Gets the ret_status of this BatchMember.
    ...
    def ret_status(self, ret_status):
        """Sets the ret_status of this BatchMember.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchMember):
            return False
