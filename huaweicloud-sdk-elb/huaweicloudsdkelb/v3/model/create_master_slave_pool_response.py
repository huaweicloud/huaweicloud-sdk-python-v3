...
class CreateMasterSlavePoolResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, pool=None):
        r"""CreateMasterSlavePoolResponse
    ...
    @property
    def pool(self):
        r"""Gets the pool of this CreateMasterSlavePoolResponse.
    ...
    @pool.setter
    def pool(self, pool):
        r"""Sets the pool of this CreateMasterSlavePoolResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateMasterSlavePoolResponse.to_dict() is deprecated and no longer maintained, "
