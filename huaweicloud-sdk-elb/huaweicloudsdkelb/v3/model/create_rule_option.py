...
class CreateRuleOption:
    ...
    def __init__(self, admin_state_up=None, compare_type=None, key=None, value=None, project_id=None, type=None, invert=None, conditions=None):
        ...
        :type project_id: str
        :param type: **参数解释**：转发规则类别。  **约束限制**： - 一个l7policy下创建的l7rule的HOST_NAME，PATH，METHOD，SOURCE_IP不能重复。HEADER、QUERY_STRING支持重复的rule配置。  **取值范围**： - HOST_NAME：匹配域名。 - PATH：匹配请求路径。 - METHOD：匹配请求方法。 - HEADER：匹配请求头。 - QUERY_STRING：匹配请求查询参数。 - SOURCE_IP：匹配请求源IP地址。 - COOKIE: 匹配cookie信息。 [只支持取值为HOST_NAME，PATH。](tag:hcso_dt)  **默认取值**：不涉及
        :type type: str
        :param invert: **参数解释**：是否反向匹配。  **约束限制**：不涉及  **取值范围**：true、false  **默认取值**：false  不支持该字段，请勿使用。
        :type invert: bool
        :param conditions: **参数解释**：转发规则的匹配条件。  **约束限制**： - 当监听器的高级转发策略功能（enhance_l7policy_enable）开启后才会生效。 - 若转发规则配置了conditions，字段key、字段value的值无意义。 - 同一个rule内的conditions列表中所有key必须相同，value不允许重复。  **取值范围**：不涉及  **默认取值**：不涉及  [不支持该字段，请勿使用。](tag:hcso_dt)  [荷兰region不支持该字段，请勿使用。](tag:dt)
    ...
    def admin_state_up(self):
        r"""Gets the admin_state_up of this CreateRuleOption.
    ...
    def admin_state_up(self, admin_state_up):
        r"""Sets the admin_state_up of this CreateRuleOption.
    ...
    @property
    def key(self):
        r"""Gets the key of this CreateRuleOption.
    ...
    @key.setter
    def key(self, key):
        r"""Sets the key of this CreateRuleOption.
    ...
    @property
    def project_id(self):
        r"""Gets the project_id of this CreateRuleOption.

        **参数解释**：转发规则所在的项目ID。  **约束限制**：不涉及  **取值范围**：不涉及  **默认取值**：不涉及
    ...
    def project_id(self, project_id):
        r"""Sets the project_id of this CreateRuleOption.
    ...
    @property
    def type(self):
        r"""Gets the type of this CreateRuleOption.

        **参数解释**：转发规则类别。  **约束限制**： - 一个l7policy下创建的l7rule的HOST_NAME，PATH，METHOD，SOURCE_IP不能重复。HEADER、QUERY_STRING支持重复的rule配置。  **取值范围**： - HOST_NAME：匹配域名。 - PATH：匹配请求路径。 - METHOD：匹配请求方法。 - HEADER：匹配请求头。 - QUERY_STRING：匹配请求查询参数。 - SOURCE_IP：匹配请求源IP地址。 - COOKIE: 匹配cookie信息。 [只支持取值为HOST_NAME，PATH。](tag:hcso_dt)  **默认取值**：不涉及
    ...
    @type.setter
    def type(self, type):
        r"""Sets the type of this CreateRuleOption.
    ...
    @property
    def invert(self):
        r"""Gets the invert of this CreateRuleOption.
    ...
    def invert(self, invert):
        r"""Sets the invert of this CreateRuleOption.
    ...
    @property
    def conditions(self):
        r"""Gets the conditions of this CreateRuleOption.
    ...
    def conditions(self, conditions):
        r"""Sets the conditions of this CreateRuleOption.
