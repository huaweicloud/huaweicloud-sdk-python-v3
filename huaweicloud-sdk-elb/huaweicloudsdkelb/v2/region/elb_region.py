...
class ElbRegion:
    ...
    CN_NORTH_9 = Region(id="cn-north-9", endpoint="https://elb.cn-north-9.myhuaweicloud.com")
    ...
    LA_NORTH_2 = Region(id="la-north-2", endpoint="https://elb.la-north-2.myhuaweicloud.com")
