...
class ListLoadbalancersByTagsRequest:
    ...
    openapi_types = {
        'body': 'ListLoadbalancersByTagsRequestBody'
    }
    ...
    def __init__(self, body=None):
        """ListLoadbalancersByTagsRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: ListLoadbalancersByTagsRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListLoadbalancersByTagsRequest):
            return False
