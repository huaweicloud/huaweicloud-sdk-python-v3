...
class BatchDeleteListenerTagsRequest:
    ...
    openapi_types = {
        'listener_id': 'str',
        'body': 'BatchDeleteListenerTagsRequestBody'
    }
    ...
    def listener_id(self):
        ...
        :return: The listener_id of this BatchDeleteListenerTagsRequest.
        :rtype: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteListenerTagsRequest):
            return False
