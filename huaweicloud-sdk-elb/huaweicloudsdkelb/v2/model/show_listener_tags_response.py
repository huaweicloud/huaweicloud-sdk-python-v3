...
class ShowListenerTagsResponse(SdkResponse):
    ...
    @property
    def tags(self):
        r"""Gets the tags of this ShowListenerTagsResponse.
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this ShowListenerTagsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowListenerTagsResponse.to_dict() is deprecated and no longer maintained, "
