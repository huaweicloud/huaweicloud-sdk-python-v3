...
class CreateL7policyResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateL7policyResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateL7policyResponse):
            return False
