...
class CreateLoadbalancerTagsRequestBody:
    ...
    def __init__(self, tag=None):
        r"""CreateLoadbalancerTagsRequestBody
    ...
    @property
    def tag(self):
        r"""Gets the tag of this CreateLoadbalancerTagsRequestBody.
    ...
    @tag.setter
    def tag(self, tag):
        r"""Sets the tag of this CreateLoadbalancerTagsRequestBody.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateLoadbalancerTagsRequestBody):
            return False
