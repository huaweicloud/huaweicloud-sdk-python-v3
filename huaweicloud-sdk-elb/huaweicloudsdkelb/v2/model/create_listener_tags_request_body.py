...
class CreateListenerTagsRequestBody:
    ...
    def __init__(self, tag=None):
        r"""CreateListenerTagsRequestBody
    ...
    @property
    def tag(self):
        r"""Gets the tag of this CreateListenerTagsRequestBody.
    ...
    @tag.setter
    def tag(self, tag):
        r"""Sets the tag of this CreateListenerTagsRequestBody.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateListenerTagsRequestBody):
            return False
