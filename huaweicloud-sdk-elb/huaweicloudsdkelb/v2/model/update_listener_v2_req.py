...
class UpdateListenerV2Req:
    ...
    def __init__(self, name=None, description=None, connection_limit=-1, http2_enable=False, default_pool_id='null', default_tls_container_ref=None, client_ca_tls_container_ref=None, sni_container_refs=None, insert_headers=None, tls_ciphers_policy=None, admin_state_up=None):
        """UpdateListenerV2Req - a model defined in huaweicloud sdk"""
    ...
    @property
    def name(self):
        """Gets the name of this UpdateListenerV2Req.

        监听器名称。

        :return: The name of this UpdateListenerV2Req.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this UpdateListenerV2Req.

        监听器名称。

        :param name: The name of this UpdateListenerV2Req.
        :type: str
        """
        self._name = name
    ...
    def description(self):
        """Gets the description of this UpdateListenerV2Req.

        监听器的描述信息

        :return: The description of this UpdateListenerV2Req.
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this UpdateListenerV2Req.

        监听器的描述信息

        :param description: The description of this UpdateListenerV2Req.
        :type: str
        """
    ...
    def connection_limit(self):
        """Gets the connection_limit of this UpdateListenerV2Req.

        监听器的最大连接数。该字段为预留字段，暂未启用。默认为-1。

        :return: The connection_limit of this UpdateListenerV2Req.
        :rtype: int
        """
    ...
    def connection_limit(self, connection_limit):
        """Sets the connection_limit of this UpdateListenerV2Req.

        监听器的最大连接数。该字段为预留字段，暂未启用。默认为-1。

        :param connection_limit: The connection_limit of this UpdateListenerV2Req.
        :type: int
        """
    ...
    def http2_enable(self):
        """Gets the http2_enable of this UpdateListenerV2Req.

        HTTP2功能的开启状态。该字段只有当监听器的协议是TERMINATED_HTTPS时生效。

        :return: The http2_enable of this UpdateListenerV2Req.
        :rtype: bool
        """
    ...
    def http2_enable(self, http2_enable):
        """Sets the http2_enable of this UpdateListenerV2Req.

        HTTP2功能的开启状态。该字段只有当监听器的协议是TERMINATED_HTTPS时生效。

        :param http2_enable: The http2_enable of this UpdateListenerV2Req.
        :type: bool
        """
    ...
    def default_pool_id(self):
        """Gets the default_pool_id of this UpdateListenerV2Req.

        监听器的默认后端云服务器组ID。当请求没有匹配的转发策略时，转发到默认后端云服务器上处理。当该字段为null时，表示监听器无默认的后端云服务器组。

        :return: The default_pool_id of this UpdateListenerV2Req.
        :rtype: str
        """
    ...
    def default_pool_id(self, default_pool_id):
        """Sets the default_pool_id of this UpdateListenerV2Req.

        监听器的默认后端云服务器组ID。当请求没有匹配的转发策略时，转发到默认后端云服务器上处理。当该字段为null时，表示监听器无默认的后端云服务器组。

        :param default_pool_id: The default_pool_id of this UpdateListenerV2Req.
        :type: str
        """
    ...
    def default_tls_container_ref(self):
        """Gets the default_tls_container_ref of this UpdateListenerV2Req.

        监听器使用的服务器证书ID。当protocol参数为TERMINATED_HTTPS时，为必选字段

        :return: The default_tls_container_ref of this UpdateListenerV2Req.
        :rtype: str
        """
    ...
    def default_tls_container_ref(self, default_tls_container_ref):
        """Sets the default_tls_container_ref of this UpdateListenerV2Req.

        监听器使用的服务器证书ID。当protocol参数为TERMINATED_HTTPS时，为必选字段

        :param default_tls_container_ref: The default_tls_container_ref of this UpdateListenerV2Req.
        :type: str
        """
    ...
    def client_ca_tls_container_ref(self):
        """Gets the client_ca_tls_container_ref of this UpdateListenerV2Req.

        监听器使用的CA证书ID。

        :return: The client_ca_tls_container_ref of this UpdateListenerV2Req.
        :rtype: str
        """
    ...
    def client_ca_tls_container_ref(self, client_ca_tls_container_ref):
        """Sets the client_ca_tls_container_ref of this UpdateListenerV2Req.

        监听器使用的CA证书ID。

        :param client_ca_tls_container_ref: The client_ca_tls_container_ref of this UpdateListenerV2Req.
        :type: str
        """
    ...
    def sni_container_refs(self):
        """Gets the sni_container_refs of this UpdateListenerV2Req.

        监听器使用的SNI证书（带域名的服务器证书）ID的列表。

        :return: The sni_container_refs of this UpdateListenerV2Req.
        :rtype: list[str]
        """
    ...
    def sni_container_refs(self, sni_container_refs):
        """Sets the sni_container_refs of this UpdateListenerV2Req.

        监听器使用的SNI证书（带域名的服务器证书）ID的列表。

        :param sni_container_refs: The sni_container_refs of this UpdateListenerV2Req.
        :type: list[str]
        """
    ...
    def insert_headers(self):
        """Gets the insert_headers of this UpdateListenerV2Req.


        :return: The insert_headers of this UpdateListenerV2Req.
        :rtype: InsertHeader
        """
    ...
    def insert_headers(self, insert_headers):
        """Sets the insert_headers of this UpdateListenerV2Req.


        :param insert_headers: The insert_headers of this UpdateListenerV2Req.
        :type: InsertHeader
        """
    ...
    def tls_ciphers_policy(self):
        """Gets the tls_ciphers_policy of this UpdateListenerV2Req.

        监听器使用的安全策略，仅对TERMINATED_HTTPS协议类型的监听器有效。  取值包括：tls-1-0, tls-1-1, tls-1-2, tls-1-2-strict多种安全策略。

        :return: The tls_ciphers_policy of this UpdateListenerV2Req.
        :rtype: str
        """
    ...
    def tls_ciphers_policy(self, tls_ciphers_policy):
        """Sets the tls_ciphers_policy of this UpdateListenerV2Req.

        监听器使用的安全策略，仅对TERMINATED_HTTPS协议类型的监听器有效。  取值包括：tls-1-0, tls-1-1, tls-1-2, tls-1-2-strict多种安全策略。

        :param tls_ciphers_policy: The tls_ciphers_policy of this UpdateListenerV2Req.
        :type: str
        """
    ...
    def admin_state_up(self):
        """Gets the admin_state_up of this UpdateListenerV2Req.

        监听器的管理状态。  该字段为预留字段，暂未启动。只支持设定为true

        :return: The admin_state_up of this UpdateListenerV2Req.
        :rtype: bool
        """
    ...
    def admin_state_up(self, admin_state_up):
        """Sets the admin_state_up of this UpdateListenerV2Req.

        监听器的管理状态。  该字段为预留字段，暂未启动。只支持设定为true

        :param admin_state_up: The admin_state_up of this UpdateListenerV2Req.
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateListenerV2Req):
            return False
