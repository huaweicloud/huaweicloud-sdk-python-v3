...
class ShowCertificateResponse(SdkResponse):
    ...
    @property
    def tenant_id(self):
        r"""Gets the tenant_id of this ShowCertificateResponse.

        SSL证书所在的项目ID

        :return: The tenant_id of this ShowCertificateResponse.
        :rtype: str
        """
    ...
    def tenant_id(self, tenant_id):
        r"""Sets the tenant_id of this ShowCertificateResponse.

        SSL证书所在的项目ID

        :param tenant_id: The tenant_id of this ShowCertificateResponse.
        :type tenant_id: str
        """
    ...
    def admin_state_up(self):
        r"""Gets the admin_state_up of this ShowCertificateResponse.

        SSL证书的管理状态；暂不支持

        :return: The admin_state_up of this ShowCertificateResponse.
        :rtype: bool
        """
    ...
    def admin_state_up(self, admin_state_up):
        r"""Sets the admin_state_up of this ShowCertificateResponse.

        SSL证书的管理状态；暂不支持

        :param admin_state_up: The admin_state_up of this ShowCertificateResponse.
        :type admin_state_up: bool
        """
    ...
    def private_key(self):
        r"""Gets the private_key of this ShowCertificateResponse.

        服务器证书的私钥。仅type为server时有效。type为server时必选。

        :return: The private_key of this ShowCertificateResponse.
        :rtype: str
        """
    ...
    def private_key(self, private_key):
        r"""Sets the private_key of this ShowCertificateResponse.

        服务器证书的私钥。仅type为server时有效。type为server时必选。

        :param private_key: The private_key of this ShowCertificateResponse.
        :type private_key: str
        """
    ...
    def expire_time(self):
        r"""Gets the expire_time of this ShowCertificateResponse.

        SSL证书的过期时间。 UTC时间，格式为：yyyy-MM-dd HH:mm:ss ，如2020-05-28 08:30:09

        :return: The expire_time of this ShowCertificateResponse.
        :rtype: str
        """
    ...
    def expire_time(self, expire_time):
        r"""Sets the expire_time of this ShowCertificateResponse.
    ...
    def update_time(self):
        r"""Gets the update_time of this ShowCertificateResponse.

        SSL证书的更新时间。 UTC时间，格式为：yyyy-MM-dd HH:mm:ss ，如2020-05-28 08:30:09

        :return: The update_time of this ShowCertificateResponse.
        :rtype: str
        """
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this ShowCertificateResponse.

        SSL证书的更新时间。 UTC时间，格式为：yyyy-MM-dd HH:mm:ss ，如2020-05-28 08:30:09

        :param update_time: The update_time of this ShowCertificateResponse.
        :type update_time: str
        """
    ...
    @property
    def source(self):
        r"""Gets the source of this ShowCertificateResponse.
    ...
    def source(self, source):
        r"""Sets the source of this ShowCertificateResponse.
    ...
    def protection_status(self):
        r"""Gets the protection_status of this ShowCertificateResponse.
    ...
    def protection_status(self, protection_status):
        r"""Sets the protection_status of this ShowCertificateResponse.
    ...
    def protection_reason(self):
        r"""Gets the protection_reason of this ShowCertificateResponse.
    ...
    def protection_reason(self, protection_reason):
        r"""Sets the protection_reason of this ShowCertificateResponse.
