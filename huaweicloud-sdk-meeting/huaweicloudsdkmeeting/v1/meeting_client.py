...
class MeetingClient(Client):
    ...
    def search_corp_digital_info_list(self, request):
        """查询公共或本地数字资产列表
    ...
    def search_corp_digital_info_list_invoker(self, request):
        http_info = self._search_corp_digital_info_list_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _search_corp_digital_info_list_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def search_private_corp_digital_info(self, request):
        """查询主讲人绑定的数字资产信息
    ...
    def search_private_corp_digital_info_invoker(self, request):
        http_info = self._search_private_corp_digital_info_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _search_private_corp_digital_info_http_info(cls, request):
        http_info = {
            "method": "GET",
