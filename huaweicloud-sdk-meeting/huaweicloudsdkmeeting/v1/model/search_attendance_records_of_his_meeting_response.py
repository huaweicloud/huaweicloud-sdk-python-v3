...
class SearchAttendanceRecordsOfHisMeetingResponse(SdkResponse):
    ...
    def __init__(self, offset=None, limit=None, count=None, data=None):
        r"""SearchAttendanceRecordsOfHisMeetingResponse
    ...
    @property
    def offset(self):
        r"""Gets the offset of this SearchAttendanceRecordsOfHisMeetingResponse.
    ...
    def offset(self, offset):
        r"""Sets the offset of this SearchAttendanceRecordsOfHisMeetingResponse.
    ...
    @property
    def limit(self):
        r"""Gets the limit of this SearchAttendanceRecordsOfHisMeetingResponse.
    ...
    def limit(self, limit):
        r"""Sets the limit of this SearchAttendanceRecordsOfHisMeetingResponse.
    ...
    @property
    def count(self):
        r"""Gets the count of this SearchAttendanceRecordsOfHisMeetingResponse.
    ...
    def count(self, count):
        r"""Sets the count of this SearchAttendanceRecordsOfHisMeetingResponse.
    ...
    @property
    def data(self):
        r"""Gets the data of this SearchAttendanceRecordsOfHisMeetingResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this SearchAttendanceRecordsOfHisMeetingResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("SearchAttendanceRecordsOfHisMeetingResponse.to_dict() is deprecated and no longer maintained, "
