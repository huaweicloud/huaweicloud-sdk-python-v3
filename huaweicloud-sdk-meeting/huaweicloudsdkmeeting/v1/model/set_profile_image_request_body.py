...
class SetProfileImageRequestBody:
    ...
    def __init__(self, file=None):
        ...
        :param file: 上传的头像图片，图片文件不超过10MB，尺寸不超过4096*4096
    ...
    def file(self):
        ...
        :return: The file of this SetProfileImageRequestBody.
    ...
    def file(self, file):
        ...
        :param file: The file of this SetProfileImageRequestBody.
        :type file: :class:`huaweicloudsdkcore.http.formdata.FormFile`
        """
        self._file = file
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SetProfileImageRequestBody):
            return False
