...
class UpdateUserRequest:
    ...
    def x_request_id(self):
        r"""Gets the x_request_id of this UpdateUserRequest.

        请求requestId，用来标识一路请求，用于问题跟踪定位，建议使用UUID，若不携带，则后台自动生成。

        :return: The x_request_id of this UpdateUserRequest.
        :rtype: str
        """
    ...
    def x_request_id(self, x_request_id):
        r"""Sets the x_request_id of this UpdateUserRequest.
    ...
    def accept_language(self):
        r"""Gets the accept_language of this UpdateUserRequest.

        语言参数，默认为中文zh-CN，英文为en-US。

        :return: The accept_language of this UpdateUserRequest.
        :rtype: str
        """
    ...
    def accept_language(self, accept_language):
        r"""Sets the accept_language of this UpdateUserRequest.
    ...
    @property
    def account(self):
        r"""Gets the account of this UpdateUserRequest.

        帐号。 * 如果是帐号/密码鉴权方式，是指华为云会议帐号 * 如果是App ID鉴权方式，是指第三方User ID 

        :return: The account of this UpdateUserRequest.
        :rtype: str
        """
    ...
    def account(self, account):
        r"""Sets the account of this UpdateUserRequest.
    ...
    def account_type(self):
        r"""Gets the account_type of this UpdateUserRequest.

        帐号类型。默认0。 * 0：华为云会议帐号。用于帐号/密码鉴权方式 * 1：第三方User ID，用于App ID鉴权方式 

        :return: The account_type of this UpdateUserRequest.
        :rtype: int
        """
    ...
    def account_type(self, account_type):
        r"""Sets the account_type of this UpdateUserRequest.
