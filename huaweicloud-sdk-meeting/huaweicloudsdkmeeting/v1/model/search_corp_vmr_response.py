...
class SearchCorpVmrResponse(object):
    ...
    def __init__(self, offset=None, limit=None, count=None, data=None):  # noqa: E501
        """SearchCorpVmrResponse - a model defined in huaweicloud sdk"""
    ...
    @property
    def offset(self):
        """Gets the offset of this SearchCorpVmrResponse.
    ...
    def offset(self, offset):
        """Sets the offset of this SearchCorpVmrResponse.
    ...
    @property
    def limit(self):
        """Gets the limit of this SearchCorpVmrResponse.
    ...
    def limit(self, limit):
        """Sets the limit of this SearchCorpVmrResponse.
    ...
    @property
    def count(self):
        """Gets the count of this SearchCorpVmrResponse.
    ...
    def count(self, count):
        """Sets the count of this SearchCorpVmrResponse.
    ...
    @property
    def data(self):
        """Gets the data of this SearchCorpVmrResponse.

        查询到的专用云会议室列表

        :return: The data of this SearchCorpVmrResponse.
        :rtype: list[QueryOrgVmrResultDTO]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this SearchCorpVmrResponse.

        查询到的专用云会议室列表

        :param data: The data of this SearchCorpVmrResponse.
        :type: list[QueryOrgVmrResultDTO]
        """
        self._data = data
