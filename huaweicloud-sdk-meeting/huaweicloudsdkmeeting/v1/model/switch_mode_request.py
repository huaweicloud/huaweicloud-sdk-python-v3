...
class SwitchModeRequest:
    ...
    def conference_id(self):
        r"""Gets the conference_id of this SwitchModeRequest.

        会议ID。

        :return: The conference_id of this SwitchModeRequest.
        :rtype: str
        """
    ...
    def conference_id(self, conference_id):
        r"""Sets the conference_id of this SwitchModeRequest.

        会议ID。

        :param conference_id: The conference_id of this SwitchModeRequest.
        :type conference_id: str
        """
    ...
    def x_conference_authorization(self):
        r"""Gets the x_conference_authorization of this SwitchModeRequest.
    ...
    def x_conference_authorization(self, x_conference_authorization):
        r"""Sets the x_conference_authorization of this SwitchModeRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this SwitchModeRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this SwitchModeRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SwitchModeRequest):
            return False
