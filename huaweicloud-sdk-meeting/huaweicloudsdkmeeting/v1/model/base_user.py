...
class BaseUser:
    ...
    def contact(self, contact):
        r"""Sets the contact of this BaseUser.

        后台自动识别是手机还是邮箱，若为手机号，则要求和国家码匹配。 > * 当前中国站点企业支持使用邮箱或手机号进行邀请，手机仅支持+86开头的手机号。 > * 当前国际站点企业仅支持使用邮箱进行邀请。 

        :param contact: The contact of this BaseUser.
        :type contact: str
        """
    ...
    @property
    def country(self):
        r"""Gets the country of this BaseUser.

        [[手机号所属的国家](https://support.huaweicloud.com/api-meeting/meeting_21_0109.html#ZH-CN_TOPIC_0212714591__table19371178135314)](tag:hws)[[手机号所属的国家](https://support.huaweicloud.com/intl/zh-cn/api-meeting/meeting_21_0109.html#ZH-CN_TOPIC_0212714591__table19371178135314)](tag:hk) 。 

        :return: The country of this BaseUser.
        :rtype: str
        """
    ...
    def country(self, country):
        r"""Sets the country of this BaseUser.

        [[手机号所属的国家](https://support.huaweicloud.com/api-meeting/meeting_21_0109.html#ZH-CN_TOPIC_0212714591__table19371178135314)](tag:hws)[[手机号所属的国家](https://support.huaweicloud.com/intl/zh-cn/api-meeting/meeting_21_0109.html#ZH-CN_TOPIC_0212714591__table19371178135314)](tag:hk) 。 

        :param country: The country of this BaseUser.
        :type country: str
        """
    ...
    @property
    def dept_code(self):
        r"""Gets the dept_code of this BaseUser.

        部门编码，若不携带则默认根部门。

        :return: The dept_code of this BaseUser.
        :rtype: str
        """
    ...
    def dept_code(self, dept_code):
        r"""Sets the dept_code of this BaseUser.

        部门编码，若不携带则默认根部门。

        :param dept_code: The dept_code of this BaseUser.
        :type dept_code: str
        """
    ...
    @property
    def title(self):
        r"""Gets the title of this BaseUser.

        职位。

        :return: The title of this BaseUser.
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        r"""Sets the title of this BaseUser.

        职位。

        :param title: The title of this BaseUser.
        :type title: str
        """
        self._title = title
    ...
    @property
    def sort_level(self):
        r"""Gets the sort_level of this BaseUser.

        通讯录排序等级，序号越低优先级越高。

        :return: The sort_level of this BaseUser.
        :rtype: int
        """
    ...
    def sort_level(self, sort_level):
        r"""Sets the sort_level of this BaseUser.

        通讯录排序等级，序号越低优先级越高。

        :param sort_level: The sort_level of this BaseUser.
        :type sort_level: int
        """
    ...
    @property
    def desc(self):
        r"""Gets the desc of this BaseUser.

        备注。

        :return: The desc of this BaseUser.
        :rtype: str
        """
        return self._desc
    ...
    @desc.setter
    def desc(self, desc):
        r"""Sets the desc of this BaseUser.

        备注。

        :param desc: The desc of this BaseUser.
        :type desc: str
        """
        self._desc = desc
