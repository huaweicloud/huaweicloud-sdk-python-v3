...
class CheckTokenResponse(SdkResponse):
    ...
    def access_token(self):
        r"""Gets the access_token of this CheckTokenResponse.
    ...
    def access_token(self, access_token):
        r"""Sets the access_token of this CheckTokenResponse.
    ...
    @property
    def token_ip(self):
        r"""Gets the token_ip of this CheckTokenResponse.
    ...
    def token_ip(self, token_ip):
        r"""Sets the token_ip of this CheckTokenResponse.
    ...
    def valid_period(self):
        r"""Gets the valid_period of this CheckTokenResponse.
    ...
    def valid_period(self, valid_period):
        r"""Sets the valid_period of this CheckTokenResponse.
    ...
    def expire_time(self):
        r"""Gets the expire_time of this CheckTokenResponse.
    ...
    def expire_time(self, expire_time):
        r"""Sets the expire_time of this CheckTokenResponse.
    ...
    def create_time(self):
        r"""Gets the create_time of this CheckTokenResponse.
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this CheckTokenResponse.
    ...
    @property
    def user(self):
        r"""Gets the user of this CheckTokenResponse.
    ...
    @user.setter
    def user(self, user):
        r"""Sets the user of this CheckTokenResponse.
    ...
    def client_type(self):
        r"""Gets the client_type of this CheckTokenResponse.
    ...
    def client_type(self, client_type):
        r"""Sets the client_type of this CheckTokenResponse.
    ...
    def force_login_ind(self):
        r"""Gets the force_login_ind of this CheckTokenResponse.
    ...
    def force_login_ind(self, force_login_ind):
        r"""Sets the force_login_ind of this CheckTokenResponse.
    ...
    def first_login(self):
        r"""Gets the first_login of this CheckTokenResponse.
    ...
    def first_login(self, first_login):
        r"""Sets the first_login of this CheckTokenResponse.
    ...
    def pwd_expired(self):
        r"""Gets the pwd_expired of this CheckTokenResponse.
    ...
    def pwd_expired(self, pwd_expired):
        r"""Sets the pwd_expired of this CheckTokenResponse.
    ...
    def days_pwd_available(self):
        r"""Gets the days_pwd_available of this CheckTokenResponse.
    ...
    def days_pwd_available(self, days_pwd_available):
        r"""Sets the days_pwd_available of this CheckTokenResponse.
    ...
    def proxy_token(self):
        r"""Gets the proxy_token of this CheckTokenResponse.
    ...
    def proxy_token(self, proxy_token):
        r"""Sets the proxy_token of this CheckTokenResponse.
    ...
    def delay_delete(self):
        r"""Gets the delay_delete of this CheckTokenResponse.
    ...
    def delay_delete(self, delay_delete):
        r"""Sets the delay_delete of this CheckTokenResponse.
    ...
    @property
    def token_type(self):
        r"""Gets the token_type of this CheckTokenResponse.
    ...
    def token_type(self, token_type):
        r"""Sets the token_type of this CheckTokenResponse.
    ...
    def refresh_token(self):
        r"""Gets the refresh_token of this CheckTokenResponse.
    ...
    def refresh_token(self, refresh_token):
        r"""Sets the refresh_token of this CheckTokenResponse.
    ...
    def refresh_valid_period(self):
        r"""Gets the refresh_valid_period of this CheckTokenResponse.
    ...
    def refresh_valid_period(self, refresh_valid_period):
        r"""Sets the refresh_valid_period of this CheckTokenResponse.
    ...
    def refresh_expire_time(self):
        r"""Gets the refresh_expire_time of this CheckTokenResponse.
    ...
    def refresh_expire_time(self, refresh_expire_time):
        r"""Sets the refresh_expire_time of this CheckTokenResponse.
    ...
    def refresh_create_time(self):
        r"""Gets the refresh_create_time of this CheckTokenResponse.
    ...
    def refresh_create_time(self, refresh_create_time):
        r"""Sets the refresh_create_time of this CheckTokenResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CheckTokenResponse.to_dict() is deprecated and no longer maintained, "
