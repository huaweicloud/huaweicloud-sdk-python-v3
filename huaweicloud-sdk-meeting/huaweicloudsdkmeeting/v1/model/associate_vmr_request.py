...
class AssociateVmrRequest:
    ...
    def __init__(self, x_request_id=None, accept_language=None, account=None, account_type=None, body=None):
        ...
        :param account: 帐号。 * 如果是帐号/密码鉴权方式，是指华为云会议帐号 * 如果是App ID鉴权方式，是指第三方User ID &gt; 一个帐号能分配32个云会议室。 
        :type account: str
        :param account_type: 帐号类型。默认0。 * 0：华为云会议帐号。用于帐号/密码鉴权方式 * 1：第三方User ID，用于App ID鉴权方式 
        :type account_type: int
        :param body: Body of the AssociateVmrRequest
        :type body: list[str]
        """
    ...
    def x_request_id(self):
        ...
        :return: The x_request_id of this AssociateVmrRequest.
        :rtype: str
        """
    ...
    def x_request_id(self, x_request_id):
        ...
        :param x_request_id: The x_request_id of this AssociateVmrRequest.
        :type x_request_id: str
        """
    ...
    def accept_language(self):
        ...
        :return: The accept_language of this AssociateVmrRequest.
        :rtype: str
        """
    ...
    def accept_language(self, accept_language):
        ...
        :param accept_language: The accept_language of this AssociateVmrRequest.
        :type accept_language: str
        """
    ...
    def account(self):
        ...
        :return: The account of this AssociateVmrRequest.
        :rtype: str
        """
    ...
    def account(self, account):
        ...
        :param account: The account of this AssociateVmrRequest.
        :type account: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssociateVmrRequest):
            return False
