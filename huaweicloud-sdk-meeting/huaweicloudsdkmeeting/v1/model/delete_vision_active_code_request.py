...
class DeleteVisionActiveCodeRequest:
    ...
    def __init__(self, x_request_id=None, accept_language=None, body=None):
        r"""DeleteVisionActiveCodeRequest
        ...
        :param body: Body of the DeleteVisionActiveCodeRequest
        :type body: list[str]
        """
    ...
    def x_request_id(self):
        r"""Gets the x_request_id of this DeleteVisionActiveCodeRequest.
    ...
    def x_request_id(self, x_request_id):
        r"""Sets the x_request_id of this DeleteVisionActiveCodeRequest.
    ...
    def accept_language(self):
        r"""Gets the accept_language of this DeleteVisionActiveCodeRequest.
    ...
    def accept_language(self, accept_language):
        r"""Sets the accept_language of this DeleteVisionActiveCodeRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this DeleteVisionActiveCodeRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this DeleteVisionActiveCodeRequest.
