...
class SetParticipantViewRequest:
    ...
    openapi_types = {
        ...
        'body': 'RestParticipantViewReqBody'
    }
    ...
    def __init__(self, conference_id=None, participant_id=None, x_conference_authorization=None, body=None):
        ...
        :param body: Body of the SetParticipantViewRequest
    ...
    def conference_id(self):
        r"""Gets the conference_id of this SetParticipantViewRequest.
    ...
    def conference_id(self, conference_id):
        r"""Sets the conference_id of this SetParticipantViewRequest.
    ...
    def participant_id(self):
        r"""Gets the participant_id of this SetParticipantViewRequest.
    ...
    def participant_id(self, participant_id):
        r"""Sets the participant_id of this SetParticipantViewRequest.
    ...
    def x_conference_authorization(self):
        r"""Gets the x_conference_authorization of this SetParticipantViewRequest.
    ...
    def x_conference_authorization(self, x_conference_authorization):
        r"""Sets the x_conference_authorization of this SetParticipantViewRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this SetParticipantViewRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this SetParticipantViewRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SetParticipantViewRequest):
            return False
