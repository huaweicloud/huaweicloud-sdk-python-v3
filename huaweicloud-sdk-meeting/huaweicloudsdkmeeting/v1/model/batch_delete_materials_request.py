...
class BatchDeleteMaterialsRequest:
    ...
    def __init__(self, x_request_id=None, accept_language=None, body=None):
        """BatchDeleteMaterialsRequest - a model defined in huaweicloud sdk"""
    ...
    @property
    def body(self):
        """Gets the body of this BatchDeleteMaterialsRequest.
    ...
    @body.setter
    def body(self, body):
        """Sets the body of this BatchDeleteMaterialsRequest.
