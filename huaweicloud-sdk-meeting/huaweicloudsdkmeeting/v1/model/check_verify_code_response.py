...
class CheckVerifyCodeResponse(SdkResponse):
    ...
    @property
    def token(self):
        r"""Gets the token of this CheckVerifyCodeResponse.
    ...
    def token(self, token):
        r"""Sets the token of this CheckVerifyCodeResponse.
    ...
    @property
    def expire(self):
        r"""Gets the expire of this CheckVerifyCodeResponse.
    ...
    def expire(self, expire):
        r"""Sets the expire of this CheckVerifyCodeResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CheckVerifyCodeResponse.to_dict() is deprecated and no longer maintained, "
