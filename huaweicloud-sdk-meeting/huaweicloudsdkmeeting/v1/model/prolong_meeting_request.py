...
class ProlongMeetingRequest:
    ...
    def __init__(self, conference_id=None, x_conference_authorization=None, body=None):
        """ProlongMeetingRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProlongMeetingRequest):
            return False
