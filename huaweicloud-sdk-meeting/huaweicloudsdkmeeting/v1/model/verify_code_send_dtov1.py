...
class VerifyCodeSendDTOV1:
    ...
    @property
    def user(self):
        r"""Gets the user of this VerifyCodeSendDTOV1.
    ...
    @user.setter
    def user(self, user):
        r"""Sets the user of this VerifyCodeSendDTOV1.
    ...
    def send_method(self):
        r"""Gets the send_method of this VerifyCodeSendDTOV1.
    ...
    def send_method(self, send_method):
        r"""Sets the send_method of this VerifyCodeSendDTOV1.
    ...
    @property
    def token(self):
        r"""Gets the token of this VerifyCodeSendDTOV1.
    ...
    def token(self, token):
        r"""Sets the token of this VerifyCodeSendDTOV1.
