...
class SendVeriCodeForChangePwdRequest:
    ...
    def __init__(self, x_request_id=None, accept_language=None, body=None):
        r"""SendVeriCodeForChangePwdRequest
        ...
        :param body: Body of the SendVeriCodeForChangePwdRequest
        :type body: :class:`huaweicloudsdkmeeting.v1.VerifyCodeSendDTOV1`
        """
    ...
    def x_request_id(self):
        r"""Gets the x_request_id of this SendVeriCodeForChangePwdRequest.
    ...
    def x_request_id(self, x_request_id):
        r"""Sets the x_request_id of this SendVeriCodeForChangePwdRequest.
    ...
    def accept_language(self):
        r"""Gets the accept_language of this SendVeriCodeForChangePwdRequest.
    ...
    def accept_language(self, accept_language):
        r"""Sets the accept_language of this SendVeriCodeForChangePwdRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this SendVeriCodeForChangePwdRequest.

        :return: The body of this SendVeriCodeForChangePwdRequest.
        :rtype: :class:`huaweicloudsdkmeeting.v1.VerifyCodeSendDTOV1`
        """
        return self._body

    @body.setter
    def body(self, body):
        r"""Sets the body of this SendVeriCodeForChangePwdRequest.
