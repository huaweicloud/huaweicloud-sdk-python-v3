...
class UpdateMeetingResponse(SdkResponse):
    ...
    @property
    def body(self):
        r"""Gets the body of this UpdateMeetingResponse.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this UpdateMeetingResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateMeetingResponse.to_dict() is deprecated and no longer maintained, "
