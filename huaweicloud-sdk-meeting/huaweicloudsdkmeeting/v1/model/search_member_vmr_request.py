...
class SearchMemberVmrRequest(object):
    ...
    def __init__(self, x_request_id=None, accept_language=None, offset=0, limit=100, search_key=None, special_vmr=None):  # noqa: E501
