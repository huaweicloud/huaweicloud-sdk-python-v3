...
class MuteMeetingRequest:
    ...
    def __init__(self, conference_id=None, x_conference_authorization=None, body=None):
        ...
        :param body: Body of the MuteMeetingRequest
    ...
    def conference_id(self):
        r"""Gets the conference_id of this MuteMeetingRequest.
    ...
    def conference_id(self, conference_id):
        r"""Sets the conference_id of this MuteMeetingRequest.
    ...
    def x_conference_authorization(self):
        r"""Gets the x_conference_authorization of this MuteMeetingRequest.
    ...
    def x_conference_authorization(self, x_conference_authorization):
        r"""Sets the x_conference_authorization of this MuteMeetingRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this MuteMeetingRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this MuteMeetingRequest.
