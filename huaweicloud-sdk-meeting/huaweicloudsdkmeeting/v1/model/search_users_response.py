...
class SearchUsersResponse(SdkResponse):
    ...
    def __init__(self, offset=None, limit=None, count=None, data=None):
        ...
        :type data: list[:class:`huaweicloudsdkmeeting.v1.SearchUserResultDTO`]
        """
    ...
    def data(self):
        ...
        :rtype: list[:class:`huaweicloudsdkmeeting.v1.SearchUserResultDTO`]
        """
        return self._data
    ...
    def to_dict(self):
        import warnings
        warnings.warn("SearchUsersResponse.to_dict() is deprecated and no longer maintained, "
