...
class SearchDevicesResponse(SdkResponse):
    ...
    openapi_types = {
        ...
        'limit': 'int',
        'count': 'int',
        'data': 'list[QueryDeviceResultDTO]'
    }
    ...
    def offset(self):
        ...
        :return: The offset of this SearchDevicesResponse.
        :rtype: int
        """
        return self._offset
    ...
    def limit(self):
        ...
        :return: The limit of this SearchDevicesResponse.
        :rtype: int
        """
        return self._limit
    ...
    def to_dict(self):
        import warnings
        warnings.warn("SearchDevicesResponse.to_dict() is deprecated and no longer maintained, "
