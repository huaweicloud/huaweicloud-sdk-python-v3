...
class SearchMeetingsResponse(SdkResponse):
    ...
    @property
    def offset(self):
        r"""Gets the offset of this SearchMeetingsResponse.
    ...
    def offset(self, offset):
        r"""Sets the offset of this SearchMeetingsResponse.
    ...
    @property
    def limit(self):
        r"""Gets the limit of this SearchMeetingsResponse.
    ...
    def limit(self, limit):
        r"""Sets the limit of this SearchMeetingsResponse.
    ...
    @property
    def count(self):
        r"""Gets the count of this SearchMeetingsResponse.
    ...
    def count(self, count):
        r"""Sets the count of this SearchMeetingsResponse.
    ...
    @property
    def data(self):
        r"""Gets the data of this SearchMeetingsResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this SearchMeetingsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("SearchMeetingsResponse.to_dict() is deprecated and no longer maintained, "
