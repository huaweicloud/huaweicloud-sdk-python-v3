...
class SaveLayoutRequest:
    ...
    def __init__(self, conference_id=None, x_conference_authorization=None, body=None):
        ...
        :param body: Body of the SaveLayoutRequest
    ...
    def conference_id(self):
        r"""Gets the conference_id of this SaveLayoutRequest.

        会议ID。

        :return: The conference_id of this SaveLayoutRequest.
        :rtype: str
        """
    ...
    def conference_id(self, conference_id):
        r"""Sets the conference_id of this SaveLayoutRequest.

        会议ID。

        :param conference_id: The conference_id of this SaveLayoutRequest.
        :type conference_id: str
        """
    ...
    def x_conference_authorization(self):
        r"""Gets the x_conference_authorization of this SaveLayoutRequest.

        会控Token，通过[[获取会控token](https://support.huaweicloud.com/api-meeting/meeting_21_0027.html)](tag:hws)[[获取会控token](https://support.huaweicloud.com/intl/zh-cn/api-meeting/meeting_21_0027.html)](tag:hk)接口获得。

        :return: The x_conference_authorization of this SaveLayoutRequest.
        :rtype: str
        """
    ...
    def x_conference_authorization(self, x_conference_authorization):
        r"""Sets the x_conference_authorization of this SaveLayoutRequest.

        会控Token，通过[[获取会控token](https://support.huaweicloud.com/api-meeting/meeting_21_0027.html)](tag:hws)[[获取会控token](https://support.huaweicloud.com/intl/zh-cn/api-meeting/meeting_21_0027.html)](tag:hk)接口获得。

        :param x_conference_authorization: The x_conference_authorization of this SaveLayoutRequest.
        :type x_conference_authorization: str
        """
    ...
    @property
    def body(self):
        r"""Gets the body of this SaveLayoutRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this SaveLayoutRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SaveLayoutRequest):
            return False
