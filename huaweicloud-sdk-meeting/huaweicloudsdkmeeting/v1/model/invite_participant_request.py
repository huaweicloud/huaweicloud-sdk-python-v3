...
class InviteParticipantRequest:
    ...
    def conference_id(self):
        r"""Gets the conference_id of this InviteParticipantRequest.

        会议ID。

        :return: The conference_id of this InviteParticipantRequest.
        :rtype: str
        """
    ...
    def conference_id(self, conference_id):
        r"""Sets the conference_id of this InviteParticipantRequest.
    ...
    def x_conference_authorization(self):
        r"""Gets the x_conference_authorization of this InviteParticipantRequest.

        会控Token，通过[[获取会控token](https://support.huaweicloud.com/api-meeting/meeting_21_0027.html)](tag:hws)[[获取会控token](https://support.huaweicloud.com/intl/zh-cn/api-meeting/meeting_21_0027.html)](tag:hk)接口获得。

        :return: The x_conference_authorization of this InviteParticipantRequest.
        :rtype: str
        """
    ...
    def x_conference_authorization(self, x_conference_authorization):
        r"""Sets the x_conference_authorization of this InviteParticipantRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this InviteParticipantRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this InviteParticipantRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InviteParticipantRequest):
            return False
