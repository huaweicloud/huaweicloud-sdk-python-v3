...
class QueryCorpResultDTO(object):
    ...
    def __init__(self, basic_info=None, admin_info=None, res_info=None, id=None):  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QueryCorpResultDTO):
            return False
