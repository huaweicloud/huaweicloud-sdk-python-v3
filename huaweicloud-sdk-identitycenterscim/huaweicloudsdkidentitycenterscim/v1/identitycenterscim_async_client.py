...
class IdentityCenterSCIMAsyncClient(Client):
    ...
    def new_builder(cls, clazz=None):
        if not clazz:
            ...
            if clazz.__name__ != "IdentityCenterSCIMAsyncClient":
                raise TypeError("client type error, support client type is IdentityCenterSCIMAsyncClient")
    ...
    def get_group_async(self, request):
        r"""查询用户组详情
    ...
    def get_group_async_invoker(self, request):
        http_info = self._get_group_http_info(request)
        return AsyncInvoker(self, http_info)

    def _get_group_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/{tenant_id}/scim/v2/Groups/{group_id}",
            "request_type": request.__class__.__name__,
    ...
    def patch_group_async(self, request):
        r"""部分更新用户组
    ...
    def patch_group_async_invoker(self, request):
        http_info = self._patch_group_http_info(request)
        return AsyncInvoker(self, http_info)

    def _patch_group_http_info(self, request):
        http_info = {
            "method": "PATCH",
            "resource_path": "/{tenant_id}/scim/v2/Groups/{group_id}",
            "request_type": request.__class__.__name__,
    ...
    def service_provider_config_async(self, request):
        r"""查询服务提供商配置
    ...
    def service_provider_config_async_invoker(self, request):
        http_info = self._service_provider_config_http_info(request)
        return AsyncInvoker(self, http_info)

    def _service_provider_config_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def get_user_async(self, request):
        r"""查询用户详情
    ...
    def get_user_async_invoker(self, request):
        http_info = self._get_user_http_info(request)
        return AsyncInvoker(self, http_info)

    def _get_user_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/{tenant_id}/scim/v2/Users/{user_id}",
            "request_type": request.__class__.__name__,
    ...
    def patch_user_async(self, request):
        r"""部分更新用户
    ...
    def patch_user_async_invoker(self, request):
        http_info = self._patch_user_http_info(request)
        return AsyncInvoker(self, http_info)

    def _patch_user_http_info(self, request):
        http_info = {
            "method": "PATCH",
            "resource_path": "/{tenant_id}/scim/v2/Users/{user_id}",
            "request_type": request.__class__.__name__,
    ...
    def put_user_async(self, request):
        r"""更新用户
    ...
    def put_user_async_invoker(self, request):
        http_info = self._put_user_http_info(request)
        return AsyncInvoker(self, http_info)

    def _put_user_http_info(self, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/{tenant_id}/scim/v2/Users/{user_id}",
            "request_type": request.__class__.__name__,
