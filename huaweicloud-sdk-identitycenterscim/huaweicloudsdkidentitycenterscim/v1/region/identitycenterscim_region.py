...
class IdentityCenterSCIMRegion:
    _PROVIDER = RegionProviderChain.get_default_region_provider_chain("IDENTITYCENTERSCIM")
    ...
    AF_NORTH_1 = Region("af-north-1",
                        "https://scim.af-north-1.myhuaweicloud.com")
    AP_SOUTHEAST_5 = Region("ap-southeast-5",
                        "https://scim.ap-southeast-5.myhuaweicloud.com")
    ...
    def value_of(cls, region_id, static_fields=None):
        ...
        raise KeyError("region_id '%s' is not in the following supported regions of service 'IdentityCenterSCIM': [%s]" % (
