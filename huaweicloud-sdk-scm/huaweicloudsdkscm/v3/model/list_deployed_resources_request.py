...
class ListDeployedResourcesRequest:
    ...
    openapi_types = {
        'body': 'ListDeployedResourcesRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ListDeployedResourcesRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListDeployedResourcesRequest):
            return False
