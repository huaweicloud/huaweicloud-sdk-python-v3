...
class BatchCreateOrDeleteTagsRequest:
    ...
    def __init__(self, resource_id=None, body=None):
        ...
        :param resource_id: 证书id。
        :type resource_id: str
        :param body: Body of the BatchCreateOrDeleteTagsRequest
        :type body: :class:`huaweicloudsdkscm.v3.BatchCreateOrDeleteTagsRequestBody`
        """
    ...
    def resource_id(self):
        r"""Gets the resource_id of this BatchCreateOrDeleteTagsRequest.

        证书id。

        :return: The resource_id of this BatchCreateOrDeleteTagsRequest.
        :rtype: str
        """
    ...
    def resource_id(self, resource_id):
        r"""Sets the resource_id of this BatchCreateOrDeleteTagsRequest.

        证书id。

        :param resource_id: The resource_id of this BatchCreateOrDeleteTagsRequest.
        :type resource_id: str
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkscm.v3.BatchCreateOrDeleteTagsRequestBody`
        """
        return self._body
