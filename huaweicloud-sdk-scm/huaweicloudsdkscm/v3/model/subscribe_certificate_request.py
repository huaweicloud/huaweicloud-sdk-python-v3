...
class SubscribeCertificateRequest:
    ...
    openapi_types = {
        'body': 'PurchaseCertificateRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the SubscribeCertificateRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubscribeCertificateRequest):
            return False
