...
class ScmClient(Client):
    ...
    def apply_certificate(self, request):
        r"""申请证书
    ...
    def apply_certificate_invoker(self, request):
        http_info = self._apply_certificate_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _apply_certificate_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def cancel_certificate_request(self, request):
        r"""撤回证书申请
    ...
    def cancel_certificate_request_invoker(self, request):
        http_info = self._cancel_certificate_request_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _cancel_certificate_request_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def create_certificate_tag(self, request):
        r"""创建标签
    ...
    def create_certificate_tag_invoker(self, request):
        http_info = self._create_certificate_tag_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_certificate_tag_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def disable_notification_invoker(self, request):
        http_info = self._disable_notification_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _disable_notification_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def enable_notification_invoker(self, request):
        http_info = self._enable_notification_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _enable_notification_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def list_certificates_by_tag(self, request):
        r"""根据标签查询证书列表
    ...
    def list_certificates_by_tag_invoker(self, request):
        http_info = self._list_certificates_by_tag_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_certificates_by_tag_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def list_deployed_resources(self, request):
        r"""查询已部署资源
    ...
    def list_deployed_resources_invoker(self, request):
        http_info = self._list_deployed_resources_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_deployed_resources_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def list_tags_by_certificate(self, request):
        r"""根据证书ID查询标签列表
    ...
    def list_tags_by_certificate_invoker(self, request):
        http_info = self._list_tags_by_certificate_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_tags_by_certificate_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v3/scm/{resource_id}/tags",
            "request_type": request.__class__.__name__,
    ...
    def subscribe_certificate(self, request):
        r"""购买SSL证书
    ...
    def subscribe_certificate_invoker(self, request):
        http_info = self._subscribe_certificate_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _subscribe_certificate_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def unsubscribe_certificate(self, request):
        r"""退订证书
    ...
    def unsubscribe_certificate_invoker(self, request):
        http_info = self._unsubscribe_certificate_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _unsubscribe_certificate_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def create_csr_invoker(self, request):
        http_info = self._create_csr_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_csr_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def delete_csr_invoker(self, request):
        http_info = self._delete_csr_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_csr_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_csr_invoker(self, request):
        http_info = self._list_csr_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_csr_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v3/scm/csr",
            "request_type": request.__class__.__name__,
    ...
    def show_csr_invoker(self, request):
        http_info = self._show_csr_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_csr_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v3/scm/csr/{id}",
            "request_type": request.__class__.__name__,
    ...
    def show_csr_private_key(self, request):
        r"""查询私钥
    ...
    def show_csr_private_key_invoker(self, request):
        http_info = self._show_csr_private_key_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_csr_private_key_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def update_csr_invoker(self, request):
        http_info = self._update_csr_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_csr_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v3/scm/csr/{id}",
            "request_type": request.__class__.__name__,
    ...
    def upload_csr_invoker(self, request):
        http_info = self._upload_csr_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _upload_csr_http_info(cls, request):
        http_info = {
            "method": "POST",
