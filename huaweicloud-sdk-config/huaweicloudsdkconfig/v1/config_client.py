...
class ConfigClient(Client):
    ...
    def collect_policy_assignments_states_summary(self, request):
        r"""查询规则的合规总结
    ...
    def collect_policy_assignments_states_summary_invoker(self, request):
        http_info = self._collect_policy_assignments_states_summary_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _collect_policy_assignments_states_summary_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def collect_policy_states_summary(self, request):
        r"""查询用户的合规总结
    ...
    def collect_policy_states_summary_invoker(self, request):
        http_info = self._collect_policy_states_summary_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _collect_policy_states_summary_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def collect_remediation_execution_statuses_summary_invoker(self, request):
        http_info = self._collect_remediation_execution_statuses_summary_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _collect_remediation_execution_statuses_summary_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def collect_resources_policy_states_summary(self, request):
        r"""查询用户资源的合规总结
    ...
    def collect_resources_policy_states_summary_invoker(self, request):
        http_info = self._collect_resources_policy_states_summary_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _collect_resources_policy_states_summary_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_policy_states_statistics(self, request):
        r"""查询当前账号合规统计趋势
    ...
    def list_policy_states_statistics_invoker(self, request):
        http_info = self._list_policy_states_statistics_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_policy_states_statistics_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_all_providers(self, request):
        r"""列举所有已对接的云服务
    ...
    def list_all_providers_invoker(self, request):
        http_info = self._list_all_providers_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_all_providers_http_info(cls, request):
        http_info = {
            "method": "GET",
