...
class ShowAggregatePolicyAssignmentDetailResponse(SdkResponse):
    ...
    @property
    def id(self):
        r"""Gets the id of this ShowAggregatePolicyAssignmentDetailResponse.

        规则ID

        :return: The id of this ShowAggregatePolicyAssignmentDetailResponse.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this ShowAggregatePolicyAssignmentDetailResponse.

        规则ID

        :param id: The id of this ShowAggregatePolicyAssignmentDetailResponse.
        :type id: str
        """
        self._id = id
    ...
    @property
    def name(self):
        r"""Gets the name of this ShowAggregatePolicyAssignmentDetailResponse.

        规则名字

        :return: The name of this ShowAggregatePolicyAssignmentDetailResponse.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this ShowAggregatePolicyAssignmentDetailResponse.

        规则名字

        :param name: The name of this ShowAggregatePolicyAssignmentDetailResponse.
        :type name: str
        """
        self._name = name
    ...
    def description(self):
        r"""Gets the description of this ShowAggregatePolicyAssignmentDetailResponse.

        规则描述

        :return: The description of this ShowAggregatePolicyAssignmentDetailResponse.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this ShowAggregatePolicyAssignmentDetailResponse.

        规则描述

        :param description: The description of this ShowAggregatePolicyAssignmentDetailResponse.
        :type description: str
        """
    ...
    def policy_filter(self):
        r"""Gets the policy_filter of this ShowAggregatePolicyAssignmentDetailResponse.

        :return: The policy_filter of this ShowAggregatePolicyAssignmentDetailResponse.
    ...
    def policy_filter(self, policy_filter):
        r"""Sets the policy_filter of this ShowAggregatePolicyAssignmentDetailResponse.

        :param policy_filter: The policy_filter of this ShowAggregatePolicyAssignmentDetailResponse.
        :type policy_filter: :class:`huaweicloudsdkconfig.v1.PolicyFilterDefinition`
        """
    ...
    def policy_filter_v2(self):
        r"""Gets the policy_filter_v2 of this ShowAggregatePolicyAssignmentDetailResponse.

        :return: The policy_filter_v2 of this ShowAggregatePolicyAssignmentDetailResponse.
    ...
    def policy_filter_v2(self, policy_filter_v2):
        r"""Sets the policy_filter_v2 of this ShowAggregatePolicyAssignmentDetailResponse.

        :param policy_filter_v2: The policy_filter_v2 of this ShowAggregatePolicyAssignmentDetailResponse.
        :type policy_filter_v2: :class:`huaweicloudsdkconfig.v1.PolicyFilterDefinitionV2`
        """
    ...
    @property
    def state(self):
        r"""Gets the state of this ShowAggregatePolicyAssignmentDetailResponse.

        规则状态

        :return: The state of this ShowAggregatePolicyAssignmentDetailResponse.
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        r"""Sets the state of this ShowAggregatePolicyAssignmentDetailResponse.

        规则状态

        :param state: The state of this ShowAggregatePolicyAssignmentDetailResponse.
        :type state: str
        """
        self._state = state
    ...
    @property
    def created(self):
        r"""Gets the created of this ShowAggregatePolicyAssignmentDetailResponse.

        规则创建时间

        :return: The created of this ShowAggregatePolicyAssignmentDetailResponse.
        :rtype: str
        """
    ...
    def created(self, created):
        r"""Sets the created of this ShowAggregatePolicyAssignmentDetailResponse.

        规则创建时间

        :param created: The created of this ShowAggregatePolicyAssignmentDetailResponse.
        :type created: str
        """
    ...
    @property
    def updated(self):
        r"""Gets the updated of this ShowAggregatePolicyAssignmentDetailResponse.

        规则更新时间

        :return: The updated of this ShowAggregatePolicyAssignmentDetailResponse.
        :rtype: str
        """
    ...
    def updated(self, updated):
        r"""Sets the updated of this ShowAggregatePolicyAssignmentDetailResponse.

        规则更新时间

        :param updated: The updated of this ShowAggregatePolicyAssignmentDetailResponse.
        :type updated: str
        """
    ...
    def policy_definition_id(self):
        r"""Gets the policy_definition_id of this ShowAggregatePolicyAssignmentDetailResponse.

        规则的策略ID

        :return: The policy_definition_id of this ShowAggregatePolicyAssignmentDetailResponse.
        :rtype: str
        """
    ...
    def policy_definition_id(self, policy_definition_id):
        r"""Sets the policy_definition_id of this ShowAggregatePolicyAssignmentDetailResponse.

        规则的策略ID

        :param policy_definition_id: The policy_definition_id of this ShowAggregatePolicyAssignmentDetailResponse.
        :type policy_definition_id: str
        """
    ...
    def custom_policy(self):
        r"""Gets the custom_policy of this ShowAggregatePolicyAssignmentDetailResponse.

        :return: The custom_policy of this ShowAggregatePolicyAssignmentDetailResponse.
    ...
    def custom_policy(self, custom_policy):
        r"""Sets the custom_policy of this ShowAggregatePolicyAssignmentDetailResponse.

        :param custom_policy: The custom_policy of this ShowAggregatePolicyAssignmentDetailResponse.
        :type custom_policy: :class:`huaweicloudsdkconfig.v1.CustomPolicy`
        """
    ...
    @property
    def parameters(self):
        r"""Gets the parameters of this ShowAggregatePolicyAssignmentDetailResponse.

        规则参数

        :return: The parameters of this ShowAggregatePolicyAssignmentDetailResponse.
    ...
    def parameters(self, parameters):
        r"""Sets the parameters of this ShowAggregatePolicyAssignmentDetailResponse.

        规则参数

        :param parameters: The parameters of this ShowAggregatePolicyAssignmentDetailResponse.
        :type parameters: dict(str, PolicyParameterValue)
        """
    ...
    @property
    def created_by(self):
        r"""Gets the created_by of this ShowAggregatePolicyAssignmentDetailResponse.

        规则的创建者

        :return: The created_by of this ShowAggregatePolicyAssignmentDetailResponse.
        :rtype: str
        """
    ...
    def created_by(self, created_by):
        r"""Sets the created_by of this ShowAggregatePolicyAssignmentDetailResponse.

        规则的创建者

        :param created_by: The created_by of this ShowAggregatePolicyAssignmentDetailResponse.
        :type created_by: str
        """
    ...
    def target_type(self):
        r"""Gets the target_type of this ShowAggregatePolicyAssignmentDetailResponse.
    ...
    def target_type(self, target_type):
        r"""Sets the target_type of this ShowAggregatePolicyAssignmentDetailResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowAggregatePolicyAssignmentDetailResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowAggregatePolicyAssignmentDetailResponse):
            return False
