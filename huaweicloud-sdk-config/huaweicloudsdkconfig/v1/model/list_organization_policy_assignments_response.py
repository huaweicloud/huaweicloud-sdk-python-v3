...
class ListOrganizationPolicyAssignmentsResponse(SdkResponse):
    ...
    def __init__(self, organization_policy_assignments=None, page_info=None):
        ...
        :type organization_policy_assignments: list[:class:`huaweicloudsdkconfig.v1.OrganizationPolicyAssignmentResponse`]
        :param page_info: 
    ...
    def organization_policy_assignments(self):
        ...
        :rtype: list[:class:`huaweicloudsdkconfig.v1.OrganizationPolicyAssignmentResponse`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListOrganizationPolicyAssignmentsResponse.to_dict() is deprecated and no longer maintained, "
