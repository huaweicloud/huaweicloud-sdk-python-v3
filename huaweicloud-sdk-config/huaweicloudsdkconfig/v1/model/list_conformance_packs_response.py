...
class ListConformancePacksResponse(SdkResponse):
    ...
    def __init__(self, value=None, page_info=None):
        ...
        :param value: 合规规则包查询列表。
        :type value: list[:class:`huaweicloudsdkconfig.v1.ConformancePack`]
        :param page_info: 
    ...
    def value(self):
        ...
        :return: The value of this ListConformancePacksResponse.
        :rtype: list[:class:`huaweicloudsdkconfig.v1.ConformancePack`]
        """
        return self._value
    ...
    def value(self, value):
        ...
        :param value: The value of this ListConformancePacksResponse.
        :type value: list[:class:`huaweicloudsdkconfig.v1.ConformancePack`]
        """
        self._value = value
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListConformancePacksResponse.to_dict() is deprecated and no longer maintained, "
