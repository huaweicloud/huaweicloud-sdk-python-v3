...
class ShowAggregateDiscoveredResourceCountsResponse(SdkResponse):
    ...
    def __init__(self, group_by_key=None, grouped_resource_counts=None, total_discovered_resources=None):
        ...
        :type grouped_resource_counts: list[:class:`huaweicloudsdkconfig.v1.GroupedResourceCount`]
    ...
    def grouped_resource_counts(self):
        ...
        :rtype: list[:class:`huaweicloudsdkconfig.v1.GroupedResourceCount`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowAggregateDiscoveredResourceCountsResponse.to_dict() is deprecated and no longer maintained, "
