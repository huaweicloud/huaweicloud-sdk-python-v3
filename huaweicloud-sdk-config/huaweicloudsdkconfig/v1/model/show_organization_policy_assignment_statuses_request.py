...
class ShowOrganizationPolicyAssignmentStatusesRequest:
    ...
    def organization_policy_assignment_id(self):
        r"""Gets the organization_policy_assignment_id of this ShowOrganizationPolicyAssignmentStatusesRequest.

        组织合规规则ID

        :return: The organization_policy_assignment_id of this ShowOrganizationPolicyAssignmentStatusesRequest.
        :rtype: str
        """
    ...
    def organization_policy_assignment_id(self, organization_policy_assignment_id):
        r"""Sets the organization_policy_assignment_id of this ShowOrganizationPolicyAssignmentStatusesRequest.

        组织合规规则ID

        :param organization_policy_assignment_id: The organization_policy_assignment_id of this ShowOrganizationPolicyAssignmentStatusesRequest.
        :type organization_policy_assignment_id: str
        """
