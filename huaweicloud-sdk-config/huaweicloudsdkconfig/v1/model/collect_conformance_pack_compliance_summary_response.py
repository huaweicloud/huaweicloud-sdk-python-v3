...
class CollectConformancePackComplianceSummaryResponse(SdkResponse):
    ...
    openapi_types = {
        'value': 'list[ConformancePackComplianceSummary]',
        'page_info': 'PageInfo'
    }
    ...
    def __init__(self, value=None, page_info=None):
        ...
        :param value: 合规规则包的合规结果概览列表。
        :type value: list[:class:`huaweicloudsdkconfig.v1.ConformancePackComplianceSummary`]
        :param page_info: 
    ...
    def value(self):
        ...
        :return: The value of this CollectConformancePackComplianceSummaryResponse.
        :rtype: list[:class:`huaweicloudsdkconfig.v1.ConformancePackComplianceSummary`]
        """
        return self._value
    ...
    def value(self, value):
        ...
        :param value: The value of this CollectConformancePackComplianceSummaryResponse.
        :type value: list[:class:`huaweicloudsdkconfig.v1.ConformancePackComplianceSummary`]
        """
        self._value = value
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CollectConformancePackComplianceSummaryResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CollectConformancePackComplianceSummaryResponse):
            return False
