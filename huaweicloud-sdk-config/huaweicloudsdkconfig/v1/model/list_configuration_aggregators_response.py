...
class ListConfigurationAggregatorsResponse(SdkResponse):
    ...
    def __init__(self, configuration_aggregators=None, page_info=None):
        ...
        :type configuration_aggregators: list[:class:`huaweicloudsdkconfig.v1.ConfigurationAggregatorResp`]
        :param page_info: 
    ...
    def configuration_aggregators(self):
        ...
        :rtype: list[:class:`huaweicloudsdkconfig.v1.ConfigurationAggregatorResp`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListConfigurationAggregatorsResponse.to_dict() is deprecated and no longer maintained, "
