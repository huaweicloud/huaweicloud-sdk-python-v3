...
class UpdatePolicyAssignmentResponse(SdkResponse):
    ...
    def __init__(self, policy_assignment_type=None, id=None, name=None, description=None, policy_filter=None, policy_filter_v2=None, period=None, state=None, created=None, updated=None, policy_definition_id=None, custom_policy=None, parameters=None, tags=None, created_by=None, target_type=None, target_id=None):
        r"""UpdatePolicyAssignmentResponse
    ...
    def policy_assignment_type(self):
        r"""Gets the policy_assignment_type of this UpdatePolicyAssignmentResponse.
    ...
    def policy_assignment_type(self, policy_assignment_type):
        r"""Sets the policy_assignment_type of this UpdatePolicyAssignmentResponse.
    ...
    @property
    def id(self):
        r"""Gets the id of this UpdatePolicyAssignmentResponse.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this UpdatePolicyAssignmentResponse.
    ...
    @property
    def name(self):
        r"""Gets the name of this UpdatePolicyAssignmentResponse.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this UpdatePolicyAssignmentResponse.
    ...
    def description(self):
        r"""Gets the description of this UpdatePolicyAssignmentResponse.
    ...
    def description(self, description):
        r"""Sets the description of this UpdatePolicyAssignmentResponse.
    ...
    def policy_filter(self):
        r"""Gets the policy_filter of this UpdatePolicyAssignmentResponse.
    ...
    def policy_filter(self, policy_filter):
        r"""Sets the policy_filter of this UpdatePolicyAssignmentResponse.
    ...
    def policy_filter_v2(self):
        r"""Gets the policy_filter_v2 of this UpdatePolicyAssignmentResponse.

        :return: The policy_filter_v2 of this UpdatePolicyAssignmentResponse.
    ...
    def policy_filter_v2(self, policy_filter_v2):
        r"""Sets the policy_filter_v2 of this UpdatePolicyAssignmentResponse.

        :param policy_filter_v2: The policy_filter_v2 of this UpdatePolicyAssignmentResponse.
        :type policy_filter_v2: :class:`huaweicloudsdkconfig.v1.PolicyFilterDefinitionV2`
        """
    ...
    @property
    def period(self):
        r"""Gets the period of this UpdatePolicyAssignmentResponse.
    ...
    def period(self, period):
        r"""Sets the period of this UpdatePolicyAssignmentResponse.
    ...
    @property
    def state(self):
        r"""Gets the state of this UpdatePolicyAssignmentResponse.
    ...
    def state(self, state):
        r"""Sets the state of this UpdatePolicyAssignmentResponse.
    ...
    @property
    def created(self):
        r"""Gets the created of this UpdatePolicyAssignmentResponse.
    ...
    def created(self, created):
        r"""Sets the created of this UpdatePolicyAssignmentResponse.
    ...
    @property
    def updated(self):
        r"""Gets the updated of this UpdatePolicyAssignmentResponse.
    ...
    def updated(self, updated):
        r"""Sets the updated of this UpdatePolicyAssignmentResponse.
    ...
    def policy_definition_id(self):
        r"""Gets the policy_definition_id of this UpdatePolicyAssignmentResponse.
    ...
    def policy_definition_id(self, policy_definition_id):
        r"""Sets the policy_definition_id of this UpdatePolicyAssignmentResponse.
    ...
    def custom_policy(self):
        r"""Gets the custom_policy of this UpdatePolicyAssignmentResponse.
    ...
    def custom_policy(self, custom_policy):
        r"""Sets the custom_policy of this UpdatePolicyAssignmentResponse.
    ...
    @property
    def parameters(self):
        r"""Gets the parameters of this UpdatePolicyAssignmentResponse.
    ...
    def parameters(self, parameters):
        r"""Sets the parameters of this UpdatePolicyAssignmentResponse.
    ...
    @property
    def tags(self):
        r"""Gets the tags of this UpdatePolicyAssignmentResponse.

        :return: The tags of this UpdatePolicyAssignmentResponse.
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this UpdatePolicyAssignmentResponse.

        :param tags: The tags of this UpdatePolicyAssignmentResponse.
        :type tags: list[:class:`huaweicloudsdkconfig.v1.ResourceTag`]
        """
        self._tags = tags
    ...
    @property
    def created_by(self):
        r"""Gets the created_by of this UpdatePolicyAssignmentResponse.
    ...
    def created_by(self, created_by):
        r"""Sets the created_by of this UpdatePolicyAssignmentResponse.
    ...
    def target_type(self):
        r"""Gets the target_type of this UpdatePolicyAssignmentResponse.

        合规规则修正方式。

        :return: The target_type of this UpdatePolicyAssignmentResponse.
        :rtype: str
        """
    ...
    def target_type(self, target_type):
        r"""Sets the target_type of this UpdatePolicyAssignmentResponse.

        合规规则修正方式。

        :param target_type: The target_type of this UpdatePolicyAssignmentResponse.
        :type target_type: str
        """
    ...
    @property
    def target_id(self):
        r"""Gets the target_id of this UpdatePolicyAssignmentResponse.

        修正执行的目标id。

        :return: The target_id of this UpdatePolicyAssignmentResponse.
        :rtype: str
        """
    ...
    def target_id(self, target_id):
        r"""Sets the target_id of this UpdatePolicyAssignmentResponse.

        修正执行的目标id。

        :param target_id: The target_id of this UpdatePolicyAssignmentResponse.
        :type target_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdatePolicyAssignmentResponse.to_dict() is deprecated and no longer maintained, "
