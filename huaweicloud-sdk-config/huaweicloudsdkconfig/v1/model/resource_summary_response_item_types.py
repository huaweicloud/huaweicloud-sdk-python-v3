...
class ResourceSummaryResponseItemTypes:
    ...
    def __init__(self, type=None, regions=None):
        ...
        :type type: str
        :param regions: 区域列表
        :type regions: list[:class:`huaweicloudsdkconfig.v1.ResourceSummaryResponseItemRegions`]
        """
    ...
    def regions(self):
        ...
        :rtype: list[:class:`huaweicloudsdkconfig.v1.ResourceSummaryResponseItemRegions`]
        """
