...
class ShowOrganizationPolicyAssignmentStatusesResponse(SdkResponse):
    ...
    def __init__(self, value=None, page_info=None):
        ...
        :type value: list[:class:`huaweicloudsdkconfig.v1.OrganizationPolicyAssignmentStatusResponse`]
        :param page_info: 
    ...
    def value(self):
        ...
        :rtype: list[:class:`huaweicloudsdkconfig.v1.OrganizationPolicyAssignmentStatusResponse`]
        """
        return self._value
