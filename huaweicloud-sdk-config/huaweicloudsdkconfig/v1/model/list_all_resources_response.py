...
class ListAllResourcesResponse(SdkResponse):
    ...
    def __init__(self, resources=None, page_info=None):
        r"""ListAllResourcesResponse

        The model defined in huaweicloud sdk

        :param resources: 资源列表
        :type resources: list[:class:`huaweicloudsdkconfig.v1.ResourceEntity`]
        :param page_info: 
    ...
    @property
    def resources(self):
        r"""Gets the resources of this ListAllResourcesResponse.

        资源列表

        :return: The resources of this ListAllResourcesResponse.
        :rtype: list[:class:`huaweicloudsdkconfig.v1.ResourceEntity`]
        """
        return self._resources

    @resources.setter
    def resources(self, resources):
        r"""Sets the resources of this ListAllResourcesResponse.
    ...
    @property
    def page_info(self):
        r"""Gets the page_info of this ListAllResourcesResponse.
    ...
    def page_info(self, page_info):
        r"""Sets the page_info of this ListAllResourcesResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAllResourcesResponse.to_dict() is deprecated and no longer maintained, "
