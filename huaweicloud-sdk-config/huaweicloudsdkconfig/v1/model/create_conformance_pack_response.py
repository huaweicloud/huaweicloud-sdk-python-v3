...
class CreateConformancePackResponse(SdkResponse):
    ...
    def __init__(self, id=None, name=None, stack_id=None, stack_name=None, deployment_id=None, created_at=None, updated_at=None, template_key=None, template_uri=None, agency_name=None, status=None, error_message=None, vars_structure=None, created_by=None):
        r"""CreateConformancePackResponse
    ...
    @property
    def id(self):
        r"""Gets the id of this CreateConformancePackResponse.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this CreateConformancePackResponse.
    ...
    @property
    def name(self):
        r"""Gets the name of this CreateConformancePackResponse.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this CreateConformancePackResponse.
    ...
    @property
    def stack_id(self):
        r"""Gets the stack_id of this CreateConformancePackResponse.
    ...
    def stack_id(self, stack_id):
        r"""Sets the stack_id of this CreateConformancePackResponse.
    ...
    @property
    def stack_name(self):
        r"""Gets the stack_name of this CreateConformancePackResponse.
    ...
    def stack_name(self, stack_name):
        r"""Sets the stack_name of this CreateConformancePackResponse.
    ...
    def deployment_id(self):
        r"""Gets the deployment_id of this CreateConformancePackResponse.
    ...
    def deployment_id(self, deployment_id):
        r"""Sets the deployment_id of this CreateConformancePackResponse.
    ...
    @property
    def created_at(self):
        r"""Gets the created_at of this CreateConformancePackResponse.
    ...
    def created_at(self, created_at):
        r"""Sets the created_at of this CreateConformancePackResponse.
    ...
    @property
    def updated_at(self):
        r"""Gets the updated_at of this CreateConformancePackResponse.
    ...
    def updated_at(self, updated_at):
        r"""Sets the updated_at of this CreateConformancePackResponse.
    ...
    def template_key(self):
        r"""Gets the template_key of this CreateConformancePackResponse.

        预定义合规规则包模板名称。

        :return: The template_key of this CreateConformancePackResponse.
        :rtype: str
        """
    ...
    def template_key(self, template_key):
        r"""Sets the template_key of this CreateConformancePackResponse.

        预定义合规规则包模板名称。

        :param template_key: The template_key of this CreateConformancePackResponse.
        :type template_key: str
        """
    ...
    def template_uri(self):
        r"""Gets the template_uri of this CreateConformancePackResponse.

        合规规则包模板OBS地址

        :return: The template_uri of this CreateConformancePackResponse.
        :rtype: str
        """
    ...
    def template_uri(self, template_uri):
        r"""Sets the template_uri of this CreateConformancePackResponse.

        合规规则包模板OBS地址

        :param template_uri: The template_uri of this CreateConformancePackResponse.
        :type template_uri: str
        """
    ...
    def agency_name(self):
        r"""Gets the agency_name of this CreateConformancePackResponse.

        委托名称

        :return: The agency_name of this CreateConformancePackResponse.
        :rtype: str
        """
    ...
    def agency_name(self, agency_name):
        r"""Sets the agency_name of this CreateConformancePackResponse.

        委托名称

        :param agency_name: The agency_name of this CreateConformancePackResponse.
        :type agency_name: str
        """
    ...
    @property
    def status(self):
        r"""Gets the status of this CreateConformancePackResponse.
    ...
    def status(self, status):
        r"""Sets the status of this CreateConformancePackResponse.
    ...
    def error_message(self):
        r"""Gets the error_message of this CreateConformancePackResponse.
    ...
    def error_message(self, error_message):
        r"""Sets the error_message of this CreateConformancePackResponse.
    ...
    def vars_structure(self):
        r"""Gets the vars_structure of this CreateConformancePackResponse.
    ...
    def vars_structure(self, vars_structure):
        r"""Sets the vars_structure of this CreateConformancePackResponse.
    ...
    @property
    def created_by(self):
        r"""Gets the created_by of this CreateConformancePackResponse.
    ...
    def created_by(self, created_by):
        r"""Sets the created_by of this CreateConformancePackResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateConformancePackResponse.to_dict() is deprecated and no longer maintained, "
