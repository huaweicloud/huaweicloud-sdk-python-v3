...
class CollectRemediationExecutionStatusesSummaryResponse(SdkResponse):
    ...
    openapi_types = {
        'value': 'list[RemediationExecutionStatus]',
        'page_info': 'PageInfo'
    }
    ...
    def __init__(self, value=None, page_info=None):
        ...
        :type value: list[:class:`huaweicloudsdkconfig.v1.RemediationExecutionStatus`]
        :param page_info: 
        :type page_info: :class:`huaweicloudsdkconfig.v1.PageInfo`
        """
        
        super(CollectRemediationExecutionStatusesSummaryResponse, self).__init__()
    ...
    def value(self):
        ...
        :return: The value of this CollectRemediationExecutionStatusesSummaryResponse.
        :rtype: list[:class:`huaweicloudsdkconfig.v1.RemediationExecutionStatus`]
        """
        return self._value
    ...
    def value(self, value):
        ...
        :param value: The value of this CollectRemediationExecutionStatusesSummaryResponse.
        :type value: list[:class:`huaweicloudsdkconfig.v1.RemediationExecutionStatus`]
        """
        self._value = value
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CollectRemediationExecutionStatusesSummaryResponse):
            return False
