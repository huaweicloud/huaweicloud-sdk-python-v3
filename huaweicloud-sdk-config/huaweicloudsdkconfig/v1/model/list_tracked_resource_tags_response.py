...
class ListTrackedResourceTagsResponse(SdkResponse):
    ...
    def __init__(self, tags=None, page_info=None):
        ...
        :param tags: 标签列表
        :type tags: list[:class:`huaweicloudsdkconfig.v1.TagDetail`]
        :param page_info: 
    ...
    def tags(self):
        ...
        :return: The tags of this ListTrackedResourceTagsResponse.
        :rtype: list[:class:`huaweicloudsdkconfig.v1.TagDetail`]
        """
        return self._tags
    ...
    def tags(self, tags):
        ...
        :param tags: The tags of this ListTrackedResourceTagsResponse.
        :type tags: list[:class:`huaweicloudsdkconfig.v1.TagDetail`]
        """
        self._tags = tags
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListTrackedResourceTagsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListTrackedResourceTagsResponse):
            return False
