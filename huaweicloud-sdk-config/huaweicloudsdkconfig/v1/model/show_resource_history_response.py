...
class ShowResourceHistoryResponse(SdkResponse):
    ...
    def __init__(self, items=None, page_info=None):
        ...
        :param items: 资源历史列表
        :type items: list[:class:`huaweicloudsdkconfig.v1.HistoryItem`]
        :param page_info: 
    ...
    def items(self):
        ...
        :rtype: list[:class:`huaweicloudsdkconfig.v1.HistoryItem`]
        """
        return self._items
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowResourceHistoryResponse.to_dict() is deprecated and no longer maintained, "
