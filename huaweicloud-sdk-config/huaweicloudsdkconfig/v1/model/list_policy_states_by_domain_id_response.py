...
class ListPolicyStatesByDomainIdResponse(SdkResponse):
    ...
    def value(self):
        ...
        :return: The value of this ListPolicyStatesByDomainIdResponse.
    ...
    def value(self, value):
        ...
        :param value: The value of this ListPolicyStatesByDomainIdResponse.
        :type value: list[:class:`huaweicloudsdkconfig.v1.PolicyState`]
        """
        self._value = value
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListPolicyStatesByDomainIdResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListPolicyStatesByDomainIdResponse):
            return False
