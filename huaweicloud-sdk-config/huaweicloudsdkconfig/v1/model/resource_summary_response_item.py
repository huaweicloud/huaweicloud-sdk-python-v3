...
class ResourceSummaryResponseItem:
    ...
    def __init__(self, provider=None, types=None):
        ...
        :type provider: str
        :param types: 资源类型列表
        :type types: list[:class:`huaweicloudsdkconfig.v1.ResourceSummaryResponseItemTypes`]
        """
    ...
    def types(self):
        ...
        :rtype: list[:class:`huaweicloudsdkconfig.v1.ResourceSummaryResponseItemTypes`]
        """
        return self._types
