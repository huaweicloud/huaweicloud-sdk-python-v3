...
class ShowAggregatePolicyStateComplianceSummaryResponse(SdkResponse):
    ...
    def __init__(self, results=None):
        ...
        :type results: list[:class:`huaweicloudsdkconfig.v1.AggregatePolicyComplianceSummaryResult`]
        """
    ...
    def results(self):
        ...
        :rtype: list[:class:`huaweicloudsdkconfig.v1.AggregatePolicyComplianceSummaryResult`]
        """
