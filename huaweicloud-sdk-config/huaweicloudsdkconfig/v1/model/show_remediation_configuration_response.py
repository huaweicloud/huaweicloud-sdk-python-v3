...
class ShowRemediationConfigurationResponse(SdkResponse):
    ...
    def __init__(self, automatic=None, target_type=None, target_id=None, target_region_id=None, target_project_id=None, static_parameter=None, resource_parameter=None, maximum_attempts=None, retry_attempt_seconds=None, auth_type=None, auth_value=None, created_at=None, updated_at=None, created_by=None):
        r"""ShowRemediationConfigurationResponse
    ...
    @property
    def automatic(self):
        r"""Gets the automatic of this ShowRemediationConfigurationResponse.
    ...
    def automatic(self, automatic):
        r"""Sets the automatic of this ShowRemediationConfigurationResponse.
    ...
    def target_type(self):
        r"""Gets the target_type of this ShowRemediationConfigurationResponse.
    ...
    def target_type(self, target_type):
        r"""Sets the target_type of this ShowRemediationConfigurationResponse.
    ...
    @property
    def target_id(self):
        r"""Gets the target_id of this ShowRemediationConfigurationResponse.
    ...
    def target_id(self, target_id):
        r"""Sets the target_id of this ShowRemediationConfigurationResponse.
    ...
    def target_region_id(self):
        r"""Gets the target_region_id of this ShowRemediationConfigurationResponse.
        ...
        :return: The target_region_id of this ShowRemediationConfigurationResponse.
        :rtype: str
        """
    ...
    def target_region_id(self, target_region_id):
        r"""Sets the target_region_id of this ShowRemediationConfigurationResponse.

        修正执行的目标的regionId。如果修正方式为RFS，该字段为空则Config服务会默认配置北京四（中国站）或香港一（国际站）的regionId；如果修正方式为FGS，该字段为空则Config服务会根据实例urn自动配置。指定target_project_id字段则该字段必选。

        :param target_region_id: The target_region_id of this ShowRemediationConfigurationResponse.
        :type target_region_id: str
        """
    ...
    def target_project_id(self):
        r"""Gets the target_project_id of this ShowRemediationConfigurationResponse.
        ...
        :return: The target_project_id of this ShowRemediationConfigurationResponse.
        :rtype: str
        """
    ...
    def target_project_id(self, target_project_id):
        r"""Sets the target_project_id of this ShowRemediationConfigurationResponse.

        修正执行的目标的projectId。如果修正方式为RFS，该字段为空则Config服务会默认配置北京四（中国站）或香港一（国际站）的主projectId；如果修正方式为FGS，该字段为空则Config服务会根据实例urn自动配置。指定target_region_id字段则该字段必选。

        :param target_project_id: The target_project_id of this ShowRemediationConfigurationResponse.
        :type target_project_id: str
        """
    ...
    def static_parameter(self):
        r"""Gets the static_parameter of this ShowRemediationConfigurationResponse.
    ...
    def static_parameter(self, static_parameter):
        r"""Sets the static_parameter of this ShowRemediationConfigurationResponse.
    ...
    def resource_parameter(self):
        r"""Gets the resource_parameter of this ShowRemediationConfigurationResponse.
    ...
    def resource_parameter(self, resource_parameter):
        r"""Sets the resource_parameter of this ShowRemediationConfigurationResponse.
    ...
    def maximum_attempts(self):
        r"""Gets the maximum_attempts of this ShowRemediationConfigurationResponse.
    ...
    def maximum_attempts(self, maximum_attempts):
        r"""Sets the maximum_attempts of this ShowRemediationConfigurationResponse.
    ...
    def retry_attempt_seconds(self):
        r"""Gets the retry_attempt_seconds of this ShowRemediationConfigurationResponse.
    ...
    def retry_attempt_seconds(self, retry_attempt_seconds):
        r"""Sets the retry_attempt_seconds of this ShowRemediationConfigurationResponse.
    ...
    @property
    def auth_type(self):
        r"""Gets the auth_type of this ShowRemediationConfigurationResponse.
    ...
    def auth_type(self, auth_type):
        r"""Sets the auth_type of this ShowRemediationConfigurationResponse.
    ...
    @property
    def auth_value(self):
        r"""Gets the auth_value of this ShowRemediationConfigurationResponse.
    ...
    def auth_value(self, auth_value):
        r"""Sets the auth_value of this ShowRemediationConfigurationResponse.
    ...
    @property
    def created_at(self):
        r"""Gets the created_at of this ShowRemediationConfigurationResponse.
    ...
    def created_at(self, created_at):
        r"""Sets the created_at of this ShowRemediationConfigurationResponse.
    ...
    @property
    def updated_at(self):
        r"""Gets the updated_at of this ShowRemediationConfigurationResponse.
    ...
    def updated_at(self, updated_at):
        r"""Sets the updated_at of this ShowRemediationConfigurationResponse.
    ...
    @property
    def created_by(self):
        r"""Gets the created_by of this ShowRemediationConfigurationResponse.
    ...
    def created_by(self, created_by):
        r"""Sets the created_by of this ShowRemediationConfigurationResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowRemediationConfigurationResponse.to_dict() is deprecated and no longer maintained, "
