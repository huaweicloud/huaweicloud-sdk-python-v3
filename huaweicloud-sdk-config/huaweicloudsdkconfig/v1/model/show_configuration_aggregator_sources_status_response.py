...
class ShowConfigurationAggregatorSourcesStatusResponse(SdkResponse):
    ...
    def __init__(self, aggregated_source_statuses=None, page_info=None):
        ...
        :type aggregated_source_statuses: list[:class:`huaweicloudsdkconfig.v1.AggregatedSourceStatus`]
        :param page_info: 
    ...
    def aggregated_source_statuses(self):
        ...
        :rtype: list[:class:`huaweicloudsdkconfig.v1.AggregatedSourceStatus`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowConfigurationAggregatorSourcesStatusResponse.to_dict() is deprecated and no longer maintained, "
