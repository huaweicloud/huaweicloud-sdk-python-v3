...
class ListBuiltInConformancePackTemplatesResponse(SdkResponse):
    ...
    openapi_types = {
        'value': 'list[ConformancePackTemplate]',
        'page_info': 'PageInfo'
    }
    ...
    def __init__(self, value=None, page_info=None):
        ...
        :param value: 预定义合规规则包模板列表。
        :type value: list[:class:`huaweicloudsdkconfig.v1.ConformancePackTemplate`]
        :param page_info: 
    ...
    def value(self):
        ...
        :return: The value of this ListBuiltInConformancePackTemplatesResponse.
        :rtype: list[:class:`huaweicloudsdkconfig.v1.ConformancePackTemplate`]
        """
        return self._value
    ...
    def value(self, value):
        ...
        :param value: The value of this ListBuiltInConformancePackTemplatesResponse.
        :type value: list[:class:`huaweicloudsdkconfig.v1.ConformancePackTemplate`]
        """
        self._value = value
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListBuiltInConformancePackTemplatesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListBuiltInConformancePackTemplatesResponse):
            return False
