...
class ShowBuiltInPolicyDefinitionResponse(SdkResponse):
    ...
    def default_resource_types(self):
        ...
        :return: The default_resource_types of this ShowBuiltInPolicyDefinitionResponse.
    ...
    def default_resource_types(self, default_resource_types):
        ...
        :param default_resource_types: The default_resource_types of this ShowBuiltInPolicyDefinitionResponse.
        :type default_resource_types: list[:class:`huaweicloudsdkconfig.v1.PolicyDefinitionDefaultResourceTypes`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowBuiltInPolicyDefinitionResponse.to_dict() is deprecated and no longer maintained, "
