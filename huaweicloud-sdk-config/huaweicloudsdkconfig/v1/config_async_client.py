...
class ConfigAsyncClient(Client):
    ...
    def new_builder(cls, clazz=None):
        if not clazz:
            ...
            if clazz.__name__ != "ConfigAsyncClient":
                raise TypeError("client type error, support client type is ConfigAsyncClient")
    ...
    def batch_create_remediation_exceptions_async(self, request):
        r"""批量创建修正例外
    ...
    def batch_create_remediation_exceptions_async_invoker(self, request):
        http_info = self._batch_create_remediation_exceptions_http_info(request)
        return AsyncInvoker(self, http_info)

    def _batch_create_remediation_exceptions_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def batch_delete_remediation_exceptions_async(self, request):
        r"""批量删除修正例外
    ...
    def batch_delete_remediation_exceptions_async_invoker(self, request):
        http_info = self._batch_delete_remediation_exceptions_http_info(request)
        return AsyncInvoker(self, http_info)

    def _batch_delete_remediation_exceptions_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def collect_remediation_execution_statuses_summary_async(self, request):
        ...
        :param request: Request instance for CollectRemediationExecutionStatusesSummary
        :type request: :class:`huaweicloudsdkconfig.v1.CollectRemediationExecutionStatusesSummaryRequest`
        :rtype: :class:`huaweicloudsdkconfig.v1.CollectRemediationExecutionStatusesSummaryResponse`
        """
        http_info = self._collect_remediation_execution_statuses_summary_http_info(request)
        return self._call_api(**http_info)

    def collect_remediation_execution_statuses_summary_async_invoker(self, request):
        http_info = self._collect_remediation_execution_statuses_summary_http_info(request)
        return AsyncInvoker(self, http_info)

    def _collect_remediation_execution_statuses_summary_http_info(self, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v1/resource-manager/domains/{domain_id}/policy-assignments/{policy_assignment_id}/remediation-execution-statuses/summary",
            "request_type": request.__class__.__name__,
            "response_type": "CollectRemediationExecutionStatusesSummaryResponse"
            }
    ...
    def create_or_update_remediation_configuration_async(self, request):
        r"""创建或更新修正配置
    ...
    def create_or_update_remediation_configuration_async_invoker(self, request):
        http_info = self._create_or_update_remediation_configuration_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_or_update_remediation_configuration_http_info(self, request):
        http_info = {
            "method": "PUT",
    ...
    def delete_remediation_configuration_async(self, request):
        r"""删除修正配置
    ...
    def delete_remediation_configuration_async_invoker(self, request):
        http_info = self._delete_remediation_configuration_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_remediation_configuration_http_info(self, request):
        http_info = {
            "method": "DELETE",
            "resource_path": "/v1/resource-manager/domains/{domain_id}/policy-assignments/{policy_assignment_id}/remediation-configuration",
            "request_type": request.__class__.__name__,
    ...
    def list_remediation_exceptions_async_invoker(self, request):
        http_info = self._list_remediation_exceptions_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_remediation_exceptions_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_remediation_execution_statuses_async(self, request):
        r"""查询修正执行结果
    ...
    def list_remediation_execution_statuses_async_invoker(self, request):
        http_info = self._list_remediation_execution_statuses_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_remediation_execution_statuses_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def run_remediation_execution_async(self, request):
        r"""运行修正执行
    ...
    def run_remediation_execution_async_invoker(self, request):
        http_info = self._run_remediation_execution_http_info(request)
        return AsyncInvoker(self, http_info)

    def _run_remediation_execution_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def show_remediation_configuration_async(self, request):
        r"""查询修正配置
    ...
    def show_remediation_configuration_async_invoker(self, request):
        http_info = self._show_remediation_configuration_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_remediation_configuration_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/resource-manager/domains/{domain_id}/policy-assignments/{policy_assignment_id}/remediation-configuration",
            "request_type": request.__class__.__name__,
    ...
    def update_organization_policy_assignment_async(self, request):
        r"""更新组织合规规则
    ...
    def update_organization_policy_assignment_async_invoker(self, request):
        http_info = self._update_organization_policy_assignment_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_organization_policy_assignment_http_info(self, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v1/resource-manager/organizations/{organization_id}/policy-assignments/{organization_policy_assignment_id}",
            "request_type": request.__class__.__name__,
    ...
    def collect_tracked_resources_summary_async(self, request):
        r"""列举资源记录器收集的资源概要
    ...
    def collect_tracked_resources_summary_async_invoker(self, request):
        http_info = self._collect_tracked_resources_summary_http_info(request)
        return AsyncInvoker(self, http_info)

    def _collect_tracked_resources_summary_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def count_tracked_resources_async(self, request):
        r"""查询资源记录器收集的资源数量
    ...
    def count_tracked_resources_async_invoker(self, request):
        http_info = self._count_tracked_resources_http_info(request)
        return AsyncInvoker(self, http_info)

    def _count_tracked_resources_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_tracked_resource_tags_async(self, request):
        r"""列举资源记录器收集的资源标签
    ...
    def list_tracked_resource_tags_async_invoker(self, request):
        http_info = self._list_tracked_resource_tags_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_tracked_resource_tags_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_tracked_resources_async(self, request):
        r"""列举资源记录器收集的全部资源
    ...
    def list_tracked_resources_async_invoker(self, request):
        http_info = self._list_tracked_resources_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_tracked_resources_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_tracked_resource_detail_async(self, request):
        r"""查询资源记录器收集的单个资源
    ...
    def show_tracked_resource_detail_async_invoker(self, request):
        http_info = self._show_tracked_resource_detail_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_tracked_resource_detail_http_info(self, request):
        http_info = {
            "method": "GET",
