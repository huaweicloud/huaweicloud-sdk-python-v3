...
class DeleteLtsConfigRequest:
    ...
    openapi_types = {
        'body': 'DeleteLtsConfigRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the DeleteLtsConfigRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteLtsConfigRequest):
            return False
