...
class MongoUpdateReplSetV3RequestBody:
    ...
    def name(self):
        ...
        :return: The name of this MongoUpdateReplSetV3RequestBody.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this MongoUpdateReplSetV3RequestBody.
        :type name: str
        """
        self._name = name
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MongoUpdateReplSetV3RequestBody):
            return False
