...
class BatchOperateInstanceTagRequestBody:
    ...
    def __init__(self, action=None, tags=None):
        r"""BatchOperateInstanceTagRequestBody
        ...
        :type action: str
        :param tags: 标签列表。
        :type tags: list[:class:`huaweicloudsdkdds.v3.TagItem`]
        """
    ...
    @property
    def action(self):
        r"""Gets the action of this BatchOperateInstanceTagRequestBody.
    ...
    def action(self, action):
        r"""Sets the action of this BatchOperateInstanceTagRequestBody.
    ...
    @property
    def tags(self):
        r"""Gets the tags of this BatchOperateInstanceTagRequestBody.

        标签列表。

        :return: The tags of this BatchOperateInstanceTagRequestBody.
        :rtype: list[:class:`huaweicloudsdkdds.v3.TagItem`]
        """
        return self._tags

    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this BatchOperateInstanceTagRequestBody.
