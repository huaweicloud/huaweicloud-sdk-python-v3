...
class CancelScheduledTaskResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CancelScheduledTaskResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CancelScheduledTaskResponse):
            return False
