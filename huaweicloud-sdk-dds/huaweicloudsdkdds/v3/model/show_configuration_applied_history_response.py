...
class ShowConfigurationAppliedHistoryResponse(SdkResponse):
    ...
    def __init__(self, histories=None):
        ...
        super(ShowConfigurationAppliedHistoryResponse, self).__init__()
    ...
    @property
    def histories(self):
        """Gets the histories of this ShowConfigurationAppliedHistoryResponse.
    ...
    def histories(self, histories):
        """Sets the histories of this ShowConfigurationAppliedHistoryResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowConfigurationAppliedHistoryResponse):
            return False
