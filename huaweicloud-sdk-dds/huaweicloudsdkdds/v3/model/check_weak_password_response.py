...
class CheckWeakPasswordResponse(SdkResponse):
    ...
    @property
    def weak(self):
        r"""Gets the weak of this CheckWeakPasswordResponse.
    ...
    @weak.setter
    def weak(self, weak):
        r"""Sets the weak of this CheckWeakPasswordResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CheckWeakPasswordResponse.to_dict() is deprecated and no longer maintained, "
