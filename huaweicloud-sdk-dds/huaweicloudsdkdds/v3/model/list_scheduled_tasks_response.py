...
class ListScheduledTasksResponse(SdkResponse):
    ...
    openapi_types = {
        'total_count': 'int',
        'schedules': 'list[ScheduledTasksRspSchedules]'
    }
    ...
    def __init__(self, total_count=None, schedules=None):
        ...
        :param total_count: 记录数量
        :type total_count: int
        :param schedules: 任务详情
        :type schedules: list[:class:`huaweicloudsdkdds.v3.ScheduledTasksRspSchedules`]
        """
    ...
    @property
    def schedules(self):
        r"""Gets the schedules of this ListScheduledTasksResponse.

        任务详情

        :return: The schedules of this ListScheduledTasksResponse.
        :rtype: list[:class:`huaweicloudsdkdds.v3.ScheduledTasksRspSchedules`]
        """
        return self._schedules

    @schedules.setter
    def schedules(self, schedules):
        r"""Sets the schedules of this ListScheduledTasksResponse.

        任务详情

        :param schedules: The schedules of this ListScheduledTasksResponse.
        :type schedules: list[:class:`huaweicloudsdkdds.v3.ScheduledTasksRspSchedules`]
        """
