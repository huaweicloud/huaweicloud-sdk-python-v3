...
class MigrateAzResponse(SdkResponse):
    ...
    @property
    def job_id(self):
        r"""Gets the job_id of this MigrateAzResponse.
    ...
    def job_id(self, job_id):
        r"""Sets the job_id of this MigrateAzResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("MigrateAzResponse.to_dict() is deprecated and no longer maintained, "
