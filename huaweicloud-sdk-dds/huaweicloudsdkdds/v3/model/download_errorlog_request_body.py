...
class DownloadErrorlogRequestBody:
    ...
    def __init__(self, file_name_list=None, node_id_list=None):
        ...
        :param node_id_list: 节点ID列表，取空值，表示查询实例下所有允许查询的节点。使用请参考《DDS API参考》的“查询实例列表和详情”响应消息表“nodes 数据结构说明”的“id”。允许查询的节点如下： - 集群下面的mongos、shard、config节点 - 副本集、单节点下面的所有节点
    ...
    def file_name_list(self):
        ...
        :return: The file_name_list of this DownloadErrorlogRequestBody.
        :rtype: list[str]
        """
    ...
    def file_name_list(self, file_name_list):
        ...
        :param file_name_list: The file_name_list of this DownloadErrorlogRequestBody.
        :type file_name_list: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DownloadErrorlogRequestBody):
            return False
