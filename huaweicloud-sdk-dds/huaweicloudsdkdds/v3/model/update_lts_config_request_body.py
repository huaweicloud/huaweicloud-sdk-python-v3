...
class UpdateLtsConfigRequestBody:
    ...
    openapi_types = {
        'lts_configs': 'list[UpdateLtsConfigRequestBodyLtsConfigs]'
    }
    ...
    def __init__(self, lts_configs=None):
        ...
        :param lts_configs: 每个Item是实例需要设置的LTS策略。
        :type lts_configs: list[:class:`huaweicloudsdkdds.v3.UpdateLtsConfigRequestBodyLtsConfigs`]
        """
    ...
    def lts_configs(self):
        ...
        :return: The lts_configs of this UpdateLtsConfigRequestBody.
        :rtype: list[:class:`huaweicloudsdkdds.v3.UpdateLtsConfigRequestBodyLtsConfigs`]
        """
    ...
    def lts_configs(self, lts_configs):
        ...
        :param lts_configs: The lts_configs of this UpdateLtsConfigRequestBody.
        :type lts_configs: list[:class:`huaweicloudsdkdds.v3.UpdateLtsConfigRequestBodyLtsConfigs`]
        """
