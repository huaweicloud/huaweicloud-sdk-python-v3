...
class ListFlavorInfosResponse(SdkResponse):
    ...
    def __init__(self, total_count=None, flavors=None):
        """ListFlavorInfosResponse - a model defined in huaweicloud sdk"""
    ...
    def total_count(self):
        """Gets the total_count of this ListFlavorInfosResponse.
    ...
    def total_count(self, total_count):
        """Sets the total_count of this ListFlavorInfosResponse.
    ...
    @property
    def flavors(self):
        """Gets the flavors of this ListFlavorInfosResponse.

        实例规格信息列表。

        :return: The flavors of this ListFlavorInfosResponse.
        :rtype: list[FlavorInfo]
        """
        return self._flavors

    @flavors.setter
    def flavors(self, flavors):
        """Sets the flavors of this ListFlavorInfosResponse.

        实例规格信息列表。

        :param flavors: The flavors of this ListFlavorInfosResponse.
        :type: list[FlavorInfo]
        """
