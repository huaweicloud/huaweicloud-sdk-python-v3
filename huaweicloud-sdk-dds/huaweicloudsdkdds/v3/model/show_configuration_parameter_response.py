...
class ShowConfigurationParameterResponse(SdkResponse):
    ...
    openapi_types = {
        ...
        'created': 'str',
        'updated': 'str',
        'parameters': 'list[ConfigurationParametersResult]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowConfigurationParameterResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowConfigurationParameterResponse):
            return False
