...
class ListTasksResponse(SdkResponse):
    ...
    @property
    def jobs(self):
        """Gets the jobs of this ListTasksResponse.

        任务列表。

        :return: The jobs of this ListTasksResponse.
        :rtype: list[:class:`huaweicloudsdkdds.v3.JobInfo`]
        """
        return self._jobs

    @jobs.setter
    def jobs(self, jobs):
        """Sets the jobs of this ListTasksResponse.

        任务列表。

        :param jobs: The jobs of this ListTasksResponse.
        :type jobs: list[:class:`huaweicloudsdkdds.v3.JobInfo`]
        """
        self._jobs = jobs
    ...
    def total_count(self):
        """Gets the total_count of this ListTasksResponse.
