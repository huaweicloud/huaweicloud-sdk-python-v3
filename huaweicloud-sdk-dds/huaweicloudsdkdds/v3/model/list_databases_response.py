...
class ListDatabasesResponse(SdkResponse):
    ...
    openapi_types = {
        'databases': 'list[DatabaseInfoItem]',
        'total_count': 'int'
    }
    ...
    def __init__(self, databases=None, total_count=None):
        ...
        :param databases: 数据库列表信息。
        :type databases: list[:class:`huaweicloudsdkdds.v3.DatabaseInfoItem`]
        :param total_count: 数据库列表总数。
    ...
    def databases(self):
        ...
        :rtype: list[:class:`huaweicloudsdkdds.v3.DatabaseInfoItem`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListDatabasesResponse.to_dict() is deprecated and no longer maintained, "
