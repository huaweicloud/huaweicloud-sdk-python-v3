...
class ListSlowLogsResponse(SdkResponse):
    ...
    def __init__(self, slow_log_list=None, total_record=None):
        ...
        :type slow_log_list: list[:class:`huaweicloudsdkdds.v3.SlowlogResult`]
    ...
    def slow_log_list(self):
        ...
        :rtype: list[:class:`huaweicloudsdkdds.v3.SlowlogResult`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListSlowLogsResponse.to_dict() is deprecated and no longer maintained, "
