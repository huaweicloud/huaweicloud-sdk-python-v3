...
class ApplyHistoryInfo:
    ...
    def __init__(self, instance_id=None, instance_name=None, applied_at=None, apply_result=None, failure_reason=None):
        ...
        :type applied_at: str
        :param apply_result: 应用结果。 SUCCESS：应用成功，FAILED：应用失败。
    ...
    def instance_id(self):
        """Gets the instance_id of this ApplyHistoryInfo.
    ...
    def instance_id(self, instance_id):
        """Sets the instance_id of this ApplyHistoryInfo.
    ...
    def instance_name(self):
        """Gets the instance_name of this ApplyHistoryInfo.
    ...
    def instance_name(self, instance_name):
        """Sets the instance_name of this ApplyHistoryInfo.
    ...
    @property
    def applied_at(self):
        """Gets the applied_at of this ApplyHistoryInfo.

        应用时间，格式为\"yyyy-MM-ddTHH:mm:ssZ\"。其中，T指某个时间的开始；Z指时区偏移量，例如北京时间偏移显示为+0800。

        :return: The applied_at of this ApplyHistoryInfo.
        :rtype: str
        """
    ...
    def applied_at(self, applied_at):
        """Sets the applied_at of this ApplyHistoryInfo.

        应用时间，格式为\"yyyy-MM-ddTHH:mm:ssZ\"。其中，T指某个时间的开始；Z指时区偏移量，例如北京时间偏移显示为+0800。

        :param applied_at: The applied_at of this ApplyHistoryInfo.
        :type applied_at: str
        """
    ...
    def apply_result(self):
        """Gets the apply_result of this ApplyHistoryInfo.
    ...
    def apply_result(self, apply_result):
        """Sets the apply_result of this ApplyHistoryInfo.
    ...
    def failure_reason(self):
        """Gets the failure_reason of this ApplyHistoryInfo.

        失败原因。

        :return: The failure_reason of this ApplyHistoryInfo.
        :rtype: str
        """
    ...
    def failure_reason(self, failure_reason):
        """Sets the failure_reason of this ApplyHistoryInfo.

        失败原因。

        :param failure_reason: The failure_reason of this ApplyHistoryInfo.
        :type failure_reason: str
        """
