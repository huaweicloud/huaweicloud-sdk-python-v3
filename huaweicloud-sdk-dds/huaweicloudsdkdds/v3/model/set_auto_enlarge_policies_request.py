...
class SetAutoEnlargePoliciesRequest:
    ...
    openapi_types = {
        'body': 'SetAutoEnlargePoliciesRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the SetAutoEnlargePoliciesRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SetAutoEnlargePoliciesRequest):
            return False
