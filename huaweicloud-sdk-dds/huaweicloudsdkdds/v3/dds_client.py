...
class DdsClient(Client):
    ...
    def batch_delete_shards(self, request):
        r"""删除分片
    ...
    def batch_delete_shards_invoker(self, request):
        http_info = self._batch_delete_shards_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _batch_delete_shards_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def bind_public_gateway(self, request):
        r"""绑定公网网关
    ...
    def bind_public_gateway_invoker(self, request):
        http_info = self._bind_public_gateway_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _bind_public_gateway_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def delete_ip_invoker(self, request):
        http_info = self._delete_ip_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_ip_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def unbind_public_gateway(self, request):
        r"""解绑公网网关
    ...
    def unbind_public_gateway_invoker(self, request):
        http_info = self._unbind_public_gateway_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _unbind_public_gateway_http_info(cls, request):
        http_info = {
            "method": "DELETE",
            "resource_path": "/v3/{project_id}/instances/{instance_id}/nodes/{node_id}/public-gateway",
            "request_type": request.__class__.__name__,
