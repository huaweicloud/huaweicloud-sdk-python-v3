...
class CompareConfigurationResponse(SdkResponse):
    ...
    openapi_types = {
        'differences': 'list[DifferentDetails]'
    }
    ...
    def __init__(self, differences=None):
        ...
        :param differences: 参数之间的区别集合。
        :type differences: list[:class:`huaweicloudsdkgaussdbfornosql.v3.DifferentDetails`]
        """
    ...
    def differences(self):
        ...
        :rtype: list[:class:`huaweicloudsdkgaussdbfornosql.v3.DifferentDetails`]
        """
