...
class RestartInstanceRequestBody:
    ...
    def __init__(self, node_id=None):
        ...
        :param node_id: 待重启的节点ID。 仅GeminiDB Redis云原生部署模式集群实例支持传入节点ID重启对应节点。 不传则重启整个实例。
        :type node_id: str
        """
    ...
    def node_id(self):
        ...
        :return: The node_id of this RestartInstanceRequestBody.
        :rtype: str
        """
    ...
    def node_id(self, node_id):
        ...
        :param node_id: The node_id of this RestartInstanceRequestBody.
        :type node_id: str
        """
