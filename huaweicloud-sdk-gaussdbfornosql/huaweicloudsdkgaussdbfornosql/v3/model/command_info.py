...
class CommandInfo:
    ...
    def __init__(self, origin_name=None, name=None):
        ...
        :param origin_name: 原高危命令，当前支持的有：keys、flushdb、flushall、hgetall、hkeys、hvals、smembers
        :type origin_name: str
        :param name: 当前生效的命令名称，当为空时表示命令禁用，允许修改为30个字符以内数字、字母和下划线的组合
        :type name: str
        """
    ...
    def origin_name(self):
        ...
        :return: The origin_name of this CommandInfo.
        :rtype: str
        """
    ...
    def origin_name(self, origin_name):
        ...
        :param origin_name: The origin_name of this CommandInfo.
        :type origin_name: str
        """
    ...
    def name(self):
        ...
        :return: The name of this CommandInfo.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this CommandInfo.
        :type name: str
        """
        self._name = name
