...
class ListInstancesByTagsResponse(SdkResponse):
    ...
    def __init__(self, instances=None, total_count=None):
        r"""ListInstancesByTagsResponse

        The model defined in huaweicloud sdk

        :param instances: 实例列表。
        :type instances: list[:class:`huaweicloudsdkgaussdbfornosql.v3.InstanceResult`]
    ...
    def instances(self):
        ...
        :rtype: list[:class:`huaweicloudsdkgaussdbfornosql.v3.InstanceResult`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListInstancesByTagsResponse.to_dict() is deprecated and no longer maintained, "
