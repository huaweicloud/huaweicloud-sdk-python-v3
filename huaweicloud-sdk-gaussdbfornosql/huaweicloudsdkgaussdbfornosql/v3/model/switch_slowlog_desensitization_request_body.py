...
class SwitchSlowlogDesensitizationRequestBody:
    ...
    def __init__(self, desensitization_status=None):
        ...
        :param desensitization_status: 实例慢日志脱敏开关开启状态，取值： - off 关闭
    ...
    def desensitization_status(self):
        ...
        :return: The desensitization_status of this SwitchSlowlogDesensitizationRequestBody.
        :rtype: str
        """
    ...
    def desensitization_status(self, desensitization_status):
        ...
        :param desensitization_status: The desensitization_status of this SwitchSlowlogDesensitizationRequestBody.
        :type desensitization_status: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SwitchSlowlogDesensitizationRequestBody):
            return False
