...
class CreateDbCacheMappingRequest:
    ...
    openapi_types = {
        'body': 'CreateDbCacheMappingRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateDbCacheMappingRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateDbCacheMappingRequest):
            return False
