...
class RestoreRedisDataRequest:
    ...
    openapi_types = {
        'instance_id': 'str',
        'body': 'RestoreRedisDataRequestBody'
    }
    ...
    @property
    def body(self):
        r"""Gets the body of this RestoreRedisDataRequest.

        :return: The body of this RestoreRedisDataRequest.
        :rtype: :class:`huaweicloudsdkgaussdbfornosql.v3.RestoreRedisDataRequestBody`
        """
        return self._body

    @body.setter
    def body(self, body):
        r"""Sets the body of this RestoreRedisDataRequest.

        :param body: The body of this RestoreRedisDataRequest.
        :type body: :class:`huaweicloudsdkgaussdbfornosql.v3.RestoreRedisDataRequestBody`
        """
        self._body = body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RestoreRedisDataRequest):
            return False
