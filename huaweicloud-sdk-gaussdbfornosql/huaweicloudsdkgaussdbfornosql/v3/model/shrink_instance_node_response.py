...
class ShrinkInstanceNodeResponse(SdkResponse):
    ...
    def job_id(self):
        ...
        :return: The job_id of this ShrinkInstanceNodeResponse.
        :rtype: str
        """
        return self._job_id
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShrinkInstanceNodeResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShrinkInstanceNodeResponse):
            return False
