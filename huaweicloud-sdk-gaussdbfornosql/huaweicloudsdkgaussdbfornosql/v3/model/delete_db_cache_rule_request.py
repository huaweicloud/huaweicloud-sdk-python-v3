...
class DeleteDbCacheRuleRequest:
    ...
    openapi_types = {
        'body': 'DeleteDbCacheRuleRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the DeleteDbCacheRuleRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteDbCacheRuleRequest):
            return False
