...
class DeleteInstancesSessionRequest:
    ...
    openapi_types = {
        'node_id': 'str',
        'body': 'DeleteInstancesSessionRequestBody'
    }
    ...
    def __init__(self, node_id=None, body=None):
        ...
        :param node_id: 节点ID。
        :type node_id: str
        :param body: Body of the DeleteInstancesSessionRequest
    ...
    def node_id(self):
        ...
        :return: The node_id of this DeleteInstancesSessionRequest.
        :rtype: str
        """
    ...
    def node_id(self, node_id):
        ...
        :param node_id: The node_id of this DeleteInstancesSessionRequest.
        :type node_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteInstancesSessionRequest):
            return False
