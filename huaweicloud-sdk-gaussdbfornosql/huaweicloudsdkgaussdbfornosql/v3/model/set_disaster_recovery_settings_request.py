...
class SetDisasterRecoverySettingsRequest:
    ...
    openapi_types = {
        'body': 'SetDisasterRecoverySettingsRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the SetDisasterRecoverySettingsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SetDisasterRecoverySettingsRequest):
            return False
