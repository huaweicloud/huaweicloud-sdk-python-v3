...
class ListInstancesByResourceTagsRequest:
    ...
    def __init__(self, body=None):
        r"""ListInstancesByResourceTagsRequest
    ...
    @property
    def body(self):
        r"""Gets the body of this ListInstancesByResourceTagsRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this ListInstancesByResourceTagsRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListInstancesByResourceTagsRequest):
            return False
