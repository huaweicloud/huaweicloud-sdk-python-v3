...
class ListDbUsersResponse(SdkResponse):
    ...
    def __init__(self, users=None, total_count=None):
        ...
        :param users: 数据库用户信息列表。
        :type users: list[:class:`huaweicloudsdkgaussdbfornosql.v3.RedisDbUserInfo`]
    ...
    def users(self):
        ...
        :rtype: list[:class:`huaweicloudsdkgaussdbfornosql.v3.RedisDbUserInfo`]
        """
        return self._users
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListDbUsersResponse.to_dict() is deprecated and no longer maintained, "
