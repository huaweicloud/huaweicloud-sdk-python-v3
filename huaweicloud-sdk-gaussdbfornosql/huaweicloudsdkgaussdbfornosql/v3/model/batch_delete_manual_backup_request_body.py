...
class BatchDeleteManualBackupRequestBody:
    ...
    def __init__(self, backup_ids=None):
        ...
        :param backup_ids: 需要批量删除的手动备份id列表，最多一次不超过10条
    ...
    def backup_ids(self):
        ...
        :return: The backup_ids of this BatchDeleteManualBackupRequestBody.
        :rtype: list[str]
        """
    ...
    def backup_ids(self, backup_ids):
        ...
        :param backup_ids: The backup_ids of this BatchDeleteManualBackupRequestBody.
        :type backup_ids: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteManualBackupRequestBody):
            return False
