...
class ModifyEpsQuotasRequest:
    ...
    openapi_types = {
        'body': 'NoSqlModiflyEpsQuotasRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ModifyEpsQuotasRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModifyEpsQuotasRequest):
            return False
