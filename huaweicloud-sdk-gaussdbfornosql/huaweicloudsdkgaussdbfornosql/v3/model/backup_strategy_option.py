...
class BackupStrategyOption:
    ...
    def __init__(self, start_time=None, keep_days=None):
        """BackupStrategyOption - a model defined in huaweicloud sdk"""
    ...
    @property
    def start_time(self):
        """Gets the start_time of this BackupStrategyOption.
    ...
    def start_time(self, start_time):
        """Sets the start_time of this BackupStrategyOption.
    ...
    @property
    def keep_days(self):
        """Gets the keep_days of this BackupStrategyOption.
    ...
    def keep_days(self, keep_days):
        """Sets the keep_days of this BackupStrategyOption.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BackupStrategyOption):
            return False
