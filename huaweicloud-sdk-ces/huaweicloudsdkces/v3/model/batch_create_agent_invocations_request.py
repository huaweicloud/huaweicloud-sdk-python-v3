...
class BatchCreateAgentInvocationsRequest:
    ...
    openapi_types = {
        'body': 'BatchCreateInvocationRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchCreateAgentInvocationsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchCreateAgentInvocationsRequest):
            return False
