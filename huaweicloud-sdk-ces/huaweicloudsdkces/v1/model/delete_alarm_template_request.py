...
class DeleteAlarmTemplateRequest:
    ...
    def __init__(self, template_id=None):
        ...
        :param template_id: **参数解释**： 自定义告警模板的ID，如：at1603330892378wkDm77y6B **约束限制**： 不涉及 **取值范围**： 以at开头，后跟字母、数字，长度最长为64 **默认取值**： 不涉及 
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteAlarmTemplateRequest):
            return False
