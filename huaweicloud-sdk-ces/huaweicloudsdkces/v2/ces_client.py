...
class CesClient(Client):
    ...
    def add_alarm_resources(self, request):
    ...
    def add_resource_groups_resources_batch(self, request):
        """自定义资源分组批量增加关联资源
    ...
    def delete_alarm_resources(self, request):
    ...
    def delete_resource_groups_resources_batch(self, request):
        """自定义资源分组批量删除关联资源
    ...
    def list_alarm_resources(self, request):
        """根据告警ID查询告警资源列表
