...
class BatchUpdateNotificationMaskTimeRequest:
    ...
    openapi_types = {
        'body': 'BatchUpdateNotificationMaskTimeRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchUpdateNotificationMaskTimeRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchUpdateNotificationMaskTimeRequest):
            return False
