...
class ProductMetricResp:
    ...
    def __init__(self, dimension_name=None, metric_name=None):
        ...
        :param dimension_name: **参数解释**： 按云产品维度屏蔽时的资源维度信息。    **取值范围**： 长度为[0,128]个字符，有多个时用\&quot;,\&quot;连接。 
    ...
    def dimension_name(self):
        r"""Gets the dimension_name of this ProductMetricResp.

        **参数解释**： 按云产品维度屏蔽时的资源维度信息。    **取值范围**： 长度为[0,128]个字符，有多个时用\",\"连接。 

        :return: The dimension_name of this ProductMetricResp.
        :rtype: str
        """
    ...
    def dimension_name(self, dimension_name):
        r"""Sets the dimension_name of this ProductMetricResp.

        **参数解释**： 按云产品维度屏蔽时的资源维度信息。    **取值范围**： 长度为[0,128]个字符，有多个时用\",\"连接。 

        :param dimension_name: The dimension_name of this ProductMetricResp.
        :type dimension_name: str
        """
    ...
    def metric_name(self):
        r"""Gets the metric_name of this ProductMetricResp.
        ...
        **参数解释**： 资源的监控指标名称，各服务的指标名称可查看：“[服务指标名称](ces_03_0059.xml)”。 **约束限制**： 不涉及。 **取值范围**： 必须以字母开头，只能包含0-9/a-z/A-Z/_/-。字符长度最短为1，最大为96。如：弹性云服务器中的监控指标cpu_util，表示弹性服务器的CPU使用率；文档数据库中的指标mongo001_command_ps，表示command执行频率。         **默认取值**： 不涉及。 
        ...
        :return: The metric_name of this ProductMetricResp.
        :rtype: str
        """
    ...
    def metric_name(self, metric_name):
        r"""Sets the metric_name of this ProductMetricResp.

        **参数解释**： 资源的监控指标名称，各服务的指标名称可查看：“[服务指标名称](ces_03_0059.xml)”。 **约束限制**： 不涉及。 **取值范围**： 必须以字母开头，只能包含0-9/a-z/A-Z/_/-。字符长度最短为1，最大为96。如：弹性云服务器中的监控指标cpu_util，表示弹性服务器的CPU使用率；文档数据库中的指标mongo001_command_ps，表示command执行频率。         **默认取值**： 不涉及。 

        :param metric_name: The metric_name of this ProductMetricResp.
        :type metric_name: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProductMetricResp):
            return False
