...
class UpdatePolicyResp:
    ...
    def __init__(self, metric_name=None, extra_info=None, period=None, filter=None, comparison_operator=None, value=None, hierarchical_value=None, unit=None, type=None, count=None, suppress_duration=None, level=None, namespace=None, dimension_name=None):
        ...
        :param period: **参数解释**： 指标周期，单位是秒。如想了解各个云服务的指标原始周期可以参考“[支持服务列表](ces_03_0059.xml)”。 **取值范围**： 枚举值。 - 0代表立即触发，仅限事件类告警使用。 - 1代表指标的原始周期，比如RDS监控指标原始周期是60s，表示该RDS指标按60s周期为一个数据点参与告警计算。 - 300代表指标按5分钟聚合周期为一个数据点参与告警计算。 - 1200代表指标按20分钟聚合周期为一个数据点参与告警计算。 - 3600代表指标按1小时聚合周期为一个数据点参与告警计算。 - 14400代表指标按4小时聚合周期为一个数据点参与告警计算。 - 86400代表指标按1天聚合周期为一个数据点参与告警计算。 
        :type period: int
        ...
        :type unit: str
        :param type: **参数解释**： 告警策略类型，已废弃，不推荐使用。 **取值范围**： 只能为auto。 
        :type type: str
        ...
        :type level: int
        :param namespace: **参数解释**： 各服务命名空间，请参考“[服务命名空间](ces_03_0059.xml)”。产品层级规则增加namespace（服务命名空间）和dimension_name（服务维度名称），用于指明策略生效的资源归属。 **取值范围**： 格式为service.item；service和item必须是字符串，必须以字母开头，只能包含0-9/a-z/A-Z/_。长度为[0,32]个字符。        。 
        :type namespace: str
        :param dimension_name: **参数解释**： 指标维度名称，各服务资源的指标维度名称可查看：“[服务维度名称](ces_03_0059.xml)”。 **取值范围**： 目前最大支持4个维度。举例：单维度场景：instance_id；多维度场景：instance_id,disk 
    ...
    def metric_name(self):
        r"""Gets the metric_name of this UpdatePolicyResp.
        ...
        **参数解释**： 资源的监控指标名称，各服务的指标名称可查看：“[服务指标名称](ces_03_0059.xml)”。 **取值范围**： 必须以字母开头，只能包含0-9/a-z/A-Z/_/-。字符长度最短为1，最大为96。如：弹性云服务器中的监控指标cpu_util，表示弹性服务器的CPU使用率；文档数据库中的指标mongo001_command_ps，表示command执行频率。 
        ...
        :return: The metric_name of this UpdatePolicyResp.
        :rtype: str
        """
    ...
    def metric_name(self, metric_name):
        r"""Sets the metric_name of this UpdatePolicyResp.

        **参数解释**： 资源的监控指标名称，各服务的指标名称可查看：“[服务指标名称](ces_03_0059.xml)”。 **取值范围**： 必须以字母开头，只能包含0-9/a-z/A-Z/_/-。字符长度最短为1，最大为96。如：弹性云服务器中的监控指标cpu_util，表示弹性服务器的CPU使用率；文档数据库中的指标mongo001_command_ps，表示command执行频率。 

        :param metric_name: The metric_name of this UpdatePolicyResp.
        :type metric_name: str
        """
    ...
    @property
    def extra_info(self):
        r"""Gets the extra_info of this UpdatePolicyResp.

        :return: The extra_info of this UpdatePolicyResp.
    ...
    def extra_info(self, extra_info):
        r"""Sets the extra_info of this UpdatePolicyResp.

        :param extra_info: The extra_info of this UpdatePolicyResp.
        :type extra_info: :class:`huaweicloudsdkces.v2.MetricExtraInfoResp`
        """
    ...
    @property
    def period(self):
        r"""Gets the period of this UpdatePolicyResp.
        ...
        **参数解释**： 指标周期，单位是秒。如想了解各个云服务的指标原始周期可以参考“[支持服务列表](ces_03_0059.xml)”。 **取值范围**： 枚举值。 - 0代表立即触发，仅限事件类告警使用。 - 1代表指标的原始周期，比如RDS监控指标原始周期是60s，表示该RDS指标按60s周期为一个数据点参与告警计算。 - 300代表指标按5分钟聚合周期为一个数据点参与告警计算。 - 1200代表指标按20分钟聚合周期为一个数据点参与告警计算。 - 3600代表指标按1小时聚合周期为一个数据点参与告警计算。 - 14400代表指标按4小时聚合周期为一个数据点参与告警计算。 - 86400代表指标按1天聚合周期为一个数据点参与告警计算。 
        ...
        :return: The period of this UpdatePolicyResp.
        :rtype: int
        """
        return self._period
    ...
    def period(self, period):
        r"""Sets the period of this UpdatePolicyResp.

        **参数解释**： 指标周期，单位是秒。如想了解各个云服务的指标原始周期可以参考“[支持服务列表](ces_03_0059.xml)”。 **取值范围**： 枚举值。 - 0代表立即触发，仅限事件类告警使用。 - 1代表指标的原始周期，比如RDS监控指标原始周期是60s，表示该RDS指标按60s周期为一个数据点参与告警计算。 - 300代表指标按5分钟聚合周期为一个数据点参与告警计算。 - 1200代表指标按20分钟聚合周期为一个数据点参与告警计算。 - 3600代表指标按1小时聚合周期为一个数据点参与告警计算。 - 14400代表指标按4小时聚合周期为一个数据点参与告警计算。 - 86400代表指标按1天聚合周期为一个数据点参与告警计算。 

        :param period: The period of this UpdatePolicyResp.
        :type period: int
        """
        self._period = period
    ...
    @property
    def filter(self):
        r"""Gets the filter of this UpdatePolicyResp.

        **参数解释**： 聚合方式。         **取值范围**： average： 平均值，variance：方差，min：最小值，max：最大值，sum：求和。 

        :return: The filter of this UpdatePolicyResp.
        :rtype: str
        """
        return self._filter
    ...
    def filter(self, filter):
        r"""Sets the filter of this UpdatePolicyResp.

        **参数解释**： 聚合方式。         **取值范围**： average： 平均值，variance：方差，min：最小值，max：最大值，sum：求和。 

        :param filter: The filter of this UpdatePolicyResp.
        :type filter: str
        """
        self._filter = filter
    ...
    def comparison_operator(self, comparison_operator):
        r"""Sets the comparison_operator of this UpdatePolicyResp.

        **参数解释**： 阈值符号。     **取值范围**： 支持的值为(>|<|>=|<=|=|!=|cycle_decrease|cycle_increase|cycle_wave);cycle_decrease为环比下降,cycle_increase为环比上升,cycle_wave为环比波动。 

        :param comparison_operator: The comparison_operator of this UpdatePolicyResp.
        :type comparison_operator: str
        """
    ...
    @property
    def value(self):
        r"""Gets the value of this UpdatePolicyResp.

        **参数解释**： 告警阈值。具体阈值取值请参见附录中各服务监控指标中取值范围。 **取值范围**： 最小值为0，最大值为1.7976931348623157e+108。 

        :return: The value of this UpdatePolicyResp.
        :rtype: float
        """
        return self._value
    ...
    def value(self, value):
        r"""Sets the value of this UpdatePolicyResp.

        **参数解释**： 告警阈值。具体阈值取值请参见附录中各服务监控指标中取值范围。 **取值范围**： 最小值为0，最大值为1.7976931348623157e+108。 

        :param value: The value of this UpdatePolicyResp.
        :type value: float
        """
        self._value = value
    ...
    def hierarchical_value(self):
        r"""Gets the hierarchical_value of this UpdatePolicyResp.

        :return: The hierarchical_value of this UpdatePolicyResp.
    ...
    def hierarchical_value(self, hierarchical_value):
        r"""Sets the hierarchical_value of this UpdatePolicyResp.

        :param hierarchical_value: The hierarchical_value of this UpdatePolicyResp.
        :type hierarchical_value: :class:`huaweicloudsdkces.v2.HierarchicalValueResp`
        """
    ...
    @property
    def unit(self):
        r"""Gets the unit of this UpdatePolicyResp.

        **参数解释**： 数据的单位。    **取值范围**： 长度为[0,32]个字符。 

        :return: The unit of this UpdatePolicyResp.
        :rtype: str
        """
        return self._unit
    ...
    @unit.setter
    def unit(self, unit):
        r"""Sets the unit of this UpdatePolicyResp.

        **参数解释**： 数据的单位。    **取值范围**： 长度为[0,32]个字符。 

        :param unit: The unit of this UpdatePolicyResp.
        :type unit: str
        """
        self._unit = unit
    ...
    @property
    def type(self):
        r"""Gets the type of this UpdatePolicyResp.

        **参数解释**： 告警策略类型，已废弃，不推荐使用。 **取值范围**： 只能为auto。 

        :return: The type of this UpdatePolicyResp.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        r"""Sets the type of this UpdatePolicyResp.

        **参数解释**： 告警策略类型，已废弃，不推荐使用。 **取值范围**： 只能为auto。 

        :param type: The type of this UpdatePolicyResp.
        :type type: str
        """
        self._type = type
    ...
    def count(self, count):
        r"""Sets the count of this UpdatePolicyResp.

        **参数解释**： 告警连续触发次数。     **取值范围**： 事件告警时参数值为1~180（包括1和180）；指标告警和站点告警时，次数采用枚举值，枚举值分别为：1、2、3、4、5、10、15、30、60、90、120、180。 

        :param count: The count of this UpdatePolicyResp.
        :type count: int
        """
        self._count = count
    ...
    def suppress_duration(self):
        r"""Gets the suppress_duration of this UpdatePolicyResp.

        **参数解释**： 告警抑制时间，单位为秒，对应页面上创建告警规则时告警策略最后一个字段，该字段主要为解决告警频繁的问题。 **取值范围**： 枚举值，只能为0、300、600、900、1800、3600、10800、21600、43200、86400。 - 0：在立即触发场景中，0代表不抑制；在累计触发场景，0代表只告警一次。 - 300代表满足告警触发条件后每5分钟告警一次。 - 600代表满足告警触发条件后每10分钟告警一次。 - 900代表满足告警触发条件后每15分钟告警一次。 - 1800代表满足告警触发条件后每30分钟告警一次。 - 3600代表满足告警触发条件后每60分钟告警一次。 - 10800代表满足告警触发条件后每3小时告警一次。 - 21600代表满足告警触发条件后每6小时告警一次。 - 43200代表满足告警触发条件后每12小时告警一次。 - 86000代表满足告警触发条件后每一天告警一次。 

        :return: The suppress_duration of this UpdatePolicyResp.
        :rtype: int
        """
    ...
    def suppress_duration(self, suppress_duration):
        r"""Sets the suppress_duration of this UpdatePolicyResp.

        **参数解释**： 告警抑制时间，单位为秒，对应页面上创建告警规则时告警策略最后一个字段，该字段主要为解决告警频繁的问题。 **取值范围**： 枚举值，只能为0、300、600、900、1800、3600、10800、21600、43200、86400。 - 0：在立即触发场景中，0代表不抑制；在累计触发场景，0代表只告警一次。 - 300代表满足告警触发条件后每5分钟告警一次。 - 600代表满足告警触发条件后每10分钟告警一次。 - 900代表满足告警触发条件后每15分钟告警一次。 - 1800代表满足告警触发条件后每30分钟告警一次。 - 3600代表满足告警触发条件后每60分钟告警一次。 - 10800代表满足告警触发条件后每3小时告警一次。 - 21600代表满足告警触发条件后每6小时告警一次。 - 43200代表满足告警触发条件后每12小时告警一次。 - 86000代表满足告警触发条件后每一天告警一次。 

        :param suppress_duration: The suppress_duration of this UpdatePolicyResp.
        :type suppress_duration: int
        """
    ...
    @property
    def level(self):
        r"""Gets the level of this UpdatePolicyResp.

        **参数解释**： 告警级别。    **取值范围**： 只能为1、2、3、4。1为紧急，2为重要，3为次要，4为提示。 

        :return: The level of this UpdatePolicyResp.
        :rtype: int
        """
        return self._level
    ...
    def level(self, level):
        r"""Sets the level of this UpdatePolicyResp.

        **参数解释**： 告警级别。    **取值范围**： 只能为1、2、3、4。1为紧急，2为重要，3为次要，4为提示。 

        :param level: The level of this UpdatePolicyResp.
        :type level: int
        """
        self._level = level
    ...
    @property
    def namespace(self):
        r"""Gets the namespace of this UpdatePolicyResp.
        ...
        **参数解释**： 各服务命名空间，请参考“[服务命名空间](ces_03_0059.xml)”。产品层级规则增加namespace（服务命名空间）和dimension_name（服务维度名称），用于指明策略生效的资源归属。 **取值范围**： 格式为service.item；service和item必须是字符串，必须以字母开头，只能包含0-9/a-z/A-Z/_。长度为[0,32]个字符。        。 
        ...
        :return: The namespace of this UpdatePolicyResp.
        :rtype: str
        """
    ...
    def namespace(self, namespace):
        r"""Sets the namespace of this UpdatePolicyResp.

        **参数解释**： 各服务命名空间，请参考“[服务命名空间](ces_03_0059.xml)”。产品层级规则增加namespace（服务命名空间）和dimension_name（服务维度名称），用于指明策略生效的资源归属。 **取值范围**： 格式为service.item；service和item必须是字符串，必须以字母开头，只能包含0-9/a-z/A-Z/_。长度为[0,32]个字符。        。 

        :param namespace: The namespace of this UpdatePolicyResp.
        :type namespace: str
        """
    ...
    def dimension_name(self, dimension_name):
        r"""Sets the dimension_name of this UpdatePolicyResp.

        **参数解释**： 指标维度名称，各服务资源的指标维度名称可查看：“[服务维度名称](ces_03_0059.xml)”。 **取值范围**： 目前最大支持4个维度。举例：单维度场景：instance_id；多维度场景：instance_id,disk 

        :param dimension_name: The dimension_name of this UpdatePolicyResp.
        :type dimension_name: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdatePolicyResp):
            return False
