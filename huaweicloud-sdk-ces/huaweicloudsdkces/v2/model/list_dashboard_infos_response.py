...
class ListDashboardInfosResponse(SdkResponse):
    ...
    def __init__(self, dashboards=None):
        r"""ListDashboardInfosResponse

        The model defined in huaweicloud sdk

        :param dashboards: **参数描述**： 监控看板列表 
    ...
    @property
    def dashboards(self):
        r"""Gets the dashboards of this ListDashboardInfosResponse.
    ...
    def dashboards(self, dashboards):
        r"""Sets the dashboards of this ListDashboardInfosResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListDashboardInfosResponse.to_dict() is deprecated and no longer maintained, "
