...
class BatchDeleteOneClickAlarmsRequest:
    ...
    openapi_types = {
        'body': 'BatchDeleteOneClickAlarmsRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchDeleteOneClickAlarmsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteOneClickAlarmsRequest):
            return False
