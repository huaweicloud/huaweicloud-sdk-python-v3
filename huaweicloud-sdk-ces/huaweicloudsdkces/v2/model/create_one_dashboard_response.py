...
class CreateOneDashboardResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateOneDashboardResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateOneDashboardResponse):
            return False
