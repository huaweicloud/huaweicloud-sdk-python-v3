...
class ListAlarmsResponse(SdkResponse):
    ...
    openapi_types = {
        'alarms': 'list[ListAlarmResponseBodyAlarms]',
        'count': 'int'
    }
    ...
    @property
    def alarms(self):
        """Gets the alarms of this ListAlarmsResponse.

        告警详情

        :return: The alarms of this ListAlarmsResponse.
        :rtype: list[ListAlarmResponseBodyAlarms]
        """
        return self._alarms

    @alarms.setter
    def alarms(self, alarms):
        """Sets the alarms of this ListAlarmsResponse.

        告警详情

        :param alarms: The alarms of this ListAlarmsResponse.
        :type: list[ListAlarmResponseBodyAlarms]
        """
        self._alarms = alarms
