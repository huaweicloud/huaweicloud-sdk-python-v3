...
class ResourceDimension:
    ...
    def __init__(self, name=None, value=None):
        ...
        :param name: 资源维度，如：弹性云服务器，则维度为instance_id；目前最大支持4个维度，各服务资源的指标维度名称可查看：“[服务指标维度](ces_03_0059.xml)”。
        :type name: str
    ...
    @property
    def value(self):
        r"""Gets the value of this ResourceDimension.

        资源维度值，为资源的实例ID，如：4270ff17-aba3-4138-89fa-820594c39755。

        :return: The value of this ResourceDimension.
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        r"""Sets the value of this ResourceDimension.

        资源维度值，为资源的实例ID，如：4270ff17-aba3-4138-89fa-820594c39755。

        :param value: The value of this ResourceDimension.
        :type value: str
        """
        self._value = value
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResourceDimension):
            return False
