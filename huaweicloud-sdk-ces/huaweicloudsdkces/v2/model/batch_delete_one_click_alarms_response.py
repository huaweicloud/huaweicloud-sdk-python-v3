...
class BatchDeleteOneClickAlarmsResponse(SdkResponse):
    ...
    def __init__(self, one_click_alarm_ids=None):
        ...
        super(BatchDeleteOneClickAlarmsResponse, self).__init__()

        self._one_click_alarm_ids = None
        self.discriminator = None

        if one_click_alarm_ids is not None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteOneClickAlarmsResponse):
            return False
