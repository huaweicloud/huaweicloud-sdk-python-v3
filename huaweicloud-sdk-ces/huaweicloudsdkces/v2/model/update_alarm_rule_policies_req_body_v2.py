...
class UpdateAlarmRulePoliciesReqBodyV2:
    ...
    def __init__(self, policies=None):
        r"""UpdateAlarmRulePoliciesReqBodyV2
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateAlarmRulePoliciesReqBodyV2):
            return False
