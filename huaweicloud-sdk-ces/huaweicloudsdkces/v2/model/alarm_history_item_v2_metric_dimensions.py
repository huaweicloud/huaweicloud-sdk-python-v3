...
class AlarmHistoryItemV2MetricDimensions:
    ...
    def __init__(self, name=None, value=None):
        r"""AlarmHistoryItemV2MetricDimensions
    ...
    @property
    def value(self):
        r"""Gets the value of this AlarmHistoryItemV2MetricDimensions.

        **参数解释**： 资源维度值，为资源的实例ID，如：4270ff17-aba3-4138-89fa-820594c39755。 **取值范围**： 字符串长度在 1 到 256 之间。 

        :return: The value of this AlarmHistoryItemV2MetricDimensions.
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        r"""Sets the value of this AlarmHistoryItemV2MetricDimensions.

        **参数解释**： 资源维度值，为资源的实例ID，如：4270ff17-aba3-4138-89fa-820594c39755。 **取值范围**： 字符串长度在 1 到 256 之间。 

        :param value: The value of this AlarmHistoryItemV2MetricDimensions.
        :type value: str
        """
        self._value = value
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AlarmHistoryItemV2MetricDimensions):
            return False
