...
class BatchUpdateWidgetsResponse(SdkResponse):
    ...
    openapi_types = {
        'widgets': 'list[BatchUpdateWidgetInfo]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchUpdateWidgetsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchUpdateWidgetsResponse):
            return False
