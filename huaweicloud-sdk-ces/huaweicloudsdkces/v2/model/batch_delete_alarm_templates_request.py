...
class BatchDeleteAlarmTemplatesRequest:
    ...
    openapi_types = {
        'body': 'BatchDeleteAlarmTemplatesRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchDeleteAlarmTemplatesRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteAlarmTemplatesRequest):
            return False
