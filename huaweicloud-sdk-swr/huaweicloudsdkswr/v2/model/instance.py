...
class Instance:
    ...
    @property
    def spec(self):
        r"""Gets the spec of this Instance.

        实例规格

        :return: The spec of this Instance.
        :rtype: str
        """
        return self._spec
    ...
    @spec.setter
    def spec(self, spec):
        r"""Sets the spec of this Instance.

        实例规格

        :param spec: The spec of this Instance.
        :type spec: str
        """
        self._spec = spec
    ...
    @property
    def version(self):
        r"""Gets the version of this Instance.
    ...
    def version(self, version):
        r"""Sets the version of this Instance.
    ...
    def charge_mode(self):
        r"""Gets the charge_mode of this Instance.

        实例计费模式

        :return: The charge_mode of this Instance.
        :rtype: str
        """
    ...
    def charge_mode(self, charge_mode):
        r"""Sets the charge_mode of this Instance.

        实例计费模式

        :param charge_mode: The charge_mode of this Instance.
        :type charge_mode: str
        """
    ...
    def access_address(self):
        r"""Gets the access_address of this Instance.

        访问地址

        :return: The access_address of this Instance.
        :rtype: str
        """
    ...
    def access_address(self, access_address):
        r"""Sets the access_address of this Instance.

        访问地址

        :param access_address: The access_address of this Instance.
        :type access_address: str
        """
    ...
    @property
    def expires_at(self):
        r"""Gets the expires_at of this Instance.

        实例过期时间

        :return: The expires_at of this Instance.
        :rtype: str
        """
    ...
    def expires_at(self, expires_at):
        r"""Sets the expires_at of this Instance.

        实例过期时间

        :param expires_at: The expires_at of this Instance.
        :type expires_at: str
        """
    ...
    def obs_bucket_name(self):
        r"""Gets the obs_bucket_name of this Instance.

        obs桶名称

        :return: The obs_bucket_name of this Instance.
        :rtype: str
        """
    ...
    def obs_bucket_name(self, obs_bucket_name):
        r"""Sets the obs_bucket_name of this Instance.

        obs桶名称

        :param obs_bucket_name: The obs_bucket_name of this Instance.
        :type obs_bucket_name: str
        """
    ...
    def enterprise_project_id(self):
        r"""Gets the enterprise_project_id of this Instance.

        企业项目ID

        :return: The enterprise_project_id of this Instance.
        :rtype: str
        """
    ...
    def enterprise_project_id(self, enterprise_project_id):
        r"""Sets the enterprise_project_id of this Instance.

        企业项目ID

        :param enterprise_project_id: The enterprise_project_id of this Instance.
        :type enterprise_project_id: str
        """
    ...
    def user_def_obs(self):
        r"""Gets the user_def_obs of this Instance.

        是否为用户指定obs桶

        :return: The user_def_obs of this Instance.
        :rtype: bool
        """
    ...
    def user_def_obs(self, user_def_obs):
        r"""Sets the user_def_obs of this Instance.

        是否为用户指定obs桶

        :param user_def_obs: The user_def_obs of this Instance.
        :type user_def_obs: bool
        """
    ...
    @property
    def product_id(self):
        r"""Gets the product_id of this Instance.

        产品ID

        :return: The product_id of this Instance.
        :rtype: str
        """
    ...
    def product_id(self, product_id):
        r"""Sets the product_id of this Instance.

        产品ID

        :param product_id: The product_id of this Instance.
        :type product_id: str
        """
    ...
    @property
    def order_id(self):
        r"""Gets the order_id of this Instance.

        订单ID，包周期预留字段

        :return: The order_id of this Instance.
        :rtype: str
        """
    ...
    def order_id(self, order_id):
        r"""Sets the order_id of this Instance.

        订单ID，包周期预留字段

        :param order_id: The order_id of this Instance.
        :type order_id: str
        """
    ...
    @property
    def vpc_name(self):
        r"""Gets the vpc_name of this Instance.

        VPC的名称

        :return: The vpc_name of this Instance.
        :rtype: str
        """
    ...
    def vpc_name(self, vpc_name):
        r"""Sets the vpc_name of this Instance.

        VPC的名称

        :param vpc_name: The vpc_name of this Instance.
        :type vpc_name: str
        """
    ...
    @property
    def vpc_cidr(self):
        r"""Gets the vpc_cidr of this Instance.

        VPC的可用子网的范围

        :return: The vpc_cidr of this Instance.
        :rtype: str
        """
    ...
    def vpc_cidr(self, vpc_cidr):
        r"""Sets the vpc_cidr of this Instance.

        VPC的可用子网的范围

        :param vpc_cidr: The vpc_cidr of this Instance.
        :type vpc_cidr: str
        """
    ...
    def subnet_name(self):
        r"""Gets the subnet_name of this Instance.

        VPC的子网名称

        :return: The subnet_name of this Instance.
        :rtype: str
        """
    ...
    def subnet_name(self, subnet_name):
        r"""Sets the subnet_name of this Instance.

        VPC的子网名称

        :param subnet_name: The subnet_name of this Instance.
        :type subnet_name: str
        """
    ...
    def subnet_cidr(self):
        r"""Gets the subnet_cidr of this Instance.

        子网的网段

        :return: The subnet_cidr of this Instance.
        :rtype: str
        """
    ...
    def subnet_cidr(self, subnet_cidr):
        r"""Sets the subnet_cidr of this Instance.

        子网的网段

        :param subnet_cidr: The subnet_cidr of this Instance.
        :type subnet_cidr: str
        """
    ...
    def vpcep_service_id(self):
        r"""Gets the vpcep_service_id of this Instance.

        实例对应的VPC终端节点服务ID

        :return: The vpcep_service_id of this Instance.
        :rtype: str
        """
    ...
    def vpcep_service_id(self, vpcep_service_id):
        r"""Sets the vpcep_service_id of this Instance.

        实例对应的VPC终端节点服务ID

        :param vpcep_service_id: The vpcep_service_id of this Instance.
        :type vpcep_service_id: str
        """
