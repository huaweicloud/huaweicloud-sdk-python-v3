...
class CreateRepoDomainsRequest:
    ...
    openapi_types = {
        'namespace': 'str',
        'repository': 'str',
        'body': 'CreateRepoDomainsRequestBody'
    }
    ...
    def __init__(self, namespace=None, repository=None, body=None):
        """CreateRepoDomainsRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: CreateRepoDomainsRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateRepoDomainsRequest):
            return False
