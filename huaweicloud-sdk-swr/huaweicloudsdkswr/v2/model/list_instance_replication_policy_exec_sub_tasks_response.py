...
class ListInstanceReplicationPolicyExecSubTasksResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListInstanceReplicationPolicyExecSubTasksResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListInstanceReplicationPolicyExecSubTasksResponse):
            return False
