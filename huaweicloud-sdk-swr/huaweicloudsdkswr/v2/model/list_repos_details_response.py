...
class ListReposDetailsResponse(SdkResponse):
    ...
    @property
    def body(self):
        r"""Gets the body of this ListReposDetailsResponse.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this ListReposDetailsResponse.
    ...
    def content_range(self):
        r"""Gets the content_range of this ListReposDetailsResponse.
    ...
    def content_range(self, content_range):
        r"""Sets the content_range of this ListReposDetailsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListReposDetailsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListReposDetailsResponse):
            return False
