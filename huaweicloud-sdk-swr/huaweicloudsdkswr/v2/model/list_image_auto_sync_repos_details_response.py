...
class ListImageAutoSyncReposDetailsResponse(SdkResponse):
    ...
    def __init__(self, body=None):
        r"""ListImageAutoSyncReposDetailsResponse
    ...
    @property
    def body(self):
        r"""Gets the body of this ListImageAutoSyncReposDetailsResponse.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this ListImageAutoSyncReposDetailsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListImageAutoSyncReposDetailsResponse.to_dict() is deprecated and no longer maintained, "
