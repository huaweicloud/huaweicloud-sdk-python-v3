...
class ShowSubResourceInstancesCountResponse(SdkResponse):
    ...
    def __init__(self, total_count=None):
        r"""ShowSubResourceInstancesCountResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowSubResourceInstancesCountResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowSubResourceInstancesCountResponse):
            return False
