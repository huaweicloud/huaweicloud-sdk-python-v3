...
class ListQuotasResponse(SdkResponse):
    ...
    def __init__(self, quotas=None):
        ...
        :param quotas: 配额列表
        :type quotas: list[:class:`huaweicloudsdkswr.v2.ShowQuota`]
        """
    ...
    def quotas(self):
        ...
        :rtype: list[:class:`huaweicloudsdkswr.v2.ShowQuota`]
        """
        return self._quotas
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListQuotasResponse.to_dict() is deprecated and no longer maintained, "
