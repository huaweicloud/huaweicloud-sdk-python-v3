...
class AddDomainNameResponse(SdkResponse):
    ...
    def domain_name_info(self):
        r"""Gets the domain_name_info of this AddDomainNameResponse.

        :return: The domain_name_info of this AddDomainNameResponse.
    ...
    def domain_name_info(self, domain_name_info):
        r"""Sets the domain_name_info of this AddDomainNameResponse.

        :param domain_name_info: The domain_name_info of this AddDomainNameResponse.
        :type domain_name_info: :class:`huaweicloudsdkswr.v2.DomainNameInfo`
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("AddDomainNameResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddDomainNameResponse):
            return False
