...
class CreateInstanceRequestBody:
    ...
    attribute_map = {
        ...
        'enable_intranet_access': 'enable_intranet_access',
        'obs_enc_kms_key_id': 'obs_enc_kms_key_id'
    }

    def __init__(self, name=None, description=None, spec=None, vpc_id=None, subnet_id=None, project_id=None, charge_mode=None, enterprise_project_id=None, resource_tags=None, obs_encrypt=None, encrypt_type=None, obs_bucket_name=None, enable_intranet_access=None, obs_enc_kms_key_id=None):
        r"""CreateInstanceRequestBody

        The model defined in huaweicloud sdk

        :param name: 企业仓库实例名称，长度范围为3-48个字符，以小写字母开头，支持小写字母、数字和中划线(-)，不能以中划线(-)结尾，中划线不能连续。
        :type name: str
        ...
        :param enable_intranet_access: 是否创建内网访问，不传此值，默认会创建内网访问。
        :type enable_intranet_access: bool
        ...
        self._enable_intranet_access = None
        ...
        if enable_intranet_access is not None:
            self.enable_intranet_access = enable_intranet_access
    ...
    @property
    def enable_intranet_access(self):
        r"""Gets the enable_intranet_access of this CreateInstanceRequestBody.

        是否创建内网访问，不传此值，默认会创建内网访问。

        :return: The enable_intranet_access of this CreateInstanceRequestBody.
        :rtype: bool
        """
        return self._enable_intranet_access

    @enable_intranet_access.setter
    def enable_intranet_access(self, enable_intranet_access):
        r"""Sets the enable_intranet_access of this CreateInstanceRequestBody.

        是否创建内网访问，不传此值，默认会创建内网访问。

        :param enable_intranet_access: The enable_intranet_access of this CreateInstanceRequestBody.
        :type enable_intranet_access: bool
        """
        self._enable_intranet_access = enable_intranet_access
