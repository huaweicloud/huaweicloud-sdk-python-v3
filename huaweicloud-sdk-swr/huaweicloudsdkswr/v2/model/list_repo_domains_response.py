...
class ListRepoDomainsResponse(SdkResponse):
    ...
    openapi_types = {
        'body': 'list[ShowRepoDomainsResponse]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListRepoDomainsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRepoDomainsResponse):
            return False
