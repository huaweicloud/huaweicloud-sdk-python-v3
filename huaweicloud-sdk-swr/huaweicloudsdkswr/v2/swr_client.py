...
class SwrClient(Client):
    ...
    def list_sync_regions(self, request):
        r"""获取可进行镜像同步的区域列表
    ...
    def list_sync_regions_invoker(self, request):
        http_info = self._list_sync_regions_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_sync_regions_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_instance_artifact_vulnerabilities(self, request):
        r"""获取制品扫描的漏洞信息
    ...
    def list_instance_artifact_vulnerabilities_invoker(self, request):
        http_info = self._list_instance_artifact_vulnerabilities_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_instance_artifact_vulnerabilities_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def start_manual_scanning(self, request):
        r"""手动启动制品扫描
    ...
    def start_manual_scanning_invoker(self, request):
        http_info = self._start_manual_scanning_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _start_manual_scanning_http_info(cls, request):
        http_info = {
            "method": "POST",
