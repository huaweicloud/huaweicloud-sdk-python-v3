...
class RunImageBatchModerationRequest(object):
    ...
    @property
    def body(self):
        """Gets the body of this RunImageBatchModerationRequest.
    ...
    @body.setter
    def body(self, body):
        """Sets the body of this RunImageBatchModerationRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunImageBatchModerationRequest):
            return False
