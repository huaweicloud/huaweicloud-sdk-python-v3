...
class VideoModerationImageDetailListQrLocation:
    ...
    def __init__(self, top_left_x=None, top_left_y=None, bottom_right_x=None, bottom_right_y=None):
        ...
        :param top_left_x: 检测出的二维码左上角横坐标。
        :type top_left_x: int
        :param top_left_y: 检测出的二维码左上角纵坐标。
        :type top_left_y: int
        :param bottom_right_x: 检测出的二维码右下角横坐标。
        :type bottom_right_x: int
        :param bottom_right_y: 检测出的二维码右下角纵坐标。
    ...
    def top_left_x(self):
        ...
        :return: The top_left_x of this VideoModerationImageDetailListQrLocation.
        :rtype: int
        """
    ...
    def top_left_x(self, top_left_x):
        ...
        :param top_left_x: The top_left_x of this VideoModerationImageDetailListQrLocation.
        :type top_left_x: int
        """
    ...
    def top_left_y(self):
        ...
        :return: The top_left_y of this VideoModerationImageDetailListQrLocation.
        :rtype: int
        """
    ...
    def top_left_y(self, top_left_y):
        ...
        :param top_left_y: The top_left_y of this VideoModerationImageDetailListQrLocation.
        :type top_left_y: int
        """
    ...
    def bottom_right_x(self):
        ...
        :return: The bottom_right_x of this VideoModerationImageDetailListQrLocation.
        :rtype: int
        """
    ...
    def bottom_right_x(self, bottom_right_x):
        ...
        :param bottom_right_x: The bottom_right_x of this VideoModerationImageDetailListQrLocation.
        :type bottom_right_x: int
        """
    ...
    def bottom_right_y(self):
        ...
        :return: The bottom_right_y of this VideoModerationImageDetailListQrLocation.
        :rtype: int
        """
    ...
    def bottom_right_y(self, bottom_right_y):
        ...
        :param bottom_right_y: The bottom_right_y of this VideoModerationImageDetailListQrLocation.
        :type bottom_right_y: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VideoModerationImageDetailListQrLocation):
            return False
