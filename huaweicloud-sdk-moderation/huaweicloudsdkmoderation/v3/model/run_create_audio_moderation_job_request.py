...
class RunCreateAudioModerationJobRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the RunCreateAudioModerationJobRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunCreateAudioModerationJobRequest):
            return False
