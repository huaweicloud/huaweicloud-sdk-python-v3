...
class RunCreateVideoModerationJobResponse(SdkResponse):
    ...
    def __init__(self, request_id=None, job_id=None):
        r"""RunCreateVideoModerationJobResponse
    ...
    @property
    def request_id(self):
        r"""Gets the request_id of this RunCreateVideoModerationJobResponse.
    ...
    def request_id(self, request_id):
        r"""Sets the request_id of this RunCreateVideoModerationJobResponse.
    ...
    @property
    def job_id(self):
        r"""Gets the job_id of this RunCreateVideoModerationJobResponse.
    ...
    def job_id(self, job_id):
        r"""Sets the job_id of this RunCreateVideoModerationJobResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("RunCreateVideoModerationJobResponse.to_dict() is deprecated and no longer maintained, "
