...
class RunCreateVideoModerationJobRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the RunCreateVideoModerationJobRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunCreateVideoModerationJobRequest):
            return False
