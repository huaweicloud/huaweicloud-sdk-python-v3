...
class CheckTaskJobsItemsBody:
    ...
    @property
    def job_id(self):
        """Gets the job_id of this CheckTaskJobsItemsBody.

        任务标识。

        :return: The job_id of this CheckTaskJobsItemsBody.
        :rtype: str
        """
        return self._job_id
    ...
    def job_id(self, job_id):
        """Sets the job_id of this CheckTaskJobsItemsBody.
    ...
    @property
    def status(self):
        """Gets the status of this CheckTaskJobsItemsBody.

        任务状态如下：  - created 已创建  - running 正在处理  - finish 已完成  - failed 处理失败 

        :return: The status of this CheckTaskJobsItemsBody.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this CheckTaskJobsItemsBody.
    ...
    def create_time(self):
        """Gets the create_time of this CheckTaskJobsItemsBody.

        任务创建的时间。例如：2018-01-02T15:03:04Z

        :return: The create_time of this CheckTaskJobsItemsBody.
        :rtype: str
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this CheckTaskJobsItemsBody.
    ...
    def update_time(self):
        """Gets the update_time of this CheckTaskJobsItemsBody.

        任务最近更新的时间。例如：2018-01-02T15:03:04Z

        :return: The update_time of this CheckTaskJobsItemsBody.
        :rtype: str
        """
    ...
    def update_time(self, update_time):
        """Sets the update_time of this CheckTaskJobsItemsBody.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CheckTaskJobsItemsBody):
            return False
