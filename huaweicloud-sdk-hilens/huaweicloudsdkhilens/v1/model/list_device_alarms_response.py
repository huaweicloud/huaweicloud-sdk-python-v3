...
class ListDeviceAlarmsResponse(SdkResponse):
    ...
    def total(self):
        ...
        :return: The total of this ListDeviceAlarmsResponse.
        :rtype: int
        """
        return self._total
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListDeviceAlarmsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListDeviceAlarmsResponse):
            return False
