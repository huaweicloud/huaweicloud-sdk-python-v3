...
class TagObject:
    ...
    @property
    def key(self):
        r"""Gets the key of this TagObject.

        标签键，最大长度36个字符。不能为空，只能包含大小写字母，数字，中划线“-”，下划线“_”

        :return: The key of this TagObject.
        :rtype: str
        """
        return self._key
    ...
    @key.setter
    def key(self, key):
        r"""Sets the key of this TagObject.

        标签键，最大长度36个字符。不能为空，只能包含大小写字母，数字，中划线“-”，下划线“_”

        :param key: The key of this TagObject.
        :type key: str
        """
        self._key = key
    ...
    def value(self, value):
        r"""Sets the value of this TagObject.

        标签值，每个值最大长度43个字符，删除时如果value有值按照key/value删除，如果value没值，则按照key删除。不能为空，只能包含大小写字母，数字，中划线“-”，下划线“_”

        :param value: The value of this TagObject.
        :type value: str
        """
        self._value = value
