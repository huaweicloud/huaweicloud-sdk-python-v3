...
class ShowDeploymentResponse(SdkResponse):
    ...
    @property
    def reason(self):
        r"""Gets the reason of this ShowDeploymentResponse.

        部署成功失败的理由

        :return: The reason of this ShowDeploymentResponse.
        :rtype: str
        """
        return self._reason
    ...
    def reason(self, reason):
        r"""Sets the reason of this ShowDeploymentResponse.

        部署成功失败的理由

        :param reason: The reason of this ShowDeploymentResponse.
        :type reason: str
        """
        self._reason = reason
    ...
    @property
    def cluster_id(self):
        r"""Gets the cluster_id of this ShowDeploymentResponse.

        应用部署的集群ID，与node_id二选一

        :return: The cluster_id of this ShowDeploymentResponse.
        :rtype: str
        """
    ...
    def cluster_id(self, cluster_id):
        r"""Sets the cluster_id of this ShowDeploymentResponse.

        应用部署的集群ID，与node_id二选一

        :param cluster_id: The cluster_id of this ShowDeploymentResponse.
        :type cluster_id: str
        """
    ...
    @property
    def node_num(self):
        r"""Gets the node_num of this ShowDeploymentResponse.

        部署的节点数，最小为1，集群部署也为1

        :return: The node_num of this ShowDeploymentResponse.
        :rtype: int
        """
    ...
    def node_num(self, node_num):
        r"""Sets the node_num of this ShowDeploymentResponse.

        部署的节点数，最小为1，集群部署也为1

        :param node_num: The node_num of this ShowDeploymentResponse.
        :type node_num: int
        """
    ...
    @property
    def result(self):
        r"""Gets the result of this ShowDeploymentResponse.

        每个节点的部署结果

        :return: The result of this ShowDeploymentResponse.
    ...
    def result(self, result):
        r"""Sets the result of this ShowDeploymentResponse.

        每个节点的部署结果

        :param result: The result of this ShowDeploymentResponse.
        :type result: list[:class:`huaweicloudsdkhilens.v3.NodeResult`]
        """
        self._result = result
