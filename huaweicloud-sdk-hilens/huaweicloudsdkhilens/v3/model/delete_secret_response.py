...
class DeleteSecretResponse(SdkResponse):
    ...
    @property
    def secret(self):
        r"""Gets the secret of this DeleteSecretResponse.
    ...
    def secret(self, secret):
        r"""Sets the secret of this DeleteSecretResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteSecretResponse.to_dict() is deprecated and no longer maintained, "
