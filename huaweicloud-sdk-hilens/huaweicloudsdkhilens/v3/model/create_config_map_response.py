...
class CreateConfigMapResponse(SdkResponse):
    ...
    def workspace_id(self):
        r"""Gets the workspace_id of this CreateConfigMapResponse.

        工作空间ID，默认为注册账号/子账号的default工作空间，可通过专业版HiLens控制台展开工作空间列表获取到工作空间ID

        :return: The workspace_id of this CreateConfigMapResponse.
        :rtype: str
        """
    ...
    def workspace_id(self, workspace_id):
        r"""Sets the workspace_id of this CreateConfigMapResponse.

        工作空间ID，默认为注册账号/子账号的default工作空间，可通过专业版HiLens控制台展开工作空间列表获取到工作空间ID

        :param workspace_id: The workspace_id of this CreateConfigMapResponse.
        :type workspace_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateConfigMapResponse.to_dict() is deprecated and no longer maintained, "
