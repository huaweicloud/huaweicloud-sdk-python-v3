...
class BatchCreateNodeTagsRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchCreateNodeTagsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchCreateNodeTagsRequest):
            return False
