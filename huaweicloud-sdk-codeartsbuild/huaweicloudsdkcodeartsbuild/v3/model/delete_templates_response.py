...
class DeleteTemplatesResponse(SdkResponse):
    ...
    def result(self):
        ...
        :return: The result of this DeleteTemplatesResponse.
    ...
    def result(self, result):
        ...
        :param result: The result of this DeleteTemplatesResponse.
        :type result: list[:class:`huaweicloudsdkcodeartsbuild.v3.CreateTemplatesItems`]
        """
        self._result = result
    ...
    def error(self):
        ...
        :return: The error of this DeleteTemplatesResponse.
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        ...
        :param error: The error of this DeleteTemplatesResponse.
        :type error: str
        """
        self._error = error
    ...
    def status(self):
        ...
        :return: The status of this DeleteTemplatesResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this DeleteTemplatesResponse.
        :type status: str
        """
        self._status = status
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteTemplatesResponse.to_dict() is deprecated and no longer maintained, "
