...
class UpdateNoticeRequest:
    ...
    def __init__(self, job_id=None, body=None):
        ...
        :type job_id: str
        :param body: Body of the UpdateNoticeRequest
    ...
    def job_id(self):
        ...
        :return: The job_id of this UpdateNoticeRequest.
        :rtype: str
        """
        return self._job_id
    ...
    def job_id(self, job_id):
        ...
        :param job_id: The job_id of this UpdateNoticeRequest.
        :type job_id: str
        """
        self._job_id = job_id
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateNoticeRequest):
            return False
