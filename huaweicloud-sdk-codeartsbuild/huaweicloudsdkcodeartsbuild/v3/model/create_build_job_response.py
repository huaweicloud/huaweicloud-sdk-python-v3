...
class CreateBuildJobResponse(SdkResponse):
    ...
    def status(self):
        ...
        :return: The status of this CreateBuildJobResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this CreateBuildJobResponse.
        :type status: str
        """
        self._status = status
    ...
    def error(self):
        ...
        :return: The error of this CreateBuildJobResponse.
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        ...
        :param error: The error of this CreateBuildJobResponse.
        :type error: str
        """
        self._error = error
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateBuildJobResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateBuildJobResponse):
            return False
