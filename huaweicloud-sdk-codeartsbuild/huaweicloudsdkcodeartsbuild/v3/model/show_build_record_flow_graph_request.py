...
class ShowBuildRecordFlowGraphRequest:
    ...
    def __init__(self, build_flow_record_id=None):
        r"""ShowBuildRecordFlowGraphRequest
    ...
    def build_flow_record_id(self):
        r"""Gets the build_flow_record_id of this ShowBuildRecordFlowGraphRequest.

        父任务构建记录ID

        :return: The build_flow_record_id of this ShowBuildRecordFlowGraphRequest.
        :rtype: str
        """
    ...
    def build_flow_record_id(self, build_flow_record_id):
        r"""Sets the build_flow_record_id of this ShowBuildRecordFlowGraphRequest.

        父任务构建记录ID

        :param build_flow_record_id: The build_flow_record_id of this ShowBuildRecordFlowGraphRequest.
        :type build_flow_record_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowBuildRecordFlowGraphRequest):
            return False
