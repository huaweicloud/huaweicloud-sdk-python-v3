...
class ShowRecordDetailResponse(SdkResponse):
    ...
    def __init__(self, status=None, error=None, result=None):
        ...
        super(ShowRecordDetailResponse, self).__init__()
    ...
    def status(self):
        ...
        :return: The status of this ShowRecordDetailResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this ShowRecordDetailResponse.
        :type status: str
        """
        self._status = status
    ...
    def error(self):
        ...
        :return: The error of this ShowRecordDetailResponse.
        :rtype: object
        """
        return self._error
    ...
    def error(self, error):
        ...
        :param error: The error of this ShowRecordDetailResponse.
        :type error: object
        """
        self._error = error
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowRecordDetailResponse):
            return False
