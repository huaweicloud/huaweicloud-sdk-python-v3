...
class ListJobConfigResponse(SdkResponse):
    ...
    def error(self):
        ...
        :return: The error of this ListJobConfigResponse.
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        ...
        :param error: The error of this ListJobConfigResponse.
        :type error: str
        """
        self._error = error
    ...
    def status(self):
        ...
        :return: The status of this ListJobConfigResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this ListJobConfigResponse.
        :type status: str
        """
        self._status = status
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListJobConfigResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListJobConfigResponse):
            return False
