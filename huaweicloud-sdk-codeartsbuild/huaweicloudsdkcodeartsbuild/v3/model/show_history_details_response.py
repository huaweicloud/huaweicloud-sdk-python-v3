...
class ShowHistoryDetailsResponse(SdkResponse):
    ...
    def __init__(self, job_name=None, build_number=None, project_id=None, project_name=None, parameters=None, build_steps=None):
        ...
        :type build_steps: list[:class:`huaweicloudsdkcodeartsbuild.v3.BuildStep`]
        """
    ...
    def build_steps(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsbuild.v3.BuildStep`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowHistoryDetailsResponse.to_dict() is deprecated and no longer maintained, "
