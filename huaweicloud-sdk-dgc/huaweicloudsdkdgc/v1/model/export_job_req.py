...
class ExportJobReq:
    ...
    def __init__(self, export_depend=None, obs_path=None, export_status=None):
        r"""ExportJobReq
    ...
    def export_depend(self):
        r"""Gets the export_depend of this ExportJobReq.

        是否导出作业依赖的脚本和资源，取值为true或者false，不传该值时，默认为true。

        :return: The export_depend of this ExportJobReq.
        :rtype: bool
        """
    ...
    def export_depend(self, export_depend):
        r"""Sets the export_depend of this ExportJobReq.

        是否导出作业依赖的脚本和资源，取值为true或者false，不传该值时，默认为true。

        :param export_depend: The export_depend of this ExportJobReq.
        :type export_depend: bool
        """
    ...
    @property
    def obs_path(self):
        r"""Gets the obs_path of this ExportJobReq.

        当导出到obs时，需要指定obs路径，样例：obs://test_bucket/job_nodes/

        :return: The obs_path of this ExportJobReq.
        :rtype: str
        """
    ...
    def obs_path(self, obs_path):
        r"""Sets the obs_path of this ExportJobReq.

        当导出到obs时，需要指定obs路径，样例：obs://test_bucket/job_nodes/

        :param obs_path: The obs_path of this ExportJobReq.
        :type obs_path: str
        """
    ...
    def export_status(self):
        r"""Gets the export_status of this ExportJobReq.

        导出作业的状态，取值如下： - DEVELOP: 开发态，默认是开发态 - SUBMIT: 提交态

        :return: The export_status of this ExportJobReq.
        :rtype: str
        """
    ...
    def export_status(self, export_status):
        r"""Sets the export_status of this ExportJobReq.

        导出作业的状态，取值如下： - DEVELOP: 开发态，默认是开发态 - SUBMIT: 提交态

        :param export_status: The export_status of this ExportJobReq.
        :type export_status: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExportJobReq):
            return False
