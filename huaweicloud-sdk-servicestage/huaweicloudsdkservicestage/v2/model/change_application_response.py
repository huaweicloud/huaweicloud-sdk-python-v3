...
class ChangeApplicationResponse(SdkResponse):
    ...
    @property
    def id(self):
        r"""Gets the id of this ChangeApplicationResponse.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this ChangeApplicationResponse.
    ...
    @property
    def name(self):
        r"""Gets the name of this ChangeApplicationResponse.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this ChangeApplicationResponse.
    ...
    def description(self):
        r"""Gets the description of this ChangeApplicationResponse.
    ...
    def description(self, description):
        r"""Sets the description of this ChangeApplicationResponse.
    ...
    @property
    def creator(self):
        r"""Gets the creator of this ChangeApplicationResponse.
    ...
    def creator(self, creator):
        r"""Sets the creator of this ChangeApplicationResponse.
    ...
    @property
    def project_id(self):
        r"""Gets the project_id of this ChangeApplicationResponse.
    ...
    def project_id(self, project_id):
        r"""Sets the project_id of this ChangeApplicationResponse.
    ...
    def enterprise_project_id(self):
        r"""Gets the enterprise_project_id of this ChangeApplicationResponse.
    ...
    def enterprise_project_id(self, enterprise_project_id):
        r"""Sets the enterprise_project_id of this ChangeApplicationResponse.
    ...
    def create_time(self):
        r"""Gets the create_time of this ChangeApplicationResponse.
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this ChangeApplicationResponse.
    ...
    def update_time(self):
        r"""Gets the update_time of this ChangeApplicationResponse.
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this ChangeApplicationResponse.
    ...
    def unified_model(self):
        r"""Gets the unified_model of this ChangeApplicationResponse.

        是否统一模型

        :return: The unified_model of this ChangeApplicationResponse.
        :rtype: str
        """
    ...
    def unified_model(self, unified_model):
        r"""Sets the unified_model of this ChangeApplicationResponse.

        是否统一模型

        :param unified_model: The unified_model of this ChangeApplicationResponse.
        :type unified_model: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ChangeApplicationResponse.to_dict() is deprecated and no longer maintained, "
