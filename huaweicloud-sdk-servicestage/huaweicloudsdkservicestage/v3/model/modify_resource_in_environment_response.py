...
class ModifyResourceInEnvironmentResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ModifyResourceInEnvironmentResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModifyResourceInEnvironmentResponse):
            return False
