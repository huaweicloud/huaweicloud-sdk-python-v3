...
class ShowEnvironmentResourcesResponse(SdkResponse):
    ...
    def __init__(self, resources=None):
        ...
        super(ShowEnvironmentResourcesResponse, self).__init__()
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowEnvironmentResourcesResponse):
            return False
