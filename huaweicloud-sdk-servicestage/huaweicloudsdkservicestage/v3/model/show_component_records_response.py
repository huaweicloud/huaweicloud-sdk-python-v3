...
class ShowComponentRecordsResponse(SdkResponse):
    ...
    openapi_types = {
        'count': 'int',
        'records': 'list[ComponentRecordView]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowComponentRecordsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowComponentRecordsResponse):
            return False
