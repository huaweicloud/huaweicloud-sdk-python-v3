...
class ImportBackup2Response(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ImportBackup2Response.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ImportBackup2Response):
            return False
