...
class ShowGraph2Response(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowGraph2Response.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowGraph2Response):
            return False
