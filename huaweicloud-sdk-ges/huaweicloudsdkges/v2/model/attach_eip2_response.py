...
class AttachEip2Response(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("AttachEip2Response.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AttachEip2Response):
            return False
