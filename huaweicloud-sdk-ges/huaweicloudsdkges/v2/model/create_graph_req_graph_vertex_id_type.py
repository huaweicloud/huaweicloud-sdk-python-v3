...
class CreateGraphReqGraphVertexIdType:
    ...
    def __init__(self, id_type=None, id_length=None):
        ...
        :param id_type: id类型，目前支持固定长度fixedLengthString和hash。  - fixedLengthString：固定长度String格式下，实际点ID直接用于内部存储与计算，用户需指定一长度，实际点ID不可超过此长度。长度过大，可能影响查询性能，建议用户根据数据集状态进行设置。  - hash：哈希格式下，内部计算时将实际点ID转换成哈希码进行存储与计算，对实际点ID长度无限制，但是存在极低的概率(约10^(-43))出现点ID碰撞。若用户无法确定点ID的最大长度，建议选择哈希类型。
        :type id_type: str
    ...
    def id_type(self):
        ...
        :return: The id_type of this CreateGraphReqGraphVertexIdType.
        :rtype: str
        """
    ...
    def id_type(self, id_type):
        ...
        :param id_type: The id_type of this CreateGraphReqGraphVertexIdType.
        :type id_type: str
        """
    ...
    def id_length(self):
        ...
        :return: The id_length of this CreateGraphReqGraphVertexIdType.
        :rtype: int
        """
    ...
    def id_length(self, id_length):
        ...
        :param id_length: The id_length of this CreateGraphReqGraphVertexIdType.
        :type id_length: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateGraphReqGraphVertexIdType):
            return False
