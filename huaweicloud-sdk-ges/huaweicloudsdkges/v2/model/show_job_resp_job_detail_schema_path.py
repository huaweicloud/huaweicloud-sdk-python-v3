...
class ShowJobRespJobDetailSchemaPath:
    ...
    def __init__(self, path=None, log=None, status=None, cause=None, total_lines=None, failed_lines=None, successful_lines=None):
        r"""ShowJobRespJobDetailSchemaPath
    ...
    @property
    def path(self):
        r"""Gets the path of this ShowJobRespJobDetailSchemaPath.
    ...
    @path.setter
    def path(self, path):
        r"""Sets the path of this ShowJobRespJobDetailSchemaPath.
    ...
    @property
    def log(self):
        r"""Gets the log of this ShowJobRespJobDetailSchemaPath.
    ...
    @log.setter
    def log(self, log):
        r"""Sets the log of this ShowJobRespJobDetailSchemaPath.
    ...
    @property
    def status(self):
        r"""Gets the status of this ShowJobRespJobDetailSchemaPath.
    ...
    def status(self, status):
        r"""Sets the status of this ShowJobRespJobDetailSchemaPath.
    ...
    @property
    def cause(self):
        r"""Gets the cause of this ShowJobRespJobDetailSchemaPath.
    ...
    def cause(self, cause):
        r"""Sets the cause of this ShowJobRespJobDetailSchemaPath.
    ...
    def total_lines(self):
        r"""Gets the total_lines of this ShowJobRespJobDetailSchemaPath.
    ...
    def total_lines(self, total_lines):
        r"""Sets the total_lines of this ShowJobRespJobDetailSchemaPath.
    ...
    def failed_lines(self):
        r"""Gets the failed_lines of this ShowJobRespJobDetailSchemaPath.
    ...
    def failed_lines(self, failed_lines):
        r"""Sets the failed_lines of this ShowJobRespJobDetailSchemaPath.
    ...
    def successful_lines(self):
        r"""Gets the successful_lines of this ShowJobRespJobDetailSchemaPath.
    ...
    def successful_lines(self, successful_lines):
        r"""Sets the successful_lines of this ShowJobRespJobDetailSchemaPath.
