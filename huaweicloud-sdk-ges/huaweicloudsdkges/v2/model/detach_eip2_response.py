...
class DetachEip2Response(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DetachEip2Response.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DetachEip2Response):
            return False
