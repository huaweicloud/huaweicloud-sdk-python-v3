...
class VertexsetPath1:
    ...
    @property
    def job_id(self):
        """Gets the job_id of this VertexsetPath1.
    ...
    def job_id(self, job_id):
        """Sets the job_id of this VertexsetPath1.
    ...
    @property
    def path(self):
        """Gets the path of this VertexsetPath1.
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this VertexsetPath1.
    ...
    @property
    def status(self):
        """Gets the status of this VertexsetPath1.
    ...
    def status(self, status):
        """Sets the status of this VertexsetPath1.
