...
class VertexsetPath1:
    ...
    @property
    def job_id(self):
        r"""Gets the job_id of this VertexsetPath1.

        导入OBS文件对应的jobId。

        :return: The job_id of this VertexsetPath1.
        :rtype: str
        """
        return self._job_id
    ...
    def job_id(self, job_id):
        r"""Sets the job_id of this VertexsetPath1.
    ...
    @property
    def path(self):
        r"""Gets the path of this VertexsetPath1.

        OBS存储路径，不包含OBS Endpoint。

        :return: The path of this VertexsetPath1.
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        r"""Sets the path of this VertexsetPath1.
    ...
    @property
    def status(self):
        r"""Gets the status of this VertexsetPath1.

        OBS文件导入状态。  - success：完全导入成功 - partiallyFailed：部分失败 - failed：完全导入失败

        :return: The status of this VertexsetPath1.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        r"""Sets the status of this VertexsetPath1.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VertexsetPath1):
            return False
