...
class UploadFromObsRequest:
    ...
    @property
    def body(self):
        r"""Gets the body of this UploadFromObsRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this UploadFromObsRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadFromObsRequest):
            return False
