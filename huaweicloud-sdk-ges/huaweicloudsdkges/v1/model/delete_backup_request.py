...
class DeleteBackupRequest:
    ...
    def __init__(self, backup_id=None, graph_id=None):
    ...
    @property
    def graph_id(self):
        r"""Gets the graph_id of this DeleteBackupRequest.

        图ID。

        :return: The graph_id of this DeleteBackupRequest.
        :rtype: str
        """
    ...
    def graph_id(self, graph_id):
        r"""Sets the graph_id of this DeleteBackupRequest.

        图ID。

        :param graph_id: The graph_id of this DeleteBackupRequest.
        :type graph_id: str
        """
