...
class DisassociateKeypairRequestBody:
    ...
    openapi_types = {
        'server': 'DisassociateEcsServerInfo'
    }
    ...
    def __init__(self, server=None):
        """DisassociateKeypairRequestBody - a model defined in huaweicloud sdk"""
    ...
    def server(self):
        ...
        :rtype: DisassociateEcsServerInfo
        """
        return self._server
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DisassociateKeypairRequestBody):
            return False
