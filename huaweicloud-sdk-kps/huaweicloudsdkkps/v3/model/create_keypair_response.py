...
class CreateKeypairResponse(SdkResponse):
    ...
    @property
    def keypair(self):
        r"""Gets the keypair of this CreateKeypairResponse.
    ...
    def keypair(self, keypair):
        r"""Sets the keypair of this CreateKeypairResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateKeypairResponse.to_dict() is deprecated and no longer maintained, "
