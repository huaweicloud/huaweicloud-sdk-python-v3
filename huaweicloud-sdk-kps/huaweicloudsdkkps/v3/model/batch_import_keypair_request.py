...
class BatchImportKeypairRequest:
    ...
    openapi_types = {
        'body': 'list[CreateKeypairRequestBody]'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchImportKeypairRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchImportKeypairRequest):
            return False
