...
class ClearPrivateKeyResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ClearPrivateKeyResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClearPrivateKeyResponse):
            return False
