...
class ListFailedTaskResponse(SdkResponse):
    ...
    def total(self):
        ...
        :return: The total of this ListFailedTaskResponse.
        :rtype: int
        """
        return self._total
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListFailedTaskResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListFailedTaskResponse):
            return False
