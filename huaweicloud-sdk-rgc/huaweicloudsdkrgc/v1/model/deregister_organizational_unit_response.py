...
class DeregisterOrganizationalUnitResponse(SdkResponse):
    ...
    def __init__(self, organizational_unit_operation_id=None):
        r"""DeregisterOrganizationalUnitResponse
    ...
    def organizational_unit_operation_id(self):
        r"""Gets the organizational_unit_operation_id of this DeregisterOrganizationalUnitResponse.

        异步接口的操作ID。

        :return: The organizational_unit_operation_id of this DeregisterOrganizationalUnitResponse.
        :rtype: str
        """
    ...
    def organizational_unit_operation_id(self, organizational_unit_operation_id):
        r"""Sets the organizational_unit_operation_id of this DeregisterOrganizationalUnitResponse.

        异步接口的操作ID。

        :param organizational_unit_operation_id: The organizational_unit_operation_id of this DeregisterOrganizationalUnitResponse.
        :type organizational_unit_operation_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeregisterOrganizationalUnitResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeregisterOrganizationalUnitResponse):
            return False
