...
class UnEnrollAccountRequest:
    ...
    def managed_account_id(self):
        r"""Gets the managed_account_id of this UnEnrollAccountRequest.

        纳管账号ID。

        :return: The managed_account_id of this UnEnrollAccountRequest.
        :rtype: str
        """
    ...
    def managed_account_id(self, managed_account_id):
        r"""Sets the managed_account_id of this UnEnrollAccountRequest.

        纳管账号ID。

        :param managed_account_id: The managed_account_id of this UnEnrollAccountRequest.
        :type managed_account_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UnEnrollAccountRequest):
            return False
