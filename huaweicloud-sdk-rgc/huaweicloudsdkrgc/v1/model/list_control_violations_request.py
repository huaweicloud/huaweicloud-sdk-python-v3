...
class ListControlViolationsRequest:
    ...
    def __init__(self, account_id=None, organizational_unit_id=None):
        r"""ListControlViolationsRequest
    ...
    def organizational_unit_id(self):
        r"""Gets the organizational_unit_id of this ListControlViolationsRequest.

        注册OU ID。

        :return: The organizational_unit_id of this ListControlViolationsRequest.
        :rtype: str
        """
    ...
    def organizational_unit_id(self, organizational_unit_id):
        r"""Sets the organizational_unit_id of this ListControlViolationsRequest.

        注册OU ID。

        :param organizational_unit_id: The organizational_unit_id of this ListControlViolationsRequest.
        :type organizational_unit_id: str
        """
