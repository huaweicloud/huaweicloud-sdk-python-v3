...
class ListManagedAccountsResponse(SdkResponse):
    ...
    def managed_accounts(self):
        r"""Gets the managed_accounts of this ListManagedAccountsResponse.
    ...
    def managed_accounts(self, managed_accounts):
        r"""Sets the managed_accounts of this ListManagedAccountsResponse.
    ...
    @property
    def page_info(self):
        r"""Gets the page_info of this ListManagedAccountsResponse.

        :return: The page_info of this ListManagedAccountsResponse.
    ...
    def page_info(self, page_info):
        r"""Sets the page_info of this ListManagedAccountsResponse.

        :param page_info: The page_info of this ListManagedAccountsResponse.
        :type page_info: :class:`huaweicloudsdkrgc.v1.PageInfoDto`
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListManagedAccountsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListManagedAccountsResponse):
            return False
