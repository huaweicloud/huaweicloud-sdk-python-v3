...
class ManagedOrganizationUnit:
    ...
    def organization_unit_type(self):
        """Gets the organization_unit_type of this ManagedOrganizationUnit.

        :return: The organization_unit_type of this ManagedOrganizationUnit.
    ...
    def organization_unit_type(self, organization_unit_type):
        """Sets the organization_unit_type of this ManagedOrganizationUnit.

        :param organization_unit_type: The organization_unit_type of this ManagedOrganizationUnit.
        :type organization_unit_type: :class:`huaweicloudsdkrgc.v1.OrganizationalUnitType`
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ManagedOrganizationUnit):
            return False
