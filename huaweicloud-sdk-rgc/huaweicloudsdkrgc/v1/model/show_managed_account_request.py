...
class ShowManagedAccountRequest:
    ...
    def managed_account_id(self):
        ...
        :return: The managed_account_id of this ShowManagedAccountRequest.
        :rtype: str
        """
    ...
    def managed_account_id(self, managed_account_id):
        ...
        :param managed_account_id: The managed_account_id of this ShowManagedAccountRequest.
        :type managed_account_id: str
        """
    ...
    def x_security_token(self):
        """Gets the x_security_token of this ShowManagedAccountRequest.

        如果正在使用临时安全凭据，则此header是必需的，该值是临时安全凭据的安全令牌（会话令牌）。

        :return: The x_security_token of this ShowManagedAccountRequest.
        :rtype: str
        """
    ...
    def x_security_token(self, x_security_token):
        """Sets the x_security_token of this ShowManagedAccountRequest.

        如果正在使用临时安全凭据，则此header是必需的，该值是临时安全凭据的安全令牌（会话令牌）。

        :param x_security_token: The x_security_token of this ShowManagedAccountRequest.
        :type x_security_token: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowManagedAccountRequest):
            return False
