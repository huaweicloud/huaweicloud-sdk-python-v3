...
class UpdateManagedAccountRequestBody:
    ...
    def __init__(self, parent_organization_unit_id=None, parent_organization_unit_name=None, blueprint=None):
    ...
    def parent_organization_unit_id(self):
        """Gets the parent_organization_unit_id of this UpdateManagedAccountRequestBody.

        父注册OU ID。

        :return: The parent_organization_unit_id of this UpdateManagedAccountRequestBody.
        :rtype: str
        """
    ...
    def parent_organization_unit_id(self, parent_organization_unit_id):
        """Sets the parent_organization_unit_id of this UpdateManagedAccountRequestBody.

        父注册OU ID。

        :param parent_organization_unit_id: The parent_organization_unit_id of this UpdateManagedAccountRequestBody.
        :type parent_organization_unit_id: str
        """
    ...
    def parent_organization_unit_name(self):
        """Gets the parent_organization_unit_name of this UpdateManagedAccountRequestBody.

        父注册OU名称。

        :return: The parent_organization_unit_name of this UpdateManagedAccountRequestBody.
        :rtype: str
        """
    ...
    def parent_organization_unit_name(self, parent_organization_unit_name):
        """Sets the parent_organization_unit_name of this UpdateManagedAccountRequestBody.

        父注册OU名称。

        :param parent_organization_unit_name: The parent_organization_unit_name of this UpdateManagedAccountRequestBody.
        :type parent_organization_unit_name: str
        """
    ...
    @property
    def blueprint(self):
        """Gets the blueprint of this UpdateManagedAccountRequestBody.
    ...
    def blueprint(self, blueprint):
        """Sets the blueprint of this UpdateManagedAccountRequestBody.
