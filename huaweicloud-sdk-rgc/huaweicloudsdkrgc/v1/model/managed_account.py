...
class ManagedAccount:
    ...
    @property
    def account_id(self):
        r"""Gets the account_id of this ManagedAccount.
    ...
    def account_id(self, account_id):
        r"""Sets the account_id of this ManagedAccount.
    ...
    def account_name(self):
        r"""Gets the account_name of this ManagedAccount.
    ...
    def account_name(self, account_name):
        r"""Sets the account_name of this ManagedAccount.
    ...
    def account_type(self):
        r"""Gets the account_type of this ManagedAccount.
    ...
    def account_type(self, account_type):
        r"""Sets the account_type of this ManagedAccount.
    ...
    @property
    def owner(self):
        r"""Gets the owner of this ManagedAccount.
    ...
    def owner(self, owner):
        r"""Sets the owner of this ManagedAccount.
    ...
    @property
    def state(self):
        r"""Gets the state of this ManagedAccount.
    ...
    def state(self, state):
        r"""Sets the state of this ManagedAccount.
    ...
    @property
    def message(self):
        r"""Gets the message of this ManagedAccount.
    ...
    def message(self, message):
        r"""Sets the message of this ManagedAccount.
    ...
    def parent_organizational_unit_id(self):
        r"""Gets the parent_organizational_unit_id of this ManagedAccount.

        父注册OU ID。

        :return: The parent_organizational_unit_id of this ManagedAccount.
        :rtype: str
        """
    ...
    def parent_organizational_unit_id(self, parent_organizational_unit_id):
        r"""Sets the parent_organizational_unit_id of this ManagedAccount.

        父注册OU ID。

        :param parent_organizational_unit_id: The parent_organizational_unit_id of this ManagedAccount.
        :type parent_organizational_unit_id: str
        """
    ...
    def parent_organizational_unit_name(self):
        r"""Gets the parent_organizational_unit_name of this ManagedAccount.

        父注册OU名称。

        :return: The parent_organizational_unit_name of this ManagedAccount.
        :rtype: str
        """
    ...
    def parent_organizational_unit_name(self, parent_organizational_unit_name):
        r"""Sets the parent_organizational_unit_name of this ManagedAccount.

        父注册OU名称。

        :param parent_organizational_unit_name: The parent_organizational_unit_name of this ManagedAccount.
        :type parent_organizational_unit_name: str
        """
    ...
    def identity_store_user_name(self):
        r"""Gets the identity_store_user_name of this ManagedAccount.
    ...
    def identity_store_user_name(self, identity_store_user_name):
        r"""Sets the identity_store_user_name of this ManagedAccount.
    ...
    def blueprint_product_id(self):
        r"""Gets the blueprint_product_id of this ManagedAccount.
    ...
    def blueprint_product_id(self, blueprint_product_id):
        r"""Sets the blueprint_product_id of this ManagedAccount.
    ...
    def blueprint_product_version(self):
        r"""Gets the blueprint_product_version of this ManagedAccount.
    ...
    def blueprint_product_version(self, blueprint_product_version):
        r"""Sets the blueprint_product_version of this ManagedAccount.
    ...
    def blueprint_status(self):
        r"""Gets the blueprint_status of this ManagedAccount.
    ...
    def blueprint_status(self, blueprint_status):
        r"""Sets the blueprint_status of this ManagedAccount.
    ...
    def is_blueprint_has_multi_account_resource(self):
        r"""Gets the is_blueprint_has_multi_account_resource of this ManagedAccount.

        模板是否包含多账号资源。

        :return: The is_blueprint_has_multi_account_resource of this ManagedAccount.
        :rtype: bool
        """
    ...
    def is_blueprint_has_multi_account_resource(self, is_blueprint_has_multi_account_resource):
        r"""Sets the is_blueprint_has_multi_account_resource of this ManagedAccount.

        模板是否包含多账号资源。

        :param is_blueprint_has_multi_account_resource: The is_blueprint_has_multi_account_resource of this ManagedAccount.
        :type is_blueprint_has_multi_account_resource: bool
        """
    ...
    @property
    def regions(self):
        r"""Gets the regions of this ManagedAccount.
    ...
    def regions(self, regions):
        r"""Sets the regions of this ManagedAccount.
