...
class CreateManagedAccountRequest:
    ...
    def __init__(self, account_name=None, account_email=None, phone=None, identity_store_user_name=None, identity_store_email=None, parent_organization_unit_id=None, parent_organization_unit_name=None, blueprint=None):
