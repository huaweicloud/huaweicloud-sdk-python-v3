...
class CreateManagedOrganizationalUnitResponse(SdkResponse):
    ...
    def __init__(self, manage_account_id=None, organizational_unit_id=None, organizational_unit_name=None, organizational_unit_status=None, organizational_unit_type=None, parent_organizational_unit_id=None, parent_organizational_unit_name=None, created_at=None, landing_zone_version=None):
        r"""CreateManagedOrganizationalUnitResponse
    ...
    def organizational_unit_id(self):
        r"""Gets the organizational_unit_id of this CreateManagedOrganizationalUnitResponse.

        注册OU ID。

        :return: The organizational_unit_id of this CreateManagedOrganizationalUnitResponse.
        :rtype: str
        """
    ...
    def organizational_unit_id(self, organizational_unit_id):
        r"""Sets the organizational_unit_id of this CreateManagedOrganizationalUnitResponse.

        注册OU ID。

        :param organizational_unit_id: The organizational_unit_id of this CreateManagedOrganizationalUnitResponse.
        :type organizational_unit_id: str
        """
    ...
    def organizational_unit_name(self):
        r"""Gets the organizational_unit_name of this CreateManagedOrganizationalUnitResponse.

        注册OU名称。

        :return: The organizational_unit_name of this CreateManagedOrganizationalUnitResponse.
        :rtype: str
        """
    ...
    def organizational_unit_name(self, organizational_unit_name):
        r"""Sets the organizational_unit_name of this CreateManagedOrganizationalUnitResponse.

        注册OU名称。

        :param organizational_unit_name: The organizational_unit_name of this CreateManagedOrganizationalUnitResponse.
        :type organizational_unit_name: str
        """
    ...
    def organizational_unit_status(self):
        r"""Gets the organizational_unit_status of this CreateManagedOrganizationalUnitResponse.

        注册OU状态。

        :return: The organizational_unit_status of this CreateManagedOrganizationalUnitResponse.
        :rtype: str
        """
    ...
    def organizational_unit_status(self, organizational_unit_status):
        r"""Sets the organizational_unit_status of this CreateManagedOrganizationalUnitResponse.

        注册OU状态。

        :param organizational_unit_status: The organizational_unit_status of this CreateManagedOrganizationalUnitResponse.
        :type organizational_unit_status: str
        """
    ...
    def parent_organizational_unit_id(self):
        r"""Gets the parent_organizational_unit_id of this CreateManagedOrganizationalUnitResponse.

        父注册OU ID。

        :return: The parent_organizational_unit_id of this CreateManagedOrganizationalUnitResponse.
        :rtype: str
        """
    ...
    def parent_organizational_unit_id(self, parent_organizational_unit_id):
        r"""Sets the parent_organizational_unit_id of this CreateManagedOrganizationalUnitResponse.

        父注册OU ID。

        :param parent_organizational_unit_id: The parent_organizational_unit_id of this CreateManagedOrganizationalUnitResponse.
        :type parent_organizational_unit_id: str
        """
    ...
    def parent_organizational_unit_name(self):
        r"""Gets the parent_organizational_unit_name of this CreateManagedOrganizationalUnitResponse.

        父注册OU名称。

        :return: The parent_organizational_unit_name of this CreateManagedOrganizationalUnitResponse.
        :rtype: str
        """
    ...
    def parent_organizational_unit_name(self, parent_organizational_unit_name):
        r"""Sets the parent_organizational_unit_name of this CreateManagedOrganizationalUnitResponse.

        父注册OU名称。

        :param parent_organizational_unit_name: The parent_organizational_unit_name of this CreateManagedOrganizationalUnitResponse.
        :type parent_organizational_unit_name: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateManagedOrganizationalUnitResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateManagedOrganizationalUnitResponse):
            return False
