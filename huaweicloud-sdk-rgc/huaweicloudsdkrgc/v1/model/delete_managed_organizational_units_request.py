...
class DeleteManagedOrganizationalUnitsRequest:
    ...
    def __init__(self, managed_organizational_unit_id=None):
        r"""DeleteManagedOrganizationalUnitsRequest
    ...
    def managed_organizational_unit_id(self):
        r"""Gets the managed_organizational_unit_id of this DeleteManagedOrganizationalUnitsRequest.

        注册OU ID。

        :return: The managed_organizational_unit_id of this DeleteManagedOrganizationalUnitsRequest.
        :rtype: str
        """
    ...
    def managed_organizational_unit_id(self, managed_organizational_unit_id):
        r"""Sets the managed_organizational_unit_id of this DeleteManagedOrganizationalUnitsRequest.

        注册OU ID。

        :param managed_organizational_unit_id: The managed_organizational_unit_id of this DeleteManagedOrganizationalUnitsRequest.
        :type managed_organizational_unit_id: str
        """
