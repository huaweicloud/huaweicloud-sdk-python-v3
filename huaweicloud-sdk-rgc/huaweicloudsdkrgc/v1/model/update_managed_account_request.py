...
class UpdateManagedAccountRequest:
    ...
    def managed_account_id(self):
        r"""Gets the managed_account_id of this UpdateManagedAccountRequest.
    ...
    def managed_account_id(self, managed_account_id):
        r"""Sets the managed_account_id of this UpdateManagedAccountRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this UpdateManagedAccountRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this UpdateManagedAccountRequest.
