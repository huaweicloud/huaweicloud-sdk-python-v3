...
class EnableControlRequest:
    ...
    def x_security_token(self):
        """Gets the x_security_token of this EnableControlRequest.

        如果正在使用临时安全凭据，则此header是必需的，该值是临时安全凭据的安全令牌（会话令牌）。

        :return: The x_security_token of this EnableControlRequest.
        :rtype: str
        """
    ...
    def x_security_token(self, x_security_token):
        """Sets the x_security_token of this EnableControlRequest.

        如果正在使用临时安全凭据，则此header是必需的，该值是临时安全凭据的安全令牌（会话令牌）。

        :param x_security_token: The x_security_token of this EnableControlRequest.
        :type x_security_token: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnableControlRequest):
            return False
