...
class ShowComplianceStatusForOrganizationalUnitRequest:
    ...
    def __init__(self, managed_organizational_unit_id=None, control_id=None):
        r"""ShowComplianceStatusForOrganizationalUnitRequest
    ...
    def managed_organizational_unit_id(self):
        r"""Gets the managed_organizational_unit_id of this ShowComplianceStatusForOrganizationalUnitRequest.

        注册OU ID。

        :return: The managed_organizational_unit_id of this ShowComplianceStatusForOrganizationalUnitRequest.
        :rtype: str
        """
    ...
    def managed_organizational_unit_id(self, managed_organizational_unit_id):
        r"""Sets the managed_organizational_unit_id of this ShowComplianceStatusForOrganizationalUnitRequest.

        注册OU ID。

        :param managed_organizational_unit_id: The managed_organizational_unit_id of this ShowComplianceStatusForOrganizationalUnitRequest.
        :type managed_organizational_unit_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowComplianceStatusForOrganizationalUnitRequest):
            return False
