...
class ManagedOrganizationalUnit:
    ...
    def organizational_unit_id(self):
        r"""Gets the organizational_unit_id of this ManagedOrganizationalUnit.

        注册OU ID。

        :return: The organizational_unit_id of this ManagedOrganizationalUnit.
        :rtype: str
        """
    ...
    def organizational_unit_id(self, organizational_unit_id):
        r"""Sets the organizational_unit_id of this ManagedOrganizationalUnit.

        注册OU ID。

        :param organizational_unit_id: The organizational_unit_id of this ManagedOrganizationalUnit.
        :type organizational_unit_id: str
        """
    ...
    def organizational_unit_name(self):
        r"""Gets the organizational_unit_name of this ManagedOrganizationalUnit.

        注册OU名称。

        :return: The organizational_unit_name of this ManagedOrganizationalUnit.
        :rtype: str
        """
    ...
    def organizational_unit_name(self, organizational_unit_name):
        r"""Sets the organizational_unit_name of this ManagedOrganizationalUnit.

        注册OU名称。

        :param organizational_unit_name: The organizational_unit_name of this ManagedOrganizationalUnit.
        :type organizational_unit_name: str
        """
    ...
    def organizational_unit_status(self):
        r"""Gets the organizational_unit_status of this ManagedOrganizationalUnit.

        注册OU状态。

        :return: The organizational_unit_status of this ManagedOrganizationalUnit.
        :rtype: str
        """
    ...
    def organizational_unit_status(self, organizational_unit_status):
        r"""Sets the organizational_unit_status of this ManagedOrganizationalUnit.

        注册OU状态。

        :param organizational_unit_status: The organizational_unit_status of this ManagedOrganizationalUnit.
        :type organizational_unit_status: str
        """
    ...
    def parent_organizational_unit_id(self):
        r"""Gets the parent_organizational_unit_id of this ManagedOrganizationalUnit.

        父注册OU ID。

        :return: The parent_organizational_unit_id of this ManagedOrganizationalUnit.
        :rtype: str
        """
    ...
    def parent_organizational_unit_id(self, parent_organizational_unit_id):
        r"""Sets the parent_organizational_unit_id of this ManagedOrganizationalUnit.

        父注册OU ID。

        :param parent_organizational_unit_id: The parent_organizational_unit_id of this ManagedOrganizationalUnit.
        :type parent_organizational_unit_id: str
        """
    ...
    def parent_organizational_unit_name(self):
        r"""Gets the parent_organizational_unit_name of this ManagedOrganizationalUnit.

        父注册OU名称。

        :return: The parent_organizational_unit_name of this ManagedOrganizationalUnit.
        :rtype: str
        """
    ...
    def parent_organizational_unit_name(self, parent_organizational_unit_name):
        r"""Sets the parent_organizational_unit_name of this ManagedOrganizationalUnit.

        父注册OU名称。

        :param parent_organizational_unit_name: The parent_organizational_unit_name of this ManagedOrganizationalUnit.
        :type parent_organizational_unit_name: str
        """
    ...
    @property
    def message(self):
        r"""Gets the message of this ManagedOrganizationalUnit.

        错误信息描述。

        :return: The message of this ManagedOrganizationalUnit.
        :rtype: str
        """
    ...
    def message(self, message):
        r"""Sets the message of this ManagedOrganizationalUnit.

        错误信息描述。

        :param message: The message of this ManagedOrganizationalUnit.
        :type message: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ManagedOrganizationalUnit):
            return False
