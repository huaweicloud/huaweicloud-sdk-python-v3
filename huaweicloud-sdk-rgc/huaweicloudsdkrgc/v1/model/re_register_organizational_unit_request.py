...
class ReRegisterOrganizationalUnitRequest:
    ...
    def organization_unit_id(self):
        """Gets the organization_unit_id of this ReRegisterOrganizationalUnitRequest.

        注册OU ID。

        :return: The organization_unit_id of this ReRegisterOrganizationalUnitRequest.
        :rtype: str
        """
    ...
    def organization_unit_id(self, organization_unit_id):
        """Sets the organization_unit_id of this ReRegisterOrganizationalUnitRequest.

        注册OU ID。

        :param organization_unit_id: The organization_unit_id of this ReRegisterOrganizationalUnitRequest.
        :type organization_unit_id: str
        """
