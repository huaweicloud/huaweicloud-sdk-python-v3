...
class RgcAsyncClient(Client):
    ...
    def create_best_practice_detect_async(self, request):
        r"""检测八大场景治理成熟度
    ...
    def create_best_practice_detect_async_invoker(self, request):
        http_info = self._create_best_practice_detect_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_best_practice_detect_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def show_best_practice_details_async_invoker(self, request):
        http_info = self._show_best_practice_details_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_best_practice_details_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_best_practice_overview_async(self, request):
    ...
    def show_best_practice_overview_async_invoker(self, request):
        http_info = self._show_best_practice_overview_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_best_practice_overview_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_best_practice_status_async(self, request):
        r"""查询最近一次的治理成熟度检测的状态
    ...
    def show_best_practice_status_async_invoker(self, request):
        http_info = self._show_best_practice_status_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_best_practice_status_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_config_rule_compliances_async(self, request):
    ...
    def list_config_rule_compliances_async_invoker(self, request):
        http_info = self._list_config_rule_compliances_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_config_rule_compliances_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_external_config_rule_compliances_async(self, request):
    ...
    def list_external_config_rule_compliances_async_invoker(self, request):
        http_info = self._list_external_config_rule_compliances_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_external_config_rule_compliances_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_compliance_status_for_organizational_unit_async(self, request):
        r"""查询注册OU的合规状态
    ...
    def show_compliance_status_for_organizational_unit_async_invoker(self, request):
        http_info = self._show_compliance_status_for_organizational_unit_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_compliance_status_for_organizational_unit_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_controls_for_account_async_invoker(self, request):
        http_info = self._show_controls_for_account_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_controls_for_account_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_controls_for_organizational_unit_async(self, request):
        r"""查询注册OU开启的控制策略
    ...
    def show_controls_for_organizational_unit_async_invoker(self, request):
        http_info = self._show_controls_for_organizational_unit_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_controls_for_organizational_unit_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def delete_landing_zone_async(self, request):
        r"""删除Landing Zone
    ...
    def delete_landing_zone_async_invoker(self, request):
        http_info = self._delete_landing_zone_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_landing_zone_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def create_managed_organizational_unit_async(self, request):
        r"""创建OU
    ...
    def create_managed_organizational_unit_async_invoker(self, request):
        http_info = self._create_managed_organizational_unit_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_managed_organizational_unit_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def show_managed_account_template_async(self, request):
        r"""查询纳管账号的模板信息
    ...
    def show_managed_account_template_async_invoker(self, request):
        http_info = self._show_managed_account_template_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_managed_account_template_http_info(self, request):
        http_info = {
            "method": "GET",
