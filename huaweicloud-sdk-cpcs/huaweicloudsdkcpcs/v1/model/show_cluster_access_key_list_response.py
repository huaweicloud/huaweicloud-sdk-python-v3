...
class ShowClusterAccessKeyListResponse(SdkResponse):
    ...
    openapi_types = {
        'result': 'list[ShowClusterAccessKeyListResponseBodyResult]'
    }
    ...
    def __init__(self, result=None):
        r"""ShowClusterAccessKeyListResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowClusterAccessKeyListResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowClusterAccessKeyListResponse):
            return False
