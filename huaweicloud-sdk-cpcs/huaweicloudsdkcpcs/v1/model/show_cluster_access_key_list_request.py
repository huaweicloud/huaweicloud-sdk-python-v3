...
class ShowClusterAccessKeyListRequest:
    ...
    def __init__(self, cluster_id=None, page_size=None, page_num=None, app_name=None, sort_key=None, sort_dir=None):
    ...
    @property
    def page_size(self):
        r"""Gets the page_size of this ShowClusterAccessKeyListRequest.

        指定查询返回记录条数，默认值10

        :return: The page_size of this ShowClusterAccessKeyListRequest.
        :rtype: int
        """
    ...
    def page_size(self, page_size):
        r"""Sets the page_size of this ShowClusterAccessKeyListRequest.

        指定查询返回记录条数，默认值10

        :param page_size: The page_size of this ShowClusterAccessKeyListRequest.
        :type page_size: int
        """
    ...
    @property
    def page_num(self):
        r"""Gets the page_num of this ShowClusterAccessKeyListRequest.

        索引位置，从page_num指定的下一条数据开始查询默认值为0

        :return: The page_num of this ShowClusterAccessKeyListRequest.
        :rtype: int
        """
    ...
    def page_num(self, page_num):
        r"""Sets the page_num of this ShowClusterAccessKeyListRequest.

        索引位置，从page_num指定的下一条数据开始查询默认值为0

        :param page_num: The page_num of this ShowClusterAccessKeyListRequest.
        :type page_num: int
        """
