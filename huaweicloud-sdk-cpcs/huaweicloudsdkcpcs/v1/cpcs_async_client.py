...
class CpcsAsyncClient(Client):
    def __init__(self):
        super(CpcsAsyncClient, self).__init__()
    ...
    def new_builder(cls, clazz=None):
        if not clazz:
            ...
            if clazz.__name__ != "CpcsAsyncClient":
                raise TypeError("client type error, support client type is CpcsAsyncClient")
    ...
    def associate_apps_async_invoker(self, request):
        http_info = self._associate_apps_http_info(request)
        return AsyncInvoker(self, http_info)

    def _associate_apps_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def authorize_access_keys_async(self, request):
    ...
    def authorize_access_keys_async_invoker(self, request):
        http_info = self._authorize_access_keys_http_info(request)
        return AsyncInvoker(self, http_info)

    def _authorize_access_keys_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def batch_disable_access_keys_async(self, request):
        r"""停用应用的访问密钥
    ...
    def batch_disable_access_keys_async_invoker(self, request):
        http_info = self._batch_disable_access_keys_http_info(request)
        return AsyncInvoker(self, http_info)

    def _batch_disable_access_keys_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def batch_enable_access_keys_async(self, request):
        r"""启用应用的访问密钥
    ...
    def batch_enable_access_keys_async_invoker(self, request):
        http_info = self._batch_enable_access_keys_http_info(request)
        return AsyncInvoker(self, http_info)

    def _batch_enable_access_keys_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def cancel_authorize_access_keys_async(self, request):
        r"""密码服务集群解除对访问密钥的授权
    ...
    def cancel_authorize_access_keys_async_invoker(self, request):
        http_info = self._cancel_authorize_access_keys_http_info(request)
        return AsyncInvoker(self, http_info)

    def _cancel_authorize_access_keys_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def create_app_access_key_async(self, request):
        r"""创建访问密钥
    ...
    def create_app_access_key_async_invoker(self, request):
        http_info = self._create_app_access_key_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_app_access_key_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def delete_access_key_async(self, request):
        r"""删除应用的访问密钥
    ...
    def delete_access_key_async_invoker(self, request):
        http_info = self._delete_access_key_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_access_key_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def delete_ccsp_cluster_async(self, request):
        r"""删除密码服务集群
    ...
    def delete_ccsp_cluster_async_invoker(self, request):
        http_info = self._delete_ccsp_cluster_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_ccsp_cluster_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def disable_ccsp_instance_async_invoker(self, request):
        http_info = self._disable_ccsp_instance_http_info(request)
        return AsyncInvoker(self, http_info)

    def _disable_ccsp_instance_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def disassociate_apps_async(self, request):
        r"""解除密码服务集群与应用绑定关系
    ...
    def disassociate_apps_async_invoker(self, request):
        http_info = self._disassociate_apps_http_info(request)
        return AsyncInvoker(self, http_info)

    def _disassociate_apps_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def enable_ccsp_instance_async(self, request):
        r"""启用密码服务实例的业务功能
    ...
    def enable_ccsp_instance_async_invoker(self, request):
        http_info = self._enable_ccsp_instance_http_info(request)
        return AsyncInvoker(self, http_info)

    def _enable_ccsp_instance_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def list_ccsp_tenant_images_async(self, request):
        r"""查询密码服务的镜像
    ...
    def list_ccsp_tenant_images_async_invoker(self, request):
        http_info = self._list_ccsp_tenant_images_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_ccsp_tenant_images_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_access_key_async(self, request):
        r"""下载访问密钥
    ...
    def show_access_key_async_invoker(self, request):
        http_info = self._show_access_key_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_access_key_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/{project_id}/dew/cpcs/apps/{app_id}/access-keys/{access_key_id}",
            "request_type": request.__class__.__name__,
    ...
    def show_app_access_key_list_async(self, request):
        r"""查询应用的访问密钥列表
    ...
    def show_app_access_key_list_async_invoker(self, request):
        http_info = self._show_app_access_key_list_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_app_access_key_list_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/{project_id}/dew/cpcs/apps/{app_id}/access-keys",
            "request_type": request.__class__.__name__,
    ...
    def show_app_list_async(self, request):
        r"""查询应用列表
    ...
    def show_app_list_async_invoker(self, request):
        http_info = self._show_app_list_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_app_list_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/{project_id}/dew/cpcs/apps",
            "request_type": request.__class__.__name__,
    ...
    def show_association_list_async(self, request):
    ...
    def show_association_list_async_invoker(self, request):
        http_info = self._show_association_list_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_association_list_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_available_az_async(self, request):
        r"""查询可创建密码服务集群的可用区列表
    ...
    def show_available_az_async_invoker(self, request):
        http_info = self._show_available_az_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_available_az_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_ccsp_cluster_async(self, request):
        r"""查询密码服务集群详情
    ...
    def show_ccsp_cluster_async_invoker(self, request):
        http_info = self._show_ccsp_cluster_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_ccsp_cluster_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/{project_id}/dew/cpcs/cluster/{cluster_id}",
            "request_type": request.__class__.__name__,
    ...
    def show_ccsp_cluster_list_async(self, request):
        r"""查询密码服务集群列表
    ...
    def show_ccsp_cluster_list_async_invoker(self, request):
        http_info = self._show_ccsp_cluster_list_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_ccsp_cluster_list_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/{project_id}/dew/cpcs/cluster",
            "request_type": request.__class__.__name__,
    ...
    def show_ccsp_instance_info_async(self, request):
        r"""查询密码服务实例列表
    ...
    def show_ccsp_instance_info_async_invoker(self, request):
        http_info = self._show_ccsp_instance_info_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_ccsp_instance_info_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_cluster_access_key_list_async(self, request):
    ...
    def show_cluster_access_key_list_async_invoker(self, request):
        http_info = self._show_cluster_access_key_list_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_cluster_access_key_list_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_cluster_uri_async(self, request):
        r"""获取密码服务管理界面URL
    ...
    def show_cluster_uri_async_invoker(self, request):
        http_info = self._show_cluster_uri_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_cluster_uri_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_vm_monitor_async(self, request):
        r"""密码资源指标监控
    ...
    def show_vm_monitor_async_invoker(self, request):
        http_info = self._show_vm_monitor_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_vm_monitor_http_info(self, request):
        http_info = {
            "method": "GET",
