...
class ListJobsResponse(SdkResponse):
    ...
    def __init__(self, total=None, jobs=None, x_request_id=None):
        r"""ListJobsResponse
        ...
        :type total: int
        :param jobs: 列表信息
        :type jobs: list[:class:`huaweicloudsdkdataartsfabric.v1.JobInfo`]
        :param x_request_id: 
    ...
    def jobs(self):
        ...
        :rtype: list[:class:`huaweicloudsdkdataartsfabric.v1.JobInfo`]
        """
        return self._jobs
