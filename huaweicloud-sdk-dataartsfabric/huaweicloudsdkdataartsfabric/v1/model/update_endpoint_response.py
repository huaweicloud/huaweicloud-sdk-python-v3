...
class UpdateEndpointResponse(SdkResponse):
    ...
    @property
    def visibility(self):
        r"""Gets the visibility of this UpdateEndpointResponse.

        可见性：  - PRIVATE：私有  - PUBLIC：公共  默认为PRIVATE

        :return: The visibility of this UpdateEndpointResponse.
        :rtype: str
        """
    ...
    def visibility(self, visibility):
        r"""Sets the visibility of this UpdateEndpointResponse.

        可见性：  - PRIVATE：私有  - PUBLIC：公共  默认为PRIVATE

        :param visibility: The visibility of this UpdateEndpointResponse.
        :type visibility: str
        """
    ...
    def create_time(self):
        r"""Gets the create_time of this UpdateEndpointResponse.

        创建时间

        :return: The create_time of this UpdateEndpointResponse.
        :rtype: datetime
        """
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this UpdateEndpointResponse.

        创建时间

        :param create_time: The create_time of this UpdateEndpointResponse.
        :type create_time: datetime
        """
    ...
    def update_time(self):
        r"""Gets the update_time of this UpdateEndpointResponse.

        更新时间

        :return: The update_time of this UpdateEndpointResponse.
        :rtype: datetime
        """
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this UpdateEndpointResponse.

        更新时间

        :param update_time: The update_time of this UpdateEndpointResponse.
        :type update_time: datetime
        """
    ...
    @property
    def owner(self):
        r"""Gets the owner of this UpdateEndpointResponse.

        :return: The owner of this UpdateEndpointResponse.
    ...
    def owner(self, owner):
        r"""Sets the owner of this UpdateEndpointResponse.

        :param owner: The owner of this UpdateEndpointResponse.
        :type owner: :class:`huaweicloudsdkdataartsfabric.v1.User`
        """
        self._owner = owner
    ...
    @property
    def cap(self):
        r"""Gets the cap of this UpdateEndpointResponse.

        :return: The cap of this UpdateEndpointResponse.
    ...
    @cap.setter
    def cap(self, cap):
        r"""Sets the cap of this UpdateEndpointResponse.

        :param cap: The cap of this UpdateEndpointResponse.
        :type cap: :class:`huaweicloudsdkdataartsfabric.v1.CapRef`
        """
        self._cap = cap
    ...
    def custom_image_id(self):
        r"""Gets the custom_image_id of this UpdateEndpointResponse.

        - **参数解释**：CustomImageId。 - **约束限制**：不涉及。 - **取值范围**：长度为[32,36]的英文字符、数字和中划线(-)的组合。 - **默认取值**：不涉及。 

        :return: The custom_image_id of this UpdateEndpointResponse.
        :rtype: str
        """
    ...
    def custom_image_id(self, custom_image_id):
        r"""Sets the custom_image_id of this UpdateEndpointResponse.

        - **参数解释**：CustomImageId。 - **约束限制**：不涉及。 - **取值范围**：长度为[32,36]的英文字符、数字和中划线(-)的组合。 - **默认取值**：不涉及。 

        :param custom_image_id: The custom_image_id of this UpdateEndpointResponse.
        :type custom_image_id: str
        """
    ...
    def reserved_resource(self):
        r"""Gets the reserved_resource of this UpdateEndpointResponse.

        :return: The reserved_resource of this UpdateEndpointResponse.
    ...
    def reserved_resource(self, reserved_resource):
        r"""Sets the reserved_resource of this UpdateEndpointResponse.

        :param reserved_resource: The reserved_resource of this UpdateEndpointResponse.
        :type reserved_resource: :class:`huaweicloudsdkdataartsfabric.v1.ReservedResource`
        """
    ...
    def ray_resource(self):
        r"""Gets the ray_resource of this UpdateEndpointResponse.

        :return: The ray_resource of this UpdateEndpointResponse.
    ...
    def ray_resource(self, ray_resource):
        r"""Sets the ray_resource of this UpdateEndpointResponse.

        :param ray_resource: The ray_resource of this UpdateEndpointResponse.
        :type ray_resource: :class:`huaweicloudsdkdataartsfabric.v1.RayResourceInfo`
        """
    ...
    @property
    def error_code(self):
        r"""Gets the error_code of this UpdateEndpointResponse.

        失败状态时的错误编码

        :return: The error_code of this UpdateEndpointResponse.
        :rtype: str
        """
    ...
    def error_code(self, error_code):
        r"""Sets the error_code of this UpdateEndpointResponse.

        失败状态时的错误编码

        :param error_code: The error_code of this UpdateEndpointResponse.
        :type error_code: str
        """
    ...
    @property
    def error_msg(self):
        r"""Gets the error_msg of this UpdateEndpointResponse.

        失败状态时的错误信息

        :return: The error_msg of this UpdateEndpointResponse.
        :rtype: str
        """
    ...
    def error_msg(self, error_msg):
        r"""Sets the error_msg of this UpdateEndpointResponse.

        失败状态时的错误信息

        :param error_msg: The error_msg of this UpdateEndpointResponse.
        :type error_msg: str
        """
    ...
    @property
    def urls(self):
        r"""Gets the urls of this UpdateEndpointResponse.

        调用地址

        :return: The urls of this UpdateEndpointResponse.
    ...
    @urls.setter
    def urls(self, urls):
        r"""Sets the urls of this UpdateEndpointResponse.

        调用地址

        :param urls: The urls of this UpdateEndpointResponse.
        :type urls: list[:class:`huaweicloudsdkdataartsfabric.v1.Url`]
        """
        self._urls = urls
    ...
    def business_engine_instance_ids(self):
        r"""Gets the business_engine_instance_ids of this UpdateEndpointResponse.

        引擎实例id列表

        :return: The business_engine_instance_ids of this UpdateEndpointResponse.
        :rtype: list[str]
        """
    ...
    def business_engine_instance_ids(self, business_engine_instance_ids):
        r"""Sets the business_engine_instance_ids of this UpdateEndpointResponse.

        引擎实例id列表

        :param business_engine_instance_ids: The business_engine_instance_ids of this UpdateEndpointResponse.
        :type business_engine_instance_ids: list[str]
        """
    ...
    def tokens_quota(self):
        r"""Gets the tokens_quota of this UpdateEndpointResponse.

        :return: The tokens_quota of this UpdateEndpointResponse.
    ...
    def tokens_quota(self, tokens_quota):
        r"""Sets the tokens_quota of this UpdateEndpointResponse.

        :param tokens_quota: The tokens_quota of this UpdateEndpointResponse.
        :type tokens_quota: :class:`huaweicloudsdkdataartsfabric.v1.TokensQuota`
        """
    ...
    def runtime_env_type(self):
        r"""Gets the runtime_env_type of this UpdateEndpointResponse.

        :return: The runtime_env_type of this UpdateEndpointResponse.
    ...
    def runtime_env_type(self, runtime_env_type):
        r"""Sets the runtime_env_type of this UpdateEndpointResponse.

        :param runtime_env_type: The runtime_env_type of this UpdateEndpointResponse.
        :type runtime_env_type: :class:`huaweicloudsdkdataartsfabric.v1.RuntimeEnvType`
        """
    ...
    @property
    def config(self):
        r"""Gets the config of this UpdateEndpointResponse.

        :return: The config of this UpdateEndpointResponse.
    ...
    def config(self, config):
        r"""Sets the config of this UpdateEndpointResponse.

        :param config: The config of this UpdateEndpointResponse.
        :type config: :class:`huaweicloudsdkdataartsfabric.v1.EndpointConfigResponse`
        """
        self._config = config
    ...
    def x_request_id(self):
        r"""Gets the x_request_id of this UpdateEndpointResponse.

        :return: The x_request_id of this UpdateEndpointResponse.
        :rtype: str
        """
    ...
    def x_request_id(self, x_request_id):
        r"""Sets the x_request_id of this UpdateEndpointResponse.

        :param x_request_id: The x_request_id of this UpdateEndpointResponse.
        :type x_request_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateEndpointResponse.to_dict() is deprecated and no longer maintained, "
