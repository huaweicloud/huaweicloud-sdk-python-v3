...
class RayServiceConfigResponse:
    ...
    def __init__(self, ray_serve_config=None, ray_cluster_config=None, log_config=None, oidc_config=None, api_config=None, agency_config=None, data_infos=None):
        ...
        :type data_infos: list[:class:`huaweicloudsdkdataartsfabric.v1.DataInfo`]
        """
    ...
    def ray_serve_config(self):
        r"""Gets the ray_serve_config of this RayServiceConfigResponse.

        :return: The ray_serve_config of this RayServiceConfigResponse.
    ...
    def ray_serve_config(self, ray_serve_config):
        r"""Sets the ray_serve_config of this RayServiceConfigResponse.

        :param ray_serve_config: The ray_serve_config of this RayServiceConfigResponse.
        :type ray_serve_config: :class:`huaweicloudsdkdataartsfabric.v1.RayServeConfig`
        """
    ...
    def ray_cluster_config(self):
        r"""Gets the ray_cluster_config of this RayServiceConfigResponse.

        :return: The ray_cluster_config of this RayServiceConfigResponse.
    ...
    def ray_cluster_config(self, ray_cluster_config):
        r"""Sets the ray_cluster_config of this RayServiceConfigResponse.

        :param ray_cluster_config: The ray_cluster_config of this RayServiceConfigResponse.
        :type ray_cluster_config: :class:`huaweicloudsdkdataartsfabric.v1.RayClusterConfig`
        """
    ...
    @property
    def log_config(self):
        r"""Gets the log_config of this RayServiceConfigResponse.

        :return: The log_config of this RayServiceConfigResponse.
    ...
    def log_config(self, log_config):
        r"""Sets the log_config of this RayServiceConfigResponse.

        :param log_config: The log_config of this RayServiceConfigResponse.
        :type log_config: :class:`huaweicloudsdkdataartsfabric.v1.RayServiceLogConfig`
        """
    ...
    def oidc_config(self):
        r"""Gets the oidc_config of this RayServiceConfigResponse.

        :return: The oidc_config of this RayServiceConfigResponse.
    ...
    def oidc_config(self, oidc_config):
        r"""Sets the oidc_config of this RayServiceConfigResponse.

        :param oidc_config: The oidc_config of this RayServiceConfigResponse.
        :type oidc_config: :class:`huaweicloudsdkdataartsfabric.v1.OidcConfig`
        """
    ...
    @property
    def api_config(self):
        r"""Gets the api_config of this RayServiceConfigResponse.

        :return: The api_config of this RayServiceConfigResponse.
    ...
    def api_config(self, api_config):
        r"""Sets the api_config of this RayServiceConfigResponse.

        :param api_config: The api_config of this RayServiceConfigResponse.
        :type api_config: :class:`huaweicloudsdkdataartsfabric.v1.ApiConfig`
        """
    ...
    def agency_config(self):
        r"""Gets the agency_config of this RayServiceConfigResponse.

        :return: The agency_config of this RayServiceConfigResponse.
    ...
    def agency_config(self, agency_config):
        r"""Sets the agency_config of this RayServiceConfigResponse.

        :param agency_config: The agency_config of this RayServiceConfigResponse.
        :type agency_config: :class:`huaweicloudsdkdataartsfabric.v1.AgencyConfig`
        """
    ...
    @property
    def data_infos(self):
        r"""Gets the data_infos of this RayServiceConfigResponse.

        **参数解释**：数据信息。 **约束限制**：不涉及。 **取值范围**：[0,1]。 **默认取值**：不涉及。 

        :return: The data_infos of this RayServiceConfigResponse.
        :rtype: list[:class:`huaweicloudsdkdataartsfabric.v1.DataInfo`]
        """
        return self._data_infos

    @data_infos.setter
    def data_infos(self, data_infos):
        r"""Sets the data_infos of this RayServiceConfigResponse.

        **参数解释**：数据信息。 **约束限制**：不涉及。 **取值范围**：[0,1]。 **默认取值**：不涉及。 

        :param data_infos: The data_infos of this RayServiceConfigResponse.
        :type data_infos: list[:class:`huaweicloudsdkdataartsfabric.v1.DataInfo`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RayServiceConfigResponse):
            return False
