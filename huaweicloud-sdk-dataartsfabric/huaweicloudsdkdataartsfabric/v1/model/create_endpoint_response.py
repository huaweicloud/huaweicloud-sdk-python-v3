...
class CreateEndpointResponse(SdkResponse):
    ...
    def custom_image_id(self):
        r"""Gets the custom_image_id of this CreateEndpointResponse.

        - **参数解释**：CustomImageId。 - **约束限制**：不涉及。 - **取值范围**：长度为[32,36]的英文字符、数字和中划线(-)的组合。 - **默认取值**：不涉及。 

        :return: The custom_image_id of this CreateEndpointResponse.
        :rtype: str
        """
    ...
    def custom_image_id(self, custom_image_id):
        r"""Sets the custom_image_id of this CreateEndpointResponse.

        - **参数解释**：CustomImageId。 - **约束限制**：不涉及。 - **取值范围**：长度为[32,36]的英文字符、数字和中划线(-)的组合。 - **默认取值**：不涉及。 

        :param custom_image_id: The custom_image_id of this CreateEndpointResponse.
        :type custom_image_id: str
        """
    ...
    def tokens_quota(self):
        r"""Gets the tokens_quota of this CreateEndpointResponse.

        :return: The tokens_quota of this CreateEndpointResponse.
    ...
    def tokens_quota(self, tokens_quota):
        r"""Sets the tokens_quota of this CreateEndpointResponse.

        :param tokens_quota: The tokens_quota of this CreateEndpointResponse.
        :type tokens_quota: :class:`huaweicloudsdkdataartsfabric.v1.TokensQuota`
        """
    ...
    def runtime_env_type(self):
        r"""Gets the runtime_env_type of this CreateEndpointResponse.

        :return: The runtime_env_type of this CreateEndpointResponse.
    ...
    def runtime_env_type(self, runtime_env_type):
        r"""Sets the runtime_env_type of this CreateEndpointResponse.

        :param runtime_env_type: The runtime_env_type of this CreateEndpointResponse.
        :type runtime_env_type: :class:`huaweicloudsdkdataartsfabric.v1.RuntimeEnvType`
        """
    ...
    @property
    def config(self):
        r"""Gets the config of this CreateEndpointResponse.

        :return: The config of this CreateEndpointResponse.
    ...
    def config(self, config):
        r"""Sets the config of this CreateEndpointResponse.

        :param config: The config of this CreateEndpointResponse.
        :type config: :class:`huaweicloudsdkdataartsfabric.v1.EndpointConfigResponse`
        """
        self._config = config
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateEndpointResponse.to_dict() is deprecated and no longer maintained, "
