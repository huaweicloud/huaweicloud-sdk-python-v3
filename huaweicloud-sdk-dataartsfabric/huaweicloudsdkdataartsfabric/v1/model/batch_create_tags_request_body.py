...
class BatchCreateTagsRequestBody:
    ...
    def tags(self):
        ...
        :return: The tags of this BatchCreateTagsRequestBody.
    ...
    def tags(self, tags):
        ...
        :param tags: The tags of this BatchCreateTagsRequestBody.
        :type tags: list[:class:`huaweicloudsdkdataartsfabric.v1.ResourceTag`]
        """
        self._tags = tags
    ...
    @property
    def sys_tags(self):
        r"""Gets the sys_tags of this BatchCreateTagsRequestBody.

        系统标签列表。

        :return: The sys_tags of this BatchCreateTagsRequestBody.
    ...
    def sys_tags(self, sys_tags):
        r"""Sets the sys_tags of this BatchCreateTagsRequestBody.

        系统标签列表。

        :param sys_tags: The sys_tags of this BatchCreateTagsRequestBody.
        :type sys_tags: list[:class:`huaweicloudsdkdataartsfabric.v1.SystemTag`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchCreateTagsRequestBody):
            return False
