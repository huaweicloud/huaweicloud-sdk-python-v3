...
class UpdateTableResponse(SdkResponse):
    ...
    def table_format(self):
        r"""Gets the table_format of this UpdateTableResponse.

        表格式,支持HIVE,ICEBERG,LANCE

        :return: The table_format of this UpdateTableResponse.
        :rtype: str
        """
    ...
    def table_format(self, table_format):
        r"""Sets the table_format of this UpdateTableResponse.

        表格式,支持HIVE,ICEBERG,LANCE

        :param table_format: The table_format of this UpdateTableResponse.
        :type table_format: str
        """
