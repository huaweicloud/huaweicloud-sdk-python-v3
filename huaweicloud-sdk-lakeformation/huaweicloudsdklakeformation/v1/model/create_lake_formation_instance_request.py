...
class CreateLakeFormationInstanceRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateLakeFormationInstanceRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateLakeFormationInstanceRequest):
            return False
