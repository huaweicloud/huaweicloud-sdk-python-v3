...
class ListLakeFormationInstanceTagsResponse(SdkResponse):
    ...
    def __init__(self, tags=None, x_request_id=None):
        ...
        :param tags: 标签
        :type tags: list[:class:`huaweicloudsdklakeformation.v1.ResourceTagParam`]
        :param x_request_id: 
    ...
    def tags(self):
        ...
        :return: The tags of this ListLakeFormationInstanceTagsResponse.
        :rtype: list[:class:`huaweicloudsdklakeformation.v1.ResourceTagParam`]
        """
        return self._tags
    ...
    def tags(self, tags):
        ...
        :param tags: The tags of this ListLakeFormationInstanceTagsResponse.
        :type tags: list[:class:`huaweicloudsdklakeformation.v1.ResourceTagParam`]
        """
        self._tags = tags
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListLakeFormationInstanceTagsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListLakeFormationInstanceTagsResponse):
            return False
