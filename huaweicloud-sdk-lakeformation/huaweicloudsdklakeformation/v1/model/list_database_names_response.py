...
class ListDatabaseNamesResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListDatabaseNamesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListDatabaseNamesResponse):
            return False
