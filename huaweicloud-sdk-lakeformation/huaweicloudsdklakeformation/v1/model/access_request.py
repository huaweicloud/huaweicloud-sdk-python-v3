...
class AccessRequest:
    ...
    def __init__(self, resource=None, principal=None, action=None):
        ...
        :param action: 权限信息,ALL,CREATE,ALTER,DROP,DESCRIBE,EXEC,CREATE_DATABASE,LIST_DATABASE,CREATE_TABLE,LIST_TABLE,CREATE_FUNC,LIST_FUNC,REGISTER_MODEL,LIST_MODEL,CREATE_DATASET,LIST_DATASET,READ_DATASET,WRITE_DATASET,INSERT,UPDATE,DELETE,SELECT,READ,WRITE,OPERATE,USE
        :type action: str
        """
