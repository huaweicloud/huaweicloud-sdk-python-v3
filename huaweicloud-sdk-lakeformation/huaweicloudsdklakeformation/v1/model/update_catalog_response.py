...
class UpdateCatalogResponse(SdkResponse):
    ...
    def catalog_name(self):
        r"""Gets the catalog_name of this UpdateCatalogResponse.

        catalog名称

        :return: The catalog_name of this UpdateCatalogResponse.
        :rtype: str
        """
    ...
    def catalog_name(self, catalog_name):
        r"""Sets the catalog_name of this UpdateCatalogResponse.

        catalog名称

        :param catalog_name: The catalog_name of this UpdateCatalogResponse.
        :type catalog_name: str
        """
    ...
    def description(self):
        r"""Gets the description of this UpdateCatalogResponse.
    ...
    def description(self, description):
        r"""Sets the description of this UpdateCatalogResponse.
    ...
    @property
    def location(self):
        r"""Gets the location of this UpdateCatalogResponse.

        路径地址。例如obs://location/uri/

        :return: The location of this UpdateCatalogResponse.
        :rtype: str
        """
    ...
    def location(self, location):
        r"""Sets the location of this UpdateCatalogResponse.

        路径地址。例如obs://location/uri/

        :param location: The location of this UpdateCatalogResponse.
        :type location: str
        """
    ...
    def database_location_list(self):
        r"""Gets the database_location_list of this UpdateCatalogResponse.

        数据库路径列表。当值为null时，响应Body无该参数。

        :return: The database_location_list of this UpdateCatalogResponse.
        :rtype: list[str]
        """
    ...
    def database_location_list(self, database_location_list):
        r"""Sets the database_location_list of this UpdateCatalogResponse.

        数据库路径列表。当值为null时，响应Body无该参数。

        :param database_location_list: The database_location_list of this UpdateCatalogResponse.
        :type database_location_list: list[str]
        """
    ...
    @property
    def owner(self):
        r"""Gets the owner of this UpdateCatalogResponse.

        catalog所有者。LakeFormation服务分为一期和二期，一期响应Body无该参数。

        :return: The owner of this UpdateCatalogResponse.
        :rtype: str
        """
        return self._owner
    ...
    def owner(self, owner):
        r"""Sets the owner of this UpdateCatalogResponse.

        catalog所有者。LakeFormation服务分为一期和二期，一期响应Body无该参数。

        :param owner: The owner of this UpdateCatalogResponse.
        :type owner: str
        """
        self._owner = owner
    ...
    @property
    def owner_type(self):
        r"""Gets the owner_type of this UpdateCatalogResponse.

        所有者类型,USER-用户,GROUP-组,ROLE-角色。LakeFormation服务分为一期和二期，一期响应Body无该参数。

        :return: The owner_type of this UpdateCatalogResponse.
        :rtype: str
        """
    ...
    def owner_type(self, owner_type):
        r"""Sets the owner_type of this UpdateCatalogResponse.

        所有者类型,USER-用户,GROUP-组,ROLE-角色。LakeFormation服务分为一期和二期，一期响应Body无该参数。

        :param owner_type: The owner_type of this UpdateCatalogResponse.
        :type owner_type: str
        """
    ...
    def owner_source(self):
        r"""Gets the owner_source of this UpdateCatalogResponse.

        所有者来源,IAM-云用户,SAML-联邦,LDAP-ld用户,LOCAL-本地用户,AGENTTENANT-委托,OTHER-其它。LakeFormation服务分为一期和二期，一期响应Body无该参数。

        :return: The owner_source of this UpdateCatalogResponse.
        :rtype: str
        """
    ...
    def owner_source(self, owner_source):
        r"""Sets the owner_source of this UpdateCatalogResponse.

        所有者来源,IAM-云用户,SAML-联邦,LDAP-ld用户,LOCAL-本地用户,AGENTTENANT-委托,OTHER-其它。LakeFormation服务分为一期和二期，一期响应Body无该参数。

        :param owner_source: The owner_source of this UpdateCatalogResponse.
        :type owner_source: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateCatalogResponse.to_dict() is deprecated and no longer maintained, "
