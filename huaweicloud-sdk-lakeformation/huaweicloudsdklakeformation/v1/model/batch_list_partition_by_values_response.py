...
class BatchListPartitionByValuesResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchListPartitionByValuesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchListPartitionByValuesResponse):
            return False
