...
class ListFunctionNamesResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListFunctionNamesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListFunctionNamesResponse):
            return False
