...
class MoveLakeFormationInstanceOutRecycleBinResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("MoveLakeFormationInstanceOutRecycleBinResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MoveLakeFormationInstanceOutRecycleBinResponse):
            return False
