...
class Dataset:
    ...
    def catalog_name(self):
        r"""Gets the catalog_name of this Dataset.

        catalog名称

        :return: The catalog_name of this Dataset.
        :rtype: str
        """
    ...
    def catalog_name(self, catalog_name):
        r"""Sets the catalog_name of this Dataset.

        catalog名称

        :param catalog_name: The catalog_name of this Dataset.
        :type catalog_name: str
        """
    ...
    @property
    def catalog_id(self):
        r"""Gets the catalog_id of this Dataset.

        catalogID

        :return: The catalog_id of this Dataset.
        :rtype: str
        """
    ...
    def catalog_id(self, catalog_id):
        r"""Sets the catalog_id of this Dataset.

        catalogID

        :param catalog_id: The catalog_id of this Dataset.
        :type catalog_id: str
        """
    ...
    def dataset_name(self):
        r"""Gets the dataset_name of this Dataset.
    ...
    def dataset_name(self, dataset_name):
        r"""Sets the dataset_name of this Dataset.
    ...
    @property
    def dataset_id(self):
        r"""Gets the dataset_id of this Dataset.
    ...
    def dataset_id(self, dataset_id):
        r"""Sets the dataset_id of this Dataset.
    ...
    def database_name(self):
        r"""Gets the database_name of this Dataset.

        数据库名称。

        :return: The database_name of this Dataset.
        :rtype: str
        """
    ...
    def database_name(self, database_name):
        r"""Sets the database_name of this Dataset.

        数据库名称。

        :param database_name: The database_name of this Dataset.
        :type database_name: str
        """
    ...
    def database_id(self):
        r"""Gets the database_id of this Dataset.

        数据库ID。

        :return: The database_id of this Dataset.
        :rtype: str
        """
    ...
    def database_id(self, database_id):
        r"""Sets the database_id of this Dataset.

        数据库ID。

        :param database_id: The database_id of this Dataset.
        :type database_id: str
        """
    ...
    def storage_type(self):
        r"""Gets the storage_type of this Dataset.
    ...
    def storage_type(self, storage_type):
        r"""Sets the storage_type of this Dataset.
    ...
    def dataset_format(self):
        r"""Gets the dataset_format of this Dataset.

        :return: The dataset_format of this Dataset.
    ...
    def dataset_format(self, dataset_format):
        r"""Sets the dataset_format of this Dataset.

        :param dataset_format: The dataset_format of this Dataset.
        :type dataset_format: :class:`huaweicloudsdklakeformation.v1.DatasetFileFormat`
        """
    ...
    @property
    def owner(self):
        r"""Gets the owner of this Dataset.
    ...
    def owner(self, owner):
        r"""Sets the owner of this Dataset.
    ...
    @property
    def owner_type(self):
        r"""Gets the owner_type of this Dataset.

        所有者类型,USER-用户,GROUP-组,ROLE-角色。LakeFormation服务一期实例响应Body无该参数。

        :return: The owner_type of this Dataset.
        :rtype: str
        """
    ...
    def owner_type(self, owner_type):
        r"""Sets the owner_type of this Dataset.

        所有者类型,USER-用户,GROUP-组,ROLE-角色。LakeFormation服务一期实例响应Body无该参数。

        :param owner_type: The owner_type of this Dataset.
        :type owner_type: str
        """
    ...
    def owner_source(self, owner_source):
        r"""Sets the owner_source of this Dataset.

        所有者来源,IAM-云用户,SAML-联邦,LDAP-ld用户,LOCAL-本地用户,AGENTTENANT-委托,OTHER-其它。LakeFormation服务一期实例响应Body无该参数。

        :param owner_source: The owner_source of this Dataset.
        :type owner_source: str
        """
    ...
    @property
    def location(self):
        r"""Gets the location of this Dataset.
    ...
    def location(self, location):
        r"""Sets the location of this Dataset.
    ...
    @property
    def properties(self):
        r"""Gets the properties of this Dataset.

        数据集其他属性

        :return: The properties of this Dataset.
        :rtype: dict(str, str)
        """
    ...
    def properties(self, properties):
        r"""Sets the properties of this Dataset.

        数据集其他属性

        :param properties: The properties of this Dataset.
        :type properties: dict(str, str)
        """
    ...
    def create_time(self):
        r"""Gets the create_time of this Dataset.
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this Dataset.
    ...
    def update_time(self):
        r"""Gets the update_time of this Dataset.

        数据集修改时间

        :return: The update_time of this Dataset.
        :rtype: datetime
        """
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this Dataset.

        数据集修改时间

        :param update_time: The update_time of this Dataset.
        :type update_time: datetime
        """
