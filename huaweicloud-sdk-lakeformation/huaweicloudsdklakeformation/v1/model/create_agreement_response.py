...
class CreateAgreementResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateAgreementResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateAgreementResponse):
            return False
