...
class UpdateRolesResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateRolesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateRolesResponse):
            return False
