...
class ListAllFunctionsResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAllFunctionsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAllFunctionsResponse):
            return False
