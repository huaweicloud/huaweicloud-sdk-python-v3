...
class AuthorizeAccessServiceRequest:
    ...
    openapi_types = {
        'body': 'GrantAccessServiceRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the AuthorizeAccessServiceRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AuthorizeAccessServiceRequest):
            return False
