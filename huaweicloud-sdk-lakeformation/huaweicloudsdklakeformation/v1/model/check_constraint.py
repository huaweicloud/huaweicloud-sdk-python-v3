...
class CheckConstraint:
    ...
    def catalog_name(self):
        r"""Gets the catalog_name of this CheckConstraint.
    ...
    def catalog_name(self, catalog_name):
        r"""Sets the catalog_name of this CheckConstraint.
    ...
    def database_name(self):
        r"""Gets the database_name of this CheckConstraint.
    ...
    def database_name(self, database_name):
        r"""Sets the database_name of this CheckConstraint.
    ...
    @property
    def table_name(self):
        r"""Gets the table_name of this CheckConstraint.
    ...
    def table_name(self, table_name):
        r"""Sets the table_name of this CheckConstraint.
    ...
    def column_name(self):
        r"""Gets the column_name of this CheckConstraint.
    ...
    def column_name(self, column_name):
        r"""Sets the column_name of this CheckConstraint.
    ...
    def constraint_name(self):
        r"""Gets the constraint_name of this CheckConstraint.
    ...
    def constraint_name(self, constraint_name):
        r"""Sets the constraint_name of this CheckConstraint.
    ...
    def check_expression(self):
        r"""Gets the check_expression of this CheckConstraint.
    ...
    def check_expression(self, check_expression):
        r"""Sets the check_expression of this CheckConstraint.
    ...
    def enable_constraint(self):
        r"""Gets the enable_constraint of this CheckConstraint.
    ...
    def enable_constraint(self, enable_constraint):
        r"""Sets the enable_constraint of this CheckConstraint.
    ...
    def rely_constraint(self):
        r"""Gets the rely_constraint of this CheckConstraint.
    ...
    def rely_constraint(self, rely_constraint):
        r"""Sets the rely_constraint of this CheckConstraint.
    ...
    def validate_constraint(self):
        r"""Gets the validate_constraint of this CheckConstraint.
    ...
    def validate_constraint(self, validate_constraint):
        r"""Sets the validate_constraint of this CheckConstraint.
