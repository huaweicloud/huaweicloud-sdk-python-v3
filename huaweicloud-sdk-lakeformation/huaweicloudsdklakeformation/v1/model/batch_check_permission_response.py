...
class BatchCheckPermissionResponse(SdkResponse):
    ...
    openapi_types = {
        'body': 'list[CheckPermissionResult]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchCheckPermissionResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchCheckPermissionResponse):
            return False
