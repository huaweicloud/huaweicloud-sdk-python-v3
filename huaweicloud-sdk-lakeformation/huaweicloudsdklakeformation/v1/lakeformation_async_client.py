...
class LakeFormationAsyncClient(Client):
    ...
    def create_dataset_async(self, request):
        r"""创建数据集
    ...
    def create_dataset_async_invoker(self, request):
        http_info = self._create_dataset_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_dataset_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def delete_dataset_async(self, request):
        r"""删除数据集
    ...
    def delete_dataset_async_invoker(self, request):
        http_info = self._delete_dataset_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_dataset_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_datasets_async(self, request):
        r"""查询数据集列表
    ...
    def list_datasets_async_invoker(self, request):
        http_info = self._list_datasets_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_datasets_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/{project_id}/instances/{instance_id}/catalogs/{catalog_name}/databases/{database_name}/datasets",
            "request_type": request.__class__.__name__,
    ...
    def update_dataset_async(self, request):
        r"""修改数据集属性
    ...
    def update_dataset_async_invoker(self, request):
        http_info = self._update_dataset_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_dataset_http_info(self, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v1/{project_id}/instances/{instance_id}/catalogs/{catalog_name}/databases/{database_name}/datasets/{dataset_name}",
            "request_type": request.__class__.__name__,
