...
class RunEventExtractionResponse(SdkResponse):
    ...
    openapi_types = {
        'events': 'list[EventExtractionResponseItem]',
        'error_code': 'str',
        'error_msg': 'str'
    }
    ...
    @property
    def events(self):
        r"""Gets the events of this RunEventExtractionResponse.
    ...
    def events(self, events):
        r"""Sets the events of this RunEventExtractionResponse.
    ...
    @property
    def error_code(self):
        r"""Gets the error_code of this RunEventExtractionResponse.

        调用失败时的错误码，具体请参见错误码。调用成功时无此字段。

        :return: The error_code of this RunEventExtractionResponse.
        :rtype: str
        """
    ...
    def error_code(self, error_code):
        r"""Sets the error_code of this RunEventExtractionResponse.
    ...
    @property
    def error_msg(self):
        r"""Gets the error_msg of this RunEventExtractionResponse.

        调用失败时的错误信息。调用成功时无此字段。

        :return: The error_msg of this RunEventExtractionResponse.
        :rtype: str
        """
    ...
    def error_msg(self, error_msg):
        r"""Sets the error_msg of this RunEventExtractionResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunEventExtractionResponse):
            return False
