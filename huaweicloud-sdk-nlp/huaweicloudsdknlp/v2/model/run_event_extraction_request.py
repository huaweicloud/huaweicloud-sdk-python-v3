...
class RunEventExtractionRequest:
    ...
    def __init__(self, body=None):
        """RunEventExtractionRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunEventExtractionRequest):
            return False
