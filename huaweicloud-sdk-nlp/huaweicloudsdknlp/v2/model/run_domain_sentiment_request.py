...
class RunDomainSentimentRequest:
    ...
    def __init__(self, body=None):
        """RunDomainSentimentRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunDomainSentimentRequest):
            return False
