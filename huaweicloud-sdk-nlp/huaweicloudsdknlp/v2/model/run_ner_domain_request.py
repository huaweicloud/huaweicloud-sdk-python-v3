...
class RunNerDomainRequest:
    ...
    def __init__(self, body=None):
        """RunNerDomainRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunNerDomainRequest):
            return False
