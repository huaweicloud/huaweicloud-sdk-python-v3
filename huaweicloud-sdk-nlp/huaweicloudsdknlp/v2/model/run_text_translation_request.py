...
class RunTextTranslationRequest:
    ...
    def __init__(self, body=None):
        """RunTextTranslationRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunTextTranslationRequest):
            return False
