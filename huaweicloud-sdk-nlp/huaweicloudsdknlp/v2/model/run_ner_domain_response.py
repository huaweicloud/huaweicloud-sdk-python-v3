...
class RunNerDomainResponse(SdkResponse):
    ...
    openapi_types = {
        'named_entities': 'list[DomainNamedEntity]',
        'error_code': 'str',
        'error_msg': 'str'
    }
    ...
    def named_entities(self):
        r"""Gets the named_entities of this RunNerDomainResponse.
    ...
    def named_entities(self, named_entities):
        r"""Sets the named_entities of this RunNerDomainResponse.
    ...
    @property
    def error_code(self):
        r"""Gets the error_code of this RunNerDomainResponse.

        调用失败时的错误码，具体请参见错误码。调用成功时无此字段。

        :return: The error_code of this RunNerDomainResponse.
        :rtype: str
        """
    ...
    def error_code(self, error_code):
        r"""Sets the error_code of this RunNerDomainResponse.
    ...
    @property
    def error_msg(self):
        r"""Gets the error_msg of this RunNerDomainResponse.

        调用失败时的错误信息。调用成功时无此字段。

        :return: The error_msg of this RunNerDomainResponse.
        :rtype: str
        """
    ...
    def error_msg(self, error_msg):
        r"""Sets the error_msg of this RunNerDomainResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("RunNerDomainResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunNerDomainResponse):
            return False
