...
class RunEntitySentimentRequest:
    ...
    def __init__(self, body=None):
        """RunEntitySentimentRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunEntitySentimentRequest):
            return False
