...
class RunAspectSentimentResponse(SdkResponse):
    ...
    @property
    def text(self):
        r"""Gets the text of this RunAspectSentimentResponse.
    ...
    @text.setter
    def text(self, text):
        r"""Sets the text of this RunAspectSentimentResponse.
    ...
    @property
    def label(self):
        r"""Gets the label of this RunAspectSentimentResponse.
    ...
    def label(self, label):
        r"""Sets the label of this RunAspectSentimentResponse.
    ...
    @property
    def confidence(self):
        r"""Gets the confidence of this RunAspectSentimentResponse.
    ...
    def confidence(self, confidence):
        r"""Sets the confidence of this RunAspectSentimentResponse.
    ...
    def aspect_opinions(self):
        r"""Gets the aspect_opinions of this RunAspectSentimentResponse.
    ...
    def aspect_opinions(self, aspect_opinions):
        r"""Sets the aspect_opinions of this RunAspectSentimentResponse.
    ...
    @property
    def error_code(self):
        r"""Gets the error_code of this RunAspectSentimentResponse.
    ...
    def error_code(self, error_code):
        r"""Sets the error_code of this RunAspectSentimentResponse.
    ...
    @property
    def error_msg(self):
        r"""Gets the error_msg of this RunAspectSentimentResponse.
    ...
    def error_msg(self, error_msg):
        r"""Sets the error_msg of this RunAspectSentimentResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("RunAspectSentimentResponse.to_dict() is deprecated and no longer maintained, "
