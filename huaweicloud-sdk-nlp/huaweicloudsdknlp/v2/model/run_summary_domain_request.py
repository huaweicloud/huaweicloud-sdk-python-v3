...
class RunSummaryDomainRequest:
    ...
    def __init__(self, body=None):
        """RunSummaryDomainRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunSummaryDomainRequest):
            return False
