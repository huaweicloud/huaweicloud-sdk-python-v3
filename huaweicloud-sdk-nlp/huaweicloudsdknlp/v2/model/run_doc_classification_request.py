...
class RunDocClassificationRequest:
    ...
    openapi_types = {
        'body': 'DocumentClassificationReq'
    }
    ...
    def __init__(self, body=None):
        """RunDocClassificationRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: DocumentClassificationReq
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunDocClassificationRequest):
            return False
