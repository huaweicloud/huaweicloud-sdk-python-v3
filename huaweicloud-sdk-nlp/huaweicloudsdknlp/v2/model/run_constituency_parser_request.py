...
class RunConstituencyParserRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the RunConstituencyParserRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunConstituencyParserRequest):
            return False
