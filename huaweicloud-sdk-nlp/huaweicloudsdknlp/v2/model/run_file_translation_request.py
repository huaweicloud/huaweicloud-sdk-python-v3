...
class RunFileTranslationRequest:
    ...
    @property
    def body(self):
        r"""Gets the body of this RunFileTranslationRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this RunFileTranslationRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunFileTranslationRequest):
            return False
