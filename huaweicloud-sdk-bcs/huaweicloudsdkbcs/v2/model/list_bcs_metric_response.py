...
class ListBcsMetricResponse(SdkResponse):
    ...
    @property
    def metrics(self):
        r"""Gets the metrics of this ListBcsMetricResponse.
    ...
    def metrics(self, metrics):
        r"""Sets the metrics of this ListBcsMetricResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListBcsMetricResponse.to_dict() is deprecated and no longer maintained, "
