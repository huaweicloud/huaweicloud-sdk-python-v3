...
class HandleUnionMemberQuitListRequest:
    ...
    openapi_types = {
        'body': 'QuitUnionFromMemberListRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the HandleUnionMemberQuitListRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HandleUnionMemberQuitListRequest):
            return False
