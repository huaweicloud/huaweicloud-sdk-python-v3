...
class DownloadBlockchainSdkConfigResponse(SdkStreamResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DownloadBlockchainSdkConfigResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DownloadBlockchainSdkConfigResponse):
            return False
