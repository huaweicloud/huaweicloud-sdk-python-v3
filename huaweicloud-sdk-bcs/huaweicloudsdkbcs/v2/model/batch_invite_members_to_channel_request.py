...
class BatchInviteMembersToChannelRequest:
    ...
    openapi_types = {
        'body': 'BatchInviteMembersToChannelRequestBody'
    }
    ...
    def __init__(self, body=None):
        r"""BatchInviteMembersToChannelRequest
    ...
    @property
    def body(self):
        r"""Gets the body of this BatchInviteMembersToChannelRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this BatchInviteMembersToChannelRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchInviteMembersToChannelRequest):
            return False
