...
class ShowChatResponse(SdkResponse):
    ...
    openapi_types = {
        ...
        'route_id': 'str',
        'chat_messages': 'list[list[object]]',
        'x_chat_route_id': 'str'
    }
    ...
    def __init__(self, id=None, title=None, alias=None, create_time=None, update_time=None, repo_ids=None, agent_type=None, route_id=None, chat_messages=None, x_chat_route_id=None):
        r"""ShowChatResponse
        ...
        :param agent_type: 
        :type agent_type: :class:`huaweicloudsdkoptverse.v1.AgentType`
        :param route_id: **参数解释**： 对话路由ID。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及 
        :type route_id: str
        :param chat_messages: **参数解释**： 对话消息列表，每轮对话为一个二元数组，包含用户问题(Object)和Agent回答(Array)。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及 
        :type chat_messages: list[list[object]]
    ...
    @property
    def route_id(self):
        r"""Gets the route_id of this ShowChatResponse.

        **参数解释**： 对话路由ID。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及 

        :return: The route_id of this ShowChatResponse.
        :rtype: str
        """
    ...
    def route_id(self, route_id):
        r"""Sets the route_id of this ShowChatResponse.

        **参数解释**： 对话路由ID。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及 

        :param route_id: The route_id of this ShowChatResponse.
        :type route_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowChatResponse.to_dict() is deprecated and no longer maintained, "
