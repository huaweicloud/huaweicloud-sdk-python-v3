...
class ListChatResponse(SdkResponse):
    ...
    def __init__(self, chats=None, count=None):
        ...
        :type chats: list[:class:`huaweicloudsdkoptverse.v1.ChatRsp`]
    ...
    def chats(self):
        ...
        **参数解释**： 对话列表。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及 
        ...
        :rtype: list[:class:`huaweicloudsdkoptverse.v1.ChatRsp`]
        """
        return self._chats
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListChatResponse.to_dict() is deprecated and no longer maintained, "
