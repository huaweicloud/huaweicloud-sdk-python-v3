...
class CancelChatRequest:
    ...
    def __init__(self, x_chat_route_id=None, chat_id=None):
        r"""CancelChatRequest
    ...
    def x_chat_route_id(self):
        r"""Gets the x_chat_route_id of this CancelChatRequest.

        **参数解释**： 对话路由ID。 **约束限制**： 不涉及 **取值范围**： 仅支持字母、数字、中划线和下划线，长度为[1-64]个字符。 **默认取值**： 不涉及 

        :return: The x_chat_route_id of this CancelChatRequest.
        :rtype: str
        """
    ...
    def x_chat_route_id(self, x_chat_route_id):
        r"""Sets the x_chat_route_id of this CancelChatRequest.

        **参数解释**： 对话路由ID。 **约束限制**： 不涉及 **取值范围**： 仅支持字母、数字、中划线和下划线，长度为[1-64]个字符。 **默认取值**： 不涉及 

        :param x_chat_route_id: The x_chat_route_id of this CancelChatRequest.
        :type x_chat_route_id: str
        """
    ...
    @property
    def chat_id(self):
        r"""Gets the chat_id of this CancelChatRequest.

        **参数解释**： 对话ID。 **约束限制**： 不涉及 **取值范围**： 仅支持字母、数字、中划线和下划线，长度为[1-128]个字符。 **默认取值**： 不涉及 

        :return: The chat_id of this CancelChatRequest.
        :rtype: str
        """
    ...
    def chat_id(self, chat_id):
        r"""Sets the chat_id of this CancelChatRequest.

        **参数解释**： 对话ID。 **约束限制**： 不涉及 **取值范围**： 仅支持字母、数字、中划线和下划线，长度为[1-128]个字符。 **默认取值**： 不涉及 

        :param chat_id: The chat_id of this CancelChatRequest.
        :type chat_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CancelChatRequest):
            return False
