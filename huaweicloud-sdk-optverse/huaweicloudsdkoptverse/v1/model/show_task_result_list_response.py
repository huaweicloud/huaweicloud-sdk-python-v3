...
class ShowTaskResultListResponse(SdkResponse):
    ...
    def meta_start_at(self):
        r"""Gets the meta_start_at of this ShowTaskResultListResponse.

        **参数解释**： 演化任务启动时间,单位毫秒。 **约束限制**： 不涉及 **取值范围**： 取值范围[0,9999999999999]。 **默认取值**： 不涉及 

        :return: The meta_start_at of this ShowTaskResultListResponse.
        :rtype: int
        """
    ...
    def meta_start_at(self, meta_start_at):
        r"""Sets the meta_start_at of this ShowTaskResultListResponse.

        **参数解释**： 演化任务启动时间,单位毫秒。 **约束限制**： 不涉及 **取值范围**： 取值范围[0,9999999999999]。 **默认取值**： 不涉及 

        :param meta_start_at: The meta_start_at of this ShowTaskResultListResponse.
        :type meta_start_at: int
        """
    ...
    def meta_finish_at(self):
        r"""Gets the meta_finish_at of this ShowTaskResultListResponse.

        **参数解释**： 演化任务完成时间,单位毫秒。 **约束限制**： 不涉及 **取值范围**： 取值范围[0,9999999999999]。 **默认取值**： 不涉及 

        :return: The meta_finish_at of this ShowTaskResultListResponse.
        :rtype: int
        """
    ...
    def meta_finish_at(self, meta_finish_at):
        r"""Sets the meta_finish_at of this ShowTaskResultListResponse.

        **参数解释**： 演化任务完成时间,单位毫秒。 **约束限制**： 不涉及 **取值范围**： 取值范围[0,9999999999999]。 **默认取值**： 不涉及 

        :param meta_finish_at: The meta_finish_at of this ShowTaskResultListResponse.
        :type meta_finish_at: int
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowTaskResultListResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowTaskResultListResponse):
            return False
