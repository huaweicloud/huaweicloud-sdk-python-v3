...
class ListChatRequest:
    ...
    def __init__(self, limit=None, offset=None, sort_dir=None, title=None, agent_type=None):
        r"""ListChatRequest
        ...
        :type title: str
        :param agent_type: **参数解释**： 对话名称，支持模糊搜索。 **约束限制**： 不涉及 **取值范围**： * optverse：天筹工具链 * predict：预测工具链 * vrp：路径规划工具链 * demand：需求助手 **默认取值**： 不涉及 
        :type agent_type: str
        """
    ...
    @property
    def agent_type(self):
        r"""Gets the agent_type of this ListChatRequest.

        **参数解释**： 对话名称，支持模糊搜索。 **约束限制**： 不涉及 **取值范围**： * optverse：天筹工具链 * predict：预测工具链 * vrp：路径规划工具链 * demand：需求助手 **默认取值**： 不涉及 

        :return: The agent_type of this ListChatRequest.
        :rtype: str
        """
    ...
    def agent_type(self, agent_type):
        r"""Sets the agent_type of this ListChatRequest.

        **参数解释**： 对话名称，支持模糊搜索。 **约束限制**： 不涉及 **取值范围**： * optverse：天筹工具链 * predict：预测工具链 * vrp：路径规划工具链 * demand：需求助手 **默认取值**： 不涉及 

        :param agent_type: The agent_type of this ListChatRequest.
        :type agent_type: str
        """
