...
class ListAlgorithmsResponse(SdkResponse):
    ...
    @property
    def meta_info(self):
        r"""Gets the meta_info of this ListAlgorithmsResponse.

        :return: The meta_info of this ListAlgorithmsResponse.
    ...
    def meta_info(self, meta_info):
        r"""Sets the meta_info of this ListAlgorithmsResponse.

        :param meta_info: The meta_info of this ListAlgorithmsResponse.
        :type meta_info: :class:`huaweicloudsdkoptverse.v1.MetaInfo`
        """
    ...
    @property
    def payload(self):
        r"""Gets the payload of this ListAlgorithmsResponse.

        :return: The payload of this ListAlgorithmsResponse.
    ...
    def payload(self, payload):
        r"""Sets the payload of this ListAlgorithmsResponse.

        :param payload: The payload of this ListAlgorithmsResponse.
        :type payload: :class:`huaweicloudsdkoptverse.v1.PayloadObject`
        """
