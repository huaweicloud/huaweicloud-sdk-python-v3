...
class StopEvolveTaskRequest:
    ...
    def evolve_task_id(self):
        r"""Gets the evolve_task_id of this StopEvolveTaskRequest.

        **参数解释**： 演化任务标识符。 **约束限制**： 不涉及 **取值范围**： 仅支持字母、数字、中划线和下划线，长度为[1-128]个字符。 **默认取值**： 不涉及 

        :return: The evolve_task_id of this StopEvolveTaskRequest.
        :rtype: str
        """
    ...
    def evolve_task_id(self, evolve_task_id):
        r"""Sets the evolve_task_id of this StopEvolveTaskRequest.

        **参数解释**： 演化任务标识符。 **约束限制**： 不涉及 **取值范围**： 仅支持字母、数字、中划线和下划线，长度为[1-128]个字符。 **默认取值**： 不涉及 

        :param evolve_task_id: The evolve_task_id of this StopEvolveTaskRequest.
        :type evolve_task_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StopEvolveTaskRequest):
            return False
