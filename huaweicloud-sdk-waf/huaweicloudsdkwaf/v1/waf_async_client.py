...
class WafAsyncClient(Client):
    ...
    def batch_update_bot_m_rule_action_async_invoker(self, request):
        http_info = self._batch_update_bot_m_rule_action_http_info(request)
        return AsyncInvoker(self, http_info)

    def _batch_update_bot_m_rule_action_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def list_bot_m_request_distribution_async(self, request):
        r"""查询BotM中bot的请求分布
    ...
    def list_bot_m_request_distribution_async_invoker(self, request):
        http_info = self._list_bot_m_request_distribution_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_bot_m_request_distribution_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_bot_m_rules_async(self, request):
        r"""查询BotM所有规则
    ...
    def list_bot_m_rules_async_invoker(self, request):
        http_info = self._list_bot_m_rules_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_bot_m_rules_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_bot_m_score_distribution_async(self, request):
        r"""查询BotM中bot的评分分布
    ...
    def list_bot_m_score_distribution_async_invoker(self, request):
        http_info = self._list_bot_m_score_distribution_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_bot_m_score_distribution_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_bot_m_timeline_async(self, request):
        r"""查询BotM中bot的请求时间趋势
    ...
    def list_bot_m_timeline_async_invoker(self, request):
        http_info = self._list_bot_m_timeline_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_bot_m_timeline_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_bot_m_topn_request_async(self, request):
    ...
    def list_bot_m_topn_request_async_invoker(self, request):
        http_info = self._list_bot_m_topn_request_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_bot_m_topn_request_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_llm_guard_policy_rules_async(self, request):
        r"""查询所有策略大模型防护规则
    ...
    def list_llm_guard_policy_rules_async_invoker(self, request):
        http_info = self._list_llm_guard_policy_rules_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_llm_guard_policy_rules_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def update_bot_m_category_status_async(self, request):
    ...
    def update_bot_m_category_status_async_invoker(self, request):
        http_info = self._update_bot_m_category_status_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_bot_m_category_status_http_info(self, request):
        http_info = {
            "method": "PUT",
    ...
    def update_bot_m_rule_defense_strategy_async(self, request):
        r"""更新BotM行为检测规则的防护策略
    ...
    def update_bot_m_rule_defense_strategy_async_invoker(self, request):
        http_info = self._update_bot_m_rule_defense_strategy_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_bot_m_rule_defense_strategy_http_info(self, request):
        http_info = {
            "method": "PUT",
