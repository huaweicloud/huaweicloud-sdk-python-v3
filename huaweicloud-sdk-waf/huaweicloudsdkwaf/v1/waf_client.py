...
class WafClient(Client):
    ...
    def batch_update_bot_m_rule_status(self, request):
        r"""批量更新BotM规则启用状态
    ...
    def batch_update_bot_m_rule_status_invoker(self, request):
        http_info = self._batch_update_bot_m_rule_status_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _batch_update_bot_m_rule_status_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def batch_update_protect_status(self, request):
    ...
    def batch_update_protect_status_invoker(self, request):
        http_info = self._batch_update_protect_status_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _batch_update_protect_status_http_info(cls, request):
        http_info = {
            "method": "PUT",
    ...
    def create_bot_m_traffic_detection_condition(self, request):
        r"""创建BotM流量检测条件
    ...
    def create_bot_m_traffic_detection_condition_invoker(self, request):
        http_info = self._create_bot_m_traffic_detection_condition_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_bot_m_traffic_detection_condition_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def delete_bot_m_traffic_detection_condition(self, request):
        r"""删除BotM流量检测条件
    ...
    def delete_bot_m_traffic_detection_condition_invoker(self, request):
        http_info = self._delete_bot_m_traffic_detection_condition_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_bot_m_traffic_detection_condition_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def update_bot_m_traffic_detection_condition(self, request):
        r"""更新BotM流量检测条件
    ...
    def update_bot_m_traffic_detection_condition_invoker(self, request):
        http_info = self._update_bot_m_traffic_detection_condition_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_bot_m_traffic_detection_condition_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v1/{project_id}/waf/policy/{policy_id}/bot-manager/traffic-detection-condition/{condition_id}",
            "request_type": request.__class__.__name__,
