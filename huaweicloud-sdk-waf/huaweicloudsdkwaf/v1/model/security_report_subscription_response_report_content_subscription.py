...
class SecurityReportSubscriptionResponseReportContentSubscription:
    ...
    def __init__(self, overview_statistics_enable=None, group_by_day_enable=None, request_statistics_enable=None, qps_statistics_enable=None, bandwidth_statistics_enable=None, response_code_statistics_enable=None, attack_type_distribution_enable=None, top_attacked_domains_enable=None, top_attack_source_ips_enable=None, top_attacked_urls_enable=None, top_attack_source_locations_enable=None, top_abnormal_urls_enable=None):
        r"""SecurityReportSubscriptionResponseReportContentSubscription
        ...
        :param top_abnormal_urls_enable: **参数解释：** 是否启用TOP异常URL统计（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true
    ...
    def overview_statistics_enable(self):
        r"""Gets the overview_statistics_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用总览统计内容（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :return: The overview_statistics_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :rtype: bool
        """
    ...
    def overview_statistics_enable(self, overview_statistics_enable):
        r"""Sets the overview_statistics_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用总览统计内容（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :param overview_statistics_enable: The overview_statistics_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :type overview_statistics_enable: bool
        """
    ...
    def group_by_day_enable(self):
        r"""Gets the group_by_day_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用按天分组统计（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :return: The group_by_day_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :rtype: bool
        """
    ...
    def group_by_day_enable(self, group_by_day_enable):
        r"""Sets the group_by_day_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用按天分组统计（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :param group_by_day_enable: The group_by_day_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :type group_by_day_enable: bool
        """
    ...
    def request_statistics_enable(self):
        r"""Gets the request_statistics_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用请求次数统计内容（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :return: The request_statistics_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :rtype: bool
        """
    ...
    def request_statistics_enable(self, request_statistics_enable):
        r"""Sets the request_statistics_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用请求次数统计内容（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :param request_statistics_enable: The request_statistics_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :type request_statistics_enable: bool
        """
    ...
    def qps_statistics_enable(self):
        r"""Gets the qps_statistics_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用QPS统计内容（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :return: The qps_statistics_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :rtype: bool
        """
    ...
    def qps_statistics_enable(self, qps_statistics_enable):
        r"""Sets the qps_statistics_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用QPS统计内容（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :param qps_statistics_enable: The qps_statistics_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :type qps_statistics_enable: bool
        """
    ...
    def bandwidth_statistics_enable(self):
        r"""Gets the bandwidth_statistics_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用带宽统计内容（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :return: The bandwidth_statistics_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :rtype: bool
        """
    ...
    def bandwidth_statistics_enable(self, bandwidth_statistics_enable):
        r"""Sets the bandwidth_statistics_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用带宽统计内容（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :param bandwidth_statistics_enable: The bandwidth_statistics_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :type bandwidth_statistics_enable: bool
        """
    ...
    def response_code_statistics_enable(self):
        r"""Gets the response_code_statistics_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用响应码统计内容（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :return: The response_code_statistics_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :rtype: bool
        """
    ...
    def response_code_statistics_enable(self, response_code_statistics_enable):
        r"""Sets the response_code_statistics_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用响应码统计内容（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :param response_code_statistics_enable: The response_code_statistics_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :type response_code_statistics_enable: bool
        """
    ...
    def attack_type_distribution_enable(self):
        r"""Gets the attack_type_distribution_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用攻击类型分布统计（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :return: The attack_type_distribution_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :rtype: bool
        """
    ...
    def attack_type_distribution_enable(self, attack_type_distribution_enable):
        r"""Sets the attack_type_distribution_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用攻击类型分布统计（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :param attack_type_distribution_enable: The attack_type_distribution_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :type attack_type_distribution_enable: bool
        """
    ...
    def top_attacked_domains_enable(self):
        r"""Gets the top_attacked_domains_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用TOP被攻击域名统计（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :return: The top_attacked_domains_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :rtype: bool
        """
    ...
    def top_attacked_domains_enable(self, top_attacked_domains_enable):
        r"""Sets the top_attacked_domains_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用TOP被攻击域名统计（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :param top_attacked_domains_enable: The top_attacked_domains_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :type top_attacked_domains_enable: bool
        """
    ...
    def top_attack_source_ips_enable(self):
        r"""Gets the top_attack_source_ips_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用TOP攻击源IP统计（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :return: The top_attack_source_ips_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :rtype: bool
        """
    ...
    def top_attack_source_ips_enable(self, top_attack_source_ips_enable):
        r"""Sets the top_attack_source_ips_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用TOP攻击源IP统计（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :param top_attack_source_ips_enable: The top_attack_source_ips_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :type top_attack_source_ips_enable: bool
        """
    ...
    def top_attacked_urls_enable(self):
        r"""Gets the top_attacked_urls_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用TOP被攻击URL统计（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :return: The top_attacked_urls_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :rtype: bool
        """
    ...
    def top_attacked_urls_enable(self, top_attacked_urls_enable):
        r"""Sets the top_attacked_urls_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用TOP被攻击URL统计（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :param top_attacked_urls_enable: The top_attacked_urls_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :type top_attacked_urls_enable: bool
        """
    ...
    def top_attack_source_locations_enable(self):
        r"""Gets the top_attack_source_locations_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用TOP攻击源地理位置统计（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :return: The top_attack_source_locations_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :rtype: bool
        """
    ...
    def top_attack_source_locations_enable(self, top_attack_source_locations_enable):
        r"""Sets the top_attack_source_locations_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用TOP攻击源地理位置统计（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :param top_attack_source_locations_enable: The top_attack_source_locations_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :type top_attack_source_locations_enable: bool
        """
    ...
    def top_abnormal_urls_enable(self):
        r"""Gets the top_abnormal_urls_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用TOP异常URL统计（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :return: The top_abnormal_urls_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :rtype: bool
        """
    ...
    def top_abnormal_urls_enable(self, top_abnormal_urls_enable):
        r"""Sets the top_abnormal_urls_enable of this SecurityReportSubscriptionResponseReportContentSubscription.

        **参数解释：** 是否启用TOP异常URL统计（true表示启用，false表示禁用）。 **约束限制：** 不涉及 **取值范围：** 仅支持true、false两个布尔值 **默认取值：** true

        :param top_abnormal_urls_enable: The top_abnormal_urls_enable of this SecurityReportSubscriptionResponseReportContentSubscription.
        :type top_abnormal_urls_enable: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SecurityReportSubscriptionResponseReportContentSubscription):
            return False
