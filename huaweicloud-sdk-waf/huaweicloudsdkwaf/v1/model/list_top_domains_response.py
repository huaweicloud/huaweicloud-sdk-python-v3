...
class ListTopDomainsResponse(SdkResponse):
    ...
    openapi_types = {
        'total': 'int',
        'items': 'list[TopDomainsCountItem]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListTopDomainsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListTopDomainsResponse):
            return False
