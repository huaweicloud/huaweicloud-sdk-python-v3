...
class AlertNoticeConfig:
    ...
    def __init__(self, id=None, enabled=None, topic_urn=None, sendfreq=None, local=None, times=None, name=None, notice_class=None, nearly_expired_time=None, is_all_enterprise_project=None, description=None, prefer_html=None, threat=None):
        r"""AlertNoticeConfig
        ...
        :type enabled: bool
        :param topic_urn: **参数解释：** 通知模板，关联用于发送告警通知的SMN主题URN 查询可使用的主题，通过 云日志服务的“查询SMN主题”接口，返回体中的\&quot;topic_urn\&quot;字段 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
        :type topic_urn: str
        :param sendfreq: **参数解释：** 通知频率，控制告警通知的发送间隔 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
        :type sendfreq: int
        :param local: **参数解释：** 地区，指定告警通知的语言或地域相关配置 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
        :type local: str
    ...
    @property
    def local(self):
        r"""Gets the local of this AlertNoticeConfig.

        **参数解释：** 地区，指定告警通知的语言或地域相关配置 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :return: The local of this AlertNoticeConfig.
        :rtype: str
        """
        return self._local
    ...
    def local(self, local):
        r"""Sets the local of this AlertNoticeConfig.

        **参数解释：** 地区，指定告警通知的语言或地域相关配置 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :param local: The local of this AlertNoticeConfig.
        :type local: str
        """
        self._local = local
    ...
    def prefer_html(self):
        r"""Gets the prefer_html of this AlertNoticeConfig.

        预留参数，可忽略

        :return: The prefer_html of this AlertNoticeConfig.
        :rtype: bool
        """
    ...
    def prefer_html(self, prefer_html):
        r"""Sets the prefer_html of this AlertNoticeConfig.

        预留参数，可忽略

        :param prefer_html: The prefer_html of this AlertNoticeConfig.
        :type prefer_html: bool
        """
    ...
    @property
    def threat(self):
        r"""Gets the threat of this AlertNoticeConfig.

        告警的事件类型

        :return: The threat of this AlertNoticeConfig.
        :rtype: list[str]
        """
        return self._threat
    ...
    def threat(self, threat):
        r"""Sets the threat of this AlertNoticeConfig.

        告警的事件类型

        :param threat: The threat of this AlertNoticeConfig.
        :type threat: list[str]
        """
        self._threat = threat
