...
class DeleteIpGroupResponse(SdkResponse):
    ...
    @property
    def ip_remarks(self):
        r"""Gets the ip_remarks of this DeleteIpGroupResponse.

        ip或ip段的备注

        :return: The ip_remarks of this DeleteIpGroupResponse.
        :rtype: dict(str, str)
        """
    ...
    def ip_remarks(self, ip_remarks):
        r"""Sets the ip_remarks of this DeleteIpGroupResponse.

        ip或ip段的备注

        :param ip_remarks: The ip_remarks of this DeleteIpGroupResponse.
        :type ip_remarks: dict(str, str)
        """
