...
class ListCustomRulesRequest:
    ...
    def enterprise_project_id(self):
        r"""Gets the enterprise_project_id of this ListCustomRulesRequest.

        **参数解释：** 您可以通过调用企业项目管理服务（EPS）的查询企业项目列表接口（ListEnterpriseProject）查询企业项目ID。若需要查询当前用户所有企业项目绑定的资源信息，请传参all_granted_eps。 **约束限制：** 不涉及 **取值范围：**  - 0：代表default企业项目  - all_granted_eps：代表所有企业项目  - 其它企业项目ID：长度为36个字符 **默认取值：** 0

        :return: The enterprise_project_id of this ListCustomRulesRequest.
        :rtype: str
        """
    ...
    def enterprise_project_id(self, enterprise_project_id):
        r"""Sets the enterprise_project_id of this ListCustomRulesRequest.

        **参数解释：** 您可以通过调用企业项目管理服务（EPS）的查询企业项目列表接口（ListEnterpriseProject）查询企业项目ID。若需要查询当前用户所有企业项目绑定的资源信息，请传参all_granted_eps。 **约束限制：** 不涉及 **取值范围：**  - 0：代表default企业项目  - all_granted_eps：代表所有企业项目  - 其它企业项目ID：长度为36个字符 **默认取值：** 0

        :param enterprise_project_id: The enterprise_project_id of this ListCustomRulesRequest.
        :type enterprise_project_id: str
        """
    ...
    @property
    def policy_id(self):
        r"""Gets the policy_id of this ListCustomRulesRequest.
    ...
    def policy_id(self, policy_id):
        r"""Sets the policy_id of this ListCustomRulesRequest.
    ...
    @property
    def offset(self):
        r"""Gets the offset of this ListCustomRulesRequest.
    ...
    def offset(self, offset):
        r"""Sets the offset of this ListCustomRulesRequest.
    ...
    @property
    def limit(self):
        r"""Gets the limit of this ListCustomRulesRequest.
    ...
    def limit(self, limit):
        r"""Sets the limit of this ListCustomRulesRequest.
    ...
    @property
    def page(self):
        r"""Gets the page of this ListCustomRulesRequest.

        **参数解释：** 当前页码，与参数pagesize一起使用 **约束限制：** 不涉及 **取值范围：** [1, 记录数/pagesize] **默认取值：** 1

        :return: The page of this ListCustomRulesRequest.
        :rtype: int
        """
        return self._page
    ...
    @page.setter
    def page(self, page):
        r"""Sets the page of this ListCustomRulesRequest.

        **参数解释：** 当前页码，与参数pagesize一起使用 **约束限制：** 不涉及 **取值范围：** [1, 记录数/pagesize] **默认取值：** 1

        :param page: The page of this ListCustomRulesRequest.
        :type page: int
        """
        self._page = page
    ...
    @property
    def pagesize(self):
        r"""Gets the pagesize of this ListCustomRulesRequest.

        **参数解释：** 每页大小，与参数page一起使用 **约束限制：** 不涉及 **取值范围：** [0, 2147483647] **默认取值：** 1000

        :return: The pagesize of this ListCustomRulesRequest.
        :rtype: int
        """
    ...
    def pagesize(self, pagesize):
        r"""Sets the pagesize of this ListCustomRulesRequest.

        **参数解释：** 每页大小，与参数page一起使用 **约束限制：** 不涉及 **取值范围：** [0, 2147483647] **默认取值：** 1000

        :param pagesize: The pagesize of this ListCustomRulesRequest.
        :type pagesize: int
        """
