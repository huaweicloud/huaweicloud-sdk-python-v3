...
class BotMBehaviorDetectionRule:
    ...
    @property
    def rule(self):
        r"""Gets the rule of this BotMBehaviorDetectionRule.

        :return: The rule of this BotMBehaviorDetectionRule.
        :rtype: :class:`huaweicloudsdkwaf.v1.BotMRule`
        """
        return self._rule

    @rule.setter
    def rule(self, rule):
        r"""Sets the rule of this BotMBehaviorDetectionRule.

        :param rule: The rule of this BotMBehaviorDetectionRule.
        :type rule: :class:`huaweicloudsdkwaf.v1.BotMRule`
        """
        self._rule = rule
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BotMBehaviorDetectionRule):
            return False
