...
class ListPrivacyRuleRequest:
    ...
    def enterprise_project_id(self):
        r"""Gets the enterprise_project_id of this ListPrivacyRuleRequest.

        您可以通过调用企业项目管理服务（EPS）的查询企业项目列表接口（ListEnterpriseProject）查询企业项目id。若需要查询当前用户所有企业项目绑定的资源信息，请传参all_granted_eps。

        :return: The enterprise_project_id of this ListPrivacyRuleRequest.
        :rtype: str
        """
    ...
    def enterprise_project_id(self, enterprise_project_id):
        r"""Sets the enterprise_project_id of this ListPrivacyRuleRequest.

        您可以通过调用企业项目管理服务（EPS）的查询企业项目列表接口（ListEnterpriseProject）查询企业项目id。若需要查询当前用户所有企业项目绑定的资源信息，请传参all_granted_eps。

        :param enterprise_project_id: The enterprise_project_id of this ListPrivacyRuleRequest.
        :type enterprise_project_id: str
        """
    ...
    @property
    def policy_id(self):
        r"""Gets the policy_id of this ListPrivacyRuleRequest.
    ...
    def policy_id(self, policy_id):
        r"""Sets the policy_id of this ListPrivacyRuleRequest.
    ...
    @property
    def page(self):
        r"""Gets the page of this ListPrivacyRuleRequest.
    ...
    @page.setter
    def page(self, page):
        r"""Sets the page of this ListPrivacyRuleRequest.
    ...
    @property
    def pagesize(self):
        r"""Gets the pagesize of this ListPrivacyRuleRequest.
    ...
    def pagesize(self, pagesize):
        r"""Sets the pagesize of this ListPrivacyRuleRequest.
