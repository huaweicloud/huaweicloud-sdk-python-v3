...
class IpGroupBody:
    ...
    def __init__(self, id=None, name=None, ips=None, ip_remarks=None, size=None, rules=None, share_info=None, description=None):
        r"""IpGroupBody
    ...
    def id(self):
        ...
        :return: The id of this IpGroupBody.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this IpGroupBody.
        :type id: str
        """
        self._id = id
    ...
    def name(self):
        ...
        :return: The name of this IpGroupBody.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this IpGroupBody.
        :type name: str
        """
        self._name = name
    ...
    def ips(self):
        ...
        :return: The ips of this IpGroupBody.
        :rtype: str
        """
        return self._ips
    ...
    def ips(self, ips):
        ...
        :param ips: The ips of this IpGroupBody.
        :type ips: str
        """
        self._ips = ips
    ...
    @property
    def ip_remarks(self):
        r"""Gets the ip_remarks of this IpGroupBody.

        ip或ip段的备注

        :return: The ip_remarks of this IpGroupBody.
        :rtype: dict(str, str)
        """
    ...
    def ip_remarks(self, ip_remarks):
        r"""Sets the ip_remarks of this IpGroupBody.

        ip或ip段的备注

        :param ip_remarks: The ip_remarks of this IpGroupBody.
        :type ip_remarks: dict(str, str)
        """
    ...
    def size(self):
        ...
        :return: The size of this IpGroupBody.
        :rtype: int
        """
        return self._size
    ...
    def size(self, size):
        ...
        :param size: The size of this IpGroupBody.
        :type size: int
        """
        self._size = size
    ...
    def rules(self):
        ...
        :return: The rules of this IpGroupBody.
    ...
    def rules(self, rules):
        ...
        :param rules: The rules of this IpGroupBody.
        :type rules: list[:class:`huaweicloudsdkwaf.v1.RuleInfo`]
        """
        self._rules = rules
    ...
    def description(self):
        ...
        :return: The description of this IpGroupBody.
        :rtype: str
        """
    ...
    def description(self, description):
        ...
        :param description: The description of this IpGroupBody.
        :type description: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IpGroupBody):
            return False
