...
class ShowInstanceResponse(SdkResponse):
    ...
    def instancename(self):
        r"""Gets the instancename of this ShowInstanceResponse.

        独享引擎实例名称

        :return: The instancename of this ShowInstanceResponse.
        :rtype: str
        """
    ...
    def instancename(self, instancename):
        r"""Sets the instancename of this ShowInstanceResponse.

        独享引擎实例名称

        :param instancename: The instancename of this ShowInstanceResponse.
        :type instancename: str
        """
    ...
    @property
    def zone(self):
        r"""Gets the zone of this ShowInstanceResponse.

        可用区ID

        :return: The zone of this ShowInstanceResponse.
        :rtype: str
        """
        return self._zone
    ...
    @zone.setter
    def zone(self, zone):
        r"""Sets the zone of this ShowInstanceResponse.

        可用区ID

        :param zone: The zone of this ShowInstanceResponse.
        :type zone: str
        """
        self._zone = zone
    ...
    @property
    def arch(self):
        r"""Gets the arch of this ShowInstanceResponse.

        CPU架构

        :return: The arch of this ShowInstanceResponse.
        :rtype: str
        """
        return self._arch
    ...
    @arch.setter
    def arch(self, arch):
        r"""Sets the arch of this ShowInstanceResponse.

        CPU架构

        :param arch: The arch of this ShowInstanceResponse.
        :type arch: str
        """
        self._arch = arch
    ...
    @property
    def cpu_flavor(self):
        r"""Gets the cpu_flavor of this ShowInstanceResponse.

        ECS规格

        :return: The cpu_flavor of this ShowInstanceResponse.
        :rtype: str
        """
    ...
    def cpu_flavor(self, cpu_flavor):
        r"""Sets the cpu_flavor of this ShowInstanceResponse.

        ECS规格

        :param cpu_flavor: The cpu_flavor of this ShowInstanceResponse.
        :type cpu_flavor: str
        """
    ...
    @property
    def service_ip(self):
        r"""Gets the service_ip of this ShowInstanceResponse.

        独享引擎实例的业务面IP

        :return: The service_ip of this ShowInstanceResponse.
        :rtype: str
        """
    ...
    def service_ip(self, service_ip):
        r"""Sets the service_ip of this ShowInstanceResponse.

        独享引擎实例的业务面IP

        :param service_ip: The service_ip of this ShowInstanceResponse.
        :type service_ip: str
        """
    ...
    def security_group_ids(self):
        r"""Gets the security_group_ids of this ShowInstanceResponse.

        独享引擎绑定的安全组

        :return: The security_group_ids of this ShowInstanceResponse.
        :rtype: list[str]
        """
    ...
    def security_group_ids(self, security_group_ids):
        r"""Sets the security_group_ids of this ShowInstanceResponse.

        独享引擎绑定的安全组

        :param security_group_ids: The security_group_ids of this ShowInstanceResponse.
        :type security_group_ids: list[str]
        """
    ...
    @property
    def run_status(self):
        r"""Gets the run_status of this ShowInstanceResponse.

        独享引擎运行状态   - 0：创建中   - 1：运行中   - 2：删除中   - 3：已删除   - 4：创建失败   - 5：已冻结   - 6：异常   - 7：更新中   - 8：更新失败

        :return: The run_status of this ShowInstanceResponse.
        :rtype: int
        """
    ...
    def run_status(self, run_status):
        r"""Sets the run_status of this ShowInstanceResponse.

        独享引擎运行状态   - 0：创建中   - 1：运行中   - 2：删除中   - 3：已删除   - 4：创建失败   - 5：已冻结   - 6：异常   - 7：更新中   - 8：更新失败

        :param run_status: The run_status of this ShowInstanceResponse.
        :type run_status: int
        """
    ...
    def access_status(self):
        r"""Gets the access_status of this ShowInstanceResponse.

        独享引擎接入状态（0：未接入，1：已接入）

        :return: The access_status of this ShowInstanceResponse.
        :rtype: int
        """
    ...
    def access_status(self, access_status):
        r"""Sets the access_status of this ShowInstanceResponse.

        独享引擎接入状态（0：未接入，1：已接入）

        :param access_status: The access_status of this ShowInstanceResponse.
        :type access_status: int
        """
    ...
    @property
    def upgradable(self):
        r"""Gets the upgradable of this ShowInstanceResponse.

        独享引擎是否可升级（0：不可升级，1：可升级）

        :return: The upgradable of this ShowInstanceResponse.
        :rtype: int
        """
    ...
    def upgradable(self, upgradable):
        r"""Sets the upgradable of this ShowInstanceResponse.

        独享引擎是否可升级（0：不可升级，1：可升级）

        :param upgradable: The upgradable of this ShowInstanceResponse.
        :type upgradable: int
        """
    ...
    def cloud_service_type(self):
        r"""Gets the cloud_service_type of this ShowInstanceResponse.

        云服务代码。 仅作为标记，用户可忽略。

        :return: The cloud_service_type of this ShowInstanceResponse.
        :rtype: str
        """
    ...
    def cloud_service_type(self, cloud_service_type):
        r"""Sets the cloud_service_type of this ShowInstanceResponse.

        云服务代码。 仅作为标记，用户可忽略。

        :param cloud_service_type: The cloud_service_type of this ShowInstanceResponse.
        :type cloud_service_type: str
        """
    ...
    def resource_type(self):
        r"""Gets the resource_type of this ShowInstanceResponse.

        云服务资源类型，仅作为标记，用户可忽略。

        :return: The resource_type of this ShowInstanceResponse.
        :rtype: str
        """
    ...
    def resource_type(self, resource_type):
        r"""Sets the resource_type of this ShowInstanceResponse.

        云服务资源类型，仅作为标记，用户可忽略。

        :param resource_type: The resource_type of this ShowInstanceResponse.
        :type resource_type: str
        """
    ...
    @property
    def server_id(self):
        r"""Gets the server_id of this ShowInstanceResponse.

        独享引擎ECS ID

        :return: The server_id of this ShowInstanceResponse.
        :rtype: str
        """
    ...
    def server_id(self, server_id):
        r"""Sets the server_id of this ShowInstanceResponse.

        独享引擎ECS ID

        :param server_id: The server_id of this ShowInstanceResponse.
        :type server_id: str
        """
