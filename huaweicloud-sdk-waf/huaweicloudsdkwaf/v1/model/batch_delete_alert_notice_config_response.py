...
class BatchDeleteAlertNoticeConfigResponse(SdkResponse):
    ...
    def __init__(self, alert_notice_configs=None):
        r"""BatchDeleteAlertNoticeConfigResponse
    ...
    def alert_notice_configs(self):
        r"""Gets the alert_notice_configs of this BatchDeleteAlertNoticeConfigResponse.

        **参数解释：** 告警通知配置列表，包含多条告警通知配置信息 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :return: The alert_notice_configs of this BatchDeleteAlertNoticeConfigResponse.
    ...
    def alert_notice_configs(self, alert_notice_configs):
        r"""Sets the alert_notice_configs of this BatchDeleteAlertNoticeConfigResponse.

        **参数解释：** 告警通知配置列表，包含多条告警通知配置信息 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :param alert_notice_configs: The alert_notice_configs of this BatchDeleteAlertNoticeConfigResponse.
        :type alert_notice_configs: list[:class:`huaweicloudsdkwaf.v1.AlertNoticeConfig`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchDeleteAlertNoticeConfigResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteAlertNoticeConfigResponse):
            return False
