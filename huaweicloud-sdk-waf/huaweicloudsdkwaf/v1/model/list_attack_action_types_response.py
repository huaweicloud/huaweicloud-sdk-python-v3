...
class ListAttackActionTypesResponse(SdkResponse):
    ...
    openapi_types = {
        'total': 'int',
        'items': 'list[AttackActionCountItem]'
    }
    ...
    def __init__(self, total=None, items=None):
        r"""ListAttackActionTypesResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAttackActionTypesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAttackActionTypesResponse):
            return False
