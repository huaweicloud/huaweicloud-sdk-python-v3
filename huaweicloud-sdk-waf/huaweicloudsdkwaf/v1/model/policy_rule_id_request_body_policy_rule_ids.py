...
class PolicyRuleIdRequestBodyPolicyRuleIds:
    ...
    def __init__(self, policy_id=None, rule_ids=None):
        r"""PolicyRuleIdRequestBodyPolicyRuleIds

        The model defined in huaweicloud sdk

        :param policy_id: **参数解释：** 策略id，唯一标识一条防护策略 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
        :type policy_id: str
        :param rule_ids: **参数解释：** 规则id数组，包含当前防护策略下的多条规则ID **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
    ...
    @property
    def policy_id(self):
        r"""Gets the policy_id of this PolicyRuleIdRequestBodyPolicyRuleIds.

        **参数解释：** 策略id，唯一标识一条防护策略 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :return: The policy_id of this PolicyRuleIdRequestBodyPolicyRuleIds.
        :rtype: str
        """
    ...
    def policy_id(self, policy_id):
        r"""Sets the policy_id of this PolicyRuleIdRequestBodyPolicyRuleIds.

        **参数解释：** 策略id，唯一标识一条防护策略 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :param policy_id: The policy_id of this PolicyRuleIdRequestBodyPolicyRuleIds.
        :type policy_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PolicyRuleIdRequestBodyPolicyRuleIds):
            return False
