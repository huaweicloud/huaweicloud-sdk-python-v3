...
class ConfirmAsyncJobRequest:
    ...
    def __init__(self, job_id=None, projectid=None, enterprise_project_id=None):
        r"""ConfirmAsyncJobRequest

        The model defined in huaweicloud sdk

        :param job_id: **参数解释：** 异步任务的任务id
        :type job_id: str
    ...
    @property
    def projectid(self):
        r"""Gets the projectid of this ConfirmAsyncJobRequest.

        **参数解释：** 项目ID，对应控制台用户名->我的凭证->项目列表->项目ID。 **约束限制：** 不涉及 **取值范围：** 只能由英文字母、数字组成，且长度为32个字符。 **默认取值：** 不涉及

        :return: The projectid of this ConfirmAsyncJobRequest.
        :rtype: str
        """
    ...
    def projectid(self, projectid):
        r"""Sets the projectid of this ConfirmAsyncJobRequest.

        **参数解释：** 项目ID，对应控制台用户名->我的凭证->项目列表->项目ID。 **约束限制：** 不涉及 **取值范围：** 只能由英文字母、数字组成，且长度为32个字符。 **默认取值：** 不涉及

        :param projectid: The projectid of this ConfirmAsyncJobRequest.
        :type projectid: str
        """
