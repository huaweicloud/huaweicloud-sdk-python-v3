...
class BatchUpdateCcRulesRequestBody:
    ...
    @property
    def name(self):
        r"""Gets the name of this BatchUpdateCcRulesRequestBody.

        规则名称

        :return: The name of this BatchUpdateCcRulesRequestBody.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this BatchUpdateCcRulesRequestBody.

        规则名称

        :param name: The name of this BatchUpdateCcRulesRequestBody.
        :type name: str
        """
        self._name = name
    ...
    @property
    def mode(self):
        r"""Gets the mode of this BatchUpdateCcRulesRequestBody.

        cc规则防护模式，对应console上的mode，现在只支持创建高级cc规则防护模式。   - 0：标准，只支持对域名的防护路径做限制。  - 1：高级，支持对路径、IP、Cookie、Header、Params字段做限制。

        :return: The mode of this BatchUpdateCcRulesRequestBody.
        :rtype: int
        """
        return self._mode
    ...
    @mode.setter
    def mode(self, mode):
        r"""Sets the mode of this BatchUpdateCcRulesRequestBody.

        cc规则防护模式，对应console上的mode，现在只支持创建高级cc规则防护模式。   - 0：标准，只支持对域名的防护路径做限制。  - 1：高级，支持对路径、IP、Cookie、Header、Params字段做限制。

        :param mode: The mode of this BatchUpdateCcRulesRequestBody.
        :type mode: int
        """
        self._mode = mode
    ...
    @property
    def url(self):
        r"""Gets the url of this BatchUpdateCcRulesRequestBody.

        需要防护的域名路径，当cc防护规则为标准模式（mode参数值为0）时，该参数必填。

        :return: The url of this BatchUpdateCcRulesRequestBody.
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        r"""Sets the url of this BatchUpdateCcRulesRequestBody.

        需要防护的域名路径，当cc防护规则为标准模式（mode参数值为0）时，该参数必填。

        :param url: The url of this BatchUpdateCcRulesRequestBody.
        :type url: str
        """
        self._url = url
    ...
    @property
    def conditions(self):
        r"""Gets the conditions of this BatchUpdateCcRulesRequestBody.

        cc规则防护规则限速条件，当cc防护规则为高级模式（mode参数值为1）时，该参数必填。

        :return: The conditions of this BatchUpdateCcRulesRequestBody.
    ...
    def conditions(self, conditions):
        r"""Sets the conditions of this BatchUpdateCcRulesRequestBody.

        cc规则防护规则限速条件，当cc防护规则为高级模式（mode参数值为1）时，该参数必填。

        :param conditions: The conditions of this BatchUpdateCcRulesRequestBody.
        :type conditions: list[:class:`huaweicloudsdkwaf.v1.CcCondition`]
        """
    ...
    @property
    def action(self):
        r"""Gets the action of this BatchUpdateCcRulesRequestBody.

        :return: The action of this BatchUpdateCcRulesRequestBody.
    ...
    def action(self, action):
        r"""Sets the action of this BatchUpdateCcRulesRequestBody.

        :param action: The action of this BatchUpdateCcRulesRequestBody.
        :type action: :class:`huaweicloudsdkwaf.v1.CreateCcRuleRequestBodyAction`
        """
        self._action = action
    ...
    @property
    def tag_type(self):
        r"""Gets the tag_type of this BatchUpdateCcRulesRequestBody.
        ...
        **参数解释：** 限速模式标识，用于指定区分单个Web访问者的判断依据 **约束限制：** 不涉及 **取值范围：**  - ip：IP限速，根据IP区分单个Web访问者  - cookie：用户限速，根据Cookie键值区分单个Web访问者  - header：用户限速，根据Header区分单个Web访问者  - other：根据Referer（自定义请求访问的来源）字段区分单个Web访问者  - policy：策略限速  - domain：域名限速  - url：url限速 **默认取值：** 不涉及
        ...
        :return: The tag_type of this BatchUpdateCcRulesRequestBody.
        :rtype: str
        """
    ...
    def tag_type(self, tag_type):
        r"""Sets the tag_type of this BatchUpdateCcRulesRequestBody.

        **参数解释：** 限速模式标识，用于指定区分单个Web访问者的判断依据 **约束限制：** 不涉及 **取值范围：**  - ip：IP限速，根据IP区分单个Web访问者  - cookie：用户限速，根据Cookie键值区分单个Web访问者  - header：用户限速，根据Header区分单个Web访问者  - other：根据Referer（自定义请求访问的来源）字段区分单个Web访问者  - policy：策略限速  - domain：域名限速  - url：url限速 **默认取值：** 不涉及

        :param tag_type: The tag_type of this BatchUpdateCcRulesRequestBody.
        :type tag_type: str
        """
    ...
    @property
    def tag_index(self):
        r"""Gets the tag_index of this BatchUpdateCcRulesRequestBody.
        ...
        :return: The tag_index of this BatchUpdateCcRulesRequestBody.
        :rtype: str
        """
    ...
    def tag_index(self, tag_index):
        r"""Sets the tag_index of this BatchUpdateCcRulesRequestBody.

        用户标识，当限速模式为用户限速(cookie或header)时，需要传该参数。   - 选择cookie时，设置cookie字段名，即用户需要根据网站实际情况配置唯一可识别Web访问者的cookie中的某属性变量名。用户标识的cookie，不支持正则，必须完全匹配。例如：如果网站使用cookie中的某个字段name唯一标识用户，那么可以选取name字段来区分Web访问者。   - 选择header时，设置需要防护的自定义HTTP首部，即用户需要根据网站实际情况配置可识别Web访问者的HTTP首部。

        :param tag_index: The tag_index of this BatchUpdateCcRulesRequestBody.
        :type tag_index: str
        """
    ...
    def tag_condition(self):
        r"""Gets the tag_condition of this BatchUpdateCcRulesRequestBody.

        :return: The tag_condition of this BatchUpdateCcRulesRequestBody.
    ...
    def tag_condition(self, tag_condition):
        r"""Sets the tag_condition of this BatchUpdateCcRulesRequestBody.

        :param tag_condition: The tag_condition of this BatchUpdateCcRulesRequestBody.
        :type tag_condition: :class:`huaweicloudsdkwaf.v1.CcrulesListInfoTagCondition`
        """
    ...
    @property
    def limit_num(self):
        r"""Gets the limit_num of this BatchUpdateCcRulesRequestBody.

        限制频率，单位为次，范围为1~2147483647

        :return: The limit_num of this BatchUpdateCcRulesRequestBody.
        :rtype: int
        """
    ...
    def limit_num(self, limit_num):
        r"""Sets the limit_num of this BatchUpdateCcRulesRequestBody.

        限制频率，单位为次，范围为1~2147483647

        :param limit_num: The limit_num of this BatchUpdateCcRulesRequestBody.
        :type limit_num: int
        """
    ...
    def limit_period(self):
        r"""Gets the limit_period of this BatchUpdateCcRulesRequestBody.

        限速周期，单位为秒，范围1~3600

        :return: The limit_period of this BatchUpdateCcRulesRequestBody.
        :rtype: int
        """
    ...
    def limit_period(self, limit_period):
        r"""Sets the limit_period of this BatchUpdateCcRulesRequestBody.

        限速周期，单位为秒，范围1~3600

        :param limit_period: The limit_period of this BatchUpdateCcRulesRequestBody.
        :type limit_period: int
        """
    ...
    @property
    def unlock_num(self):
        r"""Gets the unlock_num of this BatchUpdateCcRulesRequestBody.

        放行频率，单位为次，范围为0~2147483647。只有当防护动作类型为dynamic_block时，才需要传该参数。

        :return: The unlock_num of this BatchUpdateCcRulesRequestBody.
        :rtype: int
        """
    ...
    def unlock_num(self, unlock_num):
        r"""Sets the unlock_num of this BatchUpdateCcRulesRequestBody.

        放行频率，单位为次，范围为0~2147483647。只有当防护动作类型为dynamic_block时，才需要传该参数。

        :param unlock_num: The unlock_num of this BatchUpdateCcRulesRequestBody.
        :type unlock_num: int
        """
    ...
    @property
    def lock_time(self):
        r"""Gets the lock_time of this BatchUpdateCcRulesRequestBody.

        阻断时间，单位为秒，范围为0~65535。当“防护动作”选择“阻断”时，可设置阻断后恢复正常访问页面的时间。

        :return: The lock_time of this BatchUpdateCcRulesRequestBody.
        :rtype: int
        """
    ...
    def lock_time(self, lock_time):
        r"""Sets the lock_time of this BatchUpdateCcRulesRequestBody.

        阻断时间，单位为秒，范围为0~65535。当“防护动作”选择“阻断”时，可设置阻断后恢复正常访问页面的时间。

        :param lock_time: The lock_time of this BatchUpdateCcRulesRequestBody.
        :type lock_time: int
        """
    ...
    def domain_aggregation(self):
        r"""Gets the domain_aggregation of this BatchUpdateCcRulesRequestBody.

        是否开启域名聚合统计。

        :return: The domain_aggregation of this BatchUpdateCcRulesRequestBody.
        :rtype: bool
        """
    ...
    def domain_aggregation(self, domain_aggregation):
        r"""Sets the domain_aggregation of this BatchUpdateCcRulesRequestBody.

        是否开启域名聚合统计。

        :param domain_aggregation: The domain_aggregation of this BatchUpdateCcRulesRequestBody.
        :type domain_aggregation: bool
        """
    ...
    def region_aggregation(self):
        r"""Gets the region_aggregation of this BatchUpdateCcRulesRequestBody.

        是否开启全局计数。

        :return: The region_aggregation of this BatchUpdateCcRulesRequestBody.
        :rtype: bool
        """
    ...
    def region_aggregation(self, region_aggregation):
        r"""Sets the region_aggregation of this BatchUpdateCcRulesRequestBody.

        是否开启全局计数。

        :param region_aggregation: The region_aggregation of this BatchUpdateCcRulesRequestBody.
        :type region_aggregation: bool
        """
    ...
    def description(self):
        r"""Gets the description of this BatchUpdateCcRulesRequestBody.

        规则描述

        :return: The description of this BatchUpdateCcRulesRequestBody.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this BatchUpdateCcRulesRequestBody.

        规则描述

        :param description: The description of this BatchUpdateCcRulesRequestBody.
        :type description: str
        """
    ...
    def policy_rule_ids(self):
        r"""Gets the policy_rule_ids of this BatchUpdateCcRulesRequestBody.

        **参数解释：** 策略和规则id数组，关联防护策略与对应的规则集合 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :return: The policy_rule_ids of this BatchUpdateCcRulesRequestBody.
        :rtype: list[:class:`huaweicloudsdkwaf.v1.BatchUpdateCcRulesRequestBodyPolicyRuleIds`]
        """
        return self._policy_rule_ids

    @policy_rule_ids.setter
    def policy_rule_ids(self, policy_rule_ids):
        r"""Sets the policy_rule_ids of this BatchUpdateCcRulesRequestBody.

        **参数解释：** 策略和规则id数组，关联防护策略与对应的规则集合 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :param policy_rule_ids: The policy_rule_ids of this BatchUpdateCcRulesRequestBody.
        :type policy_rule_ids: list[:class:`huaweicloudsdkwaf.v1.BatchUpdateCcRulesRequestBodyPolicyRuleIds`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchUpdateCcRulesRequestBody):
            return False
