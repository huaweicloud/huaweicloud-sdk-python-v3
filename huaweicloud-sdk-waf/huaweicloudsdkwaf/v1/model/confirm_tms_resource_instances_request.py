...
class ConfirmTmsResourceInstancesRequest:
    ...
    openapi_types = {
        'resource_type': 'str',
        'body': 'TmsResourceInstancesRequest'
    }
    ...
    def __init__(self, resource_type=None, body=None):
        r"""ConfirmTmsResourceInstancesRequest
    ...
    @property
    def body(self):
        r"""Gets the body of this ConfirmTmsResourceInstancesRequest.

        :return: The body of this ConfirmTmsResourceInstancesRequest.
        :rtype: :class:`huaweicloudsdkwaf.v1.TmsResourceInstancesRequest`
        """
        return self._body

    @body.setter
    def body(self, body):
        r"""Sets the body of this ConfirmTmsResourceInstancesRequest.

        :param body: The body of this ConfirmTmsResourceInstancesRequest.
        :type body: :class:`huaweicloudsdkwaf.v1.TmsResourceInstancesRequest`
        """
        self._body = body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfirmTmsResourceInstancesRequest):
            return False
