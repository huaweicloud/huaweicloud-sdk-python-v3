...
class PolicyRuleIdRequestBody:
    ...
    def policy_rule_ids(self):
        r"""Gets the policy_rule_ids of this PolicyRuleIdRequestBody.

        **参数解释：** 策略和规则id数组，关联防护策略与对应的规则集合 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :return: The policy_rule_ids of this PolicyRuleIdRequestBody.
    ...
    def policy_rule_ids(self, policy_rule_ids):
        r"""Sets the policy_rule_ids of this PolicyRuleIdRequestBody.

        **参数解释：** 策略和规则id数组，关联防护策略与对应的规则集合 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :param policy_rule_ids: The policy_rule_ids of this PolicyRuleIdRequestBody.
        :type policy_rule_ids: list[:class:`huaweicloudsdkwaf.v1.PolicyRuleIdRequestBodyPolicyRuleIds`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PolicyRuleIdRequestBody):
            return False
