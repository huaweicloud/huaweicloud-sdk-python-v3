...
class DeletePolicyResponse(SdkResponse):
    ...
    @property
    def id(self):
        r"""Gets the id of this DeletePolicyResponse.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this DeletePolicyResponse.
    ...
    @property
    def name(self):
        r"""Gets the name of this DeletePolicyResponse.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this DeletePolicyResponse.
    ...
    @property
    def level(self):
        r"""Gets the level of this DeletePolicyResponse.
    ...
    def level(self, level):
        r"""Sets the level of this DeletePolicyResponse.
    ...
    def full_detection(self):
        r"""Gets the full_detection of this DeletePolicyResponse.
    ...
    def full_detection(self, full_detection):
        r"""Sets the full_detection of this DeletePolicyResponse.
    ...
    def robot_action(self):
        r"""Gets the robot_action of this DeletePolicyResponse.

        :return: The robot_action of this DeletePolicyResponse.
    ...
    def robot_action(self, robot_action):
        r"""Sets the robot_action of this DeletePolicyResponse.

        :param robot_action: The robot_action of this DeletePolicyResponse.
        :type robot_action: :class:`huaweicloudsdkwaf.v1.Action`
        """
    ...
    @property
    def action(self):
        r"""Gets the action of this DeletePolicyResponse.
    ...
    def action(self, action):
        r"""Sets the action of this DeletePolicyResponse.
    ...
    @property
    def options(self):
        r"""Gets the options of this DeletePolicyResponse.
    ...
    def options(self, options):
        r"""Sets the options of this DeletePolicyResponse.
    ...
    def modulex_options(self):
        r"""Gets the modulex_options of this DeletePolicyResponse.

        智能访问控制防护项相关配置信息，目前该特性还处于公测阶段，只有部分局点支持该特性

        :return: The modulex_options of this DeletePolicyResponse.
    ...
    def modulex_options(self, modulex_options):
        r"""Sets the modulex_options of this DeletePolicyResponse.

        智能访问控制防护项相关配置信息，目前该特性还处于公测阶段，只有部分局点支持该特性

        :param modulex_options: The modulex_options of this DeletePolicyResponse.
        :type modulex_options: dict(str, object)
        """
    ...
    @property
    def hosts(self):
        r"""Gets the hosts of this DeletePolicyResponse.
    ...
    def hosts(self, hosts):
        r"""Sets the hosts of this DeletePolicyResponse.
    ...
    @property
    def bind_host(self):
        r"""Gets the bind_host of this DeletePolicyResponse.
    ...
    def bind_host(self, bind_host):
        r"""Sets the bind_host of this DeletePolicyResponse.
    ...
    @property
    def extend(self):
        r"""Gets the extend of this DeletePolicyResponse.
    ...
    def extend(self, extend):
        r"""Sets the extend of this DeletePolicyResponse.
    ...
    @property
    def timestamp(self):
        r"""Gets the timestamp of this DeletePolicyResponse.
    ...
    def timestamp(self, timestamp):
        r"""Sets the timestamp of this DeletePolicyResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeletePolicyResponse.to_dict() is deprecated and no longer maintained, "
