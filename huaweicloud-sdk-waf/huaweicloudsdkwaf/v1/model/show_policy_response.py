...
class ShowPolicyResponse(SdkResponse):
    ...
    @property
    def level(self):
        r"""Gets the level of this ShowPolicyResponse.
    ...
    def level(self, level):
        r"""Sets the level of this ShowPolicyResponse.
    ...
    def full_detection(self):
        r"""Gets the full_detection of this ShowPolicyResponse.
    ...
    def full_detection(self, full_detection):
        r"""Sets the full_detection of this ShowPolicyResponse.
    ...
    def robot_action(self):
        r"""Gets the robot_action of this ShowPolicyResponse.

        :return: The robot_action of this ShowPolicyResponse.
    ...
    def robot_action(self, robot_action):
        r"""Sets the robot_action of this ShowPolicyResponse.

        :param robot_action: The robot_action of this ShowPolicyResponse.
        :type robot_action: :class:`huaweicloudsdkwaf.v1.Action`
        """
    ...
    @property
    def action(self):
        r"""Gets the action of this ShowPolicyResponse.
    ...
    def action(self, action):
        r"""Sets the action of this ShowPolicyResponse.
    ...
    @property
    def options(self):
        r"""Gets the options of this ShowPolicyResponse.
    ...
    def options(self, options):
        r"""Sets the options of this ShowPolicyResponse.
    ...
    def modulex_options(self):
        r"""Gets the modulex_options of this ShowPolicyResponse.

        智能访问控制防护项相关配置信息，目前该特性还处于公测阶段，只有部分局点支持该特性

        :return: The modulex_options of this ShowPolicyResponse.
    ...
    def modulex_options(self, modulex_options):
        r"""Sets the modulex_options of this ShowPolicyResponse.

        智能访问控制防护项相关配置信息，目前该特性还处于公测阶段，只有部分局点支持该特性

        :param modulex_options: The modulex_options of this ShowPolicyResponse.
        :type modulex_options: dict(str, object)
        """
    ...
    @property
    def hosts(self):
        r"""Gets the hosts of this ShowPolicyResponse.

        与防护策略绑定的防护的域名id数组

        :return: The hosts of this ShowPolicyResponse.
        :rtype: list[str]
        """
        return self._hosts
    ...
    def hosts(self, hosts):
        r"""Sets the hosts of this ShowPolicyResponse.

        与防护策略绑定的防护的域名id数组

        :param hosts: The hosts of this ShowPolicyResponse.
        :type hosts: list[str]
        """
        self._hosts = hosts
    ...
    @property
    def bind_host(self):
        r"""Gets the bind_host of this ShowPolicyResponse.
    ...
    def bind_host(self, bind_host):
        r"""Sets the bind_host of this ShowPolicyResponse.
    ...
    @property
    def extend(self):
        r"""Gets the extend of this ShowPolicyResponse.
    ...
    def extend(self, extend):
        r"""Sets the extend of this ShowPolicyResponse.
    ...
    @property
    def timestamp(self):
        r"""Gets the timestamp of this ShowPolicyResponse.
    ...
    def timestamp(self, timestamp):
        r"""Sets the timestamp of this ShowPolicyResponse.
