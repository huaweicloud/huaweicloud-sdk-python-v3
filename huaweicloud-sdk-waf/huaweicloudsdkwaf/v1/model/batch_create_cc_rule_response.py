...
class BatchCreateCcRuleResponse(SdkResponse):
    ...
    @property
    def name(self):
        r"""Gets the name of this BatchCreateCcRuleResponse.

        规则名称

        :return: The name of this BatchCreateCcRuleResponse.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this BatchCreateCcRuleResponse.

        规则名称

        :param name: The name of this BatchCreateCcRuleResponse.
        :type name: str
        """
        self._name = name
    ...
    @property
    def id(self):
        r"""Gets the id of this BatchCreateCcRuleResponse.

        Rule ID.

        :return: The id of this BatchCreateCcRuleResponse.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this BatchCreateCcRuleResponse.

        Rule ID.

        :param id: The id of this BatchCreateCcRuleResponse.
        :type id: str
        """
        self._id = id
    ...
    @property
    def policyid(self):
        r"""Gets the policyid of this BatchCreateCcRuleResponse.

        Policy ID.

        :return: The policyid of this BatchCreateCcRuleResponse.
        :rtype: str
        """
    ...
    def policyid(self, policyid):
        r"""Sets the policyid of this BatchCreateCcRuleResponse.

        Policy ID.

        :param policyid: The policyid of this BatchCreateCcRuleResponse.
        :type policyid: str
        """
    ...
    @property
    def url(self):
        r"""Gets the url of this BatchCreateCcRuleResponse.

        当mode值为0时，该参数有返回值。规则应用的URL链接。

        :return: The url of this BatchCreateCcRuleResponse.
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        r"""Sets the url of this BatchCreateCcRuleResponse.

        当mode值为0时，该参数有返回值。规则应用的URL链接。

        :param url: The url of this BatchCreateCcRuleResponse.
        :type url: str
        """
        self._url = url
    ...
    @property
    def prefix(self):
        r"""Gets the prefix of this BatchCreateCcRuleResponse.

        路径是否为前缀模式，当防护url以*结束，则为前缀模式。

        :return: The prefix of this BatchCreateCcRuleResponse.
        :rtype: bool
        """
        return self._prefix
    ...
    def prefix(self, prefix):
        r"""Sets the prefix of this BatchCreateCcRuleResponse.

        路径是否为前缀模式，当防护url以*结束，则为前缀模式。

        :param prefix: The prefix of this BatchCreateCcRuleResponse.
        :type prefix: bool
        """
        self._prefix = prefix
    ...
    @mode.setter
    def mode(self, mode):
        r"""Sets the mode of this BatchCreateCcRuleResponse.

        cc规则防护模式，对应console上的mode，现在只支持创建高级cc规则防护模式。   - 0：标准，只支持对域名的防护路径做限制。  - 1：高级，支持对路径、IP、Cookie、Header、Params字段做限制。

        :param mode: The mode of this BatchCreateCcRuleResponse.
        :type mode: int
        """
        self._mode = mode
    ...
    @property
    def conditions(self):
        r"""Gets the conditions of this BatchCreateCcRuleResponse.

        cc规则防护规则限速条件，当cc防护规则为高级模式（mode参数值为1）时，该参数必填。

        :return: The conditions of this BatchCreateCcRuleResponse.
    ...
    def conditions(self, conditions):
        r"""Sets the conditions of this BatchCreateCcRuleResponse.

        cc规则防护规则限速条件，当cc防护规则为高级模式（mode参数值为1）时，该参数必填。

        :param conditions: The conditions of this BatchCreateCcRuleResponse.
        :type conditions: list[:class:`huaweicloudsdkwaf.v1.CcCondition`]
        """
    ...
    @property
    def action(self):
        r"""Gets the action of this BatchCreateCcRuleResponse.

        :return: The action of this BatchCreateCcRuleResponse.
    ...
    def action(self, action):
        r"""Sets the action of this BatchCreateCcRuleResponse.

        :param action: The action of this BatchCreateCcRuleResponse.
        :type action: :class:`huaweicloudsdkwaf.v1.CcrulesListInfoAction`
        """
        self._action = action
    ...
    @property
    def tag_index(self):
        r"""Gets the tag_index of this BatchCreateCcRuleResponse.
        ...
        :return: The tag_index of this BatchCreateCcRuleResponse.
        :rtype: str
        """
    ...
    def tag_index(self, tag_index):
        r"""Sets the tag_index of this BatchCreateCcRuleResponse.

        用户标识，当限速模式为用户限速(cookie或header)时，需要传该参数。   - 选择cookie时，设置cookie字段名，即用户需要根据网站实际情况配置唯一可识别Web访问者的cookie中的某属性变量名。用户标识的cookie，不支持正则，必须完全匹配。例如：如果网站使用cookie中的某个字段name唯一标识用户，那么可以选取name字段来区分Web访问者。   - 选择header时，设置需要防护的自定义HTTP首部，即用户需要根据网站实际情况配置可识别Web访问者的HTTP首部。

        :param tag_index: The tag_index of this BatchCreateCcRuleResponse.
        :type tag_index: str
        """
    ...
    def tag_condition(self):
        r"""Gets the tag_condition of this BatchCreateCcRuleResponse.

        :return: The tag_condition of this BatchCreateCcRuleResponse.
    ...
    def tag_condition(self, tag_condition):
        r"""Sets the tag_condition of this BatchCreateCcRuleResponse.

        :param tag_condition: The tag_condition of this BatchCreateCcRuleResponse.
        :type tag_condition: :class:`huaweicloudsdkwaf.v1.CcrulesListInfoTagCondition`
        """
    ...
    @property
    def limit_num(self):
        r"""Gets the limit_num of this BatchCreateCcRuleResponse.

        限制频率，单位为次，范围为1~2147483647

        :return: The limit_num of this BatchCreateCcRuleResponse.
        :rtype: int
        """
    ...
    def limit_num(self, limit_num):
        r"""Sets the limit_num of this BatchCreateCcRuleResponse.

        限制频率，单位为次，范围为1~2147483647

        :param limit_num: The limit_num of this BatchCreateCcRuleResponse.
        :type limit_num: int
        """
    ...
    def limit_period(self):
        r"""Gets the limit_period of this BatchCreateCcRuleResponse.

        限速周期，单位为秒，范围1~3600

        :return: The limit_period of this BatchCreateCcRuleResponse.
        :rtype: int
        """
    ...
    def limit_period(self, limit_period):
        r"""Sets the limit_period of this BatchCreateCcRuleResponse.

        限速周期，单位为秒，范围1~3600

        :param limit_period: The limit_period of this BatchCreateCcRuleResponse.
        :type limit_period: int
        """
    ...
    @property
    def unlock_num(self):
        r"""Gets the unlock_num of this BatchCreateCcRuleResponse.

        放行频率，单位为次，范围为0~2147483647。只有当防护动作类型为dynamic_block时，才需要传该参数。

        :return: The unlock_num of this BatchCreateCcRuleResponse.
        :rtype: int
        """
    ...
    def unlock_num(self, unlock_num):
        r"""Sets the unlock_num of this BatchCreateCcRuleResponse.

        放行频率，单位为次，范围为0~2147483647。只有当防护动作类型为dynamic_block时，才需要传该参数。

        :param unlock_num: The unlock_num of this BatchCreateCcRuleResponse.
        :type unlock_num: int
        """
    ...
    @property
    def lock_time(self):
        r"""Gets the lock_time of this BatchCreateCcRuleResponse.

        阻断时间，单位为秒，范围为0~65535。当“防护动作”选择“阻断”时，可设置阻断后恢复正常访问页面的时间。

        :return: The lock_time of this BatchCreateCcRuleResponse.
        :rtype: int
        """
    ...
    def lock_time(self, lock_time):
        r"""Sets the lock_time of this BatchCreateCcRuleResponse.

        阻断时间，单位为秒，范围为0~65535。当“防护动作”选择“阻断”时，可设置阻断后恢复正常访问页面的时间。

        :param lock_time: The lock_time of this BatchCreateCcRuleResponse.
        :type lock_time: int
        """
    ...
    def domain_aggregation(self):
        r"""Gets the domain_aggregation of this BatchCreateCcRuleResponse.

        是否开启域名聚合统计。

        :return: The domain_aggregation of this BatchCreateCcRuleResponse.
        :rtype: bool
        """
    ...
    def domain_aggregation(self, domain_aggregation):
        r"""Sets the domain_aggregation of this BatchCreateCcRuleResponse.

        是否开启域名聚合统计。

        :param domain_aggregation: The domain_aggregation of this BatchCreateCcRuleResponse.
        :type domain_aggregation: bool
        """
    ...
    def region_aggregation(self):
        r"""Gets the region_aggregation of this BatchCreateCcRuleResponse.

        是否开启全局计数。

        :return: The region_aggregation of this BatchCreateCcRuleResponse.
        :rtype: bool
        """
    ...
    def region_aggregation(self, region_aggregation):
        r"""Sets the region_aggregation of this BatchCreateCcRuleResponse.

        是否开启全局计数。

        :param region_aggregation: The region_aggregation of this BatchCreateCcRuleResponse.
        :type region_aggregation: bool
        """
    ...
    def description(self):
        r"""Gets the description of this BatchCreateCcRuleResponse.

        规则描述

        :return: The description of this BatchCreateCcRuleResponse.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this BatchCreateCcRuleResponse.

        规则描述

        :param description: The description of this BatchCreateCcRuleResponse.
        :type description: str
        """
    ...
    @property
    def total_num(self):
        r"""Gets the total_num of this BatchCreateCcRuleResponse.

        该参数为预留参数，用于后续功能扩展，当前请用户忽略该参数

        :return: The total_num of this BatchCreateCcRuleResponse.
        :rtype: int
        """
    ...
    def total_num(self, total_num):
        r"""Sets the total_num of this BatchCreateCcRuleResponse.

        该参数为预留参数，用于后续功能扩展，当前请用户忽略该参数

        :param total_num: The total_num of this BatchCreateCcRuleResponse.
        :type total_num: int
        """
    ...
    def unaggregation(self):
        r"""Gets the unaggregation of this BatchCreateCcRuleResponse.

        该参数为预留参数，用于后续功能扩展，当前请用户忽略该参数

        :return: The unaggregation of this BatchCreateCcRuleResponse.
        :rtype: bool
        """
    ...
    def unaggregation(self, unaggregation):
        r"""Sets the unaggregation of this BatchCreateCcRuleResponse.

        该参数为预留参数，用于后续功能扩展，当前请用户忽略该参数

        :param unaggregation: The unaggregation of this BatchCreateCcRuleResponse.
        :type unaggregation: bool
        """
    ...
    @property
    def aging_time(self):
        r"""Gets the aging_time of this BatchCreateCcRuleResponse.

        规则老化时间，该参数为预留参数，用于后续功能扩展，当前请用户忽略该参数

        :return: The aging_time of this BatchCreateCcRuleResponse.
        :rtype: int
        """
    ...
    def aging_time(self, aging_time):
        r"""Sets the aging_time of this BatchCreateCcRuleResponse.

        规则老化时间，该参数为预留参数，用于后续功能扩展，当前请用户忽略该参数

        :param aging_time: The aging_time of this BatchCreateCcRuleResponse.
        :type aging_time: int
        """
    ...
    @property
    def producer(self):
        r"""Gets the producer of this BatchCreateCcRuleResponse.

        规则创建对象，该参数为预留参数，用于后续功能扩展，当前请用户忽略该参数

        :return: The producer of this BatchCreateCcRuleResponse.
        :rtype: int
        """
    ...
    def producer(self, producer):
        r"""Sets the producer of this BatchCreateCcRuleResponse.

        规则创建对象，该参数为预留参数，用于后续功能扩展，当前请用户忽略该参数

        :param producer: The producer of this BatchCreateCcRuleResponse.
        :type producer: int
        """
    ...
    @property
    def timestamp(self):
        r"""Gets the timestamp of this BatchCreateCcRuleResponse.

        创建规则时间戳

        :return: The timestamp of this BatchCreateCcRuleResponse.
        :rtype: int
        """
    ...
    def timestamp(self, timestamp):
        r"""Sets the timestamp of this BatchCreateCcRuleResponse.

        创建规则时间戳

        :param timestamp: The timestamp of this BatchCreateCcRuleResponse.
        :type timestamp: int
        """
    ...
    @property
    def priority(self):
        r"""Gets the priority of this BatchCreateCcRuleResponse.

        执行该规则的优先级，值越小，优先级越高，值相同时，规则创建时间早，优先级越高。取值范围：1到100。 本字段仅在边缘安全场景生效

        :return: The priority of this BatchCreateCcRuleResponse.
        :rtype: int
        """
    ...
    def priority(self, priority):
        r"""Sets the priority of this BatchCreateCcRuleResponse.

        执行该规则的优先级，值越小，优先级越高，值相同时，规则创建时间早，优先级越高。取值范围：1到100。 本字段仅在边缘安全场景生效

        :param priority: The priority of this BatchCreateCcRuleResponse.
        :type priority: int
        """
    ...
    def cc_priority(self):
        r"""Gets the cc_priority of this BatchCreateCcRuleResponse.

        执行该规则的优先级，值越小，优先级越高，值相同时，规则创建时间早，优先级越高。取值范围：0到65535。 本字段仅在非边缘安全场景生效

        :return: The cc_priority of this BatchCreateCcRuleResponse.
        :rtype: int
        """
    ...
    def cc_priority(self, cc_priority):
        r"""Sets the cc_priority of this BatchCreateCcRuleResponse.

        执行该规则的优先级，值越小，优先级越高，值相同时，规则创建时间早，优先级越高。取值范围：0到65535。 本字段仅在非边缘安全场景生效

        :param cc_priority: The cc_priority of this BatchCreateCcRuleResponse.
        :type cc_priority: int
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchCreateCcRuleResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchCreateCcRuleResponse):
            return False
