...
class ListThreatsRequest:
    ...
    def __init__(self, recent=None, _from=None, to=None, hosts=None, instances=None):
    ...
    @property
    def _from(self):
        r"""Gets the _from of this ListThreatsRequest.

        **参数解释：** 起始时间(毫秒时间戳)，需要和to同时使用 **约束限制：** from <= to **取值范围：** from ~ to 最大范围30天 **默认取值：** 不涉及

        :return: The _from of this ListThreatsRequest.
        :rtype: int
        """
        return self.__from
    ...
    def _from(self, _from):
        r"""Sets the _from of this ListThreatsRequest.

        **参数解释：** 起始时间(毫秒时间戳)，需要和to同时使用 **约束限制：** from <= to **取值范围：** from ~ to 最大范围30天 **默认取值：** 不涉及

        :param _from: The _from of this ListThreatsRequest.
        :type _from: int
        """
        self.__from = _from
    ...
    @property
    def to(self):
        r"""Gets the to of this ListThreatsRequest.

        **参数解释：** 结束时间(毫秒时间戳)，需要和from同时使用 **约束限制：** from ~ to 最大范围30天 **取值范围：** 不能超过当天的结束时间 **默认取值：** 不涉及

        :return: The to of this ListThreatsRequest.
        :rtype: int
        """
        return self._to
    ...
    @to.setter
    def to(self, to):
        r"""Sets the to of this ListThreatsRequest.

        **参数解释：** 结束时间(毫秒时间戳)，需要和from同时使用 **约束限制：** from ~ to 最大范围30天 **取值范围：** 不能超过当天的结束时间 **默认取值：** 不涉及

        :param to: The to of this ListThreatsRequest.
        :type to: int
        """
        self._to = to
    ...
    @property
    def instances(self):
        r"""Gets the instances of this ListThreatsRequest.

        **参数解释：** 要查询的实例id列表，通过 “查询WAF独享引擎列表”（ListInstance）接口获取 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :return: The instances of this ListThreatsRequest.
        :rtype: list[str]
        """
    ...
    def instances(self, instances):
        r"""Sets the instances of this ListThreatsRequest.

        **参数解释：** 要查询的实例id列表，通过 “查询WAF独享引擎列表”（ListInstance）接口获取 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :param instances: The instances of this ListThreatsRequest.
        :type instances: list[str]
        """
