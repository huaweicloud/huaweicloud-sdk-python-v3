...
class ListAntitamperRuleResponse(SdkResponse):
    ...
    @property
    def total(self):
        r"""Gets the total of this ListAntitamperRuleResponse.
    ...
    def total(self, total):
        r"""Sets the total of this ListAntitamperRuleResponse.
    ...
    @property
    def items(self):
        r"""Gets the items of this ListAntitamperRuleResponse.
    ...
    def items(self, items):
        r"""Sets the items of this ListAntitamperRuleResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAntitamperRuleResponse.to_dict() is deprecated and no longer maintained, "
