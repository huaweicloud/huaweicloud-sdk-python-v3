...
class DeletePrivacyRuleResponse(SdkResponse):
    ...
    @property
    def id(self):
        r"""Gets the id of this DeletePrivacyRuleResponse.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this DeletePrivacyRuleResponse.
    ...
    @property
    def policyid(self):
        r"""Gets the policyid of this DeletePrivacyRuleResponse.
    ...
    def policyid(self, policyid):
        r"""Sets the policyid of this DeletePrivacyRuleResponse.
    ...
    @property
    def timestamp(self):
        r"""Gets the timestamp of this DeletePrivacyRuleResponse.
    ...
    def timestamp(self, timestamp):
        r"""Sets the timestamp of this DeletePrivacyRuleResponse.
    ...
    def description(self):
        r"""Gets the description of this DeletePrivacyRuleResponse.
    ...
    def description(self, description):
        r"""Sets the description of this DeletePrivacyRuleResponse.
    ...
    @property
    def status(self):
        r"""Gets the status of this DeletePrivacyRuleResponse.
    ...
    def status(self, status):
        r"""Sets the status of this DeletePrivacyRuleResponse.
    ...
    @property
    def category(self):
        r"""Gets the category of this DeletePrivacyRuleResponse.
    ...
    def category(self, category):
        r"""Sets the category of this DeletePrivacyRuleResponse.
    ...
    @property
    def index(self):
        r"""Gets the index of this DeletePrivacyRuleResponse.
    ...
    def index(self, index):
        r"""Sets the index of this DeletePrivacyRuleResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeletePrivacyRuleResponse.to_dict() is deprecated and no longer maintained, "
