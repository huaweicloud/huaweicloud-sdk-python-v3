...
class UpdatePrivacyRuleResponse(SdkResponse):
    ...
    def id(self):
        ...
        :return: The id of this UpdatePrivacyRuleResponse.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this UpdatePrivacyRuleResponse.
        :type id: str
        """
        self._id = id
    ...
    def policyid(self):
        ...
        :return: The policyid of this UpdatePrivacyRuleResponse.
        :rtype: str
        """
    ...
    def policyid(self, policyid):
        ...
        :param policyid: The policyid of this UpdatePrivacyRuleResponse.
        :type policyid: str
        """
    ...
    def timestamp(self):
        ...
        :return: The timestamp of this UpdatePrivacyRuleResponse.
        :rtype: int
        """
    ...
    def timestamp(self, timestamp):
        ...
        :param timestamp: The timestamp of this UpdatePrivacyRuleResponse.
        :type timestamp: int
        """
    ...
    def status(self):
        ...
        **参数解释：** 规则状态标识，用于指定规则的启用或关闭状态 **约束限制：** 不涉及 **取值范围：**  - 0：关闭  - 1：开启 **默认取值：** 不涉及
        ...
        :return: The status of this UpdatePrivacyRuleResponse.
        :rtype: int
        """
        return self._status
    ...
    def status(self, status):
        ...
        **参数解释：** 规则状态标识，用于指定规则的启用或关闭状态 **约束限制：** 不涉及 **取值范围：**  - 0：关闭  - 1：开启 **默认取值：** 不涉及
        ...
        :param status: The status of this UpdatePrivacyRuleResponse.
        :type status: int
        """
        self._status = status
    ...
    def url(self):
        ...
        :return: The url of this UpdatePrivacyRuleResponse.
        :rtype: str
        """
        return self._url
    ...
    def url(self, url):
        ...
        :param url: The url of this UpdatePrivacyRuleResponse.
        :type url: str
        """
        self._url = url
    ...
    def category(self):
        ...
        **参数解释：** 屏蔽字段 **约束限制：** 不涉及 **取值范围：**  - params: 请求参数  - cookie: 根据Cookie区分的Web访问者  - header: 自定义HTTP首部  - form: 表单参数  **默认取值：** 不涉及
        ...
        :return: The category of this UpdatePrivacyRuleResponse.
        :rtype: str
        """
    ...
    def category(self, category):
        ...
        **参数解释：** 屏蔽字段 **约束限制：** 不涉及 **取值范围：**  - params: 请求参数  - cookie: 根据Cookie区分的Web访问者  - header: 自定义HTTP首部  - form: 表单参数  **默认取值：** 不涉及
        ...
        :param category: The category of this UpdatePrivacyRuleResponse.
        :type category: str
        """
    ...
    def index(self):
        ...
        :return: The index of this UpdatePrivacyRuleResponse.
        :rtype: str
        """
        return self._index
    ...
    def index(self, index):
        ...
        :param index: The index of this UpdatePrivacyRuleResponse.
        :type index: str
        """
        self._index = index
    ...
    def description(self):
        ...
        :return: The description of this UpdatePrivacyRuleResponse.
        :rtype: str
        """
    ...
    def description(self, description):
        ...
        :param description: The description of this UpdatePrivacyRuleResponse.
        :type description: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdatePrivacyRuleResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdatePrivacyRuleResponse):
            return False
