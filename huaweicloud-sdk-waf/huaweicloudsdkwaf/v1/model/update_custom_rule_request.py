...
class UpdateCustomRuleRequest:
    ...
    openapi_types = {
        ...
        'policy_id': 'str',
        'rule_id': 'str',
        'body': 'UpdateCustomRuleRequestBody'
    }
    ...
    def __init__(self, enterprise_project_id=None, policy_id=None, rule_id=None, body=None):
        ...
        :type rule_id: str
        :param body: Body of the UpdateCustomRuleRequest
    ...
    def enterprise_project_id(self):
        ...
        **参数解释：** 您可以通过调用企业项目管理服务（EPS）的查询企业项目列表接口（ListEnterpriseProject）查询企业项目ID。若需要查询当前用户所有企业项目绑定的资源信息，请传参all_granted_eps。 **约束限制：** 不涉及 **取值范围：**  - 0：代表default企业项目  - all_granted_eps：代表所有企业项目  - 其它企业项目ID：长度为36个字符 **默认取值：** 0
        ...
        :return: The enterprise_project_id of this UpdateCustomRuleRequest.
        :rtype: str
        """
    ...
    def enterprise_project_id(self, enterprise_project_id):
        ...
        **参数解释：** 您可以通过调用企业项目管理服务（EPS）的查询企业项目列表接口（ListEnterpriseProject）查询企业项目ID。若需要查询当前用户所有企业项目绑定的资源信息，请传参all_granted_eps。 **约束限制：** 不涉及 **取值范围：**  - 0：代表default企业项目  - all_granted_eps：代表所有企业项目  - 其它企业项目ID：长度为36个字符 **默认取值：** 0
        ...
        :param enterprise_project_id: The enterprise_project_id of this UpdateCustomRuleRequest.
        :type enterprise_project_id: str
        """
    ...
    def policy_id(self):
        ...
        **参数解释：** 防护策略id，您可以通过调用查询防护策略列表（ListPolicy）获取策略id **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
        ...
        :return: The policy_id of this UpdateCustomRuleRequest.
        :rtype: str
        """
    ...
    def policy_id(self, policy_id):
        ...
        **参数解释：** 防护策略id，您可以通过调用查询防护策略列表（ListPolicy）获取策略id **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
        ...
        :param policy_id: The policy_id of this UpdateCustomRuleRequest.
        :type policy_id: str
        """
    ...
    def rule_id(self):
        ...
        **参数解释：** 精准防护规则id，通过查询精准防护规则列表接口（ListCustomRules）获取 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
        ...
        :return: The rule_id of this UpdateCustomRuleRequest.
        :rtype: str
        """
    ...
    def rule_id(self, rule_id):
        ...
        **参数解释：** 精准防护规则id，通过查询精准防护规则列表接口（ListCustomRules）获取 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
        ...
        :param rule_id: The rule_id of this UpdateCustomRuleRequest.
        :type rule_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateCustomRuleRequest):
            return False
