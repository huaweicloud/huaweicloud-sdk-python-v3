...
class UpdateCertificateResponse(SdkResponse):
    ...
    @property
    def content(self):
        """Gets the content of this UpdateCertificateResponse.

        证书文件，PEM编码

        :return: The content of this UpdateCertificateResponse.
        :rtype: str
        """
    ...
    def content(self, content):
        """Sets the content of this UpdateCertificateResponse.

        证书文件，PEM编码

        :param content: The content of this UpdateCertificateResponse.
        :type: str
        """
    ...
    @property
    def key(self):
        """Gets the key of this UpdateCertificateResponse.

        证书私钥，PEM编码

        :return: The key of this UpdateCertificateResponse.
        :rtype: str
        """
        return self._key
    ...
    @key.setter
    def key(self, key):
        """Sets the key of this UpdateCertificateResponse.

        证书私钥，PEM编码

        :param key: The key of this UpdateCertificateResponse.
        :type: str
        """
        self._key = key
    ...
    @property
    def exp_status(self):
        """Gets the exp_status of this UpdateCertificateResponse.

        证书过期状态，0-未过期，1-已过期，2-即将过期

        :return: The exp_status of this UpdateCertificateResponse.
        :rtype: int
        """
    ...
    def exp_status(self, exp_status):
        """Sets the exp_status of this UpdateCertificateResponse.

        证书过期状态，0-未过期，1-已过期，2-即将过期

        :param exp_status: The exp_status of this UpdateCertificateResponse.
        :type: int
        """
    ...
    @property
    def bind_host(self):
        """Gets the bind_host of this UpdateCertificateResponse.

        证书关联的域名信息

        :return: The bind_host of this UpdateCertificateResponse.
        :rtype: list[BindHost]
        """
    ...
    def bind_host(self, bind_host):
        """Sets the bind_host of this UpdateCertificateResponse.

        证书关联的域名信息

        :param bind_host: The bind_host of this UpdateCertificateResponse.
        :type: list[BindHost]
        """
