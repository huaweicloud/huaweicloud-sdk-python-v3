...
class CreatePrivacyRuleRequestBody:
    ...
    @property
    def id(self):
        """Gets the id of this CreatePrivacyRuleRequestBody.

        规则id

        :return: The id of this CreatePrivacyRuleRequestBody.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CreatePrivacyRuleRequestBody.

        规则id

        :param id: The id of this CreatePrivacyRuleRequestBody.
        :type: str
        """
        self._id = id
