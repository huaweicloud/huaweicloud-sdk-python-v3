...
class CreatePrivacyRuleRequestBody:
    ...
    def __init__(self, url=None, category=None, index=None, description=None):
        r"""CreatePrivacyRuleRequestBody
    ...
    @property
    def url(self):
        r"""Gets the url of this CreatePrivacyRuleRequestBody.
    ...
    @url.setter
    def url(self, url):
        r"""Sets the url of this CreatePrivacyRuleRequestBody.
    ...
    @property
    def index(self):
        r"""Gets the index of this CreatePrivacyRuleRequestBody.
    ...
    def index(self, index):
        r"""Sets the index of this CreatePrivacyRuleRequestBody.
    ...
    def description(self):
        r"""Gets the description of this CreatePrivacyRuleRequestBody.
    ...
    def description(self, description):
        r"""Sets the description of this CreatePrivacyRuleRequestBody.
