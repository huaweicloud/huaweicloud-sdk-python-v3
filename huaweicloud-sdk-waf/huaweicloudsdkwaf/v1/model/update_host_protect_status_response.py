...
class UpdateHostProtectStatusResponse(SdkResponse):
    ...
    def __init__(self, protect_status=None):
        r"""UpdateHostProtectStatusResponse
    ...
    def protect_status(self):
        r"""Gets the protect_status of this UpdateHostProtectStatusResponse.
    ...
    def protect_status(self, protect_status):
        r"""Sets the protect_status of this UpdateHostProtectStatusResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateHostProtectStatusResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateHostProtectStatusResponse):
            return False
