...
class UpdateCcRuleRequestBody:
    ...
    def __init__(self, name=None, mode=None, url=None, conditions=None, action=None, tag_type=None, tag_index=None, tag_condition=None, limit_num=None, limit_period=None, unlock_num=None, lock_time=None, domain_aggregation=None, region_aggregation=None, description=None, priority=None, cc_priority=None):
        r"""UpdateCcRuleRequestBody
    ...
    @property
    def name(self):
        r"""Gets the name of this UpdateCcRuleRequestBody.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this UpdateCcRuleRequestBody.
    ...
    @property
    def mode(self):
        r"""Gets the mode of this UpdateCcRuleRequestBody.
    ...
    @mode.setter
    def mode(self, mode):
        r"""Sets the mode of this UpdateCcRuleRequestBody.
    ...
    @property
    def url(self):
        r"""Gets the url of this UpdateCcRuleRequestBody.
    ...
    @url.setter
    def url(self, url):
        r"""Sets the url of this UpdateCcRuleRequestBody.
    ...
    @property
    def conditions(self):
        r"""Gets the conditions of this UpdateCcRuleRequestBody.
    ...
    def conditions(self, conditions):
        r"""Sets the conditions of this UpdateCcRuleRequestBody.
    ...
    @property
    def action(self):
        r"""Gets the action of this UpdateCcRuleRequestBody.
    ...
    def action(self, action):
        r"""Sets the action of this UpdateCcRuleRequestBody.
    ...
    @property
    def tag_type(self):
        r"""Gets the tag_type of this UpdateCcRuleRequestBody.
    ...
    def tag_type(self, tag_type):
        r"""Sets the tag_type of this UpdateCcRuleRequestBody.
    ...
    @property
    def tag_index(self):
        r"""Gets the tag_index of this UpdateCcRuleRequestBody.
    ...
    def tag_index(self, tag_index):
        r"""Sets the tag_index of this UpdateCcRuleRequestBody.
    ...
    def tag_condition(self):
        r"""Gets the tag_condition of this UpdateCcRuleRequestBody.
    ...
    def tag_condition(self, tag_condition):
        r"""Sets the tag_condition of this UpdateCcRuleRequestBody.
    ...
    @property
    def limit_num(self):
        r"""Gets the limit_num of this UpdateCcRuleRequestBody.
    ...
    def limit_num(self, limit_num):
        r"""Sets the limit_num of this UpdateCcRuleRequestBody.
    ...
    def limit_period(self):
        r"""Gets the limit_period of this UpdateCcRuleRequestBody.
    ...
    def limit_period(self, limit_period):
        r"""Sets the limit_period of this UpdateCcRuleRequestBody.
    ...
    @property
    def unlock_num(self):
        r"""Gets the unlock_num of this UpdateCcRuleRequestBody.
    ...
    def unlock_num(self, unlock_num):
        r"""Sets the unlock_num of this UpdateCcRuleRequestBody.
    ...
    @property
    def lock_time(self):
        r"""Gets the lock_time of this UpdateCcRuleRequestBody.
    ...
    def lock_time(self, lock_time):
        r"""Sets the lock_time of this UpdateCcRuleRequestBody.
    ...
    def domain_aggregation(self):
        r"""Gets the domain_aggregation of this UpdateCcRuleRequestBody.
    ...
    def domain_aggregation(self, domain_aggregation):
        r"""Sets the domain_aggregation of this UpdateCcRuleRequestBody.
    ...
    def region_aggregation(self):
        r"""Gets the region_aggregation of this UpdateCcRuleRequestBody.
    ...
    def region_aggregation(self, region_aggregation):
        r"""Sets the region_aggregation of this UpdateCcRuleRequestBody.
    ...
    def description(self):
        r"""Gets the description of this UpdateCcRuleRequestBody.
    ...
    def description(self, description):
        r"""Sets the description of this UpdateCcRuleRequestBody.
    ...
    @property
    def priority(self):
        r"""Gets the priority of this UpdateCcRuleRequestBody.

        执行该规则的优先级，值越小，优先级越高，值相同时，规则创建时间早，优先级越高。取值范围：1到100。 本字段仅在边缘安全场景生效

        :return: The priority of this UpdateCcRuleRequestBody.
        :rtype: int
        """
    ...
    def priority(self, priority):
        r"""Sets the priority of this UpdateCcRuleRequestBody.

        执行该规则的优先级，值越小，优先级越高，值相同时，规则创建时间早，优先级越高。取值范围：1到100。 本字段仅在边缘安全场景生效

        :param priority: The priority of this UpdateCcRuleRequestBody.
        :type priority: int
        """
    ...
    def cc_priority(self):
        r"""Gets the cc_priority of this UpdateCcRuleRequestBody.

        执行该规则的优先级，值越小，优先级越高，值相同时，规则创建时间早，优先级越高。取值范围：0到65535。 本字段仅在非边缘安全场景生效

        :return: The cc_priority of this UpdateCcRuleRequestBody.
        :rtype: int
        """
    ...
    def cc_priority(self, cc_priority):
        r"""Sets the cc_priority of this UpdateCcRuleRequestBody.

        执行该规则的优先级，值越小，优先级越高，值相同时，规则创建时间早，优先级越高。取值范围：0到65535。 本字段仅在非边缘安全场景生效

        :param cc_priority: The cc_priority of this UpdateCcRuleRequestBody.
        :type cc_priority: int
        """
