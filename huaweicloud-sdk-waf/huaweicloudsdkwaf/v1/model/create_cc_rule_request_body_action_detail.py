...
class CreateCcRuleRequestBodyActionDetail:
    ...
    openapi_types = {
        'response': 'CreateCcRuleRequestBodyActionDetailResponse'
    }
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateCcRuleRequestBodyActionDetail):
            return False
