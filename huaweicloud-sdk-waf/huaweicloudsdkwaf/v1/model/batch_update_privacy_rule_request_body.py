...
class BatchUpdatePrivacyRuleRequestBody:
    ...
    openapi_types = {
        ...
        'index': 'str',
        'description': 'str',
        'policy_rule_ids': 'list[BatchUpdatePrivacyRuleRequestBodyPolicyRuleIds]'
    }
    ...
    def __init__(self, url=None, category=None, index=None, description=None, policy_rule_ids=None):
        ...
        :type policy_rule_ids: list[:class:`huaweicloudsdkwaf.v1.BatchUpdatePrivacyRuleRequestBodyPolicyRuleIds`]
        """
    ...
    def policy_rule_ids(self):
        ...
        **参数解释：** 策略和规则id数组，关联防护策略与对应的规则集合 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及
        ...
        :rtype: list[:class:`huaweicloudsdkwaf.v1.BatchUpdatePrivacyRuleRequestBodyPolicyRuleIds`]
        """
