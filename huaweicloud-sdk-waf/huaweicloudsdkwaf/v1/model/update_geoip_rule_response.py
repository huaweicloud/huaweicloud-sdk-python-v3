...
class UpdateGeoipRuleResponse(SdkResponse):
    ...
    @property
    def id(self):
        r"""Gets the id of this UpdateGeoipRuleResponse.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this UpdateGeoipRuleResponse.
    ...
    @property
    def name(self):
        r"""Gets the name of this UpdateGeoipRuleResponse.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this UpdateGeoipRuleResponse.
    ...
    def description(self):
        r"""Gets the description of this UpdateGeoipRuleResponse.
    ...
    def description(self, description):
        r"""Sets the description of this UpdateGeoipRuleResponse.
    ...
    @property
    def policyid(self):
        r"""Gets the policyid of this UpdateGeoipRuleResponse.
    ...
    def policyid(self, policyid):
        r"""Sets the policyid of this UpdateGeoipRuleResponse.
    ...
    @property
    def geoip(self):
        r"""Gets the geoip of this UpdateGeoipRuleResponse.
    ...
    def geoip(self, geoip):
        r"""Sets the geoip of this UpdateGeoipRuleResponse.
    ...
    @property
    def white(self):
        r"""Gets the white of this UpdateGeoipRuleResponse.
    ...
    def white(self, white):
        r"""Sets the white of this UpdateGeoipRuleResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateGeoipRuleResponse.to_dict() is deprecated and no longer maintained, "
