...
class CreateGeoIpRuleRequestBody:
    ...
    @property
    def name(self):
        """Gets the name of this CreateGeoIpRuleRequestBody.
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CreateGeoIpRuleRequestBody.
    ...
    @property
    def status(self):
        """Gets the status of this CreateGeoIpRuleRequestBody.
    ...
    def status(self, status):
        """Sets the status of this CreateGeoIpRuleRequestBody.
