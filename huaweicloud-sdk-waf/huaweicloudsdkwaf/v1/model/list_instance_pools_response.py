...
class ListInstancePoolsResponse(SdkResponse):
    ...
    openapi_types = {
        'total': 'int',
        'items': 'list[PremiumWafPoolResponse]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListInstancePoolsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListInstancePoolsResponse):
            return False
