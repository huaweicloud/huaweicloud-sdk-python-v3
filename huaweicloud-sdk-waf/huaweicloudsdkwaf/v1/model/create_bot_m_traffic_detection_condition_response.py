...
class CreateBotMTrafficDetectionConditionResponse(SdkResponse):
    ...
    def __init__(self, id=None, match_field=None, match_field_index=None, logical_operator=None, match_contents=None, value_list_res=None):
        r"""CreateBotMTrafficDetectionConditionResponse
        ...
        super(CreateBotMTrafficDetectionConditionResponse, self).__init__()
    ...
    @property
    def id(self):
        r"""Gets the id of this CreateBotMTrafficDetectionConditionResponse.

        **参数解释：** Id，唯一标识当前流量检测条件。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :return: The id of this CreateBotMTrafficDetectionConditionResponse.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this CreateBotMTrafficDetectionConditionResponse.

        **参数解释：** Id，唯一标识当前流量检测条件。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :param id: The id of this CreateBotMTrafficDetectionConditionResponse.
        :type id: str
        """
        self._id = id
    ...
    def match_field(self):
        r"""Gets the match_field of this CreateBotMTrafficDetectionConditionResponse.

        **参数解释：** 匹配字段（类别），标识流量筛选的字段类型（如url表示URL路径）。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :return: The match_field of this CreateBotMTrafficDetectionConditionResponse.
        :rtype: str
        """
    ...
    def match_field(self, match_field):
        r"""Sets the match_field of this CreateBotMTrafficDetectionConditionResponse.

        **参数解释：** 匹配字段（类别），标识流量筛选的字段类型（如url表示URL路径）。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :param match_field: The match_field of this CreateBotMTrafficDetectionConditionResponse.
        :type match_field: str
        """
    ...
    def match_field_index(self):
        r"""Gets the match_field_index of this CreateBotMTrafficDetectionConditionResponse.

        **参数解释：** 子字段，匹配字段的细分维度（如无则不填）。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :return: The match_field_index of this CreateBotMTrafficDetectionConditionResponse.
        :rtype: str
        """
    ...
    def match_field_index(self, match_field_index):
        r"""Sets the match_field_index of this CreateBotMTrafficDetectionConditionResponse.

        **参数解释：** 子字段，匹配字段的细分维度（如无则不填）。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :param match_field_index: The match_field_index of this CreateBotMTrafficDetectionConditionResponse.
        :type match_field_index: str
        """
    ...
    def logical_operator(self):
        r"""Gets the logical_operator of this CreateBotMTrafficDetectionConditionResponse.

        **参数解释：** 逻辑运算符，标识匹配条件的逻辑关系（如contain表示包含）。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :return: The logical_operator of this CreateBotMTrafficDetectionConditionResponse.
        :rtype: str
        """
    ...
    def logical_operator(self, logical_operator):
        r"""Sets the logical_operator of this CreateBotMTrafficDetectionConditionResponse.

        **参数解释：** 逻辑运算符，标识匹配条件的逻辑关系（如contain表示包含）。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :param logical_operator: The logical_operator of this CreateBotMTrafficDetectionConditionResponse.
        :type logical_operator: str
        """
    ...
    def match_contents(self):
        r"""Gets the match_contents of this CreateBotMTrafficDetectionConditionResponse.

        **参数解释：** 匹配内容，符合筛选条件的具体值列表（如特定URL路径）。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :return: The match_contents of this CreateBotMTrafficDetectionConditionResponse.
        :rtype: list[str]
        """
    ...
    def match_contents(self, match_contents):
        r"""Sets the match_contents of this CreateBotMTrafficDetectionConditionResponse.

        **参数解释：** 匹配内容，符合筛选条件的具体值列表（如特定URL路径）。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :param match_contents: The match_contents of this CreateBotMTrafficDetectionConditionResponse.
        :type match_contents: list[str]
        """
    ...
    def value_list_res(self):
        r"""Gets the value_list_res of this CreateBotMTrafficDetectionConditionResponse.

        **参数解释：** 引用表Id，关联预设的匹配内容列表ID（如无则不填）。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :return: The value_list_res of this CreateBotMTrafficDetectionConditionResponse.
        :rtype: str
        """
    ...
    def value_list_res(self, value_list_res):
        r"""Sets the value_list_res of this CreateBotMTrafficDetectionConditionResponse.

        **参数解释：** 引用表Id，关联预设的匹配内容列表ID（如无则不填）。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :param value_list_res: The value_list_res of this CreateBotMTrafficDetectionConditionResponse.
        :type value_list_res: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateBotMTrafficDetectionConditionResponse):
            return False
