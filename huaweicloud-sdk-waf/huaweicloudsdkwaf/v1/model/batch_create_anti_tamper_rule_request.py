...
class BatchCreateAntiTamperRuleRequest:
    ...
    def __init__(self, projectid=None, policyids=None, enterprise_project_id=None, body=None):
        r"""BatchCreateAntiTamperRuleRequest
    ...
    @property
    def projectid(self):
        r"""Gets the projectid of this BatchCreateAntiTamperRuleRequest.

        **参数解释：** 项目ID，对应控制台用户名->我的凭证->项目列表->项目ID。 **约束限制：** 不涉及 **取值范围：** 只能由英文字母、数字组成，且长度为32个字符。 **默认取值：** 不涉及

        :return: The projectid of this BatchCreateAntiTamperRuleRequest.
        :rtype: str
        """
    ...
    def projectid(self, projectid):
        r"""Sets the projectid of this BatchCreateAntiTamperRuleRequest.

        **参数解释：** 项目ID，对应控制台用户名->我的凭证->项目列表->项目ID。 **约束限制：** 不涉及 **取值范围：** 只能由英文字母、数字组成，且长度为32个字符。 **默认取值：** 不涉及

        :param projectid: The projectid of this BatchCreateAntiTamperRuleRequest.
        :type projectid: str
        """
    ...
    @property
    def body(self):
        r"""Gets the body of this BatchCreateAntiTamperRuleRequest.

        :return: The body of this BatchCreateAntiTamperRuleRequest.
        :rtype: :class:`huaweicloudsdkwaf.v1.BatchCreateAntiTamperRulesRequestBody`
        """
        return self._body

    @body.setter
    def body(self, body):
        r"""Sets the body of this BatchCreateAntiTamperRuleRequest.

        :param body: The body of this BatchCreateAntiTamperRuleRequest.
        :type body: :class:`huaweicloudsdkwaf.v1.BatchCreateAntiTamperRulesRequestBody`
        """
        self._body = body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchCreateAntiTamperRuleRequest):
            return False
