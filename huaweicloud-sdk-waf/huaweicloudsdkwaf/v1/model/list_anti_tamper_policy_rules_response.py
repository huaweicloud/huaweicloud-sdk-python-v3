...
class ListAntiTamperPolicyRulesResponse(SdkResponse):
    ...
    def __init__(self, total=None, items=None):
        r"""ListAntiTamperPolicyRulesResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAntiTamperPolicyRulesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAntiTamperPolicyRulesResponse):
            return False
