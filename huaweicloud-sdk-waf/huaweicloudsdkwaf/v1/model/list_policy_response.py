...
class ListPolicyResponse(SdkResponse):
    ...
    @property
    def total(self):
        r"""Gets the total of this ListPolicyResponse.
    ...
    def total(self, total):
        r"""Sets the total of this ListPolicyResponse.
    ...
    @property
    def items(self):
        r"""Gets the items of this ListPolicyResponse.
    ...
    def items(self, items):
        r"""Sets the items of this ListPolicyResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListPolicyResponse.to_dict() is deprecated and no longer maintained, "
