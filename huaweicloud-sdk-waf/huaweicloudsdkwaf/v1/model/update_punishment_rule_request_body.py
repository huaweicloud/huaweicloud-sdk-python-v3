...
class UpdatePunishmentRuleRequestBody:
    ...
    def __init__(self, category=None, block_time=None, description=None):
        ...
        :param category: **参数解释：** 引用表类型 **约束限制：** 不涉及 **取值范围：**  - long_ip_block  - long_cookie_block  - long_params_block  - short_ip_block  - short_cookie_block  - short_params_block  **默认取值：** 不涉及
        :type category: str
