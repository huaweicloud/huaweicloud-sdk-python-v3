...
class UpdatePunishmentRuleRequestBody:
    ...
    def __init__(self, category=None, time_unit=None, block_time=None, description=None):
        ...
        :param category: **参数解释：** 攻击惩罚类别 **约束限制：** 不支持修改 **取值范围：**  - long_ip_block  - long_cookie_block  - long_params_block  - long_header_block  - short_ip_block  - short_cookie_block  - short_params_block  - short_header_block **默认取值：** 不涉及
        :type category: str
    ...
    @property
    def time_unit(self):
        r"""Gets the time_unit of this UpdatePunishmentRuleRequestBody.

        **参数解释：** 时间单位，会影响“拦截时间”参数的取值范围 **约束限制：** 不涉及 **取值范围：**  - SECOND  - MINUTE  - HOUR  - DAY  - MONTH **默认取值：** SECOND

        :return: The time_unit of this UpdatePunishmentRuleRequestBody.
        :rtype: str
        """
    ...
    def time_unit(self, time_unit):
        r"""Sets the time_unit of this UpdatePunishmentRuleRequestBody.

        **参数解释：** 时间单位，会影响“拦截时间”参数的取值范围 **约束限制：** 不涉及 **取值范围：**  - SECOND  - MINUTE  - HOUR  - DAY  - MONTH **默认取值：** SECOND

        :param time_unit: The time_unit of this UpdatePunishmentRuleRequestBody.
        :type time_unit: str
        """
