...
class CreatePolicyResponse(SdkResponse):
    ...
    @property
    def level(self):
        r"""Gets the level of this CreatePolicyResponse.
    ...
    def level(self, level):
        r"""Sets the level of this CreatePolicyResponse.
    ...
    def full_detection(self, full_detection):
        r"""Sets the full_detection of this CreatePolicyResponse.
    ...
    def robot_action(self):
        r"""Gets the robot_action of this CreatePolicyResponse.

        :return: The robot_action of this CreatePolicyResponse.
    ...
    def robot_action(self, robot_action):
        r"""Sets the robot_action of this CreatePolicyResponse.

        :param robot_action: The robot_action of this CreatePolicyResponse.
        :type robot_action: :class:`huaweicloudsdkwaf.v1.Action`
        """
    ...
    @property
    def action(self):
        r"""Gets the action of this CreatePolicyResponse.
    ...
    def action(self, action):
        r"""Sets the action of this CreatePolicyResponse.
    ...
    @property
    def options(self):
        r"""Gets the options of this CreatePolicyResponse.
    ...
    def options(self, options):
        r"""Sets the options of this CreatePolicyResponse.
    ...
    def modulex_options(self):
        r"""Gets the modulex_options of this CreatePolicyResponse.

        智能访问控制防护项相关配置信息，目前该特性还处于公测阶段，只有部分局点支持该特性

        :return: The modulex_options of this CreatePolicyResponse.
    ...
    def modulex_options(self, modulex_options):
        r"""Sets the modulex_options of this CreatePolicyResponse.

        智能访问控制防护项相关配置信息，目前该特性还处于公测阶段，只有部分局点支持该特性

        :param modulex_options: The modulex_options of this CreatePolicyResponse.
        :type modulex_options: dict(str, object)
        """
    ...
    @property
    def hosts(self):
        r"""Gets the hosts of this CreatePolicyResponse.
    ...
    def hosts(self, hosts):
        r"""Sets the hosts of this CreatePolicyResponse.
    ...
    @property
    def bind_host(self):
        r"""Gets the bind_host of this CreatePolicyResponse.
    ...
    def bind_host(self, bind_host):
        r"""Sets the bind_host of this CreatePolicyResponse.
    ...
    @property
    def extend(self):
        r"""Gets the extend of this CreatePolicyResponse.
    ...
    def extend(self, extend):
        r"""Sets the extend of this CreatePolicyResponse.
    ...
    @property
    def timestamp(self):
        r"""Gets the timestamp of this CreatePolicyResponse.

        创建防护策略的时间

        :return: The timestamp of this CreatePolicyResponse.
        :rtype: int
        """
    ...
    def timestamp(self, timestamp):
        r"""Sets the timestamp of this CreatePolicyResponse.
