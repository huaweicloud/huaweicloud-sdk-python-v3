...
class UpdatePremiumHostAccessStatusRequest:
    ...
    def __init__(self, host_id=None, body=None):
        """UpdatePremiumHostAccessStatusRequest - a model defined in huaweicloud sdk"""
    ...
    @property
    def host_id(self):
        """Gets the host_id of this UpdatePremiumHostAccessStatusRequest.
    ...
    def host_id(self, host_id):
        """Sets the host_id of this UpdatePremiumHostAccessStatusRequest.
    ...
    @property
    def body(self):
        """Gets the body of this UpdatePremiumHostAccessStatusRequest.


        :return: The body of this UpdatePremiumHostAccessStatusRequest.
        :rtype: UpdatePremiumHostAccessStatusRequestBody
        """
        return self._body

    @body.setter
    def body(self, body):
        """Sets the body of this UpdatePremiumHostAccessStatusRequest.


        :param body: The body of this UpdatePremiumHostAccessStatusRequest.
        :type: UpdatePremiumHostAccessStatusRequestBody
        """
        self._body = body
