...
class CreatePoolResponse(SdkResponse):
    ...
    @property
    def id(self):
        r"""Gets the id of this CreatePoolResponse.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this CreatePoolResponse.
    ...
    @property
    def name(self):
        r"""Gets the name of this CreatePoolResponse.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this CreatePoolResponse.
    ...
    @property
    def region(self):
        r"""Gets the region of this CreatePoolResponse.
    ...
    def region(self, region):
        r"""Sets the region of this CreatePoolResponse.
    ...
    @property
    def type(self):
        r"""Gets the type of this CreatePoolResponse.
    ...
    @type.setter
    def type(self, type):
        r"""Sets the type of this CreatePoolResponse.
    ...
    @property
    def vpc_id(self):
        r"""Gets the vpc_id of this CreatePoolResponse.
    ...
    def vpc_id(self, vpc_id):
        r"""Sets the vpc_id of this CreatePoolResponse.
    ...
    def description(self):
        r"""Gets the description of this CreatePoolResponse.
    ...
    def description(self, description):
        r"""Sets the description of this CreatePoolResponse.
    ...
    @property
    def hosts(self):
        r"""Gets the hosts of this CreatePoolResponse.

        **参数解释：** 实例组关联的防护域名列表。 **取值范围：** 不涉及

        :return: The hosts of this CreatePoolResponse.
    ...
    def hosts(self, hosts):
        r"""Sets the hosts of this CreatePoolResponse.

        **参数解释：** 实例组关联的防护域名列表。 **取值范围：** 不涉及

        :param hosts: The hosts of this CreatePoolResponse.
        :type hosts: list[:class:`huaweicloudsdkwaf.v1.IdNameEntry`]
        """
        self._hosts = hosts
    ...
    @property
    def instances(self):
        r"""Gets the instances of this CreatePoolResponse.

        **参数解释：** 实例组关联的引擎实例列表。 **取值范围：** 不涉及

        :return: The instances of this CreatePoolResponse.
        :rtype: list[:class:`huaweicloudsdkwaf.v1.IdNameEntry`]
        """
    ...
    def instances(self, instances):
        r"""Sets the instances of this CreatePoolResponse.

        **参数解释：** 实例组关联的引擎实例列表。 **取值范围：** 不涉及

        :param instances: The instances of this CreatePoolResponse.
        :type instances: list[:class:`huaweicloudsdkwaf.v1.IdNameEntry`]
        """
    ...
    def enterprise_project_id(self):
        r"""Gets the enterprise_project_id of this CreatePoolResponse.

        **参数解释：** 实例组关联的企业项目ID。 **取值范围：** - 0：代表default企业项目 - 其他为企业项目ID，长度为36个字符

        :return: The enterprise_project_id of this CreatePoolResponse.
        :rtype: str
        """
    ...
    def enterprise_project_id(self, enterprise_project_id):
        r"""Sets the enterprise_project_id of this CreatePoolResponse.

        **参数解释：** 实例组关联的企业项目ID。 **取值范围：** - 0：代表default企业项目 - 其他为企业项目ID，长度为36个字符

        :param enterprise_project_id: The enterprise_project_id of this CreatePoolResponse.
        :type enterprise_project_id: str
        """
    ...
    def create_time(self):
        r"""Gets the create_time of this CreatePoolResponse.

        **参数解释：** 实例组创建时间。Unix时间戳格式，单位为毫秒（ms）。 **取值范围：** 不涉及

        :return: The create_time of this CreatePoolResponse.
        :rtype: int
        """
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this CreatePoolResponse.

        **参数解释：** 实例组创建时间。Unix时间戳格式，单位为毫秒（ms）。 **取值范围：** 不涉及

        :param create_time: The create_time of this CreatePoolResponse.
        :type create_time: int
        """
