...
class ListSecurityReportSubscriptionsResponse(SdkResponse):
    ...
    openapi_types = {
        'total': 'int',
        'items': 'list[SecurityReportSubscriptionSummaryResponse]'
    }
    ...
    def __init__(self, total=None, items=None):
        r"""ListSecurityReportSubscriptionsResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListSecurityReportSubscriptionsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListSecurityReportSubscriptionsResponse):
            return False
