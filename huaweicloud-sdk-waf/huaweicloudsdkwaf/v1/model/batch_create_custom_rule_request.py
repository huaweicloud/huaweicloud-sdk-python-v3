...
class BatchCreateCustomRuleRequest:
    ...
    @property
    def projectid(self):
        r"""Gets the projectid of this BatchCreateCustomRuleRequest.

        **参数解释：** 项目ID，对应控制台用户名->我的凭证->项目列表->项目ID。 **约束限制：** 不涉及 **取值范围：** 只能由英文字母、数字组成，且长度为32个字符。 **默认取值：** 不涉及

        :return: The projectid of this BatchCreateCustomRuleRequest.
        :rtype: str
        """
    ...
    def projectid(self, projectid):
        r"""Sets the projectid of this BatchCreateCustomRuleRequest.

        **参数解释：** 项目ID，对应控制台用户名->我的凭证->项目列表->项目ID。 **约束限制：** 不涉及 **取值范围：** 只能由英文字母、数字组成，且长度为32个字符。 **默认取值：** 不涉及

        :param projectid: The projectid of this BatchCreateCustomRuleRequest.
        :type projectid: str
        """
