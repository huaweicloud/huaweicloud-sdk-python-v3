...
class UpdatePremiumInstanceProgressResponse(SdkResponse):
    ...
    def __init__(self, step=None, status=None):
        r"""UpdatePremiumInstanceProgressResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdatePremiumInstanceProgressResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdatePremiumInstanceProgressResponse):
            return False
