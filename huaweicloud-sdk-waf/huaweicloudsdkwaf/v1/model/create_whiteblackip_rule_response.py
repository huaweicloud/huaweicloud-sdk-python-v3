...
class CreateWhiteblackipRuleResponse(SdkResponse):
    ...
    def __init__(self, id=None, name=None, policyid=None, addr=None, white=None, time_mode=None, start=None, terminal=None, ip_group=None, status=None, description=None, timestamp=None):
        r"""CreateWhiteblackipRuleResponse
    ...
    @property
    def id(self):
        r"""Gets the id of this CreateWhiteblackipRuleResponse.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this CreateWhiteblackipRuleResponse.
    ...
    @property
    def name(self):
        r"""Gets the name of this CreateWhiteblackipRuleResponse.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this CreateWhiteblackipRuleResponse.
    ...
    @property
    def policyid(self):
        r"""Gets the policyid of this CreateWhiteblackipRuleResponse.
    ...
    def policyid(self, policyid):
        r"""Sets the policyid of this CreateWhiteblackipRuleResponse.
    ...
    @property
    def addr(self):
        r"""Gets the addr of this CreateWhiteblackipRuleResponse.
    ...
    @addr.setter
    def addr(self, addr):
        r"""Sets the addr of this CreateWhiteblackipRuleResponse.
    ...
    @property
    def white(self):
        r"""Gets the white of this CreateWhiteblackipRuleResponse.
    ...
    def white(self, white):
        r"""Sets the white of this CreateWhiteblackipRuleResponse.
    ...
    @property
    def time_mode(self):
        r"""Gets the time_mode of this CreateWhiteblackipRuleResponse.

        生效模式，默认为permanent（立即生效）

        :return: The time_mode of this CreateWhiteblackipRuleResponse.
        :rtype: str
        """
    ...
    def time_mode(self, time_mode):
        r"""Sets the time_mode of this CreateWhiteblackipRuleResponse.

        生效模式，默认为permanent（立即生效）

        :param time_mode: The time_mode of this CreateWhiteblackipRuleResponse.
        :type time_mode: str
        """
    ...
    @property
    def start(self):
        r"""Gets the start of this CreateWhiteblackipRuleResponse.

        规则生效开始时间，生效模式为自定义时，此字段才有效

        :return: The start of this CreateWhiteblackipRuleResponse.
        :rtype: int
        """
        return self._start
    ...
    def start(self, start):
        r"""Sets the start of this CreateWhiteblackipRuleResponse.

        规则生效开始时间，生效模式为自定义时，此字段才有效

        :param start: The start of this CreateWhiteblackipRuleResponse.
        :type start: int
        """
        self._start = start
    ...
    @property
    def terminal(self):
        r"""Gets the terminal of this CreateWhiteblackipRuleResponse.

        规则生效结束时间，生效模式为自定义时，此字段才有效

        :return: The terminal of this CreateWhiteblackipRuleResponse.
        :rtype: int
        """
    ...
    def terminal(self, terminal):
        r"""Sets the terminal of this CreateWhiteblackipRuleResponse.

        规则生效结束时间，生效模式为自定义时，此字段才有效

        :param terminal: The terminal of this CreateWhiteblackipRuleResponse.
        :type terminal: int
        """
    ...
    @property
    def ip_group(self):
        r"""Gets the ip_group of this CreateWhiteblackipRuleResponse.
    ...
    def ip_group(self, ip_group):
        r"""Sets the ip_group of this CreateWhiteblackipRuleResponse.
    ...
    def description(self):
        r"""Gets the description of this CreateWhiteblackipRuleResponse.
    ...
    def description(self, description):
        r"""Sets the description of this CreateWhiteblackipRuleResponse.
    ...
    @property
    def timestamp(self):
        r"""Gets the timestamp of this CreateWhiteblackipRuleResponse.
    ...
    def timestamp(self, timestamp):
        r"""Sets the timestamp of this CreateWhiteblackipRuleResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateWhiteblackipRuleResponse.to_dict() is deprecated and no longer maintained, "
