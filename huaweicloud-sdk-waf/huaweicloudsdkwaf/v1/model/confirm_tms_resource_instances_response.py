...
class ConfirmTmsResourceInstancesResponse(SdkResponse):
    ...
    openapi_types = {
        'total_count': 'int',
        'resources': 'list[TmsResourceInstance]'
    }
    ...
    def __init__(self, total_count=None, resources=None):
        r"""ConfirmTmsResourceInstancesResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ConfirmTmsResourceInstancesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfirmTmsResourceInstancesResponse):
            return False
