...
class BatchUpdateIpReputationRulesResponse(SdkResponse):
    ...
    def __init__(self, policy_rule_ids=None):
        r"""BatchUpdateIpReputationRulesResponse
    ...
    def policy_rule_ids(self):
        r"""Gets the policy_rule_ids of this BatchUpdateIpReputationRulesResponse.

        **参数解释：** 策略和规则id数组，返回防护策略与对应规则的ID关联关系 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :return: The policy_rule_ids of this BatchUpdateIpReputationRulesResponse.
    ...
    def policy_rule_ids(self, policy_rule_ids):
        r"""Sets the policy_rule_ids of this BatchUpdateIpReputationRulesResponse.

        **参数解释：** 策略和规则id数组，返回防护策略与对应规则的ID关联关系 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :param policy_rule_ids: The policy_rule_ids of this BatchUpdateIpReputationRulesResponse.
        :type policy_rule_ids: list[:class:`huaweicloudsdkwaf.v1.PolicyRuleIdResponseBodyPolicyRuleIds`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchUpdateIpReputationRulesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchUpdateIpReputationRulesResponse):
            return False
