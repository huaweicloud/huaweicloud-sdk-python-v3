...
class ListUrlResponse(SdkResponse):
    ...
    def __init__(self, qps=None):
        """ListUrlResponse - a model defined in huaweicloud sdk"""
        
        super(ListUrlResponse, self).__init__()
    ...
    @property
    def qps(self):
        """Gets the qps of this ListUrlResponse.
    ...
    @qps.setter
    def qps(self, qps):
        """Sets the qps of this ListUrlResponse.
