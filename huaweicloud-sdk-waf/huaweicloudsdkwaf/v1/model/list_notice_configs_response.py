...
class ListNoticeConfigsResponse(SdkResponse):
    ...
    @property
    def total(self):
        r"""Gets the total of this ListNoticeConfigsResponse.
    ...
    def total(self, total):
        r"""Sets the total of this ListNoticeConfigsResponse.
    ...
    @property
    def items(self):
        r"""Gets the items of this ListNoticeConfigsResponse.
    ...
    def items(self, items):
        r"""Sets the items of this ListNoticeConfigsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListNoticeConfigsResponse.to_dict() is deprecated and no longer maintained, "
