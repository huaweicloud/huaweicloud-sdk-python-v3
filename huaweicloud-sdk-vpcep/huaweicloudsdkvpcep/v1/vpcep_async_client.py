...
class VpcepAsyncClient(Client):
    ...
    def add_endpoint_service_server_resource_async(self, request):
        r"""添加终端节点服务后端服务资源
    ...
    def add_endpoint_service_server_resource_async_invoker(self, request):
        http_info = self._add_endpoint_service_server_resource_http_info(request)
        return AsyncInvoker(self, http_info)

    def _add_endpoint_service_server_resource_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def upgrade_endpoint_async(self, request):
        r"""升级终端节点
    ...
    def upgrade_endpoint_async_invoker(self, request):
        http_info = self._upgrade_endpoint_http_info(request)
        return AsyncInvoker(self, http_info)

    def _upgrade_endpoint_http_info(self, request):
        http_info = {
            "method": "POST",
