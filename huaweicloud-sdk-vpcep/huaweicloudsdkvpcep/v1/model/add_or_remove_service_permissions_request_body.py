...
class AddOrRemoveServicePermissionsRequestBody:
    ...
    def __init__(self, permissions=None, permission_type=None, action=None):
        r"""AddOrRemoveServicePermissionsRequestBody
    ...
    def permissions(self):
        r"""Gets the permissions of this AddOrRemoveServicePermissionsRequestBody.
    ...
    def permissions(self, permissions):
        r"""Sets the permissions of this AddOrRemoveServicePermissionsRequestBody.
    ...
    def permission_type(self):
        r"""Gets the permission_type of this AddOrRemoveServicePermissionsRequestBody.
    ...
    def permission_type(self, permission_type):
        r"""Sets the permission_type of this AddOrRemoveServicePermissionsRequestBody.
    ...
    @property
    def action(self):
        r"""Gets the action of this AddOrRemoveServicePermissionsRequestBody.
    ...
    def action(self, action):
        r"""Sets the action of this AddOrRemoveServicePermissionsRequestBody.
