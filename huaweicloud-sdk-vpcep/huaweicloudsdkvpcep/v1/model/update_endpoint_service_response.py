...
class UpdateEndpointServiceResponse(SdkResponse):
    ...
    def __init__(self, id=None, port_id=None, vip_port_id=None, service_name=None, server_type=None, vpc_id=None, pool_id=None, approval_enabled=None, status=None, service_type=None, created_at=None, updated_at=None, project_id=None, cidr_type=None, ports=None, tcp_proxy=None, tags=None):
        ...
        :type status: str
        :param service_type: 终端节点服务类型。 终端节点服务类型包括“网关（gataway）型”和“接口（interface）型”： ● gataway：由运维人员配置。用户无需创建，可直接使用。 ● interface：包括运维人员配置的云服务和用户自己创建的私有服务。其中，运维人员配 置的云服务无需创建，用户可直接使用。 您可以通过创建终端节点创建访问Gateway和Interface类型终端节点服务的终端节点。
        ...
        :type cidr_type: str
        :param ports: 服务开放的端口映射列表，详细内容请参见表 4-13 同一个终端节点服务下，不允许重复的端口映 射。若多个终端节点服务共用一个port_id，则 终端节点服务之间的所有端口映射的 server_port和protocol的组合不能重复。
    ...
    @property
    def id(self):
        """Gets the id of this UpdateEndpointServiceResponse.
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this UpdateEndpointServiceResponse.
    ...
    def service_name(self, service_name):
        """Sets the service_name of this UpdateEndpointServiceResponse.
    ...
    @property
    def vpc_id(self):
        """Gets the vpc_id of this UpdateEndpointServiceResponse.
    ...
    def vpc_id(self, vpc_id):
        """Sets the vpc_id of this UpdateEndpointServiceResponse.
    ...
    @property
    def project_id(self):
        """Gets the project_id of this UpdateEndpointServiceResponse.
    ...
    def project_id(self, project_id):
        """Sets the project_id of this UpdateEndpointServiceResponse.
    ...
    def ports(self, ports):
        """Sets the ports of this UpdateEndpointServiceResponse.
    ...
    @property
    def tags(self):
        """Gets the tags of this UpdateEndpointServiceResponse.
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this UpdateEndpointServiceResponse.
