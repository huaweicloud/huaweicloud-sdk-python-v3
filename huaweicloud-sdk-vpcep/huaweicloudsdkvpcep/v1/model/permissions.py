...
class Permissions:
    ...
    def __init__(self, id=None, permission=None, created_at=None):
        """Permissions - a model defined in huaweicloud sdk"""
    ...
    @property
    def permission(self):
        """Gets the permission of this Permissions.
        ...
        :return: The permission of this Permissions.
        :rtype: str
        """
    ...
    def permission(self, permission):
        ...
        :param permission: The permission of this Permissions.
        :type: str
        """
    ...
    @property
    def created_at(self):
        """Gets the created_at of this Permissions.

        白名单的添加时间。 采用UTC时间格式，格式为：YYYY-MMDDTHH: MM:SSZ

        :return: The created_at of this Permissions.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this Permissions.

        白名单的添加时间。 采用UTC时间格式，格式为：YYYY-MMDDTHH: MM:SSZ

        :param created_at: The created_at of this Permissions.
        :type: datetime
        """
