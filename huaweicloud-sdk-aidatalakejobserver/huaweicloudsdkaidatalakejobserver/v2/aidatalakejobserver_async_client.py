...
class AIDataLakeJobServerAsyncClient(Client):
    def __init__(self):
        super().__init__()
    ...
    def new_builder(cls, clazz=None):
        if not clazz:
            ...
            if clazz.__name__ != "AIDataLakeJobServerAsyncClient":
                raise TypeError("client type error, support client type is AIDataLakeJobServerAsyncClient")
