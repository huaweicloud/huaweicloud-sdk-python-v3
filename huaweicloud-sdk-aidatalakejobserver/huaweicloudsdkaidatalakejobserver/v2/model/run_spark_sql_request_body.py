...
class RunSparkSqlRequestBody:
    ...
    def __init__(self, endpoint_name=None, catalog_context=None, statement=None, parameters=None, spark_config=None, timeout=None, labels=None):
        ...
        :type catalog_context: :class:`huaweicloudsdkaidatalakejobserver.v2.SparkSqlCatalogContext`
        ...
        :type labels: list[:class:`huaweicloudsdkaidatalakejobserver.v2.SparkSqlLabel`]
        """
    ...
    def catalog_context(self):
        ...
        :rtype: :class:`huaweicloudsdkaidatalakejobserver.v2.SparkSqlCatalogContext`
        """
    ...
    def labels(self):
        ...
        **参数解释**：作业标签列表，用于标识和分类作业。数组中的每个元素为SparkSqlLabel对象，包含标签的键和值。 **约束限制**：标签数量不能超过16条。 
        ...
        :rtype: list[:class:`huaweicloudsdkaidatalakejobserver.v2.SparkSqlLabel`]
        """
        return self._labels
