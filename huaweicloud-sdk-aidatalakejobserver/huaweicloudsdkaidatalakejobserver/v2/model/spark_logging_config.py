...
class SparkLoggingConfig:
    ...
    def __init__(self, driver_root_logger_level=None, driver_loggers_level_of_class=None, executor_root_logger_level=None, executor_loggers_level_of_class=None):
        ...
        :type driver_loggers_level_of_class: list[:class:`huaweicloudsdkaidatalakejobserver.v2.SparkClassLoggerLevel`]
        ...
        :type executor_loggers_level_of_class: list[:class:`huaweicloudsdkaidatalakejobserver.v2.SparkClassLoggerLevel`]
        """
    ...
    def driver_loggers_level_of_class(self):
        ...
        **参数解释**：Driver类级别日志配置列表，用于配置指定类的日志级别。数组中的每个元素为SparkClassLoggerLevel对象，包含类名和日志级别。 **约束限制**：最多配置20个类的日志级别。 
        ...
        :rtype: list[:class:`huaweicloudsdkaidatalakejobserver.v2.SparkClassLoggerLevel`]
        """
