...
class PreviewSparkSqlResultResponse(SdkResponse):
    ...
    def __init__(self, result_format=None, result_path=None, schema=None, rows=None):
        ...
        :type schema: list[:class:`huaweicloudsdkaidatalakejobserver.v2.SparkSqlSchemaItem`]
    ...
    def schema(self):
        ...
        **参数解释**：结果数据的列结构定义，包含列名和列类型信息。数组中的每个元素为SparkSqlSchemaItem对象。
        ...
        :rtype: list[:class:`huaweicloudsdkaidatalakejobserver.v2.SparkSqlSchemaItem`]
        """
        return self._schema
