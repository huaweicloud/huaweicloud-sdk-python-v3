...
class SqlSessionInfo:
    ...
    def __init__(self, session_id=None, status=None, create_time=None, endpoint_info=None):
        ...
        :type session_id: str
        :param status: 
        :type status: :class:`huaweicloudsdkaidatalakejobserver.v2.SqlSessionStatus`
        :param create_time: **参数解释**：session创建时间。 **取值范围**：不涉及。
        :type create_time: datetime
        :param endpoint_info: **参数解释**：端点信息。
        :type endpoint_info: :class:`huaweicloudsdkaidatalakejobserver.v2.object`
        """
    ...
    def status(self):
        ...
        :rtype: :class:`huaweicloudsdkaidatalakejobserver.v2.SqlSessionStatus`
        """
        return self._status
