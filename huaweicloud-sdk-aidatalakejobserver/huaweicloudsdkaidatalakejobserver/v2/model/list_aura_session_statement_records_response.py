...
class ListAuraSessionStatementRecordsResponse(SdkResponse):
    ...
    def __init__(self, records=None, current_count=None, next_marker=None):
        ...
        :type records: list[:class:`huaweicloudsdkaidatalakejobserver.v2.SessionStatementRecord`]
    ...
    def records(self):
        ...
        **参数解释**：本次查询记录。 **取值范围**：不涉及。
        ...
        :rtype: list[:class:`huaweicloudsdkaidatalakejobserver.v2.SessionStatementRecord`]
        """
