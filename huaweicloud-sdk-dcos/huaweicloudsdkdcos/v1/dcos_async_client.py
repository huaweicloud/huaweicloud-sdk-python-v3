...
class DcosAsyncClient(Client):
    def __init__(self):
        super(DcosAsyncClient, self).__init__()
    ...
    def new_builder(cls, clazz=None):
        if not clazz:
            ...
            if clazz.__name__ != "DcosAsyncClient":
                raise TypeError("client type error, support client type is DcosAsyncClient")
    ...
    def show_page_asset_list_result_async_invoker(self, request):
        http_info = self._show_page_asset_list_result_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_page_asset_list_result_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def verify_order_async_invoker(self, request):
        http_info = self._verify_order_http_info(request)
        return AsyncInvoker(self, http_info)

    def _verify_order_http_info(self, request):
        http_info = {
            "method": "POST",
