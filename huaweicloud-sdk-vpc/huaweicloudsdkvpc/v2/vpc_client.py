...
class VpcClient(Client):
    ...
    def batch_create_security_group_tags(self, request):
        """批量创建安全组资源标签
    ...
    def batch_create_security_group_tags_invoker(self, request):
        http_info = self._batch_create_security_group_tags_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _batch_create_security_group_tags_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def batch_delete_security_group_tags(self, request):
        """批量删除安全组资源标签
    ...
    def batch_delete_security_group_tags_invoker(self, request):
        http_info = self._batch_delete_security_group_tags_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _batch_delete_security_group_tags_http_info(cls, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v2.0/{project_id}/security-groups/{security_group_id}/tags/action",
            "request_type": request.__class__.__name__,
    ...
    def create_security_group_tag(self, request):
        """创建安全组资源标签
    ...
    def create_security_group_tag_invoker(self, request):
        http_info = self._create_security_group_tag_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_security_group_tag_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def delete_security_group_tag(self, request):
        """删除安全组资源标签
    ...
    def delete_security_group_tag_invoker(self, request):
        http_info = self._delete_security_group_tag_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_security_group_tag_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_security_group_tags(self, request):
        """查询安全组项目标签
    ...
    def list_security_group_tags_invoker(self, request):
        http_info = self._list_security_group_tags_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_security_group_tags_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_security_groups_by_tags(self, request):
        """查询安全组资源实例
    ...
    def list_security_groups_by_tags_invoker(self, request):
        http_info = self._list_security_groups_by_tags_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_security_groups_by_tags_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def show_security_group_tags(self, request):
        """查询安全组资源标签
    ...
    def show_security_group_tags_invoker(self, request):
        http_info = self._show_security_group_tags_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_security_group_tags_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v2.0/{project_id}/security-groups/{security_group_id}/tags",
            "request_type": request.__class__.__name__,
