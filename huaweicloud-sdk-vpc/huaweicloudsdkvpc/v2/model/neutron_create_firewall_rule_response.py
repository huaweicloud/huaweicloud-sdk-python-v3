...
class NeutronCreateFirewallRuleResponse(SdkResponse):
    ...
    def __init__(self, firewall_rule=None):
        r"""NeutronCreateFirewallRuleResponse
    ...
    def firewall_rule(self):
        r"""Gets the firewall_rule of this NeutronCreateFirewallRuleResponse.
    ...
    def firewall_rule(self, firewall_rule):
        r"""Sets the firewall_rule of this NeutronCreateFirewallRuleResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("NeutronCreateFirewallRuleResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NeutronCreateFirewallRuleResponse):
            return False
