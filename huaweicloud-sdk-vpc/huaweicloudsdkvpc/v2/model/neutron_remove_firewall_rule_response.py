...
class NeutronRemoveFirewallRuleResponse(SdkResponse):
    ...
    def __init__(self, id=None, name=None, description=None, firewall_rules=None, audited=None, public=None, tenant_id=None, project_id=None):
        r"""NeutronRemoveFirewallRuleResponse
    ...
    @property
    def id(self):
        r"""Gets the id of this NeutronRemoveFirewallRuleResponse.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this NeutronRemoveFirewallRuleResponse.
    ...
    @property
    def name(self):
        r"""Gets the name of this NeutronRemoveFirewallRuleResponse.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this NeutronRemoveFirewallRuleResponse.
    ...
    def description(self):
        r"""Gets the description of this NeutronRemoveFirewallRuleResponse.
    ...
    def description(self, description):
        r"""Sets the description of this NeutronRemoveFirewallRuleResponse.
    ...
    def firewall_rules(self):
        r"""Gets the firewall_rules of this NeutronRemoveFirewallRuleResponse.
    ...
    def firewall_rules(self, firewall_rules):
        r"""Sets the firewall_rules of this NeutronRemoveFirewallRuleResponse.
    ...
    @property
    def audited(self):
        r"""Gets the audited of this NeutronRemoveFirewallRuleResponse.
    ...
    def audited(self, audited):
        r"""Sets the audited of this NeutronRemoveFirewallRuleResponse.
    ...
    @property
    def public(self):
        r"""Gets the public of this NeutronRemoveFirewallRuleResponse.
    ...
    def public(self, public):
        r"""Sets the public of this NeutronRemoveFirewallRuleResponse.
    ...
    @property
    def tenant_id(self):
        r"""Gets the tenant_id of this NeutronRemoveFirewallRuleResponse.
    ...
    def tenant_id(self, tenant_id):
        r"""Sets the tenant_id of this NeutronRemoveFirewallRuleResponse.
    ...
    @property
    def project_id(self):
        r"""Gets the project_id of this NeutronRemoveFirewallRuleResponse.
    ...
    def project_id(self, project_id):
        r"""Sets the project_id of this NeutronRemoveFirewallRuleResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("NeutronRemoveFirewallRuleResponse.to_dict() is deprecated and no longer maintained, "
