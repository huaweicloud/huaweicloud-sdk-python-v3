...
class NeutronUpdateRouterRequest(object):
    ...
    def __init__(self, router_id=None, body=None):  # noqa: E501
        """NeutronUpdateRouterRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: NeutronUpdateRouterRequestBody
        """
        return self._body
    ...
    def body(self, body):
        ...
        :type: NeutronUpdateRouterRequestBody
        """
        self._body = body
