...
class NeutronUpdateFirewallGroupOption(object):
    ...
    def __init__(self, admin_state_up=True, description=None, egress_firewall_policy_id=None, ingress_firewall_policy_id=None, name=None, ports=None):  # noqa: E501
        """NeutronUpdateFirewallGroupOption - a model defined in huaweicloud sdk"""
