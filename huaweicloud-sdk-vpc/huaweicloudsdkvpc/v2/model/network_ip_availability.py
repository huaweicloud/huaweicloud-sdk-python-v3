...
class NetworkIpAvailability(object):
    ...
    def __init__(self, network_id=None, network_name=None, tenant_id=None, total_ips=None, used_ips=None, subnet_ip_availability=None):  # noqa: E501
