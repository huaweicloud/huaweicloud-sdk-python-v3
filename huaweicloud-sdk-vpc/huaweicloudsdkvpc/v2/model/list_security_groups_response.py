...
class ListSecurityGroupsResponse(SdkResponse):
    ...
    def __init__(self, security_groups=None):
        ...
        :type security_groups: list[:class:`huaweicloudsdkvpc.v2.SecurityGroup`]
        """
    ...
    def security_groups(self):
        ...
        :rtype: list[:class:`huaweicloudsdkvpc.v2.SecurityGroup`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListSecurityGroupsResponse.to_dict() is deprecated and no longer maintained, "
