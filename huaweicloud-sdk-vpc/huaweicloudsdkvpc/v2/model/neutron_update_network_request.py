...
class NeutronUpdateNetworkRequest(object):
    ...
    def __init__(self, network_id=None, body=None):  # noqa: E501
        """NeutronUpdateNetworkRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: NeutronUpdateNetworkRequestBody
        """
        return self._body
    ...
    def body(self, body):
        ...
        :type: NeutronUpdateNetworkRequestBody
        """
        self._body = body
