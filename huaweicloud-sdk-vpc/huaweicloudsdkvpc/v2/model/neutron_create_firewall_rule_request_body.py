...
class NeutronCreateFirewallRuleRequestBody(object):
    ...
    openapi_types = {
        'firewall_rule': 'NeutronCreateFirewallRuleOption'
    }
    ...
    def __init__(self, firewall_rule=None):  # noqa: E501
        """NeutronCreateFirewallRuleRequestBody - a model defined in huaweicloud sdk"""
    ...
    def firewall_rule(self):
        ...
        :rtype: NeutronCreateFirewallRuleOption
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NeutronCreateFirewallRuleRequestBody):
            return False
