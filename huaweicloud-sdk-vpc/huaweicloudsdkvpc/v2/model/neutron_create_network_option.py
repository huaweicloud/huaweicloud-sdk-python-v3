...
class NeutronCreateNetworkOption:
    ...
    def __init__(self, name=None, admin_state_up=None, shared=None, providernetwork_type=None, port_security_enabled=None):
        ...
        :param shared: 功能说明：是否支持跨租户共享 取值范围：true、false
        :type shared: bool
        :param providernetwork_type: 功能说明：扩展属性：网络类型。管理员属性，普通租户不可见，允许 geneve类型租户执行操作。 取值范围：vxlan, geneve
    ...
    def shared(self):
        ...
        :return: The shared of this NeutronCreateNetworkOption.
        :rtype: bool
        """
        return self._shared
    ...
    def shared(self, shared):
        ...
        :param shared: The shared of this NeutronCreateNetworkOption.
        :type shared: bool
        """
        self._shared = shared
