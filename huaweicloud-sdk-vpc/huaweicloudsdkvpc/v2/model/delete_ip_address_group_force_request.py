...
class DeleteIpAddressGroupForceRequest(object):
    ...
    def address_group_id(self):
        ...
        :return: The address_group_id of this DeleteIpAddressGroupForceRequest.
        :rtype: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteIpAddressGroupForceRequest):
            return False
