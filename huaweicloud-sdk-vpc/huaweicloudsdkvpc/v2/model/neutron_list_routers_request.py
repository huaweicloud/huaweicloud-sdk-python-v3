...
class NeutronListRoutersRequest(object):
    ...
    def __init__(self, limit=2000, marker=None, id=None, status=None, tenant_id=None, admin_state_up=None):  # noqa: E501
        """NeutronListRoutersRequest - a model defined in huaweicloud sdk"""
