...
class CreatePrivateipResponse(SdkResponse):
    ...
    @property
    def privateips(self):
        r"""Gets the privateips of this CreatePrivateipResponse.
    ...
    def privateips(self, privateips):
        r"""Sets the privateips of this CreatePrivateipResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreatePrivateipResponse.to_dict() is deprecated and no longer maintained, "
