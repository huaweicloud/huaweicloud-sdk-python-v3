...
class DelRouteTableRoute:
    ...
    @type.setter
    def type(self, type):
        r"""Sets the type of this DelRouteTableRoute.

        功能说明：路由的类型 取值范围： ecs：弹性云服务器 eni：网卡 vip：虚拟IP nat：NAT网关 peering：对等连接 vpn：虚拟专用网络 dc：云专线 cc：云连接 egw：VPC终端节点

        :param type: The type of this DelRouteTableRoute.
        :type type: str
        """
        self._type = type
    ...
    def destination(self):
        r"""Gets the destination of this DelRouteTableRoute.

        功能说明：路由目的网段 约束：合法的CIDR格式

        :return: The destination of this DelRouteTableRoute.
        :rtype: str
        """
    ...
    def destination(self, destination):
        r"""Sets the destination of this DelRouteTableRoute.

        功能说明：路由目的网段 约束：合法的CIDR格式

        :param destination: The destination of this DelRouteTableRoute.
        :type destination: str
        """
    ...
    @property
    def nexthop(self):
        r"""Gets the nexthop of this DelRouteTableRoute.
        ...
        :return: The nexthop of this DelRouteTableRoute.
        :rtype: str
        """
    ...
    def nexthop(self, nexthop):
        r"""Sets the nexthop of this DelRouteTableRoute.

        功能说明：路由下一跳对象的ID 取值范围： 当type为ecs时，传入ecs实例ID 当type为eni时，取值为从网卡ID 当type为vip时，取值为vip对应的IP地址 当type为nat时，取值为nat实例对应的ID 当type为peering时，取值为peering对应实例ID 当type为vpn时，取值为vpn实例ID 当type为dc时，取值为dc实例ID 当type为cc时，取值为cc的实例ID

        :param nexthop: The nexthop of this DelRouteTableRoute.
        :type nexthop: str
        """
    ...
    def description(self):
        r"""Gets the description of this DelRouteTableRoute.

        功能说明：路由的描述信息 取值范围：0-255个字符，不能包含“<”和“>”

        :return: The description of this DelRouteTableRoute.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this DelRouteTableRoute.

        功能说明：路由的描述信息 取值范围：0-255个字符，不能包含“<”和“>”

        :param description: The description of this DelRouteTableRoute.
        :type description: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DelRouteTableRoute):
            return False
