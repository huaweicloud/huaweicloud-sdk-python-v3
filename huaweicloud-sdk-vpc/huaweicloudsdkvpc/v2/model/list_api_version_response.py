...
class ListApiVersionResponse(SdkResponse):
    ...
    def __init__(self, versions=None):
        ...
        :param versions: API版本列表
        :type versions: list[:class:`huaweicloudsdkvpc.v2.VersionResult`]
        """
    ...
    def versions(self):
        ...
        :rtype: list[:class:`huaweicloudsdkvpc.v2.VersionResult`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListApiVersionResponse.to_dict() is deprecated and no longer maintained, "
