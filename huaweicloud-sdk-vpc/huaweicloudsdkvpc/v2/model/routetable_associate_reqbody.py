...
class RoutetableAssociateReqbody(object):
    ...
    def __init__(self, routetable=None):  # noqa: E501
        """RoutetableAssociateReqbody - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RoutetableAssociateReqbody):
            return False
