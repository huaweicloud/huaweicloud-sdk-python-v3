...
class AddRouteTableRoute:
    ...
    def __init__(self, type=None, destination=None, nexthop=None, description=None):
        ...
        :param type: 功能说明：路由的类型 取值范围： ecs：弹性云服务器 eni：网卡 vip：虚拟IP nat：NAT网关 peering：对等连接 vpn：虚拟专用网络 dc：云专线 cc：云连接 egw：VPC终端节点 er：企业路由器 subeni：辅助弹性网卡 local：保留网段，用户下发路由的目的网段不能和local类型路由的目的网段有重叠
        :type type: str
        :param destination: 功能说明：路由目的网段 约束：合法的CIDR格式
        :type destination: str
        :param nexthop: 功能说明：路由下一跳对象的ID。 取值范围： 当type为ecs时，传入ecs实例ID； 当type为eni时，取值为从网卡ID； 当type为vip时，取值为vip对应的IP地址； 当type为nat时，取值为nat实例对应的ID； 当type为peering时，取值为peering对应实例ID； 当type为vpn时，取值为vpn实例ID； 当type为dc时，取值为dc实例ID; 当type为cc时，取值为cc的实例ID； 当type为egw时，取值为vpc终端节点的实例ID； 当type为er时，取值为企业路由器的实例ID； 当type为subeni时，取值为辅助弹性网卡的实例ID。
        :type nexthop: str
    ...
    def type(self):
        ...
        :return: The type of this AddRouteTableRoute.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        ...
        :param type: The type of this AddRouteTableRoute.
        :type type: str
        """
        self._type = type
    ...
    def destination(self):
        ...
        :return: The destination of this AddRouteTableRoute.
        :rtype: str
        """
    ...
    def destination(self, destination):
        ...
        :param destination: The destination of this AddRouteTableRoute.
        :type destination: str
        """
    ...
    def nexthop(self):
        ...
        :return: The nexthop of this AddRouteTableRoute.
        :rtype: str
        """
    ...
    def nexthop(self, nexthop):
        ...
        :param nexthop: The nexthop of this AddRouteTableRoute.
        :type nexthop: str
        """
    ...
    def description(self):
        ...
        :return: The description of this AddRouteTableRoute.
        :rtype: str
        """
    ...
    def description(self, description):
        ...
        :param description: The description of this AddRouteTableRoute.
        :type description: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddRouteTableRoute):
            return False
