...
class ListSecurityGroupsByTagsRequest:
    ...
    openapi_types = {
        'body': 'ListSecurityGroupsByTagsRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ListSecurityGroupsByTagsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListSecurityGroupsByTagsRequest):
            return False
