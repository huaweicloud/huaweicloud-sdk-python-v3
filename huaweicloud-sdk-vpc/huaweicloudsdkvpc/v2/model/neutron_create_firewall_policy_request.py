...
class NeutronCreateFirewallPolicyRequest(object):
    ...
    openapi_types = {
        'body': 'NeutronCreateFirewallPolicyRequestBody'
    }
    ...
    def __init__(self, body=None):  # noqa: E501
        """NeutronCreateFirewallPolicyRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: NeutronCreateFirewallPolicyRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NeutronCreateFirewallPolicyRequest):
            return False
