...
class NeutronNetwork(object):
    ...
    def __init__(self, id=None, status=None, name=None, subnets=None, routerexternal=None, admin_state_up=None, shared=None, tenant_id=None, providernetwork_type=None, availability_zone_hints=None, availability_zones=None, port_security_enabled=None, dns_domain=None, project_id=None, created_at=None, updated_at=None):  # noqa: E501
        """NeutronNetwork - a model defined in huaweicloud sdk"""
