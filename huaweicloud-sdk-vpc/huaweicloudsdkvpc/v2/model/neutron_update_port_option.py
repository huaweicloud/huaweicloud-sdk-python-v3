...
class NeutronUpdatePortOption(object):
    ...
    def __init__(self, name=None, security_groups=None, allowed_address_pairs=None, extra_dhcp_opts=None, port_security_enabled=True, bindingvnic_type=None, bindingprofile=None):  # noqa: E501
        """NeutronUpdatePortOption - a model defined in huaweicloud sdk"""
