...
class NeutronCreateRouterOption(object):
    ...
    def __init__(self, name=None, admin_state_up=True, external_gateway_info=None):  # noqa: E501
        """NeutronCreateRouterOption - a model defined in huaweicloud sdk"""
