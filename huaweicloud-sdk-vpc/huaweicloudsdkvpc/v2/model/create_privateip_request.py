...
class CreatePrivateipRequest(object):
    ...
    openapi_types = {
        'body': 'CreatePrivateipRequestBody'
    }
    ...
    def __init__(self, body=None):  # noqa: E501
        """CreatePrivateipRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: CreatePrivateipRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreatePrivateipRequest):
            return False
