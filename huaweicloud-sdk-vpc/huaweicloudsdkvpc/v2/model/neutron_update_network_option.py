...
class NeutronUpdateNetworkOption(object):
    ...
    def __init__(self, name=None, admin_state_up=True, port_security_enabled=True):  # noqa: E501
        """NeutronUpdateNetworkOption - a model defined in huaweicloud sdk"""
