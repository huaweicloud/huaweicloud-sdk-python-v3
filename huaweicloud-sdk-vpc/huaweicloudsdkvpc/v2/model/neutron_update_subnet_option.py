...
class NeutronUpdateSubnetOption(object):
    ...
    def __init__(self, dns_nameservers=None, enable_dhcp=True, host_routes=None, name='空', allocation_pools=None):  # noqa: E501
        """NeutronUpdateSubnetOption - a model defined in huaweicloud sdk"""
    ...
    def dns_nameservers(self):
        ...
        功能说明：dns服务器 例如：\"dns_nameservers\": [\"8.8.8.8\",\"8.8.4.4\"]，最大为5个
