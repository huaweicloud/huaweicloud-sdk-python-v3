...
class NeutronUpdateFirewallRuleRequestBody:
    ...
    def __init__(self, firewall_rule=None):
        r"""NeutronUpdateFirewallRuleRequestBody
    ...
    def firewall_rule(self):
        r"""Gets the firewall_rule of this NeutronUpdateFirewallRuleRequestBody.
    ...
    def firewall_rule(self, firewall_rule):
        r"""Sets the firewall_rule of this NeutronUpdateFirewallRuleRequestBody.
