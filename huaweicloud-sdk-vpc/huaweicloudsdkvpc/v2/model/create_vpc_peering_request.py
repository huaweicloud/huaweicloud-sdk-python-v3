...
class CreateVpcPeeringRequest(object):
    ...
    openapi_types = {
        'body': 'CreateVpcPeeringRequestBody'
    }
    ...
    def __init__(self, body=None):  # noqa: E501
        """CreateVpcPeeringRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: CreateVpcPeeringRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateVpcPeeringRequest):
            return False
