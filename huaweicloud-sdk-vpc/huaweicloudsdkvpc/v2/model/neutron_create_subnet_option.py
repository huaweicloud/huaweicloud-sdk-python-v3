...
class NeutronCreateSubnetOption(object):
    ...
    def __init__(self, name=None, cidr=None, network_id=None, gateway_ip=None, ip_version=None, allocation_pools=None, dns_nameservers=None, host_routes=None, enable_dhcp=True, ipv6_address_mode='dhcpv6-stateful', ipv6_ra_mode='dhcpv6-stateful'):  # noqa: E501
        """NeutronCreateSubnetOption - a model defined in huaweicloud sdk"""
