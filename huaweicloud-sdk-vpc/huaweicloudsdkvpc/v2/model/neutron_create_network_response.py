...
class NeutronCreateNetworkResponse(SdkResponse):
    ...
    def __init__(self, network=None):
        r"""NeutronCreateNetworkResponse
    ...
    @property
    def network(self):
        r"""Gets the network of this NeutronCreateNetworkResponse.
    ...
    def network(self, network):
        r"""Sets the network of this NeutronCreateNetworkResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("NeutronCreateNetworkResponse.to_dict() is deprecated and no longer maintained, "
