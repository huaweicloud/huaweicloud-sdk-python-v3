...
class NeutronCreateSecurityGroupRuleOption(object):
    ...
    def __init__(self, description='""', direction=None, ethertype='IPv4', port_range_max=None, port_range_min=None, protocol=None, remote_group_id=None, remote_ip_prefix=None, security_group_id=None):  # noqa: E501
