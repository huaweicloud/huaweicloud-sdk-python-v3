...
class RemoveFirewallRulesRequest:
    ...
    openapi_types = {
        'firewall_id': 'str',
        'body': 'RemoveFirewallRulesRequestBody'
    }
    ...
    def __init__(self, firewall_id=None, body=None):
        ...
        :param body: Body of the RemoveFirewallRulesRequest
    ...
    def firewall_id(self):
        ...
        :return: The firewall_id of this RemoveFirewallRulesRequest.
        :rtype: str
        """
    ...
    def firewall_id(self, firewall_id):
        ...
        :param firewall_id: The firewall_id of this RemoveFirewallRulesRequest.
        :type firewall_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RemoveFirewallRulesRequest):
            return False
