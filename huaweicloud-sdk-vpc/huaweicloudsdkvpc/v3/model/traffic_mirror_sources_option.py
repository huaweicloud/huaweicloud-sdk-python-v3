...
class TrafficMirrorSourcesOption:
    ...
    def __init__(self, traffic_mirror_sources=None):
        ...
        :param traffic_mirror_sources: 功能说明：镜像源ID列表
    ...
    def traffic_mirror_sources(self):
        ...
        :return: The traffic_mirror_sources of this TrafficMirrorSourcesOption.
        :rtype: list[str]
        """
    ...
    def traffic_mirror_sources(self, traffic_mirror_sources):
        ...
        :param traffic_mirror_sources: The traffic_mirror_sources of this TrafficMirrorSourcesOption.
        :type traffic_mirror_sources: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TrafficMirrorSourcesOption):
            return False
