...
class ShowVirsubnetCidrReservationRequest:
    ...
    def __init__(self, virsubnet_cidr_reservation_id=None):
        r"""ShowVirsubnetCidrReservationRequest
    ...
    def virsubnet_cidr_reservation_id(self):
        r"""Gets the virsubnet_cidr_reservation_id of this ShowVirsubnetCidrReservationRequest.

        **参数解释**： 子网预留网段的资源ID。 **取值范围**： 不涉及。

        :return: The virsubnet_cidr_reservation_id of this ShowVirsubnetCidrReservationRequest.
        :rtype: str
        """
    ...
    def virsubnet_cidr_reservation_id(self, virsubnet_cidr_reservation_id):
        r"""Sets the virsubnet_cidr_reservation_id of this ShowVirsubnetCidrReservationRequest.

        **参数解释**： 子网预留网段的资源ID。 **取值范围**： 不涉及。

        :param virsubnet_cidr_reservation_id: The virsubnet_cidr_reservation_id of this ShowVirsubnetCidrReservationRequest.
        :type virsubnet_cidr_reservation_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowVirsubnetCidrReservationRequest):
            return False
