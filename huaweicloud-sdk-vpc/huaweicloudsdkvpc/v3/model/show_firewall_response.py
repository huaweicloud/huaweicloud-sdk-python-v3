...
class ShowFirewallResponse(SdkResponse):
    ...
    @property
    def request_id(self):
        r"""Gets the request_id of this ShowFirewallResponse.

        请求ID

        :return: The request_id of this ShowFirewallResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        r"""Sets the request_id of this ShowFirewallResponse.

        请求ID

        :param request_id: The request_id of this ShowFirewallResponse.
        :type request_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowFirewallResponse.to_dict() is deprecated and no longer maintained, "
