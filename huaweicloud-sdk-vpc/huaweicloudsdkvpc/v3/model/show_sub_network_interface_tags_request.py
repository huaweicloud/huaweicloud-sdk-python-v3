...
class ShowSubNetworkInterfaceTagsRequest:
    ...
    def __init__(self, sub_network_interface_id=None):
        r"""ShowSubNetworkInterfaceTagsRequest
    ...
    def sub_network_interface_id(self):
        r"""Gets the sub_network_interface_id of this ShowSubNetworkInterfaceTagsRequest.

        **参数解释**： 辅助弹性网卡唯一标识。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :return: The sub_network_interface_id of this ShowSubNetworkInterfaceTagsRequest.
        :rtype: str
        """
    ...
    def sub_network_interface_id(self, sub_network_interface_id):
        r"""Sets the sub_network_interface_id of this ShowSubNetworkInterfaceTagsRequest.

        **参数解释**： 辅助弹性网卡唯一标识。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :param sub_network_interface_id: The sub_network_interface_id of this ShowSubNetworkInterfaceTagsRequest.
        :type sub_network_interface_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowSubNetworkInterfaceTagsRequest):
            return False
