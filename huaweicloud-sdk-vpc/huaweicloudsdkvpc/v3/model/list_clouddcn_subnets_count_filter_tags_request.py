...
class ListClouddcnSubnetsCountFilterTagsRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ListClouddcnSubnetsCountFilterTagsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListClouddcnSubnetsCountFilterTagsRequest):
            return False
