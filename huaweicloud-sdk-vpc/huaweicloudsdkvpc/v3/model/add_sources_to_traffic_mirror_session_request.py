...
class AddSourcesToTrafficMirrorSessionRequest:
    ...
    openapi_types = {
        ...
        'body': 'AddSourcesToTrafficMirrorSessionRequestBody'
    }
    ...
    def __init__(self, traffic_mirror_session_id=None, body=None):
        ...
        :param body: Body of the AddSourcesToTrafficMirrorSessionRequest
    ...
    def traffic_mirror_session_id(self):
        ...
        :return: The traffic_mirror_session_id of this AddSourcesToTrafficMirrorSessionRequest.
        :rtype: str
        """
    ...
    def traffic_mirror_session_id(self, traffic_mirror_session_id):
        ...
        :param traffic_mirror_session_id: The traffic_mirror_session_id of this AddSourcesToTrafficMirrorSessionRequest.
        :type traffic_mirror_session_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddSourcesToTrafficMirrorSessionRequest):
            return False
