...
class DeleteTrafficMirrorFilterRuleRequest:
    ...
    def __init__(self, traffic_mirror_filter_rule_id=None):
        r"""DeleteTrafficMirrorFilterRuleRequest
    ...
    def traffic_mirror_filter_rule_id(self):
        r"""Gets the traffic_mirror_filter_rule_id of this DeleteTrafficMirrorFilterRuleRequest.

        流量镜像筛选条件规则ID

        :return: The traffic_mirror_filter_rule_id of this DeleteTrafficMirrorFilterRuleRequest.
        :rtype: str
        """
    ...
    def traffic_mirror_filter_rule_id(self, traffic_mirror_filter_rule_id):
        r"""Sets the traffic_mirror_filter_rule_id of this DeleteTrafficMirrorFilterRuleRequest.

        流量镜像筛选条件规则ID

        :param traffic_mirror_filter_rule_id: The traffic_mirror_filter_rule_id of this DeleteTrafficMirrorFilterRuleRequest.
        :type traffic_mirror_filter_rule_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteTrafficMirrorFilterRuleRequest):
            return False
