...
class ShowTrafficMirrorSessionRequest:
    ...
    def __init__(self, traffic_mirror_session_id=None):
        r"""ShowTrafficMirrorSessionRequest
    ...
    def traffic_mirror_session_id(self):
        r"""Gets the traffic_mirror_session_id of this ShowTrafficMirrorSessionRequest.

        流量镜像会话ID

        :return: The traffic_mirror_session_id of this ShowTrafficMirrorSessionRequest.
        :rtype: str
        """
    ...
    def traffic_mirror_session_id(self, traffic_mirror_session_id):
        r"""Sets the traffic_mirror_session_id of this ShowTrafficMirrorSessionRequest.

        流量镜像会话ID

        :param traffic_mirror_session_id: The traffic_mirror_session_id of this ShowTrafficMirrorSessionRequest.
        :type traffic_mirror_session_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowTrafficMirrorSessionRequest):
            return False
