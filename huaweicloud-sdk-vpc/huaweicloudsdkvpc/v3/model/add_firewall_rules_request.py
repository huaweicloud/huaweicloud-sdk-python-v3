...
class AddFirewallRulesRequest:
    ...
    openapi_types = {
        'firewall_id': 'str',
        'body': 'AddFirewallRulesRequestBody'
    }
    ...
    def __init__(self, firewall_id=None, body=None):
        ...
        :param body: Body of the AddFirewallRulesRequest
    ...
    def firewall_id(self):
        ...
        :return: The firewall_id of this AddFirewallRulesRequest.
        :rtype: str
        """
    ...
    def firewall_id(self, firewall_id):
        ...
        :param firewall_id: The firewall_id of this AddFirewallRulesRequest.
        :type firewall_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddFirewallRulesRequest):
            return False
