...
class CountFirewallsByTagsRequest:
    ...
    openapi_types = {
        'body': 'CountFirewallsByTagsRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CountFirewallsByTagsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CountFirewallsByTagsRequest):
            return False
