...
class AssociateSubnetFirewallRequestBody:
    ...
    def subnets(self):
        ...
        :return: The subnets of this AssociateSubnetFirewallRequestBody.
    ...
    def subnets(self, subnets):
        ...
        :param subnets: The subnets of this AssociateSubnetFirewallRequestBody.
        :type subnets: list[:class:`huaweicloudsdkvpc.v3.FirewallAssociation`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssociateSubnetFirewallRequestBody):
            return False
