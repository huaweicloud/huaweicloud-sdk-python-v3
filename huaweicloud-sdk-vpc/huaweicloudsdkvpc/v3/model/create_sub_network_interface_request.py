...
class CreateSubNetworkInterfaceRequest:
    ...
    openapi_types = {
        'body': 'CreateSubNetworkInterfaceRequestBody'
    }
    ...
    def __init__(self, body=None):
        """CreateSubNetworkInterfaceRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: CreateSubNetworkInterfaceRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateSubNetworkInterfaceRequest):
            return False
