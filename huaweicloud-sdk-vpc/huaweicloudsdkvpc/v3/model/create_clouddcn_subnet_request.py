...
class CreateClouddcnSubnetRequest:
    ...
    openapi_types = {
        'body': 'CreateClouddcnSubnetRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateClouddcnSubnetRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateClouddcnSubnetRequest):
            return False
