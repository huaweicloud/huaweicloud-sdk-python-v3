...
class CreateSecurityGroupResponse(SdkResponse):
    ...
    @property
    def request_id(self):
        r"""Gets the request_id of this CreateSecurityGroupResponse.
    ...
    def request_id(self, request_id):
        r"""Sets the request_id of this CreateSecurityGroupResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateSecurityGroupResponse.to_dict() is deprecated and no longer maintained, "
