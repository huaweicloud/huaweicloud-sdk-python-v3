...
class BatchImportCloudPhoneDataRequest:
    ...
    def __init__(self, body=None):
        r"""BatchImportCloudPhoneDataRequest

        The model defined in huaweicloud sdk

        :param body: Body of the BatchImportCloudPhoneDataRequest
    ...
    @property
    def body(self):
        r"""Gets the body of this BatchImportCloudPhoneDataRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this BatchImportCloudPhoneDataRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchImportCloudPhoneDataRequest):
            return False
