...
class CreateNet2CloudPhoneServerRequestBodyPublicIp:
    ...
    def __init__(self, ids=None, eip=None, count=None):
        r"""CreateNet2CloudPhoneServerRequestBodyPublicIp
    ...
    @property
    def ids(self):
        r"""Gets the ids of this CreateNet2CloudPhoneServerRequestBodyPublicIp.
    ...
    @ids.setter
    def ids(self, ids):
        r"""Sets the ids of this CreateNet2CloudPhoneServerRequestBodyPublicIp.
    ...
    @property
    def eip(self):
        r"""Gets the eip of this CreateNet2CloudPhoneServerRequestBodyPublicIp.
    ...
    @eip.setter
    def eip(self, eip):
        r"""Sets the eip of this CreateNet2CloudPhoneServerRequestBodyPublicIp.
    ...
    @property
    def count(self):
        r"""Gets the count of this CreateNet2CloudPhoneServerRequestBodyPublicIp.
    ...
    def count(self, count):
        r"""Sets the count of this CreateNet2CloudPhoneServerRequestBodyPublicIp.
