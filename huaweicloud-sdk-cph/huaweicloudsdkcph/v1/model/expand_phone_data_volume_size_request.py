...
class ExpandPhoneDataVolumeSizeRequest:
    ...
    openapi_types = {
        'body': 'ExpandPhoneDataVolumeSizeRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ExpandPhoneDataVolumeSizeRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExpandPhoneDataVolumeSizeRequest):
            return False
