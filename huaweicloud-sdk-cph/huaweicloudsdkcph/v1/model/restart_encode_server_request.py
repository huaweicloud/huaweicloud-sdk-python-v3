...
class RestartEncodeServerRequest:
    ...
    openapi_types = {
        'body': 'RestartEncodeServerRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the RestartEncodeServerRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RestartEncodeServerRequest):
            return False
