...
class ListShareFilesResponse(SdkResponse):
    ...
    @property
    def request_id(self):
        r"""Gets the request_id of this ListShareFilesResponse.
    ...
    def request_id(self, request_id):
        r"""Sets the request_id of this ListShareFilesResponse.
    ...
    @property
    def jobs(self):
        r"""Gets the jobs of this ListShareFilesResponse.
    ...
    @jobs.setter
    def jobs(self, jobs):
        r"""Sets the jobs of this ListShareFilesResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListShareFilesResponse.to_dict() is deprecated and no longer maintained, "
