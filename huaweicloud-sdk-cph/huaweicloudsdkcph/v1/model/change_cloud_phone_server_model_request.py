...
class ChangeCloudPhoneServerModelRequest:
    ...
    openapi_types = {
        'body': 'ChangeCloudPhoneServerModelRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ChangeCloudPhoneServerModelRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChangeCloudPhoneServerModelRequest):
            return False
