...
class CreateNet2CloudPhoneServerRequest:
    ...
    openapi_types = {
        'body': 'CreateNet2CloudPhoneServerRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateNet2CloudPhoneServerRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateNet2CloudPhoneServerRequest):
            return False
