...
class CreateCloudPhoneSingleServerRequest:
    ...
    openapi_types = {
        'body': 'CreateCloudPhoneSingleServerRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateCloudPhoneSingleServerRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateCloudPhoneSingleServerRequest):
            return False
