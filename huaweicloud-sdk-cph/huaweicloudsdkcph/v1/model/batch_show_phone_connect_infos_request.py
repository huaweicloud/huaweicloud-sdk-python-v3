...
class BatchShowPhoneConnectInfosRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchShowPhoneConnectInfosRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchShowPhoneConnectInfosRequest):
            return False
