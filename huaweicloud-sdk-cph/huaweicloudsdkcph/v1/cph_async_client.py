...
class CphAsyncClient(Client):
    ...
    def attach_share_filesystem_async(self, request):
        r"""挂载共享文件系统
    ...
    def attach_share_filesystem_async_invoker(self, request):
        http_info = self._attach_share_filesystem_http_info(request)
        return AsyncInvoker(self, http_info)

    def _attach_share_filesystem_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def authorize_scheduled_event_async(self, request):
        r"""授权计划事件
    ...
    def authorize_scheduled_event_async_invoker(self, request):
        http_info = self._authorize_scheduled_event_http_info(request)
        return AsyncInvoker(self, http_info)

    def _authorize_scheduled_event_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def change_cloud_phone_server_async_invoker(self, request):
        http_info = self._change_cloud_phone_server_http_info(request)
        return AsyncInvoker(self, http_info)

    def _change_cloud_phone_server_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def create_cloud_phone_single_server_async_invoker(self, request):
        http_info = self._create_cloud_phone_single_server_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_cloud_phone_single_server_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def delete_cloud_phone_server_async_invoker(self, request):
        http_info = self._delete_cloud_phone_server_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_cloud_phone_server_http_info(self, request):
        http_info = {
            "method": "DELETE",
            "resource_path": "/v2/{project_id}/cloud-phone/servers",
            "request_type": request.__class__.__name__,
    ...
    def detach_share_filesystem_async(self, request):
        r"""卸载共享文件系统
    ...
    def detach_share_filesystem_async_invoker(self, request):
        http_info = self._detach_share_filesystem_http_info(request)
        return AsyncInvoker(self, http_info)

    def _detach_share_filesystem_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def expand_phone_data_volume_size_async_invoker(self, request):
        http_info = self._expand_phone_data_volume_size_http_info(request)
        return AsyncInvoker(self, http_info)

    def _expand_phone_data_volume_size_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def list_cloud_phone_server_model_offerings_async(self, request):
        r"""查询云手机服务器规格售卖状态列表
    ...
    def list_cloud_phone_server_model_offerings_async_invoker(self, request):
        http_info = self._list_cloud_phone_server_model_offerings_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_cloud_phone_server_model_offerings_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_share_apps_snapshot_async(self, request):
        r"""查询服务器已安装共享应用列表
    ...
    def list_share_apps_snapshot_async_invoker(self, request):
        http_info = self._list_share_apps_snapshot_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_share_apps_snapshot_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def update_image_member_async_invoker(self, request):
        http_info = self._update_image_member_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_image_member_http_info(self, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v1/{project_id}/cloud-phone/images/{image_id}/members",
            "request_type": request.__class__.__name__,
    ...
    def update_scheduled_event_async(self, request):
        r"""修改计划事件预约时间
    ...
    def update_scheduled_event_async_invoker(self, request):
        http_info = self._update_scheduled_event_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_scheduled_event_http_info(self, request):
        http_info = {
            "method": "PUT",
