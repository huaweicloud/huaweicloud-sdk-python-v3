...
class DeleteWorkloadIdentityRequest:
    ...
    def __init__(self, workload_identity_name=None):
        r"""DeleteWorkloadIdentityRequest
    ...
    def workload_identity_name(self):
        r"""Gets the workload_identity_name of this DeleteWorkloadIdentityRequest.

        The name of the workload identity.

        :return: The workload_identity_name of this DeleteWorkloadIdentityRequest.
        :rtype: str
        """
    ...
    def workload_identity_name(self, workload_identity_name):
        r"""Sets the workload_identity_name of this DeleteWorkloadIdentityRequest.

        The name of the workload identity.

        :param workload_identity_name: The workload_identity_name of this DeleteWorkloadIdentityRequest.
        :type workload_identity_name: str
        """
