...
class PolicyEngineConfiguration:
    ...
    def __init__(self, policy_engine_id=None, mode=None):
        r"""PolicyEngineConfiguration
    ...
    def policy_engine_id(self):
        r"""Gets the policy_engine_id of this PolicyEngineConfiguration.

        System-generated unique identifier for the policy engine.

        :return: The policy_engine_id of this PolicyEngineConfiguration.
        :rtype: str
        """
    ...
    def policy_engine_id(self, policy_engine_id):
        r"""Sets the policy_engine_id of this PolicyEngineConfiguration.

        System-generated unique identifier for the policy engine.

        :param policy_engine_id: The policy_engine_id of this PolicyEngineConfiguration.
        :type policy_engine_id: str
        """
    ...
    @property
    def mode(self):
        r"""Gets the mode of this PolicyEngineConfiguration.

        :return: The mode of this PolicyEngineConfiguration.
    ...
    @mode.setter
    def mode(self, mode):
        r"""Sets the mode of this PolicyEngineConfiguration.

        :param mode: The mode of this PolicyEngineConfiguration.
        :type mode: :class:`huaweicloudsdkagentidentity.v1.PolicyEngineMode`
        """
        self._mode = mode
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PolicyEngineConfiguration):
            return False
