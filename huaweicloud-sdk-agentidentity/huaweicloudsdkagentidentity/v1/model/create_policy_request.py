...
class CreatePolicyRequest:
    ...
    def __init__(self, policy_engine_id=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkagentidentity.v1.CreatePolicyReqBody`
        """
    ...
    def policy_engine_id(self):
        r"""Gets the policy_engine_id of this CreatePolicyRequest.

        System-generated unique identifier for the policy engine.

        :return: The policy_engine_id of this CreatePolicyRequest.
        :rtype: str
        """
    ...
    def policy_engine_id(self, policy_engine_id):
        r"""Sets the policy_engine_id of this CreatePolicyRequest.

        System-generated unique identifier for the policy engine.

        :param policy_engine_id: The policy_engine_id of this CreatePolicyRequest.
        :type policy_engine_id: str
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkagentidentity.v1.CreatePolicyReqBody`
        """
        return self._body
