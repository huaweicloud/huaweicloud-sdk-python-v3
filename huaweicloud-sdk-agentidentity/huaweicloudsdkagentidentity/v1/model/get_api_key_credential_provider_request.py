...
class GetApiKeyCredentialProviderRequest:
    ...
    def __init__(self, credential_provider_name=None):
        r"""GetApiKeyCredentialProviderRequest
    ...
    def credential_provider_name(self):
        r"""Gets the credential_provider_name of this GetApiKeyCredentialProviderRequest.

        The name of the credential provider.

        :return: The credential_provider_name of this GetApiKeyCredentialProviderRequest.
        :rtype: str
        """
    ...
    def credential_provider_name(self, credential_provider_name):
        r"""Sets the credential_provider_name of this GetApiKeyCredentialProviderRequest.

        The name of the credential provider.

        :param credential_provider_name: The credential_provider_name of this GetApiKeyCredentialProviderRequest.
        :type credential_provider_name: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetApiKeyCredentialProviderRequest):
            return False
