...
class GetPolicyEngineRequest:
    ...
    def policy_engine_id(self):
        r"""Gets the policy_engine_id of this GetPolicyEngineRequest.

        System-generated unique identifier for the policy engine.

        :return: The policy_engine_id of this GetPolicyEngineRequest.
        :rtype: str
        """
    ...
    def policy_engine_id(self, policy_engine_id):
        r"""Sets the policy_engine_id of this GetPolicyEngineRequest.

        System-generated unique identifier for the policy engine.

        :param policy_engine_id: The policy_engine_id of this GetPolicyEngineRequest.
        :type policy_engine_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetPolicyEngineRequest):
            return False
