...
class GetTokenVaultRequest:
    ...
    def token_vault_id(self):
        r"""Gets the token_vault_id of this GetTokenVaultRequest.

        The unique identifier of the token vault.

        :return: The token_vault_id of this GetTokenVaultRequest.
        :rtype: str
        """
    ...
    def token_vault_id(self, token_vault_id):
        r"""Sets the token_vault_id of this GetTokenVaultRequest.

        The unique identifier of the token vault.

        :param token_vault_id: The token_vault_id of this GetTokenVaultRequest.
        :type token_vault_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetTokenVaultRequest):
            return False
