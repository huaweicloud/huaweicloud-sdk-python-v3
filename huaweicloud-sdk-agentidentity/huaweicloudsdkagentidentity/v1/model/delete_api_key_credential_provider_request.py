...
class DeleteApiKeyCredentialProviderRequest:
    ...
    def __init__(self, credential_provider_name=None):
        r"""DeleteApiKeyCredentialProviderRequest
    ...
    def credential_provider_name(self):
        r"""Gets the credential_provider_name of this DeleteApiKeyCredentialProviderRequest.

        The name of the credential provider.

        :return: The credential_provider_name of this DeleteApiKeyCredentialProviderRequest.
        :rtype: str
        """
    ...
    def credential_provider_name(self, credential_provider_name):
        r"""Sets the credential_provider_name of this DeleteApiKeyCredentialProviderRequest.

        The name of the credential provider.

        :param credential_provider_name: The credential_provider_name of this DeleteApiKeyCredentialProviderRequest.
        :type credential_provider_name: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteApiKeyCredentialProviderRequest):
            return False
