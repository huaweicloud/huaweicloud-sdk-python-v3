...
class CreatePolicyReqBody:
    ...
    def __init__(self, name=None, description=None, definition=None, validation_mode=None):
    ...
    @property
    def definition(self):
        r"""Gets the definition of this CreatePolicyReqBody.

        :return: The definition of this CreatePolicyReqBody.
    ...
    def definition(self, definition):
        r"""Sets the definition of this CreatePolicyReqBody.

        :param definition: The definition of this CreatePolicyReqBody.
        :type definition: :class:`huaweicloudsdkagentidentity.v1.PolicyDefinition`
        """
    ...
    def validation_mode(self):
        r"""Gets the validation_mode of this CreatePolicyReqBody.

        :return: The validation_mode of this CreatePolicyReqBody.
    ...
    def validation_mode(self, validation_mode):
        r"""Sets the validation_mode of this CreatePolicyReqBody.

        :param validation_mode: The validation_mode of this CreatePolicyReqBody.
        :type validation_mode: :class:`huaweicloudsdkagentidentity.v1.ValidationMode`
        """
