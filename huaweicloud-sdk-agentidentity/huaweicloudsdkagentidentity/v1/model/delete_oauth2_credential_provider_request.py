...
class DeleteOauth2CredentialProviderRequest:
    ...
    def __init__(self, credential_provider_name=None):
        r"""DeleteOauth2CredentialProviderRequest
    ...
    def credential_provider_name(self):
        r"""Gets the credential_provider_name of this DeleteOauth2CredentialProviderRequest.

        The name of the credential provider.

        :return: The credential_provider_name of this DeleteOauth2CredentialProviderRequest.
        :rtype: str
        """
    ...
    def credential_provider_name(self, credential_provider_name):
        r"""Sets the credential_provider_name of this DeleteOauth2CredentialProviderRequest.

        The name of the credential provider.

        :param credential_provider_name: The credential_provider_name of this DeleteOauth2CredentialProviderRequest.
        :type credential_provider_name: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteOauth2CredentialProviderRequest):
            return False
