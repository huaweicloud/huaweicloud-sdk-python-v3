...
class AgentIdentityClient(Client):
    ...
    def list_identity_providers(self, request):
        r"""查询身份提供商
    ...
    def list_identity_providers_invoker(self, request):
        http_info = self._list_identity_providers_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_identity_providers_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def get_policy_invoker(self, request):
        http_info = self._get_policy_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _get_policy_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/policy-engines/{policy_engine_id}/policies/{policy_id}",
            "request_type": request.__class__.__name__,
    ...
    def create_policy_engine(self, request):
        r"""创建策略集
    ...
    def create_policy_engine_invoker(self, request):
        http_info = self._create_policy_engine_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_policy_engine_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def delete_policy_engine(self, request):
        r"""删除策略集
    ...
    def delete_policy_engine_invoker(self, request):
        http_info = self._delete_policy_engine_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_policy_engine_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def get_policy_engine(self, request):
        r"""查询策略集详情
    ...
    def get_policy_engine_invoker(self, request):
        http_info = self._get_policy_engine_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _get_policy_engine_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/policy-engines/{policy_engine_id}",
            "request_type": request.__class__.__name__,
    ...
    def list_policy_engine_attachments(self, request):
        r"""查询策略集关联的实体列表
    ...
    def list_policy_engine_attachments_invoker(self, request):
        http_info = self._list_policy_engine_attachments_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_policy_engine_attachments_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_policy_engines(self, request):
        r"""查询策略集列表
    ...
    def list_policy_engines_invoker(self, request):
        http_info = self._list_policy_engines_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_policy_engines_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/policy-engines",
            "request_type": request.__class__.__name__,
    ...
    def update_policy_engine(self, request):
        r"""更新策略集
    ...
    def update_policy_engine_invoker(self, request):
        http_info = self._update_policy_engine_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_policy_engine_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v1/policy-engines/{policy_engine_id}",
            "request_type": request.__class__.__name__,
    ...
    def update_token_vault(self, request):
        r"""更新令牌保管库配置
    ...
    def update_token_vault_invoker(self, request):
        http_info = self._update_token_vault_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_token_vault_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v1/token-vaults/{token_vault_id}",
            "request_type": request.__class__.__name__,
