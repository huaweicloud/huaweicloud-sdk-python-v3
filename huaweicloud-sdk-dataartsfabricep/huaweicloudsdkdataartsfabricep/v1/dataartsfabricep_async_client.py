...
class DataArtsFabricEpAsyncClient(Client):
    ...
    def cancel_job_run_async(self, request):
        r"""取消作业运行
    ...
    def cancel_job_run_async_invoker(self, request):
        http_info = self._cancel_job_run_http_info(request)
        return AsyncInvoker(self, http_info)

    def _cancel_job_run_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def clear_job_run_async(self, request):
        r"""删除端点下所有的作业
    ...
    def clear_job_run_async_invoker(self, request):
        http_info = self._clear_job_run_http_info(request)
        return AsyncInvoker(self, http_info)

    def _clear_job_run_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def delete_job_run_async(self, request):
        r"""删除作业
    ...
    def delete_job_run_async_invoker(self, request):
        http_info = self._delete_job_run_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_job_run_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_job_runs_async(self, request):
        r"""查看作业运行列表
    ...
    def list_job_runs_async_invoker(self, request):
        http_info = self._list_job_runs_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_job_runs_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_job_run_detail_async(self, request):
        r"""查看作业运行详情
    ...
    def show_job_run_detail_async_invoker(self, request):
        http_info = self._show_job_run_detail_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_job_run_detail_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/workspaces/{workspace_id}/jobs/runs/{run_id}",
            "request_type": request.__class__.__name__,
