...
class DataArtsFabricEpClient(Client):
    def __init__(self):
        super(DataArtsFabricEpClient, self).__init__()
    ...
    def new_builder(cls, clazz=None):
        if not clazz:
            ...
            if clazz.__name__ != "DataArtsFabricEpClient":
                raise TypeError("client type error, support client type is DataArtsFabricEpClient")
    ...
    def delete_service_instance_invoker(self, request):
        http_info = self._delete_service_instance_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_service_instance_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def deploy_service_instance_invoker(self, request):
        http_info = self._deploy_service_instance_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _deploy_service_instance_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def list_services_instances_invoker(self, request):
        http_info = self._list_services_instances_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_services_instances_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/workspaces/{workspace_id}/services/instances",
            "request_type": request.__class__.__name__,
    ...
    def show_service_instance_detail_invoker(self, request):
        http_info = self._show_service_instance_detail_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_service_instance_detail_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/workspaces/{workspace_id}/services/instances/{instance_id}",
            "request_type": request.__class__.__name__,
    ...
    def update_service_instance_invoker(self, request):
        http_info = self._update_service_instance_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_service_instance_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v1/workspaces/{workspace_id}/services/instances/{instance_id}",
            "request_type": request.__class__.__name__,
