...
class ShowFileInfoResponse(SdkResponse):
    ...
    def __init__(self, jobs=None, scripts=None):
        ...
        :param jobs: 
        :type jobs: list[:class:`huaweicloudsdkdlf.v1.Job`]
        :param scripts: 
        :type scripts: list[:class:`huaweicloudsdkdlf.v1.Script`]
        """
    ...
    def jobs(self):
        ...
        :rtype: list[:class:`huaweicloudsdkdlf.v1.Job`]
        """
        return self._jobs
    ...
    def scripts(self):
        ...
        :rtype: list[:class:`huaweicloudsdkdlf.v1.Script`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowFileInfoResponse.to_dict() is deprecated and no longer maintained, "
