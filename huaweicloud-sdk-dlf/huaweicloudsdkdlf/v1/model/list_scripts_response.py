...
class ListScriptsResponse(SdkResponse):
    ...
    def __init__(self, total=None, scripts=None):
        ...
        :type total: int
        :param scripts: 
        :type scripts: list[:class:`huaweicloudsdkdlf.v1.ScriptInfo`]
        """
    ...
    def scripts(self):
        ...
        :rtype: list[:class:`huaweicloudsdkdlf.v1.ScriptInfo`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListScriptsResponse.to_dict() is deprecated and no longer maintained, "
