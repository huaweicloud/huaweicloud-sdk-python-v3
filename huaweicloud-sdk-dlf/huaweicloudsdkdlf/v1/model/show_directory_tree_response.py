...
class ShowDirectoryTreeResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowDirectoryTreeResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowDirectoryTreeResponse):
            return False
