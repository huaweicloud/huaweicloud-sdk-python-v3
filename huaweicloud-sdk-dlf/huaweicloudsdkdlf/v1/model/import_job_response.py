...
class ImportJobResponse(SdkResponse):
    ...
    @property
    def task_id(self):
        r"""Gets the task_id of this ImportJobResponse.
    ...
    def task_id(self, task_id):
        r"""Sets the task_id of this ImportJobResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ImportJobResponse.to_dict() is deprecated and no longer maintained, "
