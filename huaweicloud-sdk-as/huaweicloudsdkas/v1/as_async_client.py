...
class AsAsyncClient(Client):
    ...
    def complete_lifecycle_action_async(self, request):
        """伸缩实例生命周期回调
    ...
    def create_scaling_tags_async(self, request):
        """创建标签
    ...
    def delete_scaling_tags_async(self, request):
        """删除标签
    ...
    def enable_or_disable_scaling_group_async(self, request):
        """启用或停止弹性伸缩组
    ...
    def execute_scaling_policies_async(self, request):
        """批量操作弹性伸缩策略。
    ...
    def update_scaling_group_instance_async(self, request):
        """批量操作实例
