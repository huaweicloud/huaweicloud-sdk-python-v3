...
class CreateNotificationRequestBody:
    ...
    @property
    def topic_urn(self):
        """Gets the topic_urn of this CreateNotificationRequestBody.

        SMN服务中Topic的唯一的资源标识。

        :return: The topic_urn of this CreateNotificationRequestBody.
        :rtype: str
        """
    ...
    def topic_urn(self, topic_urn):
        """Sets the topic_urn of this CreateNotificationRequestBody.

        SMN服务中Topic的唯一的资源标识。

        :param topic_urn: The topic_urn of this CreateNotificationRequestBody.
        :type: str
        """
    ...
    def topic_scene(self):
        """Gets the topic_scene of this CreateNotificationRequestBody.
        ...
        :return: The topic_scene of this CreateNotificationRequestBody.
        :rtype: list[str]
        """
    ...
    def topic_scene(self, topic_scene):
        """Sets the topic_scene of this CreateNotificationRequestBody.

        通知场景，有以下五种类型。SCALING_UP：扩容成功。SCALING_UP_FAIL：扩容失败。SCALING_DOWN：减容成功。SCALING_DOWN_FAIL：减容失败。SCALING_GROUP_ABNORMAL：伸缩组发生异常

        :param topic_scene: The topic_scene of this CreateNotificationRequestBody.
        :type: list[str]
        """
