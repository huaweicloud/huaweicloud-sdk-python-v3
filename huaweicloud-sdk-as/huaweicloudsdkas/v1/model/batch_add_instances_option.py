...
class BatchAddInstancesOption:
    ...
    def instances_id(self):
        r"""Gets the instances_id of this BatchAddInstancesOption.

        云服务器ID。

        :return: The instances_id of this BatchAddInstancesOption.
        :rtype: list[str]
        """
    ...
    def instances_id(self, instances_id):
        r"""Sets the instances_id of this BatchAddInstancesOption.
    ...
    def instance_delete(self):
        r"""Gets the instance_delete of this BatchAddInstancesOption.

        从伸缩组中移出实例时，是否删除云服务器。默认为no；可选值为yes或no。只有action为REMOVE时，这个字段才生效。

        :return: The instance_delete of this BatchAddInstancesOption.
        :rtype: str
        """
    ...
    def instance_delete(self, instance_delete):
        r"""Sets the instance_delete of this BatchAddInstancesOption.
    ...
    def action(self, action):
        r"""Sets the action of this BatchAddInstancesOption.
    ...
    def instance_append(self):
        r"""Gets the instance_append of this BatchAddInstancesOption.

        将实例移入备用状态时，是否补充新的云服务器。取值如下：no：不补充新的实例，默认情况为no。yes：补充新的实例。只有action为ENTER_STANDBY时，这个字段才生效。

        :return: The instance_append of this BatchAddInstancesOption.
        :rtype: str
        """
    ...
    def instance_append(self, instance_append):
        r"""Sets the instance_append of this BatchAddInstancesOption.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchAddInstancesOption):
            return False
