...
class BatchEnterStandbyInstancesOption:
    ...
    def __init__(self, instances_id=None, instance_delete=None, action=None, instance_append=None):
        r"""BatchEnterStandbyInstancesOption
    ...
    def instances_id(self):
        r"""Gets the instances_id of this BatchEnterStandbyInstancesOption.
    ...
    def instances_id(self, instances_id):
        r"""Sets the instances_id of this BatchEnterStandbyInstancesOption.
    ...
    def instance_delete(self):
        r"""Gets the instance_delete of this BatchEnterStandbyInstancesOption.
    ...
    def instance_delete(self, instance_delete):
        r"""Sets the instance_delete of this BatchEnterStandbyInstancesOption.
    ...
    @property
    def action(self):
        r"""Gets the action of this BatchEnterStandbyInstancesOption.
    ...
    def action(self, action):
        r"""Sets the action of this BatchEnterStandbyInstancesOption.
    ...
    def instance_append(self):
        r"""Gets the instance_append of this BatchEnterStandbyInstancesOption.
    ...
    def instance_append(self, instance_append):
        r"""Sets the instance_append of this BatchEnterStandbyInstancesOption.
