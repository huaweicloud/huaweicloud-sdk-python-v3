...
class CompleteLifecycleActionRequestBody:
    ...
    def lifecycle_action_key(self):
        """Gets the lifecycle_action_key of this CompleteLifecycleActionRequestBody.

        生命周期操作令牌，通过查询伸缩实例挂起信息接口获取。指定生命周期回调对象，当不传入instance_id字段时，该字段为必选。当该字段与instance_id字段都传入，优先使用该字段进行回调。

        :return: The lifecycle_action_key of this CompleteLifecycleActionRequestBody.
        :rtype: str
        """
    ...
    def lifecycle_action_key(self, lifecycle_action_key):
        """Sets the lifecycle_action_key of this CompleteLifecycleActionRequestBody.

        生命周期操作令牌，通过查询伸缩实例挂起信息接口获取。指定生命周期回调对象，当不传入instance_id字段时，该字段为必选。当该字段与instance_id字段都传入，优先使用该字段进行回调。

        :param lifecycle_action_key: The lifecycle_action_key of this CompleteLifecycleActionRequestBody.
        :type: str
        """
    ...
    def instance_id(self):
        """Gets the instance_id of this CompleteLifecycleActionRequestBody.

        实例ID。指定生命周期回调对象，当不传入lifecycle_action_key字段时，该字段为必选。

        :return: The instance_id of this CompleteLifecycleActionRequestBody.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        """Sets the instance_id of this CompleteLifecycleActionRequestBody.

        实例ID。指定生命周期回调对象，当不传入lifecycle_action_key字段时，该字段为必选。

        :param instance_id: The instance_id of this CompleteLifecycleActionRequestBody.
        :type: str
        """
    ...
    def lifecycle_hook_name(self):
        """Gets the lifecycle_hook_name of this CompleteLifecycleActionRequestBody.

        生命周期挂钩名称。指定生命周期回调对象，当不传入lifecycle_action_key字段时，该字段为必选。

        :return: The lifecycle_hook_name of this CompleteLifecycleActionRequestBody.
        :rtype: str
        """
    ...
    def lifecycle_hook_name(self, lifecycle_hook_name):
        """Sets the lifecycle_hook_name of this CompleteLifecycleActionRequestBody.

        生命周期挂钩名称。指定生命周期回调对象，当不传入lifecycle_action_key字段时，该字段为必选。

        :param lifecycle_hook_name: The lifecycle_hook_name of this CompleteLifecycleActionRequestBody.
        :type: str
        """
    ...
    def lifecycle_action_result(self):
        """Gets the lifecycle_action_result of this CompleteLifecycleActionRequestBody.

        生命周期回调操作。ABANDON：终止。CONTINUE：继续。EXTEND：延长超时时间，每次延长1小时。

        :return: The lifecycle_action_result of this CompleteLifecycleActionRequestBody.
        :rtype: str
        """
    ...
    def lifecycle_action_result(self, lifecycle_action_result):
        """Sets the lifecycle_action_result of this CompleteLifecycleActionRequestBody.

        生命周期回调操作。ABANDON：终止。CONTINUE：继续。EXTEND：延长超时时间，每次延长1小时。

        :param lifecycle_action_result: The lifecycle_action_result of this CompleteLifecycleActionRequestBody.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CompleteLifecycleActionRequestBody):
            return False
