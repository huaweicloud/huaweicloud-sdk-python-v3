...
class Personality:
    ...
    @property
    def path(self):
        """Gets the path of this Personality.
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this Personality.
    ...
    @property
    def content(self):
        """Gets the content of this Personality.

        注入文件内容。该值应指定为注入文件的内容进行base64格式编码后的信息。

        :return: The content of this Personality.
        :rtype: str
        """
    ...
    def content(self, content):
        """Sets the content of this Personality.

        注入文件内容。该值应指定为注入文件的内容进行base64格式编码后的信息。

        :param content: The content of this Personality.
        :type: str
        """
