...
class ListScalingActivityLogsRequest(object):
    ...
    def __init__(self, scaling_group_id=None, start_time=None, end_time=None, start_number=None, limit=None):  # noqa: E501
