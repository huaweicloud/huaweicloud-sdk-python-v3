...
class UpdateScalingV2PolicyRequestBody(object):
    ...
    def __init__(self, scaling_policy_name=None, scaling_resource_id=None, scaling_resource_type=None, scaling_policy_type=None, alarm_id=None, scheduled_policy=None, scaling_policy_action=None, cool_down_time=None):  # noqa: E501
        """UpdateScalingV2PolicyRequestBody - a model defined in huaweicloud sdk"""
    ...
    def scaling_policy_name(self):
        """Gets the scaling_policy_name of this UpdateScalingV2PolicyRequestBody.

        策略名称（1-64）字符，可以用中文、字母、数字、下划线、中划线的组合。

        :return: The scaling_policy_name of this UpdateScalingV2PolicyRequestBody.
        :rtype: str
        """
    ...
    def scaling_policy_name(self, scaling_policy_name):
        """Sets the scaling_policy_name of this UpdateScalingV2PolicyRequestBody.

        策略名称（1-64）字符，可以用中文、字母、数字、下划线、中划线的组合。

        :param scaling_policy_name: The scaling_policy_name of this UpdateScalingV2PolicyRequestBody.
        :type: str
        """
    ...
    def scaling_resource_id(self):
        """Gets the scaling_resource_id of this UpdateScalingV2PolicyRequestBody.

        伸缩资源ID，伸缩组唯一标识或带宽唯一标识。如果scaling_resource_type为SCALING_GROUP，对应伸缩组唯一标识。如果scaling_resource_type为BANDWIDTH，对应带宽唯一标识。

        :return: The scaling_resource_id of this UpdateScalingV2PolicyRequestBody.
        :rtype: str
        """
    ...
    def scaling_resource_id(self, scaling_resource_id):
        """Sets the scaling_resource_id of this UpdateScalingV2PolicyRequestBody.

        伸缩资源ID，伸缩组唯一标识或带宽唯一标识。如果scaling_resource_type为SCALING_GROUP，对应伸缩组唯一标识。如果scaling_resource_type为BANDWIDTH，对应带宽唯一标识。

        :param scaling_resource_id: The scaling_resource_id of this UpdateScalingV2PolicyRequestBody.
        :type: str
        """
    ...
    def scaling_resource_type(self):
        """Gets the scaling_resource_type of this UpdateScalingV2PolicyRequestBody.

        伸缩资源类型。伸缩组：SCALING_GROUP。带宽：BANDWIDTH。

        :return: The scaling_resource_type of this UpdateScalingV2PolicyRequestBody.
        :rtype: str
        """
    ...
    def scaling_resource_type(self, scaling_resource_type):
        """Sets the scaling_resource_type of this UpdateScalingV2PolicyRequestBody.

        伸缩资源类型。伸缩组：SCALING_GROUP。带宽：BANDWIDTH。

        :param scaling_resource_type: The scaling_resource_type of this UpdateScalingV2PolicyRequestBody.
        :type: str
        """
    ...
    def scaling_policy_type(self):
        """Gets the scaling_policy_type of this UpdateScalingV2PolicyRequestBody.

        策略类型。告警策略：ALARM（与alarm_id对应）；定时策略：SCHEDULED（与scheduled_policy对应）；周期策略：RECURRENCE（与scheduled_policy对应）

        :return: The scaling_policy_type of this UpdateScalingV2PolicyRequestBody.
        :rtype: str
        """
    ...
    def scaling_policy_type(self, scaling_policy_type):
        """Sets the scaling_policy_type of this UpdateScalingV2PolicyRequestBody.

        策略类型。告警策略：ALARM（与alarm_id对应）；定时策略：SCHEDULED（与scheduled_policy对应）；周期策略：RECURRENCE（与scheduled_policy对应）

        :param scaling_policy_type: The scaling_policy_type of this UpdateScalingV2PolicyRequestBody.
        :type: str
        """
    ...
    @property
    def alarm_id(self):
        """Gets the alarm_id of this UpdateScalingV2PolicyRequestBody.
        ...
        :return: The alarm_id of this UpdateScalingV2PolicyRequestBody.
        :rtype: str
        """
    ...
    def alarm_id(self, alarm_id):
        """Sets the alarm_id of this UpdateScalingV2PolicyRequestBody.

        告警ID，即告警规则的ID，当scaling_policy_type为ALARM时该项必选，此时scheduled_policy不生效。创建告警策略成功后，会自动为该告警ID对应的告警规则的alarm_actions字段增加类型为autoscaling的告警触发动作。告警ID通过查询云监控告警规则列表获取，详见《云监控API参考》的“查询告警规则列表”。

        :param alarm_id: The alarm_id of this UpdateScalingV2PolicyRequestBody.
        :type: str
        """
    ...
    def scheduled_policy(self):
        """Gets the scheduled_policy of this UpdateScalingV2PolicyRequestBody.


        :return: The scheduled_policy of this UpdateScalingV2PolicyRequestBody.
    ...
    def scheduled_policy(self, scheduled_policy):
        """Sets the scheduled_policy of this UpdateScalingV2PolicyRequestBody.


        :param scheduled_policy: The scheduled_policy of this UpdateScalingV2PolicyRequestBody.
    ...
    def scaling_policy_action(self):
        """Gets the scaling_policy_action of this UpdateScalingV2PolicyRequestBody.


        :return: The scaling_policy_action of this UpdateScalingV2PolicyRequestBody.
    ...
    def scaling_policy_action(self, scaling_policy_action):
        """Sets the scaling_policy_action of this UpdateScalingV2PolicyRequestBody.


        :param scaling_policy_action: The scaling_policy_action of this UpdateScalingV2PolicyRequestBody.
    ...
    def cool_down_time(self):
        """Gets the cool_down_time of this UpdateScalingV2PolicyRequestBody.

        冷却时间，取值范围0-86400，默认为300，单位是秒。

        :return: The cool_down_time of this UpdateScalingV2PolicyRequestBody.
        :rtype: int
        """
    ...
    def cool_down_time(self, cool_down_time):
        """Sets the cool_down_time of this UpdateScalingV2PolicyRequestBody.

        冷却时间，取值范围0-86400，默认为300，单位是秒。

        :param cool_down_time: The cool_down_time of this UpdateScalingV2PolicyRequestBody.
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateScalingV2PolicyRequestBody):
            return False
