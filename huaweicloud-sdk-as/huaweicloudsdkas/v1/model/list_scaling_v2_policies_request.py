...
class ListScalingV2PoliciesRequest(object):
    ...
    def __init__(self, scaling_resource_id=None, scaling_policy_name=None, scaling_policy_type=None, scaling_policy_id=None, start_number=None, limit=None):  # noqa: E501
