...
class ListScalingPolicyExecuteLogsResponse(object):
    ...
    def __init__(self, total_number=None, start_number=None, limit=None, scaling_policy_execute_log=None):  # noqa: E501
