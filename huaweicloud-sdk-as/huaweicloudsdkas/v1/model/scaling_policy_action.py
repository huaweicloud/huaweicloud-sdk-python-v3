...
class ScalingPolicyAction:
    ...
    @property
    def operation(self):
        """Gets the operation of this ScalingPolicyAction.

        操作选项。ADD：添加实例。REMOVE/REDUCE：移除实例。SET：设置实例数为

        :return: The operation of this ScalingPolicyAction.
        :rtype: str
        """
    ...
    def operation(self, operation):
        """Sets the operation of this ScalingPolicyAction.

        操作选项。ADD：添加实例。REMOVE/REDUCE：移除实例。SET：设置实例数为

        :param operation: The operation of this ScalingPolicyAction.
        :type: str
        """
    ...
    def instance_number(self):
        """Gets the instance_number of this ScalingPolicyAction.

        操作实例个数，默认为1。配置参数时，instance_number和instance_percentage参数只能选其中一个进行配置。

        :return: The instance_number of this ScalingPolicyAction.
        :rtype: int
        """
    ...
    def instance_number(self, instance_number):
        """Sets the instance_number of this ScalingPolicyAction.

        操作实例个数，默认为1。配置参数时，instance_number和instance_percentage参数只能选其中一个进行配置。

        :param instance_number: The instance_number of this ScalingPolicyAction.
        :type: int
        """
    ...
    def instance_percentage(self):
        """Gets the instance_percentage of this ScalingPolicyAction.
        ...
        :return: The instance_percentage of this ScalingPolicyAction.
        :rtype: int
        """
    ...
    def instance_percentage(self, instance_percentage):
        """Sets the instance_percentage of this ScalingPolicyAction.

        操作实例百分比，将当前组容量增加、减少或设置为指定的百分比。当instance_number和instance_percentage参数均无配置时，则操作实例个数为1。配置参数时，instance_number和instance_percentage参数只能选其中一个进行配置。

        :param instance_percentage: The instance_percentage of this ScalingPolicyAction.
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ScalingPolicyAction):
            return False
