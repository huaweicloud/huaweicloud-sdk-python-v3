...
class AsClient(Client):
    ...
    def execute_scaling_policies_with_http_info(self, request):
        ...
        return self.call_api(
            '/autoscaling-api/v1/{project_id}/scaling_policies/action', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_scaling_activity_v2_logs_with_http_info(self, request):
        ...
        :param ListScalingActivityV2LogsRequest request
        :return: tuple(ListScalingActivityV2LogsResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        return self.call_api(
            '/autoscaling-api/v2/{project_id}/scaling_activity_log/{scaling_group_id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def create_scaling_v2_policy_with_http_info(self, request):
        ...
        :param CreateScalingV2PolicyRequest request
        :return: tuple(CreateScalingV2PolicyResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        return self.call_api(
            '/autoscaling-api/v2/{project_id}/scaling_policy', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_all_scaling_v2_policies_with_http_info(self, request):
        ...
        :param ListAllScalingV2PoliciesRequest request
        :return: tuple(ListAllScalingV2PoliciesResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        return self.call_api(
            '/autoscaling-api/v2/{project_id}/scaling_policy', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_scaling_v2_policies_with_http_info(self, request):
        ...
        :param ListScalingV2PoliciesRequest request
        :return: tuple(ListScalingV2PoliciesResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        return self.call_api(
            '/autoscaling-api/v2/{project_id}/scaling_policy/{scaling_resource_id}/list', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def show_scaling_v2_policy_with_http_info(self, request):
        ...
        :param ShowScalingV2PolicyRequest request
        :return: tuple(ShowScalingV2PolicyResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        return self.call_api(
            '/autoscaling-api/v2/{project_id}/scaling_policy/{scaling_policy_id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_scaling_v2_policy_with_http_info(self, request):
        ...
        :param UpdateScalingV2PolicyRequest request
        :return: tuple(UpdateScalingV2PolicyResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        return self.call_api(
            '/autoscaling-api/v2/{project_id}/scaling_policy/{scaling_policy_id}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
