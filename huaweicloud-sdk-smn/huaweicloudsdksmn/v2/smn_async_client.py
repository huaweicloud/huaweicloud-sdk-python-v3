...
class SmnAsyncClient(Client):
    ...
    def batch_delete_subscriptions_async(self, request):
        r"""批量删除订阅
    ...
    def batch_delete_subscriptions_async_invoker(self, request):
        http_info = self._batch_delete_subscriptions_http_info(request)
        return AsyncInvoker(self, http_info)

    def _batch_delete_subscriptions_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def batch_delete_subscriptions_by_topic_async(self, request):
        r"""批量删除指定主题的订阅
    ...
    def batch_delete_subscriptions_by_topic_async_invoker(self, request):
        http_info = self._batch_delete_subscriptions_by_topic_http_info(request)
        return AsyncInvoker(self, http_info)

    def _batch_delete_subscriptions_by_topic_http_info(self, request):
        http_info = {
            "method": "DELETE",
            "resource_path": "/v2/{project_id}/notifications/topics/{topic_urn}/subscriptions",
            "request_type": request.__class__.__name__,
    ...
    def confirm_subscription_async(self, request):
        r"""确认订阅
    ...
    def confirm_subscription_async_invoker(self, request):
        http_info = self._confirm_subscription_http_info(request)
        return AsyncInvoker(self, http_info)

    def _confirm_subscription_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def delete_subscriptions_by_topic_async(self, request):
        r"""删除指定主题的订阅
    ...
    def delete_subscriptions_by_topic_async_invoker(self, request):
        http_info = self._delete_subscriptions_by_topic_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_subscriptions_by_topic_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def download_http_cert_async(self, request):
        r"""下载证书
    ...
    def download_http_cert_async_invoker(self, request):
        http_info = self._download_http_cert_http_info(request)
        return AsyncInvoker(self, http_info)

    def _download_http_cert_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_cloud_service_async_invoker(self, request):
        http_info = self._list_cloud_service_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_cloud_service_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_protocols_async(self, request):
        r"""查询协议列表
    ...
    def list_protocols_async_invoker(self, request):
        http_info = self._list_protocols_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_protocols_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def unsubscribe_subscription_async(self, request):
        r"""取消订阅
    ...
    def unsubscribe_subscription_async_invoker(self, request):
        http_info = self._unsubscribe_subscription_http_info(request)
        return AsyncInvoker(self, http_info)

    def _unsubscribe_subscription_http_info(self, request):
        http_info = {
            "method": "GET",
