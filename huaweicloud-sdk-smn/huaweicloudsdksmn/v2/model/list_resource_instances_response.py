...
class ListResourceInstancesResponse(SdkResponse):
    ...
    def __init__(self, resources=None, total_count=None):
        ...
        :param resources: 返回的资源列表。
        :type resources: list[:class:`huaweicloudsdksmn.v2.TagResource`]
    ...
    def resources(self):
        ...
        :rtype: list[:class:`huaweicloudsdksmn.v2.TagResource`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListResourceInstancesResponse.to_dict() is deprecated and no longer maintained, "
