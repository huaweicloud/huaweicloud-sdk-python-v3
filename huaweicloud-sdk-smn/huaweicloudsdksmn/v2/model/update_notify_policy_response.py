...
class UpdateNotifyPolicyResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateNotifyPolicyResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateNotifyPolicyResponse):
            return False
