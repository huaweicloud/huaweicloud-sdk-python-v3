...
class BatchDeleteSubscriptionsFilterPolicesRequest:
    ...
    openapi_types = {
        'body': 'BatchDeleteSubscriptionsFilterPolicesRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchDeleteSubscriptionsFilterPolicesRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteSubscriptionsFilterPolicesRequest):
            return False
