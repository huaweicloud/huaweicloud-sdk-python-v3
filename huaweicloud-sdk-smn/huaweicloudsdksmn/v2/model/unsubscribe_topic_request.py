...
class UnsubscribeTopicRequest:
    ...
    def subscription_urn(self):
        r"""Gets the subscription_urn of this UnsubscribeTopicRequest.

        订阅者的唯一的资源标识，可通过[查询订阅者列表](ListSubscriptions.xml)获取该标识。

        :return: The subscription_urn of this UnsubscribeTopicRequest.
        :rtype: str
        """
    ...
    def subscription_urn(self, subscription_urn):
        r"""Sets the subscription_urn of this UnsubscribeTopicRequest.

        订阅者的唯一的资源标识，可通过[查询订阅者列表](ListSubscriptions.xml)获取该标识。

        :param subscription_urn: The subscription_urn of this UnsubscribeTopicRequest.
        :type subscription_urn: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UnsubscribeTopicRequest):
            return False
