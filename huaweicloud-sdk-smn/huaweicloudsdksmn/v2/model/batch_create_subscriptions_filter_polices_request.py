...
class BatchCreateSubscriptionsFilterPolicesRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchCreateSubscriptionsFilterPolicesRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchCreateSubscriptionsFilterPolicesRequest):
            return False
