...
class CreateMessageTemplateRequest:
    ...
    openapi_types = {
        'body': 'CreateMessageTemplateRequestBody'
    }
    ...
    def __init__(self, body=None):
        """CreateMessageTemplateRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: CreateMessageTemplateRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateMessageTemplateRequest):
            return False
