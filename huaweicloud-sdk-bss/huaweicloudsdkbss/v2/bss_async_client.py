...
class BssAsyncClient(Client):
    ...
    def list_business_discount_info_async(self, request):
        r"""查询商务折扣信息
    ...
    def list_business_discount_info_async_invoker(self, request):
        http_info = self._list_business_discount_info_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_business_discount_info_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def list_customer_coupon_change_records_async(self, request):
        r"""查询优惠券收支明细
    ...
    def list_customer_coupon_change_records_async_invoker(self, request):
        http_info = self._list_customer_coupon_change_records_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_customer_coupon_change_records_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_real_name_auth_qr_code_async(self, request):
        r"""获取人脸实名认证二维码
    ...
    def show_real_name_auth_qr_code_async_invoker(self, request):
        http_info = self._show_real_name_auth_qr_code_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_real_name_auth_qr_code_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_real_name_auth_status_async(self, request):
        r"""查询实名认证状态
    ...
    def show_real_name_auth_status_async_invoker(self, request):
        http_info = self._show_real_name_auth_status_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_real_name_auth_status_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def update_period_to_on_demand_instantly_async(self, request):
        r"""设置包年/包月资源即时转按需
    ...
    def update_period_to_on_demand_instantly_async_invoker(self, request):
        http_info = self._update_period_to_on_demand_instantly_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_period_to_on_demand_instantly_http_info(self, request):
        http_info = {
            "method": "POST",
