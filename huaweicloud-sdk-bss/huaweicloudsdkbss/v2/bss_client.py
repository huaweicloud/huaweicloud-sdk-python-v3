...
class BssClient(Client):
    ...
    def list_business_discount_info(self, request):
        r"""查询商务折扣信息
        ...
        :param request: Request instance for ListBusinessDiscountInfo
        :type request: :class:`huaweicloudsdkbss.v2.ListBusinessDiscountInfoRequest`
        :rtype: :class:`huaweicloudsdkbss.v2.ListBusinessDiscountInfoResponse`
        """
        http_info = self._list_business_discount_info_http_info(request)
        return self._call_api(**http_info)

    def list_business_discount_info_invoker(self, request):
        http_info = self._list_business_discount_info_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_business_discount_info_http_info(cls, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v2/promotions/business/discount-info",
            "request_type": request.__class__.__name__,
            "response_type": "ListBusinessDiscountInfoResponse"
            }
    ...
    def set_resources_renew_config(self, request):
        ...
        :type request: :class:`huaweicloudsdkbss.v2.SetResourcesRenewConfigRequest`
        :rtype: :class:`huaweicloudsdkbss.v2.SetResourcesRenewConfigResponse`
        """
