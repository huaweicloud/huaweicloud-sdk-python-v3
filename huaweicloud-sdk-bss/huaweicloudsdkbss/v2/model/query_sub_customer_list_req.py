...
class QuerySubCustomerListReq:
    ...
    def __init__(self, account_name=None, associated_on_begin=None, associated_on_end=None, association_type=None, customer=None, customer_id=None, indirect_partner_id=None, label=None, limit=10, offset=0):
