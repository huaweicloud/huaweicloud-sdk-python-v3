...
class ListCustomerselfResourceRecordsResponse(SdkResponse):
    ...
    def __init__(self, fee_records=None, total_count=None, currency=None):
        ...
        :type fee_records: list[:class:`huaweicloudsdkbss.v2.ResFeeRecordV2`]
    ...
    def fee_records(self):
        ...
        :rtype: list[:class:`huaweicloudsdkbss.v2.ResFeeRecordV2`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListCustomerselfResourceRecordsResponse.to_dict() is deprecated and no longer maintained, "
