...
class UpdateSubEnterpriseAmountRequest:
    ...
    openapi_types = {
        'body': 'TransferEnterpriseMultiAccountReq'
    }
    ...
    def __init__(self, body=None):
        """UpdateSubEnterpriseAmountRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: TransferEnterpriseMultiAccountReq
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateSubEnterpriseAmountRequest):
            return False
