...
class BillSumRecordInfoV2:
    ...
    def __init__(self, bill_cycle=None, bill_type=None, cash_amount=None, charging_mode=None, consume_amount=None, coupon_amount=None, credit_amount=None, customer_id=None, debt_amount=None, flexipurchase_coupon_amount=None, measure_id=None, official_amount=None, official_discount_amount=None, resource_type_code=None, service_type_code=None, stored_value_card_amount=None, truncated_amount=None, writeoff_amount=None):
