...
class ReclaimToPartnerAccountRequest:
    ...
    openapi_types = {
        'body': 'ReclaimToPartnerAccountBalancesReq'
    }
    ...
    def __init__(self, body=None):
        """ReclaimToPartnerAccountRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: ReclaimToPartnerAccountBalancesReq
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReclaimToPartnerAccountRequest):
            return False
