...
class ReclaimIndirectPartnerAccountRequest:
    ...
    openapi_types = {
        'body': 'ReclaimIndirectPartnerAccountReq'
    }
    ...
    def __init__(self, body=None):
        r"""ReclaimIndirectPartnerAccountRequest
    ...
    @property
    def body(self):
        r"""Gets the body of this ReclaimIndirectPartnerAccountRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this ReclaimIndirectPartnerAccountRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReclaimIndirectPartnerAccountRequest):
            return False
