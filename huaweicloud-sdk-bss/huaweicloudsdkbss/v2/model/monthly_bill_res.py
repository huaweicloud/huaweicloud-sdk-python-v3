...
class MonthlyBillRes:
    ...
    def __init__(self, adjustment_amount=None, bill_type=None, bonus_amount=None, cash_amount=None, charge_mode=None, cloud_service_type=None, consume_amount=None, coupon_amount=None, credit_amount=None, cycle=None, debt_amount=None, discount_amount=None, enterprise_project_id=None, enterprise_project_name=None, flexipurchase_coupon_amount=None, measure_id=None, official_amount=None, region=None, res_instance_id=None, resource_type_code=None, resource_name=None, resource_tag=None, stored_card_amount=None):
