...
class UpdateCouponQuotasRequest:
    ...
    def __init__(self, body=None):
        """UpdateCouponQuotasRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateCouponQuotasRequest):
            return False
