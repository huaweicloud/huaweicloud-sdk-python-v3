...
class SubCustomerResFeeRecordV2:
    ...
    def __init__(self, adjustment_amount=None, amount=None, bill_type=None, bonus_amount=None, cash_amount=None, charge_mode=None, cloud_service_type=None, coupon_amount=None, credit_amount=None, debt_amount=None, discount_amount=None, effective_time=None, expire_time=None, flexipurchase_coupon_amount=None, free_resource_measure_id=None, free_resource_usage=None, measure_id=None, official_amount=None, order_id=None, period_type=None, product_id=None, product_name=None, region=None, resource_id=None, resource_name=None, resource_tag=None, resource_type=None, ri_usage=None, ri_usage_measure_id=None, spec_size=None, spec_size_measure_id=None, stored_card_amount=None, usage=None, usage_measure_id=None, usage_type=None):
