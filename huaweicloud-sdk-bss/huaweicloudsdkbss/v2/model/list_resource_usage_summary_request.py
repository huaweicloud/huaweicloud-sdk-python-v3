...
class ListResourceUsageSummaryRequest:
    ...
    def __init__(self, x_language=None, bill_cycle=None, service_type_code=None, resource_type_code=None, usage_type=None, offset=None, limit=None):
        ...
        :param resource_type_code: 资源类型编码，当前仅支持：hws.resource.type.cdn：CDN,hws.resource.type.obs：云存储,hws.resource.type.bandwidth：固定带宽,hws.resource.type.edgebandwidth：边缘固定带宽.资源类型和云服务类型的对应关系可调用[根据云服务类型查询资源列表](https://support.huaweicloud.com/api-oce/qct_00003.html)接口获取。
        :type resource_type_code: str
        :param usage_type: 使用量类型编码，目前仅支持：95Peak：中国大陆月95峰值带宽_1024进制,95peak_1000：中国大陆月95峰值带宽_1000进制,bandwidth95peak：95峰值带宽,95peak_plus：增强型95峰值.资源类型和使用量类型的对应关系可调用[查询使用量类型列表接](https://support.huaweicloud.com/api-oce/qct_00004.html)口获取。
        :type usage_type: str
    ...
    def x_language(self):
        ...
        :return: The x_language of this ListResourceUsageSummaryRequest.
        :rtype: str
        """
    ...
    def x_language(self, x_language):
        ...
        :param x_language: The x_language of this ListResourceUsageSummaryRequest.
        :type x_language: str
        """
    ...
    def usage_type(self):
        ...
        :return: The usage_type of this ListResourceUsageSummaryRequest.
        :rtype: str
        """
    ...
    def usage_type(self, usage_type):
        ...
        :param usage_type: The usage_type of this ListResourceUsageSummaryRequest.
        :type usage_type: str
        """
    ...
    def offset(self):
        ...
        :return: The offset of this ListResourceUsageSummaryRequest.
        :rtype: int
        """
        return self._offset
    ...
    def offset(self, offset):
        ...
        :param offset: The offset of this ListResourceUsageSummaryRequest.
        :type offset: int
        """
        self._offset = offset
    ...
    def limit(self):
        ...
        :return: The limit of this ListResourceUsageSummaryRequest.
        :rtype: int
        """
        return self._limit
    ...
    def limit(self, limit):
        ...
        :param limit: The limit of this ListResourceUsageSummaryRequest.
        :type limit: int
        """
        self._limit = limit
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListResourceUsageSummaryRequest):
            return False
