...
class CustomerOrderEntity:
    ...
    def __init__(self, agent_pay_info=None, amount_after_discount=None, amount_info=None, create_time=None, currency=None, customer_id=None, measure_id=None, official_amount=None, order_id=None, order_type=None, payment_time=None, status=None):
