...
class ShowRefundOrderDetailsResponse(SdkResponse):
    ...
    def __init__(self, total_count=None, refund_infos=None):
        ...
        :type refund_infos: list[:class:`huaweicloudsdkbss.v2.OrderRefundInfoV2`]
        """
    ...
    def refund_infos(self):
        ...
        :rtype: list[:class:`huaweicloudsdkbss.v2.OrderRefundInfoV2`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowRefundOrderDetailsResponse.to_dict() is deprecated and no longer maintained, "
