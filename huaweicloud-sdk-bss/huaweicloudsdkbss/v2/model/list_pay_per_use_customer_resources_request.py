...
class ListPayPerUseCustomerResourcesRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ListPayPerUseCustomerResourcesRequest
        :type body: :class:`huaweicloudsdkbss.v2.QueryResourcesReq`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkbss.v2.QueryResourcesReq`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListPayPerUseCustomerResourcesRequest):
            return False
