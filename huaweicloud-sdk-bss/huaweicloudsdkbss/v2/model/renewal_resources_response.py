...
class RenewalResourcesResponse(SdkResponse):
    ...
    @property
    def order_ids(self):
        r"""Gets the order_ids of this RenewalResourcesResponse.
    ...
    def order_ids(self, order_ids):
        r"""Sets the order_ids of this RenewalResourcesResponse.
    ...
    def fail_resource_infos(self):
        r"""Gets the fail_resource_infos of this RenewalResourcesResponse.
    ...
    def fail_resource_infos(self, fail_resource_infos):
        r"""Sets the fail_resource_infos of this RenewalResourcesResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("RenewalResourcesResponse.to_dict() is deprecated and no longer maintained, "
