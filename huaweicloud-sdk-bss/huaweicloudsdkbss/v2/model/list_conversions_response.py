...
class ListConversionsResponse(SdkResponse):
    ...
    def __init__(self, conversions=None):
        ...
        :type conversions: list[:class:`huaweicloudsdkbss.v2.Conversion`]
        """
    ...
    def conversions(self):
        ...
        :rtype: list[:class:`huaweicloudsdkbss.v2.Conversion`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListConversionsResponse.to_dict() is deprecated and no longer maintained, "
