...
class StoragePool:
    ...
    def __init__(self, id=None, name=None, edge_site_id=None, storage_type=None, status=None, assigned_size=None, resource_spec_code=None, capacity=None, market_options=None, created_at=None, updated_at=None, effected_at=None):
        ...
        :param status: 
        :type status: :class:`huaweicloudsdkies.v1.StoragePoolStatus`
        ...
        :type market_options: :class:`huaweicloudsdkies.v1.MarketOptions`
    ...
    def storage_type(self):
        ...
        :rtype: :class:`huaweicloudsdkies.v1.StorageType`
        """
    ...
    def status(self):
        ...
        :rtype: :class:`huaweicloudsdkies.v1.StoragePoolStatus`
        """
        return self._status
    ...
    def market_options(self):
        ...
        :rtype: :class:`huaweicloudsdkies.v1.MarketOptions`
        """
