...
class Rack:
    ...
    def __init__(self, id=None, name=None, edge_site_id=None, rack_category_id=None, rack_type=None, status=None, storage_assigned_size=None, description=None, rack_sn_no=None, rack_location_no=None, created_at=None, updated_at=None, effected_at=None, market_options=None, compute_unit=None, storage_unit=None, rack_info=None):
        ...
        :type rack_type: str
        :param status: 
        :type status: :class:`huaweicloudsdkies.v1.RackStatus`
        ...
        :type compute_unit: list[:class:`huaweicloudsdkies.v1.ComputeSpec`]
        :param storage_unit: 
        :type storage_unit: :class:`huaweicloudsdkies.v1.StorageUnit`
        :param rack_info: 
        :type rack_info: :class:`huaweicloudsdkies.v1.RackInfo`
        """
    ...
    def status(self):
        ...
        :rtype: :class:`huaweicloudsdkies.v1.RackStatus`
        """
        return self._status
    ...
    def compute_unit(self):
        ...
        :rtype: list[:class:`huaweicloudsdkies.v1.ComputeSpec`]
        """
    ...
    def storage_unit(self):
        ...
        :rtype: :class:`huaweicloudsdkies.v1.StorageUnit`
        """
    ...
    def rack_info(self):
        ...
        :rtype: :class:`huaweicloudsdkies.v1.RackInfo`
        """
