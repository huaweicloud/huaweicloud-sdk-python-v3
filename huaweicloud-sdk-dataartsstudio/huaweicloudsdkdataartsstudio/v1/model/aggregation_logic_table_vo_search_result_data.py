...
class AggregationLogicTableVOSearchResultData:
    ...
    openapi_types = {
        'value': 'AggregationLogicTableVOSearchResultDataValue'
    }
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AggregationLogicTableVOSearchResultData):
            return False
