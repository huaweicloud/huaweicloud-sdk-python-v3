...
class DeleteTableModelResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this DeleteTableModelResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this DeleteTableModelResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteTableModelResponse.to_dict() is deprecated and no longer maintained, "
