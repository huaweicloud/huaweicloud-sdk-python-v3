...
class CreateApiResponse(SdkResponse):
    ...
    @property
    def id(self):
        r"""Gets the id of this CreateApiResponse.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this CreateApiResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateApiResponse.to_dict() is deprecated and no longer maintained, "
