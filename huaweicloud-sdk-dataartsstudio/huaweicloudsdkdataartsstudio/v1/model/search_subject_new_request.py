...
class SearchSubjectNewRequest:
    ...
    @property
    def workspace(self):
        r"""Gets the workspace of this SearchSubjectNewRequest.
    ...
    def workspace(self, workspace):
        r"""Sets the workspace of this SearchSubjectNewRequest.
    ...
    def x_project_id(self):
        r"""Gets the x_project_id of this SearchSubjectNewRequest.

        项目ID，获取方法请参见[项目ID和账号ID](projectid_accountid.xml)。  多project场景采用AK/SK认证的接口请求，则该字段必选。

        :return: The x_project_id of this SearchSubjectNewRequest.
        :rtype: str
        """
    ...
    def x_project_id(self, x_project_id):
        r"""Sets the x_project_id of this SearchSubjectNewRequest.

        项目ID，获取方法请参见[项目ID和账号ID](projectid_accountid.xml)。  多project场景采用AK/SK认证的接口请求，则该字段必选。

        :param x_project_id: The x_project_id of this SearchSubjectNewRequest.
        :type x_project_id: str
        """
    ...
    @property
    def name(self):
        r"""Gets the name of this SearchSubjectNewRequest.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this SearchSubjectNewRequest.
    ...
    @property
    def create_by(self):
        r"""Gets the create_by of this SearchSubjectNewRequest.
    ...
    def create_by(self, create_by):
        r"""Sets the create_by of this SearchSubjectNewRequest.
    ...
    @property
    def owner(self):
        r"""Gets the owner of this SearchSubjectNewRequest.
    ...
    def owner(self, owner):
        r"""Sets the owner of this SearchSubjectNewRequest.
    ...
    @property
    def status(self):
        r"""Gets the status of this SearchSubjectNewRequest.
    ...
    def status(self, status):
        r"""Sets the status of this SearchSubjectNewRequest.
    ...
    @property
    def begin_time(self):
        r"""Gets the begin_time of this SearchSubjectNewRequest.
    ...
    def begin_time(self, begin_time):
        r"""Sets the begin_time of this SearchSubjectNewRequest.
    ...
    @property
    def end_time(self):
        r"""Gets the end_time of this SearchSubjectNewRequest.
    ...
    def end_time(self, end_time):
        r"""Sets the end_time of this SearchSubjectNewRequest.
    ...
    @property
    def limit(self):
        r"""Gets the limit of this SearchSubjectNewRequest.
    ...
    def limit(self, limit):
        r"""Sets the limit of this SearchSubjectNewRequest.
    ...
    @property
    def offset(self):
        r"""Gets the offset of this SearchSubjectNewRequest.
    ...
    def offset(self, offset):
        r"""Sets the offset of this SearchSubjectNewRequest.
    ...
    @property
    def parent_id(self):
        r"""Gets the parent_id of this SearchSubjectNewRequest.
    ...
    def parent_id(self, parent_id):
        r"""Sets the parent_id of this SearchSubjectNewRequest.
