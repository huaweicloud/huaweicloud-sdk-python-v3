...
class ParseUserBehaviorResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ParseUserBehaviorResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ParseUserBehaviorResponse):
            return False
