...
class DeleteBizMetricResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this DeleteBizMetricResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this DeleteBizMetricResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteBizMetricResponse.to_dict() is deprecated and no longer maintained, "
