...
class DsProcessImportResultVO:
    ...
    def __init__(self, status=None, group=None, rate=None):
        ...
        :param status: 标识本次导入的唯一值，用于查询导入结果。 枚举值：   - importing: 导入中   - fail: 导入失败   - success: 导入成功 
        :type status: str
        :param group: 
    ...
    def status(self):
        ...
        :return: The status of this DsProcessImportResultVO.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this DsProcessImportResultVO.
        :type status: str
        """
        self._status = status
    ...
    def rate(self):
        ...
        :return: The rate of this DsProcessImportResultVO.
        :rtype: str
        """
        return self._rate
    ...
    def rate(self, rate):
        ...
        :param rate: The rate of this DsProcessImportResultVO.
        :type rate: str
        """
        self._rate = rate
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DsProcessImportResultVO):
            return False
