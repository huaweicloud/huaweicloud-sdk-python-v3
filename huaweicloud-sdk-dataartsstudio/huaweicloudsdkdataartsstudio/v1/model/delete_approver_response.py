...
class DeleteApproverResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this DeleteApproverResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this DeleteApproverResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteApproverResponse.to_dict() is deprecated and no longer maintained, "
