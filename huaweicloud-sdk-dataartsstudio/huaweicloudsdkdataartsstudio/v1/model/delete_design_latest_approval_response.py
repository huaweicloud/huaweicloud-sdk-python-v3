...
class DeleteDesignLatestApprovalResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteDesignLatestApprovalResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteDesignLatestApprovalResponse):
            return False
