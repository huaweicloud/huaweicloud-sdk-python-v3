...
class CreateCodeTableResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this CreateCodeTableResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this CreateCodeTableResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateCodeTableResponse.to_dict() is deprecated and no longer maintained, "
