...
class ListDimensionGroupsResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this ListDimensionGroupsResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this ListDimensionGroupsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListDimensionGroupsResponse.to_dict() is deprecated and no longer maintained, "
