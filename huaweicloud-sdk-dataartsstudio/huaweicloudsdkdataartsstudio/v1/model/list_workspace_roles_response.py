...
class ListWorkspaceRolesResponse(SdkResponse):
    ...
    @property
    def body(self):
        r"""Gets the body of this ListWorkspaceRolesResponse.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this ListWorkspaceRolesResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListWorkspaceRolesResponse.to_dict() is deprecated and no longer maintained, "
