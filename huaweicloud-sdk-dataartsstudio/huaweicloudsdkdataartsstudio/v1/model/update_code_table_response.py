...
class UpdateCodeTableResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this UpdateCodeTableResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this UpdateCodeTableResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateCodeTableResponse.to_dict() is deprecated and no longer maintained, "
