...
class UpdateSecurityDynamicMaskingPolicyRequest:
    ...
    openapi_types = {
        'workspace': 'str',
        'id': 'str',
        'body': 'DynamicMaskingPolicyUpdateDTO'
    }
    ...
    def __init__(self, workspace=None, id=None, body=None):
        ...
        :param id: 脱敏策略id
        :type id: str
        :param body: Body of the UpdateSecurityDynamicMaskingPolicyRequest
    ...
    def workspace(self):
        ...
        :return: The workspace of this UpdateSecurityDynamicMaskingPolicyRequest.
        :rtype: str
        """
    ...
    def workspace(self, workspace):
        ...
        :param workspace: The workspace of this UpdateSecurityDynamicMaskingPolicyRequest.
        :type workspace: str
        """
    ...
    def id(self):
        ...
        :return: The id of this UpdateSecurityDynamicMaskingPolicyRequest.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this UpdateSecurityDynamicMaskingPolicyRequest.
        :type id: str
        """
        self._id = id
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateSecurityDynamicMaskingPolicyRequest):
            return False
