...
class ShowTableModelByIdResponse(SdkResponse):
    ...
    openapi_types = {
        'data': 'CreateTableModelResultData'
    }
    ...
    @property
    def data(self):
        r"""Gets the data of this ShowTableModelByIdResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this ShowTableModelByIdResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowTableModelByIdResponse.to_dict() is deprecated and no longer maintained, "
