...
class SearchSubjectNewResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this SearchSubjectNewResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this SearchSubjectNewResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("SearchSubjectNewResponse.to_dict() is deprecated and no longer maintained, "
