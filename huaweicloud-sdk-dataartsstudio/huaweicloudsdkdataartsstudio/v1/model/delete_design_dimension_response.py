...
class DeleteDesignDimensionResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteDesignDimensionResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteDesignDimensionResponse):
            return False
