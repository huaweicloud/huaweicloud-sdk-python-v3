...
class UpdateTableModelResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this UpdateTableModelResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this UpdateTableModelResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateTableModelResponse.to_dict() is deprecated and no longer maintained, "
