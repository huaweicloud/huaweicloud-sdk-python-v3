...
class DeleteCatalogResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this DeleteCatalogResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this DeleteCatalogResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteCatalogResponse.to_dict() is deprecated and no longer maintained, "
