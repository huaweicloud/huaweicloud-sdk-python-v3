...
class DynamicMaskingPolicyUpdate:
    ...
    def column_name(self):
        r"""Gets the column_name of this DynamicMaskingPolicyUpdate.

        数据表中的字段名称。

        :return: The column_name of this DynamicMaskingPolicyUpdate.
        :rtype: str
        """
    ...
    def column_name(self, column_name):
        r"""Sets the column_name of this DynamicMaskingPolicyUpdate.

        数据表中的字段名称。

        :param column_name: The column_name of this DynamicMaskingPolicyUpdate.
        :type column_name: str
        """
    ...
    def column_type(self):
        r"""Gets the column_type of this DynamicMaskingPolicyUpdate.

        数据表中字段的数据类型。

        :return: The column_type of this DynamicMaskingPolicyUpdate.
        :rtype: str
        """
    ...
    def column_type(self, column_type):
        r"""Sets the column_type of this DynamicMaskingPolicyUpdate.

        数据表中字段的数据类型。

        :param column_type: The column_type of this DynamicMaskingPolicyUpdate.
        :type column_type: str
        """
    ...
    def algorithm_type(self):
        r"""Gets the algorithm_type of this DynamicMaskingPolicyUpdate.
        ...
        :return: The algorithm_type of this DynamicMaskingPolicyUpdate.
        :rtype: str
        """
    ...
    def algorithm_type(self, algorithm_type):
        r"""Sets the algorithm_type of this DynamicMaskingPolicyUpdate.

        具体动态脱敏规则参数介绍请参见[动态脱敏规则介绍](dataartsstudio_01_1036.html)。 HIVE数据源动态脱敏算法 - MASK 掩盖英文字符和数字 - MASK_SHOW_LAST_4 保留后四位 - MASK_SHOW_FIRST_4 保留前四位 - MASK_HASH 哈希掩盖 - MASK_DATE_SHOW_YEAR 掩盖月份和日期 - MASK_NULL NULL掩盖  DWS数据源动态脱敏算法 - DWS_ALL_MASK 全掩码 - DWS_BACK_KEEP 保留后4位，其余脱敏为* - DWS_FRONT_KEEP 保留前2位，其余脱敏为* - DWS_SELF_CONFIG 需要输入开始位置、结束位置、脱敏字符传入detail结构体中，例如{\"start\": 1, \"end\": 2, \"string_target\": \"*\"}  [DLI数据源动态脱敏算法](tag:nohcs) - [MASK 掩盖英文字符和数字](tag:nohcs) - [MASK_SHOW_LAST_4 保留后四位](tag:nohcs) - [MASK_SHOW_FIRST_4 保留前四位](tag:nohcs) - [MASK_HASH 哈希掩盖](tag:nohcs) - [MASK_DATE_SHOW_YEAR 掩盖月份和日期](tag:nohcs) - [MASK_NULL NULL掩盖](tag:nohcs)

        :param algorithm_type: The algorithm_type of this DynamicMaskingPolicyUpdate.
        :type algorithm_type: str
        """
    ...
    def algorithm_detail(self):
        r"""Gets the algorithm_detail of this DynamicMaskingPolicyUpdate.

        动态脱敏策略算法详情。

        :return: The algorithm_detail of this DynamicMaskingPolicyUpdate.
        :rtype: str
        """
    ...
    def algorithm_detail(self, algorithm_detail):
        r"""Sets the algorithm_detail of this DynamicMaskingPolicyUpdate.

        动态脱敏策略算法详情。

        :param algorithm_detail: The algorithm_detail of this DynamicMaskingPolicyUpdate.
        :type algorithm_detail: str
        """
    ...
    def algorithm_detail_dto(self):
        r"""Gets the algorithm_detail_dto of this DynamicMaskingPolicyUpdate.

        :return: The algorithm_detail_dto of this DynamicMaskingPolicyUpdate.
    ...
    def algorithm_detail_dto(self, algorithm_detail_dto):
        r"""Sets the algorithm_detail_dto of this DynamicMaskingPolicyUpdate.

        :param algorithm_detail_dto: The algorithm_detail_dto of this DynamicMaskingPolicyUpdate.
        :type algorithm_detail_dto: :class:`huaweicloudsdkdataartsstudio.v1.AlgorithmDetailDTO`
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DynamicMaskingPolicyUpdate):
            return False
