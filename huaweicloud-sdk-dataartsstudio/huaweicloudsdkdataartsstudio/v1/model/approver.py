...
class Approver:
    ...
    def approver_name(self):
        r"""Gets the approver_name of this Approver.

        审批人名称

        :return: The approver_name of this Approver.
        :rtype: str
        """
    ...
    def approver_name(self, approver_name):
        r"""Sets the approver_name of this Approver.

        审批人名称

        :param approver_name: The approver_name of this Approver.
        :type approver_name: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Approver):
            return False
