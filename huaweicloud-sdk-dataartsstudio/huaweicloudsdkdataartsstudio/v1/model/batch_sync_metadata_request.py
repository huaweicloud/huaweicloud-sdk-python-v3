...
class BatchSyncMetadataRequest:
    ...
    openapi_types = {
        'body': 'CatalogMetaDataEventRequest'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchSyncMetadataRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchSyncMetadataRequest):
            return False
