...
class DeleteWorkspacesResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this DeleteWorkspacesResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this DeleteWorkspacesResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteWorkspacesResponse.to_dict() is deprecated and no longer maintained, "
