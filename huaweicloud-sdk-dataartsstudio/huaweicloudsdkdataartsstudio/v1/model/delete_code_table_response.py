...
class DeleteCodeTableResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this DeleteCodeTableResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this DeleteCodeTableResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteCodeTableResponse.to_dict() is deprecated and no longer maintained, "
