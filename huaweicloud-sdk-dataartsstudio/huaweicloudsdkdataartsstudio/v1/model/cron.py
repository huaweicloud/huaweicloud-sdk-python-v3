...
class Cron:
    ...
    attribute_map = {
        ...
        'expression_time_zone': 'expression_time_zone',
        'period': 'period',
        'depend_pre_period': 'depend_pre_period',
        'depend_jobs': 'depend_jobs'
    }

    def __init__(self, start_time=None, end_time=None, expression=None, expression_time_zone=None, period=None, depend_pre_period=None, depend_jobs=None):
        r"""Cron
        ...
        :type expression: str
        :param expression_time_zone: Cron表达式对应的时区信息，例如GMT+8。默认值：使用DataArts Studio服务端所在的时区。
        ...
        :type depend_jobs: list[:class:`huaweicloudsdkdataartsstudio.v1.DependJob`]
        """
    ...
    @property
    def period(self):
        r"""Gets the period of this Cron.

        用于描述运行的间隔时间，格式为时间+时间单位。需要与expression中的表达式对应

        :return: The period of this Cron.
        :rtype: str
        """
        return self._period
    ...
    def period(self, period):
        r"""Sets the period of this Cron.

        用于描述运行的间隔时间，格式为时间+时间单位。需要与expression中的表达式对应

        :param period: The period of this Cron.
        :type period: str
        """
        self._period = period
    ...
    def depend_jobs(self):
        ...
        :rtype: list[:class:`huaweicloudsdkdataartsstudio.v1.DependJob`]
        """
