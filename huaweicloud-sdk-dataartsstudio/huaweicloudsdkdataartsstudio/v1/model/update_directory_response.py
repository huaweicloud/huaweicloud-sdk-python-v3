...
class UpdateDirectoryResponse(SdkResponse):
    ...
    openapi_types = {
        'data': 'CreateDirectoryResultData'
    }
    ...
    @property
    def data(self):
        r"""Gets the data of this UpdateDirectoryResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this UpdateDirectoryResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateDirectoryResponse.to_dict() is deprecated and no longer maintained, "
