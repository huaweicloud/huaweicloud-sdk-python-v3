...
class SearchDesignLatestApprovalDiffResponse(SdkResponse):
    ...
    openapi_types = {
        'data': 'PublishVersionVODetailData'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("SearchDesignLatestApprovalDiffResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SearchDesignLatestApprovalDiffResponse):
            return False
