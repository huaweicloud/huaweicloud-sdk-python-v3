...
class DeleteStandardResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this DeleteStandardResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this DeleteStandardResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteStandardResponse.to_dict() is deprecated and no longer maintained, "
