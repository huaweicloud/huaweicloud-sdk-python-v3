...
class CreateSecurityAssignedQueueResponse(SdkResponse):
    ...
    openapi_types = {
        'body': 'list[QueueSrcAssignEntity]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateSecurityAssignedQueueResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateSecurityAssignedQueueResponse):
            return False
