...
class SearchCodeTablesRequest:
    ...
    def __init__(self, workspace=None, x_project_id=None, name=None, create_by=None, approver=None, directory_id=None, status=None, begin_time=None, end_time=None, limit=None, offset=None):
        r"""SearchCodeTablesRequest
    ...
    @property
    def workspace(self):
        r"""Gets the workspace of this SearchCodeTablesRequest.
    ...
    def workspace(self, workspace):
        r"""Sets the workspace of this SearchCodeTablesRequest.
    ...
    def x_project_id(self):
        r"""Gets the x_project_id of this SearchCodeTablesRequest.

        项目ID，获取方法请参见[项目ID和账号ID](projectid_accountid.xml)。  多project场景采用AK/SK认证的接口请求，则该字段必选。

        :return: The x_project_id of this SearchCodeTablesRequest.
        :rtype: str
        """
    ...
    def x_project_id(self, x_project_id):
        r"""Sets the x_project_id of this SearchCodeTablesRequest.

        项目ID，获取方法请参见[项目ID和账号ID](projectid_accountid.xml)。  多project场景采用AK/SK认证的接口请求，则该字段必选。

        :param x_project_id: The x_project_id of this SearchCodeTablesRequest.
        :type x_project_id: str
        """
    ...
    @property
    def name(self):
        r"""Gets the name of this SearchCodeTablesRequest.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this SearchCodeTablesRequest.
    ...
    @property
    def create_by(self):
        r"""Gets the create_by of this SearchCodeTablesRequest.
    ...
    def create_by(self, create_by):
        r"""Sets the create_by of this SearchCodeTablesRequest.
    ...
    @property
    def approver(self):
        r"""Gets the approver of this SearchCodeTablesRequest.
    ...
    def approver(self, approver):
        r"""Sets the approver of this SearchCodeTablesRequest.
    ...
    def directory_id(self):
        r"""Gets the directory_id of this SearchCodeTablesRequest.
    ...
    def directory_id(self, directory_id):
        r"""Sets the directory_id of this SearchCodeTablesRequest.
    ...
    @property
    def status(self):
        r"""Gets the status of this SearchCodeTablesRequest.
    ...
    def status(self, status):
        r"""Sets the status of this SearchCodeTablesRequest.
    ...
    @property
    def begin_time(self):
        r"""Gets the begin_time of this SearchCodeTablesRequest.
    ...
    def begin_time(self, begin_time):
        r"""Sets the begin_time of this SearchCodeTablesRequest.
    ...
    @property
    def end_time(self):
        r"""Gets the end_time of this SearchCodeTablesRequest.
    ...
    def end_time(self, end_time):
        r"""Sets the end_time of this SearchCodeTablesRequest.
    ...
    @property
    def limit(self):
        r"""Gets the limit of this SearchCodeTablesRequest.
    ...
    def limit(self, limit):
        r"""Sets the limit of this SearchCodeTablesRequest.
    ...
    @property
    def offset(self):
        r"""Gets the offset of this SearchCodeTablesRequest.
    ...
    def offset(self, offset):
        r"""Sets the offset of this SearchCodeTablesRequest.
