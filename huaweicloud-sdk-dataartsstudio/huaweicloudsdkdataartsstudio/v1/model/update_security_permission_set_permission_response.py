...
class UpdateSecurityPermissionSetPermissionResponse(SdkResponse):
    ...
    def url(self):
        ...
        :return: The url of this UpdateSecurityPermissionSetPermissionResponse.
        :rtype: str
        """
        return self._url
    ...
    def url(self, url):
        ...
        :param url: The url of this UpdateSecurityPermissionSetPermissionResponse.
        :type url: str
        """
        self._url = url
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateSecurityPermissionSetPermissionResponse.to_dict() is deprecated and no longer maintained, "
