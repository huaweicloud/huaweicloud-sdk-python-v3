...
class ListDatasourceConnectionsResponse(SdkResponse):
    ...
    openapi_types = {
        'is_success': 'bool',
        'message': 'str',
        'connections': 'list[ListConnectionsDetail]',
        'count': 'int'
    }
    ...
    def __init__(self, is_success=None, message=None, connections=None, count=None):
        ...
        :type message: str
        :param connections: 资源组网络连接信息列表。
        :type connections: list[:class:`huaweicloudsdkdataartsstudio.v1.ListConnectionsDetail`]
        :param count: 返回的资源组网络连接个数。
        :type count: int
        """
    ...
    def connections(self):
        ...
        :rtype: list[:class:`huaweicloudsdkdataartsstudio.v1.ListConnectionsDetail`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListDatasourceConnectionsResponse.to_dict() is deprecated and no longer maintained, "
