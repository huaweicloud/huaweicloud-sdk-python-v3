...
class BatchDeleteSecurityResourcePermissionPoliciesRequest:
    ...
    openapi_types = {
        'workspace': 'str',
        'body': 'BatchDeleteResourcePolicyDTO'
    }
    ...
    def __init__(self, workspace=None, body=None):
        ...
        :type workspace: str
        :param body: Body of the BatchDeleteSecurityResourcePermissionPoliciesRequest
    ...
    def workspace(self):
        ...
        :return: The workspace of this BatchDeleteSecurityResourcePermissionPoliciesRequest.
        :rtype: str
        """
    ...
    def workspace(self, workspace):
        ...
        :param workspace: The workspace of this BatchDeleteSecurityResourcePermissionPoliciesRequest.
        :type workspace: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteSecurityResourcePermissionPoliciesRequest):
            return False
