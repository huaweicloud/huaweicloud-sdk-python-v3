...
class UpdateStandardTemplateResponse(SdkResponse):
    ...
    def __init__(self, data=None):
        r"""UpdateStandardTemplateResponse
    ...
    @property
    def data(self):
        r"""Gets the data of this UpdateStandardTemplateResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this UpdateStandardTemplateResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateStandardTemplateResponse.to_dict() is deprecated and no longer maintained, "
