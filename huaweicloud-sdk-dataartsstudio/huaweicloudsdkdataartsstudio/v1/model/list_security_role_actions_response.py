...
class ListSecurityRoleActionsResponse(SdkResponse):
    ...
    def permission_actions(self):
        ...
        :return: The permission_actions of this ListSecurityRoleActionsResponse.
        :rtype: list[str]
        """
    ...
    def permission_actions(self, permission_actions):
        ...
        :param permission_actions: The permission_actions of this ListSecurityRoleActionsResponse.
        :type permission_actions: list[str]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListSecurityRoleActionsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListSecurityRoleActionsResponse):
            return False
