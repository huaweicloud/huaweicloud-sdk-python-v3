...
class CreateBizMetricResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this CreateBizMetricResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this CreateBizMetricResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateBizMetricResponse.to_dict() is deprecated and no longer maintained, "
