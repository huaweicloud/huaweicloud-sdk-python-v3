...
class UpdateSecurityDataClassificationCombineRuleRequest:
    ...
    openapi_types = {
        'workspace': 'str',
        'id': 'str',
        'body': 'DataClassificationCombineRuleDTO'
    }
    ...
    def __init__(self, workspace=None, id=None, body=None):
        ...
        :param id: 识别规则id
        :type id: str
        :param body: Body of the UpdateSecurityDataClassificationCombineRuleRequest
    ...
    def workspace(self):
        ...
        :return: The workspace of this UpdateSecurityDataClassificationCombineRuleRequest.
        :rtype: str
        """
    ...
    def workspace(self, workspace):
        ...
        :param workspace: The workspace of this UpdateSecurityDataClassificationCombineRuleRequest.
        :type workspace: str
        """
    ...
    def id(self):
        ...
        :return: The id of this UpdateSecurityDataClassificationCombineRuleRequest.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this UpdateSecurityDataClassificationCombineRuleRequest.
        :type id: str
        """
        self._id = id
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateSecurityDataClassificationCombineRuleRequest):
            return False
