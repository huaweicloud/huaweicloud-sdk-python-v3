...
class UpdateBizMetricResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this UpdateBizMetricResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this UpdateBizMetricResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateBizMetricResponse.to_dict() is deprecated and no longer maintained, "
