...
class ShowWorkspaceDetailByIdResponse(SdkResponse):
    ...
    def __init__(self, data=None):
        r"""ShowWorkspaceDetailByIdResponse
    ...
    @property
    def data(self):
        r"""Gets the data of this ShowWorkspaceDetailByIdResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this ShowWorkspaceDetailByIdResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowWorkspaceDetailByIdResponse.to_dict() is deprecated and no longer maintained, "
