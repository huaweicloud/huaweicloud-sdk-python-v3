...
class CreateDesignAggregationLogicTableResponse(SdkResponse):
    ...
    openapi_types = {
        'data': 'AggregationLogicTableVODetailData'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateDesignAggregationLogicTableResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateDesignAggregationLogicTableResponse):
            return False
