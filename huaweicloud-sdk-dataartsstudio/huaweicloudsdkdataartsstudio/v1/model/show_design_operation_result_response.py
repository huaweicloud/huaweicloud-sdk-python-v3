...
class ShowDesignOperationResultResponse(SdkResponse):
    ...
    openapi_types = {
        'data': 'CheckDimensionStatusResultData'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowDesignOperationResultResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowDesignOperationResultResponse):
            return False
