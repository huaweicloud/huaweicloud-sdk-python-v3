...
class ListApiCatalogListResponse(SdkResponse):
    ...
    @property
    def total(self):
        r"""Gets the total of this ListApiCatalogListResponse.
    ...
    def total(self, total):
        r"""Sets the total of this ListApiCatalogListResponse.
    ...
    @property
    def apis(self):
        r"""Gets the apis of this ListApiCatalogListResponse.
    ...
    @apis.setter
    def apis(self, apis):
        r"""Sets the apis of this ListApiCatalogListResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListApiCatalogListResponse.to_dict() is deprecated and no longer maintained, "
