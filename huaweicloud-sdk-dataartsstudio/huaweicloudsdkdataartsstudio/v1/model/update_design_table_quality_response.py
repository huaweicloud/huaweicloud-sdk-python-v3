...
class UpdateDesignTableQualityResponse(SdkResponse):
    ...
    openapi_types = {
        'data': 'UpdateDesignTableQualityResultData'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateDesignTableQualityResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateDesignTableQualityResponse):
            return False
