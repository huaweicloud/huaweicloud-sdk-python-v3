...
class DeployFactoryPackagesRequest:
    ...
    openapi_types = {
        'workspace': 'str',
        'body': 'DeployFactoryPackagesRequestBody'
    }
    ...
    def __init__(self, workspace=None, body=None):
        ...
        :type workspace: str
        :param body: Body of the DeployFactoryPackagesRequest
    ...
    def workspace(self):
        ...
        :return: The workspace of this DeployFactoryPackagesRequest.
        :rtype: str
        """
    ...
    def workspace(self, workspace):
        ...
        :param workspace: The workspace of this DeployFactoryPackagesRequest.
        :type workspace: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeployFactoryPackagesRequest):
            return False
