...
class UpdateDesignAtomicIndexResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateDesignAtomicIndexResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateDesignAtomicIndexResponse):
            return False
