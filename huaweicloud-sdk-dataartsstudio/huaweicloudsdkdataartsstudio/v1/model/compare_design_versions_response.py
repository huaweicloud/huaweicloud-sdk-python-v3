...
class CompareDesignVersionsResponse(SdkResponse):
    ...
    openapi_types = {
        'data': 'CompareDesignVersionsResultData'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CompareDesignVersionsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CompareDesignVersionsResponse):
            return False
