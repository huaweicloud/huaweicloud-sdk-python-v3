...
class ShowBizMetricByIdResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this ShowBizMetricByIdResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this ShowBizMetricByIdResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowBizMetricByIdResponse.to_dict() is deprecated and no longer maintained, "
