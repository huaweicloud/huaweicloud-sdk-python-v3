...
class CreateFactorySupplementDataInstanceRequest:
    ...
    def __init__(self, workspace=None, body=None):
        ...
        :param workspace: 当前作业的空间ID
        :type workspace: str
        :param body: Body of the CreateFactorySupplementDataInstanceRequest
    ...
    def workspace(self):
        ...
        :return: The workspace of this CreateFactorySupplementDataInstanceRequest.
        :rtype: str
        """
    ...
    def workspace(self, workspace):
        ...
        :param workspace: The workspace of this CreateFactorySupplementDataInstanceRequest.
        :type workspace: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateFactorySupplementDataInstanceRequest):
            return False
