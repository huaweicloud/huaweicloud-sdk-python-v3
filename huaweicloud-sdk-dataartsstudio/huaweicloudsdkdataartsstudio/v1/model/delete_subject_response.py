...
class DeleteSubjectResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this DeleteSubjectResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this DeleteSubjectResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteSubjectResponse.to_dict() is deprecated and no longer maintained, "
