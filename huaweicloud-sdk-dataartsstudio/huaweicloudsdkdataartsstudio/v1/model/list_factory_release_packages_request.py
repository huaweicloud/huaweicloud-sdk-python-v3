...
class ListFactoryReleasePackagesRequest:
    ...
    openapi_types = {
        'workspace': 'str',
        'body': 'ListReleasePackagesRequestBody'
    }
    ...
    def __init__(self, workspace=None, body=None):
        ...
        :param workspace: 工作空间ID，默认查询default空间
        :type workspace: str
        :param body: Body of the ListFactoryReleasePackagesRequest
    ...
    def workspace(self):
        ...
        :return: The workspace of this ListFactoryReleasePackagesRequest.
        :rtype: str
        """
    ...
    def workspace(self, workspace):
        ...
        :param workspace: The workspace of this ListFactoryReleasePackagesRequest.
        :type workspace: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListFactoryReleasePackagesRequest):
            return False
