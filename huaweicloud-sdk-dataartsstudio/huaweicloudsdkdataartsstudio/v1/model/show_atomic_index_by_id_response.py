...
class ShowAtomicIndexByIdResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this ShowAtomicIndexByIdResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this ShowAtomicIndexByIdResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowAtomicIndexByIdResponse.to_dict() is deprecated and no longer maintained, "
