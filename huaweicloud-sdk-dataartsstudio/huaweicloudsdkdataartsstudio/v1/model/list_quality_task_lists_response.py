...
class ListQualityTaskListsResponse(SdkResponse):
    ...
    def __init__(self, error_code=None, error_msg=None, data=None):
        r"""ListQualityTaskListsResponse
    ...
    @property
    def error_code(self):
        r"""Gets the error_code of this ListQualityTaskListsResponse.
    ...
    def error_code(self, error_code):
        r"""Sets the error_code of this ListQualityTaskListsResponse.
    ...
    @property
    def error_msg(self):
        r"""Gets the error_msg of this ListQualityTaskListsResponse.
    ...
    def error_msg(self, error_msg):
        r"""Sets the error_msg of this ListQualityTaskListsResponse.
    ...
    @property
    def data(self):
        r"""Gets the data of this ListQualityTaskListsResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this ListQualityTaskListsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListQualityTaskListsResponse.to_dict() is deprecated and no longer maintained, "
