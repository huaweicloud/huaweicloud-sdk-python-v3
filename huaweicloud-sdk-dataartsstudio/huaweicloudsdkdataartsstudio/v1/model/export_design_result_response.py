...
class ExportDesignResultResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ExportDesignResultResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExportDesignResultResponse):
            return False
