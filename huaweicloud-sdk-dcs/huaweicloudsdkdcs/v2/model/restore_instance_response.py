...
class RestoreInstanceResponse(SdkResponse):
    ...
    @property
    def restore_id(self):
        r"""Gets the restore_id of this RestoreInstanceResponse.
    ...
    def restore_id(self, restore_id):
        r"""Sets the restore_id of this RestoreInstanceResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("RestoreInstanceResponse.to_dict() is deprecated and no longer maintained, "
