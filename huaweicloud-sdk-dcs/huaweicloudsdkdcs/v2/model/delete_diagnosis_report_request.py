...
class DeleteDiagnosisReportRequest:
    ...
    def report_id_list(self):
        ...
        :return: The report_id_list of this DeleteDiagnosisReportRequest.
        :rtype: list[str]
        """
    ...
    def report_id_list(self, report_id_list):
        ...
        :param report_id_list: The report_id_list of this DeleteDiagnosisReportRequest.
        :type report_id_list: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteDiagnosisReportRequest):
            return False
