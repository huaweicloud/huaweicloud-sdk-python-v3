...
class ListFlavorsResponse(SdkResponse):
    ...
    def __init__(self, flavors=None):
        ...
        :param flavors: 产品规格详情。
        :type flavors: list[:class:`huaweicloudsdkdcs.v2.FlavorsItems`]
        """
    ...
    def flavors(self):
        ...
        :rtype: list[:class:`huaweicloudsdkdcs.v2.FlavorsItems`]
        """
