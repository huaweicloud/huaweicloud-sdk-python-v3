...
class HangUpKillAllClientsResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("HangUpKillAllClientsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HangUpKillAllClientsResponse):
            return False
