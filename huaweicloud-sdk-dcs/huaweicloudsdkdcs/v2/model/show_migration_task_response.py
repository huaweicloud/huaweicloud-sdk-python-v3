...
class ShowMigrationTaskResponse(SdkResponse):
    ...
    def ecs_tenant_private_ip(self):
        ...
        :return: The ecs_tenant_private_ip of this ShowMigrationTaskResponse.
        :rtype: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowMigrationTaskResponse.to_dict() is deprecated and no longer maintained, "
