...
class DeleteMigrateTaskRequest:
    ...
    def task_id_list(self):
        ...
        :return: The task_id_list of this DeleteMigrateTaskRequest.
        :rtype: list[str]
        """
    ...
    def task_id_list(self, task_id_list):
        ...
        :param task_id_list: The task_id_list of this DeleteMigrateTaskRequest.
        :type task_id_list: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteMigrateTaskRequest):
            return False
