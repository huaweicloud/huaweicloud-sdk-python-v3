...
class CopyInstanceResponse(SdkResponse):
    ...
    def backup_id(self):
        ...
        :return: The backup_id of this CopyInstanceResponse.
        :rtype: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CopyInstanceResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CopyInstanceResponse):
            return False
