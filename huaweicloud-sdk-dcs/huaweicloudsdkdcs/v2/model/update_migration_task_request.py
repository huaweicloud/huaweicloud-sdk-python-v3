...
class UpdateMigrationTaskRequest:
    ...
    openapi_types = {
        'task_id': 'str',
        'body': 'MigrationUpdateRequestEntity'
    }
    ...
    def __init__(self, task_id=None, body=None):
        ...
        :param task_id: 任务ID
        :type task_id: str
        :param body: Body of the UpdateMigrationTaskRequest
    ...
    def task_id(self):
        ...
        :return: The task_id of this UpdateMigrationTaskRequest.
        :rtype: str
        """
    ...
    def task_id(self, task_id):
        ...
        :param task_id: The task_id of this UpdateMigrationTaskRequest.
        :type task_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateMigrationTaskRequest):
            return False
