...
class DeleteMigrationTaskRequest(object):
    ...
    def __init__(self, body=None):  # noqa: E501
        """DeleteMigrationTaskRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: DeleteMigrateTaskRequest
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteMigrationTaskRequest):
            return False
