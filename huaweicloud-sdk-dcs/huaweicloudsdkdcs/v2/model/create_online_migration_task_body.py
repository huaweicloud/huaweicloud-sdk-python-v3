...
class CreateOnlineMigrationTaskBody:
    ...
    def __init__(self, name=None, description=None, vpc_id=None, subnet_id=None, security_group_id=None):
        r"""CreateOnlineMigrationTaskBody
    ...
    @property
    def name(self):
        r"""Gets the name of this CreateOnlineMigrationTaskBody.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this CreateOnlineMigrationTaskBody.
    ...
    def description(self):
        r"""Gets the description of this CreateOnlineMigrationTaskBody.
    ...
    def description(self, description):
        r"""Sets the description of this CreateOnlineMigrationTaskBody.
    ...
    @property
    def vpc_id(self):
        r"""Gets the vpc_id of this CreateOnlineMigrationTaskBody.
    ...
    def vpc_id(self, vpc_id):
        r"""Sets the vpc_id of this CreateOnlineMigrationTaskBody.
    ...
    @property
    def subnet_id(self):
        r"""Gets the subnet_id of this CreateOnlineMigrationTaskBody.
    ...
    def subnet_id(self, subnet_id):
        r"""Sets the subnet_id of this CreateOnlineMigrationTaskBody.
    ...
    def security_group_id(self):
        r"""Gets the security_group_id of this CreateOnlineMigrationTaskBody.
    ...
    def security_group_id(self, security_group_id):
        r"""Sets the security_group_id of this CreateOnlineMigrationTaskBody.
