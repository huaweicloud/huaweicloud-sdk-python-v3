...
class BatchDeleteGlobalEipTagsResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchDeleteGlobalEipTagsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteGlobalEipTagsResponse):
            return False
