...
class AttachInternetBandwidthGlobalEipRequestBody:
    ...
    openapi_types = {
        'dry_run': 'bool',
        'global_eip': 'AttachInternetBandwidthGlobalEipRequestBodyGlobalEip'
    }
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AttachInternetBandwidthGlobalEipRequestBody):
            return False
