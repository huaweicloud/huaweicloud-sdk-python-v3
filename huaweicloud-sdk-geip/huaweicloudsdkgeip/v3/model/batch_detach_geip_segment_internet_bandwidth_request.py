...
class BatchDetachGeipSegmentInternetBandwidthRequest:
    ...
    openapi_types = {
        'body': 'BatchDetachInternetBandwidthsGlobalEipSegmentRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchDetachGeipSegmentInternetBandwidthRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDetachGeipSegmentInternetBandwidthRequest):
            return False
