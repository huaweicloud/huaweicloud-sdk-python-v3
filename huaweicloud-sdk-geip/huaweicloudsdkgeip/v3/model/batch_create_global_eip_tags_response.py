...
class BatchCreateGlobalEipTagsResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchCreateGlobalEipTagsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchCreateGlobalEipTagsResponse):
            return False
