...
class BatchDetachInternetBandwidthResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchDetachInternetBandwidthResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDetachInternetBandwidthResponse):
            return False
