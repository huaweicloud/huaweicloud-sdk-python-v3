...
class BatchDetachInternetBandwidthRequest:
    ...
    openapi_types = {
        'body': 'BatchDetachInternetBandwidthsGlobalEipRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchDetachInternetBandwidthRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDetachInternetBandwidthRequest):
            return False
