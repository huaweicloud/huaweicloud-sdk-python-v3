...
class BatchDeleteGeipSegmentTagsResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchDeleteGeipSegmentTagsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteGeipSegmentTagsResponse):
            return False
