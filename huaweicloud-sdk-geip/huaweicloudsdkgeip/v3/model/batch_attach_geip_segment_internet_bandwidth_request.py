...
class BatchAttachGeipSegmentInternetBandwidthRequest:
    ...
    openapi_types = {
        'body': 'BatchAttachInternetBandwidthsGlobalEipSegmentRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchAttachGeipSegmentInternetBandwidthRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchAttachGeipSegmentInternetBandwidthRequest):
            return False
