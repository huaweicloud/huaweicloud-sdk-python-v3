...
class UpdateGlobalEipSegmentResponse(SdkResponse):
    ...
    def job_id(self):
        ...
        :return: The job_id of this UpdateGlobalEipSegmentResponse.
        :rtype: str
        """
        return self._job_id
    ...
    def job_id(self, job_id):
        ...
        :param job_id: The job_id of this UpdateGlobalEipSegmentResponse.
        :type job_id: str
        """
        self._job_id = job_id
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateGlobalEipSegmentResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateGlobalEipSegmentResponse):
            return False
