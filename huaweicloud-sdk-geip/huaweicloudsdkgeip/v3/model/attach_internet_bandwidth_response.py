...
class AttachInternetBandwidthResponse(SdkResponse):
    ...
    openapi_types = {
        'request_id': 'str',
        'global_eip': 'AttachInternetBandwidthGlobalEip',
        'x_request_id': 'str'
    }
    ...
    def __init__(self, request_id=None, global_eip=None, x_request_id=None):
        ...
        super(AttachInternetBandwidthResponse, self).__init__()
    ...
    def request_id(self):
        ...
        :return: The request_id of this AttachInternetBandwidthResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        ...
        :param request_id: The request_id of this AttachInternetBandwidthResponse.
        :type request_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AttachInternetBandwidthResponse):
            return False
