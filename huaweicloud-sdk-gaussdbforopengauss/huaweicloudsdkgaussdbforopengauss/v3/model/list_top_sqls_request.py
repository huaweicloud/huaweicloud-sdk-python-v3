...
class ListTopSqlsRequest:
    ...
    def __init__(self, x_language=None, instance_id=None, body=None):
        ...
        :param body: Body of the ListTopSqlsRequest
        :type body: :class:`huaweicloudsdkgaussdbforopengauss.v3.ListTopSqlsRequestBody`
        """
    ...
    @property
    def body(self):
        r"""Gets the body of this ListTopSqlsRequest.

        :return: The body of this ListTopSqlsRequest.
        :rtype: :class:`huaweicloudsdkgaussdbforopengauss.v3.ListTopSqlsRequestBody`
        """
        return self._body

    @body.setter
    def body(self, body):
        r"""Sets the body of this ListTopSqlsRequest.

        :param body: The body of this ListTopSqlsRequest.
        :type body: :class:`huaweicloudsdkgaussdbforopengauss.v3.ListTopSqlsRequestBody`
        """
        self._body = body
