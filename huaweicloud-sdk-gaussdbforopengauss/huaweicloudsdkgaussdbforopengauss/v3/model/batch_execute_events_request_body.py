...
class BatchExecuteEventsRequestBody:
    ...
    openapi_types = {
        'event_instances': 'list[EventInstanceOption]',
        'operation_type': 'str',
        'event_schedule_window': 'EventScheduleWindowOption'
    }
    ...
    def __init__(self, event_instances=None, operation_type=None, event_schedule_window=None):
        r"""BatchExecuteEventsRequestBody
    ...
    def event_instances(self):
        r"""Gets the event_instances of this BatchExecuteEventsRequestBody.

        **参数解释**: 事件列表。 **约束限制**: 不涉及。

        :return: The event_instances of this BatchExecuteEventsRequestBody.
        :rtype: list[:class:`huaweicloudsdkgaussdbforopengauss.v3.EventInstanceOption`]
        """
        return self._event_instances

    @event_instances.setter
    def event_instances(self, event_instances):
        r"""Sets the event_instances of this BatchExecuteEventsRequestBody.

        **参数解释**: 事件列表。 **约束限制**: 不涉及。

        :param event_instances: The event_instances of this BatchExecuteEventsRequestBody.
        :type event_instances: list[:class:`huaweicloudsdkgaussdbforopengauss.v3.EventInstanceOption`]
        """
    ...
    def event_schedule_window(self):
        r"""Gets the event_schedule_window of this BatchExecuteEventsRequestBody.

        :return: The event_schedule_window of this BatchExecuteEventsRequestBody.
        :rtype: :class:`huaweicloudsdkgaussdbforopengauss.v3.EventScheduleWindowOption`
        """
        return self._event_schedule_window

    @event_schedule_window.setter
    def event_schedule_window(self, event_schedule_window):
        r"""Sets the event_schedule_window of this BatchExecuteEventsRequestBody.

        :param event_schedule_window: The event_schedule_window of this BatchExecuteEventsRequestBody.
        :type event_schedule_window: :class:`huaweicloudsdkgaussdbforopengauss.v3.EventScheduleWindowOption`
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchExecuteEventsRequestBody):
            return False
