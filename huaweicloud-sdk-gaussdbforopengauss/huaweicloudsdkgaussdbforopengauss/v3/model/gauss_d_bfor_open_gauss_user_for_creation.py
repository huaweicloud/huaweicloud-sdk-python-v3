...
class GaussDBforOpenGaussUserForCreation:
    ...
    def __init__(self, name=None, password=None, is_login_only=None):
        r"""GaussDBforOpenGaussUserForCreation
    ...
    @property
    def name(self):
        r"""Gets the name of this GaussDBforOpenGaussUserForCreation.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this GaussDBforOpenGaussUserForCreation.
    ...
    @property
    def password(self):
        r"""Gets the password of this GaussDBforOpenGaussUserForCreation.
    ...
    def password(self, password):
        r"""Sets the password of this GaussDBforOpenGaussUserForCreation.
    ...
    def is_login_only(self):
        r"""Gets the is_login_only of this GaussDBforOpenGaussUserForCreation.
    ...
    def is_login_only(self, is_login_only):
        r"""Sets the is_login_only of this GaussDBforOpenGaussUserForCreation.
