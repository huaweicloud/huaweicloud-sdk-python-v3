...
class AddHbaConfRequestBody:
    ...
    def __init__(self, hba_confs=None):
        r"""AddHbaConfRequestBody

        The model defined in huaweicloud sdk

        :param hba_confs: **参数解释**: 需要新增的hba配置信息。 **约束限制**: 不涉及。
    ...
    @property
    def hba_confs(self):
        r"""Gets the hba_confs of this AddHbaConfRequestBody.

        **参数解释**: 需要新增的hba配置信息。 **约束限制**: 不涉及。

        :return: The hba_confs of this AddHbaConfRequestBody.
    ...
    def hba_confs(self, hba_confs):
        r"""Sets the hba_confs of this AddHbaConfRequestBody.

        **参数解释**: 需要新增的hba配置信息。 **约束限制**: 不涉及。

        :param hba_confs: The hba_confs of this AddHbaConfRequestBody.
        :type hba_confs: list[:class:`huaweicloudsdkgaussdbforopengauss.v3.HbaConfOption`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddHbaConfRequestBody):
            return False
