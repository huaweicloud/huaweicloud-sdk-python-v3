...
class ListRecycleInstancesResponse(SdkResponse):
    ...
    openapi_types = {
        'total_count': 'int',
        'instances': 'list[RecycleInstancesDetailResult]'
    }
    ...
    def __init__(self, total_count=None, instances=None):
        ...
        :param total_count: 回收站所有引擎实例总数。
        :type total_count: int
        :param instances: 回收站所有引擎实例信息。
        :type instances: list[:class:`huaweicloudsdkgaussdbforopengauss.v3.RecycleInstancesDetailResult`]
        """
    ...
    def instances(self):
        ...
        :rtype: list[:class:`huaweicloudsdkgaussdbforopengauss.v3.RecycleInstancesDetailResult`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListRecycleInstancesResponse.to_dict() is deprecated and no longer maintained, "
