...
class RestartInstanceRequest:
    ...
    def __init__(self, x_language=None, instance_id=None):
        """RestartInstanceRequest - a model defined in huaweicloud sdk"""
    ...
    @property
    def x_language(self):
        """Gets the x_language of this RestartInstanceRequest.

        语言

        :return: The x_language of this RestartInstanceRequest.
        :rtype: str
        """
    ...
    def x_language(self, x_language):
        """Sets the x_language of this RestartInstanceRequest.

        语言

        :param x_language: The x_language of this RestartInstanceRequest.
        :type: str
        """
