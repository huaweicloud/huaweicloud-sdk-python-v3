...
class UpdateRedistributionControlResponse(SdkResponse):
    ...
    def __init__(self, result=None):
        r"""UpdateRedistributionControlResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateRedistributionControlResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateRedistributionControlResponse):
            return False
