...
class ShowInstanceConfigurationResponse(SdkResponse):
    ...
    def datastore_version(self):
        r"""Gets the datastore_version of this ShowInstanceConfigurationResponse.

        引擎版本。

        :return: The datastore_version of this ShowInstanceConfigurationResponse.
        :rtype: str
        """
    ...
    def datastore_version(self, datastore_version):
        r"""Sets the datastore_version of this ShowInstanceConfigurationResponse.

        引擎版本。

        :param datastore_version: The datastore_version of this ShowInstanceConfigurationResponse.
        :type datastore_version: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowInstanceConfigurationResponse.to_dict() is deprecated and no longer maintained, "
