...
class DeleteInstanceResponse(SdkResponse):
    ...
    @property
    def job_id(self):
        r"""Gets the job_id of this DeleteInstanceResponse.
    ...
    def job_id(self, job_id):
        r"""Sets the job_id of this DeleteInstanceResponse.
    ...
    @property
    def order_id(self):
        r"""Gets the order_id of this DeleteInstanceResponse.

        **参数解释**: 订单ID。包周期实例时仅返回订单ID。 **取值范围**: 不涉及。

        :return: The order_id of this DeleteInstanceResponse.
        :rtype: str
        """
    ...
    def order_id(self, order_id):
        r"""Sets the order_id of this DeleteInstanceResponse.

        **参数解释**: 订单ID。包周期实例时仅返回订单ID。 **取值范围**: 不涉及。

        :param order_id: The order_id of this DeleteInstanceResponse.
        :type order_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteInstanceResponse.to_dict() is deprecated and no longer maintained, "
