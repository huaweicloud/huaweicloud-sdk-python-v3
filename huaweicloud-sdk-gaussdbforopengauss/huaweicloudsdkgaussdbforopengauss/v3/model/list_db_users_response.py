...
class ListDbUsersResponse(SdkResponse):
    ...
    openapi_types = {
        'users': 'list[GaussDBforOpenGaussUserForList]',
        'total_count': 'int'
    }
    ...
    def __init__(self, users=None, total_count=None):
        ...
        :type users: list[:class:`huaweicloudsdkgaussdbforopengauss.v3.GaussDBforOpenGaussUserForList`]
    ...
    def users(self):
        ...
        :rtype: list[:class:`huaweicloudsdkgaussdbforopengauss.v3.GaussDBforOpenGaussUserForList`]
        """
        return self._users
