...
class ShowInstancesStatisticsResponse(SdkResponse):
    ...
    def __init__(self, total_count=None, instances_statistics=None):
        r"""ShowInstancesStatisticsResponse

        The model defined in huaweicloud sdk

        :param total_count: **参数解释**: 实例总数。 **取值范围**: 不涉及。
        :type total_count: int
        :param instances_statistics: **参数解释**: 实例统计信息。 **取值范围**: 不涉及。
    ...
    def total_count(self):
        r"""Gets the total_count of this ShowInstancesStatisticsResponse.
    ...
    def total_count(self, total_count):
        r"""Sets the total_count of this ShowInstancesStatisticsResponse.
    ...
    def instances_statistics(self):
        r"""Gets the instances_statistics of this ShowInstancesStatisticsResponse.
    ...
    def instances_statistics(self, instances_statistics):
        r"""Sets the instances_statistics of this ShowInstancesStatisticsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowInstancesStatisticsResponse.to_dict() is deprecated and no longer maintained, "
