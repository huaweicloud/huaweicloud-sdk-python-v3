...
class CreateSlowLogDownloadResponse(SdkResponse):
    ...
    def __init__(self, list=None):
        r"""CreateSlowLogDownloadResponse
    ...
    @property
    def list(self):
        r"""Gets the list of this CreateSlowLogDownloadResponse.
    ...
    @list.setter
    def list(self, list):
        r"""Sets the list of this CreateSlowLogDownloadResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateSlowLogDownloadResponse.to_dict() is deprecated and no longer maintained, "
