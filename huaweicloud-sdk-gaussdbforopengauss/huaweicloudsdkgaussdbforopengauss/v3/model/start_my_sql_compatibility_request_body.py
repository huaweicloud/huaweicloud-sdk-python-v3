...
class StartMySQLCompatibilityRequestBody:
    ...
    def __init__(self, port=None):
        r"""StartMySQLCompatibilityRequestBody
    ...
    @property
    def port(self):
        r"""Gets the port of this StartMySQLCompatibilityRequestBody.
    ...
    @port.setter
    def port(self, port):
        r"""Sets the port of this StartMySQLCompatibilityRequestBody.
