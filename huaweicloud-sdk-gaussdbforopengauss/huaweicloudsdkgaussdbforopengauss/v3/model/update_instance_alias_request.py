...
class UpdateInstanceAliasRequest:
    ...
    openapi_types = {
        'x_language': 'str',
        'instance_id': 'str',
        'body': 'UpdateInstanceAliasRequestBody'
    }
    ...
    def __init__(self, x_language=None, instance_id=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkgaussdbforopengauss.v3.UpdateInstanceAliasRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkgaussdbforopengauss.v3.UpdateInstanceAliasRequestBody`
        """
        return self._body
