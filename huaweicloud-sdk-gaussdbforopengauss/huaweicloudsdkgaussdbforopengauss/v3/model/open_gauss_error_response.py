...
class OpenGaussErrorResponse:
    ...
    def __init__(self, error_code=None, error_msg=None):
        """OpenGaussErrorResponse - a model defined in huaweicloud sdk"""
    ...
    @property
    def error_msg(self):
        """Gets the error_msg of this OpenGaussErrorResponse.
    ...
    def error_msg(self, error_msg):
        """Sets the error_msg of this OpenGaussErrorResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OpenGaussErrorResponse):
            return False
