...
class UpdateAgencyPolicyRequest:
    ...
    def __init__(self, x_language=None, agency_name=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkgaussdbforopengauss.v3.UpdateAgencyPolicyRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkgaussdbforopengauss.v3.UpdateAgencyPolicyRequestBody`
        """
        return self._body
