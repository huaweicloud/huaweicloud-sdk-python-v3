...
class ListHbaInfosRequest:
    ...
    def instance_id(self):
        r"""Gets the instance_id of this ListHbaInfosRequest.

        **参数解释**: 实例ID，此参数是用户创建实例的唯一标识。 **约束限制**: 不涉及 **取值范围**: 只能由英文字母、数字组成，且长度为36个字符。 **默认取值**: 不涉及。

        :return: The instance_id of this ListHbaInfosRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this ListHbaInfosRequest.

        **参数解释**: 实例ID，此参数是用户创建实例的唯一标识。 **约束限制**: 不涉及 **取值范围**: 只能由英文字母、数字组成，且长度为36个字符。 **默认取值**: 不涉及。

        :param instance_id: The instance_id of this ListHbaInfosRequest.
        :type instance_id: str
        """
    ...
    @property
    def x_language(self):
        r"""Gets the x_language of this ListHbaInfosRequest.

        **参数解释**: 语言。 **约束限制**: 不涉及。 **取值范围**: - zh-cn  - en-us  **默认取值**: en-us

        :return: The x_language of this ListHbaInfosRequest.
        :rtype: str
        """
    ...
    def x_language(self, x_language):
        r"""Sets the x_language of this ListHbaInfosRequest.

        **参数解释**: 语言。 **约束限制**: 不涉及。 **取值范围**: - zh-cn  - en-us  **默认取值**: en-us

        :param x_language: The x_language of this ListHbaInfosRequest.
        :type x_language: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListHbaInfosRequest):
            return False
