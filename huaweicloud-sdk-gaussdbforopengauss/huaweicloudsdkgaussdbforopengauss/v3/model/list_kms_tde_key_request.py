...
class ListKmsTdeKeyRequest:
    ...
    def __init__(self, x_language=None, kms_project_name=None):
        r"""ListKmsTdeKeyRequest
    ...
    @property
    def x_language(self):
        r"""Gets the x_language of this ListKmsTdeKeyRequest.

        **参数解释**: 语言。 **约束限制**: 不涉及。 **取值范围**: - zh-cn  - en-us  **默认取值**: en-us

        :return: The x_language of this ListKmsTdeKeyRequest.
        :rtype: str
        """
    ...
    def x_language(self, x_language):
        r"""Sets the x_language of this ListKmsTdeKeyRequest.

        **参数解释**: 语言。 **约束限制**: 不涉及。 **取值范围**: - zh-cn  - en-us  **默认取值**: en-us

        :param x_language: The x_language of this ListKmsTdeKeyRequest.
        :type x_language: str
        """
    ...
    def kms_project_name(self):
        r"""Gets the kms_project_name of this ListKmsTdeKeyRequest.
        ...
        **参数解释**: GaussDB使用透明加密的KMS主密钥ID所在资源空间名称。 获取方法请参见[获取项目名称](https://support.huaweicloud.com/api-gaussdb/gaussdb_api_196.html)。 **约束限制**: 不涉及。 **取值范围**: 不涉及。 **默认取值**: 不涉及。
        ...
        :return: The kms_project_name of this ListKmsTdeKeyRequest.
        :rtype: str
        """
    ...
    def kms_project_name(self, kms_project_name):
        r"""Sets the kms_project_name of this ListKmsTdeKeyRequest.

        **参数解释**: GaussDB使用透明加密的KMS主密钥ID所在资源空间名称。 获取方法请参见[获取项目名称](https://support.huaweicloud.com/api-gaussdb/gaussdb_api_196.html)。 **约束限制**: 不涉及。 **取值范围**: 不涉及。 **默认取值**: 不涉及。

        :param kms_project_name: The kms_project_name of this ListKmsTdeKeyRequest.
        :type kms_project_name: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListKmsTdeKeyRequest):
            return False
