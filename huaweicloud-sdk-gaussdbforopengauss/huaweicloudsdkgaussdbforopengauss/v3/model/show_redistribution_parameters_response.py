...
class ShowRedistributionParametersResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowRedistributionParametersResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowRedistributionParametersResponse):
            return False
