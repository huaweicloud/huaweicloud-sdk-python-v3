...
class ListEnterpriseProjectsResponse(SdkResponse):
    ...
    openapi_types = {
        'enterprise_projects': 'list[EnterpriseProjectInfoResult]',
        'total_count': 'int'
    }
    ...
    def __init__(self, enterprise_projects=None, total_count=None):
        ...
        :param enterprise_projects: **参数解释**: 企业项目列表。
        :type enterprise_projects: list[:class:`huaweicloudsdkgaussdbforopengauss.v3.EnterpriseProjectInfoResult`]
        :param total_count: **参数解释**: 企业项目总数。 **取值范围**: 不涉及。
    ...
    def enterprise_projects(self):
        ...
        **参数解释**: 企业项目列表。
        ...
        :rtype: list[:class:`huaweicloudsdkgaussdbforopengauss.v3.EnterpriseProjectInfoResult`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListEnterpriseProjectsResponse.to_dict() is deprecated and no longer maintained, "
