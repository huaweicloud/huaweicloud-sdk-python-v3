...
class BatchExecuteEventsResponse(SdkResponse):
    ...
    def __init__(self, results=None):
        ...
        :param results: **参数解释**: 事件操作响应结果。
        :type results: list[:class:`huaweicloudsdkgaussdbforopengauss.v3.EventJobResult`]
        """
    ...
    def results(self):
        ...
        **参数解释**: 事件操作响应结果。
        ...
        :rtype: list[:class:`huaweicloudsdkgaussdbforopengauss.v3.EventJobResult`]
        """
