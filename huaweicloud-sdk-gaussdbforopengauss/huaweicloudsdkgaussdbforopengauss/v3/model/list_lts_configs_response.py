...
class ListLtsConfigsResponse(SdkResponse):
    ...
    openapi_types = {
        'total_count': 'int',
        'instance_lts_configs': 'list[InstanceLtsLogConfigResult]'
    }
    ...
    def __init__(self, total_count=None, instance_lts_configs=None):
        ...
        :param instance_lts_configs: **参数解释**: 实例下Lts明细列表。
        :type instance_lts_configs: list[:class:`huaweicloudsdkgaussdbforopengauss.v3.InstanceLtsLogConfigResult`]
        """
    ...
    def instance_lts_configs(self):
        ...
        **参数解释**: 实例下Lts明细列表。
        ...
        :rtype: list[:class:`huaweicloudsdkgaussdbforopengauss.v3.InstanceLtsLogConfigResult`]
        """
