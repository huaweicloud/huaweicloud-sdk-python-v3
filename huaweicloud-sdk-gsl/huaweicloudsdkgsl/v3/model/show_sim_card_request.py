...
class ShowSimCardRequest:
    ...
    def sim_card_id(self, sim_card_id):
        r"""Sets the sim_card_id of this ShowSimCardRequest.
    ...
    @property
    def iccid(self):
        r"""Gets the iccid of this ShowSimCardRequest.

        iccid

        :return: The iccid of this ShowSimCardRequest.
        :rtype: str
        """
        return self._iccid
    ...
    def iccid(self, iccid):
        r"""Sets the iccid of this ShowSimCardRequest.

        iccid

        :param iccid: The iccid of this ShowSimCardRequest.
        :type iccid: str
        """
        self._iccid = iccid
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowSimCardRequest):
            return False
