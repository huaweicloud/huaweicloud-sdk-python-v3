...
class SetSpeedValueResponse(SdkResponse):
    ...
    def work_order_id(self):
        ...
        :return: The work_order_id of this SetSpeedValueResponse.
        :rtype: int
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("SetSpeedValueResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SetSpeedValueResponse):
            return False
