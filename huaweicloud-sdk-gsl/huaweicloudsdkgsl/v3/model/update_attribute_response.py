...
class UpdateAttributeResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateAttributeResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateAttributeResponse):
            return False
