...
class SimDeviceVO:
    ...
    @property
    def sn(self):
        """Gets the sn of this SimDeviceVO.

        sn

        :return: The sn of this SimDeviceVO.
        :rtype: str
        """
        return self._sn
    ...
    @sn.setter
    def sn(self, sn):
        """Sets the sn of this SimDeviceVO.

        sn

        :param sn: The sn of this SimDeviceVO.
        :type: str
        """
        self._sn = sn
    ...
    def supply_code(self):
        """Gets the supply_code of this SimDeviceVO.

        供应商代码

        :return: The supply_code of this SimDeviceVO.
        :rtype: str
        """
    ...
    def supply_code(self, supply_code):
        """Sets the supply_code of this SimDeviceVO.

        供应商代码

        :param supply_code: The supply_code of this SimDeviceVO.
        :type: str
        """
    ...
    @property
    def bundle_id(self):
        """Gets the bundle_id of this SimDeviceVO.

        码号对应的bundle

        :return: The bundle_id of this SimDeviceVO.
        :rtype: str
        """
    ...
    def bundle_id(self, bundle_id):
        """Sets the bundle_id of this SimDeviceVO.

        码号对应的bundle

        :param bundle_id: The bundle_id of this SimDeviceVO.
        :type: str
        """
    ...
    @property
    def test_type(self):
        """Gets the test_type of this SimDeviceVO.

        是否测试卡

        :return: The test_type of this SimDeviceVO.
        :rtype: bool
        """
    ...
    def test_type(self, test_type):
        """Sets the test_type of this SimDeviceVO.

        是否测试卡

        :param test_type: The test_type of this SimDeviceVO.
        :type: bool
        """
