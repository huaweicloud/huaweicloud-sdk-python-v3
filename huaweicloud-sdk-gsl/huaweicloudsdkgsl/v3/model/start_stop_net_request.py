...
class StartStopNetRequest:
    ...
    def sim_card_id(self):
        r"""Gets the sim_card_id of this StartStopNetRequest.
    ...
    def sim_card_id(self, sim_card_id):
        r"""Sets the sim_card_id of this StartStopNetRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this StartStopNetRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this StartStopNetRequest.
