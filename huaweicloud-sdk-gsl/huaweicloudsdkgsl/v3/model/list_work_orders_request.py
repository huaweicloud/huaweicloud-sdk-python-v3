...
class ListWorkOrdersRequest:
    ...
    def __init__(self, main_search_key=None, limit=None, offset=None, sim_type=None, work_order_type=None, status=None):
        ...
        :type sim_type: int
        :param work_order_type: 业务受理类型：1.批量激活实体卡 2.批量转移实体卡 3.创建前向流量池 4.实体卡复机 5.实体卡停机 6.批量启用或复机 7.批量停机或停机 8.批量订购 9.批量退订 10.实体卡激活 11.申请断网 12.达量断网 13.机卡重绑 14.实名制信息清除 15.实体卡限速 16.批量补卡 17.批量机卡重绑 18.重启已废弃后向流量池 19.批量达量断网 20断网恢复 21取消达量断网 22批量取消达量断网 23批量拆机
