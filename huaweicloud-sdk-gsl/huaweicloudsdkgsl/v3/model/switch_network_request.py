...
class SwitchNetworkRequest:
    ...
    def __init__(self, sim_card_id=None, body=None):
        ...
        :param body: Body of the SwitchNetworkRequest
    ...
    def sim_card_id(self):
        ...
        :return: The sim_card_id of this SwitchNetworkRequest.
        :rtype: int
        """
    ...
    def sim_card_id(self, sim_card_id):
        ...
        :param sim_card_id: The sim_card_id of this SwitchNetworkRequest.
        :type sim_card_id: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SwitchNetworkRequest):
            return False
