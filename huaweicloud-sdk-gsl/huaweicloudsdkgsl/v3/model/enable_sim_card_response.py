...
class EnableSimCardResponse(SdkResponse):
    ...
    def work_order_id(self):
        r"""Gets the work_order_id of this EnableSimCardResponse.

        业务受理单号

        :return: The work_order_id of this EnableSimCardResponse.
        :rtype: int
        """
    ...
    def work_order_id(self, work_order_id):
        r"""Sets the work_order_id of this EnableSimCardResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("EnableSimCardResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnableSimCardResponse):
            return False
