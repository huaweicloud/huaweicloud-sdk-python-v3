...
class ListSimCardFlowPerDayRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ListSimCardFlowPerDayRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListSimCardFlowPerDayRequest):
            return False
