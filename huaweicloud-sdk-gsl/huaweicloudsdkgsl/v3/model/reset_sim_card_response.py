...
class ResetSimCardResponse(SdkResponse):
    ...
    def work_order_id(self):
        ...
        :return: The work_order_id of this ResetSimCardResponse.
        :rtype: int
        """
    ...
    def work_order_id(self, work_order_id):
        ...
        :param work_order_id: The work_order_id of this ResetSimCardResponse.
        :type work_order_id: int
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ResetSimCardResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResetSimCardResponse):
            return False
