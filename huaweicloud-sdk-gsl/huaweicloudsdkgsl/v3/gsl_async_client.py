...
class GslAsyncClient(Client):
    ...
    def new_builder(cls, clazz=None):
        if not clazz:
            ...
            if clazz.__name__ != "GslAsyncClient":
                raise TypeError("client type error, support client type is GslAsyncClient")
    ...
    def add_network_switch_policy_async(self, request):
        r"""新增网络切换策略
    ...
    def add_network_switch_policy_async_invoker(self, request):
        http_info = self._add_network_switch_policy_http_info(request)
        return AsyncInvoker(self, http_info)

    def _add_network_switch_policy_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def list_network_switch_policies_async(self, request):
        r"""查询策略列表
    ...
    def list_network_switch_policies_async_invoker(self, request):
        http_info = self._list_network_switch_policies_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_network_switch_policies_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/network-switch-policies",
            "request_type": request.__class__.__name__,
    ...
    def list_sim_card_flow_per_day_async(self, request):
        r"""批量查询SIM卡日用量
    ...
    def list_sim_card_flow_per_day_async_invoker(self, request):
        http_info = self._list_sim_card_flow_per_day_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_sim_card_flow_per_day_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def list_sim_device_multiply_async(self, request):
        r"""查询三网卡列表
    ...
    def list_sim_device_multiply_async_invoker(self, request):
        http_info = self._list_sim_device_multiply_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_sim_device_multiply_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def set_network_switch_policy_async(self, request):
        r"""SIM卡设置网络切换策略
    ...
    def set_network_switch_policy_async_invoker(self, request):
        http_info = self._set_network_switch_policy_http_info(request)
        return AsyncInvoker(self, http_info)

    def _set_network_switch_policy_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def switch_network_async(self, request):
        r"""切换网络
    ...
    def switch_network_async_invoker(self, request):
        http_info = self._switch_network_http_info(request)
        return AsyncInvoker(self, http_info)

    def _switch_network_http_info(self, request):
        http_info = {
            "method": "POST",
