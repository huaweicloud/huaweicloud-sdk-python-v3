...
class CoverageResp:
    ...
    openapi_types = {
        'coverage_policy': 'str',
        'coverage_level': 'str',
        'coverage_sites': 'list[CoverageSiteResp]'
    }
    ...
    def coverage_policy(self):
        ...
        :return: The coverage_policy of this CoverageResp.
        :rtype: str
        """
    ...
    def coverage_level(self):
        ...
        :return: The coverage_level of this CoverageResp.
        :rtype: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CoverageResp):
            return False
