...
class ShowBandwidthResponse(SdkResponse):
    ...
    @property
    def bandwidth(self):
        r"""Gets the bandwidth of this ShowBandwidthResponse.
    ...
    def bandwidth(self, bandwidth):
        r"""Sets the bandwidth of this ShowBandwidthResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowBandwidthResponse.to_dict() is deprecated and no longer maintained, "
