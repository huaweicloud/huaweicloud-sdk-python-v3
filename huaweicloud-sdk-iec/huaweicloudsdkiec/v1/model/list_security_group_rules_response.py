...
class ListSecurityGroupRulesResponse(SdkResponse):
    ...
    @property
    def count(self):
        r"""Gets the count of this ListSecurityGroupRulesResponse.
    ...
    def count(self, count):
        r"""Sets the count of this ListSecurityGroupRulesResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListSecurityGroupRulesResponse.to_dict() is deprecated and no longer maintained, "
