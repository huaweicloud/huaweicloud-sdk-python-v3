...
class BatchListMetricDataRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchListMetricDataRequest
        :type body: :class:`huaweicloudsdkiec.v1.BatchListMetricDataRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkiec.v1.BatchListMetricDataRequestBody`
        """
        return self._body
