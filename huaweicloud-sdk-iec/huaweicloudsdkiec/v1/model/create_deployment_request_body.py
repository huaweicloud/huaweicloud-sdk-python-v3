...
class CreateDeploymentRequestBody:
    ...
    def __init__(self, edgecloud=None):
        """CreateDeploymentRequestBody - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateDeploymentRequestBody):
            return False
