...
class ListPortsResponse(SdkResponse):
    ...
    def __init__(self, ports=None, count=None):
        ...
        :param ports: 端口对象。
        :type ports: list[:class:`huaweicloudsdkiec.v1.Port`]
        :param count: 端口数目。
        :type count: int
        """
    ...
    def ports(self):
        ...
        :rtype: list[:class:`huaweicloudsdkiec.v1.Port`]
        """
        return self._ports
    ...
    @property
    def count(self):
        r"""Gets the count of this ListPortsResponse.
    ...
    def count(self, count):
        r"""Sets the count of this ListPortsResponse.
