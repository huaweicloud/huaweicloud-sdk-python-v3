...
class ShowRoutetableResponse(SdkResponse):
    ...
    @property
    def routetable(self):
        r"""Gets the routetable of this ShowRoutetableResponse.
    ...
    def routetable(self, routetable):
        r"""Sets the routetable of this ShowRoutetableResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowRoutetableResponse.to_dict() is deprecated and no longer maintained, "
