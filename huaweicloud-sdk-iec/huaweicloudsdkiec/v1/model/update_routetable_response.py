...
class UpdateRoutetableResponse(SdkResponse):
    ...
    @property
    def routetable(self):
        r"""Gets the routetable of this UpdateRoutetableResponse.
    ...
    def routetable(self, routetable):
        r"""Sets the routetable of this UpdateRoutetableResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateRoutetableResponse.to_dict() is deprecated and no longer maintained, "
