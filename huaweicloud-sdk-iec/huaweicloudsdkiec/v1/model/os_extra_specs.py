...
class OsExtraSpecs:
    ...
    def __init__(self, condoperationstatus=None, ecsgeneration=None, ecsperformance_type=None, ecsvirtualization_env_types=None, info_cpu_name=None, info_gpu_name=None, pci_passthroughalias=None, pci_passthroughenable_gpu=None, pci_passthroughgpu_specs=None, resource_type=None):
        ...
        :param ecsperformance_type: 边缘实例规格的分类。
        :type ecsperformance_type: str
        :param ecsvirtualization_env_types: 虚拟化类型。
        :type ecsvirtualization_env_types: str
        :param info_cpu_name: 此参数是规格的CPU详细信息。
        :type info_cpu_name: str
        :param info_gpu_name: 此参数是规格的GPU详细信息。
        :type info_gpu_name: str
