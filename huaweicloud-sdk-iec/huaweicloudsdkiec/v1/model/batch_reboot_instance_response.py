...
class BatchRebootInstanceResponse(SdkResponse):
    ...
    @property
    def jobs(self):
        r"""Gets the jobs of this BatchRebootInstanceResponse.
    ...
    @jobs.setter
    def jobs(self, jobs):
        r"""Sets the jobs of this BatchRebootInstanceResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchRebootInstanceResponse.to_dict() is deprecated and no longer maintained, "
