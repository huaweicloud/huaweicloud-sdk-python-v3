...
class ListVulHostsResponse(SdkResponse):
    ...
    def __init__(self, total_num=None, data_list=None):
        ...
        :param total_num: **参数解释**: 受影响的云服务器总数 **取值范围**: 最小值0，最大值10000 
        :type total_num: int
        :param data_list: **参数解释**: 受影响的云服务器列表 **取值范围**: 最小值1，最大值10000 
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListVulHostsResponse.to_dict() is deprecated and no longer maintained, "
