...
class ListPortStatisticsResponse(SdkResponse):
    ...
    def __init__(self, total_num=None, data_list=None):
        r"""ListPortStatisticsResponse

        The model defined in huaweicloud sdk

        :param total_num: **参数解释**: 开放端口总数 **取值范围**: 最小值0， 最大值10000 
        :type total_num: int
        :param data_list: **参数解释**: 开放端口统计信息列表 **取值范围**: 最小值0， 最大值10000 
    ...
    @property
    def total_num(self):
        r"""Gets the total_num of this ListPortStatisticsResponse.
    ...
    def total_num(self, total_num):
        r"""Sets the total_num of this ListPortStatisticsResponse.
    ...
    @property
    def data_list(self):
        r"""Gets the data_list of this ListPortStatisticsResponse.
    ...
    def data_list(self, data_list):
        r"""Sets the data_list of this ListPortStatisticsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListPortStatisticsResponse.to_dict() is deprecated and no longer maintained, "
