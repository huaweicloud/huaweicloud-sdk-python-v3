...
class CreateGlobalAssetScanTaskResponse(SdkResponse):
    ...
    def __init__(self, error=None):
        r"""CreateGlobalAssetScanTaskResponse
        ...
        super(CreateGlobalAssetScanTaskResponse, self).__init__()
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateGlobalAssetScanTaskResponse):
            return False
