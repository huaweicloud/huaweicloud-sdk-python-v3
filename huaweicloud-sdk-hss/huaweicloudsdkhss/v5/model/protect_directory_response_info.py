...
class ProtectDirectoryResponseInfo:
    ...
    def __init__(self, protect_directory=None, exclude_child_directory_list=None, exclude_file_list=None, backup_directory=None):
        r"""ProtectDirectoryResponseInfo

        The model defined in huaweicloud sdk

        :param protect_directory: **参数解释**： 防护目录 **取值范围**： 字符长度1-256位 
        ...
        :param backup_directory: **参数解释**： 备份目录 **取值范围**： 字符长度1-256位 
    ...
    def protect_directory(self):
        r"""Gets the protect_directory of this ProtectDirectoryResponseInfo.

        **参数解释**： 防护目录 **取值范围**： 字符长度1-256位 

        :return: The protect_directory of this ProtectDirectoryResponseInfo.
        :rtype: str
        """
    ...
    def protect_directory(self, protect_directory):
        r"""Sets the protect_directory of this ProtectDirectoryResponseInfo.

        **参数解释**： 防护目录 **取值范围**： 字符长度1-256位 

        :param protect_directory: The protect_directory of this ProtectDirectoryResponseInfo.
        :type protect_directory: str
        """
    ...
    def exclude_child_directory_list(self):
        r"""Gets the exclude_child_directory_list of this ProtectDirectoryResponseInfo.

        **参数解释**： 需要排除的子目录列表 **取值范围**： 最少0条，最多10条 

        :return: The exclude_child_directory_list of this ProtectDirectoryResponseInfo.
        :rtype: list[str]
        """
    ...
    def exclude_child_directory_list(self, exclude_child_directory_list):
        r"""Sets the exclude_child_directory_list of this ProtectDirectoryResponseInfo.

        **参数解释**： 需要排除的子目录列表 **取值范围**： 最少0条，最多10条 

        :param exclude_child_directory_list: The exclude_child_directory_list of this ProtectDirectoryResponseInfo.
        :type exclude_child_directory_list: list[str]
        """
    ...
    def exclude_file_list(self):
        r"""Gets the exclude_file_list of this ProtectDirectoryResponseInfo.

        **参数解释**： 需要排除的子文件列表 **取值范围**： 最少0条，最多10条 

        :return: The exclude_file_list of this ProtectDirectoryResponseInfo.
        :rtype: list[str]
        """
    ...
    def exclude_file_list(self, exclude_file_list):
        r"""Sets the exclude_file_list of this ProtectDirectoryResponseInfo.

        **参数解释**： 需要排除的子文件列表 **取值范围**： 最少0条，最多10条 

        :param exclude_file_list: The exclude_file_list of this ProtectDirectoryResponseInfo.
        :type exclude_file_list: list[str]
        """
    ...
    def backup_directory(self):
        r"""Gets the backup_directory of this ProtectDirectoryResponseInfo.

        **参数解释**： 备份目录 **取值范围**： 字符长度1-256位 

        :return: The backup_directory of this ProtectDirectoryResponseInfo.
        :rtype: str
        """
    ...
    def backup_directory(self, backup_directory):
        r"""Sets the backup_directory of this ProtectDirectoryResponseInfo.

        **参数解释**： 备份目录 **取值范围**： 字符长度1-256位 

        :param backup_directory: The backup_directory of this ProtectDirectoryResponseInfo.
        :type backup_directory: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProtectDirectoryResponseInfo):
            return False
