...
class ListWebSiteHostInfoResponse(SdkResponse):
    ...
    openapi_types = {
        'total_num': 'int',
        'data_list': 'list[WebSiteHostInfo]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListWebSiteHostInfoResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListWebSiteHostInfoResponse):
            return False
