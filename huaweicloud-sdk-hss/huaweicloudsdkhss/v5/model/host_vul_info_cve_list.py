...
class HostVulInfoCveList:
    ...
    def cve_id(self):
        ...
        **参数解释**: CVE ID **取值范围**: 字符范围1-32位 
        ...
        :return: The cve_id of this HostVulInfoCveList.
        :rtype: str
        """
        return self._cve_id
    ...
    def cve_id(self, cve_id):
        ...
        **参数解释**: CVE ID **取值范围**: 字符范围1-32位 
        ...
        :param cve_id: The cve_id of this HostVulInfoCveList.
        :type cve_id: str
        """
        self._cve_id = cve_id
    ...
    def cvss(self):
        ...
        **参数解释**: CVSS分值 **取值范围**: 最小值0，最大值10 
        ...
        :return: The cvss of this HostVulInfoCveList.
        :rtype: float
        """
        return self._cvss
    ...
    def cvss(self, cvss):
        ...
        **参数解释**: CVSS分值 **取值范围**: 最小值0，最大值10 
        ...
        :param cvss: The cvss of this HostVulInfoCveList.
        :type cvss: float
        """
        self._cvss = cvss
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HostVulInfoCveList):
            return False
