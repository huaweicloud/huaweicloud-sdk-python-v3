...
class ListRiskConfigHostsResponse(SdkResponse):
    ...
    openapi_types = {
        'total_num': 'int',
        'data_list': 'list[SecurityCheckHostInfoResponseInfo]'
    }
    ...
    def __init__(self, total_num=None, data_list=None):
        ...
        :param total_num: **参数解释**: 受配置检测影响的服务器数据总量 **取值范围**: 不涉及 
        :type total_num: int
        :param data_list: **参数解释**: 数据列表 **取值范围**: 不涉及 
    ...
    def data_list(self):
        ...
        **参数解释**: 数据列表 **取值范围**: 不涉及 
        ...
        :return: The data_list of this ListRiskConfigHostsResponse.
        :rtype: list[:class:`huaweicloudsdkhss.v5.SecurityCheckHostInfoResponseInfo`]
        """
    ...
    def data_list(self, data_list):
        ...
        **参数解释**: 数据列表 **取值范围**: 不涉及 
        ...
        :param data_list: The data_list of this ListRiskConfigHostsResponse.
        :type data_list: list[:class:`huaweicloudsdkhss.v5.SecurityCheckHostInfoResponseInfo`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListRiskConfigHostsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRiskConfigHostsResponse):
            return False
