...
class ListImageRiskConfigsResponse(SdkResponse):
    ...
    openapi_types = {
        'total_num': 'int',
        'data_list': 'list[ImageRiskConfigsInfoResponseInfo]'
    }
    ...
    def __init__(self, total_num=None, data_list=None):
        ...
        super(ListImageRiskConfigsResponse, self).__init__()
    ...
    @property
    def total_num(self):
        """Gets the total_num of this ListImageRiskConfigsResponse.
    ...
    def total_num(self, total_num):
        """Sets the total_num of this ListImageRiskConfigsResponse.
    ...
    @property
    def data_list(self):
        """Gets the data_list of this ListImageRiskConfigsResponse.
    ...
    def data_list(self, data_list):
        """Sets the data_list of this ListImageRiskConfigsResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListImageRiskConfigsResponse):
            return False
