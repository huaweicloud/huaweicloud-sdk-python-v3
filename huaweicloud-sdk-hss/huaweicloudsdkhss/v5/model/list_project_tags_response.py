...
class ListProjectTagsResponse(SdkResponse):
    ...
    def __init__(self, tags=None):
        ...
        :param tags: 标签信息
        :type tags: list[:class:`huaweicloudsdkhss.v5.MultiValueTagInfo`]
        """
    ...
    def tags(self):
        ...
        :rtype: list[:class:`huaweicloudsdkhss.v5.MultiValueTagInfo`]
        """
        return self._tags
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListProjectTagsResponse.to_dict() is deprecated and no longer maintained, "
