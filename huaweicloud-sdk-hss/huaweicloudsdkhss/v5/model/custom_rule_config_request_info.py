...
class CustomRuleConfigRequestInfo:
    ...
    @property
    def rule_name(self):
        r"""Gets the rule_name of this CustomRuleConfigRequestInfo.

        **参数解释**： 规则名称 **约束限制**： 不涉及 **取值范围**： 字符长度1-64位 **默认取值**： 不涉及 

        :return: The rule_name of this CustomRuleConfigRequestInfo.
        :rtype: str
        """
    ...
    def rule_name(self, rule_name):
        r"""Sets the rule_name of this CustomRuleConfigRequestInfo.

        **参数解释**： 规则名称 **约束限制**： 不涉及 **取值范围**： 字符长度1-64位 **默认取值**： 不涉及 

        :param rule_name: The rule_name of this CustomRuleConfigRequestInfo.
        :type rule_name: str
        """
    ...
    def is_all_host(self):
        r"""Gets the is_all_host of this CustomRuleConfigRequestInfo.

        **参数解释**: 是否选择所有主机 **约束限制**: 不涉及 **取值范围**: - true：是 - false：否  **默认取值**: false 

        :return: The is_all_host of this CustomRuleConfigRequestInfo.
        :rtype: bool
        """
    ...
    def is_all_host(self, is_all_host):
        r"""Sets the is_all_host of this CustomRuleConfigRequestInfo.

        **参数解释**: 是否选择所有主机 **约束限制**: 不涉及 **取值范围**: - true：是 - false：否  **默认取值**: false 

        :param is_all_host: The is_all_host of this CustomRuleConfigRequestInfo.
        :type is_all_host: bool
        """
    ...
    def custom_rule_value_info(self):
        r"""Gets the custom_rule_value_info of this CustomRuleConfigRequestInfo.

        :return: The custom_rule_value_info of this CustomRuleConfigRequestInfo.
    ...
    def custom_rule_value_info(self, custom_rule_value_info):
        r"""Sets the custom_rule_value_info of this CustomRuleConfigRequestInfo.

        :param custom_rule_value_info: The custom_rule_value_info of this CustomRuleConfigRequestInfo.
        :type custom_rule_value_info: :class:`huaweicloudsdkhss.v5.CustomRuleValueInfo`
        """
    ...
    @property
    def agent_ids(self):
        r"""Gets the agent_ids of this CustomRuleConfigRequestInfo.

        **参数解释**: agent列表 **约束限制**: 不涉及 **取值范围**: 1-1000个agentID **默认取值**: 不涉及 

        :return: The agent_ids of this CustomRuleConfigRequestInfo.
        :rtype: list[str]
        """
    ...
    def agent_ids(self, agent_ids):
        r"""Sets the agent_ids of this CustomRuleConfigRequestInfo.

        **参数解释**: agent列表 **约束限制**: 不涉及 **取值范围**: 1-1000个agentID **默认取值**: 不涉及 

        :param agent_ids: The agent_ids of this CustomRuleConfigRequestInfo.
        :type agent_ids: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CustomRuleConfigRequestInfo):
            return False
