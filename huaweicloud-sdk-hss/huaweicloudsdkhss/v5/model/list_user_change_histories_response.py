...
class ListUserChangeHistoriesResponse(SdkResponse):
    ...
    def __init__(self, total_num=None, data_list=None):
        r"""ListUserChangeHistoriesResponse

        The model defined in huaweicloud sdk

        :param total_num: **参数解释**: 账号变动总数 **取值范围**: 最小值0，最大值10000000 
        :type total_num: int
        :param data_list: **参数解释**: 账号历史变动记录列表 **取值范围**: 最小值0，最大值200 
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListUserChangeHistoriesResponse.to_dict() is deprecated and no longer maintained, "
