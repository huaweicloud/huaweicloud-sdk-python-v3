...
class ListClusterProtectionInfoResponse(SdkResponse):
    ...
    openapi_types = {
        'total_num': 'int',
        'data_list': 'list[ClusterResponseInfo]'
    }
    ...
    def __init__(self, total_num=None, data_list=None):
        r"""ListClusterProtectionInfoResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListClusterProtectionInfoResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListClusterProtectionInfoResponse):
            return False
