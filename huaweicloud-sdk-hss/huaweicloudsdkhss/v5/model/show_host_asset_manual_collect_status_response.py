...
class ShowHostAssetManualCollectStatusResponse(SdkResponse):
    ...
    def __init__(self, scan_status=None, scanned_time=None):
        r"""ShowHostAssetManualCollectStatusResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowHostAssetManualCollectStatusResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowHostAssetManualCollectStatusResponse):
            return False
