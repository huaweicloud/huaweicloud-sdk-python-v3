...
class ListAlarmWhiteListRequest:
    ...
    @property
    def region(self):
        r"""Gets the region of this ListAlarmWhiteListRequest.
    ...
    def region(self, region):
        r"""Sets the region of this ListAlarmWhiteListRequest.
    ...
    @property
    def hash(self):
        r"""Gets the hash of this ListAlarmWhiteListRequest.
    ...
    @hash.setter
    def hash(self, hash):
        r"""Sets the hash of this ListAlarmWhiteListRequest.
    ...
    @property
    def event_type(self):
        r"""Gets the event_type of this ListAlarmWhiteListRequest.
    ...
    def event_type(self, event_type):
        r"""Sets the event_type of this ListAlarmWhiteListRequest.
