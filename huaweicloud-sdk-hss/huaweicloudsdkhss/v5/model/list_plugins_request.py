...
class ListPluginsRequest:
    ...
    def __init__(self, enterprise_project_id=None, offset=None, limit=None, code=None, name=None):
        ...
        :type code: str
        :param name: **参数解释**： 插件名称 **约束限制**: 不涉及 **取值范围**: 字符长度1-256位 **默认取值**: 不涉及 
        :type name: str
        """
    ...
    @property
    def code(self):
        r"""Gets the code of this ListPluginsRequest.

        **参数解释**： 插件编码 **约束限制**: 不涉及 **取值范围**: 字符长度1-64位 **默认取值**: 不涉及 

        :return: The code of this ListPluginsRequest.
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        r"""Sets the code of this ListPluginsRequest.

        **参数解释**： 插件编码 **约束限制**: 不涉及 **取值范围**: 字符长度1-64位 **默认取值**: 不涉及 

        :param code: The code of this ListPluginsRequest.
        :type code: str
        """
        self._code = code
    ...
    def name(self):
        ...
        **参数解释**： 插件名称 **约束限制**: 不涉及 **取值范围**: 字符长度1-256位 **默认取值**: 不涉及 
