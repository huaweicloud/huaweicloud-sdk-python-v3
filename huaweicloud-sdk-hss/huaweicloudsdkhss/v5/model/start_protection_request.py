...
class StartProtectionRequest:
    ...
    @property
    def region(self):
        r"""Gets the region of this StartProtectionRequest.
    ...
    def region(self, region):
        r"""Sets the region of this StartProtectionRequest.
    ...
    def enterprise_project_id(self):
        r"""Gets the enterprise_project_id of this StartProtectionRequest.
    ...
    def enterprise_project_id(self, enterprise_project_id):
        r"""Sets the enterprise_project_id of this StartProtectionRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this StartProtectionRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this StartProtectionRequest.
