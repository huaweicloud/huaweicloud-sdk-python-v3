...
class ListAntiVirusResultResponse(SdkResponse):
    ...
    openapi_types = {
        'total_num': 'int',
        'data_list': 'list[AntiVirusResultResponseInfo]'
    }
    ...
    @property
    def total_num(self):
        r"""Gets the total_num of this ListAntiVirusResultResponse.

        **参数解释**: 总数 **取值范围**: 最小值0，最大值2147483647 

        :return: The total_num of this ListAntiVirusResultResponse.
        :rtype: int
        """
    ...
    def total_num(self, total_num):
        r"""Sets the total_num of this ListAntiVirusResultResponse.

        **参数解释**: 总数 **取值范围**: 最小值0，最大值2147483647 

        :param total_num: The total_num of this ListAntiVirusResultResponse.
        :type total_num: int
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAntiVirusResultResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAntiVirusResultResponse):
            return False
