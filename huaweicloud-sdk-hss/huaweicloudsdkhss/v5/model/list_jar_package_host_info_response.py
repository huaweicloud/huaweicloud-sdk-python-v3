...
class ListJarPackageHostInfoResponse(SdkResponse):
    ...
    def __init__(self, total_num=None, data_list=None):
        r"""ListJarPackageHostInfoResponse
    ...
    @property
    def total_num(self):
        r"""Gets the total_num of this ListJarPackageHostInfoResponse.
    ...
    def total_num(self, total_num):
        r"""Sets the total_num of this ListJarPackageHostInfoResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListJarPackageHostInfoResponse.to_dict() is deprecated and no longer maintained, "
