...
class ListHostRaspProtectHistoryInfoResponse(SdkResponse):
    ...
    openapi_types = {
        'total_num': 'int',
        'data_list': 'list[HostRaspProtectHistoryResponseInfo]'
    }
    ...
    def __init__(self, total_num=None, data_list=None):
        """ListHostRaspProtectHistoryInfoResponse
        ...
        super(ListHostRaspProtectHistoryInfoResponse, self).__init__()
    ...
    @property
    def data_list(self):
        """Gets the data_list of this ListHostRaspProtectHistoryInfoResponse.
    ...
    def data_list(self, data_list):
        """Sets the data_list of this ListHostRaspProtectHistoryInfoResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListHostRaspProtectHistoryInfoResponse):
            return False
