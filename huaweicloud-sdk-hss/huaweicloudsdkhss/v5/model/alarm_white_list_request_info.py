...
class AlarmWhiteListRequestInfo:
    ...
    def __init__(self, event_type=None, hash=None, description=None, delete_white_rule=None, white_field=None, judge_type=None, field_value=None, file_hash=None, file_path=None):
        ...
        :param delete_white_rule: 是否删除告警白名单规则(仅删除的白名单是规则类型时使用)
        :type delete_white_rule: bool
        :param white_field: 加白字段，包含如下: - \&quot;file_path\&quot; # 文件路径 - \&quot;process_path\&quot; # 进程路径 - \&quot;login_ip\&quot; # 登录ip - \&quot;reg_key\&quot; #注册表key - \&quot;process_cmdline\&quot; # 进程命令行 - \&quot;username\&quot; # 用户名
        :type white_field: str
        :param judge_type: 通配符，包含如下: - \&quot;equal\&quot; # 相等 - \&quot;not_equal\&quot; #不相等 - \&quot;contain\&quot; # 包含 - \&quot;not_contain\&quot; # 不包含
        :type judge_type: str
