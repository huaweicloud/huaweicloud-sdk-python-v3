...
class ListWebAppAndServicesResponse(SdkResponse):
    ...
    openapi_types = {
        'total_num': 'int',
        'data_list': 'list[WebAppAndServiceResponseInfo]'
    }
    ...
    def __init__(self, total_num=None, data_list=None):
        r"""ListWebAppAndServicesResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListWebAppAndServicesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListWebAppAndServicesResponse):
            return False
