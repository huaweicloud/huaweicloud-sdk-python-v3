...
class ListTasksRequest:
    ...
    def __init__(self, enterprise_project_id=None, offset=None, limit=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkhss.v5.ListTasksRequestBody`
        """
    ...
    @property
    def body(self):
        r"""Gets the body of this ListTasksRequest.

        :return: The body of this ListTasksRequest.
        :rtype: :class:`huaweicloudsdkhss.v5.ListTasksRequestBody`
        """
        return self._body

    @body.setter
    def body(self, body):
        r"""Sets the body of this ListTasksRequest.
