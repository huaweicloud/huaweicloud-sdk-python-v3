...
class UpdatePolicyRequestBody:
    ...
    def feature_list(self):
        r"""Gets the feature_list of this UpdatePolicyRequestBody.

        检测特性规则列表

        :return: The feature_list of this UpdatePolicyRequestBody.
    ...
    def feature_list(self, feature_list):
        r"""Sets the feature_list of this UpdatePolicyRequestBody.

        检测特性规则列表

        :param feature_list: The feature_list of this UpdatePolicyRequestBody.
        :type feature_list: list[:class:`huaweicloudsdkhss.v5.ChkFeatureInfo`]
        """
