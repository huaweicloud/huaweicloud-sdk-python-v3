...
class ShowVersionResponse(SdkResponse):
    ...
    def __init__(self, version=None):
        ...
        :param version: **参数解释**： 主机开通的版本 **取值范围**： 包含如下6种输入。 - hss.version.basic ：基础版。 - hss.version.advanced ：专业版。 - hss.version.enterprise ：企业版。 - hss.version.premium ：旗舰版。 - hss.version.wtp ：网页防篡改版。 - hss.version.container.enterprise：容器版。
        :type version: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowVersionResponse.to_dict() is deprecated and no longer maintained, "
