...
class ListAntivirusHandleHistoryResponse(SdkResponse):
    ...
    openapi_types = {
        'total_num': 'int',
        'data_list': 'list[AntiVirusHandleHistory]'
    }
    ...
    def __init__(self, total_num=None, data_list=None):
        r"""ListAntivirusHandleHistoryResponse
    ...
    @property
    def total_num(self):
        r"""Gets the total_num of this ListAntivirusHandleHistoryResponse.

        **参数解释**: 总数 **取值范围**: 最小值0，最大值2147483647 

        :return: The total_num of this ListAntivirusHandleHistoryResponse.
        :rtype: int
        """
    ...
    def total_num(self, total_num):
        r"""Sets the total_num of this ListAntivirusHandleHistoryResponse.

        **参数解释**: 总数 **取值范围**: 最小值0，最大值2147483647 

        :param total_num: The total_num of this ListAntivirusHandleHistoryResponse.
        :type total_num: int
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAntivirusHandleHistoryResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAntivirusHandleHistoryResponse):
            return False
