...
class UpdateRegistryRequestBody:
    ...
    def __init__(self, api_version=None, protocol=None, registry_addr=None, registry_username=None, registry_password=None, namespace=None, connect_cluster_id=None, get_scan_image_channel=None):
        r"""UpdateRegistryRequestBody
    ...
    def api_version(self):
        r"""Gets the api_version of this UpdateRegistryRequestBody.

        **参数解释**： 镜像仓接口版本 **约束限制**： 不涉及 **取值范围**：   - V1：V1版本   - V2：V2版本  **默认取值**： 不涉及 

        :return: The api_version of this UpdateRegistryRequestBody.
        :rtype: str
        """
    ...
    def api_version(self, api_version):
        r"""Sets the api_version of this UpdateRegistryRequestBody.

        **参数解释**： 镜像仓接口版本 **约束限制**： 不涉及 **取值范围**：   - V1：V1版本   - V2：V2版本  **默认取值**： 不涉及 

        :param api_version: The api_version of this UpdateRegistryRequestBody.
        :type api_version: str
        """
    ...
    @property
    def protocol(self):
        r"""Gets the protocol of this UpdateRegistryRequestBody.

        **参数解释**： 协议类型 **约束限制**： 不涉及 **取值范围**：   - http：http协议   - https：https协议  **默认取值**： 不涉及 

        :return: The protocol of this UpdateRegistryRequestBody.
        :rtype: str
        """
    ...
    def protocol(self, protocol):
        r"""Sets the protocol of this UpdateRegistryRequestBody.

        **参数解释**： 协议类型 **约束限制**： 不涉及 **取值范围**：   - http：http协议   - https：https协议  **默认取值**： 不涉及 

        :param protocol: The protocol of this UpdateRegistryRequestBody.
        :type protocol: str
        """
    ...
    def registry_addr(self):
        r"""Gets the registry_addr of this UpdateRegistryRequestBody.

        **参数解释**： 镜像仓地址 **约束限制**： 网址/IP:端口。如：myharbor.com。 **取值范围**： 字符长度1-256位  **默认取值**： 不涉及 

        :return: The registry_addr of this UpdateRegistryRequestBody.
        :rtype: str
        """
    ...
    def registry_addr(self, registry_addr):
        r"""Sets the registry_addr of this UpdateRegistryRequestBody.

        **参数解释**： 镜像仓地址 **约束限制**： 网址/IP:端口。如：myharbor.com。 **取值范围**： 字符长度1-256位  **默认取值**： 不涉及 

        :param registry_addr: The registry_addr of this UpdateRegistryRequestBody.
        :type registry_addr: str
        """
    ...
    def registry_username(self):
        r"""Gets the registry_username of this UpdateRegistryRequestBody.

        **参数解释**： 用于登录镜像仓的用户名。 **约束限制**： 不涉及 **取值范围**： 字符长度1-128位  **默认取值**： 不涉及 

        :return: The registry_username of this UpdateRegistryRequestBody.
        :rtype: str
        """
    ...
    def registry_username(self, registry_username):
        r"""Sets the registry_username of this UpdateRegistryRequestBody.

        **参数解释**： 用于登录镜像仓的用户名。 **约束限制**： 不涉及 **取值范围**： 字符长度1-128位  **默认取值**： 不涉及 

        :param registry_username: The registry_username of this UpdateRegistryRequestBody.
        :type registry_username: str
        """
    ...
    def registry_password(self):
        r"""Gets the registry_password of this UpdateRegistryRequestBody.

        **参数解释**： 用于登录镜像仓的密码。仅用于访问镜像仓，HSS服务不会存储您的镜像仓密码。 **约束限制**： 不涉及 **取值范围**： 字符长度1-128位  **默认取值**： 不涉及 

        :return: The registry_password of this UpdateRegistryRequestBody.
        :rtype: str
        """
    ...
    def registry_password(self, registry_password):
        r"""Sets the registry_password of this UpdateRegistryRequestBody.

        **参数解释**： 用于登录镜像仓的密码。仅用于访问镜像仓，HSS服务不会存储您的镜像仓密码。 **约束限制**： 不涉及 **取值范围**： 字符长度1-128位  **默认取值**： 不涉及 

        :param registry_password: The registry_password of this UpdateRegistryRequestBody.
        :type registry_password: str
        """
    ...
    @property
    def namespace(self):
        r"""Gets the namespace of this UpdateRegistryRequestBody.

        **参数解释**： 镜像仓项目,用来指定扫描组件要上传到的镜像仓目录。get_scan_image_channel为Other时需要填写。 **约束限制**： 不涉及 **取值范围**： 字符长度1-128位  **默认取值**： 不涉及 

        :return: The namespace of this UpdateRegistryRequestBody.
        :rtype: str
        """
    ...
    def namespace(self, namespace):
        r"""Sets the namespace of this UpdateRegistryRequestBody.

        **参数解释**： 镜像仓项目,用来指定扫描组件要上传到的镜像仓目录。get_scan_image_channel为Other时需要填写。 **约束限制**： 不涉及 **取值范围**： 字符长度1-128位  **默认取值**： 不涉及 

        :param namespace: The namespace of this UpdateRegistryRequestBody.
        :type namespace: str
        """
    ...
    def connect_cluster_id(self):
        r"""Gets the connect_cluster_id of this UpdateRegistryRequestBody.

        **参数解释**： 承载集群id。请选择一个已接入HSS的集群作为承载集群，镜像同步组件和扫描组件会以任务的方式运行在您所选的集群上，来帮助主机安全获取您的镜像数据和扫描镜像安全风险。 **约束限制**： 不涉及 **取值范围**： 字符长度1-64位  **默认取值**： 不涉及 

        :return: The connect_cluster_id of this UpdateRegistryRequestBody.
        :rtype: str
        """
    ...
    def connect_cluster_id(self, connect_cluster_id):
        r"""Sets the connect_cluster_id of this UpdateRegistryRequestBody.

        **参数解释**： 承载集群id。请选择一个已接入HSS的集群作为承载集群，镜像同步组件和扫描组件会以任务的方式运行在您所选的集群上，来帮助主机安全获取您的镜像数据和扫描镜像安全风险。 **约束限制**： 不涉及 **取值范围**： 字符长度1-64位  **默认取值**： 不涉及 

        :param connect_cluster_id: The connect_cluster_id of this UpdateRegistryRequestBody.
        :type connect_cluster_id: str
        """
    ...
    def get_scan_image_channel(self):
        r"""Gets the get_scan_image_channel of this UpdateRegistryRequestBody.
        ...
        **参数解释**： 获取扫描组件的方式 **约束限制**： 不涉及 **取值范围**： - Swr：访问swr获取扫描组件 - Other：手动上传扫描组件到承载集群。选择此方式，需要调用接口/v5/{project_id}/image/registries/image-upload-command 获取扫描组件镜像上传指令。  **默认取值**： 不涉及 
        ...
        :return: The get_scan_image_channel of this UpdateRegistryRequestBody.
        :rtype: str
        """
    ...
    def get_scan_image_channel(self, get_scan_image_channel):
        r"""Sets the get_scan_image_channel of this UpdateRegistryRequestBody.

        **参数解释**： 获取扫描组件的方式 **约束限制**： 不涉及 **取值范围**： - Swr：访问swr获取扫描组件 - Other：手动上传扫描组件到承载集群。选择此方式，需要调用接口/v5/{project_id}/image/registries/image-upload-command 获取扫描组件镜像上传指令。  **默认取值**： 不涉及 

        :param get_scan_image_channel: The get_scan_image_channel of this UpdateRegistryRequestBody.
        :type get_scan_image_channel: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateRegistryRequestBody):
            return False
