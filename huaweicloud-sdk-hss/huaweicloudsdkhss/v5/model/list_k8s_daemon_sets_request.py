...
class ListK8sDaemonSetsRequest:
    ...
    def __init__(self, enterprise_project_id=None, offset=None, daemonset_name=None, namespace_name=None, cluster_name=None, limit=None):
        r"""ListK8sDaemonSetsRequest
    ...
    def enterprise_project_id(self):
        r"""Gets the enterprise_project_id of this ListK8sDaemonSetsRequest.

        **参数解释**: 企业项目ID，用于过滤不同企业项目下的资产。获取方式请参见[获取企业项目ID](hss_02_0027.xml)。 如需查询所有企业项目下的资产请传参“all_granted_eps”。 **约束限制**: 开通企业项目功能后才需要配置企业项目ID参数。 **取值范围**: 字符长度1-256位 **默认取值**: 0，表示默认企业项目（default）。 

        :return: The enterprise_project_id of this ListK8sDaemonSetsRequest.
        :rtype: str
        """
    ...
    def enterprise_project_id(self, enterprise_project_id):
        r"""Sets the enterprise_project_id of this ListK8sDaemonSetsRequest.

        **参数解释**: 企业项目ID，用于过滤不同企业项目下的资产。获取方式请参见[获取企业项目ID](hss_02_0027.xml)。 如需查询所有企业项目下的资产请传参“all_granted_eps”。 **约束限制**: 开通企业项目功能后才需要配置企业项目ID参数。 **取值范围**: 字符长度1-256位 **默认取值**: 0，表示默认企业项目（default）。 

        :param enterprise_project_id: The enterprise_project_id of this ListK8sDaemonSetsRequest.
        :type enterprise_project_id: str
        """
    ...
    @property
    def offset(self):
        r"""Gets the offset of this ListK8sDaemonSetsRequest.

        **参数解释**: 偏移量：指定返回记录的开始位置 **约束限制**: 不涉及 **取值范围**: 最小值0，最大值2000000 **默认取值**: 默认为0 

        :return: The offset of this ListK8sDaemonSetsRequest.
        :rtype: int
        """
        return self._offset
    ...
    def offset(self, offset):
        r"""Sets the offset of this ListK8sDaemonSetsRequest.

        **参数解释**: 偏移量：指定返回记录的开始位置 **约束限制**: 不涉及 **取值范围**: 最小值0，最大值2000000 **默认取值**: 默认为0 

        :param offset: The offset of this ListK8sDaemonSetsRequest.
        :type offset: int
        """
        self._offset = offset
    ...
    def daemonset_name(self, daemonset_name):
        ...
        :type daemonset_name: str
        """
        self._daemonset_name = daemonset_name
    ...
    @property
    def limit(self):
        r"""Gets the limit of this ListK8sDaemonSetsRequest.

        **参数解释**: 每页显示个数 **约束限制**: 不涉及 **取值范围**: 取值10-200 **默认取值**: 10 

        :return: The limit of this ListK8sDaemonSetsRequest.
        :rtype: int
        """
        return self._limit
    ...
    def limit(self, limit):
        r"""Sets the limit of this ListK8sDaemonSetsRequest.

        **参数解释**: 每页显示个数 **约束限制**: 不涉及 **取值范围**: 取值10-200 **默认取值**: 10 

        :param limit: The limit of this ListK8sDaemonSetsRequest.
        :type limit: int
        """
        self._limit = limit
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListK8sDaemonSetsRequest):
            return False
