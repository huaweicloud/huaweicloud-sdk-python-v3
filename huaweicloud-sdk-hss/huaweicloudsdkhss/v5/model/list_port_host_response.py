...
class ListPortHostResponse(SdkResponse):
    ...
    openapi_types = {
        'total_num': 'int',
        'data_list': 'list[PortHostResponseInfo]'
    }
    ...
    def __init__(self, total_num=None, data_list=None):
        ...
        super(ListPortHostResponse, self).__init__()
    ...
    @property
    def total_num(self):
        """Gets the total_num of this ListPortHostResponse.
    ...
    def total_num(self, total_num):
        """Sets the total_num of this ListPortHostResponse.
    ...
    @property
    def data_list(self):
        """Gets the data_list of this ListPortHostResponse.
    ...
    def data_list(self, data_list):
        """Sets the data_list of this ListPortHostResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListPortHostResponse):
            return False
