...
class ListTasksRequestBodyClusterScanInfo:
    ...
    def __init__(self, scan_type_list=None):
        r"""ListTasksRequestBodyClusterScanInfo
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListTasksRequestBodyClusterScanInfo):
            return False
