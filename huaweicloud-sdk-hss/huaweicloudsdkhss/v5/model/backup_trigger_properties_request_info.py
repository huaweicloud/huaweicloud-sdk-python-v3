...
class BackupTriggerPropertiesRequestInfo:
    ...
    def __init__(self, pattern=None):
        """BackupTriggerPropertiesRequestInfo
    ...
    @property
    def pattern(self):
        """Gets the pattern of this BackupTriggerPropertiesRequestInfo.
    ...
    def pattern(self, pattern):
        """Sets the pattern of this BackupTriggerPropertiesRequestInfo.
