...
class ListFileHostsResponse(SdkResponse):
    ...
    openapi_types = {
        'total_num': 'int',
        'data_list': 'list[FileHostResponseInfo]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListFileHostsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListFileHostsResponse):
            return False
