...
class ShowVulReportDataResponseInfoSummary:
    ...
    def __init__(self, vul_num_repair_necessity=None, vul_num_unfixed=None, vul_num_linux=None, vul_num_windows=None, vul_num_web_cms=None, vul_num_app=None, host_num_risk=None, host_num_high_risk=None, host_num_medium_risk=None, host_num_low_risk=None, affect_asset_num_important=None, affect_asset_num_common=None, affect_asset_num_test=None):
        r"""ShowVulReportDataResponseInfoSummary
        ...
        :param vul_num_linux: **参数解释**: linux漏洞数量 **取值范围**: 最小值0，最大值1000000 
    ...
    def vul_num_repair_necessity(self):
        r"""Gets the vul_num_repair_necessity of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: 紧急修复漏洞数量 **取值范围**: 最小值0，最大值1000000 

        :return: The vul_num_repair_necessity of this ShowVulReportDataResponseInfoSummary.
        :rtype: int
        """
    ...
    def vul_num_repair_necessity(self, vul_num_repair_necessity):
        r"""Sets the vul_num_repair_necessity of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: 紧急修复漏洞数量 **取值范围**: 最小值0，最大值1000000 

        :param vul_num_repair_necessity: The vul_num_repair_necessity of this ShowVulReportDataResponseInfoSummary.
        :type vul_num_repair_necessity: int
        """
    ...
    def vul_num_unfixed(self):
        r"""Gets the vul_num_unfixed of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: 未完成修复的漏洞数量 **取值范围**: 最小值0，最大值1000000 

        :return: The vul_num_unfixed of this ShowVulReportDataResponseInfoSummary.
        :rtype: int
        """
    ...
    def vul_num_unfixed(self, vul_num_unfixed):
        r"""Sets the vul_num_unfixed of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: 未完成修复的漏洞数量 **取值范围**: 最小值0，最大值1000000 

        :param vul_num_unfixed: The vul_num_unfixed of this ShowVulReportDataResponseInfoSummary.
        :type vul_num_unfixed: int
        """
    ...
    def vul_num_linux(self):
        r"""Gets the vul_num_linux of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: linux漏洞数量 **取值范围**: 最小值0，最大值1000000 

        :return: The vul_num_linux of this ShowVulReportDataResponseInfoSummary.
        :rtype: int
        """
    ...
    def vul_num_linux(self, vul_num_linux):
        r"""Sets the vul_num_linux of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: linux漏洞数量 **取值范围**: 最小值0，最大值1000000 

        :param vul_num_linux: The vul_num_linux of this ShowVulReportDataResponseInfoSummary.
        :type vul_num_linux: int
        """
    ...
    def vul_num_windows(self):
        r"""Gets the vul_num_windows of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: windows的漏洞数量 **取值范围**: 最小值0，最大值1000000 

        :return: The vul_num_windows of this ShowVulReportDataResponseInfoSummary.
        :rtype: int
        """
    ...
    def vul_num_windows(self, vul_num_windows):
        r"""Sets the vul_num_windows of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: windows的漏洞数量 **取值范围**: 最小值0，最大值1000000 

        :param vul_num_windows: The vul_num_windows of this ShowVulReportDataResponseInfoSummary.
        :type vul_num_windows: int
        """
    ...
    def vul_num_web_cms(self):
        r"""Gets the vul_num_web_cms of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: web-cms的漏洞数量 **取值范围**: 最小值0，最大值1000000 

        :return: The vul_num_web_cms of this ShowVulReportDataResponseInfoSummary.
        :rtype: int
        """
    ...
    def vul_num_web_cms(self, vul_num_web_cms):
        r"""Sets the vul_num_web_cms of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: web-cms的漏洞数量 **取值范围**: 最小值0，最大值1000000 

        :param vul_num_web_cms: The vul_num_web_cms of this ShowVulReportDataResponseInfoSummary.
        :type vul_num_web_cms: int
        """
    ...
    def vul_num_app(self):
        r"""Gets the vul_num_app of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: 应用漏洞 **取值范围**: 最小值0，最大值1000000 

        :return: The vul_num_app of this ShowVulReportDataResponseInfoSummary.
        :rtype: int
        """
    ...
    def vul_num_app(self, vul_num_app):
        r"""Sets the vul_num_app of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: 应用漏洞 **取值范围**: 最小值0，最大值1000000 

        :param vul_num_app: The vul_num_app of this ShowVulReportDataResponseInfoSummary.
        :type vul_num_app: int
        """
    ...
    def host_num_risk(self):
        r"""Gets the host_num_risk of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: 有风险的主机数量 **取值范围**: 最小值0，最大值1000000 

        :return: The host_num_risk of this ShowVulReportDataResponseInfoSummary.
        :rtype: int
        """
    ...
    def host_num_risk(self, host_num_risk):
        r"""Sets the host_num_risk of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: 有风险的主机数量 **取值范围**: 最小值0，最大值1000000 

        :param host_num_risk: The host_num_risk of this ShowVulReportDataResponseInfoSummary.
        :type host_num_risk: int
        """
    ...
    def host_num_high_risk(self):
        r"""Gets the host_num_high_risk of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: 有高危风险的主机数量 **取值范围**: 最小值0，最大值1000000 

        :return: The host_num_high_risk of this ShowVulReportDataResponseInfoSummary.
        :rtype: int
        """
    ...
    def host_num_high_risk(self, host_num_high_risk):
        r"""Sets the host_num_high_risk of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: 有高危风险的主机数量 **取值范围**: 最小值0，最大值1000000 

        :param host_num_high_risk: The host_num_high_risk of this ShowVulReportDataResponseInfoSummary.
        :type host_num_high_risk: int
        """
    ...
    def host_num_medium_risk(self):
        r"""Gets the host_num_medium_risk of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: 有中危风险的主机数量 **取值范围**: 最小值0，最大值1000000 

        :return: The host_num_medium_risk of this ShowVulReportDataResponseInfoSummary.
        :rtype: int
        """
    ...
    def host_num_medium_risk(self, host_num_medium_risk):
        r"""Sets the host_num_medium_risk of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: 有中危风险的主机数量 **取值范围**: 最小值0，最大值1000000 

        :param host_num_medium_risk: The host_num_medium_risk of this ShowVulReportDataResponseInfoSummary.
        :type host_num_medium_risk: int
        """
    ...
    def host_num_low_risk(self):
        r"""Gets the host_num_low_risk of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: 有低危风险的主机数量 **取值范围**: 最小值0，最大值1000000 

        :return: The host_num_low_risk of this ShowVulReportDataResponseInfoSummary.
        :rtype: int
        """
    ...
    def host_num_low_risk(self, host_num_low_risk):
        r"""Sets the host_num_low_risk of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: 有低危风险的主机数量 **取值范围**: 最小值0，最大值1000000 

        :param host_num_low_risk: The host_num_low_risk of this ShowVulReportDataResponseInfoSummary.
        :type host_num_low_risk: int
        """
    ...
    def affect_asset_num_important(self):
        r"""Gets the affect_asset_num_important of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: 受影响的重要资产数量 **取值范围**: 最小值0，最大值1000000 

        :return: The affect_asset_num_important of this ShowVulReportDataResponseInfoSummary.
        :rtype: int
        """
    ...
    def affect_asset_num_important(self, affect_asset_num_important):
        r"""Sets the affect_asset_num_important of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: 受影响的重要资产数量 **取值范围**: 最小值0，最大值1000000 

        :param affect_asset_num_important: The affect_asset_num_important of this ShowVulReportDataResponseInfoSummary.
        :type affect_asset_num_important: int
        """
    ...
    def affect_asset_num_common(self):
        r"""Gets the affect_asset_num_common of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: 受影响的一般资产数量 **取值范围**: 最小值0，最大值1000000 

        :return: The affect_asset_num_common of this ShowVulReportDataResponseInfoSummary.
        :rtype: int
        """
    ...
    def affect_asset_num_common(self, affect_asset_num_common):
        r"""Sets the affect_asset_num_common of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: 受影响的一般资产数量 **取值范围**: 最小值0，最大值1000000 

        :param affect_asset_num_common: The affect_asset_num_common of this ShowVulReportDataResponseInfoSummary.
        :type affect_asset_num_common: int
        """
    ...
    def affect_asset_num_test(self):
        r"""Gets the affect_asset_num_test of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: 受影响的测试资产数量 **取值范围**: 最小值0，最大值1000000 

        :return: The affect_asset_num_test of this ShowVulReportDataResponseInfoSummary.
        :rtype: int
        """
    ...
    def affect_asset_num_test(self, affect_asset_num_test):
        r"""Sets the affect_asset_num_test of this ShowVulReportDataResponseInfoSummary.

        **参数解释**: 受影响的测试资产数量 **取值范围**: 最小值0，最大值1000000 

        :param affect_asset_num_test: The affect_asset_num_test of this ShowVulReportDataResponseInfoSummary.
        :type affect_asset_num_test: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowVulReportDataResponseInfoSummary):
            return False
