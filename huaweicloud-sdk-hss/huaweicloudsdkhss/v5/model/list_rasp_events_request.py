...
class ListRaspEventsRequest:
    ...
    def __init__(self, enterprise_project_id=None, host_id=None, offset=None, limit=None, start_time=None, end_time=None, app_type=None, severity=None, attack_tag=None, protect_status=None):
