...
class DownloadAssetFileResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DownloadAssetFileResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DownloadAssetFileResponse):
            return False
