...
class ListRaspEventsResponse(SdkResponse):
    ...
    openapi_types = {
        'total_num': 'int',
        'data_list': 'list[RaspProtectHistoryResponseInfo]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListRaspEventsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRaspEventsResponse):
            return False
