...
class ListRiskConfigHostsRequest:
    ...
    def __init__(self, enterprise_project_id=None, check_type=None, standard=None, host_name=None, host_ip=None, limit=None, offset=None):
    ...
    @property
    def check_type(self):
        """Gets the check_type of this ListRiskConfigHostsRequest.

        基线名称

        :return: The check_type of this ListRiskConfigHostsRequest.
        :rtype: str
        """
    ...
    def check_type(self, check_type):
        """Sets the check_type of this ListRiskConfigHostsRequest.

        基线名称

        :param check_type: The check_type of this ListRiskConfigHostsRequest.
        :type check_type: str
        """
