...
class ListAppChangeHistoriesResponse(SdkResponse):
    ...
    openapi_types = {
        'total_num': 'int',
        'data_list': 'list[AppChangeResponseInfo]'
    }
    ...
    def __init__(self, total_num=None, data_list=None):
        """ListAppChangeHistoriesResponse
        ...
        super(ListAppChangeHistoriesResponse, self).__init__()
    ...
    @property
    def total_num(self):
        """Gets the total_num of this ListAppChangeHistoriesResponse.
    ...
    def total_num(self, total_num):
        """Sets the total_num of this ListAppChangeHistoriesResponse.
    ...
    @property
    def data_list(self):
        """Gets the data_list of this ListAppChangeHistoriesResponse.
    ...
    def data_list(self, data_list):
        """Sets the data_list of this ListAppChangeHistoriesResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAppChangeHistoriesResponse):
            return False
