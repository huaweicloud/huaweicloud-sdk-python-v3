...
class ListPasswordComplexityResponse(SdkResponse):
    ...
    openapi_types = {
        'total_num': 'int',
        'data_list': 'list[PwdPolicyInfoResponseInfo]'
    }
    ...
    def __init__(self, total_num=None, data_list=None):
        """ListPasswordComplexityResponse
        ...
        super(ListPasswordComplexityResponse, self).__init__()
    ...
    @property
    def total_num(self):
        """Gets the total_num of this ListPasswordComplexityResponse.
    ...
    def total_num(self, total_num):
        """Sets the total_num of this ListPasswordComplexityResponse.
    ...
    @property
    def data_list(self):
        """Gets the data_list of this ListPasswordComplexityResponse.
    ...
    def data_list(self, data_list):
        """Sets the data_list of this ListPasswordComplexityResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListPasswordComplexityResponse):
            return False
