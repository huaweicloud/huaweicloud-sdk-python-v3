...
class ListClusterProtectPolicyTemplatesResponse(SdkResponse):
    ...
    openapi_types = {
        'total_num': 'int',
        'data_list': 'list[PolicyTemplateInfo]'
    }
    ...
    def __init__(self, total_num=None, data_list=None):
        r"""ListClusterProtectPolicyTemplatesResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListClusterProtectPolicyTemplatesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListClusterProtectPolicyTemplatesResponse):
            return False
