...
class CreateAppWhitelistPolicyResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateAppWhitelistPolicyResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateAppWhitelistPolicyResponse):
            return False
