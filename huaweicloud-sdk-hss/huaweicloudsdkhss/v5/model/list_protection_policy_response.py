...
class ListProtectionPolicyResponse(SdkResponse):
    ...
    openapi_types = {
        'total_num': 'int',
        'data_list': 'list[ProtectionPolicyInfo]'
    }
    ...
    def __init__(self, total_num=None, data_list=None):
        ...
        super(ListProtectionPolicyResponse, self).__init__()
    ...
    @property
    def total_num(self):
        """Gets the total_num of this ListProtectionPolicyResponse.
    ...
    def total_num(self, total_num):
        """Sets the total_num of this ListProtectionPolicyResponse.
    ...
    @property
    def data_list(self):
        """Gets the data_list of this ListProtectionPolicyResponse.
    ...
    def data_list(self, data_list):
        """Sets the data_list of this ListProtectionPolicyResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListProtectionPolicyResponse):
            return False
