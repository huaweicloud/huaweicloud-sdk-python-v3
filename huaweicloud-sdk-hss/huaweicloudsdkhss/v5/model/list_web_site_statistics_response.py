...
class ListWebSiteStatisticsResponse(SdkResponse):
    ...
    openapi_types = {
        'total_num': 'int',
        'data_list': 'list[WebSiteStatisticsResponseInfo]'
    }
    ...
    def __init__(self, total_num=None, data_list=None):
        r"""ListWebSiteStatisticsResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListWebSiteStatisticsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListWebSiteStatisticsResponse):
            return False
