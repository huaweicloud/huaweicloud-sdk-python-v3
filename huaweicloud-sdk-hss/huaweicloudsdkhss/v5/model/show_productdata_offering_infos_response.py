...
class ShowProductdataOfferingInfosResponse(SdkResponse):
    ...
    openapi_types = {
        'body': 'list[ResourceProductDataObjectInfo]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowProductdataOfferingInfosResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowProductdataOfferingInfosResponse):
            return False
