...
class ListWebFrameworkStatisticsResponse(SdkResponse):
    ...
    openapi_types = {
        'total_num': 'int',
        'data_list': 'list[WebFrameworkStatisticsResponseInfo]'
    }
    ...
    def __init__(self, total_num=None, data_list=None):
        r"""ListWebFrameworkStatisticsResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListWebFrameworkStatisticsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListWebFrameworkStatisticsResponse):
            return False
