...
class CreateVpcEndpointRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateVpcEndpointRequest
        :type body: :class:`huaweicloudsdkhss.v5.CreateVpcCondition`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkhss.v5.CreateVpcCondition`
        """
        return self._body
