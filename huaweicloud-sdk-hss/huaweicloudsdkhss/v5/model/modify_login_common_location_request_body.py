...
class ModifyLoginCommonLocationRequestBody:
    ...
    def __init__(self, area_code=None, host_id_list=None):
        r"""ModifyLoginCommonLocationRequestBody
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModifyLoginCommonLocationRequestBody):
            return False
