...
class ListResourceInstanceTagRequest:
    ...
    def __init__(self, resource_type=None, resource_id=None):
        r"""ListResourceInstanceTagRequest
    ...
    def resource_id(self):
        r"""Gets the resource_id of this ListResourceInstanceTagRequest.

        **参数解释**: 资源ID **约束限制**: 不涉及 **取值范围**: 字符长度1-128位 **默认取值**: 不涉及 

        :return: The resource_id of this ListResourceInstanceTagRequest.
        :rtype: str
        """
    ...
    def resource_id(self, resource_id):
        r"""Sets the resource_id of this ListResourceInstanceTagRequest.

        **参数解释**: 资源ID **约束限制**: 不涉及 **取值范围**: 字符长度1-128位 **默认取值**: 不涉及 

        :param resource_id: The resource_id of this ListResourceInstanceTagRequest.
        :type resource_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListResourceInstanceTagRequest):
            return False
