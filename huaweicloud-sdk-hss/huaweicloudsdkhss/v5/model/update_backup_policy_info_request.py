...
class UpdateBackupPolicyInfoRequest:
    ...
    def __init__(self, region=None, enterprise_project_id=None, body=None):
        r"""UpdateBackupPolicyInfoRequest
    ...
    @property
    def region(self):
        r"""Gets the region of this UpdateBackupPolicyInfoRequest.
    ...
    def region(self, region):
        r"""Sets the region of this UpdateBackupPolicyInfoRequest.
    ...
    def enterprise_project_id(self):
        r"""Gets the enterprise_project_id of this UpdateBackupPolicyInfoRequest.
    ...
    def enterprise_project_id(self, enterprise_project_id):
        r"""Sets the enterprise_project_id of this UpdateBackupPolicyInfoRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this UpdateBackupPolicyInfoRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this UpdateBackupPolicyInfoRequest.
