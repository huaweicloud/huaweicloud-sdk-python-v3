...
class CheckRuleIdListRequestInfo:
    ...
    openapi_types = {
        'check_rules': 'list[CheckRuleKeyInfoRequestInfo]'
    }
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CheckRuleIdListRequestInfo):
            return False
