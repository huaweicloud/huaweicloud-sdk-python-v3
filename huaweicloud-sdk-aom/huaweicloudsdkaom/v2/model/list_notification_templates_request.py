...
class ListNotificationTemplatesRequest:
    ...
    def enterprise_project_id(self):
        r"""Gets the enterprise_project_id of this ListNotificationTemplatesRequest.
        ...
        :return: The enterprise_project_id of this ListNotificationTemplatesRequest.
        :rtype: str
        """
    ...
    def enterprise_project_id(self, enterprise_project_id):
        r"""Sets the enterprise_project_id of this ListNotificationTemplatesRequest.

        企业项目id。获取方式请参见：[获取企业项目ID](aom_04_0024.xml)。 - 查询单个企业项目下通知消息模板列表，填写企业项目id。 - 查询所有企业项目下通知消息模板列表，填写“all_granted_eps”。 - 不填，查询默认企业项目下通知消息模板列表。

        :param enterprise_project_id: The enterprise_project_id of this ListNotificationTemplatesRequest.
        :type enterprise_project_id: str
        """
