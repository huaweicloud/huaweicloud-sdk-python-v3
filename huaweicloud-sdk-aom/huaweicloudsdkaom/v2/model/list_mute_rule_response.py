...
class ListMuteRuleResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListMuteRuleResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListMuteRuleResponse):
            return False
