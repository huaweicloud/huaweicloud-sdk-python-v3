...
class ListPermissionsResponse(SdkResponse):
    ...
    @property
    def body(self):
        r"""Gets the body of this ListPermissionsResponse.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this ListPermissionsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListPermissionsResponse.to_dict() is deprecated and no longer maintained, "
