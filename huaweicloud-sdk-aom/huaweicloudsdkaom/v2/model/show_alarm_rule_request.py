...
class ShowAlarmRuleRequest:
    ...
    def __init__(self, alarm_rule_id=None):
        """ShowAlarmRuleRequest - a model defined in huaweicloud sdk"""
    ...
    def alarm_rule_id(self):
        ...
        :return: The alarm_rule_id of this ShowAlarmRuleRequest.
        :rtype: str
        """
    ...
    def alarm_rule_id(self, alarm_rule_id):
        ...
        :param alarm_rule_id: The alarm_rule_id of this ShowAlarmRuleRequest.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowAlarmRuleRequest):
            return False
