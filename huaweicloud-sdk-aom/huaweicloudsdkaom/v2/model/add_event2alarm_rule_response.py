...
class AddEvent2alarmRuleResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("AddEvent2alarmRuleResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddEvent2alarmRuleResponse):
            return False
