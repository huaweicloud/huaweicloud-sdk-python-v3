...
class ListAllVersionByVersionIdRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ListAllVersionByVersionIdRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAllVersionByVersionIdRequest):
            return False
