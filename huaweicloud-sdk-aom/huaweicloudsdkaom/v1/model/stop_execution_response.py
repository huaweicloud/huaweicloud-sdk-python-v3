...
class StopExecutionResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("StopExecutionResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StopExecutionResponse):
            return False
