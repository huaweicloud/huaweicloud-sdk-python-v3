...
class ValidateSqlRequest:
    ...
    def __init__(self, body=None):
        """ValidateSqlRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ValidateSqlRequest):
            return False
