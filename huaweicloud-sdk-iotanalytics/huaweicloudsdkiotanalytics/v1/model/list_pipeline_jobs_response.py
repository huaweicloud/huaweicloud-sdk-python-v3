...
class ListPipelineJobsResponse(SdkResponse):
    ...
    openapi_types = {
        'count': 'int',
        'pipelines': 'list[PipelineJobInfoDto]'
    }
    ...
    def count(self):
        ...
        :return: The count of this ListPipelineJobsResponse.
        :rtype: int
        """
        return self._count
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListPipelineJobsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListPipelineJobsResponse):
            return False
