...
class CreateAssetModelRequest:
    ...
    def __init__(self, body=None):
        """CreateAssetModelRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateAssetModelRequest):
            return False
