...
class BindGlobalEipsRequest:
    ...
    openapi_types = {
        ...
        'body': 'CreateBindingGeipRequestBody'
    }
    ...
    def __init__(self, connect_gateway_id=None, body=None):
        ...
        :param body: Body of the BindGlobalEipsRequest
    ...
    def connect_gateway_id(self):
        ...
        :return: The connect_gateway_id of this BindGlobalEipsRequest.
        :rtype: str
        """
    ...
    def connect_gateway_id(self, connect_gateway_id):
        ...
        :param connect_gateway_id: The connect_gateway_id of this BindGlobalEipsRequest.
        :type connect_gateway_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BindGlobalEipsRequest):
            return False
