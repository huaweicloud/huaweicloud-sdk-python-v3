...
class UpdateVifPeerResponse(SdkResponse):
    ...
    @property
    def vif_peer(self):
        r"""Gets the vif_peer of this UpdateVifPeerResponse.
    ...
    def vif_peer(self, vif_peer):
        r"""Sets the vif_peer of this UpdateVifPeerResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateVifPeerResponse.to_dict() is deprecated and no longer maintained, "
