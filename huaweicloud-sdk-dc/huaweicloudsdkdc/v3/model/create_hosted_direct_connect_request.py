...
class CreateHostedDirectConnectRequest:
    ...
    openapi_types = {
        'body': 'CreateHostedDirectConnectRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateHostedDirectConnectRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateHostedDirectConnectRequest):
            return False
