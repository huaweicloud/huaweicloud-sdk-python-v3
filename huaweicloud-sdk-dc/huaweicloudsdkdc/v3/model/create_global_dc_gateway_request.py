...
class CreateGlobalDcGatewayRequest:
    ...
    openapi_types = {
        'body': 'CreateGlobalDcGatewayRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateGlobalDcGatewayRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateGlobalDcGatewayRequest):
            return False
