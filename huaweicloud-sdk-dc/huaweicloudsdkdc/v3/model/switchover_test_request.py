...
class SwitchoverTestRequest:
    ...
    openapi_types = {
        'body': 'CreateSwitchoverTestRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the SwitchoverTestRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SwitchoverTestRequest):
            return False
