...
class DeleteConnectGatewayRequest:
    ...
    def connect_gateway_id(self):
        r"""Gets the connect_gateway_id of this DeleteConnectGatewayRequest.

        互联网关ID

        :return: The connect_gateway_id of this DeleteConnectGatewayRequest.
        :rtype: str
        """
    ...
    def connect_gateway_id(self, connect_gateway_id):
        r"""Sets the connect_gateway_id of this DeleteConnectGatewayRequest.

        互联网关ID

        :param connect_gateway_id: The connect_gateway_id of this DeleteConnectGatewayRequest.
        :type connect_gateway_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteConnectGatewayRequest):
            return False
