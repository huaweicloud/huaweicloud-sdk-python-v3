...
class CreateVifPeerResponse(SdkResponse):
    ...
    @property
    def vif_peer(self):
        r"""Gets the vif_peer of this CreateVifPeerResponse.
    ...
    def vif_peer(self, vif_peer):
        r"""Sets the vif_peer of this CreateVifPeerResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateVifPeerResponse.to_dict() is deprecated and no longer maintained, "
