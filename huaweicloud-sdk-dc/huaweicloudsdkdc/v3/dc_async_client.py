...
class DcAsyncClient(Client):
    ...
    def create_vif_peer_detection_async(self, request):
        r"""创建虚拟接口对等体连通性探测实例
    ...
    def create_vif_peer_detection_async_invoker(self, request):
        http_info = self._create_vif_peer_detection_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_vif_peer_detection_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def delete_vif_peer_detection_async(self, request):
        r"""删除虚拟接口对等体连通性探测实例
    ...
    def delete_vif_peer_detection_async_invoker(self, request):
        http_info = self._delete_vif_peer_detection_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_vif_peer_detection_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_vif_peer_detections_async(self, request):
    ...
    def list_vif_peer_detections_async_invoker(self, request):
        http_info = self._list_vif_peer_detections_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_vif_peer_detections_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v3/{project_id}/dcaas/vif-peer-detections",
            "request_type": request.__class__.__name__,
    ...
    def show_vif_peer_detection_async(self, request):
        r"""查询虚拟接口对等体连通性探测实例
    ...
    def show_vif_peer_detection_async_invoker(self, request):
        http_info = self._show_vif_peer_detection_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_vif_peer_detection_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v3/{project_id}/dcaas/vif-peer-detections/{vif_peer_id}",
            "request_type": request.__class__.__name__,
    ...
    def update_extend_attribute_async(self, request):
        r"""修改虚拟接口可靠性检测的扩展参数
    ...
    def update_extend_attribute_async_invoker(self, request):
        http_info = self._update_extend_attribute_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_extend_attribute_http_info(self, request):
        http_info = {
            "method": "PUT",
