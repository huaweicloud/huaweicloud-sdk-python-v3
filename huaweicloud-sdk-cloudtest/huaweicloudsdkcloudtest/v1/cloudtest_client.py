...
class CloudtestClient(Client):
    ...
    def add_or_update_testsuite_info_using(self, request):
        r"""添加测试套
    ...
    def add_or_update_testsuite_info_using_invoker(self, request):
        http_info = self._add_or_update_testsuite_info_using_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _add_or_update_testsuite_info_using_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def batch_add_case_result_in_task(self, request):
        r"""在任务下批量设置用例结果
    ...
    def batch_add_case_result_in_task_invoker(self, request):
        http_info = self._batch_add_case_result_in_task_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _batch_add_case_result_in_task_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def batch_update_test_cases_in_diff_version(self, request):
        r"""在不同分支或者迭代下批量修改用例
    ...
    def batch_update_test_cases_in_diff_version_invoker(self, request):
        http_info = self._batch_update_test_cases_in_diff_version_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _batch_update_test_cases_in_diff_version_http_info(cls, request):
        http_info = {
            "method": "PUT",
    ...
    def delete_testsuite_infos_using(self, request):
        r"""根据任务Id列表批量删除任务
    ...
    def delete_testsuite_infos_using_invoker(self, request):
        http_info = self._delete_testsuite_infos_using_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_testsuite_infos_using_http_info(cls, request):
        http_info = {
            "method": "DELETE",
            "resource_path": "/v1/projects/{service_id}/testsuite",
            "request_type": request.__class__.__name__,
    ...
    def list_sub_tasks_by_post_using(self, request):
        r"""根据条件查询子任务集合
    ...
    def list_sub_tasks_by_post_using_invoker(self, request):
        http_info = self._list_sub_tasks_by_post_using_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_sub_tasks_by_post_using_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def list_sub_test_case_by_conditions_using(self, request):
        r"""批量查询子任务用例
    ...
    def list_sub_test_case_by_conditions_using_invoker(self, request):
        http_info = self._list_sub_test_case_by_conditions_using_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_sub_test_case_by_conditions_using_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def show_testsuite_info_using(self, request):
        r"""根据任务id查询任务
    ...
    def show_testsuite_info_using_invoker(self, request):
        http_info = self._show_testsuite_info_using_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_testsuite_info_using_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def start_testsuite_using(self, request):
        r"""启动测试套
    ...
    def start_testsuite_using_invoker(self, request):
        http_info = self._start_testsuite_using_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _start_testsuite_using_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def update_testsuite_info_using(self, request):
        r"""更新测试套
    ...
    def update_testsuite_info_using_invoker(self, request):
        http_info = self._update_testsuite_info_using_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_testsuite_info_using_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v1/projects/{service_id}/testsuite/{suite_id}",
            "request_type": request.__class__.__name__,
    ...
    def add_resource_to_iterator(self, request):
        r"""向迭代中添加资源
    ...
    def add_resource_to_iterator_invoker(self, request):
        http_info = self._add_resource_to_iterator_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _add_resource_to_iterator_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def list_visible_services(self, request):
        r"""查询当前租户可见的第三方服务列表
    ...
    def list_visible_services_invoker(self, request):
        http_info = self._list_visible_services_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_visible_services_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def batch_delete_tasks(self, request):
        r"""批量删除测试套件
    ...
    def batch_delete_tasks_invoker(self, request):
        http_info = self._batch_delete_tasks_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _batch_delete_tasks_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def create_test_version_case(self, request):
        r"""在分支或者迭代下创建用例
    ...
    def create_test_version_case_invoker(self, request):
        http_info = self._create_test_version_case_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_test_version_case_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def list_test_cases_by_condition(self, request):
        r"""查询用例列表
    ...
    def list_test_cases_by_condition_invoker(self, request):
        http_info = self._list_test_cases_by_condition_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_test_cases_by_condition_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def show_test_version_case(self, request):
        r"""查询用例详情
    ...
    def show_test_version_case_invoker(self, request):
        http_info = self._show_test_version_case_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_test_version_case_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def update_test_version_case(self, request):
        r"""在分支或者迭代下修改用例
    ...
    def update_test_version_case_invoker(self, request):
        http_info = self._update_test_version_case_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_test_version_case_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v4/testcases/{case_uri}",
            "request_type": request.__class__.__name__,
    ...
    def add_issues_to_iterator(self, request):
        r"""向迭代中添加需求
    ...
    def add_issues_to_iterator_invoker(self, request):
        http_info = self._add_issues_to_iterator_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _add_issues_to_iterator_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def create_test_iterator(self, request):
        r"""新增迭代
    ...
    def create_test_iterator_invoker(self, request):
        http_info = self._create_test_iterator_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_test_iterator_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def delete_iterator(self, request):
        r"""删除迭代
    ...
    def delete_iterator_invoker(self, request):
        http_info = self._delete_iterator_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_iterator_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_test_branches(self, request):
        r"""获取分支列表
    ...
    def list_test_branches_invoker(self, request):
        http_info = self._list_test_branches_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_test_branches_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v4/branches",
            "request_type": request.__class__.__name__,
    ...
    def show_iterator(self, request):
        r"""查询迭代计划详情，包含统计信息
    ...
    def show_iterator_invoker(self, request):
        http_info = self._show_iterator_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_iterator_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v4/iterators/{iterator_uri}",
            "request_type": request.__class__.__name__,
    ...
    def show_test_branch(self, request):
        r"""获取分支详情
    ...
    def show_test_branch_invoker(self, request):
        http_info = self._show_test_branch_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_test_branch_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v4/branches/{branch_uri}",
            "request_type": request.__class__.__name__,
    ...
    def update_branch_invoker(self, request):
        http_info = self._update_branch_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_branch_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v4/branches/{branch_uri}",
            "request_type": request.__class__.__name__,
    ...
    def update_test_iterator(self, request):
        r"""修改迭代
    ...
    def update_test_iterator_invoker(self, request):
        http_info = self._update_test_iterator_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_test_iterator_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v4/iterators/{iterator_uri}",
            "request_type": request.__class__.__name__,
