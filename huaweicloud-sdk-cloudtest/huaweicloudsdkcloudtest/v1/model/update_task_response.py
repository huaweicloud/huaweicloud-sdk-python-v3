...
class UpdateTaskResponse(SdkResponse):
    ...
    @property
    def result(self):
        r"""Gets the result of this UpdateTaskResponse.

        :return: The result of this UpdateTaskResponse.
    ...
    def result(self, result):
        r"""Sets the result of this UpdateTaskResponse.

        :param result: The result of this UpdateTaskResponse.
        :type result: :class:`huaweicloudsdkcloudtest.v1.ResultValueString`
        """
        self._result = result
    ...
    @property
    def request_id(self):
        r"""Gets the request_id of this UpdateTaskResponse.

        由接口调用方传入，建议使用UUID保证请求的唯一性。

        :return: The request_id of this UpdateTaskResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        r"""Sets the request_id of this UpdateTaskResponse.

        由接口调用方传入，建议使用UUID保证请求的唯一性。

        :param request_id: The request_id of this UpdateTaskResponse.
        :type request_id: str
        """
    ...
    def server_address(self):
        r"""Gets the server_address of this UpdateTaskResponse.

        对内接口才有此属性

        :return: The server_address of this UpdateTaskResponse.
        :rtype: str
        """
    ...
    def server_address(self, server_address):
        r"""Sets the server_address of this UpdateTaskResponse.

        对内接口才有此属性

        :param server_address: The server_address of this UpdateTaskResponse.
        :type server_address: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateTaskResponse.to_dict() is deprecated and no longer maintained, "
