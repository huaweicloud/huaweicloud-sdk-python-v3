...
class ListAllConfigItemByTypeRequest:
    ...
    openapi_types = {
        'service_id': 'str',
        'body': 'ListAllConfigItemByTypeRequestBody'
    }
    ...
    def __init__(self, service_id=None, body=None):
        ...
        :type service_id: str
        :param body: Body of the ListAllConfigItemByTypeRequest
    ...
    def service_id(self):
        ...
        :return: The service_id of this ListAllConfigItemByTypeRequest.
        :rtype: str
        """
    ...
    def service_id(self, service_id):
        ...
        :param service_id: The service_id of this ListAllConfigItemByTypeRequest.
        :type service_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAllConfigItemByTypeRequest):
            return False
