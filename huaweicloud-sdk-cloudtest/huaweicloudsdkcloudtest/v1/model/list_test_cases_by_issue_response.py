...
class ListTestCasesByIssueResponse(SdkResponse):
    ...
    def __init__(self, status=None, result=None, error=None, request_id=None, server_address=None):
        r"""ListTestCasesByIssueResponse
    ...
    @property
    def status(self):
        r"""Gets the status of this ListTestCasesByIssueResponse.
    ...
    def status(self, status):
        r"""Sets the status of this ListTestCasesByIssueResponse.
    ...
    @property
    def result(self):
        r"""Gets the result of this ListTestCasesByIssueResponse.
    ...
    def result(self, result):
        r"""Sets the result of this ListTestCasesByIssueResponse.
    ...
    @property
    def error(self):
        r"""Gets the error of this ListTestCasesByIssueResponse.
    ...
    def error(self, error):
        r"""Sets the error of this ListTestCasesByIssueResponse.
    ...
    @property
    def request_id(self):
        r"""Gets the request_id of this ListTestCasesByIssueResponse.
    ...
    def request_id(self, request_id):
        r"""Sets the request_id of this ListTestCasesByIssueResponse.
    ...
    def server_address(self):
        r"""Gets the server_address of this ListTestCasesByIssueResponse.
    ...
    def server_address(self, server_address):
        r"""Sets the server_address of this ListTestCasesByIssueResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListTestCasesByIssueResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListTestCasesByIssueResponse):
            return False
