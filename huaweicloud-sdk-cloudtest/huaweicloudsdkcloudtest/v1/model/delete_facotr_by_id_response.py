...
class DeleteFacotrByIdResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteFacotrByIdResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteFacotrByIdResponse):
            return False
