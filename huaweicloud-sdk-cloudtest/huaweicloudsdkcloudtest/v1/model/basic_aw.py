...
class BasicAw:
    ...
    openapi_types = {
        ...
        'create_user': 'str',
        'create_user_id': 'str',
        'custom_aw_libs': 'list[UploadFile]',
        'delete_time': 'str',
        'delete_user': 'str',
        'description': 'str',
    ...
    def __init__(self, aw_code=None, aw_description=None, aw_ins_list=None, aw_mark=None, aw_operationid=None, aw_tags=None, aw_type=None, aw_uniqueid=None, by_order=None, create_time=None, create_time_stamp=None, create_time_string=None, create_user=None, create_user_id=None, custom_aw_libs=None, delete_time=None, delete_user=None, description=None, dft_check_point_list=None, dft_custom_header=None, dft_retry_interval=None, dft_retry_times=None, dft_variable_list=None, extra_info=None, group_name=None, has_code=None, id=None, import_package=None, interface_label=None, is_favorite=None, keyword_variable_value=None, method=None, name=None, name_view=None, origin_project=None, output_param_list=None, param_type_and_dft_value=None, project_id=None, protocol_type=None, public_aw_lib=None, public_aw_lib_id=None, region=None, return_type=None, root_id=None, source=None, special_type=None, tmss_case_number=None, tmss_case_id=None, update_time=None, update_time_stamp=None, update_time_string=None, update_user=None, warning_msg=None, yaml_name=None):
        r"""BasicAw
        ...
        :type aw_ins_list: list[:class:`huaweicloudsdkcloudtest.v1.AwInstance`]
        ...
        :type custom_aw_libs: list[:class:`huaweicloudsdkcloudtest.v1.UploadFile`]
        ...
        :param public_aw_lib: 
        :type public_aw_lib: :class:`huaweicloudsdkcloudtest.v1.PublicAwLib`
    ...
    @property
    def aw_code(self):
        r"""Gets the aw_code of this BasicAw.

        aw代码, hasCode为1时有效

        :return: The aw_code of this BasicAw.
        :rtype: str
        """
    ...
    def aw_code(self, aw_code):
        r"""Sets the aw_code of this BasicAw.

        aw代码, hasCode为1时有效

        :param aw_code: The aw_code of this BasicAw.
        :type aw_code: str
        """
    ...
    def aw_description(self):
        r"""Gets the aw_description of this BasicAw.

        脚本模板描述信息，在用例更新时添加

        :return: The aw_description of this BasicAw.
        :rtype: str
        """
    ...
    def aw_description(self, aw_description):
        r"""Sets the aw_description of this BasicAw.

        脚本模板描述信息，在用例更新时添加

        :param aw_description: The aw_description of this BasicAw.
        :type aw_description: str
        """
    ...
    def aw_ins_list(self):
        r"""Gets the aw_ins_list of this BasicAw.

        组合aw包含的aw实例信息，awType为2时该字段有效

        :return: The aw_ins_list of this BasicAw.
    ...
    def aw_ins_list(self, aw_ins_list):
        r"""Sets the aw_ins_list of this BasicAw.

        组合aw包含的aw实例信息，awType为2时该字段有效

        :param aw_ins_list: The aw_ins_list of this BasicAw.
        :type aw_ins_list: list[:class:`huaweicloudsdkcloudtest.v1.AwInstance`]
        """
    ...
    @property
    def aw_mark(self):
        r"""Gets the aw_mark of this BasicAw.

        aw标记 0-normal；1-new；2-update 3-delete

        :return: The aw_mark of this BasicAw.
        :rtype: int
        """
    ...
    def aw_mark(self, aw_mark):
        r"""Sets the aw_mark of this BasicAw.

        aw标记 0-normal；1-new；2-update 3-delete

        :param aw_mark: The aw_mark of this BasicAw.
        :type aw_mark: int
        """
    ...
    def aw_operationid(self):
        r"""Gets the aw_operationid of this BasicAw.

        接口的operationId

        :return: The aw_operationid of this BasicAw.
        :rtype: str
        """
    ...
    def aw_operationid(self, aw_operationid):
        r"""Sets the aw_operationid of this BasicAw.

        接口的operationId

        :param aw_operationid: The aw_operationid of this BasicAw.
        :type aw_operationid: str
        """
    ...
    @property
    def aw_tags(self):
        r"""Gets the aw_tags of this BasicAw.

        接口的tags

        :return: The aw_tags of this BasicAw.
        :rtype: str
        """
    ...
    def aw_tags(self, aw_tags):
        r"""Sets the aw_tags of this BasicAw.

        接口的tags

        :param aw_tags: The aw_tags of this BasicAw.
        :type aw_tags: str
        """
    ...
    @property
    def aw_type(self):
        r"""Gets the aw_type of this BasicAw.

        AW类型1-普通aw,2-组合aw,3-导入aw

        :return: The aw_type of this BasicAw.
        :rtype: int
        """
    ...
    def aw_type(self, aw_type):
        r"""Sets the aw_type of this BasicAw.

        AW类型1-普通aw,2-组合aw,3-导入aw

        :param aw_type: The aw_type of this BasicAw.
        :type aw_type: int
        """
    ...
    def aw_uniqueid(self):
        r"""Gets the aw_uniqueid of this BasicAw.

        awOperationId_awTags的拼接

        :return: The aw_uniqueid of this BasicAw.
        :rtype: str
        """
    ...
    def aw_uniqueid(self, aw_uniqueid):
        r"""Sets the aw_uniqueid of this BasicAw.

        awOperationId_awTags的拼接

        :param aw_uniqueid: The aw_uniqueid of this BasicAw.
        :type aw_uniqueid: str
        """
    ...
    @property
    def by_order(self):
        r"""Gets the by_order of this BasicAw.

        顺序

        :return: The by_order of this BasicAw.
        :rtype: int
        """
    ...
    def by_order(self, by_order):
        r"""Sets the by_order of this BasicAw.

        顺序

        :param by_order: The by_order of this BasicAw.
        :type by_order: int
        """
    ...
    def create_time(self):
        r"""Gets the create_time of this BasicAw.

        创建时间

        :return: The create_time of this BasicAw.
        :rtype: str
        """
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this BasicAw.

        创建时间

        :param create_time: The create_time of this BasicAw.
        :type create_time: str
        """
    ...
    def create_time_stamp(self):
        r"""Gets the create_time_stamp of this BasicAw.

        创建时间戳

        :return: The create_time_stamp of this BasicAw.
        :rtype: int
        """
    ...
    def create_time_stamp(self, create_time_stamp):
        r"""Sets the create_time_stamp of this BasicAw.

        创建时间戳

        :param create_time_stamp: The create_time_stamp of this BasicAw.
        :type create_time_stamp: int
        """
    ...
    def create_time_string(self):
        r"""Gets the create_time_string of this BasicAw.

        创建时间字符串

        :return: The create_time_string of this BasicAw.
        :rtype: str
        """
    ...
    def create_time_string(self, create_time_string):
        r"""Sets the create_time_string of this BasicAw.

        创建时间字符串

        :param create_time_string: The create_time_string of this BasicAw.
        :type create_time_string: str
        """
    ...
    def create_user(self):
        r"""Gets the create_user of this BasicAw.

        创建人

        :return: The create_user of this BasicAw.
        :rtype: str
        """
    ...
    def create_user(self, create_user):
        r"""Sets the create_user of this BasicAw.

        创建人

        :param create_user: The create_user of this BasicAw.
        :type create_user: str
        """
    ...
    def create_user_id(self):
        r"""Gets the create_user_id of this BasicAw.

        创建人id

        :return: The create_user_id of this BasicAw.
        :rtype: str
        """
    ...
    def create_user_id(self, create_user_id):
        r"""Sets the create_user_id of this BasicAw.

        创建人id

        :param create_user_id: The create_user_id of this BasicAw.
        :type create_user_id: str
        """
    ...
    def custom_aw_libs(self):
        r"""Gets the custom_aw_libs of this BasicAw.

        aw库的文件列表

        :return: The custom_aw_libs of this BasicAw.
        :rtype: list[:class:`huaweicloudsdkcloudtest.v1.UploadFile`]
        """
        return self._custom_aw_libs

    @custom_aw_libs.setter
    def custom_aw_libs(self, custom_aw_libs):
        r"""Sets the custom_aw_libs of this BasicAw.

        aw库的文件列表

        :param custom_aw_libs: The custom_aw_libs of this BasicAw.
        :type custom_aw_libs: list[:class:`huaweicloudsdkcloudtest.v1.UploadFile`]
        """
    ...
    def delete_time(self):
        r"""Gets the delete_time of this BasicAw.

        删除时间

        :return: The delete_time of this BasicAw.
        :rtype: str
        """
    ...
    def delete_time(self, delete_time):
        r"""Sets the delete_time of this BasicAw.

        删除时间

        :param delete_time: The delete_time of this BasicAw.
        :type delete_time: str
        """
    ...
    def delete_user(self):
        r"""Gets the delete_user of this BasicAw.

        删除人

        :return: The delete_user of this BasicAw.
        :rtype: str
        """
    ...
    def delete_user(self, delete_user):
        r"""Sets the delete_user of this BasicAw.

        删除人

        :param delete_user: The delete_user of this BasicAw.
        :type delete_user: str
        """
    ...
    def description(self):
        r"""Gets the description of this BasicAw.

        描述

        :return: The description of this BasicAw.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this BasicAw.

        描述

        :param description: The description of this BasicAw.
        :type description: str
        """
    ...
    def dft_check_point_list(self):
        r"""Gets the dft_check_point_list of this BasicAw.

        默认检查点List

        :return: The dft_check_point_list of this BasicAw.
    ...
    def dft_check_point_list(self, dft_check_point_list):
        r"""Sets the dft_check_point_list of this BasicAw.

        默认检查点List

        :param dft_check_point_list: The dft_check_point_list of this BasicAw.
        :type dft_check_point_list: list[:class:`huaweicloudsdkcloudtest.v1.CheckPoint`]
        """
    ...
    def dft_custom_header(self):
        r"""Gets the dft_custom_header of this BasicAw.

        默认请求头参数对象

        :return: The dft_custom_header of this BasicAw.
    ...
    def dft_custom_header(self, dft_custom_header):
        r"""Sets the dft_custom_header of this BasicAw.

        默认请求头参数对象

        :param dft_custom_header: The dft_custom_header of this BasicAw.
        :type dft_custom_header: list[:class:`huaweicloudsdkcloudtest.v1.AwParam`]
        """
    ...
    def dft_retry_interval(self):
        r"""Gets the dft_retry_interval of this BasicAw.

        重试间隔时间 (ms) 为空表示不等待

        :return: The dft_retry_interval of this BasicAw.
        :rtype: str
        """
    ...
    def dft_retry_interval(self, dft_retry_interval):
        r"""Sets the dft_retry_interval of this BasicAw.

        重试间隔时间 (ms) 为空表示不等待

        :param dft_retry_interval: The dft_retry_interval of this BasicAw.
        :type dft_retry_interval: str
        """
    ...
    def dft_retry_times(self):
        r"""Gets the dft_retry_times of this BasicAw.

        重试次数

        :return: The dft_retry_times of this BasicAw.
        :rtype: str
        """
    ...
    def dft_retry_times(self, dft_retry_times):
        r"""Sets the dft_retry_times of this BasicAw.

        重试次数

        :param dft_retry_times: The dft_retry_times of this BasicAw.
        :type dft_retry_times: str
        """
    ...
    def dft_variable_list(self):
        r"""Gets the dft_variable_list of this BasicAw.

        定义的变量信息

        :return: The dft_variable_list of this BasicAw.
    ...
    def dft_variable_list(self, dft_variable_list):
        r"""Sets the dft_variable_list of this BasicAw.

        定义的变量信息

        :param dft_variable_list: The dft_variable_list of this BasicAw.
        :type dft_variable_list: list[:class:`huaweicloudsdkcloudtest.v1.AwVariable`]
        """
    ...
    @property
    def extra_info(self):
        r"""Gets the extra_info of this BasicAw.

        :return: The extra_info of this BasicAw.
    ...
    def extra_info(self, extra_info):
        r"""Sets the extra_info of this BasicAw.

        :param extra_info: The extra_info of this BasicAw.
        :type extra_info: :class:`huaweicloudsdkcloudtest.v1.JsonNode`
        """
    ...
    @property
    def group_name(self):
        r"""Gets the group_name of this BasicAw.

        组名

        :return: The group_name of this BasicAw.
        :rtype: str
        """
    ...
    def group_name(self, group_name):
        r"""Sets the group_name of this BasicAw.

        组名

        :param group_name: The group_name of this BasicAw.
        :type group_name: str
        """
    ...
    @property
    def has_code(self):
        r"""Gets the has_code of this BasicAw.

        是否自带代码 0-不自带代码，该aw依赖source字段中的源；1-自带代码

        :return: The has_code of this BasicAw.
        :rtype: int
        """
    ...
    def has_code(self, has_code):
        r"""Sets the has_code of this BasicAw.

        是否自带代码 0-不自带代码，该aw依赖source字段中的源；1-自带代码

        :param has_code: The has_code of this BasicAw.
        :type has_code: int
        """
    ...
    @property
    def id(self):
        r"""Gets the id of this BasicAw.

        id

        :return: The id of this BasicAw.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this BasicAw.

        id

        :param id: The id of this BasicAw.
        :type id: str
        """
        self._id = id
    ...
    def import_package(self):
        r"""Gets the import_package of this BasicAw.

        导入的包

        :return: The import_package of this BasicAw.
        :rtype: list[str]
        """
    ...
    def import_package(self, import_package):
        r"""Sets the import_package of this BasicAw.

        导入的包

        :param import_package: The import_package of this BasicAw.
        :type import_package: list[str]
        """
    ...
    def interface_label(self):
        r"""Gets the interface_label of this BasicAw.

        接口的x-extend

        :return: The interface_label of this BasicAw.
        :rtype: str
        """
    ...
    def interface_label(self, interface_label):
        r"""Sets the interface_label of this BasicAw.

        接口的x-extend

        :param interface_label: The interface_label of this BasicAw.
        :type interface_label: str
        """
    ...
    def is_favorite(self):
        r"""Gets the is_favorite of this BasicAw.

        是否是当前工程的收藏aw，该字段不存数据库，每次获取时实时判断

        :return: The is_favorite of this BasicAw.
        :rtype: int
        """
    ...
    def is_favorite(self, is_favorite):
        r"""Sets the is_favorite of this BasicAw.

        是否是当前工程的收藏aw，该字段不存数据库，每次获取时实时判断

        :param is_favorite: The is_favorite of this BasicAw.
        :type is_favorite: int
        """
    ...
    def keyword_variable_value(self):
        r"""Gets the keyword_variable_value of this BasicAw.

        关键字局部变量

        :return: The keyword_variable_value of this BasicAw.
        :rtype: list[:class:`huaweicloudsdkcloudtest.v1.AwVariable`]
        """
    ...
    def keyword_variable_value(self, keyword_variable_value):
        r"""Sets the keyword_variable_value of this BasicAw.

        关键字局部变量

        :param keyword_variable_value: The keyword_variable_value of this BasicAw.
        :type keyword_variable_value: list[:class:`huaweicloudsdkcloudtest.v1.AwVariable`]
        """
    ...
    @property
    def method(self):
        r"""Gets the method of this BasicAw.

        方法

        :return: The method of this BasicAw.
        :rtype: str
        """
        return self._method
    ...
    def method(self, method):
        r"""Sets the method of this BasicAw.

        方法

        :param method: The method of this BasicAw.
        :type method: str
        """
        self._method = method
    ...
    @property
    def name(self):
        r"""Gets the name of this BasicAw.

        名称

        :return: The name of this BasicAw.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this BasicAw.

        名称

        :param name: The name of this BasicAw.
        :type name: str
        """
        self._name = name
    ...
    @property
    def name_view(self):
        r"""Gets the name_view of this BasicAw.

        aw在页面上显示的名字

        :return: The name_view of this BasicAw.
        :rtype: str
        """
    ...
    def name_view(self, name_view):
        r"""Sets the name_view of this BasicAw.

        aw在页面上显示的名字

        :param name_view: The name_view of this BasicAw.
        :type name_view: str
        """
    ...
    def origin_project(self):
        r"""Gets the origin_project of this BasicAw.

        源工程信息，如果该aw是从其他工程过来的(继承或者copy to local)

        :return: The origin_project of this BasicAw.
        :rtype: str
        """
    ...
    def origin_project(self, origin_project):
        r"""Sets the origin_project of this BasicAw.

        源工程信息，如果该aw是从其他工程过来的(继承或者copy to local)

        :param origin_project: The origin_project of this BasicAw.
        :type origin_project: str
        """
    ...
    def output_param_list(self):
        r"""Gets the output_param_list of this BasicAw.

        组合aw的输出参数信息，该字段不存数据库，实时获取

        :return: The output_param_list of this BasicAw.
        :rtype: list[:class:`huaweicloudsdkcloudtest.v1.AwVariable`]
        """
    ...
    def output_param_list(self, output_param_list):
        r"""Sets the output_param_list of this BasicAw.

        组合aw的输出参数信息，该字段不存数据库，实时获取

        :param output_param_list: The output_param_list of this BasicAw.
        :type output_param_list: list[:class:`huaweicloudsdkcloudtest.v1.AwVariable`]
        """
    ...
    def param_type_and_dft_value(self):
        r"""Gets the param_type_and_dft_value of this BasicAw.

        参数类型和参数默认值对应List

        :return: The param_type_and_dft_value of this BasicAw.
        :rtype: list[:class:`huaweicloudsdkcloudtest.v1.AwParam`]
        """
    ...
    def param_type_and_dft_value(self, param_type_and_dft_value):
        r"""Sets the param_type_and_dft_value of this BasicAw.

        参数类型和参数默认值对应List

        :param param_type_and_dft_value: The param_type_and_dft_value of this BasicAw.
        :type param_type_and_dft_value: list[:class:`huaweicloudsdkcloudtest.v1.AwParam`]
        """
    ...
    @property
    def project_id(self):
        r"""Gets the project_id of this BasicAw.

        工程ID

        :return: The project_id of this BasicAw.
        :rtype: str
        """
    ...
    def project_id(self, project_id):
        r"""Sets the project_id of this BasicAw.

        工程ID

        :param project_id: The project_id of this BasicAw.
        :type project_id: str
        """
    ...
    def protocol_type(self):
        r"""Gets the protocol_type of this BasicAw.

        协议类型 (http/dsf/other)

        :return: The protocol_type of this BasicAw.
        :rtype: str
        """
    ...
    def protocol_type(self, protocol_type):
        r"""Sets the protocol_type of this BasicAw.

        协议类型 (http/dsf/other)

        :param protocol_type: The protocol_type of this BasicAw.
        :type protocol_type: str
        """
    ...
    def public_aw_lib(self):
        r"""Gets the public_aw_lib of this BasicAw.

        :return: The public_aw_lib of this BasicAw.
        :rtype: :class:`huaweicloudsdkcloudtest.v1.PublicAwLib`
        """
        return self._public_aw_lib

    @public_aw_lib.setter
    def public_aw_lib(self, public_aw_lib):
        r"""Sets the public_aw_lib of this BasicAw.

        :param public_aw_lib: The public_aw_lib of this BasicAw.
        :type public_aw_lib: :class:`huaweicloudsdkcloudtest.v1.PublicAwLib`
        """
    ...
    def public_aw_lib_id(self):
        r"""Gets the public_aw_lib_id of this BasicAw.

        所属公共aw库Id

        :return: The public_aw_lib_id of this BasicAw.
        :rtype: str
        """
    ...
    def public_aw_lib_id(self, public_aw_lib_id):
        r"""Sets the public_aw_lib_id of this BasicAw.

        所属公共aw库Id

        :param public_aw_lib_id: The public_aw_lib_id of this BasicAw.
        :type public_aw_lib_id: str
        """
    ...
    @property
    def region(self):
        r"""Gets the region of this BasicAw.

        区域名称

        :return: The region of this BasicAw.
        :rtype: str
        """
        return self._region
    ...
    def region(self, region):
        r"""Sets the region of this BasicAw.

        区域名称

        :param region: The region of this BasicAw.
        :type region: str
        """
        self._region = region
    ...
    def return_type(self):
        r"""Gets the return_type of this BasicAw.

        返回类型

        :return: The return_type of this BasicAw.
        :rtype: str
        """
    ...
    def return_type(self, return_type):
        r"""Sets the return_type of this BasicAw.

        返回类型

        :param return_type: The return_type of this BasicAw.
        :type return_type: str
        """
    ...
    @property
    def root_id(self):
        r"""Gets the root_id of this BasicAw.

        root id

        :return: The root_id of this BasicAw.
        :rtype: str
        """
    ...
    def root_id(self, root_id):
        r"""Sets the root_id of this BasicAw.

        root id

        :param root_id: The root_id of this BasicAw.
        :type root_id: str
        """
    ...
    @property
    def source(self):
        r"""Gets the source of this BasicAw.

        来源

        :return: The source of this BasicAw.
        :rtype: str
        """
        return self._source
    ...
    def source(self, source):
        r"""Sets the source of this BasicAw.

        来源

        :param source: The source of this BasicAw.
        :type source: str
        """
        self._source = source
    ...
    def special_type(self):
        r"""Gets the special_type of this BasicAw.

        测试步骤来源

        :return: The special_type of this BasicAw.
        :rtype: int
        """
    ...
    def special_type(self, special_type):
        r"""Sets the special_type of this BasicAw.

        测试步骤来源

        :param special_type: The special_type of this BasicAw.
        :type special_type: int
        """
    ...
    def tmss_case_number(self):
        r"""Gets the tmss_case_number of this BasicAw.

        关键字管理的用例编号

        :return: The tmss_case_number of this BasicAw.
        :rtype: str
        """
    ...
    def tmss_case_number(self, tmss_case_number):
        r"""Sets the tmss_case_number of this BasicAw.

        关键字管理的用例编号

        :param tmss_case_number: The tmss_case_number of this BasicAw.
        :type tmss_case_number: str
        """
    ...
    def tmss_case_id(self):
        r"""Gets the tmss_case_id of this BasicAw.

        关键字aw管理的用例ID

        :return: The tmss_case_id of this BasicAw.
        :rtype: str
        """
    ...
    def tmss_case_id(self, tmss_case_id):
        r"""Sets the tmss_case_id of this BasicAw.

        关键字aw管理的用例ID

        :param tmss_case_id: The tmss_case_id of this BasicAw.
        :type tmss_case_id: str
        """
    ...
    def update_time(self):
        r"""Gets the update_time of this BasicAw.

        更新时间

        :return: The update_time of this BasicAw.
        :rtype: datetime
        """
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this BasicAw.

        更新时间

        :param update_time: The update_time of this BasicAw.
        :type update_time: datetime
        """
    ...
    def update_time_stamp(self):
        r"""Gets the update_time_stamp of this BasicAw.

        更新时间戳

        :return: The update_time_stamp of this BasicAw.
        :rtype: int
        """
    ...
    def update_time_stamp(self, update_time_stamp):
        r"""Sets the update_time_stamp of this BasicAw.

        更新时间戳

        :param update_time_stamp: The update_time_stamp of this BasicAw.
        :type update_time_stamp: int
        """
    ...
    def update_time_string(self):
        r"""Gets the update_time_string of this BasicAw.

        更新时间字符串

        :return: The update_time_string of this BasicAw.
        :rtype: str
        """
    ...
    def update_time_string(self, update_time_string):
        r"""Sets the update_time_string of this BasicAw.

        更新时间字符串

        :param update_time_string: The update_time_string of this BasicAw.
        :type update_time_string: str
        """
    ...
    def update_user(self):
        r"""Gets the update_user of this BasicAw.

        更新人

        :return: The update_user of this BasicAw.
        :rtype: str
        """
    ...
    def update_user(self, update_user):
        r"""Sets the update_user of this BasicAw.

        更新人

        :param update_user: The update_user of this BasicAw.
        :type update_user: str
        """
    ...
    def warning_msg(self):
        r"""Gets the warning_msg of this BasicAw.

        警告信息

        :return: The warning_msg of this BasicAw.
        :rtype: str
        """
    ...
    def warning_msg(self, warning_msg):
        r"""Sets the warning_msg of this BasicAw.

        警告信息

        :param warning_msg: The warning_msg of this BasicAw.
        :type warning_msg: str
        """
    ...
    @property
    def yaml_name(self):
        r"""Gets the yaml_name of this BasicAw.

        所属yaml文件名称,该字段不存库，用来记录从哪个yaml文件导入

        :return: The yaml_name of this BasicAw.
        :rtype: str
        """
    ...
    def yaml_name(self, yaml_name):
        r"""Sets the yaml_name of this BasicAw.

        所属yaml文件名称,该字段不存库，用来记录从哪个yaml文件导入

        :param yaml_name: The yaml_name of this BasicAw.
        :type yaml_name: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BasicAw):
            return False
