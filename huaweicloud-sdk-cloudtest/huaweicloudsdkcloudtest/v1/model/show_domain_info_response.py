...
class ShowDomainInfoResponse(SdkResponse):
    ...
    @property
    def status(self):
        r"""Gets the status of this ShowDomainInfoResponse.
    ...
    def status(self, status):
        r"""Sets the status of this ShowDomainInfoResponse.
    ...
    @property
    def result(self):
        r"""Gets the result of this ShowDomainInfoResponse.
    ...
    def result(self, result):
        r"""Sets the result of this ShowDomainInfoResponse.
    ...
    @property
    def error(self):
        r"""Gets the error of this ShowDomainInfoResponse.
    ...
    def error(self, error):
        r"""Sets the error of this ShowDomainInfoResponse.
    ...
    @property
    def request_id(self):
        r"""Gets the request_id of this ShowDomainInfoResponse.
    ...
    def request_id(self, request_id):
        r"""Sets the request_id of this ShowDomainInfoResponse.
    ...
    def server_address(self):
        r"""Gets the server_address of this ShowDomainInfoResponse.
    ...
    def server_address(self, server_address):
        r"""Sets the server_address of this ShowDomainInfoResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowDomainInfoResponse.to_dict() is deprecated and no longer maintained, "
