...
class ListScattersUsingResponse(SdkResponse):
    ...
    @property
    def list(self):
        r"""Gets the list of this ListScattersUsingResponse.
    ...
    @list.setter
    def list(self, list):
        r"""Sets the list of this ListScattersUsingResponse.
    ...
    @property
    def page_num(self):
        r"""Gets the page_num of this ListScattersUsingResponse.
    ...
    def page_num(self, page_num):
        r"""Sets the page_num of this ListScattersUsingResponse.
    ...
    @property
    def page_size(self):
        r"""Gets the page_size of this ListScattersUsingResponse.
    ...
    def page_size(self, page_size):
        r"""Sets the page_size of this ListScattersUsingResponse.
    ...
    @property
    def total_page(self):
        r"""Gets the total_page of this ListScattersUsingResponse.
    ...
    def total_page(self, total_page):
        r"""Sets the total_page of this ListScattersUsingResponse.
    ...
    @property
    def total_size(self):
        r"""Gets the total_size of this ListScattersUsingResponse.
    ...
    def total_size(self, total_size):
        r"""Sets the total_size of this ListScattersUsingResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListScattersUsingResponse.to_dict() is deprecated and no longer maintained, "
