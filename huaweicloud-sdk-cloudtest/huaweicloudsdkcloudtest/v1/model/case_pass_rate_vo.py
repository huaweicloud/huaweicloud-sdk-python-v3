...
class CasePassRateVo:
    ...
    @property
    def pass_rate(self):
        r"""Gets the pass_rate of this CasePassRateVo.

        用例通过率

        :return: The pass_rate of this CasePassRateVo.
        :rtype: str
        """
    ...
    def pass_rate(self, pass_rate):
        r"""Sets the pass_rate of this CasePassRateVo.

        用例通过率

        :param pass_rate: The pass_rate of this CasePassRateVo.
        :type pass_rate: str
        """
    ...
    def result_number_list(self):
        r"""Gets the result_number_list of this CasePassRateVo.

        用户自定义结果对应的用例数目

        :return: The result_number_list of this CasePassRateVo.
    ...
    def result_number_list(self, result_number_list):
        r"""Sets the result_number_list of this CasePassRateVo.

        用户自定义结果对应的用例数目

        :param result_number_list: The result_number_list of this CasePassRateVo.
        :type result_number_list: list[:class:`huaweicloudsdkcloudtest.v1.NameAndValueVo`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CasePassRateVo):
            return False
