...
class ShowUserAccessInfoResponse(SdkResponse):
    ...
    def status(self):
        ...
        :return: The status of this ShowUserAccessInfoResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this ShowUserAccessInfoResponse.
        :type status: str
        """
        self._status = status
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowUserAccessInfoResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowUserAccessInfoResponse):
            return False
