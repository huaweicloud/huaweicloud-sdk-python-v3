...
class ShowMindmapBackupByPageResponse(SdkResponse):
    ...
    openapi_types = {
        'code': 'str',
        'data': 'BasePageInfoMindmapBackup',
        'message': 'str'
    }
    ...
    def code(self):
        ...
        :return: The code of this ShowMindmapBackupByPageResponse.
        :rtype: str
        """
        return self._code
    ...
    def code(self, code):
        ...
        :param code: The code of this ShowMindmapBackupByPageResponse.
        :type code: str
        """
        self._code = code
    ...
    def message(self):
        ...
        :return: The message of this ShowMindmapBackupByPageResponse.
        :rtype: str
        """
    ...
    def message(self, message):
        ...
        :param message: The message of this ShowMindmapBackupByPageResponse.
        :type message: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowMindmapBackupByPageResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowMindmapBackupByPageResponse):
            return False
