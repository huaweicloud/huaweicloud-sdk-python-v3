...
class PublicAwLibRes:
    ...
    def __init__(self, create_time=None, create_time_stamp=None, create_time_string=None, create_user=None, document_link=None, id=None, name=None, net_area=None, obs_temp_url=None, product_line=None, repo_branch=None, repo_lib_path=None, repo_password=None, repo_private_key=None, repo_url=None, repo_username=None, update_time=None, update_time_stamp=None, update_time_string=None, update_user=None):
        ...
        :param document_link: 关联公共aw时的编辑链接
    ...
    def create_time(self):
        r"""Gets the create_time of this PublicAwLibRes.

        创建时间

        :return: The create_time of this PublicAwLibRes.
        :rtype: str
        """
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this PublicAwLibRes.

        创建时间

        :param create_time: The create_time of this PublicAwLibRes.
        :type create_time: str
        """
    ...
    def create_time_stamp(self):
        r"""Gets the create_time_stamp of this PublicAwLibRes.

        创建时间戳

        :return: The create_time_stamp of this PublicAwLibRes.
        :rtype: int
        """
    ...
    def create_time_stamp(self, create_time_stamp):
        r"""Sets the create_time_stamp of this PublicAwLibRes.

        创建时间戳

        :param create_time_stamp: The create_time_stamp of this PublicAwLibRes.
        :type create_time_stamp: int
        """
    ...
    def create_time_string(self):
        r"""Gets the create_time_string of this PublicAwLibRes.

        创建时间字符串

        :return: The create_time_string of this PublicAwLibRes.
        :rtype: str
        """
    ...
    def create_time_string(self, create_time_string):
        r"""Sets the create_time_string of this PublicAwLibRes.

        创建时间字符串

        :param create_time_string: The create_time_string of this PublicAwLibRes.
        :type create_time_string: str
        """
    ...
    def create_user(self):
        r"""Gets the create_user of this PublicAwLibRes.

        创建人

        :return: The create_user of this PublicAwLibRes.
        :rtype: str
        """
    ...
    def create_user(self, create_user):
        r"""Sets the create_user of this PublicAwLibRes.

        创建人

        :param create_user: The create_user of this PublicAwLibRes.
        :type create_user: str
        """
    ...
    def document_link(self):
        r"""Gets the document_link of this PublicAwLibRes.

        关联公共aw时的编辑链接

        :return: The document_link of this PublicAwLibRes.
        :rtype: str
        """
    ...
    def document_link(self, document_link):
        r"""Sets the document_link of this PublicAwLibRes.

        关联公共aw时的编辑链接

        :param document_link: The document_link of this PublicAwLibRes.
        :type document_link: str
        """
    ...
    @property
    def id(self):
        r"""Gets the id of this PublicAwLibRes.

        id

        :return: The id of this PublicAwLibRes.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this PublicAwLibRes.

        id

        :param id: The id of this PublicAwLibRes.
        :type id: str
        """
        self._id = id
    ...
    @property
    def name(self):
        r"""Gets the name of this PublicAwLibRes.

        名称

        :return: The name of this PublicAwLibRes.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this PublicAwLibRes.

        名称

        :param name: The name of this PublicAwLibRes.
        :type name: str
        """
        self._name = name
    ...
    @property
    def net_area(self):
        r"""Gets the net_area of this PublicAwLibRes.

        蓝区:Blue,绿区:Green,黄区:Yellow

        :return: The net_area of this PublicAwLibRes.
        :rtype: list[str]
        """
    ...
    def net_area(self, net_area):
        r"""Sets the net_area of this PublicAwLibRes.

        蓝区:Blue,绿区:Green,黄区:Yellow

        :param net_area: The net_area of this PublicAwLibRes.
        :type net_area: list[str]
        """
    ...
    def obs_temp_url(self):
        r"""Gets the obs_temp_url of this PublicAwLibRes.

        obs临时url

        :return: The obs_temp_url of this PublicAwLibRes.
        :rtype: str
        """
    ...
    def obs_temp_url(self, obs_temp_url):
        r"""Sets the obs_temp_url of this PublicAwLibRes.

        obs临时url

        :param obs_temp_url: The obs_temp_url of this PublicAwLibRes.
        :type obs_temp_url: str
        """
    ...
    def product_line(self):
        r"""Gets the product_line of this PublicAwLibRes.

        产品线

        :return: The product_line of this PublicAwLibRes.
        :rtype: str
        """
    ...
    def product_line(self, product_line):
        r"""Sets the product_line of this PublicAwLibRes.

        产品线

        :param product_line: The product_line of this PublicAwLibRes.
        :type product_line: str
        """
    ...
    def repo_branch(self):
        r"""Gets the repo_branch of this PublicAwLibRes.

        仓库分支

        :return: The repo_branch of this PublicAwLibRes.
        :rtype: str
        """
    ...
    def repo_branch(self, repo_branch):
        r"""Sets the repo_branch of this PublicAwLibRes.

        仓库分支

        :param repo_branch: The repo_branch of this PublicAwLibRes.
        :type repo_branch: str
        """
    ...
    def repo_lib_path(self):
        r"""Gets the repo_lib_path of this PublicAwLibRes.

        存公共aw依赖jar包的目录

        :return: The repo_lib_path of this PublicAwLibRes.
        :rtype: str
        """
    ...
    def repo_lib_path(self, repo_lib_path):
        r"""Sets the repo_lib_path of this PublicAwLibRes.

        存公共aw依赖jar包的目录

        :param repo_lib_path: The repo_lib_path of this PublicAwLibRes.
        :type repo_lib_path: str
        """
    ...
    def repo_password(self):
        r"""Gets the repo_password of this PublicAwLibRes.

        仓库密码

        :return: The repo_password of this PublicAwLibRes.
        :rtype: str
        """
    ...
    def repo_password(self, repo_password):
        r"""Sets the repo_password of this PublicAwLibRes.

        仓库密码

        :param repo_password: The repo_password of this PublicAwLibRes.
        :type repo_password: str
        """
    ...
    def repo_private_key(self):
        r"""Gets the repo_private_key of this PublicAwLibRes.

        仓库秘钥

        :return: The repo_private_key of this PublicAwLibRes.
        :rtype: str
        """
    ...
    def repo_private_key(self, repo_private_key):
        r"""Sets the repo_private_key of this PublicAwLibRes.

        仓库秘钥

        :param repo_private_key: The repo_private_key of this PublicAwLibRes.
        :type repo_private_key: str
        """
    ...
    @property
    def repo_url(self):
        r"""Gets the repo_url of this PublicAwLibRes.

        仓库地址

        :return: The repo_url of this PublicAwLibRes.
        :rtype: str
        """
    ...
    def repo_url(self, repo_url):
        r"""Sets the repo_url of this PublicAwLibRes.

        仓库地址

        :param repo_url: The repo_url of this PublicAwLibRes.
        :type repo_url: str
        """
    ...
    def repo_username(self):
        r"""Gets the repo_username of this PublicAwLibRes.

        仓库用户名

        :return: The repo_username of this PublicAwLibRes.
        :rtype: str
        """
    ...
    def repo_username(self, repo_username):
        r"""Sets the repo_username of this PublicAwLibRes.

        仓库用户名

        :param repo_username: The repo_username of this PublicAwLibRes.
        :type repo_username: str
        """
    ...
    def update_time(self):
        r"""Gets the update_time of this PublicAwLibRes.

        更新时间

        :return: The update_time of this PublicAwLibRes.
        :rtype: str
        """
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this PublicAwLibRes.

        更新时间

        :param update_time: The update_time of this PublicAwLibRes.
        :type update_time: str
        """
    ...
    def update_time_stamp(self):
        r"""Gets the update_time_stamp of this PublicAwLibRes.

        更新时间戳

        :return: The update_time_stamp of this PublicAwLibRes.
        :rtype: int
        """
    ...
    def update_time_stamp(self, update_time_stamp):
        r"""Sets the update_time_stamp of this PublicAwLibRes.

        更新时间戳

        :param update_time_stamp: The update_time_stamp of this PublicAwLibRes.
        :type update_time_stamp: int
        """
    ...
    def update_time_string(self):
        r"""Gets the update_time_string of this PublicAwLibRes.

        更新时间字符串

        :return: The update_time_string of this PublicAwLibRes.
        :rtype: str
        """
    ...
    def update_time_string(self, update_time_string):
        r"""Sets the update_time_string of this PublicAwLibRes.

        更新时间字符串

        :param update_time_string: The update_time_string of this PublicAwLibRes.
        :type update_time_string: str
        """
    ...
    def update_user(self):
        r"""Gets the update_user of this PublicAwLibRes.

        更新人

        :return: The update_user of this PublicAwLibRes.
        :rtype: str
        """
    ...
    def update_user(self, update_user):
        r"""Sets the update_user of this PublicAwLibRes.

        更新人

        :param update_user: The update_user of this PublicAwLibRes.
        :type update_user: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PublicAwLibRes):
            return False
