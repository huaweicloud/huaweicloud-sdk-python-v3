...
class ShowPlansResponseExecuteStage:
    ...
    def __init__(self, defect_count=None, completed_defect_count=None, case_pass_rate=None, executed_case_count=None):
        """ShowPlansResponseExecuteStage - a model defined in huaweicloud sdk"""
    ...
    def defect_count(self):
        """Gets the defect_count of this ShowPlansResponseExecuteStage.

        缺陷个数

        :return: The defect_count of this ShowPlansResponseExecuteStage.
        :rtype: int
        """
    ...
    def defect_count(self, defect_count):
        """Sets the defect_count of this ShowPlansResponseExecuteStage.

        缺陷个数

        :param defect_count: The defect_count of this ShowPlansResponseExecuteStage.
        :type: int
        """
    ...
    def completed_defect_count(self):
        """Gets the completed_defect_count of this ShowPlansResponseExecuteStage.

        已完成缺陷个数

        :return: The completed_defect_count of this ShowPlansResponseExecuteStage.
        :rtype: int
        """
    ...
    def completed_defect_count(self, completed_defect_count):
        """Sets the completed_defect_count of this ShowPlansResponseExecuteStage.

        已完成缺陷个数

        :param completed_defect_count: The completed_defect_count of this ShowPlansResponseExecuteStage.
        :type: int
        """
    ...
    def case_pass_rate(self):
        """Gets the case_pass_rate of this ShowPlansResponseExecuteStage.

        用例通过率,按用例结果计算

        :return: The case_pass_rate of this ShowPlansResponseExecuteStage.
        :rtype: str
        """
    ...
    def case_pass_rate(self, case_pass_rate):
        """Sets the case_pass_rate of this ShowPlansResponseExecuteStage.

        用例通过率,按用例结果计算

        :param case_pass_rate: The case_pass_rate of this ShowPlansResponseExecuteStage.
        :type: str
        """
    ...
    def executed_case_count(self):
        """Gets the executed_case_count of this ShowPlansResponseExecuteStage.

        已执行用例数, 按用例状态统计

        :return: The executed_case_count of this ShowPlansResponseExecuteStage.
        :rtype: int
        """
    ...
    def executed_case_count(self, executed_case_count):
        """Sets the executed_case_count of this ShowPlansResponseExecuteStage.

        已执行用例数, 按用例状态统计

        :param executed_case_count: The executed_case_count of this ShowPlansResponseExecuteStage.
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowPlansResponseExecuteStage):
            return False
