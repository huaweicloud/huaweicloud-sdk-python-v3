...
class UpdateTestCaseCommentResponse(SdkResponse):
    ...
    def __init__(self, status=None, result=None, error=None, request_id=None, server_address=None):
        r"""UpdateTestCaseCommentResponse
    ...
    @property
    def status(self):
        r"""Gets the status of this UpdateTestCaseCommentResponse.
    ...
    def status(self, status):
        r"""Sets the status of this UpdateTestCaseCommentResponse.
    ...
    @property
    def result(self):
        r"""Gets the result of this UpdateTestCaseCommentResponse.
    ...
    def result(self, result):
        r"""Sets the result of this UpdateTestCaseCommentResponse.
    ...
    @property
    def error(self):
        r"""Gets the error of this UpdateTestCaseCommentResponse.
    ...
    def error(self, error):
        r"""Sets the error of this UpdateTestCaseCommentResponse.
    ...
    @property
    def request_id(self):
        r"""Gets the request_id of this UpdateTestCaseCommentResponse.
    ...
    def request_id(self, request_id):
        r"""Sets the request_id of this UpdateTestCaseCommentResponse.
    ...
    def server_address(self):
        r"""Gets the server_address of this UpdateTestCaseCommentResponse.
    ...
    def server_address(self, server_address):
        r"""Sets the server_address of this UpdateTestCaseCommentResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateTestCaseCommentResponse.to_dict() is deprecated and no longer maintained, "
