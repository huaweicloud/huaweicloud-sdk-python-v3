...
class ListAllBranchesResponse(SdkResponse):
    ...
    def status(self):
        ...
        :return: The status of this ListAllBranchesResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this ListAllBranchesResponse.
        :type status: str
        """
        self._status = status
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAllBranchesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAllBranchesResponse):
            return False
