...
class RunTestCaseResponse(SdkResponse):
    ...
    @property
    def error_code(self):
        r"""Gets the error_code of this RunTestCaseResponse.

        接口调用失败错误码

        :return: The error_code of this RunTestCaseResponse.
        :rtype: str
        """
    ...
    def error_code(self, error_code):
        r"""Sets the error_code of this RunTestCaseResponse.
    ...
    @property
    def error_msg(self):
        r"""Gets the error_msg of this RunTestCaseResponse.

        接口调用失败错误信息

        :return: The error_msg of this RunTestCaseResponse.
        :rtype: str
        """
    ...
    def error_msg(self, error_msg):
        r"""Sets the error_msg of this RunTestCaseResponse.
    ...
    def error_detail(self):
        r"""Gets the error_detail of this RunTestCaseResponse.
    ...
    def error_detail(self, error_detail):
        r"""Sets the error_detail of this RunTestCaseResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("RunTestCaseResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunTestCaseResponse):
            return False
