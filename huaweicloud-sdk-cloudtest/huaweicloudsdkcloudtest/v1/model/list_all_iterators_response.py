...
class ListAllIteratorsResponse(SdkResponse):
    ...
    @property
    def status(self):
        r"""Gets the status of this ListAllIteratorsResponse.
    ...
    def status(self, status):
        r"""Sets the status of this ListAllIteratorsResponse.
    ...
    @property
    def result(self):
        r"""Gets the result of this ListAllIteratorsResponse.
    ...
    def result(self, result):
        r"""Sets the result of this ListAllIteratorsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAllIteratorsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAllIteratorsResponse):
            return False
