...
class ShowTestCasesChangeStatisticsResponse(SdkResponse):
    ...
    def __init__(self, status=None, result=None, error=None, request_id=None, server_address=None):
        r"""ShowTestCasesChangeStatisticsResponse
    ...
    @property
    def status(self):
        r"""Gets the status of this ShowTestCasesChangeStatisticsResponse.
    ...
    def status(self, status):
        r"""Sets the status of this ShowTestCasesChangeStatisticsResponse.
    ...
    @property
    def result(self):
        r"""Gets the result of this ShowTestCasesChangeStatisticsResponse.
    ...
    def result(self, result):
        r"""Sets the result of this ShowTestCasesChangeStatisticsResponse.
    ...
    @property
    def error(self):
        r"""Gets the error of this ShowTestCasesChangeStatisticsResponse.
    ...
    def error(self, error):
        r"""Sets the error of this ShowTestCasesChangeStatisticsResponse.
    ...
    @property
    def request_id(self):
        r"""Gets the request_id of this ShowTestCasesChangeStatisticsResponse.
    ...
    def request_id(self, request_id):
        r"""Sets the request_id of this ShowTestCasesChangeStatisticsResponse.
    ...
    def server_address(self):
        r"""Gets the server_address of this ShowTestCasesChangeStatisticsResponse.
    ...
    def server_address(self, server_address):
        r"""Sets the server_address of this ShowTestCasesChangeStatisticsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowTestCasesChangeStatisticsResponse.to_dict() is deprecated and no longer maintained, "
