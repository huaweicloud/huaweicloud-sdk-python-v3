...
class ListCasesStatusResponse(SdkResponse):
    ...
    openapi_types = {
        'error': 'CommonResponseErrorOfobject',
        'result': 'QueryCasesStatusResponseV2',
        'status': 'str'
    }
    ...
    def status(self):
        ...
        :return: The status of this ListCasesStatusResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this ListCasesStatusResponse.
        :type status: str
        """
        self._status = status
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListCasesStatusResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListCasesStatusResponse):
            return False
