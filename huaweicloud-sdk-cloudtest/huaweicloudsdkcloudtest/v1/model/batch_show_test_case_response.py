...
class BatchShowTestCaseResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchShowTestCaseResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchShowTestCaseResponse):
            return False
