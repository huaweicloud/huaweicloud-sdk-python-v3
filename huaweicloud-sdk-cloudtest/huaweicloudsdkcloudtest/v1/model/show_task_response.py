...
class ShowTaskResponse(SdkResponse):
    ...
    def __init__(self, status=None, result=None, error=None, request_id=None, server_address=None):
        ...
        :type status: str
        :param result: 
        :type result: :class:`huaweicloudsdkcloudtest.v1.ResultValueTaskVo`
        :param error: 
    ...
    @property
    def result(self):
        r"""Gets the result of this ShowTaskResponse.

        :return: The result of this ShowTaskResponse.
        :rtype: :class:`huaweicloudsdkcloudtest.v1.ResultValueTaskVo`
        """
        return self._result

    @result.setter
    def result(self, result):
        r"""Sets the result of this ShowTaskResponse.

        :param result: The result of this ShowTaskResponse.
        :type result: :class:`huaweicloudsdkcloudtest.v1.ResultValueTaskVo`
        """
        self._result = result
    ...
    def server_address(self):
        r"""Gets the server_address of this ShowTaskResponse.

        对内接口才有此属性

        :return: The server_address of this ShowTaskResponse.
        :rtype: str
        """
    ...
    def server_address(self, server_address):
        r"""Sets the server_address of this ShowTaskResponse.

        对内接口才有此属性

        :param server_address: The server_address of this ShowTaskResponse.
        :type server_address: str
        """
