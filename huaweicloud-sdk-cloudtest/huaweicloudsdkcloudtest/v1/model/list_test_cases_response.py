...
class ListTestCasesResponse(SdkResponse):
    ...
    @property
    def values(self):
        r"""Gets the values of this ListTestCasesResponse.
    ...
    def values(self, values):
        r"""Sets the values of this ListTestCasesResponse.
    ...
    @property
    def total(self):
        r"""Gets the total of this ListTestCasesResponse.
    ...
    def total(self, total):
        r"""Sets the total of this ListTestCasesResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListTestCasesResponse.to_dict() is deprecated and no longer maintained, "
