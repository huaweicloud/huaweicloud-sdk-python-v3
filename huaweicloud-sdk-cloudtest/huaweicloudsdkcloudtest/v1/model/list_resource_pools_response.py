...
class ListResourcePoolsResponse(SdkResponse):
    ...
    openapi_types = {
        'status': 'str',
        'result': 'ResultValueListResourcePoolVo',
        'error': 'ApiError',
        'request_id': 'str'
    }
    ...
    def __init__(self, status=None, result=None, error=None, request_id=None):
        ...
        super(ListResourcePoolsResponse, self).__init__()
    ...
    def status(self):
        ...
        :return: The status of this ListResourcePoolsResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this ListResourcePoolsResponse.
        :type status: str
        """
        self._status = status
    ...
    def request_id(self):
        ...
        :return: The request_id of this ListResourcePoolsResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        ...
        :param request_id: The request_id of this ListResourcePoolsResponse.
        :type request_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListResourcePoolsResponse):
            return False
