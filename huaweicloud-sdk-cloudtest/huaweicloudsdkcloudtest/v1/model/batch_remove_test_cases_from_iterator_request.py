...
class BatchRemoveTestCasesFromIteratorRequest:
    ...
    def __init__(self, iterator_id=None, body=None):
        ...
        :param body: Body of the BatchRemoveTestCasesFromIteratorRequest
    ...
    def iterator_id(self):
        ...
        :return: The iterator_id of this BatchRemoveTestCasesFromIteratorRequest.
        :rtype: str
        """
    ...
    def iterator_id(self, iterator_id):
        ...
        :param iterator_id: The iterator_id of this BatchRemoveTestCasesFromIteratorRequest.
        :type iterator_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchRemoveTestCasesFromIteratorRequest):
            return False
