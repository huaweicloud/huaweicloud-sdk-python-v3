...
class ShowPlanJournalsResponse(SdkResponse):
    ...
    openapi_types = {
        'body': 'list[ShowPlanJournalsResponseBody]'
    }
    ...
    def body(self):
        ...
        :rtype: list[ShowPlanJournalsResponseBody]
        """
        return self._body
    ...
    def body(self, body):
        ...
        :type: list[ShowPlanJournalsResponseBody]
        """
        self._body = body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowPlanJournalsResponse):
            return False
