...
class UpdateTestCaseAndScriptResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateTestCaseAndScriptResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateTestCaseAndScriptResponse):
            return False
