...
class ShowMindmapRecycleByPageResponse(SdkResponse):
    ...
    openapi_types = {
        'code': 'str',
        'data': 'BasePageInfoMindmapRecycle',
        'message': 'str'
    }
    ...
    def code(self):
        ...
        :return: The code of this ShowMindmapRecycleByPageResponse.
        :rtype: str
        """
        return self._code
    ...
    def code(self, code):
        ...
        :param code: The code of this ShowMindmapRecycleByPageResponse.
        :type code: str
        """
        self._code = code
    ...
    def message(self):
        ...
        :return: The message of this ShowMindmapRecycleByPageResponse.
        :rtype: str
        """
    ...
    def message(self, message):
        ...
        :param message: The message of this ShowMindmapRecycleByPageResponse.
        :type message: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowMindmapRecycleByPageResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowMindmapRecycleByPageResponse):
            return False
