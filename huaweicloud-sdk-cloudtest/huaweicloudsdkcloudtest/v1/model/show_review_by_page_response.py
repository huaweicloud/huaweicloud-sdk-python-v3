...
class ShowReviewByPageResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowReviewByPageResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowReviewByPageResponse):
            return False
