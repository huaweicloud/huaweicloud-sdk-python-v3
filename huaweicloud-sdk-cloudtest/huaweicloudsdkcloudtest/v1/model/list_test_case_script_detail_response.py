...
class ListTestCaseScriptDetailResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListTestCaseScriptDetailResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListTestCaseScriptDetailResponse):
            return False
