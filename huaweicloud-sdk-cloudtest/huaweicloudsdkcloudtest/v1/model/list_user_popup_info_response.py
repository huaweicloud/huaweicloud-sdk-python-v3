...
class ListUserPopupInfoResponse(SdkResponse):
    ...
    def status(self):
        ...
        :return: The status of this ListUserPopupInfoResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this ListUserPopupInfoResponse.
        :type status: str
        """
        self._status = status
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListUserPopupInfoResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListUserPopupInfoResponse):
            return False
