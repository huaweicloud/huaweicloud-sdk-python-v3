...
class CreateUserDefinedUrlKeyWordResponse(SdkResponse):
    ...
    openapi_types = {
        'code': 'str',
        'error': 'CommonResponseErrorObject',
        'reason': 'str',
        'result': 'object',
        'status': 'str'
    }
    ...
    def __init__(self, code=None, error=None, reason=None, result=None, status=None):
        ...
        super(CreateUserDefinedUrlKeyWordResponse, self).__init__()
    ...
    def code(self):
        ...
        :return: The code of this CreateUserDefinedUrlKeyWordResponse.
        :rtype: str
        """
        return self._code
    ...
    def code(self, code):
        ...
        :param code: The code of this CreateUserDefinedUrlKeyWordResponse.
        :type code: str
        """
        self._code = code
    ...
    def reason(self):
        ...
        :return: The reason of this CreateUserDefinedUrlKeyWordResponse.
        :rtype: str
        """
        return self._reason
    ...
    def reason(self, reason):
        ...
        :param reason: The reason of this CreateUserDefinedUrlKeyWordResponse.
        :type reason: str
        """
        self._reason = reason
    ...
    def result(self):
        ...
        :return: The result of this CreateUserDefinedUrlKeyWordResponse.
        :rtype: object
        """
        return self._result
    ...
    def result(self, result):
        ...
        :param result: The result of this CreateUserDefinedUrlKeyWordResponse.
        :type result: object
        """
        self._result = result
    ...
    def status(self):
        ...
        :return: The status of this CreateUserDefinedUrlKeyWordResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this CreateUserDefinedUrlKeyWordResponse.
        :type status: str
        """
        self._status = status
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateUserDefinedUrlKeyWordResponse):
            return False
