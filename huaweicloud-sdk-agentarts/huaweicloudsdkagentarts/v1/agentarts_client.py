...
class AgentArtsClient(Client):
    ...
    def update_ops_dataset_tags(self, request):
        r"""更新评测集标签
    ...
    def update_ops_dataset_tags_invoker(self, request):
        http_info = self._update_ops_dataset_tags_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_ops_dataset_tags_http_info(cls, request):
        http_info = {
            "method": "PUT",
    ...
    def update_ops_evaluator_tags(self, request):
        r"""更新评估器标签
    ...
    def update_ops_evaluator_tags_invoker(self, request):
        http_info = self._update_ops_evaluator_tags_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_ops_evaluator_tags_http_info(cls, request):
        http_info = {
            "method": "PUT",
    ...
    def update_ops_evaluation_task_tags(self, request):
        r"""更新评估任务标签
    ...
    def update_ops_evaluation_task_tags_invoker(self, request):
        http_info = self._update_ops_evaluation_task_tags_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_ops_evaluation_task_tags_http_info(cls, request):
        http_info = {
            "method": "PUT",
