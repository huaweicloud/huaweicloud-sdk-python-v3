...
class UpdateOpsDatasetTagsRequest:
    ...
    @property
    def body(self):
        r"""Gets the body of this UpdateOpsDatasetTagsRequest.

        :return: The body of this UpdateOpsDatasetTagsRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this UpdateOpsDatasetTagsRequest.

        :param body: The body of this UpdateOpsDatasetTagsRequest.
        :type body: :class:`huaweicloudsdkagentarts.v1.UpdateOpsResourceTagsRequestBody`
        """
        self._body = body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateOpsDatasetTagsRequest):
            return False
