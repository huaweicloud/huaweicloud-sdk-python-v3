...
class CoreRunClaimMatchValue:
    ...
    def __init__(self, match_value_string=None, match_value_string_list=None):
        r"""CoreRunClaimMatchValue

        The model defined in huaweicloud sdk

        :param match_value_string: **参数解释**：  入站认证需要校验的自定义Claim字段所要匹配的字符串值。 **约束限制**: 不涉及。 **取值范围**： 长度为 1 - 255 个字符，只包含字母数字、下划线、点号和中划线。 **默认取值**: 不涉及。
        :type match_value_string: str
        :param match_value_string_list: **参数解释**：  入站认证需要校验的自定义Claim字段所要匹配的字符串值列表。 **约束限制**: 不涉及。 **取值范围**： 最小数量 1，最大数量 50，每个值的长度为 1 - 255 个字符。 **默认取值**: 不涉及。
    ...
    def match_value_string(self):
        r"""Gets the match_value_string of this CoreRunClaimMatchValue.

        **参数解释**：  入站认证需要校验的自定义Claim字段所要匹配的字符串值。 **约束限制**: 不涉及。 **取值范围**： 长度为 1 - 255 个字符，只包含字母数字、下划线、点号和中划线。 **默认取值**: 不涉及。

        :return: The match_value_string of this CoreRunClaimMatchValue.
        :rtype: str
        """
    ...
    def match_value_string(self, match_value_string):
        r"""Sets the match_value_string of this CoreRunClaimMatchValue.

        **参数解释**：  入站认证需要校验的自定义Claim字段所要匹配的字符串值。 **约束限制**: 不涉及。 **取值范围**： 长度为 1 - 255 个字符，只包含字母数字、下划线、点号和中划线。 **默认取值**: 不涉及。

        :param match_value_string: The match_value_string of this CoreRunClaimMatchValue.
        :type match_value_string: str
        """
    ...
    def match_value_string_list(self):
        r"""Gets the match_value_string_list of this CoreRunClaimMatchValue.

        **参数解释**：  入站认证需要校验的自定义Claim字段所要匹配的字符串值列表。 **约束限制**: 不涉及。 **取值范围**： 最小数量 1，最大数量 50，每个值的长度为 1 - 255 个字符。 **默认取值**: 不涉及。

        :return: The match_value_string_list of this CoreRunClaimMatchValue.
        :rtype: list[str]
        """
    ...
    def match_value_string_list(self, match_value_string_list):
        r"""Sets the match_value_string_list of this CoreRunClaimMatchValue.

        **参数解释**：  入站认证需要校验的自定义Claim字段所要匹配的字符串值列表。 **约束限制**: 不涉及。 **取值范围**： 最小数量 1，最大数量 50，每个值的长度为 1 - 255 个字符。 **默认取值**: 不涉及。

        :param match_value_string_list: The match_value_string_list of this CoreRunClaimMatchValue.
        :type match_value_string_list: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CoreRunClaimMatchValue):
            return False
