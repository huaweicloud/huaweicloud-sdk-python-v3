...
class OpsAgentTuningTask:
    ...
    @property
    def id(self):
        r"""Gets the id of this OpsAgentTuningTask.

        **参数解释：** 智能体优化任务ID。  **取值范围：** UUID格式字符串。

        :return: The id of this OpsAgentTuningTask.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this OpsAgentTuningTask.

        **参数解释：** 智能体优化任务ID。  **取值范围：** UUID格式字符串。

        :param id: The id of this OpsAgentTuningTask.
        :type id: str
        """
        self._id = id
    ...
    @property
    def name(self):
        r"""Gets the name of this OpsAgentTuningTask.

        **参数解释：** 任务名称。  **取值范围：** 长度1-64个字符的字符串。

        :return: The name of this OpsAgentTuningTask.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this OpsAgentTuningTask.

        **参数解释：** 任务名称。  **取值范围：** 长度1-64个字符的字符串。

        :param name: The name of this OpsAgentTuningTask.
        :type name: str
        """
        self._name = name
    ...
    def description(self):
        r"""Gets the description of this OpsAgentTuningTask.

        **参数解释：** 任务描述。  **取值范围：** 长度0-255个字符的字符串。

        :return: The description of this OpsAgentTuningTask.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this OpsAgentTuningTask.

        **参数解释：** 任务描述。  **取值范围：** 长度0-255个字符的字符串。

        :param description: The description of this OpsAgentTuningTask.
        :type description: str
        """
    ...
    @property
    def type(self):
        r"""Gets the type of this OpsAgentTuningTask.

        **参数解释：**  任务类型，用于根据类型筛选任务。  **取值范围：**  tool：工具，skill：技能。

        :return: The type of this OpsAgentTuningTask.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        r"""Sets the type of this OpsAgentTuningTask.

        **参数解释：**  任务类型，用于根据类型筛选任务。  **取值范围：**  tool：工具，skill：技能。

        :param type: The type of this OpsAgentTuningTask.
        :type type: str
        """
        self._type = type
    ...
    @property
    def agent(self):
        r"""Gets the agent of this OpsAgentTuningTask.

        :return: The agent of this OpsAgentTuningTask.
    ...
    def agent(self, agent):
        r"""Sets the agent of this OpsAgentTuningTask.

        :param agent: The agent of this OpsAgentTuningTask.
        :type agent: :class:`huaweicloudsdkagentarts.v1.OpsAgentTuningTaskAgent`
        """
        self._agent = agent
    ...
    def agency_name(self):
        r"""Gets the agency_name of this OpsAgentTuningTask.

        **参数解释：** 委托名称，赋予服务访问用户资源的权限。  **取值范围：** 有效的IAM委托名称字符串。

        :return: The agency_name of this OpsAgentTuningTask.
        :rtype: str
        """
    ...
    def agency_name(self, agency_name):
        r"""Sets the agency_name of this OpsAgentTuningTask.

        **参数解释：** 委托名称，赋予服务访问用户资源的权限。  **取值范围：** 有效的IAM委托名称字符串。

        :param agency_name: The agency_name of this OpsAgentTuningTask.
        :type agency_name: str
        """
    ...
    def analysis_task_id(self):
        r"""Gets the analysis_task_id of this OpsAgentTuningTask.

        **参数解释：** 分析任务ID，通过分析任务一键优化创建出来的智能体优化任务该字段不为空。  **取值范围：** 有效分析任务ID。

        :return: The analysis_task_id of this OpsAgentTuningTask.
        :rtype: str
        """
    ...
    def analysis_task_id(self, analysis_task_id):
        r"""Sets the analysis_task_id of this OpsAgentTuningTask.

        **参数解释：** 分析任务ID，通过分析任务一键优化创建出来的智能体优化任务该字段不为空。  **取值范围：** 有效分析任务ID。

        :param analysis_task_id: The analysis_task_id of this OpsAgentTuningTask.
        :type analysis_task_id: str
        """
    ...
    @property
    def status(self):
        r"""Gets the status of this OpsAgentTuningTask.

        **参数解释：** 任务状态。  **取值范围：** draft：草稿态，running：运行中，stopping：停止中，stopped：已停止，success：成功，fail：失败。

        :return: The status of this OpsAgentTuningTask.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        r"""Sets the status of this OpsAgentTuningTask.

        **参数解释：** 任务状态。  **取值范围：** draft：草稿态，running：运行中，stopping：停止中，stopped：已停止，success：成功，fail：失败。

        :param status: The status of this OpsAgentTuningTask.
        :type status: str
        """
        self._status = status
    ...
    def fail_reason(self):
        r"""Gets the fail_reason of this OpsAgentTuningTask.

        **参数解释：** 失败的错误信息。  **取值范围：** 无。

        :return: The fail_reason of this OpsAgentTuningTask.
        :rtype: str
        """
    ...
    def fail_reason(self, fail_reason):
        r"""Sets the fail_reason of this OpsAgentTuningTask.

        **参数解释：** 失败的错误信息。  **取值范围：** 无。

        :param fail_reason: The fail_reason of this OpsAgentTuningTask.
        :type fail_reason: str
        """
    ...
    @property
    def created_at(self):
        r"""Gets the created_at of this OpsAgentTuningTask.

        **参数解释：** 创建时间，单位：毫秒（13位时间戳）。  **取值范围：** 13位毫秒级时间戳。

        :return: The created_at of this OpsAgentTuningTask.
        :rtype: int
        """
    ...
    def created_at(self, created_at):
        r"""Sets the created_at of this OpsAgentTuningTask.

        **参数解释：** 创建时间，单位：毫秒（13位时间戳）。  **取值范围：** 13位毫秒级时间戳。

        :param created_at: The created_at of this OpsAgentTuningTask.
        :type created_at: int
        """
    ...
    @property
    def updated_at(self):
        r"""Gets the updated_at of this OpsAgentTuningTask.

        **参数解释：** 更新时间（单位：毫秒）  **取值范围：** 13位毫秒级时间戳。

        :return: The updated_at of this OpsAgentTuningTask.
        :rtype: int
        """
    ...
    def updated_at(self, updated_at):
        r"""Sets the updated_at of this OpsAgentTuningTask.

        **参数解释：** 更新时间（单位：毫秒）  **取值范围：** 13位毫秒级时间戳。

        :param updated_at: The updated_at of this OpsAgentTuningTask.
        :type updated_at: int
        """
    ...
    def executed_time(self):
        r"""Gets the executed_time of this OpsAgentTuningTask.

        **参数解释：** 运行时长，单位：分钟。  **取值范围：** 大于等于0的整数（单位：分钟）

        :return: The executed_time of this OpsAgentTuningTask.
        :rtype: int
        """
    ...
    def executed_time(self, executed_time):
        r"""Sets the executed_time of this OpsAgentTuningTask.

        **参数解释：** 运行时长，单位：分钟。  **取值范围：** 大于等于0的整数（单位：分钟）

        :param executed_time: The executed_time of this OpsAgentTuningTask.
        :type executed_time: int
        """
    ...
    @property
    def tags(self):
        r"""Gets the tags of this OpsAgentTuningTask.

        **参数解释：** 资源标签列表。  **取值范围：** 符合OpsTasksTagForTMS定义的对象数组。

        :return: The tags of this OpsAgentTuningTask.
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this OpsAgentTuningTask.

        **参数解释：** 资源标签列表。  **取值范围：** 符合OpsTasksTagForTMS定义的对象数组。

        :param tags: The tags of this OpsAgentTuningTask.
        :type tags: list[:class:`huaweicloudsdkagentarts.v1.OpsTasksTagForTMS`]
        """
        self._tags = tags
    ...
    def tuning_target(self):
        r"""Gets the tuning_target of this OpsAgentTuningTask.

        :return: The tuning_target of this OpsAgentTuningTask.
    ...
    def tuning_target(self, tuning_target):
        r"""Sets the tuning_target of this OpsAgentTuningTask.

        :param tuning_target: The tuning_target of this OpsAgentTuningTask.
        :type tuning_target: :class:`huaweicloudsdkagentarts.v1.OpsTuningTarget`
        """
    ...
    def tuning_output(self):
        r"""Gets the tuning_output of this OpsAgentTuningTask.

        :return: The tuning_output of this OpsAgentTuningTask.
    ...
    def tuning_output(self, tuning_output):
        r"""Sets the tuning_output of this OpsAgentTuningTask.

        :param tuning_output: The tuning_output of this OpsAgentTuningTask.
        :type tuning_output: :class:`huaweicloudsdkagentarts.v1.OpsTuningOutput`
        """
    ...
    def sample_duration(self):
        r"""Gets the sample_duration of this OpsAgentTuningTask.

        :return: The sample_duration of this OpsAgentTuningTask.
    ...
    def sample_duration(self, sample_duration):
        r"""Sets the sample_duration of this OpsAgentTuningTask.

        :param sample_duration: The sample_duration of this OpsAgentTuningTask.
        :type sample_duration: :class:`huaweicloudsdkagentarts.v1.OpsSampleDuration`
        """
    ...
    def sample_strategy(self):
        r"""Gets the sample_strategy of this OpsAgentTuningTask.

        :return: The sample_strategy of this OpsAgentTuningTask.
    ...
    def sample_strategy(self, sample_strategy):
        r"""Sets the sample_strategy of this OpsAgentTuningTask.

        :param sample_strategy: The sample_strategy of this OpsAgentTuningTask.
        :type sample_strategy: :class:`huaweicloudsdkagentarts.v1.OpsSampleStrategy`
        """
    ...
    def input_tokens(self):
        r"""Gets the input_tokens of this OpsAgentTuningTask.

        **参数解释：** 输入的 Token 数。  **取值范围：** 无。

        :return: The input_tokens of this OpsAgentTuningTask.
        :rtype: int
        """
    ...
    def input_tokens(self, input_tokens):
        r"""Sets the input_tokens of this OpsAgentTuningTask.

        **参数解释：** 输入的 Token 数。  **取值范围：** 无。

        :param input_tokens: The input_tokens of this OpsAgentTuningTask.
        :type input_tokens: int
        """
    ...
    def output_tokens(self):
        r"""Gets the output_tokens of this OpsAgentTuningTask.

        **参数解释：** 模型输出的 Token 数。  **取值范围：** 无。

        :return: The output_tokens of this OpsAgentTuningTask.
        :rtype: int
        """
    ...
    def output_tokens(self, output_tokens):
        r"""Sets the output_tokens of this OpsAgentTuningTask.

        **参数解释：** 模型输出的 Token 数。  **取值范围：** 无。

        :param output_tokens: The output_tokens of this OpsAgentTuningTask.
        :type output_tokens: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OpsAgentTuningTask):
            return False
