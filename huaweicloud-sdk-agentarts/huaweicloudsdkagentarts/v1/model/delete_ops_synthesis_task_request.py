...
class DeleteOpsSynthesisTaskRequest:
    ...
    def __init__(self, synthesis_id=None):
        r"""DeleteOpsSynthesisTaskRequest
    ...
    def synthesis_id(self):
        r"""Gets the synthesis_id of this DeleteOpsSynthesisTaskRequest.

        **参数解释：** 合成任务的唯一标识符（ID），该参数用于在路径中指定特定的合成任务，以便执行查询、停止或删除等操作。 **约束限制：** 字符串长度限制为1到64个字符。通常采用标准 UUID格式。 **取值范围：** 1-64位字符。 **默认取值：** 不涉及。 

        :return: The synthesis_id of this DeleteOpsSynthesisTaskRequest.
        :rtype: str
        """
    ...
    def synthesis_id(self, synthesis_id):
        r"""Sets the synthesis_id of this DeleteOpsSynthesisTaskRequest.

        **参数解释：** 合成任务的唯一标识符（ID），该参数用于在路径中指定特定的合成任务，以便执行查询、停止或删除等操作。 **约束限制：** 字符串长度限制为1到64个字符。通常采用标准 UUID格式。 **取值范围：** 1-64位字符。 **默认取值：** 不涉及。 

        :param synthesis_id: The synthesis_id of this DeleteOpsSynthesisTaskRequest.
        :type synthesis_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteOpsSynthesisTaskRequest):
            return False
