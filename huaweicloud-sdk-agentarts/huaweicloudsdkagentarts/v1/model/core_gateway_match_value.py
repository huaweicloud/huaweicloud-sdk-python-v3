...
class CoreGatewayMatchValue:
    ...
    def __init__(self, match_value_string=None, match_value_string_list=None):
        r"""CoreGatewayMatchValue

        The model defined in huaweicloud sdk

        :param match_value_string: 单个匹配值。
        :type match_value_string: str
        :param match_value_string_list: 匹配值列表。
    ...
    def match_value_string(self):
        r"""Gets the match_value_string of this CoreGatewayMatchValue.

        单个匹配值。

        :return: The match_value_string of this CoreGatewayMatchValue.
        :rtype: str
        """
    ...
    def match_value_string(self, match_value_string):
        r"""Sets the match_value_string of this CoreGatewayMatchValue.

        单个匹配值。

        :param match_value_string: The match_value_string of this CoreGatewayMatchValue.
        :type match_value_string: str
        """
    ...
    def match_value_string_list(self):
        r"""Gets the match_value_string_list of this CoreGatewayMatchValue.

        匹配值列表。

        :return: The match_value_string_list of this CoreGatewayMatchValue.
        :rtype: list[str]
        """
    ...
    def match_value_string_list(self, match_value_string_list):
        r"""Sets the match_value_string_list of this CoreGatewayMatchValue.

        匹配值列表。

        :param match_value_string_list: The match_value_string_list of this CoreGatewayMatchValue.
        :type match_value_string_list: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CoreGatewayMatchValue):
            return False
