...
class UpdateOpsModelTuningTaskRequestBody:
    ...
    def __init__(self, name=None, description=None, agent=None, model_name=None, training_type=None, tuning_method=None, reward_setting=None, parameter_setting=None, dataset=None, validation_set=None, validation_set_ratio=None, train_product_path=None, log_config=None, agency_name=None, tags=None):
        r"""UpdateOpsModelTuningTaskRequestBody
    ...
    @property
    def name(self):
        r"""Gets the name of this UpdateOpsModelTuningTaskRequestBody.

        **参数解释：** 任务名称，用于标识和区分不同的模型优化任务。  **约束限制：** 不涉及  **取值范围：** 长度1-64个字符，支持中文、字母、数字、中划线及下划线。  **默认取值：** 无

        :return: The name of this UpdateOpsModelTuningTaskRequestBody.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this UpdateOpsModelTuningTaskRequestBody.

        **参数解释：** 任务名称，用于标识和区分不同的模型优化任务。  **约束限制：** 不涉及  **取值范围：** 长度1-64个字符，支持中文、字母、数字、中划线及下划线。  **默认取值：** 无

        :param name: The name of this UpdateOpsModelTuningTaskRequestBody.
        :type name: str
        """
        self._name = name
    ...
    def description(self):
        r"""Gets the description of this UpdateOpsModelTuningTaskRequestBody.

        **参数解释：** 任务的详细描述，用于记录任务目的或备注信息。  **约束限制：** 不涉及  **取值范围：** 长度0-1024个字符。  **默认取值：** 无

        :return: The description of this UpdateOpsModelTuningTaskRequestBody.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this UpdateOpsModelTuningTaskRequestBody.

        **参数解释：** 任务的详细描述，用于记录任务目的或备注信息。  **约束限制：** 不涉及  **取值范围：** 长度0-1024个字符。  **默认取值：** 无

        :param description: The description of this UpdateOpsModelTuningTaskRequestBody.
        :type description: str
        """
    ...
    @property
    def agent(self):
        r"""Gets the agent of this UpdateOpsModelTuningTaskRequestBody.

        :return: The agent of this UpdateOpsModelTuningTaskRequestBody.
    ...
    def agent(self, agent):
        r"""Sets the agent of this UpdateOpsModelTuningTaskRequestBody.

        :param agent: The agent of this UpdateOpsModelTuningTaskRequestBody.
        :type agent: :class:`huaweicloudsdkagentarts.v1.OpsTuningTargetAgent`
        """
        self._agent = agent
    ...
    @property
    def model_name(self):
        r"""Gets the model_name of this UpdateOpsModelTuningTaskRequestBody.

        **参数解释：** 基础调优模型名称，作为本次优化训练的底座模型。  **约束限制：**  必须是系统支持的基础模型。  **取值范围：**  可选值为 qwen3_8b 或 qwen3_1_7b。  **默认取值：** 无

        :return: The model_name of this UpdateOpsModelTuningTaskRequestBody.
        :rtype: str
        """
    ...
    def model_name(self, model_name):
        r"""Sets the model_name of this UpdateOpsModelTuningTaskRequestBody.

        **参数解释：** 基础调优模型名称，作为本次优化训练的底座模型。  **约束限制：**  必须是系统支持的基础模型。  **取值范围：**  可选值为 qwen3_8b 或 qwen3_1_7b。  **默认取值：** 无

        :param model_name: The model_name of this UpdateOpsModelTuningTaskRequestBody.
        :type model_name: str
        """
    ...
    def training_type(self):
        r"""Gets the training_type of this UpdateOpsModelTuningTaskRequestBody.

        **参数解释：** 训练类型，决定模型训练所采用的学习算法类别。  **约束限制：** 目前仅支持强化学习。  **取值范围：** 固定值为rl。  **默认取值：** rl

        :return: The training_type of this UpdateOpsModelTuningTaskRequestBody.
        :rtype: str
        """
    ...
    def training_type(self, training_type):
        r"""Sets the training_type of this UpdateOpsModelTuningTaskRequestBody.

        **参数解释：** 训练类型，决定模型训练所采用的学习算法类别。  **约束限制：** 目前仅支持强化学习。  **取值范围：** 固定值为rl。  **默认取值：** rl

        :param training_type: The training_type of this UpdateOpsModelTuningTaskRequestBody.
        :type training_type: str
        """
    ...
    def tuning_method(self):
        r"""Gets the tuning_method of this UpdateOpsModelTuningTaskRequestBody.

        **参数解释：**  调优方法/算法，指定模型优化所使用的具体算法策略。  **约束限制：**  目前仅支持群组相对优化算法。  **取值范围：**  固定值为 grpo。  **默认取值：**  grpo

        :return: The tuning_method of this UpdateOpsModelTuningTaskRequestBody.
        :rtype: str
        """
    ...
    def tuning_method(self, tuning_method):
        r"""Sets the tuning_method of this UpdateOpsModelTuningTaskRequestBody.

        **参数解释：**  调优方法/算法，指定模型优化所使用的具体算法策略。  **约束限制：**  目前仅支持群组相对优化算法。  **取值范围：**  固定值为 grpo。  **默认取值：**  grpo

        :param tuning_method: The tuning_method of this UpdateOpsModelTuningTaskRequestBody.
        :type tuning_method: str
        """
    ...
    def reward_setting(self):
        r"""Gets the reward_setting of this UpdateOpsModelTuningTaskRequestBody.

        :return: The reward_setting of this UpdateOpsModelTuningTaskRequestBody.
    ...
    def reward_setting(self, reward_setting):
        r"""Sets the reward_setting of this UpdateOpsModelTuningTaskRequestBody.

        :param reward_setting: The reward_setting of this UpdateOpsModelTuningTaskRequestBody.
        :type reward_setting: :class:`huaweicloudsdkagentarts.v1.OpsTuningRewardSetting`
        """
    ...
    def parameter_setting(self):
        r"""Gets the parameter_setting of this UpdateOpsModelTuningTaskRequestBody.

        :return: The parameter_setting of this UpdateOpsModelTuningTaskRequestBody.
    ...
    def parameter_setting(self, parameter_setting):
        r"""Sets the parameter_setting of this UpdateOpsModelTuningTaskRequestBody.

        :param parameter_setting: The parameter_setting of this UpdateOpsModelTuningTaskRequestBody.
        :type parameter_setting: :class:`huaweicloudsdkagentarts.v1.OpsTuningParamSetting`
        """
    ...
    @property
    def dataset(self):
        r"""Gets the dataset of this UpdateOpsModelTuningTaskRequestBody.

        :return: The dataset of this UpdateOpsModelTuningTaskRequestBody.
    ...
    def dataset(self, dataset):
        r"""Sets the dataset of this UpdateOpsModelTuningTaskRequestBody.

        :param dataset: The dataset of this UpdateOpsModelTuningTaskRequestBody.
        :type dataset: :class:`huaweicloudsdkagentarts.v1.OpsDataset`
        """
    ...
    def validation_set(self):
        r"""Gets the validation_set of this UpdateOpsModelTuningTaskRequestBody.

        :return: The validation_set of this UpdateOpsModelTuningTaskRequestBody.
        :rtype: :class:`huaweicloudsdkagentarts.v1.OpsDataset`
        """
    ...
    def validation_set(self, validation_set):
        r"""Sets the validation_set of this UpdateOpsModelTuningTaskRequestBody.

        :param validation_set: The validation_set of this UpdateOpsModelTuningTaskRequestBody.
        :type validation_set: :class:`huaweicloudsdkagentarts.v1.OpsDataset`
        """
    ...
    def validation_set_ratio(self):
        r"""Gets the validation_set_ratio of this UpdateOpsModelTuningTaskRequestBody.

        **参数解释：** 验证集比例，使用训练数据集中的部分数据进行验证。  **约束限制：** 不涉及  **取值范围：** 0到99的整数（单位：%）  **默认取值：** 不涉及

        :return: The validation_set_ratio of this UpdateOpsModelTuningTaskRequestBody.
        :rtype: int
        """
    ...
    def validation_set_ratio(self, validation_set_ratio):
        r"""Sets the validation_set_ratio of this UpdateOpsModelTuningTaskRequestBody.

        **参数解释：** 验证集比例，使用训练数据集中的部分数据进行验证。  **约束限制：** 不涉及  **取值范围：** 0到99的整数（单位：%）  **默认取值：** 不涉及

        :param validation_set_ratio: The validation_set_ratio of this UpdateOpsModelTuningTaskRequestBody.
        :type validation_set_ratio: int
        """
    ...
    def train_product_path(self):
        r"""Gets the train_product_path of this UpdateOpsModelTuningTaskRequestBody.

        **参数解释：** 训练产物OBS路径。  **约束限制：** 必须是真实存在的OBS路径且具备读写权限。  **取值范围：** 不涉及  **默认取值：** 无

        :return: The train_product_path of this UpdateOpsModelTuningTaskRequestBody.
        :rtype: str
        """
    ...
    def train_product_path(self, train_product_path):
        r"""Sets the train_product_path of this UpdateOpsModelTuningTaskRequestBody.

        **参数解释：** 训练产物OBS路径。  **约束限制：** 必须是真实存在的OBS路径且具备读写权限。  **取值范围：** 不涉及  **默认取值：** 无

        :param train_product_path: The train_product_path of this UpdateOpsModelTuningTaskRequestBody.
        :type train_product_path: str
        """
    ...
    @property
    def log_config(self):
        r"""Gets the log_config of this UpdateOpsModelTuningTaskRequestBody.

        :return: The log_config of this UpdateOpsModelTuningTaskRequestBody.
    ...
    def log_config(self, log_config):
        r"""Sets the log_config of this UpdateOpsModelTuningTaskRequestBody.

        :param log_config: The log_config of this UpdateOpsModelTuningTaskRequestBody.
        :type log_config: :class:`huaweicloudsdkagentarts.v1.OpsLogConfig`
        """
    ...
    def agency_name(self):
        r"""Gets the agency_name of this UpdateOpsModelTuningTaskRequestBody.

        **参数解释：** 委托名称，赋予服务访问用户资源的权限。  **约束限制：** 必须是IAM中已创建的有效委托。  **取值范围：** 合法的委托名称字符串。  **默认取值：** 无

        :return: The agency_name of this UpdateOpsModelTuningTaskRequestBody.
        :rtype: str
        """
    ...
    def agency_name(self, agency_name):
        r"""Sets the agency_name of this UpdateOpsModelTuningTaskRequestBody.

        **参数解释：** 委托名称，赋予服务访问用户资源的权限。  **约束限制：** 必须是IAM中已创建的有效委托。  **取值范围：** 合法的委托名称字符串。  **默认取值：** 无

        :param agency_name: The agency_name of this UpdateOpsModelTuningTaskRequestBody.
        :type agency_name: str
        """
    ...
    @property
    def tags(self):
        r"""Gets the tags of this UpdateOpsModelTuningTaskRequestBody.

        **参数解释：** 资源标签列表，用于资源分类。  **约束限制：** 不涉及  **取值范围：** 数组长度0-20。  **默认取值：** 空数组

        :return: The tags of this UpdateOpsModelTuningTaskRequestBody.
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this UpdateOpsModelTuningTaskRequestBody.

        **参数解释：** 资源标签列表，用于资源分类。  **约束限制：** 不涉及  **取值范围：** 数组长度0-20。  **默认取值：** 空数组

        :param tags: The tags of this UpdateOpsModelTuningTaskRequestBody.
        :type tags: list[:class:`huaweicloudsdkagentarts.v1.OpsTasksTagForTMS`]
        """
        self._tags = tags
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateOpsModelTuningTaskRequestBody):
            return False
