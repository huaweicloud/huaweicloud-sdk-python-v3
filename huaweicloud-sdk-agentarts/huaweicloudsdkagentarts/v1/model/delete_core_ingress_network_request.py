...
class DeleteCoreIngressNetworkRequest:
    ...
    def __init__(self, ingress_id=None, vpc_ingress_network_id=None):
        r"""DeleteCoreIngressNetworkRequest
    ...
    @property
    def ingress_id(self):
        r"""Gets the ingress_id of this DeleteCoreIngressNetworkRequest.

        Ingress ID，用于唯一标识一个Ingress实例。

        :return: The ingress_id of this DeleteCoreIngressNetworkRequest.
        :rtype: str
        """
    ...
    def ingress_id(self, ingress_id):
        r"""Sets the ingress_id of this DeleteCoreIngressNetworkRequest.

        Ingress ID，用于唯一标识一个Ingress实例。

        :param ingress_id: The ingress_id of this DeleteCoreIngressNetworkRequest.
        :type ingress_id: str
        """
    ...
    def vpc_ingress_network_id(self):
        r"""Gets the vpc_ingress_network_id of this DeleteCoreIngressNetworkRequest.

        **参数解释**： 入站网络ID，用于唯一标识一个VPC入站网络实例。 **取值范围**： 匹配标准的UUID格式。

        :return: The vpc_ingress_network_id of this DeleteCoreIngressNetworkRequest.
        :rtype: str
        """
    ...
    def vpc_ingress_network_id(self, vpc_ingress_network_id):
        r"""Sets the vpc_ingress_network_id of this DeleteCoreIngressNetworkRequest.

        **参数解释**： 入站网络ID，用于唯一标识一个VPC入站网络实例。 **取值范围**： 匹配标准的UUID格式。

        :param vpc_ingress_network_id: The vpc_ingress_network_id of this DeleteCoreIngressNetworkRequest.
        :type vpc_ingress_network_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteCoreIngressNetworkRequest):
            return False
