...
class ListOpsEvaluationTaskCustomLabelValuesResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListOpsEvaluationTaskCustomLabelValuesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListOpsEvaluationTaskCustomLabelValuesResponse):
            return False
