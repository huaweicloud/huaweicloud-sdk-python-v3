...
class ShowCoreSpaceResponse(SdkResponse):
    ...
    @property
    def id(self):
        r"""Gets the id of this ShowCoreSpaceResponse.

        **参数解释：** 记忆库 ID，唯一标识一个记忆库，可通过\"创建Space\"接口获取。 **取值范围：** 不涉及。 

        :return: The id of this ShowCoreSpaceResponse.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this ShowCoreSpaceResponse.

        **参数解释：** 记忆库 ID，唯一标识一个记忆库，可通过\"创建Space\"接口获取。 **取值范围：** 不涉及。 

        :param id: The id of this ShowCoreSpaceResponse.
        :type id: str
        """
        self._id = id
    ...
    @property
    def name(self):
        r"""Gets the name of this ShowCoreSpaceResponse.

        **参数解释：** 记忆库名称。 **取值范围：** 不涉及。 

        :return: The name of this ShowCoreSpaceResponse.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this ShowCoreSpaceResponse.

        **参数解释：** 记忆库名称。 **取值范围：** 不涉及。 

        :param name: The name of this ShowCoreSpaceResponse.
        :type name: str
        """
        self._name = name
    ...
    def description(self):
        r"""Gets the description of this ShowCoreSpaceResponse.

        **参数解释：** 记忆库描述。 **取值范围：** 不涉及。 

        :return: The description of this ShowCoreSpaceResponse.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this ShowCoreSpaceResponse.

        **参数解释：** 记忆库描述。 **取值范围：** 不涉及。 

        :param description: The description of this ShowCoreSpaceResponse.
        :type description: str
        """
    ...
    def message_ttl_hours(self):
        r"""Gets the message_ttl_hours of this ShowCoreSpaceResponse.

        **参数解释：** 短期记忆过期时间（小时）。 **取值范围：** 不涉及。 

        :return: The message_ttl_hours of this ShowCoreSpaceResponse.
        :rtype: int
        """
    ...
    def message_ttl_hours(self, message_ttl_hours):
        r"""Sets the message_ttl_hours of this ShowCoreSpaceResponse.

        **参数解释：** 短期记忆过期时间（小时）。 **取值范围：** 不涉及。 

        :param message_ttl_hours: The message_ttl_hours of this ShowCoreSpaceResponse.
        :type message_ttl_hours: int
        """
    ...
    def memory_extract_enabled(self):
        r"""Gets the memory_extract_enabled of this ShowCoreSpaceResponse.

        **参数解释：** 是否开启长期记忆抽取。 **取值范围：** - true: 已开启 - false: 未开启 

        :return: The memory_extract_enabled of this ShowCoreSpaceResponse.
        :rtype: bool
        """
    ...
    def memory_extract_enabled(self, memory_extract_enabled):
        r"""Sets the memory_extract_enabled of this ShowCoreSpaceResponse.

        **参数解释：** 是否开启长期记忆抽取。 **取值范围：** - true: 已开启 - false: 未开启 

        :param memory_extract_enabled: The memory_extract_enabled of this ShowCoreSpaceResponse.
        :type memory_extract_enabled: bool
        """
    ...
    def memory_extract_idle_seconds(self):
        r"""Gets the memory_extract_idle_seconds of this ShowCoreSpaceResponse.

        **参数解释：** 长期记忆抽取空闲时间（秒）。 **取值范围：** 不涉及。 

        :return: The memory_extract_idle_seconds of this ShowCoreSpaceResponse.
        :rtype: int
        """
    ...
    def memory_extract_idle_seconds(self, memory_extract_idle_seconds):
        r"""Sets the memory_extract_idle_seconds of this ShowCoreSpaceResponse.

        **参数解释：** 长期记忆抽取空闲时间（秒）。 **取值范围：** 不涉及。 

        :param memory_extract_idle_seconds: The memory_extract_idle_seconds of this ShowCoreSpaceResponse.
        :type memory_extract_idle_seconds: int
        """
    ...
    def memory_extract_max_tokens(self):
        r"""Gets the memory_extract_max_tokens of this ShowCoreSpaceResponse.

        **参数解释：** 长期记忆抽取最大累计 token 数。 **取值范围：** 不涉及。 

        :return: The memory_extract_max_tokens of this ShowCoreSpaceResponse.
        :rtype: int
        """
    ...
    def memory_extract_max_tokens(self, memory_extract_max_tokens):
        r"""Sets the memory_extract_max_tokens of this ShowCoreSpaceResponse.

        **参数解释：** 长期记忆抽取最大累计 token 数。 **取值范围：** 不涉及。 

        :param memory_extract_max_tokens: The memory_extract_max_tokens of this ShowCoreSpaceResponse.
        :type memory_extract_max_tokens: int
        """
    ...
    def memory_extract_max_messages(self):
        r"""Gets the memory_extract_max_messages of this ShowCoreSpaceResponse.

        **参数解释：** 长期记忆抽取最大累计 message 数。 **取值范围：** 不涉及。 

        :return: The memory_extract_max_messages of this ShowCoreSpaceResponse.
        :rtype: int
        """
    ...
    def memory_extract_max_messages(self, memory_extract_max_messages):
        r"""Sets the memory_extract_max_messages of this ShowCoreSpaceResponse.

        **参数解释：** 长期记忆抽取最大累计 message 数。 **取值范围：** 不涉及。 

        :param memory_extract_max_messages: The memory_extract_max_messages of this ShowCoreSpaceResponse.
        :type memory_extract_max_messages: int
        """
    ...
    def memory_strategies_builtin(self):
        r"""Gets the memory_strategies_builtin of this ShowCoreSpaceResponse.

        **参数解释：** 内置策略列表。 **取值范围：** 不涉及。 

        :return: The memory_strategies_builtin of this ShowCoreSpaceResponse.
    ...
    def memory_strategies_builtin(self, memory_strategies_builtin):
        r"""Sets the memory_strategies_builtin of this ShowCoreSpaceResponse.

        **参数解释：** 内置策略列表。 **取值范围：** 不涉及。 

        :param memory_strategies_builtin: The memory_strategies_builtin of this ShowCoreSpaceResponse.
        :type memory_strategies_builtin: list[:class:`huaweicloudsdkagentarts.v1.CoreSpaceBuiltinMemoryStrategy`]
        """
    ...
    def memory_strategies_customized(self):
        r"""Gets the memory_strategies_customized of this ShowCoreSpaceResponse.

        **参数解释：** 该记忆库关联的用户自定义记忆策略列表（完整数据）。 **取值范围：** 不涉及。 

        :return: The memory_strategies_customized of this ShowCoreSpaceResponse.
    ...
    def memory_strategies_customized(self, memory_strategies_customized):
        r"""Sets the memory_strategies_customized of this ShowCoreSpaceResponse.

        **参数解释：** 该记忆库关联的用户自定义记忆策略列表（完整数据）。 **取值范围：** 不涉及。 

        :param memory_strategies_customized: The memory_strategies_customized of this ShowCoreSpaceResponse.
        :type memory_strategies_customized: list[:class:`huaweicloudsdkagentarts.v1.CoreSpaceMemoryStrategy`]
        """
    ...
    @property
    def vpc_id(self):
        r"""Gets the vpc_id of this ShowCoreSpaceResponse.

        **参数解释：** 租户 VPC ID，获取方式：[查询VPC列表](https://support.huaweicloud.com/api-vpc/vpc_apiv3_0003.html)。 **取值范围：** 不涉及。 

        :return: The vpc_id of this ShowCoreSpaceResponse.
        :rtype: str
        """
        return self._vpc_id
    ...
    def vpc_id(self, vpc_id):
        r"""Sets the vpc_id of this ShowCoreSpaceResponse.

        **参数解释：** 租户 VPC ID，获取方式：[查询VPC列表](https://support.huaweicloud.com/api-vpc/vpc_apiv3_0003.html)。 **取值范围：** 不涉及。 

        :param vpc_id: The vpc_id of this ShowCoreSpaceResponse.
        :type vpc_id: str
        """
        self._vpc_id = vpc_id
    ...
    @property
    def subnet_id(self):
        r"""Gets the subnet_id of this ShowCoreSpaceResponse.

        **参数解释：** 租户子网 ID，获取方式：[查询子网列表](https://support.huaweicloud.com/api-vpc/vpc_subnet01_0003.html)。 **取值范围：** 不涉及。 

        :return: The subnet_id of this ShowCoreSpaceResponse.
        :rtype: str
        """
    ...
    def subnet_id(self, subnet_id):
        r"""Sets the subnet_id of this ShowCoreSpaceResponse.

        **参数解释：** 租户子网 ID，获取方式：[查询子网列表](https://support.huaweicloud.com/api-vpc/vpc_subnet01_0003.html)。 **取值范围：** 不涉及。 

        :param subnet_id: The subnet_id of this ShowCoreSpaceResponse.
        :type subnet_id: str
        """
    ...
    def private_access(self):
        r"""Gets the private_access of this ShowCoreSpaceResponse.

        :return: The private_access of this ShowCoreSpaceResponse.
    ...
    def private_access(self, private_access):
        r"""Sets the private_access of this ShowCoreSpaceResponse.

        :param private_access: The private_access of this ShowCoreSpaceResponse.
        :type private_access: :class:`huaweicloudsdkagentarts.v1.CoreSpaceNetwork`
        """
    ...
    def public_access(self):
        r"""Gets the public_access of this ShowCoreSpaceResponse.

        :return: The public_access of this ShowCoreSpaceResponse.
        :rtype: :class:`huaweicloudsdkagentarts.v1.CoreSpaceNetwork`
        """
    ...
    def public_access(self, public_access):
        r"""Sets the public_access of this ShowCoreSpaceResponse.

        :param public_access: The public_access of this ShowCoreSpaceResponse.
        :type public_access: :class:`huaweicloudsdkagentarts.v1.CoreSpaceNetwork`
        """
    ...
    @property
    def api_key(self):
        r"""Gets the api_key of this ShowCoreSpaceResponse.

        :return: The api_key of this ShowCoreSpaceResponse.
    ...
    def api_key(self, api_key):
        r"""Sets the api_key of this ShowCoreSpaceResponse.

        :param api_key: The api_key of this ShowCoreSpaceResponse.
        :type api_key: :class:`huaweicloudsdkagentarts.v1.ShowCoreSpaceApiKeyResponseBody`
        """
    ...
    def encryption_config(self):
        r"""Gets the encryption_config of this ShowCoreSpaceResponse.

        :return: The encryption_config of this ShowCoreSpaceResponse.
    ...
    def encryption_config(self, encryption_config):
        r"""Sets the encryption_config of this ShowCoreSpaceResponse.

        :param encryption_config: The encryption_config of this ShowCoreSpaceResponse.
        :type encryption_config: :class:`huaweicloudsdkagentarts.v1.EncryptionConfig`
        """
    ...
    @property
    def tags(self):
        r"""Gets the tags of this ShowCoreSpaceResponse.

        **参数解释：** 库标签列表。 **取值范围：** 不涉及。 

        :return: The tags of this ShowCoreSpaceResponse.
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this ShowCoreSpaceResponse.

        **参数解释：** 库标签列表。 **取值范围：** 不涉及。 

        :param tags: The tags of this ShowCoreSpaceResponse.
        :type tags: list[:class:`huaweicloudsdkagentarts.v1.CoreSpaceTag`]
        """
        self._tags = tags
    ...
    @property
    def status(self):
        r"""Gets the status of this ShowCoreSpaceResponse.

        **参数解释：** Space 状态。 **取值范围：** - creating: 创建中 - running: 运行中 - deleted: 已删除 - create_failed: 创建失败 

        :return: The status of this ShowCoreSpaceResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        r"""Sets the status of this ShowCoreSpaceResponse.

        **参数解释：** Space 状态。 **取值范围：** - creating: 创建中 - running: 运行中 - deleted: 已删除 - create_failed: 创建失败 

        :param status: The status of this ShowCoreSpaceResponse.
        :type status: str
        """
        self._status = status
    ...
    @property
    def created_at(self):
        r"""Gets the created_at of this ShowCoreSpaceResponse.

        **参数解释：** 记录的创建时间，由系统自动生成，格式为 ISO 8601（YYYY-MM-DDTHH:mm:ssZ）。 **取值范围：** 不涉及。 

        :return: The created_at of this ShowCoreSpaceResponse.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        r"""Sets the created_at of this ShowCoreSpaceResponse.

        **参数解释：** 记录的创建时间，由系统自动生成，格式为 ISO 8601（YYYY-MM-DDTHH:mm:ssZ）。 **取值范围：** 不涉及。 

        :param created_at: The created_at of this ShowCoreSpaceResponse.
        :type created_at: datetime
        """
    ...
    @property
    def updated_at(self):
        r"""Gets the updated_at of this ShowCoreSpaceResponse.

        **参数解释：** 记录的最近更新时间，由系统自动更新，格式为 ISO 8601（YYYY-MM-DDTHH:mm:ssZ）。 **取值范围：** 不涉及。 

        :return: The updated_at of this ShowCoreSpaceResponse.
        :rtype: datetime
        """
    ...
    def updated_at(self, updated_at):
        r"""Sets the updated_at of this ShowCoreSpaceResponse.

        **参数解释：** 记录的最近更新时间，由系统自动更新，格式为 ISO 8601（YYYY-MM-DDTHH:mm:ssZ）。 **取值范围：** 不涉及。 

        :param updated_at: The updated_at of this ShowCoreSpaceResponse.
        :type updated_at: datetime
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowCoreSpaceResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowCoreSpaceResponse):
            return False
