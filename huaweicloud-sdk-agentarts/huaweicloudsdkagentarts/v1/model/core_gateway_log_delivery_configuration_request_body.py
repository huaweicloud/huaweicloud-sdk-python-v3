...
class CoreGatewayLogDeliveryConfigurationRequestBody:
    ...
    @property
    def enabled(self):
        r"""Gets the enabled of this CoreGatewayLogDeliveryConfigurationRequestBody.

        是否启用日志上报。

        :return: The enabled of this CoreGatewayLogDeliveryConfigurationRequestBody.
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        r"""Sets the enabled of this CoreGatewayLogDeliveryConfigurationRequestBody.

        是否启用日志上报。

        :param enabled: The enabled of this CoreGatewayLogDeliveryConfigurationRequestBody.
        :type enabled: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CoreGatewayLogDeliveryConfigurationRequestBody):
            return False
