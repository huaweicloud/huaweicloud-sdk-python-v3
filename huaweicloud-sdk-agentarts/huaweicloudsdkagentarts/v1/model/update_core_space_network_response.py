...
class UpdateCoreSpaceNetworkResponse(SdkResponse):
    ...
    def __init__(self, public_access_enable=None, private_access_config=None):
        r"""UpdateCoreSpaceNetworkResponse
    ...
    def public_access_enable(self):
        r"""Gets the public_access_enable of this UpdateCoreSpaceNetworkResponse.

        **参数解释：** 是否开启公网访问。 **约束限制：** 不涉及。 **取值范围：** - true: 开启公网访问 - false: 关闭公网访问 **默认取值：** false 

        :return: The public_access_enable of this UpdateCoreSpaceNetworkResponse.
        :rtype: bool
        """
    ...
    def public_access_enable(self, public_access_enable):
        r"""Sets the public_access_enable of this UpdateCoreSpaceNetworkResponse.

        **参数解释：** 是否开启公网访问。 **约束限制：** 不涉及。 **取值范围：** - true: 开启公网访问 - false: 关闭公网访问 **默认取值：** false 

        :param public_access_enable: The public_access_enable of this UpdateCoreSpaceNetworkResponse.
        :type public_access_enable: bool
        """
    ...
    def private_access_config(self):
        r"""Gets the private_access_config of this UpdateCoreSpaceNetworkResponse.

        :return: The private_access_config of this UpdateCoreSpaceNetworkResponse.
    ...
    def private_access_config(self, private_access_config):
        r"""Sets the private_access_config of this UpdateCoreSpaceNetworkResponse.

        :param private_access_config: The private_access_config of this UpdateCoreSpaceNetworkResponse.
        :type private_access_config: :class:`huaweicloudsdkagentarts.v1.CoreSpacePrivateNetworkRequestBody`
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateCoreSpaceNetworkResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateCoreSpaceNetworkResponse):
            return False
