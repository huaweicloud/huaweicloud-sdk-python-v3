...
class DeleteOpsAnalysisTaskRequest:
    ...
    def __init__(self, analysis_task_id=None):
        r"""DeleteOpsAnalysisTaskRequest
    ...
    def analysis_task_id(self):
        r"""Gets the analysis_task_id of this DeleteOpsAnalysisTaskRequest.

        **参数解释：** 分析任务ID，标识任务的唯一标识符。获取方法请参考查询分析任务列表。  **约束限制：** 不涉及  **取值范围：** 32位ID字符串。  **默认取值：** 无

        :return: The analysis_task_id of this DeleteOpsAnalysisTaskRequest.
        :rtype: str
        """
    ...
    def analysis_task_id(self, analysis_task_id):
        r"""Sets the analysis_task_id of this DeleteOpsAnalysisTaskRequest.

        **参数解释：** 分析任务ID，标识任务的唯一标识符。获取方法请参考查询分析任务列表。  **约束限制：** 不涉及  **取值范围：** 32位ID字符串。  **默认取值：** 无

        :param analysis_task_id: The analysis_task_id of this DeleteOpsAnalysisTaskRequest.
        :type analysis_task_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteOpsAnalysisTaskRequest):
            return False
