...
class ShowOpsEvaluationTasksCompareResultResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this ShowOpsEvaluationTasksCompareResultResponse.

        评估任务对比返回结构体。

        :return: The data of this ShowOpsEvaluationTasksCompareResultResponse.
        :rtype: list[:class:`huaweicloudsdkagentarts.v1.CompareResultItem`]
        """
        return self._data

    @data.setter
    def data(self, data):
        r"""Sets the data of this ShowOpsEvaluationTasksCompareResultResponse.

        评估任务对比返回结构体。

        :param data: The data of this ShowOpsEvaluationTasksCompareResultResponse.
        :type data: list[:class:`huaweicloudsdkagentarts.v1.CompareResultItem`]
        """
        self._data = data
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowOpsEvaluationTasksCompareResultResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowOpsEvaluationTasksCompareResultResponse):
            return False
