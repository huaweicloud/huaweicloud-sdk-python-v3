...
class ListOpsAgentTuningTasksRequest:
    ...
    def __init__(self, offset=None, limit=None, name=None, type=None, status=None, analysis_task_id=None, tag_key_exists=None, tag_key_matches=None, tag_value_matches=None, tag_match_policy=None):
        r"""ListOpsAgentTuningTasksRequest
        ...
        :type type: str
        :param status: **参数解释：** 任务状态，用于根据状态筛选任务。  **约束限制：** 不涉及  **取值范围：** draft：草稿态，running：运行中，stopping：停止中，stopped：已停止，success：成功，fail：失败。  **默认取值：** 无
        :type status: str
        :param analysis_task_id: **参数解释：** 分析任务ID，用于查询通过指定分析任务一键优化创建出来的优化任务。  **约束限制：** 不涉及  **取值范围：** 无。  **默认取值：** 无。
    ...
    @property
    def offset(self):
        r"""Gets the offset of this ListOpsAgentTuningTasksRequest.

        **参数解释：** 返回结果偏移量。 **约束限制：** 必须为非负整数。 **取值范围：** 0-100000。 **默认取值：** 0。 

        :return: The offset of this ListOpsAgentTuningTasksRequest.
        :rtype: int
        """
        return self._offset
    ...
    def offset(self, offset):
        r"""Sets the offset of this ListOpsAgentTuningTasksRequest.

        **参数解释：** 返回结果偏移量。 **约束限制：** 必须为非负整数。 **取值范围：** 0-100000。 **默认取值：** 0。 

        :param offset: The offset of this ListOpsAgentTuningTasksRequest.
        :type offset: int
        """
        self._offset = offset
    ...
    @property
    def limit(self):
        r"""Gets the limit of this ListOpsAgentTuningTasksRequest.

        **参数解释：** 限制数量。 **约束限制：** 不涉及。 **取值范围：** 正整数，最大值100。 **默认取值：** 100。

        :return: The limit of this ListOpsAgentTuningTasksRequest.
        :rtype: int
        """
        return self._limit
    ...
    def limit(self, limit):
        r"""Sets the limit of this ListOpsAgentTuningTasksRequest.

        **参数解释：** 限制数量。 **约束限制：** 不涉及。 **取值范围：** 正整数，最大值100。 **默认取值：** 100。

        :param limit: The limit of this ListOpsAgentTuningTasksRequest.
        :type limit: int
        """
        self._limit = limit
    ...
    @property
    def name(self):
        r"""Gets the name of this ListOpsAgentTuningTasksRequest.

        **参数解释：** 任务名称，用于根据名称关键词筛选任务。  **约束限制：** 支持包含匹配的模糊搜索。  **取值范围：** 长度0-64个字符。  **默认取值：** 无

        :return: The name of this ListOpsAgentTuningTasksRequest.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this ListOpsAgentTuningTasksRequest.

        **参数解释：** 任务名称，用于根据名称关键词筛选任务。  **约束限制：** 支持包含匹配的模糊搜索。  **取值范围：** 长度0-64个字符。  **默认取值：** 无

        :param name: The name of this ListOpsAgentTuningTasksRequest.
        :type name: str
        """
        self._name = name
    ...
    @property
    def type(self):
        r"""Gets the type of this ListOpsAgentTuningTasksRequest.

        **参数解释：** 任务类型，用于根据类型筛选任务。  **约束限制：** 不涉及  **取值范围：** tool：工具，skill：技能。  **默认取值：** 无

        :return: The type of this ListOpsAgentTuningTasksRequest.
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        r"""Sets the type of this ListOpsAgentTuningTasksRequest.

        **参数解释：** 任务类型，用于根据类型筛选任务。  **约束限制：** 不涉及  **取值范围：** tool：工具，skill：技能。  **默认取值：** 无

        :param type: The type of this ListOpsAgentTuningTasksRequest.
        :type type: str
        """
        self._type = type
    ...
    @property
    def status(self):
        r"""Gets the status of this ListOpsAgentTuningTasksRequest.

        **参数解释：** 任务状态，用于根据状态筛选任务。  **约束限制：** 不涉及  **取值范围：** draft：草稿态，running：运行中，stopping：停止中，stopped：已停止，success：成功，fail：失败。  **默认取值：** 无

        :return: The status of this ListOpsAgentTuningTasksRequest.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        r"""Sets the status of this ListOpsAgentTuningTasksRequest.

        **参数解释：** 任务状态，用于根据状态筛选任务。  **约束限制：** 不涉及  **取值范围：** draft：草稿态，running：运行中，stopping：停止中，stopped：已停止，success：成功，fail：失败。  **默认取值：** 无

        :param status: The status of this ListOpsAgentTuningTasksRequest.
        :type status: str
        """
        self._status = status
    ...
    def analysis_task_id(self):
        r"""Gets the analysis_task_id of this ListOpsAgentTuningTasksRequest.

        **参数解释：** 分析任务ID，用于查询通过指定分析任务一键优化创建出来的优化任务。  **约束限制：** 不涉及  **取值范围：** 无。  **默认取值：** 无。

        :return: The analysis_task_id of this ListOpsAgentTuningTasksRequest.
        :rtype: str
        """
    ...
    def analysis_task_id(self, analysis_task_id):
        r"""Sets the analysis_task_id of this ListOpsAgentTuningTasksRequest.

        **参数解释：** 分析任务ID，用于查询通过指定分析任务一键优化创建出来的优化任务。  **约束限制：** 不涉及  **取值范围：** 无。  **默认取值：** 无。

        :param analysis_task_id: The analysis_task_id of this ListOpsAgentTuningTasksRequest.
        :type analysis_task_id: str
        """
    ...
    def tag_key_exists(self):
        r"""Gets the tag_key_exists of this ListOpsAgentTuningTasksRequest.

        **参数解释**：  需要匹配的包含该标签名称的资源。 **约束限制**: 支持批量查询多个标签名，最多支持10个标签。 **取值范围**： 最小数量 0，最大数量 10 **默认取值**: 不涉及。

        :return: The tag_key_exists of this ListOpsAgentTuningTasksRequest.
        :rtype: list[str]
        """
    ...
    def tag_key_exists(self, tag_key_exists):
        r"""Sets the tag_key_exists of this ListOpsAgentTuningTasksRequest.

        **参数解释**：  需要匹配的包含该标签名称的资源。 **约束限制**: 支持批量查询多个标签名，最多支持10个标签。 **取值范围**： 最小数量 0，最大数量 10 **默认取值**: 不涉及。

        :param tag_key_exists: The tag_key_exists of this ListOpsAgentTuningTasksRequest.
        :type tag_key_exists: list[str]
        """
    ...
    def tag_key_matches(self):
        r"""Gets the tag_key_matches of this ListOpsAgentTuningTasksRequest.
        ...
        **参数解释**：  需要匹配的包含该标签的资源，需要和tag_value_matches条件配合使用，tag_key_matches和tag_value_matches的元素个数需要一致，且标签顺序需要完全匹配，不支持空字符串。 **约束限制**: 支持批量查询多个标签，最多支持10个标签。tag_key_matches和tag_value_matches键值对不可重复. **取值范围**： 最小数量0，最大数量 10 **默认取值**: 不涉及。
        ...
        :return: The tag_key_matches of this ListOpsAgentTuningTasksRequest.
        :rtype: list[str]
        """
    ...
    def tag_key_matches(self, tag_key_matches):
        r"""Sets the tag_key_matches of this ListOpsAgentTuningTasksRequest.

        **参数解释**：  需要匹配的包含该标签的资源，需要和tag_value_matches条件配合使用，tag_key_matches和tag_value_matches的元素个数需要一致，且标签顺序需要完全匹配，不支持空字符串。 **约束限制**: 支持批量查询多个标签，最多支持10个标签。tag_key_matches和tag_value_matches键值对不可重复. **取值范围**： 最小数量0，最大数量 10 **默认取值**: 不涉及。

        :param tag_key_matches: The tag_key_matches of this ListOpsAgentTuningTasksRequest.
        :type tag_key_matches: list[str]
        """
    ...
    def tag_value_matches(self):
        r"""Gets the tag_value_matches of this ListOpsAgentTuningTasksRequest.
        ...
        **参数解释**：  需要匹配的包含该标签的资源，需要和tag_key_matches条件配合使用，tag_key_matches和tag_value_matches的元素个数需要一致，且标签顺序需要完全匹配，支持空字符串。 **约束限制**: 支持批量查询多个标签，最多支持10个标签。tag_key_matches和tag_value_matches键值对不可重复. **取值范围**： 最小数量 0，最大数量 10 **默认取值**: 不涉及。
        ...
        :return: The tag_value_matches of this ListOpsAgentTuningTasksRequest.
        :rtype: list[str]
        """
    ...
    def tag_value_matches(self, tag_value_matches):
        r"""Sets the tag_value_matches of this ListOpsAgentTuningTasksRequest.

        **参数解释**：  需要匹配的包含该标签的资源，需要和tag_key_matches条件配合使用，tag_key_matches和tag_value_matches的元素个数需要一致，且标签顺序需要完全匹配，支持空字符串。 **约束限制**: 支持批量查询多个标签，最多支持10个标签。tag_key_matches和tag_value_matches键值对不可重复. **取值范围**： 最小数量 0，最大数量 10 **默认取值**: 不涉及。

        :param tag_value_matches: The tag_value_matches of this ListOpsAgentTuningTasksRequest.
        :type tag_value_matches: list[str]
        """
    ...
    def tag_match_policy(self):
        r"""Gets the tag_match_policy of this ListOpsAgentTuningTasksRequest.

        **参数解释**: 标签匹配模式，仅针对tag_key_exists，tag_key_matches，tag_value_matches参数生效。 - ALL: 若请求中包含tag_key_exists参数，查询规则为资源标签需要包含tag_key_exists中的所有元素，若请求中tag_key_matches以及tag_value_matches参数存在，查询规则为资源标签需要包含所有tag_key_matches以及tag_value_matches参数中指定的key-value对应的标签。 三个参数都存在时，取tag_key_exists和tag_key_matches，tag_value_matches的交集  - ANY: 若请求中包含tag_key_exists参数，查询规则为资源标签需要包含tag_key_exists中的任意一个元素，若请求中tag_key_matches以及tag_value_matches参数存在，查询规则为资源标签需要包含tag_key_matches以及tag_value_matches参数中任意一个key-value对应的标签。 三个参数都存在时，取tag_key_exists和tag_key_matches，tag_value_matches的并集 **约束限制**: 不涉及。 **取值范围**： 长度为1-3个字符。允许的值为： - ALL - ANY **默认取值**: ALL

        :return: The tag_match_policy of this ListOpsAgentTuningTasksRequest.
        :rtype: str
        """
    ...
    def tag_match_policy(self, tag_match_policy):
        r"""Sets the tag_match_policy of this ListOpsAgentTuningTasksRequest.

        **参数解释**: 标签匹配模式，仅针对tag_key_exists，tag_key_matches，tag_value_matches参数生效。 - ALL: 若请求中包含tag_key_exists参数，查询规则为资源标签需要包含tag_key_exists中的所有元素，若请求中tag_key_matches以及tag_value_matches参数存在，查询规则为资源标签需要包含所有tag_key_matches以及tag_value_matches参数中指定的key-value对应的标签。 三个参数都存在时，取tag_key_exists和tag_key_matches，tag_value_matches的交集  - ANY: 若请求中包含tag_key_exists参数，查询规则为资源标签需要包含tag_key_exists中的任意一个元素，若请求中tag_key_matches以及tag_value_matches参数存在，查询规则为资源标签需要包含tag_key_matches以及tag_value_matches参数中任意一个key-value对应的标签。 三个参数都存在时，取tag_key_exists和tag_key_matches，tag_value_matches的并集 **约束限制**: 不涉及。 **取值范围**： 长度为1-3个字符。允许的值为： - ALL - ANY **默认取值**: ALL

        :param tag_match_policy: The tag_match_policy of this ListOpsAgentTuningTasksRequest.
        :type tag_match_policy: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListOpsAgentTuningTasksRequest):
            return False
