...
class StopOpsAgentTuningTaskRequest:
    ...
    def __init__(self, agent_tuning_task_id=None):
        r"""StopOpsAgentTuningTaskRequest
    ...
    def agent_tuning_task_id(self):
        r"""Gets the agent_tuning_task_id of this StopOpsAgentTuningTaskRequest.

        **参数解释：** 智能体优化任务ID，标识任务的唯一标识符。获取方法请参考查询智能体优化任务列表。  **约束限制：** 不涉及  **取值范围：** 32位ID字符串。  **默认取值：** 无

        :return: The agent_tuning_task_id of this StopOpsAgentTuningTaskRequest.
        :rtype: str
        """
    ...
    def agent_tuning_task_id(self, agent_tuning_task_id):
        r"""Sets the agent_tuning_task_id of this StopOpsAgentTuningTaskRequest.

        **参数解释：** 智能体优化任务ID，标识任务的唯一标识符。获取方法请参考查询智能体优化任务列表。  **约束限制：** 不涉及  **取值范围：** 32位ID字符串。  **默认取值：** 无

        :param agent_tuning_task_id: The agent_tuning_task_id of this StopOpsAgentTuningTaskRequest.
        :type agent_tuning_task_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StopOpsAgentTuningTaskRequest):
            return False
