...
class ListAllCoreGatewayTagsRequest:
    ...
    def __init__(self, offset=None, limit=None):
        r"""ListAllCoreGatewayTagsRequest
    ...
    @property
    def offset(self):
        r"""Gets the offset of this ListAllCoreGatewayTagsRequest.

        **参数解释：** 返回结果偏移量。 **约束限制：** 必须为非负整数。 **取值范围：** 0-100000。 **默认取值：** 0。 

        :return: The offset of this ListAllCoreGatewayTagsRequest.
        :rtype: int
        """
        return self._offset
    ...
    def offset(self, offset):
        r"""Sets the offset of this ListAllCoreGatewayTagsRequest.

        **参数解释：** 返回结果偏移量。 **约束限制：** 必须为非负整数。 **取值范围：** 0-100000。 **默认取值：** 0。 

        :param offset: The offset of this ListAllCoreGatewayTagsRequest.
        :type offset: int
        """
        self._offset = offset
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAllCoreGatewayTagsRequest):
            return False
