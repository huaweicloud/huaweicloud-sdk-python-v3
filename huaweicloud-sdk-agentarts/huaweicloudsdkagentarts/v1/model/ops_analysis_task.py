...
class OpsAnalysisTask:
    ...
    @property
    def id(self):
        r"""Gets the id of this OpsAnalysisTask.

        **参数解释：** 智能体优化任务ID。  **取值范围：** UUID格式字符串。

        :return: The id of this OpsAnalysisTask.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this OpsAnalysisTask.

        **参数解释：** 智能体优化任务ID。  **取值范围：** UUID格式字符串。

        :param id: The id of this OpsAnalysisTask.
        :type id: str
        """
        self._id = id
    ...
    @property
    def name(self):
        r"""Gets the name of this OpsAnalysisTask.

        **参数解释：** 任务名称，用于标识和区分不同的分析任务。  **取值范围：** 长度1-64个字符，支持中文、字母、数字、中划线及下划线。

        :return: The name of this OpsAnalysisTask.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this OpsAnalysisTask.

        **参数解释：** 任务名称，用于标识和区分不同的分析任务。  **取值范围：** 长度1-64个字符，支持中文、字母、数字、中划线及下划线。

        :param name: The name of this OpsAnalysisTask.
        :type name: str
        """
        self._name = name
    ...
    def description(self):
        r"""Gets the description of this OpsAnalysisTask.

        **参数解释：** 任务的详细描述，用于记录任务目的或备注信息。  **取值范围：** 长度0-1024个字符。

        :return: The description of this OpsAnalysisTask.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this OpsAnalysisTask.

        **参数解释：** 任务的详细描述，用于记录任务目的或备注信息。  **取值范围：** 长度0-1024个字符。

        :param description: The description of this OpsAnalysisTask.
        :type description: str
        """
    ...
    @property
    def agent(self):
        r"""Gets the agent of this OpsAnalysisTask.

        :return: The agent of this OpsAnalysisTask.
    ...
    def agent(self, agent):
        r"""Sets the agent of this OpsAnalysisTask.

        :param agent: The agent of this OpsAnalysisTask.
        :type agent: :class:`huaweicloudsdkagentarts.v1.OpsAnalysisTaskAgent`
        """
        self._agent = agent
    ...
    def agency_name(self):
        r"""Gets the agency_name of this OpsAnalysisTask.

        **参数解释：** 委托名称，赋予服务访问用户资源的权限。  **取值范围：** 合法的委托名称字符串。

        :return: The agency_name of this OpsAnalysisTask.
        :rtype: str
        """
    ...
    def agency_name(self, agency_name):
        r"""Sets the agency_name of this OpsAnalysisTask.

        **参数解释：** 委托名称，赋予服务访问用户资源的权限。  **取值范围：** 合法的委托名称字符串。

        :param agency_name: The agency_name of this OpsAnalysisTask.
        :type agency_name: str
        """
    ...
    def status(self, status):
        r"""Sets the status of this OpsAnalysisTask.

        **参数解释：** 任务状态。  **取值范围：** draft：草稿态，scheduled：待运行，running：运行中，paused：已暂停，completed：已完成，fail：失败，stopping：停止中，stopped：已停止。

        :param status: The status of this OpsAnalysisTask.
        :type status: str
        """
        self._status = status
    ...
    @property
    def created_at(self):
        r"""Gets the created_at of this OpsAnalysisTask.

        **参数解释：** 创建时间，单位：毫秒（13位时间戳）。  **取值范围：** 13位毫秒级时间戳。

        :return: The created_at of this OpsAnalysisTask.
        :rtype: int
        """
    ...
    def created_at(self, created_at):
        r"""Sets the created_at of this OpsAnalysisTask.

        **参数解释：** 创建时间，单位：毫秒（13位时间戳）。  **取值范围：** 13位毫秒级时间戳。

        :param created_at: The created_at of this OpsAnalysisTask.
        :type created_at: int
        """
    ...
    @property
    def updated_at(self):
        r"""Gets the updated_at of this OpsAnalysisTask.

        **参数解释：** 更新时间（单位：毫秒）  **取值范围：** 13位毫秒级时间戳。

        :return: The updated_at of this OpsAnalysisTask.
        :rtype: int
        """
    ...
    def updated_at(self, updated_at):
        r"""Sets the updated_at of this OpsAnalysisTask.

        **参数解释：** 更新时间（单位：毫秒）  **取值范围：** 13位毫秒级时间戳。

        :param updated_at: The updated_at of this OpsAnalysisTask.
        :type updated_at: int
        """
    ...
    def next_fire_time(self, next_fire_time):
        r"""Sets the next_fire_time of this OpsAnalysisTask.

        **参数解释：** 计划下次执行时间。对于待运行、运行中的周期任务，显示下一个task instance时间。对于其他状态的周期任务为null。对待运行的单次任务显示计划运行时间。无后续调度时为 null。  **取值范围：** 13位毫秒级时间戳或 null。

        :param next_fire_time: The next_fire_time of this OpsAnalysisTask.
        :type next_fire_time: int
        """
    ...
    @property
    def tags(self):
        r"""Gets the tags of this OpsAnalysisTask.

        **参数解释：** 资源标签列表，用于资源分类。  **取值范围：** 数组长度0-20。

        :return: The tags of this OpsAnalysisTask.
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this OpsAnalysisTask.

        **参数解释：** 资源标签列表，用于资源分类。  **取值范围：** 数组长度0-20。

        :param tags: The tags of this OpsAnalysisTask.
        :type tags: list[:class:`huaweicloudsdkagentarts.v1.OpsTasksTagForTMS`]
        """
        self._tags = tags
    ...
    @property
    def progress(self):
        r"""Gets the progress of this OpsAnalysisTask.

        :return: The progress of this OpsAnalysisTask.
    ...
    def progress(self, progress):
        r"""Sets the progress of this OpsAnalysisTask.

        :param progress: The progress of this OpsAnalysisTask.
        :type progress: :class:`huaweicloudsdkagentarts.v1.OpsTaskProgress`
        """
    ...
    def execution_strategy(self):
        r"""Gets the execution_strategy of this OpsAnalysisTask.

        :return: The execution_strategy of this OpsAnalysisTask.
    ...
    def execution_strategy(self, execution_strategy):
        r"""Sets the execution_strategy of this OpsAnalysisTask.

        :param execution_strategy: The execution_strategy of this OpsAnalysisTask.
        :type execution_strategy: :class:`huaweicloudsdkagentarts.v1.OpsExecutionStrategy`
        """
    ...
    def status_count(self):
        r"""Gets the status_count of this OpsAnalysisTask.

        :return: The status_count of this OpsAnalysisTask.
    ...
    def status_count(self, status_count):
        r"""Sets the status_count of this OpsAnalysisTask.

        :param status_count: The status_count of this OpsAnalysisTask.
        :type status_count: :class:`huaweicloudsdkagentarts.v1.OpsAnalysisTaskInstanceStatusCount`
        """
    ...
    def sample_strategy(self):
        r"""Gets the sample_strategy of this OpsAnalysisTask.

        :return: The sample_strategy of this OpsAnalysisTask.
    ...
    def sample_strategy(self, sample_strategy):
        r"""Sets the sample_strategy of this OpsAnalysisTask.

        :param sample_strategy: The sample_strategy of this OpsAnalysisTask.
        :type sample_strategy: :class:`huaweicloudsdkagentarts.v1.OpsSampleStrategy`
        """
    ...
    @property
    def failures(self):
        r"""Gets the failures of this OpsAnalysisTask.

        **参数解释：** 故障列表。  **取值范围：** 长度为0-100的数组。

        :return: The failures of this OpsAnalysisTask.
    ...
    def failures(self, failures):
        r"""Sets the failures of this OpsAnalysisTask.

        **参数解释：** 故障列表。  **取值范围：** 长度为0-100的数组。

        :param failures: The failures of this OpsAnalysisTask.
        :type failures: list[:class:`huaweicloudsdkagentarts.v1.OpsFailureCategory`]
        """
    ...
    def input_tokens(self):
        r"""Gets the input_tokens of this OpsAnalysisTask.

        **参数解释：** 输入的 Token 数。 **取值范围：** 无。任务未执行过时为 null。

        :return: The input_tokens of this OpsAnalysisTask.
        :rtype: int
        """
    ...
    def input_tokens(self, input_tokens):
        r"""Sets the input_tokens of this OpsAnalysisTask.

        **参数解释：** 输入的 Token 数。 **取值范围：** 无。任务未执行过时为 null。

        :param input_tokens: The input_tokens of this OpsAnalysisTask.
        :type input_tokens: int
        """
    ...
    def output_tokens(self):
        r"""Gets the output_tokens of this OpsAnalysisTask.

        **参数解释：** 模型输出的 Token 数。 **取值范围：** 无。任务未执行过时为 null。

        :return: The output_tokens of this OpsAnalysisTask.
        :rtype: int
        """
    ...
    def output_tokens(self, output_tokens):
        r"""Sets the output_tokens of this OpsAnalysisTask.

        **参数解释：** 模型输出的 Token 数。 **取值范围：** 无。任务未执行过时为 null。

        :param output_tokens: The output_tokens of this OpsAnalysisTask.
        :type output_tokens: int
        """
    ...
    def total_session_count(self):
        r"""Gets the total_session_count of this OpsAnalysisTask.

        **参数解释：** 分析覆盖的session总数。 **取值范围：** 无。

        :return: The total_session_count of this OpsAnalysisTask.
        :rtype: int
        """
    ...
    def total_session_count(self, total_session_count):
        r"""Sets the total_session_count of this OpsAnalysisTask.

        **参数解释：** 分析覆盖的session总数。 **取值范围：** 无。

        :param total_session_count: The total_session_count of this OpsAnalysisTask.
        :type total_session_count: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OpsAnalysisTask):
            return False
