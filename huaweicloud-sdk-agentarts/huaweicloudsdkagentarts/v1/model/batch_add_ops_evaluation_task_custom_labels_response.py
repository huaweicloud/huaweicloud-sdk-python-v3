...
class BatchAddOpsEvaluationTaskCustomLabelsResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchAddOpsEvaluationTaskCustomLabelsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchAddOpsEvaluationTaskCustomLabelsResponse):
            return False
