...
class UpdateOpsEvaluatorTagsRequest:
    ...
    def __init__(self, evaluator_id=None, body=None):
        r"""UpdateOpsEvaluatorTagsRequest
    ...
    @property
    def body(self):
        r"""Gets the body of this UpdateOpsEvaluatorTagsRequest.

        :return: The body of this UpdateOpsEvaluatorTagsRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this UpdateOpsEvaluatorTagsRequest.

        :param body: The body of this UpdateOpsEvaluatorTagsRequest.
        :type body: :class:`huaweicloudsdkagentarts.v1.UpdateOpsResourceTagsRequestBody`
        """
        self._body = body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateOpsEvaluatorTagsRequest):
            return False
