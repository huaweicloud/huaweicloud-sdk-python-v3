...
class ShowOpsEvaluationTaskResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowOpsEvaluationTaskResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowOpsEvaluationTaskResponse):
            return False
