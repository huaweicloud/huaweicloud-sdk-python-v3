...
class CbhAsyncClient(Client):
    ...
    def batch_create_instance_tag_async(self, request):
        r"""操作堡垒机实例资源标签
    ...
    def batch_create_instance_tag_async_invoker(self, request):
        http_info = self._batch_create_instance_tag_http_info(request)
        return AsyncInvoker(self, http_info)

    def _batch_create_instance_tag_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def change_instance_type_async(self, request):
        r"""修改单机堡垒机实例类型
    ...
    def change_instance_type_async_invoker(self, request):
        http_info = self._change_instance_type_http_info(request)
        return AsyncInvoker(self, http_info)

    def _change_instance_type_http_info(self, request):
        http_info = {
            "method": "PUT",
    ...
    def count_instances_by_tag_async(self, request):
        r"""统计符合标签条件的实例数量
    ...
    def count_instances_by_tag_async_invoker(self, request):
        http_info = self._count_instances_by_tag_http_info(request)
        return AsyncInvoker(self, http_info)

    def _count_instances_by_tag_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def list_instances_by_tag_async(self, request):
        r"""使用标签过滤实例
    ...
    def list_instances_by_tag_async_invoker(self, request):
        http_info = self._list_instances_by_tag_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_instances_by_tag_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def list_specifications_async(self, request):
        r"""查询云堡垒机规格信息
    ...
    def list_specifications_async_invoker(self, request):
        http_info = self._list_specifications_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_specifications_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_switch_config_info_async(self, request):
        r"""获取后端开关控制信息列表
    ...
    def list_switch_config_info_async_invoker(self, request):
        http_info = self._list_switch_config_info_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_switch_config_info_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def login_instance_async(self, request):
    ...
    def login_instance_async_invoker(self, request):
        http_info = self._login_instance_http_info(request)
        return AsyncInvoker(self, http_info)

    def _login_instance_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def login_instance_admin_async(self, request):
    ...
    def login_instance_admin_async_invoker(self, request):
        http_info = self._login_instance_admin_http_info(request)
        return AsyncInvoker(self, http_info)

    def _login_instance_admin_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def reboot_instance_async(self, request):
        r"""重启堡垒机实例
    ...
    def reboot_instance_async_invoker(self, request):
        http_info = self._reboot_instance_http_info(request)
        return AsyncInvoker(self, http_info)

    def _reboot_instance_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def register_authorization_async(self, request):
    ...
    def register_authorization_async_invoker(self, request):
        http_info = self._register_authorization_http_info(request)
        return AsyncInvoker(self, http_info)

    def _register_authorization_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def reset_instance_login_method_async(self, request):
        r"""重置堡垒机实例admin登录方式
    ...
    def reset_instance_login_method_async_invoker(self, request):
        http_info = self._reset_instance_login_method_http_info(request)
        return AsyncInvoker(self, http_info)

    def _reset_instance_login_method_http_info(self, request):
        http_info = {
            "method": "PUT",
    ...
    def reset_instance_password_async(self, request):
        r"""重置堡垒机实例admin密码
    ...
    def reset_instance_password_async_invoker(self, request):
        http_info = self._reset_instance_password_http_info(request)
        return AsyncInvoker(self, http_info)

    def _reset_instance_password_http_info(self, request):
        http_info = {
            "method": "PUT",
    ...
    def rollback_instance_async(self, request):
        r"""回退升级的堡垒机实例
    ...
    def rollback_instance_async_invoker(self, request):
        http_info = self._rollback_instance_http_info(request)
        return AsyncInvoker(self, http_info)

    def _rollback_instance_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def show_authorization_async(self, request):
        r"""获取租户给云堡垒机服务委托授权信息
    ...
    def show_authorization_async_invoker(self, request):
        http_info = self._show_authorization_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_authorization_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v2/{project_id}/cbs/agency/authorization",
            "request_type": request.__class__.__name__,
    ...
    def show_ecs_quota_async(self, request):
    ...
    def show_ecs_quota_async_invoker(self, request):
        http_info = self._show_ecs_quota_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_ecs_quota_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_om_url_async(self, request):
        r"""获取运维链接
    ...
    def show_om_url_async_invoker(self, request):
        http_info = self._show_om_url_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_om_url_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def switch_instance_vpc_async(self, request):
        r"""切换堡垒机虚拟私有云
    ...
    def switch_instance_vpc_async_invoker(self, request):
        http_info = self._switch_instance_vpc_http_info(request)
        return AsyncInvoker(self, http_info)

    def _switch_instance_vpc_http_info(self, request):
        http_info = {
            "method": "PUT",
