...
class ListSpecificationsResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListSpecificationsResponse.to_dict() is deprecated and no longer maintained, "
