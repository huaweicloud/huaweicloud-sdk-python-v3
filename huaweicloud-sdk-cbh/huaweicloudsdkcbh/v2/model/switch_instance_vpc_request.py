...
class SwitchInstanceVpcRequest:
    ...
    openapi_types = {
        'body': 'SwitchVirtualPrivateCloudRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the SwitchInstanceVpcRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SwitchInstanceVpcRequest):
            return False
