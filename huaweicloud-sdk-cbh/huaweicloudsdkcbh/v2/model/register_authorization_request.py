...
class RegisterAuthorizationRequest:
    ...
    openapi_types = {
        'body': 'AuthorizeCsmsAndKmsRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the RegisterAuthorizationRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RegisterAuthorizationRequest):
            return False
