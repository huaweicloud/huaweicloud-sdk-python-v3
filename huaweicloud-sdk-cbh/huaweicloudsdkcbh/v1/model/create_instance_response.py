...
class CreateInstanceResponse(SdkResponse):
    ...
    def instance_key(self):
        """Gets the instance_key of this CreateInstanceResponse.

        云堡垒机实例key。

        :return: The instance_key of this CreateInstanceResponse.
        :rtype: int
        """
    ...
    def instance_key(self, instance_key):
        """Sets the instance_key of this CreateInstanceResponse.

        云堡垒机实例key。

        :param instance_key: The instance_key of this CreateInstanceResponse.
        :type instance_key: int
        """
    ...
    def slave_instance_key(self):
        """Gets the slave_instance_key of this CreateInstanceResponse.

        云堡垒机备机实例key。（当前字段未启用，返回默认值null）

        :return: The slave_instance_key of this CreateInstanceResponse.
        :rtype: int
        """
    ...
    def slave_instance_key(self, slave_instance_key):
        """Sets the slave_instance_key of this CreateInstanceResponse.

        云堡垒机备机实例key。（当前字段未启用，返回默认值null）

        :param slave_instance_key: The slave_instance_key of this CreateInstanceResponse.
        :type slave_instance_key: int
        """
    ...
    def request_info(self):
        """Gets the request_info of this CreateInstanceResponse.

        返回创建云堡垒机实例信息。

        :return: The request_info of this CreateInstanceResponse.
        :rtype: int
        """
    ...
    def request_info(self, request_info):
        """Sets the request_info of this CreateInstanceResponse.

        返回创建云堡垒机实例信息。

        :param request_info: The request_info of this CreateInstanceResponse.
        :type request_info: int
        """
