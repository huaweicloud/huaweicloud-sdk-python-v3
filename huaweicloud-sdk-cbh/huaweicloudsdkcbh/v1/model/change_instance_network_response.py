...
class ChangeInstanceNetworkResponse(SdkResponse):
    ...
    def __init__(self, status=None, security_grp_status=None, firewall_status=None, public_eip_status=None):
        r"""ChangeInstanceNetworkResponse
    ...
    @property
    def status(self):
        r"""Gets the status of this ChangeInstanceNetworkResponse.
    ...
    def status(self, status):
        r"""Sets the status of this ChangeInstanceNetworkResponse.
    ...
    def security_grp_status(self):
        r"""Gets the security_grp_status of this ChangeInstanceNetworkResponse.
    ...
    def security_grp_status(self, security_grp_status):
        r"""Sets the security_grp_status of this ChangeInstanceNetworkResponse.
    ...
    def firewall_status(self):
        r"""Gets the firewall_status of this ChangeInstanceNetworkResponse.
    ...
    def firewall_status(self, firewall_status):
        r"""Sets the firewall_status of this ChangeInstanceNetworkResponse.
    ...
    def public_eip_status(self):
        r"""Gets the public_eip_status of this ChangeInstanceNetworkResponse.
    ...
    def public_eip_status(self, public_eip_status):
        r"""Sets the public_eip_status of this ChangeInstanceNetworkResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ChangeInstanceNetworkResponse.to_dict() is deprecated and no longer maintained, "
