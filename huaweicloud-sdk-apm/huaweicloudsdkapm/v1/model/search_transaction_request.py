...
class SearchTransactionRequest:
    ...
    def __init__(self, x_business_id=None, body=None):
        ...
        :param body: Body of the SearchTransactionRequest
    ...
    def x_business_id(self):
        ...
        :return: The x_business_id of this SearchTransactionRequest.
        :rtype: int
        """
    ...
    def x_business_id(self, x_business_id):
        ...
        :param x_business_id: The x_business_id of this SearchTransactionRequest.
        :type x_business_id: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SearchTransactionRequest):
            return False
