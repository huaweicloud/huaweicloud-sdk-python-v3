...
class ListPermRulesResponse(SdkResponse):
    ...
    def rules(self):
        ...
        :return: The rules of this ListPermRulesResponse.
    ...
    def rules(self, rules):
        ...
        :param rules: The rules of this ListPermRulesResponse.
        :type rules: list[:class:`huaweicloudsdksfsturbo.v1.OnePermRuleResponseInfo`]
        """
        self._rules = rules
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListPermRulesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListPermRulesResponse):
            return False
