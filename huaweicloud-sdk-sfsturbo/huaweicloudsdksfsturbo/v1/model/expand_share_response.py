...
class ExpandShareResponse(SdkResponse):
    ...
    def id(self):
        ...
        :return: The id of this ExpandShareResponse.
        :rtype: str
        """
        return self._id
    ...
    def name(self):
        ...
        :return: The name of this ExpandShareResponse.
        :rtype: str
        """
        return self._name
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ExpandShareResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExpandShareResponse):
            return False
