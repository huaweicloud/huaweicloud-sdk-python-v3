...
class SetHpcCacheBackendResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("SetHpcCacheBackendResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SetHpcCacheBackendResponse):
            return False
