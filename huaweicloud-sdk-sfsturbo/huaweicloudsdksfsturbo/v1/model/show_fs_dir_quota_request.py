...
class ShowFsDirQuotaRequest:
    ...
    def path(self):
        ...
        :return: The path of this ShowFsDirQuotaRequest.
        :rtype: str
        """
        return self._path
    ...
    def path(self, path):
        ...
        :param path: The path of this ShowFsDirQuotaRequest.
        :type path: str
        """
        self._path = path
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowFsDirQuotaRequest):
            return False
