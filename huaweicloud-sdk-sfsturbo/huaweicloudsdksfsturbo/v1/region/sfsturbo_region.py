...
class SFSTurboRegion:
    ...
    CN_EAST_2 = Region(id="cn-east-2", endpoint="https://sfs-turbo.cn-east-2.myhuaweicloud.com")
    ...
    CN_NORTH_2 = Region(id="cn-north-2", endpoint="https://sfs-turbo.cn-north-2.myhuaweicloud.com")
