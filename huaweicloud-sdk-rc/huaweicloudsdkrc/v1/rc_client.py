...
class RcClient(Client):
    ...
    def new_builder(cls, clazz=None):
        if not clazz:
            ...
            if clazz.__name__ != "RcClient":
                raise TypeError("client type error, support client type is RcClient")
    ...
    def add_resources_to_group(self, request):
        r"""将资源添加到资源组
    ...
    def add_resources_to_group_invoker(self, request):
        http_info = self._add_resources_to_group_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _add_resources_to_group_http_info(cls, request):
        http_info = {
            "method": "PUT",
    ...
    def remove_resource_from_group(self, request):
        r"""从资源组中移除资源
    ...
    def remove_resource_from_group_invoker(self, request):
        http_info = self._remove_resource_from_group_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _remove_resource_from_group_http_info(cls, request):
        http_info = {
            "method": "DELETE",
