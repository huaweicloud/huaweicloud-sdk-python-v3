...
class ShowResourceByIdResponse(SdkResponse):
    ...
    @property
    def group_id(self):
        r"""Gets the group_id of this ShowResourceByIdResponse.

        资源组id

        :return: The group_id of this ShowResourceByIdResponse.
        :rtype: str
        """
    ...
    def group_id(self, group_id):
        r"""Sets the group_id of this ShowResourceByIdResponse.

        资源组id

        :param group_id: The group_id of this ShowResourceByIdResponse.
        :type group_id: str
        """
    ...
    @property
    def state(self):
        r"""Gets the state of this ShowResourceByIdResponse.

        资源状态，保有中（Normal）/已删除(Deleted)

        :return: The state of this ShowResourceByIdResponse.
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        r"""Sets the state of this ShowResourceByIdResponse.

        资源状态，保有中（Normal）/已删除(Deleted)

        :param state: The state of this ShowResourceByIdResponse.
        :type state: str
        """
        self._state = state
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowResourceByIdResponse.to_dict() is deprecated and no longer maintained, "
