...
class ListStoredQueriesResponse(SdkResponse):
    ...
    def __init__(self, value=None, page_info=None):
        ...
        :param value: 高级查询列表
        :type value: list[:class:`huaweicloudsdkrc.v1.StoredQuery`]
        :param page_info: 
    ...
    def value(self):
        ...
        :rtype: list[:class:`huaweicloudsdkrc.v1.StoredQuery`]
        """
        return self._value
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListStoredQueriesResponse.to_dict() is deprecated and no longer maintained, "
