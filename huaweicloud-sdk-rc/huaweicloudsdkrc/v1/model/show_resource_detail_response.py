...
class ShowResourceDetailResponse(SdkResponse):
    ...
    @property
    def group_id(self):
        r"""Gets the group_id of this ShowResourceDetailResponse.

        资源组id

        :return: The group_id of this ShowResourceDetailResponse.
        :rtype: str
        """
    ...
    def group_id(self, group_id):
        r"""Sets the group_id of this ShowResourceDetailResponse.

        资源组id

        :param group_id: The group_id of this ShowResourceDetailResponse.
        :type group_id: str
        """
