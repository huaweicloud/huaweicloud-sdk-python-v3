...
class ListAllTagsResponse(SdkResponse):
    ...
    def __init__(self, tags=None, page_info=None):
        ...
        :param tags: 标签列表
        :type tags: list[:class:`huaweicloudsdkrc.v1.TagDetail`]
        :param page_info: 
    ...
    def tags(self):
        ...
        :rtype: list[:class:`huaweicloudsdkrc.v1.TagDetail`]
        """
        return self._tags
    ...
    @property
    def page_info(self):
        r"""Gets the page_info of this ListAllTagsResponse.
    ...
    def page_info(self, page_info):
        r"""Sets the page_info of this ListAllTagsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAllTagsResponse.to_dict() is deprecated and no longer maintained, "
