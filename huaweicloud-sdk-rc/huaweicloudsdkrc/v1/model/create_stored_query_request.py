...
class CreateStoredQueryRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateStoredQueryRequest
        :type body: :class:`huaweicloudsdkrc.v1.StoredQueryRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkrc.v1.StoredQueryRequestBody`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateStoredQueryRequest):
            return False
