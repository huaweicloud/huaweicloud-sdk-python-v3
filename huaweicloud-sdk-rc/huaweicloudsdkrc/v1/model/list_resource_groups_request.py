...
class ListResourceGroupsRequest:
    ...
    @property
    def marker(self):
        r"""Gets the marker of this ListResourceGroupsRequest.

        分页参数，通过上一个请求中返回的marker信息作为输入，获取当前页

        :return: The marker of this ListResourceGroupsRequest.
        :rtype: str
        """
        return self._marker
    ...
    def marker(self, marker):
        r"""Sets the marker of this ListResourceGroupsRequest.

        分页参数，通过上一个请求中返回的marker信息作为输入，获取当前页

        :param marker: The marker of this ListResourceGroupsRequest.
        :type marker: str
        """
        self._marker = marker
