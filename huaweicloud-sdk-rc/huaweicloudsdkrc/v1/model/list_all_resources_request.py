...
class ListAllResourcesRequest:
    ...
    def __init__(self, region_id=None, ep_id=None, type=None, limit=None, marker=None, id=None, name=None, tags=None, group_id=None, sort_key=None, sort_value=None):
        ...
        :type group_id: str
        :param sort_key: 排序字段列表，仅支持createdAt和updatedAt
        :type sort_key: list[str]
        :param sort_value: 排序顺序列表，仅支持asc和desc
        :type sort_value: list[str]
        """
    ...
    @property
    def group_id(self):
        r"""Gets the group_id of this ListAllResourcesRequest.

        资源组ID

        :return: The group_id of this ListAllResourcesRequest.
        :rtype: str
        """
    ...
    def group_id(self, group_id):
        r"""Sets the group_id of this ListAllResourcesRequest.

        资源组ID

        :param group_id: The group_id of this ListAllResourcesRequest.
        :type group_id: str
        """
    ...
    @property
    def sort_key(self):
        r"""Gets the sort_key of this ListAllResourcesRequest.

        排序字段列表，仅支持createdAt和updatedAt

        :return: The sort_key of this ListAllResourcesRequest.
        :rtype: list[str]
        """
    ...
    def sort_key(self, sort_key):
        r"""Sets the sort_key of this ListAllResourcesRequest.

        排序字段列表，仅支持createdAt和updatedAt

        :param sort_key: The sort_key of this ListAllResourcesRequest.
        :type sort_key: list[str]
        """
    ...
    @property
    def sort_value(self):
        r"""Gets the sort_value of this ListAllResourcesRequest.

        排序顺序列表，仅支持asc和desc

        :return: The sort_value of this ListAllResourcesRequest.
        :rtype: list[str]
        """
    ...
    def sort_value(self, sort_value):
        r"""Sets the sort_value of this ListAllResourcesRequest.

        排序顺序列表，仅支持asc和desc

        :param sort_value: The sort_value of this ListAllResourcesRequest.
        :type sort_value: list[str]
        """
