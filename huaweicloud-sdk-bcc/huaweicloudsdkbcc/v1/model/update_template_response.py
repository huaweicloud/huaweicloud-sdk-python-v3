...
class UpdateTemplateResponse(SdkResponse):
    ...
    def body(self):
        ...
        :return: The body of this UpdateTemplateResponse.
        :rtype: str
        """
        return self._body
    ...
    def body(self, body):
        ...
        :param body: The body of this UpdateTemplateResponse.
        :type body: str
        """
        self._body = body
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateTemplateResponse.to_dict() is deprecated and no longer maintained, "
