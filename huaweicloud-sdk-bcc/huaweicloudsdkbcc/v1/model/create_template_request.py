...
class CreateTemplateRequest:
    ...
    def __init__(self, domain_id=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkbcc.v1.TemplateSetting`
        """
    ...
    @property
    def domain_id(self):
        r"""Gets the domain_id of this CreateTemplateRequest.

        账号ID

        :return: The domain_id of this CreateTemplateRequest.
        :rtype: str
        """
    ...
    def domain_id(self, domain_id):
        r"""Sets the domain_id of this CreateTemplateRequest.

        账号ID

        :param domain_id: The domain_id of this CreateTemplateRequest.
        :type domain_id: str
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkbcc.v1.TemplateSetting`
        """
        return self._body
