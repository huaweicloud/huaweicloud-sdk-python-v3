...
class BackupComplianceRule:
    ...
    @property
    def id(self):
        r"""Gets the id of this BackupComplianceRule.

        id

        :return: The id of this BackupComplianceRule.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this BackupComplianceRule.

        id

        :param id: The id of this BackupComplianceRule.
        :type id: str
        """
        self._id = id
    ...
    def is_system_embedded(self):
        r"""Gets the is_system_embedded of this BackupComplianceRule.

        是否系统内置规则

        :return: The is_system_embedded of this BackupComplianceRule.
        :rtype: bool
        """
    ...
    def is_system_embedded(self, is_system_embedded):
        r"""Sets the is_system_embedded of this BackupComplianceRule.

        是否系统内置规则

        :param is_system_embedded: The is_system_embedded of this BackupComplianceRule.
        :type is_system_embedded: bool
        """
    ...
    @property
    def domain_id(self):
        r"""Gets the domain_id of this BackupComplianceRule.

        账号ID

        :return: The domain_id of this BackupComplianceRule.
        :rtype: str
        """
    ...
    def domain_id(self, domain_id):
        r"""Sets the domain_id of this BackupComplianceRule.

        账号ID

        :param domain_id: The domain_id of this BackupComplianceRule.
        :type domain_id: str
        """
    ...
    def resource_type(self):
        r"""Gets the resource_type of this BackupComplianceRule.

        资源类型

        :return: The resource_type of this BackupComplianceRule.
        :rtype: str
        """
    ...
    def resource_type(self, resource_type):
        r"""Sets the resource_type of this BackupComplianceRule.

        资源类型

        :param resource_type: The resource_type of this BackupComplianceRule.
        :type resource_type: str
        """
    ...
    def backup_type(self):
        r"""Gets the backup_type of this BackupComplianceRule.

        备份类型

        :return: The backup_type of this BackupComplianceRule.
        :rtype: str
        """
    ...
    def backup_type(self, backup_type):
        r"""Sets the backup_type of this BackupComplianceRule.

        备份类型

        :param backup_type: The backup_type of this BackupComplianceRule.
        :type backup_type: str
        """
    ...
    def local_backup_enabled(self):
        r"""Gets the local_backup_enabled of this BackupComplianceRule.

        是否启用本地备份

        :return: The local_backup_enabled of this BackupComplianceRule.
        :rtype: bool
        """
    ...
    def local_backup_enabled(self, local_backup_enabled):
        r"""Sets the local_backup_enabled of this BackupComplianceRule.

        是否启用本地备份

        :param local_backup_enabled: The local_backup_enabled of this BackupComplianceRule.
        :type local_backup_enabled: bool
        """
    ...
    def local_backup_retention(self):
        r"""Gets the local_backup_retention of this BackupComplianceRule.

        本地备份副本保留时长

        :return: The local_backup_retention of this BackupComplianceRule.
        :rtype: int
        """
    ...
    def local_backup_retention(self, local_backup_retention):
        r"""Sets the local_backup_retention of this BackupComplianceRule.

        本地备份副本保留时长

        :param local_backup_retention: The local_backup_retention of this BackupComplianceRule.
        :type local_backup_retention: int
        """
    ...
    def local_backup_frequency(self):
        r"""Gets the local_backup_frequency of this BackupComplianceRule.

        :return: The local_backup_frequency of this BackupComplianceRule.
    ...
    def local_backup_frequency(self, local_backup_frequency):
        r"""Sets the local_backup_frequency of this BackupComplianceRule.

        :param local_backup_frequency: The local_backup_frequency of this BackupComplianceRule.
        :type local_backup_frequency: :class:`huaweicloudsdkbcc.v1.BackupComplianceRuleLocalBackupFrequency`
        """
    ...
    def remote_backup_enabled(self):
        r"""Gets the remote_backup_enabled of this BackupComplianceRule.

        是否启用异地复制。

        :return: The remote_backup_enabled of this BackupComplianceRule.
        :rtype: bool
        """
    ...
    def remote_backup_enabled(self, remote_backup_enabled):
        r"""Sets the remote_backup_enabled of this BackupComplianceRule.

        是否启用异地复制。

        :param remote_backup_enabled: The remote_backup_enabled of this BackupComplianceRule.
        :type remote_backup_enabled: bool
        """
    ...
    def remote_backup_retention(self):
        r"""Gets the remote_backup_retention of this BackupComplianceRule.

        异地复制副本保留时长。

        :return: The remote_backup_retention of this BackupComplianceRule.
        :rtype: int
        """
    ...
    def remote_backup_retention(self, remote_backup_retention):
        r"""Sets the remote_backup_retention of this BackupComplianceRule.

        异地复制副本保留时长。

        :param remote_backup_retention: The remote_backup_retention of this BackupComplianceRule.
        :type remote_backup_retention: int
        """
    ...
    def local_worm_enabled(self):
        r"""Gets the local_worm_enabled of this BackupComplianceRule.

        本地副本是否启用WORM特性。

        :return: The local_worm_enabled of this BackupComplianceRule.
        :rtype: bool
        """
    ...
    def local_worm_enabled(self, local_worm_enabled):
        r"""Sets the local_worm_enabled of this BackupComplianceRule.

        本地副本是否启用WORM特性。

        :param local_worm_enabled: The local_worm_enabled of this BackupComplianceRule.
        :type local_worm_enabled: bool
        """
    ...
    def remote_worm_enabled(self):
        r"""Gets the remote_worm_enabled of this BackupComplianceRule.

        异地复制副本是否启用WORM特性。

        :return: The remote_worm_enabled of this BackupComplianceRule.
        :rtype: bool
        """
    ...
    def remote_worm_enabled(self, remote_worm_enabled):
        r"""Sets the remote_worm_enabled of this BackupComplianceRule.

        异地复制副本是否启用WORM特性。

        :param remote_worm_enabled: The remote_worm_enabled of this BackupComplianceRule.
        :type remote_worm_enabled: bool
        """
    ...
    def is_cross_account_backup_forced(self):
        r"""Gets the is_cross_account_backup_forced of this BackupComplianceRule.

        是否开启强制跨账号备份

        :return: The is_cross_account_backup_forced of this BackupComplianceRule.
        :rtype: bool
        """
    ...
    def is_cross_account_backup_forced(self, is_cross_account_backup_forced):
        r"""Sets the is_cross_account_backup_forced of this BackupComplianceRule.

        是否开启强制跨账号备份

        :param is_cross_account_backup_forced: The is_cross_account_backup_forced of this BackupComplianceRule.
        :type is_cross_account_backup_forced: bool
        """
    ...
    def description(self):
        r"""Gets the description of this BackupComplianceRule.

        规则描述

        :return: The description of this BackupComplianceRule.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this BackupComplianceRule.

        规则描述

        :param description: The description of this BackupComplianceRule.
        :type description: str
        """
    ...
    @property
    def created(self):
        r"""Gets the created of this BackupComplianceRule.

        规则创建时间

        :return: The created of this BackupComplianceRule.
        :rtype: int
        """
    ...
    def created(self, created):
        r"""Sets the created of this BackupComplianceRule.

        规则创建时间

        :param created: The created of this BackupComplianceRule.
        :type created: int
        """
    ...
    @property
    def updated(self):
        r"""Gets the updated of this BackupComplianceRule.

        规则更新时间

        :return: The updated of this BackupComplianceRule.
        :rtype: int
        """
    ...
    def updated(self, updated):
        r"""Sets the updated of this BackupComplianceRule.

        规则更新时间

        :param updated: The updated of this BackupComplianceRule.
        :type updated: int
        """
    ...
    @property
    def name(self):
        r"""Gets the name of this BackupComplianceRule.

        合规规则名称

        :return: The name of this BackupComplianceRule.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this BackupComplianceRule.

        合规规则名称

        :param name: The name of this BackupComplianceRule.
        :type name: str
        """
        self._name = name
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BackupComplianceRule):
            return False
