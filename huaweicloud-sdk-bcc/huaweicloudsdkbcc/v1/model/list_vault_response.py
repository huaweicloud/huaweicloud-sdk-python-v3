...
class ListVaultResponse(SdkResponse):
    ...
    def __init__(self, vaults=None, count=None):
        ...
        :type vaults: list[:class:`huaweicloudsdkbcc.v1.CbrVaultDetail`]
        :param count: 存储库个数
        :type count: int
        """
    ...
    def vaults(self):
        ...
        :rtype: list[:class:`huaweicloudsdkbcc.v1.CbrVaultDetail`]
        """
        return self._vaults
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListVaultResponse.to_dict() is deprecated and no longer maintained, "
