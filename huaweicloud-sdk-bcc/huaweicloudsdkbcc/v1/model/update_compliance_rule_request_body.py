...
class UpdateComplianceRuleRequestBody:
    ...
    openapi_types = {
        ...
        'local_backup_frequency': 'UpdateComplianceRuleRequestBodyLocalBackupFrequency',
    ...
    def __init__(self, local_backup_enabled=None, local_backup_retention=None, local_backup_frequency=None, remote_backup_enabled=None, remote_backup_retention=None, local_worm_enabled=None, remote_worm_enabled=None, is_cross_account_backup_forced=None, description=None):
        r"""UpdateComplianceRuleRequestBody
        ...
        :type local_backup_frequency: :class:`huaweicloudsdkbcc.v1.UpdateComplianceRuleRequestBodyLocalBackupFrequency`
        ...
        :param remote_worm_enabled: 异地复制副本是否开启WORM特性
    ...
    def local_backup_enabled(self):
        r"""Gets the local_backup_enabled of this UpdateComplianceRuleRequestBody.

        是否启用本地备份

        :return: The local_backup_enabled of this UpdateComplianceRuleRequestBody.
        :rtype: bool
        """
    ...
    def local_backup_enabled(self, local_backup_enabled):
        r"""Sets the local_backup_enabled of this UpdateComplianceRuleRequestBody.

        是否启用本地备份

        :param local_backup_enabled: The local_backup_enabled of this UpdateComplianceRuleRequestBody.
        :type local_backup_enabled: bool
        """
    ...
    def local_backup_retention(self):
        r"""Gets the local_backup_retention of this UpdateComplianceRuleRequestBody.

        本地备份副本保留时长

        :return: The local_backup_retention of this UpdateComplianceRuleRequestBody.
        :rtype: int
        """
    ...
    def local_backup_retention(self, local_backup_retention):
        r"""Sets the local_backup_retention of this UpdateComplianceRuleRequestBody.

        本地备份副本保留时长

        :param local_backup_retention: The local_backup_retention of this UpdateComplianceRuleRequestBody.
        :type local_backup_retention: int
        """
    ...
    def local_backup_frequency(self):
        r"""Gets the local_backup_frequency of this UpdateComplianceRuleRequestBody.

        :return: The local_backup_frequency of this UpdateComplianceRuleRequestBody.
        :rtype: :class:`huaweicloudsdkbcc.v1.UpdateComplianceRuleRequestBodyLocalBackupFrequency`
        """
        return self._local_backup_frequency

    @local_backup_frequency.setter
    def local_backup_frequency(self, local_backup_frequency):
        r"""Sets the local_backup_frequency of this UpdateComplianceRuleRequestBody.

        :param local_backup_frequency: The local_backup_frequency of this UpdateComplianceRuleRequestBody.
        :type local_backup_frequency: :class:`huaweicloudsdkbcc.v1.UpdateComplianceRuleRequestBodyLocalBackupFrequency`
        """
    ...
    def remote_backup_enabled(self):
        r"""Gets the remote_backup_enabled of this UpdateComplianceRuleRequestBody.

        是否启用异地复制

        :return: The remote_backup_enabled of this UpdateComplianceRuleRequestBody.
        :rtype: bool
        """
    ...
    def remote_backup_enabled(self, remote_backup_enabled):
        r"""Sets the remote_backup_enabled of this UpdateComplianceRuleRequestBody.

        是否启用异地复制

        :param remote_backup_enabled: The remote_backup_enabled of this UpdateComplianceRuleRequestBody.
        :type remote_backup_enabled: bool
        """
    ...
    def remote_backup_retention(self):
        r"""Gets the remote_backup_retention of this UpdateComplianceRuleRequestBody.

        异地复制副本保留时长。

        :return: The remote_backup_retention of this UpdateComplianceRuleRequestBody.
        :rtype: int
        """
    ...
    def remote_backup_retention(self, remote_backup_retention):
        r"""Sets the remote_backup_retention of this UpdateComplianceRuleRequestBody.

        异地复制副本保留时长。

        :param remote_backup_retention: The remote_backup_retention of this UpdateComplianceRuleRequestBody.
        :type remote_backup_retention: int
        """
    ...
    def local_worm_enabled(self):
        r"""Gets the local_worm_enabled of this UpdateComplianceRuleRequestBody.

        本地副本是否启用WORM特性。

        :return: The local_worm_enabled of this UpdateComplianceRuleRequestBody.
        :rtype: bool
        """
    ...
    def local_worm_enabled(self, local_worm_enabled):
        r"""Sets the local_worm_enabled of this UpdateComplianceRuleRequestBody.

        本地副本是否启用WORM特性。

        :param local_worm_enabled: The local_worm_enabled of this UpdateComplianceRuleRequestBody.
        :type local_worm_enabled: bool
        """
    ...
    def remote_worm_enabled(self):
        r"""Gets the remote_worm_enabled of this UpdateComplianceRuleRequestBody.

        异地复制副本是否开启WORM特性

        :return: The remote_worm_enabled of this UpdateComplianceRuleRequestBody.
        :rtype: bool
        """
    ...
    def remote_worm_enabled(self, remote_worm_enabled):
        r"""Sets the remote_worm_enabled of this UpdateComplianceRuleRequestBody.

        异地复制副本是否开启WORM特性

        :param remote_worm_enabled: The remote_worm_enabled of this UpdateComplianceRuleRequestBody.
        :type remote_worm_enabled: bool
        """
    ...
    def is_cross_account_backup_forced(self):
        r"""Gets the is_cross_account_backup_forced of this UpdateComplianceRuleRequestBody.

        是否强制开启跨账号备份

        :return: The is_cross_account_backup_forced of this UpdateComplianceRuleRequestBody.
        :rtype: bool
        """
    ...
    def is_cross_account_backup_forced(self, is_cross_account_backup_forced):
        r"""Sets the is_cross_account_backup_forced of this UpdateComplianceRuleRequestBody.

        是否强制开启跨账号备份

        :param is_cross_account_backup_forced: The is_cross_account_backup_forced of this UpdateComplianceRuleRequestBody.
        :type is_cross_account_backup_forced: bool
        """
    ...
    def description(self):
        r"""Gets the description of this UpdateComplianceRuleRequestBody.

        规则描述

        :return: The description of this UpdateComplianceRuleRequestBody.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this UpdateComplianceRuleRequestBody.

        规则描述

        :param description: The description of this UpdateComplianceRuleRequestBody.
        :type description: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateComplianceRuleRequestBody):
            return False
