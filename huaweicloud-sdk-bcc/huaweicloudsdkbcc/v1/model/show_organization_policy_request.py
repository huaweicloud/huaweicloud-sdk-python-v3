...
class ShowOrganizationPolicyRequest:
    ...
    def __init__(self, domain_id=None, organization_policy_id=None):
    ...
    @property
    def domain_id(self):
        r"""Gets the domain_id of this ShowOrganizationPolicyRequest.

        账号ID

        :return: The domain_id of this ShowOrganizationPolicyRequest.
        :rtype: str
        """
    ...
    def domain_id(self, domain_id):
        r"""Sets the domain_id of this ShowOrganizationPolicyRequest.

        账号ID

        :param domain_id: The domain_id of this ShowOrganizationPolicyRequest.
        :type domain_id: str
        """
