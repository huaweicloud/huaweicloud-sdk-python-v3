...
class ShowPolicyRequest:
    ...
    def __init__(self, domain_id=None, policy_id=None):
        r"""ShowPolicyRequest
    ...
    @property
    def domain_id(self):
        r"""Gets the domain_id of this ShowPolicyRequest.

        账号ID

        :return: The domain_id of this ShowPolicyRequest.
        :rtype: str
        """
    ...
    def domain_id(self, domain_id):
        r"""Sets the domain_id of this ShowPolicyRequest.

        账号ID

        :param domain_id: The domain_id of this ShowPolicyRequest.
        :type domain_id: str
        """
