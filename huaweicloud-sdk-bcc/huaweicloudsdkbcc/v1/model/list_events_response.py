...
class ListEventsResponse(SdkResponse):
    ...
    def __init__(self, count=None, next_marker=None, events=None):
        r"""ListEventsResponse

        The model defined in huaweicloud sdk

        :param count: 本次分页查询响应的事件条数
        :type count: int
        :param next_marker: 下一页的marker
        :type next_marker: str
        :param events: 事件
        :type events: list[:class:`huaweicloudsdkbcc.v1.EventEntity`]
        """
    ...
    def events(self):
        ...
        :rtype: list[:class:`huaweicloudsdkbcc.v1.EventEntity`]
        """
        return self._events
