...
class ShowVaultRequest:
    ...
    def __init__(self, domain_id=None, vault_id=None):
        r"""ShowVaultRequest
    ...
    @property
    def domain_id(self):
        r"""Gets the domain_id of this ShowVaultRequest.

        账号ID

        :return: The domain_id of this ShowVaultRequest.
        :rtype: str
        """
    ...
    def domain_id(self, domain_id):
        r"""Sets the domain_id of this ShowVaultRequest.

        账号ID

        :param domain_id: The domain_id of this ShowVaultRequest.
        :type domain_id: str
        """
