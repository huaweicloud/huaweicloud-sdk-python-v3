...
class BatchDeleteCertTagsRequest:
    ...
    def __init__(self, certificate_id=None, body=None):
        ...
        :param certificate_id: 所需要批量删除标签的证书ID。
        :type certificate_id: str
        :param body: Body of the BatchDeleteCertTagsRequest
    ...
    def certificate_id(self):
        ...
        :return: The certificate_id of this BatchDeleteCertTagsRequest.
        :rtype: str
        """
    ...
    def certificate_id(self, certificate_id):
        ...
        :param certificate_id: The certificate_id of this BatchDeleteCertTagsRequest.
        :type certificate_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteCertTagsRequest):
            return False
