...
class CreateCertificateByCsrResponse(SdkResponse):
    ...
    def certificate_id(self):
        ...
        :return: The certificate_id of this CreateCertificateByCsrResponse.
        :rtype: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateCertificateByCsrResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateCertificateByCsrResponse):
            return False
