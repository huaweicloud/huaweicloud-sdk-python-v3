...
class BatchDeleteCaTagsRequest:
    ...
    def __init__(self, ca_id=None, body=None):
        ...
        :param ca_id: 所需要批量删除标签的CA证书ID。
        :type ca_id: str
        :param body: Body of the BatchDeleteCaTagsRequest
    ...
    def ca_id(self):
        ...
        :return: The ca_id of this BatchDeleteCaTagsRequest.
        :rtype: str
        """
        return self._ca_id
    ...
    def ca_id(self, ca_id):
        ...
        :param ca_id: The ca_id of this BatchDeleteCaTagsRequest.
        :type ca_id: str
        """
        self._ca_id = ca_id
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteCaTagsRequest):
            return False
