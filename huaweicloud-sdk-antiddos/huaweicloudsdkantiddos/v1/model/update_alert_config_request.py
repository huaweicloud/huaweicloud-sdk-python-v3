...
class UpdateAlertConfigRequest:
    ...
    openapi_types = {
        'body': 'UpdateAlertConfigRequestBody'
    }
    ...
    def __init__(self, body=None):
        """UpdateAlertConfigRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: UpdateAlertConfigRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateAlertConfigRequest):
            return False
