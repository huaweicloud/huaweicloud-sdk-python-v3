...
class DdosConfig:
    ...
    def __init__(self, enable_l7=None, traffic_pos_id=None, http_request_pos_id=None, cleaning_access_pos_id=None, app_type_id=None):
        """DdosConfig - a model defined in huaweicloud sdk"""
    ...
    @property
    def enable_l7(self):
        """Gets the enable_l7 of this DdosConfig.

        是否开启L7层防护

        :return: The enable_l7 of this DdosConfig.
        :rtype: bool
        """
    ...
    def enable_l7(self, enable_l7):
        """Sets the enable_l7 of this DdosConfig.

        是否开启L7层防护

        :param enable_l7: The enable_l7 of this DdosConfig.
        :type: bool
        """
    ...
    def traffic_pos_id(self):
        """Gets the traffic_pos_id of this DdosConfig.

        流量分段ID，取值范围：1～9

        :return: The traffic_pos_id of this DdosConfig.
        :rtype: int
        """
    ...
    def traffic_pos_id(self, traffic_pos_id):
        """Sets the traffic_pos_id of this DdosConfig.

        流量分段ID，取值范围：1～9

        :param traffic_pos_id: The traffic_pos_id of this DdosConfig.
        :type: int
        """
    ...
    def http_request_pos_id(self):
        """Gets the http_request_pos_id of this DdosConfig.

        HTTP请求数分段ID，取值范围：1～15

        :return: The http_request_pos_id of this DdosConfig.
        :rtype: int
        """
    ...
    def http_request_pos_id(self, http_request_pos_id):
        """Sets the http_request_pos_id of this DdosConfig.

        HTTP请求数分段ID，取值范围：1～15

        :param http_request_pos_id: The http_request_pos_id of this DdosConfig.
        :type: int
        """
    ...
    def cleaning_access_pos_id(self):
        """Gets the cleaning_access_pos_id of this DdosConfig.

        清洗时访问限制分段ID，取值范围：1～8

        :return: The cleaning_access_pos_id of this DdosConfig.
        :rtype: int
        """
    ...
    def cleaning_access_pos_id(self, cleaning_access_pos_id):
        """Sets the cleaning_access_pos_id of this DdosConfig.

        清洗时访问限制分段ID，取值范围：1～8

        :param cleaning_access_pos_id: The cleaning_access_pos_id of this DdosConfig.
        :type: int
        """
    ...
    def app_type_id(self):
        """Gets the app_type_id of this DdosConfig.

        应用类型ID，可选取值： - 0 - 1

        :return: The app_type_id of this DdosConfig.
        :rtype: int
        """
    ...
    def app_type_id(self, app_type_id):
        """Sets the app_type_id of this DdosConfig.

        应用类型ID，可选取值： - 0 - 1

        :param app_type_id: The app_type_id of this DdosConfig.
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DdosConfig):
            return False
