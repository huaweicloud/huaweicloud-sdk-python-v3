...
class ListDailyReportRequest:
    ...
    def floating_ip_id(self):
        r"""Gets the floating_ip_id of this ListDailyReportRequest.

        用户EIP对应的ID

        :return: The floating_ip_id of this ListDailyReportRequest.
        :rtype: str
        """
    ...
    def floating_ip_id(self, floating_ip_id):
        r"""Sets the floating_ip_id of this ListDailyReportRequest.
    ...
    @property
    def ip(self):
        r"""Gets the ip of this ListDailyReportRequest.

        用户EIP

        :return: The ip of this ListDailyReportRequest.
        :rtype: str
        """
        return self._ip
    ...
    @ip.setter
    def ip(self, ip):
        r"""Sets the ip of this ListDailyReportRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListDailyReportRequest):
            return False
