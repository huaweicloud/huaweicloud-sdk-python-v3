...
class AntiDDoSAsyncClient(Client):
    ...
    def enable_defense_policy_async(self, request):
        r"""开通DDoS服务
    ...
    def enable_defense_policy_async_invoker(self, request):
        http_info = self._enable_defense_policy_http_info(request)
        return AsyncInvoker(self, http_info)

    def _enable_defense_policy_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def show_log_config_async(self, request):
        r"""查询全量日志设置
    ...
    def show_log_config_async_invoker(self, request):
        http_info = self._show_log_config_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_log_config_http_info(self, request):
        http_info = {
            "method": "GET",
