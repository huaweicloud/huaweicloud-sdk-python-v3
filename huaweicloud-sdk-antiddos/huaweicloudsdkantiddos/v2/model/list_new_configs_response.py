...
class ListNewConfigsResponse(SdkResponse):
    ...
    def __init__(self, traffic_limited_list=None, http_limited_list=None, connection_limited_list=None, extend_ddos_config=None):
        ...
        :type traffic_limited_list: list[:class:`huaweicloudsdkantiddos.v2.TriggerBpsDict`]
        :param http_limited_list: HTTP限制列表
        :type http_limited_list: list[:class:`huaweicloudsdkantiddos.v2.TriggerQpsDict`]
        :param connection_limited_list: 连接数限制列表
        :type connection_limited_list: list[:class:`huaweicloudsdkantiddos.v2.CleanLimitDict`]
        :param extend_ddos_config: 扩展配置列表
        :type extend_ddos_config: list[:class:`huaweicloudsdkantiddos.v2.ExtendDDoSSet`]
        """
    ...
    def traffic_limited_list(self):
        ...
        :rtype: list[:class:`huaweicloudsdkantiddos.v2.TriggerBpsDict`]
        """
    ...
    def http_limited_list(self):
        ...
        :rtype: list[:class:`huaweicloudsdkantiddos.v2.TriggerQpsDict`]
        """
    ...
    def connection_limited_list(self):
        ...
        :rtype: list[:class:`huaweicloudsdkantiddos.v2.CleanLimitDict`]
        """
    ...
    def extend_ddos_config(self):
        ...
        :rtype: list[:class:`huaweicloudsdkantiddos.v2.ExtendDDoSSet`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListNewConfigsResponse.to_dict() is deprecated and no longer maintained, "
