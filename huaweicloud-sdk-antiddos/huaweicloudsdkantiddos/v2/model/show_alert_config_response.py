...
class ShowAlertConfigResponse(SdkResponse):
    ...
    def __init__(self, topic_urn=None, display_name=None, warn_config=None):
        ...
        :param warn_config: 
        :type warn_config: :class:`huaweicloudsdkantiddos.v2.AlertConfigRespWarnConfig`
        """
    ...
    def warn_config(self):
        ...
        :rtype: :class:`huaweicloudsdkantiddos.v2.AlertConfigRespWarnConfig`
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowAlertConfigResponse.to_dict() is deprecated and no longer maintained, "
