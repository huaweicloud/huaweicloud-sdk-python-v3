...
class ListDDosStatusRequest:
    ...
    def __init__(self, status=None, limit=None, offset=None, ips=None):
        ...
        :type offset: str
        :param ips: IP地址，支持IPv4格式和IPv6格式输入，支持部分查询。例如“？ip&#x3D;192.168”，会返回192.168.111.1和10.192.168.8所对应的EIP防护状态。
        :type ips: str
        """
    ...
    @property
    def ips(self):
        r"""Gets the ips of this ListDDosStatusRequest.

        IP地址，支持IPv4格式和IPv6格式输入，支持部分查询。例如“？ip=192.168”，会返回192.168.111.1和10.192.168.8所对应的EIP防护状态。

        :return: The ips of this ListDDosStatusRequest.
        :rtype: str
        """
        return self._ips
    ...
    @ips.setter
    def ips(self, ips):
        r"""Sets the ips of this ListDDosStatusRequest.

        IP地址，支持IPv4格式和IPv6格式输入，支持部分查询。例如“？ip=192.168”，会返回192.168.111.1和10.192.168.8所对应的EIP防护状态。

        :param ips: The ips of this ListDDosStatusRequest.
        :type ips: str
        """
        self._ips = ips
