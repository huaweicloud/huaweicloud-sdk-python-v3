...
class ListApiVersionsResponse(SdkResponse):
    ...
    openapi_types = {
        'versions': 'list[ApiVersionsVersions]'
    }
    ...
    def __init__(self, versions=None):
        ...
        :param versions: 版本定义
        :type versions: list[:class:`huaweicloudsdkeg.v1.ApiVersionsVersions`]
        """
    ...
    def versions(self):
        ...
        :rtype: list[:class:`huaweicloudsdkeg.v1.ApiVersionsVersions`]
        """
