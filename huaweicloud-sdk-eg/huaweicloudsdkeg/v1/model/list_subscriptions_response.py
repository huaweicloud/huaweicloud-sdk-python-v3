...
class ListSubscriptionsResponse(SdkResponse):
    ...
    @property
    def size(self):
        """Gets the size of this ListSubscriptionsResponse.
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this ListSubscriptionsResponse.
    ...
    @property
    def items(self):
        """Gets the items of this ListSubscriptionsResponse.
    ...
    def items(self, items):
        """Sets the items of this ListSubscriptionsResponse.
