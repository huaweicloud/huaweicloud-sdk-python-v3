...
class ListConnectionsResponse(SdkResponse):
    ...
    def __init__(self, total=None, size=None, items=None):
        ...
        :type size: int
        :param items: 对象列表
        :type items: list[:class:`huaweicloudsdkeg.v1.ConnectionInfo`]
        """
    ...
    def size(self):
        ...
        :return: The size of this ListConnectionsResponse.
        :rtype: int
        """
        return self._size
    ...
    def size(self, size):
        ...
        :param size: The size of this ListConnectionsResponse.
        :type size: int
        """
        self._size = size
    ...
    def items(self):
        ...
        :return: The items of this ListConnectionsResponse.
        :rtype: list[:class:`huaweicloudsdkeg.v1.ConnectionInfo`]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :param items: The items of this ListConnectionsResponse.
        :type items: list[:class:`huaweicloudsdkeg.v1.ConnectionInfo`]
        """
        self._items = items
