...
class ListServiceSetDetailResponse(SdkResponse):
    ...
    def __init__(self, data=None):
        r"""ListServiceSetDetailResponse
    ...
    @property
    def data(self):
        r"""Gets the data of this ListServiceSetDetailResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this ListServiceSetDetailResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListServiceSetDetailResponse.to_dict() is deprecated and no longer maintained, "
