...
class BatchDeleteAclRulesResponse(SdkResponse):
    ...
    openapi_types = {
        'data': 'BatchDeleteAclRulesResponseData'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchDeleteAclRulesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteAclRulesResponse):
            return False
