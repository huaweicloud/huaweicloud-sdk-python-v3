...
class ListIpsProtectModeResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListIpsProtectModeResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListIpsProtectModeResponse):
            return False
