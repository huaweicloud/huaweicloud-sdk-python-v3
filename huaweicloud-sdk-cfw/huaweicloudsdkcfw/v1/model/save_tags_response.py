...
class SaveTagsResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("SaveTagsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SaveTagsResponse):
            return False
