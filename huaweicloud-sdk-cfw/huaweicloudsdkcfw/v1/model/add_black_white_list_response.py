...
class AddBlackWhiteListResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("AddBlackWhiteListResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddBlackWhiteListResponse):
            return False
