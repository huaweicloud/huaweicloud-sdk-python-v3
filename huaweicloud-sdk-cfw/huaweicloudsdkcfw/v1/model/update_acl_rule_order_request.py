...
class UpdateAclRuleOrderRequest:
    ...
    @property
    def body(self):
        r"""Gets the body of this UpdateAclRuleOrderRequest.

        :return: The body of this UpdateAclRuleOrderRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this UpdateAclRuleOrderRequest.

        :param body: The body of this UpdateAclRuleOrderRequest.
        :type body: :class:`huaweicloudsdkcfw.v1.OrderRuleAclDto`
        """
        self._body = body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateAclRuleOrderRequest):
            return False
