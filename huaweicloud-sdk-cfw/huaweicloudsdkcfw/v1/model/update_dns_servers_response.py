...
class UpdateDnsServersResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateDnsServersResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateDnsServersResponse):
            return False
