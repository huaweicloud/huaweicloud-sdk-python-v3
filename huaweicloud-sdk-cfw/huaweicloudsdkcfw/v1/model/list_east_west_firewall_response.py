...
class ListEastWestFirewallResponse(SdkResponse):
    ...
    openapi_types = {
        'data': 'GetEastWestFirewallResponseBody'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListEastWestFirewallResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListEastWestFirewallResponse):
            return False
