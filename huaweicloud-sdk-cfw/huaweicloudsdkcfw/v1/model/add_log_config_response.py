...
class AddLogConfigResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("AddLogConfigResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddLogConfigResponse):
            return False
