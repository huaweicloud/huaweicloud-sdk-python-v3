...
class ShowAutoProtectStatusResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowAutoProtectStatusResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowAutoProtectStatusResponse):
            return False
