...
class ListLogConfigResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListLogConfigResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListLogConfigResponse):
            return False
