...
class ListIpsRulesResponse(SdkResponse):
    ...
    def __init__(self, data=None):
        ...
        super(ListIpsRulesResponse, self).__init__()
    ...
    @property
    def data(self):
        """Gets the data of this ListIpsRulesResponse.
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this ListIpsRulesResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListIpsRulesResponse):
            return False
