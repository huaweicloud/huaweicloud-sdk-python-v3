...
class ListCustomerIpsResponse(SdkResponse):
    ...
    openapi_types = {
        'data': 'PageInfoCustomerIpsListVO'
    }
    ...
    def __init__(self, data=None):
        ...
        :param data: 
        :type data: :class:`huaweicloudsdkcfw.v1.PageInfoCustomerIpsListVO`
        """
    ...
    def data(self):
        ...
        :rtype: :class:`huaweicloudsdkcfw.v1.PageInfoCustomerIpsListVO`
        """
        return self._data
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListCustomerIpsResponse):
            return False
