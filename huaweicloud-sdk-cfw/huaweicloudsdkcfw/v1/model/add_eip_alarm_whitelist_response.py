...
class AddEipAlarmWhitelistResponse(SdkResponse):
    ...
    def __init__(self, data=None):
        r"""AddEipAlarmWhitelistResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("AddEipAlarmWhitelistResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddEipAlarmWhitelistResponse):
            return False
