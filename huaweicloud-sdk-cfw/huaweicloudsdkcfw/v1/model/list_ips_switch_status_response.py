...
class ListIpsSwitchStatusResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListIpsSwitchStatusResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListIpsSwitchStatusResponse):
            return False
