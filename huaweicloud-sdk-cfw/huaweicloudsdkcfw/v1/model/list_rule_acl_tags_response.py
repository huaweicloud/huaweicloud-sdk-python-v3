...
class ListRuleAclTagsResponse(SdkResponse):
    ...
    openapi_types = {
        'data': 'HttpGetAclTagResponseData'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListRuleAclTagsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRuleAclTagsResponse):
            return False
