...
class ListAttackStatisticRequest:
    ...
    @property
    def item(self):
        r"""Gets the item of this ListAttackStatisticRequest.

        **参数解释**： 聚合类型 **约束限制**： 不涉及 **取值范围**： dst TOP攻击目的统计 src TOP攻击来源统计 **默认取值**： 不涉及

        :return: The item of this ListAttackStatisticRequest.
        :rtype: str
        """
        return self._item
    ...
    @item.setter
    def item(self, item):
        r"""Sets the item of this ListAttackStatisticRequest.

        **参数解释**： 聚合类型 **约束限制**： 不涉及 **取值范围**： dst TOP攻击目的统计 src TOP攻击来源统计 **默认取值**： 不涉及

        :param item: The item of this ListAttackStatisticRequest.
        :type item: str
        """
        self._item = item
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAttackStatisticRequest):
            return False
