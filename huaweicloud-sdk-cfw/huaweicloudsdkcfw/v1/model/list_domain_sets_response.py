...
class ListDomainSetsResponse(SdkResponse):
    ...
    openapi_types = {
        'data': 'ListDomainsetsResponseData'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListDomainSetsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListDomainSetsResponse):
            return False
