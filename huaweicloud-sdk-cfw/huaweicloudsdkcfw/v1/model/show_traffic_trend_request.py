...
class ShowTrafficTrendRequest:
    ...
    def __init__(self, fw_instance_id=None, range=None, log_type=None, start_time=None, end_time=None, vgw_id=None, agg_type=None, ip=None):
        r"""ShowTrafficTrendRequest
        ...
        :type agg_type: str
        :param ip: **参数解释**： IP地址列表，查看IP的流量趋势 **约束限制**： 不涉及 **取值范围**： IP地址 **默认取值**： 不涉及
        :type ip: list[str]
        """
    ...
    @property
    def agg_type(self):
        r"""Gets the agg_type of this ShowTrafficTrendRequest.

        **参数解释**： 聚合类型 **约束限制**： 不涉及 **取值范围**： avg为平均值 max为最大值 **默认取值**： 不涉及

        :return: The agg_type of this ShowTrafficTrendRequest.
        :rtype: str
        """
    ...
    def agg_type(self, agg_type):
        r"""Sets the agg_type of this ShowTrafficTrendRequest.

        **参数解释**： 聚合类型 **约束限制**： 不涉及 **取值范围**： avg为平均值 max为最大值 **默认取值**： 不涉及

        :param agg_type: The agg_type of this ShowTrafficTrendRequest.
        :type agg_type: str
        """
    ...
    @property
    def ip(self):
        r"""Gets the ip of this ShowTrafficTrendRequest.

        **参数解释**： IP地址列表，查看IP的流量趋势 **约束限制**： 不涉及 **取值范围**： IP地址 **默认取值**： 不涉及

        :return: The ip of this ShowTrafficTrendRequest.
        :rtype: list[str]
        """
        return self._ip
    ...
    @ip.setter
    def ip(self, ip):
        r"""Sets the ip of this ShowTrafficTrendRequest.

        **参数解释**： IP地址列表，查看IP的流量趋势 **约束限制**： 不涉及 **取值范围**： IP地址 **默认取值**： 不涉及

        :param ip: The ip of this ShowTrafficTrendRequest.
        :type ip: list[str]
        """
        self._ip = ip
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowTrafficTrendRequest):
            return False
