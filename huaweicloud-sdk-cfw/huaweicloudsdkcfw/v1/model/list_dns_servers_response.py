...
class ListDnsServersResponse(SdkResponse):
    ...
    openapi_types = {
        'data': 'list[DnsServersResponseDTO]',
        'total': 'int'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListDnsServersResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListDnsServersResponse):
            return False
