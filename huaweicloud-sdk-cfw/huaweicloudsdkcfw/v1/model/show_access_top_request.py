...
class ShowAccessTopRequest:
    ...
    def __init__(self, fw_instance_id=None, range=None, direction=None, start_time=None, end_time=None, vgw_id=None, log_type=None, item=None, rule_id=None):
        ...
        :type log_type: str
        :param item: **参数解释**： 聚合类型 **约束限制**： 不涉及 **取值范围**： strategy_hit_info 策略的命中趋势 strategy_dashboard 策略命中概览 top_deny_rule TOP命中拦截策略 dst_ip TOP拦截目的IP src_ip TOP拦截源IP dst_port TOP拦截端口 dst_region TOP拦截目的地区 src_region TOP拦截源地区 **默认取值**： 不涉及
        :type item: str
        :param rule_id: **参数解释**： 规则ID列表 **约束限制**： 不涉及 **取值范围**： 32位UUID **默认取值**： 不涉及
        :type rule_id: list[str]
        """
    ...
    @property
    def log_type(self):
        r"""Gets the log_type of this ShowAccessTopRequest.

        **参数解释**： 日志类型 **约束限制**： 不涉及 **取值范围**： internet为南北向日志、nat为nat场景日志，vpc为东西向日志，vgw为vgw场景日志 **默认取值**： 不涉及

        :return: The log_type of this ShowAccessTopRequest.
        :rtype: str
        """
    ...
    def log_type(self, log_type):
        r"""Sets the log_type of this ShowAccessTopRequest.

        **参数解释**： 日志类型 **约束限制**： 不涉及 **取值范围**： internet为南北向日志、nat为nat场景日志，vpc为东西向日志，vgw为vgw场景日志 **默认取值**： 不涉及

        :param log_type: The log_type of this ShowAccessTopRequest.
        :type log_type: str
        """
    ...
    @property
    def item(self):
        r"""Gets the item of this ShowAccessTopRequest.
        ...
        **参数解释**： 聚合类型 **约束限制**： 不涉及 **取值范围**： strategy_hit_info 策略的命中趋势 strategy_dashboard 策略命中概览 top_deny_rule TOP命中拦截策略 dst_ip TOP拦截目的IP src_ip TOP拦截源IP dst_port TOP拦截端口 dst_region TOP拦截目的地区 src_region TOP拦截源地区 **默认取值**： 不涉及
        ...
        :return: The item of this ShowAccessTopRequest.
        :rtype: str
        """
        return self._item
    ...
    @item.setter
    def item(self, item):
        r"""Sets the item of this ShowAccessTopRequest.

        **参数解释**： 聚合类型 **约束限制**： 不涉及 **取值范围**： strategy_hit_info 策略的命中趋势 strategy_dashboard 策略命中概览 top_deny_rule TOP命中拦截策略 dst_ip TOP拦截目的IP src_ip TOP拦截源IP dst_port TOP拦截端口 dst_region TOP拦截目的地区 src_region TOP拦截源地区 **默认取值**： 不涉及

        :param item: The item of this ShowAccessTopRequest.
        :type item: str
        """
        self._item = item
    ...
    @property
    def rule_id(self):
        r"""Gets the rule_id of this ShowAccessTopRequest.

        **参数解释**： 规则ID列表 **约束限制**： 不涉及 **取值范围**： 32位UUID **默认取值**： 不涉及

        :return: The rule_id of this ShowAccessTopRequest.
        :rtype: list[str]
        """
    ...
    def rule_id(self, rule_id):
        r"""Sets the rule_id of this ShowAccessTopRequest.

        **参数解释**： 规则ID列表 **约束限制**： 不涉及 **取值范围**： 32位UUID **默认取值**： 不涉及

        :param rule_id: The rule_id of this ShowAccessTopRequest.
        :type rule_id: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowAccessTopRequest):
            return False
