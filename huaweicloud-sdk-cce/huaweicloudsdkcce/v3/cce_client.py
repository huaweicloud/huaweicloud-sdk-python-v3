...
class CceClient(Client):
    ...
    def batch_create_addon_precheck(self, request):
        r"""批量创建插件检查任务
    ...
    def batch_create_addon_precheck_invoker(self, request):
        http_info = self._batch_create_addon_precheck_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _batch_create_addon_precheck_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def delete_access_policy(self, request):
        r"""删除访问策略
    ...
    def delete_access_policy_invoker(self, request):
        http_info = self._delete_access_policy_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_access_policy_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def get_access_policy_invoker(self, request):
        http_info = self._get_access_policy_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _get_access_policy_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/api/v3/access-policies/{policy_id}",
            "request_type": request.__class__.__name__,
    ...
    def get_avaliable_zone(self, request):
        r"""查询可用区列表
    ...
    def get_avaliable_zone_invoker(self, request):
        http_info = self._get_avaliable_zone_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _get_avaliable_zone_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def get_cluster_flavor_specs(self, request):
        r"""查询集群可售卖规格
    ...
    def get_cluster_flavor_specs_invoker(self, request):
        http_info = self._get_cluster_flavor_specs_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _get_cluster_flavor_specs_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def get_cluster_long_aksk_config(self, request):
        r"""获取集群LongAKSK配置
    ...
    def get_cluster_long_aksk_config_invoker(self, request):
        http_info = self._get_cluster_long_aksk_config_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _get_cluster_long_aksk_config_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def get_cluster_quota(self, request):
        r"""获取集群配额
    ...
    def get_cluster_quota_invoker(self, request):
        http_info = self._get_cluster_quota_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _get_cluster_quota_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def get_customize_tags(self, request):
        r"""查询自定义标签
    ...
    def get_customize_tags_invoker(self, request):
        http_info = self._get_customize_tags_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _get_customize_tags_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def get_labels_invoker(self, request):
        http_info = self._get_labels_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _get_labels_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def get_long_aksk_config(self, request):
        r"""获取项目LongAKSK配置
    ...
    def get_long_aksk_config_invoker(self, request):
        http_info = self._get_long_aksk_config_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _get_long_aksk_config_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def get_resource_tags_invoker(self, request):
        http_info = self._get_resource_tags_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _get_resource_tags_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def inplace_migrate_node(self, request):
        r"""节点腾挪
    ...
    def inplace_migrate_node_invoker(self, request):
        http_info = self._inplace_migrate_node_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _inplace_migrate_node_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def list_access_policy(self, request):
        r"""获取访问策略列表
    ...
    def list_access_policy_invoker(self, request):
        http_info = self._list_access_policy_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_access_policy_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/api/v3/access-policies",
            "request_type": request.__class__.__name__,
    ...
    def migrate_to_node_pool(self, request):
        r"""节点迁移到自定义节点池。
    ...
    def migrate_to_node_pool_invoker(self, request):
        http_info = self._migrate_to_node_pool_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _migrate_to_node_pool_http_info(cls, request):
        http_info = {
            "method": "PUT",
    ...
    def show_feature_gates(self, request):
        r"""查询特性开关状态
    ...
    def show_feature_gates_invoker(self, request):
        http_info = self._show_feature_gates_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_feature_gates_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def update_cluster_long_aksk_config(self, request):
        r"""更新集群LongAKSK配置
    ...
    def update_cluster_long_aksk_config_invoker(self, request):
        http_info = self._update_cluster_long_aksk_config_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_cluster_long_aksk_config_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/api/v3/projects/{project_id}/clusters/{cluster_id}/longaksk/config",
            "request_type": request.__class__.__name__,
    ...
    def update_long_aksk_config(self, request):
        r"""更新项目LongAKSK配置
    ...
    def update_long_aksk_config_invoker(self, request):
        http_info = self._update_long_aksk_config_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_long_aksk_config_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/api/v3/projects/{project_id}/longaksk/config",
            "request_type": request.__class__.__name__,
    ...
    def show_autopilot_cluster_config(self, request):
        r"""查询集群日志配置信息
    ...
    def show_autopilot_cluster_config_invoker(self, request):
        http_info = self._show_autopilot_cluster_config_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_autopilot_cluster_config_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_autopilot_feature_gates(self, request):
        r"""查询特性开关状态
    ...
    def show_autopilot_feature_gates_invoker(self, request):
        http_info = self._show_autopilot_feature_gates_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_autopilot_feature_gates_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def delete_autopilot_job(self, request):
        r"""删除Job
    ...
    def delete_autopilot_job_invoker(self, request):
        http_info = self._delete_autopilot_job_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_autopilot_job_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def get_autopilot_one_job(self, request):
        r"""获取Job详情
    ...
    def get_autopilot_one_job_invoker(self, request):
        http_info = self._get_autopilot_one_job_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _get_autopilot_one_job_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/autopilot/v2/projects/{project_id}/jobs/{job_id}",
            "request_type": request.__class__.__name__,
    ...
    def list_autopilot_jobs(self, request):
        r"""获取Job列表
    ...
    def list_autopilot_jobs_invoker(self, request):
        http_info = self._list_autopilot_jobs_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_autopilot_jobs_http_info(cls, request):
        http_info = {
            "method": "GET",
