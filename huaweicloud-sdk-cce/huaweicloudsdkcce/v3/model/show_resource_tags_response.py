...
class ShowResourceTagsResponse(SdkResponse):
    ...
    @property
    def sys_tags(self):
        """Gets the sys_tags of this ShowResourceTagsResponse.

        系统标签

        :return: The sys_tags of this ShowResourceTagsResponse.
        :rtype: list[:class:`huaweicloudsdkcce.v3.ResourceTagBody`]
        """
    ...
    def sys_tags(self, sys_tags):
        """Sets the sys_tags of this ShowResourceTagsResponse.

        系统标签

        :param sys_tags: The sys_tags of this ShowResourceTagsResponse.
        :type sys_tags: list[:class:`huaweicloudsdkcce.v3.ResourceTagBody`]
        """
    ...
    @property
    def action(self):
        """Gets the action of this ShowResourceTagsResponse.

        执行动作

        :return: The action of this ShowResourceTagsResponse.
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        """Sets the action of this ShowResourceTagsResponse.

        执行动作

        :param action: The action of this ShowResourceTagsResponse.
        :type action: str
        """
        self._action = action
