...
class ShowUpgradeClusterTaskResponse(SdkResponse):
    ...
    def __init__(self, api_version=None, kind=None, metadata=None, spec=None, status=None):
        r"""ShowUpgradeClusterTaskResponse
    ...
    def api_version(self):
        r"""Gets the api_version of this ShowUpgradeClusterTaskResponse.
    ...
    def api_version(self, api_version):
        r"""Sets the api_version of this ShowUpgradeClusterTaskResponse.
    ...
    @property
    def kind(self):
        r"""Gets the kind of this ShowUpgradeClusterTaskResponse.
    ...
    @kind.setter
    def kind(self, kind):
        r"""Sets the kind of this ShowUpgradeClusterTaskResponse.
    ...
    @property
    def metadata(self):
        r"""Gets the metadata of this ShowUpgradeClusterTaskResponse.
    ...
    def metadata(self, metadata):
        r"""Sets the metadata of this ShowUpgradeClusterTaskResponse.
    ...
    @property
    def spec(self):
        r"""Gets the spec of this ShowUpgradeClusterTaskResponse.
    ...
    @spec.setter
    def spec(self, spec):
        r"""Sets the spec of this ShowUpgradeClusterTaskResponse.
    ...
    @property
    def status(self):
        r"""Gets the status of this ShowUpgradeClusterTaskResponse.
    ...
    def status(self, status):
        r"""Sets the status of this ShowUpgradeClusterTaskResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowUpgradeClusterTaskResponse.to_dict() is deprecated and no longer maintained, "
