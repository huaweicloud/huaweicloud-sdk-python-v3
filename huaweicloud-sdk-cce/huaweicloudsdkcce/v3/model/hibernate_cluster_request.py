...
class HibernateClusterRequest:
    ...
    @property
    def cluster_id(self):
        r"""Gets the cluster_id of this HibernateClusterRequest.
    ...
    def cluster_id(self, cluster_id):
        r"""Sets the cluster_id of this HibernateClusterRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HibernateClusterRequest):
            return False
