...
class ListUpgradeWorkFlowsResponse(SdkResponse):
    ...
    def __init__(self, kind=None, api_version=None, items=None):
        r"""ListUpgradeWorkFlowsResponse

        The model defined in huaweicloud sdk

        :param kind: **参数解释：** API类型，固定值\&quot;List\&quot;，该值不可修改 **约束限制：** 固定值 **取值范围：** - List  **默认取值：** List 
        :type kind: str
        :param api_version: **参数解释：** API版本，固定值\&quot;v3\&quot;，该值不可修改 **约束限制：** 固定值 **取值范围：** - v3  **默认取值：** v3 
        :type api_version: str
        :param items: **参数解释：** 升级工作流列表 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及 
    ...
    @property
    def kind(self):
        r"""Gets the kind of this ListUpgradeWorkFlowsResponse.
    ...
    @kind.setter
    def kind(self, kind):
        r"""Sets the kind of this ListUpgradeWorkFlowsResponse.
    ...
    def api_version(self):
        r"""Gets the api_version of this ListUpgradeWorkFlowsResponse.
    ...
    def api_version(self, api_version):
        r"""Sets the api_version of this ListUpgradeWorkFlowsResponse.
    ...
    @property
    def items(self):
        r"""Gets the items of this ListUpgradeWorkFlowsResponse.
    ...
    def items(self, items):
        r"""Sets the items of this ListUpgradeWorkFlowsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListUpgradeWorkFlowsResponse.to_dict() is deprecated and no longer maintained, "
