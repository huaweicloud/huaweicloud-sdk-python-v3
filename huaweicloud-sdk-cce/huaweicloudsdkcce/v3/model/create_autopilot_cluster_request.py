...
class CreateAutopilotClusterRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateAutopilotClusterRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateAutopilotClusterRequest):
            return False
