...
class UpdateClusterLogConfigResponse(SdkResponse):
    ...
    def __init__(self, ttl_in_days=None, log_configs=None):
        r"""UpdateClusterLogConfigResponse
    ...
    def ttl_in_days(self):
        r"""Gets the ttl_in_days of this UpdateClusterLogConfigResponse.

        **参数解释**：  存储时长，单位：天。  **约束限制**：  不涉及  **取值范围**： 0-30  **默认取值**： 不涉及

        :return: The ttl_in_days of this UpdateClusterLogConfigResponse.
        :rtype: int
        """
    ...
    def ttl_in_days(self, ttl_in_days):
        r"""Sets the ttl_in_days of this UpdateClusterLogConfigResponse.

        **参数解释**：  存储时长，单位：天。  **约束限制**：  不涉及  **取值范围**： 0-30  **默认取值**： 不涉及

        :param ttl_in_days: The ttl_in_days of this UpdateClusterLogConfigResponse.
        :type ttl_in_days: int
        """
    ...
    def log_configs(self):
        r"""Gets the log_configs of this UpdateClusterLogConfigResponse.

        **参数解释**： 日志配置项详细信息 **约束限制**: 不涉及

        :return: The log_configs of this UpdateClusterLogConfigResponse.
    ...
    def log_configs(self, log_configs):
        r"""Sets the log_configs of this UpdateClusterLogConfigResponse.

        **参数解释**： 日志配置项详细信息 **约束限制**: 不涉及

        :param log_configs: The log_configs of this UpdateClusterLogConfigResponse.
        :type log_configs: list[:class:`huaweicloudsdkcce.v3.ClusterLogConfigLogConfigs`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateClusterLogConfigResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateClusterLogConfigResponse):
            return False
