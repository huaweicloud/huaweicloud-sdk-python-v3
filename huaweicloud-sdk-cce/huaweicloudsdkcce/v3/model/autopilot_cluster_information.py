...
class AutopilotClusterInformation:
    ...
    openapi_types = {
        'spec': 'AutopilotClusterInformationSpec',
        'metadata': 'AutopilotClusterMetadataForUpdate'
    }
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AutopilotClusterInformation):
            return False
