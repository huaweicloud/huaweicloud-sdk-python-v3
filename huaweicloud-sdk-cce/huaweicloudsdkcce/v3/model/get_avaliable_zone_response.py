...
class GetAvaliableZoneResponse(SdkResponse):
    ...
    openapi_types = {
        'body': 'list[GetAvailableZoneResponseBody]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("GetAvaliableZoneResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetAvaliableZoneResponse):
            return False
