...
class CreateNodePoolStatus:
    ...
    def active_node(self):
        r"""Gets the active_node of this CreateNodePoolStatus.

        **参数解释**： 当前节点池中就绪的节点数量。 **取值范围**： 不涉及

        :return: The active_node of this CreateNodePoolStatus.
        :rtype: int
        """
    ...
    def active_node(self, active_node):
        r"""Sets the active_node of this CreateNodePoolStatus.

        **参数解释**： 当前节点池中就绪的节点数量。 **取值范围**： 不涉及

        :param active_node: The active_node of this CreateNodePoolStatus.
        :type active_node: int
        """
    ...
    def configuration_synced_node_count(self):
        r"""Gets the configuration_synced_node_count of this CreateNodePoolStatus.

        **参数解释** 当前节点池中已经同步了节点池配置参数的节点数量。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及

        :return: The configuration_synced_node_count of this CreateNodePoolStatus.
        :rtype: int
        """
    ...
    def configuration_synced_node_count(self, configuration_synced_node_count):
        r"""Sets the configuration_synced_node_count of this CreateNodePoolStatus.

        **参数解释** 当前节点池中已经同步了节点池配置参数的节点数量。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及

        :param configuration_synced_node_count: The configuration_synced_node_count of this CreateNodePoolStatus.
        :type configuration_synced_node_count: int
        """
    ...
    def scale_group_statuses(self):
        ...
        :return: The scale_group_statuses of this CreateNodePoolStatus.
    ...
    def scale_group_statuses(self, scale_group_statuses):
        ...
        :param scale_group_statuses: The scale_group_statuses of this CreateNodePoolStatus.
        :type scale_group_statuses: list[:class:`huaweicloudsdkcce.v3.ScaleGroupStatus`]
        """
