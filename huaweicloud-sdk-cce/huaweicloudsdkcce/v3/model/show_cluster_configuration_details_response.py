...
class ShowClusterConfigurationDetailsResponse(SdkResponse):
    ...
    def __init__(self, body=None):
        r"""ShowClusterConfigurationDetailsResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowClusterConfigurationDetailsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowClusterConfigurationDetailsResponse):
            return False
