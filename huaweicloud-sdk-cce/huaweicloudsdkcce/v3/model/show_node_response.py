...
class ShowNodeResponse(SdkResponse):
    ...
    @property
    def kind(self):
        r"""Gets the kind of this ShowNodeResponse.

        **参数解释**： API类型 **约束限制**： 该值不可修改 **取值范围**： 不涉及 **默认取值**： Node 

        :return: The kind of this ShowNodeResponse.
        :rtype: str
        """
        return self._kind
    ...
    @kind.setter
    def kind(self, kind):
        r"""Sets the kind of this ShowNodeResponse.
    ...
    def api_version(self):
        r"""Gets the api_version of this ShowNodeResponse.

        **参数解释**： API类型 **约束限制**： 该值不可修改 **取值范围**： 不涉及 **默认取值**： Node 

        :return: The api_version of this ShowNodeResponse.
        :rtype: str
        """
    ...
    def api_version(self, api_version):
        r"""Sets the api_version of this ShowNodeResponse.
    ...
    @property
    def metadata(self):
        r"""Gets the metadata of this ShowNodeResponse.
    ...
    def metadata(self, metadata):
        r"""Sets the metadata of this ShowNodeResponse.
    ...
    @property
    def spec(self):
        r"""Gets the spec of this ShowNodeResponse.
    ...
    @spec.setter
    def spec(self, spec):
        r"""Sets the spec of this ShowNodeResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowNodeResponse.to_dict() is deprecated and no longer maintained, "
