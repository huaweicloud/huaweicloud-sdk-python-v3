...
class ShowAutopilotChartValuesResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowAutopilotChartValuesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowAutopilotChartValuesResponse):
            return False
