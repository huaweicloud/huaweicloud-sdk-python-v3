...
class ListAutopilotChartsResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAutopilotChartsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAutopilotChartsResponse):
            return False
