...
class UpdateAccessPolicyRequest:
    ...
    def __init__(self, policy_id=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkcce.v3.AccessPolicy`
        """
    ...
    @property
    def policy_id(self):
        r"""Gets the policy_id of this UpdateAccessPolicyRequest.

        **参数解释：** 访问策略ID。获取方式请参见[获取访问策略列表](ListAccessPolicy.xml)。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :return: The policy_id of this UpdateAccessPolicyRequest.
        :rtype: str
        """
    ...
    def policy_id(self, policy_id):
        r"""Sets the policy_id of this UpdateAccessPolicyRequest.

        **参数解释：** 访问策略ID。获取方式请参见[获取访问策略列表](ListAccessPolicy.xml)。 **约束限制：** 不涉及 **取值范围：** 不涉及 **默认取值：** 不涉及

        :param policy_id: The policy_id of this UpdateAccessPolicyRequest.
        :type policy_id: str
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkcce.v3.AccessPolicy`
        """
        return self._body
