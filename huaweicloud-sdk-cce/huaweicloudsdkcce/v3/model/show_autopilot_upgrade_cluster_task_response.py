...
class ShowAutopilotUpgradeClusterTaskResponse(SdkResponse):
    ...
    def __init__(self, api_version=None, kind=None, metadata=None, spec=None, status=None):
        ...
        :param kind: **参数解释：** 资源类型，默认为UpgradeTask **约束限制：** 不涉及 **取值范围：** - UpgradeTask  **默认取值：** UpgradeTask 
        :type kind: str
        :param metadata: 
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowAutopilotUpgradeClusterTaskResponse.to_dict() is deprecated and no longer maintained, "
