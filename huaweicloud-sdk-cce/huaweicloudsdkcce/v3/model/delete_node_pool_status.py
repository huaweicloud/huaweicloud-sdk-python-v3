...
class DeleteNodePoolStatus:
    ...
    def current_node(self):
        r"""Gets the current_node of this DeleteNodePoolStatus.

        当前节点池中所有节点数量（不含删除中的节点）。

        :return: The current_node of this DeleteNodePoolStatus.
        :rtype: int
        """
    ...
    def current_node(self, current_node):
        r"""Sets the current_node of this DeleteNodePoolStatus.

        当前节点池中所有节点数量（不含删除中的节点）。

        :param current_node: The current_node of this DeleteNodePoolStatus.
        :type current_node: int
        """
    ...
    def creating_node(self):
        r"""Gets the creating_node of this DeleteNodePoolStatus.

        当前节点池中处于创建流程中的节点数量。

        :return: The creating_node of this DeleteNodePoolStatus.
        :rtype: int
        """
    ...
    def creating_node(self, creating_node):
        r"""Sets the creating_node of this DeleteNodePoolStatus.

        当前节点池中处于创建流程中的节点数量。

        :param creating_node: The creating_node of this DeleteNodePoolStatus.
        :type creating_node: int
        """
    ...
    def deleting_node(self):
        r"""Gets the deleting_node of this DeleteNodePoolStatus.

        当前节点池中删除中的节点数量。

        :return: The deleting_node of this DeleteNodePoolStatus.
        :rtype: int
        """
    ...
    def deleting_node(self, deleting_node):
        r"""Sets the deleting_node of this DeleteNodePoolStatus.

        当前节点池中删除中的节点数量。

        :param deleting_node: The deleting_node of this DeleteNodePoolStatus.
        :type deleting_node: int
        """
    ...
    def active_node(self):
        r"""Gets the active_node of this DeleteNodePoolStatus.

        **参数解释**： 当前节点池中就绪的节点数量。 **取值范围**： 不涉及

        :return: The active_node of this DeleteNodePoolStatus.
        :rtype: int
        """
    ...
    def active_node(self, active_node):
        r"""Sets the active_node of this DeleteNodePoolStatus.

        **参数解释**： 当前节点池中就绪的节点数量。 **取值范围**： 不涉及

        :param active_node: The active_node of this DeleteNodePoolStatus.
        :type active_node: int
        """
    ...
    def configuration_synced_node_count(self):
        r"""Gets the configuration_synced_node_count of this DeleteNodePoolStatus.

        **参数解释** 当前节点池中已经同步了节点池配置参数的节点数量。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及

        :return: The configuration_synced_node_count of this DeleteNodePoolStatus.
        :rtype: int
        """
    ...
    def configuration_synced_node_count(self, configuration_synced_node_count):
        r"""Sets the configuration_synced_node_count of this DeleteNodePoolStatus.

        **参数解释** 当前节点池中已经同步了节点池配置参数的节点数量。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及

        :param configuration_synced_node_count: The configuration_synced_node_count of this DeleteNodePoolStatus.
        :type configuration_synced_node_count: int
        """
    ...
    def phase(self, phase):
        r"""Sets the phase of this DeleteNodePoolStatus.

        节点池状态。 - 空值：可用（节点池当前节点数已达到预期，且无伸缩中的节点） - Synchronizing：伸缩中（节点池当前节点数未达到预期，且无伸缩中的节点） - Synchronized：伸缩等待中（节点池当前节点数未达到预期，或者存在伸缩中的节点） - SoldOut：节点池当前不可扩容（兼容字段，标记节点池资源售罄、资源配额不足等不可扩容状态） > 上述节点池状态已废弃，仅兼容保留，不建议使用，替代感知方式如下： > - 节点池扩缩状态：可通过currentNode/creatingNode/deletingNode节点状态统计信息，精确感知当前节点池扩缩状态。 > - 节点池可扩容状态：可通过conditions感知节点池详细状态，其中\"Scalable\"可替代SoldOut语义。 - Deleting：删除中 - Error：错误 

        :param phase: The phase of this DeleteNodePoolStatus.
        :type phase: str
        """
        self._phase = phase
    ...
    @property
    def job_id(self):
        r"""Gets the job_id of this DeleteNodePoolStatus.

        对节点池执行操作时的 JobID。

        :return: The job_id of this DeleteNodePoolStatus.
        :rtype: str
        """
        return self._job_id
    ...
    def job_id(self, job_id):
        r"""Sets the job_id of this DeleteNodePoolStatus.

        对节点池执行操作时的 JobID。

        :param job_id: The job_id of this DeleteNodePoolStatus.
        :type job_id: str
        """
        self._job_id = job_id
    ...
    @property
    def conditions(self):
        r"""Gets the conditions of this DeleteNodePoolStatus.

        节点池当前详细状态列表，详情参见Condition类型定义。 

        :return: The conditions of this DeleteNodePoolStatus.
    ...
    def conditions(self, conditions):
        r"""Sets the conditions of this DeleteNodePoolStatus.

        节点池当前详细状态列表，详情参见Condition类型定义。 

        :param conditions: The conditions of this DeleteNodePoolStatus.
        :type conditions: list[:class:`huaweicloudsdkcce.v3.NodePoolCondition`]
        """
    ...
    def scale_group_statuses(self):
        r"""Gets the scale_group_statuses of this DeleteNodePoolStatus.

        伸缩组当前详细状态信息，详情参见ScaleGroupStatus类型定义

        :return: The scale_group_statuses of this DeleteNodePoolStatus.
    ...
    def scale_group_statuses(self, scale_group_statuses):
        r"""Sets the scale_group_statuses of this DeleteNodePoolStatus.

        伸缩组当前详细状态信息，详情参见ScaleGroupStatus类型定义

        :param scale_group_statuses: The scale_group_statuses of this DeleteNodePoolStatus.
        :type scale_group_statuses: list[:class:`huaweicloudsdkcce.v3.ScaleGroupStatus`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteNodePoolStatus):
            return False
