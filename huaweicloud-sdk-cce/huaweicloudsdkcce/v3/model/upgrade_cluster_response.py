...
class UpgradeClusterResponse(SdkResponse):
    ...
    @property
    def metadata(self):
        r"""Gets the metadata of this UpgradeClusterResponse.
    ...
    def metadata(self, metadata):
        r"""Sets the metadata of this UpgradeClusterResponse.
    ...
    @property
    def spec(self):
        r"""Gets the spec of this UpgradeClusterResponse.
    ...
    @spec.setter
    def spec(self, spec):
        r"""Sets the spec of this UpgradeClusterResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpgradeClusterResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpgradeClusterResponse):
            return False
