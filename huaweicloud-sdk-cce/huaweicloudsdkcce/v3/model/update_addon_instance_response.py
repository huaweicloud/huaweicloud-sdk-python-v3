...
class UpdateAddonInstanceResponse(SdkResponse):
    ...
    def __init__(self, api_version='v3', kind='Addon', metadata=None, spec=None, status=None):
        """UpdateAddonInstanceResponse - a model defined in huaweicloud sdk"""
    ...
    def api_version(self):
        """Gets the api_version of this UpdateAddonInstanceResponse.
    ...
    def api_version(self, api_version):
        """Sets the api_version of this UpdateAddonInstanceResponse.
    ...
    @property
    def kind(self):
        """Gets the kind of this UpdateAddonInstanceResponse.
    ...
    @kind.setter
    def kind(self, kind):
        """Sets the kind of this UpdateAddonInstanceResponse.
