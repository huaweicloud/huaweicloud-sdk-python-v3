...
class CreatePartitionRequest:
    ...
    @property
    def cluster_id(self):
        r"""Gets the cluster_id of this CreatePartitionRequest.

        集群ID，获取方式请参见[如何获取接口URI中参数](cce_02_0271.xml)。

        :return: The cluster_id of this CreatePartitionRequest.
        :rtype: str
        """
    ...
    def cluster_id(self, cluster_id):
        r"""Sets the cluster_id of this CreatePartitionRequest.

        集群ID，获取方式请参见[如何获取接口URI中参数](cce_02_0271.xml)。

        :param cluster_id: The cluster_id of this CreatePartitionRequest.
        :type cluster_id: str
        """
    ...
    @property
    def body(self):
        r"""Gets the body of this CreatePartitionRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this CreatePartitionRequest.
