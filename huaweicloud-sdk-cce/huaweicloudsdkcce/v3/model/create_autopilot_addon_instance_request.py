...
class CreateAutopilotAddonInstanceRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateAutopilotAddonInstanceRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateAutopilotAddonInstanceRequest):
            return False
