...
class ListAutopilotClusterMasterSnapshotTasksResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAutopilotClusterMasterSnapshotTasksResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAutopilotClusterMasterSnapshotTasksResponse):
            return False
