...
class QuotaRespQuotas:
    ...
    openapi_types = {
        'resources': 'list[QuotaRespQuotasResources]'
    }
    ...
    @property
    def resources(self):
        """Gets the resources of this QuotaRespQuotas.
    ...
    def resources(self, resources):
        """Sets the resources of this QuotaRespQuotas.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QuotaRespQuotas):
            return False
