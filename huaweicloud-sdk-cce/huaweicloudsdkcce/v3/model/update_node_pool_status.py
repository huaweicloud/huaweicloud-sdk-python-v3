...
class UpdateNodePoolStatus:
    ...
    def __init__(self, current_node=None, creating_node=None, deleting_node=None, active_node=None, configuration_synced_node_count=None, phase=None, conditions=None, scale_group_statuses=None):
