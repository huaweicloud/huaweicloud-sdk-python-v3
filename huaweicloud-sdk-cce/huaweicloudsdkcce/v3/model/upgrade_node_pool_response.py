...
class UpgradeNodePoolResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpgradeNodePoolResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpgradeNodePoolResponse):
            return False
