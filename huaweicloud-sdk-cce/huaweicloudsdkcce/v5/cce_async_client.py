...
class CceAsyncClient(Client):
    ...
    def create_image_cache_async(self, request):
        r"""创建镜像缓存
    ...
    def create_image_cache_async_invoker(self, request):
        http_info = self._create_image_cache_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_image_cache_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def delete_image_cache_async(self, request):
        r"""删除镜像缓存
    ...
    def delete_image_cache_async_invoker(self, request):
        http_info = self._delete_image_cache_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_image_cache_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_image_caches_async(self, request):
        r"""查询镜像缓存列表
    ...
    def list_image_caches_async_invoker(self, request):
        http_info = self._list_image_caches_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_image_caches_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v5/imagecaches",
            "request_type": request.__class__.__name__,
    ...
    def list_package_products_async(self, request):
        r"""查询套餐包列表
        ...
        :param request: Request instance for ListPackageProducts
        :type request: :class:`huaweicloudsdkcce.v5.ListPackageProductsRequest`
        :rtype: :class:`huaweicloudsdkcce.v5.ListPackageProductsResponse`
        """
        http_info = self._list_package_products_http_info(request)
        return self._call_api(**http_info)

    def list_package_products_async_invoker(self, request):
        http_info = self._list_package_products_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_package_products_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v5/package-products",
            "request_type": request.__class__.__name__,
            "response_type": "ListPackageProductsResponse"
            }
    ...
    def show_image_cache_async(self, request):
        r"""查询镜像缓存详情
    ...
    def show_image_cache_async_invoker(self, request):
        http_info = self._show_image_cache_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_image_cache_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v5/imagecaches/{image_cache_id}",
            "request_type": request.__class__.__name__,
    ...
    def subscribe_package_products_async(self, request):
        r"""订购套餐包
        ...
        :param request: Request instance for SubscribePackageProducts
        :type request: :class:`huaweicloudsdkcce.v5.SubscribePackageProductsRequest`
        :rtype: :class:`huaweicloudsdkcce.v5.SubscribePackageProductsResponse`
        """
        http_info = self._subscribe_package_products_http_info(request)
        return self._call_api(**http_info)

    def subscribe_package_products_async_invoker(self, request):
        http_info = self._subscribe_package_products_http_info(request)
        return AsyncInvoker(self, http_info)

    def _subscribe_package_products_http_info(self, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v5/package-products/subscribe",
            "request_type": request.__class__.__name__,
            "response_type": "SubscribePackageProductsResponse"
            }
