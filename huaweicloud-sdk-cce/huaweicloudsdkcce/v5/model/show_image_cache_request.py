...
class ShowImageCacheRequest:
    ...
    def image_cache_id(self):
        ...
        **参数解释：** 镜像缓存ID。 **约束限制：** 不涉及 **取值范围：** 镜像缓存ID。 **默认取值：** 不涉及 
        ...
        :return: The image_cache_id of this ShowImageCacheRequest.
        :rtype: str
        """
    ...
    def image_cache_id(self, image_cache_id):
        ...
        **参数解释：** 镜像缓存ID。 **约束限制：** 不涉及 **取值范围：** 镜像缓存ID。 **默认取值：** 不涉及 
        ...
        :param image_cache_id: The image_cache_id of this ShowImageCacheRequest.
        :type image_cache_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowImageCacheRequest):
            return False
