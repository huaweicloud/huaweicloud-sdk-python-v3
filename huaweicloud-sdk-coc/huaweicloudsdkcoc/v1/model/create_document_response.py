...
class CreateDocumentResponse(SdkResponse):
    ...
    def x_request_id(self):
        r"""Gets the x_request_id of this CreateDocumentResponse.

        :return: The x_request_id of this CreateDocumentResponse.
        :rtype: str
        """
    ...
    def x_request_id(self, x_request_id):
        r"""Sets the x_request_id of this CreateDocumentResponse.

        :param x_request_id: The x_request_id of this CreateDocumentResponse.
        :type x_request_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateDocumentResponse.to_dict() is deprecated and no longer maintained, "
