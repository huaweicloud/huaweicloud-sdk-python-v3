...
class EnableScheduledTaskRequestBody:
    ...
    def ticket_infos(self):
        ...
        :return: The ticket_infos of this EnableScheduledTaskRequestBody.
    ...
    def ticket_infos(self, ticket_infos):
        ...
        :param ticket_infos: The ticket_infos of this EnableScheduledTaskRequestBody.
        :type ticket_infos: list[:class:`huaweicloudsdkcoc.v1.TicketInfo`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnableScheduledTaskRequestBody):
            return False
