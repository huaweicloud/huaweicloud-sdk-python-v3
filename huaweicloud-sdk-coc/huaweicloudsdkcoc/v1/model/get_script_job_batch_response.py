...
class GetScriptJobBatchResponse(SdkResponse):
    ...
    openapi_types = {
        'data': 'JobScriptBatchDetailModel'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("GetScriptJobBatchResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetScriptJobBatchResponse):
            return False
