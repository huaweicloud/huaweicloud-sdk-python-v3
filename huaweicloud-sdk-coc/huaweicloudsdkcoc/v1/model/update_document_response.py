...
class UpdateDocumentResponse(SdkResponse):
    ...
    @property
    def body(self):
        r"""Gets the body of this UpdateDocumentResponse.

        :return: The body of this UpdateDocumentResponse.
        :rtype: str
        """
        return self._body
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this UpdateDocumentResponse.

        :param body: The body of this UpdateDocumentResponse.
        :type body: str
        """
        self._body = body
