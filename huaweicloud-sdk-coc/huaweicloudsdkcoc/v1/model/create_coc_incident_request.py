...
class CreateCocIncidentRequest:
    ...
    openapi_types = {
        'body': 'CreateExternalIncidentRequest'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateCocIncidentRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateCocIncidentRequest):
            return False
