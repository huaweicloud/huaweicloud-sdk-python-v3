...
class HandleCocIncidentRequest:
    ...
    openapi_types = {
        'body': 'HandleExternalIncidentRequest'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the HandleCocIncidentRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HandleCocIncidentRequest):
            return False
