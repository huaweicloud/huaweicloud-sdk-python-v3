...
class BaseResponse:
    ...
    def provider_code(self):
        ...
        :return: The provider_code of this BaseResponse.
        :rtype: str
        """
    ...
    def provider_code(self, provider_code):
        ...
        :param provider_code: The provider_code of this BaseResponse.
        :type provider_code: str
        """
    ...
    @property
    def data(self):
        r"""Gets the data of this BaseResponse.

        响应数据

        :return: The data of this BaseResponse.
        :rtype: object
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this BaseResponse.

        响应数据

        :param data: The data of this BaseResponse.
        :type data: object
        """
        self._data = data
