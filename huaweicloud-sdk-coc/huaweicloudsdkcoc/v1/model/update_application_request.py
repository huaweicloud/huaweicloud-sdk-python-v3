...
class UpdateApplicationRequest:
    ...
    def __init__(self, id=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkcoc.v1.ApplicationUpdateRequest`
        """
    ...
    @property
    def id(self):
        r"""Gets the id of this UpdateApplicationRequest.

        应用ID。

        :return: The id of this UpdateApplicationRequest.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this UpdateApplicationRequest.

        应用ID。

        :param id: The id of this UpdateApplicationRequest.
        :type id: str
        """
        self._id = id
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkcoc.v1.ApplicationUpdateRequest`
        """
        return self._body
