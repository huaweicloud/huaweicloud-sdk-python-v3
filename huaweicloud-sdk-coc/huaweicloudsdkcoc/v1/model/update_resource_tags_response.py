...
class UpdateResourceTagsResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateResourceTagsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateResourceTagsResponse):
            return False
