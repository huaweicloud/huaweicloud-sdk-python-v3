...
class ListAuthorizableTicketsExternalRequest:
    ...
    openapi_types = {
        'body': 'ListAuthorizableTicketsReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ListAuthorizableTicketsExternalRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAuthorizableTicketsExternalRequest):
            return False
