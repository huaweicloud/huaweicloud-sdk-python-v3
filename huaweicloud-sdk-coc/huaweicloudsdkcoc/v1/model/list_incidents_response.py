...
class ListIncidentsResponse(SdkResponse):
    ...
    def provider_code(self):
        r"""Gets the provider_code of this ListIncidentsResponse.

        服务标识

        :return: The provider_code of this ListIncidentsResponse.
        :rtype: str
        """
    ...
    def provider_code(self, provider_code):
        r"""Sets the provider_code of this ListIncidentsResponse.

        服务标识

        :param provider_code: The provider_code of this ListIncidentsResponse.
        :type provider_code: str
        """
    ...
    @property
    def error_code(self):
        r"""Gets the error_code of this ListIncidentsResponse.

        请求响应代码，范围：0000~9999，正常时取值：0

        :return: The error_code of this ListIncidentsResponse.
        :rtype: str
        """
    ...
    def error_code(self, error_code):
        r"""Sets the error_code of this ListIncidentsResponse.

        请求响应代码，范围：0000~9999，正常时取值：0

        :param error_code: The error_code of this ListIncidentsResponse.
        :type error_code: str
        """
    ...
    @property
    def error_msg(self):
        r"""Gets the error_msg of this ListIncidentsResponse.

        请求响应描述

        :return: The error_msg of this ListIncidentsResponse.
        :rtype: str
        """
    ...
    def error_msg(self, error_msg):
        r"""Sets the error_msg of this ListIncidentsResponse.

        请求响应描述

        :param error_msg: The error_msg of this ListIncidentsResponse.
        :type error_msg: str
        """
