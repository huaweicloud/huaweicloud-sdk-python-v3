...
class ListApplicationModelResponse(SdkResponse):
    ...
    openapi_types = {
        'data': 'ApplicationModelQueryResponseData'
    }
    ...
    def __init__(self, data=None):
        ...
        super(ListApplicationModelResponse, self).__init__()
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListApplicationModelResponse):
            return False
