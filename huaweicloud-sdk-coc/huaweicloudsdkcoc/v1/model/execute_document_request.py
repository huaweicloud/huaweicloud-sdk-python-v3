...
class ExecuteDocumentRequest:
    ...
    def document_id(self):
        r"""Gets the document_id of this ExecuteDocumentRequest.

        :return: The document_id of this ExecuteDocumentRequest.
        :rtype: str
        """
    ...
    def document_id(self, document_id):
        r"""Sets the document_id of this ExecuteDocumentRequest.

        :param document_id: The document_id of this ExecuteDocumentRequest.
        :type document_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExecuteDocumentRequest):
            return False
