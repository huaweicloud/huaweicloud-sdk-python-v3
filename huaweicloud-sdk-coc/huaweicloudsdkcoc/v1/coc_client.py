...
class CocClient(Client):
    ...
    def list_personnel_invoker(self, request):
        http_info = self._list_personnel_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_personnel_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def sync_add_personnel_invoker(self, request):
        http_info = self._sync_add_personnel_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _sync_add_personnel_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def show_sla_customized_template_invoker(self, request):
        http_info = self._show_sla_customized_template_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_sla_customized_template_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_sla_order_invoker(self, request):
        http_info = self._show_sla_order_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_sla_order_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_interrupt_records_invoker(self, request):
        http_info = self._list_interrupt_records_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_interrupt_records_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_slo_detail_invoker(self, request):
        http_info = self._show_slo_detail_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_slo_detail_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_application_model_invoker(self, request):
        http_info = self._list_application_model_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_application_model_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_patch_baseline_invoker(self, request):
        http_info = self._show_patch_baseline_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_patch_baseline_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_cce_compliant_invoker(self, request):
        http_info = self._list_cce_compliant_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_cce_compliant_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_multi_cloud_resources_invoker(self, request):
        http_info = self._list_multi_cloud_resources_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_multi_cloud_resources_http_info(cls, request):
        http_info = {
            "method": "GET",
