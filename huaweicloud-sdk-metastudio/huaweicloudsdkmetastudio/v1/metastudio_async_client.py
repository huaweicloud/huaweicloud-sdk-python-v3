...
class MetaStudioAsyncClient(Client):
    ...
    def create_assetby_replication_info_async(self, request):
        """复制资产
    ...
    def create_assetby_replication_info_async_invoker(self, request):
        http_info = self._create_assetby_replication_info_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_assetby_replication_info_http_info(self, request):
        http_info = {
            "method": "POST",
