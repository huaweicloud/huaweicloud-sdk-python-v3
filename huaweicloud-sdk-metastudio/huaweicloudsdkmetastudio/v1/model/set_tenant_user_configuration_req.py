...
class SetTenantUserConfigurationReq:
    ...
    def __init__(self, my_collections=None):
        r"""SetTenantUserConfigurationReq
    ...
    def my_collections(self):
        r"""Gets the my_collections of this SetTenantUserConfigurationReq.

        我的收藏列表

        :return: The my_collections of this SetTenantUserConfigurationReq.
    ...
    def my_collections(self, my_collections):
        r"""Sets the my_collections of this SetTenantUserConfigurationReq.

        我的收藏列表

        :param my_collections: The my_collections of this SetTenantUserConfigurationReq.
        :type my_collections: list[:class:`huaweicloudsdkmetastudio.v1.CollectionInfo`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SetTenantUserConfigurationReq):
            return False
