...
class UpdateDocumentRequest:
    ...
    def __init__(self, x_app_user_id=None, document_id=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkmetastudio.v1.UpdateDocumentRequestBody`
        """
    ...
    def x_app_user_id(self):
        r"""Gets the x_app_user_id of this UpdateDocumentRequest.

        第三方用户ID。不允许输入中文。

        :return: The x_app_user_id of this UpdateDocumentRequest.
        :rtype: str
        """
    ...
    def x_app_user_id(self, x_app_user_id):
        r"""Sets the x_app_user_id of this UpdateDocumentRequest.

        第三方用户ID。不允许输入中文。

        :param x_app_user_id: The x_app_user_id of this UpdateDocumentRequest.
        :type x_app_user_id: str
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkmetastudio.v1.UpdateDocumentRequestBody`
        """
        return self._body
