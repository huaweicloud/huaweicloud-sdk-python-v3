...
class UpdateWelcomeSpeechSwitchResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateWelcomeSpeechSwitchResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateWelcomeSpeechSwitchResponse):
            return False
