...
class DigitalAssetInfo:
    ...
    def __init__(self, asset_id=None, asset_name=None, asset_description=None, create_time=None, update_time=None, asset_type=None, asset_state=None, fail_type=None, reason=None, is_need_generate_cover=None, tags=None, asset_extra_meta=None, system_properties=None, files=None):
        """DigitalAssetInfo
    ...
    def is_need_generate_cover(self):
        """Gets the is_need_generate_cover of this DigitalAssetInfo.

        是否需要资产库生成封面图片。 > * 当前支持自动生成封面图片的资产类型包括VIDEO

        :return: The is_need_generate_cover of this DigitalAssetInfo.
        :rtype: bool
        """
    ...
    def is_need_generate_cover(self, is_need_generate_cover):
        """Sets the is_need_generate_cover of this DigitalAssetInfo.

        是否需要资产库生成封面图片。 > * 当前支持自动生成封面图片的资产类型包括VIDEO

        :param is_need_generate_cover: The is_need_generate_cover of this DigitalAssetInfo.
        :type is_need_generate_cover: bool
        """
