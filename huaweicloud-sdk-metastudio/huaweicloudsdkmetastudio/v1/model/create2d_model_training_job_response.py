...
class Create2dModelTrainingJobResponse(SdkResponse):
    ...
    def __init__(self, job_id=None, training_video_upload_url=None, action_video_upload_url=None, audio_upload_url=None, cover_upload_url=None, id_card_image1_upload_url=None, id_card_image2_upload_url=None, grant_file_upload_url=None, pre_beauty_image_upload_url=None, post_beauty_image_upload_url=None, x_request_id=None):
        r"""Create2dModelTrainingJobResponse
    ...
    @property
    def job_id(self):
        r"""Gets the job_id of this Create2dModelTrainingJobResponse.
    ...
    def job_id(self, job_id):
        r"""Sets the job_id of this Create2dModelTrainingJobResponse.
    ...
    def training_video_upload_url(self):
        r"""Gets the training_video_upload_url of this Create2dModelTrainingJobResponse.
    ...
    def training_video_upload_url(self, training_video_upload_url):
        r"""Sets the training_video_upload_url of this Create2dModelTrainingJobResponse.
    ...
    def action_video_upload_url(self):
        r"""Gets the action_video_upload_url of this Create2dModelTrainingJobResponse.
    ...
    def action_video_upload_url(self, action_video_upload_url):
        r"""Sets the action_video_upload_url of this Create2dModelTrainingJobResponse.
    ...
    def audio_upload_url(self):
        r"""Gets the audio_upload_url of this Create2dModelTrainingJobResponse.
    ...
    def audio_upload_url(self, audio_upload_url):
        r"""Sets the audio_upload_url of this Create2dModelTrainingJobResponse.
    ...
    def cover_upload_url(self):
        r"""Gets the cover_upload_url of this Create2dModelTrainingJobResponse.
    ...
    def cover_upload_url(self, cover_upload_url):
        r"""Sets the cover_upload_url of this Create2dModelTrainingJobResponse.
    ...
    def id_card_image1_upload_url(self):
        r"""Gets the id_card_image1_upload_url of this Create2dModelTrainingJobResponse.
    ...
    def id_card_image1_upload_url(self, id_card_image1_upload_url):
        r"""Sets the id_card_image1_upload_url of this Create2dModelTrainingJobResponse.
    ...
    def id_card_image2_upload_url(self):
        r"""Gets the id_card_image2_upload_url of this Create2dModelTrainingJobResponse.
    ...
    def id_card_image2_upload_url(self, id_card_image2_upload_url):
        r"""Sets the id_card_image2_upload_url of this Create2dModelTrainingJobResponse.
    ...
    def grant_file_upload_url(self):
        r"""Gets the grant_file_upload_url of this Create2dModelTrainingJobResponse.
    ...
    def grant_file_upload_url(self, grant_file_upload_url):
        r"""Sets the grant_file_upload_url of this Create2dModelTrainingJobResponse.
    ...
    def pre_beauty_image_upload_url(self):
        r"""Gets the pre_beauty_image_upload_url of this Create2dModelTrainingJobResponse.

        美白前图片上传url。 > 通过该地址上传时，需设置content-type为application/octet-stream

        :return: The pre_beauty_image_upload_url of this Create2dModelTrainingJobResponse.
        :rtype: str
        """
    ...
    def pre_beauty_image_upload_url(self, pre_beauty_image_upload_url):
        r"""Sets the pre_beauty_image_upload_url of this Create2dModelTrainingJobResponse.

        美白前图片上传url。 > 通过该地址上传时，需设置content-type为application/octet-stream

        :param pre_beauty_image_upload_url: The pre_beauty_image_upload_url of this Create2dModelTrainingJobResponse.
        :type pre_beauty_image_upload_url: str
        """
    ...
    def post_beauty_image_upload_url(self):
        r"""Gets the post_beauty_image_upload_url of this Create2dModelTrainingJobResponse.

        美白后图片上传url。 > 通过该地址上传时，需设置content-type为application/octet-stream

        :return: The post_beauty_image_upload_url of this Create2dModelTrainingJobResponse.
        :rtype: str
        """
    ...
    def post_beauty_image_upload_url(self, post_beauty_image_upload_url):
        r"""Sets the post_beauty_image_upload_url of this Create2dModelTrainingJobResponse.

        美白后图片上传url。 > 通过该地址上传时，需设置content-type为application/octet-stream

        :param post_beauty_image_upload_url: The post_beauty_image_upload_url of this Create2dModelTrainingJobResponse.
        :type post_beauty_image_upload_url: str
        """
    ...
    def x_request_id(self):
        r"""Gets the x_request_id of this Create2dModelTrainingJobResponse.
    ...
    def x_request_id(self, x_request_id):
        r"""Sets the x_request_id of this Create2dModelTrainingJobResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("Create2dModelTrainingJobResponse.to_dict() is deprecated and no longer maintained, "
