...
class CreateDialogUrlResponse(SdkResponse):
    ...
    def __init__(self, url=None, x_request_id=None):
        ...
        super(CreateDialogUrlResponse, self).__init__()
    ...
    def url(self):
        ...
        :return: The url of this CreateDialogUrlResponse.
        :rtype: str
        """
        return self._url
    ...
    def url(self, url):
        ...
        :param url: The url of this CreateDialogUrlResponse.
        :type url: str
        """
        self._url = url
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateDialogUrlResponse):
            return False
