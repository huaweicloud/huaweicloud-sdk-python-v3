...
class ListTtscVocabularyConfigsResponse(SdkResponse):
    ...
    def count(self):
        ...
        :return: The count of this ListTtscVocabularyConfigsResponse.
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        ...
        :param count: The count of this ListTtscVocabularyConfigsResponse.
        :type count: int
        """
        self._count = count
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListTtscVocabularyConfigsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListTtscVocabularyConfigsResponse):
            return False
