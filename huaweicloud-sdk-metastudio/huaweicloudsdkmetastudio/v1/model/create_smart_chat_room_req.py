...
class CreateSmartChatRoomReq:
    ...
    def billing_mode(self):
        r"""Gets the billing_mode of this CreateSmartChatRoomReq.

        计费模式，默认值CONCURRENCY * CONCURRENCY：并发计费 * CLIENT：按接入端计费 * CLIENT_TOKENS: 按接入端计费（TOKENS）

        :return: The billing_mode of this CreateSmartChatRoomReq.
        :rtype: str
        """
    ...
    def billing_mode(self, billing_mode):
        r"""Sets the billing_mode of this CreateSmartChatRoomReq.

        计费模式，默认值CONCURRENCY * CONCURRENCY：并发计费 * CLIENT：按接入端计费 * CLIENT_TOKENS: 按接入端计费（TOKENS）

        :param billing_mode: The billing_mode of this CreateSmartChatRoomReq.
        :type billing_mode: str
        """
    ...
    def reuse_resource(self):
        r"""Gets the reuse_resource of this CreateSmartChatRoomReq.

        是否允许使用未分配的并发数（端模式下不能复用），默认不使用。

        :return: The reuse_resource of this CreateSmartChatRoomReq.
        :rtype: bool
        """
    ...
    def reuse_resource(self, reuse_resource):
        r"""Sets the reuse_resource of this CreateSmartChatRoomReq.

        是否允许使用未分配的并发数（端模式下不能复用），默认不使用。

        :param reuse_resource: The reuse_resource of this CreateSmartChatRoomReq.
        :type reuse_resource: bool
        """
    ...
    def client_nums(self):
        r"""Gets the client_nums of this CreateSmartChatRoomReq.

        **参数解释**： 允许接入终端端数量。

        :return: The client_nums of this CreateSmartChatRoomReq.
        :rtype: int
        """
    ...
    def client_nums(self, client_nums):
        r"""Sets the client_nums of this CreateSmartChatRoomReq.

        **参数解释**： 允许接入终端端数量。

        :param client_nums: The client_nums of this CreateSmartChatRoomReq.
        :type client_nums: int
        """
    ...
    def enable_semantic_action(self):
        r"""Gets the enable_semantic_action of this CreateSmartChatRoomReq.

        是否优先级加载模型资产

        :return: The enable_semantic_action of this CreateSmartChatRoomReq.
        :rtype: bool
        """
    ...
    def enable_semantic_action(self, enable_semantic_action):
        r"""Sets the enable_semantic_action of this CreateSmartChatRoomReq.

        是否优先级加载模型资产

        :param enable_semantic_action: The enable_semantic_action of this CreateSmartChatRoomReq.
        :type enable_semantic_action: bool
        """
