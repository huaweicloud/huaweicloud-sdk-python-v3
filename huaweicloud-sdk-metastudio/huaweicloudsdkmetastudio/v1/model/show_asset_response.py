...
class ShowAssetResponse(SdkResponse):
    ...
    @property
    def project_id(self):
        r"""Gets the project_id of this ShowAssetResponse.
    ...
    def project_id(self, project_id):
        r"""Sets the project_id of this ShowAssetResponse.
    ...
    @property
    def asset_id(self):
        r"""Gets the asset_id of this ShowAssetResponse.

        资产ID。

        :return: The asset_id of this ShowAssetResponse.
        :rtype: str
        """
    ...
    def asset_id(self, asset_id):
        r"""Sets the asset_id of this ShowAssetResponse.

        资产ID。

        :param asset_id: The asset_id of this ShowAssetResponse.
        :type asset_id: str
        """
    ...
    @property
    def asset_name(self):
        r"""Gets the asset_name of this ShowAssetResponse.

        资产名称。

        :return: The asset_name of this ShowAssetResponse.
        :rtype: str
        """
    ...
    def asset_name(self, asset_name):
        r"""Sets the asset_name of this ShowAssetResponse.

        资产名称。

        :param asset_name: The asset_name of this ShowAssetResponse.
        :type asset_name: str
        """
    ...
    def asset_description(self):
        r"""Gets the asset_description of this ShowAssetResponse.

        资产描述。

        :return: The asset_description of this ShowAssetResponse.
        :rtype: str
        """
    ...
    def asset_description(self, asset_description):
        r"""Sets the asset_description of this ShowAssetResponse.

        资产描述。

        :param asset_description: The asset_description of this ShowAssetResponse.
        :type asset_description: str
        """
    ...
    def app_user_id(self):
        r"""Gets the app_user_id of this ShowAssetResponse.
    ...
    def app_user_id(self, app_user_id):
        r"""Sets the app_user_id of this ShowAssetResponse.
    ...
    @property
    def asset_type(self):
        r"""Gets the asset_type of this ShowAssetResponse.
    ...
    def asset_type(self, asset_type):
        r"""Sets the asset_type of this ShowAssetResponse.
    ...
    def asset_state(self):
        r"""Gets the asset_state of this ShowAssetResponse.
        ...
        :return: The asset_state of this ShowAssetResponse.
        :rtype: str
        """
    ...
    def asset_state(self, asset_state):
        r"""Sets the asset_state of this ShowAssetResponse.

        资产状态。 * CREATING：资产创建中，主文件尚未上传 * FAILED：主文件上传失败 * UNACTIVED：主文件上传成功，资产未激活，资产不可用于其他业务（用户可更新状态） * ACTIVED：主文件上传成功，资产激活，资产可用于其他业务（用户可更新状态） * DELETING：资产删除中，资产不可用，资产可恢复 * DELETED：资产文件已删除，资产不可用，资产不可恢复 * BLOCK: 资产被冻结，资产不可用，不可查看文件。 * WAITING_DELETE：资产将被下线

        :param asset_state: The asset_state of this ShowAssetResponse.
        :type asset_state: str
        """
    ...
    @property
    def fail_type(self):
        r"""Gets the fail_type of this ShowAssetResponse.
    ...
    def fail_type(self, fail_type):
        r"""Sets the fail_type of this ShowAssetResponse.
    ...
    def block_reason_code(self):
        r"""Gets the block_reason_code of this ShowAssetResponse.

        冻结原因编号。

        :return: The block_reason_code of this ShowAssetResponse.
        :rtype: str
        """
    ...
    def block_reason_code(self, block_reason_code):
        r"""Sets the block_reason_code of this ShowAssetResponse.

        冻结原因编号。

        :param block_reason_code: The block_reason_code of this ShowAssetResponse.
        :type block_reason_code: str
        """
    ...
    @property
    def reason(self):
        r"""Gets the reason of this ShowAssetResponse.
    ...
    def reason(self, reason):
        r"""Sets the reason of this ShowAssetResponse.
    ...
    @property
    def tags(self):
        r"""Gets the tags of this ShowAssetResponse.
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this ShowAssetResponse.
    ...
    def asset_extra_meta(self):
        r"""Gets the asset_extra_meta of this ShowAssetResponse.

        :return: The asset_extra_meta of this ShowAssetResponse.
    ...
    def asset_extra_meta(self, asset_extra_meta):
        r"""Sets the asset_extra_meta of this ShowAssetResponse.

        :param asset_extra_meta: The asset_extra_meta of this ShowAssetResponse.
        :type asset_extra_meta: :class:`huaweicloudsdkmetastudio.v1.AssetExtraMeta`
        """
    ...
    def system_properties(self):
        r"""Gets the system_properties of this ShowAssetResponse.

        设置系统属性。

        :return: The system_properties of this ShowAssetResponse.
    ...
    def system_properties(self, system_properties):
        r"""Sets the system_properties of this ShowAssetResponse.

        设置系统属性。

        :param system_properties: The system_properties of this ShowAssetResponse.
        :type system_properties: list[:class:`huaweicloudsdkmetastudio.v1.SystemProperty`]
        """
    ...
    @property
    def files(self):
        r"""Gets the files of this ShowAssetResponse.

        资产下的文件。

        :return: The files of this ShowAssetResponse.
    ...
    def files(self, files):
        r"""Sets the files of this ShowAssetResponse.

        资产下的文件。

        :param files: The files of this ShowAssetResponse.
        :type files: list[:class:`huaweicloudsdkmetastudio.v1.AssetFileInfo`]
        """
        self._files = files
    ...
    def asset_order(self):
        r"""Gets the asset_order of this ShowAssetResponse.
    ...
    def asset_order(self, asset_order):
        r"""Sets the asset_order of this ShowAssetResponse.
    ...
    def supported_service(self):
        r"""Gets the supported_service of this ShowAssetResponse.
    ...
    def supported_service(self, supported_service):
        r"""Sets the supported_service of this ShowAssetResponse.
    ...
    def auto_operation_config(self):
        r"""Gets the auto_operation_config of this ShowAssetResponse.

        资产自动处理任务。

        :return: The auto_operation_config of this ShowAssetResponse.
    ...
    def auto_operation_config(self, auto_operation_config):
        r"""Sets the auto_operation_config of this ShowAssetResponse.

        资产自动处理任务。

        :param auto_operation_config: The auto_operation_config of this ShowAssetResponse.
        :type auto_operation_config: list[:class:`huaweicloudsdkmetastudio.v1.AutoOperationConfig`]
        """
    ...
    def x_request_id(self):
        r"""Gets the x_request_id of this ShowAssetResponse.

        :return: The x_request_id of this ShowAssetResponse.
        :rtype: str
        """
    ...
    def x_request_id(self, x_request_id):
        r"""Sets the x_request_id of this ShowAssetResponse.

        :param x_request_id: The x_request_id of this ShowAssetResponse.
        :type x_request_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowAssetResponse.to_dict() is deprecated and no longer maintained, "
