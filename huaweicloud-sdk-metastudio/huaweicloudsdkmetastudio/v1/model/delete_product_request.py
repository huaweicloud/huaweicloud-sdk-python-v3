...
class DeleteProductRequest:
    ...
    def x_app_user_id(self):
        r"""Gets the x_app_user_id of this DeleteProductRequest.

        第三方用户ID。不允许输入中文。

        :return: The x_app_user_id of this DeleteProductRequest.
        :rtype: str
        """
    ...
    def x_app_user_id(self, x_app_user_id):
        r"""Sets the x_app_user_id of this DeleteProductRequest.

        第三方用户ID。不允许输入中文。

        :param x_app_user_id: The x_app_user_id of this DeleteProductRequest.
        :type x_app_user_id: str
        """
