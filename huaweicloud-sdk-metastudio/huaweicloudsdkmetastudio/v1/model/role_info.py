...
class RoleInfo:
    ...
    def __init__(self, role_id=None, name=None, description=None, role_business_list=None, llm_source=None, llm_config_id=None, plugin_config_list=None, mcp_server_info_list=None, instruction_library_id=None, create_time=None, update_time=None):
        r"""RoleInfo
    ...
    @property
    def role_id(self):
        r"""Gets the role_id of this RoleInfo.
    ...
    def role_id(self, role_id):
        r"""Sets the role_id of this RoleInfo.
    ...
    @property
    def name(self):
        r"""Gets the name of this RoleInfo.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this RoleInfo.
    ...
    def description(self):
        r"""Gets the description of this RoleInfo.
    ...
    def description(self, description):
        r"""Sets the description of this RoleInfo.
    ...
    def role_business_list(self):
        r"""Gets the role_business_list of this RoleInfo.

        角色业务配置列表。

        :return: The role_business_list of this RoleInfo.
    ...
    def role_business_list(self, role_business_list):
        r"""Sets the role_business_list of this RoleInfo.

        角色业务配置列表。

        :param role_business_list: The role_business_list of this RoleInfo.
        :type role_business_list: list[:class:`huaweicloudsdkmetastudio.v1.RoleBusinessInfo`]
        """
    ...
    @property
    def llm_source(self):
        r"""Gets the llm_source of this RoleInfo.

        :return: The llm_source of this RoleInfo.
    ...
    def llm_source(self, llm_source):
        r"""Sets the llm_source of this RoleInfo.

        :param llm_source: The llm_source of this RoleInfo.
        :type llm_source: :class:`huaweicloudsdkmetastudio.v1.LlmSourceEnum`
        """
    ...
    def llm_config_id(self):
        r"""Gets the llm_config_id of this RoleInfo.

        大语言模型配置ID。

        :return: The llm_config_id of this RoleInfo.
        :rtype: str
        """
    ...
    def llm_config_id(self, llm_config_id):
        r"""Sets the llm_config_id of this RoleInfo.

        大语言模型配置ID。

        :param llm_config_id: The llm_config_id of this RoleInfo.
        :type llm_config_id: str
        """
    ...
    def plugin_config_list(self):
        r"""Gets the plugin_config_list of this RoleInfo.

        插件配置列表

        :return: The plugin_config_list of this RoleInfo.
    ...
    def plugin_config_list(self, plugin_config_list):
        r"""Sets the plugin_config_list of this RoleInfo.

        插件配置列表

        :param plugin_config_list: The plugin_config_list of this RoleInfo.
        :type plugin_config_list: list[:class:`huaweicloudsdkmetastudio.v1.RolePluginConfigInfo`]
        """
    ...
    def mcp_server_info_list(self):
        r"""Gets the mcp_server_info_list of this RoleInfo.

        MCP服务端对接配置信息列表

        :return: The mcp_server_info_list of this RoleInfo.
    ...
    def mcp_server_info_list(self, mcp_server_info_list):
        r"""Sets the mcp_server_info_list of this RoleInfo.

        MCP服务端对接配置信息列表

        :param mcp_server_info_list: The mcp_server_info_list of this RoleInfo.
        :type mcp_server_info_list: list[:class:`huaweicloudsdkmetastudio.v1.McpServerBaseInfo`]
        """
    ...
    def instruction_library_id(self):
        r"""Gets the instruction_library_id of this RoleInfo.

        指令集ID。

        :return: The instruction_library_id of this RoleInfo.
        :rtype: str
        """
    ...
    def instruction_library_id(self, instruction_library_id):
        r"""Sets the instruction_library_id of this RoleInfo.

        指令集ID。

        :param instruction_library_id: The instruction_library_id of this RoleInfo.
        :type instruction_library_id: str
        """
    ...
    def create_time(self):
        r"""Gets the create_time of this RoleInfo.

        创建时间，格式遵循：RFC 3339 如\"2021-01-10T08:43:17Z\"。

        :return: The create_time of this RoleInfo.
        :rtype: str
        """
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this RoleInfo.

        创建时间，格式遵循：RFC 3339 如\"2021-01-10T08:43:17Z\"。

        :param create_time: The create_time of this RoleInfo.
        :type create_time: str
        """
    ...
    def update_time(self):
        r"""Gets the update_time of this RoleInfo.

        更新时间，格式遵循：RFC 3339 如\"2021-01-10T08:43:17Z\"。

        :return: The update_time of this RoleInfo.
        :rtype: str
        """
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this RoleInfo.

        更新时间，格式遵循：RFC 3339 如\"2021-01-10T08:43:17Z\"。

        :param update_time: The update_time of this RoleInfo.
        :type update_time: str
        """
