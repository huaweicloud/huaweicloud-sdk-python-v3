...
class UpdateDialogReportConfigReq:
    ...
    def obs_bucket_name(self):
        r"""Gets the obs_bucket_name of this UpdateDialogReportConfigReq.

        **参数解释**： 接收对话结果上报的obs桶名。 **约束限制**： 不涉及 **取值范围**： 字符长度1-64 **默认取值**： 不涉及

        :return: The obs_bucket_name of this UpdateDialogReportConfigReq.
        :rtype: str
        """
    ...
    def obs_bucket_name(self, obs_bucket_name):
        r"""Sets the obs_bucket_name of this UpdateDialogReportConfigReq.

        **参数解释**： 接收对话结果上报的obs桶名。 **约束限制**： 不涉及 **取值范围**： 字符长度1-64 **默认取值**： 不涉及

        :param obs_bucket_name: The obs_bucket_name of this UpdateDialogReportConfigReq.
        :type obs_bucket_name: str
        """
    ...
    def obs_endpoint(self):
        r"""Gets the obs_endpoint of this UpdateDialogReportConfigReq.

        **参数解释**： 接收对话结果上报的obs终端节点。 **约束限制**： 需要为obs合法终端节点。 **取值范围**： 字符长度1-64 **默认取值**： 不涉及

        :return: The obs_endpoint of this UpdateDialogReportConfigReq.
        :rtype: str
        """
    ...
    def obs_endpoint(self, obs_endpoint):
        r"""Sets the obs_endpoint of this UpdateDialogReportConfigReq.

        **参数解释**： 接收对话结果上报的obs终端节点。 **约束限制**： 需要为obs合法终端节点。 **取值范围**： 字符长度1-64 **默认取值**： 不涉及

        :param obs_endpoint: The obs_endpoint of this UpdateDialogReportConfigReq.
        :type obs_endpoint: str
        """
    ...
    def enable_dialog_report(self):
        r"""Gets the enable_dialog_report of this UpdateDialogReportConfigReq.

        对话结果上报开关

        :return: The enable_dialog_report of this UpdateDialogReportConfigReq.
        :rtype: bool
        """
    ...
    def enable_dialog_report(self, enable_dialog_report):
        r"""Sets the enable_dialog_report of this UpdateDialogReportConfigReq.

        对话结果上报开关

        :param enable_dialog_report: The enable_dialog_report of this UpdateDialogReportConfigReq.
        :type enable_dialog_report: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateDialogReportConfigReq):
            return False
