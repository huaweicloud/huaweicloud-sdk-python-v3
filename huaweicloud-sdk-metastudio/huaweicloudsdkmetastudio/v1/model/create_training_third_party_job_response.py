...
class CreateTrainingThirdPartyJobResponse(SdkResponse):
    ...
    def __init__(self, job_id=None, training_data_uploading_url=None, segment_uploading_url=None, authorization_letter_uploading_url=None):
        r"""CreateTrainingThirdPartyJobResponse
    ...
    @property
    def job_id(self):
        r"""Gets the job_id of this CreateTrainingThirdPartyJobResponse.

        任务id。

        :return: The job_id of this CreateTrainingThirdPartyJobResponse.
        :rtype: str
        """
        return self._job_id
    ...
    def job_id(self, job_id):
        r"""Sets the job_id of this CreateTrainingThirdPartyJobResponse.

        任务id。

        :param job_id: The job_id of this CreateTrainingThirdPartyJobResponse.
        :type job_id: str
        """
        self._job_id = job_id
    ...
    def training_data_uploading_url(self):
        r"""Gets the training_data_uploading_url of this CreateTrainingThirdPartyJobResponse.

        上传训练数据的地址。训练数据需打包成zip文件后，上传至该url。  create_type取值为package时设置。 > 通过该obs地址上传时，需设置content-type为application/zip。

        :return: The training_data_uploading_url of this CreateTrainingThirdPartyJobResponse.
        :rtype: str
        """
    ...
    def training_data_uploading_url(self, training_data_uploading_url):
        r"""Sets the training_data_uploading_url of this CreateTrainingThirdPartyJobResponse.

        上传训练数据的地址。训练数据需打包成zip文件后，上传至该url。  create_type取值为package时设置。 > 通过该obs地址上传时，需设置content-type为application/zip。

        :param training_data_uploading_url: The training_data_uploading_url of this CreateTrainingThirdPartyJobResponse.
        :type training_data_uploading_url: str
        """
    ...
    def segment_uploading_url(self):
        r"""Gets the segment_uploading_url of this CreateTrainingThirdPartyJobResponse.

        :return: The segment_uploading_url of this CreateTrainingThirdPartyJobResponse.
    ...
    def segment_uploading_url(self, segment_uploading_url):
        r"""Sets the segment_uploading_url of this CreateTrainingThirdPartyJobResponse.

        :param segment_uploading_url: The segment_uploading_url of this CreateTrainingThirdPartyJobResponse.
        :type segment_uploading_url: :class:`huaweicloudsdkmetastudio.v1.CreateTrainingJobRspSegmentUploadingUrl`
        """
    ...
    def authorization_letter_uploading_url(self):
        r"""Gets the authorization_letter_uploading_url of this CreateTrainingThirdPartyJobResponse.

        授权书的上传地址。

        :return: The authorization_letter_uploading_url of this CreateTrainingThirdPartyJobResponse.
        :rtype: str
        """
    ...
    def authorization_letter_uploading_url(self, authorization_letter_uploading_url):
        r"""Sets the authorization_letter_uploading_url of this CreateTrainingThirdPartyJobResponse.

        授权书的上传地址。

        :param authorization_letter_uploading_url: The authorization_letter_uploading_url of this CreateTrainingThirdPartyJobResponse.
        :type authorization_letter_uploading_url: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateTrainingThirdPartyJobResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateTrainingThirdPartyJobResponse):
            return False
