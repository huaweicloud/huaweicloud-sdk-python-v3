...
class CreateRoleReq:
    ...
    @property
    def name(self):
        r"""Gets the name of this CreateRoleReq.

        角色名称。

        :return: The name of this CreateRoleReq.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this CreateRoleReq.

        角色名称。

        :param name: The name of this CreateRoleReq.
        :type name: str
        """
        self._name = name
    ...
    def description(self):
        r"""Gets the description of this CreateRoleReq.

        角色描述。

        :return: The description of this CreateRoleReq.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this CreateRoleReq.

        角色描述。

        :param description: The description of this CreateRoleReq.
        :type description: str
        """
    ...
    def role_business_list(self):
        r"""Gets the role_business_list of this CreateRoleReq.

        角色业务配置列表

        :return: The role_business_list of this CreateRoleReq.
    ...
    def role_business_list(self, role_business_list):
        r"""Sets the role_business_list of this CreateRoleReq.

        角色业务配置列表

        :param role_business_list: The role_business_list of this CreateRoleReq.
        :type role_business_list: list[:class:`huaweicloudsdkmetastudio.v1.RoleBusinessReq`]
        """
    ...
    @property
    def llm_source(self):
        r"""Gets the llm_source of this CreateRoleReq.

        :return: The llm_source of this CreateRoleReq.
    ...
    def llm_source(self, llm_source):
        r"""Sets the llm_source of this CreateRoleReq.

        :param llm_source: The llm_source of this CreateRoleReq.
        :type llm_source: :class:`huaweicloudsdkmetastudio.v1.LlmSourceEnum`
        """
    ...
    def llm_config_id(self):
        r"""Gets the llm_config_id of this CreateRoleReq.

        大语言模型配置ID。

        :return: The llm_config_id of this CreateRoleReq.
        :rtype: str
        """
    ...
    def llm_config_id(self, llm_config_id):
        r"""Sets the llm_config_id of this CreateRoleReq.

        大语言模型配置ID。

        :param llm_config_id: The llm_config_id of this CreateRoleReq.
        :type llm_config_id: str
        """
    ...
    def plugin_config_list(self):
        r"""Gets the plugin_config_list of this CreateRoleReq.

        插件配置列表

        :return: The plugin_config_list of this CreateRoleReq.
    ...
    def plugin_config_list(self, plugin_config_list):
        r"""Sets the plugin_config_list of this CreateRoleReq.

        插件配置列表

        :param plugin_config_list: The plugin_config_list of this CreateRoleReq.
        :type plugin_config_list: list[:class:`huaweicloudsdkmetastudio.v1.RolePluginConfigInfo`]
        """
    ...
    def mcp_server_id_list(self):
        r"""Gets the mcp_server_id_list of this CreateRoleReq.

        MCP服务端对接配置ID列表

        :return: The mcp_server_id_list of this CreateRoleReq.
        :rtype: list[str]
        """
    ...
    def mcp_server_id_list(self, mcp_server_id_list):
        r"""Sets the mcp_server_id_list of this CreateRoleReq.

        MCP服务端对接配置ID列表

        :param mcp_server_id_list: The mcp_server_id_list of this CreateRoleReq.
        :type mcp_server_id_list: list[str]
        """
    ...
    def instruction_library_id(self):
        r"""Gets the instruction_library_id of this CreateRoleReq.

        指令集ID。

        :return: The instruction_library_id of this CreateRoleReq.
        :rtype: str
        """
    ...
    def instruction_library_id(self, instruction_library_id):
        r"""Sets the instruction_library_id of this CreateRoleReq.

        指令集ID。

        :param instruction_library_id: The instruction_library_id of this CreateRoleReq.
        :type instruction_library_id: str
        """
