...
class ShowTenantServiceConfigsResponse(SdkResponse):
    ...
    def __init__(self, service_shared_config=None, tenant_log_config=None, sub_account_control_config=None, is_ai_mark_on=None, x_request_id=None):
        r"""ShowTenantServiceConfigsResponse
    ...
    def service_shared_config(self):
        r"""Gets the service_shared_config of this ShowTenantServiceConfigsResponse.

        :return: The service_shared_config of this ShowTenantServiceConfigsResponse.
    ...
    def service_shared_config(self, service_shared_config):
        r"""Sets the service_shared_config of this ShowTenantServiceConfigsResponse.

        :param service_shared_config: The service_shared_config of this ShowTenantServiceConfigsResponse.
        :type service_shared_config: :class:`huaweicloudsdkmetastudio.v1.ServiceSharedConfig`
        """
    ...
    def tenant_log_config(self):
        r"""Gets the tenant_log_config of this ShowTenantServiceConfigsResponse.

        :return: The tenant_log_config of this ShowTenantServiceConfigsResponse.
    ...
    def tenant_log_config(self, tenant_log_config):
        r"""Sets the tenant_log_config of this ShowTenantServiceConfigsResponse.

        :param tenant_log_config: The tenant_log_config of this ShowTenantServiceConfigsResponse.
        :type tenant_log_config: :class:`huaweicloudsdkmetastudio.v1.TenantLogConfig`
        """
    ...
    def sub_account_control_config(self):
        r"""Gets the sub_account_control_config of this ShowTenantServiceConfigsResponse.

        :return: The sub_account_control_config of this ShowTenantServiceConfigsResponse.
    ...
    def sub_account_control_config(self, sub_account_control_config):
        r"""Sets the sub_account_control_config of this ShowTenantServiceConfigsResponse.

        :param sub_account_control_config: The sub_account_control_config of this ShowTenantServiceConfigsResponse.
        :type sub_account_control_config: :class:`huaweicloudsdkmetastudio.v1.SubAccountControlConfig`
        """
    ...
    def is_ai_mark_on(self):
        r"""Gets the is_ai_mark_on of this ShowTenantServiceConfigsResponse.

        AI标识开关

        :return: The is_ai_mark_on of this ShowTenantServiceConfigsResponse.
        :rtype: bool
        """
    ...
    def is_ai_mark_on(self, is_ai_mark_on):
        r"""Sets the is_ai_mark_on of this ShowTenantServiceConfigsResponse.

        AI标识开关

        :param is_ai_mark_on: The is_ai_mark_on of this ShowTenantServiceConfigsResponse.
        :type is_ai_mark_on: bool
        """
    ...
    def x_request_id(self):
        r"""Gets the x_request_id of this ShowTenantServiceConfigsResponse.

        :return: The x_request_id of this ShowTenantServiceConfigsResponse.
        :rtype: str
        """
    ...
    def x_request_id(self, x_request_id):
        r"""Sets the x_request_id of this ShowTenantServiceConfigsResponse.

        :param x_request_id: The x_request_id of this ShowTenantServiceConfigsResponse.
        :type x_request_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowTenantServiceConfigsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowTenantServiceConfigsResponse):
            return False
