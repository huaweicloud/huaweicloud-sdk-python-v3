...
class BatchExecuteAssetActionResponse(SdkResponse):
    ...
    def __init__(self, results=None, x_request_id=None):
        ...
        :type results: list[:class:`huaweicloudsdkmetastudio.v1.AssetActionResult`]
        :param x_request_id: 
    ...
    def results(self):
        ...
        :return: The results of this BatchExecuteAssetActionResponse.
        :rtype: list[:class:`huaweicloudsdkmetastudio.v1.AssetActionResult`]
        """
    ...
    def results(self, results):
        ...
        :param results: The results of this BatchExecuteAssetActionResponse.
        :type results: list[:class:`huaweicloudsdkmetastudio.v1.AssetActionResult`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchExecuteAssetActionResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchExecuteAssetActionResponse):
            return False
