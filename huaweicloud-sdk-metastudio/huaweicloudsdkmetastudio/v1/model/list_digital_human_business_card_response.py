...
class ListDigitalHumanBusinessCardResponse(SdkResponse):
    ...
    openapi_types = {
        'count': 'int',
        'jobs': 'list[DigitalHumanBusinessCardJobInfo]',
        'x_request_id': 'str'
    }
    ...
    def jobs(self):
        ...
        :return: The jobs of this ListDigitalHumanBusinessCardResponse.
        :rtype: list[:class:`huaweicloudsdkmetastudio.v1.DigitalHumanBusinessCardJobInfo`]
        """
        return self._jobs
    ...
    def jobs(self, jobs):
        ...
        :param jobs: The jobs of this ListDigitalHumanBusinessCardResponse.
        :type jobs: list[:class:`huaweicloudsdkmetastudio.v1.DigitalHumanBusinessCardJobInfo`]
        """
        self._jobs = jobs
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListDigitalHumanBusinessCardResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListDigitalHumanBusinessCardResponse):
            return False
