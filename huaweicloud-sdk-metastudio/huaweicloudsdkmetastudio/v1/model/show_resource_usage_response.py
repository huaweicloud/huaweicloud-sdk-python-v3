...
class ShowResourceUsageResponse(SdkResponse):
    ...
    openapi_types = {
        'resources': 'list[ResourceUsageInfo]',
        'x_request_id': 'str'
    }
    ...
    def __init__(self, resources=None, x_request_id=None):
        ...
        :type resources: list[:class:`huaweicloudsdkmetastudio.v1.ResourceUsageInfo`]
        :param x_request_id: 
    ...
    def resources(self):
        ...
        :return: The resources of this ShowResourceUsageResponse.
    ...
    def resources(self, resources):
        ...
        :param resources: The resources of this ShowResourceUsageResponse.
        :type resources: list[:class:`huaweicloudsdkmetastudio.v1.ResourceUsageInfo`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowResourceUsageResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowResourceUsageResponse):
            return False
