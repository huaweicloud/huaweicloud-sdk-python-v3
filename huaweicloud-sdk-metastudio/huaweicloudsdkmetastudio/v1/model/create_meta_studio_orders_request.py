...
class CreateMetaStudioOrdersRequest:
    ...
    openapi_types = {
        'body': 'CreateMetaStudioOrdersReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateMetaStudioOrdersRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateMetaStudioOrdersRequest):
            return False
