...
class Delete2dModelTrainingJobResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("Delete2dModelTrainingJobResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Delete2dModelTrainingJobResponse):
            return False
