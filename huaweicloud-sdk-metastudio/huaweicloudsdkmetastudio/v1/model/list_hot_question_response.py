...
class ListHotQuestionResponse(SdkResponse):
    ...
    def __init__(self, offset=None, limit=None, count=None, data=None, x_request_id=None):
        ...
        :type count: int
        :param data: 热点问题信息
        :type data: list[:class:`huaweicloudsdkmetastudio.v1.HotQuestionInfo`]
        :param x_request_id: 
    ...
    def offset(self):
        ...
        :return: The offset of this ListHotQuestionResponse.
        :rtype: int
        """
        return self._offset
    ...
    def offset(self, offset):
        ...
        :param offset: The offset of this ListHotQuestionResponse.
        :type offset: int
        """
        self._offset = offset
    ...
    def limit(self):
        ...
        :return: The limit of this ListHotQuestionResponse.
        :rtype: int
        """
        return self._limit
    ...
    def limit(self, limit):
        ...
        :param limit: The limit of this ListHotQuestionResponse.
        :type limit: int
        """
        self._limit = limit
    ...
    def count(self):
        ...
        :return: The count of this ListHotQuestionResponse.
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        ...
        :param count: The count of this ListHotQuestionResponse.
        :type count: int
        """
        self._count = count
    ...
    def data(self):
        ...
        :return: The data of this ListHotQuestionResponse.
        :rtype: list[:class:`huaweicloudsdkmetastudio.v1.HotQuestionInfo`]
        """
        return self._data
    ...
    def data(self, data):
        ...
        :param data: The data of this ListHotQuestionResponse.
        :type data: list[:class:`huaweicloudsdkmetastudio.v1.HotQuestionInfo`]
        """
        self._data = data
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListHotQuestionResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListHotQuestionResponse):
            return False
