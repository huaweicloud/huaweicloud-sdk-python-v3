...
class CreateLargeFileResponse(SdkResponse):
    ...
    def __init__(self, file_id=None, upload_urls=None, x_request_id=None):
        ...
        :param file_id: 文件ID。
        :type file_id: str
        :param upload_urls: 文件分段上传URL。
        :type upload_urls: list[str]
        :param x_request_id: 
    ...
    def file_id(self):
        ...
        :return: The file_id of this CreateLargeFileResponse.
        :rtype: str
        """
    ...
    def file_id(self, file_id):
        ...
        :param file_id: The file_id of this CreateLargeFileResponse.
        :type file_id: str
        """
    ...
    def upload_urls(self):
        ...
        :return: The upload_urls of this CreateLargeFileResponse.
        :rtype: list[str]
        """
    ...
    def upload_urls(self, upload_urls):
        ...
        :param upload_urls: The upload_urls of this CreateLargeFileResponse.
        :type upload_urls: list[str]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateLargeFileResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateLargeFileResponse):
            return False
