...
class UpdateSmartLiveRoomResponse(SdkResponse):
    ...
    @property
    def room_name(self):
        r"""Gets the room_name of this UpdateSmartLiveRoomResponse.
    ...
    def room_name(self, room_name):
        r"""Sets the room_name of this UpdateSmartLiveRoomResponse.
    ...
    def room_description(self):
        r"""Gets the room_description of this UpdateSmartLiveRoomResponse.
    ...
    def room_description(self, room_description):
        r"""Sets the room_description of this UpdateSmartLiveRoomResponse.
    ...
    @property
    def room_type(self):
        r"""Gets the room_type of this UpdateSmartLiveRoomResponse.
    ...
    def room_type(self, room_type):
        r"""Sets the room_type of this UpdateSmartLiveRoomResponse.
    ...
    def scene_scripts(self):
        r"""Gets the scene_scripts of this UpdateSmartLiveRoomResponse.
    ...
    def scene_scripts(self, scene_scripts):
        r"""Sets the scene_scripts of this UpdateSmartLiveRoomResponse.
    ...
    def interaction_config(self):
        r"""Gets the interaction_config of this UpdateSmartLiveRoomResponse.

        :return: The interaction_config of this UpdateSmartLiveRoomResponse.
    ...
    def interaction_config(self, interaction_config):
        r"""Sets the interaction_config of this UpdateSmartLiveRoomResponse.

        :param interaction_config: The interaction_config of this UpdateSmartLiveRoomResponse.
        :type interaction_config: :class:`huaweicloudsdkmetastudio.v1.LiveRoomInteractionConfig`
        """
    ...
    def interaction_rules(self):
        r"""Gets the interaction_rules of this UpdateSmartLiveRoomResponse.
    ...
    def interaction_rules(self, interaction_rules):
        r"""Sets the interaction_rules of this UpdateSmartLiveRoomResponse.
    ...
    def play_policy(self):
        r"""Gets the play_policy of this UpdateSmartLiveRoomResponse.
    ...
    def play_policy(self, play_policy):
        r"""Sets the play_policy of this UpdateSmartLiveRoomResponse.
    ...
    def video_config(self):
        r"""Gets the video_config of this UpdateSmartLiveRoomResponse.
    ...
    def video_config(self, video_config):
        r"""Sets the video_config of this UpdateSmartLiveRoomResponse.
    ...
    def output_urls(self):
        r"""Gets the output_urls of this UpdateSmartLiveRoomResponse.
    ...
    def output_urls(self, output_urls):
        r"""Sets the output_urls of this UpdateSmartLiveRoomResponse.
    ...
    def stream_keys(self):
        r"""Gets the stream_keys of this UpdateSmartLiveRoomResponse.
    ...
    def stream_keys(self, stream_keys):
        r"""Sets the stream_keys of this UpdateSmartLiveRoomResponse.
    ...
    def backup_model_asset_ids(self):
        r"""Gets the backup_model_asset_ids of this UpdateSmartLiveRoomResponse.
    ...
    def backup_model_asset_ids(self, backup_model_asset_ids):
        r"""Sets the backup_model_asset_ids of this UpdateSmartLiveRoomResponse.
    ...
    def live_event_callback_config(self):
        r"""Gets the live_event_callback_config of this UpdateSmartLiveRoomResponse.
    ...
    def live_event_callback_config(self, live_event_callback_config):
        r"""Sets the live_event_callback_config of this UpdateSmartLiveRoomResponse.
    ...
    def rtc_callback_config(self):
        r"""Gets the rtc_callback_config of this UpdateSmartLiveRoomResponse.

        :return: The rtc_callback_config of this UpdateSmartLiveRoomResponse.
    ...
    def rtc_callback_config(self, rtc_callback_config):
        r"""Sets the rtc_callback_config of this UpdateSmartLiveRoomResponse.

        :param rtc_callback_config: The rtc_callback_config of this UpdateSmartLiveRoomResponse.
        :type rtc_callback_config: :class:`huaweicloudsdkmetastudio.v1.RTCLiveEventCallBackConfig`
        """
    ...
    def review_config(self):
        r"""Gets the review_config of this UpdateSmartLiveRoomResponse.
    ...
    def review_config(self, review_config):
        r"""Sets the review_config of this UpdateSmartLiveRoomResponse.
    ...
    def shared_config(self):
        r"""Gets the shared_config of this UpdateSmartLiveRoomResponse.
    ...
    def shared_config(self, shared_config):
        r"""Sets the shared_config of this UpdateSmartLiveRoomResponse.
    ...
    @property
    def view_mode(self):
        r"""Gets the view_mode of this UpdateSmartLiveRoomResponse.

        **参数解释**： 横竖屏类型。 **约束限制**： 用户无需填写，通过video_config中分辨率判断 **取值范围**： * LANDSCAPE：横屏。 * VERTICAL： 竖屏。

        :return: The view_mode of this UpdateSmartLiveRoomResponse.
        :rtype: str
        """
    ...
    def view_mode(self, view_mode):
        r"""Sets the view_mode of this UpdateSmartLiveRoomResponse.

        **参数解释**： 横竖屏类型。 **约束限制**： 用户无需填写，通过video_config中分辨率判断 **取值范围**： * LANDSCAPE：横屏。 * VERTICAL： 竖屏。

        :param view_mode: The view_mode of this UpdateSmartLiveRoomResponse.
        :type view_mode: str
        """
    ...
    def co_streamer_config(self):
        r"""Gets the co_streamer_config of this UpdateSmartLiveRoomResponse.

        :return: The co_streamer_config of this UpdateSmartLiveRoomResponse.
    ...
    def co_streamer_config(self, co_streamer_config):
        r"""Sets the co_streamer_config of this UpdateSmartLiveRoomResponse.

        :param co_streamer_config: The co_streamer_config of this UpdateSmartLiveRoomResponse.
        :type co_streamer_config: :class:`huaweicloudsdkmetastudio.v1.CoStreamerConfig`
        """
    ...
    @property
    def priv_data(self):
        r"""Gets the priv_data of this UpdateSmartLiveRoomResponse.

        **参数解释**： 匹配值私有数据，用户填写，原样带回。 **约束限制**： 不涉及 **取值范围**： 字符长度0-8192 **默认取值**： 不涉及。

        :return: The priv_data of this UpdateSmartLiveRoomResponse.
        :rtype: str
        """
    ...
    def priv_data(self, priv_data):
        r"""Sets the priv_data of this UpdateSmartLiveRoomResponse.

        **参数解释**： 匹配值私有数据，用户填写，原样带回。 **约束限制**： 不涉及 **取值范围**： 字符长度0-8192 **默认取值**： 不涉及。

        :param priv_data: The priv_data of this UpdateSmartLiveRoomResponse.
        :type priv_data: str
        """
    ...
    @property
    def room_id(self):
        r"""Gets the room_id of this UpdateSmartLiveRoomResponse.
    ...
    def room_id(self, room_id):
        r"""Sets the room_id of this UpdateSmartLiveRoomResponse.
    ...
    def relation_live_platform_info(self):
        r"""Gets the relation_live_platform_info of this UpdateSmartLiveRoomResponse.

        :return: The relation_live_platform_info of this UpdateSmartLiveRoomResponse.
    ...
    def relation_live_platform_info(self, relation_live_platform_info):
        r"""Sets the relation_live_platform_info of this UpdateSmartLiveRoomResponse.

        :param relation_live_platform_info: The relation_live_platform_info of this UpdateSmartLiveRoomResponse.
        :type relation_live_platform_info: :class:`huaweicloudsdkmetastudio.v1.PlatformLiveDetailInfo`
        """
    ...
    def create_time(self):
        r"""Gets the create_time of this UpdateSmartLiveRoomResponse.
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this UpdateSmartLiveRoomResponse.
    ...
    def update_time(self):
        r"""Gets the update_time of this UpdateSmartLiveRoomResponse.
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this UpdateSmartLiveRoomResponse.
    ...
    @property
    def cover_url(self):
        r"""Gets the cover_url of this UpdateSmartLiveRoomResponse.
    ...
    def cover_url(self, cover_url):
        r"""Sets the cover_url of this UpdateSmartLiveRoomResponse.
    ...
    @property
    def thumbnail(self):
        r"""Gets the thumbnail of this UpdateSmartLiveRoomResponse.

        直播间封面图新URL

        :return: The thumbnail of this UpdateSmartLiveRoomResponse.
        :rtype: str
        """
    ...
    def thumbnail(self, thumbnail):
        r"""Sets the thumbnail of this UpdateSmartLiveRoomResponse.

        直播间封面图新URL

        :param thumbnail: The thumbnail of this UpdateSmartLiveRoomResponse.
        :type thumbnail: str
        """
    ...
    @property
    def room_state(self):
        r"""Gets the room_state of this UpdateSmartLiveRoomResponse.
    ...
    def room_state(self, room_state):
        r"""Sets the room_state of this UpdateSmartLiveRoomResponse.
    ...
    def confirm_state(self):
        r"""Gets the confirm_state of this UpdateSmartLiveRoomResponse.

        直播间确认状态。此状态仅用于特定用户需要人工确认场景。 - UNCONFIRM: 未确认 - CONFIRMED：已确认 - REJECT： 拒绝

        :return: The confirm_state of this UpdateSmartLiveRoomResponse.
        :rtype: str
        """
    ...
    def confirm_state(self, confirm_state):
        r"""Sets the confirm_state of this UpdateSmartLiveRoomResponse.

        直播间确认状态。此状态仅用于特定用户需要人工确认场景。 - UNCONFIRM: 未确认 - CONFIRMED：已确认 - REJECT： 拒绝

        :param confirm_state: The confirm_state of this UpdateSmartLiveRoomResponse.
        :type confirm_state: str
        """
    ...
    def script_version(self):
        r"""Gets the script_version of this UpdateSmartLiveRoomResponse.

        直播间剧本版本。调用update接口即更新版本。使用时间戳。

        :return: The script_version of this UpdateSmartLiveRoomResponse.
        :rtype: str
        """
    ...
    def script_version(self, script_version):
        r"""Sets the script_version of this UpdateSmartLiveRoomResponse.

        直播间剧本版本。调用update接口即更新版本。使用时间戳。

        :param script_version: The script_version of this UpdateSmartLiveRoomResponse.
        :type script_version: str
        """
    ...
    @property
    def error_info(self):
        r"""Gets the error_info of this UpdateSmartLiveRoomResponse.
    ...
    def error_info(self, error_info):
        r"""Sets the error_info of this UpdateSmartLiveRoomResponse.
    ...
    def x_request_id(self):
        r"""Gets the x_request_id of this UpdateSmartLiveRoomResponse.
    ...
    def x_request_id(self, x_request_id):
        r"""Sets the x_request_id of this UpdateSmartLiveRoomResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateSmartLiveRoomResponse.to_dict() is deprecated and no longer maintained, "
