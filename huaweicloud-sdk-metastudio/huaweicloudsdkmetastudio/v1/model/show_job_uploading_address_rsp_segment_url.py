...
class ShowJobUploadingAddressRspSegmentUrl:
    ...
    def __init__(self, audio_uploading_url=None, txt_uploading_url=None):
        ...
        :param audio_uploading_url: 音频上传的地址。 &gt; * 通过该obs地址上传时需要设置content-type为audio/wav
        :type audio_uploading_url: list[str]
        :param txt_uploading_url: 文本上传的地址。 &gt; * 通过该obs地址上传时需要设置content-type为text/plain
    ...
    def audio_uploading_url(self):
        ...
        :return: The audio_uploading_url of this ShowJobUploadingAddressRspSegmentUrl.
        :rtype: list[str]
        """
    ...
    def audio_uploading_url(self, audio_uploading_url):
        ...
        :param audio_uploading_url: The audio_uploading_url of this ShowJobUploadingAddressRspSegmentUrl.
        :type audio_uploading_url: list[str]
        """
    ...
    def txt_uploading_url(self):
        ...
        :return: The txt_uploading_url of this ShowJobUploadingAddressRspSegmentUrl.
        :rtype: list[str]
        """
    ...
    def txt_uploading_url(self, txt_uploading_url):
        ...
        :param txt_uploading_url: The txt_uploading_url of this ShowJobUploadingAddressRspSegmentUrl.
        :type txt_uploading_url: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowJobUploadingAddressRspSegmentUrl):
            return False
