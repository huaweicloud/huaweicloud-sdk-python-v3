...
class Show2dModelTrainingJobResponse(SdkResponse):
    ...
    openapi_types = {
        ...
        'external_action_json_data_download_url': 'str',
        'action_video_download_url': 'str',
        'post_beauty_image_download_url': 'str',
        'audio_file_download_url': 'str',
        'action_mark_file_download_url': 'str',
        'action_mark_file_upload_url': 'str',
        ...
        'markable_action_video_download_url': 'str',
        ...
        'train_video_rotation_state': 'str',
        'action_video_rotation_state': 'str',
        'sub_training_job_info': 'list[SubTrainingJobInfoDto]',
        'x_request_id': 'str'
    }
    ...
    attribute_map = {
        ...
        'external_action_json_data_download_url': 'external_action_json_data_download_url',
        ...
        'action_mark_file_download_url': 'action_mark_file_download_url',
        'action_mark_file_upload_url': 'action_mark_file_upload_url',
        ...
        'markable_action_video_download_url': 'markable_action_video_download_url',
        ...
        'train_video_rotation_state': 'train_video_rotation_state',
        'action_video_rotation_state': 'action_video_rotation_state',
        'sub_training_job_info': 'sub_training_job_info',
        'x_request_id': 'X-Request-Id'
    }

    def __init__(self, job_id=None, name=None, state=None, asset_id=None, project_id=None, cover_download_url=None, last_update_time=None, create_time=None, contact=None, batch_name=None, tags=None, model_version=None, matting_type=None, model_resolution=None, app_user_id=None, is_flexus=None, is_live_copy=None, is_fast_flexus=None, is_only_human_model=None, optional_training_location=None, is_background_replacement=None, is_ondemand_resource=None, training_video_download_url=None, id_card_image1_download_url=None, id_card_image2_download_url=None, grant_file_download_url=None, pre_beauty_image_download_url=None, external_action_json_data_download_url=None, action_video_download_url=None, post_beauty_image_download_url=None, audio_file_download_url=None, action_mark_file_download_url=None, action_mark_file_upload_url=None, operation_logs=None, verify_video_matting_info=None, comment_logs=None, samples=None, is_mask_file_uploaded=None, mask_file_download_url=None, verify_video_download_url=None, markable_video_download_url=None, markable_action_video_download_url=None, traning_video_mark_info=None, inference_data_process_video_mark_info=None, voice_properties=None, inference_data_process_action_mark_info=None, inference_data_process_chat_action_mark_info=None, inference_data_process_eye_correction_mark_info=None, worker_type=None, voice_train_job_id=None, flexus_retry_count=None, audio_source_type=None, supported_service=None, allocated_resource=None, train_video_rotation_state=None, action_video_rotation_state=None, sub_training_job_info=None, x_request_id=None):
        ...
        :param external_action_json_data_download_url: 授权书下载URL。24小时内有效。
        :type external_action_json_data_download_url: str
        ...
        :param action_mark_file_download_url: 动作标定文件下载url。
        :type action_mark_file_download_url: str
        :param action_mark_file_upload_url: 动作标定文件上传url。
        :type action_mark_file_upload_url: str
        ...
        :param markable_action_video_download_url: 动作标注视频url下载链接。24小时内有效。
        :type markable_action_video_download_url: str
        ...
        :param train_video_rotation_state: 训练视频旋转任务状态。 * WAITING：等待中 * PROCESSING：转编译中 * SUCCESS：转编译成功 * FAILED：转编译失败
        :type train_video_rotation_state: str
        :param action_video_rotation_state: 训练视频旋转任务状态。 * WAITING：等待中 * PROCESSING：转编译中 * SUCCESS：转编译成功 * FAILED：转编译失败
        :type action_video_rotation_state: str
        :param sub_training_job_info: 子任务信息
        :type sub_training_job_info: list[:class:`huaweicloudsdkmetastudio.v1.SubTrainingJobInfoDto`]
        :param x_request_id: 
        ...
        self._external_action_json_data_download_url = None
        self._action_video_download_url = None
        self._post_beauty_image_download_url = None
        self._audio_file_download_url = None
        self._action_mark_file_download_url = None
        self._action_mark_file_upload_url = None
        ...
        self._markable_action_video_download_url = None
        ...
        self._train_video_rotation_state = None
        self._action_video_rotation_state = None
        self._sub_training_job_info = None
        ...
        if external_action_json_data_download_url is not None:
            self.external_action_json_data_download_url = external_action_json_data_download_url
        ...
        if action_mark_file_download_url is not None:
            self.action_mark_file_download_url = action_mark_file_download_url
        if action_mark_file_upload_url is not None:
            self.action_mark_file_upload_url = action_mark_file_upload_url
        ...
        if markable_action_video_download_url is not None:
            self.markable_action_video_download_url = markable_action_video_download_url
        ...
        if train_video_rotation_state is not None:
            self.train_video_rotation_state = train_video_rotation_state
        if action_video_rotation_state is not None:
            self.action_video_rotation_state = action_video_rotation_state
        if sub_training_job_info is not None:
            self.sub_training_job_info = sub_training_job_info
    ...
    def is_live_copy(self):
        r"""Gets the is_live_copy of this Show2dModelTrainingJobResponse.

        是否是直播间复刻任务

        :return: The is_live_copy of this Show2dModelTrainingJobResponse.
        :rtype: bool
        """
    ...
    def is_live_copy(self, is_live_copy):
        r"""Sets the is_live_copy of this Show2dModelTrainingJobResponse.

        是否是直播间复刻任务

        :param is_live_copy: The is_live_copy of this Show2dModelTrainingJobResponse.
        :type is_live_copy: bool
        """
    ...
    def is_fast_flexus(self):
        r"""Gets the is_fast_flexus of this Show2dModelTrainingJobResponse.

        是否极速版flexus

        :return: The is_fast_flexus of this Show2dModelTrainingJobResponse.
        :rtype: bool
        """
    ...
    def is_fast_flexus(self, is_fast_flexus):
        r"""Sets the is_fast_flexus of this Show2dModelTrainingJobResponse.

        是否极速版flexus

        :param is_fast_flexus: The is_fast_flexus of this Show2dModelTrainingJobResponse.
        :type is_fast_flexus: bool
        """
    ...
    def optional_training_location(self):
        r"""Gets the optional_training_location of this Show2dModelTrainingJobResponse.

        可选训练region

        :return: The optional_training_location of this Show2dModelTrainingJobResponse.
        :rtype: list[str]
        """
    ...
    def optional_training_location(self, optional_training_location):
        r"""Sets the optional_training_location of this Show2dModelTrainingJobResponse.

        可选训练region

        :param optional_training_location: The optional_training_location of this Show2dModelTrainingJobResponse.
        :type optional_training_location: list[str]
        """
    ...
    def is_ondemand_resource(self):
        r"""Gets the is_ondemand_resource of this Show2dModelTrainingJobResponse.

        是否按需任务

        :return: The is_ondemand_resource of this Show2dModelTrainingJobResponse.
        :rtype: bool
        """
    ...
    def is_ondemand_resource(self, is_ondemand_resource):
        r"""Sets the is_ondemand_resource of this Show2dModelTrainingJobResponse.

        是否按需任务

        :param is_ondemand_resource: The is_ondemand_resource of this Show2dModelTrainingJobResponse.
        :type is_ondemand_resource: bool
        """
    ...
    @property
    def external_action_json_data_download_url(self):
        r"""Gets the external_action_json_data_download_url of this Show2dModelTrainingJobResponse.

        授权书下载URL。24小时内有效。

        :return: The external_action_json_data_download_url of this Show2dModelTrainingJobResponse.
        :rtype: str
        """
        return self._external_action_json_data_download_url

    @external_action_json_data_download_url.setter
    def external_action_json_data_download_url(self, external_action_json_data_download_url):
        r"""Sets the external_action_json_data_download_url of this Show2dModelTrainingJobResponse.

        授权书下载URL。24小时内有效。

        :param external_action_json_data_download_url: The external_action_json_data_download_url of this Show2dModelTrainingJobResponse.
        :type external_action_json_data_download_url: str
        """
        self._external_action_json_data_download_url = external_action_json_data_download_url
    ...
    @property
    def action_mark_file_download_url(self):
        r"""Gets the action_mark_file_download_url of this Show2dModelTrainingJobResponse.

        动作标定文件下载url。

        :return: The action_mark_file_download_url of this Show2dModelTrainingJobResponse.
        :rtype: str
        """
        return self._action_mark_file_download_url

    @action_mark_file_download_url.setter
    def action_mark_file_download_url(self, action_mark_file_download_url):
        r"""Sets the action_mark_file_download_url of this Show2dModelTrainingJobResponse.

        动作标定文件下载url。

        :param action_mark_file_download_url: The action_mark_file_download_url of this Show2dModelTrainingJobResponse.
        :type action_mark_file_download_url: str
        """
        self._action_mark_file_download_url = action_mark_file_download_url

    @property
    def action_mark_file_upload_url(self):
        r"""Gets the action_mark_file_upload_url of this Show2dModelTrainingJobResponse.

        动作标定文件上传url。

        :return: The action_mark_file_upload_url of this Show2dModelTrainingJobResponse.
        :rtype: str
        """
        return self._action_mark_file_upload_url

    @action_mark_file_upload_url.setter
    def action_mark_file_upload_url(self, action_mark_file_upload_url):
        r"""Sets the action_mark_file_upload_url of this Show2dModelTrainingJobResponse.

        动作标定文件上传url。

        :param action_mark_file_upload_url: The action_mark_file_upload_url of this Show2dModelTrainingJobResponse.
        :type action_mark_file_upload_url: str
        """
        self._action_mark_file_upload_url = action_mark_file_upload_url
    ...
    @property
    def markable_action_video_download_url(self):
        r"""Gets the markable_action_video_download_url of this Show2dModelTrainingJobResponse.

        动作标注视频url下载链接。24小时内有效。

        :return: The markable_action_video_download_url of this Show2dModelTrainingJobResponse.
        :rtype: str
        """
        return self._markable_action_video_download_url

    @markable_action_video_download_url.setter
    def markable_action_video_download_url(self, markable_action_video_download_url):
        r"""Sets the markable_action_video_download_url of this Show2dModelTrainingJobResponse.

        动作标注视频url下载链接。24小时内有效。

        :param markable_action_video_download_url: The markable_action_video_download_url of this Show2dModelTrainingJobResponse.
        :type markable_action_video_download_url: str
        """
        self._markable_action_video_download_url = markable_action_video_download_url
    ...
    def voice_properties(self):
        r"""Gets the voice_properties of this Show2dModelTrainingJobResponse.

        :return: The voice_properties of this Show2dModelTrainingJobResponse.
    ...
    def voice_properties(self, voice_properties):
        r"""Sets the voice_properties of this Show2dModelTrainingJobResponse.

        :param voice_properties: The voice_properties of this Show2dModelTrainingJobResponse.
        :type voice_properties: :class:`huaweicloudsdkmetastudio.v1.VoiceProperties`
        """
    ...
    @property
    def train_video_rotation_state(self):
        r"""Gets the train_video_rotation_state of this Show2dModelTrainingJobResponse.

        训练视频旋转任务状态。 * WAITING：等待中 * PROCESSING：转编译中 * SUCCESS：转编译成功 * FAILED：转编译失败

        :return: The train_video_rotation_state of this Show2dModelTrainingJobResponse.
        :rtype: str
        """
        return self._train_video_rotation_state

    @train_video_rotation_state.setter
    def train_video_rotation_state(self, train_video_rotation_state):
        r"""Sets the train_video_rotation_state of this Show2dModelTrainingJobResponse.

        训练视频旋转任务状态。 * WAITING：等待中 * PROCESSING：转编译中 * SUCCESS：转编译成功 * FAILED：转编译失败

        :param train_video_rotation_state: The train_video_rotation_state of this Show2dModelTrainingJobResponse.
        :type train_video_rotation_state: str
        """
        self._train_video_rotation_state = train_video_rotation_state

    @property
    def action_video_rotation_state(self):
        r"""Gets the action_video_rotation_state of this Show2dModelTrainingJobResponse.

        训练视频旋转任务状态。 * WAITING：等待中 * PROCESSING：转编译中 * SUCCESS：转编译成功 * FAILED：转编译失败

        :return: The action_video_rotation_state of this Show2dModelTrainingJobResponse.
        :rtype: str
        """
        return self._action_video_rotation_state

    @action_video_rotation_state.setter
    def action_video_rotation_state(self, action_video_rotation_state):
        r"""Sets the action_video_rotation_state of this Show2dModelTrainingJobResponse.

        训练视频旋转任务状态。 * WAITING：等待中 * PROCESSING：转编译中 * SUCCESS：转编译成功 * FAILED：转编译失败

        :param action_video_rotation_state: The action_video_rotation_state of this Show2dModelTrainingJobResponse.
        :type action_video_rotation_state: str
        """
        self._action_video_rotation_state = action_video_rotation_state

    @property
    def sub_training_job_info(self):
        r"""Gets the sub_training_job_info of this Show2dModelTrainingJobResponse.

        子任务信息

        :return: The sub_training_job_info of this Show2dModelTrainingJobResponse.
        :rtype: list[:class:`huaweicloudsdkmetastudio.v1.SubTrainingJobInfoDto`]
        """
        return self._sub_training_job_info

    @sub_training_job_info.setter
    def sub_training_job_info(self, sub_training_job_info):
        r"""Sets the sub_training_job_info of this Show2dModelTrainingJobResponse.

        子任务信息

        :param sub_training_job_info: The sub_training_job_info of this Show2dModelTrainingJobResponse.
        :type sub_training_job_info: list[:class:`huaweicloudsdkmetastudio.v1.SubTrainingJobInfoDto`]
        """
        self._sub_training_job_info = sub_training_job_info
    ...
    def to_dict(self):
        import warnings
        warnings.warn("Show2dModelTrainingJobResponse.to_dict() is deprecated and no longer maintained, "
