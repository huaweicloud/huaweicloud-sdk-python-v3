...
class DeleteAddonInstanceRequest:
    ...
    def __init__(self, id=None, cluster_id=None):
        ...
        :param id: 插件实例id
        :type id: str
        :param cluster_id: cluster_id 为空时，使用 addonInstance 的 cluster_id；不为空时，需要校验addonInstance 的 cluster_id 和 query 中的是否相同
        :type cluster_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteAddonInstanceRequest):
            return False
