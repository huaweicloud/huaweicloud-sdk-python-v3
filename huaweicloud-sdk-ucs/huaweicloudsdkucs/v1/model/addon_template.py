...
class AddonTemplate:
    ...
    openapi_types = {
        'kind': 'str',
        'api_version': 'str',
        'metadata': 'AddonObjectMeta',
        'spec': 'AddonTemplateSpec'
    }
    ...
    def __init__(self, kind=None, api_version=None, metadata=None, spec=None):
        ...
        :param metadata: 
        :type metadata: :class:`huaweicloudsdkucs.v1.AddonObjectMeta`
        :param spec: 
        :type spec: :class:`huaweicloudsdkucs.v1.AddonTemplateSpec`
        """
    ...
    def metadata(self):
        ...
        :rtype: :class:`huaweicloudsdkucs.v1.AddonObjectMeta`
        """
    ...
    def spec(self):
        ...
        :rtype: :class:`huaweicloudsdkucs.v1.AddonTemplateSpec`
        """
        return self._spec
