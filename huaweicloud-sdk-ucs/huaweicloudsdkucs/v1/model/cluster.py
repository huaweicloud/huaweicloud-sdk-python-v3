...
class Cluster:
    ...
    def __init__(self, kind=None, api_version=None, metadata=None, spec=None, status=None):
        ...
        :param spec: 
        :type spec: :class:`huaweicloudsdkucs.v1.ClusterSpec`
        :param status: 
        :type status: :class:`huaweicloudsdkucs.v1.ClusterStatus`
        """
    ...
    def spec(self):
        ...
        :rtype: :class:`huaweicloudsdkucs.v1.ClusterSpec`
        """
        return self._spec
    ...
    def status(self):
        ...
        :rtype: :class:`huaweicloudsdkucs.v1.ClusterStatus`
        """
        return self._status
