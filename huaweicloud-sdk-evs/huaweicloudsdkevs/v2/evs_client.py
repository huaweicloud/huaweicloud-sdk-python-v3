...
class EvsClient(Client):
    ...
    def change_volume_charge_mode(self, request):
        r"""修改云硬盘计费模式
        ...
        :param request: Request instance for ChangeVolumeChargeMode
        :type request: :class:`huaweicloudsdkevs.v2.ChangeVolumeChargeModeRequest`
        :rtype: :class:`huaweicloudsdkevs.v2.ChangeVolumeChargeModeResponse`
        """
        http_info = self._change_volume_charge_mode_http_info(request)
        return self._call_api(**http_info)

    def change_volume_charge_mode_invoker(self, request):
        http_info = self._change_volume_charge_mode_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _change_volume_charge_mode_http_info(cls, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v2/{project_id}/cloudvolumes/change-charge-mode",
            "request_type": request.__class__.__name__,
            "response_type": "ChangeVolumeChargeModeResponse"
            }
    ...
    def delete_volume_in_recycle(self, request):
        r"""删除回收站中单个云硬盘
    ...
    def delete_volume_in_recycle_invoker(self, request):
        http_info = self._delete_volume_in_recycle_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_volume_in_recycle_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_volumes_in_recycle(self, request):
        r"""查询回收站中所有云硬盘详情
    ...
    def list_volumes_in_recycle_invoker(self, request):
        http_info = self._list_volumes_in_recycle_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_volumes_in_recycle_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def revert_volume_in_recycle(self, request):
        r"""还原回收站中单个云硬盘
    ...
    def revert_volume_in_recycle_invoker(self, request):
        http_info = self._revert_volume_in_recycle_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _revert_volume_in_recycle_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def show_volume_in_recycle(self, request):
        r"""查询回收站中单个云硬盘详情
    ...
    def show_volume_in_recycle_invoker(self, request):
        http_info = self._show_volume_in_recycle_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_volume_in_recycle_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v3/{project_id}/recycle-bin-volumes/{volume_id}",
            "request_type": request.__class__.__name__,
    ...
    def update_recycle_policy(self, request):
        r"""更新回收站策略
    ...
    def update_recycle_policy_invoker(self, request):
        http_info = self._update_recycle_policy_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_recycle_policy_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v3/{project_id}/recycle-bin-volumes/policy",
            "request_type": request.__class__.__name__,
