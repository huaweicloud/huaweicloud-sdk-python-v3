...
class UnsubscribePostpaidVolumeRequest:
    ...
    openapi_types = {
        'body': 'UnsubscribeVolumeRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the UnsubscribePostpaidVolumeRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UnsubscribePostpaidVolumeRequest):
            return False
