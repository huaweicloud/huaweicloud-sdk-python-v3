...
class CreateVolumeOption:
    ...
    def __init__(self, availability_zone=None, backup_id=None, count=None, description=None, enterprise_project_id=None, image_ref=None, metadata=None, multiattach=None, name=None, size=None, snapshot_id=None, volume_type=None, tags=None, iops=None, throughput=None):
        r"""CreateVolumeOption
    ...
    def availability_zone(self):
        r"""Gets the availability_zone of this CreateVolumeOption.
    ...
    def availability_zone(self, availability_zone):
        r"""Sets the availability_zone of this CreateVolumeOption.
    ...
    @property
    def backup_id(self):
        r"""Gets the backup_id of this CreateVolumeOption.
    ...
    def backup_id(self, backup_id):
        r"""Sets the backup_id of this CreateVolumeOption.
    ...
    @property
    def count(self):
        r"""Gets the count of this CreateVolumeOption.
    ...
    def count(self, count):
        r"""Sets the count of this CreateVolumeOption.
    ...
    def description(self):
        r"""Gets the description of this CreateVolumeOption.
    ...
    def description(self, description):
        r"""Sets the description of this CreateVolumeOption.
    ...
    def enterprise_project_id(self):
        r"""Gets the enterprise_project_id of this CreateVolumeOption.
    ...
    def enterprise_project_id(self, enterprise_project_id):
        r"""Sets the enterprise_project_id of this CreateVolumeOption.
    ...
    @property
    def image_ref(self):
        r"""Gets the image_ref of this CreateVolumeOption.
    ...
    def image_ref(self, image_ref):
        r"""Sets the image_ref of this CreateVolumeOption.
    ...
    @property
    def metadata(self):
        r"""Gets the metadata of this CreateVolumeOption.
    ...
    def metadata(self, metadata):
        r"""Sets the metadata of this CreateVolumeOption.
    ...
    def multiattach(self):
        r"""Gets the multiattach of this CreateVolumeOption.
    ...
    def multiattach(self, multiattach):
        r"""Sets the multiattach of this CreateVolumeOption.
    ...
    @property
    def name(self):
        r"""Gets the name of this CreateVolumeOption.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this CreateVolumeOption.
    ...
    @property
    def size(self):
        r"""Gets the size of this CreateVolumeOption.
    ...
    @size.setter
    def size(self, size):
        r"""Sets the size of this CreateVolumeOption.
    ...
    def snapshot_id(self):
        r"""Gets the snapshot_id of this CreateVolumeOption.
    ...
    def snapshot_id(self, snapshot_id):
        r"""Sets the snapshot_id of this CreateVolumeOption.
    ...
    def volume_type(self):
        r"""Gets the volume_type of this CreateVolumeOption.
    ...
    def volume_type(self, volume_type):
        r"""Sets the volume_type of this CreateVolumeOption.
    ...
    @property
    def tags(self):
        r"""Gets the tags of this CreateVolumeOption.
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this CreateVolumeOption.
    ...
    @property
    def iops(self):
        r"""Gets the iops of this CreateVolumeOption.
        ...
        :return: The iops of this CreateVolumeOption.
        :rtype: int
        """
        return self._iops
    ...
    @iops.setter
    def iops(self, iops):
        r"""Sets the iops of this CreateVolumeOption.

        给云硬盘配置iops，购买GPSSD2、ESSD2类型的云硬盘时必填，其他类型不能设置。  说明： 1、了解GPSSD2、ESSD2类型的iops大小范围，请参见 [云硬盘类型及性能介绍里面的云硬盘性能数据表](https://support.huaweicloud.com/productdesc-evs/zh-cn_topic_0044524691.html)。 2、只支持按需计费。

        :param iops: The iops of this CreateVolumeOption.
        :type iops: int
        """
        self._iops = iops
    ...
    @property
    def throughput(self):
        r"""Gets the throughput of this CreateVolumeOption.
        ...
        :return: The throughput of this CreateVolumeOption.
        :rtype: int
        """
    ...
    def throughput(self, throughput):
        r"""Sets the throughput of this CreateVolumeOption.

        给云硬盘配置吞吐量，单位是MiB/s，购买GPSSD2类型云盘时必填，其他类型不能设置。  说明： 1、了解GPSSD2类型的吞吐量大小范围，请参见 [云硬盘类型及性能介绍里面的云硬盘性能数据表](https://support.huaweicloud.com/productdesc-evs/zh-cn_topic_0044524691.html)。 2、只支持按需计费。

        :param throughput: The throughput of this CreateVolumeOption.
        :type throughput: int
        """
