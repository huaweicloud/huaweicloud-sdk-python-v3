...
class UpdateSnapshotRequest(object):
    ...
    openapi_types = {
        'snapshot_id': 'str',
        'body': 'UpdateSnapshotRequestBody'
    }
    ...
    def __init__(self, snapshot_id=None, body=None):  # noqa: E501
        """UpdateSnapshotRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: UpdateSnapshotRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateSnapshotRequest):
            return False
