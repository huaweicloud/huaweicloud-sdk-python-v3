...
class QuotaDetailPerVolumeGigabytes:
    ...
    def __init__(self, in_use=None, limit=None, reserved=None, allocated=None):
        """QuotaDetailPerVolumeGigabytes - a model defined in huaweicloud sdk"""
    ...
    @property
    def allocated(self):
        """Gets the allocated of this QuotaDetailPerVolumeGigabytes.

        预留属性。

        :return: The allocated of this QuotaDetailPerVolumeGigabytes.
        :rtype: str
        """
    ...
    def allocated(self, allocated):
        """Sets the allocated of this QuotaDetailPerVolumeGigabytes.

        预留属性。

        :param allocated: The allocated of this QuotaDetailPerVolumeGigabytes.
        :type: str
        """
