...
class ResizeVolumeResponse(SdkResponse):
    ...
    @property
    def job_id(self):
        r"""Gets the job_id of this ResizeVolumeResponse.
    ...
    def job_id(self, job_id):
        r"""Sets the job_id of this ResizeVolumeResponse.
    ...
    @property
    def order_id(self):
        r"""Gets the order_id of this ResizeVolumeResponse.
    ...
    def order_id(self, order_id):
        r"""Sets the order_id of this ResizeVolumeResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ResizeVolumeResponse.to_dict() is deprecated and no longer maintained, "
