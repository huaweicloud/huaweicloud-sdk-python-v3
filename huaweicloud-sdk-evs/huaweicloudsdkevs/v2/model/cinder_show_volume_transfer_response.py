...
class CinderShowVolumeTransferResponse(SdkResponse):
    ...
    def __init__(self, transfer=None):
        r"""CinderShowVolumeTransferResponse
    ...
    @property
    def transfer(self):
        r"""Gets the transfer of this CinderShowVolumeTransferResponse.
    ...
    def transfer(self, transfer):
        r"""Sets the transfer of this CinderShowVolumeTransferResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CinderShowVolumeTransferResponse.to_dict() is deprecated and no longer maintained, "
