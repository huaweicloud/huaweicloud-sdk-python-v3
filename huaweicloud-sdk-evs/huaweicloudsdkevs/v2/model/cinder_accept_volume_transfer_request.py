...
class CinderAcceptVolumeTransferRequest:
    ...
    openapi_types = {
        'transfer_id': 'str',
        'body': 'CinderAcceptVolumeTransferRequestBody'
    }
    ...
    def __init__(self, transfer_id=None, body=None):
        ...
        :param transfer_id: 云硬盘ID
        :type transfer_id: str
        :param body: Body of the CinderAcceptVolumeTransferRequest
    ...
    def transfer_id(self):
        ...
        :return: The transfer_id of this CinderAcceptVolumeTransferRequest.
        :rtype: str
        """
    ...
    def transfer_id(self, transfer_id):
        ...
        :param transfer_id: The transfer_id of this CinderAcceptVolumeTransferRequest.
        :type transfer_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CinderAcceptVolumeTransferRequest):
            return False
