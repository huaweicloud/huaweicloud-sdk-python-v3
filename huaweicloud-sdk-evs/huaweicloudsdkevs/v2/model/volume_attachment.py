...
class VolumeAttachment(object):
    ...
    def attached_at(self):
        """Gets the attached_at of this VolumeAttachment.

        挂载的时间信息。  时间格式：UTC YYYY-MM-DDTHH:MM:SS.XXXXXX

        :return: The attached_at of this VolumeAttachment.
        :rtype: str
        """
    ...
    def attached_at(self, attached_at):
        """Sets the attached_at of this VolumeAttachment.

        挂载的时间信息。  时间格式：UTC YYYY-MM-DDTHH:MM:SS.XXXXXX

        :param attached_at: The attached_at of this VolumeAttachment.
        :type: str
        """
    ...
    def attachment_id(self):
        """Gets the attachment_id of this VolumeAttachment.

        挂载信息对应的ID。

        :return: The attachment_id of this VolumeAttachment.
        :rtype: str
        """
    ...
    def attachment_id(self, attachment_id):
        """Sets the attachment_id of this VolumeAttachment.

        挂载信息对应的ID。

        :param attachment_id: The attachment_id of this VolumeAttachment.
        :type: str
        """
    ...
    @property
    def host_name(self):
        """Gets the host_name of this VolumeAttachment.

        云硬盘挂载到的云服务器云主机对应 的物理主机的名称。

        :return: The host_name of this VolumeAttachment.
        :rtype: str
        """
    ...
    def host_name(self, host_name):
        """Sets the host_name of this VolumeAttachment.

        云硬盘挂载到的云服务器云主机对应 的物理主机的名称。

        :param host_name: The host_name of this VolumeAttachment.
        :type: str
        """
    ...
    @property
    def server_id(self):
        """Gets the server_id of this VolumeAttachment.

        云硬盘挂载到的云服务器云主机的 ID。

        :return: The server_id of this VolumeAttachment.
        :rtype: str
        """
    ...
    def server_id(self, server_id):
        ...
        :param server_id: The server_id of this VolumeAttachment.
        :type: str
        """
