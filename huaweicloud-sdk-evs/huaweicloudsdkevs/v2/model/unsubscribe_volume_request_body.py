...
class UnsubscribeVolumeRequestBody:
    ...
    def volume_ids(self):
        ...
        :return: The volume_ids of this UnsubscribeVolumeRequestBody.
        :rtype: list[str]
        """
    ...
    def volume_ids(self, volume_ids):
        ...
        :param volume_ids: The volume_ids of this UnsubscribeVolumeRequestBody.
        :type volume_ids: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UnsubscribeVolumeRequestBody):
            return False
