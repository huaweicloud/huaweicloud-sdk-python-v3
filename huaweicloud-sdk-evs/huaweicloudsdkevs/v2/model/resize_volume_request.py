...
class ResizeVolumeRequest(object):
    ...
    def volume_id(self):
        ...
        :return: The volume_id of this ResizeVolumeRequest.
        :rtype: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResizeVolumeRequest):
            return False
