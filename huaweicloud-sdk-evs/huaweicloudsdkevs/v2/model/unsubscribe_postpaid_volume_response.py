...
class UnsubscribePostpaidVolumeResponse(SdkResponse):
    ...
    def __init__(self, body=None):
        ...
        super(UnsubscribePostpaidVolumeResponse, self).__init__()
    ...
    @property
    def body(self):
        """Gets the body of this UnsubscribePostpaidVolumeResponse.
    ...
    @body.setter
    def body(self, body):
        """Sets the body of this UnsubscribePostpaidVolumeResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UnsubscribePostpaidVolumeResponse):
            return False
