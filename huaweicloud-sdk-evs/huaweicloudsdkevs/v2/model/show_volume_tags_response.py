...
class ShowVolumeTagsResponse(SdkResponse):
    ...
    @property
    def tags(self):
        r"""Gets the tags of this ShowVolumeTagsResponse.
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this ShowVolumeTagsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowVolumeTagsResponse.to_dict() is deprecated and no longer maintained, "
