...
class ShowSnapshotResponse(SdkResponse):
    ...
    @property
    def snapshot(self):
        r"""Gets the snapshot of this ShowSnapshotResponse.
    ...
    def snapshot(self, snapshot):
        r"""Sets the snapshot of this ShowSnapshotResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowSnapshotResponse.to_dict() is deprecated and no longer maintained, "
