...
class EvsAsyncClient(Client):
    ...
    def batch_resize_volumes_async(self, request):
        r"""批量扩容云硬盘
    ...
    def batch_resize_volumes_async_invoker(self, request):
        http_info = self._batch_resize_volumes_http_info(request)
        return AsyncInvoker(self, http_info)

    def _batch_resize_volumes_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def change_volume_charge_mode_async(self, request):
        r"""修改云硬盘计费模式
    ...
    def change_volume_charge_mode_async_invoker(self, request):
        http_info = self._change_volume_charge_mode_http_info(request)
        return AsyncInvoker(self, http_info)

    def _change_volume_charge_mode_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def retype_volume_async_invoker(self, request):
        http_info = self._retype_volume_http_info(request)
        return AsyncInvoker(self, http_info)

    def _retype_volume_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def unsubscribe_postpaid_volume_async_invoker(self, request):
        http_info = self._unsubscribe_postpaid_volume_http_info(request)
        return AsyncInvoker(self, http_info)

    def _unsubscribe_postpaid_volume_http_info(self, request):
        http_info = {
            "method": "POST",
