...
class ChangeBaremetalServerNameResponse(SdkResponse):
    ...
    openapi_types = {
        'server': 'ChangeBaremetalNameResponsesServers'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ChangeBaremetalServerNameResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChangeBaremetalServerNameResponse):
            return False
