...
class CreateBareMetalServersRequest:
    ...
    openapi_types = {
        'body': 'CreateBaremetalServersBody'
    }
    ...
    def __init__(self, body=None):
        """CreateBareMetalServersRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: CreateBaremetalServersBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateBareMetalServersRequest):
            return False
