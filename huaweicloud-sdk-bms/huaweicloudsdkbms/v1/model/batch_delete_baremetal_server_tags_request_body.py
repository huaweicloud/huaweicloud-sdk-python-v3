...
class BatchDeleteBaremetalServerTagsRequestBody:
    ...
    def __init__(self, action=None, tags=None):
        r"""BatchDeleteBaremetalServerTagsRequestBody
    ...
    @property
    def action(self):
        r"""Gets the action of this BatchDeleteBaremetalServerTagsRequestBody.
    ...
    def action(self, action):
        r"""Sets the action of this BatchDeleteBaremetalServerTagsRequestBody.
    ...
    @property
    def tags(self):
        r"""Gets the tags of this BatchDeleteBaremetalServerTagsRequestBody.
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this BatchDeleteBaremetalServerTagsRequestBody.
