...
class BatchDeleteBaremetalServerTagsRequest:
    ...
    openapi_types = {
        'server_id': 'str',
        'body': 'BatchDeleteBaremetalServerTagsRequestBody'
    }
    ...
    def __init__(self, server_id=None, body=None):
        """BatchDeleteBaremetalServerTagsRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: BatchDeleteBaremetalServerTagsRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteBaremetalServerTagsRequest):
            return False
