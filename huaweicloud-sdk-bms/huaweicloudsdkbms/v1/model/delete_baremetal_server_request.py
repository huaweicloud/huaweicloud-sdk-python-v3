...
class DeleteBaremetalServerRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the DeleteBaremetalServerRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteBaremetalServerRequest):
            return False
