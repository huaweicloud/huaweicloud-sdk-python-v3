...
class BmsClient(Client):
    ...
    def modify_vm_nic(self, request):
        r"""编辑port
    ...
    def modify_vm_nic_invoker(self, request):
        http_info = self._modify_vm_nic_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _modify_vm_nic_http_info(cls, request):
        http_info = {
            "method": "PUT",
    ...
    def show_available_resource(self, request):
        r"""查询可用资源
    ...
    def show_available_resource_invoker(self, request):
        http_info = self._show_available_resource_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_available_resource_http_info(cls, request):
        http_info = {
            "method": "GET",
