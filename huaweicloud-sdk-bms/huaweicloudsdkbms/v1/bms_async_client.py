...
class BmsAsyncClient(Client):
    ...
    def delete_baremetal_server_async_invoker(self, request):
        http_info = self._delete_baremetal_server_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_baremetal_server_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def list_bare_metal_servers_detail_async(self, request):
        r"""查询裸金属服务器列表
    ...
    def list_bare_metal_servers_detail_async_invoker(self, request):
        http_info = self._list_bare_metal_servers_detail_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_bare_metal_servers_detail_http_info(self, request):
        http_info = {
            "method": "GET",
