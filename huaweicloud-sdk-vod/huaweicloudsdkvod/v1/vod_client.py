...
class VodClient(Client):
    ...
    def create_asset_edit_task(self, request):
        r"""创建编辑任务
    ...
    def create_asset_edit_task_invoker(self, request):
        http_info = self._create_asset_edit_task_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_asset_edit_task_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def create_edit_task(self, request):
        r"""create_edit_task
    ...
    def create_edit_task_invoker(self, request):
        http_info = self._create_edit_task_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_edit_task_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def create_object_process_task(self, request):
        r"""创建视频处理任务
    ...
    def create_object_process_task_invoker(self, request):
        http_info = self._create_object_process_task_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_object_process_task_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def create_object_replication(self, request):
        r"""obs桶内容复制
    ...
    def create_object_replication_invoker(self, request):
        http_info = self._create_object_replication_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_object_replication_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def create_object_retrieval(self, request):
        r"""obs桶内容解冻
    ...
    def create_object_retrieval_invoker(self, request):
        http_info = self._create_object_retrieval_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_object_retrieval_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def create_real_time_clip(self, request):
        r"""直播内容即时剪辑
    ...
    def create_real_time_clip_invoker(self, request):
        http_info = self._create_real_time_clip_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_real_time_clip_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def create_upload_by_url(self, request):
        r"""URL拉取上传
    ...
    def create_upload_by_url_invoker(self, request):
        http_info = self._create_upload_by_url_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_upload_by_url_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def delete_asset_edit_task(self, request):
        r"""取消编辑任务
    ...
    def delete_asset_edit_task_invoker(self, request):
        http_info = self._delete_asset_edit_task_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_asset_edit_task_http_info(cls, request):
        http_info = {
            "method": "DELETE",
            "resource_path": "/v1/{project_id}/asset/editing/tasks",
            "request_type": request.__class__.__name__,
    ...
    def delete_dy_asset(self, request):
        r"""删除斗鱼媒资
    ...
    def delete_dy_asset_invoker(self, request):
        http_info = self._delete_dy_asset_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_dy_asset_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def delete_transcode_product_invoker(self, request):
        http_info = self._delete_transcode_product_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_transcode_product_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_asset_edit_task(self, request):
        r"""查询编辑任务
    ...
    def list_asset_edit_task_invoker(self, request):
        http_info = self._list_asset_edit_task_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_asset_edit_task_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/{project_id}/asset/editing/tasks",
            "request_type": request.__class__.__name__,
    ...
    def list_asset_task_info(self, request):
        r"""查询媒资任务信息
    ...
    def list_asset_task_info_invoker(self, request):
        http_info = self._list_asset_task_info_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_asset_task_info_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_category_info(self, request):
        r"""查询指定分类信息
    ...
    def list_category_info_invoker(self, request):
        http_info = self._list_category_info_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_category_info_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_cdn_statistics(self, request):
        r"""查询CDN统计信息
    ...
    def list_cdn_statistics_invoker(self, request):
        http_info = self._list_cdn_statistics_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_cdn_statistics_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_object_meta_data(self, request):
        r"""查询媒体元数据
    ...
    def show_object_meta_data_invoker(self, request):
        http_info = self._show_object_meta_data_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_object_meta_data_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_storage_mode_type_invoker(self, request):
        http_info = self._show_storage_mode_type_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_storage_mode_type_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def update_storage_mode_type_invoker(self, request):
        http_info = self._update_storage_mode_type_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_storage_mode_type_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v1/{project_id}/asset/storage-mode-type",
            "request_type": request.__class__.__name__,
    ...
    def show_https_config(self, request):
        r"""查询https配置
    ...
    def show_https_config_invoker(self, request):
        http_info = self._show_https_config_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_https_config_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def update_https_config(self, request):
        r"""配置https
    ...
    def update_https_config_invoker(self, request):
        http_info = self._update_https_config_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_https_config_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v1.0/{project_id}/asset/domain/https",
            "request_type": request.__class__.__name__,
