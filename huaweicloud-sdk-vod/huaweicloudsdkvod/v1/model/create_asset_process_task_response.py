...
class CreateAssetProcessTaskResponse(SdkResponse):
    ...
    def thumbnail_task_id(self):
        r"""Gets the thumbnail_task_id of this CreateAssetProcessTaskResponse.

        截图任务id，仅支持多截图场景会返回。

        :return: The thumbnail_task_id of this CreateAssetProcessTaskResponse.
        :rtype: str
        """
    ...
    def thumbnail_task_id(self, thumbnail_task_id):
        r"""Sets the thumbnail_task_id of this CreateAssetProcessTaskResponse.

        截图任务id，仅支持多截图场景会返回。

        :param thumbnail_task_id: The thumbnail_task_id of this CreateAssetProcessTaskResponse.
        :type thumbnail_task_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateAssetProcessTaskResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateAssetProcessTaskResponse):
            return False
