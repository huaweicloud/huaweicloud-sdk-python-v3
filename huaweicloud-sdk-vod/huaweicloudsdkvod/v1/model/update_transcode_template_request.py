...
class UpdateTranscodeTemplateRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the UpdateTranscodeTemplateRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateTranscodeTemplateRequest):
            return False
