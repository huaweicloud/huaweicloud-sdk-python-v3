...
class ConfirmAssetUploadRequest:
    ...
    def __init__(self, body=None):
        """ConfirmAssetUploadRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfirmAssetUploadRequest):
            return False
