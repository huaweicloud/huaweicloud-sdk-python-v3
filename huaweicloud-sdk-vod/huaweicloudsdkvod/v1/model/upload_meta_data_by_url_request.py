...
class UploadMetaDataByUrlRequest:
    ...
    def __init__(self, body=None):
        """UploadMetaDataByUrlRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadMetaDataByUrlRequest):
            return False
