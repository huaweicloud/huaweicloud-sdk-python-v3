...
class UpdateStorageModeRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the UpdateStorageModeRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateStorageModeRequest):
            return False
