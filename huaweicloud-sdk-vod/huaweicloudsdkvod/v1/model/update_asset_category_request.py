...
class UpdateAssetCategoryRequest:
    ...
    @property
    def body(self):
        r"""Gets the body of this UpdateAssetCategoryRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this UpdateAssetCategoryRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateAssetCategoryRequest):
            return False
