...
class AudioResponseOutputHosting:
    ...
    openapi_types = {
        'obs': 'list[AudioOutputHostingObs]',
    ...
    def __init__(self, obs=None, result_json_overdue_at=None, check_obs_after_end_state=None):
        r"""AudioResponseOutputHosting

        The model defined in huaweicloud sdk

        :param obs: 结果文件result.json的OBS信息。
        :type obs: list[:class:`huaweicloudsdkvcm.v2.AudioOutputHostingObs`]
    ...
    @property
    def obs(self):
        r"""Gets the obs of this AudioResponseOutputHosting.

        结果文件result.json的OBS信息。

        :return: The obs of this AudioResponseOutputHosting.
        :rtype: list[:class:`huaweicloudsdkvcm.v2.AudioOutputHostingObs`]
        """
        return self._obs

    @obs.setter
    def obs(self, obs):
        r"""Sets the obs of this AudioResponseOutputHosting.

        结果文件result.json的OBS信息。

        :param obs: The obs of this AudioResponseOutputHosting.
        :type obs: list[:class:`huaweicloudsdkvcm.v2.AudioOutputHostingObs`]
        """
        self._obs = obs
    ...
    def result_json_overdue_at(self):
        r"""Gets the result_json_overdue_at of this AudioResponseOutputHosting.

        托管文件result.json的过期日期，文件默认保存48小时。  result.json文件生成且未过期时，会有这个字段。 

        :return: The result_json_overdue_at of this AudioResponseOutputHosting.
        :rtype: str
        """
    ...
    def result_json_overdue_at(self, result_json_overdue_at):
        r"""Sets the result_json_overdue_at of this AudioResponseOutputHosting.

        托管文件result.json的过期日期，文件默认保存48小时。  result.json文件生成且未过期时，会有这个字段。 

        :param result_json_overdue_at: The result_json_overdue_at of this AudioResponseOutputHosting.
        :type result_json_overdue_at: str
        """
    ...
    def check_obs_after_end_state(self):
        r"""Gets the check_obs_after_end_state of this AudioResponseOutputHosting.

        True表示校验obs。

        :return: The check_obs_after_end_state of this AudioResponseOutputHosting.
        :rtype: bool
        """
    ...
    def check_obs_after_end_state(self, check_obs_after_end_state):
        r"""Sets the check_obs_after_end_state of this AudioResponseOutputHosting.

        True表示校验obs。

        :param check_obs_after_end_state: The check_obs_after_end_state of this AudioResponseOutputHosting.
        :type check_obs_after_end_state: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AudioResponseOutputHosting):
            return False
