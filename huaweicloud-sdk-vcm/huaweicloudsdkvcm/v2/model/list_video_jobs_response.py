...
class ListVideoJobsResponse(SdkResponse):
    ...
    @property
    def tasks(self):
        r"""Gets the tasks of this ListVideoJobsResponse.
    ...
    def tasks(self, tasks):
        r"""Sets the tasks of this ListVideoJobsResponse.
    ...
    @property
    def count(self):
        r"""Gets the count of this ListVideoJobsResponse.
    ...
    def count(self, count):
        r"""Sets the count of this ListVideoJobsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListVideoJobsResponse.to_dict() is deprecated and no longer maintained, "
