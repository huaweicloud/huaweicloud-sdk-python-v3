...
class ImageSearchAsyncClient(Client):
    ...
    def run_add_data_async(self, request):
        ...
        """
        return self.run_add_data_with_http_info(request)

    def run_add_data_with_http_info(self, request):
        all_params = ['service_name', 'add_data_param']
        local_var_params = {}
    ...
    def run_check_data_async(self, request):
        ...
        """
        return self.run_check_data_with_http_info(request)

    def run_check_data_with_http_info(self, request):
        all_params = ['service_name', 'check_param']
        local_var_params = {}
        for attr in request.attribute_map:
            if hasattr(request, attr):
                local_var_params[attr] = getattr(request, attr)
    ...
    def run_delete_data_async(self, request):
        ...
        """
        return self.run_delete_data_with_http_info(request)

    def run_delete_data_with_http_info(self, request):
        all_params = ['service_name', 'delete_param']
        local_var_params = {}
        for attr in request.attribute_map:
            if hasattr(request, attr):
                local_var_params[attr] = getattr(request, attr)
    ...
    def run_search_async(self, request):
        ...
        """
        return self.run_search_with_http_info(request)

    def run_search_with_http_info(self, request):
        all_params = ['service_name', 'search_param']
        local_var_params = {}
        for attr in request.attribute_map:
            if hasattr(request, attr):
                local_var_params[attr] = getattr(request, attr)
    ...
    def run_update_data_async(self, request):
        ...
        """
        return self.run_update_data_with_http_info(request)

    def run_update_data_with_http_info(self, request):
        all_params = ['service_name', 'update_param']
        local_var_params = {}
        for attr in request.attribute_map:
            if hasattr(request, attr):
                local_var_params[attr] = getattr(request, attr)
