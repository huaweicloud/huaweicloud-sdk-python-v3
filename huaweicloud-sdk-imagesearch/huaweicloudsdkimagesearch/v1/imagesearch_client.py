...
class ImageSearchClient(Client):
    ...
    def run_add_picture(self, request):
        """添加图片
        ...
        :param RunAddPictureRequest request
    ...
    def run_check_picture(self, request):
        """查询图片

        通过图片路径查询索引库中对应图片是否存在。

        :param RunCheckPictureRequest request
    ...
    def run_create_instance(self, request):
        """创建实例

        创建实例，实例中会生成图片索引库，用来存放图片特征。

        :param RunCreateInstanceRequest request
    ...
    def run_delete_instance(self, request):
        """删除实例

        删除已存在的实例。

        :param RunDeleteInstanceRequest request
    ...
    def run_delete_picture(self, request):
        """删除图片

        通过图片路径删除索引库中对应图片。

        :param RunDeletePictureRequest request
    ...
    def run_modify_picture(self, request):
        """修改图片信息

        修改图像索引库中已存在的图片信息。

        :param RunModifyPictureRequest request
    ...
    def run_query_instance(self, request):
        """查询用户实例信息

        查看用户指定实例详细信息。

        :param RunQueryInstanceRequest request
    ...
    def run_search_picture(self, request):
        """搜索图片

        从图片索引库中搜索相似图片。

        :param RunSearchPictureRequest request
