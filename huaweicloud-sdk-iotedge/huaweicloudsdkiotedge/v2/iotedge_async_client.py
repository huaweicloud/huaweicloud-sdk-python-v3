...
class IoTEdgeAsyncClient(Client):
    ...
    def create_reinstall_cmd_async(self, request):
        r"""生成边缘节点重新安装命令
    ...
    def create_reinstall_cmd_async_invoker(self, request):
        http_info = self._create_reinstall_cmd_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_reinstall_cmd_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def create_upgrade_cmd_async(self, request):
        r"""生成边缘节点升级命令
    ...
    def create_upgrade_cmd_async_invoker(self, request):
        http_info = self._create_upgrade_cmd_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_upgrade_cmd_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def show_edge_node_hosts_info_async_invoker(self, request):
        http_info = self._show_edge_node_hosts_info_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_edge_node_hosts_info_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def create_client_node_async(self, request):
        r"""分配推送通道到客户端节点
    ...
    def create_client_node_async_invoker(self, request):
        http_info = self._create_client_node_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_client_node_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def update_client_node_async(self, request):
        r"""修改已分配节点通道的详情
    ...
    def update_client_node_async_invoker(self, request):
        http_info = self._update_client_node_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_client_node_http_info(self, request):
        http_info = {
            "method": "PUT",
    ...
    def show_edge_node_software_version_async(self, request):
        r"""查询当前边缘软件版本
    ...
    def show_edge_node_software_version_async_invoker(self, request):
        http_info = self._show_edge_node_software_version_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_edge_node_software_version_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def bind_node_async(self, request):
        r"""绑定节点-专业版
    ...
    def bind_node_async_invoker(self, request):
        http_info = self._bind_node_http_info(request)
        return AsyncInvoker(self, http_info)

    def _bind_node_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def list_property_active_controls_async_invoker(self, request):
        http_info = self._list_property_active_controls_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_property_active_controls_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def set_device_control_default_values_async_invoker(self, request):
        http_info = self._set_device_control_default_values_http_info(request)
        return AsyncInvoker(self, http_info)

    def _set_device_control_default_values_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def invoke_module_msg_async_invoker(self, request):
        http_info = self._invoke_module_msg_http_info(request)
        return AsyncInvoker(self, http_info)

    def _invoke_module_msg_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def invoke_delete_proxy_async(self, request):
        r"""DELETE方法的代理
    ...
    def invoke_delete_proxy_async_invoker(self, request):
        http_info = self._invoke_delete_proxy_http_info(request)
        return AsyncInvoker(self, http_info)

    def _invoke_delete_proxy_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def invoke_get_proxy_async(self, request):
        r"""GET方法的代理
    ...
    def invoke_get_proxy_async_invoker(self, request):
        http_info = self._invoke_get_proxy_http_info(request)
        return AsyncInvoker(self, http_info)

    def _invoke_get_proxy_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v2/{project_id}/edge-nodes/{node_id}/ias/{ia_id}/api",
            "request_type": request.__class__.__name__,
    ...
    def invoke_patch_proxy_async(self, request):
        r"""PATCH方法的代理
    ...
    def invoke_patch_proxy_async_invoker(self, request):
        http_info = self._invoke_patch_proxy_http_info(request)
        return AsyncInvoker(self, http_info)

    def _invoke_patch_proxy_http_info(self, request):
        http_info = {
            "method": "PATCH",
            "resource_path": "/v2/{project_id}/edge-nodes/{node_id}/ias/{ia_id}/api",
            "request_type": request.__class__.__name__,
    ...
    def invoke_post_proxy_async(self, request):
        r"""POST方法的代理
    ...
    def invoke_post_proxy_async_invoker(self, request):
        http_info = self._invoke_post_proxy_http_info(request)
        return AsyncInvoker(self, http_info)

    def _invoke_post_proxy_http_info(self, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v2/{project_id}/edge-nodes/{node_id}/ias/{ia_id}/api",
            "request_type": request.__class__.__name__,
    ...
    def invoke_put_proxy_async(self, request):
        r"""PUT方法的代理
    ...
    def invoke_put_proxy_async_invoker(self, request):
        http_info = self._invoke_put_proxy_http_info(request)
        return AsyncInvoker(self, http_info)

    def _invoke_put_proxy_http_info(self, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v2/{project_id}/edge-nodes/{node_id}/ias/{ia_id}/api",
            "request_type": request.__class__.__name__,
    ...
    def batch_confirm_configs_async(self, request):
        r"""南向3rdIA对配置项下发进行确认
        ...
        """
        warnings.warn("Method 'batch_confirm_configs_async' of IoTEdgeAsyncClient is deprecated and will be removed in the future versions", DeprecationWarning)
        http_info = self._batch_confirm_configs_http_info(request)
        return self._call_api(**http_info)

    def batch_confirm_configs_async_invoker(self, request):
        warnings.warn("Method 'batch_confirm_configs_async_invoker' of IoTEdgeAsyncClient is deprecated and will be removed in the future versions", DeprecationWarning)
        http_info = self._batch_confirm_configs_http_info(request)
        return AsyncInvoker(self, http_info)

    def _batch_confirm_configs_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def create_push_channel_async(self, request):
        r"""创建外部推送通道
    ...
    def create_push_channel_async_invoker(self, request):
        http_info = self._create_push_channel_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_push_channel_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def delete_push_channel_async_invoker(self, request):
        http_info = self._delete_push_channel_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_push_channel_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_push_channels_async(self, request):
        r"""查询推送通道列表
    ...
    def list_push_channels_async_invoker(self, request):
        http_info = self._list_push_channels_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_push_channels_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v2/{project_id}/push-channels",
            "request_type": request.__class__.__name__,
