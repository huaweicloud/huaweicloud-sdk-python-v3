...
class SynchronizeDcConfigsResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("SynchronizeDcConfigsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SynchronizeDcConfigsResponse):
            return False
