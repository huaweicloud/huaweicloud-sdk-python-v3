...
class EdgeModuleDTO:
    ...
    def liveness_state(self):
        r"""Gets the liveness_state of this EdgeModuleDTO.

        模块健康状态

        :return: The liveness_state of this EdgeModuleDTO.
        :rtype: str
        """
    ...
    def liveness_state(self, liveness_state):
        r"""Sets the liveness_state of this EdgeModuleDTO.

        模块健康状态

        :param liveness_state: The liveness_state of this EdgeModuleDTO.
        :type liveness_state: str
        """
