...
class UpdateDcPointResponse(SdkResponse):
    ...
    @property
    def active(self):
        r"""Gets the active of this UpdateDcPointResponse.

        点位启停状态

        :return: The active of this UpdateDcPointResponse.
        :rtype: bool
        """
        return self._active
    ...
    def active(self, active):
        r"""Sets the active of this UpdateDcPointResponse.

        点位启停状态

        :param active: The active of this UpdateDcPointResponse.
        :type active: bool
        """
        self._active = active
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateDcPointResponse.to_dict() is deprecated and no longer maintained, "
