...
class CreateEdgeNodeRequest:
    ...
    def __init__(self, body=None):
        """CreateEdgeNodeRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateEdgeNodeRequest):
            return False
