...
class SetDeviceControlDefaultValuesResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("SetDeviceControlDefaultValuesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SetDeviceControlDefaultValuesResponse):
            return False
