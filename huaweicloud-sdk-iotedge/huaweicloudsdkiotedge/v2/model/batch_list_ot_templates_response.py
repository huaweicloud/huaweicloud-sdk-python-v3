...
class BatchListOtTemplatesResponse(SdkResponse):
    ...
    openapi_types = {
        ...
        'templates': 'list[QueryOtTemplateBriefRespDTO]'
    }
    ...
    def __init__(self, count=None, page_info=None, templates=None):
        ...
        :param templates: 每页记录数
        :type templates: list[:class:`huaweicloudsdkiotedge.v2.QueryOtTemplateBriefRespDTO`]
        """
    ...
    def count(self):
        ...
        :return: The count of this BatchListOtTemplatesResponse.
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        ...
        :param count: The count of this BatchListOtTemplatesResponse.
        :type count: int
        """
        self._count = count
    ...
    def templates(self):
        ...
        :return: The templates of this BatchListOtTemplatesResponse.
        :rtype: list[:class:`huaweicloudsdkiotedge.v2.QueryOtTemplateBriefRespDTO`]
        """
    ...
    def templates(self, templates):
        ...
        :param templates: The templates of this BatchListOtTemplatesResponse.
        :type templates: list[:class:`huaweicloudsdkiotedge.v2.QueryOtTemplateBriefRespDTO`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchListOtTemplatesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchListOtTemplatesResponse):
            return False
