...
class ShowEdgeAppRequest:
    ...
    def edge_app_id(self):
        r"""Gets the edge_app_id of this ShowEdgeAppRequest.

        应用ID，应用唯一。

        :return: The edge_app_id of this ShowEdgeAppRequest.
        :rtype: str
        """
    ...
    def edge_app_id(self, edge_app_id):
        r"""Sets the edge_app_id of this ShowEdgeAppRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowEdgeAppRequest):
            return False
