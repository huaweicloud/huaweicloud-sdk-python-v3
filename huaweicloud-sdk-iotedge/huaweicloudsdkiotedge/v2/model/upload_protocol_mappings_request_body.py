...
class UploadProtocolMappingsRequestBody:
    ...
    @property
    def file(self):
        """Gets the file of this UploadProtocolMappingsRequestBody.
    ...
    @file.setter
    def file(self, file):
        """Sets the file of this UploadProtocolMappingsRequestBody.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadProtocolMappingsRequestBody):
            return False
