...
class AddAppConfigsTemplatesRequest:
    ...
    openapi_types = {
        'body': 'CreateAppConfigsTemplatesReqDTO'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the AddAppConfigsTemplatesRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddAppConfigsTemplatesRequest):
            return False
