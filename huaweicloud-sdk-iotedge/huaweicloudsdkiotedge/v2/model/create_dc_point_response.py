...
class CreateDcPointResponse(SdkResponse):
    ...
    @property
    def active(self):
        r"""Gets the active of this CreateDcPointResponse.

        点位启停状态

        :return: The active of this CreateDcPointResponse.
        :rtype: bool
        """
        return self._active
    ...
    def active(self, active):
        r"""Sets the active of this CreateDcPointResponse.

        点位启停状态

        :param active: The active of this CreateDcPointResponse.
        :type active: bool
        """
        self._active = active
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateDcPointResponse.to_dict() is deprecated and no longer maintained, "
