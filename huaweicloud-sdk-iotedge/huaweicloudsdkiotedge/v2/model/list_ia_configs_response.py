...
class ListIaConfigsResponse(SdkResponse):
    ...
    openapi_types = {
        'configs': 'list[QueryIaConfigResponseDTO]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListIaConfigsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListIaConfigsResponse):
            return False
