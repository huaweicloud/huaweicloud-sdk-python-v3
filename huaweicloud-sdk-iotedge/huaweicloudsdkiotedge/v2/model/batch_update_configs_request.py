...
class BatchUpdateConfigsRequest:
    ...
    @property
    def body(self):
        """Gets the body of this BatchUpdateConfigsRequest.
    ...
    @body.setter
    def body(self, body):
        """Sets the body of this BatchUpdateConfigsRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchUpdateConfigsRequest):
            return False
