...
class ShowExternalEntityResponse(SdkResponse):
    ...
    openapi_types = {
        ...
        'protocol': 'str',
        'connection_type': 'str',
        'mqtt_connection_info': 'MqttBriefConnectionInfo',
        'create_time': 'str',
    ...
    @property
    def node_id(self):
        """Gets the node_id of this ShowExternalEntityResponse.

        节点ID

        :return: The node_id of this ShowExternalEntityResponse.
        :rtype: str
        """
    ...
    def node_id(self, node_id):
        """Sets the node_id of this ShowExternalEntityResponse.
    ...
    def space_id(self, space_id):
        """Sets the space_id of this ShowExternalEntityResponse.
    ...
    def external_id(self):
        """Gets the external_id of this ShowExternalEntityResponse.

        外部实体ID

        :return: The external_id of this ShowExternalEntityResponse.
        :rtype: str
        """
    ...
    def external_id(self, external_id):
        """Sets the external_id of this ShowExternalEntityResponse.
    ...
    @property
    def protocol(self):
        """Gets the protocol of this ShowExternalEntityResponse.

        接入协议类型

        :return: The protocol of this ShowExternalEntityResponse.
        :rtype: str
        """
    ...
    def protocol(self, protocol):
        """Sets the protocol of this ShowExternalEntityResponse.
    ...
    def connection_type(self):
        """Gets the connection_type of this ShowExternalEntityResponse.

        连接类型(client和server)

        :return: The connection_type of this ShowExternalEntityResponse.
        :rtype: str
        """
    ...
    def connection_type(self, connection_type):
        """Sets the connection_type of this ShowExternalEntityResponse.
    ...
    def mqtt_connection_info(self):
        """Gets the mqtt_connection_info of this ShowExternalEntityResponse.
    ...
    def mqtt_connection_info(self, mqtt_connection_info):
        """Sets the mqtt_connection_info of this ShowExternalEntityResponse.
    ...
    def create_time(self):
        """Gets the create_time of this ShowExternalEntityResponse.

        创建时间

        :return: The create_time of this ShowExternalEntityResponse.
        :rtype: str
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this ShowExternalEntityResponse.
    ...
    def last_modify_time(self):
        """Gets the last_modify_time of this ShowExternalEntityResponse.

        最后修改时间

        :return: The last_modify_time of this ShowExternalEntityResponse.
        :rtype: str
        """
    ...
    def last_modify_time(self, last_modify_time):
        """Sets the last_modify_time of this ShowExternalEntityResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowExternalEntityResponse):
            return False
