...
class PutCustomRoleToPermissionSetReqBody:
    ...
    def __init__(self, custom_role=None):
        ...
        :param custom_role: 要附加到权限集的自定义策略
    ...
    def custom_role(self):
        ...
        :return: The custom_role of this PutCustomRoleToPermissionSetReqBody.
        :rtype: str
        """
    ...
    def custom_role(self, custom_role):
        ...
        :param custom_role: The custom_role of this PutCustomRoleToPermissionSetReqBody.
        :type custom_role: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PutCustomRoleToPermissionSetReqBody):
            return False
