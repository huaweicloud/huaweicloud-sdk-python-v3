...
class AssignmentConfigDto:
    ...
    def assignment_required(self):
        r"""Gets the assignment_required of this AssignmentConfigDto.

        应用程序是否需要分配

        :return: The assignment_required of this AssignmentConfigDto.
        :rtype: bool
        """
    ...
    def assignment_required(self, assignment_required):
        r"""Sets the assignment_required of this AssignmentConfigDto.

        应用程序是否需要分配

        :param assignment_required: The assignment_required of this AssignmentConfigDto.
        :type assignment_required: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssignmentConfigDto):
            return False
