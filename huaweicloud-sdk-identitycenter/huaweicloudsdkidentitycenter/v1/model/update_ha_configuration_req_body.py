...
class UpdateHAConfigurationReqBody:
    ...
    def __init__(self, disaster_recovery_choice=None):
        r"""UpdateHAConfigurationReqBody
    ...
    def disaster_recovery_choice(self):
        r"""Gets the disaster_recovery_choice of this UpdateHAConfigurationReqBody.

        高可用选项，接受高可用或者拒绝高可用功能。

        :return: The disaster_recovery_choice of this UpdateHAConfigurationReqBody.
        :rtype: str
        """
    ...
    def disaster_recovery_choice(self, disaster_recovery_choice):
        r"""Sets the disaster_recovery_choice of this UpdateHAConfigurationReqBody.

        高可用选项，接受高可用或者拒绝高可用功能。

        :param disaster_recovery_choice: The disaster_recovery_choice of this UpdateHAConfigurationReqBody.
        :type disaster_recovery_choice: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateHAConfigurationReqBody):
            return False
