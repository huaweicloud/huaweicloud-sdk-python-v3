...
class ApplicationDto:
    ...
    def application_urn(self):
        r"""Gets the application_urn of this ApplicationDto.

        应用程序URN

        :return: The application_urn of this ApplicationDto.
        :rtype: str
        """
    ...
    def application_urn(self, application_urn):
        r"""Sets the application_urn of this ApplicationDto.

        应用程序URN

        :param application_urn: The application_urn of this ApplicationDto.
        :type application_urn: str
        """
    ...
    def application_provider_urn(self):
        r"""Gets the application_provider_urn of this ApplicationDto.

        应用程序提供商URN

        :return: The application_provider_urn of this ApplicationDto.
        :rtype: str
        """
    ...
    def application_provider_urn(self, application_provider_urn):
        r"""Sets the application_provider_urn of this ApplicationDto.

        应用程序提供商URN

        :param application_provider_urn: The application_provider_urn of this ApplicationDto.
        :type application_provider_urn: str
        """
    ...
    def assignment_config(self):
        r"""Gets the assignment_config of this ApplicationDto.

        :return: The assignment_config of this ApplicationDto.
    ...
    def assignment_config(self, assignment_config):
        r"""Sets the assignment_config of this ApplicationDto.

        :param assignment_config: The assignment_config of this ApplicationDto.
        :type assignment_config: :class:`huaweicloudsdkidentitycenter.v1.AssignmentConfigDto`
        """
    ...
    def created_date(self):
        r"""Gets the created_date of this ApplicationDto.

        应用程序创建时间

        :return: The created_date of this ApplicationDto.
        :rtype: int
        """
    ...
    def created_date(self, created_date):
        r"""Sets the created_date of this ApplicationDto.

        应用程序创建时间

        :param created_date: The created_date of this ApplicationDto.
        :type created_date: int
        """
    ...
    def description(self):
        r"""Gets the description of this ApplicationDto.

        应用程序描述

        :return: The description of this ApplicationDto.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this ApplicationDto.

        应用程序描述

        :param description: The description of this ApplicationDto.
        :type description: str
        """
    ...
    def instance_urn(self):
        r"""Gets the instance_urn of this ApplicationDto.

        IAM身份中心实例URN

        :return: The instance_urn of this ApplicationDto.
        :rtype: str
        """
    ...
    def instance_urn(self, instance_urn):
        r"""Sets the instance_urn of this ApplicationDto.

        IAM身份中心实例URN

        :param instance_urn: The instance_urn of this ApplicationDto.
        :type instance_urn: str
        """
    ...
    @property
    def name(self):
        r"""Gets the name of this ApplicationDto.

        应用程序显示名称

        :return: The name of this ApplicationDto.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this ApplicationDto.

        应用程序显示名称

        :param name: The name of this ApplicationDto.
        :type name: str
        """
        self._name = name
    ...
    def portal_options(self):
        r"""Gets the portal_options of this ApplicationDto.

        :return: The portal_options of this ApplicationDto.
    ...
    def portal_options(self, portal_options):
        r"""Sets the portal_options of this ApplicationDto.

        :param portal_options: The portal_options of this ApplicationDto.
        :type portal_options: :class:`huaweicloudsdkidentitycenter.v1.PortalOptionsDto`
        """
    ...
    @property
    def status(self):
        r"""Gets the status of this ApplicationDto.

        应用程序状态

        :return: The status of this ApplicationDto.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        r"""Sets the status of this ApplicationDto.

        应用程序状态

        :param status: The status of this ApplicationDto.
        :type status: str
        """
        self._status = status
    ...
    def application_account(self):
        r"""Gets the application_account of this ApplicationDto.

        华为云账号

        :return: The application_account of this ApplicationDto.
        :rtype: str
        """
    ...
    def application_account(self, application_account):
        r"""Sets the application_account of this ApplicationDto.

        华为云账号

        :param application_account: The application_account of this ApplicationDto.
        :type application_account: str
        """
