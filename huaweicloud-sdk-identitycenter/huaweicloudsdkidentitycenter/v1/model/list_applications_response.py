...
class ListApplicationsResponse(SdkResponse):
    ...
    def __init__(self, applications=None, page_info=None):
        ...
        :param applications: 应用程序列表
        :type applications: list[:class:`huaweicloudsdkidentitycenter.v1.ApplicationDto`]
        :param page_info: 
    ...
    def applications(self):
        ...
        :rtype: list[:class:`huaweicloudsdkidentitycenter.v1.ApplicationDto`]
        """
    ...
    @property
    def page_info(self):
        r"""Gets the page_info of this ListApplicationsResponse.

        :return: The page_info of this ListApplicationsResponse.
    ...
    def page_info(self, page_info):
        r"""Sets the page_info of this ListApplicationsResponse.

        :param page_info: The page_info of this ListApplicationsResponse.
        :type page_info: :class:`huaweicloudsdkidentitycenter.v1.PageInfoDto`
        """
