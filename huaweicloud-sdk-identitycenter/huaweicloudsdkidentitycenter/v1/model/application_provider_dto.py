...
class ApplicationProviderDto:
    ...
    def application_provider_urn(self):
        r"""Gets the application_provider_urn of this ApplicationProviderDto.

        应用程序提供者URN

        :return: The application_provider_urn of this ApplicationProviderDto.
        :rtype: str
        """
    ...
    def application_provider_urn(self, application_provider_urn):
        r"""Sets the application_provider_urn of this ApplicationProviderDto.

        应用程序提供者URN

        :param application_provider_urn: The application_provider_urn of this ApplicationProviderDto.
        :type application_provider_urn: str
        """
    ...
    def display_data(self):
        r"""Gets the display_data of this ApplicationProviderDto.

        :return: The display_data of this ApplicationProviderDto.
    ...
    def display_data(self, display_data):
        r"""Sets the display_data of this ApplicationProviderDto.

        :param display_data: The display_data of this ApplicationProviderDto.
        :type display_data: :class:`huaweicloudsdkidentitycenter.v1.DisplayDataDto`
        """
    ...
    def federation_protocol(self):
        r"""Gets the federation_protocol of this ApplicationProviderDto.

        支持的协议

        :return: The federation_protocol of this ApplicationProviderDto.
        :rtype: str
        """
    ...
    def federation_protocol(self, federation_protocol):
        r"""Sets the federation_protocol of this ApplicationProviderDto.

        支持的协议

        :param federation_protocol: The federation_protocol of this ApplicationProviderDto.
        :type federation_protocol: str
        """
    ...
    def application_provider_id(self):
        r"""Gets the application_provider_id of this ApplicationProviderDto.

        应用程序提供者唯一标识符（ID）

        :return: The application_provider_id of this ApplicationProviderDto.
        :rtype: str
        """
    ...
    def application_provider_id(self, application_provider_id):
        r"""Sets the application_provider_id of this ApplicationProviderDto.

        应用程序提供者唯一标识符（ID）

        :param application_provider_id: The application_provider_id of this ApplicationProviderDto.
        :type application_provider_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApplicationProviderDto):
            return False
