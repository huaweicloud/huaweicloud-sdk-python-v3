...
class PutCustomPolicyToPermissionSetReqBody:
    ...
    def __init__(self, custom_policy=None):
        ...
        :param custom_policy: 要附加到权限集的自定义身份策略
    ...
    def custom_policy(self):
        ...
        :return: The custom_policy of this PutCustomPolicyToPermissionSetReqBody.
        :rtype: str
        """
    ...
    def custom_policy(self, custom_policy):
        ...
        :param custom_policy: The custom_policy of this PutCustomPolicyToPermissionSetReqBody.
        :type custom_policy: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PutCustomPolicyToPermissionSetReqBody):
            return False
