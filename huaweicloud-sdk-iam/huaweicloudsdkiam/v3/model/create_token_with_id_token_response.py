...
class CreateTokenWithIdTokenResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateTokenWithIdTokenResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateTokenWithIdTokenResponse):
            return False
