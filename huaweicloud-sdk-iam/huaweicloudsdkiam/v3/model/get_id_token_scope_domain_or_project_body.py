...
class GetIdTokenScopeDomainOrProjectBody:
    ...
    def id(self):
        ...
        :return: The id of this GetIdTokenScopeDomainOrProjectBody.
        :rtype: str
        """
        return self._id
    ...
    def name(self):
        ...
        :return: The name of this GetIdTokenScopeDomainOrProjectBody.
        :rtype: str
        """
        return self._name
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetIdTokenScopeDomainOrProjectBody):
            return False
