...
class KeystoneListFederationDomainsResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("KeystoneListFederationDomainsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KeystoneListFederationDomainsResponse):
            return False
