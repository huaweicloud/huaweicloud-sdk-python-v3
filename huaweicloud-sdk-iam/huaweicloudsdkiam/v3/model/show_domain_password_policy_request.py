...
class ShowDomainPasswordPolicyRequest:
    ...
    def __init__(self, domain_id=None):
        r"""ShowDomainPasswordPolicyRequest
    ...
    @property
    def domain_id(self):
        r"""Gets the domain_id of this ShowDomainPasswordPolicyRequest.
    ...
    def domain_id(self, domain_id):
        r"""Sets the domain_id of this ShowDomainPasswordPolicyRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowDomainPasswordPolicyRequest):
            return False
