...
class KeystoneShowProtocolResponse(SdkResponse):
    ...
    def __init__(self, protocol=None):
        r"""KeystoneShowProtocolResponse
    ...
    @property
    def protocol(self):
        r"""Gets the protocol of this KeystoneShowProtocolResponse.
    ...
    def protocol(self, protocol):
        r"""Sets the protocol of this KeystoneShowProtocolResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("KeystoneShowProtocolResponse.to_dict() is deprecated and no longer maintained, "
