...
class AgencyTokenDomain:
    ...
    @property
    def name(self):
        r"""Gets the name of this AgencyTokenDomain.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this AgencyTokenDomain.
    ...
    @property
    def id(self):
        r"""Gets the id of this AgencyTokenDomain.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this AgencyTokenDomain.
