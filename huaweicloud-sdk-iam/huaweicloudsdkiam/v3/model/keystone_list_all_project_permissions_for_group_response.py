...
class KeystoneListAllProjectPermissionsForGroupResponse(SdkResponse):
    ...
    openapi_types = {
        'links': 'Links',
        'roles': 'list[InheritedRoleResult]'
    }
    ...
    def __init__(self, links=None, roles=None):
        ...
        :param roles: 权限信息列表。
        :type roles: list[:class:`huaweicloudsdkiam.v3.InheritedRoleResult`]
        """
    ...
    def roles(self):
        ...
        :rtype: list[:class:`huaweicloudsdkiam.v3.InheritedRoleResult`]
        """
        return self._roles
    ...
    def to_dict(self):
        import warnings
        warnings.warn("KeystoneListAllProjectPermissionsForGroupResponse.to_dict() is deprecated and no longer maintained, "
