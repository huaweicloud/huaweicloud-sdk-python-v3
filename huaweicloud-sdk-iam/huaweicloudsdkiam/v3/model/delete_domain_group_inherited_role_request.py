...
class DeleteDomainGroupInheritedRoleRequest:
    ...
    def __init__(self, domain_id=None, group_id=None, role_id=None):
        r"""DeleteDomainGroupInheritedRoleRequest
    ...
    @property
    def domain_id(self):
        r"""Gets the domain_id of this DeleteDomainGroupInheritedRoleRequest.

        用户组所属账号ID，获取方式请参见：[获取账号ID](https://support.huaweicloud.com/api-iam/iam_17_0002.html)。

        :return: The domain_id of this DeleteDomainGroupInheritedRoleRequest.
        :rtype: str
        """
    ...
    def domain_id(self, domain_id):
        r"""Sets the domain_id of this DeleteDomainGroupInheritedRoleRequest.
    ...
    @property
    def group_id(self):
        r"""Gets the group_id of this DeleteDomainGroupInheritedRoleRequest.

        用户组ID，获取方式请参见：[获取用户组ID](https://support.huaweicloud.com/api-iam/iam_17_0002.html)。

        :return: The group_id of this DeleteDomainGroupInheritedRoleRequest.
        :rtype: str
        """
    ...
    def group_id(self, group_id):
        r"""Sets the group_id of this DeleteDomainGroupInheritedRoleRequest.
    ...
    @property
    def role_id(self):
        r"""Gets the role_id of this DeleteDomainGroupInheritedRoleRequest.

        权限ID，获取方式请参见：[获取权限名、权限ID](https://support.huaweicloud.com/api-iam/iam_10_0001.html)。

        :return: The role_id of this DeleteDomainGroupInheritedRoleRequest.
        :rtype: str
        """
    ...
    def role_id(self, role_id):
        r"""Sets the role_id of this DeleteDomainGroupInheritedRoleRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteDomainGroupInheritedRoleRequest):
            return False
