...
class RevokeRoleFromAgencyOnEnterpriseProjectRequest:
    ...
    openapi_types = {
        'body': 'CreateOrDelAgencyEpPolicyAssignmentReqBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the RevokeRoleFromAgencyOnEnterpriseProjectRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RevokeRoleFromAgencyOnEnterpriseProjectRequest):
            return False
