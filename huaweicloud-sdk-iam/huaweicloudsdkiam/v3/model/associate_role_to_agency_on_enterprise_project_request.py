...
class AssociateRoleToAgencyOnEnterpriseProjectRequest:
    ...
    openapi_types = {
        'body': 'CreateAgencyEpPolicyAssignmentReqBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the AssociateRoleToAgencyOnEnterpriseProjectRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssociateRoleToAgencyOnEnterpriseProjectRequest):
            return False
