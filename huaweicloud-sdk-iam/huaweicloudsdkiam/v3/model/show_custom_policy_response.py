...
class ShowCustomPolicyResponse(SdkResponse):
    ...
    @property
    def role(self):
        r"""Gets the role of this ShowCustomPolicyResponse.
    ...
    @role.setter
    def role(self, role):
        r"""Sets the role of this ShowCustomPolicyResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowCustomPolicyResponse.to_dict() is deprecated and no longer maintained, "
