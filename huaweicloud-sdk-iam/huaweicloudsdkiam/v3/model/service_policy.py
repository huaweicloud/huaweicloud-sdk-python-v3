...
class ServicePolicy(object):
    ...
    openapi_types = {
        'version': 'str',
        'statement': 'list[ServiceStatement]'
    }
    ...
    def __init__(self, version='1.1', statement=None):  # noqa: E501
    ...
    def version(self, version):
        """Sets the version of this ServicePolicy.

        权限版本号，创建自定义策略时，该字段值填为“1.1”。 > - 1.0：系统预置的角色。以服务为粒度，提供有限的服务相关角色用于授权。   > - 1.1：策略。IAM最新提供的一种细粒度授权的能力，可以精确到具体服务的操作、资源以及请求条件等。

        :param version: The version of this ServicePolicy.
        :type: str
        """
