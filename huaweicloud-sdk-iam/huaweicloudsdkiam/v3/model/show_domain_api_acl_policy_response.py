...
class ShowDomainApiAclPolicyResponse(SdkResponse):
    ...
    openapi_types = {
        'api_acl_policy': 'AclPolicyResult'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowDomainApiAclPolicyResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowDomainApiAclPolicyResponse):
            return False
