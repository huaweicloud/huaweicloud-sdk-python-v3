...
class LoginTokenDomain:
    ...
    @property
    def name(self):
        r"""Gets the name of this LoginTokenDomain.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this LoginTokenDomain.
    ...
    @property
    def id(self):
        r"""Gets the id of this LoginTokenDomain.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this LoginTokenDomain.
