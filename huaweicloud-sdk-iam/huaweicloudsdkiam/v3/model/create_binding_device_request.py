...
class CreateBindingDeviceRequest:
    ...
    @property
    def body(self):
        r"""Gets the body of this CreateBindingDeviceRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this CreateBindingDeviceRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateBindingDeviceRequest):
            return False
