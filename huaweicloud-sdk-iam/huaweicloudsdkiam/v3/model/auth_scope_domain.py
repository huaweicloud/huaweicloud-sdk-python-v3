...
class AuthScopeDomain:
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this AuthScopeDomain.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this AuthScopeDomain.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AuthScopeDomain):
            return False
