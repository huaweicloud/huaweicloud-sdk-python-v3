...
class AgencyTokenScopeProject:
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this AgencyTokenScopeProject.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this AgencyTokenScopeProject.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AgencyTokenScopeProject):
            return False
