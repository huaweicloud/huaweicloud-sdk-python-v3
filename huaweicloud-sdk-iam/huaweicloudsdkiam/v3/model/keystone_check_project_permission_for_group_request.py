...
class KeystoneCheckProjectPermissionForGroupRequest:
    ...
    def __init__(self, project_id=None, group_id=None, role_id=None):
        r"""KeystoneCheckProjectPermissionForGroupRequest
    ...
    @property
    def project_id(self):
        r"""Gets the project_id of this KeystoneCheckProjectPermissionForGroupRequest.

        项目ID，获取方式请参见：[获取项目名称、项目ID](https://support.huaweicloud.com/api-iam/iam_17_0002.html)。

        :return: The project_id of this KeystoneCheckProjectPermissionForGroupRequest.
        :rtype: str
        """
    ...
    def project_id(self, project_id):
        r"""Sets the project_id of this KeystoneCheckProjectPermissionForGroupRequest.
    ...
    @property
    def group_id(self):
        r"""Gets the group_id of this KeystoneCheckProjectPermissionForGroupRequest.
    ...
    def group_id(self, group_id):
        r"""Sets the group_id of this KeystoneCheckProjectPermissionForGroupRequest.
    ...
    @property
    def role_id(self):
        r"""Gets the role_id of this KeystoneCheckProjectPermissionForGroupRequest.
    ...
    def role_id(self, role_id):
        r"""Sets the role_id of this KeystoneCheckProjectPermissionForGroupRequest.
