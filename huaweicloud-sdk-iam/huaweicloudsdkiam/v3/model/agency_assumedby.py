...
class AgencyAssumedby:
    ...
    def __init__(self, user=None):
        """AgencyAssumedby - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AgencyAssumedby):
            return False
