...
class KeystoneShowProjectRequest:
    ...
    @property
    def project_id(self):
        r"""Gets the project_id of this KeystoneShowProjectRequest.
    ...
    def project_id(self, project_id):
        r"""Sets the project_id of this KeystoneShowProjectRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KeystoneShowProjectRequest):
            return False
