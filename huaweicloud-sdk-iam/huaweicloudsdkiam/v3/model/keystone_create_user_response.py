...
class KeystoneCreateUserResponse(SdkResponse):
    ...
    @property
    def user(self):
        r"""Gets the user of this KeystoneCreateUserResponse.
    ...
    @user.setter
    def user(self, user):
        r"""Sets the user of this KeystoneCreateUserResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("KeystoneCreateUserResponse.to_dict() is deprecated and no longer maintained, "
