...
class KeystoneDeleteUserRequest:
    ...
    def __init__(self, user_id=None):
        r"""KeystoneDeleteUserRequest

        The model defined in huaweicloud sdk

        :param user_id: 待删除的IAM用户ID，获取方式请参见：[获取用户ID](https://support.huaweicloud.com/api-iam/iam_17_0002.html)。
        :type user_id: str
        """
    ...
    @property
    def user_id(self):
        r"""Gets the user_id of this KeystoneDeleteUserRequest.
    ...
    def user_id(self, user_id):
        r"""Sets the user_id of this KeystoneDeleteUserRequest.
