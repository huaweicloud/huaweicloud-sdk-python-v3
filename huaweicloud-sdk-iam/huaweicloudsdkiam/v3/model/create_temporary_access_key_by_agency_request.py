...
class CreateTemporaryAccessKeyByAgencyRequest(object):
    ...
    def __init__(self, body=None):  # noqa: E501
        """CreateTemporaryAccessKeyByAgencyRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: CreateTemporaryAccessKeyByAgencyRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateTemporaryAccessKeyByAgencyRequest):
            return False
