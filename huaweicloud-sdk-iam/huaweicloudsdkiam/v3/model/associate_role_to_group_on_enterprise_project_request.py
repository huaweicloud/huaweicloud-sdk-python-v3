...
class AssociateRoleToGroupOnEnterpriseProjectRequest:
    ...
    def __init__(self, enterprise_project_id=None, group_id=None, role_id=None):
        r"""AssociateRoleToGroupOnEnterpriseProjectRequest
    ...
    def enterprise_project_id(self):
        r"""Gets the enterprise_project_id of this AssociateRoleToGroupOnEnterpriseProjectRequest.
    ...
    def enterprise_project_id(self, enterprise_project_id):
        r"""Sets the enterprise_project_id of this AssociateRoleToGroupOnEnterpriseProjectRequest.
    ...
    @property
    def group_id(self):
        r"""Gets the group_id of this AssociateRoleToGroupOnEnterpriseProjectRequest.
    ...
    def group_id(self, group_id):
        r"""Sets the group_id of this AssociateRoleToGroupOnEnterpriseProjectRequest.
    ...
    @property
    def role_id(self):
        r"""Gets the role_id of this AssociateRoleToGroupOnEnterpriseProjectRequest.
    ...
    def role_id(self, role_id):
        r"""Sets the role_id of this AssociateRoleToGroupOnEnterpriseProjectRequest.
