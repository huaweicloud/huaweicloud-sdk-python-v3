...
class KeystoneRemoveDomainPermissionFromGroupRequest:
    ...
    def __init__(self, domain_id=None, group_id=None, role_id=None):
        r"""KeystoneRemoveDomainPermissionFromGroupRequest
    ...
    @property
    def domain_id(self):
        r"""Gets the domain_id of this KeystoneRemoveDomainPermissionFromGroupRequest.
    ...
    def domain_id(self, domain_id):
        r"""Sets the domain_id of this KeystoneRemoveDomainPermissionFromGroupRequest.
    ...
    @property
    def group_id(self):
        r"""Gets the group_id of this KeystoneRemoveDomainPermissionFromGroupRequest.
    ...
    def group_id(self, group_id):
        r"""Sets the group_id of this KeystoneRemoveDomainPermissionFromGroupRequest.
    ...
    @property
    def role_id(self):
        r"""Gets the role_id of this KeystoneRemoveDomainPermissionFromGroupRequest.
    ...
    def role_id(self, role_id):
        r"""Sets the role_id of this KeystoneRemoveDomainPermissionFromGroupRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KeystoneRemoveDomainPermissionFromGroupRequest):
            return False
