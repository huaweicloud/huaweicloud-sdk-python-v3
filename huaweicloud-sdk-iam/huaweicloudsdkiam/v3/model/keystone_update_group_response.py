...
class KeystoneUpdateGroupResponse(SdkResponse):
    ...
    def __init__(self, group=None):
        ...
        super(KeystoneUpdateGroupResponse, self).__init__()
    ...
    @property
    def group(self):
        r"""Gets the group of this KeystoneUpdateGroupResponse.
    ...
    def group(self, group):
        r"""Sets the group of this KeystoneUpdateGroupResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KeystoneUpdateGroupResponse):
            return False
