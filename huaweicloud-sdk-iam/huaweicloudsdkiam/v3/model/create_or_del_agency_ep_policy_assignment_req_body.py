...
class CreateOrDelAgencyEpPolicyAssignmentReqBody:
    ...
    def role_assignments(self):
        ...
        :return: The role_assignments of this CreateOrDelAgencyEpPolicyAssignmentReqBody.
    ...
    def role_assignments(self, role_assignments):
        ...
        :param role_assignments: The role_assignments of this CreateOrDelAgencyEpPolicyAssignmentReqBody.
        :type role_assignments: list[:class:`huaweicloudsdkiam.v3.CreateAgencyEpPolicyAssignmentReqBodyRoleAssignments`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateOrDelAgencyEpPolicyAssignmentReqBody):
            return False
