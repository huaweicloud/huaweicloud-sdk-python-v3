...
class AssociateAgencyWithAllProjectsPermissionRequest:
    ...
    def __init__(self, agency_id=None, domain_id=None, role_id=None):
        r"""AssociateAgencyWithAllProjectsPermissionRequest
    ...
    @property
    def agency_id(self):
        r"""Gets the agency_id of this AssociateAgencyWithAllProjectsPermissionRequest.
    ...
    def agency_id(self, agency_id):
        r"""Sets the agency_id of this AssociateAgencyWithAllProjectsPermissionRequest.
    ...
    @property
    def domain_id(self):
        r"""Gets the domain_id of this AssociateAgencyWithAllProjectsPermissionRequest.
    ...
    def domain_id(self, domain_id):
        r"""Sets the domain_id of this AssociateAgencyWithAllProjectsPermissionRequest.
    ...
    @property
    def role_id(self):
        r"""Gets the role_id of this AssociateAgencyWithAllProjectsPermissionRequest.
    ...
    def role_id(self, role_id):
        r"""Sets the role_id of this AssociateAgencyWithAllProjectsPermissionRequest.
