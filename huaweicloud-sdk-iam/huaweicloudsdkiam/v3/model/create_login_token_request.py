...
class CreateLoginTokenRequest:
    ...
    openapi_types = {
        'body': 'CreateLoginTokenRequestBody'
    }
    ...
    def __init__(self, body=None):
        r"""CreateLoginTokenRequest

        The model defined in huaweicloud sdk

        :param body: Body of the CreateLoginTokenRequest
    ...
    @property
    def body(self):
        r"""Gets the body of this CreateLoginTokenRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this CreateLoginTokenRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateLoginTokenRequest):
            return False
