...
class GetIdTokenRequestBody:
    ...
    def __init__(self, auth=None):
        """GetIdTokenRequestBody - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetIdTokenRequestBody):
            return False
