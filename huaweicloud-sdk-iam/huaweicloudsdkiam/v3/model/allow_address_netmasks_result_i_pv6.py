...
class AllowAddressNetmasksResultIPv6:
    ...
    def __init__(self, address_netmask=None, description=None):
        r"""AllowAddressNetmasksResultIPv6
    ...
    def address_netmask(self):
        r"""Gets the address_netmask of this AllowAddressNetmasksResultIPv6.
    ...
    def address_netmask(self, address_netmask):
        r"""Sets the address_netmask of this AllowAddressNetmasksResultIPv6.
    ...
    def description(self):
        r"""Gets the description of this AllowAddressNetmasksResultIPv6.
    ...
    def description(self, description):
        r"""Sets the description of this AllowAddressNetmasksResultIPv6.
