...
class CreateAgencyCustomPolicyRequest(object):
    ...
    openapi_types = {
        'body': 'CreateAgencyCustomPolicyRequestBody'
    }
    ...
    def __init__(self, body=None):  # noqa: E501
        """CreateAgencyCustomPolicyRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: CreateAgencyCustomPolicyRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateAgencyCustomPolicyRequest):
            return False
