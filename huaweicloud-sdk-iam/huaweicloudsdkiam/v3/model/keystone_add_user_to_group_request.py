...
class KeystoneAddUserToGroupRequest:
    ...
    def __init__(self, group_id=None, user_id=None):
        r"""KeystoneAddUserToGroupRequest

        The model defined in huaweicloud sdk

        :param group_id: 用户组ID，获取方式请参见：[获取用户组ID](https://support.huaweicloud.com/api-iam/iam_17_0002.html)。
        :type group_id: str
        :param user_id: 待添加的IAM用户ID，获取方式请参见：[获取IAM用户ID](https://support.huaweicloud.com/api-iam/iam_17_0002.html)。
        :type user_id: str
        """
    ...
    @property
    def group_id(self):
        r"""Gets the group_id of this KeystoneAddUserToGroupRequest.
    ...
    def group_id(self, group_id):
        r"""Sets the group_id of this KeystoneAddUserToGroupRequest.
    ...
    @property
    def user_id(self):
        r"""Gets the user_id of this KeystoneAddUserToGroupRequest.
    ...
    def user_id(self, user_id):
        r"""Sets the user_id of this KeystoneAddUserToGroupRequest.
