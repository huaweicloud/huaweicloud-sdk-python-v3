...
class KeystoneUpdateProjectResponse(SdkResponse):
    ...
    def __init__(self, project=None):
        r"""KeystoneUpdateProjectResponse
    ...
    @property
    def project(self):
        r"""Gets the project of this KeystoneUpdateProjectResponse.
    ...
    def project(self, project):
        r"""Sets the project of this KeystoneUpdateProjectResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("KeystoneUpdateProjectResponse.to_dict() is deprecated and no longer maintained, "
