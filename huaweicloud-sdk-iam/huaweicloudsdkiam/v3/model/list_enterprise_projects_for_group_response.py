...
class ListEnterpriseProjectsForGroupResponse(SdkResponse):
    ...
    def __init__(self, enterprise_projects=None):
        r"""ListEnterpriseProjectsForGroupResponse
    ...
    def enterprise_projects(self):
        r"""Gets the enterprise_projects of this ListEnterpriseProjectsForGroupResponse.

        企业项目信息。

        :return: The enterprise_projects of this ListEnterpriseProjectsForGroupResponse.
    ...
    def enterprise_projects(self, enterprise_projects):
        r"""Sets the enterprise_projects of this ListEnterpriseProjectsForGroupResponse.

        企业项目信息。

        :param enterprise_projects: The enterprise_projects of this ListEnterpriseProjectsForGroupResponse.
        :type enterprise_projects: list[:class:`huaweicloudsdkiam.v3.ListEnterpriseProjectsResDetail`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListEnterpriseProjectsForGroupResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListEnterpriseProjectsForGroupResponse):
            return False
