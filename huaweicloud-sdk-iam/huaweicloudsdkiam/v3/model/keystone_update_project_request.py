...
class KeystoneUpdateProjectRequest(object):
    ...
    openapi_types = {
        'project_id': 'str',
        'body': 'KeystoneUpdateProjectRequestBody'
    }
    ...
    def __init__(self, project_id=None, body=None):  # noqa: E501
    ...
    def project_id(self):
        ...
        :return: The project_id of this KeystoneUpdateProjectRequest.
        :rtype: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KeystoneUpdateProjectRequest):
            return False
