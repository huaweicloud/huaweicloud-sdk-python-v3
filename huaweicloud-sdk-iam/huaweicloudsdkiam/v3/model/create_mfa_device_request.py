...
class CreateMfaDeviceRequest:
    ...
    @property
    def body(self):
        r"""Gets the body of this CreateMfaDeviceRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this CreateMfaDeviceRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateMfaDeviceRequest):
            return False
