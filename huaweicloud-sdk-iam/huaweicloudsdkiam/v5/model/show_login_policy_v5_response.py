...
class ShowLoginPolicyV5Response(SdkResponse):
    ...
    def login_policy(self):
        r"""Gets the login_policy of this ShowLoginPolicyV5Response.
    ...
    def login_policy(self, login_policy):
        r"""Sets the login_policy of this ShowLoginPolicyV5Response.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowLoginPolicyV5Response.to_dict() is deprecated and no longer maintained, "
