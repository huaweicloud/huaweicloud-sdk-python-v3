...
class UpdateAccessKeyV5Response(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateAccessKeyV5Response.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateAccessKeyV5Response):
            return False
