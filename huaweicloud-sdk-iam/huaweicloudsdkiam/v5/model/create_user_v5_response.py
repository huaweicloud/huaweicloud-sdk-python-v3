...
class CreateUserV5Response(SdkResponse):
    ...
    @property
    def user(self):
        r"""Gets the user of this CreateUserV5Response.
    ...
    @user.setter
    def user(self, user):
        r"""Sets the user of this CreateUserV5Response.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateUserV5Response.to_dict() is deprecated and no longer maintained, "
