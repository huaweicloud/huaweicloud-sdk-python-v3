...
class DisableMfaDeviceV5Request:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the DisableMfaDeviceV5Request
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DisableMfaDeviceV5Request):
            return False
