...
class CreateVirtualMfaDeviceV5Request:
    ...
    openapi_types = {
        'body': 'CreateVirtualMfaDeviceReqBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateVirtualMfaDeviceV5Request
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateVirtualMfaDeviceV5Request):
            return False
