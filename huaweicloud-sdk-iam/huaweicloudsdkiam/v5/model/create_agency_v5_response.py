...
class CreateAgencyV5Response(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateAgencyV5Response.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateAgencyV5Response):
            return False
