...
class ShowUserV5Response(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowUserV5Response.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowUserV5Response):
            return False
