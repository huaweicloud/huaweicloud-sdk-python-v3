...
class UpdatePasswordPolicyV5Response(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdatePasswordPolicyV5Response.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdatePasswordPolicyV5Response):
            return False
