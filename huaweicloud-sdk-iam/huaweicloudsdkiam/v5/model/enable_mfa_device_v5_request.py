...
class EnableMfaDeviceV5Request:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the EnableMfaDeviceV5Request
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnableMfaDeviceV5Request):
            return False
