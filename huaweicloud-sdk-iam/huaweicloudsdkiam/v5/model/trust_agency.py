...
class TrustAgency:
    ...
    def __init__(self, urn=None, trust_policy=None, created_at=None, description=None, max_session_duration=None, path=None, agency_id=None, agency_name=None, trust_domain_id=None, trust_domain_name=None):
        r"""TrustAgency
    ...
    @property
    def urn(self):
        r"""Gets the urn of this TrustAgency.

        统一资源名称。

        :return: The urn of this TrustAgency.
        :rtype: str
        """
        return self._urn
    ...
    @urn.setter
    def urn(self, urn):
        r"""Sets the urn of this TrustAgency.

        统一资源名称。

        :param urn: The urn of this TrustAgency.
        :type urn: str
        """
        self._urn = urn
    ...
    def trust_policy(self, trust_policy):
        r"""Sets the trust_policy of this TrustAgency.

        信任委托信任策略的策略文档的json格式。下面的字符`= < > ( ) |`是语法中的特殊字符，不包含在信任策略中。  问号`?`表示元素是可选的。例如`sid_block?`。  竖线`|`表示可选项，括号定义了可选项的范围。例如`(\"Allow\" | \"Deny\")`。  当一个元素允许多个值时，使用重复值`,`以及`...`表示。例如`[ <policy_statement>, <policy_statement>, ... ]`。  下面的递归文法描述了信任策略的语法： ``` policy = {   <version_block>,   <statement_block> }  <version_block> = \"Version\" : (\"5.0\")  <statement_block> = \"Statement\" : [ <policy_statement>, <policy_statement>, ... ]  <policy_statement> = {   <sid_block?>,   <principal_block>,   <effect_block>,   <action_block>,   <resource_block?>,   <condition_block?> }  <sid_block> = \"Sid\" : <sid_string>  <principal_block> = (\"Principal\" | \"NotPrincipal\") : <principal_map>  <principal_map> = { <principal_map_entry>, <principal_map_entry>, ... }  <principal_map_entry> = (\"IAM\" | \"Service\") : [ <principal_id_string>, ... | <service_principal_string>, ... ]  <effect_block> = \"Effect\" : (\"Allow\" | \"Deny\")  <action_block> = (\"Action\" | \"NotAction\") : [ <action_string>, <action_string>, ... ]  <resource_block> = (\"Resource\" | \"NotResource\") : [ <resource_string>, <resource_string>, ... ]  <condition_block> = \"Condition\" : { <condition_map> }  <condition_map> = {   <condition_type_string> : { <condition_key_string> : <condition_value_list> },   <condition_type_string> : { <condition_key_string> : <condition_value_list> },   ... }  <condition_value_list> = ( <condition_value> | [ <condition_value>, <condition_value>, ... ] )  <condition_value> = \"string\" ``` 

        :param trust_policy: The trust_policy of this TrustAgency.
        :type trust_policy: str
        """
    ...
    @property
    def created_at(self):
        r"""Gets the created_at of this TrustAgency.

        信任委托创建时间。

        :return: The created_at of this TrustAgency.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        r"""Sets the created_at of this TrustAgency.

        信任委托创建时间。

        :param created_at: The created_at of this TrustAgency.
        :type created_at: datetime
        """
    ...
    def description(self):
        r"""Gets the description of this TrustAgency.

        信任委托描述信息。

        :return: The description of this TrustAgency.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this TrustAgency.

        信任委托描述信息。

        :param description: The description of this TrustAgency.
        :type description: str
        """
    ...
    def max_session_duration(self):
        r"""Gets the max_session_duration of this TrustAgency.

        信任委托最大会话时长，默认为3600秒，取值范围为[3600,43200]。

        :return: The max_session_duration of this TrustAgency.
        :rtype: int
        """
    ...
    def max_session_duration(self, max_session_duration):
        r"""Sets the max_session_duration of this TrustAgency.

        信任委托最大会话时长，默认为3600秒，取值范围为[3600,43200]。

        :param max_session_duration: The max_session_duration of this TrustAgency.
        :type max_session_duration: int
        """
    ...
    @property
    def path(self):
        r"""Gets the path of this TrustAgency.

        资源路径，默认为空串。由若干段字符串拼接而成，每段先包含一个或多个字母、数字、\".\"、\",\"、\"+\"、\"@\"、\"=\"、\"_\"或\"-\"，并以\"/\"结尾，例如\"foo/bar/\"。

        :return: The path of this TrustAgency.
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        r"""Sets the path of this TrustAgency.

        资源路径，默认为空串。由若干段字符串拼接而成，每段先包含一个或多个字母、数字、\".\"、\",\"、\"+\"、\"@\"、\"=\"、\"_\"或\"-\"，并以\"/\"结尾，例如\"foo/bar/\"。

        :param path: The path of this TrustAgency.
        :type path: str
        """
        self._path = path
    ...
    @property
    def agency_id(self):
        r"""Gets the agency_id of this TrustAgency.

        信任委托ID，长度为1到64个字符，只包含字母、数字和\"-\"的字符串。

        :return: The agency_id of this TrustAgency.
        :rtype: str
        """
    ...
    def agency_id(self, agency_id):
        r"""Sets the agency_id of this TrustAgency.

        信任委托ID，长度为1到64个字符，只包含字母、数字和\"-\"的字符串。

        :param agency_id: The agency_id of this TrustAgency.
        :type agency_id: str
        """
    ...
    def agency_name(self):
        r"""Gets the agency_name of this TrustAgency.

        信任委托名称，长度为1到64个字符，只包含字母、数字、\"_\"、\"+\"、\"=\"、\",\"、\".\"、\"@\"和\"-\"的字符串。

        :return: The agency_name of this TrustAgency.
        :rtype: str
        """
    ...
    def agency_name(self, agency_name):
        r"""Sets the agency_name of this TrustAgency.

        信任委托名称，长度为1到64个字符，只包含字母、数字、\"_\"、\"+\"、\"=\"、\",\"、\".\"、\"@\"和\"-\"的字符串。

        :param agency_name: The agency_name of this TrustAgency.
        :type agency_name: str
        """
    ...
    def trust_domain_id(self):
        r"""Gets the trust_domain_id of this TrustAgency.

        被委托方账号ID，仅存在于委托中，不存在于信任委托中。

        :return: The trust_domain_id of this TrustAgency.
        :rtype: str
        """
    ...
    def trust_domain_id(self, trust_domain_id):
        r"""Sets the trust_domain_id of this TrustAgency.

        被委托方账号ID，仅存在于委托中，不存在于信任委托中。

        :param trust_domain_id: The trust_domain_id of this TrustAgency.
        :type trust_domain_id: str
        """
    ...
    def trust_domain_name(self):
        r"""Gets the trust_domain_name of this TrustAgency.

        被委托方账号名，仅存在于委托中，不存在于信任委托中。

        :return: The trust_domain_name of this TrustAgency.
        :rtype: str
        """
    ...
    def trust_domain_name(self, trust_domain_name):
        r"""Sets the trust_domain_name of this TrustAgency.

        被委托方账号名，仅存在于委托中，不存在于信任委托中。

        :param trust_domain_name: The trust_domain_name of this TrustAgency.
        :type trust_domain_name: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TrustAgency):
            return False
