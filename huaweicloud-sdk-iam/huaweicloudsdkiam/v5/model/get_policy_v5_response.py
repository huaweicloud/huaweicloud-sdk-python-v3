...
class GetPolicyV5Response(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("GetPolicyV5Response.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetPolicyV5Response):
            return False
