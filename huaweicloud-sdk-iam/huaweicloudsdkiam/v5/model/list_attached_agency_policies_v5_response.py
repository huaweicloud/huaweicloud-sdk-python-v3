...
class ListAttachedAgencyPoliciesV5Response(SdkResponse):
    ...
    def attached_policies(self):
        ...
        :return: The attached_policies of this ListAttachedAgencyPoliciesV5Response.
    ...
    def attached_policies(self, attached_policies):
        ...
        :param attached_policies: The attached_policies of this ListAttachedAgencyPoliciesV5Response.
        :type attached_policies: list[:class:`huaweicloudsdkiam.v5.AttachedPolicy`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAttachedAgencyPoliciesV5Response.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListAttachedAgencyPoliciesV5Response):
            return False
