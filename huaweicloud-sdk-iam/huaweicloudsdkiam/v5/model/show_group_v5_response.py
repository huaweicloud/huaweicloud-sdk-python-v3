...
class ShowGroupV5Response(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowGroupV5Response.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowGroupV5Response):
            return False
