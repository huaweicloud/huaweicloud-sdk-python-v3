...
class RabbitMQClient(Client):
    ...
    def show_rabbit_mq_product_cores_invoker(self, request):
        http_info = self._show_rabbit_mq_product_cores_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_rabbit_mq_product_cores_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def create_binding_invoker(self, request):
        http_info = self._create_binding_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_binding_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def delete_binding_invoker(self, request):
        http_info = self._delete_binding_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_binding_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_bindings_invoker(self, request):
        http_info = self._list_bindings_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_bindings_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v2/rabbitmq/{project_id}/instances/{instance_id}/vhosts/{vhost}/exchanges/{exchange}/binding",
            "request_type": request.__class__.__name__,
    ...
    def batch_delete_exchanges(self, request):
        r"""批量删除指定Exchange
    ...
    def batch_delete_exchanges_invoker(self, request):
        http_info = self._batch_delete_exchanges_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _batch_delete_exchanges_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def create_exchange_invoker(self, request):
        http_info = self._create_exchange_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_exchange_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v2/rabbitmq/{project_id}/instances/{instance_id}/vhosts/{vhost}/exchanges",
            "request_type": request.__class__.__name__,
    ...
    def list_exchanges_invoker(self, request):
        http_info = self._list_exchanges_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_exchanges_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v2/rabbitmq/{project_id}/instances/{instance_id}/vhosts/{vhost}/exchanges",
            "request_type": request.__class__.__name__,
    ...
    def batch_delete_queues(self, request):
        r"""批量删除指定Queue
    ...
    def batch_delete_queues_invoker(self, request):
        http_info = self._batch_delete_queues_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _batch_delete_queues_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def delete_queue_info(self, request):
        r"""清空Queue消息
    ...
    def delete_queue_info_invoker(self, request):
        http_info = self._delete_queue_info_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_queue_info_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def show_queue_details(self, request):
        r"""查询指定Queue详情
    ...
    def show_queue_details_invoker(self, request):
        http_info = self._show_queue_details_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_queue_details_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def batch_delete_vhosts(self, request):
        r"""批量删除指定Vhost
    ...
    def batch_delete_vhosts_invoker(self, request):
        http_info = self._batch_delete_vhosts_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _batch_delete_vhosts_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def create_vhost_invoker(self, request):
        http_info = self._create_vhost_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_vhost_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v2/rabbitmq/{project_id}/instances/{instance_id}/vhosts",
            "request_type": request.__class__.__name__,
    ...
    def list_vhosts_invoker(self, request):
        http_info = self._list_vhosts_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_vhosts_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v2/rabbitmq/{project_id}/instances/{instance_id}/vhosts",
            "request_type": request.__class__.__name__,
