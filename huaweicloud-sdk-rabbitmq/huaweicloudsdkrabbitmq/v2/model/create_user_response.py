...
class CreateUserResponse(SdkResponse):
    ...
    @property
    def vhosts(self):
        r"""Gets the vhosts of this CreateUserResponse.

        需要配置权限的Vhost，一个用户可以配置多个Vhost下的资源权限。

        :return: The vhosts of this CreateUserResponse.
    ...
    def vhosts(self, vhosts):
        r"""Sets the vhosts of this CreateUserResponse.

        需要配置权限的Vhost，一个用户可以配置多个Vhost下的资源权限。

        :param vhosts: The vhosts of this CreateUserResponse.
        :type vhosts: list[:class:`huaweicloudsdkrabbitmq.v2.AMQPUserPerm`]
        """
        self._vhosts = vhosts
