...
class ListAvailableZonesResponse(SdkResponse):
    ...
    def __init__(self, region_id=None, available_zones=None):
        ...
        :type available_zones: list[:class:`huaweicloudsdkrabbitmq.v2.ListAvailableZonesRespAvailableZones`]
        """
    ...
    def available_zones(self):
        ...
        **参数解释**： 可用区数组。
        ...
        :rtype: list[:class:`huaweicloudsdkrabbitmq.v2.ListAvailableZonesRespAvailableZones`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAvailableZonesResponse.to_dict() is deprecated and no longer maintained, "
