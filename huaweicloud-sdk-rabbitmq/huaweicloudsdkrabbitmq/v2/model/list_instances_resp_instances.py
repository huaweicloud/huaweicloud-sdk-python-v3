...
class ListInstancesRespInstances:
    ...
    def publicip_id(self):
        """Gets the publicip_id of this ListInstancesRespInstances.

        RabbitMQ实例绑定的弹性IP地址的ID。  如果未开启公网访问功能，该字段值为null。

        :return: The publicip_id of this ListInstancesRespInstances.
        :rtype: str
        """
    ...
    def publicip_id(self, publicip_id):
        """Sets the publicip_id of this ListInstancesRespInstances.

        RabbitMQ实例绑定的弹性IP地址的ID。  如果未开启公网访问功能，该字段值为null。

        :param publicip_id: The publicip_id of this ListInstancesRespInstances.
        :type: str
        """
