...
class ShowEngineInstanceExtendProductInfoResponse(SdkResponse):
    ...
    def __init__(self, total=None, next_offset=None, previous_offset=None, engine=None, versions=None, products=None):
        ...
        :param total: 查询结果总数。
        :type total: int
        :param next_offset: 下一个偏移量。
        :type next_offset: int
        :param previous_offset: 前一个偏移量。
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowEngineInstanceExtendProductInfoResponse.to_dict() is deprecated and no longer maintained, "
