...
class ShowQuotasResponse(SdkResponse):
    ...
    def __init__(self, quotas=None):
        ...
        :param quotas: 
        :type quotas: :class:`huaweicloudsdkrabbitmq.v2.QuotasRespQuotas`
        """
    ...
    def quotas(self):
        ...
        :rtype: :class:`huaweicloudsdkrabbitmq.v2.QuotasRespQuotas`
        """
        return self._quotas
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowQuotasResponse.to_dict() is deprecated and no longer maintained, "
