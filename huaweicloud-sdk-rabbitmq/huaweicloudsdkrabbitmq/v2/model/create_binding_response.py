...
class CreateBindingResponse(SdkResponse):
    ...
    def __init__(self, source=None, destination_type=None, destination=None, routing_key=None):
        ...
        :param source: 绑定对象
        :type source: str
        :param destination_type: **参数解释**： 绑定目标端类型。 **取值范围**： - exchange：交换机。 - queue：队列。[AMQP版本只支持绑定queue。](tag:hws,hws_hk,hws_eu,srg)
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateBindingResponse.to_dict() is deprecated and no longer maintained, "
