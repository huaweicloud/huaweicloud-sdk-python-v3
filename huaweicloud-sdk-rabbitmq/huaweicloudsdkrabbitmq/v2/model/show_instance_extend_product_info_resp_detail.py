...
class ShowInstanceExtendProductInfoRespDetail:
    ...
    def __init__(self, storage=None, product_id=None, spec_code=None, io=None, unavailable_zones=None, available_zones=None, ecs_flavor_id=None, arch_type=None):
        ...
        :type spec_code: str
        :param io: IO信息。
        :type io: list[:class:`huaweicloudsdkrabbitmq.v2.ShowInstanceExtendProductInfoRespIo`]
    ...
    def io(self):
        ...
        :rtype: list[:class:`huaweicloudsdkrabbitmq.v2.ShowInstanceExtendProductInfoRespIo`]
        """
        return self._io
