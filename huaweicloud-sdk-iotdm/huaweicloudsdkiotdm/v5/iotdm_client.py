...
class IoTDMClient(Client):
    ...
    def list_instance_flavors(self, request):
        r"""查询实例规格列表
    ...
    def list_instance_flavors_invoker(self, request):
        http_info = self._list_instance_flavors_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_instance_flavors_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def list_instance_tasks(self, request):
        r"""查询实例任务列表
    ...
    def list_instance_tasks_invoker(self, request):
        http_info = self._list_instance_tasks_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_instance_tasks_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def retry_instance_task(self, request):
        r"""重试实例任务
    ...
    def retry_instance_task_invoker(self, request):
        http_info = self._retry_instance_task_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _retry_instance_task_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def show_instance_task(self, request):
        r"""查询实例任务详情
    ...
    def show_instance_task_invoker(self, request):
        http_info = self._show_instance_task_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_instance_task_http_info(cls, request):
        http_info = {
            "method": "GET",
