...
class BindInstanceTagsRequest:
    ...
    def instance_id(self):
        ...
        **参数说明**：实例ID。 **取值范围**：长度不超过36，由小写字母[a-f]、数字、连接符（-）的组成。 
        ...
        :return: The instance_id of this BindInstanceTagsRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        ...
        **参数说明**：实例ID。 **取值范围**：长度不超过36，由小写字母[a-f]、数字、连接符（-）的组成。 
        ...
        :param instance_id: The instance_id of this BindInstanceTagsRequest.
        :type instance_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BindInstanceTagsRequest):
            return False
