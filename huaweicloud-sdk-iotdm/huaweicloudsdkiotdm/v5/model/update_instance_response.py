...
class UpdateInstanceResponse(SdkResponse):
    ...
    @property
    def region_id(self):
        r"""Gets the region_id of this UpdateInstanceResponse.

        **参数说明**：实例所属region。 

        :return: The region_id of this UpdateInstanceResponse.
        :rtype: str
        """
    ...
    def region_id(self, region_id):
        r"""Sets the region_id of this UpdateInstanceResponse.

        **参数说明**：实例所属region。 

        :param region_id: The region_id of this UpdateInstanceResponse.
        :type region_id: str
        """
