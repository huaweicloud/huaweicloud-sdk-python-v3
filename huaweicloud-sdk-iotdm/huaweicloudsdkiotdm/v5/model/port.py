...
class Port:
    ...
    def __init__(self, app_https_port=None, app_amqps_port=None, app_mqtts_port=None, device_coap_port=None, device_coaps_port=None, device_mqtt_port=None, device_mqtts_port=None, device_https_port=None):
        r"""Port
        ...
        :param app_mqtts_port: **参数说明**：应用接入MQTTS协议端口, 默认值：8883。 
        :type app_mqtts_port: int
        ...
        if app_mqtts_port is not None:
            self.app_mqtts_port = app_mqtts_port
    ...
    @property
    def app_mqtts_port(self):
        r"""Gets the app_mqtts_port of this Port.

        **参数说明**：应用接入MQTTS协议端口, 默认值：8883。 

        :return: The app_mqtts_port of this Port.
        :rtype: int
        """
        return self._app_mqtts_port

    @app_mqtts_port.setter
    def app_mqtts_port(self, app_mqtts_port):
        r"""Sets the app_mqtts_port of this Port.

        **参数说明**：应用接入MQTTS协议端口, 默认值：8883。 

        :param app_mqtts_port: The app_mqtts_port of this Port.
        :type app_mqtts_port: int
        """
        self._app_mqtts_port = app_mqtts_port
