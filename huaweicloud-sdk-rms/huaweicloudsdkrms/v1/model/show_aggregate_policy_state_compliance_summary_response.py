...
class ShowAggregatePolicyStateComplianceSummaryResponse(SdkResponse):
    ...
    def __init__(self, results=None):
        r"""ShowAggregatePolicyStateComplianceSummaryResponse
    ...
    @property
    def results(self):
        r"""Gets the results of this ShowAggregatePolicyStateComplianceSummaryResponse.
    ...
    def results(self, results):
        r"""Sets the results of this ShowAggregatePolicyStateComplianceSummaryResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowAggregatePolicyStateComplianceSummaryResponse.to_dict() is deprecated and no longer maintained, "
