...
class CreateConfigurationAggregatorRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateConfigurationAggregatorRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateConfigurationAggregatorRequest):
            return False
