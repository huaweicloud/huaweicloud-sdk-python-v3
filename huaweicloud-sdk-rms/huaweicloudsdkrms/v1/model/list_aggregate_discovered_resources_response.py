...
class ListAggregateDiscoveredResourcesResponse(SdkResponse):
    ...
    def __init__(self, resource_identifiers=None, page_info=None):
        ...
        :type resource_identifiers: list[:class:`huaweicloudsdkrms.v1.ResourceIdentifier`]
        :param page_info: 
    ...
    def resource_identifiers(self):
        ...
        :rtype: list[:class:`huaweicloudsdkrms.v1.ResourceIdentifier`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAggregateDiscoveredResourcesResponse.to_dict() is deprecated and no longer maintained, "
