...
class ShowOrganizationPolicyAssignmentDetailedStatusResponse(SdkResponse):
    ...
    def __init__(self, value=None, page_info=None):
        ...
        :type value: list[:class:`huaweicloudsdkrms.v1.OrganizationPolicyAssignmentDetailedStatusResponse`]
        :param page_info: 
    ...
    def value(self):
        ...
        :rtype: list[:class:`huaweicloudsdkrms.v1.OrganizationPolicyAssignmentDetailedStatusResponse`]
        """
        return self._value
