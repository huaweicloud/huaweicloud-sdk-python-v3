...
class ShowAggregateComplianceDetailsByPolicyAssignmentResponse(SdkResponse):
    ...
    def __init__(self, policy_states=None, page_info=None):
        ...
        :type policy_states: list[:class:`huaweicloudsdkrms.v1.PolicyState`]
        :param page_info: 
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowAggregateComplianceDetailsByPolicyAssignmentResponse.to_dict() is deprecated and no longer maintained, "
