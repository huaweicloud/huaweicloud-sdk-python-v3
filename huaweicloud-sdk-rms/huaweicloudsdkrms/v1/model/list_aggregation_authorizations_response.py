...
class ListAggregationAuthorizationsResponse(SdkResponse):
    ...
    def __init__(self, aggregation_authorizations=None, page_info=None):
        ...
        :type aggregation_authorizations: list[:class:`huaweicloudsdkrms.v1.AggregationAuthorizationResp`]
        :param page_info: 
    ...
    def aggregation_authorizations(self):
        ...
        :rtype: list[:class:`huaweicloudsdkrms.v1.AggregationAuthorizationResp`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAggregationAuthorizationsResponse.to_dict() is deprecated and no longer maintained, "
