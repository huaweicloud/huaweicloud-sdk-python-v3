...
class CreateAggregationAuthorizationRequest:
    ...
    openapi_types = {
        'body': 'AggregationAuthorizationRequest'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateAggregationAuthorizationRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateAggregationAuthorizationRequest):
            return False
