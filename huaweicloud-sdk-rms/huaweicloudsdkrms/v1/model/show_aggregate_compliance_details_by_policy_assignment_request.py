...
class ShowAggregateComplianceDetailsByPolicyAssignmentRequest:
    ...
    openapi_types = {
        'limit': 'int',
        'marker': 'str',
        'body': 'AggregateComplianceDetailRequest'
    }
    ...
    def __init__(self, limit=None, marker=None, body=None):
        ...
        :type marker: str
        :param body: Body of the ShowAggregateComplianceDetailsByPolicyAssignmentRequest
    ...
    def limit(self):
        ...
        :return: The limit of this ShowAggregateComplianceDetailsByPolicyAssignmentRequest.
        :rtype: int
        """
        return self._limit
    ...
    def limit(self, limit):
        ...
        :param limit: The limit of this ShowAggregateComplianceDetailsByPolicyAssignmentRequest.
        :type limit: int
        """
        self._limit = limit
    ...
    def marker(self):
        ...
        :return: The marker of this ShowAggregateComplianceDetailsByPolicyAssignmentRequest.
        :rtype: str
        """
        return self._marker
    ...
    def marker(self, marker):
        ...
        :param marker: The marker of this ShowAggregateComplianceDetailsByPolicyAssignmentRequest.
        :type marker: str
        """
        self._marker = marker
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowAggregateComplianceDetailsByPolicyAssignmentRequest):
            return False
