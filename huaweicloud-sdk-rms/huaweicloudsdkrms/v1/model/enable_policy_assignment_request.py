...
class EnablePolicyAssignmentRequest:
    ...
    def x_auth_token(self):
        """Gets the x_auth_token of this EnablePolicyAssignmentRequest.

        用户Token。 获取Token，请参考《统一身份认证服务API参考》的“获取用户Token”章节。请求响应成功后在响应消息头中包含的“X-Subject-Token”的值即为Token值。

        :return: The x_auth_token of this EnablePolicyAssignmentRequest.
        :rtype: str
        """
    ...
    def x_auth_token(self, x_auth_token):
        """Sets the x_auth_token of this EnablePolicyAssignmentRequest.

        用户Token。 获取Token，请参考《统一身份认证服务API参考》的“获取用户Token”章节。请求响应成功后在响应消息头中包含的“X-Subject-Token”的值即为Token值。

        :param x_auth_token: The x_auth_token of this EnablePolicyAssignmentRequest.
        :type x_auth_token: str
        """
    ...
    def policy_assignment_id(self):
        """Gets the policy_assignment_id of this EnablePolicyAssignmentRequest.
    ...
    def policy_assignment_id(self, policy_assignment_id):
        """Sets the policy_assignment_id of this EnablePolicyAssignmentRequest.
