...
class ShowAggregateDiscoveredResourceCountsRequest:
    ...
    openapi_types = {
        'body': 'AggregateDiscoveredResourceCountsRequest'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ShowAggregateDiscoveredResourceCountsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowAggregateDiscoveredResourceCountsRequest):
            return False
