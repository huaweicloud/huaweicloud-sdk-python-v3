...
class ListUnreadNewInstantMessagesResponse(SdkResponse):
    ...
    def __init__(self, imunread=None):
        ...
        if imunread is not None:
            self.imunread = imunread
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListUnreadNewInstantMessagesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListUnreadNewInstantMessagesResponse):
            return False
