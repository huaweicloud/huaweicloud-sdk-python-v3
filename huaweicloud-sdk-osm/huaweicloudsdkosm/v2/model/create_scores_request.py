...
class CreateScoresRequest:
    ...
    def __init__(self, case_id=None, x_site=None, x_language=None, x_time_zone=None, body=None):
        ...
        :param body: Body of the CreateScoresRequest
        :type body: :class:`huaweicloudsdkosm.v2.CreateScoreV2Req`
        """
    ...
    @property
    def case_id(self):
        r"""Gets the case_id of this CreateScoresRequest.
    ...
    def case_id(self, case_id):
        r"""Sets the case_id of this CreateScoresRequest.
    ...
    @property
    def x_site(self):
        r"""Gets the x_site of this CreateScoresRequest.
    ...
    def x_site(self, x_site):
        r"""Sets the x_site of this CreateScoresRequest.
    ...
    @property
    def x_language(self):
        r"""Gets the x_language of this CreateScoresRequest.
    ...
    def x_language(self, x_language):
        r"""Sets the x_language of this CreateScoresRequest.
    ...
    def x_time_zone(self):
        r"""Gets the x_time_zone of this CreateScoresRequest.
    ...
    def x_time_zone(self, x_time_zone):
        r"""Sets the x_time_zone of this CreateScoresRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this CreateScoresRequest.

        :return: The body of this CreateScoresRequest.
        :rtype: :class:`huaweicloudsdkosm.v2.CreateScoreV2Req`
        """
        return self._body

    @body.setter
    def body(self, body):
        r"""Sets the body of this CreateScoresRequest.
