...
class CreateResourceConfigurationsReqBody:
    ...
    def __init__(self, resource_configurations=None):
        r"""CreateResourceConfigurationsReqBody
    ...
    def resource_configurations(self):
        r"""Gets the resource_configurations of this CreateResourceConfigurationsReqBody.

        提权访问中的资源配置。

        :return: The resource_configurations of this CreateResourceConfigurationsReqBody.
    ...
    def resource_configurations(self, resource_configurations):
        r"""Sets the resource_configurations of this CreateResourceConfigurationsReqBody.

        提权访问中的资源配置。

        :param resource_configurations: The resource_configurations of this CreateResourceConfigurationsReqBody.
        :type resource_configurations: list[:class:`huaweicloudsdkiamaccessanalyzer.v1.ResourceConfiguration`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateResourceConfigurationsReqBody):
            return False
