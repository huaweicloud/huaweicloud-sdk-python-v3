...
class IAMAccessAnalyzerAsyncClient(Client):
    ...
    def get_access_preview_async(self, request):
        """获取相关访问预览的信息
    ...
    def get_access_preview_async_invoker(self, request):
        http_info = self._get_access_preview_http_info(request)
        return AsyncInvoker(self, http_info)

    def _get_access_preview_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_preview_findings_async(self, request):
        """获取相关预览生成的分析结果
    ...
    def list_preview_findings_async_invoker(self, request):
        http_info = self._list_preview_findings_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_preview_findings_http_info(self, request):
        http_info = {
            "method": "POST",
