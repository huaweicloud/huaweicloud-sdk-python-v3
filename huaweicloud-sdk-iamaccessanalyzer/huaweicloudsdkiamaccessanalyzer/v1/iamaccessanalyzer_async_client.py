...
class IAMAccessAnalyzerAsyncClient(Client):
    ...
    def check_no_new_access_async(self, request):
        r"""校验策略是否有新访问权限
        ...
        :param request: Request instance for CheckNoNewAccess
        :type request: :class:`huaweicloudsdkiamaccessanalyzer.v1.CheckNoNewAccessRequest`
        :rtype: :class:`huaweicloudsdkiamaccessanalyzer.v1.CheckNoNewAccessResponse`
        """
        http_info = self._check_no_new_access_http_info(request)
        return self._call_api(**http_info)

    def check_no_new_access_async_invoker(self, request):
        http_info = self._check_no_new_access_http_info(request)
        return AsyncInvoker(self, http_info)

    def _check_no_new_access_http_info(self, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v5/policies/check-no-new-access",
            "request_type": request.__class__.__name__,
            "response_type": "CheckNoNewAccessResponse"
            }
