...
class ShowKafkaTopicQuotaResponse(SdkResponse):
    ...
    openapi_types = {
        'quotas': 'list[KafkaTopicQuotaResp]',
        'count': 'int'
    }
    ...
    def __init__(self, quotas=None, count=None):
        ...
        :type quotas: list[:class:`huaweicloudsdkkafka.v2.KafkaTopicQuotaResp`]
    ...
    def quotas(self):
        ...
        :rtype: list[:class:`huaweicloudsdkkafka.v2.KafkaTopicQuotaResp`]
        """
        return self._quotas
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowKafkaTopicQuotaResponse.to_dict() is deprecated and no longer maintained, "
