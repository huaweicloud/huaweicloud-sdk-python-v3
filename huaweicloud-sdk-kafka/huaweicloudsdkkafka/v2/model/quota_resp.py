...
class QuotaResp:
    ...
    @property
    def user(self):
        r"""Gets the user of this QuotaResp.

        用户名。  不对全部用户/客户端限流时，用户名和客户端ID不能同时为空。

        :return: The user of this QuotaResp.
        :rtype: str
        """
        return self._user
    ...
    @user.setter
    def user(self, user):
        r"""Sets the user of this QuotaResp.

        用户名。  不对全部用户/客户端限流时，用户名和客户端ID不能同时为空。

        :param user: The user of this QuotaResp.
        :type user: str
        """
        self._user = user
    ...
    @property
    def client(self):
        r"""Gets the client of this QuotaResp.

        客户端ID。  不对全部用户/客户端限流时，用户名和客户端ID不能同时为空。

        :return: The client of this QuotaResp.
        :rtype: str
        """
        return self._client
    ...
    def client(self, client):
        r"""Sets the client of this QuotaResp.

        客户端ID。  不对全部用户/客户端限流时，用户名和客户端ID不能同时为空。

        :param client: The client of this QuotaResp.
        :type client: str
        """
        self._client = client
    ...
    def user_default(self):
        r"""Gets the user_default of this QuotaResp.

        是否使用用户默认设置。   - 是：表示对全部用户限流。此时不能同时设置用户名。   - 否：表示对特定用户限流。此时需要设置用户名。

        :return: The user_default of this QuotaResp.
        :rtype: bool
        """
    ...
    def user_default(self, user_default):
        r"""Sets the user_default of this QuotaResp.

        是否使用用户默认设置。   - 是：表示对全部用户限流。此时不能同时设置用户名。   - 否：表示对特定用户限流。此时需要设置用户名。

        :param user_default: The user_default of this QuotaResp.
        :type user_default: bool
        """
    ...
    def client_default(self):
        r"""Gets the client_default of this QuotaResp.

        是否使用客户端默认设置。   - 是：表示对全部客户端限流。此时不能设置客户端ID。   - 否：表示对特定客户端限流。此时需要设置客户端ID。

        :return: The client_default of this QuotaResp.
        :rtype: bool
        """
    ...
    def client_default(self, client_default):
        r"""Sets the client_default of this QuotaResp.

        是否使用客户端默认设置。   - 是：表示对全部客户端限流。此时不能设置客户端ID。   - 否：表示对特定客户端限流。此时需要设置客户端ID。

        :param client_default: The client_default of this QuotaResp.
        :type client_default: bool
        """
    ...
    def producer_byte_rate(self):
        r"""Gets the producer_byte_rate of this QuotaResp.

        生产上限速率（单位为B/s）。

        :return: The producer_byte_rate of this QuotaResp.
        :rtype: int
        """
    ...
    def producer_byte_rate(self, producer_byte_rate):
        r"""Sets the producer_byte_rate of this QuotaResp.

        生产上限速率（单位为B/s）。

        :param producer_byte_rate: The producer_byte_rate of this QuotaResp.
        :type producer_byte_rate: int
        """
    ...
    def consumer_byte_rate(self):
        r"""Gets the consumer_byte_rate of this QuotaResp.

        消费上限速率（单位为B/s）。  > “生产上限速率”和“消费上限速率”不可同时为空。

        :return: The consumer_byte_rate of this QuotaResp.
        :rtype: int
        """
    ...
    def consumer_byte_rate(self, consumer_byte_rate):
        r"""Sets the consumer_byte_rate of this QuotaResp.

        消费上限速率（单位为B/s）。  > “生产上限速率”和“消费上限速率”不可同时为空。

        :param consumer_byte_rate: The consumer_byte_rate of this QuotaResp.
        :type consumer_byte_rate: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QuotaResp):
            return False
