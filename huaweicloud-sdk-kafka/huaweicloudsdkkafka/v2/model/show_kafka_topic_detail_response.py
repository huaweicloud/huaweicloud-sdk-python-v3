...
class ShowKafkaTopicDetailResponse(SdkResponse):
    ...
    def __init__(self, body=None):
        r"""ShowKafkaTopicDetailResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowKafkaTopicDetailResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowKafkaTopicDetailResponse):
            return False
