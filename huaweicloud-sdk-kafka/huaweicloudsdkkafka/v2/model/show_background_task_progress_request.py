...
class ShowBackgroundTaskProgressRequest:
    ...
    def __init__(self, instance_id=None, task_id=None):
        r"""ShowBackgroundTaskProgressRequest
    ...
    def instance_id(self):
        r"""Gets the instance_id of this ShowBackgroundTaskProgressRequest.

        **参数解释**： 实例ID。获取方法如下：调用“查询所有实例列表”接口，从响应体中获取实例ID。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :return: The instance_id of this ShowBackgroundTaskProgressRequest.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this ShowBackgroundTaskProgressRequest.

        **参数解释**： 实例ID。获取方法如下：调用“查询所有实例列表”接口，从响应体中获取实例ID。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :param instance_id: The instance_id of this ShowBackgroundTaskProgressRequest.
        :type instance_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowBackgroundTaskProgressRequest):
            return False
