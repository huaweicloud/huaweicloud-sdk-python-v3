...
class UpdateVolumeExpansionConfigResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateVolumeExpansionConfigResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateVolumeExpansionConfigResponse):
            return False
