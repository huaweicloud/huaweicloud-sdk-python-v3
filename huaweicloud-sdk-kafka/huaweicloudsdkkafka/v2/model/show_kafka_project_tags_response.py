...
class ShowKafkaProjectTagsResponse(SdkResponse):
    ...
    def __init__(self, tags=None):
        r"""ShowKafkaProjectTagsResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowKafkaProjectTagsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowKafkaProjectTagsResponse):
            return False
