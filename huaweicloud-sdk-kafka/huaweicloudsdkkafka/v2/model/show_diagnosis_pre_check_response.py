...
class ShowDiagnosisPreCheckResponse(SdkResponse):
    ...
    openapi_types = {
        'body': 'list[KafkaDiagnosisCheckEntity]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowDiagnosisPreCheckResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowDiagnosisPreCheckResponse):
            return False
