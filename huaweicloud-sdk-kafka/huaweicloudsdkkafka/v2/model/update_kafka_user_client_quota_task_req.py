...
class UpdateKafkaUserClientQuotaTaskReq:
    ...
    def __init__(self, user=None, client=None, user_default=None, client_default=None, producer_byte_rate=None, consumer_byte_rate=None):
        """UpdateKafkaUserClientQuotaTaskReq
    ...
    @property
    def user(self):
        """Gets the user of this UpdateKafkaUserClientQuotaTaskReq.

        用户名

        :return: The user of this UpdateKafkaUserClientQuotaTaskReq.
        :rtype: str
        """
        return self._user
    ...
    @user.setter
    def user(self, user):
        """Sets the user of this UpdateKafkaUserClientQuotaTaskReq.

        用户名

        :param user: The user of this UpdateKafkaUserClientQuotaTaskReq.
        :type user: str
        """
        self._user = user
    ...
    @property
    def client(self):
        """Gets the client of this UpdateKafkaUserClientQuotaTaskReq.

        客户端ID

        :return: The client of this UpdateKafkaUserClientQuotaTaskReq.
        :rtype: str
        """
        return self._client
    ...
    def client(self, client):
        """Sets the client of this UpdateKafkaUserClientQuotaTaskReq.

        客户端ID

        :param client: The client of this UpdateKafkaUserClientQuotaTaskReq.
        :type client: str
        """
        self._client = client
    ...
    def user_default(self):
        """Gets the user_default of this UpdateKafkaUserClientQuotaTaskReq.
    ...
    def user_default(self, user_default):
        """Sets the user_default of this UpdateKafkaUserClientQuotaTaskReq.
    ...
    def client_default(self):
        """Gets the client_default of this UpdateKafkaUserClientQuotaTaskReq.
    ...
    def client_default(self, client_default):
        """Sets the client_default of this UpdateKafkaUserClientQuotaTaskReq.
    ...
    def producer_byte_rate(self):
        """Gets the producer_byte_rate of this UpdateKafkaUserClientQuotaTaskReq.

        生产上限速率（单位为B/s）

        :return: The producer_byte_rate of this UpdateKafkaUserClientQuotaTaskReq.
        :rtype: int
        """
    ...
    def producer_byte_rate(self, producer_byte_rate):
        """Sets the producer_byte_rate of this UpdateKafkaUserClientQuotaTaskReq.

        生产上限速率（单位为B/s）

        :param producer_byte_rate: The producer_byte_rate of this UpdateKafkaUserClientQuotaTaskReq.
        :type producer_byte_rate: int
        """
    ...
    def consumer_byte_rate(self):
        """Gets the consumer_byte_rate of this UpdateKafkaUserClientQuotaTaskReq.

        消费上限速率（单位为B/s）

        :return: The consumer_byte_rate of this UpdateKafkaUserClientQuotaTaskReq.
        :rtype: int
        """
    ...
    def consumer_byte_rate(self, consumer_byte_rate):
        """Sets the consumer_byte_rate of this UpdateKafkaUserClientQuotaTaskReq.

        消费上限速率（单位为B/s）

        :param consumer_byte_rate: The consumer_byte_rate of this UpdateKafkaUserClientQuotaTaskReq.
        :type consumer_byte_rate: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateKafkaUserClientQuotaTaskReq):
            return False
