...
class UpdateKafkaUserClientQuotaTaskReq:
    ...
    def __init__(self, user=None, client=None, user_default=None, client_default=None, producer_byte_rate=None, consumer_byte_rate=None):
        r"""UpdateKafkaUserClientQuotaTaskReq
    ...
    @property
    def user(self):
        r"""Gets the user of this UpdateKafkaUserClientQuotaTaskReq.
    ...
    @user.setter
    def user(self, user):
        r"""Sets the user of this UpdateKafkaUserClientQuotaTaskReq.
    ...
    @property
    def client(self):
        r"""Gets the client of this UpdateKafkaUserClientQuotaTaskReq.
    ...
    def client(self, client):
        r"""Sets the client of this UpdateKafkaUserClientQuotaTaskReq.
    ...
    def producer_byte_rate(self):
        r"""Gets the producer_byte_rate of this UpdateKafkaUserClientQuotaTaskReq.
    ...
    def producer_byte_rate(self, producer_byte_rate):
        r"""Sets the producer_byte_rate of this UpdateKafkaUserClientQuotaTaskReq.
    ...
    def consumer_byte_rate(self):
        r"""Gets the consumer_byte_rate of this UpdateKafkaUserClientQuotaTaskReq.
    ...
    def consumer_byte_rate(self, consumer_byte_rate):
        r"""Sets the consumer_byte_rate of this UpdateKafkaUserClientQuotaTaskReq.
