...
class KafkaTopicQuotaResp:
    ...
    @property
    def topic(self):
        r"""Gets the topic of this KafkaTopicQuotaResp.

        Topic名称

        :return: The topic of this KafkaTopicQuotaResp.
        :rtype: str
        """
        return self._topic
    ...
    def topic(self, topic):
        r"""Sets the topic of this KafkaTopicQuotaResp.

        Topic名称

        :param topic: The topic of this KafkaTopicQuotaResp.
        :type topic: str
        """
        self._topic = topic
    ...
    def producer_byte_rate(self):
        r"""Gets the producer_byte_rate of this KafkaTopicQuotaResp.

        生产者速率

        :return: The producer_byte_rate of this KafkaTopicQuotaResp.
        :rtype: int
        """
    ...
    def producer_byte_rate(self, producer_byte_rate):
        r"""Sets the producer_byte_rate of this KafkaTopicQuotaResp.

        生产者速率

        :param producer_byte_rate: The producer_byte_rate of this KafkaTopicQuotaResp.
        :type producer_byte_rate: int
        """
    ...
    def consumer_byte_rate(self):
        r"""Gets the consumer_byte_rate of this KafkaTopicQuotaResp.

        消费者速率

        :return: The consumer_byte_rate of this KafkaTopicQuotaResp.
        :rtype: int
        """
    ...
    def consumer_byte_rate(self, consumer_byte_rate):
        r"""Sets the consumer_byte_rate of this KafkaTopicQuotaResp.

        消费者速率

        :param consumer_byte_rate: The consumer_byte_rate of this KafkaTopicQuotaResp.
        :type consumer_byte_rate: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KafkaTopicQuotaResp):
            return False
