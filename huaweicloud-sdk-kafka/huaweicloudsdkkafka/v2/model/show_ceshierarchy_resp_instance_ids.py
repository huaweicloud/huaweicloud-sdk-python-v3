...
class ShowCeshierarchyRespInstanceIds:
    ...
    @property
    def name(self):
        """Gets the name of this ShowCeshierarchyRespInstanceIds.
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ShowCeshierarchyRespInstanceIds.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowCeshierarchyRespInstanceIds):
            return False
