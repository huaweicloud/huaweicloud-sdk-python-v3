...
class ShowInstanceConfigsResponse(SdkResponse):
    ...
    openapi_types = {
        'kafka_configs': 'list[InstanceConfig]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowInstanceConfigsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowInstanceConfigsResponse):
            return False
