...
class ShowCoordinatorsResponse(SdkResponse):
    ...
    openapi_types = {
        'coordinators': 'list[ShowCoordinatorsRespCoordinators]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowCoordinatorsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowCoordinatorsResponse):
            return False
