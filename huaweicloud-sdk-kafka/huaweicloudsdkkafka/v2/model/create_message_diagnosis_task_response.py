...
class CreateMessageDiagnosisTaskResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateMessageDiagnosisTaskResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateMessageDiagnosisTaskResponse):
            return False
