...
class CreatePartitionReq:
    ...
    def __init__(self, partition=None):
        r"""CreatePartitionReq

        The model defined in huaweicloud sdk

        :param partition: 期望调整分区后的数量，必须大于当前分区数量，小于等于 200。
        :type partition: int
        """
    ...
    @property
    def partition(self):
        r"""Gets the partition of this CreatePartitionReq.
    ...
    def partition(self, partition):
        r"""Sets the partition of this CreatePartitionReq.
