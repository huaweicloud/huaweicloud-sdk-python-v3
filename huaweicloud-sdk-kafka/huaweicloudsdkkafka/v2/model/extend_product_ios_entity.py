...
class ExtendProductIosEntity:
    ...
    @property
    def io_spec(self):
        """Gets the io_spec of this ExtendProductIosEntity.
    ...
    def io_spec(self, io_spec):
        """Sets the io_spec of this ExtendProductIosEntity.
    ...
    def available_zones(self):
        """Gets the available_zones of this ExtendProductIosEntity.

        有可用资源的可用区列表。

        :return: The available_zones of this ExtendProductIosEntity.
        :rtype: list[str]
        """
    ...
    def available_zones(self, available_zones):
        """Sets the available_zones of this ExtendProductIosEntity.

        有可用资源的可用区列表。

        :param available_zones: The available_zones of this ExtendProductIosEntity.
        :type available_zones: list[str]
        """
    ...
    @property
    def type(self):
        """Gets the type of this ExtendProductIosEntity.
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this ExtendProductIosEntity.
    ...
    def unavailable_zones(self):
        """Gets the unavailable_zones of this ExtendProductIosEntity.

        资源售罄的可用区列表。

        :return: The unavailable_zones of this ExtendProductIosEntity.
        :rtype: list[str]
        """
    ...
    def unavailable_zones(self, unavailable_zones):
        """Sets the unavailable_zones of this ExtendProductIosEntity.

        资源售罄的可用区列表。

        :param unavailable_zones: The unavailable_zones of this ExtendProductIosEntity.
        :type unavailable_zones: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExtendProductIosEntity):
            return False
