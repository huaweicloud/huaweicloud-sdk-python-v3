...
class ShowInstanceResp:
    ...
    def public_cross_vpc_info(self):
        r"""Gets the public_cross_vpc_info of this ShowInstanceResp.

        **参数解释**： 公网跨VPC访问信息。 **取值范围**： 不涉及。

        :return: The public_cross_vpc_info of this ShowInstanceResp.
        :rtype: str
        """
    ...
    def public_cross_vpc_info(self, public_cross_vpc_info):
        r"""Sets the public_cross_vpc_info of this ShowInstanceResp.

        **参数解释**： 公网跨VPC访问信息。 **取值范围**： 不涉及。

        :param public_cross_vpc_info: The public_cross_vpc_info of this ShowInstanceResp.
        :type public_cross_vpc_info: str
        """
