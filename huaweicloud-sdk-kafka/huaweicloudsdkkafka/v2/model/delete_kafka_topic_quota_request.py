...
class DeleteKafkaTopicQuotaRequest:
    ...
    def __init__(self, instance_id=None, body=None):
        r"""DeleteKafkaTopicQuotaRequest
    ...
    @property
    def body(self):
        r"""Gets the body of this DeleteKafkaTopicQuotaRequest.

        :return: The body of this DeleteKafkaTopicQuotaRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this DeleteKafkaTopicQuotaRequest.

        :param body: The body of this DeleteKafkaTopicQuotaRequest.
        :type body: :class:`huaweicloudsdkkafka.v2.KafkaTopicQuota`
        """
        self._body = body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteKafkaTopicQuotaRequest):
            return False
