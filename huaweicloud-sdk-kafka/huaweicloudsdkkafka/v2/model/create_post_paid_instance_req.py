...
class CreatePostPaidInstanceReq:
    ...
    def __init__(self, name=None, description=None, engine=None, engine_version=None, specification=None, broker_num=None, storage_space=None, partition_num=None, access_user=None, password=None, vpc_id=None, security_group_id=None, subnet_id=None, available_zones=None, product_id=None, maintain_begin=None, maintain_end=None, enable_publicip=None, public_bandwidth=None, publicip_id=None, ssl_enable=None, kafka_security_protocol=None, sasl_enabled_mechanisms=None, port_protocol=None, retention_policy=None, disk_encrypted_enable=None, disk_encrypted_key=None, connector_enable=None, enable_auto_topic=None, storage_spec_code=None, enterprise_project_id=None, tags=None):
        ...
        :type engine: str
        :param engine_version: 消息引擎的版本。取值填写为：   [- 1.1.0](tag:hws,hws_hk,ocb,hws_ocb,ctc,g42,hk_g42,tm,hk_tm,sbc,hk_sbc,cmcc,ax,srg)   [- 2.3.0](tag:g42,tm,hk_g42,ctc,hk_tm,dt,cmcc,ocb,hws_ocb)   - 2.7   [- 3.x](tag:hws,hws_hk,dt,sbc,hk_sbc,hcs,fcs,ctc,tm,hk_tm,hws_eu,ax,cmcc,srg)
        ...
        :param connector_enable: 是否开启消息转储功能。[华为云Stack不支持此参数。](tag:hcs) 默认不开启消息转储。
    ...
    def port_protocol(self):
        r"""Gets the port_protocol of this CreatePostPaidInstanceReq.

        :return: The port_protocol of this CreatePostPaidInstanceReq.
    ...
    def port_protocol(self, port_protocol):
        r"""Sets the port_protocol of this CreatePostPaidInstanceReq.

        :param port_protocol: The port_protocol of this CreatePostPaidInstanceReq.
        :type port_protocol: :class:`huaweicloudsdkkafka.v2.PortProtocol`
        """
