...
class KafkaClient(Client):
    ...
    def create_shrinkage_job(self, request):
        """实例缩容
    ...
    def create_shrinkage_job_invoker(self, request):
        http_info = self._create_shrinkage_job_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_shrinkage_job_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def show_shrink_check_result(self, request):
        """实例缩容前置检查
    ...
    def show_shrink_check_result_invoker(self, request):
        http_info = self._show_shrink_check_result_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_shrink_check_result_http_info(cls, request):
        http_info = {
            "method": "POST",
