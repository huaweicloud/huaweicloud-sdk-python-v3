...
class KafkaClient(Client):
    ...
    def show_kafka_log_task(self, request):
        r"""查询日志任务
    ...
    def show_kafka_log_task_invoker(self, request):
        http_info = self._show_kafka_log_task_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_kafka_log_task_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def start_kafka_log_task(self, request):
        r"""开启日志任务
    ...
    def start_kafka_log_task_invoker(self, request):
        http_info = self._start_kafka_log_task_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _start_kafka_log_task_http_info(cls, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v2/{project_id}/kafka/instances/{instance_id}/logs/{log_type}",
            "request_type": request.__class__.__name__,
    ...
    def stop_kafka_log_task(self, request):
        r"""停止日志任务
    ...
    def stop_kafka_log_task_invoker(self, request):
        http_info = self._stop_kafka_log_task_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _stop_kafka_log_task_http_info(cls, request):
        http_info = {
            "method": "DELETE",
            "resource_path": "/v2/{project_id}/kafka/instances/{instance_id}/logs/{log_type}",
            "request_type": request.__class__.__name__,
