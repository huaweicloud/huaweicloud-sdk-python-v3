...
class OmsClient(Client):
    ...
    def check_url_source_list_file_format(self, request):
        r"""检查url来源列表文件格式
    ...
    def check_url_source_list_file_format_invoker(self, request):
        http_info = self._check_url_source_list_file_format_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _check_url_source_list_file_format_http_info(cls, request):
        http_info = {
            "method": "POST",
