...
class TaskGroupResp:
    ...
    @property
    def obs_system(self):
        r"""Gets the obs_system of this TaskGroupResp.

        OBS系统类型 BUCKET：一般桶 PFS：并行文件系统

        :return: The obs_system of this TaskGroupResp.
        :rtype: str
        """
    ...
    def obs_system(self, obs_system):
        r"""Sets the obs_system of this TaskGroupResp.

        OBS系统类型 BUCKET：一般桶 PFS：并行文件系统

        :param obs_system: The obs_system of this TaskGroupResp.
        :type obs_system: str
        """
