...
class OmsAsyncClient(Client):
    ...
    def update_privacy_agreement_record_async(self, request):
        r"""同意隐私协议
    ...
    def update_privacy_agreement_record_async_invoker(self, request):
        http_info = self._update_privacy_agreement_record_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_privacy_agreement_record_http_info(self, request):
        http_info = {
            "method": "POST",
