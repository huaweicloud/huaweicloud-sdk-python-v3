...
class EcsAsyncClient(Client):
    ...
    def batch_add_server_group_member_async(self, request):
        r"""云服务器组批量添加成员
    ...
    def _batch_add_server_group_member_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def batch_delete_server_group_member_async(self, request):
        r"""云服务器组批量删除成员
    ...
    def _batch_delete_server_group_member_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def batch_detach_volumes_async(self, request):
        r"""批量卸载卷
    ...
    def batch_detach_volumes_async_invoker(self, request):
        http_info = self._batch_detach_volumes_http_info(request)
        return AsyncInvoker(self, http_info)

    def _batch_detach_volumes_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def batch_resize_servers_async(self, request):
        r"""批量变更云服务器规格
    ...
    def batch_resize_servers_async_invoker(self, request):
        http_info = self._batch_resize_servers_http_info(request)
        return AsyncInvoker(self, http_info)

    def _batch_resize_servers_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def delete_launch_templates_async(self, request):
        r"""删除模板
    ...
    def delete_launch_templates_async_invoker(self, request):
        http_info = self._delete_launch_templates_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_launch_templates_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def execute_server_dump_async(self, request):
        r"""触发云服务器内核dump
    ...
    def execute_server_dump_async_invoker(self, request):
        http_info = self._execute_server_dump_http_info(request)
        return AsyncInvoker(self, http_info)

    def _execute_server_dump_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def execute_server_redeploy_async(self, request):
        r"""重部署云服务器
    ...
    def execute_server_redeploy_async_invoker(self, request):
        http_info = self._execute_server_redeploy_http_info(request)
        return AsyncInvoker(self, http_info)

    def _execute_server_redeploy_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def list_launch_template_versions_async(self, request):
        r"""查询模板版本列表
    ...
    def list_launch_template_versions_async_invoker(self, request):
        http_info = self._list_launch_template_versions_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_launch_template_versions_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_server_az_info_async_invoker(self, request):
        http_info = self._list_server_az_info_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_server_az_info_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_server_volume_attachments_async(self, request):
        r"""查询弹性云服务器挂载磁盘列表信息
    ...
    def list_server_volume_attachments_async_invoker(self, request):
        http_info = self._list_server_volume_attachments_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_server_volume_attachments_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def nova_list_availability_zones_async(self, request):
        ...
        """
        warnings.warn("Method 'nova_list_availability_zones_async' of EcsAsyncClient is deprecated and will be removed in the future versions", DeprecationWarning)
    ...
    def nova_list_availability_zones_async_invoker(self, request):
        warnings.warn("Method 'nova_list_availability_zones_async_invoker' of EcsAsyncClient is deprecated and will be removed in the future versions", DeprecationWarning)
        http_info = self._nova_list_availability_zones_http_info(request)
        return AsyncInvoker(self, http_info)
    ...
    def nova_list_servers_async(self, request):
        r"""查询云服务器列表
    ...
    def _nova_list_servers_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v2.1/{project_id}/servers",
            "request_type": request.__class__.__name__,
    ...
    def nova_show_server_interface_async(self, request):
        r"""查询指定云服务器网卡信息
    ...
    def _nova_show_server_interface_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_appendable_volume_quota_async(self, request):
        r"""查询包周期虚拟机可以追加卷数量
    ...
    def show_appendable_volume_quota_async_invoker(self, request):
        http_info = self._show_appendable_volume_quota_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_appendable_volume_quota_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_flavor_capacity_async_invoker(self, request):
        http_info = self._show_flavor_capacity_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_flavor_capacity_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_serial_console_actions_async(self, request):
        r"""获取串口登录地址
    ...
    def show_serial_console_actions_async_invoker(self, request):
        http_info = self._show_serial_console_actions_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_serial_console_actions_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def show_server_attachable_nic_num_async(self, request):
        r"""查询虚拟机可挂载网卡
    ...
    def show_server_attachable_nic_num_async_invoker(self, request):
        http_info = self._show_server_attachable_nic_num_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_server_attachable_nic_num_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def update_serial_console_options_async(self, request):
        r"""设置云服务器云主机串口登录
    ...
    def update_serial_console_options_async_invoker(self, request):
        http_info = self._update_serial_console_options_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_serial_console_options_http_info(self, request):
        http_info = {
            "method": "PUT",
    ...
    def update_server_interface_async(self, request):
        r"""更新云服务器网卡挂载信息
    ...
    def update_server_interface_async_invoker(self, request):
        http_info = self._update_server_interface_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_server_interface_http_info(self, request):
        http_info = {
            "method": "PUT",
