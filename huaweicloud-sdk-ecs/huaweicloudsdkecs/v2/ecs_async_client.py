...
class EcsAsyncClient(Client):
    ...
    def list_server_az_info_async(self, request):
        ...
        """
        warnings.warn("Method 'list_server_az_info_async' of EcsAsyncClient is deprecated and will be removed in the future versions", DeprecationWarning)
        http_info = self._list_server_az_info_http_info(request)
        return self._call_api(**http_info)

    def list_server_az_info_async_invoker(self, request):
        warnings.warn("Method 'list_server_az_info_async_invoker' of EcsAsyncClient is deprecated and will be removed in the future versions", DeprecationWarning)
        http_info = self._list_server_az_info_http_info(request)
        return AsyncInvoker(self, http_info)
