...
class ChangeServerOsWithoutCloudInitRequest(object):
    ...
    def __init__(self, server_id=None, body=None):  # noqa: E501
        """ChangeServerOsWithoutCloudInitRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: ChangeServerOsWithoutCloudInitRequestBody
        """
        return self._body
