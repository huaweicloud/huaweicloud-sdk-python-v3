...
class ChangeServerChargeModeRequest:
    ...
    openapi_types = {
        'body': 'ChangeServerChargeModeRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ChangeServerChargeModeRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChangeServerChargeModeRequest):
            return False
