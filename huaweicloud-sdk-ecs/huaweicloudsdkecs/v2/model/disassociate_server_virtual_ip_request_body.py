...
class DisassociateServerVirtualIpRequestBody(object):
    ...
    def __init__(self, nic=None):  # noqa: E501
        """DisassociateServerVirtualIpRequestBody - a model defined in huaweicloud sdk"""
    ...
    def nic(self):
        ...
        :rtype: DisassociateServerVirtualIpOption
        """
        return self._nic
