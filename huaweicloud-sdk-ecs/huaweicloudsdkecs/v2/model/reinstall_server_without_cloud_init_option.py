...
class ReinstallServerWithoutCloudInitOption:
    ...
    def __init__(self, adminpass=None, keyname=None, userid=None, mode=None, metadata=None):
        r"""ReinstallServerWithoutCloudInitOption
    ...
    @property
    def adminpass(self):
        r"""Gets the adminpass of this ReinstallServerWithoutCloudInitOption.
    ...
    def adminpass(self, adminpass):
        r"""Sets the adminpass of this ReinstallServerWithoutCloudInitOption.
    ...
    @property
    def keyname(self):
        r"""Gets the keyname of this ReinstallServerWithoutCloudInitOption.
    ...
    def keyname(self, keyname):
        r"""Sets the keyname of this ReinstallServerWithoutCloudInitOption.
    ...
    @property
    def userid(self):
        r"""Gets the userid of this ReinstallServerWithoutCloudInitOption.
    ...
    def userid(self, userid):
        r"""Sets the userid of this ReinstallServerWithoutCloudInitOption.
    ...
    @property
    def mode(self):
        r"""Gets the mode of this ReinstallServerWithoutCloudInitOption.
    ...
    @mode.setter
    def mode(self, mode):
        r"""Sets the mode of this ReinstallServerWithoutCloudInitOption.
    ...
    @property
    def metadata(self):
        r"""Gets the metadata of this ReinstallServerWithoutCloudInitOption.
    ...
    def metadata(self, metadata):
        r"""Sets the metadata of this ReinstallServerWithoutCloudInitOption.
