...
class MigrateServerResponse(SdkResponse):
    ...
    @property
    def job_id(self):
        r"""Gets the job_id of this MigrateServerResponse.
    ...
    def job_id(self, job_id):
        r"""Sets the job_id of this MigrateServerResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("MigrateServerResponse.to_dict() is deprecated and no longer maintained, "
