...
class CreatePostPaidServersRequestBody:
    ...
    def __init__(self, dry_run=None, server=None):
        r"""CreatePostPaidServersRequestBody
    ...
    @property
    def dry_run(self):
        r"""Gets the dry_run of this CreatePostPaidServersRequestBody.
    ...
    def dry_run(self, dry_run):
        r"""Sets the dry_run of this CreatePostPaidServersRequestBody.
    ...
    @property
    def server(self):
        r"""Gets the server of this CreatePostPaidServersRequestBody.
    ...
    def server(self, server):
        r"""Sets the server of this CreatePostPaidServersRequestBody.
