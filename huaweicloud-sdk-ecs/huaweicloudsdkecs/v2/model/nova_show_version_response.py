...
class NovaShowVersionResponse(object):
    ...
    def __init__(self, version=None):  # noqa: E501
        """NovaShowVersionResponse - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NovaShowVersionResponse):
            return False
