...
class PrePaidServer:
    ...
    def auto_terminate_time(self):
        r"""Gets the auto_terminate_time of this PrePaidServer.
    ...
    def auto_terminate_time(self, auto_terminate_time):
        r"""Sets the auto_terminate_time of this PrePaidServer.
    ...
    @property
    def image_ref(self):
        r"""Gets the image_ref of this PrePaidServer.
    ...
    def image_ref(self, image_ref):
        r"""Sets the image_ref of this PrePaidServer.
    ...
    @property
    def flavor_ref(self):
        r"""Gets the flavor_ref of this PrePaidServer.
    ...
    def flavor_ref(self, flavor_ref):
        r"""Sets the flavor_ref of this PrePaidServer.
    ...
    @property
    def name(self):
        r"""Gets the name of this PrePaidServer.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this PrePaidServer.
    ...
    @property
    def user_data(self):
        r"""Gets the user_data of this PrePaidServer.
    ...
    def user_data(self, user_data):
        r"""Sets the user_data of this PrePaidServer.
    ...
    @property
    def admin_pass(self):
        r"""Gets the admin_pass of this PrePaidServer.
    ...
    def admin_pass(self, admin_pass):
        r"""Sets the admin_pass of this PrePaidServer.
    ...
    @property
    def key_name(self):
        r"""Gets the key_name of this PrePaidServer.
    ...
    def key_name(self, key_name):
        r"""Sets the key_name of this PrePaidServer.
    ...
    @property
    def vpcid(self):
        r"""Gets the vpcid of this PrePaidServer.
    ...
    def vpcid(self, vpcid):
        r"""Sets the vpcid of this PrePaidServer.
    ...
    @property
    def nics(self):
        r"""Gets the nics of this PrePaidServer.
    ...
    @nics.setter
    def nics(self, nics):
        r"""Sets the nics of this PrePaidServer.
    ...
    @property
    def publicip(self):
        r"""Gets the publicip of this PrePaidServer.
    ...
    def publicip(self, publicip):
        r"""Sets the publicip of this PrePaidServer.
    ...
    def is_auto_rename(self):
        r"""Gets the is_auto_rename of this PrePaidServer.
    ...
    def is_auto_rename(self, is_auto_rename):
        r"""Sets the is_auto_rename of this PrePaidServer.
    ...
    def root_volume(self):
        r"""Gets the root_volume of this PrePaidServer.
    ...
    def root_volume(self, root_volume):
        r"""Sets the root_volume of this PrePaidServer.
    ...
    def data_volumes(self):
        r"""Gets the data_volumes of this PrePaidServer.
    ...
    def data_volumes(self, data_volumes):
        r"""Sets the data_volumes of this PrePaidServer.
    ...
    def security_groups(self):
        r"""Gets the security_groups of this PrePaidServer.
    ...
    def security_groups(self, security_groups):
        r"""Sets the security_groups of this PrePaidServer.
    ...
    def availability_zone(self):
        r"""Gets the availability_zone of this PrePaidServer.
    ...
    def availability_zone(self, availability_zone):
        r"""Sets the availability_zone of this PrePaidServer.
    ...
    def batch_create_in_multi_az(self):
        r"""Gets the batch_create_in_multi_az of this PrePaidServer.
    ...
    def batch_create_in_multi_az(self, batch_create_in_multi_az):
        r"""Sets the batch_create_in_multi_az of this PrePaidServer.
    ...
    def extendparam(self):
        r"""Gets the extendparam of this PrePaidServer.
    ...
    def extendparam(self, extendparam):
        r"""Sets the extendparam of this PrePaidServer.
    ...
    @property
    def metadata(self):
        r"""Gets the metadata of this PrePaidServer.
    ...
    def metadata(self, metadata):
        r"""Sets the metadata of this PrePaidServer.
    ...
    def osscheduler_hints(self):
        r"""Gets the osscheduler_hints of this PrePaidServer.
    ...
    def osscheduler_hints(self, osscheduler_hints):
        r"""Sets the osscheduler_hints of this PrePaidServer.
    ...
    @property
    def tags(self):
        r"""Gets the tags of this PrePaidServer.
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this PrePaidServer.
    ...
    def server_tags(self):
        r"""Gets the server_tags of this PrePaidServer.
    ...
    def server_tags(self, server_tags):
        r"""Sets the server_tags of this PrePaidServer.
    ...
    def description(self):
        r"""Gets the description of this PrePaidServer.
    ...
    def description(self, description):
        r"""Sets the description of this PrePaidServer.
    ...
    def cpu_options(self):
        r"""Gets the cpu_options of this PrePaidServer.
    ...
    def cpu_options(self, cpu_options):
        r"""Sets the cpu_options of this PrePaidServer.
    ...
    def security_options(self):
        r"""Gets the security_options of this PrePaidServer.

        :return: The security_options of this PrePaidServer.
    ...
    def security_options(self, security_options):
        r"""Sets the security_options of this PrePaidServer.

        :param security_options: The security_options of this PrePaidServer.
        :type security_options: :class:`huaweicloudsdkecs.v2.SecurityOptions`
        """
    ...
    def metadata_options(self):
        r"""Gets the metadata_options of this PrePaidServer.

        :return: The metadata_options of this PrePaidServer.
    ...
    def metadata_options(self, metadata_options):
        r"""Sets the metadata_options of this PrePaidServer.

        :param metadata_options: The metadata_options of this PrePaidServer.
        :type metadata_options: :class:`huaweicloudsdkecs.v2.UpdateServerMetadataOptionsRequestBody`
        """
    ...
    def enclave_options(self):
        r"""Gets the enclave_options of this PrePaidServer.

        :return: The enclave_options of this PrePaidServer.
    ...
    def enclave_options(self, enclave_options):
        r"""Sets the enclave_options of this PrePaidServer.

        :param enclave_options: The enclave_options of this PrePaidServer.
        :type enclave_options: :class:`huaweicloudsdkecs.v2.EnclaveOptions`
        """
