...
class ReinstallServerWithoutCloudInitRequest(object):
    ...
    def __init__(self, server_id=None, body=None):  # noqa: E501
        """ReinstallServerWithoutCloudInitRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: ReinstallServerWithoutCloudInitRequestBody
        """
        return self._body
