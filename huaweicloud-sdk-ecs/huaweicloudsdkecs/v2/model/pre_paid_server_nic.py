...
class PrePaidServerNic:
    ...
    @property
    def port_id(self):
        r"""Gets the port_id of this PrePaidServerNic.
        ...
        :return: The port_id of this PrePaidServerNic.
        :rtype: str
        """
    ...
    def port_id(self, port_id):
        r"""Sets the port_id of this PrePaidServerNic.

        网卡ID，UUID格式。 当该字段不为空时，表示挂载指定的网卡。port_id和subnet_id不能同时为空。 网卡ID可以从虚拟私有云的“查询端口列表”章节查询到。 约束： 网卡状态必须为DOWN。 网卡的vpcid必须和传入的vpcid一致。 当port_id和subnet_id同时存在的时候，优先使用port_id。当选择port_id不为空时，代表此时使用的是弹性网卡，此时security_groups和ip_address等参数不生效。

        :param port_id: The port_id of this PrePaidServerNic.
        :type port_id: str
        """
