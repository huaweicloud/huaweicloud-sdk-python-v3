...
class NovaDisassociateSecurityGroupRequest(object):
    ...
    def __init__(self, server_id=None, body=None):  # noqa: E501
        """NovaDisassociateSecurityGroupRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: NovaDisassociateSecurityGroupRequestBody
        """
        return self._body
