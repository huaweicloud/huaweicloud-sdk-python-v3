...
class PostPaidServer:
    ...
    def __init__(self, auto_terminate_time=None, admin_pass=None, availability_zone=None, batch_create_in_multi_az=None, count=None, data_volumes=None, extendparam=None, flavor_ref=None, image_ref=None, is_auto_rename=None, key_name=None, metadata=None, name=None, nics=None, osscheduler_hints=None, publicip=None, root_volume=None, security_groups=None, server_tags=None, tags=None, user_data=None, vpcid=None, description=None, cpu_options=None, security_options=None, serial_console_options=None, metadata_options=None, enclave_options=None):
        ...
        :param key_name: 如果需要使用SSH密钥方式登录云服务器，请指定已创建密钥的名称。  密钥可以通过密钥创建接口进行创建（请参见[创建和导入SSH密钥](https://support.huaweicloud.com/api-dew/CreateKeypair.html)），或使用SSH密钥查询接口查询已有的密钥（请参见[查询SSH密钥列表](https://support.huaweicloud.com/api-dew/ListKeypairs.html)）。
        :type key_name: str
    ...
    def auto_terminate_time(self):
        r"""Gets the auto_terminate_time of this PostPaidServer.
    ...
    def auto_terminate_time(self, auto_terminate_time):
        r"""Sets the auto_terminate_time of this PostPaidServer.
    ...
    @property
    def admin_pass(self):
        r"""Gets the admin_pass of this PostPaidServer.
    ...
    def admin_pass(self, admin_pass):
        r"""Sets the admin_pass of this PostPaidServer.
    ...
    def availability_zone(self):
        r"""Gets the availability_zone of this PostPaidServer.
    ...
    def availability_zone(self, availability_zone):
        r"""Sets the availability_zone of this PostPaidServer.
    ...
    def batch_create_in_multi_az(self):
        r"""Gets the batch_create_in_multi_az of this PostPaidServer.
    ...
    def batch_create_in_multi_az(self, batch_create_in_multi_az):
        r"""Sets the batch_create_in_multi_az of this PostPaidServer.
    ...
    def data_volumes(self):
        r"""Gets the data_volumes of this PostPaidServer.
    ...
    def data_volumes(self, data_volumes):
        r"""Sets the data_volumes of this PostPaidServer.
    ...
    def extendparam(self):
        r"""Gets the extendparam of this PostPaidServer.
    ...
    def extendparam(self, extendparam):
        r"""Sets the extendparam of this PostPaidServer.
    ...
    @property
    def flavor_ref(self):
        r"""Gets the flavor_ref of this PostPaidServer.
    ...
    def flavor_ref(self, flavor_ref):
        r"""Sets the flavor_ref of this PostPaidServer.
    ...
    @property
    def image_ref(self):
        r"""Gets the image_ref of this PostPaidServer.
    ...
    def image_ref(self, image_ref):
        r"""Sets the image_ref of this PostPaidServer.
    ...
    def is_auto_rename(self):
        r"""Gets the is_auto_rename of this PostPaidServer.
    ...
    def is_auto_rename(self, is_auto_rename):
        r"""Sets the is_auto_rename of this PostPaidServer.
    ...
    @property
    def key_name(self):
        r"""Gets the key_name of this PostPaidServer.
    ...
    def key_name(self, key_name):
        r"""Sets the key_name of this PostPaidServer.
    ...
    @property
    def metadata(self):
        r"""Gets the metadata of this PostPaidServer.
    ...
    def metadata(self, metadata):
        r"""Sets the metadata of this PostPaidServer.
    ...
    @property
    def name(self):
        r"""Gets the name of this PostPaidServer.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this PostPaidServer.
    ...
    @property
    def nics(self):
        r"""Gets the nics of this PostPaidServer.
    ...
    @nics.setter
    def nics(self, nics):
        r"""Sets the nics of this PostPaidServer.
    ...
    def osscheduler_hints(self):
        r"""Gets the osscheduler_hints of this PostPaidServer.
    ...
    def osscheduler_hints(self, osscheduler_hints):
        r"""Sets the osscheduler_hints of this PostPaidServer.
    ...
    @property
    def publicip(self):
        r"""Gets the publicip of this PostPaidServer.
    ...
    def publicip(self, publicip):
        r"""Sets the publicip of this PostPaidServer.
    ...
    def root_volume(self):
        r"""Gets the root_volume of this PostPaidServer.
    ...
    def root_volume(self, root_volume):
        r"""Sets the root_volume of this PostPaidServer.
    ...
    def security_groups(self):
        r"""Gets the security_groups of this PostPaidServer.
    ...
    def security_groups(self, security_groups):
        r"""Sets the security_groups of this PostPaidServer.
    ...
    def server_tags(self):
        r"""Gets the server_tags of this PostPaidServer.
    ...
    def server_tags(self, server_tags):
        r"""Sets the server_tags of this PostPaidServer.
    ...
    @property
    def tags(self):
        r"""Gets the tags of this PostPaidServer.
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this PostPaidServer.
    ...
    @property
    def user_data(self):
        r"""Gets the user_data of this PostPaidServer.
    ...
    def user_data(self, user_data):
        r"""Sets the user_data of this PostPaidServer.
    ...
    @property
    def vpcid(self):
        r"""Gets the vpcid of this PostPaidServer.
    ...
    def vpcid(self, vpcid):
        r"""Sets the vpcid of this PostPaidServer.
    ...
    def description(self):
        r"""Gets the description of this PostPaidServer.
    ...
    def description(self, description):
        r"""Sets the description of this PostPaidServer.
    ...
    def cpu_options(self):
        r"""Gets the cpu_options of this PostPaidServer.
    ...
    def cpu_options(self, cpu_options):
        r"""Sets the cpu_options of this PostPaidServer.
    ...
    def security_options(self):
        r"""Gets the security_options of this PostPaidServer.

        :return: The security_options of this PostPaidServer.
    ...
    def security_options(self, security_options):
        r"""Sets the security_options of this PostPaidServer.

        :param security_options: The security_options of this PostPaidServer.
        :type security_options: :class:`huaweicloudsdkecs.v2.SecurityOptions`
        """
    ...
    def metadata_options(self):
        r"""Gets the metadata_options of this PostPaidServer.

        :return: The metadata_options of this PostPaidServer.
        :rtype: :class:`huaweicloudsdkecs.v2.UpdateServerMetadataOptionsRequestBody`
        """
        return self._metadata_options

    @metadata_options.setter
    def metadata_options(self, metadata_options):
        r"""Sets the metadata_options of this PostPaidServer.

        :param metadata_options: The metadata_options of this PostPaidServer.
        :type metadata_options: :class:`huaweicloudsdkecs.v2.UpdateServerMetadataOptionsRequestBody`
        """
