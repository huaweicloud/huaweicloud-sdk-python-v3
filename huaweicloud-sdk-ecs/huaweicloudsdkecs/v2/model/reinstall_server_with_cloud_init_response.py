...
class ReinstallServerWithCloudInitResponse(SdkResponse):
    ...
    def __init__(self, job_id=None):
        r"""ReinstallServerWithCloudInitResponse
    ...
    @property
    def job_id(self):
        r"""Gets the job_id of this ReinstallServerWithCloudInitResponse.
    ...
    def job_id(self, job_id):
        r"""Sets the job_id of this ReinstallServerWithCloudInitResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ReinstallServerWithCloudInitResponse.to_dict() is deprecated and no longer maintained, "
