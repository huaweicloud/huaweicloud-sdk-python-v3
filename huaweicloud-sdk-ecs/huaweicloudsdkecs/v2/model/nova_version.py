...
class NovaVersion(object):
    ...
    def __init__(self, id=None, links=None, min_version=None, status=None, version=None, updated=None):  # noqa: E501
        """NovaVersion - a model defined in huaweicloud sdk"""
