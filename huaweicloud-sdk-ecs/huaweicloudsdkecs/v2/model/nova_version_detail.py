...
class NovaVersionDetail(object):
    ...
    def __init__(self, id=None, links=None, media_types=None, min_version=None, status=None, updated=None, version=None):  # noqa: E501
        """NovaVersionDetail - a model defined in huaweicloud sdk"""
    ...
    def links(self):
        ...
        链接到资源的问题。有关更多信息，请参见http://developer.openstack.org/api-guide/compute/links_and_references.html
    ...
    def media_types(self):
        ...
        :rtype: list[NovaVersionMediaType]
        """
    ...
    def media_types(self, media_types):
        ...
        :type: list[NovaVersionMediaType]
        """
