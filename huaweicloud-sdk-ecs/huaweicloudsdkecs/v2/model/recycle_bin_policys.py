...
class RecycleBinPolicys:
    ...
    def __init__(self, recycle_threshold_day=None, retention_hour=None):
        r"""RecycleBinPolicys
    ...
    def recycle_threshold_day(self):
        r"""Gets the recycle_threshold_day of this RecycleBinPolicys.

        创建多久的虚拟机可以进入回收站

        :return: The recycle_threshold_day of this RecycleBinPolicys.
        :rtype: int
        """
    ...
    def recycle_threshold_day(self, recycle_threshold_day):
        r"""Sets the recycle_threshold_day of this RecycleBinPolicys.

        创建多久的虚拟机可以进入回收站

        :param recycle_threshold_day: The recycle_threshold_day of this RecycleBinPolicys.
        :type recycle_threshold_day: int
        """
    ...
    def retention_hour(self):
        r"""Gets the retention_hour of this RecycleBinPolicys.

        虚拟机进入回收站后多久删除

        :return: The retention_hour of this RecycleBinPolicys.
        :rtype: int
        """
    ...
    def retention_hour(self, retention_hour):
        r"""Sets the retention_hour of this RecycleBinPolicys.

        虚拟机进入回收站后多久删除

        :param retention_hour: The retention_hour of this RecycleBinPolicys.
        :type retention_hour: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecycleBinPolicys):
            return False
