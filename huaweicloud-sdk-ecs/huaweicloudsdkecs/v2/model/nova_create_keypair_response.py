...
class NovaCreateKeypairResponse(SdkResponse):
    ...
    @property
    def keypair(self):
        r"""Gets the keypair of this NovaCreateKeypairResponse.
    ...
    def keypair(self, keypair):
        r"""Sets the keypair of this NovaCreateKeypairResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("NovaCreateKeypairResponse.to_dict() is deprecated and no longer maintained, "
