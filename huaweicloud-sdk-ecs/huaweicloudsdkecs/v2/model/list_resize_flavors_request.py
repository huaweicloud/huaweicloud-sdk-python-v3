...
class ListResizeFlavorsRequest(object):
    ...
    def __init__(self, instance_uuid=None, source_flavor_id=None, source_flavor_name=None, sort_key='flavorid', sort_dir='asc', marker=None):  # noqa: E501
