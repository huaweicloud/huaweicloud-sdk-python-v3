...
class ShowServerTagsResponse(SdkResponse):
    ...
    @property
    def tags(self):
        r"""Gets the tags of this ShowServerTagsResponse.
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this ShowServerTagsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowServerTagsResponse.to_dict() is deprecated and no longer maintained, "
