...
class PrePaidServerRootVolumeMetadata:
    ...
    def __init__(self, system__encrypted=None, system__cmkid=None):
        r"""PrePaidServerRootVolumeMetadata
    ...
    def system__encrypted(self):
        r"""Gets the system__encrypted of this PrePaidServerRootVolumeMetadata.

        metadata中的表示加密功能的字段，0代表不加密，1代表加密。  该字段不存在时，云硬盘默认为不加密。

        :return: The system__encrypted of this PrePaidServerRootVolumeMetadata.
        :rtype: str
        """
    ...
    def system__encrypted(self, system__encrypted):
        r"""Sets the system__encrypted of this PrePaidServerRootVolumeMetadata.

        metadata中的表示加密功能的字段，0代表不加密，1代表加密。  该字段不存在时，云硬盘默认为不加密。

        :param system__encrypted: The system__encrypted of this PrePaidServerRootVolumeMetadata.
        :type system__encrypted: str
        """
    ...
    def system__cmkid(self):
        r"""Gets the system__cmkid of this PrePaidServerRootVolumeMetadata.
        ...
        :return: The system__cmkid of this PrePaidServerRootVolumeMetadata.
        :rtype: str
        """
    ...
    def system__cmkid(self, system__cmkid):
        r"""Sets the system__cmkid of this PrePaidServerRootVolumeMetadata.

        metadata中的加密cmkid字段，与__system__encrypted配合表示需要加密，cmkid长度固定为36个字节。  > 说明：  - 请参考[查询密钥列表](https://support.huaweicloud.com/api-dew/ListKeys.html)，通过HTTPS请求获取密钥ID。

        :param system__cmkid: The system__cmkid of this PrePaidServerRootVolumeMetadata.
        :type system__cmkid: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PrePaidServerRootVolumeMetadata):
            return False
