...
class RegisterServerMonitorRequestBody(object):
    ...
    def __init__(self, monitor_metrics=None):  # noqa: E501
        """RegisterServerMonitorRequestBody - a model defined in huaweicloud sdk"""
