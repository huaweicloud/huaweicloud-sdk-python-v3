...
class PostPaidServerEipBandwidth:
    ...
    @property
    def size(self):
        r"""Gets the size of this PostPaidServerEipBandwidth.
    ...
    @size.setter
    def size(self, size):
        r"""Sets the size of this PostPaidServerEipBandwidth.
    ...
    @property
    def sharetype(self):
        r"""Gets the sharetype of this PostPaidServerEipBandwidth.
    ...
    def sharetype(self, sharetype):
        r"""Sets the sharetype of this PostPaidServerEipBandwidth.
    ...
    @property
    def chargemode(self):
        r"""Gets the chargemode of this PostPaidServerEipBandwidth.
    ...
    def chargemode(self, chargemode):
        r"""Sets the chargemode of this PostPaidServerEipBandwidth.
    ...
    @property
    def id(self):
        r"""Gets the id of this PostPaidServerEipBandwidth.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this PostPaidServerEipBandwidth.
