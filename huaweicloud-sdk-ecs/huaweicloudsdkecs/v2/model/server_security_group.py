...
class ServerSecurityGroup:
    ...
    @property
    def name(self):
        r"""Gets the name of this ServerSecurityGroup.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this ServerSecurityGroup.
    ...
    @property
    def id(self):
        r"""Gets the id of this ServerSecurityGroup.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this ServerSecurityGroup.
