...
class DisassociateServerVirtualIpRequest(object):
    ...
    def __init__(self, nic_id=None, body=None):  # noqa: E501
        """DisassociateServerVirtualIpRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: DisassociateServerVirtualIpRequestBody
        """
        return self._body
