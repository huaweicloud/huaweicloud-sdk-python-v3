...
class ReinstallServerWithCloudInitRequest(object):
    ...
    def __init__(self, server_id=None, body=None):  # noqa: E501
        """ReinstallServerWithCloudInitRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: ReinstallServerWithCloudInitRequestBody
        """
        return self._body
