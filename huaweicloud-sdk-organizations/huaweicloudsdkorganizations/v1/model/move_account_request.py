...
class MoveAccountRequest:
    ...
    def x_security_token(self):
        r"""Gets the x_security_token of this MoveAccountRequest.

        如果正在使用临时安全凭据，则此header是必需的，该值是临时安全凭据的安全令牌（会话令牌）。

        :return: The x_security_token of this MoveAccountRequest.
        :rtype: str
        """
    ...
    def x_security_token(self, x_security_token):
        r"""Sets the x_security_token of this MoveAccountRequest.

        如果正在使用临时安全凭据，则此header是必需的，该值是临时安全凭据的安全令牌（会话令牌）。

        :param x_security_token: The x_security_token of this MoveAccountRequest.
        :type x_security_token: str
        """
    ...
    @property
    def account_id(self):
        r"""Gets the account_id of this MoveAccountRequest.
    ...
    def account_id(self, account_id):
        r"""Sets the account_id of this MoveAccountRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this MoveAccountRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this MoveAccountRequest.
