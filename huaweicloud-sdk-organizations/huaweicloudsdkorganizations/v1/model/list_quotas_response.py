...
class ListQuotasResponse(SdkResponse):
    ...
    def __init__(self, quotas=None):
        ...
        :param quotas: 
        :type quotas: :class:`huaweicloudsdkorganizations.v1.QuotasResourcesDto`
        """
    ...
    def quotas(self):
        ...
        :rtype: :class:`huaweicloudsdkorganizations.v1.QuotasResourcesDto`
        """
        return self._quotas
