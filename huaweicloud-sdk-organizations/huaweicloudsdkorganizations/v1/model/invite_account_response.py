...
class InviteAccountResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("InviteAccountResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InviteAccountResponse):
            return False
