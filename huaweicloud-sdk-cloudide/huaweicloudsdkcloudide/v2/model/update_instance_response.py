...
class UpdateInstanceResponse(SdkResponse):
    ...
    @property
    def result(self):
        r"""Gets the result of this UpdateInstanceResponse.

        返回值

        :return: The result of this UpdateInstanceResponse.
        :rtype: bool
        """
        return self._result
    ...
    def result(self, result):
        r"""Sets the result of this UpdateInstanceResponse.

        返回值

        :param result: The result of this UpdateInstanceResponse.
        :type result: bool
        """
        self._result = result
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateInstanceResponse.to_dict() is deprecated and no longer maintained, "
