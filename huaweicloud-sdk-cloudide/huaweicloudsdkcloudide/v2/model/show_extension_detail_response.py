...
class ShowExtensionDetailResponse(SdkResponse):
    ...
    @property
    def results(self):
        r"""Gets the results of this ShowExtensionDetailResponse.
    ...
    def results(self, results):
        r"""Sets the results of this ShowExtensionDetailResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowExtensionDetailResponse.to_dict() is deprecated and no longer maintained, "
