...
class AddExtensionEvaluationReplyRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the AddExtensionEvaluationReplyRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddExtensionEvaluationReplyRequest):
            return False
