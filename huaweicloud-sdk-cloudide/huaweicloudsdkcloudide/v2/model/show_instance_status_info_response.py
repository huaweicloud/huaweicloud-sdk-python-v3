...
class ShowInstanceStatusInfoResponse(SdkResponse):
    ...
    def status(self):
        ...
        :return: The status of this ShowInstanceStatusInfoResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this ShowInstanceStatusInfoResponse.
        :type status: str
        """
        self._status = status
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowInstanceStatusInfoResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowInstanceStatusInfoResponse):
            return False
