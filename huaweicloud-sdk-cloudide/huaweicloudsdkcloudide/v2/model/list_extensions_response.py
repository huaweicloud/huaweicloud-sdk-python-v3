...
class ListExtensionsResponse(SdkResponse):
    ...
    def results(self):
        ...
        :return: The results of this ListExtensionsResponse.
    ...
    def results(self, results):
        ...
        :param results: The results of this ListExtensionsResponse.
        :type results: list[:class:`huaweicloudsdkcloudide.v2.ExtensionQueryResult`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListExtensionsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListExtensionsResponse):
            return False
