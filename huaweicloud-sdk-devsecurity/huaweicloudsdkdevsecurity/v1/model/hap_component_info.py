...
class HapComponentInfo:
    ...
    def __init__(self, permission=None, page=None, service=None, data=None):
        ...
        :type page: list[:class:`huaweicloudsdkdevsecurity.v1.HapComponentItem`]
        :param service: 鸿蒙service列表，仅鸿蒙任务存在该组件
        :type service: list[:class:`huaweicloudsdkdevsecurity.v1.HapComponentItem`]
        :param data: 鸿蒙data息列表，仅鸿蒙任务存在该组件
        :type data: list[:class:`huaweicloudsdkdevsecurity.v1.HapComponentItem`]
        """
    ...
    def page(self):
        ...
        :rtype: list[:class:`huaweicloudsdkdevsecurity.v1.HapComponentItem`]
        """
        return self._page
