...
class CheckerRule:
    ...
    def checker_rule(self):
        """Gets the checker_rule of this CheckerRule.

        检测项

        :return: The checker_rule of this CheckerRule.
        :rtype: str
        """
    ...
    def checker_rule(self, checker_rule):
        """Sets the checker_rule of this CheckerRule.

        检测项

        :param checker_rule: The checker_rule of this CheckerRule.
        :type checker_rule: str
        """
    ...
    def checker_entry(self):
        """Gets the checker_entry of this CheckerRule.

        规范检测项条目

        :return: The checker_entry of this CheckerRule.
        :rtype: str
        """
    ...
    def checker_entry(self, checker_entry):
        """Sets the checker_entry of this CheckerRule.

        规范检测项条目

        :param checker_entry: The checker_entry of this CheckerRule.
        :type checker_entry: str
        """
    ...
    def checker_result(self):
        """Gets the checker_result of this CheckerRule.

        规则检测项结果

        :return: The checker_result of this CheckerRule.
        :rtype: str
        """
    ...
    def checker_result(self, checker_result):
        """Sets the checker_result of this CheckerRule.

        规则检测项结果

        :param checker_result: The checker_result of this CheckerRule.
        :type checker_result: str
        """
    ...
    def checker_stack(self):
        """Gets the checker_stack of this CheckerRule.

        调用栈信息

        :return: The checker_stack of this CheckerRule.
        :rtype: str
        """
    ...
    def checker_stack(self, checker_stack):
        """Sets the checker_stack of this CheckerRule.

        调用栈信息

        :param checker_stack: The checker_stack of this CheckerRule.
        :type checker_stack: str
        """
    ...
    def privacy_policy_evidences(self):
        """Gets the privacy_policy_evidences of this CheckerRule.

        隐私声明

        :return: The privacy_policy_evidences of this CheckerRule.
        :rtype: str
        """
    ...
    def privacy_policy_evidences(self, privacy_policy_evidences):
        """Sets the privacy_policy_evidences of this CheckerRule.

        隐私声明

        :param privacy_policy_evidences: The privacy_policy_evidences of this CheckerRule.
        :type privacy_policy_evidences: str
        """
    ...
    @property
    def _pass(self):
        """Gets the _pass of this CheckerRule.

        是否通过

        :return: The _pass of this CheckerRule.
        :rtype: bool
        """
        return self.__pass
    ...
    def _pass(self, _pass):
        """Sets the _pass of this CheckerRule.

        是否通过

        :param _pass: The _pass of this CheckerRule.
        :type _pass: bool
        """
        self.__pass = _pass
    ...
    def rectify_suggestion(self):
        """Gets the rectify_suggestion of this CheckerRule.

        修复建议

        :return: The rectify_suggestion of this CheckerRule.
        :rtype: str
        """
    ...
    def rectify_suggestion(self, rectify_suggestion):
        """Sets the rectify_suggestion of this CheckerRule.

        修复建议

        :param rectify_suggestion: The rectify_suggestion of this CheckerRule.
        :type rectify_suggestion: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CheckerRule):
            return False
