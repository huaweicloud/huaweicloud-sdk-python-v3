...
class CreateAgencyAccessRequest:
    ...
    openapi_types = {
        'body': 'PreviewAgencyLogAccessReqListBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateAgencyAccessRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateAgencyAccessRequest):
            return False
