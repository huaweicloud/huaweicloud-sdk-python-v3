...
class CreateDashboardGroupRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateDashboardGroupRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateDashboardGroupRequest):
            return False
