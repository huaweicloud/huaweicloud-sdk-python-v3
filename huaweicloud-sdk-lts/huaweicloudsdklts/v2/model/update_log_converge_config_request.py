...
class UpdateLogConvergeConfigRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the UpdateLogConvergeConfigRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateLogConvergeConfigRequest):
            return False
