...
class UpdateAccessConfigRequest:
    ...
    openapi_types = {
        'body': 'UpdateAccessConfigRequestBody'
    }
    ...
    def __init__(self, body=None):
        """UpdateAccessConfigRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: UpdateAccessConfigRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateAccessConfigRequest):
            return False
