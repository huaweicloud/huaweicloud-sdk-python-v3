...
class AccessConfigTimeOffset:
    ...
    @property
    def offset(self):
        r"""Gets the offset of this AccessConfigTimeOffset.

        偏移时间。 当\"unit\"选择\"day\"时，范围为1~7天。 当\"unit\"选择\"hour\"时，范围为1~168小时。 当\"unit\"选择\"sec\"时，范围为1~604800秒。

        :return: The offset of this AccessConfigTimeOffset.
        :rtype: int
        """
        return self._offset
    ...
    def offset(self, offset):
        r"""Sets the offset of this AccessConfigTimeOffset.
    ...
    @property
    def unit(self):
        r"""Gets the unit of this AccessConfigTimeOffset.

        偏移时间单位。day ：天，hour：小时，sec：秒

        :return: The unit of this AccessConfigTimeOffset.
        :rtype: str
        """
        return self._unit
    ...
    @unit.setter
    def unit(self, unit):
        r"""Sets the unit of this AccessConfigTimeOffset.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AccessConfigTimeOffset):
            return False
