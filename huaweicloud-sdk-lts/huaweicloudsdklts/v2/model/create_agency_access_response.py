...
class CreateAgencyAccessResponse(SdkResponse):
    ...
    openapi_types = {
        'body': 'list[LTSAccessConfigInfoRespon200]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateAgencyAccessResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateAgencyAccessResponse):
            return False
