...
class CreateTransferResponse(SdkResponse):
    ...
    def log_group_id(self):
        r"""Gets the log_group_id of this CreateTransferResponse.

        日志组ID

        :return: The log_group_id of this CreateTransferResponse.
        :rtype: str
        """
    ...
    def log_group_id(self, log_group_id):
        r"""Sets the log_group_id of this CreateTransferResponse.
    ...
    def log_group_name(self):
        r"""Gets the log_group_name of this CreateTransferResponse.

        日志组名称

        :return: The log_group_name of this CreateTransferResponse.
        :rtype: str
        """
    ...
    def log_group_name(self, log_group_name):
        r"""Sets the log_group_name of this CreateTransferResponse.
    ...
    def log_streams(self):
        r"""Gets the log_streams of this CreateTransferResponse.
    ...
    def log_streams(self, log_streams):
        r"""Sets the log_streams of this CreateTransferResponse.
    ...
    def log_transfer_id(self):
        r"""Gets the log_transfer_id of this CreateTransferResponse.

        日志转储ID

        :return: The log_transfer_id of this CreateTransferResponse.
        :rtype: str
        """
    ...
    def log_transfer_id(self, log_transfer_id):
        r"""Sets the log_transfer_id of this CreateTransferResponse.
    ...
    def log_transfer_info(self):
        r"""Gets the log_transfer_info of this CreateTransferResponse.
    ...
    def log_transfer_info(self, log_transfer_info):
        r"""Sets the log_transfer_info of this CreateTransferResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateTransferResponse):
            return False
