...
class CreateLogStreamResponse(SdkResponse):
    ...
    def log_stream_id(self):
        ...
        :return: The log_stream_id of this CreateLogStreamResponse.
        :rtype: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateLogStreamResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateLogStreamResponse):
            return False
