...
class ShowMemberGroupAndStreamResponse(SdkResponse):
    ...
    openapi_types = {
        'results': 'list[MemberGroupandStreamResults]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowMemberGroupAndStreamResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowMemberGroupAndStreamResponse):
            return False
