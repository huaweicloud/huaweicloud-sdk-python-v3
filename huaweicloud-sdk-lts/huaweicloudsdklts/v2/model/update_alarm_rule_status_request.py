...
class UpdateAlarmRuleStatusRequest:
    ...
    def __init__(self, body=None):
        """UpdateAlarmRuleStatusRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateAlarmRuleStatusRequest):
            return False
