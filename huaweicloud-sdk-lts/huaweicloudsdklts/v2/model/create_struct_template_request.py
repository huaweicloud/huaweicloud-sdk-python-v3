...
class CreateStructTemplateRequest:
    ...
    @property
    def body(self):
        r"""Gets the body of this CreateStructTemplateRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this CreateStructTemplateRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateStructTemplateRequest):
            return False
