...
class ListStructTemplateResponse(SdkResponse):
    ...
    openapi_types = {
        'results': 'list[StructTemplateModel]'
    }
    ...
    @property
    def results(self):
        r"""Gets the results of this ListStructTemplateResponse.
    ...
    def results(self, results):
        r"""Sets the results of this ListStructTemplateResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListStructTemplateResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListStructTemplateResponse):
            return False
