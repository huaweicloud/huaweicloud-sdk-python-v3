...
class CreateHostGroupResponse(SdkResponse):
    ...
    def host_group_id(self):
        r"""Gets the host_group_id of this CreateHostGroupResponse.

        主机组ID

        :return: The host_group_id of this CreateHostGroupResponse.
        :rtype: str
        """
    ...
    def host_group_id(self, host_group_id):
        r"""Sets the host_group_id of this CreateHostGroupResponse.
    ...
    def host_group_name(self):
        r"""Gets the host_group_name of this CreateHostGroupResponse.

        主机组名称

        :return: The host_group_name of this CreateHostGroupResponse.
        :rtype: str
        """
    ...
    def host_group_name(self, host_group_name):
        r"""Sets the host_group_name of this CreateHostGroupResponse.
    ...
    def host_group_type(self):
        r"""Gets the host_group_type of this CreateHostGroupResponse.

        主机组类型。linux：linux类型，windows：windows类型

        :return: The host_group_type of this CreateHostGroupResponse.
        :rtype: str
        """
    ...
    def host_group_type(self, host_group_type):
        r"""Sets the host_group_type of this CreateHostGroupResponse.
    ...
    def host_id_list(self):
        r"""Gets the host_id_list of this CreateHostGroupResponse.

        主机ID列表

        :return: The host_id_list of this CreateHostGroupResponse.
        :rtype: list[str]
        """
    ...
    def host_id_list(self, host_id_list):
        r"""Sets the host_id_list of this CreateHostGroupResponse.
    ...
    def host_group_tag(self):
        r"""Gets the host_group_tag of this CreateHostGroupResponse.
    ...
    def host_group_tag(self, host_group_tag):
        r"""Sets the host_group_tag of this CreateHostGroupResponse.
    ...
    def create_time(self):
        r"""Gets the create_time of this CreateHostGroupResponse.

        创建时间

        :return: The create_time of this CreateHostGroupResponse.
        :rtype: int
        """
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this CreateHostGroupResponse.
    ...
    def update_time(self):
        r"""Gets the update_time of this CreateHostGroupResponse.

        更新时间

        :return: The update_time of this CreateHostGroupResponse.
        :rtype: int
        """
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this CreateHostGroupResponse.
    ...
    def agent_access_type(self):
        r"""Gets the agent_access_type of this CreateHostGroupResponse.

        **参数解释：** 主机组类型。分别为IP、LABEL类型。 **取值范围：** - IP。 - LABEL。

        :return: The agent_access_type of this CreateHostGroupResponse.
        :rtype: str
        """
    ...
    def agent_access_type(self, agent_access_type):
        r"""Sets the agent_access_type of this CreateHostGroupResponse.

        **参数解释：** 主机组类型。分别为IP、LABEL类型。 **取值范围：** - IP。 - LABEL。

        :param agent_access_type: The agent_access_type of this CreateHostGroupResponse.
        :type agent_access_type: str
        """
    ...
    @property
    def labels(self):
        r"""Gets the labels of this CreateHostGroupResponse.

        **参数解释：** 主机组自定义标识。

        :return: The labels of this CreateHostGroupResponse.
        :rtype: list[str]
        """
        return self._labels
    ...
    def labels(self, labels):
        r"""Sets the labels of this CreateHostGroupResponse.

        **参数解释：** 主机组自定义标识。

        :param labels: The labels of this CreateHostGroupResponse.
        :type labels: list[str]
        """
        self._labels = labels
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateHostGroupResponse):
            return False
