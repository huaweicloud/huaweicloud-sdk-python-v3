...
class CreateHostGroupRequest:
    ...
    openapi_types = {
        'body': 'CreateHostGroupRequestBody'
    }
    ...
    @property
    def body(self):
        r"""Gets the body of this CreateHostGroupRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this CreateHostGroupRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateHostGroupRequest):
            return False
