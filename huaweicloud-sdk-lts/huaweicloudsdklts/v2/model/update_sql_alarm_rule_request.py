...
class UpdateSqlAlarmRuleRequest:
    ...
    openapi_types = {
        'body': 'UpdateSqlAlarmRuleRequestBody'
    }
    ...
    @property
    def body(self):
        r"""Gets the body of this UpdateSqlAlarmRuleRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this UpdateSqlAlarmRuleRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateSqlAlarmRuleRequest):
            return False
