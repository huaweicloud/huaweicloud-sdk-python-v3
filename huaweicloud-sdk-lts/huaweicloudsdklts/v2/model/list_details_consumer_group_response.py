...
class ListDetailsConsumerGroupResponse(SdkResponse):
    ...
    openapi_types = {
        'body': 'list[ConsumerCheckpointInfo]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListDetailsConsumerGroupResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListDetailsConsumerGroupResponse):
            return False
