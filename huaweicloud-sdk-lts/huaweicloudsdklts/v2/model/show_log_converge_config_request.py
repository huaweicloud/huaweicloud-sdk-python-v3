...
class ShowLogConvergeConfigRequest:
    ...
    def __init__(self, member_account_id=None):
        ...
        :param member_account_id: 成员帐户ID
    ...
    def member_account_id(self):
        ...
        :return: The member_account_id of this ShowLogConvergeConfigRequest.
        :rtype: str
        """
    ...
    def member_account_id(self, member_account_id):
        ...
        :param member_account_id: The member_account_id of this ShowLogConvergeConfigRequest.
        :type member_account_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowLogConvergeConfigRequest):
            return False
