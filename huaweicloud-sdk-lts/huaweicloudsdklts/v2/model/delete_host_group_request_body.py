...
class DeleteHostGroupRequestBody:
    ...
    def __init__(self, host_group_id_list=None):
        """DeleteHostGroupRequestBody - a model defined in huaweicloud sdk"""
    ...
    def host_group_id_list(self):
        ...
        :return: The host_group_id_list of this DeleteHostGroupRequestBody.
        :rtype: list[str]
        """
    ...
    def host_group_id_list(self, host_group_id_list):
        ...
        :param host_group_id_list: The host_group_id_list of this DeleteHostGroupRequestBody.
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteHostGroupRequestBody):
            return False
