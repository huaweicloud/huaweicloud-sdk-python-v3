...
class CreateAccessConfigResponse(SdkResponse):
    ...
    def access_config_id(self):
        r"""Gets the access_config_id of this CreateAccessConfigResponse.
    ...
    def access_config_id(self, access_config_id):
        r"""Sets the access_config_id of this CreateAccessConfigResponse.
    ...
    def access_config_name(self):
        r"""Gets the access_config_name of this CreateAccessConfigResponse.
    ...
    def access_config_name(self, access_config_name):
        r"""Sets the access_config_name of this CreateAccessConfigResponse.
    ...
    def access_config_type(self):
        r"""Gets the access_config_type of this CreateAccessConfigResponse.
    ...
    def access_config_type(self, access_config_type):
        r"""Sets the access_config_type of this CreateAccessConfigResponse.
    ...
    def create_time(self):
        r"""Gets the create_time of this CreateAccessConfigResponse.
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this CreateAccessConfigResponse.
    ...
    def access_config_detail(self):
        r"""Gets the access_config_detail of this CreateAccessConfigResponse.
    ...
    def access_config_detail(self, access_config_detail):
        r"""Sets the access_config_detail of this CreateAccessConfigResponse.
    ...
    @property
    def log_info(self):
        r"""Gets the log_info of this CreateAccessConfigResponse.
    ...
    def log_info(self, log_info):
        r"""Sets the log_info of this CreateAccessConfigResponse.
    ...
    def host_group_info(self):
        r"""Gets the host_group_info of this CreateAccessConfigResponse.
    ...
    def host_group_info(self, host_group_info):
        r"""Sets the host_group_info of this CreateAccessConfigResponse.
    ...
    def access_config_tag(self):
        r"""Gets the access_config_tag of this CreateAccessConfigResponse.
    ...
    def access_config_tag(self, access_config_tag):
        r"""Sets the access_config_tag of this CreateAccessConfigResponse.
    ...
    @property
    def log_split(self):
        r"""Gets the log_split of this CreateAccessConfigResponse.
    ...
    def log_split(self, log_split):
        r"""Sets the log_split of this CreateAccessConfigResponse.
    ...
    def binary_collect(self):
        r"""Gets the binary_collect of this CreateAccessConfigResponse.
    ...
    def binary_collect(self, binary_collect):
        r"""Sets the binary_collect of this CreateAccessConfigResponse.
    ...
    @property
    def cluster_id(self):
        r"""Gets the cluster_id of this CreateAccessConfigResponse.
    ...
    def cluster_id(self, cluster_id):
        r"""Sets the cluster_id of this CreateAccessConfigResponse.
    ...
    def encoding_format(self):
        r"""Gets the encoding_format of this CreateAccessConfigResponse.

        编码格式，默认UTF-8

        :return: The encoding_format of this CreateAccessConfigResponse.
        :rtype: str
        """
    ...
    def encoding_format(self, encoding_format):
        r"""Sets the encoding_format of this CreateAccessConfigResponse.

        编码格式，默认UTF-8

        :param encoding_format: The encoding_format of this CreateAccessConfigResponse.
        :type encoding_format: str
        """
    ...
    def incremental_collect(self):
        r"""Gets the incremental_collect of this CreateAccessConfigResponse.

        采集策略：增量/全量

        :return: The incremental_collect of this CreateAccessConfigResponse.
        :rtype: bool
        """
    ...
    def incremental_collect(self, incremental_collect):
        r"""Sets the incremental_collect of this CreateAccessConfigResponse.

        采集策略：增量/全量

        :param incremental_collect: The incremental_collect of this CreateAccessConfigResponse.
        :type incremental_collect: bool
        """
    ...
    def processor_type(self):
        r"""Gets the processor_type of this CreateAccessConfigResponse.

        IC结构化解析类型

        :return: The processor_type of this CreateAccessConfigResponse.
        :rtype: str
        """
    ...
    def processor_type(self, processor_type):
        r"""Sets the processor_type of this CreateAccessConfigResponse.

        IC结构化解析类型

        :param processor_type: The processor_type of this CreateAccessConfigResponse.
        :type processor_type: str
        """
    ...
    @property
    def demo_log(self):
        r"""Gets the demo_log of this CreateAccessConfigResponse.

        示例日志

        :return: The demo_log of this CreateAccessConfigResponse.
        :rtype: str
        """
    ...
    def demo_log(self, demo_log):
        r"""Sets the demo_log of this CreateAccessConfigResponse.

        示例日志

        :param demo_log: The demo_log of this CreateAccessConfigResponse.
        :type demo_log: str
        """
    ...
    def demo_fields(self):
        r"""Gets the demo_fields of this CreateAccessConfigResponse.

        示例日志解析字段

        :return: The demo_fields of this CreateAccessConfigResponse.
    ...
    def demo_fields(self, demo_fields):
        r"""Sets the demo_fields of this CreateAccessConfigResponse.

        示例日志解析字段

        :param demo_fields: The demo_fields of this CreateAccessConfigResponse.
        :type demo_fields: list[:class:`huaweicloudsdklts.v2.DemoFieldAccess`]
        """
    ...
    @property
    def processors(self):
        r"""Gets the processors of this CreateAccessConfigResponse.

        IC结构化解析器

        :return: The processors of this CreateAccessConfigResponse.
    ...
    def processors(self, processors):
        r"""Sets the processors of this CreateAccessConfigResponse.

        IC结构化解析器

        :param processors: The processors of this CreateAccessConfigResponse.
        :type processors: list[:class:`huaweicloudsdklts.v2.Processor`]
        """
    ...
    def log_split_size(self):
        r"""Gets the log_split_size of this CreateAccessConfigResponse.

        **参数解释：** 拆分日志大小。 **取值范围：** 不涉及。

        :return: The log_split_size of this CreateAccessConfigResponse.
        :rtype: int
        """
    ...
    def log_split_size(self, log_split_size):
        r"""Sets the log_split_size of this CreateAccessConfigResponse.

        **参数解释：** 拆分日志大小。 **取值范围：** 不涉及。

        :param log_split_size: The log_split_size of this CreateAccessConfigResponse.
        :type log_split_size: int
        """
    ...
    def recursive_depth(self):
        r"""Gets the recursive_depth of this CreateAccessConfigResponse.

        **参数解释：** 采集路径递归最大深度。 **取值范围：** 不涉及。

        :return: The recursive_depth of this CreateAccessConfigResponse.
        :rtype: int
        """
    ...
    def recursive_depth(self, recursive_depth):
        r"""Sets the recursive_depth of this CreateAccessConfigResponse.

        **参数解释：** 采集路径递归最大深度。 **取值范围：** 不涉及。

        :param recursive_depth: The recursive_depth of this CreateAccessConfigResponse.
        :type recursive_depth: int
        """
    ...
    def access_config_type_source(self):
        r"""Gets the access_config_type_source of this CreateAccessConfigResponse.

        **参数解释：** 日志接入自建软件来源。 **取值范围：** - ECS - CCE - BMS - K8S - ServiceStageHost - ServiceStage

        :return: The access_config_type_source of this CreateAccessConfigResponse.
        :rtype: str
        """
    ...
    def access_config_type_source(self, access_config_type_source):
        r"""Sets the access_config_type_source of this CreateAccessConfigResponse.

        **参数解释：** 日志接入自建软件来源。 **取值范围：** - ECS - CCE - BMS - K8S - ServiceStageHost - ServiceStage

        :param access_config_type_source: The access_config_type_source of this CreateAccessConfigResponse.
        :type access_config_type_source: str
        """
    ...
    def application_id(self):
        r"""Gets the application_id of this CreateAccessConfigResponse.

        ServiceStage应用ID

        :return: The application_id of this CreateAccessConfigResponse.
        :rtype: str
        """
    ...
    def application_id(self, application_id):
        r"""Sets the application_id of this CreateAccessConfigResponse.

        ServiceStage应用ID

        :param application_id: The application_id of this CreateAccessConfigResponse.
        :type application_id: str
        """
    ...
    def environment_id(self):
        r"""Gets the environment_id of this CreateAccessConfigResponse.

        ServiceStage环境ID

        :return: The environment_id of this CreateAccessConfigResponse.
        :rtype: str
        """
    ...
    def environment_id(self, environment_id):
        r"""Sets the environment_id of this CreateAccessConfigResponse.

        ServiceStage环境ID

        :param environment_id: The environment_id of this CreateAccessConfigResponse.
        :type environment_id: str
        """
    ...
    def component_id(self):
        r"""Gets the component_id of this CreateAccessConfigResponse.

        ServiceStage组件ID

        :return: The component_id of this CreateAccessConfigResponse.
        :rtype: list[str]
        """
    ...
    def component_id(self, component_id):
        r"""Sets the component_id of this CreateAccessConfigResponse.

        ServiceStage组件ID

        :param component_id: The component_id of this CreateAccessConfigResponse.
        :type component_id: list[str]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateAccessConfigResponse.to_dict() is deprecated and no longer maintained, "
