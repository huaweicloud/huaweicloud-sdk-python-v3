...
class AccessConfigFormatSingle:
    ...
    @property
    def mode(self):
        r"""Gets the mode of this AccessConfigFormatSingle.

        单行日志。system：系统时间，wildcard：时间通配符。

        :return: The mode of this AccessConfigFormatSingle.
        :rtype: str
        """
        return self._mode
    ...
    @mode.setter
    def mode(self, mode):
        r"""Sets the mode of this AccessConfigFormatSingle.
    ...
    @property
    def value(self):
        r"""Gets the value of this AccessConfigFormatSingle.
        ...
        :return: The value of this AccessConfigFormatSingle.
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        r"""Sets the value of this AccessConfigFormatSingle.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AccessConfigFormatSingle):
            return False
