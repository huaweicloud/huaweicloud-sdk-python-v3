...
class AccessConfigInfo:
    ...
    def log_split(self):
        ...
        :return: The log_split of this AccessConfigInfo.
        :rtype: bool
        """
    ...
    def log_split(self, log_split):
        ...
        :param log_split: The log_split of this AccessConfigInfo.
        :type log_split: bool
        """
    ...
    def binary_collect(self):
        ...
        :return: The binary_collect of this AccessConfigInfo.
        :rtype: bool
        """
    ...
    def binary_collect(self, binary_collect):
        ...
        :param binary_collect: The binary_collect of this AccessConfigInfo.
        :type binary_collect: bool
        """
    ...
    def encoding_format(self):
        ...
        :return: The encoding_format of this AccessConfigInfo.
        :rtype: str
        """
    ...
    def encoding_format(self, encoding_format):
        ...
        :param encoding_format: The encoding_format of this AccessConfigInfo.
        :type encoding_format: str
        """
    ...
    def incremental_collect(self):
        ...
        :return: The incremental_collect of this AccessConfigInfo.
        :rtype: bool
        """
    ...
    def incremental_collect(self, incremental_collect):
        ...
        :param incremental_collect: The incremental_collect of this AccessConfigInfo.
        :type incremental_collect: bool
        """
    ...
    def processor_type(self):
        ...
        :return: The processor_type of this AccessConfigInfo.
        :rtype: str
        """
    ...
    def processor_type(self, processor_type):
        ...
        :param processor_type: The processor_type of this AccessConfigInfo.
        :type processor_type: str
        """
    ...
    def demo_log(self):
        ...
        :return: The demo_log of this AccessConfigInfo.
        :rtype: str
        """
    ...
    def demo_log(self, demo_log):
        ...
        :param demo_log: The demo_log of this AccessConfigInfo.
        :type demo_log: str
        """
    ...
    def demo_fields(self):
        ...
        :return: The demo_fields of this AccessConfigInfo.
    ...
    def demo_fields(self, demo_fields):
        ...
        :param demo_fields: The demo_fields of this AccessConfigInfo.
        :type demo_fields: list[:class:`huaweicloudsdklts.v2.DemoFieldAccess`]
        """
    ...
    def processors(self):
        ...
        :return: The processors of this AccessConfigInfo.
    ...
    def processors(self, processors):
        ...
        :param processors: The processors of this AccessConfigInfo.
        :type processors: list[:class:`huaweicloudsdklts.v2.Processor`]
        """
    ...
    def log_split_size(self):
        r"""Gets the log_split_size of this AccessConfigInfo.

        **参数解释：** 拆分日志大小。 **取值范围：** 不涉及。

        :return: The log_split_size of this AccessConfigInfo.
        :rtype: int
        """
    ...
    def log_split_size(self, log_split_size):
        r"""Sets the log_split_size of this AccessConfigInfo.

        **参数解释：** 拆分日志大小。 **取值范围：** 不涉及。

        :param log_split_size: The log_split_size of this AccessConfigInfo.
        :type log_split_size: int
        """
    ...
    def recursive_depth(self):
        r"""Gets the recursive_depth of this AccessConfigInfo.

        **参数解释：** 采集路径递归最大深度。 **取值范围：** 不涉及。

        :return: The recursive_depth of this AccessConfigInfo.
        :rtype: int
        """
    ...
    def recursive_depth(self, recursive_depth):
        r"""Sets the recursive_depth of this AccessConfigInfo.

        **参数解释：** 采集路径递归最大深度。 **取值范围：** 不涉及。

        :param recursive_depth: The recursive_depth of this AccessConfigInfo.
        :type recursive_depth: int
        """
    ...
    def access_config_type_source(self):
        r"""Gets the access_config_type_source of this AccessConfigInfo.

        **参数解释：** 日志接入自建软件来源。 **取值范围：** - ECS - CCE - BMS - K8S - ServiceStageHost - ServiceStage

        :return: The access_config_type_source of this AccessConfigInfo.
        :rtype: str
        """
    ...
    def access_config_type_source(self, access_config_type_source):
        r"""Sets the access_config_type_source of this AccessConfigInfo.

        **参数解释：** 日志接入自建软件来源。 **取值范围：** - ECS - CCE - BMS - K8S - ServiceStageHost - ServiceStage

        :param access_config_type_source: The access_config_type_source of this AccessConfigInfo.
        :type access_config_type_source: str
        """
    ...
    def application_id(self):
        ...
        :return: The application_id of this AccessConfigInfo.
        :rtype: str
        """
    ...
    def application_id(self, application_id):
        ...
        :param application_id: The application_id of this AccessConfigInfo.
        :type application_id: str
        """
    ...
    def environment_id(self):
        ...
        :return: The environment_id of this AccessConfigInfo.
        :rtype: str
        """
    ...
    def environment_id(self, environment_id):
        ...
        :param environment_id: The environment_id of this AccessConfigInfo.
        :type environment_id: str
        """
    ...
    def component_id(self):
        ...
        :return: The component_id of this AccessConfigInfo.
        :rtype: list[str]
        """
    ...
    def component_id(self, component_id):
        ...
        :param component_id: The component_id of this AccessConfigInfo.
        :type component_id: list[str]
        """
