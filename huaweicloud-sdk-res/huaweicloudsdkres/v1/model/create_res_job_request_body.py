...
class CreateResJobRequestBody:
    ...
    @property
    def category(self):
        r"""Gets the category of this CreateResJobRequestBody.

        类别： - RECALL，召回作业 - DATASOURCE，数据源作业 - FILTER，过滤作业 - SORTING，排序作业 - EVALUATE，效果评估作业

        :return: The category of this CreateResJobRequestBody.
        :rtype: str
        """
    ...
    def category(self, category):
        r"""Sets the category of this CreateResJobRequestBody.
    ...
    def description(self):
        r"""Gets the description of this CreateResJobRequestBody.

        描述

        :return: The description of this CreateResJobRequestBody.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this CreateResJobRequestBody.
    ...
    @property
    def job_config(self):
        r"""Gets the job_config of this CreateResJobRequestBody.
    ...
    def job_config(self, job_config):
        r"""Sets the job_config of this CreateResJobRequestBody.
    ...
    def exec_config(self):
        r"""Gets the exec_config of this CreateResJobRequestBody.
    ...
    def exec_config(self, exec_config):
        r"""Sets the exec_config of this CreateResJobRequestBody.
    ...
    @property
    def job_name(self):
        r"""Gets the job_name of this CreateResJobRequestBody.

        作业名称，1-64位字母、数字、下划线、中划线组合

        :return: The job_name of this CreateResJobRequestBody.
        :rtype: str
        """
    ...
    def job_name(self, job_name):
        r"""Sets the job_name of this CreateResJobRequestBody.
    ...
    @property
    def job_type(self):
        r"""Gets the job_type of this CreateResJobRequestBody.

        作业类型： - WriteUserProfile，用户画像实时导入作业 - WriteItemProfile，物品画像实时导入作业 - UniversalProcess，行为数据实时导入作业 - NearlineRecall，近线召回作业 - EncodeProfile，近线特征工程作业 - AttributeMatch，属性匹配召回作业 - AlsCF，交替最小二乘协同过滤作业 - BhvHistory，历史行为记忆召回作业 - ItemCf，物品协同过滤召回作业 - MenEdit，人工配置候选集作业 - Ucb，UCB召回作业 - UserCf，用户协同过滤召回作业 - WeightBehavior，综合行为热度召回作业 - Filter，历史行为过滤作业 - AutoPreRank，智能ETL参数生成作业 - ETL，离线特征工程作业 - LR，LR作业 - DEEPFM，DEEPFM作业 - AutoGroup，AutoGroup作业 - StreamRank，在线训练作业 - DataStruct，识别数据结构作业 - DataExploration，数据探索作业 - DataImport，离线数据导入作业 - Evaluate，效果评估作业

        :return: The job_type of this CreateResJobRequestBody.
        :rtype: str
        """
    ...
    def job_type(self, job_type):
        r"""Sets the job_type of this CreateResJobRequestBody.
    ...
    @property
    def schedule(self):
        r"""Gets the schedule of this CreateResJobRequestBody.

        调度参数

        :return: The schedule of this CreateResJobRequestBody.
        :rtype: str
        """
    ...
    def schedule(self, schedule):
        r"""Sets the schedule of this CreateResJobRequestBody.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateResJobRequestBody):
            return False
