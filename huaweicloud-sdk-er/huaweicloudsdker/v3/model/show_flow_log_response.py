...
class ShowFlowLogResponse(SdkResponse):
    ...
    @property
    def flow_log(self):
        r"""Gets the flow_log of this ShowFlowLogResponse.
    ...
    def flow_log(self, flow_log):
        r"""Sets the flow_log of this ShowFlowLogResponse.
    ...
    @property
    def request_id(self):
        r"""Gets the request_id of this ShowFlowLogResponse.

        请求id

        :return: The request_id of this ShowFlowLogResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        r"""Sets the request_id of this ShowFlowLogResponse.

        请求id

        :param request_id: The request_id of this ShowFlowLogResponse.
        :type request_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowFlowLogResponse.to_dict() is deprecated and no longer maintained, "
