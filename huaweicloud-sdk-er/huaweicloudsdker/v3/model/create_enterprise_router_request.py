...
class CreateEnterpriseRouterRequest:
    ...
    openapi_types = {
        'x_client_token': 'str',
        'body': 'CreateEnterpriseRouterRequestBody'
    }
    ...
    def __init__(self, x_client_token=None, body=None):
        ...
        :param body: Body of the CreateEnterpriseRouterRequest
    ...
    def x_client_token(self):
        ...
        :return: The x_client_token of this CreateEnterpriseRouterRequest.
        :rtype: str
        """
    ...
    def x_client_token(self, x_client_token):
        ...
        :param x_client_token: The x_client_token of this CreateEnterpriseRouterRequest.
        :type x_client_token: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateEnterpriseRouterRequest):
            return False
