...
class ListStaticRoutesResponse(SdkResponse):
    ...
    def __init__(self, routes=None, request_id=None, page_info=None):
        ...
        :param routes: 路由列表
        :type routes: list[:class:`huaweicloudsdker.v3.Route`]
    ...
    def routes(self):
        ...
        :return: The routes of this ListStaticRoutesResponse.
        :rtype: list[:class:`huaweicloudsdker.v3.Route`]
        """
        return self._routes
    ...
    def routes(self, routes):
        ...
        :param routes: The routes of this ListStaticRoutesResponse.
        :type routes: list[:class:`huaweicloudsdker.v3.Route`]
        """
        self._routes = routes
    ...
    def request_id(self):
        ...
        :return: The request_id of this ListStaticRoutesResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        ...
        :param request_id: The request_id of this ListStaticRoutesResponse.
        :type request_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListStaticRoutesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListStaticRoutesResponse):
            return False
