...
class ErClient(Client):
    ...
    def change_association_route_policy(self, request):
        r"""修改关联的路由策略
    ...
    def change_association_route_policy_invoker(self, request):
        http_info = self._change_association_route_policy_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _change_association_route_policy_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def update_propagation_route_policy(self, request):
        r"""修改路由策略
    ...
    def update_propagation_route_policy_invoker(self, request):
        http_info = self._update_propagation_route_policy_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_propagation_route_policy_http_info(cls, request):
        http_info = {
            "method": "POST",
