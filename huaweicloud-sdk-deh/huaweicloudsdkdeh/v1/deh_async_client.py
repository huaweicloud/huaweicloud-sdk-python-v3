...
class DeHAsyncClient(Client):
    ...
    def delete_dedicated_host_async_invoker(self, request):
        http_info = self._delete_dedicated_host_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_dedicated_host_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_dedicated_host_all_types_async(self, request):
        r"""查询专属主机类型列表
    ...
    def list_dedicated_host_all_types_async_invoker(self, request):
        http_info = self._list_dedicated_host_all_types_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_dedicated_host_all_types_http_info(self, request):
        http_info = {
            "method": "GET",
