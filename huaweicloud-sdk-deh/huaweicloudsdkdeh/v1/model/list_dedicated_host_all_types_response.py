...
class ListDedicatedHostAllTypesResponse(SdkResponse):
    ...
    def dedicated_host_types(self):
        r"""Gets the dedicated_host_types of this ListDedicatedHostAllTypesResponse.

        指定可用的DeH类型。

        :return: The dedicated_host_types of this ListDedicatedHostAllTypesResponse.
        :rtype: list[:class:`huaweicloudsdkdeh.v1.DedicatedHostType`]
        """
        return self._dedicated_host_types

    @dedicated_host_types.setter
    def dedicated_host_types(self, dedicated_host_types):
        r"""Sets the dedicated_host_types of this ListDedicatedHostAllTypesResponse.

        指定可用的DeH类型。

        :param dedicated_host_types: The dedicated_host_types of this ListDedicatedHostAllTypesResponse.
        :type dedicated_host_types: list[:class:`huaweicloudsdkdeh.v1.DedicatedHostType`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListDedicatedHostAllTypesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListDedicatedHostAllTypesResponse):
            return False
