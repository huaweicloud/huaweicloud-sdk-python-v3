...
class ReqSetOrDeleteTags:
    ...
    @property
    def tags(self):
        r"""Gets the tags of this ReqSetOrDeleteTags.
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this ReqSetOrDeleteTags.
    ...
    @property
    def action(self):
        r"""Gets the action of this ReqSetOrDeleteTags.

        操作标识（仅支持小写）：create（创建），delete（删除）。

        :return: The action of this ReqSetOrDeleteTags.
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        r"""Sets the action of this ReqSetOrDeleteTags.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReqSetOrDeleteTags):
            return False
