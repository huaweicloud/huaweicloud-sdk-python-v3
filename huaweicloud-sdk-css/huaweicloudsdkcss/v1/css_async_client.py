...
class CssAsyncClient(Client):
    ...
    def close_ai_ops_setting_async(self, request):
        r"""关闭智能运维定时检测
    ...
    def close_ai_ops_setting_async_invoker(self, request):
        http_info = self._close_ai_ops_setting_http_info(request)
        return AsyncInvoker(self, http_info)

    def _close_ai_ops_setting_http_info(self, request):
        http_info = {
            "method": "PUT",
    ...
    def list_disk_type_async(self, request):
        r"""列举磁盘类型
        ...
        :param request: Request instance for ListDiskType
        :type request: :class:`huaweicloudsdkcss.v1.ListDiskTypeRequest`
        :rtype: :class:`huaweicloudsdkcss.v1.ListDiskTypeResponse`
        """
        http_info = self._list_disk_type_http_info(request)
        return self._call_api(**http_info)

    def list_disk_type_async_invoker(self, request):
        http_info = self._list_disk_type_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_disk_type_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1.0/{project_id}/disktypes",
            "request_type": request.__class__.__name__,
            "response_type": "ListDiskTypeResponse"
            }
    ...
    def show_ai_ops_detector_async(self, request):
        r"""查看智能运维检测项
    ...
    def show_ai_ops_detector_async_invoker(self, request):
        http_info = self._show_ai_ops_detector_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_ai_ops_detector_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_ai_ops_setting_async(self, request):
        r"""查看智能运维定时检测设置
    ...
    def show_ai_ops_setting_async_invoker(self, request):
        http_info = self._show_ai_ops_setting_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_ai_ops_setting_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_cluster_volume_usage_async(self, request):
        r"""查询集群磁盘使用情况
    ...
    def show_cluster_volume_usage_async_invoker(self, request):
        http_info = self._show_cluster_volume_usage_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_cluster_volume_usage_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_data_store_flavor_detail_async(self, request):
        r"""查询指定引擎支持的规格。
    ...
    def show_data_store_flavor_detail_async_invoker(self, request):
        http_info = self._show_data_store_flavor_detail_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_data_store_flavor_detail_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_flavor_detail_async_invoker(self, request):
        http_info = self._show_flavor_detail_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_flavor_detail_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_resize_flavors_async(self, request):
        r"""查询指定集群的可变更规格列表
    ...
    def show_resize_flavors_async_invoker(self, request):
        http_info = self._show_resize_flavors_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_resize_flavors_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def start_target_cluster_connectivity_test_async_invoker(self, request):
        http_info = self._start_target_cluster_connectivity_test_http_info(request)
        return AsyncInvoker(self, http_info)

    def _start_target_cluster_connectivity_test_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def update_ai_ops_setting_async(self, request):
        r"""更新智能运维定时检测设置
    ...
    def update_ai_ops_setting_async_invoker(self, request):
        http_info = self._update_ai_ops_setting_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_ai_ops_setting_http_info(self, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v1.0/{project_id}/clusters/{cluster_id}/ai-ops/setting",
            "request_type": request.__class__.__name__,
    ...
    def update_route_async(self, request):
        r"""更新集群路由
    ...
    def update_route_async_invoker(self, request):
        http_info = self._update_route_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_route_http_info(self, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v1.0/{project_id}/clusters/{cluster_id}/route",
            "request_type": request.__class__.__name__,
    ...
    def delete_certs_async(self, request):
        r"""删除证书文件
    ...
    def delete_certs_async_invoker(self, request):
        http_info = self._delete_certs_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_certs_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def reboot_cluster_async(self, request):
        r"""强制重启集群VMs
    ...
    def reboot_cluster_async_invoker(self, request):
        http_info = self._reboot_cluster_http_info(request)
        return AsyncInvoker(self, http_info)

    def _reboot_cluster_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def show_certs_detail_async(self, request):
        r"""查询证书文件信息
    ...
    def show_certs_detail_async_invoker(self, request):
        http_info = self._show_certs_detail_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_certs_detail_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def start_hot_pipeline_async(self, request):
        r"""热启动pipeline迁移数据。
    ...
    def start_hot_pipeline_async_invoker(self, request):
        http_info = self._start_hot_pipeline_http_info(request)
        return AsyncInvoker(self, http_info)

    def _start_hot_pipeline_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def upload_certs_async(self, request):
        r"""上传证书文件
    ...
    def upload_certs_async_invoker(self, request):
        http_info = self._upload_certs_http_info(request)
        return AsyncInvoker(self, http_info)

    def _upload_certs_http_info(self, request):
        http_info = {
            "method": "POST",
