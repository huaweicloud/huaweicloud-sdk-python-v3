...
class ChangeModeRequestBody:
    ...
    def authority_enable(self):
        """Gets the authority_enable of this ChangeModeRequestBody.

        是否开启安全模式。 - true: 开启安全模式。 - false: 关闭安全模式。 默认为：true。

        :return: The authority_enable of this ChangeModeRequestBody.
        :rtype: bool
        """
    ...
    def authority_enable(self, authority_enable):
        """Sets the authority_enable of this ChangeModeRequestBody.

        是否开启安全模式。 - true: 开启安全模式。 - false: 关闭安全模式。 默认为：true。

        :param authority_enable: The authority_enable of this ChangeModeRequestBody.
        :type authority_enable: bool
        """
    ...
    @property
    def admin_pwd(self):
        """Gets the admin_pwd of this ChangeModeRequestBody.

        安全模式下集群密码。

        :return: The admin_pwd of this ChangeModeRequestBody.
        :rtype: str
        """
    ...
    def admin_pwd(self, admin_pwd):
        """Sets the admin_pwd of this ChangeModeRequestBody.

        安全模式下集群密码。

        :param admin_pwd: The admin_pwd of this ChangeModeRequestBody.
        :type admin_pwd: str
        """
    ...
    def https_enable(self):
        """Gets the https_enable of this ChangeModeRequestBody.

        是否开启HTTPS。 - true: 开启HTTPS。 - false: 关闭HTTPS。 默认为：true。

        :return: The https_enable of this ChangeModeRequestBody.
        :rtype: bool
        """
    ...
    def https_enable(self, https_enable):
        """Sets the https_enable of this ChangeModeRequestBody.

        是否开启HTTPS。 - true: 开启HTTPS。 - false: 关闭HTTPS。 默认为：true。

        :param https_enable: The https_enable of this ChangeModeRequestBody.
        :type https_enable: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChangeModeRequestBody):
            return False
