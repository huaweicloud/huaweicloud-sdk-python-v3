...
class UpdateExtendInstanceStorageRequest:
    ...
    def __init__(self, cluster_id=None, body=None):
        r"""UpdateExtendInstanceStorageRequest
    ...
    @property
    def cluster_id(self):
        r"""Gets the cluster_id of this UpdateExtendInstanceStorageRequest.

        指定待扩容的集群ID。

        :return: The cluster_id of this UpdateExtendInstanceStorageRequest.
        :rtype: str
        """
    ...
    def cluster_id(self, cluster_id):
        r"""Sets the cluster_id of this UpdateExtendInstanceStorageRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this UpdateExtendInstanceStorageRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this UpdateExtendInstanceStorageRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateExtendInstanceStorageRequest):
            return False
