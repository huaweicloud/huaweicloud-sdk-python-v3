...
class Confsetting:
    ...
    @property
    def workers(self):
        r"""Gets the workers of this Confsetting.

        并行执行管道的Filters+Outputs阶段的工作线程数，默认值为CPU核数。

        :return: The workers of this Confsetting.
        :rtype: int
        """
    ...
    def workers(self, workers):
        r"""Sets the workers of this Confsetting.

        并行执行管道的Filters+Outputs阶段的工作线程数，默认值为CPU核数。

        :param workers: The workers of this Confsetting.
        :type workers: int
        """
    ...
    @property
    def batch_size(self):
        r"""Gets the batch_size of this Confsetting.

        单个工作线程在尝试执行其Filters和Outputs之前将从inputs收集的最大事件数，该值较大通常更有效，但会增加内存开销，默认为125。

        :return: The batch_size of this Confsetting.
        :rtype: int
        """
    ...
    def batch_size(self, batch_size):
        r"""Sets the batch_size of this Confsetting.

        单个工作线程在尝试执行其Filters和Outputs之前将从inputs收集的最大事件数，该值较大通常更有效，但会增加内存开销，默认为125。

        :param batch_size: The batch_size of this Confsetting.
        :type batch_size: int
        """
    ...
    def batch_delay_ms(self):
        r"""Gets the batch_delay_ms of this Confsetting.

        每个event被pipeline调度等待的最小时间。 单位毫秒。

        :return: The batch_delay_ms of this Confsetting.
        :rtype: int
        """
    ...
    def batch_delay_ms(self, batch_delay_ms):
        r"""Sets the batch_delay_ms of this Confsetting.

        每个event被pipeline调度等待的最小时间。 单位毫秒。

        :param batch_delay_ms: The batch_delay_ms of this Confsetting.
        :type batch_delay_ms: int
        """
    ...
    @property
    def queue_type(self):
        r"""Gets the queue_type of this Confsetting.

        用于事件缓冲的内部队列模型。memory 为基于内存的传统队列，persisted为基于磁盘的ACKed持久化队列，默认值为memory。

        :return: The queue_type of this Confsetting.
        :rtype: str
        """
    ...
    def queue_type(self, queue_type):
        r"""Sets the queue_type of this Confsetting.

        用于事件缓冲的内部队列模型。memory 为基于内存的传统队列，persisted为基于磁盘的ACKed持久化队列，默认值为memory。

        :param queue_type: The queue_type of this Confsetting.
        :type queue_type: str
        """
    ...
    def queue_check_point_writes(self):
        r"""Gets the queue_check_point_writes of this Confsetting.

        如果使用持久化队列，则表示强制执行检查点之前写入的最大事件数，默认值为1024。

        :return: The queue_check_point_writes of this Confsetting.
        :rtype: int
        """
    ...
    def queue_check_point_writes(self, queue_check_point_writes):
        r"""Sets the queue_check_point_writes of this Confsetting.

        如果使用持久化队列，则表示强制执行检查点之前写入的最大事件数，默认值为1024。

        :param queue_check_point_writes: The queue_check_point_writes of this Confsetting.
        :type queue_check_point_writes: int
        """
    ...
    def queue_max_bytes_mb(self):
        r"""Gets the queue_max_bytes_mb of this Confsetting.

        如果使用持久化队列，则表示持久化队列的总容量（以兆字节MB为单位），确保磁盘的容量大于该值，默认值为1024。

        :return: The queue_max_bytes_mb of this Confsetting.
        :rtype: int
        """
    ...
    def queue_max_bytes_mb(self, queue_max_bytes_mb):
        r"""Sets the queue_max_bytes_mb of this Confsetting.

        如果使用持久化队列，则表示持久化队列的总容量（以兆字节MB为单位），确保磁盘的容量大于该值，默认值为1024。

        :param queue_max_bytes_mb: The queue_max_bytes_mb of this Confsetting.
        :type queue_max_bytes_mb: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Confsetting):
            return False
