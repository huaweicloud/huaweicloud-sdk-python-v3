...
class CreateClusterBackupStrategyBody:
    ...
    def __init__(self, period=None, prefix=None, keepday=None, bucket=None, base_path=None, agency=None):
        ...
        :type base_path: str
        :param agency: 委托名称，委托给CSS，允许CSS调用您的其他云服务。  &gt;如果bucket、basePath和agency三个参数同时为空，则系统会自动创建OBS桶和IAM代理，否则使用配置的参数值。
        :type agency: str
        """
    ...
    def agency(self):
        ...
        委托名称，委托给CSS，允许CSS调用您的其他云服务。  >如果bucket、basePath和agency三个参数同时为空，则系统会自动创建OBS桶和IAM代理，否则使用配置的参数值。
