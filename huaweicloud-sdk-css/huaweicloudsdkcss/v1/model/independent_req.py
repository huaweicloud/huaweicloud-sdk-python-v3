...
class IndependentReq:
    ...
    @property
    def flavor_ref(self):
        """Gets the flavor_ref of this IndependentReq.

        规格id，该参数通过[获取实例规格列表](ListFlavors.xml)接口获取，根据集群版本选择所需要的规格id

        :return: The flavor_ref of this IndependentReq.
        :rtype: str
        """
    ...
    def flavor_ref(self, flavor_ref):
        """Sets the flavor_ref of this IndependentReq.

        规格id，该参数通过[获取实例规格列表](ListFlavors.xml)接口获取，根据集群版本选择所需要的规格id

        :param flavor_ref: The flavor_ref of this IndependentReq.
        :type flavor_ref: str
        """
    ...
    @property
    def node_size(self):
        """Gets the node_size of this IndependentReq.
        ...
        :return: The node_size of this IndependentReq.
        :rtype: int
        """
    ...
    def node_size(self, node_size):
        """Sets the node_size of this IndependentReq.

        要独立节点个数。 - 如果路径参数type取值为“ess-master”即新增独立master节点，节点个数必须为大于等于三且小于等于10的奇数。 - 如果路径参数type取值为“ess-client”即新增独立client节点，节点个数要求大于等于1小于等于32。

        :param node_size: The node_size of this IndependentReq.
        :type node_size: int
        """
    ...
    def volume_type(self):
        """Gets the volume_type of this IndependentReq.

        节点存储类型：取值为ULTRAHIGH，COMMON，HIGH。

        :return: The volume_type of this IndependentReq.
        :rtype: str
        """
    ...
    def volume_type(self, volume_type):
        """Sets the volume_type of this IndependentReq.

        节点存储类型：取值为ULTRAHIGH，COMMON，HIGH。

        :param volume_type: The volume_type of this IndependentReq.
        :type volume_type: str
        """
