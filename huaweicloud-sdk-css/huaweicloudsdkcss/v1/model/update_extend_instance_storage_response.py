...
class UpdateExtendInstanceStorageResponse(SdkResponse):
    ...
    def id(self):
        ...
        :return: The id of this UpdateExtendInstanceStorageResponse.
        :rtype: str
        """
        return self._id
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateExtendInstanceStorageResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateExtendInstanceStorageResponse):
            return False
