...
class StartTargetClusterConnectivityTestResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("StartTargetClusterConnectivityTestResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StartTargetClusterConnectivityTestResponse):
            return False
