...
class StopLogAutoBackupPolicyRequest:
    ...
    def __init__(self, cluster_id=None):
        """StopLogAutoBackupPolicyRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StopLogAutoBackupPolicyRequest):
            return False
