...
class ListConfsRequest:
    ...
    @property
    def offset(self):
        r"""Gets the offset of this ListConfsRequest.

        指定查询起始值，默认值为1。

        :return: The offset of this ListConfsRequest.
        :rtype: str
        """
        return self._offset
    ...
    def offset(self, offset):
        r"""Sets the offset of this ListConfsRequest.

        指定查询起始值，默认值为1。

        :param offset: The offset of this ListConfsRequest.
        :type offset: str
        """
        self._offset = offset
