...
class ShowVpcepConnectionRequest:
    ...
    @property
    def offset(self):
        r"""Gets the offset of this ShowVpcepConnectionRequest.

        指定查询起始值，默认值为1，即从第1个任务开始查询。

        :return: The offset of this ShowVpcepConnectionRequest.
        :rtype: int
        """
        return self._offset
    ...
    def offset(self, offset):
        r"""Sets the offset of this ShowVpcepConnectionRequest.

        指定查询起始值，默认值为1，即从第1个任务开始查询。

        :param offset: The offset of this ShowVpcepConnectionRequest.
        :type offset: int
        """
        self._offset = offset
