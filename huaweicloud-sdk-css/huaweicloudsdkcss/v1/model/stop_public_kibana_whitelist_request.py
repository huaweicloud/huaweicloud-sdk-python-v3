...
class StopPublicKibanaWhitelistRequest:
    ...
    def __init__(self, cluster_id=None):
        """StopPublicKibanaWhitelistRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StopPublicKibanaWhitelistRequest):
            return False
