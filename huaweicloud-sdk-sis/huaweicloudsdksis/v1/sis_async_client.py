...
class SisAsyncClient(Client):
    ...
    def create_voice_async(self, request):
        r"""注册接口
    ...
    def create_voice_async_invoker(self, request):
        http_info = self._create_voice_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_voice_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def generate_speech_async(self, request):
        r"""合成接口
    ...
    def generate_speech_async_invoker(self, request):
        http_info = self._generate_speech_http_info(request)
        return AsyncInvoker(self, http_info)

    def _generate_speech_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def list_voices_async(self, request):
        r"""查询接口
    ...
    def list_voices_async_invoker(self, request):
        http_info = self._list_voices_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_voices_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/{project_id}/vcs/voices",
            "request_type": request.__class__.__name__,
