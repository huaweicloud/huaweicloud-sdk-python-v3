...
class RunMultiModalAssessmentRequest:
    ...
    openapi_types = {
        'body': 'PostMultiModalAssessmentReq'
    }
    ...
    @property
    def body(self):
        """Gets the body of this RunMultiModalAssessmentRequest.
    ...
    @body.setter
    def body(self, body):
        """Sets the body of this RunMultiModalAssessmentRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunMultiModalAssessmentRequest):
            return False
