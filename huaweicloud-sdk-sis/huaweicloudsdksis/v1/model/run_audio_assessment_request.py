...
class RunAudioAssessmentRequest:
    ...
    openapi_types = {
        'body': 'PostShortAudioAssessmentReq'
    }
    ...
    def __init__(self, body=None):
        """RunAudioAssessmentRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: PostShortAudioAssessmentReq
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunAudioAssessmentRequest):
            return False
