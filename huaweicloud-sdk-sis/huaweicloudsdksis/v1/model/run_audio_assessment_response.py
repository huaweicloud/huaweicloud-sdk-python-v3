...
class RunAudioAssessmentResponse(SdkResponse):
    ...
    @property
    def score(self):
        """Gets the score of this RunAudioAssessmentResponse.

        综合评分，0-100

        :return: The score of this RunAudioAssessmentResponse.
        :rtype: float
        """
        return self._score
    ...
    def score(self, score):
        """Sets the score of this RunAudioAssessmentResponse.
    ...
    def completeness(self):
        """Gets the completeness of this RunAudioAssessmentResponse.

        完整性评分，0-100 表示有多少比例的单词发音是清楚的

        :return: The completeness of this RunAudioAssessmentResponse.
        :rtype: float
        """
    ...
    def completeness(self, completeness):
        """Sets the completeness of this RunAudioAssessmentResponse.
    ...
    @property
    def duration(self):
        """Gets the duration of this RunAudioAssessmentResponse.

        音频/视频时长，单位秒

        :return: The duration of this RunAudioAssessmentResponse.
        :rtype: float
        """
    ...
    def duration(self, duration):
        """Sets the duration of this RunAudioAssessmentResponse.
    ...
    @property
    def words(self):
        """Gets the words of this RunAudioAssessmentResponse.
    ...
    def words(self, words):
        """Sets the words of this RunAudioAssessmentResponse.
    ...
    @property
    def trace_id(self):
        """Gets the trace_id of this RunAudioAssessmentResponse.

        评测失败时定位问题使用的字段

        :return: The trace_id of this RunAudioAssessmentResponse.
        :rtype: str
        """
    ...
    def trace_id(self, trace_id):
        """Sets the trace_id of this RunAudioAssessmentResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RunAudioAssessmentResponse):
            return False
