...
class ShowVocabulariesRequest:
    ...
    def __init__(self, body=None):
        """ShowVocabulariesRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowVocabulariesRequest):
            return False
