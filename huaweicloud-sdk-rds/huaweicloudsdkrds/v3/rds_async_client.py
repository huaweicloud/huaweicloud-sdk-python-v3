...
class RdsAsyncClient(Client):
    ...
    def do_manual_backup_async(self, request):
        """创建手动备份
    ...
    def modify_configuration_async(self, request):
        """修改参数模板参数
    ...
    def modify_instance_configuration_async(self, request):
        """修改指定实例的参数
    ...
    def start_instance_action_async(self, request):
