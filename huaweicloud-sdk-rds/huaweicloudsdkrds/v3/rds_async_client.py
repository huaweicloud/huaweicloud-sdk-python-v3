...
class RdsAsyncClient(Client):
    ...
    def start_instance_dr_to_master_action_async(self, request):
        """灾备实例升主
    ...
    def start_instance_master_dr_action_async(self, request):
        """配置主实例容灾能力
    ...
    def start_instance_slave_dr_action_async(self, request):
        """配置灾备实例容灾能力
