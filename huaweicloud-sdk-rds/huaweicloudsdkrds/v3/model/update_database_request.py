...
class UpdateDatabaseRequest:
    ...
    def __init__(self, x_language=None, instance_id=None, body=None):
        """UpdateDatabaseRequest - a model defined in huaweicloud sdk"""
    ...
    @property
    def x_language(self):
        """Gets the x_language of this UpdateDatabaseRequest.

        语言

        :return: The x_language of this UpdateDatabaseRequest.
        :rtype: str
        """
    ...
    def x_language(self, x_language):
        """Sets the x_language of this UpdateDatabaseRequest.

        语言

        :param x_language: The x_language of this UpdateDatabaseRequest.
        :type: str
        """
