...
class ListPostgresqlHbaInfoResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListPostgresqlHbaInfoResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListPostgresqlHbaInfoResponse):
            return False
