...
class UpgradeDbVersionRequest:
    ...
    openapi_types = {
        'x_language': 'str',
        'instance_id': 'str',
        'body': 'CustomerUpgradeDatabaseVersionReq'
    }
    ...
    def x_language(self):
        ...
        :return: The x_language of this UpgradeDbVersionRequest.
        :rtype: str
        """
    ...
    def instance_id(self):
        ...
        :return: The instance_id of this UpgradeDbVersionRequest.
        :rtype: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpgradeDbVersionRequest):
            return False
