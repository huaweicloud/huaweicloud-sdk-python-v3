...
class SetSecondLevelMonitorResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("SetSecondLevelMonitorResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SetSecondLevelMonitorResponse):
            return False
