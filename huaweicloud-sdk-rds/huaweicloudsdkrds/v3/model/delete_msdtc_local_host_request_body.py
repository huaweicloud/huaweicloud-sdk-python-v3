...
class DeleteMsdtcLocalHostRequestBody:
    ...
    def hosts(self):
        ...
        :return: The hosts of this DeleteMsdtcLocalHostRequestBody.
    ...
    def hosts(self, hosts):
        ...
        :param hosts: The hosts of this DeleteMsdtcLocalHostRequestBody.
        :type hosts: list[:class:`huaweicloudsdkrds.v3.MsdtcHostOption`]
        """
        self._hosts = hosts
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteMsdtcLocalHostRequestBody):
            return False
