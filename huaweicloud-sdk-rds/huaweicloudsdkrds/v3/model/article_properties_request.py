...
class ArticlePropertiesRequest:
    ...
    def destination_object_name(self):
        r"""Gets the destination_object_name of this ArticlePropertiesRequest.

        目标对象名称。

        :return: The destination_object_name of this ArticlePropertiesRequest.
        :rtype: str
        """
    ...
    def destination_object_name(self, destination_object_name):
        r"""Sets the destination_object_name of this ArticlePropertiesRequest.

        目标对象名称。

        :param destination_object_name: The destination_object_name of this ArticlePropertiesRequest.
        :type destination_object_name: str
        """
    ...
    def destination_object_owner(self):
        r"""Gets the destination_object_owner of this ArticlePropertiesRequest.

        目标对象命名空间。

        :return: The destination_object_owner of this ArticlePropertiesRequest.
        :rtype: str
        """
    ...
    def destination_object_owner(self, destination_object_owner):
        r"""Sets the destination_object_owner of this ArticlePropertiesRequest.

        目标对象命名空间。

        :param destination_object_owner: The destination_object_owner of this ArticlePropertiesRequest.
        :type destination_object_owner: str
        """
    ...
    def insert_delivery_format(self):
        r"""Gets the insert_delivery_format of this ArticlePropertiesRequest.

        插入交付格式。

        :return: The insert_delivery_format of this ArticlePropertiesRequest.
        :rtype: str
        """
    ...
    def insert_delivery_format(self, insert_delivery_format):
        r"""Sets the insert_delivery_format of this ArticlePropertiesRequest.

        插入交付格式。

        :param insert_delivery_format: The insert_delivery_format of this ArticlePropertiesRequest.
        :type insert_delivery_format: str
        """
    ...
    def insert_stored_procedure(self):
        r"""Gets the insert_stored_procedure of this ArticlePropertiesRequest.

        插入存储过程。插入交付格式填call_procedure时该项必填。

        :return: The insert_stored_procedure of this ArticlePropertiesRequest.
        :rtype: str
        """
    ...
    def insert_stored_procedure(self, insert_stored_procedure):
        r"""Sets the insert_stored_procedure of this ArticlePropertiesRequest.

        插入存储过程。插入交付格式填call_procedure时该项必填。

        :param insert_stored_procedure: The insert_stored_procedure of this ArticlePropertiesRequest.
        :type insert_stored_procedure: str
        """
    ...
    def update_delivery_format(self):
        r"""Gets the update_delivery_format of this ArticlePropertiesRequest.

        更新交付格式。

        :return: The update_delivery_format of this ArticlePropertiesRequest.
        :rtype: str
        """
    ...
    def update_delivery_format(self, update_delivery_format):
        r"""Sets the update_delivery_format of this ArticlePropertiesRequest.

        更新交付格式。

        :param update_delivery_format: The update_delivery_format of this ArticlePropertiesRequest.
        :type update_delivery_format: str
        """
    ...
    def update_stored_procedure(self):
        r"""Gets the update_stored_procedure of this ArticlePropertiesRequest.

        更新存储过程。更新交付格式填(m/x/s)call_procedure时该项必填。

        :return: The update_stored_procedure of this ArticlePropertiesRequest.
        :rtype: str
        """
    ...
    def update_stored_procedure(self, update_stored_procedure):
        r"""Sets the update_stored_procedure of this ArticlePropertiesRequest.

        更新存储过程。更新交付格式填(m/x/s)call_procedure时该项必填。

        :param update_stored_procedure: The update_stored_procedure of this ArticlePropertiesRequest.
        :type update_stored_procedure: str
        """
    ...
    def delete_delivery_format(self):
        r"""Gets the delete_delivery_format of this ArticlePropertiesRequest.

        删除交付格式。

        :return: The delete_delivery_format of this ArticlePropertiesRequest.
        :rtype: str
        """
    ...
    def delete_delivery_format(self, delete_delivery_format):
        r"""Sets the delete_delivery_format of this ArticlePropertiesRequest.

        删除交付格式。

        :param delete_delivery_format: The delete_delivery_format of this ArticlePropertiesRequest.
        :type delete_delivery_format: str
        """
    ...
    def delete_stored_procedure(self):
        r"""Gets the delete_stored_procedure of this ArticlePropertiesRequest.

        删除存储过程。删除交付格式填(x)call_procedure时该项必填。

        :return: The delete_stored_procedure of this ArticlePropertiesRequest.
        :rtype: str
        """
    ...
    def delete_stored_procedure(self, delete_stored_procedure):
        r"""Sets the delete_stored_procedure of this ArticlePropertiesRequest.

        删除存储过程。删除交付格式填(x)call_procedure时该项必填。

        :param delete_stored_procedure: The delete_stored_procedure of this ArticlePropertiesRequest.
        :type delete_stored_procedure: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ArticlePropertiesRequest):
            return False
