...
class DownloadSlowlogResponse(SdkResponse):
    ...
    def __init__(self, list=None, status=None, count=None):
        ...
        :type list: list[:class:`huaweicloudsdkrds.v3.SlowlogDownloadInfo`]
    ...
    def list(self):
        ...
        :rtype: list[:class:`huaweicloudsdkrds.v3.SlowlogDownloadInfo`]
        """
        return self._list
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DownloadSlowlogResponse.to_dict() is deprecated and no longer maintained, "
