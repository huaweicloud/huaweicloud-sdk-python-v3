...
class ShowBackupUsageAlarmConfigResponse(SdkResponse):
    ...
    def __init__(self, alarm_enabled=None, threshold_percent=None, increment_percent=None):
        r"""ShowBackupUsageAlarmConfigResponse

        The model defined in huaweicloud sdk

        :param alarm_enabled: **参数解释**：  告警开关。  **约束限制**：  不涉及。  **取值范围**：  - ON - OFF  **默认取值**：  OFF。
    ...
    def alarm_enabled(self):
        r"""Gets the alarm_enabled of this ShowBackupUsageAlarmConfigResponse.

        **参数解释**：  告警开关。  **约束限制**：  不涉及。  **取值范围**：  - ON - OFF  **默认取值**：  OFF。

        :return: The alarm_enabled of this ShowBackupUsageAlarmConfigResponse.
        :rtype: str
        """
    ...
    def alarm_enabled(self, alarm_enabled):
        r"""Sets the alarm_enabled of this ShowBackupUsageAlarmConfigResponse.

        **参数解释**：  告警开关。  **约束限制**：  不涉及。  **取值范围**：  - ON - OFF  **默认取值**：  OFF。

        :param alarm_enabled: The alarm_enabled of this ShowBackupUsageAlarmConfigResponse.
        :type alarm_enabled: str
        """
    ...
    def threshold_percent(self):
        r"""Gets the threshold_percent of this ShowBackupUsageAlarmConfigResponse.

        **参数解释**：  阈值百分比，占免费备份空间大小的百分比。  **约束限制**：  不涉及。  **取值范围**：  1-100。  **默认取值**：  90。

        :return: The threshold_percent of this ShowBackupUsageAlarmConfigResponse.
        :rtype: int
        """
    ...
    def threshold_percent(self, threshold_percent):
        r"""Sets the threshold_percent of this ShowBackupUsageAlarmConfigResponse.

        **参数解释**：  阈值百分比，占免费备份空间大小的百分比。  **约束限制**：  不涉及。  **取值范围**：  1-100。  **默认取值**：  90。

        :param threshold_percent: The threshold_percent of this ShowBackupUsageAlarmConfigResponse.
        :type threshold_percent: int
        """
    ...
    def increment_percent(self):
        r"""Gets the increment_percent of this ShowBackupUsageAlarmConfigResponse.

        **参数解释**：  增量百分比，占免费备份空间大小的百分比。  **约束限制**：  不涉及。  **取值范围**：  1-100。  **默认取值**：  10。

        :return: The increment_percent of this ShowBackupUsageAlarmConfigResponse.
        :rtype: int
        """
    ...
    def increment_percent(self, increment_percent):
        r"""Sets the increment_percent of this ShowBackupUsageAlarmConfigResponse.

        **参数解释**：  增量百分比，占免费备份空间大小的百分比。  **约束限制**：  不涉及。  **取值范围**：  1-100。  **默认取值**：  10。

        :param increment_percent: The increment_percent of this ShowBackupUsageAlarmConfigResponse.
        :type increment_percent: int
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowBackupUsageAlarmConfigResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowBackupUsageAlarmConfigResponse):
            return False
