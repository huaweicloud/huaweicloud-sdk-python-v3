...
class ReduceVolumeRequestBody:
    ...
    openapi_types = {
        'reduce_volume': 'ReduceVolumeObject'
    }
    ...
    def __init__(self, reduce_volume=None):
        ...
        self._reduce_volume = None
        self.discriminator = None

        self.reduce_volume = reduce_volume
    ...
    def reduce_volume(self, reduce_volume):
        ...
        :type reduce_volume: :class:`huaweicloudsdkrds.v3.ReduceVolumeObject`
        """
        self._reduce_volume = reduce_volume
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReduceVolumeRequestBody):
            return False
