...
class ModifiyInstanceNameRequest:
    ...
    def __init__(self, name=None):
        """ModifiyInstanceNameRequest - a model defined in huaweicloud sdk"""
    ...
    def name(self):
        ...
        :return: The name of this ModifiyInstanceNameRequest.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this ModifiyInstanceNameRequest.
        :type: str
        """
        self._name = name
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModifiyInstanceNameRequest):
            return False
