...
class SetSecurityGroupRequest:
    ...
    def __init__(self, x_language=None, instance_id=None, body=None):
        ...
        :param body: Body of the SetSecurityGroupRequest
    ...
    @property
    def x_language(self):
        r"""Gets the x_language of this SetSecurityGroupRequest.
    ...
    def x_language(self, x_language):
        r"""Sets the x_language of this SetSecurityGroupRequest.
    ...
    def instance_id(self):
        r"""Gets the instance_id of this SetSecurityGroupRequest.
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this SetSecurityGroupRequest.
    ...
    @property
    def body(self):
        r"""Gets the body of this SetSecurityGroupRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this SetSecurityGroupRequest.
