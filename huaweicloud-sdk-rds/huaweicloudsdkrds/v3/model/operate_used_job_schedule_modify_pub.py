...
class OperateUsedJobScheduleModifyPub:
    ...
    def __init__(self, id=None, job_schedule_type=None, one_time_occurrence=None, frequency=None, daily_frequency=None, duration=None):
        r"""OperateUsedJobScheduleModifyPub
    ...
    @property
    def id(self):
        r"""Gets the id of this OperateUsedJobScheduleModifyPub.

        策略id。

        :return: The id of this OperateUsedJobScheduleModifyPub.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this OperateUsedJobScheduleModifyPub.

        策略id。

        :param id: The id of this OperateUsedJobScheduleModifyPub.
        :type id: str
        """
        self._id = id
    ...
    def job_schedule_type(self):
        r"""Gets the job_schedule_type of this OperateUsedJobScheduleModifyPub.

        计划类型。默认值recurring。  automatically：SQL Server代理启动时自动启动。 cpu_idle：CPU空闲时启动。 recurring：重复执行。 one_time：执行一次。

        :return: The job_schedule_type of this OperateUsedJobScheduleModifyPub.
        :rtype: str
        """
    ...
    def job_schedule_type(self, job_schedule_type):
        r"""Sets the job_schedule_type of this OperateUsedJobScheduleModifyPub.

        计划类型。默认值recurring。  automatically：SQL Server代理启动时自动启动。 cpu_idle：CPU空闲时启动。 recurring：重复执行。 one_time：执行一次。

        :param job_schedule_type: The job_schedule_type of this OperateUsedJobScheduleModifyPub.
        :type job_schedule_type: str
        """
    ...
    def one_time_occurrence(self):
        r"""Gets the one_time_occurrence of this OperateUsedJobScheduleModifyPub.

        :return: The one_time_occurrence of this OperateUsedJobScheduleModifyPub.
    ...
    def one_time_occurrence(self, one_time_occurrence):
        r"""Sets the one_time_occurrence of this OperateUsedJobScheduleModifyPub.

        :param one_time_occurrence: The one_time_occurrence of this OperateUsedJobScheduleModifyPub.
        :type one_time_occurrence: :class:`huaweicloudsdkrds.v3.JobScheduleOneTimeOccurrenceInfo`
        """
    ...
    @property
    def frequency(self):
        r"""Gets the frequency of this OperateUsedJobScheduleModifyPub.

        :return: The frequency of this OperateUsedJobScheduleModifyPub.
    ...
    def frequency(self, frequency):
        r"""Sets the frequency of this OperateUsedJobScheduleModifyPub.

        :param frequency: The frequency of this OperateUsedJobScheduleModifyPub.
        :type frequency: :class:`huaweicloudsdkrds.v3.JobScheduleFrequencyInfo`
        """
    ...
    def daily_frequency(self):
        r"""Gets the daily_frequency of this OperateUsedJobScheduleModifyPub.

        :return: The daily_frequency of this OperateUsedJobScheduleModifyPub.
    ...
    def daily_frequency(self, daily_frequency):
        r"""Sets the daily_frequency of this OperateUsedJobScheduleModifyPub.

        :param daily_frequency: The daily_frequency of this OperateUsedJobScheduleModifyPub.
        :type daily_frequency: :class:`huaweicloudsdkrds.v3.JobScheduleDailyFrequencyInfo`
        """
    ...
    @property
    def duration(self):
        r"""Gets the duration of this OperateUsedJobScheduleModifyPub.

        :return: The duration of this OperateUsedJobScheduleModifyPub.
    ...
    def duration(self, duration):
        r"""Sets the duration of this OperateUsedJobScheduleModifyPub.

        :param duration: The duration of this OperateUsedJobScheduleModifyPub.
        :type duration: :class:`huaweicloudsdkrds.v3.JobScheduleDurationInfo`
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OperateUsedJobScheduleModifyPub):
            return False
