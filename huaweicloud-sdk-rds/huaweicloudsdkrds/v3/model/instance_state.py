...
class InstanceState:
    ...
    @property
    def status(self):
        r"""Gets the status of this InstanceState.
    ...
    def status(self, status):
        r"""Sets the status of this InstanceState.
    ...
    def wait_restart_for_params(self):
        r"""Gets the wait_restart_for_params of this InstanceState.
    ...
    def wait_restart_for_params(self, wait_restart_for_params):
        r"""Sets the wait_restart_for_params of this InstanceState.
