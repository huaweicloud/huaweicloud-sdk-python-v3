...
class ListPostgresqlHbaInfoHistoryResponse(SdkResponse):
    ...
    openapi_types = {
        'body': 'list[PostgresqlHbaHistory]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListPostgresqlHbaInfoHistoryResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListPostgresqlHbaInfoHistoryResponse):
            return False
