...
class ListPostgresqlDbUserPaginatedResponse(SdkResponse):
    ...
    def __init__(self, users=None, total_count=None):
        r"""ListPostgresqlDbUserPaginatedResponse
    ...
    @property
    def users(self):
        r"""Gets the users of this ListPostgresqlDbUserPaginatedResponse.
    ...
    def users(self, users):
        r"""Sets the users of this ListPostgresqlDbUserPaginatedResponse.
    ...
    def total_count(self):
        r"""Gets the total_count of this ListPostgresqlDbUserPaginatedResponse.
    ...
    def total_count(self, total_count):
        r"""Sets the total_count of this ListPostgresqlDbUserPaginatedResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListPostgresqlDbUserPaginatedResponse.to_dict() is deprecated and no longer maintained, "
