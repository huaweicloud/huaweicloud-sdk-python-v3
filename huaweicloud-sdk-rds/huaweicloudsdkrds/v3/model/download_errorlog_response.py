...
class DownloadErrorlogResponse(SdkResponse):
    ...
    openapi_types = {
        'list': 'list[ErrorlogDownloadInfo]',
        'status': 'str',
        'count': 'int'
    }
    ...
    def __init__(self, list=None, status=None, count=None):
        """DownloadErrorlogResponse

        The model defined in huaweicloud sdk

        :param list: 错误日志下载链接列表
        :type list: list[:class:`huaweicloudsdkrds.v3.ErrorlogDownloadInfo`]
    ...
    @property
    def list(self):
        """Gets the list of this DownloadErrorlogResponse.

        错误日志下载链接列表

        :return: The list of this DownloadErrorlogResponse.
        :rtype: list[:class:`huaweicloudsdkrds.v3.ErrorlogDownloadInfo`]
        """
        return self._list

    @list.setter
    def list(self, list):
        """Sets the list of this DownloadErrorlogResponse.
    ...
    @property
    def status(self):
        """Gets the status of this DownloadErrorlogResponse.
    ...
    def status(self, status):
        """Sets the status of this DownloadErrorlogResponse.
    ...
    @property
    def count(self):
        """Gets the count of this DownloadErrorlogResponse.
    ...
    def count(self, count):
        """Sets the count of this DownloadErrorlogResponse.
