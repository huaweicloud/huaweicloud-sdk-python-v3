...
class UsedJobSchedule:
    ...
    @property
    def id(self):
        r"""Gets the id of this UsedJobSchedule.

        策略id。

        :return: The id of this UsedJobSchedule.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this UsedJobSchedule.

        策略id。

        :param id: The id of this UsedJobSchedule.
        :type id: str
        """
        self._id = id
    ...
    def job_schedule_type(self):
        r"""Gets the job_schedule_type of this UsedJobSchedule.

        计划类型。默认值recurring。  automatically：SQL Server代理启动时自动启动。 cpu_idle：CPU空闲时启动。 recurring：重复执行。 one_time：执行一次。

        :return: The job_schedule_type of this UsedJobSchedule.
        :rtype: str
        """
    ...
    def job_schedule_type(self, job_schedule_type):
        r"""Sets the job_schedule_type of this UsedJobSchedule.

        计划类型。默认值recurring。  automatically：SQL Server代理启动时自动启动。 cpu_idle：CPU空闲时启动。 recurring：重复执行。 one_time：执行一次。

        :param job_schedule_type: The job_schedule_type of this UsedJobSchedule.
        :type job_schedule_type: str
        """
    ...
    def one_time_occurrence(self):
        r"""Gets the one_time_occurrence of this UsedJobSchedule.

        :return: The one_time_occurrence of this UsedJobSchedule.
    ...
    def one_time_occurrence(self, one_time_occurrence):
        r"""Sets the one_time_occurrence of this UsedJobSchedule.

        :param one_time_occurrence: The one_time_occurrence of this UsedJobSchedule.
        :type one_time_occurrence: :class:`huaweicloudsdkrds.v3.JobScheduleOneTimeOccurrenceInfo`
        """
    ...
    @property
    def frequency(self):
        r"""Gets the frequency of this UsedJobSchedule.

        :return: The frequency of this UsedJobSchedule.
    ...
    def frequency(self, frequency):
        r"""Sets the frequency of this UsedJobSchedule.

        :param frequency: The frequency of this UsedJobSchedule.
        :type frequency: :class:`huaweicloudsdkrds.v3.JobScheduleFrequencyInfo`
        """
    ...
    def daily_frequency(self):
        r"""Gets the daily_frequency of this UsedJobSchedule.

        :return: The daily_frequency of this UsedJobSchedule.
    ...
    def daily_frequency(self, daily_frequency):
        r"""Sets the daily_frequency of this UsedJobSchedule.

        :param daily_frequency: The daily_frequency of this UsedJobSchedule.
        :type daily_frequency: :class:`huaweicloudsdkrds.v3.JobScheduleDailyFrequencyInfo`
        """
    ...
    @property
    def duration(self):
        r"""Gets the duration of this UsedJobSchedule.

        :return: The duration of this UsedJobSchedule.
    ...
    def duration(self, duration):
        r"""Sets the duration of this UsedJobSchedule.

        :param duration: The duration of this UsedJobSchedule.
        :type duration: :class:`huaweicloudsdkrds.v3.JobScheduleDurationInfo`
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UsedJobSchedule):
            return False
