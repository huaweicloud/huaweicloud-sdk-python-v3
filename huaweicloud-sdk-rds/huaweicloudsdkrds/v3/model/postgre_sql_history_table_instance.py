...
class PostgreSQLHistoryTableInstance:
    ...
    openapi_types = {
        ...
        'name': 'str',
        'total_tables': 'int',
        'databases': 'list[PostgreSQLHistoryDatabase]'
    }
    ...
    def __init__(self, id=None, name=None, total_tables=None, databases=None):
        ...
        :type databases: list[:class:`huaweicloudsdkrds.v3.PostgreSQLHistoryDatabase`]
        """
    ...
    def id(self):
        ...
        :return: The id of this PostgreSQLHistoryTableInstance.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this PostgreSQLHistoryTableInstance.
        :type id: str
        """
        self._id = id
    ...
    def name(self):
        ...
        :return: The name of this PostgreSQLHistoryTableInstance.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this PostgreSQLHistoryTableInstance.
        :type name: str
        """
        self._name = name
    ...
    def total_tables(self):
        ...
        :return: The total_tables of this PostgreSQLHistoryTableInstance.
        :rtype: int
        """
    ...
    def total_tables(self, total_tables):
        ...
        :param total_tables: The total_tables of this PostgreSQLHistoryTableInstance.
        :type total_tables: int
        """
    ...
    def databases(self):
        ...
        :return: The databases of this PostgreSQLHistoryTableInstance.
        :rtype: list[:class:`huaweicloudsdkrds.v3.PostgreSQLHistoryDatabase`]
        """
    ...
    def databases(self, databases):
        ...
        :param databases: The databases of this PostgreSQLHistoryTableInstance.
        :type databases: list[:class:`huaweicloudsdkrds.v3.PostgreSQLHistoryDatabase`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PostgreSQLHistoryTableInstance):
            return False
