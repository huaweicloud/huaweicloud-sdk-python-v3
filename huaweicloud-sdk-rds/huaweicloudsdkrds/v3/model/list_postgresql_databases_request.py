...
class ListPostgresqlDatabasesRequest:
    ...
    def __init__(self, x_language=None, instance_id=None, page=None, limit=None):
        """ListPostgresqlDatabasesRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListPostgresqlDatabasesRequest):
            return False
