...
class DeleteDatabaseResponse(SdkResponse):
    ...
    def resp(self):
        ...
        :return: The resp of this DeleteDatabaseResponse.
        :rtype: str
        """
        return self._resp
    ...
    def resp(self, resp):
        ...
        :param resp: The resp of this DeleteDatabaseResponse.
        :type resp: str
        """
        self._resp = resp
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteDatabaseResponse.to_dict() is deprecated and no longer maintained, "
