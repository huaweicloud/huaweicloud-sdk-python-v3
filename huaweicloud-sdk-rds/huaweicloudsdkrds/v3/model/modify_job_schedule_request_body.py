...
class ModifyJobScheduleRequestBody:
    ...
    def __init__(self, job_schedule_type=None, one_time_occurrence=None, frequency=None, daily_frequency=None, duration=None):
        r"""ModifyJobScheduleRequestBody
    ...
    def job_schedule_type(self):
        r"""Gets the job_schedule_type of this ModifyJobScheduleRequestBody.

        计划类型。默认值recurring。  automatically：SQL Server代理启动时自动启动。 cpu_idle：CPU空闲时启动。 recurring：重复执行。 one_time：执行一次。

        :return: The job_schedule_type of this ModifyJobScheduleRequestBody.
        :rtype: str
        """
    ...
    def job_schedule_type(self, job_schedule_type):
        r"""Sets the job_schedule_type of this ModifyJobScheduleRequestBody.

        计划类型。默认值recurring。  automatically：SQL Server代理启动时自动启动。 cpu_idle：CPU空闲时启动。 recurring：重复执行。 one_time：执行一次。

        :param job_schedule_type: The job_schedule_type of this ModifyJobScheduleRequestBody.
        :type job_schedule_type: str
        """
    ...
    def one_time_occurrence(self):
        r"""Gets the one_time_occurrence of this ModifyJobScheduleRequestBody.

        :return: The one_time_occurrence of this ModifyJobScheduleRequestBody.
    ...
    def one_time_occurrence(self, one_time_occurrence):
        r"""Sets the one_time_occurrence of this ModifyJobScheduleRequestBody.

        :param one_time_occurrence: The one_time_occurrence of this ModifyJobScheduleRequestBody.
        :type one_time_occurrence: :class:`huaweicloudsdkrds.v3.JobScheduleOneTimeOccurrenceInfo`
        """
    ...
    @property
    def frequency(self):
        r"""Gets the frequency of this ModifyJobScheduleRequestBody.

        :return: The frequency of this ModifyJobScheduleRequestBody.
    ...
    def frequency(self, frequency):
        r"""Sets the frequency of this ModifyJobScheduleRequestBody.

        :param frequency: The frequency of this ModifyJobScheduleRequestBody.
        :type frequency: :class:`huaweicloudsdkrds.v3.JobScheduleFrequencyInfo`
        """
    ...
    def daily_frequency(self):
        r"""Gets the daily_frequency of this ModifyJobScheduleRequestBody.

        :return: The daily_frequency of this ModifyJobScheduleRequestBody.
    ...
    def daily_frequency(self, daily_frequency):
        r"""Sets the daily_frequency of this ModifyJobScheduleRequestBody.

        :param daily_frequency: The daily_frequency of this ModifyJobScheduleRequestBody.
        :type daily_frequency: :class:`huaweicloudsdkrds.v3.JobScheduleDailyFrequencyInfo`
        """
    ...
    @property
    def duration(self):
        r"""Gets the duration of this ModifyJobScheduleRequestBody.

        :return: The duration of this ModifyJobScheduleRequestBody.
    ...
    def duration(self, duration):
        r"""Sets the duration of this ModifyJobScheduleRequestBody.

        :param duration: The duration of this ModifyJobScheduleRequestBody.
        :type duration: :class:`huaweicloudsdkrds.v3.JobScheduleDurationInfo`
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModifyJobScheduleRequestBody):
            return False
