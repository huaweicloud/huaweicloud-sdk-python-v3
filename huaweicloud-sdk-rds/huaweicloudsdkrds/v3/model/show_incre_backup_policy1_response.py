...
class ShowIncreBackupPolicy1Response(SdkResponse):
    ...
    def __init__(self, incre_backup_policy=None):
        ...
        if incre_backup_policy is not None:
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowIncreBackupPolicy1Response.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowIncreBackupPolicy1Response):
            return False
