...
class BatchRestoreDatabaseRequest:
    ...
    openapi_types = {
        'body': 'PostgreSQLRestoreDatabaseRequest'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchRestoreDatabaseRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchRestoreDatabaseRequest):
            return False
