...
class CreateDiskSpaceDiagnosisResponse(SdkResponse):
    ...
    def __init__(self, result=None):
        r"""CreateDiskSpaceDiagnosisResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateDiskSpaceDiagnosisResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateDiskSpaceDiagnosisResponse):
            return False
