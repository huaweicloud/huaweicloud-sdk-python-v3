...
class BatchRestorePostgreSqlTablesRequest:
    ...
    openapi_types = {
        'body': 'PostgreSQLRestoreTableRequest'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchRestorePostgreSqlTablesRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchRestorePostgreSqlTablesRequest):
            return False
