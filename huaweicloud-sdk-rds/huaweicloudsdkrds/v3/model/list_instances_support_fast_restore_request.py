...
class ListInstancesSupportFastRestoreRequest:
    ...
    openapi_types = {
        'x_language': 'str',
        'body': 'ListInstancesSupportFastRestoreRequestBody'
    }
    ...
    def __init__(self, x_language=None, body=None):
        ...
        :param x_language: 语言
        :type x_language: str
        :param body: Body of the ListInstancesSupportFastRestoreRequest
    ...
    def x_language(self):
        ...
        :return: The x_language of this ListInstancesSupportFastRestoreRequest.
        :rtype: str
        """
    ...
    def x_language(self, x_language):
        ...
        :param x_language: The x_language of this ListInstancesSupportFastRestoreRequest.
        :type x_language: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListInstancesSupportFastRestoreRequest):
            return False
