...
class GetTaskDetailListRspJobsInstance:
    ...
    def id(self):
        ...
        :return: The id of this GetTaskDetailListRspJobsInstance.
        :rtype: str
        """
        return self._id
    ...
    def name(self):
        ...
        :return: The name of this GetTaskDetailListRspJobsInstance.
        :rtype: str
        """
        return self._name
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetTaskDetailListRspJobsInstance):
            return False
