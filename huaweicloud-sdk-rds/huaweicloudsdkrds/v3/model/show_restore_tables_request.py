...
class ShowRestoreTablesRequest:
    ...
    openapi_types = {
        'instance_id': 'str',
        'x_language': 'str',
        'body': 'ShowRestoreTablesRequestBody'
    }
    ...
    def __init__(self, instance_id=None, x_language=None, body=None):
        ...
        :type x_language: str
        :param body: Body of the ShowRestoreTablesRequest
        :type body: :class:`huaweicloudsdkrds.v3.ShowRestoreTablesRequestBody`
        """
    ...
    @property
    def body(self):
        r"""Gets the body of this ShowRestoreTablesRequest.

        :return: The body of this ShowRestoreTablesRequest.
        :rtype: :class:`huaweicloudsdkrds.v3.ShowRestoreTablesRequestBody`
        """
        return self._body

    @body.setter
    def body(self, body):
        r"""Sets the body of this ShowRestoreTablesRequest.

        :param body: The body of this ShowRestoreTablesRequest.
        :type body: :class:`huaweicloudsdkrds.v3.ShowRestoreTablesRequestBody`
        """
        self._body = body
