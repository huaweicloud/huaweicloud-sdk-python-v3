...
class CreateJobScheduleRequestBody:
    ...
    def __init__(self, schedule_type=None, job_schedule_type=None, one_time_occurrence=None, frequency=None, daily_frequency=None, duration=None):
        r"""CreateJobScheduleRequestBody
    ...
    def schedule_type(self):
        r"""Gets the schedule_type of this CreateJobScheduleRequestBody.

        策略类型，snapshot:快照策略, sync:同步策略。

        :return: The schedule_type of this CreateJobScheduleRequestBody.
        :rtype: str
        """
    ...
    def schedule_type(self, schedule_type):
        r"""Sets the schedule_type of this CreateJobScheduleRequestBody.

        策略类型，snapshot:快照策略, sync:同步策略。

        :param schedule_type: The schedule_type of this CreateJobScheduleRequestBody.
        :type schedule_type: str
        """
    ...
    def job_schedule_type(self):
        r"""Gets the job_schedule_type of this CreateJobScheduleRequestBody.

        计划类型。默认值recurring。  automatically：SQL Server代理启动时自动启动。 cpu_idle：CPU空闲时启动。 recurring：重复执行。 one_time：执行一次。

        :return: The job_schedule_type of this CreateJobScheduleRequestBody.
        :rtype: str
        """
    ...
    def job_schedule_type(self, job_schedule_type):
        r"""Sets the job_schedule_type of this CreateJobScheduleRequestBody.

        计划类型。默认值recurring。  automatically：SQL Server代理启动时自动启动。 cpu_idle：CPU空闲时启动。 recurring：重复执行。 one_time：执行一次。

        :param job_schedule_type: The job_schedule_type of this CreateJobScheduleRequestBody.
        :type job_schedule_type: str
        """
    ...
    def one_time_occurrence(self):
        r"""Gets the one_time_occurrence of this CreateJobScheduleRequestBody.

        :return: The one_time_occurrence of this CreateJobScheduleRequestBody.
    ...
    def one_time_occurrence(self, one_time_occurrence):
        r"""Sets the one_time_occurrence of this CreateJobScheduleRequestBody.

        :param one_time_occurrence: The one_time_occurrence of this CreateJobScheduleRequestBody.
        :type one_time_occurrence: :class:`huaweicloudsdkrds.v3.JobScheduleOneTimeOccurrenceInfo`
        """
    ...
    @property
    def frequency(self):
        r"""Gets the frequency of this CreateJobScheduleRequestBody.

        :return: The frequency of this CreateJobScheduleRequestBody.
    ...
    def frequency(self, frequency):
        r"""Sets the frequency of this CreateJobScheduleRequestBody.

        :param frequency: The frequency of this CreateJobScheduleRequestBody.
        :type frequency: :class:`huaweicloudsdkrds.v3.JobScheduleFrequencyInfo`
        """
    ...
    def daily_frequency(self):
        r"""Gets the daily_frequency of this CreateJobScheduleRequestBody.

        :return: The daily_frequency of this CreateJobScheduleRequestBody.
    ...
    def daily_frequency(self, daily_frequency):
        r"""Sets the daily_frequency of this CreateJobScheduleRequestBody.

        :param daily_frequency: The daily_frequency of this CreateJobScheduleRequestBody.
        :type daily_frequency: :class:`huaweicloudsdkrds.v3.JobScheduleDailyFrequencyInfo`
        """
    ...
    @property
    def duration(self):
        r"""Gets the duration of this CreateJobScheduleRequestBody.

        :return: The duration of this CreateJobScheduleRequestBody.
    ...
    def duration(self, duration):
        r"""Sets the duration of this CreateJobScheduleRequestBody.

        :param duration: The duration of this CreateJobScheduleRequestBody.
        :type duration: :class:`huaweicloudsdkrds.v3.JobScheduleDurationInfo`
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateJobScheduleRequestBody):
            return False
