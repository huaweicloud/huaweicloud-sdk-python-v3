...
class ListRecycleInstancesResponse(SdkResponse):
    ...
    openapi_types = {
        'total_count': 'int',
        'instances': 'list[RecycleInstsanceV3]'
    }
    ...
    def __init__(self, total_count=None, instances=None):
        ...
        :param total_count: 回收站数据条数
        :type total_count: int
        :param instances: 回收站信息
        :type instances: list[:class:`huaweicloudsdkrds.v3.RecycleInstsanceV3`]
        """
    ...
    def instances(self):
        ...
        :rtype: list[:class:`huaweicloudsdkrds.v3.RecycleInstsanceV3`]
        """
