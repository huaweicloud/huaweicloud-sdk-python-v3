...
class ListPipelineTemplatesResponse(SdkResponse):
    ...
    @property
    def count(self):
        r"""Gets the count of this ListPipelineTemplatesResponse.
    ...
    def count(self, count):
        r"""Sets the count of this ListPipelineTemplatesResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListPipelineTemplatesResponse.to_dict() is deprecated and no longer maintained, "
