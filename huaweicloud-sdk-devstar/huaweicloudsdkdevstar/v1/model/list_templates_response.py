...
class ListTemplatesResponse(SdkResponse):
    ...
    def invalid_count(self):
        r"""Gets the invalid_count of this ListTemplatesResponse.

        返回关联了失效资源的模板数量。

        :return: The invalid_count of this ListTemplatesResponse.
        :rtype: int
        """
    ...
    def invalid_count(self, invalid_count):
        r"""Sets the invalid_count of this ListTemplatesResponse.
