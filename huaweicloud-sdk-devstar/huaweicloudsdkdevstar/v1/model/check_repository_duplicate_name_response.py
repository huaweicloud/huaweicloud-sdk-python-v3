...
class CheckRepositoryDuplicateNameResponse(SdkResponse):
    ...
    def result(self):
        ...
        :return: The result of this CheckRepositoryDuplicateNameResponse.
        :rtype: bool
        """
        return self._result
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CheckRepositoryDuplicateNameResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CheckRepositoryDuplicateNameResponse):
            return False
