...
class CreateMergeRequestDiscussionRequest:
    ...
    openapi_types = {
        ...
        'body': 'CreateMergeRequestNoteDto'
    }
    ...
    def __init__(self, repository_id=None, merge_request_iid=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkcodeartsrepo.v4.CreateMergeRequestNoteDto`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v4.CreateMergeRequestNoteDto`
        """
        return self._body
