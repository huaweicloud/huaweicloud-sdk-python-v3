...
class ShowRepositoryPermissionInheritEnabledResponse(SdkResponse):
    ...
    def __init__(self, inherit_parent_permission=None):
        r"""ShowRepositoryPermissionInheritEnabledResponse
    ...
    def inherit_parent_permission(self):
        r"""Gets the inherit_parent_permission of this ShowRepositoryPermissionInheritEnabledResponse.

        **参数解释：** 权限继承设置。 **约束限制：** 不涉及。 **取值范围：** - true，使用上层权限配置，如果上层是代码组使用代码组权限配置，如果上层是项目使用项目权限配置。 - false，使用仓库权限配置。 

        :return: The inherit_parent_permission of this ShowRepositoryPermissionInheritEnabledResponse.
        :rtype: bool
        """
    ...
    def inherit_parent_permission(self, inherit_parent_permission):
        r"""Sets the inherit_parent_permission of this ShowRepositoryPermissionInheritEnabledResponse.

        **参数解释：** 权限继承设置。 **约束限制：** 不涉及。 **取值范围：** - true，使用上层权限配置，如果上层是代码组使用代码组权限配置，如果上层是项目使用项目权限配置。 - false，使用仓库权限配置。 

        :param inherit_parent_permission: The inherit_parent_permission of this ShowRepositoryPermissionInheritEnabledResponse.
        :type inherit_parent_permission: bool
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowRepositoryPermissionInheritEnabledResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowRepositoryPermissionInheritEnabledResponse):
            return False
