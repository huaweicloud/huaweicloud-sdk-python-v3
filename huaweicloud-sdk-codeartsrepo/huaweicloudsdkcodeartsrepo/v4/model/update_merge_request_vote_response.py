...
class UpdateMergeRequestVoteResponse(SdkResponse):
    ...
    def __init__(self, id=None, merge_request_id=None, score=None, author=None):
        ...
        :type score: int
        :param author: 
        :type author: :class:`huaweicloudsdkcodeartsrepo.v4.UserSafeDto`
        """
    ...
    def author(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v4.UserSafeDto`
        """
        return self._author
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateMergeRequestVoteResponse.to_dict() is deprecated and no longer maintained, "
