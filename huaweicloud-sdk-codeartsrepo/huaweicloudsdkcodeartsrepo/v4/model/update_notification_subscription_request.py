...
class UpdateNotificationSubscriptionRequest:
    ...
    def __init__(self, repository_id=None, type=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkcodeartsrepo.v4.UpdateRepoNotificationSubscriptionDto`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v4.UpdateRepoNotificationSubscriptionDto`
        """
        return self._body
