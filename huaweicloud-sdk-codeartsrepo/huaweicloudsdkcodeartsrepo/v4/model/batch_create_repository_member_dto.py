...
class BatchCreateRepositoryMemberDto:
    ...
    def __init__(self, status=None, result=None):
        ...
        :type result: list[:class:`huaweicloudsdkcodeartsrepo.v4.CreateRepositoryMemberResponseDto`]
        """
    ...
    def result(self):
        ...
        **参数解释：** 批量添加结果详情。 **约束限制：** 不涉及。
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.CreateRepositoryMemberResponseDto`]
        """
        return self._result
