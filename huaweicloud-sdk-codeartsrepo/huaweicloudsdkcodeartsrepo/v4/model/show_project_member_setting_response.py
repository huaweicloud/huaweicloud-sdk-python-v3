...
class ShowProjectMemberSettingResponse(SdkResponse):
    ...
    def __init__(self, product_id=None, sync_enabled=None, sync_all_role_enabled=None, role_sync=None):
        ...
        :type role_sync: list[:class:`huaweicloudsdkcodeartsrepo.v4.RoleSyncDto`]
        """
    ...
    def role_sync(self):
        ...
        **参数解释：** 角色同步
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.RoleSyncDto`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowProjectMemberSettingResponse.to_dict() is deprecated and no longer maintained, "
