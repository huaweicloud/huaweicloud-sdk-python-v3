...
class ListUserGpgKeysResponse(SdkResponse):
    ...
    def __init__(self, id=None, created_at=None, emails_with_verified_status=None, fingerprint=None, key=None, description=None, title=None, primary_keyid=None, active=None, subkeys=None):
        ...
        :type subkeys: list[:class:`huaweicloudsdkcodeartsrepo.v4.GpgSubKeyDto`]
        """
    ...
    def subkeys(self):
        ...
        **参数解释：** 子钥列表。 **取值范围：** 列表长度不少于0，不超过1000。
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.GpgSubKeyDto`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListUserGpgKeysResponse.to_dict() is deprecated and no longer maintained, "
