...
class ShowCommitResponse(SdkResponse):
    ...
    @property
    def author_id(self):
        r"""Gets the author_id of this ShowCommitResponse.

        作者id

        :return: The author_id of this ShowCommitResponse.
        :rtype: int
        """
    ...
    def author_id(self, author_id):
        r"""Sets the author_id of this ShowCommitResponse.

        作者id

        :param author_id: The author_id of this ShowCommitResponse.
        :type author_id: int
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowCommitResponse.to_dict() is deprecated and no longer maintained, "
