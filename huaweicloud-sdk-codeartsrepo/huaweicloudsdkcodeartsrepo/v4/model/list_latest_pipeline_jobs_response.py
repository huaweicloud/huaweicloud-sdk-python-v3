...
class ListLatestPipelineJobsResponse(SdkResponse):
    ...
    def __init__(self, id=None, status=None, stages=None):
        ...
        :type status: str
        :param stages: 
        :type stages: list[:class:`huaweicloudsdkcodeartsrepo.v4.PipelineStageJobDto`]
        """
    ...
    def stages(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.PipelineStageJobDto`]
        """
        return self._stages
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListLatestPipelineJobsResponse.to_dict() is deprecated and no longer maintained, "
