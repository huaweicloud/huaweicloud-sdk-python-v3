...
class ProjectSettingsInheritCfgDto:
    ...
    def __init__(self, name=None, inherit_mod=None):
        r"""ProjectSettingsInheritCfgDto
    ...
    def inherit_mod(self):
        r"""Gets the inherit_mod of this ProjectSettingsInheritCfgDto.

        **参数解释：** 继承设置。 **约束限制：** 不涉及。 **取值范围：** - force_inherit，强制继承配置。 - custom，使用当前配置。 **默认取值：** 不涉及。

        :return: The inherit_mod of this ProjectSettingsInheritCfgDto.
        :rtype: str
        """
    ...
    def inherit_mod(self, inherit_mod):
        r"""Sets the inherit_mod of this ProjectSettingsInheritCfgDto.

        **参数解释：** 继承设置。 **约束限制：** 不涉及。 **取值范围：** - force_inherit，强制继承配置。 - custom，使用当前配置。 **默认取值：** 不涉及。

        :param inherit_mod: The inherit_mod of this ProjectSettingsInheritCfgDto.
        :type inherit_mod: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProjectSettingsInheritCfgDto):
            return False
