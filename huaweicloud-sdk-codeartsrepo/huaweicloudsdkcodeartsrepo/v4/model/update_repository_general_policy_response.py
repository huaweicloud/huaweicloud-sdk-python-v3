...
class UpdateRepositoryGeneralPolicyResponse(SdkResponse):
    ...
    def repo_encryption_enabled(self):
        r"""Gets the repo_encryption_enabled of this UpdateRepositoryGeneralPolicyResponse.

        **参数解释：** 是否开启仓库加密。 **约束限制：** 不涉及。 **取值范围：** - true，开启仓库加密。 - false，关闭仓库加密。

        :return: The repo_encryption_enabled of this UpdateRepositoryGeneralPolicyResponse.
        :rtype: bool
        """
    ...
    def repo_encryption_enabled(self, repo_encryption_enabled):
        r"""Sets the repo_encryption_enabled of this UpdateRepositoryGeneralPolicyResponse.

        **参数解释：** 是否开启仓库加密。 **约束限制：** 不涉及。 **取值范围：** - true，开启仓库加密。 - false，关闭仓库加密。

        :param repo_encryption_enabled: The repo_encryption_enabled of this UpdateRepositoryGeneralPolicyResponse.
        :type repo_encryption_enabled: bool
        """
    ...
    def repo_encryption_status(self):
        r"""Gets the repo_encryption_status of this UpdateRepositoryGeneralPolicyResponse.

        :return: The repo_encryption_status of this UpdateRepositoryGeneralPolicyResponse.
    ...
    def repo_encryption_status(self, repo_encryption_status):
        r"""Sets the repo_encryption_status of this UpdateRepositoryGeneralPolicyResponse.

        :param repo_encryption_status: The repo_encryption_status of this UpdateRepositoryGeneralPolicyResponse.
        :type repo_encryption_status: :class:`huaweicloudsdkcodeartsrepo.v4.ProjectEncryptionStatusBriefDto`
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateRepositoryGeneralPolicyResponse.to_dict() is deprecated and no longer maintained, "
