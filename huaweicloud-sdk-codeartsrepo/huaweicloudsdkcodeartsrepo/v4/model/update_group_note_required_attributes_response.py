...
class UpdateGroupNoteRequiredAttributesResponse(SdkResponse):
    ...
    def __init__(self, note_required_attributes=None):
        r"""UpdateGroupNoteRequiredAttributesResponse
    ...
    def note_required_attributes(self):
        r"""Gets the note_required_attributes of this UpdateGroupNoteRequiredAttributesResponse.

        **参数解释：** 检视意见必填项。

        :return: The note_required_attributes of this UpdateGroupNoteRequiredAttributesResponse.
    ...
    def note_required_attributes(self, note_required_attributes):
        r"""Sets the note_required_attributes of this UpdateGroupNoteRequiredAttributesResponse.

        **参数解释：** 检视意见必填项。

        :param note_required_attributes: The note_required_attributes of this UpdateGroupNoteRequiredAttributesResponse.
        :type note_required_attributes: list[:class:`huaweicloudsdkcodeartsrepo.v4.RequiredAttributeDto`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateGroupNoteRequiredAttributesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateGroupNoteRequiredAttributesResponse):
            return False
