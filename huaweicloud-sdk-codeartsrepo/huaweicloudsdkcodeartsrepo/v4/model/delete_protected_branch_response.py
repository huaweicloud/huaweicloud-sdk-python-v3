...
class DeleteProtectedBranchResponse(SdkResponse):
    ...
    def __init__(self, status=None):
        r"""DeleteProtectedBranchResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteProtectedBranchResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteProtectedBranchResponse):
            return False
