...
class UpdateRepositoryGeneralCommitRuleResponse(SdkResponse):
    ...
    def __init__(self, reject_unsigned_commits=None, reject_not_signed_by_gpg=None, deny_delete_tag=None, prevent_secrets=None, deny_force_push=None):
        r"""UpdateRepositoryGeneralCommitRuleResponse
    ...
    def reject_unsigned_commits(self):
        r"""Gets the reject_unsigned_commits of this UpdateRepositoryGeneralCommitRuleResponse.

        **参数解释：** 是否拒绝未Signed-off-by签名的提交。 **约束限制：** 不涉及。 **取值范围：** - true，拒绝未Signed-off-by签名的提交。 - false，允许未Signed-off-by签名的提交。 **默认取值：** 不涉及。

        :return: The reject_unsigned_commits of this UpdateRepositoryGeneralCommitRuleResponse.
        :rtype: bool
        """
    ...
    def reject_unsigned_commits(self, reject_unsigned_commits):
        r"""Sets the reject_unsigned_commits of this UpdateRepositoryGeneralCommitRuleResponse.

        **参数解释：** 是否拒绝未Signed-off-by签名的提交。 **约束限制：** 不涉及。 **取值范围：** - true，拒绝未Signed-off-by签名的提交。 - false，允许未Signed-off-by签名的提交。 **默认取值：** 不涉及。

        :param reject_unsigned_commits: The reject_unsigned_commits of this UpdateRepositoryGeneralCommitRuleResponse.
        :type reject_unsigned_commits: bool
        """
    ...
    def reject_not_signed_by_gpg(self):
        r"""Gets the reject_not_signed_by_gpg of this UpdateRepositoryGeneralCommitRuleResponse.

        **参数解释：** 是否拒绝未GPG签名的提交。 **约束限制：** 不涉及。 **取值范围：** - true，拒绝未GPG签名的提交。 - false，允许未GPG签名的提交。 **默认取值：** 不涉及。

        :return: The reject_not_signed_by_gpg of this UpdateRepositoryGeneralCommitRuleResponse.
        :rtype: bool
        """
    ...
    def reject_not_signed_by_gpg(self, reject_not_signed_by_gpg):
        r"""Sets the reject_not_signed_by_gpg of this UpdateRepositoryGeneralCommitRuleResponse.

        **参数解释：** 是否拒绝未GPG签名的提交。 **约束限制：** 不涉及。 **取值范围：** - true，拒绝未GPG签名的提交。 - false，允许未GPG签名的提交。 **默认取值：** 不涉及。

        :param reject_not_signed_by_gpg: The reject_not_signed_by_gpg of this UpdateRepositoryGeneralCommitRuleResponse.
        :type reject_not_signed_by_gpg: bool
        """
    ...
    def deny_delete_tag(self):
        r"""Gets the deny_delete_tag of this UpdateRepositoryGeneralCommitRuleResponse.

        **参数解释：** 是否不允许删除Tags。 **约束限制：** 不涉及。 **取值范围：** - true，不允许删除Tags。 - false，允许删除Tags。 **默认取值：** 不涉及。

        :return: The deny_delete_tag of this UpdateRepositoryGeneralCommitRuleResponse.
        :rtype: bool
        """
    ...
    def deny_delete_tag(self, deny_delete_tag):
        r"""Sets the deny_delete_tag of this UpdateRepositoryGeneralCommitRuleResponse.

        **参数解释：** 是否不允许删除Tags。 **约束限制：** 不涉及。 **取值范围：** - true，不允许删除Tags。 - false，允许删除Tags。 **默认取值：** 不涉及。

        :param deny_delete_tag: The deny_delete_tag of this UpdateRepositoryGeneralCommitRuleResponse.
        :type deny_delete_tag: bool
        """
    ...
    def prevent_secrets(self):
        r"""Gets the prevent_secrets of this UpdateRepositoryGeneralCommitRuleResponse.

        **参数解释：** 是否阻止包含涉密文件的提交。 **约束限制：** 不涉及。 **取值范围：** - true，阻止包含涉密文件的提交。 - false，允许包含涉密文件的提交。 **默认取值：** 不涉及。

        :return: The prevent_secrets of this UpdateRepositoryGeneralCommitRuleResponse.
        :rtype: bool
        """
    ...
    def prevent_secrets(self, prevent_secrets):
        r"""Sets the prevent_secrets of this UpdateRepositoryGeneralCommitRuleResponse.

        **参数解释：** 是否阻止包含涉密文件的提交。 **约束限制：** 不涉及。 **取值范围：** - true，阻止包含涉密文件的提交。 - false，允许包含涉密文件的提交。 **默认取值：** 不涉及。

        :param prevent_secrets: The prevent_secrets of this UpdateRepositoryGeneralCommitRuleResponse.
        :type prevent_secrets: bool
        """
    ...
    def deny_force_push(self):
        r"""Gets the deny_force_push of this UpdateRepositoryGeneralCommitRuleResponse.

        **参数解释：** 是否禁止强制推送。 **约束限制：** 不涉及。 **取值范围：** - true，禁止强制推送。 - false，允许强制推送。 **默认取值：** 不涉及。

        :return: The deny_force_push of this UpdateRepositoryGeneralCommitRuleResponse.
        :rtype: bool
        """
    ...
    def deny_force_push(self, deny_force_push):
        r"""Sets the deny_force_push of this UpdateRepositoryGeneralCommitRuleResponse.

        **参数解释：** 是否禁止强制推送。 **约束限制：** 不涉及。 **取值范围：** - true，禁止强制推送。 - false，允许强制推送。 **默认取值：** 不涉及。

        :param deny_force_push: The deny_force_push of this UpdateRepositoryGeneralCommitRuleResponse.
        :type deny_force_push: bool
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateRepositoryGeneralCommitRuleResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateRepositoryGeneralCommitRuleResponse):
            return False
