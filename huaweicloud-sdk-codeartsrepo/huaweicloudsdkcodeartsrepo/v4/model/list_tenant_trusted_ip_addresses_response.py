...
class ListTenantTrustedIpAddressesResponse(SdkResponse):
    ...
    openapi_types = {
        'body': 'list[TenantTrustedIpAddressDto]',
        'x_total': 'str'
    }
    ...
    def __init__(self, body=None, x_total=None):
        ...
        :param body: 
        :type body: list[:class:`huaweicloudsdkcodeartsrepo.v4.TenantTrustedIpAddressDto`]
        :param x_total: 
        :type x_total: str
        """
    ...
    def body(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.TenantTrustedIpAddressDto`]
        """
        return self._body
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListTenantTrustedIpAddressesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListTenantTrustedIpAddressesResponse):
            return False
