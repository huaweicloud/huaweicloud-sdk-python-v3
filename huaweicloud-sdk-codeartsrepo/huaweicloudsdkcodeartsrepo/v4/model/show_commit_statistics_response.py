...
class ShowCommitStatisticsResponse(SdkResponse):
    ...
    def __init__(self, commits=None, statistics=None, total=None, x_total=None):
        ...
        :type commits: list[:class:`huaweicloudsdkcodeartsrepo.v4.CommitStatisticsResultCommitDto`]
    ...
    def commits(self):
        ...
        **参数解释：** 提交统计。
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.CommitStatisticsResultCommitDto`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowCommitStatisticsResponse.to_dict() is deprecated and no longer maintained, "
