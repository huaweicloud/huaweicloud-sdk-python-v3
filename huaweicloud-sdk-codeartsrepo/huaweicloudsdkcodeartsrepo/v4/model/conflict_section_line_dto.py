...
class ConflictSectionLineDto:
    ...
    def __init__(self, line_code=None, type=None, old_line=None, new_line=None, text=None, meta_data=None, rich_text=None, can_receive_suggestion=None):
        ...
        :type text: str
        :param meta_data: 
        :type meta_data: :class:`huaweicloudsdkcodeartsrepo.v4.ConflictSectionLineMetaDataDto`
        :param rich_text: 富文本
        :type rich_text: str
    ...
    def meta_data(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v4.ConflictSectionLineMetaDataDto`
        """
