...
class ListTrustedIpAddressesResponse(SdkResponse):
    ...
    def __init__(self, body=None, x_total=None):
        ...
        :param body: 
        :type body: list[:class:`huaweicloudsdkcodeartsrepo.v4.TrustedIpAddressDto`]
        :param x_total: 
        :type x_total: str
        """
    ...
    def body(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.TrustedIpAddressDto`]
        """
        return self._body
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListTrustedIpAddressesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListTrustedIpAddressesResponse):
            return False
