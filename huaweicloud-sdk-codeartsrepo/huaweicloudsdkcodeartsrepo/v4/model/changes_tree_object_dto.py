...
class ChangesTreeObjectDto:
    ...
    def __init__(self, title=None, level=None, file_path=None, file_type=None, diff=None, items=None):
        ...
        :type file_type: str
        :param diff: 
        :type diff: :class:`huaweicloudsdkcodeartsrepo.v4.ChangesTreeObjectDiffDto`
        :param items: **参数解释：** 子文件变更。
        :type items: list[:class:`huaweicloudsdkcodeartsrepo.v4.ChangesTreeObjectDto`]
        """
    ...
    def diff(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v4.ChangesTreeObjectDiffDto`
        """
        return self._diff
    ...
    def items(self):
        ...
        **参数解释：** 子文件变更。
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.ChangesTreeObjectDto`]
        """
        return self._items
