...
class UpdateMergeRequestSettingResponse(SdkResponse):
    ...
    def __init__(self, id=None, disable_merge_by_self=None, disable_approve_by_self=None, disable_review_by_self=None, created_at=None, updated_at=None, can_force_merge=None, disable_squash_merge=None, must_relate_issue=None, need_relate_issue_branches=None, need_all_issues_check_passed=None, review_mode=None, add_notes_after_merged=None, merged_commit_author=None, evaluation_role=None, evaluation_merge_gate=None, mark_auto_merged_mr_as_closed=None, delete_source_branch_when_merged=None, auto_squash_merge=None, squash_merge_with_no_merge_commit=None, only_allow_one_issue_check_passed=None, enable_custom_evaluation=None, evaluation_types=None, can_reopen=None, only_allow_merge_if_all_discussions_are_resolved=None, merge_method=None, only_allow_merge_if_vote_bigger_than=None, only_assignee_can_merge=None, repository_id=None, has_evaluation_permission=None):
        r"""UpdateMergeRequestSettingResponse
    ...
    @property
    def id(self):
        r"""Gets the id of this UpdateMergeRequestSettingResponse.

        **参数解释：** 主键id

        :return: The id of this UpdateMergeRequestSettingResponse.
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this UpdateMergeRequestSettingResponse.

        **参数解释：** 主键id

        :param id: The id of this UpdateMergeRequestSettingResponse.
        :type id: int
        """
        self._id = id
    ...
    def disable_merge_by_self(self):
        r"""Gets the disable_merge_by_self of this UpdateMergeRequestSettingResponse.

        **参数解释：** 禁止合入自己创建的合并请求

        :return: The disable_merge_by_self of this UpdateMergeRequestSettingResponse.
        :rtype: bool
        """
    ...
    def disable_merge_by_self(self, disable_merge_by_self):
        r"""Sets the disable_merge_by_self of this UpdateMergeRequestSettingResponse.

        **参数解释：** 禁止合入自己创建的合并请求

        :param disable_merge_by_self: The disable_merge_by_self of this UpdateMergeRequestSettingResponse.
        :type disable_merge_by_self: bool
        """
    ...
    def disable_approve_by_self(self):
        r"""Gets the disable_approve_by_self of this UpdateMergeRequestSettingResponse.

        **参数解释：** 禁止审核自己创建的合并请求

        :return: The disable_approve_by_self of this UpdateMergeRequestSettingResponse.
        :rtype: bool
        """
    ...
    def disable_approve_by_self(self, disable_approve_by_self):
        r"""Sets the disable_approve_by_self of this UpdateMergeRequestSettingResponse.

        **参数解释：** 禁止审核自己创建的合并请求

        :param disable_approve_by_self: The disable_approve_by_self of this UpdateMergeRequestSettingResponse.
        :type disable_approve_by_self: bool
        """
    ...
    def disable_review_by_self(self):
        r"""Gets the disable_review_by_self of this UpdateMergeRequestSettingResponse.

        **参数解释：** 禁止检视自己创建的合并请求

        :return: The disable_review_by_self of this UpdateMergeRequestSettingResponse.
        :rtype: bool
        """
    ...
    def disable_review_by_self(self, disable_review_by_self):
        r"""Sets the disable_review_by_self of this UpdateMergeRequestSettingResponse.

        **参数解释：** 禁止检视自己创建的合并请求

        :param disable_review_by_self: The disable_review_by_self of this UpdateMergeRequestSettingResponse.
        :type disable_review_by_self: bool
        """
    ...
    @property
    def created_at(self):
        r"""Gets the created_at of this UpdateMergeRequestSettingResponse.

        **参数解释：** 创建时间。

        :return: The created_at of this UpdateMergeRequestSettingResponse.
        :rtype: str
        """
    ...
    def created_at(self, created_at):
        r"""Sets the created_at of this UpdateMergeRequestSettingResponse.

        **参数解释：** 创建时间。

        :param created_at: The created_at of this UpdateMergeRequestSettingResponse.
        :type created_at: str
        """
    ...
    @property
    def updated_at(self):
        r"""Gets the updated_at of this UpdateMergeRequestSettingResponse.

        **参数解释：** 更新时间。

        :return: The updated_at of this UpdateMergeRequestSettingResponse.
        :rtype: str
        """
    ...
    def updated_at(self, updated_at):
        r"""Sets the updated_at of this UpdateMergeRequestSettingResponse.

        **参数解释：** 更新时间。

        :param updated_at: The updated_at of this UpdateMergeRequestSettingResponse.
        :type updated_at: str
        """
    ...
    def can_force_merge(self):
        r"""Gets the can_force_merge of this UpdateMergeRequestSettingResponse.

        **参数解释：** 允许仓库管理员及项目经理强制合入

        :return: The can_force_merge of this UpdateMergeRequestSettingResponse.
        :rtype: bool
        """
    ...
    def can_force_merge(self, can_force_merge):
        r"""Sets the can_force_merge of this UpdateMergeRequestSettingResponse.

        **参数解释：** 允许仓库管理员及项目经理强制合入

        :param can_force_merge: The can_force_merge of this UpdateMergeRequestSettingResponse.
        :type can_force_merge: bool
        """
    ...
    def disable_squash_merge(self):
        r"""Gets the disable_squash_merge of this UpdateMergeRequestSettingResponse.

        **参数解释：** 禁止Squash合并（合入MR时禁止Squash合并）

        :return: The disable_squash_merge of this UpdateMergeRequestSettingResponse.
        :rtype: bool
        """
    ...
    def disable_squash_merge(self, disable_squash_merge):
        r"""Sets the disable_squash_merge of this UpdateMergeRequestSettingResponse.

        **参数解释：** 禁止Squash合并（合入MR时禁止Squash合并）

        :param disable_squash_merge: The disable_squash_merge of this UpdateMergeRequestSettingResponse.
        :type disable_squash_merge: bool
        """
    ...
    def must_relate_issue(self):
        r"""Gets the must_relate_issue of this UpdateMergeRequestSettingResponse.

        **参数解释：** 必须与CodeArts Req关联

        :return: The must_relate_issue of this UpdateMergeRequestSettingResponse.
        :rtype: bool
        """
    ...
    def must_relate_issue(self, must_relate_issue):
        r"""Sets the must_relate_issue of this UpdateMergeRequestSettingResponse.

        **参数解释：** 必须与CodeArts Req关联

        :param must_relate_issue: The must_relate_issue of this UpdateMergeRequestSettingResponse.
        :type must_relate_issue: bool
        """
    ...
    def need_relate_issue_branches(self):
        r"""Gets the need_relate_issue_branches of this UpdateMergeRequestSettingResponse.

        **参数解释：** 必须与CodeArts Req关联-选择目标分支配置合并请求策略(分支以逗号分支的字符串)

        :return: The need_relate_issue_branches of this UpdateMergeRequestSettingResponse.
        :rtype: str
        """
    ...
    def need_relate_issue_branches(self, need_relate_issue_branches):
        r"""Sets the need_relate_issue_branches of this UpdateMergeRequestSettingResponse.

        **参数解释：** 必须与CodeArts Req关联-选择目标分支配置合并请求策略(分支以逗号分支的字符串)

        :param need_relate_issue_branches: The need_relate_issue_branches of this UpdateMergeRequestSettingResponse.
        :type need_relate_issue_branches: str
        """
    ...
    def need_all_issues_check_passed(self):
        r"""Gets the need_all_issues_check_passed of this UpdateMergeRequestSettingResponse.

        **参数解释：** 必须与CodeArts Req关联-所有E2E单号校验必须通过

        :return: The need_all_issues_check_passed of this UpdateMergeRequestSettingResponse.
        :rtype: bool
        """
    ...
    def need_all_issues_check_passed(self, need_all_issues_check_passed):
        r"""Sets the need_all_issues_check_passed of this UpdateMergeRequestSettingResponse.

        **参数解释：** 必须与CodeArts Req关联-所有E2E单号校验必须通过

        :param need_all_issues_check_passed: The need_all_issues_check_passed of this UpdateMergeRequestSettingResponse.
        :type need_all_issues_check_passed: bool
        """
    ...
    def review_mode(self):
        r"""Gets the review_mode of this UpdateMergeRequestSettingResponse.

        **参数解释：** 合入模式

        :return: The review_mode of this UpdateMergeRequestSettingResponse.
        :rtype: str
        """
    ...
    def review_mode(self, review_mode):
        r"""Sets the review_mode of this UpdateMergeRequestSettingResponse.

        **参数解释：** 合入模式

        :param review_mode: The review_mode of this UpdateMergeRequestSettingResponse.
        :type review_mode: str
        """
    ...
    def add_notes_after_merged(self):
        r"""Gets the add_notes_after_merged of this UpdateMergeRequestSettingResponse.

        **参数解释：** 允许合并请求合并或关闭后继续做代码检视和评论

        :return: The add_notes_after_merged of this UpdateMergeRequestSettingResponse.
        :rtype: bool
        """
    ...
    def add_notes_after_merged(self, add_notes_after_merged):
        r"""Sets the add_notes_after_merged of this UpdateMergeRequestSettingResponse.

        **参数解释：** 允许合并请求合并或关闭后继续做代码检视和评论

        :param add_notes_after_merged: The add_notes_after_merged of this UpdateMergeRequestSettingResponse.
        :type add_notes_after_merged: bool
        """
    ...
    def merged_commit_author(self):
        r"""Gets the merged_commit_author of this UpdateMergeRequestSettingResponse.

        **参数解释：** merged_by：使用MR合入者生成Merge Commit created_by：使用MR创建者生成Merge Commit

        :return: The merged_commit_author of this UpdateMergeRequestSettingResponse.
        :rtype: str
        """
    ...
    def merged_commit_author(self, merged_commit_author):
        r"""Sets the merged_commit_author of this UpdateMergeRequestSettingResponse.

        **参数解释：** merged_by：使用MR合入者生成Merge Commit created_by：使用MR创建者生成Merge Commit

        :param merged_commit_author: The merged_commit_author of this UpdateMergeRequestSettingResponse.
        :type merged_commit_author: str
        """
    ...
    def evaluation_role(self):
        r"""Gets the evaluation_role of this UpdateMergeRequestSettingResponse.

        **参数解释：** 是否将星级评价作为合入门禁-参与星级评价角色。 29：勾选开发者 30：勾选开发者，Committer 35：勾选Committer 40：都不勾选

        :return: The evaluation_role of this UpdateMergeRequestSettingResponse.
        :rtype: int
        """
    ...
    def evaluation_role(self, evaluation_role):
        r"""Sets the evaluation_role of this UpdateMergeRequestSettingResponse.

        **参数解释：** 是否将星级评价作为合入门禁-参与星级评价角色。 29：勾选开发者 30：勾选开发者，Committer 35：勾选Committer 40：都不勾选

        :param evaluation_role: The evaluation_role of this UpdateMergeRequestSettingResponse.
        :type evaluation_role: int
        """
    ...
    def evaluation_merge_gate(self):
        r"""Gets the evaluation_merge_gate of this UpdateMergeRequestSettingResponse.

        **参数解释：** 是否将星级评价作为合入门禁

        :return: The evaluation_merge_gate of this UpdateMergeRequestSettingResponse.
        :rtype: bool
        """
    ...
    def evaluation_merge_gate(self, evaluation_merge_gate):
        r"""Sets the evaluation_merge_gate of this UpdateMergeRequestSettingResponse.

        **参数解释：** 是否将星级评价作为合入门禁

        :param evaluation_merge_gate: The evaluation_merge_gate of this UpdateMergeRequestSettingResponse.
        :type evaluation_merge_gate: bool
        """
    ...
    def mark_auto_merged_mr_as_closed(self):
        r"""Gets the mark_auto_merged_mr_as_closed of this UpdateMergeRequestSettingResponse.

        **参数解释：** 是否将自动合并的MR状态标记为关闭状态

        :return: The mark_auto_merged_mr_as_closed of this UpdateMergeRequestSettingResponse.
        :rtype: bool
        """
    ...
    def mark_auto_merged_mr_as_closed(self, mark_auto_merged_mr_as_closed):
        r"""Sets the mark_auto_merged_mr_as_closed of this UpdateMergeRequestSettingResponse.

        **参数解释：** 是否将自动合并的MR状态标记为关闭状态

        :param mark_auto_merged_mr_as_closed: The mark_auto_merged_mr_as_closed of this UpdateMergeRequestSettingResponse.
        :type mark_auto_merged_mr_as_closed: bool
        """
    ...
    def delete_source_branch_when_merged(self):
        r"""Gets the delete_source_branch_when_merged of this UpdateMergeRequestSettingResponse.

        **参数解释：** 新建合并请求，默认开启合并后删除源分支

        :return: The delete_source_branch_when_merged of this UpdateMergeRequestSettingResponse.
        :rtype: bool
        """
    ...
    def delete_source_branch_when_merged(self, delete_source_branch_when_merged):
        r"""Sets the delete_source_branch_when_merged of this UpdateMergeRequestSettingResponse.

        **参数解释：** 新建合并请求，默认开启合并后删除源分支

        :param delete_source_branch_when_merged: The delete_source_branch_when_merged of this UpdateMergeRequestSettingResponse.
        :type delete_source_branch_when_merged: bool
        """
    ...
    def auto_squash_merge(self):
        r"""Gets the auto_squash_merge of this UpdateMergeRequestSettingResponse.

        **参数解释：** 新建合并请求，默认开启Squash合并

        :return: The auto_squash_merge of this UpdateMergeRequestSettingResponse.
        :rtype: bool
        """
    ...
    def auto_squash_merge(self, auto_squash_merge):
        r"""Sets the auto_squash_merge of this UpdateMergeRequestSettingResponse.

        **参数解释：** 新建合并请求，默认开启Squash合并

        :param auto_squash_merge: The auto_squash_merge of this UpdateMergeRequestSettingResponse.
        :type auto_squash_merge: bool
        """
    ...
    def squash_merge_with_no_merge_commit(self):
        r"""Gets the squash_merge_with_no_merge_commit of this UpdateMergeRequestSettingResponse.

        **参数解释：** Squash合并不产生Merge节点

        :return: The squash_merge_with_no_merge_commit of this UpdateMergeRequestSettingResponse.
        :rtype: bool
        """
    ...
    def squash_merge_with_no_merge_commit(self, squash_merge_with_no_merge_commit):
        r"""Sets the squash_merge_with_no_merge_commit of this UpdateMergeRequestSettingResponse.

        **参数解释：** Squash合并不产生Merge节点

        :param squash_merge_with_no_merge_commit: The squash_merge_with_no_merge_commit of this UpdateMergeRequestSettingResponse.
        :type squash_merge_with_no_merge_commit: bool
        """
    ...
    def only_allow_one_issue_check_passed(self):
        r"""Gets the only_allow_one_issue_check_passed of this UpdateMergeRequestSettingResponse.

        **参数解释：** 只能关联一个单号

        :return: The only_allow_one_issue_check_passed of this UpdateMergeRequestSettingResponse.
        :rtype: bool
        """
    ...
    def only_allow_one_issue_check_passed(self, only_allow_one_issue_check_passed):
        r"""Sets the only_allow_one_issue_check_passed of this UpdateMergeRequestSettingResponse.

        **参数解释：** 只能关联一个单号

        :param only_allow_one_issue_check_passed: The only_allow_one_issue_check_passed of this UpdateMergeRequestSettingResponse.
        :type only_allow_one_issue_check_passed: bool
        """
    ...
    def enable_custom_evaluation(self):
        r"""Gets the enable_custom_evaluation of this UpdateMergeRequestSettingResponse.

        **参数解释：** 启用MR自定义评价维度分类（MR评价设置）

        :return: The enable_custom_evaluation of this UpdateMergeRequestSettingResponse.
        :rtype: bool
        """
    ...
    def enable_custom_evaluation(self, enable_custom_evaluation):
        r"""Sets the enable_custom_evaluation of this UpdateMergeRequestSettingResponse.

        **参数解释：** 启用MR自定义评价维度分类（MR评价设置）

        :param enable_custom_evaluation: The enable_custom_evaluation of this UpdateMergeRequestSettingResponse.
        :type enable_custom_evaluation: bool
        """
    ...
    def evaluation_types(self):
        r"""Gets the evaluation_types of this UpdateMergeRequestSettingResponse.

        **参数解释：** 评价维度（MR评价设置）

        :return: The evaluation_types of this UpdateMergeRequestSettingResponse.
    ...
    def evaluation_types(self, evaluation_types):
        r"""Sets the evaluation_types of this UpdateMergeRequestSettingResponse.

        **参数解释：** 评价维度（MR评价设置）

        :param evaluation_types: The evaluation_types of this UpdateMergeRequestSettingResponse.
        :type evaluation_types: list[:class:`huaweicloudsdkcodeartsrepo.v4.EvaluationTypeDto`]
        """
    ...
    @property
    def can_reopen(self):
        r"""Gets the can_reopen of this UpdateMergeRequestSettingResponse.

        **参数解释：** 不能重新打开一个已经关闭的合并请求

        :return: The can_reopen of this UpdateMergeRequestSettingResponse.
        :rtype: bool
        """
    ...
    def can_reopen(self, can_reopen):
        r"""Sets the can_reopen of this UpdateMergeRequestSettingResponse.

        **参数解释：** 不能重新打开一个已经关闭的合并请求

        :param can_reopen: The can_reopen of this UpdateMergeRequestSettingResponse.
        :type can_reopen: bool
        """
    ...
    def only_allow_merge_if_all_discussions_are_resolved(self):
        r"""Gets the only_allow_merge_if_all_discussions_are_resolved of this UpdateMergeRequestSettingResponse.

        **参数解释：** 评审问题全部解决才能合入

        :return: The only_allow_merge_if_all_discussions_are_resolved of this UpdateMergeRequestSettingResponse.
        :rtype: bool
        """
    ...
    def only_allow_merge_if_all_discussions_are_resolved(self, only_allow_merge_if_all_discussions_are_resolved):
        r"""Sets the only_allow_merge_if_all_discussions_are_resolved of this UpdateMergeRequestSettingResponse.

        **参数解释：** 评审问题全部解决才能合入

        :param only_allow_merge_if_all_discussions_are_resolved: The only_allow_merge_if_all_discussions_are_resolved of this UpdateMergeRequestSettingResponse.
        :type only_allow_merge_if_all_discussions_are_resolved: bool
        """
    ...
    def merge_method(self):
        r"""Gets the merge_method of this UpdateMergeRequestSettingResponse.

        **参数解释：** 合并模式。 merge：通过 Merge Commit 合并 rebase_merge：通过 Merge Commit 合并(记录半线性历史) ff：Fast-forward 合并

        :return: The merge_method of this UpdateMergeRequestSettingResponse.
        :rtype: str
        """
    ...
    def merge_method(self, merge_method):
        r"""Sets the merge_method of this UpdateMergeRequestSettingResponse.

        **参数解释：** 合并模式。 merge：通过 Merge Commit 合并 rebase_merge：通过 Merge Commit 合并(记录半线性历史) ff：Fast-forward 合并

        :param merge_method: The merge_method of this UpdateMergeRequestSettingResponse.
        :type merge_method: str
        """
    ...
    def only_allow_merge_if_vote_bigger_than(self):
        r"""Gets the only_allow_merge_if_vote_bigger_than of this UpdateMergeRequestSettingResponse.

        **参数解释：** 打分模式最低合入分数。

        :return: The only_allow_merge_if_vote_bigger_than of this UpdateMergeRequestSettingResponse.
        :rtype: int
        """
    ...
    def only_allow_merge_if_vote_bigger_than(self, only_allow_merge_if_vote_bigger_than):
        r"""Sets the only_allow_merge_if_vote_bigger_than of this UpdateMergeRequestSettingResponse.

        **参数解释：** 打分模式最低合入分数。

        :param only_allow_merge_if_vote_bigger_than: The only_allow_merge_if_vote_bigger_than of this UpdateMergeRequestSettingResponse.
        :type only_allow_merge_if_vote_bigger_than: int
        """
    ...
    def only_assignee_can_merge(self):
        r"""Gets the only_assignee_can_merge of this UpdateMergeRequestSettingResponse.

        **参数解释：** 仅合并人和合并合并请求。

        :return: The only_assignee_can_merge of this UpdateMergeRequestSettingResponse.
        :rtype: bool
        """
    ...
    def only_assignee_can_merge(self, only_assignee_can_merge):
        r"""Sets the only_assignee_can_merge of this UpdateMergeRequestSettingResponse.

        **参数解释：** 仅合并人和合并合并请求。

        :param only_assignee_can_merge: The only_assignee_can_merge of this UpdateMergeRequestSettingResponse.
        :type only_assignee_can_merge: bool
        """
    ...
    def repository_id(self):
        r"""Gets the repository_id of this UpdateMergeRequestSettingResponse.

        **参数解释：** 仓库id。

        :return: The repository_id of this UpdateMergeRequestSettingResponse.
        :rtype: int
        """
    ...
    def repository_id(self, repository_id):
        r"""Sets the repository_id of this UpdateMergeRequestSettingResponse.

        **参数解释：** 仓库id。

        :param repository_id: The repository_id of this UpdateMergeRequestSettingResponse.
        :type repository_id: int
        """
    ...
    def has_evaluation_permission(self):
        r"""Gets the has_evaluation_permission of this UpdateMergeRequestSettingResponse.

        **参数解释：** 调用者是否有星级评价权限。

        :return: The has_evaluation_permission of this UpdateMergeRequestSettingResponse.
        :rtype: bool
        """
    ...
    def has_evaluation_permission(self, has_evaluation_permission):
        r"""Sets the has_evaluation_permission of this UpdateMergeRequestSettingResponse.

        **参数解释：** 调用者是否有星级评价权限。

        :param has_evaluation_permission: The has_evaluation_permission of this UpdateMergeRequestSettingResponse.
        :type has_evaluation_permission: bool
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateMergeRequestSettingResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateMergeRequestSettingResponse):
            return False
