...
class ShowMergeRequestVotesDetailResponse(SdkResponse):
    ...
    def __init__(self, scores=None, merge_request_id=None, merge_request_creator=None, votes=None):
        ...
        :type votes: list[:class:`huaweicloudsdkcodeartsrepo.v4.MergeRequestVotesDto`]
        """
    ...
    def votes(self):
        ...
        **参数解释：** 个人打分详情。
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.MergeRequestVotesDto`]
        """
        return self._votes
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowMergeRequestVotesDetailResponse.to_dict() is deprecated and no longer maintained, "
