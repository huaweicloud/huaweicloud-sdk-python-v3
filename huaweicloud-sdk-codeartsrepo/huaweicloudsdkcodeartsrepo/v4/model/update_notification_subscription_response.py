...
class UpdateNotificationSubscriptionResponse(SdkResponse):
    ...
    def webhook_config(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v4.RepoWebHookSubscriptionDto`
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateNotificationSubscriptionResponse.to_dict() is deprecated and no longer maintained, "
