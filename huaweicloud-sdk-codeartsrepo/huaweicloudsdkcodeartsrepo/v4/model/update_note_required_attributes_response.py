...
class UpdateNoteRequiredAttributesResponse(SdkResponse):
    ...
    def __init__(self, note_required_attributes=None):
        r"""UpdateNoteRequiredAttributesResponse
    ...
    def note_required_attributes(self):
        r"""Gets the note_required_attributes of this UpdateNoteRequiredAttributesResponse.

        **参数解释：** 检视意见必填项。

        :return: The note_required_attributes of this UpdateNoteRequiredAttributesResponse.
    ...
    def note_required_attributes(self, note_required_attributes):
        r"""Sets the note_required_attributes of this UpdateNoteRequiredAttributesResponse.

        **参数解释：** 检视意见必填项。

        :param note_required_attributes: The note_required_attributes of this UpdateNoteRequiredAttributesResponse.
        :type note_required_attributes: list[:class:`huaweicloudsdkcodeartsrepo.v4.RequiredAttributeDto`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateNoteRequiredAttributesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateNoteRequiredAttributesResponse):
            return False
