...
class ShowUserRefPermissionResponse(SdkResponse):
    ...
    def __init__(self, read=None, review=None, approval=None, create_change=None, merge=None, create_delete=None, push=None):
        ...
        :param read: 
        :type read: :class:`huaweicloudsdkcodeartsrepo.v4.UserRefPermissionBasicDto`
        :param review: 
        :type review: :class:`huaweicloudsdkcodeartsrepo.v4.UserRefPermissionBasicDto`
        :param approval: 
        :type approval: :class:`huaweicloudsdkcodeartsrepo.v4.UserRefPermissionBasicDto`
        :param create_change: 
        :type create_change: :class:`huaweicloudsdkcodeartsrepo.v4.UserRefPermissionBasicDto`
        :param merge: 
        :type merge: :class:`huaweicloudsdkcodeartsrepo.v4.UserRefPermissionBasicDto`
        :param create_delete: 
        :type create_delete: :class:`huaweicloudsdkcodeartsrepo.v4.UserRefPermissionBasicDto`
        :param push: 
        :type push: :class:`huaweicloudsdkcodeartsrepo.v4.UserRefPermissionBasicDto`
        """
    ...
    def read(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v4.UserRefPermissionBasicDto`
        """
        return self._read
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowUserRefPermissionResponse.to_dict() is deprecated and no longer maintained, "
