...
class ShowResourcePermissionsRequest:
    ...
    def __init__(self, group_id=None, resource_id=None, offset=None, limit=None):
        r"""ShowResourcePermissionsRequest
    ...
    @property
    def offset(self):
        r"""Gets the offset of this ShowResourcePermissionsRequest.

        **参数解释：** 偏移量，从0开始。

        :return: The offset of this ShowResourcePermissionsRequest.
        :rtype: int
        """
        return self._offset
    ...
    def offset(self, offset):
        r"""Sets the offset of this ShowResourcePermissionsRequest.

        **参数解释：** 偏移量，从0开始。

        :param offset: The offset of this ShowResourcePermissionsRequest.
        :type offset: int
        """
        self._offset = offset
    ...
    @property
    def limit(self):
        r"""Gets the limit of this ShowResourcePermissionsRequest.

        **参数解释：** 返回数量。

        :return: The limit of this ShowResourcePermissionsRequest.
        :rtype: int
        """
        return self._limit
    ...
    def limit(self, limit):
        r"""Sets the limit of this ShowResourcePermissionsRequest.

        **参数解释：** 返回数量。

        :param limit: The limit of this ShowResourcePermissionsRequest.
        :type limit: int
        """
        self._limit = limit
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowResourcePermissionsRequest):
            return False
