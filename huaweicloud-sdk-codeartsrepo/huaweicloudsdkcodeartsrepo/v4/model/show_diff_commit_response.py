...
class ShowDiffCommitResponse(SdkResponse):
    ...
    def __init__(self, diffs=None, diff_refs=None, added_lines=None, removed_lines=None, change_file_count=None, change_line_count=None, too_large=None):
        ...
        :type diffs: list[:class:`huaweicloudsdkcodeartsrepo.v4.DiffNoLineDto`]
        :param diff_refs: 
    ...
    def diffs(self):
        ...
        **参数解释：** 差异信息。 **取值范围：** 不涉及。
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.DiffNoLineDto`]
        """
        return self._diffs
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowDiffCommitResponse.to_dict() is deprecated and no longer maintained, "
