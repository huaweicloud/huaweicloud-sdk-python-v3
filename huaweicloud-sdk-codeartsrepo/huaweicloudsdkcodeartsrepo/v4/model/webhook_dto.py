...
class WebhookDto:
    ...
    @property
    def url(self):
        r"""Gets the url of this WebhookDto.

        **参数解释：** webhook地址。 **取值范围：** 字符串长度不少于0，不超过500。

        :return: The url of this WebhookDto.
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        r"""Sets the url of this WebhookDto.

        **参数解释：** webhook地址。 **取值范围：** 字符串长度不少于0，不超过500。

        :param url: The url of this WebhookDto.
        :type url: str
        """
        self._url = url
    ...
    def push_events(self):
        r"""Gets the push_events of this WebhookDto.

        **参数解释：** 是否启用推送事件。

        :return: The push_events of this WebhookDto.
        :rtype: bool
        """
    ...
    def push_events(self, push_events):
        r"""Sets the push_events of this WebhookDto.

        **参数解释：** 是否启用推送事件。

        :param push_events: The push_events of this WebhookDto.
        :type push_events: bool
        """
    ...
    def push_events_branch_regex_filter(self):
        r"""Gets the push_events_branch_regex_filter of this WebhookDto.

        **参数解释：** 推送事件分支过滤正则规则。 **取值范围：** 字符串长度不少于0，不超过500。                

        :return: The push_events_branch_regex_filter of this WebhookDto.
        :rtype: str
        """
    ...
    def push_events_branch_regex_filter(self, push_events_branch_regex_filter):
        r"""Sets the push_events_branch_regex_filter of this WebhookDto.

        **参数解释：** 推送事件分支过滤正则规则。 **取值范围：** 字符串长度不少于0，不超过500。                

        :param push_events_branch_regex_filter: The push_events_branch_regex_filter of this WebhookDto.
        :type push_events_branch_regex_filter: str
        """
    ...
    def note_plain_text_filter(self):
        r"""Gets the note_plain_text_filter of this WebhookDto.

        **参数解释：** 评论事件文本过滤规则。 **取值范围：** 字符串长度不少于0，不超过50，不能超过10个。  

        :return: The note_plain_text_filter of this WebhookDto.
        :rtype: list[str]
        """
    ...
    def note_plain_text_filter(self, note_plain_text_filter):
        r"""Sets the note_plain_text_filter of this WebhookDto.

        **参数解释：** 评论事件文本过滤规则。 **取值范围：** 字符串长度不少于0，不超过50，不能超过10个。  

        :param note_plain_text_filter: The note_plain_text_filter of this WebhookDto.
        :type note_plain_text_filter: list[str]
        """
    ...
    def tag_push_events(self):
        r"""Gets the tag_push_events of this WebhookDto.

        **参数解释：** 是否启用Tag推送事件。

        :return: The tag_push_events of this WebhookDto.
        :rtype: bool
        """
    ...
    def tag_push_events(self, tag_push_events):
        r"""Sets the tag_push_events of this WebhookDto.

        **参数解释：** 是否启用Tag推送事件。

        :param tag_push_events: The tag_push_events of this WebhookDto.
        :type tag_push_events: bool
        """
    ...
    def merge_requests_events(self):
        r"""Gets the merge_requests_events of this WebhookDto.

        **参数解释：** 是否启用合并请求事件。

        :return: The merge_requests_events of this WebhookDto.
        :rtype: bool
        """
    ...
    def merge_requests_events(self, merge_requests_events):
        r"""Sets the merge_requests_events of this WebhookDto.

        **参数解释：** 是否启用合并请求事件。

        :param merge_requests_events: The merge_requests_events of this WebhookDto.
        :type merge_requests_events: bool
        """
    ...
    def note_events(self):
        r"""Gets the note_events of this WebhookDto.

        **参数解释：** 是否启用评论事件。

        :return: The note_events of this WebhookDto.
        :rtype: bool
        """
    ...
    def note_events(self, note_events):
        r"""Sets the note_events of this WebhookDto.

        **参数解释：** 是否启用评论事件。

        :param note_events: The note_events of this WebhookDto.
        :type note_events: bool
        """
    ...
    @property
    def token(self):
        r"""Gets the token of this WebhookDto.

        **参数解释：** token值，作为返回值时会使用掩码代替实际值。 **取值范围：** 字符串长度不少于0，不超过2000。

        :return: The token of this WebhookDto.
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        r"""Sets the token of this WebhookDto.

        **参数解释：** token值，作为返回值时会使用掩码代替实际值。 **取值范围：** 字符串长度不少于0，不超过2000。

        :param token: The token of this WebhookDto.
        :type token: str
        """
        self._token = token
    ...
    @property
    def token_type(self):
        r"""Gets the token_type of this WebhookDto.

        **参数解释：** token类型，默认为X-Repo-Token。 **取值范围：** 字符串长度不少于0，不超过200。

        :return: The token_type of this WebhookDto.
        :rtype: str
        """
    ...
    def token_type(self, token_type):
        r"""Sets the token_type of this WebhookDto.

        **参数解释：** token类型，默认为X-Repo-Token。 **取值范围：** 字符串长度不少于0，不超过200。

        :param token_type: The token_type of this WebhookDto.
        :type token_type: str
        """
    ...
    @property
    def name(self):
        r"""Gets the name of this WebhookDto.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this WebhookDto.
    ...
    def description(self):
        r"""Gets the description of this WebhookDto.

        **参数解释：** 描述。 **取值范围：** 字符串长度不少于0，不超过200。

        :return: The description of this WebhookDto.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this WebhookDto.

        **参数解释：** 描述。 **取值范围：** 字符串长度不少于0，不超过200。

        :param description: The description of this WebhookDto.
        :type description: str
        """
    ...
    @property
    def event_cfgs(self):
        r"""Gets the event_cfgs of this WebhookDto.

        **参数解释：** 预留字段，事件触发设置，可为空。

        :return: The event_cfgs of this WebhookDto.
    ...
    def event_cfgs(self, event_cfgs):
        r"""Sets the event_cfgs of this WebhookDto.

        **参数解释：** 预留字段，事件触发设置，可为空。

        :param event_cfgs: The event_cfgs of this WebhookDto.
        :type event_cfgs: list[:class:`huaweicloudsdkcodeartsrepo.v4.WebHookEventCfgDto`]
        """
    ...
    def project_cfgs(self):
        r"""Gets the project_cfgs of this WebhookDto.

        **参数解释：** 预留字段，仓库分支规则设置，可为空。

        :return: The project_cfgs of this WebhookDto.
    ...
    def project_cfgs(self, project_cfgs):
        r"""Sets the project_cfgs of this WebhookDto.

        **参数解释：** 预留字段，仓库分支规则设置，可为空。

        :param project_cfgs: The project_cfgs of this WebhookDto.
        :type project_cfgs: list[:class:`huaweicloudsdkcodeartsrepo.v4.WebHookBranchCfgDto`]
        """
    ...
    def branch_cfgs(self):
        r"""Gets the branch_cfgs of this WebhookDto.

        :return: The branch_cfgs of this WebhookDto.
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.WebHookBranchCfgDto`]
        """
    ...
    def branch_cfgs(self, branch_cfgs):
        r"""Sets the branch_cfgs of this WebhookDto.

        :param branch_cfgs: The branch_cfgs of this WebhookDto.
        :type branch_cfgs: list[:class:`huaweicloudsdkcodeartsrepo.v4.WebHookBranchCfgDto`]
        """
    ...
    @property
    def id(self):
        r"""Gets the id of this WebhookDto.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this WebhookDto.
    ...
    @property
    def created_at(self):
        r"""Gets the created_at of this WebhookDto.
    ...
    def created_at(self, created_at):
        r"""Sets the created_at of this WebhookDto.
    ...
    @property
    def updated_at(self):
        r"""Gets the updated_at of this WebhookDto.
    ...
    def updated_at(self, updated_at):
        r"""Sets the updated_at of this WebhookDto.
    ...
    @property
    def service(self):
        r"""Gets the service of this WebhookDto.

        **参数解释：** 内部服务名称。

        :return: The service of this WebhookDto.
        :rtype: str
        """
    ...
    def service(self, service):
        r"""Sets the service of this WebhookDto.

        **参数解释：** 内部服务名称。

        :param service: The service of this WebhookDto.
        :type service: str
        """
