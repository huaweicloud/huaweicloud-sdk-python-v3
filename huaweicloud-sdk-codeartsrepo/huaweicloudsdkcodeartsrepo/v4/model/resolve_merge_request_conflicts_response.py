...
class ResolveMergeRequestConflictsResponse(SdkResponse):
    ...
    def __init__(self, message=None):
        r"""ResolveMergeRequestConflictsResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ResolveMergeRequestConflictsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResolveMergeRequestConflictsResponse):
            return False
