...
class RepositoryProtectedActionDto:
    ...
    def __init__(self, action=None, enable=None, users=None, user_teams=None, roles=None):
        ...
        :type users: list[:class:`huaweicloudsdkcodeartsrepo.v4.RepositoryUserDto`]
        ...
        :type roles: list[:class:`huaweicloudsdkcodeartsrepo.v4.BasicRoleDto`]
        """
    ...
    def users(self):
        ...
        **参数解释：** 白名单用户列表。 **取值范围：** 不涉及。
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.RepositoryUserDto`]
        """
        return self._users
    ...
    def roles(self):
        ...
        **参数解释：** 白名单角色列表。 **取值范围：** 不涉及。
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.BasicRoleDto`]
        """
        return self._roles
