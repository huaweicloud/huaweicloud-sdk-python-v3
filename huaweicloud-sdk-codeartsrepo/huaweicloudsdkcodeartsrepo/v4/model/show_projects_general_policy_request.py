...
class ShowProjectsGeneralPolicyRequest:
    ...
    def __init__(self, project_id=None):
        r"""ShowProjectsGeneralPolicyRequest
    ...
    @property
    def project_id(self):
        r"""Gets the project_id of this ShowProjectsGeneralPolicyRequest.

        **参数解释：** 项目的32位uuid，项目唯一标识，通过[[查询项目列表](https://support.huaweicloud.com/api-projectman/ListProjectsV4.html)](tag:hws)[[查询项目列表](https://support.huaweicloud.com/intl/en-us/api-projectman/ListProjectsV4.html)](tag:hws_hk)[[查询项目列表](https://support.huaweicloud.com/eu/api-projectman/ListProjectsV4.html)](tag:hws_eu)[查询项目列表](tag:hcs,hcs_sm)接口查询项目列表获取。 **取值范围：** 字符串长度32。

        :return: The project_id of this ShowProjectsGeneralPolicyRequest.
        :rtype: str
        """
    ...
    def project_id(self, project_id):
        r"""Sets the project_id of this ShowProjectsGeneralPolicyRequest.

        **参数解释：** 项目的32位uuid，项目唯一标识，通过[[查询项目列表](https://support.huaweicloud.com/api-projectman/ListProjectsV4.html)](tag:hws)[[查询项目列表](https://support.huaweicloud.com/intl/en-us/api-projectman/ListProjectsV4.html)](tag:hws_hk)[[查询项目列表](https://support.huaweicloud.com/eu/api-projectman/ListProjectsV4.html)](tag:hws_eu)[查询项目列表](tag:hcs,hcs_sm)接口查询项目列表获取。 **取值范围：** 字符串长度32。

        :param project_id: The project_id of this ShowProjectsGeneralPolicyRequest.
        :type project_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowProjectsGeneralPolicyRequest):
            return False
