...
class ShowRefCompareResponse(SdkResponse):
    ...
    def __init__(self, commit=None, commits=None, diffs=None, diffs_files=None, compare_timeout=None, compare_same_ref=None, conflict_files=None, added_lines=None, removed_lines=None, commits_count=None, diffs_count=None, x_total=None):
        ...
        :type diffs_files: list[:class:`huaweicloudsdkcodeartsrepo.v4.DiffDto`]
        ...
        :type conflict_files: list[:class:`huaweicloudsdkcodeartsrepo.v4.ConflictFileDto`]
    ...
    def conflict_files(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.ConflictFileDto`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowRefCompareResponse.to_dict() is deprecated and no longer maintained, "
