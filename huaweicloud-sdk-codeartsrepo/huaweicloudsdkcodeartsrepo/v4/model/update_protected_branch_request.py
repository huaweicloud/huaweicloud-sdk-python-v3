...
class UpdateProtectedBranchRequest:
    ...
    def __init__(self, repository_id=None, branch_name=None, body=None):
        ...
        :param body: 保护分支权限列表
        :type body: list[:class:`huaweicloudsdkcodeartsrepo.v4.ProtectedBranchProtectedActionBodyDto`]
        """
    ...
    def body(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.ProtectedBranchProtectedActionBodyDto`]
        """
        return self._body
