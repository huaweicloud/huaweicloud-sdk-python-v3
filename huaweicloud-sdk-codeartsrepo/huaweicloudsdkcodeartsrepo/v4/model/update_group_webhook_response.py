...
class UpdateGroupWebhookResponse(SdkResponse):
    ...
    def note_plain_text_filter(self):
        r"""Gets the note_plain_text_filter of this UpdateGroupWebhookResponse.

        **参数解释：** 评论事件文本过滤规则。 **取值范围：** 字符串长度不少于0，不超过50，不能超过10个。  

        :return: The note_plain_text_filter of this UpdateGroupWebhookResponse.
        :rtype: list[str]
        """
    ...
    def note_plain_text_filter(self, note_plain_text_filter):
        r"""Sets the note_plain_text_filter of this UpdateGroupWebhookResponse.

        **参数解释：** 评论事件文本过滤规则。 **取值范围：** 字符串长度不少于0，不超过50，不能超过10个。  

        :param note_plain_text_filter: The note_plain_text_filter of this UpdateGroupWebhookResponse.
        :type note_plain_text_filter: list[str]
        """
    ...
    @property
    def event_cfgs(self):
        r"""Gets the event_cfgs of this UpdateGroupWebhookResponse.

        **参数解释：** 预留字段，事件触发设置，可为空。

        :return: The event_cfgs of this UpdateGroupWebhookResponse.
    ...
    def event_cfgs(self, event_cfgs):
        r"""Sets the event_cfgs of this UpdateGroupWebhookResponse.

        **参数解释：** 预留字段，事件触发设置，可为空。

        :param event_cfgs: The event_cfgs of this UpdateGroupWebhookResponse.
        :type event_cfgs: list[:class:`huaweicloudsdkcodeartsrepo.v4.WebHookEventCfgDto`]
        """
    ...
    def project_cfgs(self):
        r"""Gets the project_cfgs of this UpdateGroupWebhookResponse.

        **参数解释：** 预留字段，仓库分支规则设置，可为空。

        :return: The project_cfgs of this UpdateGroupWebhookResponse.
    ...
    def project_cfgs(self, project_cfgs):
        r"""Sets the project_cfgs of this UpdateGroupWebhookResponse.

        **参数解释：** 预留字段，仓库分支规则设置，可为空。

        :param project_cfgs: The project_cfgs of this UpdateGroupWebhookResponse.
        :type project_cfgs: list[:class:`huaweicloudsdkcodeartsrepo.v4.WebHookBranchCfgDto`]
        """
    ...
    def branch_cfgs(self):
        r"""Gets the branch_cfgs of this UpdateGroupWebhookResponse.

        :return: The branch_cfgs of this UpdateGroupWebhookResponse.
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.WebHookBranchCfgDto`]
        """
    ...
    def branch_cfgs(self, branch_cfgs):
        r"""Sets the branch_cfgs of this UpdateGroupWebhookResponse.

        :param branch_cfgs: The branch_cfgs of this UpdateGroupWebhookResponse.
        :type branch_cfgs: list[:class:`huaweicloudsdkcodeartsrepo.v4.WebHookBranchCfgDto`]
        """
    ...
    @property
    def service(self):
        r"""Gets the service of this UpdateGroupWebhookResponse.

        **参数解释：** 内部服务名称。

        :return: The service of this UpdateGroupWebhookResponse.
        :rtype: str
        """
    ...
    def service(self, service):
        r"""Sets the service of this UpdateGroupWebhookResponse.

        **参数解释：** 内部服务名称。

        :param service: The service of this UpdateGroupWebhookResponse.
        :type service: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateGroupWebhookResponse.to_dict() is deprecated and no longer maintained, "
