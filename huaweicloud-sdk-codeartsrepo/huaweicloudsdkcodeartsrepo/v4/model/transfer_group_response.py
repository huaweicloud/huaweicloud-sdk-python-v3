...
class TransferGroupResponse(SdkResponse):
    ...
    def __init__(self, id=None, full_name=None, full_path=None, my_role=None, name=None, parent_id=None, creator_id=None):
        ...
        :type full_path: str
        :param my_role: 
        :type my_role: :class:`huaweicloudsdkcodeartsrepo.v4.GroupMyRoleDto`
        :param name: 代码组名称
        :type name: str
    ...
    def my_role(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v4.GroupMyRoleDto`
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("TransferGroupResponse.to_dict() is deprecated and no longer maintained, "
