...
class ShowActualHeadPipelineResponse(SdkResponse):
    ...
    def __init__(self, data=None, is_valid=None):
        ...
        :param data: 
        :type data: :class:`huaweicloudsdkcodeartsrepo.v4.PipelineDetailDto`
    ...
    def data(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v4.PipelineDetailDto`
        """
        return self._data
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowActualHeadPipelineResponse.to_dict() is deprecated and no longer maintained, "
