...
class ListGroupPermissionResourcesResponse(SdkResponse):
    ...
    def __init__(self, use_project_permission=None, resources=None):
        ...
        :type resources: list[:class:`huaweicloudsdkcodeartsrepo.v4.PermissionResourcesDto`]
        """
    ...
    def resources(self):
        ...
        **参数解释：** 资源列表。
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.PermissionResourcesDto`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListGroupPermissionResourcesResponse.to_dict() is deprecated and no longer maintained, "
