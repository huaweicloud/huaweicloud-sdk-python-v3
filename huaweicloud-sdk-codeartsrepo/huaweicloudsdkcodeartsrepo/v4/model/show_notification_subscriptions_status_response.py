...
class ShowNotificationSubscriptionsStatusResponse(SdkResponse):
    ...
    def __init__(self, internal_message=None, email=None, qyweixin=None, feishu=None, dingding=None):
        ...
        :type internal_message: :class:`huaweicloudsdkcodeartsrepo.v4.RepoNotificationSubscriptionStateDto`
        :param email: 
        :type email: :class:`huaweicloudsdkcodeartsrepo.v4.RepoNotificationSubscriptionStateDto`
        :param qyweixin: 
        :type qyweixin: :class:`huaweicloudsdkcodeartsrepo.v4.RepoNotificationSubscriptionStateDto`
        :param feishu: 
        :type feishu: :class:`huaweicloudsdkcodeartsrepo.v4.RepoNotificationSubscriptionStateDto`
        :param dingding: 
        :type dingding: :class:`huaweicloudsdkcodeartsrepo.v4.RepoNotificationSubscriptionStateDto`
        """
    ...
    def internal_message(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v4.RepoNotificationSubscriptionStateDto`
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowNotificationSubscriptionsStatusResponse.to_dict() is deprecated and no longer maintained, "
