...
class UpdateGeneralPolicyDto:
    ...
    def disable_fork(self):
        r"""Gets the disable_fork of this UpdateGeneralPolicyDto.

        **参数解释：** 是否禁用fork。

        :return: The disable_fork of this UpdateGeneralPolicyDto.
        :rtype: bool
        """
    ...
    def disable_fork(self, disable_fork):
        r"""Sets the disable_fork of this UpdateGeneralPolicyDto.

        **参数解释：** 是否禁用fork。

        :param disable_fork: The disable_fork of this UpdateGeneralPolicyDto.
        :type disable_fork: bool
        """
    ...
    def branch_name_regex(self):
        r"""Gets the branch_name_regex of this UpdateGeneralPolicyDto.

        **参数解释：** 分支名称正则表达式。 **取值范围：** 字符串长度不少于1，不超过1000。

        :return: The branch_name_regex of this UpdateGeneralPolicyDto.
        :rtype: str
        """
    ...
    def branch_name_regex(self, branch_name_regex):
        r"""Sets the branch_name_regex of this UpdateGeneralPolicyDto.

        **参数解释：** 分支名称正则表达式。 **取值范围：** 字符串长度不少于1，不超过1000。

        :param branch_name_regex: The branch_name_regex of this UpdateGeneralPolicyDto.
        :type branch_name_regex: str
        """
    ...
    def tag_name_regex(self):
        r"""Gets the tag_name_regex of this UpdateGeneralPolicyDto.

        **参数解释：** 标签名正则表达式。 **取值范围：** 字符串长度不少于1，不超过1000。

        :return: The tag_name_regex of this UpdateGeneralPolicyDto.
        :rtype: str
        """
    ...
    def tag_name_regex(self, tag_name_regex):
        r"""Sets the tag_name_regex of this UpdateGeneralPolicyDto.

        **参数解释：** 标签名正则表达式。 **取值范围：** 字符串长度不少于1，不超过1000。

        :param tag_name_regex: The tag_name_regex of this UpdateGeneralPolicyDto.
        :type tag_name_regex: str
        """
    ...
    def generate_pre_merge_ref(self):
        r"""Gets the generate_pre_merge_ref of this UpdateGeneralPolicyDto.

        **参数解释：** 生成合并请求预合并。

        :return: The generate_pre_merge_ref of this UpdateGeneralPolicyDto.
        :rtype: bool
        """
    ...
    def generate_pre_merge_ref(self, generate_pre_merge_ref):
        r"""Sets the generate_pre_merge_ref of this UpdateGeneralPolicyDto.

        **参数解释：** 生成合并请求预合并。

        :param generate_pre_merge_ref: The generate_pre_merge_ref of this UpdateGeneralPolicyDto.
        :type generate_pre_merge_ref: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateGeneralPolicyDto):
            return False
