...
class ShowRepositoryGeneralPolicyResponse(SdkResponse):
    ...
    def disable_fork(self):
        r"""Gets the disable_fork of this ShowRepositoryGeneralPolicyResponse.

        **参数解释：** 是否禁止fork该仓库。 **约束限制：** 不涉及。 **取值范围：** - true，禁止fork。 - false，允许fork。 **默认取值：** 不涉及。

        :return: The disable_fork of this ShowRepositoryGeneralPolicyResponse.
        :rtype: bool
        """
    ...
    def disable_fork(self, disable_fork):
        r"""Sets the disable_fork of this ShowRepositoryGeneralPolicyResponse.

        **参数解释：** 是否禁止fork该仓库。 **约束限制：** 不涉及。 **取值范围：** - true，禁止fork。 - false，允许fork。 **默认取值：** 不涉及。

        :param disable_fork: The disable_fork of this ShowRepositoryGeneralPolicyResponse.
        :type disable_fork: bool
        """
    ...
    def generate_pre_merge_ref(self):
        r"""Gets the generate_pre_merge_ref of this ShowRepositoryGeneralPolicyResponse.

        **参数解释：** 是否预合并MR。 **约束限制：** 不涉及。 **取值范围：** - true，禁止预合并MR。 - false，允许预合并MR。 **默认取值：** 不涉及。

        :return: The generate_pre_merge_ref of this ShowRepositoryGeneralPolicyResponse.
        :rtype: bool
        """
    ...
    def generate_pre_merge_ref(self, generate_pre_merge_ref):
        r"""Sets the generate_pre_merge_ref of this ShowRepositoryGeneralPolicyResponse.

        **参数解释：** 是否预合并MR。 **约束限制：** 不涉及。 **取值范围：** - true，禁止预合并MR。 - false，允许预合并MR。 **默认取值：** 不涉及。

        :param generate_pre_merge_ref: The generate_pre_merge_ref of this ShowRepositoryGeneralPolicyResponse.
        :type generate_pre_merge_ref: bool
        """
    ...
    def branch_name_regex(self):
        r"""Gets the branch_name_regex of this ShowRepositoryGeneralPolicyResponse.

        **参数解释：** 分支名规则。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The branch_name_regex of this ShowRepositoryGeneralPolicyResponse.
        :rtype: str
        """
    ...
    def branch_name_regex(self, branch_name_regex):
        r"""Sets the branch_name_regex of this ShowRepositoryGeneralPolicyResponse.

        **参数解释：** 分支名规则。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param branch_name_regex: The branch_name_regex of this ShowRepositoryGeneralPolicyResponse.
        :type branch_name_regex: str
        """
    ...
    def tag_name_regex(self):
        r"""Gets the tag_name_regex of this ShowRepositoryGeneralPolicyResponse.

        **参数解释：** Tag名规则。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :return: The tag_name_regex of this ShowRepositoryGeneralPolicyResponse.
        :rtype: str
        """
    ...
    def tag_name_regex(self, tag_name_regex):
        r"""Sets the tag_name_regex of this ShowRepositoryGeneralPolicyResponse.

        **参数解释：** Tag名规则。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。

        :param tag_name_regex: The tag_name_regex of this ShowRepositoryGeneralPolicyResponse.
        :type tag_name_regex: str
        """
    ...
    def forbidden_developer_create_branch(self):
        r"""Gets the forbidden_developer_create_branch of this ShowRepositoryGeneralPolicyResponse.

        **参数解释：** 是否禁止开发者创建分支。 **约束限制：** 不涉及。 **取值范围：** - true，禁止开发者创建分支。 - false，允许开发者创建分支。

        :return: The forbidden_developer_create_branch of this ShowRepositoryGeneralPolicyResponse.
        :rtype: bool
        """
    ...
    def forbidden_developer_create_branch(self, forbidden_developer_create_branch):
        r"""Sets the forbidden_developer_create_branch of this ShowRepositoryGeneralPolicyResponse.

        **参数解释：** 是否禁止开发者创建分支。 **约束限制：** 不涉及。 **取值范围：** - true，禁止开发者创建分支。 - false，允许开发者创建分支。

        :param forbidden_developer_create_branch: The forbidden_developer_create_branch of this ShowRepositoryGeneralPolicyResponse.
        :type forbidden_developer_create_branch: bool
        """
    ...
    def create_branch_whitelist_users(self):
        r"""Gets the create_branch_whitelist_users of this ShowRepositoryGeneralPolicyResponse.

        **参数解释：** 开发人员创建分支权限白名单。

        :return: The create_branch_whitelist_users of this ShowRepositoryGeneralPolicyResponse.
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.PushRuleDevelopersDto`]
        """
    ...
    def create_branch_whitelist_users(self, create_branch_whitelist_users):
        r"""Sets the create_branch_whitelist_users of this ShowRepositoryGeneralPolicyResponse.

        **参数解释：** 开发人员创建分支权限白名单。

        :param create_branch_whitelist_users: The create_branch_whitelist_users of this ShowRepositoryGeneralPolicyResponse.
        :type create_branch_whitelist_users: list[:class:`huaweicloudsdkcodeartsrepo.v4.PushRuleDevelopersDto`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowRepositoryGeneralPolicyResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowRepositoryGeneralPolicyResponse):
            return False
