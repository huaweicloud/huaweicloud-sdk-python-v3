...
class ListRepositoryLanguagesResponse(SdkResponse):
    ...
    def __init__(self, languages=None, status=None, x_total=None):
        ...
        :type languages: list[:class:`huaweicloudsdkcodeartsrepo.v4.LanguagesDto`]
    ...
    def languages(self):
        ...
        **参数解释：** 语言描述。
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.LanguagesDto`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListRepositoryLanguagesResponse.to_dict() is deprecated and no longer maintained, "
