...
class ShowAverageEvaluationResponse(SdkResponse):
    ...
    def __init__(self, merge_request_id=None, average_evaluation_level=None, evaluations=None, custom_evaluations=None):
        ...
        :type evaluations: list[:class:`huaweicloudsdkcodeartsrepo.v4.MergeRequestBaseEvaluationDto`]
        :param custom_evaluations: **参数解释：** 自定义评价维度详情。
        :type custom_evaluations: list[:class:`huaweicloudsdkcodeartsrepo.v4.MergeRequestCustomAverageEvaluationDto`]
        """
    ...
    def evaluations(self):
        ...
        **参数解释：** 单人评价详情。
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.MergeRequestBaseEvaluationDto`]
        """
    ...
    def custom_evaluations(self):
        ...
        **参数解释：** 自定义评价维度详情。
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.MergeRequestCustomAverageEvaluationDto`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowAverageEvaluationResponse.to_dict() is deprecated and no longer maintained, "
