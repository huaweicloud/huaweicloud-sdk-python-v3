...
class AssociateGroupUserGroupResponse(SdkResponse):
    ...
    def __init__(self, success=None, failure=None):
        ...
        :type success: list[:class:`huaweicloudsdkcodeartsrepo.v4.MemberBaseDto`]
        :param failure: 关联失败成员列表
        :type failure: list[:class:`huaweicloudsdkcodeartsrepo.v4.FailureForBatchCreateGroupMembersDto`]
        """
    ...
    def success(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.MemberBaseDto`]
        """
    ...
    def failure(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.FailureForBatchCreateGroupMembersDto`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("AssociateGroupUserGroupResponse.to_dict() is deprecated and no longer maintained, "
