...
class BatchUpdateFilePushPermissionBodyDto:
    ...
    def __init__(self, permissions=None):
        ...
        :type permissions: list[:class:`huaweicloudsdkcodeartsrepo.v4.FilePushPermissionUpdateDto`]
        """
    ...
    def permissions(self):
        ...
        **参数解释：** 文件推送权限更新列表。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.FilePushPermissionUpdateDto`]
        """
