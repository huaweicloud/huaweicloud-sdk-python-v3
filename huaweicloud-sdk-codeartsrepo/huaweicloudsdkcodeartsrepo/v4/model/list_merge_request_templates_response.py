...
class ListMergeRequestTemplatesResponse(SdkResponse):
    ...
    def body(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.RepositoryMergeRequestTemplateDto`]
        """
        return self._body
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListMergeRequestTemplatesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListMergeRequestTemplatesResponse):
            return False
