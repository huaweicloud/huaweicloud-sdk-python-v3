...
class CommentPathDto:
    ...
    def __init__(self, new=None, old=None, path=None):
        ...
        :type new: list[:class:`huaweicloudsdkcodeartsrepo.v4.LineDiscussionDto`]
        :param old: **参数解释：** 位于文件对比结果左侧的检视意见集合。
        :type old: list[:class:`huaweicloudsdkcodeartsrepo.v4.LineDiscussionDto`]
        :param path: **参数解释：** 文件名。
        :type path: str
        """
    ...
    def new(self):
        ...
        **参数解释：** 位于文件对比结果右侧的检视意见集合。
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.LineDiscussionDto`]
        """
        return self._new
