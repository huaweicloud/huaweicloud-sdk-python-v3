...
class ReqWorkItemDto:
    ...
    def __init__(self, id=None, subject=None, sequence=None, tracker=None, status=None, priority=None):
        ...
        :type sequence: str
        :param tracker: 
        :type tracker: :class:`huaweicloudsdkcodeartsrepo.v4.ReqWorkItemBasicDto`
        :param status: 
        :type status: :class:`huaweicloudsdkcodeartsrepo.v4.ReqWorkItemBasicDto`
        :param priority: 
        :type priority: :class:`huaweicloudsdkcodeartsrepo.v4.ReqWorkItemBasicDto`
        """
    ...
    def tracker(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v4.ReqWorkItemBasicDto`
        """
