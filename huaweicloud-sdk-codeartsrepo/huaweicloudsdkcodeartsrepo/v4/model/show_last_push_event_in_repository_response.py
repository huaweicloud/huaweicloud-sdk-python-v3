...
class ShowLastPushEventInRepositoryResponse(SdkResponse):
    ...
    def __init__(self, ref=None, created_at=None, repository=None):
        ...
        :type created_at: str
        :param repository: 
        :type repository: :class:`huaweicloudsdkcodeartsrepo.v4.RepositoryBriefDto`
        """
    ...
    def repository(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v4.RepositoryBriefDto`
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowLastPushEventInRepositoryResponse.to_dict() is deprecated and no longer maintained, "
