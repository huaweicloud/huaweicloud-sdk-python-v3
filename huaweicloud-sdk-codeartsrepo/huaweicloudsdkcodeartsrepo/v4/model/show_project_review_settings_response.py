...
class ShowProjectReviewSettingsResponse(SdkResponse):
    ...
    def secondary_category_type(self):
        r"""Gets the secondary_category_type of this ShowProjectReviewSettingsResponse.

        **参数解释：** 系统预置检视意见分类类型(启用系统预置检视意见分类时返回，默认'HiCode')。

        :return: The secondary_category_type of this ShowProjectReviewSettingsResponse.
        :rtype: str
        """
    ...
    def secondary_category_type(self, secondary_category_type):
        r"""Sets the secondary_category_type of this ShowProjectReviewSettingsResponse.

        **参数解释：** 系统预置检视意见分类类型(启用系统预置检视意见分类时返回，默认'HiCode')。

        :param secondary_category_type: The secondary_category_type of this ShowProjectReviewSettingsResponse.
        :type secondary_category_type: str
        """
    ...
    def secondary_categories(self):
        r"""Gets the secondary_categories of this ShowProjectReviewSettingsResponse.

        **参数解释：** 系统预置检视意见分类详情(启用系统预置检视意见分类时返回)。

        :return: The secondary_categories of this ShowProjectReviewSettingsResponse.
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.CategoryDto`]
        """
    ...
    def secondary_categories(self, secondary_categories):
        r"""Sets the secondary_categories of this ShowProjectReviewSettingsResponse.

        **参数解释：** 系统预置检视意见分类详情(启用系统预置检视意见分类时返回)。

        :param secondary_categories: The secondary_categories of this ShowProjectReviewSettingsResponse.
        :type secondary_categories: list[:class:`huaweicloudsdkcodeartsrepo.v4.CategoryDto`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowProjectReviewSettingsResponse.to_dict() is deprecated and no longer maintained, "
