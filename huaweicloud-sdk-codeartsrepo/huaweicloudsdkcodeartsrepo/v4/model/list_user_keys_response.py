...
class ListUserKeysResponse(SdkResponse):
    ...
    def __init__(self, keys=None, total=None):
        ...
        :type keys: list[:class:`huaweicloudsdkcodeartsrepo.v4.SSHKeyDto`]
    ...
    def keys(self):
        ...
        **参数解释：** 密钥列表。 **取值范围：** 列表长度不少于0，不超过1000。
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.SSHKeyDto`]
        """
        return self._keys
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListUserKeysResponse.to_dict() is deprecated and no longer maintained, "
