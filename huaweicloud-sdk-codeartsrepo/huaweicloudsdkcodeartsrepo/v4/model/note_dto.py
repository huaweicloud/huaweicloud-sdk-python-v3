...
class NoteDto:
    ...
    @property
    def repository(self):
        r"""Gets the repository of this NoteDto.

        **参数解释：** 仓库路径。

        :return: The repository of this NoteDto.
        :rtype: str
        """
    ...
    def repository(self, repository):
        r"""Sets the repository of this NoteDto.

        **参数解释：** 仓库路径。

        :param repository: The repository of this NoteDto.
        :type repository: str
        """
    ...
    @property
    def from_robot(self):
        r"""Gets the from_robot of this NoteDto.

        **参数解释：** 是否为AI工具提供的。

        :return: The from_robot of this NoteDto.
        :rtype: bool
        """
    ...
    def from_robot(self, from_robot):
        r"""Sets the from_robot of this NoteDto.

        **参数解释：** 是否为AI工具提供的。

        :param from_robot: The from_robot of this NoteDto.
        :type from_robot: bool
        """
    ...
    def moderation_result(self):
        r"""Gets the moderation_result of this NoteDto.

        **参数解释：** 内容审核结果。

        :return: The moderation_result of this NoteDto.
        :rtype: bool
        """
    ...
    def moderation_result(self, moderation_result):
        r"""Sets the moderation_result of this NoteDto.

        **参数解释：** 内容审核结果。

        :param moderation_result: The moderation_result of this NoteDto.
        :type moderation_result: bool
        """
    ...
    def moderation_time(self):
        r"""Gets the moderation_time of this NoteDto.

        **参数解释：** 内容审核时间。

        :return: The moderation_time of this NoteDto.
        :rtype: int
        """
    ...
    def moderation_time(self, moderation_time):
        r"""Sets the moderation_time of this NoteDto.

        **参数解释：** 内容审核时间。

        :param moderation_time: The moderation_time of this NoteDto.
        :type moderation_time: int
        """
    ...
    def moderation_status(self):
        r"""Gets the moderation_status of this NoteDto.

        **参数解释：** 内容审核状态。

        :return: The moderation_status of this NoteDto.
        :rtype: int
        """
    ...
    def moderation_status(self, moderation_status):
        r"""Sets the moderation_status of this NoteDto.

        **参数解释：** 内容审核状态。

        :param moderation_status: The moderation_status of this NoteDto.
        :type moderation_status: int
        """
