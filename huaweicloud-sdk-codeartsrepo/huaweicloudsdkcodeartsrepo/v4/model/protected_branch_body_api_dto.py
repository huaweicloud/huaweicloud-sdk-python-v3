...
class ProtectedBranchBodyApiDto:
    ...
    def __init__(self, name=None, actions=None):
        ...
        :type actions: list[:class:`huaweicloudsdkcodeartsrepo.v4.ProtectedActionBasicApiDto`]
        """
    ...
    def actions(self):
        ...
        **参数解释：** 事件列表。
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v4.ProtectedActionBasicApiDto`]
        """
