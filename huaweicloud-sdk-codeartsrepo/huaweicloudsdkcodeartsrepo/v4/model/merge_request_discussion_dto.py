...
class MergeRequestDiscussionDto:
    ...
    def repository_id(self):
        r"""Gets the repository_id of this MergeRequestDiscussionDto.

        **参数解释：** 仓库id。

        :return: The repository_id of this MergeRequestDiscussionDto.
        :rtype: int
        """
    ...
    def repository_id(self, repository_id):
        r"""Sets the repository_id of this MergeRequestDiscussionDto.

        **参数解释：** 仓库id。

        :param repository_id: The repository_id of this MergeRequestDiscussionDto.
        :type repository_id: int
        """
    ...
    def repository_full_path(self):
        r"""Gets the repository_full_path of this MergeRequestDiscussionDto.

        **参数解释：** 仓库路径。

        :return: The repository_full_path of this MergeRequestDiscussionDto.
        :rtype: str
        """
    ...
    def repository_full_path(self, repository_full_path):
        r"""Sets the repository_full_path of this MergeRequestDiscussionDto.

        **参数解释：** 仓库路径。

        :param repository_full_path: The repository_full_path of this MergeRequestDiscussionDto.
        :type repository_full_path: str
        """
