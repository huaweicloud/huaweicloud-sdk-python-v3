...
class CreateMergeRequestResponse(SdkResponse):
    ...
    def is_source_branch_default(self):
        r"""Gets the is_source_branch_default of this CreateMergeRequestResponse.

        源分支是否为默认分支

        :return: The is_source_branch_default of this CreateMergeRequestResponse.
        :rtype: bool
        """
    ...
    def is_source_branch_default(self, is_source_branch_default):
        r"""Sets the is_source_branch_default of this CreateMergeRequestResponse.

        源分支是否为默认分支

        :param is_source_branch_default: The is_source_branch_default of this CreateMergeRequestResponse.
        :type is_source_branch_default: bool
        """
    ...
    @property
    def upvotes(self):
        r"""Gets the upvotes of this CreateMergeRequestResponse.

        MR点赞数

        :return: The upvotes of this CreateMergeRequestResponse.
        :rtype: int
        """
    ...
    def upvotes(self, upvotes):
        r"""Sets the upvotes of this CreateMergeRequestResponse.

        MR点赞数

        :param upvotes: The upvotes of this CreateMergeRequestResponse.
        :type upvotes: int
        """
    ...
    @property
    def downvotes(self):
        r"""Gets the downvotes of this CreateMergeRequestResponse.

        MR倒赞数

        :return: The downvotes of this CreateMergeRequestResponse.
        :rtype: int
        """
    ...
    def downvotes(self, downvotes):
        r"""Sets the downvotes of this CreateMergeRequestResponse.

        MR倒赞数

        :param downvotes: The downvotes of this CreateMergeRequestResponse.
        :type downvotes: int
        """
    ...
    @property
    def assignee(self):
        r"""Gets the assignee of this CreateMergeRequestResponse.

        :return: The assignee of this CreateMergeRequestResponse.
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v4.UserBasicExternalDto`
        """
    ...
    def assignee(self, assignee):
        r"""Sets the assignee of this CreateMergeRequestResponse.

        :param assignee: The assignee of this CreateMergeRequestResponse.
        :type assignee: :class:`huaweicloudsdkcodeartsrepo.v4.UserBasicExternalDto`
        """
    ...
    def should_remove_source_branch(self):
        r"""Gets the should_remove_source_branch of this CreateMergeRequestResponse.

        是否需要删除源分支

        :return: The should_remove_source_branch of this CreateMergeRequestResponse.
        :rtype: bool
        """
    ...
    def should_remove_source_branch(self, should_remove_source_branch):
        r"""Sets the should_remove_source_branch of this CreateMergeRequestResponse.

        是否需要删除源分支

        :param should_remove_source_branch: The should_remove_source_branch of this CreateMergeRequestResponse.
        :type should_remove_source_branch: bool
        """
    ...
    def only_assignee_can_merge(self):
        r"""Gets the only_assignee_can_merge of this CreateMergeRequestResponse.

        只有合并人允许合入

        :return: The only_assignee_can_merge of this CreateMergeRequestResponse.
        :rtype: bool
        """
    ...
    def only_assignee_can_merge(self, only_assignee_can_merge):
        r"""Sets the only_assignee_can_merge of this CreateMergeRequestResponse.

        只有合并人允许合入

        :param only_assignee_can_merge: The only_assignee_can_merge of this CreateMergeRequestResponse.
        :type only_assignee_can_merge: bool
        """
    ...
    @property
    def topic(self):
        r"""Gets the topic of this CreateMergeRequestResponse.

        合并请求关联主题

        :return: The topic of this CreateMergeRequestResponse.
        :rtype: str
        """
        return self._topic
    ...
    def topic(self, topic):
        r"""Sets the topic of this CreateMergeRequestResponse.

        合并请求关联主题

        :param topic: The topic of this CreateMergeRequestResponse.
        :type topic: str
        """
        self._topic = topic
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateMergeRequestResponse.to_dict() is deprecated and no longer maintained, "
