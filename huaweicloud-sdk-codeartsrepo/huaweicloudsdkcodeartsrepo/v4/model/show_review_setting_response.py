...
class ShowReviewSettingResponse(SdkResponse):
    ...
    def categories_and_modules_enabled(self):
        r"""Gets the categories_and_modules_enabled of this ShowReviewSettingResponse.

        **参数解释：** 是否启用启用检视意见分类与模块。

        :return: The categories_and_modules_enabled of this ShowReviewSettingResponse.
        :rtype: bool
        """
    ...
    def categories_and_modules_enabled(self, categories_and_modules_enabled):
        r"""Sets the categories_and_modules_enabled of this ShowReviewSettingResponse.

        **参数解释：** 是否启用启用检视意见分类与模块。

        :param categories_and_modules_enabled: The categories_and_modules_enabled of this ShowReviewSettingResponse.
        :type categories_and_modules_enabled: bool
        """
    ...
    def secondary_category_enabled(self):
        r"""Gets the secondary_category_enabled of this ShowReviewSettingResponse.

        **参数解释：** 是否启用系统预置检视意见分类。

        :return: The secondary_category_enabled of this ShowReviewSettingResponse.
        :rtype: bool
        """
    ...
    def secondary_category_enabled(self, secondary_category_enabled):
        r"""Sets the secondary_category_enabled of this ShowReviewSettingResponse.

        **参数解释：** 是否启用系统预置检视意见分类。

        :param secondary_category_enabled: The secondary_category_enabled of this ShowReviewSettingResponse.
        :type secondary_category_enabled: bool
        """
    ...
    def primary_categories(self):
        r"""Gets the primary_categories of this ShowReviewSettingResponse.

        **参数解释：** 检视意见分类(已勾选)。

        :return: The primary_categories of this ShowReviewSettingResponse.
    ...
    def primary_categories(self, primary_categories):
        r"""Sets the primary_categories of this ShowReviewSettingResponse.

        **参数解释：** 检视意见分类(已勾选)。

        :param primary_categories: The primary_categories of this ShowReviewSettingResponse.
        :type primary_categories: list[:class:`huaweicloudsdkcodeartsrepo.v4.CategoryDto`]
        """
    ...
    def review_default_categories(self):
        r"""Gets the review_default_categories of this ShowReviewSettingResponse.

        **参数解释：** 检视意见分类的key(已勾选)。

        :return: The review_default_categories of this ShowReviewSettingResponse.
        :rtype: list[str]
        """
    ...
    def review_default_categories(self, review_default_categories):
        r"""Sets the review_default_categories of this ShowReviewSettingResponse.

        **参数解释：** 检视意见分类的key(已勾选)。

        :param review_default_categories: The review_default_categories of this ShowReviewSettingResponse.
        :type review_default_categories: list[str]
        """
    ...
    def review_customized_categories(self):
        r"""Gets the review_customized_categories of this ShowReviewSettingResponse.

        **参数解释：** 自定义分类。

        :return: The review_customized_categories of this ShowReviewSettingResponse.
        :rtype: list[str]
        """
    ...
    def review_customized_categories(self, review_customized_categories):
        r"""Sets the review_customized_categories of this ShowReviewSettingResponse.

        **参数解释：** 自定义分类。

        :param review_customized_categories: The review_customized_categories of this ShowReviewSettingResponse.
        :type review_customized_categories: list[str]
        """
    ...
    def review_modules(self):
        r"""Gets the review_modules of this ShowReviewSettingResponse.

        **参数解释：** 检视意见模块。

        :return: The review_modules of this ShowReviewSettingResponse.
        :rtype: list[str]
        """
    ...
    def review_modules(self, review_modules):
        r"""Sets the review_modules of this ShowReviewSettingResponse.

        **参数解释：** 检视意见模块。

        :param review_modules: The review_modules of this ShowReviewSettingResponse.
        :type review_modules: list[str]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowReviewSettingResponse.to_dict() is deprecated and no longer maintained, "
