...
class UpdateMergeRequestApprovalStateResponse(SdkResponse):
    ...
    def __init__(self, result=None, status=None):
        ...
        :param result: 
        :type result: :class:`huaweicloudsdkcodeartsrepo.v3.ApproverBasicDto`
        :param status: 响应状态
        :type status: str
        """
    ...
    def result(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v3.ApproverBasicDto`
        """
        return self._result
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateMergeRequestApprovalStateResponse.to_dict() is deprecated and no longer maintained, "
