...
class ListRepoMembersResponse(SdkResponse):
    ...
    def __init__(self, error=None, result=None, status=None):
        ...
        :param result: 
        :type result: :class:`huaweicloudsdkcodeartsrepo.v3.RepositoryMemberList`
        :param status: 响应状态
        :type status: str
        """
    ...
    def result(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v3.RepositoryMemberList`
        """
        return self._result
    ...
    def status(self):
        ...
        :return: The status of this ListRepoMembersResponse.
        :rtype: str
        """
        return self._status
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListRepoMembersResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListRepoMembersResponse):
            return False
