...
class BranchesItem:
    ...
    def __init__(self, commit=None, diverging_commit_counts=None, name=None):
        ...
        :param commit: 
        :type commit: :class:`huaweicloudsdkcodeartsrepo.v3.CommitV2`
        :param diverging_commit_counts: 
        :type diverging_commit_counts: :class:`huaweicloudsdkcodeartsrepo.v3.DivergingCommitCounts`
        :param name: 分支名
        :type name: str
        """
    ...
    def commit(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v3.CommitV2`
        """
        return self._commit
    ...
    def diverging_commit_counts(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v3.DivergingCommitCounts`
        """
