...
class ShowDiffCommitResponse(SdkResponse):
    ...
    def __init__(self, error=None, result=None, status=None):
        ...
        :param result: 差异列表
        :type result: list[:class:`huaweicloudsdkcodeartsrepo.v3.DiffCommitInfo`]
        :param status: 响应状态
        :type status: str
        """
    ...
    def result(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v3.DiffCommitInfo`]
        """
        return self._result
    ...
    def status(self):
        ...
        :return: The status of this ShowDiffCommitResponse.
        :rtype: str
        """
        return self._status
