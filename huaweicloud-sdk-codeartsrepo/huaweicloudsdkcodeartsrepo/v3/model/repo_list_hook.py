...
class RepoListHook:
    ...
    def __init__(self, hooks=None):
        ...
        :param hooks: hook列表
        :type hooks: list[:class:`huaweicloudsdkcodeartsrepo.v3.RepoHook`]
        """
    ...
    def hooks(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v3.RepoHook`]
        """
        return self._hooks
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RepoListHook):
            return False
