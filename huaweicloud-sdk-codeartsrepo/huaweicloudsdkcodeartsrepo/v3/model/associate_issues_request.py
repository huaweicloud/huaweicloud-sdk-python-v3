...
class AssociateIssuesRequest:
    ...
    openapi_types = {
        'body': 'AssociateIssuesRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :type body: :class:`huaweicloudsdkcodeartsrepo.v3.AssociateIssuesRequestBody`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v3.AssociateIssuesRequestBody`
        """
        return self._body
