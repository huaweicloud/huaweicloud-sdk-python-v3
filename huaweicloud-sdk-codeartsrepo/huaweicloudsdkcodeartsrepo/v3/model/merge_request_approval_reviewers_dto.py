...
class MergeRequestApprovalReviewersDto:
    ...
    def __init__(self, approval_merge_request_reviewers=None):
        ...
        :type approval_merge_request_reviewers: list[:class:`huaweicloudsdkcodeartsrepo.v3.ApprovalUserDto`]
        """
    ...
    def approval_merge_request_reviewers(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v3.ApprovalUserDto`]
        """
