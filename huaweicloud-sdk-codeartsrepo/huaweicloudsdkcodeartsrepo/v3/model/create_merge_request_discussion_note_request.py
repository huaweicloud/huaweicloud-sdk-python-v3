...
class CreateMergeRequestDiscussionNoteRequest:
    ...
    def __init__(self, repository_id=None, merge_request_iid=None, discussion_id=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkcodeartsrepo.v3.CreateMergeRequestDiscussionNoteDto`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v3.CreateMergeRequestDiscussionNoteDto`
        """
        return self._body
