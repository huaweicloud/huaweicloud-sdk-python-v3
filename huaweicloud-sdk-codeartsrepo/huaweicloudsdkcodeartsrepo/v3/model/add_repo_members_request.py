...
class AddRepoMembersRequest:
    ...
    def __init__(self, repository_uuid=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkcodeartsrepo.v3.CreateRepoMemberRequest`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v3.CreateRepoMemberRequest`
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddRepoMembersRequest):
            return False
