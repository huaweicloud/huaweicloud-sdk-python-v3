...
class DeleteRepoMemberResponse(SdkResponse):
    ...
    def __init__(self, error=None, result=None, status=None):
        ...
        :param result: 
        :type result: :class:`huaweicloudsdkcodeartsrepo.v3.Empty`
        :param status: 响应状态
        :type status: str
        """
    ...
    def result(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v3.Empty`
        """
        return self._result
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteRepoMemberResponse.to_dict() is deprecated and no longer maintained, "
