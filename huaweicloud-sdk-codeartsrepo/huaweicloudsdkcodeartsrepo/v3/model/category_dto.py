...
class CategoryDto:
    ...
    def __init__(self, key=None, name_zh=None, name_en=None, sub_categories=None):
        ...
        :param name_en: 英文名
        :type name_en: str
        :param sub_categories: 二级分类
        :type sub_categories: list[:class:`huaweicloudsdkcodeartsrepo.v3.CategoryDto`]
        """
    ...
    def sub_categories(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v3.CategoryDto`]
        """
