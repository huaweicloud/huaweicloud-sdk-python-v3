...
class ListProductTwoTemplatesResponse(SdkResponse):
    ...
    def status(self):
        ...
        :return: The status of this ListProductTwoTemplatesResponse.
        :rtype: str
        """
        return self._status
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListProductTwoTemplatesResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListProductTwoTemplatesResponse):
            return False
