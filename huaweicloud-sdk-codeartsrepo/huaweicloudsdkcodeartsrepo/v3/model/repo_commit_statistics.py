...
class RepoCommitStatistics:
    ...
    def __init__(self, all_branch_commits_count=None, codelines=None, count=None, event=None, statistics=None, total=None):
        ...
        :type codelines: list[:class:`huaweicloudsdkcodeartsrepo.v3.RepoDailyCodeline`]
        :param count: 对应分支仓库总提交次数
        :type count: int
        :param event: 
        :type event: :class:`huaweicloudsdkcodeartsrepo.v3.RepoStatisticsEvent`
        :param statistics: 仓库统计列表
        :type statistics: list[:class:`huaweicloudsdkcodeartsrepo.v3.RepoStatistics`]
        :param total: 仓库统计次数
        :type total: int
        """
    ...
    def codelines(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v3.RepoDailyCodeline`]
        """
    ...
    def event(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v3.RepoStatisticsEvent`
        """
        return self._event
    ...
    def statistics(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v3.RepoStatistics`]
        """
