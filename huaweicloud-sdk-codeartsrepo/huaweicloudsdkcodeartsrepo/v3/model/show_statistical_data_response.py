...
class ShowStatisticalDataResponse(SdkResponse):
    ...
    def __init__(self, error=None, result=None, status=None):
        ...
        :param result: 
        :type result: :class:`huaweicloudsdkcodeartsrepo.v3.RepositoryStatisticsVO`
        :param status: 响应状态
        :type status: str
        """
    ...
    def result(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v3.RepositoryStatisticsVO`
        """
        return self._result
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowStatisticalDataResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowStatisticalDataResponse):
            return False
