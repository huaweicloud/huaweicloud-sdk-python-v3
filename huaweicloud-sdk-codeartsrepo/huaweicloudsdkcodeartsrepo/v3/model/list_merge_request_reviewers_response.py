...
class ListMergeRequestReviewersResponse(SdkResponse):
    ...
    openapi_types = {
        'result': 'MergeRequestApprovalReviewersDto',
        'status': 'str'
    }
    ...
    def __init__(self, result=None, status=None):
        ...
        :param result: 
        :type result: :class:`huaweicloudsdkcodeartsrepo.v3.MergeRequestApprovalReviewersDto`
        :param status: 响应状态
        :type status: str
        """
    ...
    def result(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v3.MergeRequestApprovalReviewersDto`
        """
        return self._result
    ...
    def status(self):
        ...
        :return: The status of this ListMergeRequestReviewersResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this ListMergeRequestReviewersResponse.
        :type status: str
        """
        self._status = status
