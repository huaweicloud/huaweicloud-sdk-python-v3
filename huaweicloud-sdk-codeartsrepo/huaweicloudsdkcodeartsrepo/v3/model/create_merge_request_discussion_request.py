...
class CreateMergeRequestDiscussionRequest:
    ...
    def __init__(self, repository_id=None, merge_request_iid=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkcodeartsrepo.v3.CreateMergeRequestDiscussionBodyDto`
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v3.CreateMergeRequestDiscussionBodyDto`
        """
        return self._body
