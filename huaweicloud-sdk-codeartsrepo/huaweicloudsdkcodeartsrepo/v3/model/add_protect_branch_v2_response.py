...
class AddProtectBranchV2Response(SdkResponse):
    ...
    def status(self):
        ...
        :return: The status of this AddProtectBranchV2Response.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this AddProtectBranchV2Response.
        :type status: str
        """
        self._status = status
    ...
    def to_dict(self):
        import warnings
        warnings.warn("AddProtectBranchV2Response.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddProtectBranchV2Response):
            return False
