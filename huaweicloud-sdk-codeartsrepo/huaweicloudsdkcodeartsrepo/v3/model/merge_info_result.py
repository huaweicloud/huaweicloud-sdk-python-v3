...
class MergeInfoResult:
    ...
    def __init__(self, approval_merge_request_approvers=None, author=None, closed_at=None, created_at=None, description=None, devcloud_source_branch=None, id=None, iid=None, is_source_branch_exist=None, merge_request_assignee_list=None, merge_request_diff=None, merge_status=None, source_branch=None, state=None, target_branch=None, title=None, updated_at=None):
        ...
        :type approval_merge_request_approvers: list[:class:`huaweicloudsdkcodeartsrepo.v3.ApprovalMergeRequestApproversItem`]
        :param author: 
        ...
        :type merge_request_assignee_list: list[:class:`huaweicloudsdkcodeartsrepo.v3.MergeRequestAssigneeListItem`]
        :param merge_request_diff: 
        :type merge_request_diff: :class:`huaweicloudsdkcodeartsrepo.v3.MergeRequestDiff`
    ...
    def approval_merge_request_approvers(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v3.ApprovalMergeRequestApproversItem`]
        """
    ...
    def merge_request_assignee_list(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsrepo.v3.MergeRequestAssigneeListItem`]
        """
    ...
    def merge_request_diff(self):
        ...
        :rtype: :class:`huaweicloudsdkcodeartsrepo.v3.MergeRequestDiff`
        """
