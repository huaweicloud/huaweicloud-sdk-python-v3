...
class GlanceDeleteImageRequest(object):
    ...
    openapi_types = {
        'image_id': 'str',
        'body': 'GlanceDeleteImageRequestBody'
    }
    ...
    def image_id(self):
        ...
        :return: The image_id of this GlanceDeleteImageRequest.
        :rtype: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GlanceDeleteImageRequest):
            return False
