...
class ImageInfo:
    ...
    def system_cmkid(self):
        """Gets the system_cmkid of this ImageInfo.

        加密镜像所使用的密钥ID。

        :return: The system_cmkid of this ImageInfo.
        :rtype: str
        """
    ...
    def system_cmkid(self, system_cmkid):
        """Sets the system_cmkid of this ImageInfo.

        加密镜像所使用的密钥ID。

        :param system_cmkid: The system_cmkid of this ImageInfo.
        :type: str
        """
