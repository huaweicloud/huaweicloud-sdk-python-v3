...
class GlanceListImageMembersResponse(SdkResponse):
    ...
    @property
    def page_info(self):
        r"""Gets the page_info of this GlanceListImageMembersResponse.

        :return: The page_info of this GlanceListImageMembersResponse.
    ...
    def page_info(self, page_info):
        r"""Sets the page_info of this GlanceListImageMembersResponse.

        :param page_info: The page_info of this GlanceListImageMembersResponse.
        :type page_info: :class:`huaweicloudsdkims.v2.GlancePageInfo`
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("GlanceListImageMembersResponse.to_dict() is deprecated and no longer maintained, "
