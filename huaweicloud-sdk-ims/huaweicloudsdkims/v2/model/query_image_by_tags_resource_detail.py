...
class QueryImageByTagsResourceDetail:
    ...
    def __init__(self, status=None):
        """QueryImageByTagsResourceDetail - a model defined in huaweicloud sdk"""
    ...
    def status(self):
        ...
        :return: The status of this QueryImageByTagsResourceDetail.
        :rtype: str
        """
        return self._status
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QueryImageByTagsResourceDetail):
            return False
