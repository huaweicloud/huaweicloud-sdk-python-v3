...
class ListOsVersionsResponse(SdkResponse):
    ...
    openapi_types = {
        'body': 'list[ListOsVersionsResponseBody]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListOsVersionsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListOsVersionsResponse):
            return False
