...
class CreateWholeImageRequest(object):
    ...
    openapi_types = {
        'body': 'CreateWholeImageRequestBody'
    }
    ...
    def __init__(self, body=None):  # noqa: E501
        """CreateWholeImageRequest - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateWholeImageRequest):
            return False
