...
class ListImageByTagsResponse(SdkResponse):
    ...
    openapi_types = {
        'resources': 'list[ShowImageByTagsResource]',
        'total_count': 'int'
    }
    ...
    def total_count(self):
        ...
        :return: The total_count of this ListImageByTagsResponse.
        :rtype: int
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListImageByTagsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListImageByTagsResponse):
            return False
