...
class ShowSecAppTaskResultResponse(SdkResponse):
    ...
    def __init__(self, basic_info=None, apk_component_info=None, hap_component_info=None, vuln_list=None, privacy_compliance_list=None):
        ...
        :type vuln_list: list[:class:`huaweicloudsdkcodeartsgovernance.v1.VulnInfo`]
        :param privacy_compliance_list: 隐私合规列表
        :type privacy_compliance_list: list[:class:`huaweicloudsdkcodeartsgovernance.v1.PrivacyComplianceInfo`]
        """
    ...
    def vuln_list(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsgovernance.v1.VulnInfo`]
        """
    ...
    def privacy_compliance_list(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsgovernance.v1.PrivacyComplianceInfo`]
        """
