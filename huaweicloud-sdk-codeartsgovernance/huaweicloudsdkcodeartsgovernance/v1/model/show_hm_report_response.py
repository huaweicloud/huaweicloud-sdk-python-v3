...
class ShowHmReportResponse(SdkResponse):
    ...
    def code(self):
        ...
        :return: The code of this ShowHmReportResponse.
        :rtype: str
        """
        return self._code
    ...
    def code(self, code):
        ...
        :param code: The code of this ShowHmReportResponse.
        :type code: str
        """
        self._code = code
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowHmReportResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowHmReportResponse):
            return False
