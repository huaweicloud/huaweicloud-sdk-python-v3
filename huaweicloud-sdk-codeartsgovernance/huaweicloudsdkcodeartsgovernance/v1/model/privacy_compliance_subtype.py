...
class PrivacyComplianceSubtype:
    ...
    openapi_types = {
        'desc': 'str',
        'checker_rules': 'list[VulCheckerRule]'
    }
    ...
    def __init__(self, desc=None, checker_rules=None):
        ...
        :type checker_rules: list[:class:`huaweicloudsdkcodeartsgovernance.v1.VulCheckerRule`]
        """
    ...
    def checker_rules(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsgovernance.v1.VulCheckerRule`]
        """
