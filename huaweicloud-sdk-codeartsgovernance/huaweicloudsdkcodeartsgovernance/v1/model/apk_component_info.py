...
class ApkComponentInfo:
    ...
    def __init__(self, permission=None, activity=None, service=None, provider=None, receive=None):
        ...
        :type activity: list[:class:`huaweicloudsdkcodeartsgovernance.v1.ApkComponentItem`]
        :param service: 安卓service列表，仅安卓任务存在该组件
        :type service: list[:class:`huaweicloudsdkcodeartsgovernance.v1.ApkComponentItem`]
        :param provider: 安卓provider列表，仅安卓任务存在该组件
        :type provider: list[:class:`huaweicloudsdkcodeartsgovernance.v1.ApkComponentItem`]
        :param receive: 安卓receive列表，仅安卓任务存在该组件
        :type receive: list[:class:`huaweicloudsdkcodeartsgovernance.v1.ApkComponentItem`]
        """
    ...
    def activity(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartsgovernance.v1.ApkComponentItem`]
        """
