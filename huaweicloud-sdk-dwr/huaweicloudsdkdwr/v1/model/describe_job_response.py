...
class DescribeJobResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this DescribeJobResponse.

        :return: The data of this DescribeJobResponse.
        :rtype: :class:`huaweicloudsdkdwr.v1.JobData`
        """
        return self._data

    @data.setter
    def data(self, data):
        r"""Sets the data of this DescribeJobResponse.

        :param data: The data of this DescribeJobResponse.
        :type data: :class:`huaweicloudsdkdwr.v1.JobData`
        """
        self._data = data
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DescribeJobResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DescribeJobResponse):
            return False
