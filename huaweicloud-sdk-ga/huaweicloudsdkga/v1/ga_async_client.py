...
class GaAsyncClient(Client):
    ...
    def list_byoip_pools_async(self, request):
        r"""查询自带IP地址池列表
    ...
    def list_byoip_pools_async_invoker(self, request):
        http_info = self._list_byoip_pools_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_byoip_pools_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_all_pops_async(self, request):
        r"""查询pop列表
    ...
    def list_all_pops_async_invoker(self, request):
        http_info = self._list_all_pops_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_all_pops_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_tenant_quotas_async(self, request):
        r"""查询配额列表
    ...
    def list_tenant_quotas_async_invoker(self, request):
        http_info = self._list_tenant_quotas_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_tenant_quotas_http_info(self, request):
        http_info = {
            "method": "GET",
