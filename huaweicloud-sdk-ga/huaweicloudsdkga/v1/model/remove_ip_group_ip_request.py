...
class RemoveIpGroupIpRequest:
    ...
    openapi_types = {
        'ip_group_id': 'str',
        'body': 'RemoveIpGroupIpRequestBody'
    }
    ...
    def __init__(self, ip_group_id=None, body=None):
        ...
        :param body: Body of the RemoveIpGroupIpRequest
    ...
    def ip_group_id(self):
        ...
        :return: The ip_group_id of this RemoveIpGroupIpRequest.
        :rtype: str
        """
    ...
    def ip_group_id(self, ip_group_id):
        ...
        :param ip_group_id: The ip_group_id of this RemoveIpGroupIpRequest.
        :type ip_group_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RemoveIpGroupIpRequest):
            return False
