...
class ListTagsResponse(SdkResponse):
    ...
    def total_count(self):
        r"""Gets the total_count of this ListTagsResponse.

        资源总数量。

        :return: The total_count of this ListTagsResponse.
        :rtype: int
        """
    ...
    def total_count(self, total_count):
        r"""Sets the total_count of this ListTagsResponse.

        资源总数量。

        :param total_count: The total_count of this ListTagsResponse.
        :type total_count: int
        """
