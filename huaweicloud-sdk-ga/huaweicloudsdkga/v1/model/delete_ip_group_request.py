...
class DeleteIpGroupRequest:
    ...
    def ip_group_id(self):
        r"""Gets the ip_group_id of this DeleteIpGroupRequest.

        IP地址组ID。

        :return: The ip_group_id of this DeleteIpGroupRequest.
        :rtype: str
        """
    ...
    def ip_group_id(self, ip_group_id):
        r"""Sets the ip_group_id of this DeleteIpGroupRequest.

        IP地址组ID。

        :param ip_group_id: The ip_group_id of this DeleteIpGroupRequest.
        :type ip_group_id: str
        """
