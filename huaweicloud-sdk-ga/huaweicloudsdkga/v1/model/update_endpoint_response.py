...
class UpdateEndpointResponse(SdkResponse):
    ...
    @property
    def request_id(self):
        r"""Gets the request_id of this UpdateEndpointResponse.

        请求ID。

        :return: The request_id of this UpdateEndpointResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        r"""Sets the request_id of this UpdateEndpointResponse.

        请求ID。

        :param request_id: The request_id of this UpdateEndpointResponse.
        :type request_id: str
        """
