...
class ShowEndpointResponse(SdkResponse):
    ...
    @property
    def request_id(self):
        r"""Gets the request_id of this ShowEndpointResponse.

        请求ID。

        :return: The request_id of this ShowEndpointResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        r"""Sets the request_id of this ShowEndpointResponse.

        请求ID。

        :param request_id: The request_id of this ShowEndpointResponse.
        :type request_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowEndpointResponse.to_dict() is deprecated and no longer maintained, "
