...
class ShowEndpointGroupResponse(SdkResponse):
    ...
    def endpoint_group(self):
        r"""Gets the endpoint_group of this ShowEndpointGroupResponse.
    ...
    def endpoint_group(self, endpoint_group):
        r"""Sets the endpoint_group of this ShowEndpointGroupResponse.
    ...
    @property
    def request_id(self):
        r"""Gets the request_id of this ShowEndpointGroupResponse.

        请求ID。

        :return: The request_id of this ShowEndpointGroupResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        r"""Sets the request_id of this ShowEndpointGroupResponse.

        请求ID。

        :param request_id: The request_id of this ShowEndpointGroupResponse.
        :type request_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowEndpointGroupResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowEndpointGroupResponse):
            return False
