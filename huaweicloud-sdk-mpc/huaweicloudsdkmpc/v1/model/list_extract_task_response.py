...
class ListExtractTaskResponse(SdkResponse):
    ...
    @property
    def total(self):
        r"""Gets the total of this ListExtractTaskResponse.
    ...
    def total(self, total):
        r"""Sets the total of this ListExtractTaskResponse.
    ...
    @property
    def tasks(self):
        r"""Gets the tasks of this ListExtractTaskResponse.
    ...
    def tasks(self, tasks):
        r"""Sets the tasks of this ListExtractTaskResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListExtractTaskResponse.to_dict() is deprecated and no longer maintained, "
