...
class CreateThumbnailsTaskRequest:
    ...
    @property
    def body(self):
        r"""Gets the body of this CreateThumbnailsTaskRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this CreateThumbnailsTaskRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateThumbnailsTaskRequest):
            return False
