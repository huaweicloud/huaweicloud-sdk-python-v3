...
class CreateQualityEnhanceTemplateRequest:
    ...
    def __init__(self, body=None):
        r"""CreateQualityEnhanceTemplateRequest
    ...
    @property
    def body(self):
        r"""Gets the body of this CreateQualityEnhanceTemplateRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this CreateQualityEnhanceTemplateRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateQualityEnhanceTemplateRequest):
            return False
