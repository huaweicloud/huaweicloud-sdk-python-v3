...
class ListAllObsObjListResponse(SdkResponse):
    ...
    def __init__(self, objects=None):
        ...
        :param objects: 返回OBS对象组
        :type objects: list[:class:`huaweicloudsdkmpc.v1.ObsObject`]
        """
    ...
    def objects(self):
        ...
        :rtype: list[:class:`huaweicloudsdkmpc.v1.ObsObject`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAllObsObjListResponse.to_dict() is deprecated and no longer maintained, "
