...
class ListAnimatedGraphicsTaskRequest:
    ...
    def __init__(self, x_language=None, task_id=None, status=None, start_time=None, end_time=None, page=None, size=None):
        r"""ListAnimatedGraphicsTaskRequest
    ...
    @property
    def x_language(self):
        r"""Gets the x_language of this ListAnimatedGraphicsTaskRequest.
    ...
    def x_language(self, x_language):
        r"""Sets the x_language of this ListAnimatedGraphicsTaskRequest.
    ...
    @property
    def task_id(self):
        r"""Gets the task_id of this ListAnimatedGraphicsTaskRequest.
    ...
    def task_id(self, task_id):
        r"""Sets the task_id of this ListAnimatedGraphicsTaskRequest.
    ...
    @property
    def status(self):
        r"""Gets the status of this ListAnimatedGraphicsTaskRequest.
    ...
    def status(self, status):
        r"""Sets the status of this ListAnimatedGraphicsTaskRequest.
    ...
    @property
    def start_time(self):
        r"""Gets the start_time of this ListAnimatedGraphicsTaskRequest.
    ...
    def start_time(self, start_time):
        r"""Sets the start_time of this ListAnimatedGraphicsTaskRequest.
    ...
    @property
    def end_time(self):
        r"""Gets the end_time of this ListAnimatedGraphicsTaskRequest.
    ...
    def end_time(self, end_time):
        r"""Sets the end_time of this ListAnimatedGraphicsTaskRequest.
    ...
    @property
    def page(self):
        r"""Gets the page of this ListAnimatedGraphicsTaskRequest.
    ...
    @page.setter
    def page(self, page):
        r"""Sets the page of this ListAnimatedGraphicsTaskRequest.
    ...
    @property
    def size(self):
        r"""Gets the size of this ListAnimatedGraphicsTaskRequest.
    ...
    @size.setter
    def size(self, size):
        r"""Sets the size of this ListAnimatedGraphicsTaskRequest.
