...
class MpcAsyncClient(Client):
    ...
    def list_quality_enhance_template_async(self, request):
        """查询用户视频增强模板
    ...
    def list_notify_template_async(self, request):
        """查询规定的消息通知模板内容
    ...
    def list_summary_async(self, request):
        """查询转码概览信息
    ...
    def update_tenant_status_async(self, request):
        """更新租户状态
    ...
    def show_tenant_info_async(self, request):
        """查询租户状态信息
    ...
    def update_tenant_info_async(self, request):
        """修改租户信息，如开通点播服务
