...
class ListDatabaseUsersRequest:
    ...
    def __init__(self, cluster_id=None, offset=None, limit=None, type=None, user_type=None):
    ...
    @property
    def cluster_id(self):
        r"""Gets the cluster_id of this ListDatabaseUsersRequest.

        **参数解释**： 集群ID。获取方法请参见[获取集群ID](dws_02_00068.xml)。 **约束限制**： 必须是有效的dws集群ID。 **取值范围**： 36位UUID。 **默认取值**： 不涉及。

        :return: The cluster_id of this ListDatabaseUsersRequest.
        :rtype: str
        """
    ...
    def cluster_id(self, cluster_id):
        r"""Sets the cluster_id of this ListDatabaseUsersRequest.

        **参数解释**： 集群ID。获取方法请参见[获取集群ID](dws_02_00068.xml)。 **约束限制**： 必须是有效的dws集群ID。 **取值范围**： 36位UUID。 **默认取值**： 不涉及。

        :param cluster_id: The cluster_id of this ListDatabaseUsersRequest.
        :type cluster_id: str
        """
