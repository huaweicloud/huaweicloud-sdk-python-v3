...
class ListHostNetResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListHostNetResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListHostNetResponse):
            return False
