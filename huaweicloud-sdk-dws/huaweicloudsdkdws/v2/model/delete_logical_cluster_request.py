...
class DeleteLogicalClusterRequest:
    ...
    def __init__(self, cluster_id=None, logical_cluster_id=None):
        ...
        :type cluster_id: str
        :param logical_cluster_id: **参数解释**： 指定待删除逻辑集群的ID。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
    ...
    def cluster_id(self):
        ...
        **参数解释**： 集群ID。获取方法请参见[获取集群ID](dws_02_00068.xml)。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        ...
        :return: The cluster_id of this DeleteLogicalClusterRequest.
        :rtype: str
        """
    ...
    def cluster_id(self, cluster_id):
        ...
        **参数解释**： 集群ID。获取方法请参见[获取集群ID](dws_02_00068.xml)。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        ...
        :param cluster_id: The cluster_id of this DeleteLogicalClusterRequest.
        :type cluster_id: str
        """
    ...
    def logical_cluster_id(self):
        ...
        **参数解释**： 指定待删除逻辑集群的ID。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        ...
        :return: The logical_cluster_id of this DeleteLogicalClusterRequest.
        :rtype: str
        """
    ...
    def logical_cluster_id(self, logical_cluster_id):
        ...
        **参数解释**： 指定待删除逻辑集群的ID。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        ...
        :param logical_cluster_id: The logical_cluster_id of this DeleteLogicalClusterRequest.
        :type logical_cluster_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteLogicalClusterRequest):
            return False
