...
class BatchDeleteResourceTagRequest:
    ...
    def __init__(self, cluster_id=None, body=None):
        ...
        :type body: :class:`huaweicloudsdkdws.v2.BatchDeleteResourceTags`
        """
    ...
    @property
    def cluster_id(self):
        r"""Gets the cluster_id of this BatchDeleteResourceTagRequest.

        **参数解释**： 集群ID。获取方法请参见[获取集群ID](dws_02_00068.xml)。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :return: The cluster_id of this BatchDeleteResourceTagRequest.
        :rtype: str
        """
    ...
    def cluster_id(self, cluster_id):
        r"""Sets the cluster_id of this BatchDeleteResourceTagRequest.

        **参数解释**： 集群ID。获取方法请参见[获取集群ID](dws_02_00068.xml)。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :param cluster_id: The cluster_id of this BatchDeleteResourceTagRequest.
        :type cluster_id: str
        """
    ...
    def body(self):
        ...
        :rtype: :class:`huaweicloudsdkdws.v2.BatchDeleteResourceTags`
        """
        return self._body
