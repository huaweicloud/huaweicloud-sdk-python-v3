...
class ExportUserAuthorityRequest:
    ...
    @property
    def name(self):
        r"""Gets the name of this ExportUserAuthorityRequest.

        **参数解释**： 数据库用户/角色名称。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 10000

        :return: The name of this ExportUserAuthorityRequest.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this ExportUserAuthorityRequest.

        **参数解释**： 数据库用户/角色名称。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 10000

        :param name: The name of this ExportUserAuthorityRequest.
        :type name: str
        """
        self._name = name
    ...
    @property
    def limit(self):
        r"""Gets the limit of this ExportUserAuthorityRequest.

        **参数解释**： 分页单页大小。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 10000

        :return: The limit of this ExportUserAuthorityRequest.
        :rtype: int
        """
        return self._limit
    ...
    def limit(self, limit):
        r"""Sets the limit of this ExportUserAuthorityRequest.

        **参数解释**： 分页单页大小。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 10000

        :param limit: The limit of this ExportUserAuthorityRequest.
        :type limit: int
        """
        self._limit = limit
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExportUserAuthorityRequest):
            return False
