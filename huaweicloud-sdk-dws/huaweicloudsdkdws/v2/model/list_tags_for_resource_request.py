...
class ListTagsForResourceRequest:
    ...
    def __init__(self, cluster_id=None, offset=None, limit=None):
        ...
        :type offset: int
        :param limit: **参数解释**： 分页大小，默认10。 **约束限制**： 不涉及。 **取值范围**： 有效值大于等于1。 **默认取值**： 10
        :type limit: int
        """
    ...
    @property
    def cluster_id(self):
        r"""Gets the cluster_id of this ListTagsForResourceRequest.

        **参数解释**： 集群ID。获取方法请参见[获取集群ID](dws_02_00068.xml)。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :return: The cluster_id of this ListTagsForResourceRequest.
        :rtype: str
        """
    ...
    def cluster_id(self, cluster_id):
        r"""Sets the cluster_id of this ListTagsForResourceRequest.

        **参数解释**： 集群ID。获取方法请参见[获取集群ID](dws_02_00068.xml)。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :param cluster_id: The cluster_id of this ListTagsForResourceRequest.
        :type cluster_id: str
        """
    ...
    @property
    def offset(self):
        r"""Gets the offset of this ListTagsForResourceRequest.

        **参数解释**： 分页偏移量，从0开始，页数减1。 **约束限制**： 不涉及。 **取值范围**： 大于等于0 **默认取值**： 0

        :return: The offset of this ListTagsForResourceRequest.
        :rtype: int
        """
        return self._offset
    ...
    def offset(self, offset):
        r"""Sets the offset of this ListTagsForResourceRequest.

        **参数解释**： 分页偏移量，从0开始，页数减1。 **约束限制**： 不涉及。 **取值范围**： 大于等于0 **默认取值**： 0

        :param offset: The offset of this ListTagsForResourceRequest.
        :type offset: int
        """
        self._offset = offset
