...
class ListClusterDetailsResponse(SdkResponse):
    ...
    @property
    def cluster(self):
        r"""Gets the cluster of this ListClusterDetailsResponse.
    ...
    def cluster(self, cluster):
        r"""Sets the cluster of this ListClusterDetailsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListClusterDetailsResponse.to_dict() is deprecated and no longer maintained, "
