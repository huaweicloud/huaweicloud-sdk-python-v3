...
class ListQueriesResponse(SdkResponse):
    ...
    @property
    def data(self):
        r"""Gets the data of this ListQueriesResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this ListQueriesResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListQueriesResponse.to_dict() is deprecated and no longer maintained, "
