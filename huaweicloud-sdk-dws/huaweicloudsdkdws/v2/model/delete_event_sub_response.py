...
class DeleteEventSubResponse(SdkResponse):
    ...
    def id(self):
        ...
        **参数解释**： 订阅ID。 **取值范围**： 不涉及。
        ...
        :return: The id of this DeleteEventSubResponse.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        **参数解释**： 订阅ID。 **取值范围**： 不涉及。
        ...
        :param id: The id of this DeleteEventSubResponse.
        :type id: str
        """
        self._id = id
    ...
    def name(self):
        ...
        **参数解释**： 订阅名称。 **取值范围**： 不涉及。
        ...
        :return: The name of this DeleteEventSubResponse.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        **参数解释**： 订阅名称。 **取值范围**： 不涉及。
        ...
        :param name: The name of this DeleteEventSubResponse.
        :type name: str
        """
        self._name = name
    ...
    def source_type(self):
        ...
        **参数解释**： 事件源类型。 **取值范围**： - cluster：集群。 - backup：快照。 - disaster-recovery：容灾。 - data.migration：数据迁移。 - dws.ingestion：DwsIngestion。
        ...
        :return: The source_type of this DeleteEventSubResponse.
        :rtype: str
        """
    ...
    def source_type(self, source_type):
        ...
        **参数解释**： 事件源类型。 **取值范围**： - cluster：集群。 - backup：快照。 - disaster-recovery：容灾。 - data.migration：数据迁移。 - dws.ingestion：DwsIngestion。
        ...
        :param source_type: The source_type of this DeleteEventSubResponse.
        :type source_type: str
        """
    ...
    def source_id(self):
        ...
        **参数解释**： 事件源ID。 **取值范围**： 不涉及。
        ...
        :return: The source_id of this DeleteEventSubResponse.
        :rtype: str
        """
    ...
    def source_id(self, source_id):
        ...
        **参数解释**： 事件源ID。 **取值范围**： 不涉及。
        ...
        :param source_id: The source_id of this DeleteEventSubResponse.
        :type source_id: str
        """
    ...
    def category(self):
        ...
        **参数解释**： 事件类别。 **取值范围**： - management：管理。 - monitor：监控。 - security：安全。
        ...
        :return: The category of this DeleteEventSubResponse.
        :rtype: str
        """
    ...
    def category(self, category):
        ...
        **参数解释**： 事件类别。 **取值范围**： - management：管理。 - monitor：监控。 - security：安全。
        ...
        :param category: The category of this DeleteEventSubResponse.
        :type category: str
        """
    ...
    def severity(self):
        ...
        **参数解释**： 事件级别。 **取值范围**： 不涉及。
        ...
        :return: The severity of this DeleteEventSubResponse.
        :rtype: str
        """
    ...
    def severity(self, severity):
        ...
        **参数解释**： 事件级别。 **取值范围**： 不涉及。
        ...
        :param severity: The severity of this DeleteEventSubResponse.
        :type severity: str
        """
    ...
    def tag(self):
        ...
        **参数解释**： 事件标签。 **取值范围**： 不涉及。
        ...
        :return: The tag of this DeleteEventSubResponse.
        :rtype: str
        """
        return self._tag
    ...
    def tag(self, tag):
        ...
        **参数解释**： 事件标签。 **取值范围**： 不涉及。
        ...
        :param tag: The tag of this DeleteEventSubResponse.
        :type tag: str
        """
        self._tag = tag
    ...
    def enable(self):
        ...
        **参数解释**： 是否开启订阅。 **取值范围**： 1为开启，0为关闭。
        ...
        :return: The enable of this DeleteEventSubResponse.
        :rtype: int
        """
        return self._enable
    ...
    def enable(self, enable):
        ...
        **参数解释**： 是否开启订阅。 **取值范围**： 1为开启，0为关闭。
        ...
        :param enable: The enable of this DeleteEventSubResponse.
        :type enable: int
        """
        self._enable = enable
    ...
    def project_id(self):
        ...
        **参数解释**： 项目ID。 **取值范围**： 不涉及。
        ...
        :return: The project_id of this DeleteEventSubResponse.
        :rtype: str
        """
    ...
    def project_id(self, project_id):
        ...
        **参数解释**： 项目ID。 **取值范围**： 不涉及。
        ...
        :param project_id: The project_id of this DeleteEventSubResponse.
        :type project_id: str
        """
    ...
    def name_space(self):
        ...
        **参数解释**： 所属服务。 **取值范围**： 不涉及。
        ...
        :return: The name_space of this DeleteEventSubResponse.
        :rtype: str
        """
    ...
    def name_space(self, name_space):
        ...
        **参数解释**： 所属服务。 **取值范围**： 不涉及。
        ...
        :param name_space: The name_space of this DeleteEventSubResponse.
        :type name_space: str
        """
    ...
    def notification_target(self):
        ...
        **参数解释**： 消息通知主题地址。 **取值范围**： 不涉及。
        ...
        :return: The notification_target of this DeleteEventSubResponse.
        :rtype: str
        """
    ...
    def notification_target(self, notification_target):
        ...
        **参数解释**： 消息通知主题地址。 **取值范围**： 不涉及。
        ...
        :param notification_target: The notification_target of this DeleteEventSubResponse.
        :type notification_target: str
        """
    ...
    def notification_target_name(self):
        ...
        **参数解释**： 消息通知主题名称。 **取值范围**： 不涉及。
        ...
        :return: The notification_target_name of this DeleteEventSubResponse.
        :rtype: str
        """
    ...
    def notification_target_name(self, notification_target_name):
        ...
        **参数解释**： 消息通知主题名称。 **取值范围**： 不涉及。
        ...
        :param notification_target_name: The notification_target_name of this DeleteEventSubResponse.
        :type notification_target_name: str
        """
    ...
    def notification_target_type(self):
        ...
        **参数解释**： 消息主题类型。 **取值范围**： - SMN：SMN类型
        ...
        :return: The notification_target_type of this DeleteEventSubResponse.
        :rtype: str
        """
    ...
    def notification_target_type(self, notification_target_type):
        ...
        **参数解释**： 消息主题类型。 **取值范围**： - SMN：SMN类型
        ...
        :param notification_target_type: The notification_target_type of this DeleteEventSubResponse.
        :type notification_target_type: str
        """
    ...
    def language(self):
        ...
        **参数解释**： 语言。 **取值范围**： 不涉及。
        ...
        :return: The language of this DeleteEventSubResponse.
        :rtype: str
        """
    ...
    def language(self, language):
        ...
        **参数解释**： 语言。 **取值范围**： 不涉及。
        ...
        :param language: The language of this DeleteEventSubResponse.
        :type language: str
        """
    ...
    def time_zone(self):
        ...
        **参数解释**： 时区。 **取值范围**： 不涉及。
        ...
        :return: The time_zone of this DeleteEventSubResponse.
        :rtype: str
        """
    ...
    def time_zone(self, time_zone):
        ...
        **参数解释**： 时区。 **取值范围**： 不涉及。
        ...
        :param time_zone: The time_zone of this DeleteEventSubResponse.
        :type time_zone: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteEventSubResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteEventSubResponse):
            return False
