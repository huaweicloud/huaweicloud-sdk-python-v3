...
class ListWorkloadPlansResponse(SdkResponse):
    ...
    openapi_types = {
        ...
        'plan_list': 'list[WorkloadPlanInfo]',
        'count': 'int'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListWorkloadPlansResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListWorkloadPlansResponse):
            return False
