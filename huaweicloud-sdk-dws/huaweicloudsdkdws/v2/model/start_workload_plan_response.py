...
class StartWorkloadPlanResponse(SdkResponse):
    ...
    def __init__(self, workload_res_code=None, workload_res_str=None):
        ...
        super(StartWorkloadPlanResponse, self).__init__()
    ...
    def workload_res_code(self):
        """Gets the workload_res_code of this StartWorkloadPlanResponse.
    ...
    def workload_res_code(self, workload_res_code):
        """Sets the workload_res_code of this StartWorkloadPlanResponse.
    ...
    def workload_res_str(self):
        """Gets the workload_res_str of this StartWorkloadPlanResponse.
    ...
    def workload_res_str(self, workload_res_str):
        """Sets the workload_res_str of this StartWorkloadPlanResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StartWorkloadPlanResponse):
            return False
