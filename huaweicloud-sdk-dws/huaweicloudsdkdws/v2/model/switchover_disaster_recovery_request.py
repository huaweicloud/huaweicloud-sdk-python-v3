...
class SwitchoverDisasterRecoveryRequest:
    ...
    def disaster_recovery_id(self):
        r"""Gets the disaster_recovery_id of this SwitchoverDisasterRecoveryRequest.

        **参数解释**： 容灾ID。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :return: The disaster_recovery_id of this SwitchoverDisasterRecoveryRequest.
        :rtype: str
        """
    ...
    def disaster_recovery_id(self, disaster_recovery_id):
        r"""Sets the disaster_recovery_id of this SwitchoverDisasterRecoveryRequest.

        **参数解释**： 容灾ID。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。

        :param disaster_recovery_id: The disaster_recovery_id of this SwitchoverDisasterRecoveryRequest.
        :type disaster_recovery_id: str
        """
