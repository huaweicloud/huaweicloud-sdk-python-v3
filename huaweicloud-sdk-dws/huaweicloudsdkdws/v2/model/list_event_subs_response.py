...
class ListEventSubsResponse(SdkResponse):
    ...
    openapi_types = {
        'count': 'int',
        'event_subscriptions': 'list[EventSubscriptionResponse]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListEventSubsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListEventSubsResponse):
            return False
