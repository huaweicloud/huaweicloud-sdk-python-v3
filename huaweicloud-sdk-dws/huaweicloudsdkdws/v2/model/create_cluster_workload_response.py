...
class CreateClusterWorkloadResponse(SdkResponse):
    ...
    def __init__(self, workload_res_code=None, workload_res_str=None):
        r"""CreateClusterWorkloadResponse
    ...
    def workload_res_code(self):
        r"""Gets the workload_res_code of this CreateClusterWorkloadResponse.
    ...
    def workload_res_code(self, workload_res_code):
        r"""Sets the workload_res_code of this CreateClusterWorkloadResponse.
    ...
    def workload_res_str(self):
        r"""Gets the workload_res_str of this CreateClusterWorkloadResponse.
    ...
    def workload_res_str(self, workload_res_str):
        r"""Sets the workload_res_str of this CreateClusterWorkloadResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateClusterWorkloadResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateClusterWorkloadResponse):
            return False
