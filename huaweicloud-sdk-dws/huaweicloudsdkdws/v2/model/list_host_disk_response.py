...
class ListHostDiskResponse(SdkResponse):
    ...
    def __init__(self, body=None):
        ...
        :param body: **参数解释**： 磁盘信息响应体。 **取值范围**： 不涉及。
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListHostDiskResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListHostDiskResponse):
            return False
