...
class CreateSnapshotPolicyResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateSnapshotPolicyResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateSnapshotPolicyResponse):
            return False
