...
class ClusterInfo:
    ...
    def __init__(self, id=None, name=None, status=None, version=None, updated=None, created=None, port=None, endpoints=None, nodes=None, tags=None, user_name=None, number_of_node=None, recent_event=None, availability_zone=None, enterprise_project_id=None, node_type=None, vpc_id=None, subnet_id=None, public_ip=None, public_endpoints=None, action_progress=None, sub_status=None, task_status=None, security_group_id=None, failed_reasons=None):
        ...
        :type name: str
        :param status: **参数解释**： 集群状态，字符串枚举。 **取值范围**： - CREATING：创建中 - AVAILABLE：可用 - FAILED：不可用 - CREATE_FAILED：创建失败 - DELETING：删除中 - DELETE_FAILED：删除失败 - FROZEN：普通冻结 - POLICE_FROZEN：公安冻结
        :type status: str
        ...
        :param node_type: **参数解释**： 集群规格名称。 **取值范围**： 集群规格详情请参见[数据仓库规格](https://support.huaweicloud.com/productdesc-dws/dws_01_00018.html)。
        :type node_type: str
    ...
    def status(self):
        ...
        **参数解释**： 集群状态，字符串枚举。 **取值范围**： - CREATING：创建中 - AVAILABLE：可用 - FAILED：不可用 - CREATE_FAILED：创建失败 - DELETING：删除中 - DELETE_FAILED：删除失败 - FROZEN：普通冻结 - POLICE_FROZEN：公安冻结
