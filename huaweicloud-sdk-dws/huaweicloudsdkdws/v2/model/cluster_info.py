...
class ClusterInfo:
    ...
    def __init__(self, id=None, status=None, sub_status=None, task_status=None, action_progress=None, node_type=None, subnet_id=None, security_group_id=None, number_of_node=None, availability_zone=None, port=None, name=None, version=None, vpc_id=None, user_name=None, public_ip=None, public_endpoints=None, endpoints=None, tags=None, updated=None, created=None, enterprise_project_id=None, recent_event=None, failed_reasons=None):
        """ClusterInfo
        ...
        :param action_progress: 任务信息，由key、value组成。key值为正在进行的任务，value值为正在进行任务的进度。key值的有效值包括：  - GROWING：扩容中 - RESTORING：恢复中 - SNAPSHOTTING：快照中 - REPAIRING: 修复中 - CREATING: 创建中
        ...
        :param port: 集群服务端口，取值范围8000~30000，默认值：8000
        :type port: int
        :param name: 集群名称
        :type name: str
