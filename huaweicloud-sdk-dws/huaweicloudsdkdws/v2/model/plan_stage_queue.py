...
class PlanStageQueue:
    ...
    @property
    def queue_name(self):
        r"""Gets the queue_name of this PlanStageQueue.

        **参数解释**： 资源池名称。 **取值范围**： 不涉及。

        :return: The queue_name of this PlanStageQueue.
        :rtype: str
        """
    ...
    def queue_name(self, queue_name):
        r"""Sets the queue_name of this PlanStageQueue.

        **参数解释**： 资源池名称。 **取值范围**： 不涉及。

        :param queue_name: The queue_name of this PlanStageQueue.
        :type queue_name: str
        """
    ...
    def queue_resources(self):
        r"""Gets the queue_resources of this PlanStageQueue.

        **参数解释**： 资源配置队列。 **取值范围**： 不涉及。

        :return: The queue_resources of this PlanStageQueue.
    ...
    def queue_resources(self, queue_resources):
        r"""Sets the queue_resources of this PlanStageQueue.

        **参数解释**： 资源配置队列。 **取值范围**： 不涉及。

        :param queue_resources: The queue_resources of this PlanStageQueue.
        :type queue_resources: list[:class:`huaweicloudsdkdws.v2.WorkloadResourceItem`]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PlanStageQueue):
            return False
