...
class AddWorkloadPlanStageRequest:
    ...
    def __init__(self, cluster_id=None, plan_id=None, body=None):
        ...
        :type plan_id: str
        :param body: Body of the AddWorkloadPlanStageRequest
    ...
    def cluster_id(self):
        ...
        **参数解释**： 集群ID。获取方法请参见[获取集群ID](dws_02_00068.xml)。 **约束限制**： 必须是有效的dws集群ID。 **取值范围**： 36位UUID。 **默认取值**： 不涉及。
        ...
        :return: The cluster_id of this AddWorkloadPlanStageRequest.
        :rtype: str
        """
    ...
    def cluster_id(self, cluster_id):
        ...
        **参数解释**： 集群ID。获取方法请参见[获取集群ID](dws_02_00068.xml)。 **约束限制**： 必须是有效的dws集群ID。 **取值范围**： 36位UUID。 **默认取值**： 不涉及。
        ...
        :param cluster_id: The cluster_id of this AddWorkloadPlanStageRequest.
        :type cluster_id: str
        """
    ...
    def plan_id(self):
        ...
        **参数解释**： 计划ID。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        ...
        :return: The plan_id of this AddWorkloadPlanStageRequest.
        :rtype: str
        """
    ...
    def plan_id(self, plan_id):
        ...
        **参数解释**： 计划ID。 **约束限制**： 不涉及。 **取值范围**： 不涉及。 **默认取值**： 不涉及。
        ...
        :param plan_id: The plan_id of this AddWorkloadPlanStageRequest.
        :type plan_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddWorkloadPlanStageRequest):
            return False
