...
class CreateClusterDns:
    ...
    @property
    def name(self):
        """Gets the name of this CreateClusterDns.
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CreateClusterDns.
    ...
    @property
    def type(self):
        """Gets the type of this CreateClusterDns.
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this CreateClusterDns.
    ...
    @property
    def ttl(self):
        """Gets the ttl of this CreateClusterDns.
    ...
    @ttl.setter
    def ttl(self, ttl):
        """Sets the ttl of this CreateClusterDns.
