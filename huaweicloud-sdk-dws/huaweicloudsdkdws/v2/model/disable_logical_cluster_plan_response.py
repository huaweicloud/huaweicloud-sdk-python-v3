...
class DisableLogicalClusterPlanResponse(SdkResponse):
    ...
    def __init__(self, error_code=None, error_msg=None):
        r"""DisableLogicalClusterPlanResponse
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DisableLogicalClusterPlanResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DisableLogicalClusterPlanResponse):
            return False
