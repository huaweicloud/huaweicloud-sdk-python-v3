...
class ShowClusterFlavorResponse(SdkResponse):
    ...
    openapi_types = {
        'flavor': 'ClusterFlavorDetailInfo'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowClusterFlavorResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowClusterFlavorResponse):
            return False
