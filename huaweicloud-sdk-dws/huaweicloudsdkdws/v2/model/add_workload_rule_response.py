...
class AddWorkloadRuleResponse(SdkResponse):
    ...
    def workload_res_code(self):
        r"""Gets the workload_res_code of this AddWorkloadRuleResponse.

        **参数解释**： 错误编码。 **取值范围**： 不涉及。

        :return: The workload_res_code of this AddWorkloadRuleResponse.
        :rtype: int
        """
    ...
    def workload_res_code(self, workload_res_code):
        r"""Sets the workload_res_code of this AddWorkloadRuleResponse.

        **参数解释**： 错误编码。 **取值范围**： 不涉及。

        :param workload_res_code: The workload_res_code of this AddWorkloadRuleResponse.
        :type workload_res_code: int
        """
    ...
    def workload_res_str(self):
        r"""Gets the workload_res_str of this AddWorkloadRuleResponse.

        **参数解释**： 查询错误详情。 **取值范围**： 不涉及。

        :return: The workload_res_str of this AddWorkloadRuleResponse.
        :rtype: str
        """
    ...
    def workload_res_str(self, workload_res_str):
        r"""Sets the workload_res_str of this AddWorkloadRuleResponse.

        **参数解释**： 查询错误详情。 **取值范围**： 不涉及。

        :param workload_res_str: The workload_res_str of this AddWorkloadRuleResponse.
        :type workload_res_str: str
        """
    ...
    @property
    def items(self):
        r"""Gets the items of this AddWorkloadRuleResponse.

        **参数解释**： 异常规则列表。 **取值范围**： 不涉及。

        :return: The items of this AddWorkloadRuleResponse.
    ...
    def items(self, items):
        r"""Sets the items of this AddWorkloadRuleResponse.

        **参数解释**： 异常规则列表。 **取值范围**： 不涉及。

        :param items: The items of this AddWorkloadRuleResponse.
        :type items: list[:class:`huaweicloudsdkdws.v2.ExceptRuleBo`]
        """
        self._items = items
    ...
    @property
    def count(self):
        r"""Gets the count of this AddWorkloadRuleResponse.

        **参数解释**： 异常规则总条数。 **取值范围**： 大于等于0

        :return: The count of this AddWorkloadRuleResponse.
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        r"""Sets the count of this AddWorkloadRuleResponse.

        **参数解释**： 异常规则总条数。 **取值范围**： 大于等于0

        :param count: The count of this AddWorkloadRuleResponse.
        :type count: int
        """
        self._count = count
    ...
    def to_dict(self):
        import warnings
        warnings.warn("AddWorkloadRuleResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddWorkloadRuleResponse):
            return False
