...
class ListClusterConfigurationsResponse(SdkResponse):
    ...
    openapi_types = {
        'configurations': 'list[ClusterConfiguration]'
    }
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListClusterConfigurationsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListClusterConfigurationsResponse):
            return False
