...
class DeleteAlarmSubResponse(SdkResponse):
    ...
    @property
    def cluster_id(self):
        r"""Gets the cluster_id of this DeleteAlarmSubResponse.

        **参数解释**： 集群ID。 **取值范围**： 不涉及。

        :return: The cluster_id of this DeleteAlarmSubResponse.
        :rtype: str
        """
    ...
    def cluster_id(self, cluster_id):
        r"""Sets the cluster_id of this DeleteAlarmSubResponse.

        **参数解释**： 集群ID。 **取值范围**： 不涉及。

        :param cluster_id: The cluster_id of this DeleteAlarmSubResponse.
        :type cluster_id: str
        """
    ...
    def alarm_details(self):
        r"""Gets the alarm_details of this DeleteAlarmSubResponse.

        **参数解释**： 订阅的所有告警详细信息。 **取值范围**： 不涉及。

        :return: The alarm_details of this DeleteAlarmSubResponse.
    ...
    def alarm_details(self, alarm_details):
        r"""Sets the alarm_details of this DeleteAlarmSubResponse.

        **参数解释**： 订阅的所有告警详细信息。 **取值范围**： 不涉及。

        :param alarm_details: The alarm_details of this DeleteAlarmSubResponse.
        :type alarm_details: list[:class:`huaweicloudsdkdws.v2.AlarmSubDetailResopnse`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteAlarmSubResponse.to_dict() is deprecated and no longer maintained, "
