...
class CreateWorkloadPlanResponse(SdkResponse):
    ...
    def workload_res_code(self):
        r"""Gets the workload_res_code of this CreateWorkloadPlanResponse.
    ...
    def workload_res_code(self, workload_res_code):
        r"""Sets the workload_res_code of this CreateWorkloadPlanResponse.
    ...
    def workload_res_str(self):
        r"""Gets the workload_res_str of this CreateWorkloadPlanResponse.
    ...
    def workload_res_str(self, workload_res_str):
        r"""Sets the workload_res_str of this CreateWorkloadPlanResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateWorkloadPlanResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateWorkloadPlanResponse):
            return False
