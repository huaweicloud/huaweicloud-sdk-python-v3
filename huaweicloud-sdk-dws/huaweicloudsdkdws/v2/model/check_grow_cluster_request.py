...
class CheckGrowClusterRequest:
    ...
    @property
    def body(self):
        r"""Gets the body of this CheckGrowClusterRequest.

        :return: The body of this CheckGrowClusterRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this CheckGrowClusterRequest.

        :param body: The body of this CheckGrowClusterRequest.
        :type body: :class:`huaweicloudsdkdws.v2.ResizeClusterRequestBody`
        """
        self._body = body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CheckGrowClusterRequest):
            return False
