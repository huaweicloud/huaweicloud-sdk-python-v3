...
class CreateAlarmSubResponse(SdkResponse):
    ...
    @property
    def cluster_id(self):
        r"""Gets the cluster_id of this CreateAlarmSubResponse.

        **参数解释**： 集群ID。 **取值范围**： 不涉及。

        :return: The cluster_id of this CreateAlarmSubResponse.
        :rtype: str
        """
    ...
    def cluster_id(self, cluster_id):
        r"""Sets the cluster_id of this CreateAlarmSubResponse.

        **参数解释**： 集群ID。 **取值范围**： 不涉及。

        :param cluster_id: The cluster_id of this CreateAlarmSubResponse.
        :type cluster_id: str
        """
    ...
    def alarm_details(self):
        r"""Gets the alarm_details of this CreateAlarmSubResponse.

        **参数解释**： 订阅的所有告警详细信息。 **取值范围**： 不涉及。

        :return: The alarm_details of this CreateAlarmSubResponse.
    ...
    def alarm_details(self, alarm_details):
        r"""Sets the alarm_details of this CreateAlarmSubResponse.

        **参数解释**： 订阅的所有告警详细信息。 **取值范围**： 不涉及。

        :param alarm_details: The alarm_details of this CreateAlarmSubResponse.
        :type alarm_details: list[:class:`huaweicloudsdkdws.v2.AlarmSubDetailResopnse`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateAlarmSubResponse.to_dict() is deprecated and no longer maintained, "
