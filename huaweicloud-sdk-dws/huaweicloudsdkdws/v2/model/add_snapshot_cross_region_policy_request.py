...
class AddSnapshotCrossRegionPolicyRequest:
    ...
    openapi_types = {
        'body': 'AddSnapshotCrossRegionPolicyRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the AddSnapshotCrossRegionPolicyRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddSnapshotCrossRegionPolicyRequest):
            return False
