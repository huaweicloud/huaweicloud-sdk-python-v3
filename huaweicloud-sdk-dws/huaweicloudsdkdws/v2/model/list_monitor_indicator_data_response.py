...
class ListMonitorIndicatorDataResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListMonitorIndicatorDataResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListMonitorIndicatorDataResponse):
            return False
