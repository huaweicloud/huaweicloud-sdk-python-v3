...
class DeleteWorkloadQueueResponse(SdkResponse):
    ...
    def workload_res_code(self):
        ...
        **参数解释**： 响应编码。 **取值范围**： 不涉及。
        ...
        :return: The workload_res_code of this DeleteWorkloadQueueResponse.
        :rtype: int
        """
    ...
    def workload_res_code(self, workload_res_code):
        ...
        **参数解释**： 响应编码。 **取值范围**： 不涉及。
        ...
        :param workload_res_code: The workload_res_code of this DeleteWorkloadQueueResponse.
        :type workload_res_code: int
        """
    ...
    def workload_res_str(self):
        ...
        **参数解释**： 响应信息。 **取值范围**： 不涉及。
        ...
        :return: The workload_res_str of this DeleteWorkloadQueueResponse.
        :rtype: str
        """
    ...
    def workload_res_str(self, workload_res_str):
        ...
        **参数解释**： 响应信息。 **取值范围**： 不涉及。
        ...
        :param workload_res_str: The workload_res_str of this DeleteWorkloadQueueResponse.
        :type workload_res_str: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteWorkloadQueueResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteWorkloadQueueResponse):
            return False
