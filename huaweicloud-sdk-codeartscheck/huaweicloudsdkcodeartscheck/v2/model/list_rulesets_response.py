...
class ListRulesetsResponse(SdkResponse):
    ...
    @property
    def info(self):
        r"""Gets the info of this ListRulesetsResponse.
    ...
    @info.setter
    def info(self, info):
        r"""Sets the info of this ListRulesetsResponse.
    ...
    @property
    def total(self):
        r"""Gets the total of this ListRulesetsResponse.
    ...
    def total(self, total):
        r"""Sets the total of this ListRulesetsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListRulesetsResponse.to_dict() is deprecated and no longer maintained, "
