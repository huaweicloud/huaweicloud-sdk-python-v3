...
class ShowTaskListByProjectIdResponse(SdkResponse):
    ...
    def __init__(self, tasks=None, total=None):
        ...
        :param tasks: 任务信息
        :type tasks: list[:class:`huaweicloudsdkcodeartscheck.v2.SimpleTaskInfoV2`]
        :param total: 总数
        :type total: int
        """
    ...
    def tasks(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartscheck.v2.SimpleTaskInfoV2`]
        """
        return self._tasks
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowTaskListByProjectIdResponse.to_dict() is deprecated and no longer maintained, "
