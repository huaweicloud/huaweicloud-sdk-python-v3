...
class CheckRulesetParametersResponse(SdkResponse):
    ...
    def __init__(self, data=None, total=None):
        r"""CheckRulesetParametersResponse

        The model defined in huaweicloud sdk

        :param data: 历史记录数据
        :type data: list[:class:`huaweicloudsdkcodeartscheck.v2.TaskCheckParamters`]
        :param total: 总数
        :type total: int
        """
    ...
    @property
    def data(self):
        r"""Gets the data of this CheckRulesetParametersResponse.
    ...
    @data.setter
    def data(self, data):
        r"""Sets the data of this CheckRulesetParametersResponse.
    ...
    @property
    def total(self):
        r"""Gets the total of this CheckRulesetParametersResponse.
    ...
    def total(self, total):
        r"""Sets the total of this CheckRulesetParametersResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CheckRulesetParametersResponse.to_dict() is deprecated and no longer maintained, "
