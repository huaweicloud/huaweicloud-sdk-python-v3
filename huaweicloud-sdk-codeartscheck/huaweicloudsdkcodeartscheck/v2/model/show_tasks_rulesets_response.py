...
class ShowTasksRulesetsResponse(SdkResponse):
    ...
    def __init__(self, info=None, total=None):
        ...
        :param info: 规则集信息
        :type info: list[:class:`huaweicloudsdkcodeartscheck.v2.TaskRulesetInfo`]
        :param total: 总数
        :type total: int
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowTasksRulesetsResponse.to_dict() is deprecated and no longer maintained, "
