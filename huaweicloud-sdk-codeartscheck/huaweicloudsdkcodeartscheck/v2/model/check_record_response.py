...
class CheckRecordResponse(SdkResponse):
    ...
    def __init__(self, data=None, total=None):
        ...
        :param data: 历史记录数据
        :type data: list[:class:`huaweicloudsdkcodeartscheck.v2.CheckRecordDataInfo`]
        :param total: 总数
        :type total: int
        """
    ...
    def data(self):
        ...
        :rtype: list[:class:`huaweicloudsdkcodeartscheck.v2.CheckRecordDataInfo`]
        """
        return self._data
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CheckRecordResponse.to_dict() is deprecated and no longer maintained, "
