...
class ShowAppResponse(SdkResponse):
    ...
    def commit_checkpoint_stream_names(self):
        r"""Gets the commit_checkpoint_stream_names of this ShowAppResponse.

        关联通道列表。

        :return: The commit_checkpoint_stream_names of this ShowAppResponse.
        :rtype: list[str]
        """
    ...
    def commit_checkpoint_stream_names(self, commit_checkpoint_stream_names):
        r"""Sets the commit_checkpoint_stream_names of this ShowAppResponse.

        关联通道列表。

        :param commit_checkpoint_stream_names: The commit_checkpoint_stream_names of this ShowAppResponse.
        :type commit_checkpoint_stream_names: list[str]
        """
