...
class DisClient(Client):
    def __init__(self):
        super(DisClient, self).__init__()
    ...
    def new_builder(cls, clazz=None):
        if not clazz:
            ...
            if clazz.__name__ != "DisClient":
                raise TypeError("client type error, support client type is DisClient")
    ...
    def batch_start_transfer_task(self, request):
        r"""批量启动转储任务
    ...
    def batch_start_transfer_task_invoker(self, request):
        http_info = self._batch_start_transfer_task_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _batch_start_transfer_task_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def batch_stop_transfer_task(self, request):
        r"""批量暂停转储任务
    ...
    def batch_stop_transfer_task_invoker(self, request):
        http_info = self._batch_stop_transfer_task_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _batch_stop_transfer_task_http_info(cls, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v2/{project_id}/streams/{stream_name}/transfer-tasks/action",
            "request_type": request.__class__.__name__,
    ...
    def consume_records(self, request):
        r"""下载数据
    ...
    def consume_records_invoker(self, request):
        http_info = self._consume_records_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _consume_records_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def create_obs_transfer_task(self, request):
        r"""添加OBS转储任务
    ...
    def create_obs_transfer_task_invoker(self, request):
        http_info = self._create_obs_transfer_task_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_obs_transfer_task_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def create_stream_invoker(self, request):
        http_info = self._create_stream_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_stream_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def delete_stream_invoker(self, request):
        http_info = self._delete_stream_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_stream_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def delete_transfer_task(self, request):
        r"""删除转储任务
    ...
    def delete_transfer_task_invoker(self, request):
        http_info = self._delete_transfer_task_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_transfer_task_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_streams_invoker(self, request):
        http_info = self._list_streams_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_streams_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v2/{project_id}/streams",
            "request_type": request.__class__.__name__,
    ...
    def list_transfer_tasks(self, request):
        r"""查询转储任务列表
    ...
    def list_transfer_tasks_invoker(self, request):
        http_info = self._list_transfer_tasks_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_transfer_tasks_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v2/{project_id}/streams/{stream_name}/transfer-tasks",
            "request_type": request.__class__.__name__,
    ...
    def send_records_invoker(self, request):
        http_info = self._send_records_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _send_records_http_info(cls, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v2/{project_id}/records",
            "request_type": request.__class__.__name__,
    ...
    def show_cursor_invoker(self, request):
        http_info = self._show_cursor_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_cursor_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_partition_metrics(self, request):
        r"""查询分区监控
    ...
    def show_partition_metrics_invoker(self, request):
        http_info = self._show_partition_metrics_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_partition_metrics_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_stream_invoker(self, request):
        http_info = self._show_stream_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_stream_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v2/{project_id}/streams/{stream_name}",
            "request_type": request.__class__.__name__,
    ...
    def show_stream_metrics(self, request):
        r"""查询通道监控
    ...
    def show_stream_metrics_invoker(self, request):
        http_info = self._show_stream_metrics_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_stream_metrics_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_stream_tags(self, request):
        r"""查询指定通道的标签信息
    ...
    def show_stream_tags_invoker(self, request):
        http_info = self._show_stream_tags_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_stream_tags_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v2/{project_id}/stream/{stream_id}/tags",
            "request_type": request.__class__.__name__,
    ...
    def show_transfer_task(self, request):
        r"""查询转储任务详情
    ...
    def show_transfer_task_invoker(self, request):
        http_info = self._show_transfer_task_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_transfer_task_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v2/{project_id}/streams/{stream_name}/transfer-tasks/{task_name}",
            "request_type": request.__class__.__name__,
    ...
    def update_partition_count(self, request):
        r"""修改分区数量
    ...
    def update_partition_count_invoker(self, request):
        http_info = self._update_partition_count_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_partition_count_http_info(cls, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v2/{project_id}/streams/{stream_name}",
            "request_type": request.__class__.__name__,
    ...
    def update_stream_invoker(self, request):
        http_info = self._update_stream_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_stream_http_info(cls, request):
        http_info = {
            "method": "PUT",
    ...
    def show_consumer_state(self, request):
        r"""查看App消费状态
    ...
    def show_consumer_state_invoker(self, request):
        http_info = self._show_consumer_state_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_consumer_state_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def commit_checkpoint(self, request):
        r"""提交Checkpoint
    ...
    def commit_checkpoint_invoker(self, request):
        http_info = self._commit_checkpoint_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _commit_checkpoint_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def delete_checkpoint_invoker(self, request):
        http_info = self._delete_checkpoint_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_checkpoint_http_info(cls, request):
        http_info = {
            "method": "DELETE",
            "resource_path": "/v2/{project_id}/checkpoints",
            "request_type": request.__class__.__name__,
