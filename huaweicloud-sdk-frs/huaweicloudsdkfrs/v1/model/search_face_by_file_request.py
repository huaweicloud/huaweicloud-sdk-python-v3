...
class SearchFaceByFileRequest:
    ...
    openapi_types = {
        'face_set_name': 'str',
        'body': 'SearchFaceByFileRequestBody'
    }
    ...
    def face_set_name(self):
        """Gets the face_set_name of this SearchFaceByFileRequest.

        人脸库名称。

        :return: The face_set_name of this SearchFaceByFileRequest.
        :rtype: str
        """
    ...
    def face_set_name(self, face_set_name):
        """Sets the face_set_name of this SearchFaceByFileRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SearchFaceByFileRequest):
            return False
