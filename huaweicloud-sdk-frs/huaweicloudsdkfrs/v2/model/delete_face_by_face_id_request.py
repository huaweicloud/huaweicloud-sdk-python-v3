...
class DeleteFaceByFaceIdRequest:
    ...
    def enterprise_project_id(self):
        r"""Gets the enterprise_project_id of this DeleteFaceByFaceIdRequest.
        ...
        :return: The enterprise_project_id of this DeleteFaceByFaceIdRequest.
        :rtype: str
        """
    ...
    def enterprise_project_id(self, enterprise_project_id):
        r"""Sets the enterprise_project_id of this DeleteFaceByFaceIdRequest.

        企业项目ID。FRS支持通过企业项目管理（EPS）对不同用户组和用户的资源使用，进行分账。当前仅支持按需计费模式。  获取方法：进入“[企业项目管理](https://console.huaweicloud.com/eps/?region=cn-north-4#/projects/list)”页面，单击企业项目名称，在企业项目详情页获取Enterprise-Project-Id（企业项目ID）。  企业项目创建步骤请参见用户指南。 > 说明： 创建企业项目后，在传参时，有以下三类场景。 - 携带正确的ID，正常使用FRS服务，账单的企业项目会被分类到企业ID对应的企业项目中。 - 携带格式正确但不存在的ID，正常使用FRS服务，账单的企业项目会显示对应不存在的企业项目ID。 - 不携带ID或格式错误ID（包含特殊字符等），正常使用FRS服务，账单的企业项目会被分类到\"default\"中。

        :param enterprise_project_id: The enterprise_project_id of this DeleteFaceByFaceIdRequest.
        :type enterprise_project_id: str
        """
    ...
    def face_set_name(self):
        r"""Gets the face_set_name of this DeleteFaceByFaceIdRequest.

        人脸库名称。

        :return: The face_set_name of this DeleteFaceByFaceIdRequest.
        :rtype: str
        """
    ...
    def face_set_name(self, face_set_name):
        r"""Sets the face_set_name of this DeleteFaceByFaceIdRequest.

        人脸库名称。

        :param face_set_name: The face_set_name of this DeleteFaceByFaceIdRequest.
        :type face_set_name: str
        """
    ...
    @property
    def face_id(self):
        r"""Gets the face_id of this DeleteFaceByFaceIdRequest.

        人脸ID。

        :return: The face_id of this DeleteFaceByFaceIdRequest.
        :rtype: str
        """
    ...
    def face_id(self, face_id):
        r"""Sets the face_id of this DeleteFaceByFaceIdRequest.

        人脸ID。

        :param face_id: The face_id of this DeleteFaceByFaceIdRequest.
        :type face_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteFaceByFaceIdRequest):
            return False
