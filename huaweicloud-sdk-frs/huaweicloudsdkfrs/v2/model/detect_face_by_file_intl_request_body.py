...
class DetectFaceByFileIntlRequestBody:
    ...
    def image_file(self):
        ...
        :return: The image_file of this DetectFaceByFileIntlRequestBody.
    ...
    def image_file(self, image_file):
        ...
        :param image_file: The image_file of this DetectFaceByFileIntlRequestBody.
        :type image_file: :class:`huaweicloudsdkcore.http.formdata.FormFile`
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DetectFaceByFileIntlRequestBody):
            return False
