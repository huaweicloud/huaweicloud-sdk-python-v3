...
class ShowFacesByFaceIdResponse(SdkResponse):
    ...
    def face_set_id(self):
        ...
        :return: The face_set_id of this ShowFacesByFaceIdResponse.
        :rtype: str
        """
    ...
    def face_set_name(self):
        ...
        :return: The face_set_name of this ShowFacesByFaceIdResponse.
        :rtype: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowFacesByFaceIdResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowFacesByFaceIdResponse):
            return False
