...
class DetectLiveByFileIntlResponse(SdkResponse):
    ...
    def __init__(self, video_result=None, warning_list=None, x_request_id=None):
        r"""DetectLiveByFileIntlResponse
    ...
    def video_result(self):
        r"""Gets the video_result of this DetectLiveByFileIntlResponse.
    ...
    def video_result(self, video_result):
        r"""Sets the video_result of this DetectLiveByFileIntlResponse.
    ...
    def warning_list(self):
        r"""Gets the warning_list of this DetectLiveByFileIntlResponse.
        ...
        :return: The warning_list of this DetectLiveByFileIntlResponse.
    ...
    def warning_list(self, warning_list):
        r"""Sets the warning_list of this DetectLiveByFileIntlResponse.

        [警告信息列表，WarningList结构见[WarningList](https://support.huaweicloud.com/api-face/face_02_0077.html)。调用失败时无此字段](tag:hc) [警告信息列表，WarningList结构见[WarningList](https://support.huaweicloud.com/intl/zh-cn/api-face/face_02_0077.html)。调用失败时无此字段](tag:hk)

        :param warning_list: The warning_list of this DetectLiveByFileIntlResponse.
        :type warning_list: list[:class:`huaweicloudsdkfrs.v2.WarningList`]
        """
    ...
    def x_request_id(self):
        r"""Gets the x_request_id of this DetectLiveByFileIntlResponse.
    ...
    def x_request_id(self, x_request_id):
        r"""Sets the x_request_id of this DetectLiveByFileIntlResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DetectLiveByFileIntlResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DetectLiveByFileIntlResponse):
            return False
