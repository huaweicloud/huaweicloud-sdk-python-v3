...
class DetectFaceByBase64Request:
    ...
    def enterprise_project_id(self):
        r"""Gets the enterprise_project_id of this DetectFaceByBase64Request.
    ...
    def enterprise_project_id(self, enterprise_project_id):
        r"""Sets the enterprise_project_id of this DetectFaceByBase64Request.
    ...
    @property
    def body(self):
        r"""Gets the body of this DetectFaceByBase64Request.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this DetectFaceByBase64Request.
