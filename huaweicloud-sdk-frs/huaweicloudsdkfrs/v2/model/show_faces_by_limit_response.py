...
class ShowFacesByLimitResponse(SdkResponse):
    ...
    def face_set_id(self):
        r"""Gets the face_set_id of this ShowFacesByLimitResponse.

        人脸库ID，随机生成的包含八个字符的字符串。 调用失败时无此字段。

        :return: The face_set_id of this ShowFacesByLimitResponse.
        :rtype: str
        """
    ...
    def face_set_id(self, face_set_id):
        r"""Sets the face_set_id of this ShowFacesByLimitResponse.

        人脸库ID，随机生成的包含八个字符的字符串。 调用失败时无此字段。

        :param face_set_id: The face_set_id of this ShowFacesByLimitResponse.
        :type face_set_id: str
        """
    ...
    def face_set_name(self):
        r"""Gets the face_set_name of this ShowFacesByLimitResponse.

        人脸库名称。 调用失败时无此字段。

        :return: The face_set_name of this ShowFacesByLimitResponse.
        :rtype: str
        """
    ...
    def face_set_name(self, face_set_name):
        r"""Sets the face_set_name of this ShowFacesByLimitResponse.

        人脸库名称。 调用失败时无此字段。

        :param face_set_name: The face_set_name of this ShowFacesByLimitResponse.
        :type face_set_name: str
        """
    ...
    @property
    def faces(self):
        r"""Gets the faces of this ShowFacesByLimitResponse.
        ...
        :return: The faces of this ShowFacesByLimitResponse.
    ...
    def faces(self, faces):
        r"""Sets the faces of this ShowFacesByLimitResponse.

        [人脸库当中的人脸结构，详见[FaceSetFace](https://support.huaweicloud.com/api-face/face_02_0018.html)。调用失败时无此字段。](tag:hc) [人脸库当中的人脸结构，详见[FaceSetFace](https://support.huaweicloud.com/intl/zh-cn/api-face/face_02_0018.html)。调用失败时无此字段。](tag:hk)

        :param faces: The faces of this ShowFacesByLimitResponse.
        :type faces: list[:class:`huaweicloudsdkfrs.v2.FaceSetFace`]
        """
        self._faces = faces
    ...
    def x_request_id(self):
        r"""Gets the x_request_id of this ShowFacesByLimitResponse.

        :return: The x_request_id of this ShowFacesByLimitResponse.
        :rtype: str
        """
    ...
    def x_request_id(self, x_request_id):
        r"""Sets the x_request_id of this ShowFacesByLimitResponse.

        :param x_request_id: The x_request_id of this ShowFacesByLimitResponse.
        :type x_request_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowFacesByLimitResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowFacesByLimitResponse):
            return False
