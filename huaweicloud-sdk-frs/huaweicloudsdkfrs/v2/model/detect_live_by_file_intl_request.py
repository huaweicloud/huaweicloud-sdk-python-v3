...
class DetectLiveByFileIntlRequest:
    ...
    openapi_types = {
        ...
        'body': 'DetectLiveByFileIntlRequestBody'
    }
    ...
    def __init__(self, enterprise_project_id=None, body=None):
        ...
        :param body: Body of the DetectLiveByFileIntlRequest
    ...
    def enterprise_project_id(self):
        r"""Gets the enterprise_project_id of this DetectLiveByFileIntlRequest.
        ...
        :return: The enterprise_project_id of this DetectLiveByFileIntlRequest.
        :rtype: str
        """
    ...
    def enterprise_project_id(self, enterprise_project_id):
        r"""Sets the enterprise_project_id of this DetectLiveByFileIntlRequest.

        企业项目ID。FRS支持通过企业项目管理（EPS）对不同用户组和用户的资源使用，进行分账。当前仅支持按需计费模式。  获取方法：进入“[企业项目管理](https://console.huaweicloud.com/eps/?region=cn-north-4#/projects/list)”页面，单击企业项目名称，在企业项目详情页获取Enterprise-Project-Id（企业项目ID）。  企业项目创建步骤请参见用户指南。 > 说明： 创建企业项目后，在传参时，有以下三类场景。 - 携带正确的ID，正常使用FRS服务，账单的企业项目会被分类到企业ID对应的企业项目中。 - 携带格式正确但不存在的ID，正常使用FRS服务，账单的企业项目会显示对应不存在的企业项目ID。 - 不携带ID或格式错误ID（包含特殊字符等），正常使用FRS服务，账单的企业项目会被分类到\"default\"中。

        :param enterprise_project_id: The enterprise_project_id of this DetectLiveByFileIntlRequest.
        :type enterprise_project_id: str
        """
    ...
    @property
    def body(self):
        r"""Gets the body of this DetectLiveByFileIntlRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this DetectLiveByFileIntlRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DetectLiveByFileIntlRequest):
            return False
