...
class DeleteFaceByExternalImageIdResponse(SdkResponse):
    ...
    def __init__(self, face_number=None, face_set_id=None, face_set_name=None, x_request_id=None):
        r"""DeleteFaceByExternalImageIdResponse
    ...
    def face_number(self):
        r"""Gets the face_number of this DeleteFaceByExternalImageIdResponse.

        删除的人脸数量。 调用失败时无此字段。

        :return: The face_number of this DeleteFaceByExternalImageIdResponse.
        :rtype: int
        """
    ...
    def face_number(self, face_number):
        r"""Sets the face_number of this DeleteFaceByExternalImageIdResponse.
    ...
    def face_set_id(self):
        r"""Gets the face_set_id of this DeleteFaceByExternalImageIdResponse.

        人脸库ID。 调用失败时无此字段。

        :return: The face_set_id of this DeleteFaceByExternalImageIdResponse.
        :rtype: str
        """
    ...
    def face_set_id(self, face_set_id):
        r"""Sets the face_set_id of this DeleteFaceByExternalImageIdResponse.
    ...
    def face_set_name(self):
        r"""Gets the face_set_name of this DeleteFaceByExternalImageIdResponse.

        人脸库名称。 调用失败时无此字段。

        :return: The face_set_name of this DeleteFaceByExternalImageIdResponse.
        :rtype: str
        """
    ...
    def face_set_name(self, face_set_name):
        r"""Sets the face_set_name of this DeleteFaceByExternalImageIdResponse.
    ...
    def x_request_id(self):
        r"""Gets the x_request_id of this DeleteFaceByExternalImageIdResponse.

        :return: The x_request_id of this DeleteFaceByExternalImageIdResponse.
        :rtype: str
        """
    ...
    def x_request_id(self, x_request_id):
        r"""Sets the x_request_id of this DeleteFaceByExternalImageIdResponse.

        :param x_request_id: The x_request_id of this DeleteFaceByExternalImageIdResponse.
        :type x_request_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteFaceByExternalImageIdResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteFaceByExternalImageIdResponse):
            return False
