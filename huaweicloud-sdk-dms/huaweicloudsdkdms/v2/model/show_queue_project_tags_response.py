...
class ShowQueueProjectTagsResponse(SdkResponse):
    ...
    def __init__(self, tags=None):
        """ShowQueueProjectTagsResponse

        The model defined in huaweicloud sdk

        :param tags: 标签列表
        :type tags: list[:class:`huaweicloudsdkdms.v2.ShowProjectTagsRespTags`]
        """
    ...
    def tags(self):
        ...
        :rtype: list[:class:`huaweicloudsdkdms.v2.ShowProjectTagsRespTags`]
        """
        return self._tags
