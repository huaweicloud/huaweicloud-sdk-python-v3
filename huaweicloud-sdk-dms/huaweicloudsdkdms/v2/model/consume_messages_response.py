...
class ConsumeMessagesResponse(SdkResponse):
    ...
    @property
    def body(self):
        """Gets the body of this ConsumeMessagesResponse.
    ...
    @body.setter
    def body(self, body):
        """Sets the body of this ConsumeMessagesResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConsumeMessagesResponse):
            return False
