...
class BatchCreateOrDeleteQueueTagRequest:
    ...
    @property
    def body(self):
        """Gets the body of this BatchCreateOrDeleteQueueTagRequest.
    ...
    @body.setter
    def body(self, body):
        """Sets the body of this BatchCreateOrDeleteQueueTagRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchCreateOrDeleteQueueTagRequest):
            return False
