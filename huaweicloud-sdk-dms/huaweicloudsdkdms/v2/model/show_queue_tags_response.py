...
class ShowQueueTagsResponse(SdkResponse):
    ...
    openapi_types = {
        'tags': 'list[BatchCreateOrDeleteTagReqTags]'
    }
    ...
    @property
    def tags(self):
        """Gets the tags of this ShowQueueTagsResponse.
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this ShowQueueTagsResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowQueueTagsResponse):
            return False
