...
class StsClient(Client):
    ...
    def assume_agency(self, request):
    ...
    def assume_agency_invoker(self, request):
        http_info = self._assume_agency_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _assume_agency_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def assume_agency_with_oidc(self, request):
    ...
    def assume_agency_with_oidc_invoker(self, request):
        http_info = self._assume_agency_with_oidc_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _assume_agency_with_oidc_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def assume_agency_with_saml(self, request):
    ...
    def assume_agency_with_saml_invoker(self, request):
        http_info = self._assume_agency_with_saml_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _assume_agency_with_saml_http_info(cls, request):
        http_info = {
            "method": "POST",
