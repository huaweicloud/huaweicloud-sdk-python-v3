...
class ListJobResponse(SdkResponse):
    ...
    @property
    def jobs(self):
        r"""Gets the jobs of this ListJobResponse.

        作业列表

        :return: The jobs of this ListJobResponse.
    ...
    @jobs.setter
    def jobs(self, jobs):
        r"""Sets the jobs of this ListJobResponse.

        作业列表

        :param jobs: The jobs of this ListJobResponse.
        :type jobs: list[:class:`huaweicloudsdkeihealth.v1.JobListDto`]
        """
        self._jobs = jobs
    ...
    @property
    def count(self):
        r"""Gets the count of this ListJobResponse.

        作业总数

        :return: The count of this ListJobResponse.
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        r"""Sets the count of this ListJobResponse.

        作业总数

        :param count: The count of this ListJobResponse.
        :type count: int
        """
        self._count = count
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListJobResponse.to_dict() is deprecated and no longer maintained, "
