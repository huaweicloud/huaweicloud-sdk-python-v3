...
class CreatePerformanceResourceRequest:
    ...
    openapi_types = {
        'body': 'CreatePerformanceResourceReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreatePerformanceResourceRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreatePerformanceResourceRequest):
            return False
