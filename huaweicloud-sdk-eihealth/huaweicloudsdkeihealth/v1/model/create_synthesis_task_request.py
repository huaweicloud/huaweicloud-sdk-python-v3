...
class CreateSynthesisTaskRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateSynthesisTaskRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateSynthesisTaskRequest):
            return False
