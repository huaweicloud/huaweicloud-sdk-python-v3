...
class CreateGenerationTaskRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateGenerationTaskRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateGenerationTaskRequest):
            return False
