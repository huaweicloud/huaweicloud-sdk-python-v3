...
class UpdateDataPathPolicyRequest:
    ...
    def __init__(self, eihealth_project_id=None, path=None, body=None):
        ...
        :type path: str
        :param body: Body of the UpdateDataPathPolicyRequest
    ...
    def path(self):
        ...
        :return: The path of this UpdateDataPathPolicyRequest.
        :rtype: str
        """
        return self._path
    ...
    def path(self, path):
        ...
        :param path: The path of this UpdateDataPathPolicyRequest.
        :type path: str
        """
        self._path = path
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateDataPathPolicyRequest):
            return False
