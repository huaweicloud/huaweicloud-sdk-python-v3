...
class ShowDrugLigandSimilarityGraphTaskResponse(SdkResponse):
    ...
    openapi_types = {
        'status': 'str',
        'result': 'LigandSimilarityGraphTaskResultDto'
    }
    ...
    def status(self):
        ...
        :return: The status of this ShowDrugLigandSimilarityGraphTaskResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        ...
        :param status: The status of this ShowDrugLigandSimilarityGraphTaskResponse.
        :type status: str
        """
        self._status = status
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowDrugLigandSimilarityGraphTaskResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowDrugLigandSimilarityGraphTaskResponse):
            return False
