...
class CreateGenJobResponse(SdkResponse):
    ...
    @property
    def id(self):
        r"""Gets the id of this CreateGenJobResponse.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this CreateGenJobResponse.
    ...
    def limit_concurrency(self):
        r"""Gets the limit_concurrency of this CreateGenJobResponse.
    ...
    def limit_concurrency(self, limit_concurrency):
        r"""Sets the limit_concurrency of this CreateGenJobResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateGenJobResponse.to_dict() is deprecated and no longer maintained, "
