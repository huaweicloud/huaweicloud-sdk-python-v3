...
class CreateCustomPropsTaskRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateCustomPropsTaskRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateCustomPropsTaskRequest):
            return False
