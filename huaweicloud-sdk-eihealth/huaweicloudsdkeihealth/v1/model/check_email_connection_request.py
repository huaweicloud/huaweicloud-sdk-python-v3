...
class CheckEmailConnectionRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CheckEmailConnectionRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CheckEmailConnectionRequest):
            return False
