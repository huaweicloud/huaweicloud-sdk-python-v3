...
class CreateMessageAdditionsReq:
    ...
    def __init__(self, type=None, workspace_id=None, job_id=None, tool_type=None, job_type=None, data_path=None):
        r"""CreateMessageAdditionsReq
    ...
    def workspace_id(self):
        r"""Gets the workspace_id of this CreateMessageAdditionsReq.

        **参数解释**： 实验问答使用的空间ID。 **约束限制**： 不涉及 **取值范围**： 仅支持字母、数字、中划线和下划线，长度为[1-128]个字符。 **默认取值**： 不涉及 

        :return: The workspace_id of this CreateMessageAdditionsReq.
        :rtype: str
        """
    ...
    def workspace_id(self, workspace_id):
        r"""Sets the workspace_id of this CreateMessageAdditionsReq.

        **参数解释**： 实验问答使用的空间ID。 **约束限制**： 不涉及 **取值范围**： 仅支持字母、数字、中划线和下划线，长度为[1-128]个字符。 **默认取值**： 不涉及 

        :param workspace_id: The workspace_id of this CreateMessageAdditionsReq.
        :type workspace_id: str
        """
    ...
    @property
    def job_id(self):
        r"""Gets the job_id of this CreateMessageAdditionsReq.

        **参数解释**： 实验问答的作业ID。 **约束限制**： 不涉及 **取值范围**： 仅支持字母、数字、中划线和下划线，长度为[1-128]个字符。 **默认取值**： 不涉及 

        :return: The job_id of this CreateMessageAdditionsReq.
        :rtype: str
        """
        return self._job_id
    ...
    def job_id(self, job_id):
        r"""Sets the job_id of this CreateMessageAdditionsReq.

        **参数解释**： 实验问答的作业ID。 **约束限制**： 不涉及 **取值范围**： 仅支持字母、数字、中划线和下划线，长度为[1-128]个字符。 **默认取值**： 不涉及 

        :param job_id: The job_id of this CreateMessageAdditionsReq.
        :type job_id: str
        """
        self._job_id = job_id
    ...
    @property
    def job_type(self):
        r"""Gets the job_type of this CreateMessageAdditionsReq.

        **参数解释**： 作业类型。 **约束限制**： 不涉及 **取值范围**： 取值范围为[1-64]个字符。 **默认取值**： 不涉及 

        :return: The job_type of this CreateMessageAdditionsReq.
        :rtype: str
        """
    ...
    def job_type(self, job_type):
        r"""Sets the job_type of this CreateMessageAdditionsReq.

        **参数解释**： 作业类型。 **约束限制**： 不涉及 **取值范围**： 取值范围为[1-64]个字符。 **默认取值**： 不涉及 

        :param job_type: The job_type of this CreateMessageAdditionsReq.
        :type job_type: str
        """
    ...
    @property
    def data_path(self):
        r"""Gets the data_path of this CreateMessageAdditionsReq.

        **参数解释**： 深度探究生成报告存储路径。 **约束限制**： 不涉及 **取值范围**： 取值范围为[1-1024]个字符。 **默认取值**： 不涉及 

        :return: The data_path of this CreateMessageAdditionsReq.
        :rtype: str
        """
    ...
    def data_path(self, data_path):
        r"""Sets the data_path of this CreateMessageAdditionsReq.

        **参数解释**： 深度探究生成报告存储路径。 **约束限制**： 不涉及 **取值范围**： 取值范围为[1-1024]个字符。 **默认取值**： 不涉及 

        :param data_path: The data_path of this CreateMessageAdditionsReq.
        :type data_path: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateMessageAdditionsReq):
            return False
