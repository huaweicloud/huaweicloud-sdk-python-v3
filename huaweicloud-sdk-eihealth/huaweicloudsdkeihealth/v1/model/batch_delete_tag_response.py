...
class BatchDeleteTagResponse(SdkResponse):
    ...
    def __init__(self, body=None):
        ...
        super(BatchDeleteTagResponse, self).__init__()
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteTagResponse):
            return False
