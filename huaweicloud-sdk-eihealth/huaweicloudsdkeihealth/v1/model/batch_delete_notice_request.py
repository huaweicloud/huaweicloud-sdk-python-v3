...
class BatchDeleteNoticeRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchDeleteNoticeRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteNoticeRequest):
            return False
