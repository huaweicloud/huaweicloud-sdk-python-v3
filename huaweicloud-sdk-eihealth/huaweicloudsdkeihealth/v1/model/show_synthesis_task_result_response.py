...
class ShowSynthesisTaskResultResponse(SdkResponse):
    ...
    def __init__(self, status=None, task_data=None, result=None):
        ...
        super(ShowSynthesisTaskResultResponse, self).__init__()
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowSynthesisTaskResultResponse):
            return False
