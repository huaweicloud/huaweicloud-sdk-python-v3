...
class ListQuotaResponse(SdkResponse):
    ...
    def __init__(self, quotas=None, count=None):
        ...
        :param quotas: 配额信息列表
        :type quotas: list[:class:`huaweicloudsdkeihealth.v1.QuotaRsp`]
        :param count: 配额列表个数
        :type count: int
        """
    ...
    def quotas(self):
        ...
        :rtype: list[:class:`huaweicloudsdkeihealth.v1.QuotaRsp`]
        """
        return self._quotas
    ...
    @property
    def count(self):
        r"""Gets the count of this ListQuotaResponse.

        配额列表个数

        :return: The count of this ListQuotaResponse.
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        r"""Sets the count of this ListQuotaResponse.

        配额列表个数

        :param count: The count of this ListQuotaResponse.
        :type count: int
        """
        self._count = count
