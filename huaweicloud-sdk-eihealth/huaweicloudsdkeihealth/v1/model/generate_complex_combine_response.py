...
class GenerateComplexCombineResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("GenerateComplexCombineResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GenerateComplexCombineResponse):
            return False
