...
class InstallNextflowRequest:
    ...
    openapi_types = {
        'body': 'InstallNextflowRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the InstallNextflowRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InstallNextflowRequest):
            return False
