...
class CreateCodeRequest:
    ...
    def __init__(self, user_id=None, body=None):
        ...
        :param user_id: 用户id
        :type user_id: str
        :param body: Body of the CreateCodeRequest
    ...
    def user_id(self):
        ...
        :return: The user_id of this CreateCodeRequest.
        :rtype: str
        """
    ...
    def user_id(self, user_id):
        ...
        :param user_id: The user_id of this CreateCodeRequest.
        :type user_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateCodeRequest):
            return False
