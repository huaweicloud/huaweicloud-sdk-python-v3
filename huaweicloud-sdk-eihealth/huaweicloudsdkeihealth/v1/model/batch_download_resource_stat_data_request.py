...
class BatchDownloadResourceStatDataRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchDownloadResourceStatDataRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDownloadResourceStatDataRequest):
            return False
