...
class ListAppResponse(SdkResponse):
    ...
    @property
    def count(self):
        r"""Gets the count of this ListAppResponse.
    ...
    def count(self, count):
        r"""Sets the count of this ListAppResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListAppResponse.to_dict() is deprecated and no longer maintained, "
