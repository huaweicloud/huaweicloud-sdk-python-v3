...
class CreateDatabaseResourceRequest:
    ...
    openapi_types = {
        'body': 'CreateDatabaseResourceReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateDatabaseResourceRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateDatabaseResourceRequest):
            return False
