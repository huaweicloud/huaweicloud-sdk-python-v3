...
class ShowNotebookResponse(SdkResponse):
    ...
    def eihealth_project_id(self):
        r"""Gets the eihealth_project_id of this ShowNotebookResponse.

        **参数解释**： 空间ID。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及 

        :return: The eihealth_project_id of this ShowNotebookResponse.
        :rtype: str
        """
    ...
    def eihealth_project_id(self, eihealth_project_id):
        r"""Sets the eihealth_project_id of this ShowNotebookResponse.

        **参数解释**： 空间ID。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及 

        :param eihealth_project_id: The eihealth_project_id of this ShowNotebookResponse.
        :type eihealth_project_id: str
        """
    ...
    def eihealth_project_name(self):
        r"""Gets the eihealth_project_name of this ShowNotebookResponse.

        **参数解释**： 空间名称。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及 

        :return: The eihealth_project_name of this ShowNotebookResponse.
        :rtype: str
        """
    ...
    def eihealth_project_name(self, eihealth_project_name):
        r"""Sets the eihealth_project_name of this ShowNotebookResponse.

        **参数解释**： 空间名称。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及 

        :param eihealth_project_name: The eihealth_project_name of this ShowNotebookResponse.
        :type eihealth_project_name: str
        """
