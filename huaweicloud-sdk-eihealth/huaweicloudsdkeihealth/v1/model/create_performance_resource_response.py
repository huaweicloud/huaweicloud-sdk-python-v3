...
class CreatePerformanceResourceResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreatePerformanceResourceResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreatePerformanceResourceResponse):
            return False
