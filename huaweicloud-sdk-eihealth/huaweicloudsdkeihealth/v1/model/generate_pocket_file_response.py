...
class GeneratePocketFileResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("GeneratePocketFileResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GeneratePocketFileResponse):
            return False
