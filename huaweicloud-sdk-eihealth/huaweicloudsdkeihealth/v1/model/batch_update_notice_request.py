...
class BatchUpdateNoticeRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchUpdateNoticeRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchUpdateNoticeRequest):
            return False
