...
class UpdateMessageEmailConfigRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the UpdateMessageEmailConfigRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateMessageEmailConfigRequest):
            return False
