...
class CreateScaleOutPolicyRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateScaleOutPolicyRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateScaleOutPolicyRequest):
            return False
