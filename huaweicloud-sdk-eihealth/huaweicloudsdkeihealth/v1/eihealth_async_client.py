...
class EiHealthAsyncClient(Client):
    ...
    def create_gen_job_async(self, request):
        r"""创建分子生成作业
    ...
    def create_gen_job_async_invoker(self, request):
        http_info = self._create_gen_job_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_gen_job_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def create_target_opt_job_async(self, request):
        r"""创建靶点优化作业
    ...
    def create_target_opt_job_async_invoker(self, request):
        http_info = self._create_target_opt_job_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_target_opt_job_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def list_base_model_async_invoker(self, request):
        http_info = self._list_base_model_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_base_model_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def run_fasta_preprocess_async(self, request):
        r"""受体预处理（Fasta格式）
    ...
    def run_fasta_preprocess_async_invoker(self, request):
        http_info = self._run_fasta_preprocess_http_info(request)
        return AsyncInvoker(self, http_info)

    def _run_fasta_preprocess_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def show_gen_job_async(self, request):
        r"""查询分子生成作业详情
    ...
    def show_gen_job_async_invoker(self, request):
        http_info = self._show_gen_job_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_gen_job_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_target_opt_job_async(self, request):
        r"""查询靶点优化作业详情
    ...
    def show_target_opt_job_async_invoker(self, request):
        http_info = self._show_target_opt_job_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_target_opt_job_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def create_cpi_job_async(self, request):
        r"""创建CPI作业
    ...
    def create_cpi_job_async_invoker(self, request):
        http_info = self._create_cpi_job_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_cpi_job_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def show_cpi_job_async(self, request):
        r"""查询CPI作业详情
    ...
    def show_cpi_job_async_invoker(self, request):
        http_info = self._show_cpi_job_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_cpi_job_http_info(self, request):
        http_info = {
            "method": "GET",
