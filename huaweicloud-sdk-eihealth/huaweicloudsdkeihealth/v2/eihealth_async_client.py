...
class EiHealthAsyncClient(Client):
    ...
    def show_drug_job_statistics_async(self, request):
        r"""统计药物作业数量和调用次数
    ...
    def show_drug_job_statistics_async_invoker(self, request):
        http_info = self._show_drug_job_statistics_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_drug_job_statistics_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def create_message_feedback_async(self, request):
        r"""创建问答内容反馈
    ...
    def create_message_feedback_async_invoker(self, request):
        http_info = self._create_message_feedback_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_message_feedback_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def create_assistant_model_async(self, request):
        r"""创建助手模型
    ...
    def create_assistant_model_async_invoker(self, request):
        http_info = self._create_assistant_model_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_assistant_model_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def delete_assistant_model_async(self, request):
        r"""删除助手模型
    ...
    def delete_assistant_model_async_invoker(self, request):
        http_info = self._delete_assistant_model_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_assistant_model_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_all_assistant_models_async(self, request):
        r"""获取模型列表
    ...
    def list_all_assistant_models_async_invoker(self, request):
        http_info = self._list_all_assistant_models_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_all_assistant_models_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_assistant_models_async(self, request):
        r"""获取供应商模型列表
    ...
    def list_assistant_models_async_invoker(self, request):
        http_info = self._list_assistant_models_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_assistant_models_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/{project_id}/model-vendors/{vendor_id}/models",
            "request_type": request.__class__.__name__,
    ...
    def update_assistant_model_async(self, request):
        r"""更新助手模型
    ...
    def update_assistant_model_async_invoker(self, request):
        http_info = self._update_assistant_model_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_assistant_model_http_info(self, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v1/{project_id}/model-vendors/{vendor_id}/models/{model_id}",
            "request_type": request.__class__.__name__,
    ...
    def create_model_vendor_async(self, request):
        r"""创建模型供应商
    ...
    def create_model_vendor_async_invoker(self, request):
        http_info = self._create_model_vendor_http_info(request)
        return AsyncInvoker(self, http_info)

    def _create_model_vendor_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def delete_model_vendor_async(self, request):
        r"""删除模型供应商
    ...
    def delete_model_vendor_async_invoker(self, request):
        http_info = self._delete_model_vendor_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_model_vendor_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_model_vendors_async(self, request):
        r"""获取模型供应商列表
    ...
    def list_model_vendors_async_invoker(self, request):
        http_info = self._list_model_vendors_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_model_vendors_http_info(self, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v1/{project_id}/model-vendors",
            "request_type": request.__class__.__name__,
    ...
    def update_model_vendor_async(self, request):
        r"""更新模型供应商
    ...
    def update_model_vendor_async_invoker(self, request):
        http_info = self._update_model_vendor_http_info(request)
        return AsyncInvoker(self, http_info)

    def _update_model_vendor_http_info(self, request):
        http_info = {
            "method": "PUT",
            "resource_path": "/v1/{project_id}/model-vendors/{vendor_id}",
            "request_type": request.__class__.__name__,
