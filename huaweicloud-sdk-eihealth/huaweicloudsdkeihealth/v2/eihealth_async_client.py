...
class EiHealthAsyncClient(Client):
    ...
    def show_admet_with_custom_props_async(self, request):
        ...
        """
        http_info = self._show_admet_with_custom_props_http_info(request)
        return self._call_api(**http_info)

    def show_admet_with_custom_props_async_invoker(self, request):
        http_info = self._show_admet_with_custom_props_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_admet_with_custom_props_http_info(self, request):
        http_info = {
            "method": "POST",
