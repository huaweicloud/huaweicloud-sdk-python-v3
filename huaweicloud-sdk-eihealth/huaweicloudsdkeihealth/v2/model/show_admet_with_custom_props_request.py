...
class ShowAdmetWithCustomPropsRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ShowAdmetWithCustomPropsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowAdmetWithCustomPropsRequest):
            return False
