...
class ApigClient(Client):
    ...
    def create_ai_api_key(self, request):
        r"""创建AIAPIKey
        ...
        :param request: Request instance for CreateAiApiKey
        :type request: :class:`huaweicloudsdkapig.v2.CreateAiApiKeyRequest`
        :rtype: :class:`huaweicloudsdkapig.v2.CreateAiApiKeyResponse`
        """
        http_info = self._create_ai_api_key_http_info(request)
        return self._call_api(**http_info)

    def create_ai_api_key_invoker(self, request):
        http_info = self._create_ai_api_key_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_ai_api_key_http_info(cls, request):
        http_info = {
            "method": "POST",
            "resource_path": "/v2/{project_id}/apigw/instances/{instance_id}/apps/{app_id}/ai-api-keys",
            "request_type": request.__class__.__name__,
            "response_type": "CreateAiApiKeyResponse"
            }
    ...
    def delete_ai_api_key(self, request):
        r"""删除AIAPIKey
        ...
        :param request: Request instance for DeleteAiApiKey
        :type request: :class:`huaweicloudsdkapig.v2.DeleteAiApiKeyRequest`
        :rtype: :class:`huaweicloudsdkapig.v2.DeleteAiApiKeyResponse`
        """
        http_info = self._delete_ai_api_key_http_info(request)
        return self._call_api(**http_info)

    def delete_ai_api_key_invoker(self, request):
        http_info = self._delete_ai_api_key_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_ai_api_key_http_info(cls, request):
        http_info = {
            "method": "DELETE",
            "resource_path": "/v2/{project_id}/apigw/instances/{instance_id}/apps/{app_id}/ai-api-keys/{ai_api_key_id}",
            "request_type": request.__class__.__name__,
            "response_type": "DeleteAiApiKeyResponse"
            }
        ...
        if 'app_id' in local_var_params:
            path_params['app_id'] = local_var_params['app_id']
        if 'ai_api_key_id' in local_var_params:
            path_params['ai_api_key_id'] = local_var_params['ai_api_key_id']
    ...
    def export_api_definitions_async_invoker(self, request):
        http_info = self._export_api_definitions_async_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _export_api_definitions_async_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def import_api_definitions_async_invoker(self, request):
        http_info = self._import_api_definitions_async_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _import_api_definitions_async_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def list_ai_api_keys(self, request):
        r"""查询AIAPIKey列表
        ...
        :param request: Request instance for ListAiApiKeys
        :type request: :class:`huaweicloudsdkapig.v2.ListAiApiKeysRequest`
        :rtype: :class:`huaweicloudsdkapig.v2.ListAiApiKeysResponse`
        """
        http_info = self._list_ai_api_keys_http_info(request)
        return self._call_api(**http_info)

    def list_ai_api_keys_invoker(self, request):
        http_info = self._list_ai_api_keys_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_ai_api_keys_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v2/{project_id}/apigw/instances/{instance_id}/apps/{app_id}/ai-api-keys",
            "request_type": request.__class__.__name__,
            "response_type": "ListAiApiKeysResponse"
            }
    ...
    def _list_apps_v2_http_info(cls, request):
        ...
        if 'related_domain_id' in local_var_params:
            query_params.append(('related_domain_id', local_var_params['related_domain_id']))
        if 'related_project_id' in local_var_params:
            query_params.append(('related_project_id', local_var_params['related_project_id']))
    ...
    def list_instance_features(self, request):
        r"""查询实例支持的特性列表
    ...
    def list_instance_features_invoker(self, request):
        http_info = self._list_instance_features_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _list_instance_features_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_async_task_result(self, request):
        r"""获取异步任务结果
    ...
    def show_async_task_result_invoker(self, request):
        http_info = self._show_async_task_result_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_async_task_result_http_info(cls, request):
        http_info = {
            "method": "GET",
    ...
    def show_details_of_ai_api_key(self, request):
        r"""查看AIAPIKey详情
        ...
        :param request: Request instance for ShowDetailsOfAiApiKey
        :type request: :class:`huaweicloudsdkapig.v2.ShowDetailsOfAiApiKeyRequest`
        :rtype: :class:`huaweicloudsdkapig.v2.ShowDetailsOfAiApiKeyResponse`
        """
        http_info = self._show_details_of_ai_api_key_http_info(request)
        return self._call_api(**http_info)

    def show_details_of_ai_api_key_invoker(self, request):
        http_info = self._show_details_of_ai_api_key_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_details_of_ai_api_key_http_info(cls, request):
        http_info = {
            "method": "GET",
            "resource_path": "/v2/{project_id}/apigw/instances/{instance_id}/apps/{app_id}/ai-api-keys/{ai_api_key_id}",
            "request_type": request.__class__.__name__,
            "response_type": "ShowDetailsOfAiApiKeyResponse"
            }
    ...
    def update_sl_domain_setting_v2(self, request):
        r"""设置调试域名是否可以访问
    ...
    def update_sl_domain_setting_v2_invoker(self, request):
        http_info = self._update_sl_domain_setting_v2_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _update_sl_domain_setting_v2_http_info(cls, request):
        http_info = {
            "method": "PUT",
