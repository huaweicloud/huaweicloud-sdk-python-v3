...
class ListApiRuntimeDefinitionV2Response(SdkResponse):
    ...
    def trace_enabled(self):
        r"""Gets the trace_enabled of this ListApiRuntimeDefinitionV2Response.

        是否开启链路追踪，默认关闭。

        :return: The trace_enabled of this ListApiRuntimeDefinitionV2Response.
        :rtype: bool
        """
    ...
    def trace_enabled(self, trace_enabled):
        r"""Sets the trace_enabled of this ListApiRuntimeDefinitionV2Response.

        是否开启链路追踪，默认关闭。

        :param trace_enabled: The trace_enabled of this ListApiRuntimeDefinitionV2Response.
        :type trace_enabled: bool
        """
    ...
    def sampling_strategy(self):
        r"""Gets the sampling_strategy of this ListApiRuntimeDefinitionV2Response.

        采样策略，当选择开启链路追踪时，此字段必填。 - RATE：按比例采样 

        :return: The sampling_strategy of this ListApiRuntimeDefinitionV2Response.
        :rtype: str
        """
    ...
    def sampling_strategy(self, sampling_strategy):
        r"""Sets the sampling_strategy of this ListApiRuntimeDefinitionV2Response.

        采样策略，当选择开启链路追踪时，此字段必填。 - RATE：按比例采样 

        :param sampling_strategy: The sampling_strategy of this ListApiRuntimeDefinitionV2Response.
        :type sampling_strategy: str
        """
    ...
    def sampling_param(self):
        r"""Gets the sampling_param of this ListApiRuntimeDefinitionV2Response.

        采样参数。 - 当采样策略为RATE时，此字段取值为字符串化的整数，范围为0-100，缺省为'100'，'100'为采集每个请求，建议与后端应用的采样率保持一致。 

        :return: The sampling_param of this ListApiRuntimeDefinitionV2Response.
        :rtype: str
        """
    ...
    def sampling_param(self, sampling_param):
        r"""Sets the sampling_param of this ListApiRuntimeDefinitionV2Response.

        采样参数。 - 当采样策略为RATE时，此字段取值为字符串化的整数，范围为0-100，缺省为'100'，'100'为采集每个请求，建议与后端应用的采样率保持一致。 

        :param sampling_param: The sampling_param of this ListApiRuntimeDefinitionV2Response.
        :type sampling_param: str
        """
    ...
    def is_send_fg_body_base64(self):
        ...
        :return: The is_send_fg_body_base64 of this ListApiRuntimeDefinitionV2Response.
        :rtype: bool
        """
    ...
    def is_send_fg_body_base64(self, is_send_fg_body_base64):
        ...
        :param is_send_fg_body_base64: The is_send_fg_body_base64 of this ListApiRuntimeDefinitionV2Response.
        :type is_send_fg_body_base64: bool
        """
