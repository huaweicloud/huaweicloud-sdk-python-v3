...
class UpdateSignatureKeyV2Response(SdkResponse):
    ...
    def __init__(self, name=None, sign_type=None, sign_key=None, sign_secret=None, sign_algorithm=None, update_time=None, create_time=None, id=None):
        r"""UpdateSignatureKeyV2Response
    ...
    @property
    def name(self):
        r"""Gets the name of this UpdateSignatureKeyV2Response.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this UpdateSignatureKeyV2Response.
    ...
    @property
    def sign_type(self):
        r"""Gets the sign_type of this UpdateSignatureKeyV2Response.
    ...
    def sign_type(self, sign_type):
        r"""Sets the sign_type of this UpdateSignatureKeyV2Response.
    ...
    @property
    def sign_key(self):
        r"""Gets the sign_key of this UpdateSignatureKeyV2Response.
    ...
    def sign_key(self, sign_key):
        r"""Sets the sign_key of this UpdateSignatureKeyV2Response.
    ...
    def sign_secret(self):
        r"""Gets the sign_secret of this UpdateSignatureKeyV2Response.
    ...
    def sign_secret(self, sign_secret):
        r"""Sets the sign_secret of this UpdateSignatureKeyV2Response.
    ...
    def sign_algorithm(self):
        r"""Gets the sign_algorithm of this UpdateSignatureKeyV2Response.
    ...
    def sign_algorithm(self, sign_algorithm):
        r"""Sets the sign_algorithm of this UpdateSignatureKeyV2Response.
    ...
    def update_time(self):
        r"""Gets the update_time of this UpdateSignatureKeyV2Response.

        更新时间

        :return: The update_time of this UpdateSignatureKeyV2Response.
        :rtype: datetime
        """
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this UpdateSignatureKeyV2Response.

        更新时间

        :param update_time: The update_time of this UpdateSignatureKeyV2Response.
        :type update_time: datetime
        """
    ...
    def create_time(self):
        r"""Gets the create_time of this UpdateSignatureKeyV2Response.

        创建时间

        :return: The create_time of this UpdateSignatureKeyV2Response.
        :rtype: datetime
        """
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this UpdateSignatureKeyV2Response.

        创建时间

        :param create_time: The create_time of this UpdateSignatureKeyV2Response.
        :type create_time: datetime
        """
    ...
    @property
    def id(self):
        r"""Gets the id of this UpdateSignatureKeyV2Response.

        签名密钥的编号

        :return: The id of this UpdateSignatureKeyV2Response.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this UpdateSignatureKeyV2Response.

        签名密钥的编号

        :param id: The id of this UpdateSignatureKeyV2Response.
        :type id: str
        """
        self._id = id
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateSignatureKeyV2Response.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateSignatureKeyV2Response):
            return False
