...
class ListApisBindedToAclPolicyV2Response(SdkResponse):
    ...
    openapi_types = {
        'size': 'int',
        'total': 'int',
        'apis': 'list[AclBindApiPageApisResp]'
    }
    ...
    def __init__(self, size=None, total=None, apis=None):
        """ListApisBindedToAclPolicyV2Response - a model defined in huaweicloud sdk"""
    ...
    def apis(self):
        ...
        :rtype: list[AclBindApiPageApisResp]
        """
        return self._apis
    ...
    def apis(self, apis):
        ...
        :type: list[AclBindApiPageApisResp]
        """
        self._apis = apis
