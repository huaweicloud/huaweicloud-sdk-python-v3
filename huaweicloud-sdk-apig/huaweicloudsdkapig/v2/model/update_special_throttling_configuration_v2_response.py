...
class UpdateSpecialThrottlingConfigurationV2Response(SdkResponse):
    ...
    def __init__(self, id=None, call_limits=None, apply_time=None, app_name=None, app_id=None, object_id=None, object_type=None, object_name=None, throttle_id=None):
        r"""UpdateSpecialThrottlingConfigurationV2Response
        ...
        :param object_name: 作用的APP或租户的名称
    ...
    @property
    def id(self):
        r"""Gets the id of this UpdateSpecialThrottlingConfigurationV2Response.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this UpdateSpecialThrottlingConfigurationV2Response.
    ...
    def call_limits(self):
        r"""Gets the call_limits of this UpdateSpecialThrottlingConfigurationV2Response.
    ...
    def call_limits(self, call_limits):
        r"""Sets the call_limits of this UpdateSpecialThrottlingConfigurationV2Response.
    ...
    @property
    def apply_time(self):
        r"""Gets the apply_time of this UpdateSpecialThrottlingConfigurationV2Response.
    ...
    def apply_time(self, apply_time):
        r"""Sets the apply_time of this UpdateSpecialThrottlingConfigurationV2Response.
    ...
    @property
    def app_name(self):
        r"""Gets the app_name of this UpdateSpecialThrottlingConfigurationV2Response.
    ...
    def app_name(self, app_name):
        r"""Sets the app_name of this UpdateSpecialThrottlingConfigurationV2Response.
    ...
    @property
    def app_id(self):
        r"""Gets the app_id of this UpdateSpecialThrottlingConfigurationV2Response.
    ...
    def app_id(self, app_id):
        r"""Sets the app_id of this UpdateSpecialThrottlingConfigurationV2Response.
    ...
    @property
    def object_id(self):
        r"""Gets the object_id of this UpdateSpecialThrottlingConfigurationV2Response.
    ...
    def object_id(self, object_id):
        r"""Sets the object_id of this UpdateSpecialThrottlingConfigurationV2Response.
    ...
    def object_type(self):
        r"""Gets the object_type of this UpdateSpecialThrottlingConfigurationV2Response.
    ...
    def object_type(self, object_type):
        r"""Sets the object_type of this UpdateSpecialThrottlingConfigurationV2Response.
    ...
    def object_name(self):
        r"""Gets the object_name of this UpdateSpecialThrottlingConfigurationV2Response.
    ...
    def object_name(self, object_name):
        r"""Sets the object_name of this UpdateSpecialThrottlingConfigurationV2Response.
    ...
    def throttle_id(self):
        r"""Gets the throttle_id of this UpdateSpecialThrottlingConfigurationV2Response.
    ...
    def throttle_id(self, throttle_id):
        r"""Sets the throttle_id of this UpdateSpecialThrottlingConfigurationV2Response.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateSpecialThrottlingConfigurationV2Response.to_dict() is deprecated and no longer maintained, "
