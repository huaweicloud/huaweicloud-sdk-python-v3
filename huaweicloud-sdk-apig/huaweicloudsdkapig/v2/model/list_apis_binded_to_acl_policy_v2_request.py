...
class ListApisBindedToAclPolicyV2Request:
    ...
    @property
    def api_id(self):
        r"""Gets the api_id of this ListApisBindedToAclPolicyV2Request.

        API编号

        :return: The api_id of this ListApisBindedToAclPolicyV2Request.
        :rtype: str
        """
        return self._api_id
    ...
    def api_id(self, api_id):
        r"""Sets the api_id of this ListApisBindedToAclPolicyV2Request.

        API编号

        :param api_id: The api_id of this ListApisBindedToAclPolicyV2Request.
        :type api_id: str
        """
        self._api_id = api_id
    ...
    @property
    def tags(self):
        r"""Gets the tags of this ListApisBindedToAclPolicyV2Request.

        API标签，该参数可指定多个，多个不同的参数值为或关系；不指定或为空时，表示不筛选标签；指定为#no_tags#时，表示筛选无标签API。

        :return: The tags of this ListApisBindedToAclPolicyV2Request.
        :rtype: str
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this ListApisBindedToAclPolicyV2Request.

        API标签，该参数可指定多个，多个不同的参数值为或关系；不指定或为空时，表示不筛选标签；指定为#no_tags#时，表示筛选无标签API。

        :param tags: The tags of this ListApisBindedToAclPolicyV2Request.
        :type tags: str
        """
        self._tags = tags
