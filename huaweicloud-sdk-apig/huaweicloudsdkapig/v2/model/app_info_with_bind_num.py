...
class AppInfoWithBindNum:
    ...
    def __init__(self, id=None, name=None, remark=None, creator=None, update_time=None, app_key=None, related_domain_id=None, related_project_id=None, app_secret=None, register_time=None, status=None, app_type=None, roma_app_type=None, bind_num=None):
    ...
    def related_domain_id(self):
        r"""Gets the related_domain_id of this AppInfoWithBindNum.

        凭据关联的账号ID。

        :return: The related_domain_id of this AppInfoWithBindNum.
        :rtype: str
        """
    ...
    def related_domain_id(self, related_domain_id):
        r"""Sets the related_domain_id of this AppInfoWithBindNum.

        凭据关联的账号ID。

        :param related_domain_id: The related_domain_id of this AppInfoWithBindNum.
        :type related_domain_id: str
        """
    ...
    def related_project_id(self):
        r"""Gets the related_project_id of this AppInfoWithBindNum.

        凭据关联的项目ID。

        :return: The related_project_id of this AppInfoWithBindNum.
        :rtype: str
        """
    ...
    def related_project_id(self, related_project_id):
        r"""Sets the related_project_id of this AppInfoWithBindNum.

        凭据关联的项目ID。

        :param related_project_id: The related_project_id of this AppInfoWithBindNum.
        :type related_project_id: str
        """
