...
class ListRequestThrottlingPolicyV2Response(SdkResponse):
    ...
    def __init__(self, size=None, total=None, throttles=None):
        r"""ListRequestThrottlingPolicyV2Response
        ...
        :type throttles: list[:class:`huaweicloudsdkapig.v2.ThrottlesInfo`]
        """
    ...
    @property
    def size(self):
        r"""Gets the size of this ListRequestThrottlingPolicyV2Response.
    ...
    @size.setter
    def size(self, size):
        r"""Sets the size of this ListRequestThrottlingPolicyV2Response.
    ...
    @property
    def total(self):
        r"""Gets the total of this ListRequestThrottlingPolicyV2Response.
    ...
    def total(self, total):
        r"""Sets the total of this ListRequestThrottlingPolicyV2Response.
    ...
    @property
    def throttles(self):
        r"""Gets the throttles of this ListRequestThrottlingPolicyV2Response.

        本次查询到的流控策略列表

        :return: The throttles of this ListRequestThrottlingPolicyV2Response.
        :rtype: list[:class:`huaweicloudsdkapig.v2.ThrottlesInfo`]
        """
        return self._throttles

    @throttles.setter
    def throttles(self, throttles):
        r"""Sets the throttles of this ListRequestThrottlingPolicyV2Response.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListRequestThrottlingPolicyV2Response.to_dict() is deprecated and no longer maintained, "
