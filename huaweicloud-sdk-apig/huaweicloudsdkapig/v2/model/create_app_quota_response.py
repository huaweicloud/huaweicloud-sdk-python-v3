...
class CreateAppQuotaResponse(SdkResponse):
    ...
    def app_quota_id(self):
        r"""Gets the app_quota_id of this CreateAppQuotaResponse.

        凭据配额编号

        :return: The app_quota_id of this CreateAppQuotaResponse.
        :rtype: str
        """
    ...
    def app_quota_id(self, app_quota_id):
        r"""Sets the app_quota_id of this CreateAppQuotaResponse.
    ...
    @property
    def name(self):
        r"""Gets the name of this CreateAppQuotaResponse.

        配额名称。支持汉字，英文，数字，下划线，且只能以英文和汉字开头，3-255字符

        :return: The name of this CreateAppQuotaResponse.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this CreateAppQuotaResponse.
    ...
    def call_limits(self):
        r"""Gets the call_limits of this CreateAppQuotaResponse.

        凭据配额的访问次数限制

        :return: The call_limits of this CreateAppQuotaResponse.
        :rtype: int
        """
    ...
    def call_limits(self, call_limits):
        r"""Sets the call_limits of this CreateAppQuotaResponse.
    ...
    @property
    def time_unit(self):
        r"""Gets the time_unit of this CreateAppQuotaResponse.

        限定时间单位：SECOND:秒、MINUTE:分、HOUR:时、DAY:天

        :return: The time_unit of this CreateAppQuotaResponse.
        :rtype: str
        """
    ...
    def time_unit(self, time_unit):
        r"""Sets the time_unit of this CreateAppQuotaResponse.
    ...
    def time_interval(self):
        r"""Gets the time_interval of this CreateAppQuotaResponse.

        配额的限定时间值

        :return: The time_interval of this CreateAppQuotaResponse.
        :rtype: int
        """
    ...
    def time_interval(self, time_interval):
        r"""Sets the time_interval of this CreateAppQuotaResponse.
    ...
    @property
    def remark(self):
        r"""Gets the remark of this CreateAppQuotaResponse.

        参数说明和描述

        :return: The remark of this CreateAppQuotaResponse.
        :rtype: str
        """
        return self._remark
    ...
    def remark(self, remark):
        r"""Sets the remark of this CreateAppQuotaResponse.
    ...
    @property
    def reset_time(self):
        r"""Gets the reset_time of this CreateAppQuotaResponse.

        首次配额重置时间点，不配置默认为首次调用时间计算

        :return: The reset_time of this CreateAppQuotaResponse.
        :rtype: str
        """
    ...
    def reset_time(self, reset_time):
        r"""Sets the reset_time of this CreateAppQuotaResponse.
    ...
    def create_time(self):
        r"""Gets the create_time of this CreateAppQuotaResponse.

        创建时间

        :return: The create_time of this CreateAppQuotaResponse.
        :rtype: datetime
        """
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this CreateAppQuotaResponse.
    ...
    def bound_app_num(self):
        r"""Gets the bound_app_num of this CreateAppQuotaResponse.

        配额策略已绑定应用数量

        :return: The bound_app_num of this CreateAppQuotaResponse.
        :rtype: int
        """
    ...
    def bound_app_num(self, bound_app_num):
        r"""Sets the bound_app_num of this CreateAppQuotaResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateAppQuotaResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateAppQuotaResponse):
            return False
