...
class ApiPolicyHttpCreate:
    ...
    def __init__(self, url_domain=None, req_protocol=None, req_method=None, req_uri=None, timeout=None, retry_count=None, enable_sm_channel=None, member_group_url_infos=None, effect_mode=None, name=None, backend_params=None, conditions=None, authorizer_id=None, vpc_channel_info=None, vpc_channel_status=None):
    ...
    def member_group_url_infos(self):
        r"""Gets the member_group_url_infos of this ApiPolicyHttpCreate.

        后端服务器分组详细信息，当vpc_channel_status取值为4时，该字段必填。

        :return: The member_group_url_infos of this ApiPolicyHttpCreate.
    ...
    def member_group_url_infos(self, member_group_url_infos):
        r"""Sets the member_group_url_infos of this ApiPolicyHttpCreate.

        后端服务器分组详细信息，当vpc_channel_status取值为4时，该字段必填。

        :param member_group_url_infos: The member_group_url_infos of this ApiPolicyHttpCreate.
        :type member_group_url_infos: list[:class:`huaweicloudsdkapig.v2.MemberGroupUrlInfo`]
        """
