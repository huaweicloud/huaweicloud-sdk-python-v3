...
class ApiCommon:
    ...
    def name(self):
        ...
        :return: The name of this ApiCommon.
        :rtype: str
        """
        return self._name
    ...
    def type(self):
        ...
        :return: The type of this ApiCommon.
        :rtype: int
        """
        return self._type
    ...
    def version(self):
        ...
        :return: The version of this ApiCommon.
        :rtype: str
        """
    ...
    def cors(self):
        ...
        :return: The cors of this ApiCommon.
        :rtype: bool
        """
        return self._cors
    ...
    def trace_enabled(self):
        r"""Gets the trace_enabled of this ApiCommon.

        是否开启链路追踪，默认关闭。

        :return: The trace_enabled of this ApiCommon.
        :rtype: bool
        """
    ...
    def trace_enabled(self, trace_enabled):
        r"""Sets the trace_enabled of this ApiCommon.

        是否开启链路追踪，默认关闭。

        :param trace_enabled: The trace_enabled of this ApiCommon.
        :type trace_enabled: bool
        """
    ...
    def sampling_strategy(self):
        r"""Gets the sampling_strategy of this ApiCommon.

        采样策略，当选择开启链路追踪时，此字段必填。 - RATE：按比例采样 

        :return: The sampling_strategy of this ApiCommon.
        :rtype: str
        """
    ...
    def sampling_strategy(self, sampling_strategy):
        r"""Sets the sampling_strategy of this ApiCommon.

        采样策略，当选择开启链路追踪时，此字段必填。 - RATE：按比例采样 

        :param sampling_strategy: The sampling_strategy of this ApiCommon.
        :type sampling_strategy: str
        """
    ...
    def sampling_param(self):
        r"""Gets the sampling_param of this ApiCommon.

        采样参数。 - 当采样策略为RATE时，此字段取值为字符串化的整数，范围为0-100，缺省为'100'，'100'为采集每个请求，建议与后端应用的采样率保持一致。 

        :return: The sampling_param of this ApiCommon.
        :rtype: str
        """
    ...
    def sampling_param(self, sampling_param):
        r"""Sets the sampling_param of this ApiCommon.

        采样参数。 - 当采样策略为RATE时，此字段取值为字符串化的整数，范围为0-100，缺省为'100'，'100'为采集每个请求，建议与后端应用的采样率保持一致。 

        :param sampling_param: The sampling_param of this ApiCommon.
        :type sampling_param: str
        """
    ...
    def match_mode(self):
        ...
        :return: The match_mode of this ApiCommon.
        :rtype: str
        """
    ...
    def remark(self):
        ...
        :return: The remark of this ApiCommon.
        :rtype: str
        """
        return self._remark
    ...
    def group_id(self):
        ...
        :return: The group_id of this ApiCommon.
        :rtype: str
        """
    ...
    def body_remark(self):
        ...
        :return: The body_remark of this ApiCommon.
        :rtype: str
        """
    ...
    def response_id(self):
        ...
        :return: The response_id of this ApiCommon.
        :rtype: str
        """
    ...
    def roma_app_id(self):
        ...
        :return: The roma_app_id of this ApiCommon.
        :rtype: str
        """
    ...
    def domain_name(self):
        ...
        :return: The domain_name of this ApiCommon.
        :rtype: str
        """
    ...
    def tag(self):
        ...
        :return: The tag of this ApiCommon.
        :rtype: str
        """
        return self._tag
    ...
    def content_type(self):
        ...
        :return: The content_type of this ApiCommon.
        :rtype: str
        """
    ...
    def is_send_fg_body_base64(self):
        r"""Gets the is_send_fg_body_base64 of this ApiCommon.
        ...
        :return: The is_send_fg_body_base64 of this ApiCommon.
        :rtype: bool
        """
    ...
    def is_send_fg_body_base64(self, is_send_fg_body_base64):
        r"""Sets the is_send_fg_body_base64 of this ApiCommon.

        是否对与FunctionGraph交互场景的body进行Base64编码。仅当content_type为application/json时，可以不对body进行Base64编码。 应用场景： - 自定义认证 - 绑定断路器插件，且断路器后端降级策略为函数后端 - API后端类型为函数工作流

        :param is_send_fg_body_base64: The is_send_fg_body_base64 of this ApiCommon.
        :type is_send_fg_body_base64: bool
        """
    ...
    def id(self):
        ...
        :return: The id of this ApiCommon.
        :rtype: str
        """
        return self._id
    ...
    def status(self):
        ...
        :return: The status of this ApiCommon.
        :rtype: int
        """
        return self._status
    ...
    def arrange_necessary(self):
        ...
        :return: The arrange_necessary of this ApiCommon.
        :rtype: int
        """
    ...
    def register_time(self):
        ...
        :return: The register_time of this ApiCommon.
        :rtype: datetime
        """
    ...
    def update_time(self):
        ...
        :return: The update_time of this ApiCommon.
        :rtype: datetime
        """
    ...
    def group_name(self):
        ...
        :return: The group_name of this ApiCommon.
        :rtype: str
        """
    ...
    def group_version(self):
        ...
        :return: The group_version of this ApiCommon.
        :rtype: str
        """
    ...
    def run_env_id(self):
        ...
        :return: The run_env_id of this ApiCommon.
        :rtype: str
        """
    ...
    def run_env_name(self):
        ...
        :return: The run_env_name of this ApiCommon.
        :rtype: str
        """
    ...
    def publish_id(self):
        ...
        :return: The publish_id of this ApiCommon.
        :rtype: str
        """
    ...
    def publish_time(self):
        ...
        :return: The publish_time of this ApiCommon.
        :rtype: str
        """
    ...
    def roma_app_name(self):
        ...
        :return: The roma_app_name of this ApiCommon.
        :rtype: str
        """
    ...
    def ld_api_id(self):
        ...
        :return: The ld_api_id of this ApiCommon.
        :rtype: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApiCommon):
            return False
