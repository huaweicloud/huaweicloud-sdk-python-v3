...
class ListApiGroupsV2Response(SdkResponse):
    ...
    @property
    def size(self):
        r"""Gets the size of this ListApiGroupsV2Response.
    ...
    @size.setter
    def size(self, size):
        r"""Sets the size of this ListApiGroupsV2Response.
    ...
    @property
    def total(self):
        r"""Gets the total of this ListApiGroupsV2Response.
    ...
    def total(self, total):
        r"""Sets the total of this ListApiGroupsV2Response.
    ...
    @property
    def groups(self):
        r"""Gets the groups of this ListApiGroupsV2Response.
    ...
    def groups(self, groups):
        r"""Sets the groups of this ListApiGroupsV2Response.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListApiGroupsV2Response.to_dict() is deprecated and no longer maintained, "
