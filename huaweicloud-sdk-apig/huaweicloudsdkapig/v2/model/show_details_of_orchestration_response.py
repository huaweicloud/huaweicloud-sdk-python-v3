...
class ShowDetailsOfOrchestrationResponse(SdkResponse):
    ...
    def __init__(self, orchestration_name=None, orchestration_strategy=None, orchestration_mapped_param=None, is_preprocessing=None, orchestration_map=None, orchestration_id=None, orchestration_create_time=None, orchestration_update_time=None):
        r"""ShowDetailsOfOrchestrationResponse
    ...
    def orchestration_name(self):
        r"""Gets the orchestration_name of this ShowDetailsOfOrchestrationResponse.

        编排映射规则名称。  支持英文，数字，下划线，且只能以英文开头，3-64个字符，同一实例下不允许重名。

        :return: The orchestration_name of this ShowDetailsOfOrchestrationResponse.
        :rtype: str
        """
    ...
    def orchestration_name(self, orchestration_name):
        r"""Sets the orchestration_name of this ShowDetailsOfOrchestrationResponse.

        编排映射规则名称。  支持英文，数字，下划线，且只能以英文开头，3-64个字符，同一实例下不允许重名。

        :param orchestration_name: The orchestration_name of this ShowDetailsOfOrchestrationResponse.
        :type orchestration_name: str
        """
    ...
    def orchestration_strategy(self):
        r"""Gets the orchestration_strategy of this ShowDetailsOfOrchestrationResponse.
        ...
        :return: The orchestration_strategy of this ShowDetailsOfOrchestrationResponse.
        :rtype: str
        """
    ...
    def orchestration_strategy(self, orchestration_strategy):
        r"""Sets the orchestration_strategy of this ShowDetailsOfOrchestrationResponse.

        编排策略，有以下几种策略类型： - list：列表； - hash：哈希； - range：区间； - hash_range: 哈希+区间； - none_value: 空值映射； - default: 默认值映射； - head_n: 截取前n项； - tail_n: 截取后n项； 当编排策略为list时，orchestration_map列表长度*map_param_list长度不超过3000。

        :param orchestration_strategy: The orchestration_strategy of this ShowDetailsOfOrchestrationResponse.
        :type orchestration_strategy: str
        """
    ...
    def orchestration_mapped_param(self):
        r"""Gets the orchestration_mapped_param of this ShowDetailsOfOrchestrationResponse.

        :return: The orchestration_mapped_param of this ShowDetailsOfOrchestrationResponse.
    ...
    def orchestration_mapped_param(self, orchestration_mapped_param):
        r"""Sets the orchestration_mapped_param of this ShowDetailsOfOrchestrationResponse.

        :param orchestration_mapped_param: The orchestration_mapped_param of this ShowDetailsOfOrchestrationResponse.
        :type orchestration_mapped_param: :class:`huaweicloudsdkapig.v2.OrchestrationMappedParam`
        """
    ...
    def is_preprocessing(self):
        r"""Gets the is_preprocessing of this ShowDetailsOfOrchestrationResponse.

        是否为预处理策略，预处理策略只会生成临时参数作为后面参数编排规则的入参标记。当为预处理策略时，该编排规则不能作为除default之外的最后一个编排规则。

        :return: The is_preprocessing of this ShowDetailsOfOrchestrationResponse.
        :rtype: bool
        """
    ...
    def is_preprocessing(self, is_preprocessing):
        r"""Sets the is_preprocessing of this ShowDetailsOfOrchestrationResponse.

        是否为预处理策略，预处理策略只会生成临时参数作为后面参数编排规则的入参标记。当为预处理策略时，该编排规则不能作为除default之外的最后一个编排规则。

        :param is_preprocessing: The is_preprocessing of this ShowDetailsOfOrchestrationResponse.
        :type is_preprocessing: bool
        """
    ...
    def orchestration_map(self):
        r"""Gets the orchestration_map of this ShowDetailsOfOrchestrationResponse.
        ...
        :return: The orchestration_map of this ShowDetailsOfOrchestrationResponse.
    ...
    def orchestration_map(self, orchestration_map):
        r"""Sets the orchestration_map of this ShowDetailsOfOrchestrationResponse.

        编排映射规则列表，列表长度范围为1-300。 编排映射规则的生效优先级与列表顺序保持一致，列表中靠前的配置匹配优先级较高。 映射规则不能重复，当orchestration_strategy=list时，map_param_list的列表也不能包含重复元素。

        :param orchestration_map: The orchestration_map of this ShowDetailsOfOrchestrationResponse.
        :type orchestration_map: list[:class:`huaweicloudsdkapig.v2.OrchestrationMap`]
        """
    ...
    def orchestration_id(self):
        r"""Gets the orchestration_id of this ShowDetailsOfOrchestrationResponse.

        编排规则编号。

        :return: The orchestration_id of this ShowDetailsOfOrchestrationResponse.
        :rtype: str
        """
    ...
    def orchestration_id(self, orchestration_id):
        r"""Sets the orchestration_id of this ShowDetailsOfOrchestrationResponse.

        编排规则编号。

        :param orchestration_id: The orchestration_id of this ShowDetailsOfOrchestrationResponse.
        :type orchestration_id: str
        """
    ...
    def orchestration_create_time(self):
        r"""Gets the orchestration_create_time of this ShowDetailsOfOrchestrationResponse.

        编排规则创建时间。

        :return: The orchestration_create_time of this ShowDetailsOfOrchestrationResponse.
        :rtype: datetime
        """
    ...
    def orchestration_create_time(self, orchestration_create_time):
        r"""Sets the orchestration_create_time of this ShowDetailsOfOrchestrationResponse.

        编排规则创建时间。

        :param orchestration_create_time: The orchestration_create_time of this ShowDetailsOfOrchestrationResponse.
        :type orchestration_create_time: datetime
        """
    ...
    def orchestration_update_time(self):
        r"""Gets the orchestration_update_time of this ShowDetailsOfOrchestrationResponse.

        编排规则更新时间。

        :return: The orchestration_update_time of this ShowDetailsOfOrchestrationResponse.
        :rtype: datetime
        """
    ...
    def orchestration_update_time(self, orchestration_update_time):
        r"""Sets the orchestration_update_time of this ShowDetailsOfOrchestrationResponse.

        编排规则更新时间。

        :param orchestration_update_time: The orchestration_update_time of this ShowDetailsOfOrchestrationResponse.
        :type orchestration_update_time: datetime
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowDetailsOfOrchestrationResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowDetailsOfOrchestrationResponse):
            return False
