...
class CreateGatewayResponseV2Response(SdkResponse):
    ...
    def __init__(self, name=None, responses=None, id=None, default=None, create_time=None, update_time=None):
        r"""CreateGatewayResponseV2Response
    ...
    @property
    def name(self):
        r"""Gets the name of this CreateGatewayResponseV2Response.

        响应名称

        :return: The name of this CreateGatewayResponseV2Response.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this CreateGatewayResponseV2Response.

        响应名称

        :param name: The name of this CreateGatewayResponseV2Response.
        :type name: str
        """
        self._name = name
    ...
    @property
    def responses(self):
        r"""Gets the responses of this CreateGatewayResponseV2Response.
    ...
    def responses(self, responses):
        r"""Sets the responses of this CreateGatewayResponseV2Response.
    ...
    @property
    def id(self):
        r"""Gets the id of this CreateGatewayResponseV2Response.

        响应ID

        :return: The id of this CreateGatewayResponseV2Response.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this CreateGatewayResponseV2Response.

        响应ID

        :param id: The id of this CreateGatewayResponseV2Response.
        :type id: str
        """
        self._id = id
    ...
    @property
    def default(self):
        r"""Gets the default of this CreateGatewayResponseV2Response.

        是否为分组默认响应

        :return: The default of this CreateGatewayResponseV2Response.
        :rtype: bool
        """
    ...
    def default(self, default):
        r"""Sets the default of this CreateGatewayResponseV2Response.

        是否为分组默认响应

        :param default: The default of this CreateGatewayResponseV2Response.
        :type default: bool
        """
    ...
    def create_time(self):
        r"""Gets the create_time of this CreateGatewayResponseV2Response.

        创建时间

        :return: The create_time of this CreateGatewayResponseV2Response.
        :rtype: datetime
        """
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this CreateGatewayResponseV2Response.

        创建时间

        :param create_time: The create_time of this CreateGatewayResponseV2Response.
        :type create_time: datetime
        """
    ...
    def update_time(self):
        r"""Gets the update_time of this CreateGatewayResponseV2Response.

        修改时间

        :return: The update_time of this CreateGatewayResponseV2Response.
        :rtype: datetime
        """
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this CreateGatewayResponseV2Response.

        修改时间

        :param update_time: The update_time of this CreateGatewayResponseV2Response.
        :type update_time: datetime
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateGatewayResponseV2Response.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateGatewayResponseV2Response):
            return False
