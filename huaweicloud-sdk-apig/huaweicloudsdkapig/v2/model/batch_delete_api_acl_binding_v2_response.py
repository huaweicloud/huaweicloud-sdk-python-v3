...
class BatchDeleteApiAclBindingV2Response(SdkResponse):
    ...
    def __init__(self, success_count=None, failure=None):
        ...
        :type failure: list[:class:`huaweicloudsdkapig.v2.AclBindingBatchFailure`]
        """
    ...
    def failure(self):
        ...
        :rtype: list[:class:`huaweicloudsdkapig.v2.AclBindingBatchFailure`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchDeleteApiAclBindingV2Response.to_dict() is deprecated and no longer maintained, "
