...
class UpdateGatewayResponseTypeV2Response(SdkResponse):
    ...
    def __init__(self, body=None):
        r"""UpdateGatewayResponseTypeV2Response
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateGatewayResponseTypeV2Response.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateGatewayResponseTypeV2Response):
            return False
