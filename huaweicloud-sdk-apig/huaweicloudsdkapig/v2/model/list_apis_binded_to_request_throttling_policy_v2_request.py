...
class ListApisBindedToRequestThrottlingPolicyV2Request:
    ...
    @property
    def tags(self):
        """Gets the tags of this ListApisBindedToRequestThrottlingPolicyV2Request.

        API标签，该参数可指定多个，多个不同的参数值为或关系；不指定或为空时，表示不筛选标签；指定为#no_tags#时，表示筛选无标签API。

        :return: The tags of this ListApisBindedToRequestThrottlingPolicyV2Request.
        :rtype: str
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this ListApisBindedToRequestThrottlingPolicyV2Request.

        API标签，该参数可指定多个，多个不同的参数值为或关系；不指定或为空时，表示不筛选标签；指定为#no_tags#时，表示筛选无标签API。

        :param tags: The tags of this ListApisBindedToRequestThrottlingPolicyV2Request.
        :type tags: str
        """
        self._tags = tags
