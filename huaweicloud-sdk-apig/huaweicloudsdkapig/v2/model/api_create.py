...
class ApiCreate:
    ...
    def __init__(self, name=None, type=None, version=None, req_protocol=None, req_method=None, req_uri=None, auth_type=None, auth_opt=None, cors=None, trace_enabled=None, sampling_strategy=None, sampling_param=None, match_mode=None, backend_type=None, remark=None, group_id=None, body_remark=None, result_normal_sample=None, result_failure_sample=None, authorizer_id=None, tags=None, response_id=None, roma_app_id=None, domain_name=None, tag=None, content_type=None, is_send_fg_body_base64=None, mock_info=None, func_info=None, req_params=None, backend_params=None, policy_mocks=None, policy_functions=None, backend_api=None, policy_https=None):
        r"""ApiCreate
    ...
    def trace_enabled(self):
        r"""Gets the trace_enabled of this ApiCreate.

        是否开启链路追踪，默认关闭。

        :return: The trace_enabled of this ApiCreate.
        :rtype: bool
        """
    ...
    def trace_enabled(self, trace_enabled):
        r"""Sets the trace_enabled of this ApiCreate.

        是否开启链路追踪，默认关闭。

        :param trace_enabled: The trace_enabled of this ApiCreate.
        :type trace_enabled: bool
        """
    ...
    def sampling_strategy(self):
        r"""Gets the sampling_strategy of this ApiCreate.

        采样策略，当选择开启链路追踪时，此字段必填。 - RATE：按比例采样 

        :return: The sampling_strategy of this ApiCreate.
        :rtype: str
        """
    ...
    def sampling_strategy(self, sampling_strategy):
        r"""Sets the sampling_strategy of this ApiCreate.

        采样策略，当选择开启链路追踪时，此字段必填。 - RATE：按比例采样 

        :param sampling_strategy: The sampling_strategy of this ApiCreate.
        :type sampling_strategy: str
        """
    ...
    def sampling_param(self):
        r"""Gets the sampling_param of this ApiCreate.

        采样参数。 - 当采样策略为RATE时，此字段取值为字符串化的整数，范围为0-100，缺省为'100'，'100'为采集每个请求，建议与后端应用的采样率保持一致。 

        :return: The sampling_param of this ApiCreate.
        :rtype: str
        """
    ...
    def sampling_param(self, sampling_param):
        r"""Sets the sampling_param of this ApiCreate.

        采样参数。 - 当采样策略为RATE时，此字段取值为字符串化的整数，范围为0-100，缺省为'100'，'100'为采集每个请求，建议与后端应用的采样率保持一致。 

        :param sampling_param: The sampling_param of this ApiCreate.
        :type sampling_param: str
        """
    ...
    def is_send_fg_body_base64(self):
        r"""Gets the is_send_fg_body_base64 of this ApiCreate.
        ...
        :return: The is_send_fg_body_base64 of this ApiCreate.
        :rtype: bool
        """
    ...
    def is_send_fg_body_base64(self, is_send_fg_body_base64):
        r"""Sets the is_send_fg_body_base64 of this ApiCreate.

        是否对与FunctionGraph交互场景的body进行Base64编码。仅当content_type为application/json时，可以不对body进行Base64编码。 应用场景： - 自定义认证 - 绑定断路器插件，且断路器后端降级策略为函数后端 - API后端类型为函数工作流

        :param is_send_fg_body_base64: The is_send_fg_body_base64 of this ApiCreate.
        :type is_send_fg_body_base64: bool
        """
