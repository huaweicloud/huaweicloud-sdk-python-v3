...
class ListAppsBindedToApiV2Response(SdkResponse):
    ...
    def __init__(self, total=None, size=None, auths=None):
        """ListAppsBindedToApiV2Response - a model defined in huaweicloud sdk"""
    ...
    @property
    def total(self):
        """Gets the total of this ListAppsBindedToApiV2Response.
    ...
    def total(self, total):
        """Sets the total of this ListAppsBindedToApiV2Response.
    ...
    @property
    def size(self):
        """Gets the size of this ListAppsBindedToApiV2Response.
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this ListAppsBindedToApiV2Response.
    ...
    @property
    def auths(self):
        """Gets the auths of this ListAppsBindedToApiV2Response.
    ...
    def auths(self, auths):
        """Sets the auths of this ListAppsBindedToApiV2Response.
