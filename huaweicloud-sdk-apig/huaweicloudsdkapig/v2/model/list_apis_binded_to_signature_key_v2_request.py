...
class ListApisBindedToSignatureKeyV2Request:
    ...
    @property
    def tags(self):
        r"""Gets the tags of this ListApisBindedToSignatureKeyV2Request.

        API标签，该参数可指定多个，多个不同的参数值为或关系；不指定或为空时，表示不筛选标签；指定为#no_tags#时，表示筛选无标签API。

        :return: The tags of this ListApisBindedToSignatureKeyV2Request.
        :rtype: str
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this ListApisBindedToSignatureKeyV2Request.

        API标签，该参数可指定多个，多个不同的参数值为或关系；不指定或为空时，表示不筛选标签；指定为#no_tags#时，表示筛选无标签API。

        :param tags: The tags of this ListApisBindedToSignatureKeyV2Request.
        :type tags: str
        """
        self._tags = tags
