...
class ResponsesCreate:
    ...
    @property
    def name(self):
        r"""Gets the name of this ResponsesCreate.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this ResponsesCreate.
    ...
    @property
    def responses(self):
        r"""Gets the responses of this ResponsesCreate.
    ...
    def responses(self, responses):
        r"""Sets the responses of this ResponsesCreate.
