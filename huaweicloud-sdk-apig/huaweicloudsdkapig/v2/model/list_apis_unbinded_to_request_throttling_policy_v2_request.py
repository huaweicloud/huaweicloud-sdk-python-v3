...
class ListApisUnbindedToRequestThrottlingPolicyV2Request:
    ...
    def __init__(self, instance_id=None, offset=None, limit=None, throttle_id=None, env_id=None, group_id=None, api_id=None, api_name=None, tags=None):
        r"""ListApisUnbindedToRequestThrottlingPolicyV2Request
    ...
    def instance_id(self):
        r"""Gets the instance_id of this ListApisUnbindedToRequestThrottlingPolicyV2Request.
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this ListApisUnbindedToRequestThrottlingPolicyV2Request.
    ...
    @property
    def offset(self):
        r"""Gets the offset of this ListApisUnbindedToRequestThrottlingPolicyV2Request.
    ...
    def offset(self, offset):
        r"""Sets the offset of this ListApisUnbindedToRequestThrottlingPolicyV2Request.
    ...
    @property
    def limit(self):
        r"""Gets the limit of this ListApisUnbindedToRequestThrottlingPolicyV2Request.
    ...
    def limit(self, limit):
        r"""Sets the limit of this ListApisUnbindedToRequestThrottlingPolicyV2Request.
    ...
    def throttle_id(self):
        r"""Gets the throttle_id of this ListApisUnbindedToRequestThrottlingPolicyV2Request.
    ...
    def throttle_id(self, throttle_id):
        r"""Sets the throttle_id of this ListApisUnbindedToRequestThrottlingPolicyV2Request.
    ...
    @property
    def env_id(self):
        r"""Gets the env_id of this ListApisUnbindedToRequestThrottlingPolicyV2Request.
    ...
    def env_id(self, env_id):
        r"""Sets the env_id of this ListApisUnbindedToRequestThrottlingPolicyV2Request.
    ...
    @property
    def group_id(self):
        r"""Gets the group_id of this ListApisUnbindedToRequestThrottlingPolicyV2Request.
    ...
    def group_id(self, group_id):
        r"""Sets the group_id of this ListApisUnbindedToRequestThrottlingPolicyV2Request.
    ...
    @property
    def api_id(self):
        r"""Gets the api_id of this ListApisUnbindedToRequestThrottlingPolicyV2Request.
    ...
    def api_id(self, api_id):
        r"""Sets the api_id of this ListApisUnbindedToRequestThrottlingPolicyV2Request.
    ...
    @property
    def api_name(self):
        r"""Gets the api_name of this ListApisUnbindedToRequestThrottlingPolicyV2Request.
    ...
    def api_name(self, api_name):
        r"""Sets the api_name of this ListApisUnbindedToRequestThrottlingPolicyV2Request.
    ...
    @property
    def tags(self):
        r"""Gets the tags of this ListApisUnbindedToRequestThrottlingPolicyV2Request.

        API标签，该参数可指定多个，多个不同的参数值为或关系；不指定或为空时，表示不筛选标签；指定为#no_tags#时，表示筛选无标签API。

        :return: The tags of this ListApisUnbindedToRequestThrottlingPolicyV2Request.
        :rtype: str
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this ListApisUnbindedToRequestThrottlingPolicyV2Request.

        API标签，该参数可指定多个，多个不同的参数值为或关系；不指定或为空时，表示不筛选标签；指定为#no_tags#时，表示筛选无标签API。

        :param tags: The tags of this ListApisUnbindedToRequestThrottlingPolicyV2Request.
        :type tags: str
        """
        self._tags = tags
