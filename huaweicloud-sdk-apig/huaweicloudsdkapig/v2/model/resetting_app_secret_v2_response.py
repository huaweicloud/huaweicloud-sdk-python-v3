...
class ResettingAppSecretV2Response(SdkResponse):
    ...
    def __init__(self, id=None, name=None, remark=None, creator=None, update_time=None, app_key=None, related_domain_id=None, related_project_id=None, app_secret=None, register_time=None, status=None, app_type=None, roma_app_type=None):
        r"""ResettingAppSecretV2Response
    ...
    @property
    def id(self):
        r"""Gets the id of this ResettingAppSecretV2Response.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this ResettingAppSecretV2Response.
    ...
    @property
    def name(self):
        r"""Gets the name of this ResettingAppSecretV2Response.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this ResettingAppSecretV2Response.
    ...
    @property
    def remark(self):
        r"""Gets the remark of this ResettingAppSecretV2Response.
    ...
    def remark(self, remark):
        r"""Sets the remark of this ResettingAppSecretV2Response.
    ...
    @property
    def creator(self):
        r"""Gets the creator of this ResettingAppSecretV2Response.
    ...
    def creator(self, creator):
        r"""Sets the creator of this ResettingAppSecretV2Response.
    ...
    def update_time(self):
        r"""Gets the update_time of this ResettingAppSecretV2Response.

        更新时间

        :return: The update_time of this ResettingAppSecretV2Response.
        :rtype: datetime
        """
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this ResettingAppSecretV2Response.

        更新时间

        :param update_time: The update_time of this ResettingAppSecretV2Response.
        :type update_time: datetime
        """
    ...
    @property
    def app_key(self):
        r"""Gets the app_key of this ResettingAppSecretV2Response.

        APP凭据的key。

        :return: The app_key of this ResettingAppSecretV2Response.
        :rtype: str
        """
    ...
    def app_key(self, app_key):
        r"""Sets the app_key of this ResettingAppSecretV2Response.

        APP凭据的key。

        :param app_key: The app_key of this ResettingAppSecretV2Response.
        :type app_key: str
        """
    ...
    def related_domain_id(self):
        r"""Gets the related_domain_id of this ResettingAppSecretV2Response.

        凭据关联的账号ID。

        :return: The related_domain_id of this ResettingAppSecretV2Response.
        :rtype: str
        """
    ...
    def related_domain_id(self, related_domain_id):
        r"""Sets the related_domain_id of this ResettingAppSecretV2Response.

        凭据关联的账号ID。

        :param related_domain_id: The related_domain_id of this ResettingAppSecretV2Response.
        :type related_domain_id: str
        """
    ...
    def related_project_id(self):
        r"""Gets the related_project_id of this ResettingAppSecretV2Response.

        凭据关联的项目ID。

        :return: The related_project_id of this ResettingAppSecretV2Response.
        :rtype: str
        """
    ...
    def related_project_id(self, related_project_id):
        r"""Sets the related_project_id of this ResettingAppSecretV2Response.

        凭据关联的项目ID。

        :param related_project_id: The related_project_id of this ResettingAppSecretV2Response.
        :type related_project_id: str
        """
    ...
    @property
    def app_secret(self):
        r"""Gets the app_secret of this ResettingAppSecretV2Response.

        密钥

        :return: The app_secret of this ResettingAppSecretV2Response.
        :rtype: str
        """
    ...
    def app_secret(self, app_secret):
        r"""Sets the app_secret of this ResettingAppSecretV2Response.

        密钥

        :param app_secret: The app_secret of this ResettingAppSecretV2Response.
        :type app_secret: str
        """
    ...
    def register_time(self):
        r"""Gets the register_time of this ResettingAppSecretV2Response.

        注册时间

        :return: The register_time of this ResettingAppSecretV2Response.
        :rtype: datetime
        """
    ...
    def register_time(self, register_time):
        r"""Sets the register_time of this ResettingAppSecretV2Response.

        注册时间

        :param register_time: The register_time of this ResettingAppSecretV2Response.
        :type register_time: datetime
        """
    ...
    @property
    def status(self):
        r"""Gets the status of this ResettingAppSecretV2Response.
    ...
    def status(self, status):
        r"""Sets the status of this ResettingAppSecretV2Response.
    ...
    @property
    def app_type(self):
        r"""Gets the app_type of this ResettingAppSecretV2Response.
    ...
    def app_type(self, app_type):
        r"""Sets the app_type of this ResettingAppSecretV2Response.
    ...
    def roma_app_type(self):
        r"""Gets the roma_app_type of this ResettingAppSecretV2Response.
    ...
    def roma_app_type(self, roma_app_type):
        r"""Sets the roma_app_type of this ResettingAppSecretV2Response.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ResettingAppSecretV2Response.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResettingAppSecretV2Response):
            return False
