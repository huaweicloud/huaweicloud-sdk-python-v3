...
class ShowDetailsOfGatewayResponseTypeV2Request:
    ...
    def __init__(self, instance_id=None, group_id=None, response_id=None, response_type=None):
        r"""ShowDetailsOfGatewayResponseTypeV2Request
    ...
    def instance_id(self):
        r"""Gets the instance_id of this ShowDetailsOfGatewayResponseTypeV2Request.

        实例ID，在API网关控制台的“实例信息”中获取。

        :return: The instance_id of this ShowDetailsOfGatewayResponseTypeV2Request.
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        r"""Sets the instance_id of this ShowDetailsOfGatewayResponseTypeV2Request.
    ...
    @property
    def group_id(self):
        r"""Gets the group_id of this ShowDetailsOfGatewayResponseTypeV2Request.

        分组的编号

        :return: The group_id of this ShowDetailsOfGatewayResponseTypeV2Request.
        :rtype: str
        """
    ...
    def group_id(self, group_id):
        r"""Sets the group_id of this ShowDetailsOfGatewayResponseTypeV2Request.
    ...
    def response_id(self):
        r"""Gets the response_id of this ShowDetailsOfGatewayResponseTypeV2Request.

        响应编号

        :return: The response_id of this ShowDetailsOfGatewayResponseTypeV2Request.
        :rtype: str
        """
    ...
    def response_id(self, response_id):
        r"""Sets the response_id of this ShowDetailsOfGatewayResponseTypeV2Request.
    ...
    def response_type(self):
        r"""Gets the response_type of this ShowDetailsOfGatewayResponseTypeV2Request.
    ...
    def response_type(self, response_type):
        r"""Sets the response_type of this ShowDetailsOfGatewayResponseTypeV2Request.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowDetailsOfGatewayResponseTypeV2Request):
            return False
