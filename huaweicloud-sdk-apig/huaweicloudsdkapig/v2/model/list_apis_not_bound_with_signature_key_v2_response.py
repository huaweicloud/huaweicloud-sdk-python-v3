...
class ListApisNotBoundWithSignatureKeyV2Response(SdkResponse):
    ...
    def __init__(self, size=None, total=None, apis=None):
        r"""ListApisNotBoundWithSignatureKeyV2Response
        ...
        :type apis: list[:class:`huaweicloudsdkapig.v2.ApiForSign`]
        """
    ...
    @property
    def size(self):
        r"""Gets the size of this ListApisNotBoundWithSignatureKeyV2Response.
    ...
    @size.setter
    def size(self, size):
        r"""Sets the size of this ListApisNotBoundWithSignatureKeyV2Response.
    ...
    @property
    def total(self):
        r"""Gets the total of this ListApisNotBoundWithSignatureKeyV2Response.
    ...
    def total(self, total):
        r"""Sets the total of this ListApisNotBoundWithSignatureKeyV2Response.
    ...
    @property
    def apis(self):
        r"""Gets the apis of this ListApisNotBoundWithSignatureKeyV2Response.

        本次查询返回的API列表

        :return: The apis of this ListApisNotBoundWithSignatureKeyV2Response.
        :rtype: list[:class:`huaweicloudsdkapig.v2.ApiForSign`]
        """
        return self._apis

    @apis.setter
    def apis(self, apis):
        r"""Sets the apis of this ListApisNotBoundWithSignatureKeyV2Response.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListApisNotBoundWithSignatureKeyV2Response.to_dict() is deprecated and no longer maintained, "
