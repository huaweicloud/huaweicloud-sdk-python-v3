...
class ShowDetailsOfMemberGroupResponse(SdkResponse):
    ...
    def reference_vpc_channel_id(self):
        r"""Gets the reference_vpc_channel_id of this ShowDetailsOfMemberGroupResponse.

        引用的负载通道编号，仅VPC通道类型为引用类型（vpc_channel_type=reference）时支持。

        :return: The reference_vpc_channel_id of this ShowDetailsOfMemberGroupResponse.
        :rtype: str
        """
    ...
    def reference_vpc_channel_id(self, reference_vpc_channel_id):
        r"""Sets the reference_vpc_channel_id of this ShowDetailsOfMemberGroupResponse.

        引用的负载通道编号，仅VPC通道类型为引用类型（vpc_channel_type=reference）时支持。

        :param reference_vpc_channel_id: The reference_vpc_channel_id of this ShowDetailsOfMemberGroupResponse.
        :type reference_vpc_channel_id: str
        """
