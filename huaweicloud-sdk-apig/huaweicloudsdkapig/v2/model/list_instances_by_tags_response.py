...
class ListInstancesByTagsResponse(SdkResponse):
    ...
    openapi_types = {
        'resources': 'list[TmsResourceResp]',
        'total_count': 'int'
    }
    ...
    def __init__(self, resources=None, total_count=None):
        ...
        :param resources: 实例列表
        :type resources: list[:class:`huaweicloudsdkapig.v2.TmsResourceResp`]
    ...
    @property
    def resources(self):
        r"""Gets the resources of this ListInstancesByTagsResponse.

        实例列表

        :return: The resources of this ListInstancesByTagsResponse.
        :rtype: list[:class:`huaweicloudsdkapig.v2.TmsResourceResp`]
        """
        return self._resources

    @resources.setter
    def resources(self, resources):
        r"""Sets the resources of this ListInstancesByTagsResponse.

        实例列表

        :param resources: The resources of this ListInstancesByTagsResponse.
        :type resources: list[:class:`huaweicloudsdkapig.v2.TmsResourceResp`]
        """
