...
class CreateInstanceV2Request:
    ...
    def __init__(self, body=None):
        """CreateInstanceV2Request - a model defined in huaweicloud sdk"""
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateInstanceV2Request):
            return False
