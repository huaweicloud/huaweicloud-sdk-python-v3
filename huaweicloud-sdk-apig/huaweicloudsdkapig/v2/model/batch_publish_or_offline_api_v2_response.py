...
class BatchPublishOrOfflineApiV2Response(SdkResponse):
    ...
    def __init__(self, success=None, failure=None):
        ...
        :type success: list[:class:`huaweicloudsdkapig.v2.PublishResp`]
        :param failure: 发布或下线失败的API及错误信息
        :type failure: list[:class:`huaweicloudsdkapig.v2.BatchFailure`]
        """
    ...
    def success(self):
        ...
        :rtype: list[:class:`huaweicloudsdkapig.v2.PublishResp`]
        """
    ...
    def failure(self):
        ...
        :rtype: list[:class:`huaweicloudsdkapig.v2.BatchFailure`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("BatchPublishOrOfflineApiV2Response.to_dict() is deprecated and no longer maintained, "
