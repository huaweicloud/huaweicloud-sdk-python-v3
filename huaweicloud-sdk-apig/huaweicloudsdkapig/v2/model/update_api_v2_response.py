...
class UpdateApiV2Response(SdkResponse):
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this UpdateApiV2Response.

        API名称。  支持汉字、英文、数字、中划线、下划线、点、斜杠、中英文格式下的小括号和冒号、中文格式下的顿号，且只能以英文、汉字和数字开头，3-255个字符。 > 中文字符必须为UTF-8或者unicode编码。

        :param name: The name of this UpdateApiV2Response.
        :type name: str
        """
        self._name = name
    ...
    @property
    def type(self):
        r"""Gets the type of this UpdateApiV2Response.

        API类型 - 1：公有API - 2：私有API

        :return: The type of this UpdateApiV2Response.
        :rtype: int
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        r"""Sets the type of this UpdateApiV2Response.

        API类型 - 1：公有API - 2：私有API

        :param type: The type of this UpdateApiV2Response.
        :type type: int
        """
        self._type = type
    ...
    @property
    def version(self):
        r"""Gets the version of this UpdateApiV2Response.

        API的版本

        :return: The version of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def version(self, version):
        r"""Sets the version of this UpdateApiV2Response.

        API的版本

        :param version: The version of this UpdateApiV2Response.
        :type version: str
        """
    ...
    def req_protocol(self):
        r"""Gets the req_protocol of this UpdateApiV2Response.

        API的请求协议 - HTTP - HTTPS - BOTH：同时支持HTTP和HTTPS - GRPCS

        :return: The req_protocol of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def req_protocol(self, req_protocol):
        r"""Sets the req_protocol of this UpdateApiV2Response.

        API的请求协议 - HTTP - HTTPS - BOTH：同时支持HTTP和HTTPS - GRPCS

        :param req_protocol: The req_protocol of this UpdateApiV2Response.
        :type req_protocol: str
        """
    ...
    @property
    def req_method(self):
        r"""Gets the req_method of this UpdateApiV2Response.

        API的请求方式，当API的请求协议为GRPC类型协议时请求方式固定为POST。

        :return: The req_method of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def req_method(self, req_method):
        r"""Sets the req_method of this UpdateApiV2Response.

        API的请求方式，当API的请求协议为GRPC类型协议时请求方式固定为POST。

        :param req_method: The req_method of this UpdateApiV2Response.
        :type req_method: str
        """
    ...
    @property
    def req_uri(self):
        r"""Gets the req_uri of this UpdateApiV2Response.
    ...
    def req_uri(self, req_uri):
        r"""Sets the req_uri of this UpdateApiV2Response.
    ...
    @property
    def auth_type(self):
        r"""Gets the auth_type of this UpdateApiV2Response.
    ...
    def auth_type(self, auth_type):
        r"""Sets the auth_type of this UpdateApiV2Response.
    ...
    @property
    def auth_opt(self):
        r"""Gets the auth_opt of this UpdateApiV2Response.

        :return: The auth_opt of this UpdateApiV2Response.
    ...
    def auth_opt(self, auth_opt):
        r"""Sets the auth_opt of this UpdateApiV2Response.

        :param auth_opt: The auth_opt of this UpdateApiV2Response.
        :type auth_opt: :class:`huaweicloudsdkapig.v2.AuthOpt`
        """
    ...
    @property
    def cors(self):
        r"""Gets the cors of this UpdateApiV2Response.

        是否支持跨域 - TRUE：支持 - FALSE：不支持

        :return: The cors of this UpdateApiV2Response.
        :rtype: bool
        """
        return self._cors
    ...
    @cors.setter
    def cors(self, cors):
        r"""Sets the cors of this UpdateApiV2Response.

        是否支持跨域 - TRUE：支持 - FALSE：不支持

        :param cors: The cors of this UpdateApiV2Response.
        :type cors: bool
        """
        self._cors = cors
    ...
    def trace_enabled(self):
        r"""Gets the trace_enabled of this UpdateApiV2Response.

        是否开启链路追踪，默认关闭。

        :return: The trace_enabled of this UpdateApiV2Response.
        :rtype: bool
        """
    ...
    def trace_enabled(self, trace_enabled):
        r"""Sets the trace_enabled of this UpdateApiV2Response.

        是否开启链路追踪，默认关闭。

        :param trace_enabled: The trace_enabled of this UpdateApiV2Response.
        :type trace_enabled: bool
        """
    ...
    def sampling_strategy(self):
        r"""Gets the sampling_strategy of this UpdateApiV2Response.

        采样策略，当选择开启链路追踪时，此字段必填。 - RATE：按比例采样 

        :return: The sampling_strategy of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def sampling_strategy(self, sampling_strategy):
        r"""Sets the sampling_strategy of this UpdateApiV2Response.

        采样策略，当选择开启链路追踪时，此字段必填。 - RATE：按比例采样 

        :param sampling_strategy: The sampling_strategy of this UpdateApiV2Response.
        :type sampling_strategy: str
        """
    ...
    def sampling_param(self):
        r"""Gets the sampling_param of this UpdateApiV2Response.

        采样参数。 - 当采样策略为RATE时，此字段取值为字符串化的整数，范围为0-100，缺省为'100'，'100'为采集每个请求，建议与后端应用的采样率保持一致。 

        :return: The sampling_param of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def sampling_param(self, sampling_param):
        r"""Sets the sampling_param of this UpdateApiV2Response.

        采样参数。 - 当采样策略为RATE时，此字段取值为字符串化的整数，范围为0-100，缺省为'100'，'100'为采集每个请求，建议与后端应用的采样率保持一致。 

        :param sampling_param: The sampling_param of this UpdateApiV2Response.
        :type sampling_param: str
        """
    ...
    @property
    def match_mode(self):
        r"""Gets the match_mode of this UpdateApiV2Response.

        API的匹配方式 - SWA：前缀匹配 - NORMAL：正常匹配（绝对匹配） 默认：NORMAL

        :return: The match_mode of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def match_mode(self, match_mode):
        r"""Sets the match_mode of this UpdateApiV2Response.

        API的匹配方式 - SWA：前缀匹配 - NORMAL：正常匹配（绝对匹配） 默认：NORMAL

        :param match_mode: The match_mode of this UpdateApiV2Response.
        :type match_mode: str
        """
    ...
    def backend_type(self):
        r"""Gets the backend_type of this UpdateApiV2Response.
        ...
        :return: The backend_type of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def backend_type(self, backend_type):
        r"""Sets the backend_type of this UpdateApiV2Response.

        后端类型 - HTTP：web后端 - FUNCTION：函数工作流，当backend_type取值为FUNCTION时，func_info字段必须传入 - MOCK：模拟的后端，当backend_type取值为MOCK时，mock_info字段必须传入 - GRPC：grpc后端

        :param backend_type: The backend_type of this UpdateApiV2Response.
        :type backend_type: str
        """
    ...
    @property
    def remark(self):
        r"""Gets the remark of this UpdateApiV2Response.

        API描述。字符长度不超过255 > 中文字符必须为UTF-8或者unicode编码。

        :return: The remark of this UpdateApiV2Response.
        :rtype: str
        """
        return self._remark
    ...
    def remark(self, remark):
        r"""Sets the remark of this UpdateApiV2Response.

        API描述。字符长度不超过255 > 中文字符必须为UTF-8或者unicode编码。

        :param remark: The remark of this UpdateApiV2Response.
        :type remark: str
        """
        self._remark = remark
    ...
    @property
    def group_id(self):
        r"""Gets the group_id of this UpdateApiV2Response.

        API所属的分组编号

        :return: The group_id of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def group_id(self, group_id):
        r"""Sets the group_id of this UpdateApiV2Response.

        API所属的分组编号

        :param group_id: The group_id of this UpdateApiV2Response.
        :type group_id: str
        """
    ...
    def body_remark(self):
        r"""Gets the body_remark of this UpdateApiV2Response.

        API请求体描述，可以是请求体示例、媒体类型、参数等信息。字符长度不超过20480 > 中文字符必须为UTF-8或者unicode编码。

        :return: The body_remark of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def body_remark(self, body_remark):
        r"""Sets the body_remark of this UpdateApiV2Response.

        API请求体描述，可以是请求体示例、媒体类型、参数等信息。字符长度不超过20480 > 中文字符必须为UTF-8或者unicode编码。

        :param body_remark: The body_remark of this UpdateApiV2Response.
        :type body_remark: str
        """
    ...
    def result_normal_sample(self):
        r"""Gets the result_normal_sample of this UpdateApiV2Response.

        正常响应示例，描述API的正常返回信息。字符长度不超过20480 > 中文字符必须为UTF-8或者unicode编码。  当API的请求协议为GRPC类型时不支持配置。

        :return: The result_normal_sample of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def result_normal_sample(self, result_normal_sample):
        r"""Sets the result_normal_sample of this UpdateApiV2Response.

        正常响应示例，描述API的正常返回信息。字符长度不超过20480 > 中文字符必须为UTF-8或者unicode编码。  当API的请求协议为GRPC类型时不支持配置。

        :param result_normal_sample: The result_normal_sample of this UpdateApiV2Response.
        :type result_normal_sample: str
        """
    ...
    def result_failure_sample(self):
        r"""Gets the result_failure_sample of this UpdateApiV2Response.

        失败返回示例，描述API的异常返回信息。字符长度不超过20480 > 中文字符必须为UTF-8或者unicode编码。  当API的请求协议为GRPC类型时不支持配置。

        :return: The result_failure_sample of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def result_failure_sample(self, result_failure_sample):
        r"""Sets the result_failure_sample of this UpdateApiV2Response.

        失败返回示例，描述API的异常返回信息。字符长度不超过20480 > 中文字符必须为UTF-8或者unicode编码。  当API的请求协议为GRPC类型时不支持配置。

        :param result_failure_sample: The result_failure_sample of this UpdateApiV2Response.
        :type result_failure_sample: str
        """
    ...
    def authorizer_id(self):
        r"""Gets the authorizer_id of this UpdateApiV2Response.

        前端自定义认证对象的ID

        :return: The authorizer_id of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def authorizer_id(self, authorizer_id):
        r"""Sets the authorizer_id of this UpdateApiV2Response.

        前端自定义认证对象的ID

        :param authorizer_id: The authorizer_id of this UpdateApiV2Response.
        :type authorizer_id: str
        """
    ...
    @property
    def tags(self):
        r"""Gets the tags of this UpdateApiV2Response.
    ...
    @tags.setter
    def tags(self, tags):
        r"""Sets the tags of this UpdateApiV2Response.
    ...
    def response_id(self):
        r"""Gets the response_id of this UpdateApiV2Response.

        分组自定义响应ID

        :return: The response_id of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def response_id(self, response_id):
        r"""Sets the response_id of this UpdateApiV2Response.

        分组自定义响应ID

        :param response_id: The response_id of this UpdateApiV2Response.
        :type response_id: str
        """
    ...
    def roma_app_id(self):
        r"""Gets the roma_app_id of this UpdateApiV2Response.

        集成应用ID  暂不支持

        :return: The roma_app_id of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def roma_app_id(self, roma_app_id):
        r"""Sets the roma_app_id of this UpdateApiV2Response.

        集成应用ID  暂不支持

        :param roma_app_id: The roma_app_id of this UpdateApiV2Response.
        :type roma_app_id: str
        """
    ...
    def domain_name(self):
        r"""Gets the domain_name of this UpdateApiV2Response.

        API绑定的自定义域名  暂不支持

        :return: The domain_name of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def domain_name(self, domain_name):
        r"""Sets the domain_name of this UpdateApiV2Response.

        API绑定的自定义域名  暂不支持

        :param domain_name: The domain_name of this UpdateApiV2Response.
        :type domain_name: str
        """
    ...
    @property
    def tag(self):
        r"""Gets the tag of this UpdateApiV2Response.

        标签  待废弃，优先使用tags字段

        :return: The tag of this UpdateApiV2Response.
        :rtype: str
        """
        return self._tag
    ...
    @tag.setter
    def tag(self, tag):
        r"""Sets the tag of this UpdateApiV2Response.

        标签  待废弃，优先使用tags字段

        :param tag: The tag of this UpdateApiV2Response.
        :type tag: str
        """
        self._tag = tag
    ...
    def content_type(self):
        r"""Gets the content_type of this UpdateApiV2Response.

        请求内容格式类型：  application/json application/xml multipart/form-data text/plain

        :return: The content_type of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def content_type(self, content_type):
        r"""Sets the content_type of this UpdateApiV2Response.

        请求内容格式类型：  application/json application/xml multipart/form-data text/plain

        :param content_type: The content_type of this UpdateApiV2Response.
        :type content_type: str
        """
    ...
    def is_send_fg_body_base64(self):
        r"""Gets the is_send_fg_body_base64 of this UpdateApiV2Response.
        ...
        :return: The is_send_fg_body_base64 of this UpdateApiV2Response.
        :rtype: bool
        """
    ...
    def is_send_fg_body_base64(self, is_send_fg_body_base64):
        r"""Sets the is_send_fg_body_base64 of this UpdateApiV2Response.

        是否对与FunctionGraph交互场景的body进行Base64编码。仅当content_type为application/json时，可以不对body进行Base64编码。 应用场景： - 自定义认证 - 绑定断路器插件，且断路器后端降级策略为函数后端 - API后端类型为函数工作流

        :param is_send_fg_body_base64: The is_send_fg_body_base64 of this UpdateApiV2Response.
        :type is_send_fg_body_base64: bool
        """
    ...
    @property
    def id(self):
        r"""Gets the id of this UpdateApiV2Response.

        API编号

        :return: The id of this UpdateApiV2Response.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this UpdateApiV2Response.

        API编号

        :param id: The id of this UpdateApiV2Response.
        :type id: str
        """
        self._id = id
    ...
    @property
    def status(self):
        r"""Gets the status of this UpdateApiV2Response.

        API状态   - 1： 有效

        :return: The status of this UpdateApiV2Response.
        :rtype: int
        """
        return self._status
    ...
    def status(self, status):
        r"""Sets the status of this UpdateApiV2Response.

        API状态   - 1： 有效

        :param status: The status of this UpdateApiV2Response.
        :type status: int
        """
        self._status = status
    ...
    def arrange_necessary(self):
        r"""Gets the arrange_necessary of this UpdateApiV2Response.

        是否需要编排

        :return: The arrange_necessary of this UpdateApiV2Response.
        :rtype: int
        """
    ...
    def arrange_necessary(self, arrange_necessary):
        r"""Sets the arrange_necessary of this UpdateApiV2Response.

        是否需要编排

        :param arrange_necessary: The arrange_necessary of this UpdateApiV2Response.
        :type arrange_necessary: int
        """
    ...
    def register_time(self):
        r"""Gets the register_time of this UpdateApiV2Response.

        API注册时间

        :return: The register_time of this UpdateApiV2Response.
        :rtype: datetime
        """
    ...
    def register_time(self, register_time):
        r"""Sets the register_time of this UpdateApiV2Response.

        API注册时间

        :param register_time: The register_time of this UpdateApiV2Response.
        :type register_time: datetime
        """
    ...
    def update_time(self):
        r"""Gets the update_time of this UpdateApiV2Response.

        API修改时间

        :return: The update_time of this UpdateApiV2Response.
        :rtype: datetime
        """
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this UpdateApiV2Response.

        API修改时间

        :param update_time: The update_time of this UpdateApiV2Response.
        :type update_time: datetime
        """
    ...
    @property
    def group_name(self):
        r"""Gets the group_name of this UpdateApiV2Response.

        API所属分组的名称

        :return: The group_name of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def group_name(self, group_name):
        r"""Sets the group_name of this UpdateApiV2Response.

        API所属分组的名称

        :param group_name: The group_name of this UpdateApiV2Response.
        :type group_name: str
        """
    ...
    def group_version(self):
        r"""Gets the group_version of this UpdateApiV2Response.

        API所属分组的版本  默认V1，其他版本暂不支持

        :return: The group_version of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def group_version(self, group_version):
        r"""Sets the group_version of this UpdateApiV2Response.

        API所属分组的版本  默认V1，其他版本暂不支持

        :param group_version: The group_version of this UpdateApiV2Response.
        :type group_version: str
        """
    ...
    @property
    def run_env_id(self):
        r"""Gets the run_env_id of this UpdateApiV2Response.

        发布的环境编号  存在多个发布记录时，环境编号之间用|隔开

        :return: The run_env_id of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def run_env_id(self, run_env_id):
        r"""Sets the run_env_id of this UpdateApiV2Response.

        发布的环境编号  存在多个发布记录时，环境编号之间用|隔开

        :param run_env_id: The run_env_id of this UpdateApiV2Response.
        :type run_env_id: str
        """
    ...
    def run_env_name(self):
        r"""Gets the run_env_name of this UpdateApiV2Response.

        发布的环境名称  存在多个发布记录时，环境名称之间用|隔开

        :return: The run_env_name of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def run_env_name(self, run_env_name):
        r"""Sets the run_env_name of this UpdateApiV2Response.

        发布的环境名称  存在多个发布记录时，环境名称之间用|隔开

        :param run_env_name: The run_env_name of this UpdateApiV2Response.
        :type run_env_name: str
        """
    ...
    @property
    def publish_id(self):
        r"""Gets the publish_id of this UpdateApiV2Response.

        发布记录编号  存在多个发布记录时，发布记录编号之间用|隔开

        :return: The publish_id of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def publish_id(self, publish_id):
        r"""Sets the publish_id of this UpdateApiV2Response.

        发布记录编号  存在多个发布记录时，发布记录编号之间用|隔开

        :param publish_id: The publish_id of this UpdateApiV2Response.
        :type publish_id: str
        """
    ...
    def publish_time(self):
        r"""Gets the publish_time of this UpdateApiV2Response.

        发布时间  存在多个发布记录时，发布时间之间用|隔开

        :return: The publish_time of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def publish_time(self, publish_time):
        r"""Sets the publish_time of this UpdateApiV2Response.

        发布时间  存在多个发布记录时，发布时间之间用|隔开

        :param publish_time: The publish_time of this UpdateApiV2Response.
        :type publish_time: str
        """
    ...
    def roma_app_name(self):
        r"""Gets the roma_app_name of this UpdateApiV2Response.

        API归属的集成应用名称  暂不支持

        :return: The roma_app_name of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def roma_app_name(self, roma_app_name):
        r"""Sets the roma_app_name of this UpdateApiV2Response.

        API归属的集成应用名称  暂不支持

        :param roma_app_name: The roma_app_name of this UpdateApiV2Response.
        :type roma_app_name: str
        """
    ...
    @property
    def ld_api_id(self):
        r"""Gets the ld_api_id of this UpdateApiV2Response.

        当API的后端为自定义后端时，对应的自定义后端API编号  暂不支持

        :return: The ld_api_id of this UpdateApiV2Response.
        :rtype: str
        """
    ...
    def ld_api_id(self, ld_api_id):
        r"""Sets the ld_api_id of this UpdateApiV2Response.

        当API的后端为自定义后端时，对应的自定义后端API编号  暂不支持

        :param ld_api_id: The ld_api_id of this UpdateApiV2Response.
        :type ld_api_id: str
        """
    ...
    def backend_api(self):
        r"""Gets the backend_api of this UpdateApiV2Response.

        :return: The backend_api of this UpdateApiV2Response.
    ...
    def backend_api(self, backend_api):
        r"""Sets the backend_api of this UpdateApiV2Response.

        :param backend_api: The backend_api of this UpdateApiV2Response.
        :type backend_api: :class:`huaweicloudsdkapig.v2.BackendApi`
        """
    ...
    def api_group_info(self):
        r"""Gets the api_group_info of this UpdateApiV2Response.

        :return: The api_group_info of this UpdateApiV2Response.
    ...
    def api_group_info(self, api_group_info):
        r"""Sets the api_group_info of this UpdateApiV2Response.

        :param api_group_info: The api_group_info of this UpdateApiV2Response.
        :type api_group_info: :class:`huaweicloudsdkapig.v2.ApiGroupCommonInfo`
        """
    ...
    @property
    def func_info(self):
        r"""Gets the func_info of this UpdateApiV2Response.

        :return: The func_info of this UpdateApiV2Response.
    ...
    def func_info(self, func_info):
        r"""Sets the func_info of this UpdateApiV2Response.

        :param func_info: The func_info of this UpdateApiV2Response.
        :type func_info: :class:`huaweicloudsdkapig.v2.ApiFunc`
        """
    ...
    @property
    def mock_info(self):
        r"""Gets the mock_info of this UpdateApiV2Response.

        :return: The mock_info of this UpdateApiV2Response.
    ...
    def mock_info(self, mock_info):
        r"""Sets the mock_info of this UpdateApiV2Response.

        :param mock_info: The mock_info of this UpdateApiV2Response.
        :type mock_info: :class:`huaweicloudsdkapig.v2.ApiMock`
        """
    ...
    @property
    def req_params(self):
        r"""Gets the req_params of this UpdateApiV2Response.

        API的请求参数列表

        :return: The req_params of this UpdateApiV2Response.
    ...
    def req_params(self, req_params):
        r"""Sets the req_params of this UpdateApiV2Response.

        API的请求参数列表

        :param req_params: The req_params of this UpdateApiV2Response.
        :type req_params: list[:class:`huaweicloudsdkapig.v2.ReqParam`]
        """
    ...
    def backend_params(self):
        r"""Gets the backend_params of this UpdateApiV2Response.

        API的后端参数列表

        :return: The backend_params of this UpdateApiV2Response.
    ...
    def backend_params(self, backend_params):
        r"""Sets the backend_params of this UpdateApiV2Response.

        API的后端参数列表

        :param backend_params: The backend_params of this UpdateApiV2Response.
        :type backend_params: list[:class:`huaweicloudsdkapig.v2.BackendParam`]
        """
    ...
    def policy_functions(self):
        r"""Gets the policy_functions of this UpdateApiV2Response.

        函数工作流策略后端列表

        :return: The policy_functions of this UpdateApiV2Response.
    ...
    def policy_functions(self, policy_functions):
        r"""Sets the policy_functions of this UpdateApiV2Response.

        函数工作流策略后端列表

        :param policy_functions: The policy_functions of this UpdateApiV2Response.
        :type policy_functions: list[:class:`huaweicloudsdkapig.v2.ApiPolicyFunctionResp`]
        """
    ...
    def policy_mocks(self):
        r"""Gets the policy_mocks of this UpdateApiV2Response.

        mock策略后端列表

        :return: The policy_mocks of this UpdateApiV2Response.
    ...
    def policy_mocks(self, policy_mocks):
        r"""Sets the policy_mocks of this UpdateApiV2Response.

        mock策略后端列表

        :param policy_mocks: The policy_mocks of this UpdateApiV2Response.
        :type policy_mocks: list[:class:`huaweicloudsdkapig.v2.ApiPolicyMockResp`]
        """
    ...
    def policy_https(self):
        r"""Gets the policy_https of this UpdateApiV2Response.

        web策略后端列表

        :return: The policy_https of this UpdateApiV2Response.
    ...
    def policy_https(self, policy_https):
        r"""Sets the policy_https of this UpdateApiV2Response.

        web策略后端列表

        :param policy_https: The policy_https of this UpdateApiV2Response.
        :type policy_https: list[:class:`huaweicloudsdkapig.v2.ApiPolicyHttpResp`]
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateApiV2Response.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateApiV2Response):
            return False
