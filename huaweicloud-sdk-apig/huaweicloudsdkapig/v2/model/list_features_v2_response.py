...
class ListFeaturesV2Response(SdkResponse):
    ...
    @property
    def size(self):
        r"""Gets the size of this ListFeaturesV2Response.
    ...
    @size.setter
    def size(self, size):
        r"""Sets the size of this ListFeaturesV2Response.
    ...
    @property
    def total(self):
        r"""Gets the total of this ListFeaturesV2Response.
    ...
    def total(self, total):
        r"""Sets the total of this ListFeaturesV2Response.
    ...
    @property
    def features(self):
        r"""Gets the features of this ListFeaturesV2Response.
    ...
    def features(self, features):
        r"""Sets the features of this ListFeaturesV2Response.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListFeaturesV2Response.to_dict() is deprecated and no longer maintained, "
