...
class ShowDetailsOfAppV2Response(SdkResponse):
    ...
    def related_domain_id(self):
        r"""Gets the related_domain_id of this ShowDetailsOfAppV2Response.

        凭据关联的账号ID。

        :return: The related_domain_id of this ShowDetailsOfAppV2Response.
        :rtype: str
        """
    ...
    def related_domain_id(self, related_domain_id):
        r"""Sets the related_domain_id of this ShowDetailsOfAppV2Response.

        凭据关联的账号ID。

        :param related_domain_id: The related_domain_id of this ShowDetailsOfAppV2Response.
        :type related_domain_id: str
        """
    ...
    def related_project_id(self):
        r"""Gets the related_project_id of this ShowDetailsOfAppV2Response.

        凭据关联的项目ID。

        :return: The related_project_id of this ShowDetailsOfAppV2Response.
        :rtype: str
        """
    ...
    def related_project_id(self, related_project_id):
        r"""Sets the related_project_id of this ShowDetailsOfAppV2Response.

        凭据关联的项目ID。

        :param related_project_id: The related_project_id of this ShowDetailsOfAppV2Response.
        :type related_project_id: str
        """
