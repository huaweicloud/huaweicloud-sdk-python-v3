...
class CreateVpcChannelV2Response(SdkResponse):
    ...
    def __init__(self, name=None, type=None, port=None, balance_strategy=None, member_type=None, create_time=None, id=None, status=None, elb_id=None):
        """CreateVpcChannelV2Response - a model defined in huaweicloud sdk"""
    ...
    @property
    def elb_id(self):
        """Gets the elb_id of this CreateVpcChannelV2Response.

        私网ELB通道的编号。  仅当VPC通道类型为1时生效

        :return: The elb_id of this CreateVpcChannelV2Response.
        :rtype: str
        """
        return self._elb_id
    ...
    def elb_id(self, elb_id):
        """Sets the elb_id of this CreateVpcChannelV2Response.

        私网ELB通道的编号。  仅当VPC通道类型为1时生效

        :param elb_id: The elb_id of this CreateVpcChannelV2Response.
        :type: str
        """
        self._elb_id = elb_id
