...
class CreateVpcChannelV2Response(SdkResponse):
    ...
    def __init__(self, name=None, port=None, balance_strategy=None, member_type=None, type=None, vpc_channel_type=None, dict_code=None, create_time=None, id=None, status=None, member_groups=None, microservice_info=None):
        ...
        :param type: vpc通道类型，默认为服务器类型。 - 2：服务器类型 - 3：微服务类型  当vpc_channel_type字段为空时，负载通道类型由type字段控制： 当type不为3或microservice_info为空，VCP通道类型默认为服务器类型。 当type&#x3D;3，microservice_info不为空，VPC通道类型为微服务类型。  修改负载通道时vpc通道类型不会修改，直接使用原有的vpc通道类型。  请优先使用vpc_channel_type字段指定负载通道类型。
        :type type: int
    ...
    @property
    def name(self):
        r"""Gets the name of this CreateVpcChannelV2Response.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this CreateVpcChannelV2Response.
    ...
    @property
    def port(self):
        r"""Gets the port of this CreateVpcChannelV2Response.
    ...
    @port.setter
    def port(self, port):
        r"""Sets the port of this CreateVpcChannelV2Response.
    ...
    def balance_strategy(self):
        r"""Gets the balance_strategy of this CreateVpcChannelV2Response.
    ...
    def balance_strategy(self, balance_strategy):
        r"""Sets the balance_strategy of this CreateVpcChannelV2Response.
    ...
    def member_type(self):
        r"""Gets the member_type of this CreateVpcChannelV2Response.
    ...
    def member_type(self, member_type):
        r"""Sets the member_type of this CreateVpcChannelV2Response.
    ...
    @property
    def type(self):
        r"""Gets the type of this CreateVpcChannelV2Response.
    ...
    @type.setter
    def type(self, type):
        r"""Sets the type of this CreateVpcChannelV2Response.
    ...
    def vpc_channel_type(self):
        r"""Gets the vpc_channel_type of this CreateVpcChannelV2Response.
        ...
        :return: The vpc_channel_type of this CreateVpcChannelV2Response.
        :rtype: str
        """
    ...
    def vpc_channel_type(self, vpc_channel_type):
        r"""Sets the vpc_channel_type of this CreateVpcChannelV2Response.

        vpc通道类型。 - builtin：服务器类型 - microservice： 微服务类型 - reference：引用负载通道类型  当vpc_channel_type为空时，负载通道类型取决于type字段的取值。 当vpc_channel_type不为空，但type字段非空或不为0时，当vpc_channel_type的指定类型与type字段指定的类型冲突时会校验报错。 当vpc_channel_type不为空，且type字段为空或等于0时，直接使用vpc_channel_type字段的值指定负载通道类型。  修改负载通道时vpc通道类型不会修改，直接使用原有的vpc通道类型。

        :param vpc_channel_type: The vpc_channel_type of this CreateVpcChannelV2Response.
        :type vpc_channel_type: str
        """
    ...
    @property
    def dict_code(self):
        r"""Gets the dict_code of this CreateVpcChannelV2Response.
    ...
    def dict_code(self, dict_code):
        r"""Sets the dict_code of this CreateVpcChannelV2Response.
    ...
    def create_time(self):
        r"""Gets the create_time of this CreateVpcChannelV2Response.
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this CreateVpcChannelV2Response.
    ...
    @property
    def id(self):
        r"""Gets the id of this CreateVpcChannelV2Response.
    ...
    @id.setter
    def id(self, id):
        r"""Sets the id of this CreateVpcChannelV2Response.
    ...
    @property
    def status(self):
        r"""Gets the status of this CreateVpcChannelV2Response.
    ...
    def status(self, status):
        r"""Sets the status of this CreateVpcChannelV2Response.
    ...
    def member_groups(self):
        r"""Gets the member_groups of this CreateVpcChannelV2Response.
    ...
    def member_groups(self, member_groups):
        r"""Sets the member_groups of this CreateVpcChannelV2Response.
    ...
    def microservice_info(self):
        r"""Gets the microservice_info of this CreateVpcChannelV2Response.
    ...
    def microservice_info(self, microservice_info):
        r"""Sets the microservice_info of this CreateVpcChannelV2Response.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateVpcChannelV2Response.to_dict() is deprecated and no longer maintained, "
