...
class ApigRegion:
    ...
    SA_BRAZIL_1 = Region(id="sa-brazil-1", endpoint="https://apig.sa-brazil-1.myhuaweicloud.com")

    LA_SOUTH_2 = Region(id="la-south-2", endpoint="https://apig.la-south-2.myhuaweicloud.com")

    LA_NORTH_2 = Region(id="la-north-2", endpoint="https://apig.la-north-2.myhuaweicloud.com")

    NA_MEXICO_1 = Region(id="na-mexico-1", endpoint="https://apig.na-mexico-1.myhuaweicloud.com")

    AF_SOUTH_1 = Region(id="af-south-1", endpoint="https://apig.af-south-1.myhuaweicloud.com")

    CN_NORTH_9 = Region(id="cn-north-9", endpoint="https://apig.cn-north-9.myhuaweicloud.com")

    CN_SOUTHWEST_2 = Region(id="cn-southwest-2", endpoint="https://apig.cn-southwest-2.myhuaweicloud.com")
