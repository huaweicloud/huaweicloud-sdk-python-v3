...
class ListVerificationProgressRequest:
    ...
    def __init__(self, migration_project_id=None):
        r"""ListVerificationProgressRequest
    ...
    def migration_project_id(self):
        r"""Gets the migration_project_id of this ListVerificationProgressRequest.

        迁移项目ID。

        :return: The migration_project_id of this ListVerificationProgressRequest.
        :rtype: str
        """
    ...
    def migration_project_id(self, migration_project_id):
        r"""Sets the migration_project_id of this ListVerificationProgressRequest.

        迁移项目ID。

        :param migration_project_id: The migration_project_id of this ListVerificationProgressRequest.
        :type migration_project_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListVerificationProgressRequest):
            return False
