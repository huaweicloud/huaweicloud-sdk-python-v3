...
class DeleteMigrationProjectResponse(SdkResponse):
    ...
    def migration_project_id(self):
        ...
        :return: The migration_project_id of this DeleteMigrationProjectResponse.
        :rtype: str
        """
    ...
    def migration_project_id(self, migration_project_id):
        ...
        :param migration_project_id: The migration_project_id of this DeleteMigrationProjectResponse.
        :type migration_project_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("DeleteMigrationProjectResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteMigrationProjectResponse):
            return False
