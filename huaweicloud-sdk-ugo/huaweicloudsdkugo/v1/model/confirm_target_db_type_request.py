...
class ConfirmTargetDbTypeRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the ConfirmTargetDbTypeRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfirmTargetDbTypeRequest):
            return False
