...
class CreateEvaluationProjectRequest:
    ...
    openapi_types = {
        'body': 'CreateEvaluationProjectReq'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateEvaluationProjectRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateEvaluationProjectRequest):
            return False
