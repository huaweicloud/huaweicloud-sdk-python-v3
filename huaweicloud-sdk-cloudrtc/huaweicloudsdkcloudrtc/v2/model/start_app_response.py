...
class StartAppResponse(SdkResponse):
    ...
    @property
    def app_id(self):
        r"""Gets the app_id of this StartAppResponse.
    ...
    def app_id(self, app_id):
        r"""Sets the app_id of this StartAppResponse.
    ...
    @property
    def state(self):
        r"""Gets the state of this StartAppResponse.
    ...
    def state(self, state):
        r"""Sets the state of this StartAppResponse.
    ...
    def x_request_id(self):
        r"""Gets the x_request_id of this StartAppResponse.
    ...
    def x_request_id(self, x_request_id):
        r"""Sets the x_request_id of this StartAppResponse.
