...
class UpdateObsBucketAuthorityRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the UpdateObsBucketAuthorityRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateObsBucketAuthorityRequest):
            return False
