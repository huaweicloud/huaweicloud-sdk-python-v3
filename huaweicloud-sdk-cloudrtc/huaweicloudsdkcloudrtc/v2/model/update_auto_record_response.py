...
class UpdateAutoRecordResponse(SdkResponse):
    ...
    def app_id(self):
        ...
        :return: The app_id of this UpdateAutoRecordResponse.
        :rtype: str
        """
        return self._app_id
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateAutoRecordResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateAutoRecordResponse):
            return False
