...
class ShowMixJobResponse(SdkResponse):
    ...
    @property
    def job_id(self):
        r"""Gets the job_id of this ShowMixJobResponse.

        任务编号，可以用于修改、查看和停止合流任务

        :return: The job_id of this ShowMixJobResponse.
        :rtype: str
        """
        return self._job_id
    ...
    def job_id(self, job_id):
        r"""Sets the job_id of this ShowMixJobResponse.
    ...
    def stream_name(self):
        r"""Gets the stream_name of this ShowMixJobResponse.

        流名

        :return: The stream_name of this ShowMixJobResponse.
        :rtype: str
        """
    ...
    def stream_name(self, stream_name):
        r"""Sets the stream_name of this ShowMixJobResponse.
    ...
    @property
    def app_id(self):
        r"""Gets the app_id of this ShowMixJobResponse.

        应用id

        :return: The app_id of this ShowMixJobResponse.
        :rtype: str
        """
        return self._app_id
    ...
    def app_id(self, app_id):
        r"""Sets the app_id of this ShowMixJobResponse.
    ...
    @property
    def room_id(self):
        r"""Gets the room_id of this ShowMixJobResponse.

        房间id

        :return: The room_id of this ShowMixJobResponse.
        :rtype: str
        """
    ...
    def room_id(self, room_id):
        r"""Sets the room_id of this ShowMixJobResponse.
    ...
    @property
    def mix_param(self):
        r"""Gets the mix_param of this ShowMixJobResponse.
    ...
    def mix_param(self, mix_param):
        r"""Sets the mix_param of this ShowMixJobResponse.
    ...
    def record_param(self):
        r"""Gets the record_param of this ShowMixJobResponse.
    ...
    def record_param(self, record_param):
        r"""Sets the record_param of this ShowMixJobResponse.
    ...
    def create_time(self):
        r"""Gets the create_time of this ShowMixJobResponse.

        任务创建的时间，形如“2006-01-02T15:04:05.075Z”，时区为：UTC

        :return: The create_time of this ShowMixJobResponse.
        :rtype: str
        """
    ...
    def create_time(self, create_time):
        r"""Sets the create_time of this ShowMixJobResponse.
    ...
    def update_time(self):
        r"""Gets the update_time of this ShowMixJobResponse.

        任务中的布局更新的时间，形如“2006-01-02T15:04:05.075Z”，时区为：UTC

        :return: The update_time of this ShowMixJobResponse.
        :rtype: str
        """
    ...
    def update_time(self, update_time):
        r"""Sets the update_time of this ShowMixJobResponse.
    ...
    @property
    def state(self):
        r"""Gets the state of this ShowMixJobResponse.

        任务状态。  - INIT：任务正在初始化 - RUNNING：任务正在运行 - STOPPED：任务已停止 

        :return: The state of this ShowMixJobResponse.
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        r"""Sets the state of this ShowMixJobResponse.
    ...
    def stop_reason(self):
        r"""Gets the stop_reason of this ShowMixJobResponse.
    ...
    def stop_reason(self, stop_reason):
        r"""Sets the stop_reason of this ShowMixJobResponse.
    ...
    def description(self):
        r"""Gets the description of this ShowMixJobResponse.

        状态描述，对state字段的一些补充说明，可用于人工查阅。

        :return: The description of this ShowMixJobResponse.
        :rtype: str
        """
    ...
    def description(self, description):
        r"""Sets the description of this ShowMixJobResponse.
    ...
    @property
    def start_time(self):
        r"""Gets the start_time of this ShowMixJobResponse.

        任务开始时间，形如“2006-01-02T15:04:05.075Z”，时区为：UTC

        :return: The start_time of this ShowMixJobResponse.
        :rtype: str
        """
    ...
    def start_time(self, start_time):
        r"""Sets the start_time of this ShowMixJobResponse.
    ...
    @property
    def stop_time(self):
        r"""Gets the stop_time of this ShowMixJobResponse.

        任务结束时间，形如“2006-01-02T15:04:05.075Z”，时区为：UTC

        :return: The stop_time of this ShowMixJobResponse.
        :rtype: str
        """
    ...
    def stop_time(self, stop_time):
        r"""Sets the stop_time of this ShowMixJobResponse.
    ...
    def x_request_id(self):
        r"""Gets the x_request_id of this ShowMixJobResponse.
    ...
    def x_request_id(self, x_request_id):
        r"""Sets the x_request_id of this ShowMixJobResponse.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowMixJobResponse):
            return False
