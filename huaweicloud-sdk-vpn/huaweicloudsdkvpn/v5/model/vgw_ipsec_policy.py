...
class VgwIpsecPolicy:
    ...
    def authentication_algorithm(self):
        ...
        :return: The authentication_algorithm of this VgwIpsecPolicy.
        :rtype: str
        """
    ...
    def authentication_algorithm(self, authentication_algorithm):
        ...
        :param authentication_algorithm: The authentication_algorithm of this VgwIpsecPolicy.
        :type authentication_algorithm: str
        """
    ...
    def encryption_algorithm(self):
        ...
        :return: The encryption_algorithm of this VgwIpsecPolicy.
        :rtype: str
        """
    ...
    def encryption_algorithm(self, encryption_algorithm):
        ...
        :param encryption_algorithm: The encryption_algorithm of this VgwIpsecPolicy.
        :type encryption_algorithm: str
        """
    ...
    def pfs(self):
        ...
        :return: The pfs of this VgwIpsecPolicy.
        :rtype: str
        """
        return self._pfs
    ...
    def pfs(self, pfs):
        ...
        :param pfs: The pfs of this VgwIpsecPolicy.
        :type pfs: str
        """
        self._pfs = pfs
    ...
    def lifetime_seconds(self):
        ...
        :return: The lifetime_seconds of this VgwIpsecPolicy.
        :rtype: int
        """
    ...
    def lifetime_seconds(self, lifetime_seconds):
        ...
        :param lifetime_seconds: The lifetime_seconds of this VgwIpsecPolicy.
        :type lifetime_seconds: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VgwIpsecPolicy):
            return False
