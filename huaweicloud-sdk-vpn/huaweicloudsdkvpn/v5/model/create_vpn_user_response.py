...
class CreateVpnUserResponse(SdkResponse):
    ...
    openapi_types = {
        'user': 'CreateVpnUserResponseBodyUser',
        'request_id': 'str',
    ...
    def request_id(self):
        ...
        :return: The request_id of this CreateVpnUserResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        ...
        :param request_id: The request_id of this CreateVpnUserResponse.
        :type request_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateVpnUserResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateVpnUserResponse):
            return False
