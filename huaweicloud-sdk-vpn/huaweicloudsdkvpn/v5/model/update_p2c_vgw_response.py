...
class UpdateP2cVgwResponse(SdkResponse):
    ...
    def request_id(self):
        ...
        :return: The request_id of this UpdateP2cVgwResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        ...
        :param request_id: The request_id of this UpdateP2cVgwResponse.
        :type request_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("UpdateP2cVgwResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateP2cVgwResponse):
            return False
