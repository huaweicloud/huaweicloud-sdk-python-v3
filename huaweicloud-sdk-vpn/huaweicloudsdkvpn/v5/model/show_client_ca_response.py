...
class ShowClientCaResponse(SdkResponse):
    ...
    openapi_types = {
        'client_ca_certificate': 'QueryClientCaCertificateBody',
        'request_id': 'str',
    ...
    def request_id(self):
        ...
        :return: The request_id of this ShowClientCaResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        ...
        :param request_id: The request_id of this ShowClientCaResponse.
        :type request_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowClientCaResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowClientCaResponse):
            return False
