...
class UpdateClientCaCertificateRequestBody:
    ...
    openapi_types = {
        'client_ca_certificate': 'UpdateClientCaCertificateRequestBodyClientCaCertificate'
    }
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateClientCaCertificateRequestBody):
            return False
