...
class ShowVpnAccessPolicyResponse(SdkResponse):
    ...
    def request_id(self):
        ...
        :return: The request_id of this ShowVpnAccessPolicyResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        ...
        :param request_id: The request_id of this ShowVpnAccessPolicyResponse.
        :type request_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowVpnAccessPolicyResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowVpnAccessPolicyResponse):
            return False
