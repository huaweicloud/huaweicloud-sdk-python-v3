...
class CreateVgwResponse(SdkResponse):
    ...
    openapi_types = {
        'vpn_gateway': 'CreateResponseVpnGateway',
        'request_id': 'str',
    ...
    def request_id(self):
        ...
        :return: The request_id of this CreateVgwResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        ...
        :param request_id: The request_id of this CreateVgwResponse.
        :type request_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateVgwResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateVgwResponse):
            return False
