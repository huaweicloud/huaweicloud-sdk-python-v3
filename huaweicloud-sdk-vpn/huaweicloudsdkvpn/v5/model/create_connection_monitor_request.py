...
class CreateConnectionMonitorRequest:
    ...
    openapi_types = {
        'body': 'CreateConnectionMonitorRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CreateConnectionMonitorRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateConnectionMonitorRequest):
            return False
