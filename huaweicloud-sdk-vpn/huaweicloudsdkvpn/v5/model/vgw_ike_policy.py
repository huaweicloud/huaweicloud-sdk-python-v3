...
class VgwIkePolicy:
    ...
    def encryption_algorithm(self):
        ...
        :return: The encryption_algorithm of this VgwIkePolicy.
        :rtype: str
        """
    ...
    def encryption_algorithm(self, encryption_algorithm):
        ...
        :param encryption_algorithm: The encryption_algorithm of this VgwIkePolicy.
        :type encryption_algorithm: str
        """
    ...
    def dh_group(self):
        ...
        :return: The dh_group of this VgwIkePolicy.
        :rtype: str
        """
    ...
    def dh_group(self, dh_group):
        ...
        :param dh_group: The dh_group of this VgwIkePolicy.
        :type dh_group: str
        """
    ...
    def authentication_algorithm(self):
        ...
        :return: The authentication_algorithm of this VgwIkePolicy.
        :rtype: str
        """
    ...
    def authentication_algorithm(self, authentication_algorithm):
        ...
        :param authentication_algorithm: The authentication_algorithm of this VgwIkePolicy.
        :type authentication_algorithm: str
        """
    ...
    def lifetime_seconds(self):
        ...
        :return: The lifetime_seconds of this VgwIkePolicy.
        :rtype: int
        """
    ...
    def lifetime_seconds(self, lifetime_seconds):
        ...
        :param lifetime_seconds: The lifetime_seconds of this VgwIkePolicy.
        :type lifetime_seconds: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VgwIkePolicy):
            return False
