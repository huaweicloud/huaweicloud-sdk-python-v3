...
class DeleteConnectionMonitorRequest:
    ...
    def __init__(self, connection_monitor_id=None):
        r"""DeleteConnectionMonitorRequest
    ...
    def connection_monitor_id(self):
        r"""Gets the connection_monitor_id of this DeleteConnectionMonitorRequest.

        VPN连接监控的ID

        :return: The connection_monitor_id of this DeleteConnectionMonitorRequest.
        :rtype: str
        """
    ...
    def connection_monitor_id(self, connection_monitor_id):
        r"""Sets the connection_monitor_id of this DeleteConnectionMonitorRequest.

        VPN连接监控的ID

        :param connection_monitor_id: The connection_monitor_id of this DeleteConnectionMonitorRequest.
        :type connection_monitor_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteConnectionMonitorRequest):
            return False
