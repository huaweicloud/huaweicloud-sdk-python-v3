...
class BatchDeleteVpnUsersRequest:
    ...
    openapi_types = {
        'vpn_server_id': 'str',
        'body': 'BatchDeleteVpnUsersRequestBody'
    }
    ...
    def __init__(self, vpn_server_id=None, body=None):
        ...
        :param body: Body of the BatchDeleteVpnUsersRequest
    ...
    def vpn_server_id(self):
        ...
        :return: The vpn_server_id of this BatchDeleteVpnUsersRequest.
        :rtype: str
        """
    ...
    def vpn_server_id(self, vpn_server_id):
        ...
        :param vpn_server_id: The vpn_server_id of this BatchDeleteVpnUsersRequest.
        :type vpn_server_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDeleteVpnUsersRequest):
            return False
