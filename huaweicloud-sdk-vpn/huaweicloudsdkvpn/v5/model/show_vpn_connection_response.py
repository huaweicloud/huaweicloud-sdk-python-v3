...
class ShowVpnConnectionResponse(SdkResponse):
    ...
    openapi_types = {
        'vpn_connection': 'ResponseVpnConnection',
        'request_id': 'str',
    ...
    def request_id(self):
        ...
        :return: The request_id of this ShowVpnConnectionResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        ...
        :param request_id: The request_id of this ShowVpnConnectionResponse.
        :type request_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowVpnConnectionResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowVpnConnectionResponse):
            return False
