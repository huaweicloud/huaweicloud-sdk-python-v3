...
class ShowP2cVgwResponse(SdkResponse):
    ...
    openapi_types = {
        'p2c_vpn_gateway': 'ShowResponseP2cVgw',
        'request_id': 'str'
    }
    ...
    def request_id(self):
        ...
        :return: The request_id of this ShowP2cVgwResponse.
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        ...
        :param request_id: The request_id of this ShowP2cVgwResponse.
        :type request_id: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ShowP2cVgwResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ShowP2cVgwResponse):
            return False
