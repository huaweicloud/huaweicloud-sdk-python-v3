...
class VpnAsyncClient(Client):
    ...
    def delete_p2c_vpn_gateway_job_async(self, request):
        r"""删除指定任务的记录
    ...
    def delete_p2c_vpn_gateway_job_async_invoker(self, request):
        http_info = self._delete_p2c_vpn_gateway_job_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_p2c_vpn_gateway_job_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_p2c_vpn_gateway_jobs_async(self, request):
        r"""查询资源任务列表
    ...
    def list_p2c_vpn_gateway_jobs_async_invoker(self, request):
        http_info = self._list_p2c_vpn_gateway_jobs_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_p2c_vpn_gateway_jobs_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def upgrade_p2c_vpn_gateway_async(self, request):
        r"""升级VPN资源
    ...
    def upgrade_p2c_vpn_gateway_async_invoker(self, request):
        http_info = self._upgrade_p2c_vpn_gateway_http_info(request)
        return AsyncInvoker(self, http_info)

    def _upgrade_p2c_vpn_gateway_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def export_vpn_connection_peer_configuration_async(self, request):
        r"""导出VPN连接配置
    ...
    def export_vpn_connection_peer_configuration_async_invoker(self, request):
        http_info = self._export_vpn_connection_peer_configuration_http_info(request)
        return AsyncInvoker(self, http_info)

    def _export_vpn_connection_peer_configuration_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def list_connection_ipsec_sa_async(self, request):
        r"""查询VPN连接网段协商信息
    ...
    def list_connection_ipsec_sa_async_invoker(self, request):
        http_info = self._list_connection_ipsec_sa_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_connection_ipsec_sa_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def list_peer_configuration_supported_devices_async(self, request):
        r"""获取可导出VPN连接配置的设备
    ...
    def list_peer_configuration_supported_devices_async_invoker(self, request):
        http_info = self._list_peer_configuration_supported_devices_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_peer_configuration_supported_devices_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def delete_vpn_gateway_job_async(self, request):
        r"""删除指定任务的记录
    ...
    def delete_vpn_gateway_job_async_invoker(self, request):
        http_info = self._delete_vpn_gateway_job_http_info(request)
        return AsyncInvoker(self, http_info)

    def _delete_vpn_gateway_job_http_info(self, request):
        http_info = {
            "method": "DELETE",
    ...
    def list_vpn_gateway_jobs_async(self, request):
        r"""查询资源任务列表
    ...
    def list_vpn_gateway_jobs_async_invoker(self, request):
        http_info = self._list_vpn_gateway_jobs_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_vpn_gateway_jobs_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def upgrade_vpn_gateway_async(self, request):
        r"""升级VPN资源
    ...
    def upgrade_vpn_gateway_async_invoker(self, request):
        http_info = self._upgrade_vpn_gateway_http_info(request)
        return AsyncInvoker(self, http_info)

    def _upgrade_vpn_gateway_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def list_vpn_gateway_certificates_async(self, request):
        r"""查询租户下的的所有VPN网关证书
    ...
    def list_vpn_gateway_certificates_async_invoker(self, request):
        http_info = self._list_vpn_gateway_certificates_http_info(request)
        return AsyncInvoker(self, http_info)

    def _list_vpn_gateway_certificates_http_info(self, request):
        http_info = {
            "method": "GET",
