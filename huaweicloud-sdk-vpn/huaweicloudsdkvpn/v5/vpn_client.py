...
class VpnClient(Client):
    ...
    def create_p2c_vgw(self, request):
        r"""创建P2C VPN网关
    ...
    def create_p2c_vgw_invoker(self, request):
        http_info = self._create_p2c_vgw_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _create_p2c_vgw_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def delete_p2c_vgw(self, request):
        r"""删除P2C VPN网关
    ...
    def delete_p2c_vgw_invoker(self, request):
        http_info = self._delete_p2c_vgw_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _delete_p2c_vgw_http_info(cls, request):
        http_info = {
            "method": "DELETE",
    ...
    def batch_create_vpn_connection(self, request):
        r"""批量创建VPN连接
    ...
    def batch_create_vpn_connection_invoker(self, request):
        http_info = self._batch_create_vpn_connection_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _batch_create_vpn_connection_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def reset_vpn_connection(self, request):
        r"""重置VPN连接
    ...
    def reset_vpn_connection_invoker(self, request):
        http_info = self._reset_vpn_connection_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _reset_vpn_connection_http_info(cls, request):
        http_info = {
            "method": "POST",
    ...
    def show_vpn_gateway_routing_table(self, request):
        r"""查询VPN网关路由表
    ...
    def show_vpn_gateway_routing_table_invoker(self, request):
        http_info = self._show_vpn_gateway_routing_table_http_info(request)
        return SyncInvoker(self, http_info)

    @classmethod
    def _show_vpn_gateway_routing_table_http_info(cls, request):
        http_info = {
            "method": "GET",
