...
class CdmAsyncClient(Client):
    ...
    def modify_cluster_async_invoker(self, request):
        http_info = self._modify_cluster_http_info(request)
        return AsyncInvoker(self, http_info)

    def _modify_cluster_http_info(self, request):
        http_info = {
            "method": "POST",
    ...
    def show_availability_zones_async_invoker(self, request):
        http_info = self._show_availability_zones_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_availability_zones_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_cluster_enterprise_projects_async_invoker(self, request):
        http_info = self._show_cluster_enterprise_projects_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_cluster_enterprise_projects_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_datastores_async_invoker(self, request):
        http_info = self._show_datastores_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_datastores_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_enterprise_projects_async_invoker(self, request):
        http_info = self._show_enterprise_projects_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_enterprise_projects_http_info(self, request):
        http_info = {
            "method": "GET",
    ...
    def show_flavors_async_invoker(self, request):
        http_info = self._show_flavors_http_info(request)
        return AsyncInvoker(self, http_info)

    def _show_flavors_http_info(self, request):
        http_info = {
            "method": "GET",
