...
class CdmCreateJobJsonReq:
    ...
    @property
    def jobs(self):
        r"""Gets the jobs of this CdmCreateJobJsonReq.
    ...
    @jobs.setter
    def jobs(self, jobs):
        r"""Sets the jobs of this CdmCreateJobJsonReq.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CdmCreateJobJsonReq):
            return False
