...
class BandWidthRules:
    ...
    def __init__(self, id=None, name=None, admin_state_up=None, egress_size=None, egress_guarented_size=None, publicip_info=None):
        ...
        :param id: - 功能说明：带宽规则ID
        :type id: str
        :param name: - 功能说明：带宽规则名称
        :type name: str
        :param admin_state_up: - 功能说明：配置状态，为False时配置不生效。
        :type admin_state_up: bool
        :param egress_size: - 功能说明：出网带宽最大值，单位Mbps - 取值范围[0,n]，其中n为所属带宽的带宽大小（size字段）。0表示设置为最大带宽
        :type egress_size: int
        :param egress_guarented_size: - 功能说明：出网保障带宽大小，单位Mbps - 取值范围[0,x]，其中x为所属带宽剩余的保障额
