...
class DetachBatchPublicIpRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the DetachBatchPublicIpRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DetachBatchPublicIpRequest):
            return False
