...
class CountEipAvailableResourcesRequest:
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the CountEipAvailableResourcesRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CountEipAvailableResourcesRequest):
            return False
