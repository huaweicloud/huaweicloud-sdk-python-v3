...
class UpdatePrePaidBandwidthOption:
    ...
    def __init__(self, name=None, size=None):
        r"""UpdatePrePaidBandwidthOption
    ...
    @property
    def name(self):
        r"""Gets the name of this UpdatePrePaidBandwidthOption.
    ...
    @name.setter
    def name(self, name):
        r"""Sets the name of this UpdatePrePaidBandwidthOption.
    ...
    @property
    def size(self):
        r"""Gets the size of this UpdatePrePaidBandwidthOption.
    ...
    @size.setter
    def size(self, size):
        r"""Sets the size of this UpdatePrePaidBandwidthOption.
