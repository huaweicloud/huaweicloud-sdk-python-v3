...
class BatchCreatePublicipsRequest:
    ...
    openapi_types = {
        'body': 'BatchCreatePublicipsV2RequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchCreatePublicipsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchCreatePublicipsRequest):
            return False
