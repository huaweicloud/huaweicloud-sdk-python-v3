...
class RemoveFromSharedBandwidthOption:
    ...
    def __init__(self, charge_mode=None, publicip_info=None, size=None):
        r"""RemoveFromSharedBandwidthOption
    ...
    def charge_mode(self):
        r"""Gets the charge_mode of this RemoveFromSharedBandwidthOption.
    ...
    def charge_mode(self, charge_mode):
        r"""Sets the charge_mode of this RemoveFromSharedBandwidthOption.
    ...
    def publicip_info(self):
        r"""Gets the publicip_info of this RemoveFromSharedBandwidthOption.
    ...
    def publicip_info(self, publicip_info):
        r"""Sets the publicip_info of this RemoveFromSharedBandwidthOption.
    ...
    @property
    def size(self):
        r"""Gets the size of this RemoveFromSharedBandwidthOption.
    ...
    @size.setter
    def size(self, size):
        r"""Sets the size of this RemoveFromSharedBandwidthOption.
