...
class CreatePublicipResponse(SdkResponse):
    ...
    @property
    def publicip(self):
        r"""Gets the publicip of this CreatePublicipResponse.
    ...
    def publicip(self, publicip):
        r"""Sets the publicip of this CreatePublicipResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreatePublicipResponse.to_dict() is deprecated and no longer maintained, "
