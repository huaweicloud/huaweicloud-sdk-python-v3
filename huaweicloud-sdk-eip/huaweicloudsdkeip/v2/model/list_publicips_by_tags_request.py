...
class ListPublicipsByTagsRequest:
    ...
    openapi_types = {
        'body': 'ListPublicipsByTagsRequestBody'
    }
    ...
    def __init__(self, body=None):
        """ListPublicipsByTagsRequest - a model defined in huaweicloud sdk"""
    ...
    def body(self):
        ...
        :rtype: ListPublicipsByTagsRequestBody
        """
        return self._body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListPublicipsByTagsRequest):
            return False
