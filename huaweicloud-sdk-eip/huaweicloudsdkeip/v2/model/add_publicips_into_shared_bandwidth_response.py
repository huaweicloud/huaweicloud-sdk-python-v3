...
class AddPublicipsIntoSharedBandwidthResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("AddPublicipsIntoSharedBandwidthResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddPublicipsIntoSharedBandwidthResponse):
            return False
