...
class ListPublicipsByTagsResponse(SdkResponse):
    ...
    @property
    def resources(self):
        r"""Gets the resources of this ListPublicipsByTagsResponse.
    ...
    def resources(self, resources):
        r"""Sets the resources of this ListPublicipsByTagsResponse.
    ...
    def total_count(self):
        r"""Gets the total_count of this ListPublicipsByTagsResponse.

        总记录数

        :return: The total_count of this ListPublicipsByTagsResponse.
        :rtype: int
        """
    ...
    def total_count(self, total_count):
        r"""Sets the total_count of this ListPublicipsByTagsResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("ListPublicipsByTagsResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListPublicipsByTagsResponse):
            return False
