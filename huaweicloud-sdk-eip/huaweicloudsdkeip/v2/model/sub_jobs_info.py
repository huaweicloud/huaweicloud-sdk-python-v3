...
class SubJobsInfo:
    ...
    def __init__(self, sub_jobs=None):
        ...
        :param sub_jobs: 子job信息，类型与主job一致
        :type sub_jobs: list[object]
        """
    ...
    def sub_jobs(self):
        ...
        :return: The sub_jobs of this SubJobsInfo.
        :rtype: list[object]
        """
    ...
    def sub_jobs(self, sub_jobs):
        ...
        :param sub_jobs: The sub_jobs of this SubJobsInfo.
        :type sub_jobs: list[object]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubJobsInfo):
            return False
