...
class BatchDisassociatePublicipsRequest:
    ...
    openapi_types = {
        'body': 'BatchDeletePublicIpRequestBody'
    }
    ...
    def __init__(self, body=None):
        ...
        :param body: Body of the BatchDisassociatePublicipsRequest
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchDisassociatePublicipsRequest):
            return False
