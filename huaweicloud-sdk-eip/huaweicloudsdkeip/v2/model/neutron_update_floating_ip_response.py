...
class NeutronUpdateFloatingIpResponse(SdkResponse):
    ...
    def __init__(self, floatingip=None):
        r"""NeutronUpdateFloatingIpResponse
    ...
    @property
    def floatingip(self):
        r"""Gets the floatingip of this NeutronUpdateFloatingIpResponse.
    ...
    def floatingip(self, floatingip):
        r"""Sets the floatingip of this NeutronUpdateFloatingIpResponse.
    ...
    def to_dict(self):
        import warnings
        warnings.warn("NeutronUpdateFloatingIpResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NeutronUpdateFloatingIpResponse):
            return False
