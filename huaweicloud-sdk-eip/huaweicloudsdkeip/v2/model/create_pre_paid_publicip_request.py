...
class CreatePrePaidPublicipRequest:
    ...
    openapi_types = {
        'body': 'CreatePrePaidPublicipRequestBody'
    }
    ...
    def __init__(self, body=None):
        r"""CreatePrePaidPublicipRequest
    ...
    @property
    def body(self):
        r"""Gets the body of this CreatePrePaidPublicipRequest.
    ...
    @body.setter
    def body(self, body):
        r"""Sets the body of this CreatePrePaidPublicipRequest.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreatePrePaidPublicipRequest):
            return False
