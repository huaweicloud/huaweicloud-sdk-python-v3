...
class CountPublicIpInstanceResponse(SdkResponse):
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CountPublicIpInstanceResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CountPublicIpInstanceResponse):
            return False
